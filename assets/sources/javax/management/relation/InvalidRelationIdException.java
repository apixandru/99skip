...
<span id="LC29" class="line" lang="java"><span class="cm"> * This exception is raised when relation id provided for a relation is already</span></span>
<span id="LC30" class="line" lang="java"><span class="cm"> * used.</span></span>
...
<span id="LC34" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">InvalidRelationIdException</span> <span class="kd">extends</span> <span class="nc">RelationException</span> <span class="o">{</span></span>
<span id="LC35" class="line" lang="java"></span>
<span id="LC36" class="line" lang="java">    <span class="cm">/* Serial version */</span></span>
<span id="LC37" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="o">-</span><span class="mi">7115040321202754171L</span><span class="o">;</span></span>
...
<span id="LC42" class="line" lang="java">    <span class="kd">public</span> <span class="nf">InvalidRelationIdException</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC51" class="line" lang="java">    <span class="kd">public</span> <span class="nf">InvalidRelationIdException</span><span class="o">(</span><span class="nc">String</span> <span class="n">message</span><span class="o">)</span> <span class="o">{</span></span>
