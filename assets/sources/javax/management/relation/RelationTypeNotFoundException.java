...
<span id="LC29" class="line" lang="java"><span class="cm"> * This exception is raised when there is no relation type with given name in</span></span>
<span id="LC30" class="line" lang="java"><span class="cm"> * Relation Service.</span></span>
...
<span id="LC34" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">RelationTypeNotFoundException</span> <span class="kd">extends</span> <span class="nc">RelationException</span> <span class="o">{</span></span>
<span id="LC35" class="line" lang="java"></span>
<span id="LC36" class="line" lang="java">    <span class="cm">/* Serial version */</span></span>
<span id="LC37" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="mi">1274155316284300752L</span><span class="o">;</span></span>
...
<span id="LC42" class="line" lang="java">    <span class="kd">public</span> <span class="nf">RelationTypeNotFoundException</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC51" class="line" lang="java">    <span class="kd">public</span> <span class="nf">RelationTypeNotFoundException</span><span class="o">(</span><span class="nc">String</span> <span class="n">message</span><span class="o">)</span> <span class="o">{</span></span>
