...
<span id="LC30" class="line" lang="java"><span class="cm"> * The value specified is not valid for the attribute.</span></span>
...
<span id="LC34" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">InvalidAttributeValueException</span> <span class="kd">extends</span> <span class="nc">OperationsException</span>   <span class="o">{</span></span>
<span id="LC35" class="line" lang="java"></span>
<span id="LC36" class="line" lang="java">    <span class="cm">/* Serial version */</span></span>
<span id="LC37" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="mi">2164571879317142449L</span><span class="o">;</span></span>
...
<span id="LC42" class="line" lang="java">    <span class="kd">public</span> <span class="nf">InvalidAttributeValueException</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC51" class="line" lang="java">    <span class="kd">public</span> <span class="nf">InvalidAttributeValueException</span><span class="o">(</span><span class="nc">String</span> <span class="n">message</span><span class="o">)</span> <span class="o">{</span></span>
