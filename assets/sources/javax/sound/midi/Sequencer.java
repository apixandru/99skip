...
<span id="LC33" class="line" lang="java"><span class="cm"> * A hardware or software device that plays back a MIDI</span></span>
<span id="LC34" class="line" lang="java"><span class="cm"> * &lt;code&gt;{@link Sequence sequence}&lt;/code&gt; is known as a &lt;em&gt;sequencer&lt;/em&gt;.</span></span>
<span id="LC35" class="line" lang="java"><span class="cm"> * A MIDI sequence contains lists of time-stamped MIDI data, such as</span></span>
<span id="LC36" class="line" lang="java"><span class="cm"> * might be read from a standard MIDI file.  Most</span></span>
<span id="LC37" class="line" lang="java"><span class="cm"> * sequencers also provide functions for creating and editing sequences.</span></span>
<span id="LC38" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC39" class="line" lang="java"><span class="cm"> * The &lt;code&gt;Sequencer&lt;/code&gt; interface includes methods for the following</span></span>
<span id="LC40" class="line" lang="java"><span class="cm"> * basic MIDI sequencer operations:</span></span>
<span id="LC41" class="line" lang="java"><span class="cm"> * &lt;ul&gt;</span></span>
<span id="LC42" class="line" lang="java"><span class="cm"> * &lt;li&gt;obtaining a sequence from MIDI file data&lt;/li&gt;</span></span>
<span id="LC43" class="line" lang="java"><span class="cm"> * &lt;li&gt;starting and stopping playback&lt;/li&gt;</span></span>
<span id="LC44" class="line" lang="java"><span class="cm"> * &lt;li&gt;moving to an arbitrary position in the sequence&lt;/li&gt;</span></span>
<span id="LC45" class="line" lang="java"><span class="cm"> * &lt;li&gt;changing the tempo (speed) of playback&lt;/li&gt;</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> * &lt;li&gt;synchronizing playback to an internal clock or to received MIDI</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * messages&lt;/li&gt;</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * &lt;li&gt;controlling the timing of another device&lt;/li&gt;</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * &lt;/ul&gt;</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> * In addition, the following operations are supported, either directly, or</span></span>
<span id="LC51" class="line" lang="java"><span class="cm"> * indirectly through objects that the &lt;code&gt;Sequencer&lt;/code&gt; has access to:</span></span>
<span id="LC52" class="line" lang="java"><span class="cm"> * &lt;ul&gt;</span></span>
<span id="LC53" class="line" lang="java"><span class="cm"> * &lt;li&gt;editing the data by adding or deleting individual MIDI events or entire</span></span>
<span id="LC54" class="line" lang="java"><span class="cm"> * tracks&lt;/li&gt;</span></span>
<span id="LC55" class="line" lang="java"><span class="cm"> * &lt;li&gt;muting or soloing individual tracks in the sequence&lt;/li&gt;</span></span>
<span id="LC56" class="line" lang="java"><span class="cm"> * &lt;li&gt;notifying listener objects about any meta-events or</span></span>
<span id="LC57" class="line" lang="java"><span class="cm"> * control-change events encountered while playing back the sequence.&lt;/li&gt;</span></span>
<span id="LC58" class="line" lang="java"><span class="cm"> * &lt;/ul&gt;</span></span>
<span id="LC59" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC60" class="line" lang="java"><span class="cm"> * @see Sequencer.SyncMode</span></span>
<span id="LC61" class="line" lang="java"><span class="cm"> * @see #addMetaEventListener</span></span>
<span id="LC62" class="line" lang="java"><span class="cm"> * @see ControllerEventListener</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * @see Receiver</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> * @see Transmitter</span></span>
<span id="LC65" class="line" lang="java"><span class="cm"> * @see MidiDevice</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> * @author Kara Kytle</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> * @author Florian Bomers</span></span>
<span id="LC69" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC70" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">Sequencer</span> <span class="kd">extends</span> <span class="nc">MidiDevice</span> <span class="o">{</span></span>
...
<span id="LC74" class="line" lang="java"><span class="cm">     * A value indicating that looping should continue</span></span>
<span id="LC75" class="line" lang="java"><span class="cm">     * indefinitely rather than complete after a specific</span></span>
<span id="LC76" class="line" lang="java"><span class="cm">     * number of loops.</span></span>
<span id="LC77" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC78" class="line" lang="java"><span class="cm">     * @see #setLoopCount</span></span>
...
<span id="LC81" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">LOOP_CONTINUOUSLY</span> <span class="o">=</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span></span>
...
<span id="LC86" class="line" lang="java"><span class="cm">     * Sets the current sequence on which the sequencer operates.</span></span>
<span id="LC87" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC88" class="line" lang="java"><span class="cm">     * &lt;p&gt;This method can be called even if the</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">     * &lt;code&gt;Sequencer&lt;/code&gt; is closed.</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">     * @param sequence the sequence to be loaded.</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">     * @throws InvalidMidiDataException if the sequence contains invalid</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">     * MIDI data, or is not supported.</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC95" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSequence</span><span class="o">(</span><span class="nc">Sequence</span> <span class="n">sequence</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">InvalidMidiDataException</span><span class="o">;</span></span>
...
<span id="LC99" class="line" lang="java"><span class="cm">     * Sets the current sequence on which the sequencer operates.</span></span>
<span id="LC100" class="line" lang="java"><span class="cm">     * The stream must point to MIDI file data.</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">     * &lt;p&gt;This method can be called even if the</span></span>
<span id="LC103" class="line" lang="java"><span class="cm">     * &lt;code&gt;Sequencer&lt;/code&gt; is closed.</span></span>
<span id="LC104" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC105" class="line" lang="java"><span class="cm">     * @param stream stream containing MIDI file data.</span></span>
<span id="LC106" class="line" lang="java"><span class="cm">     * @throws IOException if an I/O exception occurs during reading of the stream.</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">     * @throws InvalidMidiDataException if invalid data is encountered</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">     * in the stream, or the stream is not supported.</span></span>
<span id="LC109" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC110" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSequence</span><span class="o">(</span><span class="nc">InputStream</span> <span class="n">stream</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">IOException</span><span class="o">,</span> <span class="nc">InvalidMidiDataException</span><span class="o">;</span></span>
...
<span id="LC114" class="line" lang="java"><span class="cm">     * Obtains the sequence on which the Sequencer is currently operating.</span></span>
<span id="LC115" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC116" class="line" lang="java"><span class="cm">     * &lt;p&gt;This method can be called even if the</span></span>
<span id="LC117" class="line" lang="java"><span class="cm">     * &lt;code&gt;Sequencer&lt;/code&gt; is closed.</span></span>
<span id="LC118" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC119" class="line" lang="java"><span class="cm">     * @return the current sequence, or &lt;code&gt;null&lt;/code&gt; if no sequence is currently set.</span></span>
<span id="LC120" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC121" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Sequence</span> <span class="nf">getSequence</span><span class="o">();</span></span>
...
<span id="LC125" class="line" lang="java"><span class="cm">     * Starts playback of the MIDI data in the currently</span></span>
<span id="LC126" class="line" lang="java"><span class="cm">     * loaded sequence.</span></span>
<span id="LC127" class="line" lang="java"><span class="cm">     * Playback will begin from the current position.</span></span>
<span id="LC128" class="line" lang="java"><span class="cm">     * If the playback position reaches the loop end point,</span></span>
<span id="LC129" class="line" lang="java"><span class="cm">     * and the loop count is greater than 0, playback will</span></span>
<span id="LC130" class="line" lang="java"><span class="cm">     * resume at the loop start point for the number of</span></span>
<span id="LC131" class="line" lang="java"><span class="cm">     * repetitions set with &lt;code&gt;setLoopCount&lt;/code&gt;.</span></span>
<span id="LC132" class="line" lang="java"><span class="cm">     * After that, or if the loop count is 0, playback will</span></span>
<span id="LC133" class="line" lang="java"><span class="cm">     * continue to play to the end of the sequence.</span></span>
<span id="LC134" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC135" class="line" lang="java"><span class="cm">     * &lt;p&gt;The implementation ensures that the synthesizer</span></span>
<span id="LC136" class="line" lang="java"><span class="cm">     * is brought to a consistent state when jumping</span></span>
<span id="LC137" class="line" lang="java"><span class="cm">     * to the loop start point by sending appropriate</span></span>
<span id="LC138" class="line" lang="java"><span class="cm">     * controllers, pitch bend, and program change events.</span></span>
<span id="LC139" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC140" class="line" lang="java"><span class="cm">     * @throws IllegalStateException if the &lt;code&gt;Sequencer&lt;/code&gt; is</span></span>
<span id="LC141" class="line" lang="java"><span class="cm">     * closed.</span></span>
<span id="LC142" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC143" class="line" lang="java"><span class="cm">     * @see #setLoopStartPoint</span></span>
<span id="LC144" class="line" lang="java"><span class="cm">     * @see #setLoopEndPoint</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">     * @see #setLoopCount</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">     * @see #stop</span></span>
<span id="LC147" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC148" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">start</span><span class="o">();</span></span>
...
<span id="LC152" class="line" lang="java"><span class="cm">     * Stops recording, if active, and playback of the currently loaded sequence,</span></span>
<span id="LC153" class="line" lang="java"><span class="cm">     * if any.</span></span>
<span id="LC154" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC155" class="line" lang="java"><span class="cm">     * @throws IllegalStateException if the &lt;code&gt;Sequencer&lt;/code&gt; is</span></span>
<span id="LC156" class="line" lang="java"><span class="cm">     * closed.</span></span>
<span id="LC157" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC158" class="line" lang="java"><span class="cm">     * @see #start</span></span>
<span id="LC159" class="line" lang="java"><span class="cm">     * @see #isRunning</span></span>
<span id="LC160" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC161" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">stop</span><span class="o">();</span></span>
...
<span id="LC165" class="line" lang="java"><span class="cm">     * Indicates whether the Sequencer is currently running.  The default is &lt;code&gt;false&lt;/code&gt;.</span></span>
<span id="LC166" class="line" lang="java"><span class="cm">     * The Sequencer starts running when either &lt;code&gt;{@link #start}&lt;/code&gt; or &lt;code&gt;{@link #startRecording}&lt;/code&gt;</span></span>
<span id="LC167" class="line" lang="java"><span class="cm">     * is called.  &lt;code&gt;isRunning&lt;/code&gt; then returns &lt;code&gt;true&lt;/code&gt; until playback of the</span></span>
<span id="LC168" class="line" lang="java"><span class="cm">     * sequence completes or &lt;code&gt;{@link #stop}&lt;/code&gt; is called.</span></span>
<span id="LC169" class="line" lang="java"><span class="cm">     * @return &lt;code&gt;true&lt;/code&gt; if the Sequencer is running, otherwise &lt;code&gt;false&lt;/code&gt;</span></span>
<span id="LC170" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC171" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isRunning</span><span class="o">();</span></span>
...
<span id="LC175" class="line" lang="java"><span class="cm">     * Starts recording and playback of MIDI data.  Data is recorded to all enabled tracks,</span></span>
<span id="LC176" class="line" lang="java"><span class="cm">     * on the channel(s) for which they were enabled.  Recording begins at the current position</span></span>
<span id="LC177" class="line" lang="java"><span class="cm">     * of the sequencer.   Any events already in the track are overwritten for the duration</span></span>
<span id="LC178" class="line" lang="java"><span class="cm">     * of the recording session.  Events from the currently loaded sequence,</span></span>
<span id="LC179" class="line" lang="java"><span class="cm">     * if any, are delivered to the sequencer's transmitter(s) along with messages</span></span>
<span id="LC180" class="line" lang="java"><span class="cm">     * received during recording.</span></span>
<span id="LC181" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC182" class="line" lang="java"><span class="cm">     * Note that tracks are not by default enabled for recording.  In order to record MIDI data,</span></span>
<span id="LC183" class="line" lang="java"><span class="cm">     * at least one track must be specifically enabled for recording.</span></span>
<span id="LC184" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC185" class="line" lang="java"><span class="cm">     * @throws IllegalStateException if the &lt;code&gt;Sequencer&lt;/code&gt; is</span></span>
<span id="LC186" class="line" lang="java"><span class="cm">     * closed.</span></span>
<span id="LC187" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC188" class="line" lang="java"><span class="cm">     * @see #startRecording</span></span>
<span id="LC189" class="line" lang="java"><span class="cm">     * @see #recordEnable</span></span>
<span id="LC190" class="line" lang="java"><span class="cm">     * @see #recordDisable</span></span>
<span id="LC191" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC192" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startRecording</span><span class="o">();</span></span>
...
<span id="LC196" class="line" lang="java"><span class="cm">     * Stops recording, if active.  Playback of the current sequence continues.</span></span>
<span id="LC197" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">     * @throws IllegalStateException if the &lt;code&gt;Sequencer&lt;/code&gt; is</span></span>
<span id="LC199" class="line" lang="java"><span class="cm">     * closed.</span></span>
<span id="LC200" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC201" class="line" lang="java"><span class="cm">     * @see #startRecording</span></span>
<span id="LC202" class="line" lang="java"><span class="cm">     * @see #isRecording</span></span>
<span id="LC203" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC204" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">stopRecording</span><span class="o">();</span></span>
...
<span id="LC208" class="line" lang="java"><span class="cm">     * Indicates whether the Sequencer is currently recording.  The default is &lt;code&gt;false&lt;/code&gt;.</span></span>
<span id="LC209" class="line" lang="java"><span class="cm">     * The Sequencer begins recording when &lt;code&gt;{@link #startRecording}&lt;/code&gt; is called,</span></span>
<span id="LC210" class="line" lang="java"><span class="cm">     * and then returns &lt;code&gt;true&lt;/code&gt; until &lt;code&gt;{@link #stop}&lt;/code&gt; or &lt;code&gt;{@link #stopRecording}&lt;/code&gt;</span></span>
<span id="LC211" class="line" lang="java"><span class="cm">     * is called.</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">     * @return &lt;code&gt;true&lt;/code&gt; if the Sequencer is recording, otherwise &lt;code&gt;false&lt;/code&gt;</span></span>
<span id="LC213" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC214" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isRecording</span><span class="o">();</span></span>
...
<span id="LC218" class="line" lang="java"><span class="cm">     * Prepares the specified track for recording events received on a particular channel.</span></span>
<span id="LC219" class="line" lang="java"><span class="cm">     * Once enabled, a track will receive events when recording is active.</span></span>
<span id="LC220" class="line" lang="java"><span class="cm">     * @param track the track to which events will be recorded</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">     * @param channel the channel on which events will be received.  If -1 is specified</span></span>
<span id="LC222" class="line" lang="java"><span class="cm">     * for the channel value, the track will receive data from all channels.</span></span>
<span id="LC223" class="line" lang="java"><span class="cm">     * @throws IllegalArgumentException thrown if the track is not part of the current</span></span>
<span id="LC224" class="line" lang="java"><span class="cm">     * sequence.</span></span>
<span id="LC225" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC226" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">recordEnable</span><span class="o">(</span><span class="nc">Track</span> <span class="n">track</span><span class="o">,</span> <span class="kt">int</span> <span class="n">channel</span><span class="o">);</span></span>
...
<span id="LC230" class="line" lang="java"><span class="cm">     * Disables recording to the specified track.  Events will no longer be recorded</span></span>
<span id="LC231" class="line" lang="java"><span class="cm">     * into this track.</span></span>
<span id="LC232" class="line" lang="java"><span class="cm">     * @param track the track to disable for recording, or &lt;code&gt;null&lt;/code&gt; to disable</span></span>
<span id="LC233" class="line" lang="java"><span class="cm">     * recording for all tracks.</span></span>
<span id="LC234" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC235" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">recordDisable</span><span class="o">(</span><span class="nc">Track</span> <span class="n">track</span><span class="o">);</span></span>
...
<span id="LC239" class="line" lang="java"><span class="cm">     * Obtains the current tempo, expressed in beats per minute.  The</span></span>
<span id="LC240" class="line" lang="java"><span class="cm">     * actual tempo of playback is the product of the returned value</span></span>
<span id="LC241" class="line" lang="java"><span class="cm">     * and the tempo factor.</span></span>
<span id="LC242" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC243" class="line" lang="java"><span class="cm">     * @return the current tempo in beats per minute</span></span>
<span id="LC244" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC245" class="line" lang="java"><span class="cm">     * @see #getTempoFactor</span></span>
<span id="LC246" class="line" lang="java"><span class="cm">     * @see #setTempoInBPM(float)</span></span>
<span id="LC247" class="line" lang="java"><span class="cm">     * @see #getTempoInMPQ</span></span>
<span id="LC248" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC249" class="line" lang="java">    <span class="kd">public</span> <span class="kt">float</span> <span class="nf">getTempoInBPM</span><span class="o">();</span></span>
...
<span id="LC253" class="line" lang="java"><span class="cm">     * Sets the tempo in beats per minute.   The actual tempo of playback</span></span>
<span id="LC254" class="line" lang="java"><span class="cm">     * is the product of the specified value and the tempo factor.</span></span>
<span id="LC255" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC256" class="line" lang="java"><span class="cm">     * @param bpm desired new tempo in beats per minute</span></span>
<span id="LC257" class="line" lang="java"><span class="cm">     * @see #getTempoFactor</span></span>
<span id="LC258" class="line" lang="java"><span class="cm">     * @see #setTempoInMPQ(float)</span></span>
<span id="LC259" class="line" lang="java"><span class="cm">     * @see #getTempoInBPM</span></span>
<span id="LC260" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC261" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTempoInBPM</span><span class="o">(</span><span class="kt">float</span> <span class="n">bpm</span><span class="o">);</span></span>
...
<span id="LC265" class="line" lang="java"><span class="cm">     * Obtains the current tempo, expressed in microseconds per quarter</span></span>
<span id="LC266" class="line" lang="java"><span class="cm">     * note.  The actual tempo of playback is the product of the returned</span></span>
<span id="LC267" class="line" lang="java"><span class="cm">     * value and the tempo factor.</span></span>
<span id="LC268" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC269" class="line" lang="java"><span class="cm">     * @return the current tempo in microseconds per quarter note</span></span>
<span id="LC270" class="line" lang="java"><span class="cm">     * @see #getTempoFactor</span></span>
<span id="LC271" class="line" lang="java"><span class="cm">     * @see #setTempoInMPQ(float)</span></span>
<span id="LC272" class="line" lang="java"><span class="cm">     * @see #getTempoInBPM</span></span>
<span id="LC273" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC274" class="line" lang="java">    <span class="kd">public</span> <span class="kt">float</span> <span class="nf">getTempoInMPQ</span><span class="o">();</span></span>
...
<span id="LC278" class="line" lang="java"><span class="cm">     * Sets the tempo in microseconds per quarter note.  The actual tempo</span></span>
<span id="LC279" class="line" lang="java"><span class="cm">     * of playback is the product of the specified value and the tempo</span></span>
<span id="LC280" class="line" lang="java"><span class="cm">     * factor.</span></span>
<span id="LC281" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC282" class="line" lang="java"><span class="cm">     * @param mpq desired new tempo in microseconds per quarter note.</span></span>
<span id="LC283" class="line" lang="java"><span class="cm">     * @see #getTempoFactor</span></span>
<span id="LC284" class="line" lang="java"><span class="cm">     * @see #setTempoInBPM(float)</span></span>
<span id="LC285" class="line" lang="java"><span class="cm">     * @see #getTempoInMPQ</span></span>
<span id="LC286" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC287" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTempoInMPQ</span><span class="o">(</span><span class="kt">float</span> <span class="n">mpq</span><span class="o">);</span></span>
...
<span id="LC291" class="line" lang="java"><span class="cm">     * Scales the sequencer's actual playback tempo by the factor provided.</span></span>
<span id="LC292" class="line" lang="java"><span class="cm">     * The default is 1.0.  A value of 1.0 represents the natural rate (the</span></span>
<span id="LC293" class="line" lang="java"><span class="cm">     * tempo specified in the sequence), 2.0 means twice as fast, etc.</span></span>
<span id="LC294" class="line" lang="java"><span class="cm">     * The tempo factor does not affect the values returned by</span></span>
<span id="LC295" class="line" lang="java"><span class="cm">     * &lt;code&gt;{@link #getTempoInMPQ}&lt;/code&gt; and &lt;code&gt;{@link #getTempoInBPM}&lt;/code&gt;.</span></span>
<span id="LC296" class="line" lang="java"><span class="cm">     * Those values indicate the tempo prior to scaling.</span></span>
<span id="LC297" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC298" class="line" lang="java"><span class="cm">     * Note that the tempo factor cannot be adjusted when external</span></span>
<span id="LC299" class="line" lang="java"><span class="cm">     * synchronization is used.  In that situation,</span></span>
<span id="LC300" class="line" lang="java"><span class="cm">     * &lt;code&gt;setTempoFactor&lt;/code&gt; always sets the tempo factor to 1.0.</span></span>
<span id="LC301" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC302" class="line" lang="java"><span class="cm">     * @param factor the requested tempo scalar</span></span>
<span id="LC303" class="line" lang="java"><span class="cm">     * @see #getTempoFactor</span></span>
<span id="LC304" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC305" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTempoFactor</span><span class="o">(</span><span class="kt">float</span> <span class="n">factor</span><span class="o">);</span></span>
...
<span id="LC309" class="line" lang="java"><span class="cm">     * Returns the current tempo factor for the sequencer.  The default is</span></span>
<span id="LC310" class="line" lang="java"><span class="cm">     * 1.0.</span></span>
<span id="LC311" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC312" class="line" lang="java"><span class="cm">     * @return tempo factor.</span></span>
<span id="LC313" class="line" lang="java"><span class="cm">     * @see #setTempoFactor(float)</span></span>
<span id="LC314" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC315" class="line" lang="java">    <span class="kd">public</span> <span class="kt">float</span> <span class="nf">getTempoFactor</span><span class="o">();</span></span>
...
<span id="LC319" class="line" lang="java"><span class="cm">     * Obtains the length of the current sequence, expressed in MIDI ticks,</span></span>
<span id="LC320" class="line" lang="java"><span class="cm">     * or 0 if no sequence is set.</span></span>
<span id="LC321" class="line" lang="java"><span class="cm">     * @return length of the sequence in ticks</span></span>
<span id="LC322" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC323" class="line" lang="java">    <span class="kd">public</span> <span class="kt">long</span> <span class="nf">getTickLength</span><span class="o">();</span></span>
...
<span id="LC327" class="line" lang="java"><span class="cm">     * Obtains the current position in the sequence, expressed in MIDI</span></span>
<span id="LC328" class="line" lang="java"><span class="cm">     * ticks.  (The duration of a tick in seconds is determined both by</span></span>
<span id="LC329" class="line" lang="java"><span class="cm">     * the tempo and by the timing resolution stored in the</span></span>
<span id="LC330" class="line" lang="java"><span class="cm">     * &lt;code&gt;{@link Sequence}&lt;/code&gt;.)</span></span>
<span id="LC331" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC332" class="line" lang="java"><span class="cm">     * @return current tick</span></span>
<span id="LC333" class="line" lang="java"><span class="cm">     * @see #setTickPosition</span></span>
<span id="LC334" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC335" class="line" lang="java">    <span class="kd">public</span> <span class="kt">long</span> <span class="nf">getTickPosition</span><span class="o">();</span></span>
...
<span id="LC339" class="line" lang="java"><span class="cm">     * Sets the current sequencer position in MIDI ticks</span></span>
<span id="LC340" class="line" lang="java"><span class="cm">     * @param tick the desired tick position</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">     * @see #getTickPosition</span></span>
<span id="LC342" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC343" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTickPosition</span><span class="o">(</span><span class="kt">long</span> <span class="n">tick</span><span class="o">);</span></span>
...
<span id="LC347" class="line" lang="java"><span class="cm">     * Obtains the length of the current sequence, expressed in microseconds,</span></span>
<span id="LC348" class="line" lang="java"><span class="cm">     * or 0 if no sequence is set.</span></span>
<span id="LC349" class="line" lang="java"><span class="cm">     * @return length of the sequence in microseconds.</span></span>
<span id="LC350" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC351" class="line" lang="java">    <span class="kd">public</span> <span class="kt">long</span> <span class="nf">getMicrosecondLength</span><span class="o">();</span></span>
...
<span id="LC355" class="line" lang="java"><span class="cm">     * Obtains the current position in the sequence, expressed in</span></span>
<span id="LC356" class="line" lang="java"><span class="cm">     * microseconds.</span></span>
<span id="LC357" class="line" lang="java"><span class="cm">     * @return the current position in microseconds</span></span>
<span id="LC358" class="line" lang="java"><span class="cm">     * @see #setMicrosecondPosition</span></span>
<span id="LC359" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC360" class="line" lang="java">    <span class="kd">public</span> <span class="kt">long</span> <span class="nf">getMicrosecondPosition</span><span class="o">();</span></span>
...
<span id="LC364" class="line" lang="java"><span class="cm">     * Sets the current position in the sequence, expressed in microseconds</span></span>
<span id="LC365" class="line" lang="java"><span class="cm">     * @param microseconds desired position in microseconds</span></span>
<span id="LC366" class="line" lang="java"><span class="cm">     * @see #getMicrosecondPosition</span></span>
<span id="LC367" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC368" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMicrosecondPosition</span><span class="o">(</span><span class="kt">long</span> <span class="n">microseconds</span><span class="o">);</span></span>
...
<span id="LC372" class="line" lang="java"><span class="cm">     * Sets the source of timing information used by this sequencer.</span></span>
<span id="LC373" class="line" lang="java"><span class="cm">     * The sequencer synchronizes to the master, which is the internal clock,</span></span>
<span id="LC374" class="line" lang="java"><span class="cm">     * MIDI clock, or MIDI time code, depending on the value of</span></span>
<span id="LC375" class="line" lang="java"><span class="cm">     * &lt;code&gt;sync&lt;/code&gt;.  The &lt;code&gt;sync&lt;/code&gt; argument must be one</span></span>
<span id="LC376" class="line" lang="java"><span class="cm">     * of the supported modes, as returned by</span></span>
<span id="LC377" class="line" lang="java"><span class="cm">     * &lt;code&gt;{@link #getMasterSyncModes}&lt;/code&gt;.</span></span>
<span id="LC378" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC379" class="line" lang="java"><span class="cm">     * @param sync the desired master synchronization mode</span></span>
<span id="LC380" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC381" class="line" lang="java"><span class="cm">     * @see SyncMode#INTERNAL_CLOCK</span></span>
<span id="LC382" class="line" lang="java"><span class="cm">     * @see SyncMode#MIDI_SYNC</span></span>
<span id="LC383" class="line" lang="java"><span class="cm">     * @see SyncMode#MIDI_TIME_CODE</span></span>
<span id="LC384" class="line" lang="java"><span class="cm">     * @see #getMasterSyncMode</span></span>
<span id="LC385" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC386" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMasterSyncMode</span><span class="o">(</span><span class="nc">SyncMode</span> <span class="n">sync</span><span class="o">);</span></span>
...
<span id="LC390" class="line" lang="java"><span class="cm">     * Obtains the current master synchronization mode for this sequencer.</span></span>
<span id="LC391" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC392" class="line" lang="java"><span class="cm">     * @return the current master synchronization mode</span></span>
<span id="LC393" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC394" class="line" lang="java"><span class="cm">     * @see #setMasterSyncMode(Sequencer.SyncMode)</span></span>
<span id="LC395" class="line" lang="java"><span class="cm">     * @see #getMasterSyncModes</span></span>
<span id="LC396" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC397" class="line" lang="java">    <span class="kd">public</span> <span class="nc">SyncMode</span> <span class="nf">getMasterSyncMode</span><span class="o">();</span></span>
...
<span id="LC401" class="line" lang="java"><span class="cm">     * Obtains the set of master synchronization modes supported by this</span></span>
<span id="LC402" class="line" lang="java"><span class="cm">     * sequencer.</span></span>
<span id="LC403" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC404" class="line" lang="java"><span class="cm">     * @return the available master synchronization modes</span></span>
<span id="LC405" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC406" class="line" lang="java"><span class="cm">     * @see SyncMode#INTERNAL_CLOCK</span></span>
<span id="LC407" class="line" lang="java"><span class="cm">     * @see SyncMode#MIDI_SYNC</span></span>
<span id="LC408" class="line" lang="java"><span class="cm">     * @see SyncMode#MIDI_TIME_CODE</span></span>
<span id="LC409" class="line" lang="java"><span class="cm">     * @see #getMasterSyncMode</span></span>
<span id="LC410" class="line" lang="java"><span class="cm">     * @see #setMasterSyncMode(Sequencer.SyncMode)</span></span>
<span id="LC411" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC412" class="line" lang="java">    <span class="kd">public</span> <span class="nc">SyncMode</span><span class="o">[]</span> <span class="nf">getMasterSyncModes</span><span class="o">();</span></span>
...
<span id="LC416" class="line" lang="java"><span class="cm">     * Sets the slave synchronization mode for the sequencer.</span></span>
<span id="LC417" class="line" lang="java"><span class="cm">     * This indicates the type of timing information sent by the sequencer</span></span>
<span id="LC418" class="line" lang="java"><span class="cm">     * to its receiver.  The &lt;code&gt;sync&lt;/code&gt; argument must be one</span></span>
<span id="LC419" class="line" lang="java"><span class="cm">     * of the supported modes, as returned by</span></span>
<span id="LC420" class="line" lang="java"><span class="cm">     * &lt;code&gt;{@link #getSlaveSyncModes}&lt;/code&gt;.</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">     * @param sync the desired slave synchronization mode</span></span>
<span id="LC423" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC424" class="line" lang="java"><span class="cm">     * @see SyncMode#MIDI_SYNC</span></span>
<span id="LC425" class="line" lang="java"><span class="cm">     * @see SyncMode#MIDI_TIME_CODE</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">     * @see SyncMode#NO_SYNC</span></span>
<span id="LC427" class="line" lang="java"><span class="cm">     * @see #getSlaveSyncModes</span></span>
<span id="LC428" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC429" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSlaveSyncMode</span><span class="o">(</span><span class="nc">SyncMode</span> <span class="n">sync</span><span class="o">);</span></span>
...
<span id="LC433" class="line" lang="java"><span class="cm">     * Obtains the current slave synchronization mode for this sequencer.</span></span>
<span id="LC434" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC435" class="line" lang="java"><span class="cm">     * @return the current slave synchronization mode</span></span>
<span id="LC436" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC437" class="line" lang="java"><span class="cm">     * @see #setSlaveSyncMode(Sequencer.SyncMode)</span></span>
<span id="LC438" class="line" lang="java"><span class="cm">     * @see #getSlaveSyncModes</span></span>
<span id="LC439" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC440" class="line" lang="java">    <span class="kd">public</span> <span class="nc">SyncMode</span> <span class="nf">getSlaveSyncMode</span><span class="o">();</span></span>
...
<span id="LC444" class="line" lang="java"><span class="cm">     * Obtains the set of slave synchronization modes supported by the sequencer.</span></span>
<span id="LC445" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC446" class="line" lang="java"><span class="cm">     * @return the available slave synchronization modes</span></span>
<span id="LC447" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC448" class="line" lang="java"><span class="cm">     * @see SyncMode#MIDI_SYNC</span></span>
<span id="LC449" class="line" lang="java"><span class="cm">     * @see SyncMode#MIDI_TIME_CODE</span></span>
<span id="LC450" class="line" lang="java"><span class="cm">     * @see SyncMode#NO_SYNC</span></span>
<span id="LC451" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC452" class="line" lang="java">    <span class="kd">public</span> <span class="nc">SyncMode</span><span class="o">[]</span> <span class="nf">getSlaveSyncModes</span><span class="o">();</span></span>
...
<span id="LC456" class="line" lang="java"><span class="cm">     * Sets the mute state for a track.  This method may fail for a number</span></span>
<span id="LC457" class="line" lang="java"><span class="cm">     * of reasons.  For example, the track number specified may not be valid</span></span>
<span id="LC458" class="line" lang="java"><span class="cm">     * for the current sequence, or the sequencer may not support this functionality.</span></span>
<span id="LC459" class="line" lang="java"><span class="cm">     * An application which needs to verify whether this operation succeeded should</span></span>
<span id="LC460" class="line" lang="java"><span class="cm">     * follow this call with a call to &lt;code&gt;{@link #getTrackMute}&lt;/code&gt;.</span></span>
<span id="LC461" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC462" class="line" lang="java"><span class="cm">     * @param track the track number.  Tracks in the current sequence are numbered</span></span>
<span id="LC463" class="line" lang="java"><span class="cm">     * from 0 to the number of tracks in the sequence minus 1.</span></span>
<span id="LC464" class="line" lang="java"><span class="cm">     * @param mute the new mute state for the track.  &lt;code&gt;true&lt;/code&gt; implies the</span></span>
<span id="LC465" class="line" lang="java"><span class="cm">     * track should be muted, &lt;code&gt;false&lt;/code&gt; implies the track should be unmuted.</span></span>
<span id="LC466" class="line" lang="java"><span class="cm">     * @see #getSequence</span></span>
<span id="LC467" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC468" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTrackMute</span><span class="o">(</span><span class="kt">int</span> <span class="n">track</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">mute</span><span class="o">);</span></span>
...
<span id="LC472" class="line" lang="java"><span class="cm">     * Obtains the current mute state for a track.  The default mute</span></span>
<span id="LC473" class="line" lang="java"><span class="cm">     * state for all tracks which have not been muted is false.  In any</span></span>
<span id="LC474" class="line" lang="java"><span class="cm">     * case where the specified track has not been muted, this method should</span></span>
<span id="LC475" class="line" lang="java"><span class="cm">     * return false.  This applies if the sequencer does not support muting</span></span>
<span id="LC476" class="line" lang="java"><span class="cm">     * of tracks, and if the specified track index is not valid.</span></span>
<span id="LC477" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC478" class="line" lang="java"><span class="cm">     * @param track the track number.  Tracks in the current sequence are numbered</span></span>
<span id="LC479" class="line" lang="java"><span class="cm">     * from 0 to the number of tracks in the sequence minus 1.</span></span>
<span id="LC480" class="line" lang="java"><span class="cm">     * @return &lt;code&gt;true&lt;/code&gt; if muted, &lt;code&gt;false&lt;/code&gt; if not.</span></span>
<span id="LC481" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC482" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getTrackMute</span><span class="o">(</span><span class="kt">int</span> <span class="n">track</span><span class="o">);</span></span>
<span id="LC483" class="line" lang="java"></span>
<span id="LC484" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC485" class="line" lang="java"><span class="cm">     * Sets the solo state for a track.  If &lt;code&gt;solo&lt;/code&gt; is &lt;code&gt;true&lt;/code&gt;</span></span>
<span id="LC486" class="line" lang="java"><span class="cm">     * only this track and other solo'd tracks will sound. If &lt;code&gt;solo&lt;/code&gt;</span></span>
<span id="LC487" class="line" lang="java"><span class="cm">     * is &lt;code&gt;false&lt;/code&gt; then only other solo'd tracks will sound, unless no</span></span>
<span id="LC488" class="line" lang="java"><span class="cm">     * tracks are solo'd in which case all un-muted tracks will sound.</span></span>
<span id="LC489" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC490" class="line" lang="java"><span class="cm">     * This method may fail for a number</span></span>
<span id="LC491" class="line" lang="java"><span class="cm">     * of reasons.  For example, the track number specified may not be valid</span></span>
<span id="LC492" class="line" lang="java"><span class="cm">     * for the current sequence, or the sequencer may not support this functionality.</span></span>
<span id="LC493" class="line" lang="java"><span class="cm">     * An application which needs to verify whether this operation succeeded should</span></span>
<span id="LC494" class="line" lang="java"><span class="cm">     * follow this call with a call to &lt;code&gt;{@link #getTrackSolo}&lt;/code&gt;.</span></span>
<span id="LC495" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC496" class="line" lang="java"><span class="cm">     * @param track the track number.  Tracks in the current sequence are numbered</span></span>
<span id="LC497" class="line" lang="java"><span class="cm">     * from 0 to the number of tracks in the sequence minus 1.</span></span>
<span id="LC498" class="line" lang="java"><span class="cm">     * @param solo the new solo state for the track.  &lt;code&gt;true&lt;/code&gt; implies the</span></span>
<span id="LC499" class="line" lang="java"><span class="cm">     * track should be solo'd, &lt;code&gt;false&lt;/code&gt; implies the track should not be solo'd.</span></span>
<span id="LC500" class="line" lang="java"><span class="cm">     * @see #getSequence</span></span>
<span id="LC501" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC502" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTrackSolo</span><span class="o">(</span><span class="kt">int</span> <span class="n">track</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">solo</span><span class="o">);</span></span>
...
<span id="LC506" class="line" lang="java"><span class="cm">     * Obtains the current solo state for a track.  The default mute</span></span>
<span id="LC507" class="line" lang="java"><span class="cm">     * state for all tracks which have not been solo'd is false.  In any</span></span>
<span id="LC508" class="line" lang="java"><span class="cm">     * case where the specified track has not been solo'd, this method should</span></span>
<span id="LC509" class="line" lang="java"><span class="cm">     * return false.  This applies if the sequencer does not support soloing</span></span>
<span id="LC510" class="line" lang="java"><span class="cm">     * of tracks, and if the specified track index is not valid.</span></span>
<span id="LC511" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC512" class="line" lang="java"><span class="cm">     * @param track the track number.  Tracks in the current sequence are numbered</span></span>
<span id="LC513" class="line" lang="java"><span class="cm">     * from 0 to the number of tracks in the sequence minus 1.</span></span>
<span id="LC514" class="line" lang="java"><span class="cm">     * @return &lt;code&gt;true&lt;/code&gt; if solo'd, &lt;code&gt;false&lt;/code&gt; if not.</span></span>
<span id="LC515" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC516" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getTrackSolo</span><span class="o">(</span><span class="kt">int</span> <span class="n">track</span><span class="o">);</span></span>
...
<span id="LC520" class="line" lang="java"><span class="cm">     * Registers a meta-event listener to receive</span></span>
<span id="LC521" class="line" lang="java"><span class="cm">     * notification whenever a meta-event is encountered in the sequence</span></span>
<span id="LC522" class="line" lang="java"><span class="cm">     * and processed by the sequencer. This method can fail if, for</span></span>
<span id="LC523" class="line" lang="java"><span class="cm">     * instance,this class of sequencer does not support meta-event</span></span>
<span id="LC524" class="line" lang="java"><span class="cm">     * notification.</span></span>
<span id="LC525" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC526" class="line" lang="java"><span class="cm">     * @param listener listener to add</span></span>
<span id="LC527" class="line" lang="java"><span class="cm">     * @return &lt;code&gt;true&lt;/code&gt; if the listener was successfully added,</span></span>
<span id="LC528" class="line" lang="java"><span class="cm">     * otherwise &lt;code&gt;false&lt;/code&gt;</span></span>
<span id="LC529" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC530" class="line" lang="java"><span class="cm">     * @see #removeMetaEventListener</span></span>
<span id="LC531" class="line" lang="java"><span class="cm">     * @see MetaEventListener</span></span>
<span id="LC532" class="line" lang="java"><span class="cm">     * @see MetaMessage</span></span>
<span id="LC533" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC534" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">addMetaEventListener</span><span class="o">(</span><span class="nc">MetaEventListener</span> <span class="n">listener</span><span class="o">);</span></span>
...
<span id="LC538" class="line" lang="java"><span class="cm">     * Removes the specified meta-event listener from this sequencer's</span></span>
<span id="LC539" class="line" lang="java"><span class="cm">     * list of registered listeners, if in fact the listener is registered.</span></span>
<span id="LC540" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC541" class="line" lang="java"><span class="cm">     * @param listener the meta-event listener to remove</span></span>
<span id="LC542" class="line" lang="java"><span class="cm">     * @see #addMetaEventListener</span></span>
<span id="LC543" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC544" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">removeMetaEventListener</span><span class="o">(</span><span class="nc">MetaEventListener</span> <span class="n">listener</span><span class="o">);</span></span>
...
<span id="LC548" class="line" lang="java"><span class="cm">     * Registers a controller event listener to receive notification</span></span>
<span id="LC549" class="line" lang="java"><span class="cm">     * whenever the sequencer processes a control-change event of the</span></span>
<span id="LC550" class="line" lang="java"><span class="cm">     * requested type or types.  The types are specified by the</span></span>
<span id="LC551" class="line" lang="java"><span class="cm">     * &lt;code&gt;controllers&lt;/code&gt; argument, which should contain an array of</span></span>
<span id="LC552" class="line" lang="java"><span class="cm">     * MIDI controller numbers.  (Each number should be between 0 and 127,</span></span>
<span id="LC553" class="line" lang="java"><span class="cm">     * inclusive.  See the MIDI 1.0 Specification for the numbers that</span></span>
<span id="LC554" class="line" lang="java"><span class="cm">     * correspond to various types of controllers.)</span></span>
<span id="LC555" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC556" class="line" lang="java"><span class="cm">     * The returned array contains the MIDI controller</span></span>
<span id="LC557" class="line" lang="java"><span class="cm">     * numbers for which the listener will now receive events.</span></span>
<span id="LC558" class="line" lang="java"><span class="cm">     * Some sequencers might not support controller event notification, in</span></span>
<span id="LC559" class="line" lang="java"><span class="cm">     * which case the array has a length of 0.  Other sequencers might</span></span>
<span id="LC560" class="line" lang="java"><span class="cm">     * support notification for some controllers but not all.</span></span>
<span id="LC561" class="line" lang="java"><span class="cm">     * This method may be invoked repeatedly.</span></span>
<span id="LC562" class="line" lang="java"><span class="cm">     * Each time, the returned array indicates all the controllers</span></span>
<span id="LC563" class="line" lang="java"><span class="cm">     * that the listener will be notified about, not only the controllers</span></span>
<span id="LC564" class="line" lang="java"><span class="cm">     * requested in that particular invocation.</span></span>
<span id="LC565" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC566" class="line" lang="java"><span class="cm">     * @param listener the controller event listener to add to the list of</span></span>
<span id="LC567" class="line" lang="java"><span class="cm">     * registered listeners</span></span>
<span id="LC568" class="line" lang="java"><span class="cm">     * @param controllers the MIDI controller numbers for which change</span></span>
<span id="LC569" class="line" lang="java"><span class="cm">     * notification is requested</span></span>
<span id="LC570" class="line" lang="java"><span class="cm">     * @return the numbers of all the MIDI controllers whose changes will</span></span>
<span id="LC571" class="line" lang="java"><span class="cm">     * now be reported to the specified listener</span></span>
<span id="LC572" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC573" class="line" lang="java"><span class="cm">     * @see #removeControllerEventListener</span></span>
<span id="LC574" class="line" lang="java"><span class="cm">     * @see ControllerEventListener</span></span>
<span id="LC575" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC576" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span><span class="o">[]</span> <span class="nf">addControllerEventListener</span><span class="o">(</span><span class="nc">ControllerEventListener</span> <span class="n">listener</span><span class="o">,</span> <span class="kt">int</span><span class="o">[]</span> <span class="n">controllers</span><span class="o">);</span></span>
...
<span id="LC580" class="line" lang="java"><span class="cm">     * Removes a controller event listener's interest in one or more</span></span>
<span id="LC581" class="line" lang="java"><span class="cm">     * types of controller event. The &lt;code&gt;controllers&lt;/code&gt; argument</span></span>
<span id="LC582" class="line" lang="java"><span class="cm">     * is an array of MIDI numbers corresponding to the  controllers for</span></span>
<span id="LC583" class="line" lang="java"><span class="cm">     * which the listener should no longer receive change notifications.</span></span>
<span id="LC584" class="line" lang="java"><span class="cm">     * To completely remove this listener from the list of registered</span></span>
<span id="LC585" class="line" lang="java"><span class="cm">     * listeners, pass in &lt;code&gt;null&lt;/code&gt; for &lt;code&gt;controllers&lt;/code&gt;.</span></span>
<span id="LC586" class="line" lang="java"><span class="cm">     * The returned array contains the MIDI controller</span></span>
<span id="LC587" class="line" lang="java"><span class="cm">     * numbers for which the listener will now receive events.  The</span></span>
<span id="LC588" class="line" lang="java"><span class="cm">     * array has a length of 0 if the listener will not receive</span></span>
<span id="LC589" class="line" lang="java"><span class="cm">     * change notifications for any controllers.</span></span>
<span id="LC590" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC591" class="line" lang="java"><span class="cm">     * @param listener old listener</span></span>
<span id="LC592" class="line" lang="java"><span class="cm">     * @param controllers the MIDI controller numbers for which change</span></span>
<span id="LC593" class="line" lang="java"><span class="cm">     * notification should be cancelled, or &lt;code&gt;null&lt;/code&gt; to cancel</span></span>
<span id="LC594" class="line" lang="java"><span class="cm">     * for all controllers</span></span>
<span id="LC595" class="line" lang="java"><span class="cm">     * @return the numbers of all the MIDI controllers whose changes will</span></span>
<span id="LC596" class="line" lang="java"><span class="cm">     * now be reported to the specified listener</span></span>
<span id="LC597" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC598" class="line" lang="java"><span class="cm">     * @see #addControllerEventListener</span></span>
<span id="LC599" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC600" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span><span class="o">[]</span> <span class="nf">removeControllerEventListener</span><span class="o">(</span><span class="nc">ControllerEventListener</span> <span class="n">listener</span><span class="o">,</span> <span class="kt">int</span><span class="o">[]</span> <span class="n">controllers</span><span class="o">);</span></span>
...
<span id="LC604" class="line" lang="java"><span class="cm">     * Sets the first MIDI tick that will be</span></span>
<span id="LC605" class="line" lang="java"><span class="cm">     * played in the loop. If the loop count is</span></span>
<span id="LC606" class="line" lang="java"><span class="cm">     * greater than 0, playback will jump to this</span></span>
<span id="LC607" class="line" lang="java"><span class="cm">     * point when reaching the loop end point.</span></span>
<span id="LC608" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC609" class="line" lang="java"><span class="cm">     * &lt;p&gt;A value of 0 for the starting point means the</span></span>
<span id="LC610" class="line" lang="java"><span class="cm">     * beginning of the loaded sequence. The starting</span></span>
<span id="LC611" class="line" lang="java"><span class="cm">     * point must be lower than or equal to the ending</span></span>
<span id="LC612" class="line" lang="java"><span class="cm">     * point, and it must fall within the size of the</span></span>
<span id="LC613" class="line" lang="java"><span class="cm">     * loaded sequence.</span></span>
<span id="LC614" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC615" class="line" lang="java"><span class="cm">     * &lt;p&gt;A sequencer's loop start point defaults to</span></span>
<span id="LC616" class="line" lang="java"><span class="cm">     * start of the sequence.</span></span>
<span id="LC617" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC618" class="line" lang="java"><span class="cm">     * @param tick the loop's starting position,</span></span>
<span id="LC619" class="line" lang="java"><span class="cm">     *        in MIDI ticks (zero-based)</span></span>
<span id="LC620" class="line" lang="java"><span class="cm">     * @throws IllegalArgumentException if the requested</span></span>
<span id="LC621" class="line" lang="java"><span class="cm">     *         loop start point cannot be set, usually because</span></span>
<span id="LC622" class="line" lang="java"><span class="cm">     *         it falls outside the sequence's</span></span>
<span id="LC623" class="line" lang="java"><span class="cm">     *         duration or because the start point is</span></span>
<span id="LC624" class="line" lang="java"><span class="cm">     *         after the end point</span></span>
<span id="LC625" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC626" class="line" lang="java"><span class="cm">     * @see #setLoopEndPoint</span></span>
<span id="LC627" class="line" lang="java"><span class="cm">     * @see #setLoopCount</span></span>
<span id="LC628" class="line" lang="java"><span class="cm">     * @see #getLoopStartPoint</span></span>
<span id="LC629" class="line" lang="java"><span class="cm">     * @see #start</span></span>
<span id="LC630" class="line" lang="java"><span class="cm">     * @since 1.5</span></span>
<span id="LC631" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC632" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setLoopStartPoint</span><span class="o">(</span><span class="kt">long</span> <span class="n">tick</span><span class="o">);</span></span>
...
<span id="LC636" class="line" lang="java"><span class="cm">     * Obtains the start position of the loop,</span></span>
<span id="LC637" class="line" lang="java"><span class="cm">     * in MIDI ticks.</span></span>
<span id="LC638" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC639" class="line" lang="java"><span class="cm">     * @return the start position of the loop,</span></span>
<span id="LC640" class="line" lang="java"><span class="cm">               in MIDI ticks (zero-based)</span></span>
<span id="LC641" class="line" lang="java"><span class="cm">     * @see #setLoopStartPoint</span></span>
<span id="LC642" class="line" lang="java"><span class="cm">     * @since 1.5</span></span>
<span id="LC643" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC644" class="line" lang="java">    <span class="kd">public</span> <span class="kt">long</span> <span class="nf">getLoopStartPoint</span><span class="o">();</span></span>
...
<span id="LC648" class="line" lang="java"><span class="cm">     * Sets the last MIDI tick that will be played in</span></span>
<span id="LC649" class="line" lang="java"><span class="cm">     * the loop. If the loop count is 0, the loop end</span></span>
<span id="LC650" class="line" lang="java"><span class="cm">     * point has no effect and playback continues to</span></span>
<span id="LC651" class="line" lang="java"><span class="cm">     * play when reaching the loop end point.</span></span>
<span id="LC652" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC653" class="line" lang="java"><span class="cm">     * &lt;p&gt;A value of -1 for the ending point</span></span>
<span id="LC654" class="line" lang="java"><span class="cm">     * indicates the last tick of the sequence.</span></span>
<span id="LC655" class="line" lang="java"><span class="cm">     * Otherwise, the ending point must be greater</span></span>
<span id="LC656" class="line" lang="java"><span class="cm">     * than or equal to the starting point, and it must</span></span>
<span id="LC657" class="line" lang="java"><span class="cm">     * fall within the size of the loaded sequence.</span></span>
<span id="LC658" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC659" class="line" lang="java"><span class="cm">     * &lt;p&gt;A sequencer's loop end point defaults to -1,</span></span>
<span id="LC660" class="line" lang="java"><span class="cm">     * meaning the end of the sequence.</span></span>
<span id="LC661" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC662" class="line" lang="java"><span class="cm">     * @param tick the loop's ending position,</span></span>
<span id="LC663" class="line" lang="java"><span class="cm">     *        in MIDI ticks (zero-based), or</span></span>
<span id="LC664" class="line" lang="java"><span class="cm">     *        -1 to indicate the final tick</span></span>
<span id="LC665" class="line" lang="java"><span class="cm">     * @throws IllegalArgumentException if the requested</span></span>
<span id="LC666" class="line" lang="java"><span class="cm">     *         loop point cannot be set, usually because</span></span>
<span id="LC667" class="line" lang="java"><span class="cm">     *         it falls outside the sequence's</span></span>
<span id="LC668" class="line" lang="java"><span class="cm">     *         duration or because the ending point is</span></span>
<span id="LC669" class="line" lang="java"><span class="cm">     *         before the starting point</span></span>
<span id="LC670" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC671" class="line" lang="java"><span class="cm">     * @see #setLoopStartPoint</span></span>
<span id="LC672" class="line" lang="java"><span class="cm">     * @see #setLoopCount</span></span>
<span id="LC673" class="line" lang="java"><span class="cm">     * @see #getLoopEndPoint</span></span>
<span id="LC674" class="line" lang="java"><span class="cm">     * @see #start</span></span>
<span id="LC675" class="line" lang="java"><span class="cm">     * @since 1.5</span></span>
<span id="LC676" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC677" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setLoopEndPoint</span><span class="o">(</span><span class="kt">long</span> <span class="n">tick</span><span class="o">);</span></span>
...
<span id="LC681" class="line" lang="java"><span class="cm">     * Obtains the end position of the loop,</span></span>
<span id="LC682" class="line" lang="java"><span class="cm">     * in MIDI ticks.</span></span>
<span id="LC683" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC684" class="line" lang="java"><span class="cm">     * @return the end position of the loop, in MIDI</span></span>
<span id="LC685" class="line" lang="java"><span class="cm">     *         ticks (zero-based), or -1 to indicate</span></span>
<span id="LC686" class="line" lang="java"><span class="cm">     *         the end of the sequence</span></span>
<span id="LC687" class="line" lang="java"><span class="cm">     * @see #setLoopEndPoint</span></span>
<span id="LC688" class="line" lang="java"><span class="cm">     * @since 1.5</span></span>
<span id="LC689" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC690" class="line" lang="java">    <span class="kd">public</span> <span class="kt">long</span> <span class="nf">getLoopEndPoint</span><span class="o">();</span></span>
...
<span id="LC694" class="line" lang="java"><span class="cm">     * Sets the number of repetitions of the loop for</span></span>
<span id="LC695" class="line" lang="java"><span class="cm">     * playback.</span></span>
<span id="LC696" class="line" lang="java"><span class="cm">     * When the playback position reaches the loop end point,</span></span>
<span id="LC697" class="line" lang="java"><span class="cm">     * it will loop back to the loop start point</span></span>
<span id="LC698" class="line" lang="java"><span class="cm">     * &lt;code&gt;count&lt;/code&gt; times, after which playback will</span></span>
<span id="LC699" class="line" lang="java"><span class="cm">     * continue to play to the end of the sequence.</span></span>
<span id="LC700" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC701" class="line" lang="java"><span class="cm">     * If the current position when this method is invoked</span></span>
<span id="LC702" class="line" lang="java"><span class="cm">     * is greater than the loop end point, playback</span></span>
<span id="LC703" class="line" lang="java"><span class="cm">     * continues to the end of the sequence without looping,</span></span>
<span id="LC704" class="line" lang="java"><span class="cm">     * unless the loop end point is changed subsequently.</span></span>
<span id="LC705" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC706" class="line" lang="java"><span class="cm">     * A &lt;code&gt;count&lt;/code&gt; value of 0 disables looping:</span></span>
<span id="LC707" class="line" lang="java"><span class="cm">     * playback will continue at the loop end point, and it</span></span>
<span id="LC708" class="line" lang="java"><span class="cm">     * will not loop back to the loop start point.</span></span>
<span id="LC709" class="line" lang="java"><span class="cm">     * This is a sequencer's default.</span></span>
<span id="LC710" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC711" class="line" lang="java"><span class="cm">     * &lt;p&gt;If playback is stopped during looping, the</span></span>
<span id="LC712" class="line" lang="java"><span class="cm">     * current loop status is cleared; subsequent start</span></span>
<span id="LC713" class="line" lang="java"><span class="cm">     * requests are not affected by an interrupted loop</span></span>
<span id="LC714" class="line" lang="java"><span class="cm">     * operation.</span></span>
<span id="LC715" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC716" class="line" lang="java"><span class="cm">     * @param count the number of times playback should</span></span>
<span id="LC717" class="line" lang="java"><span class="cm">     *        loop back from the loop's end position</span></span>
<span id="LC718" class="line" lang="java"><span class="cm">     *        to the loop's start position, or</span></span>
<span id="LC719" class="line" lang="java"><span class="cm">     *        &lt;code&gt;{@link #LOOP_CONTINUOUSLY}&lt;/code&gt;</span></span>
<span id="LC720" class="line" lang="java"><span class="cm">     *        to indicate that looping should</span></span>
<span id="LC721" class="line" lang="java"><span class="cm">     *        continue until interrupted</span></span>
<span id="LC722" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC723" class="line" lang="java"><span class="cm">     * @throws IllegalArgumentException if &lt;code&gt;count&lt;/code&gt; is</span></span>
<span id="LC724" class="line" lang="java"><span class="cm">     * negative and not equal to {@link #LOOP_CONTINUOUSLY}</span></span>
<span id="LC725" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC726" class="line" lang="java"><span class="cm">     * @see #setLoopStartPoint</span></span>
<span id="LC727" class="line" lang="java"><span class="cm">     * @see #setLoopEndPoint</span></span>
<span id="LC728" class="line" lang="java"><span class="cm">     * @see #getLoopCount</span></span>
<span id="LC729" class="line" lang="java"><span class="cm">     * @see #start</span></span>
<span id="LC730" class="line" lang="java"><span class="cm">     * @since 1.5</span></span>
<span id="LC731" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC732" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setLoopCount</span><span class="o">(</span><span class="kt">int</span> <span class="n">count</span><span class="o">);</span></span>
...
<span id="LC736" class="line" lang="java"><span class="cm">     * Obtains the number of repetitions for</span></span>
<span id="LC737" class="line" lang="java"><span class="cm">     * playback.</span></span>
<span id="LC738" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC739" class="line" lang="java"><span class="cm">     * @return the number of loops after which</span></span>
<span id="LC740" class="line" lang="java"><span class="cm">     *         playback plays to the end of the</span></span>
<span id="LC741" class="line" lang="java"><span class="cm">     *         sequence</span></span>
<span id="LC742" class="line" lang="java"><span class="cm">     * @see #setLoopCount</span></span>
<span id="LC743" class="line" lang="java"><span class="cm">     * @see #start</span></span>
<span id="LC744" class="line" lang="java"><span class="cm">     * @since 1.5</span></span>
<span id="LC745" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC746" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getLoopCount</span><span class="o">();</span></span>
<span id="LC747" class="line" lang="java"></span>
<span id="LC748" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC749" class="line" lang="java"><span class="cm">     * A &lt;code&gt;SyncMode&lt;/code&gt; object represents one of the ways in which</span></span>
<span id="LC750" class="line" lang="java"><span class="cm">     * a MIDI sequencer's notion of time can be synchronized with a master</span></span>
<span id="LC751" class="line" lang="java"><span class="cm">     * or slave device.</span></span>
<span id="LC752" class="line" lang="java"><span class="cm">     * If the sequencer is being synchronized to a master, the</span></span>
<span id="LC753" class="line" lang="java"><span class="cm">     * sequencer revises its current time in response to messages from</span></span>
<span id="LC754" class="line" lang="java"><span class="cm">     * the master.  If the sequencer has a slave, the sequencer</span></span>
<span id="LC755" class="line" lang="java"><span class="cm">     * similarly sends messages to control the slave's timing.</span></span>
<span id="LC756" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC757" class="line" lang="java"><span class="cm">     * There are three predefined modes that specify possible masters</span></span>
<span id="LC758" class="line" lang="java"><span class="cm">     * for a sequencer: &lt;code&gt;INTERNAL_CLOCK&lt;/code&gt;,</span></span>
<span id="LC759" class="line" lang="java"><span class="cm">     * &lt;code&gt;MIDI_SYNC&lt;/code&gt;, and &lt;code&gt;MIDI_TIME_CODE&lt;/code&gt;.  The</span></span>
<span id="LC760" class="line" lang="java"><span class="cm">     * latter two work if the sequencer receives MIDI messages from</span></span>
<span id="LC761" class="line" lang="java"><span class="cm">     * another device.  In these two modes, the sequencer's time gets reset</span></span>
<span id="LC762" class="line" lang="java"><span class="cm">     * based on system real-time timing clock messages or MIDI time code</span></span>
<span id="LC763" class="line" lang="java"><span class="cm">     * (MTC) messages, respectively.  These two modes can also be used</span></span>
<span id="LC764" class="line" lang="java"><span class="cm">     * as slave modes, in which case the sequencer sends the corresponding</span></span>
<span id="LC765" class="line" lang="java"><span class="cm">     * types of MIDI messages to its receiver (whether or not the sequencer</span></span>
<span id="LC766" class="line" lang="java"><span class="cm">     * is also receiving them from a master).  A fourth mode,</span></span>
<span id="LC767" class="line" lang="java"><span class="cm">     * &lt;code&gt;NO_SYNC&lt;/code&gt;, is used to indicate that the sequencer should</span></span>
<span id="LC768" class="line" lang="java"><span class="cm">     * not control its receiver's timing.</span></span>
<span id="LC769" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC770" class="line" lang="java"><span class="cm">     * @see Sequencer#setMasterSyncMode(Sequencer.SyncMode)</span></span>
<span id="LC771" class="line" lang="java"><span class="cm">     * @see Sequencer#setSlaveSyncMode(Sequencer.SyncMode)</span></span>
<span id="LC772" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC773" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">class</span> <span class="nc">SyncMode</span> <span class="o">{</span></span>
<span id="LC774" class="line" lang="java"></span>
<span id="LC775" class="line" lang="java">        <span class="cm">/**</span></span>
<span id="LC776" class="line" lang="java"><span class="cm">         * Synchronization mode name.</span></span>
<span id="LC777" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC778" class="line" lang="java">        <span class="kd">private</span> <span class="nc">String</span> <span class="n">name</span><span class="o">;</span></span>
<span id="LC779" class="line" lang="java"></span>
<span id="LC780" class="line" lang="java">        <span class="cm">/**</span></span>
<span id="LC781" class="line" lang="java"><span class="cm">         * Constructs a synchronization mode.</span></span>
<span id="LC782" class="line" lang="java"><span class="cm">         * @param name name of the synchronization mode</span></span>
<span id="LC783" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC784" class="line" lang="java">        <span class="kd">protected</span> <span class="nf">SyncMode</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC785" class="line" lang="java"></span>
<span id="LC786" class="line" lang="java">            <span class="k">this</span><span class="o">.</span><span class="na">name</span> <span class="o">=</span> <span class="n">name</span><span class="o">;</span></span>
...
<span id="LC791" class="line" lang="java"><span class="cm">         * Determines whether two objects are equal.</span></span>
<span id="LC792" class="line" lang="java"><span class="cm">         * Returns &lt;code&gt;true&lt;/code&gt; if the objects are identical</span></span>
<span id="LC793" class="line" lang="java"><span class="cm">         * @param obj the reference object with which to compare</span></span>
<span id="LC794" class="line" lang="java"><span class="cm">         * @return &lt;code&gt;true&lt;/code&gt; if this object is the same as the</span></span>
<span id="LC795" class="line" lang="java"><span class="cm">         * &lt;code&gt;obj&lt;/code&gt; argument, &lt;code&gt;false&lt;/code&gt; otherwise</span></span>
<span id="LC796" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC797" class="line" lang="java">        <span class="kd">public</span> <span class="kd">final</span> <span class="kt">boolean</span> <span class="nf">equals</span><span class="o">(</span><span class="nc">Object</span> <span class="n">obj</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC798" class="line" lang="java"></span>
<span id="LC799" class="line" lang="java">            <span class="k">return</span> <span class="kd">super</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">obj</span><span class="o">);</span></span>
...
<span id="LC804" class="line" lang="java"><span class="cm">         * Finalizes the hashcode method.</span></span>
<span id="LC805" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC806" class="line" lang="java">        <span class="kd">public</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nf">hashCode</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC807" class="line" lang="java"></span>
<span id="LC808" class="line" lang="java">            <span class="k">return</span> <span class="kd">super</span><span class="o">.</span><span class="na">hashCode</span><span class="o">();</span></span>
...
<span id="LC813" class="line" lang="java"><span class="cm">         * Provides this synchronization mode's name as the string</span></span>
<span id="LC814" class="line" lang="java"><span class="cm">         * representation of the mode.</span></span>
<span id="LC815" class="line" lang="java"><span class="cm">         * @return the name of this synchronization mode</span></span>
<span id="LC816" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC817" class="line" lang="java">        <span class="kd">public</span> <span class="kd">final</span> <span class="nc">String</span> <span class="nf">toString</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC818" class="line" lang="java"></span>
<span id="LC819" class="line" lang="java">            <span class="k">return</span> <span class="n">name</span><span class="o">;</span></span>
...
<span id="LC824" class="line" lang="java"><span class="cm">         * A master synchronization mode that makes the sequencer get</span></span>
<span id="LC825" class="line" lang="java"><span class="cm">         * its timing information from its internal clock.  This is not</span></span>
<span id="LC826" class="line" lang="java"><span class="cm">         * a legal slave sync mode.</span></span>
<span id="LC827" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC828" class="line" lang="java">        <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">SyncMode</span> <span class="no">INTERNAL_CLOCK</span>             <span class="o">=</span> <span class="k">new</span> <span class="nc">SyncMode</span><span class="o">(</span><span class="s">"Internal Clock"</span><span class="o">);</span></span>
...
<span id="LC832" class="line" lang="java"><span class="cm">         * A master or slave synchronization mode that specifies the</span></span>
<span id="LC833" class="line" lang="java"><span class="cm">         * use of MIDI clock</span></span>
<span id="LC834" class="line" lang="java"><span class="cm">         * messages.  If this mode is used as the master sync mode,</span></span>
<span id="LC835" class="line" lang="java"><span class="cm">         * the sequencer gets its timing information from system real-time</span></span>
<span id="LC836" class="line" lang="java"><span class="cm">         * MIDI clock messages.  This mode only applies as the master sync</span></span>
<span id="LC837" class="line" lang="java"><span class="cm">         * mode for sequencers that are also MIDI receivers.  If this is the</span></span>
<span id="LC838" class="line" lang="java"><span class="cm">         * slave sync mode, the sequencer sends system real-time MIDI clock</span></span>
<span id="LC839" class="line" lang="java"><span class="cm">         * messages to its receiver.  MIDI clock messages are sent at a rate</span></span>
<span id="LC840" class="line" lang="java"><span class="cm">         * of 24 per quarter note.</span></span>
<span id="LC841" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC842" class="line" lang="java">        <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">SyncMode</span> <span class="no">MIDI_SYNC</span>                  <span class="o">=</span> <span class="k">new</span> <span class="nc">SyncMode</span><span class="o">(</span><span class="s">"MIDI Sync"</span><span class="o">);</span></span>
...
<span id="LC846" class="line" lang="java"><span class="cm">         * A master or slave synchronization mode that specifies the</span></span>
<span id="LC847" class="line" lang="java"><span class="cm">         * use of MIDI Time Code.</span></span>
<span id="LC848" class="line" lang="java"><span class="cm">         * If this mode is used as the master sync mode,</span></span>
<span id="LC849" class="line" lang="java"><span class="cm">         * the sequencer gets its timing information from MIDI Time Code</span></span>
<span id="LC850" class="line" lang="java"><span class="cm">         * messages.  This mode only applies as the master sync</span></span>
<span id="LC851" class="line" lang="java"><span class="cm">         * mode to sequencers that are also MIDI receivers.  If this</span></span>
<span id="LC852" class="line" lang="java"><span class="cm">         * mode is used as the</span></span>
<span id="LC853" class="line" lang="java"><span class="cm">         * slave sync mode, the sequencer sends MIDI Time Code</span></span>
<span id="LC854" class="line" lang="java"><span class="cm">         * messages to its receiver.  (See the MIDI 1.0 Detailed</span></span>
<span id="LC855" class="line" lang="java"><span class="cm">         * Specification for a description of MIDI Time Code.)</span></span>
<span id="LC856" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC857" class="line" lang="java">        <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">SyncMode</span> <span class="no">MIDI_TIME_CODE</span>             <span class="o">=</span> <span class="k">new</span> <span class="nc">SyncMode</span><span class="o">(</span><span class="s">"MIDI Time Code"</span><span class="o">);</span></span>
...
<span id="LC861" class="line" lang="java"><span class="cm">         * A slave synchronization mode indicating that no timing information</span></span>
<span id="LC862" class="line" lang="java"><span class="cm">         * should be sent to the receiver.  This is not a legal master sync</span></span>
<span id="LC863" class="line" lang="java"><span class="cm">         * mode.</span></span>
<span id="LC864" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC865" class="line" lang="java">        <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">SyncMode</span> <span class="no">NO_SYNC</span>                            <span class="o">=</span> <span class="k">new</span> <span class="nc">SyncMode</span><span class="o">(</span><span class="s">"No Timing"</span><span class="o">);</span></span>
<span id="LC866" class="line" lang="java"></span>
<span id="LC867" class="line" lang="java">    <span class="o">}</span> <span class="c1">// class SyncMode</span></span>
