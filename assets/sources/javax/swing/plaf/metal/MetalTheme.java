...
<span id="LC32" class="line" lang="java"><span class="cm"> * {@code MetalTheme} provides the color palette and fonts used by</span></span>
<span id="LC33" class="line" lang="java"><span class="cm"> * the Java Look and Feel.</span></span>
<span id="LC34" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC35" class="line" lang="java"><span class="cm"> * {@code MetalTheme} is abstract, see {@code DefaultMetalTheme} and</span></span>
<span id="LC36" class="line" lang="java"><span class="cm"> * {@code OceanTheme} for concrete implementations.</span></span>
<span id="LC37" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC38" class="line" lang="java"><span class="cm"> * {@code MetalLookAndFeel} maintains the current theme that the</span></span>
<span id="LC39" class="line" lang="java"><span class="cm"> * the {@code ComponentUI} implementations for metal use. Refer to</span></span>
<span id="LC40" class="line" lang="java"><span class="cm"> * {@link MetalLookAndFeel#setCurrentTheme</span></span>
<span id="LC41" class="line" lang="java"><span class="cm"> * MetalLookAndFeel.setCurrentTheme(MetalTheme)} for details on changing</span></span>
<span id="LC42" class="line" lang="java"><span class="cm"> * the current theme.</span></span>
<span id="LC43" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC44" class="line" lang="java"><span class="cm"> * {@code MetalTheme} provides a number of public methods for getting</span></span>
<span id="LC45" class="line" lang="java"><span class="cm"> * colors. These methods are implemented in terms of a</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> * handful of protected abstract methods. A subclass need only override</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * the protected abstract methods ({@code getPrimary1},</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * {@code getPrimary2}, {@code getPrimary3}, {@code getSecondary1},</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * {@code getSecondary2}, and {@code getSecondary3}); although a subclass</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> * may override the other public methods for more control over the set of</span></span>
<span id="LC51" class="line" lang="java"><span class="cm"> * colors that are used.</span></span>
<span id="LC52" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC53" class="line" lang="java"><span class="cm"> * Concrete implementations of {@code MetalTheme} must return {@code non-null}</span></span>
<span id="LC54" class="line" lang="java"><span class="cm"> * values from all methods. While the behavior of returning {@code null} is</span></span>
<span id="LC55" class="line" lang="java"><span class="cm"> * not specified, returning {@code null} will result in incorrect behavior.</span></span>
<span id="LC56" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC57" class="line" lang="java"><span class="cm"> * It is strongly recommended that subclasses return completely opaque colors.</span></span>
<span id="LC58" class="line" lang="java"><span class="cm"> * To do otherwise may result in rendering problems, such as visual garbage.</span></span>
<span id="LC59" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC60" class="line" lang="java"><span class="cm"> * @see DefaultMetalTheme</span></span>
<span id="LC61" class="line" lang="java"><span class="cm"> * @see OceanTheme</span></span>
<span id="LC62" class="line" lang="java"><span class="cm"> * @see MetalLookAndFeel#setCurrentTheme</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> * @author Steve Wilson</span></span>
<span id="LC65" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC66" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">MetalTheme</span> <span class="o">{</span></span>
<span id="LC67" class="line" lang="java"></span>
<span id="LC68" class="line" lang="java">    <span class="c1">// Contants identifying the various Fonts that are Theme can support</span></span>
<span id="LC69" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">CONTROL_TEXT_FONT</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC70" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">SYSTEM_TEXT_FONT</span> <span class="o">=</span> <span class="mi">1</span><span class="o">;</span></span>
<span id="LC71" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">USER_TEXT_FONT</span> <span class="o">=</span> <span class="mi">2</span><span class="o">;</span></span>
<span id="LC72" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">MENU_TEXT_FONT</span> <span class="o">=</span> <span class="mi">3</span><span class="o">;</span></span>
<span id="LC73" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">WINDOW_TITLE_FONT</span> <span class="o">=</span> <span class="mi">4</span><span class="o">;</span></span>
<span id="LC74" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">SUB_TEXT_FONT</span> <span class="o">=</span> <span class="mi">5</span><span class="o">;</span></span>
<span id="LC75" class="line" lang="java"></span>
<span id="LC76" class="line" lang="java">    <span class="kd">static</span> <span class="nc">ColorUIResource</span> <span class="n">white</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">ColorUIResource</span><span class="o">(</span> <span class="mi">255</span><span class="o">,</span> <span class="mi">255</span><span class="o">,</span> <span class="mi">255</span> <span class="o">);</span></span>
<span id="LC77" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="nc">ColorUIResource</span> <span class="n">black</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">ColorUIResource</span><span class="o">(</span> <span class="mi">0</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="mi">0</span> <span class="o">);</span></span>
<span id="LC78" class="line" lang="java"></span>
<span id="LC79" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC80" class="line" lang="java"><span class="cm">     * Returns the name of this theme.</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC82" class="line" lang="java"><span class="cm">     * @return the name of this theme</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC84" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">String</span> <span class="nf">getName</span><span class="o">();</span></span>
<span id="LC85" class="line" lang="java"></span>
<span id="LC86" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC87" class="line" lang="java"><span class="cm">     * Returns the primary 1 color.</span></span>
<span id="LC88" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">     * @return the primary 1 color</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC91" class="line" lang="java">    <span class="kd">protected</span> <span class="kd">abstract</span> <span class="nc">ColorUIResource</span> <span class="nf">getPrimary1</span><span class="o">();</span>  <span class="c1">// these are blue in Metal Default Theme</span></span>
<span id="LC92" class="line" lang="java"></span>
<span id="LC93" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">     * Returns the primary 2 color.</span></span>
<span id="LC95" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC96" class="line" lang="java"><span class="cm">     * @return the primary 2 color</span></span>
<span id="LC97" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC98" class="line" lang="java">    <span class="kd">protected</span> <span class="kd">abstract</span> <span class="nc">ColorUIResource</span> <span class="nf">getPrimary2</span><span class="o">();</span></span>
<span id="LC99" class="line" lang="java"></span>
<span id="LC100" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">     * Returns the primary 3 color.</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC103" class="line" lang="java"><span class="cm">     * @return the primary 3 color</span></span>
<span id="LC104" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC105" class="line" lang="java">    <span class="kd">protected</span> <span class="kd">abstract</span> <span class="nc">ColorUIResource</span> <span class="nf">getPrimary3</span><span class="o">();</span></span>
<span id="LC106" class="line" lang="java"></span>
<span id="LC107" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">     * Returns the secondary 1 color.</span></span>
<span id="LC109" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC110" class="line" lang="java"><span class="cm">     * @return the secondary 1 color</span></span>
<span id="LC111" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC112" class="line" lang="java">    <span class="kd">protected</span> <span class="kd">abstract</span> <span class="nc">ColorUIResource</span> <span class="nf">getSecondary1</span><span class="o">();</span>  <span class="c1">// these are gray in Metal Default Theme</span></span>
<span id="LC113" class="line" lang="java"></span>
<span id="LC114" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC115" class="line" lang="java"><span class="cm">     * Returns the secondary 2 color.</span></span>
<span id="LC116" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC117" class="line" lang="java"><span class="cm">     * @return the secondary 2 color</span></span>
<span id="LC118" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC119" class="line" lang="java">    <span class="kd">protected</span> <span class="kd">abstract</span> <span class="nc">ColorUIResource</span> <span class="nf">getSecondary2</span><span class="o">();</span></span>
<span id="LC120" class="line" lang="java"></span>
<span id="LC121" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC122" class="line" lang="java"><span class="cm">     * Returns the secondary 3 color.</span></span>
<span id="LC123" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC124" class="line" lang="java"><span class="cm">     * @return the secondary 3 color</span></span>
<span id="LC125" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC126" class="line" lang="java">    <span class="kd">protected</span> <span class="kd">abstract</span> <span class="nc">ColorUIResource</span> <span class="nf">getSecondary3</span><span class="o">();</span></span>
<span id="LC127" class="line" lang="java"></span>
<span id="LC128" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC129" class="line" lang="java"><span class="cm">     * Returns the control text font.</span></span>
<span id="LC130" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC131" class="line" lang="java"><span class="cm">     * @return the control text font</span></span>
<span id="LC132" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC133" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">FontUIResource</span> <span class="nf">getControlTextFont</span><span class="o">();</span></span>
<span id="LC134" class="line" lang="java"></span>
<span id="LC135" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC136" class="line" lang="java"><span class="cm">     * Returns the system text font.</span></span>
<span id="LC137" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC138" class="line" lang="java"><span class="cm">     * @return the system text font</span></span>
<span id="LC139" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC140" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">FontUIResource</span> <span class="nf">getSystemTextFont</span><span class="o">();</span></span>
<span id="LC141" class="line" lang="java"></span>
<span id="LC142" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC143" class="line" lang="java"><span class="cm">     * Returns the user text font.</span></span>
<span id="LC144" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">     * @return the user text font</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC147" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">FontUIResource</span> <span class="nf">getUserTextFont</span><span class="o">();</span></span>
<span id="LC148" class="line" lang="java"></span>
<span id="LC149" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC150" class="line" lang="java"><span class="cm">     * Returns the menu text font.</span></span>
<span id="LC151" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC152" class="line" lang="java"><span class="cm">     * @return the menu text font</span></span>
<span id="LC153" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC154" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">FontUIResource</span> <span class="nf">getMenuTextFont</span><span class="o">();</span></span>
<span id="LC155" class="line" lang="java"></span>
<span id="LC156" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC157" class="line" lang="java"><span class="cm">     * Returns the window title font.</span></span>
<span id="LC158" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC159" class="line" lang="java"><span class="cm">     * @return the window title font</span></span>
<span id="LC160" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC161" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">FontUIResource</span> <span class="nf">getWindowTitleFont</span><span class="o">();</span></span>
<span id="LC162" class="line" lang="java"></span>
<span id="LC163" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC164" class="line" lang="java"><span class="cm">     * Returns the sub-text font.</span></span>
<span id="LC165" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC166" class="line" lang="java"><span class="cm">     * @return the sub-text font</span></span>
<span id="LC167" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC168" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">FontUIResource</span> <span class="nf">getSubTextFont</span><span class="o">();</span></span>
<span id="LC169" class="line" lang="java"></span>
<span id="LC170" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC171" class="line" lang="java"><span class="cm">     * Returns the white color. This returns opaque white</span></span>
<span id="LC172" class="line" lang="java"><span class="cm">     * ({@code 0xFFFFFFFF}).</span></span>
<span id="LC173" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC174" class="line" lang="java"><span class="cm">     * @return the white color</span></span>
<span id="LC175" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC176" class="line" lang="java">    <span class="kd">protected</span> <span class="nc">ColorUIResource</span> <span class="nf">getWhite</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">white</span><span class="o">;</span> <span class="o">}</span></span>
<span id="LC177" class="line" lang="java"></span>
<span id="LC178" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC179" class="line" lang="java"><span class="cm">     * Returns the black color. This returns opaque black</span></span>
<span id="LC180" class="line" lang="java"><span class="cm">     * ({@code 0xFF000000}).</span></span>
<span id="LC181" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC182" class="line" lang="java"><span class="cm">     * @return the black color</span></span>
<span id="LC183" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC184" class="line" lang="java">    <span class="kd">protected</span> <span class="nc">ColorUIResource</span> <span class="nf">getBlack</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">black</span><span class="o">;</span> <span class="o">}</span></span>
<span id="LC185" class="line" lang="java"></span>
<span id="LC186" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC187" class="line" lang="java"><span class="cm">     * Returns the focus color. This returns the value of</span></span>
<span id="LC188" class="line" lang="java"><span class="cm">     * {@code getPrimary2()}.</span></span>
<span id="LC189" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC190" class="line" lang="java"><span class="cm">     * @return the focus color</span></span>
<span id="LC191" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC192" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getFocusColor</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getPrimary2</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC193" class="line" lang="java"></span>
<span id="LC194" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC195" class="line" lang="java"><span class="cm">     * Returns the desktop color. This returns the value of</span></span>
<span id="LC196" class="line" lang="java"><span class="cm">     * {@code getPrimary2()}.</span></span>
<span id="LC197" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">     * @return the desktop color</span></span>
<span id="LC199" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC200" class="line" lang="java">    <span class="kd">public</span>  <span class="nc">ColorUIResource</span> <span class="nf">getDesktopColor</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getPrimary2</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC201" class="line" lang="java"></span>
<span id="LC202" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC203" class="line" lang="java"><span class="cm">     * Returns the control color. This returns the value of</span></span>
<span id="LC204" class="line" lang="java"><span class="cm">     * {@code getSecondary3()}.</span></span>
<span id="LC205" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC206" class="line" lang="java"><span class="cm">     * @return the control color</span></span>
<span id="LC207" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC208" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getControl</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getSecondary3</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC209" class="line" lang="java"></span>
<span id="LC210" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC211" class="line" lang="java"><span class="cm">     * Returns the control shadow color. This returns</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">     * the value of {@code getSecondary2()}.</span></span>
<span id="LC213" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC214" class="line" lang="java"><span class="cm">     * @return the control shadow color</span></span>
<span id="LC215" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC216" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getControlShadow</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getSecondary2</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC217" class="line" lang="java"></span>
<span id="LC218" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC219" class="line" lang="java"><span class="cm">     * Returns the control dark shadow color. This returns</span></span>
<span id="LC220" class="line" lang="java"><span class="cm">     * the value of {@code getSecondary1()}.</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC222" class="line" lang="java"><span class="cm">     * @return the control dark shadow color</span></span>
<span id="LC223" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC224" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getControlDarkShadow</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getSecondary1</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC225" class="line" lang="java"></span>
<span id="LC226" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC227" class="line" lang="java"><span class="cm">     * Returns the control info color. This returns</span></span>
<span id="LC228" class="line" lang="java"><span class="cm">     * the value of {@code getBlack()}.</span></span>
<span id="LC229" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC230" class="line" lang="java"><span class="cm">     * @return the control info color</span></span>
<span id="LC231" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC232" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getControlInfo</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getBlack</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC233" class="line" lang="java"></span>
<span id="LC234" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC235" class="line" lang="java"><span class="cm">     * Returns the control highlight color. This returns</span></span>
<span id="LC236" class="line" lang="java"><span class="cm">     * the value of {@code getWhite()}.</span></span>
<span id="LC237" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC238" class="line" lang="java"><span class="cm">     * @return the control highlight color</span></span>
<span id="LC239" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC240" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getControlHighlight</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getWhite</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC241" class="line" lang="java"></span>
<span id="LC242" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC243" class="line" lang="java"><span class="cm">     * Returns the control disabled color. This returns</span></span>
<span id="LC244" class="line" lang="java"><span class="cm">     * the value of {@code getSecondary2()}.</span></span>
<span id="LC245" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC246" class="line" lang="java"><span class="cm">     * @return the control disabled color</span></span>
<span id="LC247" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC248" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getControlDisabled</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getSecondary2</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC249" class="line" lang="java"></span>
<span id="LC250" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC251" class="line" lang="java"><span class="cm">     * Returns the primary control color. This returns</span></span>
<span id="LC252" class="line" lang="java"><span class="cm">     * the value of {@code getPrimary3()}.</span></span>
<span id="LC253" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC254" class="line" lang="java"><span class="cm">     * @return the primary control color</span></span>
<span id="LC255" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC256" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getPrimaryControl</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getPrimary3</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC257" class="line" lang="java"></span>
<span id="LC258" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC259" class="line" lang="java"><span class="cm">     * Returns the primary control shadow color. This returns</span></span>
<span id="LC260" class="line" lang="java"><span class="cm">     * the value of {@code getPrimary2()}.</span></span>
<span id="LC261" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC262" class="line" lang="java"><span class="cm">     * @return the primary control shadow color</span></span>
<span id="LC263" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC264" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getPrimaryControlShadow</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getPrimary2</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC265" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC266" class="line" lang="java"><span class="cm">     * Returns the primary control dark shadow color. This</span></span>
<span id="LC267" class="line" lang="java"><span class="cm">     * returns the value of {@code getPrimary1()}.</span></span>
<span id="LC268" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC269" class="line" lang="java"><span class="cm">     * @return the primary control dark shadow color</span></span>
<span id="LC270" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC271" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getPrimaryControlDarkShadow</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getPrimary1</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC272" class="line" lang="java"></span>
<span id="LC273" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC274" class="line" lang="java"><span class="cm">     * Returns the primary control info color. This</span></span>
<span id="LC275" class="line" lang="java"><span class="cm">     * returns the value of {@code getBlack()}.</span></span>
<span id="LC276" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC277" class="line" lang="java"><span class="cm">     * @return the primary control info color</span></span>
<span id="LC278" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC279" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getPrimaryControlInfo</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getBlack</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC280" class="line" lang="java"></span>
<span id="LC281" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC282" class="line" lang="java"><span class="cm">     * Returns the primary control highlight color. This</span></span>
<span id="LC283" class="line" lang="java"><span class="cm">     * returns the value of {@code getWhite()}.</span></span>
<span id="LC284" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC285" class="line" lang="java"><span class="cm">     * @return the primary control highlight color</span></span>
<span id="LC286" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC287" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getPrimaryControlHighlight</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getWhite</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC288" class="line" lang="java"></span>
<span id="LC289" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">     * Returns the system text color. This returns the value of</span></span>
<span id="LC291" class="line" lang="java"><span class="cm">     * {@code getBlack()}.</span></span>
<span id="LC292" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC293" class="line" lang="java"><span class="cm">     * @return the system text color</span></span>
<span id="LC294" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC295" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getSystemTextColor</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getBlack</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC296" class="line" lang="java"></span>
<span id="LC297" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC298" class="line" lang="java"><span class="cm">     * Returns the control text color. This returns the value of</span></span>
<span id="LC299" class="line" lang="java"><span class="cm">     * {@code getControlInfo()}.</span></span>
<span id="LC300" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC301" class="line" lang="java"><span class="cm">     * @return the control text color</span></span>
<span id="LC302" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC303" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getControlTextColor</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getControlInfo</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC304" class="line" lang="java"></span>
<span id="LC305" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC306" class="line" lang="java"><span class="cm">     * Returns the inactive control text color. This returns the value of</span></span>
<span id="LC307" class="line" lang="java"><span class="cm">     * {@code getControlDisabled()}.</span></span>
<span id="LC308" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC309" class="line" lang="java"><span class="cm">     * @return the inactive control text color</span></span>
<span id="LC310" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC311" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getInactiveControlTextColor</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getControlDisabled</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC312" class="line" lang="java"></span>
<span id="LC313" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC314" class="line" lang="java"><span class="cm">     * Returns the inactive system text color. This returns the value of</span></span>
<span id="LC315" class="line" lang="java"><span class="cm">     * {@code getSecondary2()}.</span></span>
<span id="LC316" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC317" class="line" lang="java"><span class="cm">     * @return the inactive system text color</span></span>
<span id="LC318" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC319" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getInactiveSystemTextColor</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getSecondary2</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC320" class="line" lang="java"></span>
<span id="LC321" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC322" class="line" lang="java"><span class="cm">     * Returns the user text color. This returns the value of</span></span>
<span id="LC323" class="line" lang="java"><span class="cm">     * {@code getBlack()}.</span></span>
<span id="LC324" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC325" class="line" lang="java"><span class="cm">     * @return the user text color</span></span>
<span id="LC326" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC327" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getUserTextColor</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getBlack</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC328" class="line" lang="java"></span>
<span id="LC329" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC330" class="line" lang="java"><span class="cm">     * Returns the text highlight color. This returns the value of</span></span>
<span id="LC331" class="line" lang="java"><span class="cm">     * {@code getPrimary3()}.</span></span>
<span id="LC332" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC333" class="line" lang="java"><span class="cm">     * @return the text highlight color</span></span>
<span id="LC334" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC335" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getTextHighlightColor</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getPrimary3</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC336" class="line" lang="java"></span>
<span id="LC337" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC338" class="line" lang="java"><span class="cm">     * Returns the highlighted text color. This returns the value of</span></span>
<span id="LC339" class="line" lang="java"><span class="cm">     * {@code getControlTextColor()}.</span></span>
<span id="LC340" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">     * @return the highlighted text color</span></span>
<span id="LC342" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC343" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getHighlightedTextColor</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getControlTextColor</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC344" class="line" lang="java"></span>
<span id="LC345" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC346" class="line" lang="java"><span class="cm">     * Returns the window background color. This returns the value of</span></span>
<span id="LC347" class="line" lang="java"><span class="cm">     * {@code getWhite()}.</span></span>
<span id="LC348" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC349" class="line" lang="java"><span class="cm">     * @return the window background color</span></span>
<span id="LC350" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC351" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getWindowBackground</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getWhite</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC352" class="line" lang="java"></span>
<span id="LC353" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC354" class="line" lang="java"><span class="cm">     * Returns the window title background color. This returns the value of</span></span>
<span id="LC355" class="line" lang="java"><span class="cm">     * {@code getPrimary3()}.</span></span>
<span id="LC356" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC357" class="line" lang="java"><span class="cm">     * @return the window title background color</span></span>
<span id="LC358" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC359" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getWindowTitleBackground</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getPrimary3</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC360" class="line" lang="java"></span>
<span id="LC361" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC362" class="line" lang="java"><span class="cm">     * Returns the window title foreground color. This returns the value of</span></span>
<span id="LC363" class="line" lang="java"><span class="cm">     * {@code getBlack()}.</span></span>
<span id="LC364" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC365" class="line" lang="java"><span class="cm">     * @return the window title foreground color</span></span>
<span id="LC366" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC367" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getWindowTitleForeground</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getBlack</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC368" class="line" lang="java"></span>
<span id="LC369" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC370" class="line" lang="java"><span class="cm">     * Returns the window title inactive background color. This</span></span>
<span id="LC371" class="line" lang="java"><span class="cm">     * returns the value of {@code getSecondary3()}.</span></span>
<span id="LC372" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC373" class="line" lang="java"><span class="cm">     * @return the window title inactive background color</span></span>
<span id="LC374" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC375" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getWindowTitleInactiveBackground</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getSecondary3</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC376" class="line" lang="java"></span>
<span id="LC377" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC378" class="line" lang="java"><span class="cm">     * Returns the window title inactive foreground color. This</span></span>
<span id="LC379" class="line" lang="java"><span class="cm">     * returns the value of {@code getBlack()}.</span></span>
<span id="LC380" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC381" class="line" lang="java"><span class="cm">     * @return the window title inactive foreground color</span></span>
<span id="LC382" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC383" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getWindowTitleInactiveForeground</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getBlack</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC384" class="line" lang="java"></span>
<span id="LC385" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC386" class="line" lang="java"><span class="cm">     * Returns the menu background color. This</span></span>
<span id="LC387" class="line" lang="java"><span class="cm">     * returns the value of {@code getSecondary3()}.</span></span>
<span id="LC388" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC389" class="line" lang="java"><span class="cm">     * @return the menu background color</span></span>
<span id="LC390" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC391" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getMenuBackground</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getSecondary3</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC392" class="line" lang="java"></span>
<span id="LC393" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC394" class="line" lang="java"><span class="cm">     * Returns the menu foreground color. This</span></span>
<span id="LC395" class="line" lang="java"><span class="cm">     * returns the value of {@code getBlack()}.</span></span>
<span id="LC396" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC397" class="line" lang="java"><span class="cm">     * @return the menu foreground color</span></span>
<span id="LC398" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC399" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getMenuForeground</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span>  <span class="n">getBlack</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC400" class="line" lang="java"></span>
<span id="LC401" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC402" class="line" lang="java"><span class="cm">     * Returns the menu selected background color. This</span></span>
<span id="LC403" class="line" lang="java"><span class="cm">     * returns the value of {@code getPrimary2()}.</span></span>
<span id="LC404" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC405" class="line" lang="java"><span class="cm">     * @return the menu selected background color</span></span>
<span id="LC406" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC407" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getMenuSelectedBackground</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getPrimary2</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC408" class="line" lang="java"></span>
<span id="LC409" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC410" class="line" lang="java"><span class="cm">     * Returns the menu selected foreground color. This</span></span>
<span id="LC411" class="line" lang="java"><span class="cm">     * returns the value of {@code getBlack()}.</span></span>
<span id="LC412" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC413" class="line" lang="java"><span class="cm">     * @return the menu selected foreground color</span></span>
<span id="LC414" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC415" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getMenuSelectedForeground</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getBlack</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC416" class="line" lang="java"></span>
<span id="LC417" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC418" class="line" lang="java"><span class="cm">     * Returns the menu disabled foreground color. This</span></span>
<span id="LC419" class="line" lang="java"><span class="cm">     * returns the value of {@code getSecondary2()}.</span></span>
<span id="LC420" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">     * @return the menu disabled foreground color</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC423" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getMenuDisabledForeground</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getSecondary2</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC424" class="line" lang="java"></span>
<span id="LC425" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">     * Returns the separator background color. This</span></span>
<span id="LC427" class="line" lang="java"><span class="cm">     * returns the value of {@code getWhite()}.</span></span>
<span id="LC428" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC429" class="line" lang="java"><span class="cm">     * @return the separator background color</span></span>
<span id="LC430" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC431" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getSeparatorBackground</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getWhite</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC432" class="line" lang="java"></span>
<span id="LC433" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC434" class="line" lang="java"><span class="cm">     * Returns the separator foreground color. This</span></span>
<span id="LC435" class="line" lang="java"><span class="cm">     * returns the value of {@code getPrimary1()}.</span></span>
<span id="LC436" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC437" class="line" lang="java"><span class="cm">     * @return the separator foreground color</span></span>
<span id="LC438" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC439" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getSeparatorForeground</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getPrimary1</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC440" class="line" lang="java"></span>
<span id="LC441" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC442" class="line" lang="java"><span class="cm">     * Returns the accelerator foreground color. This</span></span>
<span id="LC443" class="line" lang="java"><span class="cm">     * returns the value of {@code getPrimary1()}.</span></span>
<span id="LC444" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC445" class="line" lang="java"><span class="cm">     * @return the accelerator foreground color</span></span>
<span id="LC446" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC447" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getAcceleratorForeground</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getPrimary1</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC448" class="line" lang="java"></span>
<span id="LC449" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC450" class="line" lang="java"><span class="cm">     * Returns the accelerator selected foreground color. This</span></span>
<span id="LC451" class="line" lang="java"><span class="cm">     * returns the value of {@code getBlack()}.</span></span>
<span id="LC452" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC453" class="line" lang="java"><span class="cm">     * @return the accelerator selected foreground color</span></span>
<span id="LC454" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC455" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ColorUIResource</span> <span class="nf">getAcceleratorSelectedForeground</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getBlack</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC456" class="line" lang="java"></span>
<span id="LC457" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC458" class="line" lang="java"><span class="cm">     * Adds values specific to this theme to the defaults table. This method</span></span>
<span id="LC459" class="line" lang="java"><span class="cm">     * is invoked when the look and feel defaults are obtained from</span></span>
<span id="LC460" class="line" lang="java"><span class="cm">     * {@code MetalLookAndFeel}.</span></span>
<span id="LC461" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC462" class="line" lang="java"><span class="cm">     * This implementation does nothing; it is provided for subclasses</span></span>
<span id="LC463" class="line" lang="java"><span class="cm">     * that wish to customize the defaults table.</span></span>
<span id="LC464" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC465" class="line" lang="java"><span class="cm">     * @param table the {@code UIDefaults} to add the values to</span></span>
<span id="LC466" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC467" class="line" lang="java"><span class="cm">     * @see MetalLookAndFeel#getDefaults</span></span>
<span id="LC468" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC469" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addCustomEntriesToTable</span><span class="o">(</span><span class="nc">UIDefaults</span> <span class="n">table</span><span class="o">)</span> <span class="o">{}</span></span>
<span id="LC470" class="line" lang="java"></span>
<span id="LC471" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC472" class="line" lang="java"><span class="cm">     * This is invoked when a MetalLookAndFeel is installed and about to</span></span>
<span id="LC473" class="line" lang="java"><span class="cm">     * start using this theme. When we can add API this should be nuked</span></span>
<span id="LC474" class="line" lang="java"><span class="cm">     * in favor of DefaultMetalTheme overriding addCustomEntriesToTable.</span></span>
<span id="LC475" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC476" class="line" lang="java">    <span class="kt">void</span> <span class="nf">install</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC480" class="line" lang="java"><span class="cm">     * Returns true if this is a theme provided by the core platform.</span></span>
<span id="LC481" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC482" class="line" lang="java">    <span class="kt">boolean</span> <span class="nf">isSystemTheme</span><span class="o">()</span> <span class="o">{</span></span>
