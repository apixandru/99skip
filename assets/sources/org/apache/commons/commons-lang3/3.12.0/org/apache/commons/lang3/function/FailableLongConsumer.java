...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"></span><span class="line" lang="java" id="LC18"><span class="kn">package</span><span> </span><span>org.apache.commons.lang3.function</span><span>;</span></span><span class="line" lang="java" id="LC19"></span><span class="line" lang="java" id="LC20"><span class="kn">import</span><span> </span><span>java.util.Objects</span><span>;</span></span><span class="line" lang="java" id="LC21"><span class="kn">import</span><span> </span><span>java.util.function.LongConsumer</span><span>;</span></span><span class="line" lang="java" id="LC22"></span><span class="line" lang="java" id="LC23"><span class="cm">/**</span></span><span class="line" lang="java" id="LC24"><span class="cm"> * A functional interface like {@link LongConsumer} that declares a {@code Throwable}.</span></span><span class="line" lang="java" id="LC25"><span class="cm"> *</span></span><span class="line" lang="java" id="LC26"><span class="cm"> * @param &lt;E&gt; Thrown exception.</span></span><span class="line" lang="java" id="LC27"><span class="cm"> * @since 3.11</span></span><span class="line" lang="java" id="LC28"><span class="cm"> */</span></span><span class="line" lang="java" id="LC29"><span>@FunctionalInterface</span></span><span class="line" lang="java" id="LC30"><span class="kd">public</span><span> </span><span class="kd">interface</span><span> </span><span class="nc">FailableLongConsumer</span><span>&lt;</span><span>E</span><span> </span><span class="kd">extends</span><span> </span><span>Throwable</span><span>&gt;</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC31"></span><span class="line" lang="java" id="LC32"><span>    </span><span class="cm">/** NOP singleton */</span></span><span class="line" lang="java" id="LC33"><span>    </span><span>@</span><span>SuppressWarnings</span><span>(</span><span class="s">&quot;rawtypes&quot;</span><span>)</span></span><span class="line" lang="java" id="LC34"><span>    </span><span>FailableLongConsumer</span><span> </span><span>NOP</span><span> </span><span>=</span><span> </span><span>t</span><span> </span><span>-</span><span>&gt;</span><span> </span><span>{</span><span class="cm">/* NOP */</span><span>}</span><span>;</span></span><span class="line" lang="java" id="LC35"></span><span class="line" lang="java" id="LC36"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC37"><span class="cm">     * Returns The NOP singleton.</span></span><span class="line" lang="java" id="LC38"><span class="cm">     *</span></span><span class="line" lang="java" id="LC39"><span class="cm">     * @param &lt;E&gt; Thrown exception.</span></span><span class="line" lang="java" id="LC40"><span class="cm">     * @return The NOP singleton.</span></span><span class="line" lang="java" id="LC41"><span class="cm">     */</span></span><span class="line" lang="java" id="LC42"><span>    </span><span class="kd">static</span><span> </span><span>&lt;</span><span>E</span><span> </span><span class="kd">extends</span><span> </span><span>Throwable</span><span>&gt;</span><span> </span><span>FailableLongConsumer</span><span>&lt;</span><span>E</span><span>&gt;</span><span> </span><span>nop</span><span>(</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC43"><span>        </span><span class="k">return</span><span> </span><span>NOP</span><span>;</span></span><span class="line" lang="java" id="LC44"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC45"></span><span class="line" lang="java" id="LC46"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC47"><span class="cm">     * Accepts the consumer.</span></span><span class="line" lang="java" id="LC48"><span class="cm">     *</span></span><span class="line" lang="java" id="LC49"><span class="cm">     * @param object the parameter for the consumable to accept</span></span><span class="line" lang="java" id="LC50"><span class="cm">     * @throws E Thrown when the consumer fails.</span></span><span class="line" lang="java" id="LC51"><span class="cm">     */</span></span><span class="line" lang="java" id="LC52"><span>    </span><span class="kt">void</span><span> </span><span>accept</span><span>(</span><span class="kt">long</span><span> </span><span>object</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>E</span><span>;</span></span><span class="line" lang="java" id="LC53"></span><span class="line" lang="java" id="LC54"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC55"><span class="cm">     * Returns a composed {@code FailableLongConsumer} like {@link LongConsumer#andThen(LongConsumer)}.</span></span><span class="line" lang="java" id="LC56"><span class="cm">     *</span></span><span class="line" lang="java" id="LC57"><span class="cm">     * @param after the operation to perform after this one.</span></span><span class="line" lang="java" id="LC58"><span class="cm">     * @return a composed {@code FailableLongConsumer} like {@link LongConsumer#andThen(LongConsumer)}.</span></span><span class="line" lang="java" id="LC59"><span class="cm">     * @throws NullPointerException if {@code after} is null</span></span><span class="line" lang="java" id="LC60"><span class="cm">     */</span></span><span class="line" lang="java" id="LC61"><span>    </span><span>default</span><span> </span><span>FailableLongConsumer</span><span>&lt;</span><span>E</span><span>&gt;</span><span> </span><span>andThen</span><span>(</span><span class="kd">final</span><span> </span><span>FailableLongConsumer</span><span>&lt;</span><span>E</span><span>&gt;</span><span> </span><span>after</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC62"><span>        </span><span>Objects</span><span>.</span><span>requireNonNull</span><span>(</span><span>after</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC63"><span>        </span><span class="k">return</span><span> </span><span>(</span><span class="kd">final</span><span> </span><span class="kt">long</span><span> </span><span>t</span><span>)</span><span> </span><span>-</span><span>&gt;</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC64"><span>            </span><span>accept</span><span>(</span><span>t</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC65"><span>            </span><span>after</span><span>.</span><span>accept</span><span>(</span><span>t</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC66"><span>        </span><span>}</span><span>;</span></span><span class="line" lang="java" id="LC67"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC68"><span>}</span></span>
</code>
</pre>
    </div>
</div>