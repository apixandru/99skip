...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *     http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"></span><span class="line" lang="java" id="LC18"><span class="kn">package</span><span> </span><span>org.apache.commons.lang3</span><span>;</span></span><span class="line" lang="java" id="LC19"></span><span class="line" lang="java" id="LC20"><span class="kn">import</span><span> </span><span>java.net.URLClassLoader</span><span>;</span></span><span class="line" lang="java" id="LC21"><span class="kn">import</span><span> </span><span>java.util.Arrays</span><span>;</span></span><span class="line" lang="java" id="LC22"></span><span class="line" lang="java" id="LC23"><span class="cm">/**</span></span><span class="line" lang="java" id="LC24"><span class="cm"> * Helps work with {@link ClassLoader}.</span></span><span class="line" lang="java" id="LC25"><span class="cm"> *</span></span><span class="line" lang="java" id="LC26"><span class="cm"> * @since 3.10</span></span><span class="line" lang="java" id="LC27"><span class="cm"> */</span></span><span class="line" lang="java" id="LC28"><span class="kd">public</span><span> </span><span class="kd">class</span><span> </span><span class="nc">ClassLoaderUtils</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC29"></span><span class="line" lang="java" id="LC30"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC31"><span class="cm">     * Converts the given class loader to a String calling {@link #toString(URLClassLoader)}.</span></span><span class="line" lang="java" id="LC32"><span class="cm">     *</span></span><span class="line" lang="java" id="LC33"><span class="cm">     * @param classLoader to URLClassLoader to convert.</span></span><span class="line" lang="java" id="LC34"><span class="cm">     * @return the formatted string.</span></span><span class="line" lang="java" id="LC35"><span class="cm">     */</span></span><span class="line" lang="java" id="LC36"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>String</span><span> </span><span>toString</span><span>(</span><span class="kd">final</span><span> </span><span>ClassLoader</span><span> </span><span>classLoader</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC37"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>classLoader</span><span> </span><span class="k">instanceof</span><span> </span><span>URLClassLoader</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC38"><span>            </span><span class="k">return</span><span> </span><span>toString</span><span>(</span><span>(</span><span>URLClassLoader</span><span>)</span><span> </span><span>classLoader</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC39"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC40"><span>        </span><span class="k">return</span><span> </span><span>classLoader</span><span>.</span><span>toString</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC41"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC42"></span><span class="line" lang="java" id="LC43"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC44"><span class="cm">     * Converts the given URLClassLoader to a String in the format</span></span><span class="line" lang="java" id="LC45"><span class="cm">     * {@code &quot;URLClassLoader.toString() + [URL1, URL2, ...]&quot;}.</span></span><span class="line" lang="java" id="LC46"><span class="cm">     *</span></span><span class="line" lang="java" id="LC47"><span class="cm">     * @param classLoader to URLClassLoader to convert.</span></span><span class="line" lang="java" id="LC48"><span class="cm">     * @return the formatted string.</span></span><span class="line" lang="java" id="LC49"><span class="cm">     */</span></span><span class="line" lang="java" id="LC50"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>String</span><span> </span><span>toString</span><span>(</span><span class="kd">final</span><span> </span><span>URLClassLoader</span><span> </span><span>classLoader</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC51"><span>        </span><span class="k">return</span><span> </span><span>classLoader</span><span> </span><span>+</span><span> </span><span>Arrays</span><span>.</span><span>toString</span><span>(</span><span>classLoader</span><span>.</span><span>getURLs</span><span>(</span><span>)</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC52"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC53"><span>}</span></span>
</code>
</pre>
    </div>
</div>