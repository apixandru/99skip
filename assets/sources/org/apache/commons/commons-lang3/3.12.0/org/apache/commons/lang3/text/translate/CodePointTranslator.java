...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"><span class="kn">package</span><span> </span><span>org.apache.commons.lang3.text.translate</span><span>;</span></span><span class="line" lang="java" id="LC18"></span><span class="line" lang="java" id="LC19"><span class="kn">import</span><span> </span><span>java.io.IOException</span><span>;</span></span><span class="line" lang="java" id="LC20"><span class="kn">import</span><span> </span><span>java.io.Writer</span><span>;</span></span><span class="line" lang="java" id="LC21"></span><span class="line" lang="java" id="LC22"><span class="cm">/**</span></span><span class="line" lang="java" id="LC23"><span class="cm"> * Helper subclass to CharSequenceTranslator to allow for translations that</span></span><span class="line" lang="java" id="LC24"><span class="cm"> * will replace up to one character at a time.</span></span><span class="line" lang="java" id="LC25"><span class="cm"> *</span></span><span class="line" lang="java" id="LC26"><span class="cm"> * @since 3.0</span></span><span class="line" lang="java" id="LC27"><span class="cm"> * @deprecated as of 3.6, use commons-text</span></span><span class="line" lang="java" id="LC28"><span class="cm"> * &lt;a href=&quot;https://commons.apache.org/proper/commons-text/javadocs/api-release/org/apache/commons/text/translate/CodePointTranslator.html&quot;&gt;</span></span><span class="line" lang="java" id="LC29"><span class="cm"> * CharSequenceTranslator&lt;/a&gt; instead</span></span><span class="line" lang="java" id="LC30"><span class="cm"> */</span></span><span class="line" lang="java" id="LC31"><span>@Deprecated</span></span><span class="line" lang="java" id="LC32"><span class="kd">public</span><span> </span><span class="kd">abstract</span><span> </span><span class="kd">class</span><span> </span><span class="nc">CodePointTranslator</span><span> </span><span class="kd">extends</span><span> </span><span>CharSequenceTranslator</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC33"></span><span class="line" lang="java" id="LC34"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC35"><span class="cm">     * Implementation of translate that maps onto the abstract translate(int, Writer) method.</span></span><span class="line" lang="java" id="LC36"><span class="cm">     * {@inheritDoc}</span></span><span class="line" lang="java" id="LC37"><span class="cm">     */</span></span><span class="line" lang="java" id="LC38"><span>    </span><span>@</span><span>Override</span></span><span class="line" lang="java" id="LC39"><span>    </span><span class="kd">public</span><span> </span><span class="kd">final</span><span> </span><span class="kt">int</span><span> </span><span>translate</span><span>(</span><span class="kd">final</span><span> </span><span>CharSequence</span><span> </span><span>input</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span class="kt">int</span><span> </span><span>index</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Writer</span><span> </span><span>out</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC40"><span>        </span><span class="kd">final</span><span> </span><span class="kt">int</span><span> </span><span>codepoint</span><span> </span><span>=</span><span> </span><span>Character</span><span>.</span><span>codePointAt</span><span>(</span><span>input</span><span>,</span><span> </span><span>index</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC41"><span>        </span><span class="kd">final</span><span> </span><span class="kt">boolean</span><span> </span><span>consumed</span><span> </span><span>=</span><span> </span><span>translate</span><span>(</span><span>codepoint</span><span>,</span><span> </span><span>out</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC42"><span>        </span><span class="k">return</span><span> </span><span>consumed</span><span> </span><span>?</span><span> </span><span>1</span><span> </span><span>:</span><span> </span><span>0</span><span>;</span></span><span class="line" lang="java" id="LC43"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC44"></span><span class="line" lang="java" id="LC45"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC46"><span class="cm">     * Translate the specified codepoint into another.</span></span><span class="line" lang="java" id="LC47"><span class="cm">     *</span></span><span class="line" lang="java" id="LC48"><span class="cm">     * @param codepoint int character input to translate</span></span><span class="line" lang="java" id="LC49"><span class="cm">     * @param out Writer to optionally push the translated output to</span></span><span class="line" lang="java" id="LC50"><span class="cm">     * @return boolean as to whether translation occurred or not</span></span><span class="line" lang="java" id="LC51"><span class="cm">     * @throws IOException if and only if the Writer produces an IOException</span></span><span class="line" lang="java" id="LC52"><span class="cm">     */</span></span><span class="line" lang="java" id="LC53"><span>    </span><span class="kd">public</span><span> </span><span class="kd">abstract</span><span> </span><span class="kt">boolean</span><span> </span><span>translate</span><span>(</span><span class="kt">int</span><span> </span><span>codepoint</span><span>,</span><span> </span><span>Writer</span><span> </span><span>out</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span>;</span></span><span class="line" lang="java" id="LC54"></span><span class="line" lang="java" id="LC55"><span>}</span></span>
</code>
</pre>
    </div>
</div>