...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"><span class="kn">package</span><span> </span><span>org.apache.commons.lang3.concurrent</span><span>;</span></span><span class="line" lang="java" id="LC18"></span><span class="line" lang="java" id="LC19"><span class="cm">/**</span></span><span class="line" lang="java" id="LC20"><span class="cm"> * &lt;p&gt;</span></span><span class="line" lang="java" id="LC21"><span class="cm"> * Definition of an interface for the thread-safe initialization of objects.</span></span><span class="line" lang="java" id="LC22"><span class="cm"> * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC23"><span class="cm"> * &lt;p&gt;</span></span><span class="line" lang="java" id="LC24"><span class="cm"> * The idea behind this interface is to provide access to an object in a</span></span><span class="line" lang="java" id="LC25"><span class="cm"> * thread-safe manner. A {@code ConcurrentInitializer} can be passed to multiple</span></span><span class="line" lang="java" id="LC26"><span class="cm"> * threads which can all access the object produced by the initializer. Through</span></span><span class="line" lang="java" id="LC27"><span class="cm"> * the {@link #get()} method the object can be queried.</span></span><span class="line" lang="java" id="LC28"><span class="cm"> * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC29"><span class="cm"> * &lt;p&gt;</span></span><span class="line" lang="java" id="LC30"><span class="cm"> * Concrete implementations of this interface will use different strategies for</span></span><span class="line" lang="java" id="LC31"><span class="cm"> * the creation of the managed object, e.g. lazy initialization or</span></span><span class="line" lang="java" id="LC32"><span class="cm"> * initialization in a background thread. This is completely transparent to</span></span><span class="line" lang="java" id="LC33"><span class="cm"> * client code, so it is possible to change the initialization strategy without</span></span><span class="line" lang="java" id="LC34"><span class="cm"> * affecting clients.</span></span><span class="line" lang="java" id="LC35"><span class="cm"> * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC36"><span class="cm"> *</span></span><span class="line" lang="java" id="LC37"><span class="cm"> * @since 3.0</span></span><span class="line" lang="java" id="LC38"><span class="cm"> * @param &lt;T&gt; the type of the object managed by this initializer class</span></span><span class="line" lang="java" id="LC39"><span class="cm"> */</span></span><span class="line" lang="java" id="LC40"><span class="kd">public</span><span> </span><span class="kd">interface</span><span> </span><span class="nc">ConcurrentInitializer</span><span>&lt;</span><span>T</span><span>&gt;</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC41"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC42"><span class="cm">     * Returns the fully initialized object produced by this {@code</span></span><span class="line" lang="java" id="LC43"><span class="cm">     * ConcurrentInitializer}. A concrete implementation here returns the</span></span><span class="line" lang="java" id="LC44"><span class="cm">     * results of the initialization process. This method may block until</span></span><span class="line" lang="java" id="LC45"><span class="cm">     * results are available. Typically, once created the result object is</span></span><span class="line" lang="java" id="LC46"><span class="cm">     * always the same.</span></span><span class="line" lang="java" id="LC47"><span class="cm">     *</span></span><span class="line" lang="java" id="LC48"><span class="cm">     * @return the object created by this {@code ConcurrentException}</span></span><span class="line" lang="java" id="LC49"><span class="cm">     * @throws ConcurrentException if an error occurred during initialization of</span></span><span class="line" lang="java" id="LC50"><span class="cm">     * the object</span></span><span class="line" lang="java" id="LC51"><span class="cm">     */</span></span><span class="line" lang="java" id="LC52"><span>    </span><span>T</span><span> </span><span>get</span><span>(</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>ConcurrentException</span><span>;</span></span><span class="line" lang="java" id="LC53"><span>}</span></span>
</code>
</pre>
    </div>
</div>