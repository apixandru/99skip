...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"><span class="kn">package</span><span> </span><span>org.apache.commons.lang3.concurrent</span><span>;</span></span><span class="line" lang="java" id="LC18"></span><span class="line" lang="java" id="LC19"><span class="cm">/**</span></span><span class="line" lang="java" id="LC20"><span class="cm"> * &lt;p&gt;</span></span><span class="line" lang="java" id="LC21"><span class="cm"> * An exception class used for reporting error conditions related to accessing</span></span><span class="line" lang="java" id="LC22"><span class="cm"> * data of background tasks.</span></span><span class="line" lang="java" id="LC23"><span class="cm"> * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC24"><span class="cm"> * &lt;p&gt;</span></span><span class="line" lang="java" id="LC25"><span class="cm"> * The purpose of this exception class is analogous to the default JDK exception</span></span><span class="line" lang="java" id="LC26"><span class="cm"> * class {@link java.util.concurrent.ExecutionException}, i.e. it wraps an</span></span><span class="line" lang="java" id="LC27"><span class="cm"> * exception that occurred during the execution of a task. However, in contrast</span></span><span class="line" lang="java" id="LC28"><span class="cm"> * to {@code ExecutionException}, it wraps only checked exceptions. Runtime</span></span><span class="line" lang="java" id="LC29"><span class="cm"> * exceptions are thrown directly.</span></span><span class="line" lang="java" id="LC30"><span class="cm"> * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC31"><span class="cm"> *</span></span><span class="line" lang="java" id="LC32"><span class="cm"> * @since 3.0</span></span><span class="line" lang="java" id="LC33"><span class="cm"> */</span></span><span class="line" lang="java" id="LC34"><span class="kd">public</span><span> </span><span class="kd">class</span><span> </span><span class="nc">ConcurrentException</span><span> </span><span class="kd">extends</span><span> </span><span>Exception</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC35"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC36"><span class="cm">     * The serial version UID.</span></span><span class="line" lang="java" id="LC37"><span class="cm">     */</span></span><span class="line" lang="java" id="LC38"><span>    </span><span class="kd">private</span><span> </span><span class="kd">static</span><span> </span><span class="kd">final</span><span> </span><span class="kt">long</span><span> </span><span>serialVersionUID</span><span> </span><span>=</span><span> </span><span>6622707671812226130</span><span>L</span><span>;</span></span><span class="line" lang="java" id="LC39"></span><span class="line" lang="java" id="LC40"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC41"><span class="cm">     * Creates a new, uninitialized instance of {@code ConcurrentException}.</span></span><span class="line" lang="java" id="LC42"><span class="cm">     */</span></span><span class="line" lang="java" id="LC43"><span>    </span><span class="kd">protected</span><span> </span><span>ConcurrentException</span><span>(</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC44"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC45"></span><span class="line" lang="java" id="LC46"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC47"><span class="cm">     * Creates a new instance of {@code ConcurrentException} and initializes it</span></span><span class="line" lang="java" id="LC48"><span class="cm">     * with the given cause.</span></span><span class="line" lang="java" id="LC49"><span class="cm">     *</span></span><span class="line" lang="java" id="LC50"><span class="cm">     * @param cause the cause of this exception</span></span><span class="line" lang="java" id="LC51"><span class="cm">     * @throws IllegalArgumentException if the cause is not a checked exception</span></span><span class="line" lang="java" id="LC52"><span class="cm">     */</span></span><span class="line" lang="java" id="LC53"><span>    </span><span class="kd">public</span><span> </span><span>ConcurrentException</span><span>(</span><span class="kd">final</span><span> </span><span>Throwable</span><span> </span><span>cause</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC54"><span>        </span><span class="kd">super</span><span>(</span><span>ConcurrentUtils</span><span>.</span><span>checkedException</span><span>(</span><span>cause</span><span>)</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC55"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC56"></span><span class="line" lang="java" id="LC57"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC58"><span class="cm">     * Creates a new instance of {@code ConcurrentException} and initializes it</span></span><span class="line" lang="java" id="LC59"><span class="cm">     * with the given message and cause.</span></span><span class="line" lang="java" id="LC60"><span class="cm">     *</span></span><span class="line" lang="java" id="LC61"><span class="cm">     * @param msg the error message</span></span><span class="line" lang="java" id="LC62"><span class="cm">     * @param cause the cause of this exception</span></span><span class="line" lang="java" id="LC63"><span class="cm">     * @throws IllegalArgumentException if the cause is not a checked exception</span></span><span class="line" lang="java" id="LC64"><span class="cm">     */</span></span><span class="line" lang="java" id="LC65"><span>    </span><span class="kd">public</span><span> </span><span>ConcurrentException</span><span>(</span><span class="kd">final</span><span> </span><span>String</span><span> </span><span>msg</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Throwable</span><span> </span><span>cause</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC66"><span>        </span><span class="kd">super</span><span>(</span><span>msg</span><span>,</span><span> </span><span>ConcurrentUtils</span><span>.</span><span>checkedException</span><span>(</span><span>cause</span><span>)</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC67"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC68"><span>}</span></span>
</code>
</pre>
    </div>
</div>