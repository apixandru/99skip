...
<span id="LC29" class="line" lang="java"><span class="cm">* The Helper for &lt;tt&gt;BooleanSeq&lt;/tt&gt;.  For more information on</span></span>
...
<span id="LC32" class="line" lang="java"><span class="cm">* org/omg/CORBA/BooleanSeqHelper.java</span></span>
...
<span id="LC50" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">BooleanSeqHelper</span></span>
<span id="LC51" class="line" lang="java"><span class="o">{</span></span>
<span id="LC52" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="nc">String</span>  <span class="n">_id</span> <span class="o">=</span> <span class="s">"IDL:omg.org/CORBA/BooleanSeq:1.0"</span><span class="o">;</span></span>
<span id="LC53" class="line" lang="java"></span>
<span id="LC54" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kt">void</span> <span class="nf">insert</span> <span class="o">(</span><span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">CORBA</span><span class="o">.</span><span class="na">Any</span> <span class="n">a</span><span class="o">,</span> <span class="kt">boolean</span><span class="o">[]</span> <span class="n">that</span><span class="o">)</span></span>
...
<span id="LC84" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kt">boolean</span><span class="o">[]</span> <span class="nf">read</span> <span class="o">(</span><span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">CORBA</span><span class="o">.</span><span class="na">portable</span><span class="o">.</span><span class="na">InputStream</span> <span class="n">istream</span><span class="o">)</span></span>
<span id="LC85" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC86" class="line" lang="java">        <span class="kt">boolean</span> <span class="n">value</span><span class="o">[]</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC88" class="line" lang="java">        <span class="n">value</span> <span class="o">=</span> <span class="k">new</span> <span class="kt">boolean</span><span class="o">[</span><span class="n">_len0</span><span class="o">];</span></span>
<span id="LC89" class="line" lang="java">        <span class="n">istream</span><span class="o">.</span><span class="na">read_boolean_array</span> <span class="o">(</span><span class="n">value</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">_len0</span><span class="o">);</span></span>
...
<span id="LC96" class="line" lang="java">        <span class="n">ostream</span><span class="o">.</span><span class="na">write_boolean_array</span> <span class="o">(</span><span class="n">value</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">value</span><span class="o">.</span><span class="na">length</span><span class="o">);</span></span>
