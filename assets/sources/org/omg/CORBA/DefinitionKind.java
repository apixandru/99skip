...
<span id="LC27" class="line" lang="java"><span class="cm"> * File: ./org/omg/CORBA/DefinitionKind.java</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> * From: ./ir.idl</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> * Date: Fri Aug 28 16:03:31 1998</span></span>
<span id="LC30" class="line" lang="java"><span class="cm"> *   By: idltojava Java IDL 1.2 Aug 11 1998 02:00:18</span></span>
<span id="LC31" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC32" class="line" lang="java"></span>
<span id="LC33" class="line" lang="java"><span class="kn">package</span> <span class="nn">org.omg.CORBA</span><span class="o">;</span></span>
<span id="LC34" class="line" lang="java"></span>
<span id="LC35" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC36" class="line" lang="java"><span class="cm">* The class that provides the constants used to identify the type of an</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">* Interface Repository object.  This class contains two kinds of constants,</span></span>
<span id="LC38" class="line" lang="java"><span class="cm">* those that are an &lt;code&gt;int&lt;/code&gt; and those that are an instance of the class</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">* &lt;code&gt;DefinitionKind&lt;/code&gt;.  This class provides the method</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">* &lt;code&gt;from_int&lt;/code&gt;, which given one</span></span>
<span id="LC41" class="line" lang="java"><span class="cm">* of the &lt;code&gt;int&lt;/code&gt; constants, creates the corresponding</span></span>
<span id="LC42" class="line" lang="java"><span class="cm">* &lt;code&gt;DefinitionKind&lt;/code&gt; instance.  It also provides the method</span></span>
<span id="LC43" class="line" lang="java"><span class="cm">* &lt;code&gt;value&lt;/code&gt;, which returns the &lt;code&gt;int&lt;/code&gt; constant that</span></span>
<span id="LC44" class="line" lang="java"><span class="cm">* is the value for a &lt;code&gt;DefinitionKind&lt;/code&gt; instance.</span></span>
<span id="LC45" class="line" lang="java"><span class="cm">*</span></span>
<span id="LC46" class="line" lang="java"><span class="cm">* @see IRObject</span></span>
<span id="LC47" class="line" lang="java"><span class="cm">*/</span></span>
<span id="LC48" class="line" lang="java"></span>
<span id="LC49" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">DefinitionKind</span> <span class="kd">implements</span> <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">CORBA</span><span class="o">.</span><span class="na">portable</span><span class="o">.</span><span class="na">IDLEntity</span> <span class="o">{</span></span>
<span id="LC50" class="line" lang="java"></span>
<span id="LC51" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC52" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object</span></span>
<span id="LC53" class="line" lang="java"><span class="cm"> * does not have a definition kind.</span></span>
<span id="LC54" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC55" class="line" lang="java">        <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="n">_dk_none</span> <span class="o">=</span> <span class="mi">0</span><span class="o">,</span></span>
<span id="LC56" class="line" lang="java"></span>
<span id="LC57" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC58" class="line" lang="java"><span class="cm"> * The constant that indicates that the type of an Interface Repository object</span></span>
<span id="LC59" class="line" lang="java"><span class="cm"> * may be any type.</span></span>
<span id="LC60" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC61" class="line" lang="java">        <span class="n">_dk_all</span> <span class="o">=</span> <span class="mi">1</span><span class="o">,</span></span>
<span id="LC62" class="line" lang="java"></span>
<span id="LC63" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is an</span></span>
<span id="LC65" class="line" lang="java"><span class="cm"> * attribute.</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC67" class="line" lang="java">        <span class="n">_dk_Attribute</span> <span class="o">=</span> <span class="mi">2</span><span class="o">,</span></span>
<span id="LC68" class="line" lang="java"></span>
<span id="LC69" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC70" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is a</span></span>
<span id="LC71" class="line" lang="java"><span class="cm"> * constant.</span></span>
<span id="LC72" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC73" class="line" lang="java">        <span class="n">_dk_Constant</span> <span class="o">=</span> <span class="mi">3</span><span class="o">,</span></span>
<span id="LC74" class="line" lang="java"></span>
<span id="LC75" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC76" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is an</span></span>
<span id="LC77" class="line" lang="java"><span class="cm"> * exception.</span></span>
<span id="LC78" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC79" class="line" lang="java"></span>
<span id="LC80" class="line" lang="java">        <span class="n">_dk_Exception</span> <span class="o">=</span> <span class="mi">4</span><span class="o">,</span></span>
<span id="LC81" class="line" lang="java"></span>
<span id="LC82" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC83" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is an</span></span>
...
<span id="LC87" class="line" lang="java">        <span class="n">_dk_Interface</span> <span class="o">=</span> <span class="mi">5</span><span class="o">,</span></span>
<span id="LC88" class="line" lang="java"></span>
<span id="LC89" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC90" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is a</span></span>
<span id="LC91" class="line" lang="java"><span class="cm"> * module.</span></span>
<span id="LC92" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC93" class="line" lang="java"></span>
<span id="LC94" class="line" lang="java">        <span class="n">_dk_Module</span> <span class="o">=</span> <span class="mi">6</span><span class="o">,</span></span>
<span id="LC95" class="line" lang="java"></span>
<span id="LC96" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC97" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is an</span></span>
...
<span id="LC101" class="line" lang="java">        <span class="n">_dk_Operation</span> <span class="o">=</span> <span class="mi">7</span><span class="o">,</span></span>
<span id="LC102" class="line" lang="java"></span>
<span id="LC103" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC104" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is a</span></span>
<span id="LC105" class="line" lang="java"><span class="cm"> * Typedef.</span></span>
<span id="LC106" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC107" class="line" lang="java"></span>
<span id="LC108" class="line" lang="java">        <span class="n">_dk_Typedef</span> <span class="o">=</span> <span class="mi">8</span><span class="o">,</span></span>
<span id="LC109" class="line" lang="java"></span>
<span id="LC110" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC111" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is an</span></span>
<span id="LC112" class="line" lang="java"><span class="cm"> * Alias.</span></span>
<span id="LC113" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC114" class="line" lang="java"></span>
<span id="LC115" class="line" lang="java">        <span class="n">_dk_Alias</span> <span class="o">=</span> <span class="mi">9</span><span class="o">,</span></span>
<span id="LC116" class="line" lang="java"></span>
<span id="LC117" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC118" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is a</span></span>
<span id="LC119" class="line" lang="java"><span class="cm"> * Struct.</span></span>
<span id="LC120" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC121" class="line" lang="java"></span>
<span id="LC122" class="line" lang="java">        <span class="n">_dk_Struct</span> <span class="o">=</span> <span class="mi">10</span><span class="o">,</span></span>
<span id="LC123" class="line" lang="java"></span>
<span id="LC124" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC125" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is a</span></span>
<span id="LC126" class="line" lang="java"><span class="cm"> * Union.</span></span>
<span id="LC127" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC128" class="line" lang="java"></span>
<span id="LC129" class="line" lang="java">        <span class="n">_dk_Union</span> <span class="o">=</span> <span class="mi">11</span><span class="o">,</span></span>
<span id="LC130" class="line" lang="java"></span>
<span id="LC131" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC132" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is an</span></span>
<span id="LC133" class="line" lang="java"><span class="cm"> * Enum.</span></span>
<span id="LC134" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC135" class="line" lang="java"></span>
<span id="LC136" class="line" lang="java">        <span class="n">_dk_Enum</span> <span class="o">=</span> <span class="mi">12</span><span class="o">,</span></span>
<span id="LC137" class="line" lang="java"></span>
<span id="LC138" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC139" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is a</span></span>
<span id="LC140" class="line" lang="java"><span class="cm"> * Primitive.</span></span>
<span id="LC141" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC142" class="line" lang="java"></span>
<span id="LC143" class="line" lang="java">        <span class="n">_dk_Primitive</span> <span class="o">=</span> <span class="mi">13</span><span class="o">,</span></span>
<span id="LC144" class="line" lang="java"></span>
<span id="LC145" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC146" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is a</span></span>
<span id="LC147" class="line" lang="java"><span class="cm"> * String.</span></span>
<span id="LC148" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC149" class="line" lang="java"></span>
<span id="LC150" class="line" lang="java">        <span class="n">_dk_String</span> <span class="o">=</span> <span class="mi">14</span><span class="o">,</span></span>
<span id="LC151" class="line" lang="java"></span>
<span id="LC152" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC153" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is a</span></span>
<span id="LC154" class="line" lang="java"><span class="cm"> * Sequence.</span></span>
<span id="LC155" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC156" class="line" lang="java"></span>
<span id="LC157" class="line" lang="java">        <span class="n">_dk_Sequence</span> <span class="o">=</span> <span class="mi">15</span><span class="o">,</span></span>
<span id="LC158" class="line" lang="java"></span>
<span id="LC159" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC160" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is an</span></span>
<span id="LC161" class="line" lang="java"><span class="cm"> * Array.</span></span>
<span id="LC162" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC163" class="line" lang="java"></span>
<span id="LC164" class="line" lang="java">        <span class="n">_dk_Array</span> <span class="o">=</span> <span class="mi">16</span><span class="o">,</span></span>
<span id="LC165" class="line" lang="java"></span>
<span id="LC166" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC167" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is a</span></span>
<span id="LC168" class="line" lang="java"><span class="cm"> * Repository.</span></span>
<span id="LC169" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC170" class="line" lang="java"></span>
<span id="LC171" class="line" lang="java">        <span class="n">_dk_Repository</span> <span class="o">=</span> <span class="mi">17</span><span class="o">,</span></span>
<span id="LC172" class="line" lang="java"></span>
<span id="LC173" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC174" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is a</span></span>
<span id="LC175" class="line" lang="java"><span class="cm"> * Wstring.</span></span>
<span id="LC176" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC177" class="line" lang="java"></span>
<span id="LC178" class="line" lang="java">        <span class="n">_dk_Wstring</span> <span class="o">=</span> <span class="mi">18</span><span class="o">,</span></span>
<span id="LC179" class="line" lang="java"></span>
<span id="LC180" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC181" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is of type</span></span>
<span id="LC182" class="line" lang="java"><span class="cm"> * Fixed.</span></span>
<span id="LC183" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC184" class="line" lang="java"></span>
<span id="LC185" class="line" lang="java">        <span class="n">_dk_Fixed</span> <span class="o">=</span> <span class="mi">19</span><span class="o">,</span></span>
<span id="LC186" class="line" lang="java"></span>
<span id="LC187" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC188" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is a</span></span>
<span id="LC189" class="line" lang="java"><span class="cm"> * Value.</span></span>
<span id="LC190" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC191" class="line" lang="java"></span>
<span id="LC192" class="line" lang="java">        <span class="n">_dk_Value</span> <span class="o">=</span> <span class="mi">20</span><span class="o">,</span></span>
<span id="LC193" class="line" lang="java"></span>
<span id="LC194" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC195" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is a</span></span>
<span id="LC196" class="line" lang="java"><span class="cm"> * ValueBox.</span></span>
<span id="LC197" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC198" class="line" lang="java"></span>
<span id="LC199" class="line" lang="java">        <span class="n">_dk_ValueBox</span> <span class="o">=</span> <span class="mi">21</span><span class="o">,</span></span>
<span id="LC200" class="line" lang="java"></span>
<span id="LC201" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC202" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is a</span></span>
<span id="LC203" class="line" lang="java"><span class="cm"> * ValueMember.</span></span>
<span id="LC204" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC205" class="line" lang="java"></span>
<span id="LC206" class="line" lang="java">        <span class="n">_dk_ValueMember</span> <span class="o">=</span> <span class="mi">22</span><span class="o">,</span></span>
<span id="LC207" class="line" lang="java"></span>
<span id="LC208" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC209" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object is of type</span></span>
<span id="LC210" class="line" lang="java"><span class="cm"> * Native.</span></span>
<span id="LC211" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC212" class="line" lang="java"></span>
<span id="LC213" class="line" lang="java">        <span class="n">_dk_Native</span> <span class="o">=</span> <span class="mi">23</span><span class="o">,</span></span>
<span id="LC214" class="line" lang="java"></span>
<span id="LC215" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC216" class="line" lang="java"><span class="cm"> * The constant that indicates that an Interface Repository object</span></span>
<span id="LC217" class="line" lang="java"><span class="cm"> * is representing an abstract interface.</span></span>
<span id="LC218" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC219" class="line" lang="java">        <span class="n">_dk_AbstractInterface</span> <span class="o">=</span> <span class="mi">24</span><span class="o">;</span></span>
<span id="LC220" class="line" lang="java"></span>
<span id="LC221" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC222" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC223" class="line" lang="java"><span class="cm"> * Interface Repository object has no definition kind.</span></span>
<span id="LC224" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC225" class="line" lang="java"></span>
<span id="LC226" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_none</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_none</span><span class="o">);</span></span>
<span id="LC227" class="line" lang="java"></span>
<span id="LC228" class="line" lang="java">     <span class="cm">/**</span></span>
<span id="LC229" class="line" lang="java"><span class="cm">         * The wildcard &lt;code&gt;DefinitionKind&lt;/code&gt; constant, useful</span></span>
<span id="LC230" class="line" lang="java"><span class="cm">         * in all occasions where any</span></span>
<span id="LC231" class="line" lang="java"><span class="cm">     * &lt;code&gt;DefinitionKind&lt;/code&gt; is appropriate. The Container's</span></span>
<span id="LC232" class="line" lang="java"><span class="cm">         * &lt;code&gt;contents&lt;/code&gt; method</span></span>
<span id="LC233" class="line" lang="java"><span class="cm">     * makes use of this constant to return all contained definitions of any kind.</span></span>
<span id="LC234" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC235" class="line" lang="java"></span>
<span id="LC236" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_all</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_all</span><span class="o">);</span></span>
<span id="LC237" class="line" lang="java"></span>
<span id="LC238" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC239" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC240" class="line" lang="java"><span class="cm"> * Interface Repository object is an Attribute.</span></span>
<span id="LC241" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC242" class="line" lang="java"></span>
<span id="LC243" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Attribute</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Attribute</span><span class="o">);</span></span>
<span id="LC244" class="line" lang="java"></span>
<span id="LC245" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC246" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC247" class="line" lang="java"><span class="cm"> * Interface Repository object is a constant.</span></span>
<span id="LC248" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC249" class="line" lang="java"></span>
<span id="LC250" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Constant</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Constant</span><span class="o">);</span></span>
...
<span id="LC254" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC255" class="line" lang="java"><span class="cm"> * Interface Repository object is an Exception.</span></span>
<span id="LC256" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC257" class="line" lang="java"></span>
<span id="LC258" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Exception</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Exception</span><span class="o">);</span></span>
<span id="LC259" class="line" lang="java"></span>
<span id="LC260" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC261" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC262" class="line" lang="java"><span class="cm"> * Interface Repository object is an Interface.</span></span>
<span id="LC263" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC264" class="line" lang="java"></span>
<span id="LC265" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Interface</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Interface</span><span class="o">);</span></span>
<span id="LC266" class="line" lang="java"></span>
<span id="LC267" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC268" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC269" class="line" lang="java"><span class="cm"> * Interface Repository object is a Module.</span></span>
<span id="LC270" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC271" class="line" lang="java"></span>
<span id="LC272" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Module</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Module</span><span class="o">);</span></span>
<span id="LC273" class="line" lang="java"></span>
<span id="LC274" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC275" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC276" class="line" lang="java"><span class="cm"> * Interface Repository object is an Operation.</span></span>
<span id="LC277" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC278" class="line" lang="java"></span>
<span id="LC279" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Operation</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Operation</span><span class="o">);</span></span>
<span id="LC280" class="line" lang="java"></span>
<span id="LC281" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC282" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC283" class="line" lang="java"><span class="cm"> * Interface Repository object is a Typedef.</span></span>
<span id="LC284" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC285" class="line" lang="java"></span>
<span id="LC286" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Typedef</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Typedef</span><span class="o">);</span></span>
<span id="LC287" class="line" lang="java"></span>
<span id="LC288" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC289" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC290" class="line" lang="java"><span class="cm"> * Interface Repository object is an Alias.</span></span>
<span id="LC291" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC292" class="line" lang="java"></span>
<span id="LC293" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Alias</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Alias</span><span class="o">);</span></span>
<span id="LC294" class="line" lang="java"></span>
<span id="LC295" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC296" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC297" class="line" lang="java"><span class="cm"> * Interface Repository object is a Struct.</span></span>
<span id="LC298" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC299" class="line" lang="java"></span>
<span id="LC300" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Struct</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Struct</span><span class="o">);</span></span>
<span id="LC301" class="line" lang="java"></span>
<span id="LC302" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC303" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC304" class="line" lang="java"><span class="cm"> * Interface Repository object is a Union.</span></span>
<span id="LC305" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC306" class="line" lang="java"></span>
<span id="LC307" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Union</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Union</span><span class="o">);</span></span>
<span id="LC308" class="line" lang="java"></span>
<span id="LC309" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC310" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC311" class="line" lang="java"><span class="cm"> * Interface Repository object is an Enum.</span></span>
<span id="LC312" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC313" class="line" lang="java"></span>
<span id="LC314" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Enum</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Enum</span><span class="o">);</span></span>
<span id="LC315" class="line" lang="java"></span>
<span id="LC316" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC317" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC318" class="line" lang="java"><span class="cm"> * Interface Repository object is a Primitive.</span></span>
<span id="LC319" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC320" class="line" lang="java"></span>
<span id="LC321" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Primitive</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Primitive</span><span class="o">);</span></span>
<span id="LC322" class="line" lang="java"></span>
<span id="LC323" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC324" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC325" class="line" lang="java"><span class="cm"> * Interface Repository object is a String.</span></span>
<span id="LC326" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC327" class="line" lang="java"></span>
<span id="LC328" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_String</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_String</span><span class="o">);</span></span>
<span id="LC329" class="line" lang="java"></span>
<span id="LC330" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC331" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC332" class="line" lang="java"><span class="cm"> * Interface Repository object is a Sequence.</span></span>
<span id="LC333" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC334" class="line" lang="java"></span>
<span id="LC335" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Sequence</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Sequence</span><span class="o">);</span></span>
<span id="LC336" class="line" lang="java"></span>
<span id="LC337" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC338" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC339" class="line" lang="java"><span class="cm"> * Interface Repository object is an Array.</span></span>
<span id="LC340" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC341" class="line" lang="java"></span>
<span id="LC342" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Array</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Array</span><span class="o">);</span></span>
...
<span id="LC346" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC347" class="line" lang="java"><span class="cm"> * Interface Repository object is a Repository.</span></span>
<span id="LC348" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC349" class="line" lang="java"></span>
<span id="LC350" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Repository</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Repository</span><span class="o">);</span></span>
...
<span id="LC354" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC355" class="line" lang="java"><span class="cm"> * Interface Repository object is a Wstring.</span></span>
<span id="LC356" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC357" class="line" lang="java"></span>
<span id="LC358" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Wstring</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Wstring</span><span class="o">);</span></span>
<span id="LC359" class="line" lang="java"></span>
<span id="LC360" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC361" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC362" class="line" lang="java"><span class="cm"> * Interface Repository object is a Fixed value.</span></span>
<span id="LC363" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC364" class="line" lang="java"></span>
<span id="LC365" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Fixed</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Fixed</span><span class="o">);</span></span>
<span id="LC366" class="line" lang="java"></span>
<span id="LC367" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC368" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC369" class="line" lang="java"><span class="cm"> * Interface Repository object is a Value.</span></span>
<span id="LC370" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC371" class="line" lang="java"></span>
<span id="LC372" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Value</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Value</span><span class="o">);</span></span>
<span id="LC373" class="line" lang="java"></span>
<span id="LC374" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC375" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC376" class="line" lang="java"><span class="cm"> * Interface Repository object is a ValueBox.</span></span>
<span id="LC377" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC378" class="line" lang="java"></span>
<span id="LC379" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_ValueBox</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_ValueBox</span><span class="o">);</span></span>
<span id="LC380" class="line" lang="java"></span>
<span id="LC381" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC382" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC383" class="line" lang="java"><span class="cm"> * Interface Repository object is a ValueMember.</span></span>
<span id="LC384" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC385" class="line" lang="java"></span>
<span id="LC386" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_ValueMember</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_ValueMember</span><span class="o">);</span></span>
...
<span id="LC390" class="line" lang="java"><span class="cm"> * The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC391" class="line" lang="java"><span class="cm"> * Interface Repository object is a Native value.</span></span>
<span id="LC392" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC393" class="line" lang="java"></span>
<span id="LC394" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_Native</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_Native</span><span class="o">);</span></span>
...
<span id="LC398" class="line" lang="java"><span class="cm">* The static instance of &lt;code&gt;DefinitionKind&lt;/code&gt; indicating that an</span></span>
<span id="LC399" class="line" lang="java"><span class="cm">* Interface Repository object represents an abstract interface.</span></span>
<span id="LC400" class="line" lang="java"><span class="cm">*/</span></span>
<span id="LC401" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">DefinitionKind</span> <span class="n">dk_AbstractInterface</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DefinitionKind</span><span class="o">(</span><span class="n">_dk_AbstractInterface</span><span class="o">);</span></span>
...
<span id="LC405" class="line" lang="java"><span class="cm">     * Returns the &lt;code&gt;int&lt;/code&gt; constant identifying the type of an IR object.</span></span>
<span id="LC406" class="line" lang="java"><span class="cm">     * @return the &lt;code&gt;int&lt;/code&gt; constant from the class</span></span>
<span id="LC407" class="line" lang="java"><span class="cm">         * &lt;code&gt;DefinitionKind&lt;/code&gt; that is the value of this</span></span>
<span id="LC408" class="line" lang="java"><span class="cm">         * &lt;code&gt;DefinitionKind&lt;/code&gt; instance</span></span>
<span id="LC409" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC410" class="line" lang="java"></span>
<span id="LC411" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">value</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC412" class="line" lang="java">        <span class="k">return</span> <span class="n">_value</span><span class="o">;</span></span>
...
<span id="LC417" class="line" lang="java"><span class="cm">     * Creates a &lt;code&gt;DefinitionKind&lt;/code&gt; instance corresponding to the given code</span></span>
<span id="LC418" class="line" lang="java"><span class="cm">.</span></span>
<span id="LC419" class="line" lang="java"><span class="cm">     * @param i one of the &lt;code&gt;int&lt;/code&gt; constants from the class</span></span>
<span id="LC420" class="line" lang="java"><span class="cm">         * &lt;code&gt;DefinitionKind&lt;/code&gt;</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">         * @return the &lt;code&gt;DefinitionKind&lt;/code&gt; instance corresponding</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">         *         to the given code</span></span>
<span id="LC423" class="line" lang="java"><span class="cm">         * @throws org.omg.CORBA.BAD_PARAM if the given parameter is not</span></span>
<span id="LC424" class="line" lang="java"><span class="cm"> one</span></span>
<span id="LC425" class="line" lang="java"><span class="cm">         *         of the &lt;code&gt;int&lt;/code&gt; constants from the class</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">         *         &lt;code&gt;DefinitionKind&lt;/code&gt;</span></span>
<span id="LC427" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC428" class="line" lang="java"></span>
<span id="LC429" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="nc">DefinitionKind</span> <span class="nf">from_int</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC430" class="line" lang="java">        <span class="k">switch</span> <span class="o">(</span><span class="n">i</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC431" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_none:</span></span>
<span id="LC432" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_none</span><span class="o">;</span></span>
<span id="LC433" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_all:</span></span>
<span id="LC434" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_all</span><span class="o">;</span></span>
<span id="LC435" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Attribute:</span></span>
<span id="LC436" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Attribute</span><span class="o">;</span></span>
<span id="LC437" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Constant:</span></span>
<span id="LC438" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Constant</span><span class="o">;</span></span>
<span id="LC439" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Exception:</span></span>
<span id="LC440" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Exception</span><span class="o">;</span></span>
<span id="LC441" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Interface:</span></span>
<span id="LC442" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Interface</span><span class="o">;</span></span>
<span id="LC443" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Module:</span></span>
<span id="LC444" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Module</span><span class="o">;</span></span>
<span id="LC445" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Operation:</span></span>
<span id="LC446" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Operation</span><span class="o">;</span></span>
<span id="LC447" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Typedef:</span></span>
<span id="LC448" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Typedef</span><span class="o">;</span></span>
<span id="LC449" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Alias:</span></span>
<span id="LC450" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Alias</span><span class="o">;</span></span>
<span id="LC451" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Struct:</span></span>
<span id="LC452" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Struct</span><span class="o">;</span></span>
<span id="LC453" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Union:</span></span>
<span id="LC454" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Union</span><span class="o">;</span></span>
<span id="LC455" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Enum:</span></span>
<span id="LC456" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Enum</span><span class="o">;</span></span>
<span id="LC457" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Primitive:</span></span>
<span id="LC458" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Primitive</span><span class="o">;</span></span>
<span id="LC459" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_String:</span></span>
<span id="LC460" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_String</span><span class="o">;</span></span>
<span id="LC461" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Sequence:</span></span>
<span id="LC462" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Sequence</span><span class="o">;</span></span>
<span id="LC463" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Array:</span></span>
<span id="LC464" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Array</span><span class="o">;</span></span>
<span id="LC465" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Repository:</span></span>
<span id="LC466" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Repository</span><span class="o">;</span></span>
<span id="LC467" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Wstring:</span></span>
<span id="LC468" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Wstring</span><span class="o">;</span></span>
<span id="LC469" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Fixed:</span></span>
<span id="LC470" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Fixed</span><span class="o">;</span></span>
<span id="LC471" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Value:</span></span>
<span id="LC472" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Value</span><span class="o">;</span></span>
<span id="LC473" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_ValueBox:</span></span>
<span id="LC474" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_ValueBox</span><span class="o">;</span></span>
<span id="LC475" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_ValueMember:</span></span>
<span id="LC476" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_ValueMember</span><span class="o">;</span></span>
<span id="LC477" class="line" lang="java">        <span class="k">case</span> <span class="nl">_dk_Native:</span></span>
<span id="LC478" class="line" lang="java">            <span class="k">return</span> <span class="n">dk_Native</span><span class="o">;</span></span>
<span id="LC479" class="line" lang="java">        <span class="k">default</span><span class="o">:</span></span>
<span id="LC480" class="line" lang="java">            <span class="k">throw</span> <span class="k">new</span> <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">CORBA</span><span class="o">.</span><span class="na">BAD_PARAM</span><span class="o">();</span></span>
...
<span id="LC485" class="line" lang="java"><span class="cm">    * Constructs a &lt;code&gt;DefinitionKind&lt;/code&gt; object with its &lt;code&gt;_value&lt;/code&gt;</span></span>
<span id="LC486" class="line" lang="java"><span class="cm">    * field initialized with the given value.</span></span>
<span id="LC487" class="line" lang="java"><span class="cm">    * @param _value one of the &lt;code&gt;int&lt;/code&gt; constants defined in the</span></span>
<span id="LC488" class="line" lang="java"><span class="cm">    *                   class &lt;code&gt;DefinitionKind&lt;/code&gt;</span></span>
<span id="LC489" class="line" lang="java"><span class="cm">    */</span></span>
<span id="LC490" class="line" lang="java"></span>
<span id="LC491" class="line" lang="java">    <span class="kd">protected</span> <span class="nf">DefinitionKind</span><span class="o">(</span><span class="kt">int</span> <span class="n">_value</span><span class="o">){</span></span>
<span id="LC492" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">_value</span> <span class="o">=</span> <span class="n">_value</span><span class="o">;</span></span>
...
<span id="LC496" class="line" lang="java"><span class="cm">      * The field that holds a value for a &lt;code&gt;DefinitionKind&lt;/code&gt; object.</span></span>
<span id="LC497" class="line" lang="java"><span class="cm">      * @serial</span></span>
<span id="LC498" class="line" lang="java"><span class="cm">      */</span></span>
<span id="LC499" class="line" lang="java"></span>
<span id="LC500" class="line" lang="java">    <span class="kd">private</span> <span class="kt">int</span> <span class="n">_value</span><span class="o">;</span></span>
