...
<span id="LC5" class="line" lang="java"><span class="cm">* org/omg/PortableInterceptor/INACTIVE.java .</span></span>
...
<span id="LC11" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">INACTIVE</span></span>
<span id="LC12" class="line" lang="java"><span class="o">{</span></span>
<span id="LC13" class="line" lang="java"></span>
<span id="LC14" class="line" lang="java">  <span class="cm">/** Object adapter state that causes all requests to be discarded.</span></span>
<span id="LC15" class="line" lang="java"><span class="cm">     * This state indicates that the adapter is shutting down.</span></span>
<span id="LC16" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC17" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">short</span> <span class="n">value</span> <span class="o">=</span> <span class="o">(</span><span class="kt">short</span><span class="o">)(</span><span class="mi">3</span><span class="o">);</span></span>
