...
<span id="LC5" class="line" lang="java"><span class="cm">* org/omg/PortableInterceptor/ServerRequestInterceptor.java .</span></span>
...
<span id="LC28" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">ServerRequestInterceptor</span> <span class="kd">extends</span> <span class="nc">ServerRequestInterceptorOperations</span><span class="o">,</span> <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">PortableInterceptor</span><span class="o">.</span><span class="na">Interceptor</span><span class="o">,</span> <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">CORBA</span><span class="o">.</span><span class="na">portable</span><span class="o">.</span><span class="na">IDLEntity</span> </span>
<span id="LC29" class="line" lang="java"><span class="o">{</span></span>
<span id="LC30" class="line" lang="java"><span class="o">}</span> <span class="c1">// interface ServerRequestInterceptor</span></span>
