...
<span id="LC4" class="line" lang="java"><span class="cm">* org/omg/IOP/TaggedComponentHolder.java .</span></span>
<span id="LC5" class="line" lang="java"><span class="cm">* Generated by the IDL-to-Java compiler (portable), version "3.2"</span></span>
<span id="LC6" class="line" lang="java"><span class="cm">* from /HUDSON/workspace/8-2-build-linux-amd64/jdk8u202/12319/corba/src/share/classes/org/omg/PortableInterceptor/IOP.idl</span></span>
...
<span id="LC10" class="line" lang="java"><span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">TaggedComponentHolder</span> <span class="kd">implements</span> <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">CORBA</span><span class="o">.</span><span class="na">portable</span><span class="o">.</span><span class="na">Streamable</span></span>
<span id="LC11" class="line" lang="java"><span class="o">{</span></span>
<span id="LC12" class="line" lang="java">  <span class="kd">public</span> <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">IOP</span><span class="o">.</span><span class="na">TaggedComponent</span> <span class="n">value</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC13" class="line" lang="java"></span>
<span id="LC14" class="line" lang="java">  <span class="kd">public</span> <span class="nf">TaggedComponentHolder</span> <span class="o">()</span></span>
...
<span id="LC18" class="line" lang="java">  <span class="kd">public</span> <span class="nf">TaggedComponentHolder</span> <span class="o">(</span><span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">IOP</span><span class="o">.</span><span class="na">TaggedComponent</span> <span class="n">initialValue</span><span class="o">)</span></span>
...
<span id="LC25" class="line" lang="java">    <span class="n">value</span> <span class="o">=</span> <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">IOP</span><span class="o">.</span><span class="na">TaggedComponentHelper</span><span class="o">.</span><span class="na">read</span> <span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
...
<span id="LC30" class="line" lang="java">    <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">IOP</span><span class="o">.</span><span class="na">TaggedComponentHelper</span><span class="o">.</span><span class="na">write</span> <span class="o">(</span><span class="n">o</span><span class="o">,</span> <span class="n">value</span><span class="o">);</span></span>
...
<span id="LC35" class="line" lang="java">    <span class="k">return</span> <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">IOP</span><span class="o">.</span><span class="na">TaggedComponentHelper</span><span class="o">.</span><span class="na">type</span> <span class="o">();</span></span>
