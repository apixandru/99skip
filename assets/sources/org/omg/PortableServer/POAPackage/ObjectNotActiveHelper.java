...
<span id="LC5" class="line" lang="java"><span class="cm">* org/omg/PortableServer/POAPackage/ObjectNotActiveHelper.java .</span></span>
...
<span id="LC11" class="line" lang="java"><span class="kd">abstract</span> <span class="kd">public</span> <span class="kd">class</span> <span class="nc">ObjectNotActiveHelper</span></span>
<span id="LC12" class="line" lang="java"><span class="o">{</span></span>
<span id="LC13" class="line" lang="java">  <span class="kd">private</span> <span class="kd">static</span> <span class="nc">String</span>  <span class="n">_id</span> <span class="o">=</span> <span class="s">"IDL:omg.org/PortableServer/POA/ObjectNotActive:1.0"</span><span class="o">;</span></span>
<span id="LC14" class="line" lang="java"></span>
<span id="LC15" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kt">void</span> <span class="nf">insert</span> <span class="o">(</span><span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">CORBA</span><span class="o">.</span><span class="na">Any</span> <span class="n">a</span><span class="o">,</span> <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">PortableServer</span><span class="o">.</span><span class="na">POAPackage</span><span class="o">.</span><span class="na">ObjectNotActive</span> <span class="n">that</span><span class="o">)</span></span>
...
<span id="LC23" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">PortableServer</span><span class="o">.</span><span class="na">POAPackage</span><span class="o">.</span><span class="na">ObjectNotActive</span> <span class="nf">extract</span> <span class="o">(</span><span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">CORBA</span><span class="o">.</span><span class="na">Any</span> <span class="n">a</span><span class="o">)</span></span>
...
<span id="LC45" class="line" lang="java">          <span class="n">__typeCode</span> <span class="o">=</span> <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">CORBA</span><span class="o">.</span><span class="na">ORB</span><span class="o">.</span><span class="na">init</span> <span class="o">().</span><span class="na">create_exception_tc</span> <span class="o">(</span><span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">PortableServer</span><span class="o">.</span><span class="na">POAPackage</span><span class="o">.</span><span class="na">ObjectNotActiveHelper</span><span class="o">.</span><span class="na">id</span> <span class="o">(),</span> <span class="s">"ObjectNotActive"</span><span class="o">,</span> <span class="n">_members0</span><span class="o">);</span></span>
...
<span id="LC58" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">PortableServer</span><span class="o">.</span><span class="na">POAPackage</span><span class="o">.</span><span class="na">ObjectNotActive</span> <span class="nf">read</span> <span class="o">(</span><span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">CORBA</span><span class="o">.</span><span class="na">portable</span><span class="o">.</span><span class="na">InputStream</span> <span class="n">istream</span><span class="o">)</span></span>
<span id="LC59" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC60" class="line" lang="java">    <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">PortableServer</span><span class="o">.</span><span class="na">POAPackage</span><span class="o">.</span><span class="na">ObjectNotActive</span> <span class="n">value</span> <span class="o">=</span> <span class="k">new</span> <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">PortableServer</span><span class="o">.</span><span class="na">POAPackage</span><span class="o">.</span><span class="na">ObjectNotActive</span> <span class="o">();</span></span>
...
<span id="LC66" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kt">void</span> <span class="nf">write</span> <span class="o">(</span><span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">CORBA</span><span class="o">.</span><span class="na">portable</span><span class="o">.</span><span class="na">OutputStream</span> <span class="n">ostream</span><span class="o">,</span> <span class="n">org</span><span class="o">.</span><span class="na">omg</span><span class="o">.</span><span class="na">PortableServer</span><span class="o">.</span><span class="na">POAPackage</span><span class="o">.</span><span class="na">ObjectNotActive</span> <span class="n">value</span><span class="o">)</span></span>
