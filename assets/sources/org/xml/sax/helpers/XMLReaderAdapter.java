...
<span id="LC26" class="line" lang="java"><span class="c1">// XMLReaderAdapter.java - adapt an SAX2 XMLReader to a SAX1 Parser</span></span>
...
<span id="LC30" class="line" lang="java"><span class="c1">// $Id: XMLReaderAdapter.java,v 1.3 2004/11/03 22:53:09 jsuttor Exp $</span></span>
...
<span id="LC37" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.Parser</span><span class="o">;</span>      <span class="c1">// deprecated</span></span>
...
<span id="LC40" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.AttributeList</span><span class="o">;</span> <span class="c1">// deprecated</span></span>
...
<span id="LC43" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.DocumentHandler</span><span class="o">;</span> <span class="c1">// deprecated</span></span>
...
<span id="LC47" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.XMLReader</span><span class="o">;</span></span>
<span id="LC48" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.Attributes</span><span class="o">;</span></span>
<span id="LC49" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.ContentHandler</span><span class="o">;</span></span>
<span id="LC50" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.SAXNotSupportedException</span><span class="o">;</span></span>
...
<span id="LC54" class="line" lang="java"><span class="cm"> * Adapt a SAX2 XMLReader as a SAX1 Parser.</span></span>
...
<span id="LC57" class="line" lang="java"><span class="cm"> * &lt;em&gt;This module, both source code and documentation, is in the</span></span>
<span id="LC58" class="line" lang="java"><span class="cm"> * Public Domain, and comes with &lt;strong&gt;NO WARRANTY&lt;/strong&gt;.&lt;/em&gt;</span></span>
<span id="LC59" class="line" lang="java"><span class="cm"> * See &lt;a href='http://www.saxproject.org'&gt;http://www.saxproject.org&lt;/a&gt;</span></span>
<span id="LC60" class="line" lang="java"><span class="cm"> * for further information.</span></span>
...
<span id="LC63" class="line" lang="java"><span class="cm"> * &lt;p&gt;This class wraps a SAX2 {@link org.xml.sax.XMLReader XMLReader}</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> * and makes it act as a SAX1 {@link org.xml.sax.Parser Parser}.  The XMLReader</span></span>
<span id="LC65" class="line" lang="java"><span class="cm"> * must support a true value for the</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> * http://xml.org/sax/features/namespace-prefixes property or parsing will fail</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> * with a {@link org.xml.sax.SAXException SAXException}; if the XMLReader</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> * supports a false value for the http://xml.org/sax/features/namespaces</span></span>
<span id="LC69" class="line" lang="java"><span class="cm"> * property, that will also be used to improve efficiency.&lt;/p&gt;</span></span>
<span id="LC70" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC71" class="line" lang="java"><span class="cm"> * @since SAX 2.0</span></span>
<span id="LC72" class="line" lang="java"><span class="cm"> * @author David Megginson</span></span>
<span id="LC73" class="line" lang="java"><span class="cm"> * @see org.xml.sax.Parser</span></span>
<span id="LC74" class="line" lang="java"><span class="cm"> * @see org.xml.sax.XMLReader</span></span>
<span id="LC75" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC76" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XMLReaderAdapter</span> <span class="kd">implements</span> <span class="nc">Parser</span><span class="o">,</span> <span class="nc">ContentHandler</span></span>
...
<span id="LC81" class="line" lang="java">    <span class="c1">// Constructor.</span></span>
...
<span id="LC86" class="line" lang="java"><span class="cm">     * Create a new adapter.</span></span>
<span id="LC87" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC88" class="line" lang="java"><span class="cm">     * &lt;p&gt;Use the "org.xml.sax.driver" property to locate the SAX2</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">     * driver to embed.&lt;/p&gt;</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException If the embedded driver</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">     *            cannot be instantiated or if the</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">     *            org.xml.sax.driver property is not specified.</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC95" class="line" lang="java">    <span class="kd">public</span> <span class="nf">XMLReaderAdapter</span> <span class="o">()</span></span>
<span id="LC96" class="line" lang="java">      <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC97" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC98" class="line" lang="java">        <span class="n">setup</span><span class="o">(</span><span class="nc">XMLReaderFactory</span><span class="o">.</span><span class="na">createXMLReader</span><span class="o">());</span></span>
...
<span id="LC103" class="line" lang="java"><span class="cm">     * Create a new adapter.</span></span>
<span id="LC104" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC105" class="line" lang="java"><span class="cm">     * &lt;p&gt;Create a new adapter, wrapped around a SAX2 XMLReader.</span></span>
<span id="LC106" class="line" lang="java"><span class="cm">     * The adapter will make the XMLReader act like a SAX1</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">     * Parser.&lt;/p&gt;</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC109" class="line" lang="java"><span class="cm">     * @param xmlReader The SAX2 XMLReader to wrap.</span></span>
<span id="LC110" class="line" lang="java"><span class="cm">     * @exception java.lang.NullPointerException If the argument is null.</span></span>
<span id="LC111" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC112" class="line" lang="java">    <span class="kd">public</span> <span class="nf">XMLReaderAdapter</span> <span class="o">(</span><span class="nc">XMLReader</span> <span class="n">xmlReader</span><span class="o">)</span></span>
<span id="LC113" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC114" class="line" lang="java">        <span class="n">setup</span><span class="o">(</span><span class="n">xmlReader</span><span class="o">);</span></span>
...
<span id="LC120" class="line" lang="java"><span class="cm">     * Internal setup.</span></span>
<span id="LC121" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC122" class="line" lang="java"><span class="cm">     * @param xmlReader The embedded XMLReader.</span></span>
<span id="LC123" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC124" class="line" lang="java">    <span class="kd">private</span> <span class="kt">void</span> <span class="nf">setup</span> <span class="o">(</span><span class="nc">XMLReader</span> <span class="n">xmlReader</span><span class="o">)</span></span>
<span id="LC125" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC126" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">xmlReader</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC127" class="line" lang="java">            <span class="k">throw</span> <span class="k">new</span> <span class="nf">NullPointerException</span><span class="o">(</span><span class="s">"XMLReader must not be null"</span><span class="o">);</span></span>
<span id="LC128" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC129" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">xmlReader</span> <span class="o">=</span> <span class="n">xmlReader</span><span class="o">;</span></span>
<span id="LC130" class="line" lang="java">        <span class="n">qAtts</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">AttributesAdapter</span><span class="o">();</span></span>
...
<span id="LC136" class="line" lang="java">    <span class="c1">// Implementation of org.xml.sax.Parser.</span></span>
...
<span id="LC141" class="line" lang="java"><span class="cm">     * Set the locale for error reporting.</span></span>
<span id="LC142" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC143" class="line" lang="java"><span class="cm">     * &lt;p&gt;This is not supported in SAX2, and will always throw</span></span>
<span id="LC144" class="line" lang="java"><span class="cm">     * an exception.&lt;/p&gt;</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">     * @param locale the locale for error reporting.</span></span>
<span id="LC147" class="line" lang="java"><span class="cm">     * @see org.xml.sax.Parser#setLocale</span></span>
<span id="LC148" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException Thrown unless overridden.</span></span>
<span id="LC149" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC150" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setLocale</span> <span class="o">(</span><span class="nc">Locale</span> <span class="n">locale</span><span class="o">)</span></span>
<span id="LC151" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC152" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC153" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">SAXNotSupportedException</span><span class="o">(</span><span class="s">"setLocale not supported"</span><span class="o">);</span></span>
...
<span id="LC158" class="line" lang="java"><span class="cm">     * Register the entity resolver.</span></span>
<span id="LC159" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC160" class="line" lang="java"><span class="cm">     * @param resolver The new resolver.</span></span>
<span id="LC161" class="line" lang="java"><span class="cm">     * @see org.xml.sax.Parser#setEntityResolver</span></span>
<span id="LC162" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC163" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setEntityResolver</span> <span class="o">(</span><span class="nc">EntityResolver</span> <span class="n">resolver</span><span class="o">)</span></span>
<span id="LC164" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC165" class="line" lang="java">        <span class="n">xmlReader</span><span class="o">.</span><span class="na">setEntityResolver</span><span class="o">(</span><span class="n">resolver</span><span class="o">);</span></span>
...
<span id="LC170" class="line" lang="java"><span class="cm">     * Register the DTD event handler.</span></span>
<span id="LC171" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC172" class="line" lang="java"><span class="cm">     * @param handler The new DTD event handler.</span></span>
<span id="LC173" class="line" lang="java"><span class="cm">     * @see org.xml.sax.Parser#setDTDHandler</span></span>
<span id="LC174" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC175" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDTDHandler</span> <span class="o">(</span><span class="nc">DTDHandler</span> <span class="n">handler</span><span class="o">)</span></span>
<span id="LC176" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC177" class="line" lang="java">        <span class="n">xmlReader</span><span class="o">.</span><span class="na">setDTDHandler</span><span class="o">(</span><span class="n">handler</span><span class="o">);</span></span>
...
<span id="LC182" class="line" lang="java"><span class="cm">     * Register the SAX1 document event handler.</span></span>
<span id="LC183" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC184" class="line" lang="java"><span class="cm">     * &lt;p&gt;Note that the SAX1 document handler has no Namespace</span></span>
<span id="LC185" class="line" lang="java"><span class="cm">     * support.&lt;/p&gt;</span></span>
<span id="LC186" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC187" class="line" lang="java"><span class="cm">     * @param handler The new SAX1 document event handler.</span></span>
<span id="LC188" class="line" lang="java"><span class="cm">     * @see org.xml.sax.Parser#setDocumentHandler</span></span>
<span id="LC189" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC190" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDocumentHandler</span> <span class="o">(</span><span class="nc">DocumentHandler</span> <span class="n">handler</span><span class="o">)</span></span>
<span id="LC191" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC192" class="line" lang="java">        <span class="n">documentHandler</span> <span class="o">=</span> <span class="n">handler</span><span class="o">;</span></span>
...
<span id="LC197" class="line" lang="java"><span class="cm">     * Register the error event handler.</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC199" class="line" lang="java"><span class="cm">     * @param handler The new error event handler.</span></span>
<span id="LC200" class="line" lang="java"><span class="cm">     * @see org.xml.sax.Parser#setErrorHandler</span></span>
<span id="LC201" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC202" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setErrorHandler</span> <span class="o">(</span><span class="nc">ErrorHandler</span> <span class="n">handler</span><span class="o">)</span></span>
<span id="LC203" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC204" class="line" lang="java">        <span class="n">xmlReader</span><span class="o">.</span><span class="na">setErrorHandler</span><span class="o">(</span><span class="n">handler</span><span class="o">);</span></span>
...
<span id="LC209" class="line" lang="java"><span class="cm">     * Parse the document.</span></span>
<span id="LC210" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC211" class="line" lang="java"><span class="cm">     * &lt;p&gt;This method will throw an exception if the embedded</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">     * XMLReader does not support the</span></span>
<span id="LC213" class="line" lang="java"><span class="cm">     * http://xml.org/sax/features/namespace-prefixes property.&lt;/p&gt;</span></span>
<span id="LC214" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC215" class="line" lang="java"><span class="cm">     * @param systemId The absolute URL of the document.</span></span>
<span id="LC216" class="line" lang="java"><span class="cm">     * @exception java.io.IOException If there is a problem reading</span></span>
<span id="LC217" class="line" lang="java"><span class="cm">     *            the raw content of the document.</span></span>
<span id="LC218" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException If there is a problem</span></span>
<span id="LC219" class="line" lang="java"><span class="cm">     *            processing the document.</span></span>
<span id="LC220" class="line" lang="java"><span class="cm">     * @see #parse(org.xml.sax.InputSource)</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">     * @see org.xml.sax.Parser#parse(java.lang.String)</span></span>
<span id="LC222" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC223" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">parse</span> <span class="o">(</span><span class="nc">String</span> <span class="n">systemId</span><span class="o">)</span></span>
<span id="LC224" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">IOException</span><span class="o">,</span> <span class="nc">SAXException</span></span>
<span id="LC225" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC226" class="line" lang="java">        <span class="n">parse</span><span class="o">(</span><span class="k">new</span> <span class="nc">InputSource</span><span class="o">(</span><span class="n">systemId</span><span class="o">));</span></span>
...
<span id="LC231" class="line" lang="java"><span class="cm">     * Parse the document.</span></span>
<span id="LC232" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC233" class="line" lang="java"><span class="cm">     * &lt;p&gt;This method will throw an exception if the embedded</span></span>
<span id="LC234" class="line" lang="java"><span class="cm">     * XMLReader does not support the</span></span>
<span id="LC235" class="line" lang="java"><span class="cm">     * http://xml.org/sax/features/namespace-prefixes property.&lt;/p&gt;</span></span>
<span id="LC236" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC237" class="line" lang="java"><span class="cm">     * @param input An input source for the document.</span></span>
<span id="LC238" class="line" lang="java"><span class="cm">     * @exception java.io.IOException If there is a problem reading</span></span>
<span id="LC239" class="line" lang="java"><span class="cm">     *            the raw content of the document.</span></span>
<span id="LC240" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException If there is a problem</span></span>
<span id="LC241" class="line" lang="java"><span class="cm">     *            processing the document.</span></span>
<span id="LC242" class="line" lang="java"><span class="cm">     * @see #parse(java.lang.String)</span></span>
<span id="LC243" class="line" lang="java"><span class="cm">     * @see org.xml.sax.Parser#parse(org.xml.sax.InputSource)</span></span>
<span id="LC244" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC245" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">parse</span> <span class="o">(</span><span class="nc">InputSource</span> <span class="n">input</span><span class="o">)</span></span>
<span id="LC246" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">IOException</span><span class="o">,</span> <span class="nc">SAXException</span></span>
<span id="LC247" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC248" class="line" lang="java">        <span class="n">setupXMLReader</span><span class="o">();</span></span>
<span id="LC249" class="line" lang="java">        <span class="n">xmlReader</span><span class="o">.</span><span class="na">parse</span><span class="o">(</span><span class="n">input</span><span class="o">);</span></span>
...
<span id="LC254" class="line" lang="java"><span class="cm">     * Set up the XML reader.</span></span>
<span id="LC255" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC256" class="line" lang="java">    <span class="kd">private</span> <span class="kt">void</span> <span class="nf">setupXMLReader</span> <span class="o">()</span></span>
<span id="LC257" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC258" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC259" class="line" lang="java">        <span class="n">xmlReader</span><span class="o">.</span><span class="na">setFeature</span><span class="o">(</span><span class="s">"http://xml.org/sax/features/namespace-prefixes"</span><span class="o">,</span> <span class="kc">true</span><span class="o">);</span></span>
<span id="LC260" class="line" lang="java">        <span class="k">try</span> <span class="o">{</span></span>
<span id="LC261" class="line" lang="java">            <span class="n">xmlReader</span><span class="o">.</span><span class="na">setFeature</span><span class="o">(</span><span class="s">"http://xml.org/sax/features/namespaces"</span><span class="o">,</span></span>
<span id="LC262" class="line" lang="java">                                 <span class="kc">false</span><span class="o">);</span></span>
<span id="LC263" class="line" lang="java">        <span class="o">}</span> <span class="k">catch</span> <span class="o">(</span><span class="nc">SAXException</span> <span class="n">e</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC264" class="line" lang="java">            <span class="c1">// NO OP: it's just extra information, and we can ignore it</span></span>
<span id="LC265" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC266" class="line" lang="java">        <span class="n">xmlReader</span><span class="o">.</span><span class="na">setContentHandler</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
...
<span id="LC272" class="line" lang="java">    <span class="c1">// Implementation of org.xml.sax.ContentHandler.</span></span>
...
<span id="LC277" class="line" lang="java"><span class="cm">     * Set a document locator.</span></span>
<span id="LC278" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC279" class="line" lang="java"><span class="cm">     * @param locator The document locator.</span></span>
<span id="LC280" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#setDocumentLocator</span></span>
<span id="LC281" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC282" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDocumentLocator</span> <span class="o">(</span><span class="nc">Locator</span> <span class="n">locator</span><span class="o">)</span></span>
<span id="LC283" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC284" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">documentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC285" class="line" lang="java">            <span class="n">documentHandler</span><span class="o">.</span><span class="na">setDocumentLocator</span><span class="o">(</span><span class="n">locator</span><span class="o">);</span></span>
...
<span id="LC290" class="line" lang="java"><span class="cm">     * Start document event.</span></span>
<span id="LC291" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC292" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may raise a</span></span>
<span id="LC293" class="line" lang="java"><span class="cm">     *            processing exception.</span></span>
<span id="LC294" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#startDocument</span></span>
<span id="LC295" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC296" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startDocument</span> <span class="o">()</span></span>
<span id="LC297" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC298" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC299" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">documentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC300" class="line" lang="java">            <span class="n">documentHandler</span><span class="o">.</span><span class="na">startDocument</span><span class="o">();</span></span>
...
<span id="LC305" class="line" lang="java"><span class="cm">     * End document event.</span></span>
<span id="LC306" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC307" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may raise a</span></span>
<span id="LC308" class="line" lang="java"><span class="cm">     *            processing exception.</span></span>
<span id="LC309" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#endDocument</span></span>
<span id="LC310" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC311" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endDocument</span> <span class="o">()</span></span>
<span id="LC312" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC313" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC314" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">documentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC315" class="line" lang="java">            <span class="n">documentHandler</span><span class="o">.</span><span class="na">endDocument</span><span class="o">();</span></span>
...
<span id="LC320" class="line" lang="java"><span class="cm">     * Adapt a SAX2 start prefix mapping event.</span></span>
<span id="LC321" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC322" class="line" lang="java"><span class="cm">     * @param prefix The prefix being mapped.</span></span>
<span id="LC323" class="line" lang="java"><span class="cm">     * @param uri The Namespace URI being mapped to.</span></span>
<span id="LC324" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#startPrefixMapping</span></span>
<span id="LC325" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC326" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startPrefixMapping</span> <span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">,</span> <span class="nc">String</span> <span class="n">uri</span><span class="o">)</span></span>
...
<span id="LC332" class="line" lang="java"><span class="cm">     * Adapt a SAX2 end prefix mapping event.</span></span>
<span id="LC333" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC334" class="line" lang="java"><span class="cm">     * @param prefix The prefix being mapped.</span></span>
<span id="LC335" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#endPrefixMapping</span></span>
<span id="LC336" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC337" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endPrefixMapping</span> <span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">)</span></span>
...
<span id="LC343" class="line" lang="java"><span class="cm">     * Adapt a SAX2 start element event.</span></span>
<span id="LC344" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC345" class="line" lang="java"><span class="cm">     * @param uri The Namespace URI.</span></span>
<span id="LC346" class="line" lang="java"><span class="cm">     * @param localName The Namespace local name.</span></span>
<span id="LC347" class="line" lang="java"><span class="cm">     * @param qName The qualified (prefixed) name.</span></span>
<span id="LC348" class="line" lang="java"><span class="cm">     * @param atts The SAX2 attributes.</span></span>
<span id="LC349" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may raise a</span></span>
<span id="LC350" class="line" lang="java"><span class="cm">     *            processing exception.</span></span>
<span id="LC351" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#endDocument</span></span>
<span id="LC352" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC353" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startElement</span> <span class="o">(</span><span class="nc">String</span> <span class="n">uri</span><span class="o">,</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span></span>
<span id="LC354" class="line" lang="java">                              <span class="nc">String</span> <span class="n">qName</span><span class="o">,</span> <span class="nc">Attributes</span> <span class="n">atts</span><span class="o">)</span></span>
<span id="LC355" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC356" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC357" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">documentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC358" class="line" lang="java">            <span class="n">qAtts</span><span class="o">.</span><span class="na">setAttributes</span><span class="o">(</span><span class="n">atts</span><span class="o">);</span></span>
<span id="LC359" class="line" lang="java">            <span class="n">documentHandler</span><span class="o">.</span><span class="na">startElement</span><span class="o">(</span><span class="n">qName</span><span class="o">,</span> <span class="n">qAtts</span><span class="o">);</span></span>
...
<span id="LC365" class="line" lang="java"><span class="cm">     * Adapt a SAX2 end element event.</span></span>
<span id="LC366" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC367" class="line" lang="java"><span class="cm">     * @param uri The Namespace URI.</span></span>
<span id="LC368" class="line" lang="java"><span class="cm">     * @param localName The Namespace local name.</span></span>
<span id="LC369" class="line" lang="java"><span class="cm">     * @param qName The qualified (prefixed) name.</span></span>
<span id="LC370" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may raise a</span></span>
<span id="LC371" class="line" lang="java"><span class="cm">     *            processing exception.</span></span>
<span id="LC372" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#endElement</span></span>
<span id="LC373" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC374" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endElement</span> <span class="o">(</span><span class="nc">String</span> <span class="n">uri</span><span class="o">,</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span></span>
<span id="LC375" class="line" lang="java">                            <span class="nc">String</span> <span class="n">qName</span><span class="o">)</span></span>
<span id="LC376" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC377" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC378" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">documentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC379" class="line" lang="java">            <span class="n">documentHandler</span><span class="o">.</span><span class="na">endElement</span><span class="o">(</span><span class="n">qName</span><span class="o">);</span></span>
...
<span id="LC384" class="line" lang="java"><span class="cm">     * Adapt a SAX2 characters event.</span></span>
<span id="LC385" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC386" class="line" lang="java"><span class="cm">     * @param ch An array of characters.</span></span>
<span id="LC387" class="line" lang="java"><span class="cm">     * @param start The starting position in the array.</span></span>
<span id="LC388" class="line" lang="java"><span class="cm">     * @param length The number of characters to use.</span></span>
<span id="LC389" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may raise a</span></span>
<span id="LC390" class="line" lang="java"><span class="cm">     *            processing exception.</span></span>
<span id="LC391" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#characters</span></span>
<span id="LC392" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC393" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">characters</span> <span class="o">(</span><span class="kt">char</span> <span class="n">ch</span><span class="o">[],</span> <span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span></span>
<span id="LC394" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC395" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC396" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">documentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC397" class="line" lang="java">            <span class="n">documentHandler</span><span class="o">.</span><span class="na">characters</span><span class="o">(</span><span class="n">ch</span><span class="o">,</span> <span class="n">start</span><span class="o">,</span> <span class="n">length</span><span class="o">);</span></span>
...
<span id="LC402" class="line" lang="java"><span class="cm">     * Adapt a SAX2 ignorable whitespace event.</span></span>
<span id="LC403" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC404" class="line" lang="java"><span class="cm">     * @param ch An array of characters.</span></span>
<span id="LC405" class="line" lang="java"><span class="cm">     * @param start The starting position in the array.</span></span>
<span id="LC406" class="line" lang="java"><span class="cm">     * @param length The number of characters to use.</span></span>
<span id="LC407" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may raise a</span></span>
<span id="LC408" class="line" lang="java"><span class="cm">     *            processing exception.</span></span>
<span id="LC409" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#ignorableWhitespace</span></span>
<span id="LC410" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC411" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">ignorableWhitespace</span> <span class="o">(</span><span class="kt">char</span> <span class="n">ch</span><span class="o">[],</span> <span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span></span>
<span id="LC412" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC413" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC414" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">documentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC415" class="line" lang="java">            <span class="n">documentHandler</span><span class="o">.</span><span class="na">ignorableWhitespace</span><span class="o">(</span><span class="n">ch</span><span class="o">,</span> <span class="n">start</span><span class="o">,</span> <span class="n">length</span><span class="o">);</span></span>
...
<span id="LC420" class="line" lang="java"><span class="cm">     * Adapt a SAX2 processing instruction event.</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">     * @param target The processing instruction target.</span></span>
<span id="LC423" class="line" lang="java"><span class="cm">     * @param data The remainder of the processing instruction</span></span>
<span id="LC424" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may raise a</span></span>
<span id="LC425" class="line" lang="java"><span class="cm">     *            processing exception.</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#processingInstruction</span></span>
<span id="LC427" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC428" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">processingInstruction</span> <span class="o">(</span><span class="nc">String</span> <span class="n">target</span><span class="o">,</span> <span class="nc">String</span> <span class="n">data</span><span class="o">)</span></span>
<span id="LC429" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC430" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC431" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">documentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC432" class="line" lang="java">            <span class="n">documentHandler</span><span class="o">.</span><span class="na">processingInstruction</span><span class="o">(</span><span class="n">target</span><span class="o">,</span> <span class="n">data</span><span class="o">);</span></span>
...
<span id="LC437" class="line" lang="java"><span class="cm">     * Adapt a SAX2 skipped entity event.</span></span>
<span id="LC438" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC439" class="line" lang="java"><span class="cm">     * @param name The name of the skipped entity.</span></span>
<span id="LC440" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#skippedEntity</span></span>
<span id="LC441" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException Throwable by subclasses.</span></span>
<span id="LC442" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC443" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">skippedEntity</span> <span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span></span>
...
<span id="LC451" class="line" lang="java">    <span class="c1">// Internal state.</span></span>
<span id="LC452" class="line" lang="java">    <span class="c1">////////////////////////////////////////////////////////////////////</span></span>
<span id="LC453" class="line" lang="java"></span>
<span id="LC454" class="line" lang="java">    <span class="nc">XMLReader</span> <span class="n">xmlReader</span><span class="o">;</span></span>
<span id="LC455" class="line" lang="java">    <span class="nc">DocumentHandler</span> <span class="n">documentHandler</span><span class="o">;</span></span>
<span id="LC456" class="line" lang="java">    <span class="nc">AttributesAdapter</span> <span class="n">qAtts</span><span class="o">;</span></span>
...
<span id="LC461" class="line" lang="java">    <span class="c1">// Internal class.</span></span>
...
<span id="LC466" class="line" lang="java"><span class="cm">     * Internal class to wrap a SAX2 Attributes object for SAX1.</span></span>
<span id="LC467" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC468" class="line" lang="java">    <span class="kd">final</span> <span class="kd">class</span> <span class="nc">AttributesAdapter</span> <span class="kd">implements</span> <span class="nc">AttributeList</span></span>
<span id="LC469" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC470" class="line" lang="java">        <span class="nc">AttributesAdapter</span> <span class="o">()</span></span>
...
<span id="LC476" class="line" lang="java"><span class="cm">         * Set the embedded Attributes object.</span></span>
<span id="LC477" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC478" class="line" lang="java"><span class="cm">         * @param The embedded SAX2 Attributes.</span></span>
<span id="LC479" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC480" class="line" lang="java">        <span class="kt">void</span> <span class="nf">setAttributes</span> <span class="o">(</span><span class="nc">Attributes</span> <span class="n">attributes</span><span class="o">)</span></span>
<span id="LC481" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC482" class="line" lang="java">            <span class="k">this</span><span class="o">.</span><span class="na">attributes</span> <span class="o">=</span> <span class="n">attributes</span><span class="o">;</span></span>
...
<span id="LC487" class="line" lang="java"><span class="cm">         * Return the number of attributes.</span></span>
<span id="LC488" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC489" class="line" lang="java"><span class="cm">         * @return The length of the attribute list.</span></span>
<span id="LC490" class="line" lang="java"><span class="cm">         * @see org.xml.sax.AttributeList#getLength</span></span>
<span id="LC491" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC492" class="line" lang="java">        <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getLength</span> <span class="o">()</span></span>
<span id="LC493" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC494" class="line" lang="java">            <span class="k">return</span> <span class="n">attributes</span><span class="o">.</span><span class="na">getLength</span><span class="o">();</span></span>
...
<span id="LC499" class="line" lang="java"><span class="cm">         * Return the qualified (prefixed) name of an attribute by position.</span></span>
<span id="LC500" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC501" class="line" lang="java"><span class="cm">         * @return The qualified name.</span></span>
<span id="LC502" class="line" lang="java"><span class="cm">         * @see org.xml.sax.AttributeList#getName</span></span>
<span id="LC503" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC504" class="line" lang="java">        <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getName</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span></span>
<span id="LC505" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC506" class="line" lang="java">            <span class="k">return</span> <span class="n">attributes</span><span class="o">.</span><span class="na">getQName</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
...
<span id="LC511" class="line" lang="java"><span class="cm">         * Return the type of an attribute by position.</span></span>
<span id="LC512" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC513" class="line" lang="java"><span class="cm">         * @return The type.</span></span>
<span id="LC514" class="line" lang="java"><span class="cm">         * @see org.xml.sax.AttributeList#getType(int)</span></span>
<span id="LC515" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC516" class="line" lang="java">        <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getType</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span></span>
<span id="LC517" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC518" class="line" lang="java">            <span class="k">return</span> <span class="n">attributes</span><span class="o">.</span><span class="na">getType</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
...
<span id="LC523" class="line" lang="java"><span class="cm">         * Return the value of an attribute by position.</span></span>
<span id="LC524" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC525" class="line" lang="java"><span class="cm">         * @return The value.</span></span>
<span id="LC526" class="line" lang="java"><span class="cm">         * @see org.xml.sax.AttributeList#getValue(int)</span></span>
<span id="LC527" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC528" class="line" lang="java">        <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getValue</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span></span>
<span id="LC529" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC530" class="line" lang="java">            <span class="k">return</span> <span class="n">attributes</span><span class="o">.</span><span class="na">getValue</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
...
<span id="LC535" class="line" lang="java"><span class="cm">         * Return the type of an attribute by qualified (prefixed) name.</span></span>
<span id="LC536" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC537" class="line" lang="java"><span class="cm">         * @return The type.</span></span>
<span id="LC538" class="line" lang="java"><span class="cm">         * @see org.xml.sax.AttributeList#getType(java.lang.String)</span></span>
<span id="LC539" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC540" class="line" lang="java">        <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getType</span> <span class="o">(</span><span class="nc">String</span> <span class="n">qName</span><span class="o">)</span></span>
<span id="LC541" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC542" class="line" lang="java">            <span class="k">return</span> <span class="n">attributes</span><span class="o">.</span><span class="na">getType</span><span class="o">(</span><span class="n">qName</span><span class="o">);</span></span>
...
<span id="LC547" class="line" lang="java"><span class="cm">         * Return the value of an attribute by qualified (prefixed) name.</span></span>
<span id="LC548" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC549" class="line" lang="java"><span class="cm">         * @return The value.</span></span>
<span id="LC550" class="line" lang="java"><span class="cm">         * @see org.xml.sax.AttributeList#getValue(java.lang.String)</span></span>
<span id="LC551" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC552" class="line" lang="java">        <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getValue</span> <span class="o">(</span><span class="nc">String</span> <span class="n">qName</span><span class="o">)</span></span>
<span id="LC553" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC554" class="line" lang="java">            <span class="k">return</span> <span class="n">attributes</span><span class="o">.</span><span class="na">getValue</span><span class="o">(</span><span class="n">qName</span><span class="o">);</span></span>
<span id="LC555" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC556" class="line" lang="java"></span>
<span id="LC557" class="line" lang="java">        <span class="kd">private</span> <span class="nc">Attributes</span> <span class="n">attributes</span><span class="o">;</span></span>
...
<span id="LC562" class="line" lang="java"><span class="c1">// end of XMLReaderAdapter.java</span></span>
