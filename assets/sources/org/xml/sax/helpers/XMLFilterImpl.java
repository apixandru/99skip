...
<span id="LC26" class="line" lang="java"><span class="c1">// XMLFilterImpl.java - base SAX2 filter implementation.</span></span>
...
<span id="LC30" class="line" lang="java"><span class="c1">// $Id: XMLFilterImpl.java,v 1.3 2004/11/03 22:53:09 jsuttor Exp $</span></span>
...
<span id="LC36" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.XMLReader</span><span class="o">;</span></span>
<span id="LC37" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.XMLFilter</span><span class="o">;</span></span>
<span id="LC38" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.InputSource</span><span class="o">;</span></span>
...
<span id="LC40" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.Attributes</span><span class="o">;</span></span>
<span id="LC41" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.EntityResolver</span><span class="o">;</span></span>
<span id="LC42" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.DTDHandler</span><span class="o">;</span></span>
<span id="LC43" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.ContentHandler</span><span class="o">;</span></span>
...
<span id="LC46" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.SAXParseException</span><span class="o">;</span></span>
...
<span id="LC48" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.SAXNotRecognizedException</span><span class="o">;</span></span>
...
<span id="LC52" class="line" lang="java"><span class="cm"> * Base class for deriving an XML filter.</span></span>
<span id="LC53" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC54" class="line" lang="java"><span class="cm"> * &lt;blockquote&gt;</span></span>
<span id="LC55" class="line" lang="java"><span class="cm"> * &lt;em&gt;This module, both source code and documentation, is in the</span></span>
<span id="LC56" class="line" lang="java"><span class="cm"> * Public Domain, and comes with &lt;strong&gt;NO WARRANTY&lt;/strong&gt;.&lt;/em&gt;</span></span>
<span id="LC57" class="line" lang="java"><span class="cm"> * See &lt;a href='http://www.saxproject.org'&gt;http://www.saxproject.org&lt;/a&gt;</span></span>
<span id="LC58" class="line" lang="java"><span class="cm"> * for further information.</span></span>
...
<span id="LC61" class="line" lang="java"><span class="cm"> * &lt;p&gt;This class is designed to sit between an {@link org.xml.sax.XMLReader</span></span>
<span id="LC62" class="line" lang="java"><span class="cm"> * XMLReader} and the client application's event handlers.  By default, it</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * does nothing but pass requests up to the reader and events</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> * on to the handlers unmodified, but subclasses can override</span></span>
<span id="LC65" class="line" lang="java"><span class="cm"> * specific methods to modify the event stream or the configuration</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> * requests as they pass through.&lt;/p&gt;</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> * @since SAX 2.0</span></span>
<span id="LC69" class="line" lang="java"><span class="cm"> * @author David Megginson</span></span>
<span id="LC70" class="line" lang="java"><span class="cm"> * @see org.xml.sax.XMLFilter</span></span>
<span id="LC71" class="line" lang="java"><span class="cm"> * @see org.xml.sax.XMLReader</span></span>
<span id="LC72" class="line" lang="java"><span class="cm"> * @see org.xml.sax.EntityResolver</span></span>
<span id="LC73" class="line" lang="java"><span class="cm"> * @see org.xml.sax.DTDHandler</span></span>
<span id="LC74" class="line" lang="java"><span class="cm"> * @see org.xml.sax.ContentHandler</span></span>
<span id="LC75" class="line" lang="java"><span class="cm"> * @see org.xml.sax.ErrorHandler</span></span>
<span id="LC76" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC77" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XMLFilterImpl</span></span>
<span id="LC78" class="line" lang="java">    <span class="kd">implements</span> <span class="nc">XMLFilter</span><span class="o">,</span> <span class="nc">EntityResolver</span><span class="o">,</span> <span class="nc">DTDHandler</span><span class="o">,</span> <span class="nc">ContentHandler</span><span class="o">,</span> <span class="nc">ErrorHandler</span></span>
...
<span id="LC83" class="line" lang="java">    <span class="c1">// Constructors.</span></span>
...
<span id="LC88" class="line" lang="java"><span class="cm">     * Construct an empty XML filter, with no parent.</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">     * &lt;p&gt;This filter will have no parent: you must assign a parent</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">     * before you start a parse or do any configuration with</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">     * setFeature or setProperty, unless you use this as a pure event</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">     * consumer rather than as an {@link XMLReader}.&lt;/p&gt;</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC95" class="line" lang="java"><span class="cm">     * @see org.xml.sax.XMLReader#setFeature</span></span>
<span id="LC96" class="line" lang="java"><span class="cm">     * @see org.xml.sax.XMLReader#setProperty</span></span>
<span id="LC97" class="line" lang="java"><span class="cm">     * @see #setParent</span></span>
<span id="LC98" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC99" class="line" lang="java">    <span class="kd">public</span> <span class="nf">XMLFilterImpl</span> <span class="o">()</span></span>
...
<span id="LC106" class="line" lang="java"><span class="cm">     * Construct an XML filter with the specified parent.</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">     * @see #setParent</span></span>
<span id="LC109" class="line" lang="java"><span class="cm">     * @see #getParent</span></span>
<span id="LC110" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC111" class="line" lang="java">    <span class="kd">public</span> <span class="nf">XMLFilterImpl</span> <span class="o">(</span><span class="nc">XMLReader</span> <span class="n">parent</span><span class="o">)</span></span>
...
<span id="LC114" class="line" lang="java">        <span class="n">setParent</span><span class="o">(</span><span class="n">parent</span><span class="o">);</span></span>
...
<span id="LC120" class="line" lang="java">    <span class="c1">// Implementation of org.xml.sax.XMLFilter.</span></span>
...
<span id="LC125" class="line" lang="java"><span class="cm">     * Set the parent reader.</span></span>
<span id="LC126" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC127" class="line" lang="java"><span class="cm">     * &lt;p&gt;This is the {@link org.xml.sax.XMLReader XMLReader} from which</span></span>
<span id="LC128" class="line" lang="java"><span class="cm">     * this filter will obtain its events and to which it will pass its</span></span>
<span id="LC129" class="line" lang="java"><span class="cm">     * configuration requests.  The parent may itself be another filter.&lt;/p&gt;</span></span>
<span id="LC130" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC131" class="line" lang="java"><span class="cm">     * &lt;p&gt;If there is no parent reader set, any attempt to parse</span></span>
<span id="LC132" class="line" lang="java"><span class="cm">     * or to set or get a feature or property will fail.&lt;/p&gt;</span></span>
<span id="LC133" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC134" class="line" lang="java"><span class="cm">     * @param parent The parent XML reader.</span></span>
<span id="LC135" class="line" lang="java"><span class="cm">     * @see #getParent</span></span>
<span id="LC136" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC137" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setParent</span> <span class="o">(</span><span class="nc">XMLReader</span> <span class="n">parent</span><span class="o">)</span></span>
<span id="LC138" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC139" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">parent</span> <span class="o">=</span> <span class="n">parent</span><span class="o">;</span></span>
...
<span id="LC144" class="line" lang="java"><span class="cm">     * Get the parent reader.</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">     * @return The parent XML reader, or null if none is set.</span></span>
<span id="LC147" class="line" lang="java"><span class="cm">     * @see #setParent</span></span>
<span id="LC148" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC149" class="line" lang="java">    <span class="kd">public</span> <span class="nc">XMLReader</span> <span class="nf">getParent</span> <span class="o">()</span></span>
<span id="LC150" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC151" class="line" lang="java">        <span class="k">return</span> <span class="n">parent</span><span class="o">;</span></span>
...
<span id="LC157" class="line" lang="java">    <span class="c1">// Implementation of org.xml.sax.XMLReader.</span></span>
...
<span id="LC162" class="line" lang="java"><span class="cm">     * Set the value of a feature.</span></span>
<span id="LC163" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC164" class="line" lang="java"><span class="cm">     * &lt;p&gt;This will always fail if the parent is null.&lt;/p&gt;</span></span>
<span id="LC165" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC166" class="line" lang="java"><span class="cm">     * @param name The feature name.</span></span>
<span id="LC167" class="line" lang="java"><span class="cm">     * @param value The requested feature value.</span></span>
<span id="LC168" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXNotRecognizedException If the feature</span></span>
<span id="LC169" class="line" lang="java"><span class="cm">     *            value can't be assigned or retrieved from the parent.</span></span>
<span id="LC170" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXNotSupportedException When the</span></span>
<span id="LC171" class="line" lang="java"><span class="cm">     *            parent recognizes the feature name but</span></span>
<span id="LC172" class="line" lang="java"><span class="cm">     *            cannot set the requested value.</span></span>
<span id="LC173" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC174" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setFeature</span> <span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">value</span><span class="o">)</span></span>
<span id="LC175" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXNotRecognizedException</span><span class="o">,</span> <span class="nc">SAXNotSupportedException</span></span>
<span id="LC176" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC177" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">parent</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC178" class="line" lang="java">            <span class="n">parent</span><span class="o">.</span><span class="na">setFeature</span><span class="o">(</span><span class="n">name</span><span class="o">,</span> <span class="n">value</span><span class="o">);</span></span>
<span id="LC179" class="line" lang="java">        <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC180" class="line" lang="java">            <span class="k">throw</span> <span class="k">new</span> <span class="nf">SAXNotRecognizedException</span><span class="o">(</span><span class="s">"Feature: "</span> <span class="o">+</span> <span class="n">name</span><span class="o">);</span></span>
...
<span id="LC186" class="line" lang="java"><span class="cm">     * Look up the value of a feature.</span></span>
<span id="LC187" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC188" class="line" lang="java"><span class="cm">     * &lt;p&gt;This will always fail if the parent is null.&lt;/p&gt;</span></span>
<span id="LC189" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC190" class="line" lang="java"><span class="cm">     * @param name The feature name.</span></span>
<span id="LC191" class="line" lang="java"><span class="cm">     * @return The current value of the feature.</span></span>
<span id="LC192" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXNotRecognizedException If the feature</span></span>
<span id="LC193" class="line" lang="java"><span class="cm">     *            value can't be assigned or retrieved from the parent.</span></span>
<span id="LC194" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXNotSupportedException When the</span></span>
<span id="LC195" class="line" lang="java"><span class="cm">     *            parent recognizes the feature name but</span></span>
<span id="LC196" class="line" lang="java"><span class="cm">     *            cannot determine its value at this time.</span></span>
<span id="LC197" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC198" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getFeature</span> <span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span></span>
<span id="LC199" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXNotRecognizedException</span><span class="o">,</span> <span class="nc">SAXNotSupportedException</span></span>
<span id="LC200" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC201" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">parent</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC202" class="line" lang="java">            <span class="k">return</span> <span class="n">parent</span><span class="o">.</span><span class="na">getFeature</span><span class="o">(</span><span class="n">name</span><span class="o">);</span></span>
<span id="LC203" class="line" lang="java">        <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC204" class="line" lang="java">            <span class="k">throw</span> <span class="k">new</span> <span class="nf">SAXNotRecognizedException</span><span class="o">(</span><span class="s">"Feature: "</span> <span class="o">+</span> <span class="n">name</span><span class="o">);</span></span>
...
<span id="LC210" class="line" lang="java"><span class="cm">     * Set the value of a property.</span></span>
<span id="LC211" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">     * &lt;p&gt;This will always fail if the parent is null.&lt;/p&gt;</span></span>
<span id="LC213" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC214" class="line" lang="java"><span class="cm">     * @param name The property name.</span></span>
<span id="LC215" class="line" lang="java"><span class="cm">     * @param value The requested property value.</span></span>
<span id="LC216" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXNotRecognizedException If the property</span></span>
<span id="LC217" class="line" lang="java"><span class="cm">     *            value can't be assigned or retrieved from the parent.</span></span>
<span id="LC218" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXNotSupportedException When the</span></span>
<span id="LC219" class="line" lang="java"><span class="cm">     *            parent recognizes the property name but</span></span>
<span id="LC220" class="line" lang="java"><span class="cm">     *            cannot set the requested value.</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC222" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setProperty</span> <span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="nc">Object</span> <span class="n">value</span><span class="o">)</span></span>
<span id="LC223" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXNotRecognizedException</span><span class="o">,</span> <span class="nc">SAXNotSupportedException</span></span>
<span id="LC224" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC225" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">parent</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC226" class="line" lang="java">            <span class="n">parent</span><span class="o">.</span><span class="na">setProperty</span><span class="o">(</span><span class="n">name</span><span class="o">,</span> <span class="n">value</span><span class="o">);</span></span>
<span id="LC227" class="line" lang="java">        <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC228" class="line" lang="java">            <span class="k">throw</span> <span class="k">new</span> <span class="nf">SAXNotRecognizedException</span><span class="o">(</span><span class="s">"Property: "</span> <span class="o">+</span> <span class="n">name</span><span class="o">);</span></span>
...
<span id="LC234" class="line" lang="java"><span class="cm">     * Look up the value of a property.</span></span>
<span id="LC235" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC236" class="line" lang="java"><span class="cm">     * @param name The property name.</span></span>
<span id="LC237" class="line" lang="java"><span class="cm">     * @return The current value of the property.</span></span>
<span id="LC238" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXNotRecognizedException If the property</span></span>
<span id="LC239" class="line" lang="java"><span class="cm">     *            value can't be assigned or retrieved from the parent.</span></span>
<span id="LC240" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXNotSupportedException When the</span></span>
<span id="LC241" class="line" lang="java"><span class="cm">     *            parent recognizes the property name but</span></span>
<span id="LC242" class="line" lang="java"><span class="cm">     *            cannot determine its value at this time.</span></span>
<span id="LC243" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC244" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Object</span> <span class="nf">getProperty</span> <span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span></span>
<span id="LC245" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXNotRecognizedException</span><span class="o">,</span> <span class="nc">SAXNotSupportedException</span></span>
<span id="LC246" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC247" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">parent</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC248" class="line" lang="java">            <span class="k">return</span> <span class="n">parent</span><span class="o">.</span><span class="na">getProperty</span><span class="o">(</span><span class="n">name</span><span class="o">);</span></span>
<span id="LC249" class="line" lang="java">        <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC250" class="line" lang="java">            <span class="k">throw</span> <span class="k">new</span> <span class="nf">SAXNotRecognizedException</span><span class="o">(</span><span class="s">"Property: "</span> <span class="o">+</span> <span class="n">name</span><span class="o">);</span></span>
...
<span id="LC256" class="line" lang="java"><span class="cm">     * Set the entity resolver.</span></span>
<span id="LC257" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC258" class="line" lang="java"><span class="cm">     * @param resolver The new entity resolver.</span></span>
<span id="LC259" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC260" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setEntityResolver</span> <span class="o">(</span><span class="nc">EntityResolver</span> <span class="n">resolver</span><span class="o">)</span></span>
<span id="LC261" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC262" class="line" lang="java">        <span class="n">entityResolver</span> <span class="o">=</span> <span class="n">resolver</span><span class="o">;</span></span>
...
<span id="LC267" class="line" lang="java"><span class="cm">     * Get the current entity resolver.</span></span>
<span id="LC268" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC269" class="line" lang="java"><span class="cm">     * @return The current entity resolver, or null if none was set.</span></span>
<span id="LC270" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC271" class="line" lang="java">    <span class="kd">public</span> <span class="nc">EntityResolver</span> <span class="nf">getEntityResolver</span> <span class="o">()</span></span>
<span id="LC272" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC273" class="line" lang="java">        <span class="k">return</span> <span class="n">entityResolver</span><span class="o">;</span></span>
...
<span id="LC278" class="line" lang="java"><span class="cm">     * Set the DTD event handler.</span></span>
<span id="LC279" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC280" class="line" lang="java"><span class="cm">     * @param handler the new DTD handler</span></span>
<span id="LC281" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC282" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDTDHandler</span> <span class="o">(</span><span class="nc">DTDHandler</span> <span class="n">handler</span><span class="o">)</span></span>
<span id="LC283" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC284" class="line" lang="java">        <span class="n">dtdHandler</span> <span class="o">=</span> <span class="n">handler</span><span class="o">;</span></span>
...
<span id="LC289" class="line" lang="java"><span class="cm">     * Get the current DTD event handler.</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC291" class="line" lang="java"><span class="cm">     * @return The current DTD handler, or null if none was set.</span></span>
<span id="LC292" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC293" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTDHandler</span> <span class="nf">getDTDHandler</span> <span class="o">()</span></span>
<span id="LC294" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC295" class="line" lang="java">        <span class="k">return</span> <span class="n">dtdHandler</span><span class="o">;</span></span>
...
<span id="LC300" class="line" lang="java"><span class="cm">     * Set the content event handler.</span></span>
<span id="LC301" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC302" class="line" lang="java"><span class="cm">     * @param handler the new content handler</span></span>
<span id="LC303" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC304" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setContentHandler</span> <span class="o">(</span><span class="nc">ContentHandler</span> <span class="n">handler</span><span class="o">)</span></span>
<span id="LC305" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC306" class="line" lang="java">        <span class="n">contentHandler</span> <span class="o">=</span> <span class="n">handler</span><span class="o">;</span></span>
...
<span id="LC311" class="line" lang="java"><span class="cm">     * Get the content event handler.</span></span>
<span id="LC312" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC313" class="line" lang="java"><span class="cm">     * @return The current content handler, or null if none was set.</span></span>
<span id="LC314" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC315" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ContentHandler</span> <span class="nf">getContentHandler</span> <span class="o">()</span></span>
<span id="LC316" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC317" class="line" lang="java">        <span class="k">return</span> <span class="n">contentHandler</span><span class="o">;</span></span>
...
<span id="LC322" class="line" lang="java"><span class="cm">     * Set the error event handler.</span></span>
<span id="LC323" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC324" class="line" lang="java"><span class="cm">     * @param handler the new error handler</span></span>
<span id="LC325" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC326" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setErrorHandler</span> <span class="o">(</span><span class="nc">ErrorHandler</span> <span class="n">handler</span><span class="o">)</span></span>
<span id="LC327" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC328" class="line" lang="java">        <span class="n">errorHandler</span> <span class="o">=</span> <span class="n">handler</span><span class="o">;</span></span>
...
<span id="LC333" class="line" lang="java"><span class="cm">     * Get the current error event handler.</span></span>
<span id="LC334" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC335" class="line" lang="java"><span class="cm">     * @return The current error handler, or null if none was set.</span></span>
<span id="LC336" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC337" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ErrorHandler</span> <span class="nf">getErrorHandler</span> <span class="o">()</span></span>
<span id="LC338" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC339" class="line" lang="java">        <span class="k">return</span> <span class="n">errorHandler</span><span class="o">;</span></span>
...
<span id="LC344" class="line" lang="java"><span class="cm">     * Parse a document.</span></span>
<span id="LC345" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC346" class="line" lang="java"><span class="cm">     * @param input The input source for the document entity.</span></span>
<span id="LC347" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException Any SAX exception, possibly</span></span>
<span id="LC348" class="line" lang="java"><span class="cm">     *            wrapping another exception.</span></span>
<span id="LC349" class="line" lang="java"><span class="cm">     * @exception java.io.IOException An IO exception from the parser,</span></span>
<span id="LC350" class="line" lang="java"><span class="cm">     *            possibly from a byte stream or character stream</span></span>
<span id="LC351" class="line" lang="java"><span class="cm">     *            supplied by the application.</span></span>
<span id="LC352" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC353" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">parse</span> <span class="o">(</span><span class="nc">InputSource</span> <span class="n">input</span><span class="o">)</span></span>
<span id="LC354" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span><span class="o">,</span> <span class="nc">IOException</span></span>
<span id="LC355" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC356" class="line" lang="java">        <span class="n">setupParse</span><span class="o">();</span></span>
<span id="LC357" class="line" lang="java">        <span class="n">parent</span><span class="o">.</span><span class="na">parse</span><span class="o">(</span><span class="n">input</span><span class="o">);</span></span>
...
<span id="LC362" class="line" lang="java"><span class="cm">     * Parse a document.</span></span>
<span id="LC363" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC364" class="line" lang="java"><span class="cm">     * @param systemId The system identifier as a fully-qualified URI.</span></span>
<span id="LC365" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException Any SAX exception, possibly</span></span>
<span id="LC366" class="line" lang="java"><span class="cm">     *            wrapping another exception.</span></span>
<span id="LC367" class="line" lang="java"><span class="cm">     * @exception java.io.IOException An IO exception from the parser,</span></span>
<span id="LC368" class="line" lang="java"><span class="cm">     *            possibly from a byte stream or character stream</span></span>
<span id="LC369" class="line" lang="java"><span class="cm">     *            supplied by the application.</span></span>
<span id="LC370" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC371" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">parse</span> <span class="o">(</span><span class="nc">String</span> <span class="n">systemId</span><span class="o">)</span></span>
<span id="LC372" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span><span class="o">,</span> <span class="nc">IOException</span></span>
<span id="LC373" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC374" class="line" lang="java">        <span class="n">parse</span><span class="o">(</span><span class="k">new</span> <span class="nc">InputSource</span><span class="o">(</span><span class="n">systemId</span><span class="o">));</span></span>
...
<span id="LC380" class="line" lang="java">    <span class="c1">// Implementation of org.xml.sax.EntityResolver.</span></span>
...
<span id="LC385" class="line" lang="java"><span class="cm">     * Filter an external entity resolution.</span></span>
<span id="LC386" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC387" class="line" lang="java"><span class="cm">     * @param publicId The entity's public identifier, or null.</span></span>
<span id="LC388" class="line" lang="java"><span class="cm">     * @param systemId The entity's system identifier.</span></span>
<span id="LC389" class="line" lang="java"><span class="cm">     * @return A new InputSource or null for the default.</span></span>
<span id="LC390" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC391" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC392" class="line" lang="java"><span class="cm">     * @exception java.io.IOException The client may throw an</span></span>
<span id="LC393" class="line" lang="java"><span class="cm">     *            I/O-related exception while obtaining the</span></span>
<span id="LC394" class="line" lang="java"><span class="cm">     *            new InputSource.</span></span>
<span id="LC395" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC396" class="line" lang="java">    <span class="kd">public</span> <span class="nc">InputSource</span> <span class="nf">resolveEntity</span> <span class="o">(</span><span class="nc">String</span> <span class="n">publicId</span><span class="o">,</span> <span class="nc">String</span> <span class="n">systemId</span><span class="o">)</span></span>
<span id="LC397" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span><span class="o">,</span> <span class="nc">IOException</span></span>
<span id="LC398" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC399" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">entityResolver</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC400" class="line" lang="java">            <span class="k">return</span> <span class="n">entityResolver</span><span class="o">.</span><span class="na">resolveEntity</span><span class="o">(</span><span class="n">publicId</span><span class="o">,</span> <span class="n">systemId</span><span class="o">);</span></span>
...
<span id="LC409" class="line" lang="java">    <span class="c1">// Implementation of org.xml.sax.DTDHandler.</span></span>
...
<span id="LC414" class="line" lang="java"><span class="cm">     * Filter a notation declaration event.</span></span>
<span id="LC415" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC416" class="line" lang="java"><span class="cm">     * @param name The notation name.</span></span>
<span id="LC417" class="line" lang="java"><span class="cm">     * @param publicId The notation's public identifier, or null.</span></span>
<span id="LC418" class="line" lang="java"><span class="cm">     * @param systemId The notation's system identifier, or null.</span></span>
<span id="LC419" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC420" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC422" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">notationDecl</span> <span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="nc">String</span> <span class="n">publicId</span><span class="o">,</span> <span class="nc">String</span> <span class="n">systemId</span><span class="o">)</span></span>
...
<span id="LC425" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">dtdHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC426" class="line" lang="java">            <span class="n">dtdHandler</span><span class="o">.</span><span class="na">notationDecl</span><span class="o">(</span><span class="n">name</span><span class="o">,</span> <span class="n">publicId</span><span class="o">,</span> <span class="n">systemId</span><span class="o">);</span></span>
...
<span id="LC432" class="line" lang="java"><span class="cm">     * Filter an unparsed entity declaration event.</span></span>
<span id="LC433" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC434" class="line" lang="java"><span class="cm">     * @param name The entity name.</span></span>
<span id="LC435" class="line" lang="java"><span class="cm">     * @param publicId The entity's public identifier, or null.</span></span>
<span id="LC436" class="line" lang="java"><span class="cm">     * @param systemId The entity's system identifier, or null.</span></span>
<span id="LC437" class="line" lang="java"><span class="cm">     * @param notationName The name of the associated notation.</span></span>
<span id="LC438" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC439" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC440" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC441" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">unparsedEntityDecl</span> <span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="nc">String</span> <span class="n">publicId</span><span class="o">,</span></span>
<span id="LC442" class="line" lang="java">                                    <span class="nc">String</span> <span class="n">systemId</span><span class="o">,</span> <span class="nc">String</span> <span class="n">notationName</span><span class="o">)</span></span>
<span id="LC443" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC444" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC445" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">dtdHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC446" class="line" lang="java">            <span class="n">dtdHandler</span><span class="o">.</span><span class="na">unparsedEntityDecl</span><span class="o">(</span><span class="n">name</span><span class="o">,</span> <span class="n">publicId</span><span class="o">,</span> <span class="n">systemId</span><span class="o">,</span></span>
<span id="LC447" class="line" lang="java">                                          <span class="n">notationName</span><span class="o">);</span></span>
...
<span id="LC454" class="line" lang="java">    <span class="c1">// Implementation of org.xml.sax.ContentHandler.</span></span>
...
<span id="LC459" class="line" lang="java"><span class="cm">     * Filter a new document locator event.</span></span>
<span id="LC460" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC461" class="line" lang="java"><span class="cm">     * @param locator The document locator.</span></span>
<span id="LC462" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC463" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDocumentLocator</span> <span class="o">(</span><span class="nc">Locator</span> <span class="n">locator</span><span class="o">)</span></span>
<span id="LC464" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC465" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">locator</span> <span class="o">=</span> <span class="n">locator</span><span class="o">;</span></span>
<span id="LC466" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">contentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC467" class="line" lang="java">            <span class="n">contentHandler</span><span class="o">.</span><span class="na">setDocumentLocator</span><span class="o">(</span><span class="n">locator</span><span class="o">);</span></span>
...
<span id="LC473" class="line" lang="java"><span class="cm">     * Filter a start document event.</span></span>
<span id="LC474" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC475" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC476" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC477" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC478" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startDocument</span> <span class="o">()</span></span>
<span id="LC479" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC480" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC481" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">contentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC482" class="line" lang="java">            <span class="n">contentHandler</span><span class="o">.</span><span class="na">startDocument</span><span class="o">();</span></span>
...
<span id="LC488" class="line" lang="java"><span class="cm">     * Filter an end document event.</span></span>
<span id="LC489" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC490" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC491" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC492" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC493" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endDocument</span> <span class="o">()</span></span>
<span id="LC494" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC495" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC496" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">contentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC497" class="line" lang="java">            <span class="n">contentHandler</span><span class="o">.</span><span class="na">endDocument</span><span class="o">();</span></span>
...
<span id="LC503" class="line" lang="java"><span class="cm">     * Filter a start Namespace prefix mapping event.</span></span>
<span id="LC504" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC505" class="line" lang="java"><span class="cm">     * @param prefix The Namespace prefix.</span></span>
<span id="LC506" class="line" lang="java"><span class="cm">     * @param uri The Namespace URI.</span></span>
<span id="LC507" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC508" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC509" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC510" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startPrefixMapping</span> <span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">,</span> <span class="nc">String</span> <span class="n">uri</span><span class="o">)</span></span>
<span id="LC511" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC512" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC513" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">contentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC514" class="line" lang="java">            <span class="n">contentHandler</span><span class="o">.</span><span class="na">startPrefixMapping</span><span class="o">(</span><span class="n">prefix</span><span class="o">,</span> <span class="n">uri</span><span class="o">);</span></span>
...
<span id="LC520" class="line" lang="java"><span class="cm">     * Filter an end Namespace prefix mapping event.</span></span>
<span id="LC521" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC522" class="line" lang="java"><span class="cm">     * @param prefix The Namespace prefix.</span></span>
<span id="LC523" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC524" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC525" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC526" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endPrefixMapping</span> <span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">)</span></span>
<span id="LC527" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC528" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC529" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">contentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC530" class="line" lang="java">            <span class="n">contentHandler</span><span class="o">.</span><span class="na">endPrefixMapping</span><span class="o">(</span><span class="n">prefix</span><span class="o">);</span></span>
...
<span id="LC536" class="line" lang="java"><span class="cm">     * Filter a start element event.</span></span>
<span id="LC537" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC538" class="line" lang="java"><span class="cm">     * @param uri The element's Namespace URI, or the empty string.</span></span>
<span id="LC539" class="line" lang="java"><span class="cm">     * @param localName The element's local name, or the empty string.</span></span>
<span id="LC540" class="line" lang="java"><span class="cm">     * @param qName The element's qualified (prefixed) name, or the empty</span></span>
<span id="LC541" class="line" lang="java"><span class="cm">     *        string.</span></span>
<span id="LC542" class="line" lang="java"><span class="cm">     * @param atts The element's attributes.</span></span>
<span id="LC543" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC544" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC545" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC546" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startElement</span> <span class="o">(</span><span class="nc">String</span> <span class="n">uri</span><span class="o">,</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span> <span class="nc">String</span> <span class="n">qName</span><span class="o">,</span></span>
<span id="LC547" class="line" lang="java">                              <span class="nc">Attributes</span> <span class="n">atts</span><span class="o">)</span></span>
<span id="LC548" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC549" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC550" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">contentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC551" class="line" lang="java">            <span class="n">contentHandler</span><span class="o">.</span><span class="na">startElement</span><span class="o">(</span><span class="n">uri</span><span class="o">,</span> <span class="n">localName</span><span class="o">,</span> <span class="n">qName</span><span class="o">,</span> <span class="n">atts</span><span class="o">);</span></span>
...
<span id="LC557" class="line" lang="java"><span class="cm">     * Filter an end element event.</span></span>
<span id="LC558" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC559" class="line" lang="java"><span class="cm">     * @param uri The element's Namespace URI, or the empty string.</span></span>
<span id="LC560" class="line" lang="java"><span class="cm">     * @param localName The element's local name, or the empty string.</span></span>
<span id="LC561" class="line" lang="java"><span class="cm">     * @param qName The element's qualified (prefixed) name, or the empty</span></span>
<span id="LC562" class="line" lang="java"><span class="cm">     *        string.</span></span>
<span id="LC563" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC564" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC565" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC566" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endElement</span> <span class="o">(</span><span class="nc">String</span> <span class="n">uri</span><span class="o">,</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span> <span class="nc">String</span> <span class="n">qName</span><span class="o">)</span></span>
<span id="LC567" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC568" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC569" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">contentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC570" class="line" lang="java">            <span class="n">contentHandler</span><span class="o">.</span><span class="na">endElement</span><span class="o">(</span><span class="n">uri</span><span class="o">,</span> <span class="n">localName</span><span class="o">,</span> <span class="n">qName</span><span class="o">);</span></span>
...
<span id="LC576" class="line" lang="java"><span class="cm">     * Filter a character data event.</span></span>
<span id="LC577" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC578" class="line" lang="java"><span class="cm">     * @param ch An array of characters.</span></span>
<span id="LC579" class="line" lang="java"><span class="cm">     * @param start The starting position in the array.</span></span>
<span id="LC580" class="line" lang="java"><span class="cm">     * @param length The number of characters to use from the array.</span></span>
<span id="LC581" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC582" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC583" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC584" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">characters</span> <span class="o">(</span><span class="kt">char</span> <span class="n">ch</span><span class="o">[],</span> <span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span></span>
<span id="LC585" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC586" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC587" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">contentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC588" class="line" lang="java">            <span class="n">contentHandler</span><span class="o">.</span><span class="na">characters</span><span class="o">(</span><span class="n">ch</span><span class="o">,</span> <span class="n">start</span><span class="o">,</span> <span class="n">length</span><span class="o">);</span></span>
...
<span id="LC594" class="line" lang="java"><span class="cm">     * Filter an ignorable whitespace event.</span></span>
<span id="LC595" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC596" class="line" lang="java"><span class="cm">     * @param ch An array of characters.</span></span>
<span id="LC597" class="line" lang="java"><span class="cm">     * @param start The starting position in the array.</span></span>
<span id="LC598" class="line" lang="java"><span class="cm">     * @param length The number of characters to use from the array.</span></span>
<span id="LC599" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC600" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC601" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC602" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">ignorableWhitespace</span> <span class="o">(</span><span class="kt">char</span> <span class="n">ch</span><span class="o">[],</span> <span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span></span>
<span id="LC603" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC604" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC605" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">contentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC606" class="line" lang="java">            <span class="n">contentHandler</span><span class="o">.</span><span class="na">ignorableWhitespace</span><span class="o">(</span><span class="n">ch</span><span class="o">,</span> <span class="n">start</span><span class="o">,</span> <span class="n">length</span><span class="o">);</span></span>
...
<span id="LC612" class="line" lang="java"><span class="cm">     * Filter a processing instruction event.</span></span>
<span id="LC613" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC614" class="line" lang="java"><span class="cm">     * @param target The processing instruction target.</span></span>
<span id="LC615" class="line" lang="java"><span class="cm">     * @param data The text following the target.</span></span>
<span id="LC616" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC617" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC618" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC619" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">processingInstruction</span> <span class="o">(</span><span class="nc">String</span> <span class="n">target</span><span class="o">,</span> <span class="nc">String</span> <span class="n">data</span><span class="o">)</span></span>
<span id="LC620" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC621" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC622" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">contentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC623" class="line" lang="java">            <span class="n">contentHandler</span><span class="o">.</span><span class="na">processingInstruction</span><span class="o">(</span><span class="n">target</span><span class="o">,</span> <span class="n">data</span><span class="o">);</span></span>
...
<span id="LC629" class="line" lang="java"><span class="cm">     * Filter a skipped entity event.</span></span>
<span id="LC630" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC631" class="line" lang="java"><span class="cm">     * @param name The name of the skipped entity.</span></span>
<span id="LC632" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC633" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC634" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC635" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">skippedEntity</span> <span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span></span>
...
<span id="LC638" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">contentHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC639" class="line" lang="java">            <span class="n">contentHandler</span><span class="o">.</span><span class="na">skippedEntity</span><span class="o">(</span><span class="n">name</span><span class="o">);</span></span>
...
<span id="LC646" class="line" lang="java">    <span class="c1">// Implementation of org.xml.sax.ErrorHandler.</span></span>
...
<span id="LC651" class="line" lang="java"><span class="cm">     * Filter a warning event.</span></span>
<span id="LC652" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC653" class="line" lang="java"><span class="cm">     * @param e The warning as an exception.</span></span>
<span id="LC654" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC655" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC656" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC657" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">warning</span> <span class="o">(</span><span class="nc">SAXParseException</span> <span class="n">e</span><span class="o">)</span></span>
...
<span id="LC660" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">errorHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC661" class="line" lang="java">            <span class="n">errorHandler</span><span class="o">.</span><span class="na">warning</span><span class="o">(</span><span class="n">e</span><span class="o">);</span></span>
...
<span id="LC667" class="line" lang="java"><span class="cm">     * Filter an error event.</span></span>
<span id="LC668" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC669" class="line" lang="java"><span class="cm">     * @param e The error as an exception.</span></span>
<span id="LC670" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC671" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC672" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC673" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">error</span> <span class="o">(</span><span class="nc">SAXParseException</span> <span class="n">e</span><span class="o">)</span></span>
...
<span id="LC676" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">errorHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC677" class="line" lang="java">            <span class="n">errorHandler</span><span class="o">.</span><span class="na">error</span><span class="o">(</span><span class="n">e</span><span class="o">);</span></span>
...
<span id="LC683" class="line" lang="java"><span class="cm">     * Filter a fatal error event.</span></span>
<span id="LC684" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC685" class="line" lang="java"><span class="cm">     * @param e The error as an exception.</span></span>
<span id="LC686" class="line" lang="java"><span class="cm">     * @exception org.xml.sax.SAXException The client may throw</span></span>
<span id="LC687" class="line" lang="java"><span class="cm">     *            an exception during processing.</span></span>
<span id="LC688" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC689" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">fatalError</span> <span class="o">(</span><span class="nc">SAXParseException</span> <span class="n">e</span><span class="o">)</span></span>
<span id="LC690" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC691" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC692" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">errorHandler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC693" class="line" lang="java">            <span class="n">errorHandler</span><span class="o">.</span><span class="na">fatalError</span><span class="o">(</span><span class="n">e</span><span class="o">);</span></span>
...
<span id="LC700" class="line" lang="java">    <span class="c1">// Internal methods.</span></span>
...
<span id="LC705" class="line" lang="java"><span class="cm">     * Set up before a parse.</span></span>
<span id="LC706" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC707" class="line" lang="java"><span class="cm">     * &lt;p&gt;Before every parse, check whether the parent is</span></span>
<span id="LC708" class="line" lang="java"><span class="cm">     * non-null, and re-register the filter for all of the</span></span>
<span id="LC709" class="line" lang="java"><span class="cm">     * events.&lt;/p&gt;</span></span>
<span id="LC710" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC711" class="line" lang="java">    <span class="kd">private</span> <span class="kt">void</span> <span class="nf">setupParse</span> <span class="o">()</span></span>
<span id="LC712" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC713" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">parent</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC714" class="line" lang="java">            <span class="k">throw</span> <span class="k">new</span> <span class="nf">NullPointerException</span><span class="o">(</span><span class="s">"No parent for filter"</span><span class="o">);</span></span>
<span id="LC715" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC716" class="line" lang="java">        <span class="n">parent</span><span class="o">.</span><span class="na">setEntityResolver</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC717" class="line" lang="java">        <span class="n">parent</span><span class="o">.</span><span class="na">setDTDHandler</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC718" class="line" lang="java">        <span class="n">parent</span><span class="o">.</span><span class="na">setContentHandler</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC719" class="line" lang="java">        <span class="n">parent</span><span class="o">.</span><span class="na">setErrorHandler</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
...
<span id="LC725" class="line" lang="java">    <span class="c1">// Internal state.</span></span>
<span id="LC726" class="line" lang="java">    <span class="c1">////////////////////////////////////////////////////////////////////</span></span>
<span id="LC727" class="line" lang="java"></span>
<span id="LC728" class="line" lang="java">    <span class="kd">private</span> <span class="nc">XMLReader</span> <span class="n">parent</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC729" class="line" lang="java">    <span class="kd">private</span> <span class="nc">Locator</span> <span class="n">locator</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC730" class="line" lang="java">    <span class="kd">private</span> <span class="nc">EntityResolver</span> <span class="n">entityResolver</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC731" class="line" lang="java">    <span class="kd">private</span> <span class="nc">DTDHandler</span> <span class="n">dtdHandler</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC732" class="line" lang="java">    <span class="kd">private</span> <span class="nc">ContentHandler</span> <span class="n">contentHandler</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC733" class="line" lang="java">    <span class="kd">private</span> <span class="nc">ErrorHandler</span> <span class="n">errorHandler</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC737" class="line" lang="java"><span class="c1">// end of XMLFilterImpl.java</span></span>
