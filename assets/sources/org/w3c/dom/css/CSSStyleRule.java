...
<span id="LC47" class="line" lang="java"><span class="cm"> *  The &lt;code&gt;CSSStyleRule&lt;/code&gt; interface represents a single rule set in a</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * CSS style sheet.</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * &lt;p&gt;See also the &lt;a href='http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113'&gt;Document Object Model (DOM) Level 2 Style Specification&lt;/a&gt;.</span></span>
...
<span id="LC52" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">CSSStyleRule</span> <span class="kd">extends</span> <span class="nc">CSSRule</span> <span class="o">{</span></span>
<span id="LC53" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC54" class="line" lang="java"><span class="cm">     *  The textual representation of the selector for the rule set. The</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">     * implementation may have stripped out insignificant whitespace while</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">     * parsing the selector.</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC58" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getSelectorText</span><span class="o">();</span></span>
<span id="LC59" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC60" class="line" lang="java"><span class="cm">     *  The textual representation of the selector for the rule set. The</span></span>
<span id="LC61" class="line" lang="java"><span class="cm">     * implementation may have stripped out insignificant whitespace while</span></span>
<span id="LC62" class="line" lang="java"><span class="cm">     * parsing the selector.</span></span>
<span id="LC63" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC64" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the specified CSS string value has a syntax</span></span>
<span id="LC65" class="line" lang="java"><span class="cm">     *   error and is unparsable.</span></span>
<span id="LC66" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this rule is readonly.</span></span>
<span id="LC67" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC68" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSelectorText</span><span class="o">(</span><span class="nc">String</span> <span class="n">selectorText</span><span class="o">)</span></span>
...
<span id="LC72" class="line" lang="java"><span class="cm">     *  The declaration-block of this rule set.</span></span>
<span id="LC73" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC74" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CSSStyleDeclaration</span> <span class="nf">getStyle</span><span class="o">();</span></span>
