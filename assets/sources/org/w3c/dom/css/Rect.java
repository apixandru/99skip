...
<span id="LC45" class="line" lang="java"><span class="cm"> *  The &lt;code&gt;Rect&lt;/code&gt; interface is used to represent any rect value. This</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> * interface reflects the values in the underlying style property. Hence,</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * modifications made to the &lt;code&gt;CSSPrimitiveValue&lt;/code&gt; objects modify</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * the style property.</span></span>
...
<span id="LC52" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">Rect</span> <span class="o">{</span></span>
<span id="LC53" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC54" class="line" lang="java"><span class="cm">     *  This attribute is used for the top of the rect.</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC56" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CSSPrimitiveValue</span> <span class="nf">getTop</span><span class="o">();</span></span>
<span id="LC57" class="line" lang="java"></span>
<span id="LC58" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC59" class="line" lang="java"><span class="cm">     *  This attribute is used for the right of the rect.</span></span>
<span id="LC60" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC61" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CSSPrimitiveValue</span> <span class="nf">getRight</span><span class="o">();</span></span>
<span id="LC62" class="line" lang="java"></span>
<span id="LC63" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC64" class="line" lang="java"><span class="cm">     *  This attribute is used for the bottom of the rect.</span></span>
<span id="LC65" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC66" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CSSPrimitiveValue</span> <span class="nf">getBottom</span><span class="o">();</span></span>
<span id="LC67" class="line" lang="java"></span>
<span id="LC68" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">     *  This attribute is used for the left of the rect.</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC71" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CSSPrimitiveValue</span> <span class="nf">getLeft</span><span class="o">();</span></span>
