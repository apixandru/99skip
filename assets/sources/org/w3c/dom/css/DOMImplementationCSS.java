...
<span id="LC44" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.DOMImplementation</span><span class="o">;</span></span>
...
<span id="LC48" class="line" lang="java"><span class="cm"> *  This interface allows the DOM user to create a &lt;code&gt;CSSStyleSheet&lt;/code&gt;</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * outside the context of a document. There is no way to associate the new</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> * &lt;code&gt;CSSStyleSheet&lt;/code&gt; with a document in DOM Level 2.</span></span>
...
<span id="LC54" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">DOMImplementationCSS</span> <span class="kd">extends</span> <span class="nc">DOMImplementation</span> <span class="o">{</span></span>
<span id="LC55" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">     * Creates a new &lt;code&gt;CSSStyleSheet&lt;/code&gt;.</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">     * @param title  The advisory title. See also the  section.</span></span>
<span id="LC58" class="line" lang="java"><span class="cm">     * @param media  The comma-separated list of media associated with the</span></span>
<span id="LC59" class="line" lang="java"><span class="cm">     *   new style sheet. See also the  section.</span></span>
<span id="LC60" class="line" lang="java"><span class="cm">     * @return A new CSS style sheet.</span></span>
<span id="LC61" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC62" class="line" lang="java"><span class="cm">     *    SYNTAX_ERR: Raised if the specified media string value has a syntax</span></span>
<span id="LC63" class="line" lang="java"><span class="cm">     *   error and is unparsable.</span></span>
<span id="LC64" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC65" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CSSStyleSheet</span> <span class="nf">createCSSStyleSheet</span><span class="o">(</span><span class="nc">String</span> <span class="n">title</span><span class="o">,</span></span>
<span id="LC66" class="line" lang="java">                                             <span class="nc">String</span> <span class="n">media</span><span class="o">)</span></span>
<span id="LC67" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
