...
<span id="LC47" class="line" lang="java"><span class="cm"> *  The &lt;code&gt;CSS2Properties&lt;/code&gt; interface represents a convenience</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * mechanism for retrieving and setting properties within a</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * &lt;code&gt;CSSStyleDeclaration&lt;/code&gt;. The attributes of this interface</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> * correspond to all the properties specified in CSS2. Getting an attribute</span></span>
<span id="LC51" class="line" lang="java"><span class="cm"> * of this interface is equivalent to calling the</span></span>
<span id="LC52" class="line" lang="java"><span class="cm"> * &lt;code&gt;getPropertyValue&lt;/code&gt; method of the</span></span>
<span id="LC53" class="line" lang="java"><span class="cm"> * &lt;code&gt;CSSStyleDeclaration&lt;/code&gt; interface. Setting an attribute of this</span></span>
<span id="LC54" class="line" lang="java"><span class="cm"> * interface is equivalent to calling the &lt;code&gt;setProperty&lt;/code&gt; method of</span></span>
<span id="LC55" class="line" lang="java"><span class="cm"> * the &lt;code&gt;CSSStyleDeclaration&lt;/code&gt; interface.</span></span>
<span id="LC56" class="line" lang="java"><span class="cm"> * &lt;p&gt; A conformant implementation of the CSS module is not required to</span></span>
<span id="LC57" class="line" lang="java"><span class="cm"> * implement the &lt;code&gt;CSS2Properties&lt;/code&gt; interface. If an implementation</span></span>
<span id="LC58" class="line" lang="java"><span class="cm"> * does implement this interface, the expectation is that language-specific</span></span>
<span id="LC59" class="line" lang="java"><span class="cm"> * methods can be used to cast from an instance of the</span></span>
<span id="LC60" class="line" lang="java"><span class="cm"> * &lt;code&gt;CSSStyleDeclaration&lt;/code&gt; interface to the</span></span>
<span id="LC61" class="line" lang="java"><span class="cm"> * &lt;code&gt;CSS2Properties&lt;/code&gt; interface.</span></span>
<span id="LC62" class="line" lang="java"><span class="cm"> * &lt;p&gt; If an implementation does implement this interface, it is expected to</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * understand the specific syntax of the shorthand properties, and apply</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> * their semantics; when the &lt;code&gt;margin&lt;/code&gt; property is set, for</span></span>
<span id="LC65" class="line" lang="java"><span class="cm"> * example, the &lt;code&gt;marginTop&lt;/code&gt;, &lt;code&gt;marginRight&lt;/code&gt;,</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> * &lt;code&gt;marginBottom&lt;/code&gt; and &lt;code&gt;marginLeft&lt;/code&gt; properties are</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> * actually being set by the underlying implementation.</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> * &lt;p&gt; When dealing with CSS "shorthand" properties, the shorthand properties</span></span>
<span id="LC69" class="line" lang="java"><span class="cm"> * should be decomposed into their component longhand properties as</span></span>
<span id="LC70" class="line" lang="java"><span class="cm"> * appropriate, and when querying for their value, the form returned should</span></span>
<span id="LC71" class="line" lang="java"><span class="cm"> * be the shortest form exactly equivalent to the declarations made in the</span></span>
<span id="LC72" class="line" lang="java"><span class="cm"> * ruleset. However, if there is no shorthand declaration that could be</span></span>
<span id="LC73" class="line" lang="java"><span class="cm"> * added to the ruleset without changing in any way the rules already</span></span>
<span id="LC74" class="line" lang="java"><span class="cm"> * declared in the ruleset (i.e., by adding longhand rules that were</span></span>
<span id="LC75" class="line" lang="java"><span class="cm"> * previously not declared in the ruleset), then the empty string should be</span></span>
<span id="LC76" class="line" lang="java"><span class="cm"> * returned for the shorthand property.</span></span>
<span id="LC77" class="line" lang="java"><span class="cm"> * &lt;p&gt; For example, querying for the &lt;code&gt;font&lt;/code&gt; property should not</span></span>
<span id="LC78" class="line" lang="java"><span class="cm"> * return "normal normal normal 14pt/normal Arial, sans-serif", when "14pt</span></span>
<span id="LC79" class="line" lang="java"><span class="cm"> * Arial, sans-serif" suffices. (The normals are initial values, and are</span></span>
<span id="LC80" class="line" lang="java"><span class="cm"> * implied by use of the longhand property.)</span></span>
<span id="LC81" class="line" lang="java"><span class="cm"> * &lt;p&gt; If the values for all the longhand properties that compose a particular</span></span>
<span id="LC82" class="line" lang="java"><span class="cm"> * string are the initial values, then a string consisting of all the</span></span>
<span id="LC83" class="line" lang="java"><span class="cm"> * initial values should be returned (e.g. a &lt;code&gt;border-width&lt;/code&gt; value</span></span>
<span id="LC84" class="line" lang="java"><span class="cm"> * of "medium" should be returned as such, not as "").</span></span>
<span id="LC85" class="line" lang="java"><span class="cm"> * &lt;p&gt; For some shorthand properties that take missing values from other</span></span>
<span id="LC86" class="line" lang="java"><span class="cm"> * sides, such as the &lt;code&gt;margin&lt;/code&gt;, &lt;code&gt;padding&lt;/code&gt;, and</span></span>
<span id="LC87" class="line" lang="java"><span class="cm"> * &lt;code&gt;border-[width|style|color]&lt;/code&gt; properties, the minimum number of</span></span>
<span id="LC88" class="line" lang="java"><span class="cm"> * sides possible should be used; i.e., "0px 10px" will be returned instead</span></span>
<span id="LC89" class="line" lang="java"><span class="cm"> * of "0px 10px 0px 10px".</span></span>
<span id="LC90" class="line" lang="java"><span class="cm"> * &lt;p&gt; If the value of a shorthand property can not be decomposed into its</span></span>
<span id="LC91" class="line" lang="java"><span class="cm"> * component longhand properties, as is the case for the &lt;code&gt;font&lt;/code&gt;</span></span>
<span id="LC92" class="line" lang="java"><span class="cm"> * property with a value of "menu", querying for the values of the component</span></span>
<span id="LC93" class="line" lang="java"><span class="cm"> * longhand properties should return the empty string.</span></span>
<span id="LC94" class="line" lang="java"><span class="cm"> * &lt;p&gt;See also the &lt;a href='http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113'&gt;Document Object Model (DOM) Level 2 Style Specification&lt;/a&gt;.</span></span>
<span id="LC95" class="line" lang="java"><span class="cm"> * @since DOM Level 2</span></span>
<span id="LC96" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC97" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">CSS2Properties</span> <span class="o">{</span></span>
<span id="LC98" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC99" class="line" lang="java"><span class="cm">     *  See the azimuth property definition in CSS2.</span></span>
<span id="LC100" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC101" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getAzimuth</span><span class="o">();</span></span>
<span id="LC102" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC103" class="line" lang="java"><span class="cm">     *  See the azimuth property definition in CSS2.</span></span>
<span id="LC104" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC105" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC106" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC109" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setAzimuth</span><span class="o">(</span><span class="nc">String</span> <span class="n">azimuth</span><span class="o">)</span></span>
<span id="LC110" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC111" class="line" lang="java"></span>
<span id="LC112" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC113" class="line" lang="java"><span class="cm">     *  See the background property definition in CSS2.</span></span>
<span id="LC114" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC115" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBackground</span><span class="o">();</span></span>
<span id="LC116" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC117" class="line" lang="java"><span class="cm">     *  See the background property definition in CSS2.</span></span>
<span id="LC118" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC119" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC120" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC121" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC122" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC123" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBackground</span><span class="o">(</span><span class="nc">String</span> <span class="n">background</span><span class="o">)</span></span>
<span id="LC124" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC125" class="line" lang="java"></span>
<span id="LC126" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC127" class="line" lang="java"><span class="cm">     *  See the background-attachment property definition in CSS2.</span></span>
<span id="LC128" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC129" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBackgroundAttachment</span><span class="o">();</span></span>
<span id="LC130" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC131" class="line" lang="java"><span class="cm">     *  See the background-attachment property definition in CSS2.</span></span>
<span id="LC132" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC133" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC134" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC135" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC136" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC137" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBackgroundAttachment</span><span class="o">(</span><span class="nc">String</span> <span class="n">backgroundAttachment</span><span class="o">)</span></span>
<span id="LC138" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC139" class="line" lang="java"></span>
<span id="LC140" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC141" class="line" lang="java"><span class="cm">     *  See the background-color property definition in CSS2.</span></span>
<span id="LC142" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC143" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBackgroundColor</span><span class="o">();</span></span>
<span id="LC144" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">     *  See the background-color property definition in CSS2.</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC147" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC148" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC149" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC150" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC151" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBackgroundColor</span><span class="o">(</span><span class="nc">String</span> <span class="n">backgroundColor</span><span class="o">)</span></span>
<span id="LC152" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC153" class="line" lang="java"></span>
<span id="LC154" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC155" class="line" lang="java"><span class="cm">     *  See the background-image property definition in CSS2.</span></span>
<span id="LC156" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC157" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBackgroundImage</span><span class="o">();</span></span>
<span id="LC158" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC159" class="line" lang="java"><span class="cm">     *  See the background-image property definition in CSS2.</span></span>
<span id="LC160" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC161" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC162" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC163" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC164" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC165" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBackgroundImage</span><span class="o">(</span><span class="nc">String</span> <span class="n">backgroundImage</span><span class="o">)</span></span>
<span id="LC166" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC167" class="line" lang="java"></span>
<span id="LC168" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC169" class="line" lang="java"><span class="cm">     *  See the background-position property definition in CSS2.</span></span>
<span id="LC170" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC171" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBackgroundPosition</span><span class="o">();</span></span>
<span id="LC172" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC173" class="line" lang="java"><span class="cm">     *  See the background-position property definition in CSS2.</span></span>
<span id="LC174" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC175" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC176" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC177" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC178" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC179" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBackgroundPosition</span><span class="o">(</span><span class="nc">String</span> <span class="n">backgroundPosition</span><span class="o">)</span></span>
<span id="LC180" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC181" class="line" lang="java"></span>
<span id="LC182" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC183" class="line" lang="java"><span class="cm">     *  See the background-repeat property definition in CSS2.</span></span>
<span id="LC184" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC185" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBackgroundRepeat</span><span class="o">();</span></span>
<span id="LC186" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC187" class="line" lang="java"><span class="cm">     *  See the background-repeat property definition in CSS2.</span></span>
<span id="LC188" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC189" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC190" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC191" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC192" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC193" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBackgroundRepeat</span><span class="o">(</span><span class="nc">String</span> <span class="n">backgroundRepeat</span><span class="o">)</span></span>
<span id="LC194" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC195" class="line" lang="java"></span>
<span id="LC196" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC197" class="line" lang="java"><span class="cm">     *  See the border property definition in CSS2.</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC199" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorder</span><span class="o">();</span></span>
<span id="LC200" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC201" class="line" lang="java"><span class="cm">     *  See the border property definition in CSS2.</span></span>
<span id="LC202" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC203" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC204" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC205" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC206" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC207" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorder</span><span class="o">(</span><span class="nc">String</span> <span class="n">border</span><span class="o">)</span></span>
<span id="LC208" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC209" class="line" lang="java"></span>
<span id="LC210" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC211" class="line" lang="java"><span class="cm">     *  See the border-collapse property definition in CSS2.</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC213" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderCollapse</span><span class="o">();</span></span>
<span id="LC214" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC215" class="line" lang="java"><span class="cm">     *  See the border-collapse property definition in CSS2.</span></span>
<span id="LC216" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC217" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC218" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC219" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC220" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC221" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderCollapse</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderCollapse</span><span class="o">)</span></span>
<span id="LC222" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC223" class="line" lang="java"></span>
<span id="LC224" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC225" class="line" lang="java"><span class="cm">     *  See the border-color property definition in CSS2.</span></span>
<span id="LC226" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC227" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderColor</span><span class="o">();</span></span>
<span id="LC228" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC229" class="line" lang="java"><span class="cm">     *  See the border-color property definition in CSS2.</span></span>
<span id="LC230" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC231" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC232" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC233" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC234" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC235" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderColor</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderColor</span><span class="o">)</span></span>
<span id="LC236" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC237" class="line" lang="java"></span>
<span id="LC238" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC239" class="line" lang="java"><span class="cm">     *  See the border-spacing property definition in CSS2.</span></span>
<span id="LC240" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC241" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderSpacing</span><span class="o">();</span></span>
<span id="LC242" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC243" class="line" lang="java"><span class="cm">     *  See the border-spacing property definition in CSS2.</span></span>
<span id="LC244" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC245" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC246" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC247" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC248" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC249" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderSpacing</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderSpacing</span><span class="o">)</span></span>
<span id="LC250" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC251" class="line" lang="java"></span>
<span id="LC252" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC253" class="line" lang="java"><span class="cm">     *  See the border-style property definition in CSS2.</span></span>
<span id="LC254" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC255" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderStyle</span><span class="o">();</span></span>
<span id="LC256" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC257" class="line" lang="java"><span class="cm">     *  See the border-style property definition in CSS2.</span></span>
<span id="LC258" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC259" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC260" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC261" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC262" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC263" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderStyle</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderStyle</span><span class="o">)</span></span>
...
<span id="LC267" class="line" lang="java"><span class="cm">     *  See the border-top property definition in CSS2.</span></span>
<span id="LC268" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC269" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderTop</span><span class="o">();</span></span>
<span id="LC270" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC271" class="line" lang="java"><span class="cm">     *  See the border-top property definition in CSS2.</span></span>
<span id="LC272" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC273" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC274" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC275" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC276" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC277" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderTop</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderTop</span><span class="o">)</span></span>
<span id="LC278" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC279" class="line" lang="java"></span>
<span id="LC280" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC281" class="line" lang="java"><span class="cm">     *  See the border-right property definition in CSS2.</span></span>
<span id="LC282" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC283" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderRight</span><span class="o">();</span></span>
<span id="LC284" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC285" class="line" lang="java"><span class="cm">     *  See the border-right property definition in CSS2.</span></span>
<span id="LC286" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC287" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC288" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC291" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderRight</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderRight</span><span class="o">)</span></span>
<span id="LC292" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC293" class="line" lang="java"></span>
<span id="LC294" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC295" class="line" lang="java"><span class="cm">     *  See the border-bottom property definition in CSS2.</span></span>
<span id="LC296" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC297" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderBottom</span><span class="o">();</span></span>
<span id="LC298" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC299" class="line" lang="java"><span class="cm">     *  See the border-bottom property definition in CSS2.</span></span>
<span id="LC300" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC301" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC302" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC303" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC304" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC305" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderBottom</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderBottom</span><span class="o">)</span></span>
<span id="LC306" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC307" class="line" lang="java"></span>
<span id="LC308" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC309" class="line" lang="java"><span class="cm">     *  See the border-left property definition in CSS2.</span></span>
<span id="LC310" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC311" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderLeft</span><span class="o">();</span></span>
<span id="LC312" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC313" class="line" lang="java"><span class="cm">     *  See the border-left property definition in CSS2.</span></span>
<span id="LC314" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC315" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC316" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC317" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC318" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC319" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderLeft</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderLeft</span><span class="o">)</span></span>
<span id="LC320" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC321" class="line" lang="java"></span>
<span id="LC322" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC323" class="line" lang="java"><span class="cm">     *  See the border-top-color property definition in CSS2.</span></span>
<span id="LC324" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC325" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderTopColor</span><span class="o">();</span></span>
<span id="LC326" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC327" class="line" lang="java"><span class="cm">     *  See the border-top-color property definition in CSS2.</span></span>
<span id="LC328" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC329" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC330" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC331" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC332" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC333" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderTopColor</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderTopColor</span><span class="o">)</span></span>
<span id="LC334" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC335" class="line" lang="java"></span>
<span id="LC336" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC337" class="line" lang="java"><span class="cm">     *  See the border-right-color property definition in CSS2.</span></span>
<span id="LC338" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC339" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderRightColor</span><span class="o">();</span></span>
<span id="LC340" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">     *  See the border-right-color property definition in CSS2.</span></span>
<span id="LC342" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC343" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC344" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC345" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC346" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC347" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderRightColor</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderRightColor</span><span class="o">)</span></span>
<span id="LC348" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC349" class="line" lang="java"></span>
<span id="LC350" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC351" class="line" lang="java"><span class="cm">     *  See the border-bottom-color property definition in CSS2.</span></span>
<span id="LC352" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC353" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderBottomColor</span><span class="o">();</span></span>
<span id="LC354" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC355" class="line" lang="java"><span class="cm">     *  See the border-bottom-color property definition in CSS2.</span></span>
<span id="LC356" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC357" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC358" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC359" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC360" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC361" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderBottomColor</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderBottomColor</span><span class="o">)</span></span>
<span id="LC362" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC363" class="line" lang="java"></span>
<span id="LC364" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC365" class="line" lang="java"><span class="cm">     *  See the border-left-color property definition in CSS2.</span></span>
<span id="LC366" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC367" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderLeftColor</span><span class="o">();</span></span>
<span id="LC368" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC369" class="line" lang="java"><span class="cm">     *  See the border-left-color property definition in CSS2.</span></span>
<span id="LC370" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC371" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC372" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC373" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC374" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC375" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderLeftColor</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderLeftColor</span><span class="o">)</span></span>
<span id="LC376" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC377" class="line" lang="java"></span>
<span id="LC378" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC379" class="line" lang="java"><span class="cm">     *  See the border-top-style property definition in CSS2.</span></span>
<span id="LC380" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC381" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderTopStyle</span><span class="o">();</span></span>
<span id="LC382" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC383" class="line" lang="java"><span class="cm">     *  See the border-top-style property definition in CSS2.</span></span>
<span id="LC384" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC385" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC386" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC387" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC388" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC389" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderTopStyle</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderTopStyle</span><span class="o">)</span></span>
<span id="LC390" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC391" class="line" lang="java"></span>
<span id="LC392" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC393" class="line" lang="java"><span class="cm">     *  See the border-right-style property definition in CSS2.</span></span>
<span id="LC394" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC395" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderRightStyle</span><span class="o">();</span></span>
<span id="LC396" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC397" class="line" lang="java"><span class="cm">     *  See the border-right-style property definition in CSS2.</span></span>
<span id="LC398" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC399" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC400" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC401" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC402" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC403" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderRightStyle</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderRightStyle</span><span class="o">)</span></span>
<span id="LC404" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC405" class="line" lang="java"></span>
<span id="LC406" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC407" class="line" lang="java"><span class="cm">     *  See the border-bottom-style property definition in CSS2.</span></span>
<span id="LC408" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC409" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderBottomStyle</span><span class="o">();</span></span>
<span id="LC410" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC411" class="line" lang="java"><span class="cm">     *  See the border-bottom-style property definition in CSS2.</span></span>
<span id="LC412" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC413" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC414" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC415" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC416" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC417" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderBottomStyle</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderBottomStyle</span><span class="o">)</span></span>
<span id="LC418" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC419" class="line" lang="java"></span>
<span id="LC420" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">     *  See the border-left-style property definition in CSS2.</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC423" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderLeftStyle</span><span class="o">();</span></span>
<span id="LC424" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC425" class="line" lang="java"><span class="cm">     *  See the border-left-style property definition in CSS2.</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC427" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC428" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC429" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC430" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC431" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderLeftStyle</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderLeftStyle</span><span class="o">)</span></span>
<span id="LC432" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC433" class="line" lang="java"></span>
<span id="LC434" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC435" class="line" lang="java"><span class="cm">     *  See the border-top-width property definition in CSS2.</span></span>
<span id="LC436" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC437" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderTopWidth</span><span class="o">();</span></span>
<span id="LC438" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC439" class="line" lang="java"><span class="cm">     *  See the border-top-width property definition in CSS2.</span></span>
<span id="LC440" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC441" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC442" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC443" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC444" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC445" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderTopWidth</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderTopWidth</span><span class="o">)</span></span>
<span id="LC446" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC447" class="line" lang="java"></span>
<span id="LC448" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC449" class="line" lang="java"><span class="cm">     *  See the border-right-width property definition in CSS2.</span></span>
<span id="LC450" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC451" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderRightWidth</span><span class="o">();</span></span>
<span id="LC452" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC453" class="line" lang="java"><span class="cm">     *  See the border-right-width property definition in CSS2.</span></span>
<span id="LC454" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC455" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC456" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC457" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC458" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC459" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderRightWidth</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderRightWidth</span><span class="o">)</span></span>
<span id="LC460" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC461" class="line" lang="java"></span>
<span id="LC462" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC463" class="line" lang="java"><span class="cm">     *  See the border-bottom-width property definition in CSS2.</span></span>
<span id="LC464" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC465" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderBottomWidth</span><span class="o">();</span></span>
<span id="LC466" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC467" class="line" lang="java"><span class="cm">     *  See the border-bottom-width property definition in CSS2.</span></span>
<span id="LC468" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC469" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC470" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC471" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC472" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC473" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderBottomWidth</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderBottomWidth</span><span class="o">)</span></span>
<span id="LC474" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC475" class="line" lang="java"></span>
<span id="LC476" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC477" class="line" lang="java"><span class="cm">     *  See the border-left-width property definition in CSS2.</span></span>
<span id="LC478" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC479" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderLeftWidth</span><span class="o">();</span></span>
<span id="LC480" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC481" class="line" lang="java"><span class="cm">     *  See the border-left-width property definition in CSS2.</span></span>
<span id="LC482" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC483" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC484" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC485" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC486" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC487" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderLeftWidth</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderLeftWidth</span><span class="o">)</span></span>
<span id="LC488" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC489" class="line" lang="java"></span>
<span id="LC490" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC491" class="line" lang="java"><span class="cm">     *  See the border-width property definition in CSS2.</span></span>
<span id="LC492" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC493" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBorderWidth</span><span class="o">();</span></span>
<span id="LC494" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC495" class="line" lang="java"><span class="cm">     *  See the border-width property definition in CSS2.</span></span>
<span id="LC496" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC497" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC498" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC499" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC500" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC501" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBorderWidth</span><span class="o">(</span><span class="nc">String</span> <span class="n">borderWidth</span><span class="o">)</span></span>
<span id="LC502" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC503" class="line" lang="java"></span>
<span id="LC504" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC505" class="line" lang="java"><span class="cm">     *  See the bottom property definition in CSS2.</span></span>
<span id="LC506" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC507" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBottom</span><span class="o">();</span></span>
<span id="LC508" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC509" class="line" lang="java"><span class="cm">     *  See the bottom property definition in CSS2.</span></span>
<span id="LC510" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC511" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC512" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC513" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC514" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC515" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBottom</span><span class="o">(</span><span class="nc">String</span> <span class="n">bottom</span><span class="o">)</span></span>
<span id="LC516" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC517" class="line" lang="java"></span>
<span id="LC518" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC519" class="line" lang="java"><span class="cm">     *  See the caption-side property definition in CSS2.</span></span>
<span id="LC520" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC521" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getCaptionSide</span><span class="o">();</span></span>
<span id="LC522" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC523" class="line" lang="java"><span class="cm">     *  See the caption-side property definition in CSS2.</span></span>
<span id="LC524" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC525" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC526" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC527" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC528" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC529" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCaptionSide</span><span class="o">(</span><span class="nc">String</span> <span class="n">captionSide</span><span class="o">)</span></span>
<span id="LC530" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC531" class="line" lang="java"></span>
<span id="LC532" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC533" class="line" lang="java"><span class="cm">     *  See the clear property definition in CSS2.</span></span>
<span id="LC534" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC535" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getClear</span><span class="o">();</span></span>
<span id="LC536" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC537" class="line" lang="java"><span class="cm">     *  See the clear property definition in CSS2.</span></span>
<span id="LC538" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC539" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC540" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC541" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC542" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC543" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setClear</span><span class="o">(</span><span class="nc">String</span> <span class="n">clear</span><span class="o">)</span></span>
<span id="LC544" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC545" class="line" lang="java"></span>
<span id="LC546" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC547" class="line" lang="java"><span class="cm">     *  See the clip property definition in CSS2.</span></span>
<span id="LC548" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC549" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getClip</span><span class="o">();</span></span>
<span id="LC550" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC551" class="line" lang="java"><span class="cm">     *  See the clip property definition in CSS2.</span></span>
<span id="LC552" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC553" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC554" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC555" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC556" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC557" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setClip</span><span class="o">(</span><span class="nc">String</span> <span class="n">clip</span><span class="o">)</span></span>
<span id="LC558" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC559" class="line" lang="java"></span>
<span id="LC560" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC561" class="line" lang="java"><span class="cm">     *  See the color property definition in CSS2.</span></span>
<span id="LC562" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC563" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getColor</span><span class="o">();</span></span>
<span id="LC564" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC565" class="line" lang="java"><span class="cm">     *  See the color property definition in CSS2.</span></span>
<span id="LC566" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC567" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC568" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC569" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC570" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC571" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setColor</span><span class="o">(</span><span class="nc">String</span> <span class="n">color</span><span class="o">)</span></span>
<span id="LC572" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC573" class="line" lang="java"></span>
<span id="LC574" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC575" class="line" lang="java"><span class="cm">     *  See the content property definition in CSS2.</span></span>
<span id="LC576" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC577" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getContent</span><span class="o">();</span></span>
<span id="LC578" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC579" class="line" lang="java"><span class="cm">     *  See the content property definition in CSS2.</span></span>
<span id="LC580" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC581" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC582" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC583" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC584" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC585" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setContent</span><span class="o">(</span><span class="nc">String</span> <span class="n">content</span><span class="o">)</span></span>
<span id="LC586" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC587" class="line" lang="java"></span>
<span id="LC588" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC589" class="line" lang="java"><span class="cm">     *  See the counter-increment property definition in CSS2.</span></span>
<span id="LC590" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC591" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getCounterIncrement</span><span class="o">();</span></span>
<span id="LC592" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC593" class="line" lang="java"><span class="cm">     *  See the counter-increment property definition in CSS2.</span></span>
<span id="LC594" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC595" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC596" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC597" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC598" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC599" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCounterIncrement</span><span class="o">(</span><span class="nc">String</span> <span class="n">counterIncrement</span><span class="o">)</span></span>
<span id="LC600" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC601" class="line" lang="java"></span>
<span id="LC602" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC603" class="line" lang="java"><span class="cm">     *  See the counter-reset property definition in CSS2.</span></span>
<span id="LC604" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC605" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getCounterReset</span><span class="o">();</span></span>
<span id="LC606" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC607" class="line" lang="java"><span class="cm">     *  See the counter-reset property definition in CSS2.</span></span>
<span id="LC608" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC609" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC610" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC611" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC612" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC613" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCounterReset</span><span class="o">(</span><span class="nc">String</span> <span class="n">counterReset</span><span class="o">)</span></span>
<span id="LC614" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC615" class="line" lang="java"></span>
<span id="LC616" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC617" class="line" lang="java"><span class="cm">     *  See the cue property definition in CSS2.</span></span>
<span id="LC618" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC619" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getCue</span><span class="o">();</span></span>
<span id="LC620" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC621" class="line" lang="java"><span class="cm">     *  See the cue property definition in CSS2.</span></span>
<span id="LC622" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC623" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC624" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC625" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC626" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC627" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCue</span><span class="o">(</span><span class="nc">String</span> <span class="n">cue</span><span class="o">)</span></span>
<span id="LC628" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC629" class="line" lang="java"></span>
<span id="LC630" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC631" class="line" lang="java"><span class="cm">     *  See the cue-after property definition in CSS2.</span></span>
<span id="LC632" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC633" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getCueAfter</span><span class="o">();</span></span>
<span id="LC634" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC635" class="line" lang="java"><span class="cm">     *  See the cue-after property definition in CSS2.</span></span>
<span id="LC636" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC637" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC638" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC639" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC640" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC641" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCueAfter</span><span class="o">(</span><span class="nc">String</span> <span class="n">cueAfter</span><span class="o">)</span></span>
<span id="LC642" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC643" class="line" lang="java"></span>
<span id="LC644" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC645" class="line" lang="java"><span class="cm">     *  See the cue-before property definition in CSS2.</span></span>
<span id="LC646" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC647" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getCueBefore</span><span class="o">();</span></span>
<span id="LC648" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC649" class="line" lang="java"><span class="cm">     *  See the cue-before property definition in CSS2.</span></span>
<span id="LC650" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC651" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC652" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC653" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC654" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC655" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCueBefore</span><span class="o">(</span><span class="nc">String</span> <span class="n">cueBefore</span><span class="o">)</span></span>
<span id="LC656" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC657" class="line" lang="java"></span>
<span id="LC658" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC659" class="line" lang="java"><span class="cm">     *  See the cursor property definition in CSS2.</span></span>
<span id="LC660" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC661" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getCursor</span><span class="o">();</span></span>
<span id="LC662" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC663" class="line" lang="java"><span class="cm">     *  See the cursor property definition in CSS2.</span></span>
<span id="LC664" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC665" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC666" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC667" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC668" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC669" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCursor</span><span class="o">(</span><span class="nc">String</span> <span class="n">cursor</span><span class="o">)</span></span>
<span id="LC670" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC671" class="line" lang="java"></span>
<span id="LC672" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC673" class="line" lang="java"><span class="cm">     *  See the direction property definition in CSS2.</span></span>
<span id="LC674" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC675" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getDirection</span><span class="o">();</span></span>
<span id="LC676" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC677" class="line" lang="java"><span class="cm">     *  See the direction property definition in CSS2.</span></span>
<span id="LC678" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC679" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC680" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC681" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC682" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC683" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDirection</span><span class="o">(</span><span class="nc">String</span> <span class="n">direction</span><span class="o">)</span></span>
<span id="LC684" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC685" class="line" lang="java"></span>
<span id="LC686" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC687" class="line" lang="java"><span class="cm">     *  See the display property definition in CSS2.</span></span>
<span id="LC688" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC689" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getDisplay</span><span class="o">();</span></span>
<span id="LC690" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC691" class="line" lang="java"><span class="cm">     *  See the display property definition in CSS2.</span></span>
<span id="LC692" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC693" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC694" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC695" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC696" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC697" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDisplay</span><span class="o">(</span><span class="nc">String</span> <span class="n">display</span><span class="o">)</span></span>
<span id="LC698" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC699" class="line" lang="java"></span>
<span id="LC700" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC701" class="line" lang="java"><span class="cm">     *  See the elevation property definition in CSS2.</span></span>
<span id="LC702" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC703" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getElevation</span><span class="o">();</span></span>
<span id="LC704" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC705" class="line" lang="java"><span class="cm">     *  See the elevation property definition in CSS2.</span></span>
<span id="LC706" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC707" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC708" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC709" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC710" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC711" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setElevation</span><span class="o">(</span><span class="nc">String</span> <span class="n">elevation</span><span class="o">)</span></span>
<span id="LC712" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC713" class="line" lang="java"></span>
<span id="LC714" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC715" class="line" lang="java"><span class="cm">     *  See the empty-cells property definition in CSS2.</span></span>
<span id="LC716" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC717" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getEmptyCells</span><span class="o">();</span></span>
<span id="LC718" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC719" class="line" lang="java"><span class="cm">     *  See the empty-cells property definition in CSS2.</span></span>
<span id="LC720" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC721" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC722" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC723" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC724" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC725" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setEmptyCells</span><span class="o">(</span><span class="nc">String</span> <span class="n">emptyCells</span><span class="o">)</span></span>
<span id="LC726" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC727" class="line" lang="java"></span>
<span id="LC728" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC729" class="line" lang="java"><span class="cm">     *  See the float property definition in CSS2.</span></span>
<span id="LC730" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC731" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getCssFloat</span><span class="o">();</span></span>
<span id="LC732" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC733" class="line" lang="java"><span class="cm">     *  See the float property definition in CSS2.</span></span>
<span id="LC734" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC735" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC736" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC737" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC738" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC739" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCssFloat</span><span class="o">(</span><span class="nc">String</span> <span class="n">cssFloat</span><span class="o">)</span></span>
<span id="LC740" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC741" class="line" lang="java"></span>
<span id="LC742" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC743" class="line" lang="java"><span class="cm">     *  See the font property definition in CSS2.</span></span>
<span id="LC744" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC745" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getFont</span><span class="o">();</span></span>
<span id="LC746" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC747" class="line" lang="java"><span class="cm">     *  See the font property definition in CSS2.</span></span>
<span id="LC748" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC749" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC750" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC751" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC752" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC753" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setFont</span><span class="o">(</span><span class="nc">String</span> <span class="n">font</span><span class="o">)</span></span>
<span id="LC754" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC755" class="line" lang="java"></span>
<span id="LC756" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC757" class="line" lang="java"><span class="cm">     *  See the font-family property definition in CSS2.</span></span>
<span id="LC758" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC759" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getFontFamily</span><span class="o">();</span></span>
<span id="LC760" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC761" class="line" lang="java"><span class="cm">     *  See the font-family property definition in CSS2.</span></span>
<span id="LC762" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC763" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC764" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC765" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC766" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC767" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setFontFamily</span><span class="o">(</span><span class="nc">String</span> <span class="n">fontFamily</span><span class="o">)</span></span>
<span id="LC768" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC769" class="line" lang="java"></span>
<span id="LC770" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC771" class="line" lang="java"><span class="cm">     *  See the font-size property definition in CSS2.</span></span>
<span id="LC772" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC773" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getFontSize</span><span class="o">();</span></span>
<span id="LC774" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC775" class="line" lang="java"><span class="cm">     *  See the font-size property definition in CSS2.</span></span>
<span id="LC776" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC777" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC778" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC779" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC780" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC781" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setFontSize</span><span class="o">(</span><span class="nc">String</span> <span class="n">fontSize</span><span class="o">)</span></span>
<span id="LC782" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC783" class="line" lang="java"></span>
<span id="LC784" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC785" class="line" lang="java"><span class="cm">     *  See the font-size-adjust property definition in CSS2.</span></span>
<span id="LC786" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC787" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getFontSizeAdjust</span><span class="o">();</span></span>
<span id="LC788" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC789" class="line" lang="java"><span class="cm">     *  See the font-size-adjust property definition in CSS2.</span></span>
<span id="LC790" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC791" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC792" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC793" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC794" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC795" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setFontSizeAdjust</span><span class="o">(</span><span class="nc">String</span> <span class="n">fontSizeAdjust</span><span class="o">)</span></span>
<span id="LC796" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC797" class="line" lang="java"></span>
<span id="LC798" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC799" class="line" lang="java"><span class="cm">     *  See the font-stretch property definition in CSS2.</span></span>
<span id="LC800" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC801" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getFontStretch</span><span class="o">();</span></span>
<span id="LC802" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC803" class="line" lang="java"><span class="cm">     *  See the font-stretch property definition in CSS2.</span></span>
<span id="LC804" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC805" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC806" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC807" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC808" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC809" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setFontStretch</span><span class="o">(</span><span class="nc">String</span> <span class="n">fontStretch</span><span class="o">)</span></span>
<span id="LC810" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC811" class="line" lang="java"></span>
<span id="LC812" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC813" class="line" lang="java"><span class="cm">     *  See the font-style property definition in CSS2.</span></span>
<span id="LC814" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC815" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getFontStyle</span><span class="o">();</span></span>
<span id="LC816" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC817" class="line" lang="java"><span class="cm">     *  See the font-style property definition in CSS2.</span></span>
<span id="LC818" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC819" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC820" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC821" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC822" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC823" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setFontStyle</span><span class="o">(</span><span class="nc">String</span> <span class="n">fontStyle</span><span class="o">)</span></span>
<span id="LC824" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC825" class="line" lang="java"></span>
<span id="LC826" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC827" class="line" lang="java"><span class="cm">     *  See the font-variant property definition in CSS2.</span></span>
<span id="LC828" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC829" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getFontVariant</span><span class="o">();</span></span>
<span id="LC830" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC831" class="line" lang="java"><span class="cm">     *  See the font-variant property definition in CSS2.</span></span>
<span id="LC832" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC833" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC834" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC835" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC836" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC837" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setFontVariant</span><span class="o">(</span><span class="nc">String</span> <span class="n">fontVariant</span><span class="o">)</span></span>
<span id="LC838" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC839" class="line" lang="java"></span>
<span id="LC840" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC841" class="line" lang="java"><span class="cm">     *  See the font-weight property definition in CSS2.</span></span>
<span id="LC842" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC843" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getFontWeight</span><span class="o">();</span></span>
<span id="LC844" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC845" class="line" lang="java"><span class="cm">     *  See the font-weight property definition in CSS2.</span></span>
<span id="LC846" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC847" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC848" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC849" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC850" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC851" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setFontWeight</span><span class="o">(</span><span class="nc">String</span> <span class="n">fontWeight</span><span class="o">)</span></span>
<span id="LC852" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC853" class="line" lang="java"></span>
<span id="LC854" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC855" class="line" lang="java"><span class="cm">     *  See the height property definition in CSS2.</span></span>
<span id="LC856" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC857" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getHeight</span><span class="o">();</span></span>
<span id="LC858" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC859" class="line" lang="java"><span class="cm">     *  See the height property definition in CSS2.</span></span>
<span id="LC860" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC861" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC862" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC863" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC864" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC865" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setHeight</span><span class="o">(</span><span class="nc">String</span> <span class="n">height</span><span class="o">)</span></span>
<span id="LC866" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC867" class="line" lang="java"></span>
<span id="LC868" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC869" class="line" lang="java"><span class="cm">     *  See the left property definition in CSS2.</span></span>
<span id="LC870" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC871" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getLeft</span><span class="o">();</span></span>
<span id="LC872" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC873" class="line" lang="java"><span class="cm">     *  See the left property definition in CSS2.</span></span>
<span id="LC874" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC875" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC876" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC877" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC878" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC879" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setLeft</span><span class="o">(</span><span class="nc">String</span> <span class="n">left</span><span class="o">)</span></span>
<span id="LC880" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC881" class="line" lang="java"></span>
<span id="LC882" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC883" class="line" lang="java"><span class="cm">     *  See the letter-spacing property definition in CSS2.</span></span>
<span id="LC884" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC885" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getLetterSpacing</span><span class="o">();</span></span>
<span id="LC886" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC887" class="line" lang="java"><span class="cm">     *  See the letter-spacing property definition in CSS2.</span></span>
<span id="LC888" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC889" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC890" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC891" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC892" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC893" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setLetterSpacing</span><span class="o">(</span><span class="nc">String</span> <span class="n">letterSpacing</span><span class="o">)</span></span>
<span id="LC894" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC895" class="line" lang="java"></span>
<span id="LC896" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC897" class="line" lang="java"><span class="cm">     *  See the line-height property definition in CSS2.</span></span>
<span id="LC898" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC899" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getLineHeight</span><span class="o">();</span></span>
<span id="LC900" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC901" class="line" lang="java"><span class="cm">     *  See the line-height property definition in CSS2.</span></span>
<span id="LC902" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC903" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC904" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC905" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC906" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC907" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setLineHeight</span><span class="o">(</span><span class="nc">String</span> <span class="n">lineHeight</span><span class="o">)</span></span>
<span id="LC908" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC909" class="line" lang="java"></span>
<span id="LC910" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC911" class="line" lang="java"><span class="cm">     *  See the list-style property definition in CSS2.</span></span>
<span id="LC912" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC913" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getListStyle</span><span class="o">();</span></span>
<span id="LC914" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC915" class="line" lang="java"><span class="cm">     *  See the list-style property definition in CSS2.</span></span>
<span id="LC916" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC917" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC918" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC919" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC920" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC921" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setListStyle</span><span class="o">(</span><span class="nc">String</span> <span class="n">listStyle</span><span class="o">)</span></span>
<span id="LC922" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC923" class="line" lang="java"></span>
<span id="LC924" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC925" class="line" lang="java"><span class="cm">     *  See the list-style-image property definition in CSS2.</span></span>
<span id="LC926" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC927" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getListStyleImage</span><span class="o">();</span></span>
<span id="LC928" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC929" class="line" lang="java"><span class="cm">     *  See the list-style-image property definition in CSS2.</span></span>
<span id="LC930" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC931" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC932" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC933" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC934" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC935" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setListStyleImage</span><span class="o">(</span><span class="nc">String</span> <span class="n">listStyleImage</span><span class="o">)</span></span>
<span id="LC936" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC937" class="line" lang="java"></span>
<span id="LC938" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC939" class="line" lang="java"><span class="cm">     *  See the list-style-position property definition in CSS2.</span></span>
<span id="LC940" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC941" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getListStylePosition</span><span class="o">();</span></span>
<span id="LC942" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC943" class="line" lang="java"><span class="cm">     *  See the list-style-position property definition in CSS2.</span></span>
<span id="LC944" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC945" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC946" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC947" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC948" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC949" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setListStylePosition</span><span class="o">(</span><span class="nc">String</span> <span class="n">listStylePosition</span><span class="o">)</span></span>
<span id="LC950" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC951" class="line" lang="java"></span>
<span id="LC952" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC953" class="line" lang="java"><span class="cm">     *  See the list-style-type property definition in CSS2.</span></span>
<span id="LC954" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC955" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getListStyleType</span><span class="o">();</span></span>
<span id="LC956" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC957" class="line" lang="java"><span class="cm">     *  See the list-style-type property definition in CSS2.</span></span>
<span id="LC958" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC959" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC960" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC961" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC962" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC963" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setListStyleType</span><span class="o">(</span><span class="nc">String</span> <span class="n">listStyleType</span><span class="o">)</span></span>
<span id="LC964" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC965" class="line" lang="java"></span>
<span id="LC966" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC967" class="line" lang="java"><span class="cm">     *  See the margin property definition in CSS2.</span></span>
<span id="LC968" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC969" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMargin</span><span class="o">();</span></span>
<span id="LC970" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC971" class="line" lang="java"><span class="cm">     *  See the margin property definition in CSS2.</span></span>
<span id="LC972" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC973" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC974" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC975" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC976" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC977" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMargin</span><span class="o">(</span><span class="nc">String</span> <span class="n">margin</span><span class="o">)</span></span>
<span id="LC978" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC979" class="line" lang="java"></span>
<span id="LC980" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC981" class="line" lang="java"><span class="cm">     *  See the margin-top property definition in CSS2.</span></span>
<span id="LC982" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC983" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMarginTop</span><span class="o">();</span></span>
<span id="LC984" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC985" class="line" lang="java"><span class="cm">     *  See the margin-top property definition in CSS2.</span></span>
<span id="LC986" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC987" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC988" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC989" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC990" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC991" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMarginTop</span><span class="o">(</span><span class="nc">String</span> <span class="n">marginTop</span><span class="o">)</span></span>
<span id="LC992" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC993" class="line" lang="java"></span>
<span id="LC994" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC995" class="line" lang="java"><span class="cm">     *  See the margin-right property definition in CSS2.</span></span>
<span id="LC996" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC997" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMarginRight</span><span class="o">();</span></span>
<span id="LC998" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC999" class="line" lang="java"><span class="cm">     *  See the margin-right property definition in CSS2.</span></span>
<span id="LC1000" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1001" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1002" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1003" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1004" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1005" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMarginRight</span><span class="o">(</span><span class="nc">String</span> <span class="n">marginRight</span><span class="o">)</span></span>
<span id="LC1006" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1007" class="line" lang="java"></span>
<span id="LC1008" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1009" class="line" lang="java"><span class="cm">     *  See the margin-bottom property definition in CSS2.</span></span>
<span id="LC1010" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1011" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMarginBottom</span><span class="o">();</span></span>
<span id="LC1012" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1013" class="line" lang="java"><span class="cm">     *  See the margin-bottom property definition in CSS2.</span></span>
<span id="LC1014" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1015" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1016" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1017" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1018" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1019" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMarginBottom</span><span class="o">(</span><span class="nc">String</span> <span class="n">marginBottom</span><span class="o">)</span></span>
<span id="LC1020" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1021" class="line" lang="java"></span>
<span id="LC1022" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1023" class="line" lang="java"><span class="cm">     *  See the margin-left property definition in CSS2.</span></span>
<span id="LC1024" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1025" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMarginLeft</span><span class="o">();</span></span>
<span id="LC1026" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1027" class="line" lang="java"><span class="cm">     *  See the margin-left property definition in CSS2.</span></span>
<span id="LC1028" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1029" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1030" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1031" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1032" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1033" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMarginLeft</span><span class="o">(</span><span class="nc">String</span> <span class="n">marginLeft</span><span class="o">)</span></span>
<span id="LC1034" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1035" class="line" lang="java"></span>
<span id="LC1036" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1037" class="line" lang="java"><span class="cm">     *  See the marker-offset property definition in CSS2.</span></span>
<span id="LC1038" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1039" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMarkerOffset</span><span class="o">();</span></span>
<span id="LC1040" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1041" class="line" lang="java"><span class="cm">     *  See the marker-offset property definition in CSS2.</span></span>
<span id="LC1042" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1043" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1044" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1045" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1046" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1047" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMarkerOffset</span><span class="o">(</span><span class="nc">String</span> <span class="n">markerOffset</span><span class="o">)</span></span>
<span id="LC1048" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1049" class="line" lang="java"></span>
<span id="LC1050" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1051" class="line" lang="java"><span class="cm">     *  See the marks property definition in CSS2.</span></span>
<span id="LC1052" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1053" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMarks</span><span class="o">();</span></span>
<span id="LC1054" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1055" class="line" lang="java"><span class="cm">     *  See the marks property definition in CSS2.</span></span>
<span id="LC1056" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1057" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1058" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1059" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1060" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1061" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMarks</span><span class="o">(</span><span class="nc">String</span> <span class="n">marks</span><span class="o">)</span></span>
<span id="LC1062" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1063" class="line" lang="java"></span>
<span id="LC1064" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1065" class="line" lang="java"><span class="cm">     *  See the max-height property definition in CSS2.</span></span>
<span id="LC1066" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1067" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMaxHeight</span><span class="o">();</span></span>
<span id="LC1068" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1069" class="line" lang="java"><span class="cm">     *  See the max-height property definition in CSS2.</span></span>
<span id="LC1070" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1071" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1072" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1073" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1074" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1075" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMaxHeight</span><span class="o">(</span><span class="nc">String</span> <span class="n">maxHeight</span><span class="o">)</span></span>
<span id="LC1076" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1077" class="line" lang="java"></span>
<span id="LC1078" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1079" class="line" lang="java"><span class="cm">     *  See the max-width property definition in CSS2.</span></span>
<span id="LC1080" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1081" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMaxWidth</span><span class="o">();</span></span>
<span id="LC1082" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1083" class="line" lang="java"><span class="cm">     *  See the max-width property definition in CSS2.</span></span>
<span id="LC1084" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1085" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1086" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1087" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1088" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1089" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMaxWidth</span><span class="o">(</span><span class="nc">String</span> <span class="n">maxWidth</span><span class="o">)</span></span>
<span id="LC1090" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1091" class="line" lang="java"></span>
<span id="LC1092" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1093" class="line" lang="java"><span class="cm">     *  See the min-height property definition in CSS2.</span></span>
<span id="LC1094" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1095" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMinHeight</span><span class="o">();</span></span>
<span id="LC1096" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1097" class="line" lang="java"><span class="cm">     *  See the min-height property definition in CSS2.</span></span>
<span id="LC1098" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1099" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1100" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1101" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1102" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1103" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMinHeight</span><span class="o">(</span><span class="nc">String</span> <span class="n">minHeight</span><span class="o">)</span></span>
<span id="LC1104" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1105" class="line" lang="java"></span>
<span id="LC1106" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1107" class="line" lang="java"><span class="cm">     *  See the min-width property definition in CSS2.</span></span>
<span id="LC1108" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1109" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMinWidth</span><span class="o">();</span></span>
<span id="LC1110" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1111" class="line" lang="java"><span class="cm">     *  See the min-width property definition in CSS2.</span></span>
<span id="LC1112" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1113" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1114" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1115" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1116" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1117" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMinWidth</span><span class="o">(</span><span class="nc">String</span> <span class="n">minWidth</span><span class="o">)</span></span>
<span id="LC1118" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1119" class="line" lang="java"></span>
<span id="LC1120" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1121" class="line" lang="java"><span class="cm">     *  See the orphans property definition in CSS2.</span></span>
<span id="LC1122" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1123" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getOrphans</span><span class="o">();</span></span>
<span id="LC1124" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1125" class="line" lang="java"><span class="cm">     *  See the orphans property definition in CSS2.</span></span>
<span id="LC1126" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1127" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1128" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1129" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1130" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1131" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOrphans</span><span class="o">(</span><span class="nc">String</span> <span class="n">orphans</span><span class="o">)</span></span>
<span id="LC1132" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1133" class="line" lang="java"></span>
<span id="LC1134" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1135" class="line" lang="java"><span class="cm">     *  See the outline property definition in CSS2.</span></span>
<span id="LC1136" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1137" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getOutline</span><span class="o">();</span></span>
<span id="LC1138" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1139" class="line" lang="java"><span class="cm">     *  See the outline property definition in CSS2.</span></span>
<span id="LC1140" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1141" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1142" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1143" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1144" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1145" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOutline</span><span class="o">(</span><span class="nc">String</span> <span class="n">outline</span><span class="o">)</span></span>
<span id="LC1146" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1147" class="line" lang="java"></span>
<span id="LC1148" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1149" class="line" lang="java"><span class="cm">     *  See the outline-color property definition in CSS2.</span></span>
<span id="LC1150" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1151" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getOutlineColor</span><span class="o">();</span></span>
<span id="LC1152" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1153" class="line" lang="java"><span class="cm">     *  See the outline-color property definition in CSS2.</span></span>
<span id="LC1154" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1155" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1156" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1157" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1158" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1159" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOutlineColor</span><span class="o">(</span><span class="nc">String</span> <span class="n">outlineColor</span><span class="o">)</span></span>
<span id="LC1160" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1161" class="line" lang="java"></span>
<span id="LC1162" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1163" class="line" lang="java"><span class="cm">     *  See the outline-style property definition in CSS2.</span></span>
<span id="LC1164" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1165" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getOutlineStyle</span><span class="o">();</span></span>
<span id="LC1166" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1167" class="line" lang="java"><span class="cm">     *  See the outline-style property definition in CSS2.</span></span>
<span id="LC1168" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1169" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1170" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1171" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1172" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1173" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOutlineStyle</span><span class="o">(</span><span class="nc">String</span> <span class="n">outlineStyle</span><span class="o">)</span></span>
<span id="LC1174" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1175" class="line" lang="java"></span>
<span id="LC1176" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1177" class="line" lang="java"><span class="cm">     *  See the outline-width property definition in CSS2.</span></span>
<span id="LC1178" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1179" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getOutlineWidth</span><span class="o">();</span></span>
<span id="LC1180" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1181" class="line" lang="java"><span class="cm">     *  See the outline-width property definition in CSS2.</span></span>
<span id="LC1182" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1183" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1184" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1185" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1186" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1187" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOutlineWidth</span><span class="o">(</span><span class="nc">String</span> <span class="n">outlineWidth</span><span class="o">)</span></span>
<span id="LC1188" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1189" class="line" lang="java"></span>
<span id="LC1190" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1191" class="line" lang="java"><span class="cm">     *  See the overflow property definition in CSS2.</span></span>
<span id="LC1192" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1193" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getOverflow</span><span class="o">();</span></span>
<span id="LC1194" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1195" class="line" lang="java"><span class="cm">     *  See the overflow property definition in CSS2.</span></span>
<span id="LC1196" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1197" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1198" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1199" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1200" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1201" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOverflow</span><span class="o">(</span><span class="nc">String</span> <span class="n">overflow</span><span class="o">)</span></span>
<span id="LC1202" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1203" class="line" lang="java"></span>
<span id="LC1204" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1205" class="line" lang="java"><span class="cm">     *  See the padding property definition in CSS2.</span></span>
<span id="LC1206" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1207" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPadding</span><span class="o">();</span></span>
<span id="LC1208" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1209" class="line" lang="java"><span class="cm">     *  See the padding property definition in CSS2.</span></span>
<span id="LC1210" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1211" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1212" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1213" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1214" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1215" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPadding</span><span class="o">(</span><span class="nc">String</span> <span class="n">padding</span><span class="o">)</span></span>
<span id="LC1216" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1217" class="line" lang="java"></span>
<span id="LC1218" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1219" class="line" lang="java"><span class="cm">     *  See the padding-top property definition in CSS2.</span></span>
<span id="LC1220" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1221" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPaddingTop</span><span class="o">();</span></span>
<span id="LC1222" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1223" class="line" lang="java"><span class="cm">     *  See the padding-top property definition in CSS2.</span></span>
<span id="LC1224" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1225" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1226" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1227" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1228" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1229" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPaddingTop</span><span class="o">(</span><span class="nc">String</span> <span class="n">paddingTop</span><span class="o">)</span></span>
<span id="LC1230" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1231" class="line" lang="java"></span>
<span id="LC1232" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1233" class="line" lang="java"><span class="cm">     *  See the padding-right property definition in CSS2.</span></span>
<span id="LC1234" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1235" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPaddingRight</span><span class="o">();</span></span>
<span id="LC1236" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1237" class="line" lang="java"><span class="cm">     *  See the padding-right property definition in CSS2.</span></span>
<span id="LC1238" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1239" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1240" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1241" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1242" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1243" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPaddingRight</span><span class="o">(</span><span class="nc">String</span> <span class="n">paddingRight</span><span class="o">)</span></span>
<span id="LC1244" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1245" class="line" lang="java"></span>
<span id="LC1246" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1247" class="line" lang="java"><span class="cm">     *  See the padding-bottom property definition in CSS2.</span></span>
<span id="LC1248" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1249" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPaddingBottom</span><span class="o">();</span></span>
<span id="LC1250" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1251" class="line" lang="java"><span class="cm">     *  See the padding-bottom property definition in CSS2.</span></span>
<span id="LC1252" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1253" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1254" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1255" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1256" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1257" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPaddingBottom</span><span class="o">(</span><span class="nc">String</span> <span class="n">paddingBottom</span><span class="o">)</span></span>
<span id="LC1258" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1259" class="line" lang="java"></span>
<span id="LC1260" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1261" class="line" lang="java"><span class="cm">     *  See the padding-left property definition in CSS2.</span></span>
<span id="LC1262" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1263" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPaddingLeft</span><span class="o">();</span></span>
<span id="LC1264" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1265" class="line" lang="java"><span class="cm">     *  See the padding-left property definition in CSS2.</span></span>
<span id="LC1266" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1267" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1268" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1269" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1270" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1271" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPaddingLeft</span><span class="o">(</span><span class="nc">String</span> <span class="n">paddingLeft</span><span class="o">)</span></span>
<span id="LC1272" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1273" class="line" lang="java"></span>
<span id="LC1274" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1275" class="line" lang="java"><span class="cm">     *  See the page property definition in CSS2.</span></span>
<span id="LC1276" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1277" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPage</span><span class="o">();</span></span>
<span id="LC1278" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1279" class="line" lang="java"><span class="cm">     *  See the page property definition in CSS2.</span></span>
<span id="LC1280" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1281" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1282" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1283" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1284" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1285" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPage</span><span class="o">(</span><span class="nc">String</span> <span class="n">page</span><span class="o">)</span></span>
<span id="LC1286" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1287" class="line" lang="java"></span>
<span id="LC1288" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1289" class="line" lang="java"><span class="cm">     *  See the page-break-after property definition in CSS2.</span></span>
<span id="LC1290" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1291" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPageBreakAfter</span><span class="o">();</span></span>
<span id="LC1292" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1293" class="line" lang="java"><span class="cm">     *  See the page-break-after property definition in CSS2.</span></span>
<span id="LC1294" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1295" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1296" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1297" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1298" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1299" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPageBreakAfter</span><span class="o">(</span><span class="nc">String</span> <span class="n">pageBreakAfter</span><span class="o">)</span></span>
<span id="LC1300" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1301" class="line" lang="java"></span>
<span id="LC1302" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1303" class="line" lang="java"><span class="cm">     *  See the page-break-before property definition in CSS2.</span></span>
<span id="LC1304" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1305" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPageBreakBefore</span><span class="o">();</span></span>
<span id="LC1306" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1307" class="line" lang="java"><span class="cm">     *  See the page-break-before property definition in CSS2.</span></span>
<span id="LC1308" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1309" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1310" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1311" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1312" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1313" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPageBreakBefore</span><span class="o">(</span><span class="nc">String</span> <span class="n">pageBreakBefore</span><span class="o">)</span></span>
<span id="LC1314" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1315" class="line" lang="java"></span>
<span id="LC1316" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1317" class="line" lang="java"><span class="cm">     *  See the page-break-inside property definition in CSS2.</span></span>
<span id="LC1318" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1319" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPageBreakInside</span><span class="o">();</span></span>
<span id="LC1320" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1321" class="line" lang="java"><span class="cm">     *  See the page-break-inside property definition in CSS2.</span></span>
<span id="LC1322" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1323" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1324" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1325" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1326" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1327" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPageBreakInside</span><span class="o">(</span><span class="nc">String</span> <span class="n">pageBreakInside</span><span class="o">)</span></span>
<span id="LC1328" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1329" class="line" lang="java"></span>
<span id="LC1330" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1331" class="line" lang="java"><span class="cm">     *  See the pause property definition in CSS2.</span></span>
<span id="LC1332" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1333" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPause</span><span class="o">();</span></span>
<span id="LC1334" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1335" class="line" lang="java"><span class="cm">     *  See the pause property definition in CSS2.</span></span>
<span id="LC1336" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1337" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1338" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1339" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1340" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1341" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPause</span><span class="o">(</span><span class="nc">String</span> <span class="n">pause</span><span class="o">)</span></span>
<span id="LC1342" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1343" class="line" lang="java"></span>
<span id="LC1344" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1345" class="line" lang="java"><span class="cm">     *  See the pause-after property definition in CSS2.</span></span>
<span id="LC1346" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1347" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPauseAfter</span><span class="o">();</span></span>
<span id="LC1348" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1349" class="line" lang="java"><span class="cm">     *  See the pause-after property definition in CSS2.</span></span>
<span id="LC1350" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1351" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1352" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1353" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1354" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1355" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPauseAfter</span><span class="o">(</span><span class="nc">String</span> <span class="n">pauseAfter</span><span class="o">)</span></span>
<span id="LC1356" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1357" class="line" lang="java"></span>
<span id="LC1358" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1359" class="line" lang="java"><span class="cm">     *  See the pause-before property definition in CSS2.</span></span>
<span id="LC1360" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1361" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPauseBefore</span><span class="o">();</span></span>
<span id="LC1362" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1363" class="line" lang="java"><span class="cm">     *  See the pause-before property definition in CSS2.</span></span>
<span id="LC1364" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1365" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1366" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1367" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1368" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1369" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPauseBefore</span><span class="o">(</span><span class="nc">String</span> <span class="n">pauseBefore</span><span class="o">)</span></span>
<span id="LC1370" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1371" class="line" lang="java"></span>
<span id="LC1372" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1373" class="line" lang="java"><span class="cm">     *  See the pitch property definition in CSS2.</span></span>
<span id="LC1374" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1375" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPitch</span><span class="o">();</span></span>
<span id="LC1376" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1377" class="line" lang="java"><span class="cm">     *  See the pitch property definition in CSS2.</span></span>
<span id="LC1378" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1379" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1380" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1381" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1382" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1383" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPitch</span><span class="o">(</span><span class="nc">String</span> <span class="n">pitch</span><span class="o">)</span></span>
<span id="LC1384" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1385" class="line" lang="java"></span>
<span id="LC1386" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1387" class="line" lang="java"><span class="cm">     *  See the pitch-range property definition in CSS2.</span></span>
<span id="LC1388" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1389" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPitchRange</span><span class="o">();</span></span>
<span id="LC1390" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1391" class="line" lang="java"><span class="cm">     *  See the pitch-range property definition in CSS2.</span></span>
<span id="LC1392" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1393" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1394" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1395" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1396" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1397" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPitchRange</span><span class="o">(</span><span class="nc">String</span> <span class="n">pitchRange</span><span class="o">)</span></span>
<span id="LC1398" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1399" class="line" lang="java"></span>
<span id="LC1400" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1401" class="line" lang="java"><span class="cm">     *  See the play-during property definition in CSS2.</span></span>
<span id="LC1402" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1403" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPlayDuring</span><span class="o">();</span></span>
<span id="LC1404" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1405" class="line" lang="java"><span class="cm">     *  See the play-during property definition in CSS2.</span></span>
<span id="LC1406" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1407" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1408" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1409" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1410" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1411" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPlayDuring</span><span class="o">(</span><span class="nc">String</span> <span class="n">playDuring</span><span class="o">)</span></span>
<span id="LC1412" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1413" class="line" lang="java"></span>
<span id="LC1414" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1415" class="line" lang="java"><span class="cm">     *  See the position property definition in CSS2.</span></span>
<span id="LC1416" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1417" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPosition</span><span class="o">();</span></span>
<span id="LC1418" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1419" class="line" lang="java"><span class="cm">     *  See the position property definition in CSS2.</span></span>
<span id="LC1420" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1421" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1422" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1423" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1424" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1425" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPosition</span><span class="o">(</span><span class="nc">String</span> <span class="n">position</span><span class="o">)</span></span>
<span id="LC1426" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1427" class="line" lang="java"></span>
<span id="LC1428" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1429" class="line" lang="java"><span class="cm">     *  See the quotes property definition in CSS2.</span></span>
<span id="LC1430" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1431" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getQuotes</span><span class="o">();</span></span>
<span id="LC1432" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1433" class="line" lang="java"><span class="cm">     *  See the quotes property definition in CSS2.</span></span>
<span id="LC1434" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1435" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1436" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1437" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1438" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1439" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setQuotes</span><span class="o">(</span><span class="nc">String</span> <span class="n">quotes</span><span class="o">)</span></span>
<span id="LC1440" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1441" class="line" lang="java"></span>
<span id="LC1442" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1443" class="line" lang="java"><span class="cm">     *  See the richness property definition in CSS2.</span></span>
<span id="LC1444" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1445" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getRichness</span><span class="o">();</span></span>
<span id="LC1446" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1447" class="line" lang="java"><span class="cm">     *  See the richness property definition in CSS2.</span></span>
<span id="LC1448" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1449" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1450" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1451" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1452" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1453" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setRichness</span><span class="o">(</span><span class="nc">String</span> <span class="n">richness</span><span class="o">)</span></span>
<span id="LC1454" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1455" class="line" lang="java"></span>
<span id="LC1456" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1457" class="line" lang="java"><span class="cm">     *  See the right property definition in CSS2.</span></span>
<span id="LC1458" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1459" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getRight</span><span class="o">();</span></span>
<span id="LC1460" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1461" class="line" lang="java"><span class="cm">     *  See the right property definition in CSS2.</span></span>
<span id="LC1462" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1463" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1464" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1465" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1466" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1467" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setRight</span><span class="o">(</span><span class="nc">String</span> <span class="n">right</span><span class="o">)</span></span>
<span id="LC1468" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1469" class="line" lang="java"></span>
<span id="LC1470" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1471" class="line" lang="java"><span class="cm">     *  See the size property definition in CSS2.</span></span>
<span id="LC1472" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1473" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getSize</span><span class="o">();</span></span>
<span id="LC1474" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1475" class="line" lang="java"><span class="cm">     *  See the size property definition in CSS2.</span></span>
<span id="LC1476" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1477" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1478" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1479" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1480" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1481" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSize</span><span class="o">(</span><span class="nc">String</span> <span class="n">size</span><span class="o">)</span></span>
<span id="LC1482" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1483" class="line" lang="java"></span>
<span id="LC1484" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1485" class="line" lang="java"><span class="cm">     *  See the speak property definition in CSS2.</span></span>
<span id="LC1486" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1487" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getSpeak</span><span class="o">();</span></span>
<span id="LC1488" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1489" class="line" lang="java"><span class="cm">     *  See the speak property definition in CSS2.</span></span>
<span id="LC1490" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1491" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1492" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1493" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1494" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1495" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSpeak</span><span class="o">(</span><span class="nc">String</span> <span class="n">speak</span><span class="o">)</span></span>
<span id="LC1496" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1497" class="line" lang="java"></span>
<span id="LC1498" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1499" class="line" lang="java"><span class="cm">     *  See the speak-header property definition in CSS2.</span></span>
<span id="LC1500" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1501" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getSpeakHeader</span><span class="o">();</span></span>
<span id="LC1502" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1503" class="line" lang="java"><span class="cm">     *  See the speak-header property definition in CSS2.</span></span>
<span id="LC1504" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1505" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1506" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1507" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1508" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1509" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSpeakHeader</span><span class="o">(</span><span class="nc">String</span> <span class="n">speakHeader</span><span class="o">)</span></span>
<span id="LC1510" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1511" class="line" lang="java"></span>
<span id="LC1512" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1513" class="line" lang="java"><span class="cm">     *  See the speak-numeral property definition in CSS2.</span></span>
<span id="LC1514" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1515" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getSpeakNumeral</span><span class="o">();</span></span>
<span id="LC1516" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1517" class="line" lang="java"><span class="cm">     *  See the speak-numeral property definition in CSS2.</span></span>
<span id="LC1518" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1519" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1520" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1521" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1522" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1523" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSpeakNumeral</span><span class="o">(</span><span class="nc">String</span> <span class="n">speakNumeral</span><span class="o">)</span></span>
<span id="LC1524" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1525" class="line" lang="java"></span>
<span id="LC1526" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1527" class="line" lang="java"><span class="cm">     *  See the speak-punctuation property definition in CSS2.</span></span>
<span id="LC1528" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1529" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getSpeakPunctuation</span><span class="o">();</span></span>
<span id="LC1530" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1531" class="line" lang="java"><span class="cm">     *  See the speak-punctuation property definition in CSS2.</span></span>
<span id="LC1532" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1533" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1534" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1535" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1536" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1537" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSpeakPunctuation</span><span class="o">(</span><span class="nc">String</span> <span class="n">speakPunctuation</span><span class="o">)</span></span>
<span id="LC1538" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1539" class="line" lang="java"></span>
<span id="LC1540" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1541" class="line" lang="java"><span class="cm">     *  See the speech-rate property definition in CSS2.</span></span>
<span id="LC1542" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1543" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getSpeechRate</span><span class="o">();</span></span>
<span id="LC1544" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1545" class="line" lang="java"><span class="cm">     *  See the speech-rate property definition in CSS2.</span></span>
<span id="LC1546" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1547" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1548" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1549" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1550" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1551" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSpeechRate</span><span class="o">(</span><span class="nc">String</span> <span class="n">speechRate</span><span class="o">)</span></span>
<span id="LC1552" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1553" class="line" lang="java"></span>
<span id="LC1554" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1555" class="line" lang="java"><span class="cm">     *  See the stress property definition in CSS2.</span></span>
<span id="LC1556" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1557" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getStress</span><span class="o">();</span></span>
<span id="LC1558" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1559" class="line" lang="java"><span class="cm">     *  See the stress property definition in CSS2.</span></span>
<span id="LC1560" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1561" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1562" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1563" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1564" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1565" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setStress</span><span class="o">(</span><span class="nc">String</span> <span class="n">stress</span><span class="o">)</span></span>
<span id="LC1566" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1567" class="line" lang="java"></span>
<span id="LC1568" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1569" class="line" lang="java"><span class="cm">     *  See the table-layout property definition in CSS2.</span></span>
<span id="LC1570" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1571" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getTableLayout</span><span class="o">();</span></span>
<span id="LC1572" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1573" class="line" lang="java"><span class="cm">     *  See the table-layout property definition in CSS2.</span></span>
<span id="LC1574" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1575" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1576" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1577" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1578" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1579" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTableLayout</span><span class="o">(</span><span class="nc">String</span> <span class="n">tableLayout</span><span class="o">)</span></span>
<span id="LC1580" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1581" class="line" lang="java"></span>
<span id="LC1582" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1583" class="line" lang="java"><span class="cm">     *  See the text-align property definition in CSS2.</span></span>
<span id="LC1584" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1585" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getTextAlign</span><span class="o">();</span></span>
<span id="LC1586" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1587" class="line" lang="java"><span class="cm">     *  See the text-align property definition in CSS2.</span></span>
<span id="LC1588" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1589" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1590" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1591" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1592" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1593" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTextAlign</span><span class="o">(</span><span class="nc">String</span> <span class="n">textAlign</span><span class="o">)</span></span>
<span id="LC1594" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1595" class="line" lang="java"></span>
<span id="LC1596" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1597" class="line" lang="java"><span class="cm">     *  See the text-decoration property definition in CSS2.</span></span>
<span id="LC1598" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1599" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getTextDecoration</span><span class="o">();</span></span>
<span id="LC1600" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1601" class="line" lang="java"><span class="cm">     *  See the text-decoration property definition in CSS2.</span></span>
<span id="LC1602" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1603" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1604" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1605" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1606" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1607" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTextDecoration</span><span class="o">(</span><span class="nc">String</span> <span class="n">textDecoration</span><span class="o">)</span></span>
<span id="LC1608" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1609" class="line" lang="java"></span>
<span id="LC1610" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1611" class="line" lang="java"><span class="cm">     *  See the text-indent property definition in CSS2.</span></span>
<span id="LC1612" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1613" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getTextIndent</span><span class="o">();</span></span>
<span id="LC1614" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1615" class="line" lang="java"><span class="cm">     *  See the text-indent property definition in CSS2.</span></span>
<span id="LC1616" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1617" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1618" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1619" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1620" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1621" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTextIndent</span><span class="o">(</span><span class="nc">String</span> <span class="n">textIndent</span><span class="o">)</span></span>
<span id="LC1622" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1623" class="line" lang="java"></span>
<span id="LC1624" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1625" class="line" lang="java"><span class="cm">     *  See the text-shadow property definition in CSS2.</span></span>
<span id="LC1626" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1627" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getTextShadow</span><span class="o">();</span></span>
<span id="LC1628" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1629" class="line" lang="java"><span class="cm">     *  See the text-shadow property definition in CSS2.</span></span>
<span id="LC1630" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1631" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1632" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1633" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1634" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1635" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTextShadow</span><span class="o">(</span><span class="nc">String</span> <span class="n">textShadow</span><span class="o">)</span></span>
<span id="LC1636" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1637" class="line" lang="java"></span>
<span id="LC1638" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1639" class="line" lang="java"><span class="cm">     *  See the text-transform property definition in CSS2.</span></span>
<span id="LC1640" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1641" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getTextTransform</span><span class="o">();</span></span>
<span id="LC1642" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1643" class="line" lang="java"><span class="cm">     *  See the text-transform property definition in CSS2.</span></span>
<span id="LC1644" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1645" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1646" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1647" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1648" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1649" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTextTransform</span><span class="o">(</span><span class="nc">String</span> <span class="n">textTransform</span><span class="o">)</span></span>
<span id="LC1650" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1651" class="line" lang="java"></span>
<span id="LC1652" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1653" class="line" lang="java"><span class="cm">     *  See the top property definition in CSS2.</span></span>
<span id="LC1654" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1655" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getTop</span><span class="o">();</span></span>
<span id="LC1656" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1657" class="line" lang="java"><span class="cm">     *  See the top property definition in CSS2.</span></span>
<span id="LC1658" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1659" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1660" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1661" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1662" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1663" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTop</span><span class="o">(</span><span class="nc">String</span> <span class="n">top</span><span class="o">)</span></span>
<span id="LC1664" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1665" class="line" lang="java"></span>
<span id="LC1666" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1667" class="line" lang="java"><span class="cm">     *  See the unicode-bidi property definition in CSS2.</span></span>
<span id="LC1668" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1669" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getUnicodeBidi</span><span class="o">();</span></span>
<span id="LC1670" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1671" class="line" lang="java"><span class="cm">     *  See the unicode-bidi property definition in CSS2.</span></span>
<span id="LC1672" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1673" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1674" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1675" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1676" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1677" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setUnicodeBidi</span><span class="o">(</span><span class="nc">String</span> <span class="n">unicodeBidi</span><span class="o">)</span></span>
<span id="LC1678" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1679" class="line" lang="java"></span>
<span id="LC1680" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1681" class="line" lang="java"><span class="cm">     *  See the vertical-align property definition in CSS2.</span></span>
<span id="LC1682" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1683" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getVerticalAlign</span><span class="o">();</span></span>
<span id="LC1684" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1685" class="line" lang="java"><span class="cm">     *  See the vertical-align property definition in CSS2.</span></span>
<span id="LC1686" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1687" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1688" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1689" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1690" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1691" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setVerticalAlign</span><span class="o">(</span><span class="nc">String</span> <span class="n">verticalAlign</span><span class="o">)</span></span>
<span id="LC1692" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1693" class="line" lang="java"></span>
<span id="LC1694" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1695" class="line" lang="java"><span class="cm">     *  See the visibility property definition in CSS2.</span></span>
<span id="LC1696" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1697" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getVisibility</span><span class="o">();</span></span>
<span id="LC1698" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1699" class="line" lang="java"><span class="cm">     *  See the visibility property definition in CSS2.</span></span>
<span id="LC1700" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1701" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1702" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1703" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1704" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1705" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setVisibility</span><span class="o">(</span><span class="nc">String</span> <span class="n">visibility</span><span class="o">)</span></span>
<span id="LC1706" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1707" class="line" lang="java"></span>
<span id="LC1708" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1709" class="line" lang="java"><span class="cm">     *  See the voice-family property definition in CSS2.</span></span>
<span id="LC1710" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1711" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getVoiceFamily</span><span class="o">();</span></span>
<span id="LC1712" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1713" class="line" lang="java"><span class="cm">     *  See the voice-family property definition in CSS2.</span></span>
<span id="LC1714" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1715" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1716" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1717" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1718" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1719" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setVoiceFamily</span><span class="o">(</span><span class="nc">String</span> <span class="n">voiceFamily</span><span class="o">)</span></span>
<span id="LC1720" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1721" class="line" lang="java"></span>
<span id="LC1722" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1723" class="line" lang="java"><span class="cm">     *  See the volume property definition in CSS2.</span></span>
<span id="LC1724" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1725" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getVolume</span><span class="o">();</span></span>
<span id="LC1726" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1727" class="line" lang="java"><span class="cm">     *  See the volume property definition in CSS2.</span></span>
<span id="LC1728" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1729" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1730" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1731" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1732" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1733" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setVolume</span><span class="o">(</span><span class="nc">String</span> <span class="n">volume</span><span class="o">)</span></span>
<span id="LC1734" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1735" class="line" lang="java"></span>
<span id="LC1736" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1737" class="line" lang="java"><span class="cm">     *  See the white-space property definition in CSS2.</span></span>
<span id="LC1738" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1739" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getWhiteSpace</span><span class="o">();</span></span>
<span id="LC1740" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1741" class="line" lang="java"><span class="cm">     *  See the white-space property definition in CSS2.</span></span>
<span id="LC1742" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1743" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1744" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1745" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1746" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1747" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setWhiteSpace</span><span class="o">(</span><span class="nc">String</span> <span class="n">whiteSpace</span><span class="o">)</span></span>
<span id="LC1748" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1749" class="line" lang="java"></span>
<span id="LC1750" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1751" class="line" lang="java"><span class="cm">     *  See the widows property definition in CSS2.</span></span>
<span id="LC1752" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1753" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getWidows</span><span class="o">();</span></span>
<span id="LC1754" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1755" class="line" lang="java"><span class="cm">     *  See the widows property definition in CSS2.</span></span>
<span id="LC1756" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1757" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1758" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1759" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1760" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1761" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setWidows</span><span class="o">(</span><span class="nc">String</span> <span class="n">widows</span><span class="o">)</span></span>
<span id="LC1762" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1763" class="line" lang="java"></span>
<span id="LC1764" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1765" class="line" lang="java"><span class="cm">     *  See the width property definition in CSS2.</span></span>
<span id="LC1766" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1767" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getWidth</span><span class="o">();</span></span>
<span id="LC1768" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1769" class="line" lang="java"><span class="cm">     *  See the width property definition in CSS2.</span></span>
<span id="LC1770" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1771" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1772" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1773" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1774" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1775" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setWidth</span><span class="o">(</span><span class="nc">String</span> <span class="n">width</span><span class="o">)</span></span>
<span id="LC1776" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1777" class="line" lang="java"></span>
<span id="LC1778" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1779" class="line" lang="java"><span class="cm">     *  See the word-spacing property definition in CSS2.</span></span>
<span id="LC1780" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1781" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getWordSpacing</span><span class="o">();</span></span>
<span id="LC1782" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1783" class="line" lang="java"><span class="cm">     *  See the word-spacing property definition in CSS2.</span></span>
<span id="LC1784" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1785" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1786" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1787" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1788" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1789" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setWordSpacing</span><span class="o">(</span><span class="nc">String</span> <span class="n">wordSpacing</span><span class="o">)</span></span>
<span id="LC1790" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC1791" class="line" lang="java"></span>
<span id="LC1792" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1793" class="line" lang="java"><span class="cm">     *  See the z-index property definition in CSS2.</span></span>
<span id="LC1794" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1795" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getZIndex</span><span class="o">();</span></span>
<span id="LC1796" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1797" class="line" lang="java"><span class="cm">     *  See the z-index property definition in CSS2.</span></span>
<span id="LC1798" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1799" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the new value has a syntax error and is</span></span>
<span id="LC1800" class="line" lang="java"><span class="cm">     *   unparsable.</span></span>
<span id="LC1801" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly.</span></span>
<span id="LC1802" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1803" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setZIndex</span><span class="o">(</span><span class="nc">String</span> <span class="n">zIndex</span><span class="o">)</span></span>
<span id="LC1804" class="line" lang="java">                                             <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
