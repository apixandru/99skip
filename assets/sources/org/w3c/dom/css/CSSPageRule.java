...
<span id="LC47" class="line" lang="java"><span class="cm"> *  The &lt;code&gt;CSSPageRule&lt;/code&gt; interface represents a @page rule within a</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * CSS style sheet. The &lt;code&gt;@page&lt;/code&gt; rule is used to specify the</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * dimensions, orientation, margins, etc. of a page box for paged media.</span></span>
...
<span id="LC53" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">CSSPageRule</span> <span class="kd">extends</span> <span class="nc">CSSRule</span> <span class="o">{</span></span>
<span id="LC54" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">     *  The parsable textual representation of the page selector for the rule.</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC57" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getSelectorText</span><span class="o">();</span></span>
<span id="LC58" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC59" class="line" lang="java"><span class="cm">     *  The parsable textual representation of the page selector for the rule.</span></span>
<span id="LC60" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC61" class="line" lang="java"><span class="cm">     *   SYNTAX_ERR: Raised if the specified CSS string value has a syntax</span></span>
<span id="LC62" class="line" lang="java"><span class="cm">     *   error and is unparsable.</span></span>
<span id="LC63" class="line" lang="java"><span class="cm">     *   &lt;br&gt;NO_MODIFICATION_ALLOWED_ERR: Raised if this rule is readonly.</span></span>
<span id="LC64" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC65" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSelectorText</span><span class="o">(</span><span class="nc">String</span> <span class="n">selectorText</span><span class="o">)</span></span>
<span id="LC66" class="line" lang="java">                           <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">;</span></span>
<span id="LC67" class="line" lang="java"></span>
<span id="LC68" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">     *  The declaration-block of this rule.</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC71" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CSSStyleDeclaration</span> <span class="nf">getStyle</span><span class="o">();</span></span>
