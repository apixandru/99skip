...
<span id="LC45" class="line" lang="java"><span class="cm"> *  The &lt;code&gt;Counter&lt;/code&gt; interface is used to represent any counter or</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> * counters function value. This interface reflects the values in the</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * underlying style property.</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * &lt;p&gt;See also the &lt;a href='http://www.w3.org/TR/2000/REC-DOM-Level-2-Style-20001113'&gt;Document Object Model (DOM) Level 2 Style Specification&lt;/a&gt;.</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * @since DOM Level 2</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC51" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">Counter</span> <span class="o">{</span></span>
<span id="LC52" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC53" class="line" lang="java"><span class="cm">     *  This attribute is used for the identifier of the counter.</span></span>
<span id="LC54" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC55" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getIdentifier</span><span class="o">();</span></span>
<span id="LC56" class="line" lang="java"></span>
<span id="LC57" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC58" class="line" lang="java"><span class="cm">     *  This attribute is used for the style of the list.</span></span>
<span id="LC59" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC60" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getListStyle</span><span class="o">();</span></span>
<span id="LC61" class="line" lang="java"></span>
<span id="LC62" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC63" class="line" lang="java"><span class="cm">     *  This attribute is used for the separator of the nested counters.</span></span>
<span id="LC64" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC65" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getSeparator</span><span class="o">();</span></span>
