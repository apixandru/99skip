...
<span id="LC45" class="line" lang="java"><span class="cm"> *  Inline style information attached to elements is exposed through the</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> * &lt;code&gt;style&lt;/code&gt; attribute. This represents the contents of the STYLE</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * attribute for HTML elements (or elements in other schemas or DTDs which</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * use the STYLE attribute in the same way). The expectation is that an</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * instance of the ElementCSSInlineStyle interface can be obtained by using</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> * binding-specific casting methods on an instance of the Element interface</span></span>
<span id="LC51" class="line" lang="java"><span class="cm"> * when the element supports inline CSS style informations.</span></span>
...
<span id="LC55" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">ElementCSSInlineStyle</span> <span class="o">{</span></span>
<span id="LC56" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">     *  The style attribute.</span></span>
<span id="LC58" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC59" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CSSStyleDeclaration</span> <span class="nf">getStyle</span><span class="o">();</span></span>
