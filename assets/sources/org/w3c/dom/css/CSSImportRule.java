...
<span id="LC44" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.stylesheets.MediaList</span><span class="o">;</span></span>
<span id="LC45" class="line" lang="java"></span>
<span id="LC46" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> *  The &lt;code&gt;CSSImportRule&lt;/code&gt; interface represents a @import rule within</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * a CSS style sheet. The &lt;code&gt;@import&lt;/code&gt; rule is used to import style</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * rules from other style sheets.</span></span>
...
<span id="LC53" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">CSSImportRule</span> <span class="kd">extends</span> <span class="nc">CSSRule</span> <span class="o">{</span></span>
<span id="LC54" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">     *  The location of the style sheet to be imported. The attribute will not</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">     * contain the &lt;code&gt;"url(...)"&lt;/code&gt; specifier around the URI.</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC58" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getHref</span><span class="o">();</span></span>
<span id="LC59" class="line" lang="java"></span>
<span id="LC60" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC61" class="line" lang="java"><span class="cm">     *  A list of media types for which this style sheet may be used.</span></span>
<span id="LC62" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC63" class="line" lang="java">    <span class="kd">public</span> <span class="nc">MediaList</span> <span class="nf">getMedia</span><span class="o">();</span></span>
<span id="LC64" class="line" lang="java"></span>
<span id="LC65" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC66" class="line" lang="java"><span class="cm">     * The style sheet referred to by this rule, if it has been loaded. The</span></span>
<span id="LC67" class="line" lang="java"><span class="cm">     * value of this attribute is &lt;code&gt;null&lt;/code&gt; if the style sheet has</span></span>
<span id="LC68" class="line" lang="java"><span class="cm">     * not yet been loaded or if it will not be loaded (e.g. if the style</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">     * sheet is for a media type not supported by the user agent).</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC71" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CSSStyleSheet</span> <span class="nf">getStyleSheet</span><span class="o">();</span></span>
