...
<span id="LC45" class="line" lang="java"><span class="cm"> *  The &lt;code&gt;DocumentStyle&lt;/code&gt; interface provides a mechanism by which the</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> * style sheets embedded in a document can be retrieved. The expectation is</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * that an instance of the &lt;code&gt;DocumentStyle&lt;/code&gt; interface can be</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * obtained by using binding-specific casting methods on an instance of the</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * &lt;code&gt;Document&lt;/code&gt; interface.</span></span>
...
<span id="LC53" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">DocumentStyle</span> <span class="o">{</span></span>
<span id="LC54" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">     *  A list containing all the style sheets explicitly linked into or</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">     * embedded in a document. For HTML documents, this includes external</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">     * style sheets, included via the HTML  LINK element, and inline  STYLE</span></span>
<span id="LC58" class="line" lang="java"><span class="cm">     * elements. In XML, this includes external style sheets, included via</span></span>
<span id="LC59" class="line" lang="java"><span class="cm">     * style sheet processing instructions (see [XML StyleSheet]).</span></span>
<span id="LC60" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC61" class="line" lang="java">    <span class="kd">public</span> <span class="nc">StyleSheetList</span> <span class="nf">getStyleSheets</span><span class="o">();</span></span>
