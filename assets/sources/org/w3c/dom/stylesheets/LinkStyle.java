...
<span id="LC45" class="line" lang="java"><span class="cm"> *  The &lt;code&gt;LinkStyle&lt;/code&gt; interface provides a mechanism by which a style</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> * sheet can be retrieved from the node responsible for linking it into a</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * document. An instance of the &lt;code&gt;LinkStyle&lt;/code&gt; interface can be</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * obtained using binding-specific casting methods on an instance of a</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * linking node (&lt;code&gt;HTMLLinkElement&lt;/code&gt;, &lt;code&gt;HTMLStyleElement&lt;/code&gt;</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> * or &lt;code&gt;ProcessingInstruction&lt;/code&gt; in DOM Level 2).</span></span>
...
<span id="LC54" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">LinkStyle</span> <span class="o">{</span></span>
<span id="LC55" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">     *  The style sheet.</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC58" class="line" lang="java">    <span class="kd">public</span> <span class="nc">StyleSheet</span> <span class="nf">getSheet</span><span class="o">();</span></span>
