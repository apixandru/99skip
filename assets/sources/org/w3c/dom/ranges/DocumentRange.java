...
<span id="LC45" class="line" lang="java"><span class="cm"> * &lt;p&gt;See also the &lt;a href='http://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113'&gt;Document Object Model (DOM) Level 2 Traversal and Range Specification&lt;/a&gt;.</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> * @since DOM Level 2</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC48" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">DocumentRange</span> <span class="o">{</span></span>
<span id="LC49" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC50" class="line" lang="java"><span class="cm">     * This interface can be obtained from the object implementing the</span></span>
<span id="LC51" class="line" lang="java"><span class="cm">     * &lt;code&gt;Document&lt;/code&gt; interface using binding-specific casting</span></span>
<span id="LC52" class="line" lang="java"><span class="cm">     * methods.</span></span>
<span id="LC53" class="line" lang="java"><span class="cm">     * @return The initial state of the Range returned from this method is</span></span>
<span id="LC54" class="line" lang="java"><span class="cm">     *   such that both of its boundary-points are positioned at the</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">     *   beginning of the corresponding Document, before any content. The</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">     *   Range returned can only be used to select content associated with</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">     *   this Document, or with DocumentFragments and Attrs for which this</span></span>
<span id="LC58" class="line" lang="java"><span class="cm">     *   Document is the &lt;code&gt;ownerDocument&lt;/code&gt;.</span></span>
<span id="LC59" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC60" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Range</span> <span class="nf">createRange</span><span class="o">();</span></span>
