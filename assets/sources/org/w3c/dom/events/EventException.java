...
<span id="LC45" class="line" lang="java"><span class="cm"> *  Event operations may throw an &lt;code&gt;EventException&lt;/code&gt; as specified in</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> * their method descriptions.</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * &lt;p&gt;See also the &lt;a href='http://www.w3.org/TR/2000/REC-DOM-Level-2-Events-20001113'&gt;Document Object Model (DOM) Level 2 Events Specification&lt;/a&gt;.</span></span>
...
<span id="LC50" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">EventException</span> <span class="kd">extends</span> <span class="nc">RuntimeException</span> <span class="o">{</span></span>
<span id="LC51" class="line" lang="java">    <span class="kd">public</span> <span class="nf">EventException</span><span class="o">(</span><span class="kt">short</span> <span class="n">code</span><span class="o">,</span> <span class="nc">String</span> <span class="n">message</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC56" class="line" lang="java">    <span class="c1">// EventExceptionCode</span></span>
<span id="LC57" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC58" class="line" lang="java"><span class="cm">     *  If the &lt;code&gt;Event&lt;/code&gt;'s type was not specified by initializing the</span></span>
<span id="LC59" class="line" lang="java"><span class="cm">     * event before the method was called. Specification of the Event's type</span></span>
<span id="LC60" class="line" lang="java"><span class="cm">     * as &lt;code&gt;null&lt;/code&gt; or an empty string will also trigger this</span></span>
<span id="LC61" class="line" lang="java"><span class="cm">     * exception.</span></span>
<span id="LC62" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC63" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">short</span> <span class="no">UNSPECIFIED_EVENT_TYPE_ERR</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
