...
<span id="LC45" class="line" lang="java"><span class="cm"> *  Document base URI. See the  BASE element definition in HTML 4.0.</span></span>
...
<span id="LC48" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">HTMLBaseElement</span> <span class="kd">extends</span> <span class="nc">HTMLElement</span> <span class="o">{</span></span>
<span id="LC49" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC50" class="line" lang="java"><span class="cm">     *  The base URI. See the  href attribute definition in HTML 4.0.</span></span>
<span id="LC51" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC52" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getHref</span><span class="o">();</span></span>
<span id="LC53" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setHref</span><span class="o">(</span><span class="nc">String</span> <span class="n">href</span><span class="o">);</span></span>
<span id="LC54" class="line" lang="java"></span>
<span id="LC55" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">     *  The default target frame. See the  target attribute definition in HTML</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">     * 4.0.</span></span>
<span id="LC58" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC59" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getTarget</span><span class="o">();</span></span>
<span id="LC60" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTarget</span><span class="o">(</span><span class="nc">String</span> <span class="n">target</span><span class="o">);</span></span>
