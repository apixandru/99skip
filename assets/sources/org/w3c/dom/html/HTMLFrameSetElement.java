...
<span id="LC45" class="line" lang="java"><span class="cm"> *  Create a grid of frames. See the  FRAMESET element definition in HTML 4.0.</span></span>
...
<span id="LC48" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">HTMLFrameSetElement</span> <span class="kd">extends</span> <span class="nc">HTMLElement</span> <span class="o">{</span></span>
<span id="LC49" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC50" class="line" lang="java"><span class="cm">     *  The number of columns of frames in the frameset. See the  cols</span></span>
<span id="LC51" class="line" lang="java"><span class="cm">     * attribute definition in HTML 4.0.</span></span>
<span id="LC52" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC53" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getCols</span><span class="o">();</span></span>
<span id="LC54" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCols</span><span class="o">(</span><span class="nc">String</span> <span class="n">cols</span><span class="o">);</span></span>
<span id="LC55" class="line" lang="java"></span>
<span id="LC56" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">     *  The number of rows of frames in the frameset. See the  rows attribute</span></span>
<span id="LC58" class="line" lang="java"><span class="cm">     * definition in HTML 4.0.</span></span>
<span id="LC59" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC60" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getRows</span><span class="o">();</span></span>
<span id="LC61" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setRows</span><span class="o">(</span><span class="nc">String</span> <span class="n">rows</span><span class="o">);</span></span>
