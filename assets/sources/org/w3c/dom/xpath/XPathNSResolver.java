...
<span id="LC46" class="line" lang="java"><span class="cm"> * The &lt;code&gt;XPathNSResolver&lt;/code&gt; interface permit &lt;code&gt;prefix&lt;/code&gt;</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * strings in the expression to be properly bound to</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * &lt;code&gt;namespaceURI&lt;/code&gt; strings. &lt;code&gt;XPathEvaluator&lt;/code&gt; can</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * construct an implementation of &lt;code&gt;XPathNSResolver&lt;/code&gt; from a node,</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> * or the interface may be implemented by any application.</span></span>
...
<span id="LC53" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">XPathNSResolver</span> <span class="o">{</span></span>
<span id="LC54" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">     * Look up the namespace URI associated to the given namespace prefix. The</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">     * XPath evaluator must never call this with a &lt;code&gt;null&lt;/code&gt; or</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">     * empty argument, because the result of doing this is undefined.</span></span>
<span id="LC58" class="line" lang="java"><span class="cm">     * @param prefix The prefix to look for.</span></span>
<span id="LC59" class="line" lang="java"><span class="cm">     * @return Returns the associated namespace URI or &lt;code&gt;null&lt;/code&gt; if</span></span>
<span id="LC60" class="line" lang="java"><span class="cm">     *   none is found.</span></span>
<span id="LC61" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC62" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">lookupNamespaceURI</span><span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">);</span></span>
