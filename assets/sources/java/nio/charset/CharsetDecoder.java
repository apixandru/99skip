...
<span id="LC41" class="line" lang="java"><span class="cm"> * An engine that can transform a sequence of bytes in a specific charset into a sequence of</span></span>
<span id="LC42" class="line" lang="java"><span class="cm"> * sixteen-bit Unicode characters.</span></span>
...
<span id="LC46" class="line" lang="java"><span class="cm"> * &lt;p&gt; The input byte sequence is provided in a byte buffer or a series</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * of such buffers.  The output character sequence is written to a character buffer</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * or a series of such buffers.  A decoder should always be used by making</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * the following sequence of method invocations, hereinafter referred to as a</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> * &lt;i&gt;decoding operation&lt;/i&gt;:</span></span>
...
<span id="LC54" class="line" lang="java"><span class="cm"> *   &lt;li&gt;&lt;p&gt; Reset the decoder via the {@link #reset reset} method, unless it</span></span>
...
<span id="LC57" class="line" lang="java"><span class="cm"> *   &lt;li&gt;&lt;p&gt; Invoke the {@link #decode decode} method zero or more times, as</span></span>
...
<span id="LC62" class="line" lang="java"><span class="cm"> *   &lt;li&gt;&lt;p&gt; Invoke the {@link #decode decode} method one final time, passing</span></span>
...
<span id="LC65" class="line" lang="java"><span class="cm"> *   &lt;li&gt;&lt;p&gt; Invoke the {@link #flush flush} method so that the decoder can</span></span>
...
<span id="LC70" class="line" lang="java"><span class="cm"> * Each invocation of the {@link #decode decode} method will decode as many</span></span>
<span id="LC71" class="line" lang="java"><span class="cm"> * bytes as possible from the input buffer, writing the resulting characters</span></span>
<span id="LC72" class="line" lang="java"><span class="cm"> * to the output buffer.  The {@link #decode decode} method returns when more</span></span>
...
<span id="LC74" class="line" lang="java"><span class="cm"> * when a decoding error has occurred.  In each case a {@link CoderResult}</span></span>
...
<span id="LC77" class="line" lang="java"><span class="cm"> * attempt to recover from a decoding error, as appropriate, and try again.</span></span>
...
<span id="LC81" class="line" lang="java"><span class="cm"> * &lt;p&gt; There are two general types of decoding errors.  If the input byte</span></span>
<span id="LC82" class="line" lang="java"><span class="cm"> * sequence is not legal for this charset then the input is considered &lt;i&gt;malformed&lt;/i&gt;.  If</span></span>
<span id="LC83" class="line" lang="java"><span class="cm"> * the input byte sequence is legal but cannot be mapped to a valid</span></span>
<span id="LC84" class="line" lang="java"><span class="cm"> * Unicode character then an &lt;i&gt;unmappable character&lt;/i&gt; has been encountered.</span></span>
...
<span id="LC88" class="line" lang="java"><span class="cm"> * &lt;p&gt; How a decoding error is handled depends upon the action requested for</span></span>
...
<span id="LC95" class="line" lang="java"><span class="cm"> * replacement string.  The replacement</span></span>
...
<span id="LC102" class="line" lang="java"><span class="cm"> * has the initial value &lt;tt&gt;"&amp;#92;uFFFD"&lt;/tt&gt;;</span></span>
<span id="LC103" class="line" lang="java"></span>
<span id="LC104" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC105" class="line" lang="java"><span class="cm"> * its value may be changed via the {@link #replaceWith(java.lang.String)</span></span>
...
<span id="LC115" class="line" lang="java"><span class="cm"> * &lt;p&gt; This class is designed to handle many of the details of the decoding</span></span>
<span id="LC116" class="line" lang="java"><span class="cm"> * process, including the implementation of error actions.  A decoder for a</span></span>
...
<span id="LC118" class="line" lang="java"><span class="cm"> * implement the abstract {@link #decodeLoop decodeLoop} method, which</span></span>
<span id="LC119" class="line" lang="java"><span class="cm"> * encapsulates the basic decoding loop.  A subclass that maintains internal</span></span>
...
<span id="LC134" class="line" lang="java"><span class="cm"> * @see CharsetEncoder</span></span>
<span id="LC135" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC136" class="line" lang="java"></span>
<span id="LC137" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">CharsetDecoder</span> <span class="o">{</span></span>
...
<span id="LC140" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">float</span> <span class="n">averageCharsPerByte</span><span class="o">;</span></span>
<span id="LC141" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">float</span> <span class="n">maxCharsPerByte</span><span class="o">;</span></span>
<span id="LC142" class="line" lang="java"></span>
<span id="LC143" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">replacement</span><span class="o">;</span></span>
...
<span id="LC163" class="line" lang="java"><span class="cm">     * Initializes a new decoder.  The new decoder will have the given</span></span>
<span id="LC164" class="line" lang="java"><span class="cm">     * chars-per-byte and replacement values.</span></span>
...
<span id="LC167" class="line" lang="java"><span class="cm">     *         The charset that created this decoder</span></span>
<span id="LC168" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC169" class="line" lang="java"><span class="cm">     * @param  averageCharsPerByte</span></span>
<span id="LC170" class="line" lang="java"><span class="cm">     *         A positive float value indicating the expected number of</span></span>
<span id="LC171" class="line" lang="java"><span class="cm">     *         characters that will be produced for each input byte</span></span>
<span id="LC172" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC173" class="line" lang="java"><span class="cm">     * @param  maxCharsPerByte</span></span>
<span id="LC174" class="line" lang="java"><span class="cm">     *         A positive float value indicating the maximum number of</span></span>
<span id="LC175" class="line" lang="java"><span class="cm">     *         characters that will be produced for each input byte</span></span>
...
<span id="LC179" class="line" lang="java"><span class="cm">     *         non-zero length, must not be longer than maxCharsPerByte,</span></span>
...
<span id="LC185" class="line" lang="java">    <span class="kd">private</span></span>
<span id="LC186" class="line" lang="java">    <span class="nf">CharsetDecoder</span><span class="o">(</span><span class="nc">Charset</span> <span class="n">cs</span><span class="o">,</span></span>
<span id="LC187" class="line" lang="java">                   <span class="kt">float</span> <span class="n">averageCharsPerByte</span><span class="o">,</span></span>
<span id="LC188" class="line" lang="java">                   <span class="kt">float</span> <span class="n">maxCharsPerByte</span><span class="o">,</span></span>
<span id="LC189" class="line" lang="java">                   <span class="nc">String</span> <span class="n">replacement</span><span class="o">)</span></span>
...
<span id="LC192" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">averageCharsPerByte</span> <span class="o">&lt;=</span> <span class="mf">0.0f</span><span class="o">)</span></span>
...
<span id="LC194" class="line" lang="java">                                               <span class="o">+</span> <span class="s">"averageCharsPerByte"</span><span class="o">);</span></span>
<span id="LC195" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">maxCharsPerByte</span> <span class="o">&lt;=</span> <span class="mf">0.0f</span><span class="o">)</span></span>
...
<span id="LC197" class="line" lang="java">                                               <span class="o">+</span> <span class="s">"maxCharsPerByte"</span><span class="o">);</span></span>
...
<span id="LC199" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">averageCharsPerByte</span> <span class="o">&gt;</span> <span class="n">maxCharsPerByte</span><span class="o">)</span></span>
<span id="LC200" class="line" lang="java">                <span class="k">throw</span> <span class="k">new</span> <span class="nf">IllegalArgumentException</span><span class="o">(</span><span class="s">"averageCharsPerByte"</span></span>
<span id="LC201" class="line" lang="java">                                                   <span class="o">+</span> <span class="s">" exceeds "</span></span>
<span id="LC202" class="line" lang="java">                                                   <span class="o">+</span> <span class="s">"maxCharsPerByte"</span><span class="o">);</span></span>
...
<span id="LC205" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">averageCharsPerByte</span> <span class="o">=</span> <span class="n">averageCharsPerByte</span><span class="o">;</span></span>
<span id="LC206" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">maxCharsPerByte</span> <span class="o">=</span> <span class="n">maxCharsPerByte</span><span class="o">;</span></span>
...
<span id="LC211" class="line" lang="java"><span class="cm">     * Initializes a new decoder.  The new decoder will have the given</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">     * chars-per-byte values and its replacement will be the</span></span>
<span id="LC213" class="line" lang="java"><span class="cm">     * string &lt;tt&gt;"&amp;#92;uFFFD"&lt;/tt&gt;.</span></span>
...
<span id="LC216" class="line" lang="java"><span class="cm">     *         The charset that created this decoder</span></span>
<span id="LC217" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC218" class="line" lang="java"><span class="cm">     * @param  averageCharsPerByte</span></span>
<span id="LC219" class="line" lang="java"><span class="cm">     *         A positive float value indicating the expected number of</span></span>
<span id="LC220" class="line" lang="java"><span class="cm">     *         characters that will be produced for each input byte</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC222" class="line" lang="java"><span class="cm">     * @param  maxCharsPerByte</span></span>
<span id="LC223" class="line" lang="java"><span class="cm">     *         A positive float value indicating the maximum number of</span></span>
<span id="LC224" class="line" lang="java"><span class="cm">     *         characters that will be produced for each input byte</span></span>
...
<span id="LC229" class="line" lang="java">    <span class="kd">protected</span> <span class="nf">CharsetDecoder</span><span class="o">(</span><span class="nc">Charset</span> <span class="n">cs</span><span class="o">,</span></span>
<span id="LC230" class="line" lang="java">                             <span class="kt">float</span> <span class="n">averageCharsPerByte</span><span class="o">,</span></span>
<span id="LC231" class="line" lang="java">                             <span class="kt">float</span> <span class="n">maxCharsPerByte</span><span class="o">)</span></span>
...
<span id="LC234" class="line" lang="java">             <span class="n">averageCharsPerByte</span><span class="o">,</span> <span class="n">maxCharsPerByte</span><span class="o">,</span></span>
<span id="LC235" class="line" lang="java">             <span class="s">"\uFFFD"</span><span class="o">);</span></span>
...
<span id="LC239" class="line" lang="java"><span class="cm">     * Returns the charset that created this decoder.</span></span>
<span id="LC240" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC241" class="line" lang="java"><span class="cm">     * @return  This decoder's charset</span></span>
...
<span id="LC248" class="line" lang="java"><span class="cm">     * Returns this decoder's replacement value.</span></span>
<span id="LC249" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC250" class="line" lang="java"><span class="cm">     * @return  This decoder's current replacement,</span></span>
...
<span id="LC253" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="nc">String</span> <span class="nf">replacement</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC254" class="line" lang="java"></span>
<span id="LC255" class="line" lang="java">        <span class="k">return</span> <span class="n">replacement</span><span class="o">;</span></span>
...
<span id="LC263" class="line" lang="java"><span class="cm">     * Changes this decoder's replacement value.</span></span>
...
<span id="LC272" class="line" lang="java"><span class="cm">     *         The new replacement; must not be &lt;tt&gt;null&lt;/tt&gt;</span></span>
<span id="LC273" class="line" lang="java"><span class="cm">     *         and must have non-zero length</span></span>
...
<span id="LC282" class="line" lang="java"><span class="cm">     * @return  This decoder</span></span>
...
<span id="LC287" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="nc">CharsetDecoder</span> <span class="nf">replaceWith</span><span class="o">(</span><span class="nc">String</span> <span class="n">newReplacement</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC293" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">len</span> <span class="o">&gt;</span> <span class="n">maxCharsPerByte</span><span class="o">)</span></span>
...
<span id="LC296" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">replacement</span> <span class="o">=</span> <span class="n">newReplacement</span><span class="o">;</span></span>
...
<span id="LC308" class="line" lang="java"><span class="cm">     * Reports a change to this decoder's replacement value.</span></span>
...
<span id="LC311" class="line" lang="java"><span class="cm">     * should be overridden by decoders that require notification of changes to</span></span>
...
<span id="LC316" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">implReplaceWith</span><span class="o">(</span><span class="nc">String</span> <span class="n">newReplacement</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC360" class="line" lang="java"><span class="cm">     * Returns this decoder's current action for malformed-input errors.</span></span>
...
<span id="LC369" class="line" lang="java"><span class="cm">     * Changes this decoder's action for malformed-input errors.</span></span>
...
<span id="LC376" class="line" lang="java"><span class="cm">     * @return  This decoder</span></span>
...
<span id="LC381" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="nc">CharsetDecoder</span> <span class="nf">onMalformedInput</span><span class="o">(</span><span class="nc">CodingErrorAction</span> <span class="n">newAction</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC390" class="line" lang="java"><span class="cm">     * Reports a change to this decoder's malformed-input action.</span></span>
...
<span id="LC393" class="line" lang="java"><span class="cm">     * should be overridden by decoders that require notification of changes to</span></span>
...
<span id="LC401" class="line" lang="java"><span class="cm">     * Returns this decoder's current action for unmappable-character errors.</span></span>
...
<span id="LC411" class="line" lang="java"><span class="cm">     * Changes this decoder's action for unmappable-character errors.</span></span>
...
<span id="LC418" class="line" lang="java"><span class="cm">     * @return  This decoder</span></span>
...
<span id="LC423" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="nc">CharsetDecoder</span> <span class="nf">onUnmappableCharacter</span><span class="o">(</span><span class="nc">CodingErrorAction</span></span>
...
<span id="LC434" class="line" lang="java"><span class="cm">     * Reports a change to this decoder's unmappable-character action.</span></span>
...
<span id="LC437" class="line" lang="java"><span class="cm">     * should be overridden by decoders that require notification of changes to</span></span>
...
<span id="LC445" class="line" lang="java"><span class="cm">     * Returns the average number of characters that will be produced for each</span></span>
<span id="LC446" class="line" lang="java"><span class="cm">     * byte of input.  This heuristic value may be used to estimate the size</span></span>
...
<span id="LC449" class="line" lang="java"><span class="cm">     * @return  The average number of characters produced</span></span>
<span id="LC450" class="line" lang="java"><span class="cm">     *          per byte of input</span></span>
<span id="LC451" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC452" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="kt">float</span> <span class="nf">averageCharsPerByte</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC453" class="line" lang="java">        <span class="k">return</span> <span class="n">averageCharsPerByte</span><span class="o">;</span></span>
...
<span id="LC457" class="line" lang="java"><span class="cm">     * Returns the maximum number of characters that will be produced for each</span></span>
<span id="LC458" class="line" lang="java"><span class="cm">     * byte of input.  This value may be used to compute the worst-case size</span></span>
...
<span id="LC461" class="line" lang="java"><span class="cm">     * @return  The maximum number of characters that will be produced per</span></span>
<span id="LC462" class="line" lang="java"><span class="cm">     *          byte of input</span></span>
<span id="LC463" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC464" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="kt">float</span> <span class="nf">maxCharsPerByte</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC465" class="line" lang="java">        <span class="k">return</span> <span class="n">maxCharsPerByte</span><span class="o">;</span></span>
...
<span id="LC469" class="line" lang="java"><span class="cm">     * Decodes as many bytes as possible from the given input buffer,</span></span>
...
<span id="LC473" class="line" lang="java"><span class="cm">     * positions.  At most {@link Buffer#remaining in.remaining()} bytes</span></span>
<span id="LC474" class="line" lang="java"><span class="cm">     * will be read and at most {@link Buffer#remaining out.remaining()}</span></span>
<span id="LC475" class="line" lang="java"><span class="cm">     * characters will be written.  The buffers' positions will be advanced to</span></span>
<span id="LC476" class="line" lang="java"><span class="cm">     * reflect the bytes read and the characters written, but their marks and</span></span>
...
<span id="LC479" class="line" lang="java"><span class="cm">     * &lt;p&gt; In addition to reading bytes from the input buffer and writing</span></span>
<span id="LC480" class="line" lang="java"><span class="cm">     * characters to the output buffer, this method returns a {@link CoderResult}</span></span>
...
<span id="LC486" class="line" lang="java"><span class="cm">     *   input buffer as possible has been decoded.  If there is no further</span></span>
<span id="LC487" class="line" lang="java"><span class="cm">     *   input then the invoker can proceed to the next step of the</span></span>
<span id="LC488" class="line" lang="java"><span class="cm">     *   &lt;a href="#steps"&gt;decoding operation&lt;/a&gt;.  Otherwise this method</span></span>
...
<span id="LC492" class="line" lang="java"><span class="cm">     *   insufficient space in the output buffer to decode any more bytes.</span></span>
...
<span id="LC494" class="line" lang="java"><span class="cm">     *   more {@linkplain Buffer#remaining remaining} characters. This is</span></span>
<span id="LC495" class="line" lang="java"><span class="cm">     *   typically done by draining any decoded characters from the output</span></span>
...
<span id="LC500" class="line" lang="java"><span class="cm">     *   error has been detected.  The malformed bytes begin at the input</span></span>
...
<span id="LC502" class="line" lang="java"><span class="cm">     *   bytes may be determined by invoking the result object's {@link</span></span>
...
<span id="LC504" class="line" lang="java"><span class="cm">     *   {@linkplain #onMalformedInput malformed action} of this decoder</span></span>
...
<span id="LC510" class="line" lang="java"><span class="cm">     *   unmappable-character error has been detected.  The bytes that</span></span>
<span id="LC511" class="line" lang="java"><span class="cm">     *   decode the unmappable character begin at the input buffer's (possibly</span></span>
<span id="LC512" class="line" lang="java"><span class="cm">     *   incremented) position; the number of such bytes may be determined</span></span>
...
<span id="LC515" class="line" lang="java"><span class="cm">     *   unmappable action} of this decoder is {@link</span></span>
...
<span id="LC521" class="line" lang="java"><span class="cm">     * In any case, if this method is to be reinvoked in the same decoding</span></span>
<span id="LC522" class="line" lang="java"><span class="cm">     * operation then care should be taken to preserve any bytes remaining</span></span>
...
<span id="LC534" class="line" lang="java"><span class="cm">     * pass &lt;tt&gt;true&lt;/tt&gt; so that any remaining undecoded input will be treated</span></span>
...
<span id="LC537" class="line" lang="java"><span class="cm">     * &lt;p&gt; This method works by invoking the {@link #decodeLoop decodeLoop}</span></span>
...
<span id="LC543" class="line" lang="java"><span class="cm">     *         The input byte buffer</span></span>
...
<span id="LC546" class="line" lang="java"><span class="cm">     *         The output character buffer</span></span>
...
<span id="LC550" class="line" lang="java"><span class="cm">     *         additional input bytes beyond those in the given buffer</span></span>
...
<span id="LC555" class="line" lang="java"><span class="cm">     *          If a decoding operation is already in progress and the previous</span></span>
...
<span id="LC560" class="line" lang="java"><span class="cm">     *          but a return value indicating an incomplete decoding operation</span></span>
...
<span id="LC563" class="line" lang="java"><span class="cm">     *          If an invocation of the decodeLoop method threw</span></span>
...
<span id="LC566" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="nc">CoderResult</span> <span class="nf">decode</span><span class="o">(</span><span class="nc">ByteBuffer</span> <span class="n">in</span><span class="o">,</span> <span class="nc">CharBuffer</span> <span class="n">out</span><span class="o">,</span></span>
...
<span id="LC579" class="line" lang="java">                <span class="n">cr</span> <span class="o">=</span> <span class="n">decodeLoop</span><span class="o">(</span><span class="n">in</span><span class="o">,</span> <span class="n">out</span><span class="o">);</span></span>
...
<span id="LC628" class="line" lang="java"><span class="cm">     * Flushes this decoder.</span></span>
<span id="LC629" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC630" class="line" lang="java"><span class="cm">     * &lt;p&gt; Some decoders maintain internal state and may need to write some</span></span>
<span id="LC631" class="line" lang="java"><span class="cm">     * final characters to the output buffer once the overall input sequence has</span></span>
...
<span id="LC636" class="line" lang="java"><span class="cm">     * characters will be written.  The buffer's position will be advanced</span></span>
...
<span id="LC643" class="line" lang="java"><span class="cm">     * more room, in order to complete the current &lt;a href="#steps"&gt;decoding</span></span>
...
<span id="LC646" class="line" lang="java"><span class="cm">     * &lt;p&gt; If this decoder has already been flushed then invoking this method</span></span>
...
<span id="LC653" class="line" lang="java"><span class="cm">     *         The output character buffer</span></span>
...
<span id="LC659" class="line" lang="java"><span class="cm">     *          If the previous step of the current decoding operation was an</span></span>
...
<span id="LC662" class="line" lang="java"><span class="cm">     *          #decode(ByteBuffer,CharBuffer,boolean) decode} method</span></span>
...
<span id="LC666" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="nc">CoderResult</span> <span class="nf">flush</span><span class="o">(</span><span class="nc">CharBuffer</span> <span class="n">out</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC681" class="line" lang="java"><span class="cm">     * Flushes this decoder.</span></span>
...
<span id="LC685" class="line" lang="java"><span class="cm">     * by decoders that may need to write final characters to the output buffer</span></span>
...
<span id="LC689" class="line" lang="java"><span class="cm">     *         The output character buffer</span></span>
...
<span id="LC694" class="line" lang="java">    <span class="kd">protected</span> <span class="nc">CoderResult</span> <span class="nf">implFlush</span><span class="o">(</span><span class="nc">CharBuffer</span> <span class="n">out</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC699" class="line" lang="java"><span class="cm">     * Resets this decoder, clearing any internal state.</span></span>
...
<span id="LC705" class="line" lang="java"><span class="cm">     * @return  This decoder</span></span>
<span id="LC706" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC707" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC708" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="nc">CharsetDecoder</span> <span class="nf">reset</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC715" class="line" lang="java"><span class="cm">     * Resets this decoder, clearing any charset-specific internal state.</span></span>
...
<span id="LC718" class="line" lang="java"><span class="cm">     * should be overridden by decoders that maintain internal state.  &lt;/p&gt;</span></span>
...
<span id="LC723" class="line" lang="java"><span class="cm">     * Decodes one or more bytes into one or more characters.</span></span>
<span id="LC724" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC725" class="line" lang="java"><span class="cm">     * &lt;p&gt; This method encapsulates the basic decoding loop, decoding as many</span></span>
<span id="LC726" class="line" lang="java"><span class="cm">     * bytes as possible until it either runs out of input, runs out of room</span></span>
<span id="LC727" class="line" lang="java"><span class="cm">     * in the output buffer, or encounters a decoding error.  This method is</span></span>
<span id="LC728" class="line" lang="java"><span class="cm">     * invoked by the {@link #decode decode} method, which handles result</span></span>
...
<span id="LC732" class="line" lang="java"><span class="cm">     * positions.  At most {@link Buffer#remaining in.remaining()} bytes</span></span>
<span id="LC733" class="line" lang="java"><span class="cm">     * will be read, and at most {@link Buffer#remaining out.remaining()}</span></span>
<span id="LC734" class="line" lang="java"><span class="cm">     * characters will be written.  The buffers' positions will be advanced to</span></span>
<span id="LC735" class="line" lang="java"><span class="cm">     * reflect the bytes read and the characters written, but their marks and</span></span>
...
<span id="LC739" class="line" lang="java"><span class="cm">     * reason for termination, in the same manner as the {@link #decode decode}</span></span>
<span id="LC740" class="line" lang="java"><span class="cm">     * method.  Most implementations of this method will handle decoding errors</span></span>
...
<span id="LC742" class="line" lang="java"><span class="cm">     * {@link #decode decode} method.  An optimized implementation may instead</span></span>
...
<span id="LC750" class="line" lang="java"><span class="cm">     *         The input byte buffer</span></span>
...
<span id="LC753" class="line" lang="java"><span class="cm">     *         The output character buffer</span></span>
...
<span id="LC757" class="line" lang="java">    <span class="kd">protected</span> <span class="kd">abstract</span> <span class="nc">CoderResult</span> <span class="nf">decodeLoop</span><span class="o">(</span><span class="nc">ByteBuffer</span> <span class="n">in</span><span class="o">,</span></span>
<span id="LC758" class="line" lang="java">                                              <span class="nc">CharBuffer</span> <span class="n">out</span><span class="o">);</span></span>
<span id="LC759" class="line" lang="java"></span>
<span id="LC760" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC761" class="line" lang="java"><span class="cm">     * Convenience method that decodes the remaining content of a single input</span></span>
<span id="LC762" class="line" lang="java"><span class="cm">     * byte buffer into a newly-allocated character buffer.</span></span>
<span id="LC763" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC764" class="line" lang="java"><span class="cm">     * &lt;p&gt; This method implements an entire &lt;a href="#steps"&gt;decoding</span></span>
<span id="LC765" class="line" lang="java"><span class="cm">     * operation&lt;/a&gt;; that is, it resets this decoder, then it decodes the</span></span>
<span id="LC766" class="line" lang="java"><span class="cm">     * bytes in the given byte buffer, and finally it flushes this</span></span>
<span id="LC767" class="line" lang="java"><span class="cm">     * decoder.  This method should therefore not be invoked if a decoding</span></span>
...
<span id="LC771" class="line" lang="java"><span class="cm">     *         The input byte buffer</span></span>
<span id="LC772" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC773" class="line" lang="java"><span class="cm">     * @return A newly-allocated character buffer containing the result of the</span></span>
<span id="LC774" class="line" lang="java"><span class="cm">     *         decoding operation.  The buffer's position will be zero and its</span></span>
<span id="LC775" class="line" lang="java"><span class="cm">     *         limit will follow the last character written.</span></span>
...
<span id="LC778" class="line" lang="java"><span class="cm">     *          If a decoding operation is already in progress</span></span>
...
<span id="LC781" class="line" lang="java"><span class="cm">     *          If the byte sequence starting at the input buffer's current</span></span>
<span id="LC782" class="line" lang="java"><span class="cm">     *          position is not legal for this charset and the current malformed-input action</span></span>
...
<span id="LC786" class="line" lang="java"><span class="cm">     *          If the byte sequence starting at the input buffer's current</span></span>
<span id="LC787" class="line" lang="java"><span class="cm">     *          position cannot be mapped to an equivalent character sequence and</span></span>
...
<span id="LC791" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="nc">CharBuffer</span> <span class="nf">decode</span><span class="o">(</span><span class="nc">ByteBuffer</span> <span class="n">in</span><span class="o">)</span></span>
...
<span id="LC794" class="line" lang="java">        <span class="kt">int</span> <span class="n">n</span> <span class="o">=</span> <span class="o">(</span><span class="kt">int</span><span class="o">)(</span><span class="n">in</span><span class="o">.</span><span class="na">remaining</span><span class="o">()</span> <span class="o">*</span> <span class="n">averageCharsPerByte</span><span class="o">());</span></span>
<span id="LC795" class="line" lang="java">        <span class="nc">CharBuffer</span> <span class="n">out</span> <span class="o">=</span> <span class="nc">CharBuffer</span><span class="o">.</span><span class="na">allocate</span><span class="o">(</span><span class="n">n</span><span class="o">);</span></span>
...
<span id="LC802" class="line" lang="java">                <span class="n">decode</span><span class="o">(</span><span class="n">in</span><span class="o">,</span> <span class="n">out</span><span class="o">,</span> <span class="kc">true</span><span class="o">)</span> <span class="o">:</span> <span class="nc">CoderResult</span><span class="o">.</span><span class="na">UNDERFLOW</span><span class="o">;</span></span>
...
<span id="LC810" class="line" lang="java">                <span class="nc">CharBuffer</span> <span class="n">o</span> <span class="o">=</span> <span class="nc">CharBuffer</span><span class="o">.</span><span class="na">allocate</span><span class="o">(</span><span class="n">n</span><span class="o">);</span></span>
...
<span id="LC825" class="line" lang="java"><span class="cm">     * Tells whether or not this decoder implements an auto-detecting charset.</span></span>
<span id="LC826" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC827" class="line" lang="java"><span class="cm">     * &lt;p&gt; The default implementation of this method always returns</span></span>
<span id="LC828" class="line" lang="java"><span class="cm">     * &lt;tt&gt;false&lt;/tt&gt;; it should be overridden by auto-detecting decoders to</span></span>
<span id="LC829" class="line" lang="java"><span class="cm">     * return &lt;tt&gt;true&lt;/tt&gt;.  &lt;/p&gt;</span></span>
<span id="LC830" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC831" class="line" lang="java"><span class="cm">     * @return  &lt;tt&gt;true&lt;/tt&gt; if, and only if, this decoder implements an</span></span>
<span id="LC832" class="line" lang="java"><span class="cm">     *          auto-detecting charset</span></span>
<span id="LC833" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC834" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isAutoDetecting</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC835" class="line" lang="java">        <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC839" class="line" lang="java"><span class="cm">     * Tells whether or not this decoder has yet detected a</span></span>
<span id="LC840" class="line" lang="java"><span class="cm">     * charset&amp;nbsp;&amp;nbsp;&lt;i&gt;(optional operation)&lt;/i&gt;.</span></span>
<span id="LC841" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC842" class="line" lang="java"><span class="cm">     * &lt;p&gt; If this decoder implements an auto-detecting charset then at a</span></span>
<span id="LC843" class="line" lang="java"><span class="cm">     * single point during a decoding operation this method may start returning</span></span>
<span id="LC844" class="line" lang="java"><span class="cm">     * &lt;tt&gt;true&lt;/tt&gt; to indicate that a specific charset has been detected in</span></span>
<span id="LC845" class="line" lang="java"><span class="cm">     * the input byte sequence.  Once this occurs, the {@link #detectedCharset</span></span>
<span id="LC846" class="line" lang="java"><span class="cm">     * detectedCharset} method may be invoked to retrieve the detected charset.</span></span>
<span id="LC847" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC848" class="line" lang="java"><span class="cm">     * &lt;p&gt; That this method returns &lt;tt&gt;false&lt;/tt&gt; does not imply that no bytes</span></span>
<span id="LC849" class="line" lang="java"><span class="cm">     * have yet been decoded.  Some auto-detecting decoders are capable of</span></span>
<span id="LC850" class="line" lang="java"><span class="cm">     * decoding some, or even all, of an input byte sequence without fixing on</span></span>
<span id="LC851" class="line" lang="java"><span class="cm">     * a particular charset.</span></span>
<span id="LC852" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC853" class="line" lang="java"><span class="cm">     * &lt;p&gt; The default implementation of this method always throws an {@link</span></span>
<span id="LC854" class="line" lang="java"><span class="cm">     * UnsupportedOperationException}; it should be overridden by</span></span>
<span id="LC855" class="line" lang="java"><span class="cm">     * auto-detecting decoders to return &lt;tt&gt;true&lt;/tt&gt; once the input charset</span></span>
<span id="LC856" class="line" lang="java"><span class="cm">     * has been determined.  &lt;/p&gt;</span></span>
<span id="LC857" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC858" class="line" lang="java"><span class="cm">     * @return  &lt;tt&gt;true&lt;/tt&gt; if, and only if, this decoder has detected a</span></span>
<span id="LC859" class="line" lang="java"><span class="cm">     *          specific charset</span></span>
<span id="LC860" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC861" class="line" lang="java"><span class="cm">     * @throws  UnsupportedOperationException</span></span>
<span id="LC862" class="line" lang="java"><span class="cm">     *          If this decoder does not implement an auto-detecting charset</span></span>
<span id="LC863" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC864" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isCharsetDetected</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC865" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">UnsupportedOperationException</span><span class="o">();</span></span>
...
<span id="LC869" class="line" lang="java"><span class="cm">     * Retrieves the charset that was detected by this</span></span>
<span id="LC870" class="line" lang="java"><span class="cm">     * decoder&amp;nbsp;&amp;nbsp;&lt;i&gt;(optional operation)&lt;/i&gt;.</span></span>
<span id="LC871" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC872" class="line" lang="java"><span class="cm">     * &lt;p&gt; If this decoder implements an auto-detecting charset then this</span></span>
<span id="LC873" class="line" lang="java"><span class="cm">     * method returns the actual charset once it has been detected.  After that</span></span>
<span id="LC874" class="line" lang="java"><span class="cm">     * point, this method returns the same value for the duration of the</span></span>
<span id="LC875" class="line" lang="java"><span class="cm">     * current decoding operation.  If not enough input bytes have yet been</span></span>
<span id="LC876" class="line" lang="java"><span class="cm">     * read to determine the actual charset then this method throws an {@link</span></span>
<span id="LC877" class="line" lang="java"><span class="cm">     * IllegalStateException}.</span></span>
<span id="LC878" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC879" class="line" lang="java"><span class="cm">     * &lt;p&gt; The default implementation of this method always throws an {@link</span></span>
<span id="LC880" class="line" lang="java"><span class="cm">     * UnsupportedOperationException}; it should be overridden by</span></span>
<span id="LC881" class="line" lang="java"><span class="cm">     * auto-detecting decoders to return the appropriate value.  &lt;/p&gt;</span></span>
<span id="LC882" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC883" class="line" lang="java"><span class="cm">     * @return  The charset detected by this auto-detecting decoder,</span></span>
<span id="LC884" class="line" lang="java"><span class="cm">     *          or &lt;tt&gt;null&lt;/tt&gt; if the charset has not yet been determined</span></span>
<span id="LC885" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC886" class="line" lang="java"><span class="cm">     * @throws  IllegalStateException</span></span>
<span id="LC887" class="line" lang="java"><span class="cm">     *          If insufficient bytes have been read to determine a charset</span></span>
<span id="LC888" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC889" class="line" lang="java"><span class="cm">     * @throws  UnsupportedOperationException</span></span>
<span id="LC890" class="line" lang="java"><span class="cm">     *          If this decoder does not implement an auto-detecting charset</span></span>
<span id="LC891" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC892" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Charset</span> <span class="nf">detectedCharset</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC893" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">UnsupportedOperationException</span><span class="o">();</span></span>
