...
<span id="LC33" class="line" lang="java"><span class="cm"> * A read/write HeapCharBuffer.</span></span>
...
<span id="LC42" class="line" lang="java"><span class="kd">class</span> <span class="nc">HeapCharBuffer</span></span>
<span id="LC43" class="line" lang="java">    <span class="kd">extends</span> <span class="nc">CharBuffer</span></span>
...
<span id="LC50" class="line" lang="java"><span class="cm">    protected final char[] hb;</span></span>
...
<span id="LC55" class="line" lang="java">    <span class="nc">HeapCharBuffer</span><span class="o">(</span><span class="kt">int</span> <span class="n">cap</span><span class="o">,</span> <span class="kt">int</span> <span class="n">lim</span><span class="o">)</span> <span class="o">{</span>            <span class="c1">// package-private</span></span>
<span id="LC56" class="line" lang="java"></span>
<span id="LC57" class="line" lang="java">        <span class="kd">super</span><span class="o">(-</span><span class="mi">1</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">lim</span><span class="o">,</span> <span class="n">cap</span><span class="o">,</span> <span class="k">new</span> <span class="kt">char</span><span class="o">[</span><span class="n">cap</span><span class="o">],</span> <span class="mi">0</span><span class="o">);</span></span>
<span id="LC58" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC59" class="line" lang="java"><span class="cm">        hb = new char[cap];</span></span>
...
<span id="LC68" class="line" lang="java">    <span class="nc">HeapCharBuffer</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">buf</span><span class="o">,</span> <span class="kt">int</span> <span class="n">off</span><span class="o">,</span> <span class="kt">int</span> <span class="n">len</span><span class="o">)</span> <span class="o">{</span> <span class="c1">// package-private</span></span>
...
<span id="LC81" class="line" lang="java">    <span class="kd">protected</span> <span class="nf">HeapCharBuffer</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">buf</span><span class="o">,</span></span>
...
<span id="LC97" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">slice</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC98" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapCharBuffer</span><span class="o">(</span><span class="n">hb</span><span class="o">,</span></span>
...
<span id="LC106" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">duplicate</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC107" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapCharBuffer</span><span class="o">(</span><span class="n">hb</span><span class="o">,</span></span>
...
<span id="LC115" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">asReadOnlyBuffer</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC116" class="line" lang="java"></span>
<span id="LC117" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapCharBufferR</span><span class="o">(</span><span class="n">hb</span><span class="o">,</span></span>
...
<span id="LC134" class="line" lang="java">    <span class="kd">public</span> <span class="kt">char</span> <span class="nf">get</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC138" class="line" lang="java">    <span class="kd">public</span> <span class="kt">char</span> <span class="nf">get</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC143" class="line" lang="java">    <span class="kt">char</span> <span class="nf">getUnchecked</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC144" class="line" lang="java">	<span class="k">return</span> <span class="n">hb</span><span class="o">[</span><span class="n">ix</span><span class="o">(</span><span class="n">i</span><span class="o">)];</span></span>
...
<span id="LC167" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">char</span> <span class="n">x</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC176" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">,</span> <span class="kt">char</span> <span class="n">x</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC198" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="nc">CharBuffer</span> <span class="n">src</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC199" class="line" lang="java"></span>
<span id="LC200" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">src</span> <span class="k">instanceof</span> <span class="nc">HeapCharBuffer</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC203" class="line" lang="java">            <span class="nc">HeapCharBuffer</span> <span class="n">sb</span> <span class="o">=</span> <span class="o">(</span><span class="nc">HeapCharBuffer</span><span class="o">)</span><span class="n">src</span><span class="o">;</span></span>
...
<span id="LC226" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">compact</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC565" class="line" lang="java">    <span class="nc">String</span> <span class="nf">toString</span><span class="o">(</span><span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">end</span><span class="o">)</span> <span class="o">{</span>               <span class="c1">// package-private</span></span>
<span id="LC566" class="line" lang="java">        <span class="k">try</span> <span class="o">{</span></span>
<span id="LC567" class="line" lang="java">            <span class="k">return</span> <span class="k">new</span> <span class="nf">String</span><span class="o">(</span><span class="n">hb</span><span class="o">,</span> <span class="n">start</span> <span class="o">+</span> <span class="n">offset</span><span class="o">,</span> <span class="n">end</span> <span class="o">-</span> <span class="n">start</span><span class="o">);</span></span>
<span id="LC568" class="line" lang="java">        <span class="o">}</span> <span class="k">catch</span> <span class="o">(</span><span class="nc">StringIndexOutOfBoundsException</span> <span class="n">x</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC569" class="line" lang="java">            <span class="k">throw</span> <span class="k">new</span> <span class="nf">IndexOutOfBoundsException</span><span class="o">();</span></span>
...
<span id="LC574" class="line" lang="java">    <span class="c1">// --- Methods to support CharSequence ---</span></span>
<span id="LC575" class="line" lang="java"></span>
<span id="LC576" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">subSequence</span><span class="o">(</span><span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">end</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC577" class="line" lang="java">        <span class="k">if</span> <span class="o">((</span><span class="n">start</span> <span class="o">&lt;</span> <span class="mi">0</span><span class="o">)</span></span>
<span id="LC578" class="line" lang="java">            <span class="o">||</span> <span class="o">(</span><span class="n">end</span> <span class="o">&gt;</span> <span class="n">length</span><span class="o">())</span></span>
<span id="LC579" class="line" lang="java">            <span class="o">||</span> <span class="o">(</span><span class="n">start</span> <span class="o">&gt;</span> <span class="n">end</span><span class="o">))</span></span>
<span id="LC580" class="line" lang="java">            <span class="k">throw</span> <span class="k">new</span> <span class="nf">IndexOutOfBoundsException</span><span class="o">();</span></span>
<span id="LC581" class="line" lang="java">        <span class="kt">int</span> <span class="n">pos</span> <span class="o">=</span> <span class="n">position</span><span class="o">();</span></span>
<span id="LC582" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapCharBuffer</span><span class="o">(</span><span class="n">hb</span><span class="o">,</span></span>
<span id="LC583" class="line" lang="java">                                      <span class="o">-</span><span class="mi">1</span><span class="o">,</span></span>
<span id="LC584" class="line" lang="java">                                      <span class="n">pos</span> <span class="o">+</span> <span class="n">start</span><span class="o">,</span></span>
<span id="LC585" class="line" lang="java">                                      <span class="n">pos</span> <span class="o">+</span> <span class="n">end</span><span class="o">,</span></span>
<span id="LC586" class="line" lang="java">                                      <span class="n">capacity</span><span class="o">(),</span></span>
<span id="LC587" class="line" lang="java">                                      <span class="n">offset</span><span class="o">);</span></span>
...
<span id="LC595" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ByteOrder</span> <span class="nf">order</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC596" class="line" lang="java">        <span class="k">return</span> <span class="nc">ByteOrder</span><span class="o">.</span><span class="na">nativeOrder</span><span class="o">();</span></span>
