...
<span id="LC35" class="line" lang="java"><span class="cm"> * A read-only HeapByteBuffer.  This class extends the corresponding</span></span>
<span id="LC36" class="line" lang="java"><span class="cm"> * read/write class, overriding the mutation methods to throw a {@link</span></span>
<span id="LC37" class="line" lang="java"><span class="cm"> * ReadOnlyBufferException} and overriding the view-buffer methods to return an</span></span>
<span id="LC38" class="line" lang="java"><span class="cm"> * instance of this class rather than of the superclass.</span></span>
...
<span id="LC42" class="line" lang="java"><span class="kd">class</span> <span class="nc">HeapByteBufferR</span></span>
<span id="LC43" class="line" lang="java">    <span class="kd">extends</span> <span class="nc">HeapByteBuffer</span></span>
...
<span id="LC55" class="line" lang="java">    <span class="nc">HeapByteBufferR</span><span class="o">(</span><span class="kt">int</span> <span class="n">cap</span><span class="o">,</span> <span class="kt">int</span> <span class="n">lim</span><span class="o">)</span> <span class="o">{</span>            <span class="c1">// package-private</span></span>
...
<span id="LC63" class="line" lang="java">        <span class="kd">super</span><span class="o">(</span><span class="n">cap</span><span class="o">,</span> <span class="n">lim</span><span class="o">);</span></span>
<span id="LC64" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">isReadOnly</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC68" class="line" lang="java">    <span class="nc">HeapByteBufferR</span><span class="o">(</span><span class="kt">byte</span><span class="o">[]</span> <span class="n">buf</span><span class="o">,</span> <span class="kt">int</span> <span class="n">off</span><span class="o">,</span> <span class="kt">int</span> <span class="n">len</span><span class="o">)</span> <span class="o">{</span> <span class="c1">// package-private</span></span>
...
<span id="LC76" class="line" lang="java">        <span class="kd">super</span><span class="o">(</span><span class="n">buf</span><span class="o">,</span> <span class="n">off</span><span class="o">,</span> <span class="n">len</span><span class="o">);</span></span>
<span id="LC77" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">isReadOnly</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC81" class="line" lang="java">    <span class="kd">protected</span> <span class="nf">HeapByteBufferR</span><span class="o">(</span><span class="kt">byte</span><span class="o">[]</span> <span class="n">buf</span><span class="o">,</span></span>
...
<span id="LC92" class="line" lang="java">        <span class="kd">super</span><span class="o">(</span><span class="n">buf</span><span class="o">,</span> <span class="n">mark</span><span class="o">,</span> <span class="n">pos</span><span class="o">,</span> <span class="n">lim</span><span class="o">,</span> <span class="n">cap</span><span class="o">,</span> <span class="n">off</span><span class="o">);</span></span>
<span id="LC93" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">isReadOnly</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC98" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapByteBufferR</span><span class="o">(</span><span class="n">hb</span><span class="o">,</span></span>
...
<span id="LC107" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapByteBufferR</span><span class="o">(</span><span class="n">hb</span><span class="o">,</span></span>
...
<span id="LC124" class="line" lang="java">        <span class="k">return</span> <span class="nf">duplicate</span><span class="o">();</span></span>
...
<span id="LC172" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC181" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC194" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC222" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC234" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC250" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC273" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC282" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC290" class="line" lang="java">                <span class="o">?</span> <span class="o">(</span><span class="nc">CharBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsCharBufferRB</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC296" class="line" lang="java">                <span class="o">:</span> <span class="o">(</span><span class="nc">CharBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsCharBufferRL</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC324" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC333" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC341" class="line" lang="java">                <span class="o">?</span> <span class="o">(</span><span class="nc">ShortBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsShortBufferRB</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC347" class="line" lang="java">                <span class="o">:</span> <span class="o">(</span><span class="nc">ShortBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsShortBufferRL</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC375" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC384" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC392" class="line" lang="java">                <span class="o">?</span> <span class="o">(</span><span class="nc">IntBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsIntBufferRB</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC398" class="line" lang="java">                <span class="o">:</span> <span class="o">(</span><span class="nc">IntBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsIntBufferRL</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC426" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC435" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC443" class="line" lang="java">                <span class="o">?</span> <span class="o">(</span><span class="nc">LongBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsLongBufferRB</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC449" class="line" lang="java">                <span class="o">:</span> <span class="o">(</span><span class="nc">LongBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsLongBufferRL</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC477" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC486" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC494" class="line" lang="java">                <span class="o">?</span> <span class="o">(</span><span class="nc">FloatBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsFloatBufferRB</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC500" class="line" lang="java">                <span class="o">:</span> <span class="o">(</span><span class="nc">FloatBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsFloatBufferRL</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC528" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC537" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC545" class="line" lang="java">                <span class="o">?</span> <span class="o">(</span><span class="nc">DoubleBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsDoubleBufferRB</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC551" class="line" lang="java">                <span class="o">:</span> <span class="o">(</span><span class="nc">DoubleBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsDoubleBufferRL</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
