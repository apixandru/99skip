...
<span id="LC37" class="line" lang="java"><span class="kd">class</span> <span class="nc">DirectIntBufferU</span></span>
...
<span id="LC190" class="line" lang="java">    <span class="nc">DirectIntBufferU</span><span class="o">(</span><span class="nc">DirectBuffer</span> <span class="n">db</span><span class="o">,</span>         <span class="c1">// package-private</span></span>
...
<span id="LC213" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">DirectIntBufferU</span><span class="o">(</span><span class="k">this</span><span class="o">,</span> <span class="o">-</span><span class="mi">1</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">rem</span><span class="o">,</span> <span class="n">rem</span><span class="o">,</span> <span class="n">off</span><span class="o">);</span></span>
...
<span id="LC217" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">DirectIntBufferU</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC227" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">DirectIntBufferRU</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC249" class="line" lang="java">        <span class="k">return</span> <span class="o">((</span><span class="n">unsafe</span><span class="o">.</span><span class="na">getInt</span><span class="o">(</span><span class="n">ix</span><span class="o">(</span><span class="n">nextGetIndex</span><span class="o">()))));</span></span>
...
<span id="LC253" class="line" lang="java">        <span class="k">return</span> <span class="o">((</span><span class="n">unsafe</span><span class="o">.</span><span class="na">getInt</span><span class="o">(</span><span class="n">ix</span><span class="o">(</span><span class="n">checkIndex</span><span class="o">(</span><span class="n">i</span><span class="o">)))));</span></span>
...
<span id="LC297" class="line" lang="java">        <span class="n">unsafe</span><span class="o">.</span><span class="na">putInt</span><span class="o">(</span><span class="n">ix</span><span class="o">(</span><span class="n">nextPutIndex</span><span class="o">()),</span> <span class="o">((</span><span class="n">x</span><span class="o">)));</span></span>
...
<span id="LC306" class="line" lang="java">        <span class="n">unsafe</span><span class="o">.</span><span class="na">putInt</span><span class="o">(</span><span class="n">ix</span><span class="o">(</span><span class="n">checkIndex</span><span class="o">(</span><span class="n">i</span><span class="o">)),</span> <span class="o">((</span><span class="n">x</span><span class="o">)));</span></span>
...
<span id="LC315" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">src</span> <span class="k">instanceof</span> <span class="nc">DirectIntBufferU</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC318" class="line" lang="java">            <span class="nc">DirectIntBufferU</span> <span class="n">sb</span> <span class="o">=</span> <span class="o">(</span><span class="nc">DirectIntBufferU</span><span class="o">)</span><span class="n">src</span><span class="o">;</span></span>
