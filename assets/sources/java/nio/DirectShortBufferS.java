...
<span id="LC37" class="line" lang="java"><span class="kd">class</span> <span class="nc">DirectShortBufferS</span></span>
<span id="LC38" class="line" lang="java"></span>
<span id="LC39" class="line" lang="java">    <span class="kd">extends</span> <span class="nc">ShortBuffer</span></span>
...
<span id="LC52" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">arrayBaseOffset</span> <span class="o">=</span> <span class="o">(</span><span class="kt">long</span><span class="o">)</span><span class="n">unsafe</span><span class="o">.</span><span class="na">arrayBaseOffset</span><span class="o">(</span><span class="kt">short</span><span class="o">[].</span><span class="na">class</span><span class="o">);</span></span>
...
<span id="LC190" class="line" lang="java">    <span class="nc">DirectShortBufferS</span><span class="o">(</span><span class="nc">DirectBuffer</span> <span class="n">db</span><span class="o">,</span>         <span class="c1">// package-private</span></span>
...
<span id="LC206" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">slice</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC213" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">DirectShortBufferS</span><span class="o">(</span><span class="k">this</span><span class="o">,</span> <span class="o">-</span><span class="mi">1</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">rem</span><span class="o">,</span> <span class="n">rem</span><span class="o">,</span> <span class="n">off</span><span class="o">);</span></span>
<span id="LC214" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC215" class="line" lang="java"></span>
<span id="LC216" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">duplicate</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC217" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">DirectShortBufferS</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC225" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">asReadOnlyBuffer</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC226" class="line" lang="java"></span>
<span id="LC227" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">DirectShortBufferRS</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC248" class="line" lang="java">    <span class="kd">public</span> <span class="kt">short</span> <span class="nf">get</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC249" class="line" lang="java">        <span class="k">return</span> <span class="o">(</span><span class="nc">Bits</span><span class="o">.</span><span class="na">swap</span><span class="o">(</span><span class="n">unsafe</span><span class="o">.</span><span class="na">getShort</span><span class="o">(</span><span class="n">ix</span><span class="o">(</span><span class="n">nextGetIndex</span><span class="o">()))));</span></span>
<span id="LC250" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC251" class="line" lang="java"></span>
<span id="LC252" class="line" lang="java">    <span class="kd">public</span> <span class="kt">short</span> <span class="nf">get</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC253" class="line" lang="java">        <span class="k">return</span> <span class="o">(</span><span class="nc">Bits</span><span class="o">.</span><span class="na">swap</span><span class="o">(</span><span class="n">unsafe</span><span class="o">.</span><span class="na">getShort</span><span class="o">(</span><span class="n">ix</span><span class="o">(</span><span class="n">checkIndex</span><span class="o">(</span><span class="n">i</span><span class="o">)))));</span></span>
...
<span id="LC262" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">get</span><span class="o">(</span><span class="kt">short</span><span class="o">[]</span> <span class="n">dst</span><span class="o">,</span> <span class="kt">int</span> <span class="n">offset</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC275" class="line" lang="java">                <span class="nc">Bits</span><span class="o">.</span><span class="na">copyToShortArray</span><span class="o">(</span><span class="n">ix</span><span class="o">(</span><span class="n">pos</span><span class="o">),</span> <span class="n">dst</span><span class="o">,</span></span>
...
<span id="LC295" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">short</span> <span class="n">x</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC296" class="line" lang="java"></span>
<span id="LC297" class="line" lang="java">        <span class="n">unsafe</span><span class="o">.</span><span class="na">putShort</span><span class="o">(</span><span class="n">ix</span><span class="o">(</span><span class="n">nextPutIndex</span><span class="o">()),</span> <span class="nc">Bits</span><span class="o">.</span><span class="na">swap</span><span class="o">((</span><span class="n">x</span><span class="o">)));</span></span>
...
<span id="LC304" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">,</span> <span class="kt">short</span> <span class="n">x</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC305" class="line" lang="java"></span>
<span id="LC306" class="line" lang="java">        <span class="n">unsafe</span><span class="o">.</span><span class="na">putShort</span><span class="o">(</span><span class="n">ix</span><span class="o">(</span><span class="n">checkIndex</span><span class="o">(</span><span class="n">i</span><span class="o">)),</span> <span class="nc">Bits</span><span class="o">.</span><span class="na">swap</span><span class="o">((</span><span class="n">x</span><span class="o">)));</span></span>
...
<span id="LC313" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="nc">ShortBuffer</span> <span class="n">src</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC314" class="line" lang="java"></span>
<span id="LC315" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">src</span> <span class="k">instanceof</span> <span class="nc">DirectShortBufferS</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC318" class="line" lang="java">            <span class="nc">DirectShortBufferS</span> <span class="n">sb</span> <span class="o">=</span> <span class="o">(</span><span class="nc">DirectShortBufferS</span><span class="o">)</span><span class="n">src</span><span class="o">;</span></span>
...
<span id="LC354" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">short</span><span class="o">[]</span> <span class="n">src</span><span class="o">,</span> <span class="kt">int</span> <span class="n">offset</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC367" class="line" lang="java">                <span class="nc">Bits</span><span class="o">.</span><span class="na">copyFromShortArray</span><span class="o">(</span><span class="n">src</span><span class="o">,</span></span>
...
<span id="LC387" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">compact</span><span class="o">()</span> <span class="o">{</span></span>
