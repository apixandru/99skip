...
<span id="LC33" class="line" lang="java"><span class="cm"> * A read/write HeapShortBuffer.</span></span>
...
<span id="LC42" class="line" lang="java"><span class="kd">class</span> <span class="nc">HeapShortBuffer</span></span>
<span id="LC43" class="line" lang="java">    <span class="kd">extends</span> <span class="nc">ShortBuffer</span></span>
...
<span id="LC50" class="line" lang="java"><span class="cm">    protected final short[] hb;</span></span>
...
<span id="LC55" class="line" lang="java">    <span class="nc">HeapShortBuffer</span><span class="o">(</span><span class="kt">int</span> <span class="n">cap</span><span class="o">,</span> <span class="kt">int</span> <span class="n">lim</span><span class="o">)</span> <span class="o">{</span>            <span class="c1">// package-private</span></span>
<span id="LC56" class="line" lang="java"></span>
<span id="LC57" class="line" lang="java">        <span class="kd">super</span><span class="o">(-</span><span class="mi">1</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">lim</span><span class="o">,</span> <span class="n">cap</span><span class="o">,</span> <span class="k">new</span> <span class="kt">short</span><span class="o">[</span><span class="n">cap</span><span class="o">],</span> <span class="mi">0</span><span class="o">);</span></span>
<span id="LC58" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC59" class="line" lang="java"><span class="cm">        hb = new short[cap];</span></span>
...
<span id="LC68" class="line" lang="java">    <span class="nc">HeapShortBuffer</span><span class="o">(</span><span class="kt">short</span><span class="o">[]</span> <span class="n">buf</span><span class="o">,</span> <span class="kt">int</span> <span class="n">off</span><span class="o">,</span> <span class="kt">int</span> <span class="n">len</span><span class="o">)</span> <span class="o">{</span> <span class="c1">// package-private</span></span>
...
<span id="LC81" class="line" lang="java">    <span class="kd">protected</span> <span class="nf">HeapShortBuffer</span><span class="o">(</span><span class="kt">short</span><span class="o">[]</span> <span class="n">buf</span><span class="o">,</span></span>
...
<span id="LC97" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">slice</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC98" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapShortBuffer</span><span class="o">(</span><span class="n">hb</span><span class="o">,</span></span>
...
<span id="LC106" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">duplicate</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC107" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapShortBuffer</span><span class="o">(</span><span class="n">hb</span><span class="o">,</span></span>
...
<span id="LC115" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">asReadOnlyBuffer</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC116" class="line" lang="java"></span>
<span id="LC117" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapShortBufferR</span><span class="o">(</span><span class="n">hb</span><span class="o">,</span></span>
...
<span id="LC134" class="line" lang="java">    <span class="kd">public</span> <span class="kt">short</span> <span class="nf">get</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC138" class="line" lang="java">    <span class="kd">public</span> <span class="kt">short</span> <span class="nf">get</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC148" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">get</span><span class="o">(</span><span class="kt">short</span><span class="o">[]</span> <span class="n">dst</span><span class="o">,</span> <span class="kt">int</span> <span class="n">offset</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC167" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">short</span> <span class="n">x</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC176" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">,</span> <span class="kt">short</span> <span class="n">x</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC185" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">short</span><span class="o">[]</span> <span class="n">src</span><span class="o">,</span> <span class="kt">int</span> <span class="n">offset</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC198" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="nc">ShortBuffer</span> <span class="n">src</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC199" class="line" lang="java"></span>
<span id="LC200" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">src</span> <span class="k">instanceof</span> <span class="nc">HeapShortBuffer</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC203" class="line" lang="java">            <span class="nc">HeapShortBuffer</span> <span class="n">sb</span> <span class="o">=</span> <span class="o">(</span><span class="nc">HeapShortBuffer</span><span class="o">)</span><span class="n">src</span><span class="o">;</span></span>
...
<span id="LC226" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ShortBuffer</span> <span class="nf">compact</span><span class="o">()</span> <span class="o">{</span></span>
