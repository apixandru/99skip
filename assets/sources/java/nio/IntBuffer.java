...
<span id="LC40" class="line" lang="java"><span class="cm"> * An int buffer.</span></span>
...
<span id="LC43" class="line" lang="java"><span class="cm"> * int buffers:</span></span>
...
<span id="LC48" class="line" lang="java"><span class="cm"> *   {@link #put(int) &lt;i&gt;put&lt;/i&gt;} methods that read and write</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> *   single ints; &lt;/p&gt;&lt;/li&gt;</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC51" class="line" lang="java"><span class="cm"> *   &lt;li&gt;&lt;p&gt; Relative {@link #get(int[]) &lt;i&gt;bulk get&lt;/i&gt;}</span></span>
<span id="LC52" class="line" lang="java"><span class="cm"> *   methods that transfer contiguous sequences of ints from this buffer</span></span>
...
<span id="LC55" class="line" lang="java"><span class="cm"> *   &lt;li&gt;&lt;p&gt; Relative {@link #put(int[]) &lt;i&gt;bulk put&lt;/i&gt;}</span></span>
<span id="LC56" class="line" lang="java"><span class="cm"> *   methods that transfer contiguous sequences of ints from an</span></span>
<span id="LC57" class="line" lang="java"><span class="cm"> *   int array or some other int</span></span>
...
<span id="LC75" class="line" lang="java"><span class="cm"> *   an int buffer.  &lt;/p&gt;&lt;/li&gt;</span></span>
...
<span id="LC79" class="line" lang="java"><span class="cm"> * &lt;p&gt; Int buffers can be created either by {@link #allocate</span></span>
...
<span id="LC89" class="line" lang="java"><span class="cm"> * content, by {@link #wrap(int[]) &lt;i&gt;wrapping&lt;/i&gt;} an existing</span></span>
<span id="LC90" class="line" lang="java"><span class="cm"> * int array  into a buffer, or by creating a</span></span>
...
<span id="LC197" class="line" lang="java"><span class="cm"> * &lt;p&gt; Like a byte buffer, an int buffer is either &lt;a</span></span>
<span id="LC198" class="line" lang="java"><span class="cm"> * href="ByteBuffer.html#direct"&gt;&lt;i&gt;direct&lt;/i&gt; or &lt;i&gt;non-direct&lt;/i&gt;&lt;/a&gt;.  A</span></span>
<span id="LC199" class="line" lang="java"><span class="cm"> * int buffer created via the &lt;tt&gt;wrap&lt;/tt&gt; methods of this class will</span></span>
<span id="LC200" class="line" lang="java"><span class="cm"> * be non-direct.  An int buffer created as a view of a byte buffer will</span></span>
...
<span id="LC202" class="line" lang="java"><span class="cm"> * an int buffer is direct may be determined by invoking the {@link</span></span>
...
<span id="LC262" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">IntBuffer</span></span>
<span id="LC263" class="line" lang="java">    <span class="kd">extends</span> <span class="nc">Buffer</span></span>
<span id="LC264" class="line" lang="java">    <span class="kd">implements</span> <span class="nc">Comparable</span><span class="o">&lt;</span><span class="nc">IntBuffer</span><span class="o">&gt;</span></span>
...
<span id="LC271" class="line" lang="java">    <span class="kd">final</span> <span class="kt">int</span><span class="o">[]</span> <span class="n">hb</span><span class="o">;</span>                  <span class="c1">// Non-null only for heap buffers</span></span>
...
<span id="LC278" class="line" lang="java">    <span class="nc">IntBuffer</span><span class="o">(</span><span class="kt">int</span> <span class="n">mark</span><span class="o">,</span> <span class="kt">int</span> <span class="n">pos</span><span class="o">,</span> <span class="kt">int</span> <span class="n">lim</span><span class="o">,</span> <span class="kt">int</span> <span class="n">cap</span><span class="o">,</span>   <span class="c1">// package-private</span></span>
<span id="LC279" class="line" lang="java">                 <span class="kt">int</span><span class="o">[]</span> <span class="n">hb</span><span class="o">,</span> <span class="kt">int</span> <span class="n">offset</span><span class="o">)</span></span>
...
<span id="LC288" class="line" lang="java">    <span class="nc">IntBuffer</span><span class="o">(</span><span class="kt">int</span> <span class="n">mark</span><span class="o">,</span> <span class="kt">int</span> <span class="n">pos</span><span class="o">,</span> <span class="kt">int</span> <span class="n">lim</span><span class="o">,</span> <span class="kt">int</span> <span class="n">cap</span><span class="o">)</span> <span class="o">{</span> <span class="c1">// package-private</span></span>
...
<span id="LC317" class="line" lang="java"><span class="cm">     * Allocates a new int buffer.</span></span>
...
<span id="LC325" class="line" lang="java"><span class="cm">     *         The new buffer's capacity, in ints</span></span>
<span id="LC326" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC327" class="line" lang="java"><span class="cm">     * @return  The new int buffer</span></span>
...
<span id="LC332" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="nc">IntBuffer</span> <span class="nf">allocate</span><span class="o">(</span><span class="kt">int</span> <span class="n">capacity</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC335" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapIntBuffer</span><span class="o">(</span><span class="n">capacity</span><span class="o">,</span> <span class="n">capacity</span><span class="o">);</span></span>
...
<span id="LC339" class="line" lang="java"><span class="cm">     * Wraps an int array into a buffer.</span></span>
<span id="LC340" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">     * &lt;p&gt; The new buffer will be backed by the given int array;</span></span>
...
<span id="LC363" class="line" lang="java"><span class="cm">     * @return  The new int buffer</span></span>
...
<span id="LC369" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="nc">IntBuffer</span> <span class="nf">wrap</span><span class="o">(</span><span class="kt">int</span><span class="o">[]</span> <span class="n">array</span><span class="o">,</span></span>
...
<span id="LC373" class="line" lang="java">            <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapIntBuffer</span><span class="o">(</span><span class="n">array</span><span class="o">,</span> <span class="n">offset</span><span class="o">,</span> <span class="n">length</span><span class="o">);</span></span>
...
<span id="LC380" class="line" lang="java"><span class="cm">     * Wraps an int array into a buffer.</span></span>
<span id="LC381" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC382" class="line" lang="java"><span class="cm">     * &lt;p&gt; The new buffer will be backed by the given int array;</span></span>
...
<span id="LC393" class="line" lang="java"><span class="cm">     * @return  The new int buffer</span></span>
<span id="LC394" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC395" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="nc">IntBuffer</span> <span class="nf">wrap</span><span class="o">(</span><span class="kt">int</span><span class="o">[]</span> <span class="n">array</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC493" class="line" lang="java"><span class="cm">     * Creates a new int buffer whose content is a shared subsequence of</span></span>
...
<span id="LC502" class="line" lang="java"><span class="cm">     * will be the number of ints remaining in this buffer, and its mark</span></span>
...
<span id="LC507" class="line" lang="java"><span class="cm">     * @return  The new int buffer</span></span>
<span id="LC508" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC509" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">IntBuffer</span> <span class="nf">slice</span><span class="o">();</span></span>
<span id="LC510" class="line" lang="java"></span>
<span id="LC511" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC512" class="line" lang="java"><span class="cm">     * Creates a new int buffer that shares this buffer's content.</span></span>
...
<span id="LC524" class="line" lang="java"><span class="cm">     * @return  The new int buffer</span></span>
<span id="LC525" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC526" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">IntBuffer</span> <span class="nf">duplicate</span><span class="o">();</span></span>
<span id="LC527" class="line" lang="java"></span>
<span id="LC528" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC529" class="line" lang="java"><span class="cm">     * Creates a new, read-only int buffer that shares this buffer's</span></span>
...
<span id="LC544" class="line" lang="java"><span class="cm">     * @return  The new, read-only int buffer</span></span>
<span id="LC545" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC546" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">IntBuffer</span> <span class="nf">asReadOnlyBuffer</span><span class="o">();</span></span>
...
<span id="LC552" class="line" lang="java"><span class="cm">     * Relative &lt;i&gt;get&lt;/i&gt; method.  Reads the int at this buffer's</span></span>
...
<span id="LC555" class="line" lang="java"><span class="cm">     * @return  The int at the buffer's current position</span></span>
...
<span id="LC560" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="kt">int</span> <span class="nf">get</span><span class="o">();</span></span>
...
<span id="LC565" class="line" lang="java"><span class="cm">     * &lt;p&gt; Writes the given int into this buffer at the current</span></span>
...
<span id="LC568" class="line" lang="java"><span class="cm">     * @param  i</span></span>
<span id="LC569" class="line" lang="java"><span class="cm">     *         The int to be written</span></span>
...
<span id="LC579" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">IntBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">);</span></span>
<span id="LC580" class="line" lang="java"></span>
<span id="LC581" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC582" class="line" lang="java"><span class="cm">     * Absolute &lt;i&gt;get&lt;/i&gt; method.  Reads the int at the given</span></span>
...
<span id="LC586" class="line" lang="java"><span class="cm">     *         The index from which the int will be read</span></span>
<span id="LC587" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC588" class="line" lang="java"><span class="cm">     * @return  The int at the given index</span></span>
...
<span id="LC594" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="kt">int</span> <span class="nf">get</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">);</span></span>
...
<span id="LC612" class="line" lang="java"><span class="cm">     * &lt;p&gt; Writes the given int into this buffer at the given</span></span>
...
<span id="LC616" class="line" lang="java"><span class="cm">     *         The index at which the int will be written</span></span>
<span id="LC617" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC618" class="line" lang="java"><span class="cm">     * @param  i</span></span>
<span id="LC619" class="line" lang="java"><span class="cm">     *         The int value to be written</span></span>
...
<span id="LC630" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">IntBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">,</span> <span class="kt">int</span> <span class="n">i</span><span class="o">);</span></span>
...
<span id="LC638" class="line" lang="java"><span class="cm">     * &lt;p&gt; This method transfers ints from this buffer into the given</span></span>
<span id="LC639" class="line" lang="java"><span class="cm">     * destination array.  If there are fewer ints remaining in the</span></span>
...
<span id="LC642" class="line" lang="java"><span class="cm">     * ints are transferred and a {@link BufferUnderflowException} is</span></span>
...
<span id="LC645" class="line" lang="java"><span class="cm">     * &lt;p&gt; Otherwise, this method copies &lt;tt&gt;length&lt;/tt&gt; ints from this</span></span>
...
<span id="LC659" class="line" lang="java"><span class="cm">     * except that it first checks that there are sufficient ints in</span></span>
...
<span id="LC663" class="line" lang="java"><span class="cm">     *         The array into which ints are to be written</span></span>
...
<span id="LC666" class="line" lang="java"><span class="cm">     *         The offset within the array of the first int to be</span></span>
...
<span id="LC671" class="line" lang="java"><span class="cm">     *         The maximum number of ints to be written to the given</span></span>
...
<span id="LC678" class="line" lang="java"><span class="cm">     *          If there are fewer than &lt;tt&gt;length&lt;/tt&gt; ints</span></span>
...
<span id="LC685" class="line" lang="java">    <span class="kd">public</span> <span class="nc">IntBuffer</span> <span class="nf">get</span><span class="o">(</span><span class="kt">int</span><span class="o">[]</span> <span class="n">dst</span><span class="o">,</span> <span class="kt">int</span> <span class="n">offset</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC698" class="line" lang="java"><span class="cm">     * &lt;p&gt; This method transfers ints from this buffer into the given</span></span>
...
<span id="LC711" class="line" lang="java"><span class="cm">     *          If there are fewer than &lt;tt&gt;length&lt;/tt&gt; ints</span></span>
...
<span id="LC714" class="line" lang="java">    <span class="kd">public</span> <span class="nc">IntBuffer</span> <span class="nf">get</span><span class="o">(</span><span class="kt">int</span><span class="o">[]</span> <span class="n">dst</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC724" class="line" lang="java"><span class="cm">     * &lt;p&gt; This method transfers the ints remaining in the given source</span></span>
<span id="LC725" class="line" lang="java"><span class="cm">     * buffer into this buffer.  If there are more ints remaining in the</span></span>
...
<span id="LC728" class="line" lang="java"><span class="cm">     * then no ints are transferred and a {@link</span></span>
...
<span id="LC732" class="line" lang="java"><span class="cm">     * &lt;i&gt;n&lt;/i&gt;&amp;nbsp;=&amp;nbsp;&lt;tt&gt;src.remaining()&lt;/tt&gt; ints from the given</span></span>
...
<span id="LC747" class="line" lang="java"><span class="cm">     *         The source buffer from which ints are to be read;</span></span>
...
<span id="LC754" class="line" lang="java"><span class="cm">     *          for the remaining ints in the source buffer</span></span>
...
<span id="LC762" class="line" lang="java">    <span class="kd">public</span> <span class="nc">IntBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="nc">IntBuffer</span> <span class="n">src</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC778" class="line" lang="java"><span class="cm">     * &lt;p&gt; This method transfers ints into this buffer from the given</span></span>
<span id="LC779" class="line" lang="java"><span class="cm">     * source array.  If there are more ints to be copied from the array</span></span>
...
<span id="LC782" class="line" lang="java"><span class="cm">     * ints are transferred and a {@link BufferOverflowException} is</span></span>
...
<span id="LC785" class="line" lang="java"><span class="cm">     * &lt;p&gt; Otherwise, this method copies &lt;tt&gt;length&lt;/tt&gt; ints from the</span></span>
...
<span id="LC803" class="line" lang="java"><span class="cm">     *         The array from which ints are to be read</span></span>
...
<span id="LC806" class="line" lang="java"><span class="cm">     *         The offset within the array of the first int to be read;</span></span>
...
<span id="LC810" class="line" lang="java"><span class="cm">     *         The number of ints to be read from the given array;</span></span>
...
<span id="LC826" class="line" lang="java">    <span class="kd">public</span> <span class="nc">IntBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">int</span><span class="o">[]</span> <span class="n">src</span><span class="o">,</span> <span class="kt">int</span> <span class="n">offset</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC840" class="line" lang="java"><span class="cm">     * int array into this buffer.  An invocation of this method of the</span></span>
...
<span id="LC858" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="nc">IntBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">int</span><span class="o">[]</span> <span class="n">src</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC959" class="line" lang="java"><span class="cm">     * Tells whether or not this buffer is backed by an accessible int</span></span>
...
<span id="LC974" class="line" lang="java"><span class="cm">     * Returns the int array that backs this</span></span>
...
<span id="LC992" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="kt">int</span><span class="o">[]</span> <span class="nf">array</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC1031" class="line" lang="java"><span class="cm">     * &lt;p&gt; The ints between the buffer's current position and its limit,</span></span>
<span id="LC1032" class="line" lang="java"><span class="cm">     * if any, are copied to the beginning of the buffer.  That is, the</span></span>
<span id="LC1033" class="line" lang="java"><span class="cm">     * int at index &lt;i&gt;p&lt;/i&gt;&amp;nbsp;=&amp;nbsp;&lt;tt&gt;position()&lt;/tt&gt; is copied</span></span>
<span id="LC1034" class="line" lang="java"><span class="cm">     * to index zero, the int at index &lt;i&gt;p&lt;/i&gt;&amp;nbsp;+&amp;nbsp;1 is copied</span></span>
<span id="LC1035" class="line" lang="java"><span class="cm">     * to index one, and so forth until the int at index</span></span>
...
<span id="LC1041" class="line" lang="java"><span class="cm">     * &lt;p&gt; The buffer's position is set to the number of ints copied,</span></span>
...
<span id="LC1068" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">IntBuffer</span> <span class="nf">compact</span><span class="o">();</span></span>
<span id="LC1069" class="line" lang="java"></span>
<span id="LC1070" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1071" class="line" lang="java"><span class="cm">     * Tells whether or not this int buffer is direct.</span></span>
...
<span id="LC1105" class="line" lang="java"><span class="cm">     * &lt;p&gt; The hash code of a int buffer depends only upon its remaining</span></span>
...
<span id="LC1120" class="line" lang="java">            <span class="n">h</span> <span class="o">=</span> <span class="mi">31</span> <span class="o">*</span> <span class="n">h</span> <span class="o">+</span> <span class="n">get</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
...
<span id="LC1130" class="line" lang="java"><span class="cm">     * &lt;p&gt; Two int buffers are equal if, and only if,</span></span>
...
<span id="LC1152" class="line" lang="java"><span class="cm">     * &lt;p&gt; A int buffer is not equal to any other type of object.  &lt;/p&gt;</span></span>
...
<span id="LC1162" class="line" lang="java">        <span class="k">if</span> <span class="o">(!(</span><span class="n">ob</span> <span class="k">instanceof</span> <span class="nc">IntBuffer</span><span class="o">))</span></span>
<span id="LC1163" class="line" lang="java">            <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1164" class="line" lang="java">        <span class="nc">IntBuffer</span> <span class="n">that</span> <span class="o">=</span> <span class="o">(</span><span class="nc">IntBuffer</span><span class="o">)</span><span class="n">ob</span><span class="o">;</span></span>
...
<span id="LC1174" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="kt">boolean</span> <span class="nf">equals</span><span class="o">(</span><span class="kt">int</span> <span class="n">x</span><span class="o">,</span> <span class="kt">int</span> <span class="n">y</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC1185" class="line" lang="java"><span class="cm">     * &lt;p&gt; Two int buffers are compared by comparing their sequences of</span></span>
...
<span id="LC1196" class="line" lang="java"><span class="cm">     * Pairs of {@code int} elements are compared as if by invoking</span></span>
<span id="LC1197" class="line" lang="java"><span class="cm">     * {@link Integer#compare(int,int)}.</span></span>
<span id="LC1198" class="line" lang="java"></span>
<span id="LC1199" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1200" class="line" lang="java"><span class="cm">     * &lt;p&gt; A int buffer is not comparable to any other type of object.</span></span>
...
<span id="LC1205" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">compareTo</span><span class="o">(</span><span class="nc">IntBuffer</span> <span class="n">that</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC1215" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="kt">int</span> <span class="nf">compare</span><span class="o">(</span><span class="kt">int</span> <span class="n">x</span><span class="o">,</span> <span class="kt">int</span> <span class="n">y</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC1222" class="line" lang="java">        <span class="k">return</span> <span class="nc">Integer</span><span class="o">.</span><span class="na">compare</span><span class="o">(</span><span class="n">x</span><span class="o">,</span> <span class="n">y</span><span class="o">);</span></span>
...
<span id="LC1428" class="line" lang="java"><span class="cm">     * &lt;p&gt; The byte order of an int buffer created by allocation or by</span></span>
<span id="LC1429" class="line" lang="java"><span class="cm">     * wrapping an existing &lt;tt&gt;int&lt;/tt&gt; array is the {@link</span></span>
<span id="LC1430" class="line" lang="java"><span class="cm">     * ByteOrder#nativeOrder native order} of the underlying</span></span>
<span id="LC1431" class="line" lang="java"><span class="cm">     * hardware.  The byte order of an int buffer created as a &lt;a</span></span>
