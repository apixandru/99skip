...
<span id="LC37" class="line" lang="java"><span class="kd">class</span> <span class="nc">DirectByteBufferR</span></span>
<span id="LC38" class="line" lang="java"></span>
<span id="LC39" class="line" lang="java"></span>
<span id="LC40" class="line" lang="java"></span>
<span id="LC41" class="line" lang="java">    <span class="kd">extends</span> <span class="nc">DirectByteBuffer</span></span>
...
<span id="LC117" class="line" lang="java">    <span class="nc">DirectByteBufferR</span><span class="o">(</span><span class="kt">int</span> <span class="n">cap</span><span class="o">)</span> <span class="o">{</span>                   <span class="c1">// package-private</span></span>
...
<span id="LC142" class="line" lang="java">        <span class="kd">super</span><span class="o">(</span><span class="n">cap</span><span class="o">);</span></span>
...
<span id="LC172" class="line" lang="java">    <span class="kd">protected</span> <span class="nf">DirectByteBufferR</span><span class="o">(</span><span class="kt">int</span> <span class="n">cap</span><span class="o">,</span> <span class="kt">long</span> <span class="n">addr</span><span class="o">,</span></span>
...
<span id="LC182" class="line" lang="java">        <span class="kd">super</span><span class="o">(</span><span class="n">cap</span><span class="o">,</span> <span class="n">addr</span><span class="o">,</span> <span class="n">fd</span><span class="o">,</span> <span class="n">unmapper</span><span class="o">);</span></span>
...
<span id="LC190" class="line" lang="java">    <span class="nc">DirectByteBufferR</span><span class="o">(</span><span class="nc">DirectBuffer</span> <span class="n">db</span><span class="o">,</span>         <span class="c1">// package-private</span></span>
...
<span id="LC202" class="line" lang="java">        <span class="kd">super</span><span class="o">(</span><span class="n">db</span><span class="o">,</span> <span class="n">mark</span><span class="o">,</span> <span class="n">pos</span><span class="o">,</span> <span class="n">lim</span><span class="o">,</span> <span class="n">cap</span><span class="o">,</span> <span class="n">off</span><span class="o">);</span></span>
...
<span id="LC213" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">DirectByteBufferR</span><span class="o">(</span><span class="k">this</span><span class="o">,</span> <span class="o">-</span><span class="mi">1</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">rem</span><span class="o">,</span> <span class="n">rem</span><span class="o">,</span> <span class="n">off</span><span class="o">);</span></span>
...
<span id="LC217" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">DirectByteBufferR</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC234" class="line" lang="java">        <span class="k">return</span> <span class="nf">duplicate</span><span class="o">();</span></span>
...
<span id="LC300" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC309" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC350" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC383" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC400" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC483" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC518" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC527" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC536" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC549" class="line" lang="java">                    <span class="o">?</span> <span class="o">(</span><span class="nc">CharBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsCharBufferRB</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC555" class="line" lang="java">                    <span class="o">:</span> <span class="o">(</span><span class="nc">CharBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsCharBufferRL</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC563" class="line" lang="java">                    <span class="o">?</span> <span class="o">(</span><span class="nc">CharBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">DirectCharBufferRU</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC569" class="line" lang="java">                    <span class="o">:</span> <span class="o">(</span><span class="nc">CharBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">DirectCharBufferRS</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC609" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC618" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC627" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC640" class="line" lang="java">                    <span class="o">?</span> <span class="o">(</span><span class="nc">ShortBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsShortBufferRB</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC646" class="line" lang="java">                    <span class="o">:</span> <span class="o">(</span><span class="nc">ShortBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsShortBufferRL</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC654" class="line" lang="java">                    <span class="o">?</span> <span class="o">(</span><span class="nc">ShortBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">DirectShortBufferRU</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC660" class="line" lang="java">                    <span class="o">:</span> <span class="o">(</span><span class="nc">ShortBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">DirectShortBufferRS</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC700" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC709" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC718" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC731" class="line" lang="java">                    <span class="o">?</span> <span class="o">(</span><span class="nc">IntBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsIntBufferRB</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC737" class="line" lang="java">                    <span class="o">:</span> <span class="o">(</span><span class="nc">IntBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsIntBufferRL</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC745" class="line" lang="java">                    <span class="o">?</span> <span class="o">(</span><span class="nc">IntBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">DirectIntBufferRU</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC751" class="line" lang="java">                    <span class="o">:</span> <span class="o">(</span><span class="nc">IntBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">DirectIntBufferRS</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC791" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC800" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC809" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC822" class="line" lang="java">                    <span class="o">?</span> <span class="o">(</span><span class="nc">LongBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsLongBufferRB</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC828" class="line" lang="java">                    <span class="o">:</span> <span class="o">(</span><span class="nc">LongBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsLongBufferRL</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC836" class="line" lang="java">                    <span class="o">?</span> <span class="o">(</span><span class="nc">LongBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">DirectLongBufferRU</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC842" class="line" lang="java">                    <span class="o">:</span> <span class="o">(</span><span class="nc">LongBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">DirectLongBufferRS</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC882" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC891" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC900" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC913" class="line" lang="java">                    <span class="o">?</span> <span class="o">(</span><span class="nc">FloatBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsFloatBufferRB</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC919" class="line" lang="java">                    <span class="o">:</span> <span class="o">(</span><span class="nc">FloatBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsFloatBufferRL</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC927" class="line" lang="java">                    <span class="o">?</span> <span class="o">(</span><span class="nc">FloatBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">DirectFloatBufferRU</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC933" class="line" lang="java">                    <span class="o">:</span> <span class="o">(</span><span class="nc">FloatBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">DirectFloatBufferRS</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC973" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC982" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC991" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
...
<span id="LC1004" class="line" lang="java">                    <span class="o">?</span> <span class="o">(</span><span class="nc">DoubleBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsDoubleBufferRB</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC1010" class="line" lang="java">                    <span class="o">:</span> <span class="o">(</span><span class="nc">DoubleBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">ByteBufferAsDoubleBufferRL</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC1018" class="line" lang="java">                    <span class="o">?</span> <span class="o">(</span><span class="nc">DoubleBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">DirectDoubleBufferRU</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
...
<span id="LC1024" class="line" lang="java">                    <span class="o">:</span> <span class="o">(</span><span class="nc">DoubleBuffer</span><span class="o">)(</span><span class="k">new</span> <span class="nc">DirectDoubleBufferRS</span><span class="o">(</span><span class="k">this</span><span class="o">,</span></span>
