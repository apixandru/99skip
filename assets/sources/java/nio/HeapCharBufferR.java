...
<span id="LC35" class="line" lang="java"><span class="cm"> * A read-only HeapCharBuffer.  This class extends the corresponding</span></span>
...
<span id="LC42" class="line" lang="java"><span class="kd">class</span> <span class="nc">HeapCharBufferR</span></span>
<span id="LC43" class="line" lang="java">    <span class="kd">extends</span> <span class="nc">HeapCharBuffer</span></span>
...
<span id="LC55" class="line" lang="java">    <span class="nc">HeapCharBufferR</span><span class="o">(</span><span class="kt">int</span> <span class="n">cap</span><span class="o">,</span> <span class="kt">int</span> <span class="n">lim</span><span class="o">)</span> <span class="o">{</span>            <span class="c1">// package-private</span></span>
...
<span id="LC68" class="line" lang="java">    <span class="nc">HeapCharBufferR</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">buf</span><span class="o">,</span> <span class="kt">int</span> <span class="n">off</span><span class="o">,</span> <span class="kt">int</span> <span class="n">len</span><span class="o">)</span> <span class="o">{</span> <span class="c1">// package-private</span></span>
...
<span id="LC81" class="line" lang="java">    <span class="kd">protected</span> <span class="nf">HeapCharBufferR</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">buf</span><span class="o">,</span></span>
...
<span id="LC98" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapCharBufferR</span><span class="o">(</span><span class="n">hb</span><span class="o">,</span></span>
...
<span id="LC107" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapCharBufferR</span><span class="o">(</span><span class="n">hb</span><span class="o">,</span></span>
...
<span id="LC582" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapCharBufferR</span><span class="o">(</span><span class="n">hb</span><span class="o">,</span></span>
