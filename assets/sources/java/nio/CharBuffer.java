...
<span id="LC34" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.util.Spliterator</span><span class="o">;</span></span>
...
<span id="LC36" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.util.stream.IntStream</span><span class="o">;</span></span>
...
<span id="LC40" class="line" lang="java"><span class="cm"> * A char buffer.</span></span>
<span id="LC41" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC42" class="line" lang="java"><span class="cm"> * &lt;p&gt; This class defines four categories of operations upon</span></span>
<span id="LC43" class="line" lang="java"><span class="cm"> * char buffers:</span></span>
...
<span id="LC48" class="line" lang="java"><span class="cm"> *   {@link #put(char) &lt;i&gt;put&lt;/i&gt;} methods that read and write</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> *   single chars; &lt;/p&gt;&lt;/li&gt;</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC51" class="line" lang="java"><span class="cm"> *   &lt;li&gt;&lt;p&gt; Relative {@link #get(char[]) &lt;i&gt;bulk get&lt;/i&gt;}</span></span>
<span id="LC52" class="line" lang="java"><span class="cm"> *   methods that transfer contiguous sequences of chars from this buffer</span></span>
<span id="LC53" class="line" lang="java"><span class="cm"> *   into an array; and&lt;/p&gt;&lt;/li&gt;</span></span>
<span id="LC54" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC55" class="line" lang="java"><span class="cm"> *   &lt;li&gt;&lt;p&gt; Relative {@link #put(char[]) &lt;i&gt;bulk put&lt;/i&gt;}</span></span>
<span id="LC56" class="line" lang="java"><span class="cm"> *   methods that transfer contiguous sequences of chars from a</span></span>
<span id="LC57" class="line" lang="java"><span class="cm"> *   char array,&amp;#32;a&amp;#32;string, or some other char</span></span>
<span id="LC58" class="line" lang="java"><span class="cm"> *   buffer into this buffer;&amp;#32;and &lt;/p&gt;&lt;/li&gt;</span></span>
...
<span id="LC75" class="line" lang="java"><span class="cm"> *   a char buffer.  &lt;/p&gt;&lt;/li&gt;</span></span>
...
<span id="LC79" class="line" lang="java"><span class="cm"> * &lt;p&gt; Char buffers can be created either by {@link #allocate</span></span>
...
<span id="LC89" class="line" lang="java"><span class="cm"> * content, by {@link #wrap(char[]) &lt;i&gt;wrapping&lt;/i&gt;} an existing</span></span>
<span id="LC90" class="line" lang="java"><span class="cm"> * char array or&amp;#32;string into a buffer, or by creating a</span></span>
<span id="LC91" class="line" lang="java"><span class="cm"> * &lt;a href="ByteBuffer.html#views"&gt;&lt;i&gt;view&lt;/i&gt;&lt;/a&gt; of an existing byte buffer.</span></span>
...
<span id="LC197" class="line" lang="java"><span class="cm"> * &lt;p&gt; Like a byte buffer, a char buffer is either &lt;a</span></span>
<span id="LC198" class="line" lang="java"><span class="cm"> * href="ByteBuffer.html#direct"&gt;&lt;i&gt;direct&lt;/i&gt; or &lt;i&gt;non-direct&lt;/i&gt;&lt;/a&gt;.  A</span></span>
<span id="LC199" class="line" lang="java"><span class="cm"> * char buffer created via the &lt;tt&gt;wrap&lt;/tt&gt; methods of this class will</span></span>
<span id="LC200" class="line" lang="java"><span class="cm"> * be non-direct.  A char buffer created as a view of a byte buffer will</span></span>
<span id="LC201" class="line" lang="java"><span class="cm"> * be direct if, and only if, the byte buffer itself is direct.  Whether or not</span></span>
<span id="LC202" class="line" lang="java"><span class="cm"> * a char buffer is direct may be determined by invoking the {@link</span></span>
<span id="LC203" class="line" lang="java"><span class="cm"> * #isDirect isDirect} method.  &lt;/p&gt;</span></span>
...
<span id="LC209" class="line" lang="java"><span class="cm"> * &lt;p&gt; This class implements the {@link CharSequence} interface so that</span></span>
<span id="LC210" class="line" lang="java"><span class="cm"> * character buffers may be used wherever character sequences are accepted, for</span></span>
<span id="LC211" class="line" lang="java"><span class="cm"> * example in the regular-expression package &lt;tt&gt;{@link java.util.regex}&lt;/tt&gt;.</span></span>
...
<span id="LC241" class="line" lang="java"><span class="cm"> * The sequence of statements</span></span>
<span id="LC242" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC243" class="line" lang="java"><span class="cm"> * &lt;blockquote&gt;&lt;pre&gt;</span></span>
<span id="LC244" class="line" lang="java"><span class="cm"> * cb.put("text/");</span></span>
<span id="LC245" class="line" lang="java"><span class="cm"> * cb.put(subtype);</span></span>
<span id="LC246" class="line" lang="java"><span class="cm"> * cb.put("; charset=");</span></span>
<span id="LC247" class="line" lang="java"><span class="cm"> * cb.put(enc);&lt;/pre&gt;&lt;/blockquote&gt;</span></span>
<span id="LC248" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC249" class="line" lang="java"><span class="cm"> * can, for example, be replaced by the single statement</span></span>
<span id="LC250" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC251" class="line" lang="java"><span class="cm"> * &lt;blockquote&gt;&lt;pre&gt;</span></span>
<span id="LC252" class="line" lang="java"><span class="cm"> * cb.put("text/").put(subtype).put("; charset=").put(enc);&lt;/pre&gt;&lt;/blockquote&gt;</span></span>
...
<span id="LC262" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">CharBuffer</span></span>
<span id="LC263" class="line" lang="java">    <span class="kd">extends</span> <span class="nc">Buffer</span></span>
<span id="LC264" class="line" lang="java">    <span class="kd">implements</span> <span class="nc">Comparable</span><span class="o">&lt;</span><span class="nc">CharBuffer</span><span class="o">&gt;,</span> <span class="nc">Appendable</span><span class="o">,</span> <span class="nc">CharSequence</span><span class="o">,</span> <span class="nc">Readable</span></span>
...
<span id="LC271" class="line" lang="java">    <span class="kd">final</span> <span class="kt">char</span><span class="o">[]</span> <span class="n">hb</span><span class="o">;</span>                  <span class="c1">// Non-null only for heap buffers</span></span>
...
<span id="LC278" class="line" lang="java">    <span class="nc">CharBuffer</span><span class="o">(</span><span class="kt">int</span> <span class="n">mark</span><span class="o">,</span> <span class="kt">int</span> <span class="n">pos</span><span class="o">,</span> <span class="kt">int</span> <span class="n">lim</span><span class="o">,</span> <span class="kt">int</span> <span class="n">cap</span><span class="o">,</span>   <span class="c1">// package-private</span></span>
<span id="LC279" class="line" lang="java">                 <span class="kt">char</span><span class="o">[]</span> <span class="n">hb</span><span class="o">,</span> <span class="kt">int</span> <span class="n">offset</span><span class="o">)</span></span>
...
<span id="LC288" class="line" lang="java">    <span class="nc">CharBuffer</span><span class="o">(</span><span class="kt">int</span> <span class="n">mark</span><span class="o">,</span> <span class="kt">int</span> <span class="n">pos</span><span class="o">,</span> <span class="kt">int</span> <span class="n">lim</span><span class="o">,</span> <span class="kt">int</span> <span class="n">cap</span><span class="o">)</span> <span class="o">{</span> <span class="c1">// package-private</span></span>
...
<span id="LC317" class="line" lang="java"><span class="cm">     * Allocates a new char buffer.</span></span>
...
<span id="LC325" class="line" lang="java"><span class="cm">     *         The new buffer's capacity, in chars</span></span>
<span id="LC326" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC327" class="line" lang="java"><span class="cm">     * @return  The new char buffer</span></span>
...
<span id="LC332" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="nc">CharBuffer</span> <span class="nf">allocate</span><span class="o">(</span><span class="kt">int</span> <span class="n">capacity</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC335" class="line" lang="java">        <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapCharBuffer</span><span class="o">(</span><span class="n">capacity</span><span class="o">,</span> <span class="n">capacity</span><span class="o">);</span></span>
...
<span id="LC339" class="line" lang="java"><span class="cm">     * Wraps a char array into a buffer.</span></span>
<span id="LC340" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">     * &lt;p&gt; The new buffer will be backed by the given char array;</span></span>
...
<span id="LC363" class="line" lang="java"><span class="cm">     * @return  The new char buffer</span></span>
...
<span id="LC369" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="nc">CharBuffer</span> <span class="nf">wrap</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">array</span><span class="o">,</span></span>
...
<span id="LC373" class="line" lang="java">            <span class="k">return</span> <span class="k">new</span> <span class="nf">HeapCharBuffer</span><span class="o">(</span><span class="n">array</span><span class="o">,</span> <span class="n">offset</span><span class="o">,</span> <span class="n">length</span><span class="o">);</span></span>
...
<span id="LC380" class="line" lang="java"><span class="cm">     * Wraps a char array into a buffer.</span></span>
<span id="LC381" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC382" class="line" lang="java"><span class="cm">     * &lt;p&gt; The new buffer will be backed by the given char array;</span></span>
...
<span id="LC393" class="line" lang="java"><span class="cm">     * @return  The new char buffer</span></span>
<span id="LC394" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC395" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="nc">CharBuffer</span> <span class="nf">wrap</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">array</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC402" class="line" lang="java"><span class="cm">     * Attempts to read characters into the specified character buffer.</span></span>
<span id="LC403" class="line" lang="java"><span class="cm">     * The buffer is used as a repository of characters as-is: the only</span></span>
<span id="LC404" class="line" lang="java"><span class="cm">     * changes made are the results of a put operation. No flipping or</span></span>
<span id="LC405" class="line" lang="java"><span class="cm">     * rewinding of the buffer is performed.</span></span>
<span id="LC406" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC407" class="line" lang="java"><span class="cm">     * @param target the buffer to read characters into</span></span>
<span id="LC408" class="line" lang="java"><span class="cm">     * @return The number of characters added to the buffer, or</span></span>
<span id="LC409" class="line" lang="java"><span class="cm">     *         -1 if this source of characters is at its end</span></span>
<span id="LC410" class="line" lang="java"><span class="cm">     * @throws IOException if an I/O error occurs</span></span>
<span id="LC411" class="line" lang="java"><span class="cm">     * @throws NullPointerException if target is null</span></span>
<span id="LC412" class="line" lang="java"><span class="cm">     * @throws ReadOnlyBufferException if target is a read only buffer</span></span>
...
<span id="LC415" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">read</span><span class="o">(</span><span class="nc">CharBuffer</span> <span class="n">target</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">IOException</span> <span class="o">{</span></span>
<span id="LC416" class="line" lang="java">        <span class="c1">// Determine the number of bytes n that can be transferred</span></span>
<span id="LC417" class="line" lang="java">        <span class="kt">int</span> <span class="n">targetRemaining</span> <span class="o">=</span> <span class="n">target</span><span class="o">.</span><span class="na">remaining</span><span class="o">();</span></span>
<span id="LC418" class="line" lang="java">        <span class="kt">int</span> <span class="n">remaining</span> <span class="o">=</span> <span class="n">remaining</span><span class="o">();</span></span>
<span id="LC419" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">remaining</span> <span class="o">==</span> <span class="mi">0</span><span class="o">)</span></span>
...
<span id="LC421" class="line" lang="java">        <span class="kt">int</span> <span class="n">n</span> <span class="o">=</span> <span class="nc">Math</span><span class="o">.</span><span class="na">min</span><span class="o">(</span><span class="n">remaining</span><span class="o">,</span> <span class="n">targetRemaining</span><span class="o">);</span></span>
<span id="LC422" class="line" lang="java">        <span class="kt">int</span> <span class="n">limit</span> <span class="o">=</span> <span class="n">limit</span><span class="o">();</span></span>
<span id="LC423" class="line" lang="java">        <span class="c1">// Set source limit to prevent target overflow</span></span>
<span id="LC424" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">targetRemaining</span> <span class="o">&lt;</span> <span class="n">remaining</span><span class="o">)</span></span>
<span id="LC425" class="line" lang="java">            <span class="n">limit</span><span class="o">(</span><span class="n">position</span><span class="o">()</span> <span class="o">+</span> <span class="n">n</span><span class="o">);</span></span>
<span id="LC426" class="line" lang="java">        <span class="k">try</span> <span class="o">{</span></span>
<span id="LC427" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">n</span> <span class="o">&gt;</span> <span class="mi">0</span><span class="o">)</span></span>
<span id="LC428" class="line" lang="java">                <span class="n">target</span><span class="o">.</span><span class="na">put</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC429" class="line" lang="java">        <span class="o">}</span> <span class="k">finally</span> <span class="o">{</span></span>
<span id="LC430" class="line" lang="java">            <span class="n">limit</span><span class="o">(</span><span class="n">limit</span><span class="o">);</span> <span class="c1">// restore real limit</span></span>
<span id="LC431" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC432" class="line" lang="java">        <span class="k">return</span> <span class="n">n</span><span class="o">;</span></span>
...
<span id="LC436" class="line" lang="java"><span class="cm">     * Wraps a character sequence into a buffer.</span></span>
<span id="LC437" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC438" class="line" lang="java"><span class="cm">     * &lt;p&gt; The content of the new, read-only buffer will be the content of the</span></span>
<span id="LC439" class="line" lang="java"><span class="cm">     * given character sequence.  The buffer's capacity will be</span></span>
<span id="LC440" class="line" lang="java"><span class="cm">     * &lt;tt&gt;csq.length()&lt;/tt&gt;, its position will be &lt;tt&gt;start&lt;/tt&gt;, its limit</span></span>
<span id="LC441" class="line" lang="java"><span class="cm">     * will be &lt;tt&gt;end&lt;/tt&gt;, and its mark will be undefined.  &lt;/p&gt;</span></span>
<span id="LC442" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC443" class="line" lang="java"><span class="cm">     * @param  csq</span></span>
<span id="LC444" class="line" lang="java"><span class="cm">     *         The character sequence from which the new character buffer is to</span></span>
<span id="LC445" class="line" lang="java"><span class="cm">     *         be created</span></span>
<span id="LC446" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC447" class="line" lang="java"><span class="cm">     * @param  start</span></span>
<span id="LC448" class="line" lang="java"><span class="cm">     *         The index of the first character to be used;</span></span>
<span id="LC449" class="line" lang="java"><span class="cm">     *         must be non-negative and no larger than &lt;tt&gt;csq.length()&lt;/tt&gt;.</span></span>
<span id="LC450" class="line" lang="java"><span class="cm">     *         The new buffer's position will be set to this value.</span></span>
<span id="LC451" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC452" class="line" lang="java"><span class="cm">     * @param  end</span></span>
<span id="LC453" class="line" lang="java"><span class="cm">     *         The index of the character following the last character to be</span></span>
<span id="LC454" class="line" lang="java"><span class="cm">     *         used; must be no smaller than &lt;tt&gt;start&lt;/tt&gt; and no larger</span></span>
<span id="LC455" class="line" lang="java"><span class="cm">     *         than &lt;tt&gt;csq.length()&lt;/tt&gt;.</span></span>
<span id="LC456" class="line" lang="java"><span class="cm">     *         The new buffer's limit will be set to this value.</span></span>
<span id="LC457" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC458" class="line" lang="java"><span class="cm">     * @return  The new character buffer</span></span>
<span id="LC459" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC460" class="line" lang="java"><span class="cm">     * @throws  IndexOutOfBoundsException</span></span>
<span id="LC461" class="line" lang="java"><span class="cm">     *          If the preconditions on the &lt;tt&gt;start&lt;/tt&gt; and &lt;tt&gt;end&lt;/tt&gt;</span></span>
<span id="LC462" class="line" lang="java"><span class="cm">     *          parameters do not hold</span></span>
<span id="LC463" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC464" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="nc">CharBuffer</span> <span class="nf">wrap</span><span class="o">(</span><span class="nc">CharSequence</span> <span class="n">csq</span><span class="o">,</span> <span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">end</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC465" class="line" lang="java">        <span class="k">try</span> <span class="o">{</span></span>
<span id="LC466" class="line" lang="java">            <span class="k">return</span> <span class="k">new</span> <span class="nf">StringCharBuffer</span><span class="o">(</span><span class="n">csq</span><span class="o">,</span> <span class="n">start</span><span class="o">,</span> <span class="n">end</span><span class="o">);</span></span>
<span id="LC467" class="line" lang="java">        <span class="o">}</span> <span class="k">catch</span> <span class="o">(</span><span class="nc">IllegalArgumentException</span> <span class="n">x</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC468" class="line" lang="java">            <span class="k">throw</span> <span class="k">new</span> <span class="nf">IndexOutOfBoundsException</span><span class="o">();</span></span>
...
<span id="LC473" class="line" lang="java"><span class="cm">     * Wraps a character sequence into a buffer.</span></span>
<span id="LC474" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC475" class="line" lang="java"><span class="cm">     * &lt;p&gt; The content of the new, read-only buffer will be the content of the</span></span>
<span id="LC476" class="line" lang="java"><span class="cm">     * given character sequence.  The new buffer's capacity and limit will be</span></span>
<span id="LC477" class="line" lang="java"><span class="cm">     * &lt;tt&gt;csq.length()&lt;/tt&gt;, its position will be zero, and its mark will be</span></span>
<span id="LC478" class="line" lang="java"><span class="cm">     * undefined.  &lt;/p&gt;</span></span>
<span id="LC479" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC480" class="line" lang="java"><span class="cm">     * @param  csq</span></span>
<span id="LC481" class="line" lang="java"><span class="cm">     *         The character sequence from which the new character buffer is to</span></span>
<span id="LC482" class="line" lang="java"><span class="cm">     *         be created</span></span>
<span id="LC483" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC484" class="line" lang="java"><span class="cm">     * @return  The new character buffer</span></span>
<span id="LC485" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC486" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="nc">CharBuffer</span> <span class="nf">wrap</span><span class="o">(</span><span class="nc">CharSequence</span> <span class="n">csq</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC487" class="line" lang="java">        <span class="k">return</span> <span class="nf">wrap</span><span class="o">(</span><span class="n">csq</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">csq</span><span class="o">.</span><span class="na">length</span><span class="o">());</span></span>
...
<span id="LC493" class="line" lang="java"><span class="cm">     * Creates a new char buffer whose content is a shared subsequence of</span></span>
...
<span id="LC502" class="line" lang="java"><span class="cm">     * will be the number of chars remaining in this buffer, and its mark</span></span>
...
<span id="LC507" class="line" lang="java"><span class="cm">     * @return  The new char buffer</span></span>
<span id="LC508" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC509" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">CharBuffer</span> <span class="nf">slice</span><span class="o">();</span></span>
<span id="LC510" class="line" lang="java"></span>
<span id="LC511" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC512" class="line" lang="java"><span class="cm">     * Creates a new char buffer that shares this buffer's content.</span></span>
...
<span id="LC524" class="line" lang="java"><span class="cm">     * @return  The new char buffer</span></span>
<span id="LC525" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC526" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">CharBuffer</span> <span class="nf">duplicate</span><span class="o">();</span></span>
<span id="LC527" class="line" lang="java"></span>
<span id="LC528" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC529" class="line" lang="java"><span class="cm">     * Creates a new, read-only char buffer that shares this buffer's</span></span>
...
<span id="LC544" class="line" lang="java"><span class="cm">     * @return  The new, read-only char buffer</span></span>
<span id="LC545" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC546" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">CharBuffer</span> <span class="nf">asReadOnlyBuffer</span><span class="o">();</span></span>
...
<span id="LC552" class="line" lang="java"><span class="cm">     * Relative &lt;i&gt;get&lt;/i&gt; method.  Reads the char at this buffer's</span></span>
...
<span id="LC555" class="line" lang="java"><span class="cm">     * @return  The char at the buffer's current position</span></span>
...
<span id="LC560" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="kt">char</span> <span class="nf">get</span><span class="o">();</span></span>
...
<span id="LC565" class="line" lang="java"><span class="cm">     * &lt;p&gt; Writes the given char into this buffer at the current</span></span>
...
<span id="LC568" class="line" lang="java"><span class="cm">     * @param  c</span></span>
<span id="LC569" class="line" lang="java"><span class="cm">     *         The char to be written</span></span>
...
<span id="LC579" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">CharBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">char</span> <span class="n">c</span><span class="o">);</span></span>
<span id="LC580" class="line" lang="java"></span>
<span id="LC581" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC582" class="line" lang="java"><span class="cm">     * Absolute &lt;i&gt;get&lt;/i&gt; method.  Reads the char at the given</span></span>
...
<span id="LC586" class="line" lang="java"><span class="cm">     *         The index from which the char will be read</span></span>
<span id="LC587" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC588" class="line" lang="java"><span class="cm">     * @return  The char at the given index</span></span>
...
<span id="LC594" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="kt">char</span> <span class="nf">get</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">);</span></span>
...
<span id="LC598" class="line" lang="java"><span class="cm">     * Absolute &lt;i&gt;get&lt;/i&gt; method.  Reads the char at the given</span></span>
<span id="LC599" class="line" lang="java"><span class="cm">     * index without any validation of the index.</span></span>
<span id="LC600" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC601" class="line" lang="java"><span class="cm">     * @param  index</span></span>
<span id="LC602" class="line" lang="java"><span class="cm">     *         The index from which the char will be read</span></span>
<span id="LC603" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC604" class="line" lang="java"><span class="cm">     * @return  The char at the given index</span></span>
<span id="LC605" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC606" class="line" lang="java">    <span class="kd">abstract</span> <span class="kt">char</span> <span class="nf">getUnchecked</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">);</span>   <span class="c1">// package-private</span></span>
...
<span id="LC612" class="line" lang="java"><span class="cm">     * &lt;p&gt; Writes the given char into this buffer at the given</span></span>
...
<span id="LC616" class="line" lang="java"><span class="cm">     *         The index at which the char will be written</span></span>
<span id="LC617" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC618" class="line" lang="java"><span class="cm">     * @param  c</span></span>
<span id="LC619" class="line" lang="java"><span class="cm">     *         The char value to be written</span></span>
...
<span id="LC630" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">CharBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">,</span> <span class="kt">char</span> <span class="n">c</span><span class="o">);</span></span>
...
<span id="LC638" class="line" lang="java"><span class="cm">     * &lt;p&gt; This method transfers chars from this buffer into the given</span></span>
<span id="LC639" class="line" lang="java"><span class="cm">     * destination array.  If there are fewer chars remaining in the</span></span>
...
<span id="LC642" class="line" lang="java"><span class="cm">     * chars are transferred and a {@link BufferUnderflowException} is</span></span>
...
<span id="LC645" class="line" lang="java"><span class="cm">     * &lt;p&gt; Otherwise, this method copies &lt;tt&gt;length&lt;/tt&gt; chars from this</span></span>
...
<span id="LC659" class="line" lang="java"><span class="cm">     * except that it first checks that there are sufficient chars in</span></span>
...
<span id="LC663" class="line" lang="java"><span class="cm">     *         The array into which chars are to be written</span></span>
...
<span id="LC666" class="line" lang="java"><span class="cm">     *         The offset within the array of the first char to be</span></span>
...
<span id="LC671" class="line" lang="java"><span class="cm">     *         The maximum number of chars to be written to the given</span></span>
...
<span id="LC678" class="line" lang="java"><span class="cm">     *          If there are fewer than &lt;tt&gt;length&lt;/tt&gt; chars</span></span>
...
<span id="LC685" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">get</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">dst</span><span class="o">,</span> <span class="kt">int</span> <span class="n">offset</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC698" class="line" lang="java"><span class="cm">     * &lt;p&gt; This method transfers chars from this buffer into the given</span></span>
...
<span id="LC711" class="line" lang="java"><span class="cm">     *          If there are fewer than &lt;tt&gt;length&lt;/tt&gt; chars</span></span>
...
<span id="LC714" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">get</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">dst</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC724" class="line" lang="java"><span class="cm">     * &lt;p&gt; This method transfers the chars remaining in the given source</span></span>
<span id="LC725" class="line" lang="java"><span class="cm">     * buffer into this buffer.  If there are more chars remaining in the</span></span>
...
<span id="LC728" class="line" lang="java"><span class="cm">     * then no chars are transferred and a {@link</span></span>
...
<span id="LC732" class="line" lang="java"><span class="cm">     * &lt;i&gt;n&lt;/i&gt;&amp;nbsp;=&amp;nbsp;&lt;tt&gt;src.remaining()&lt;/tt&gt; chars from the given</span></span>
...
<span id="LC747" class="line" lang="java"><span class="cm">     *         The source buffer from which chars are to be read;</span></span>
...
<span id="LC754" class="line" lang="java"><span class="cm">     *          for the remaining chars in the source buffer</span></span>
...
<span id="LC762" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="nc">CharBuffer</span> <span class="n">src</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC778" class="line" lang="java"><span class="cm">     * &lt;p&gt; This method transfers chars into this buffer from the given</span></span>
<span id="LC779" class="line" lang="java"><span class="cm">     * source array.  If there are more chars to be copied from the array</span></span>
...
<span id="LC782" class="line" lang="java"><span class="cm">     * chars are transferred and a {@link BufferOverflowException} is</span></span>
...
<span id="LC785" class="line" lang="java"><span class="cm">     * &lt;p&gt; Otherwise, this method copies &lt;tt&gt;length&lt;/tt&gt; chars from the</span></span>
...
<span id="LC803" class="line" lang="java"><span class="cm">     *         The array from which chars are to be read</span></span>
...
<span id="LC806" class="line" lang="java"><span class="cm">     *         The offset within the array of the first char to be read;</span></span>
...
<span id="LC810" class="line" lang="java"><span class="cm">     *         The number of chars to be read from the given array;</span></span>
...
<span id="LC826" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">src</span><span class="o">,</span> <span class="kt">int</span> <span class="n">offset</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC840" class="line" lang="java"><span class="cm">     * char array into this buffer.  An invocation of this method of the</span></span>
...
<span id="LC858" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="nc">CharBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">src</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC865" class="line" lang="java"><span class="cm">     * Relative bulk &lt;i&gt;put&lt;/i&gt; method&amp;nbsp;&amp;nbsp;&lt;i&gt;(optional operation)&lt;/i&gt;.</span></span>
<span id="LC866" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC867" class="line" lang="java"><span class="cm">     * &lt;p&gt; This method transfers chars from the given string into this</span></span>
<span id="LC868" class="line" lang="java"><span class="cm">     * buffer.  If there are more chars to be copied from the string than</span></span>
<span id="LC869" class="line" lang="java"><span class="cm">     * remain in this buffer, that is, if</span></span>
<span id="LC870" class="line" lang="java"><span class="cm">     * &lt;tt&gt;end&amp;nbsp;-&amp;nbsp;start&lt;/tt&gt;&amp;nbsp;&lt;tt&gt;&amp;gt;&lt;/tt&gt;&amp;nbsp;&lt;tt&gt;remaining()&lt;/tt&gt;,</span></span>
<span id="LC871" class="line" lang="java"><span class="cm">     * then no chars are transferred and a {@link</span></span>
<span id="LC872" class="line" lang="java"><span class="cm">     * BufferOverflowException} is thrown.</span></span>
<span id="LC873" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC874" class="line" lang="java"><span class="cm">     * &lt;p&gt; Otherwise, this method copies</span></span>
<span id="LC875" class="line" lang="java"><span class="cm">     * &lt;i&gt;n&lt;/i&gt;&amp;nbsp;=&amp;nbsp;&lt;tt&gt;end&lt;/tt&gt;&amp;nbsp;-&amp;nbsp;&lt;tt&gt;start&lt;/tt&gt; chars</span></span>
<span id="LC876" class="line" lang="java"><span class="cm">     * from the given string into this buffer, starting at the given</span></span>
<span id="LC877" class="line" lang="java"><span class="cm">     * &lt;tt&gt;start&lt;/tt&gt; index and at the current position of this buffer.  The</span></span>
<span id="LC878" class="line" lang="java"><span class="cm">     * position of this buffer is then incremented by &lt;i&gt;n&lt;/i&gt;.</span></span>
<span id="LC879" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC880" class="line" lang="java"><span class="cm">     * &lt;p&gt; In other words, an invocation of this method of the form</span></span>
<span id="LC881" class="line" lang="java"><span class="cm">     * &lt;tt&gt;dst.put(src,&amp;nbsp;start,&amp;nbsp;end)&lt;/tt&gt; has exactly the same effect</span></span>
<span id="LC882" class="line" lang="java"><span class="cm">     * as the loop</span></span>
<span id="LC883" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC884" class="line" lang="java"><span class="cm">     * &lt;pre&gt;{@code</span></span>
<span id="LC885" class="line" lang="java"><span class="cm">     *     for (int i = start; i &lt; end; i++)</span></span>
<span id="LC886" class="line" lang="java"><span class="cm">     *         dst.put(src.charAt(i));</span></span>
<span id="LC887" class="line" lang="java"><span class="cm">     * }&lt;/pre&gt;</span></span>
<span id="LC888" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC889" class="line" lang="java"><span class="cm">     * except that it first checks that there is sufficient space in this</span></span>
<span id="LC890" class="line" lang="java"><span class="cm">     * buffer and it is potentially much more efficient.</span></span>
<span id="LC891" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC892" class="line" lang="java"><span class="cm">     * @param  src</span></span>
<span id="LC893" class="line" lang="java"><span class="cm">     *         The string from which chars are to be read</span></span>
<span id="LC894" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC895" class="line" lang="java"><span class="cm">     * @param  start</span></span>
<span id="LC896" class="line" lang="java"><span class="cm">     *         The offset within the string of the first char to be read;</span></span>
<span id="LC897" class="line" lang="java"><span class="cm">     *         must be non-negative and no larger than</span></span>
<span id="LC898" class="line" lang="java"><span class="cm">     *         &lt;tt&gt;string.length()&lt;/tt&gt;</span></span>
<span id="LC899" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC900" class="line" lang="java"><span class="cm">     * @param  end</span></span>
<span id="LC901" class="line" lang="java"><span class="cm">     *         The offset within the string of the last char to be read,</span></span>
<span id="LC902" class="line" lang="java"><span class="cm">     *         plus one; must be non-negative and no larger than</span></span>
<span id="LC903" class="line" lang="java"><span class="cm">     *         &lt;tt&gt;string.length()&lt;/tt&gt;</span></span>
<span id="LC904" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC905" class="line" lang="java"><span class="cm">     * @return  This buffer</span></span>
<span id="LC906" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC907" class="line" lang="java"><span class="cm">     * @throws  BufferOverflowException</span></span>
<span id="LC908" class="line" lang="java"><span class="cm">     *          If there is insufficient space in this buffer</span></span>
<span id="LC909" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC910" class="line" lang="java"><span class="cm">     * @throws  IndexOutOfBoundsException</span></span>
<span id="LC911" class="line" lang="java"><span class="cm">     *          If the preconditions on the &lt;tt&gt;start&lt;/tt&gt; and &lt;tt&gt;end&lt;/tt&gt;</span></span>
<span id="LC912" class="line" lang="java"><span class="cm">     *          parameters do not hold</span></span>
<span id="LC913" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC914" class="line" lang="java"><span class="cm">     * @throws  ReadOnlyBufferException</span></span>
<span id="LC915" class="line" lang="java"><span class="cm">     *          If this buffer is read-only</span></span>
<span id="LC916" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC917" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="nc">String</span> <span class="n">src</span><span class="o">,</span> <span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">end</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC918" class="line" lang="java">        <span class="n">checkBounds</span><span class="o">(</span><span class="n">start</span><span class="o">,</span> <span class="n">end</span> <span class="o">-</span> <span class="n">start</span><span class="o">,</span> <span class="n">src</span><span class="o">.</span><span class="na">length</span><span class="o">());</span></span>
<span id="LC919" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">isReadOnly</span><span class="o">())</span></span>
<span id="LC920" class="line" lang="java">            <span class="k">throw</span> <span class="k">new</span> <span class="nf">ReadOnlyBufferException</span><span class="o">();</span></span>
<span id="LC921" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">end</span> <span class="o">-</span> <span class="n">start</span> <span class="o">&gt;</span> <span class="n">remaining</span><span class="o">())</span></span>
<span id="LC922" class="line" lang="java">            <span class="k">throw</span> <span class="k">new</span> <span class="nf">BufferOverflowException</span><span class="o">();</span></span>
<span id="LC923" class="line" lang="java">        <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="n">start</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">end</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC924" class="line" lang="java">            <span class="k">this</span><span class="o">.</span><span class="na">put</span><span class="o">(</span><span class="n">src</span><span class="o">.</span><span class="na">charAt</span><span class="o">(</span><span class="n">i</span><span class="o">));</span></span>
<span id="LC925" class="line" lang="java">        <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC929" class="line" lang="java"><span class="cm">     * Relative bulk &lt;i&gt;put&lt;/i&gt; method&amp;nbsp;&amp;nbsp;&lt;i&gt;(optional operation)&lt;/i&gt;.</span></span>
<span id="LC930" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC931" class="line" lang="java"><span class="cm">     * &lt;p&gt; This method transfers the entire content of the given source string</span></span>
<span id="LC932" class="line" lang="java"><span class="cm">     * into this buffer.  An invocation of this method of the form</span></span>
<span id="LC933" class="line" lang="java"><span class="cm">     * &lt;tt&gt;dst.put(s)&lt;/tt&gt; behaves in exactly the same way as the invocation</span></span>
<span id="LC934" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC935" class="line" lang="java"><span class="cm">     * &lt;pre&gt;</span></span>
<span id="LC936" class="line" lang="java"><span class="cm">     *     dst.put(s, 0, s.length()) &lt;/pre&gt;</span></span>
<span id="LC937" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC938" class="line" lang="java"><span class="cm">     * @param   src</span></span>
<span id="LC939" class="line" lang="java"><span class="cm">     *          The source string</span></span>
<span id="LC940" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC941" class="line" lang="java"><span class="cm">     * @return  This buffer</span></span>
<span id="LC942" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC943" class="line" lang="java"><span class="cm">     * @throws  BufferOverflowException</span></span>
<span id="LC944" class="line" lang="java"><span class="cm">     *          If there is insufficient space in this buffer</span></span>
<span id="LC945" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC946" class="line" lang="java"><span class="cm">     * @throws  ReadOnlyBufferException</span></span>
<span id="LC947" class="line" lang="java"><span class="cm">     *          If this buffer is read-only</span></span>
<span id="LC948" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC949" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="nc">CharBuffer</span> <span class="nf">put</span><span class="o">(</span><span class="nc">String</span> <span class="n">src</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC950" class="line" lang="java">        <span class="k">return</span> <span class="nf">put</span><span class="o">(</span><span class="n">src</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">src</span><span class="o">.</span><span class="na">length</span><span class="o">());</span></span>
...
<span id="LC959" class="line" lang="java"><span class="cm">     * Tells whether or not this buffer is backed by an accessible char</span></span>
...
<span id="LC974" class="line" lang="java"><span class="cm">     * Returns the char array that backs this</span></span>
...
<span id="LC992" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="kt">char</span><span class="o">[]</span> <span class="nf">array</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC1031" class="line" lang="java"><span class="cm">     * &lt;p&gt; The chars between the buffer's current position and its limit,</span></span>
<span id="LC1032" class="line" lang="java"><span class="cm">     * if any, are copied to the beginning of the buffer.  That is, the</span></span>
<span id="LC1033" class="line" lang="java"><span class="cm">     * char at index &lt;i&gt;p&lt;/i&gt;&amp;nbsp;=&amp;nbsp;&lt;tt&gt;position()&lt;/tt&gt; is copied</span></span>
<span id="LC1034" class="line" lang="java"><span class="cm">     * to index zero, the char at index &lt;i&gt;p&lt;/i&gt;&amp;nbsp;+&amp;nbsp;1 is copied</span></span>
<span id="LC1035" class="line" lang="java"><span class="cm">     * to index one, and so forth until the char at index</span></span>
...
<span id="LC1041" class="line" lang="java"><span class="cm">     * &lt;p&gt; The buffer's position is set to the number of chars copied,</span></span>
...
<span id="LC1068" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">CharBuffer</span> <span class="nf">compact</span><span class="o">();</span></span>
<span id="LC1069" class="line" lang="java"></span>
<span id="LC1070" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1071" class="line" lang="java"><span class="cm">     * Tells whether or not this char buffer is direct.</span></span>
...
<span id="LC1105" class="line" lang="java"><span class="cm">     * &lt;p&gt; The hash code of a char buffer depends only upon its remaining</span></span>
...
<span id="LC1130" class="line" lang="java"><span class="cm">     * &lt;p&gt; Two char buffers are equal if, and only if,</span></span>
...
<span id="LC1152" class="line" lang="java"><span class="cm">     * &lt;p&gt; A char buffer is not equal to any other type of object.  &lt;/p&gt;</span></span>
...
<span id="LC1162" class="line" lang="java">        <span class="k">if</span> <span class="o">(!(</span><span class="n">ob</span> <span class="k">instanceof</span> <span class="nc">CharBuffer</span><span class="o">))</span></span>
<span id="LC1163" class="line" lang="java">            <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1164" class="line" lang="java">        <span class="nc">CharBuffer</span> <span class="n">that</span> <span class="o">=</span> <span class="o">(</span><span class="nc">CharBuffer</span><span class="o">)</span><span class="n">ob</span><span class="o">;</span></span>
...
<span id="LC1174" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="kt">boolean</span> <span class="nf">equals</span><span class="o">(</span><span class="kt">char</span> <span class="n">x</span><span class="o">,</span> <span class="kt">char</span> <span class="n">y</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC1185" class="line" lang="java"><span class="cm">     * &lt;p&gt; Two char buffers are compared by comparing their sequences of</span></span>
...
<span id="LC1196" class="line" lang="java"><span class="cm">     * Pairs of {@code char} elements are compared as if by invoking</span></span>
<span id="LC1197" class="line" lang="java"><span class="cm">     * {@link Character#compare(char,char)}.</span></span>
<span id="LC1198" class="line" lang="java"></span>
<span id="LC1199" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1200" class="line" lang="java"><span class="cm">     * &lt;p&gt; A char buffer is not comparable to any other type of object.</span></span>
...
<span id="LC1205" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">compareTo</span><span class="o">(</span><span class="nc">CharBuffer</span> <span class="n">that</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC1215" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="kt">int</span> <span class="nf">compare</span><span class="o">(</span><span class="kt">char</span> <span class="n">x</span><span class="o">,</span> <span class="kt">char</span> <span class="n">y</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC1222" class="line" lang="java">        <span class="k">return</span> <span class="nc">Character</span><span class="o">.</span><span class="na">compare</span><span class="o">(</span><span class="n">x</span><span class="o">,</span> <span class="n">y</span><span class="o">);</span></span>
...
<span id="LC1231" class="line" lang="java"><span class="cm">     * Returns a string containing the characters in this buffer.</span></span>
<span id="LC1232" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1233" class="line" lang="java"><span class="cm">     * &lt;p&gt; The first character of the resulting string will be the character at</span></span>
<span id="LC1234" class="line" lang="java"><span class="cm">     * this buffer's position, while the last character will be the character</span></span>
<span id="LC1235" class="line" lang="java"><span class="cm">     * at index &lt;tt&gt;limit()&lt;/tt&gt;&amp;nbsp;-&amp;nbsp;1.  Invoking this method does not</span></span>
<span id="LC1236" class="line" lang="java"><span class="cm">     * change the buffer's position. &lt;/p&gt;</span></span>
<span id="LC1237" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1238" class="line" lang="java"><span class="cm">     * @return  The specified string</span></span>
...
<span id="LC1241" class="line" lang="java">        <span class="k">return</span> <span class="nf">toString</span><span class="o">(</span><span class="n">position</span><span class="o">(),</span> <span class="n">limit</span><span class="o">());</span></span>
<span id="LC1242" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1243" class="line" lang="java"></span>
<span id="LC1244" class="line" lang="java">    <span class="kd">abstract</span> <span class="nc">String</span> <span class="nf">toString</span><span class="o">(</span><span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">end</span><span class="o">);</span>       <span class="c1">// package-private</span></span>
<span id="LC1245" class="line" lang="java"></span>
<span id="LC1246" class="line" lang="java"></span>
<span id="LC1247" class="line" lang="java">    <span class="c1">// --- Methods to support CharSequence ---</span></span>
<span id="LC1248" class="line" lang="java"></span>
<span id="LC1249" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1250" class="line" lang="java"><span class="cm">     * Returns the length of this character buffer.</span></span>
<span id="LC1251" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1252" class="line" lang="java"><span class="cm">     * &lt;p&gt; When viewed as a character sequence, the length of a character</span></span>
<span id="LC1253" class="line" lang="java"><span class="cm">     * buffer is simply the number of characters between the position</span></span>
<span id="LC1254" class="line" lang="java"><span class="cm">     * (inclusive) and the limit (exclusive); that is, it is equivalent to</span></span>
<span id="LC1255" class="line" lang="java"><span class="cm">     * &lt;tt&gt;remaining()&lt;/tt&gt;. &lt;/p&gt;</span></span>
<span id="LC1256" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1257" class="line" lang="java"><span class="cm">     * @return  The length of this character buffer</span></span>
<span id="LC1258" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1259" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nf">length</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC1260" class="line" lang="java">        <span class="k">return</span> <span class="nf">remaining</span><span class="o">();</span></span>
...
<span id="LC1264" class="line" lang="java"><span class="cm">     * Reads the character at the given index relative to the current</span></span>
<span id="LC1265" class="line" lang="java"><span class="cm">     * position.</span></span>
<span id="LC1266" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1267" class="line" lang="java"><span class="cm">     * @param  index</span></span>
<span id="LC1268" class="line" lang="java"><span class="cm">     *         The index of the character to be read, relative to the position;</span></span>
<span id="LC1269" class="line" lang="java"><span class="cm">     *         must be non-negative and smaller than &lt;tt&gt;remaining()&lt;/tt&gt;</span></span>
<span id="LC1270" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1271" class="line" lang="java"><span class="cm">     * @return  The character at index</span></span>
<span id="LC1272" class="line" lang="java"><span class="cm">     *          &lt;tt&gt;position()&amp;nbsp;+&amp;nbsp;index&lt;/tt&gt;</span></span>
<span id="LC1273" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1274" class="line" lang="java"><span class="cm">     * @throws  IndexOutOfBoundsException</span></span>
<span id="LC1275" class="line" lang="java"><span class="cm">     *          If the preconditions on &lt;tt&gt;index&lt;/tt&gt; do not hold</span></span>
<span id="LC1276" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1277" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="kt">char</span> <span class="nf">charAt</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1278" class="line" lang="java">        <span class="k">return</span> <span class="nf">get</span><span class="o">(</span><span class="n">position</span><span class="o">()</span> <span class="o">+</span> <span class="n">checkIndex</span><span class="o">(</span><span class="n">index</span><span class="o">,</span> <span class="mi">1</span><span class="o">));</span></span>
...
<span id="LC1282" class="line" lang="java"><span class="cm">     * Creates a new character buffer that represents the specified subsequence</span></span>
<span id="LC1283" class="line" lang="java"><span class="cm">     * of this buffer, relative to the current position.</span></span>
<span id="LC1284" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1285" class="line" lang="java"><span class="cm">     * &lt;p&gt; The new buffer will share this buffer's content; that is, if the</span></span>
<span id="LC1286" class="line" lang="java"><span class="cm">     * content of this buffer is mutable then modifications to one buffer will</span></span>
<span id="LC1287" class="line" lang="java"><span class="cm">     * cause the other to be modified.  The new buffer's capacity will be that</span></span>
<span id="LC1288" class="line" lang="java"><span class="cm">     * of this buffer, its position will be</span></span>
<span id="LC1289" class="line" lang="java"><span class="cm">     * &lt;tt&gt;position()&lt;/tt&gt;&amp;nbsp;+&amp;nbsp;&lt;tt&gt;start&lt;/tt&gt;, and its limit will be</span></span>
<span id="LC1290" class="line" lang="java"><span class="cm">     * &lt;tt&gt;position()&lt;/tt&gt;&amp;nbsp;+&amp;nbsp;&lt;tt&gt;end&lt;/tt&gt;.  The new buffer will be</span></span>
<span id="LC1291" class="line" lang="java"><span class="cm">     * direct if, and only if, this buffer is direct, and it will be read-only</span></span>
<span id="LC1292" class="line" lang="java"><span class="cm">     * if, and only if, this buffer is read-only.  &lt;/p&gt;</span></span>
<span id="LC1293" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1294" class="line" lang="java"><span class="cm">     * @param  start</span></span>
<span id="LC1295" class="line" lang="java"><span class="cm">     *         The index, relative to the current position, of the first</span></span>
<span id="LC1296" class="line" lang="java"><span class="cm">     *         character in the subsequence; must be non-negative and no larger</span></span>
<span id="LC1297" class="line" lang="java"><span class="cm">     *         than &lt;tt&gt;remaining()&lt;/tt&gt;</span></span>
<span id="LC1298" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1299" class="line" lang="java"><span class="cm">     * @param  end</span></span>
<span id="LC1300" class="line" lang="java"><span class="cm">     *         The index, relative to the current position, of the character</span></span>
<span id="LC1301" class="line" lang="java"><span class="cm">     *         following the last character in the subsequence; must be no</span></span>
<span id="LC1302" class="line" lang="java"><span class="cm">     *         smaller than &lt;tt&gt;start&lt;/tt&gt; and no larger than</span></span>
<span id="LC1303" class="line" lang="java"><span class="cm">     *         &lt;tt&gt;remaining()&lt;/tt&gt;</span></span>
<span id="LC1304" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1305" class="line" lang="java"><span class="cm">     * @return  The new character buffer</span></span>
<span id="LC1306" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1307" class="line" lang="java"><span class="cm">     * @throws  IndexOutOfBoundsException</span></span>
<span id="LC1308" class="line" lang="java"><span class="cm">     *          If the preconditions on &lt;tt&gt;start&lt;/tt&gt; and &lt;tt&gt;end&lt;/tt&gt;</span></span>
<span id="LC1309" class="line" lang="java"><span class="cm">     *          do not hold</span></span>
<span id="LC1310" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1311" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">CharBuffer</span> <span class="nf">subSequence</span><span class="o">(</span><span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">end</span><span class="o">);</span></span>
<span id="LC1312" class="line" lang="java"></span>
<span id="LC1313" class="line" lang="java"></span>
<span id="LC1314" class="line" lang="java">    <span class="c1">// --- Methods to support Appendable ---</span></span>
<span id="LC1315" class="line" lang="java"></span>
<span id="LC1316" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1317" class="line" lang="java"><span class="cm">     * Appends the specified character sequence  to this</span></span>
<span id="LC1318" class="line" lang="java"><span class="cm">     * buffer&amp;nbsp;&amp;nbsp;&lt;i&gt;(optional operation)&lt;/i&gt;.</span></span>
<span id="LC1319" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1320" class="line" lang="java"><span class="cm">     * &lt;p&gt; An invocation of this method of the form &lt;tt&gt;dst.append(csq)&lt;/tt&gt;</span></span>
<span id="LC1321" class="line" lang="java"><span class="cm">     * behaves in exactly the same way as the invocation</span></span>
<span id="LC1322" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1323" class="line" lang="java"><span class="cm">     * &lt;pre&gt;</span></span>
<span id="LC1324" class="line" lang="java"><span class="cm">     *     dst.put(csq.toString()) &lt;/pre&gt;</span></span>
<span id="LC1325" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1326" class="line" lang="java"><span class="cm">     * &lt;p&gt; Depending on the specification of &lt;tt&gt;toString&lt;/tt&gt; for the</span></span>
<span id="LC1327" class="line" lang="java"><span class="cm">     * character sequence &lt;tt&gt;csq&lt;/tt&gt;, the entire sequence may not be</span></span>
<span id="LC1328" class="line" lang="java"><span class="cm">     * appended.  For instance, invoking the {@link CharBuffer#toString()</span></span>
<span id="LC1329" class="line" lang="java"><span class="cm">     * toString} method of a character buffer will return a subsequence whose</span></span>
<span id="LC1330" class="line" lang="java"><span class="cm">     * content depends upon the buffer's position and limit.</span></span>
<span id="LC1331" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1332" class="line" lang="java"><span class="cm">     * @param  csq</span></span>
<span id="LC1333" class="line" lang="java"><span class="cm">     *         The character sequence to append.  If &lt;tt&gt;csq&lt;/tt&gt; is</span></span>
<span id="LC1334" class="line" lang="java"><span class="cm">     *         &lt;tt&gt;null&lt;/tt&gt;, then the four characters &lt;tt&gt;"null"&lt;/tt&gt; are</span></span>
<span id="LC1335" class="line" lang="java"><span class="cm">     *         appended to this character buffer.</span></span>
<span id="LC1336" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1337" class="line" lang="java"><span class="cm">     * @return  This buffer</span></span>
<span id="LC1338" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1339" class="line" lang="java"><span class="cm">     * @throws  BufferOverflowException</span></span>
<span id="LC1340" class="line" lang="java"><span class="cm">     *          If there is insufficient space in this buffer</span></span>
<span id="LC1341" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1342" class="line" lang="java"><span class="cm">     * @throws  ReadOnlyBufferException</span></span>
<span id="LC1343" class="line" lang="java"><span class="cm">     *          If this buffer is read-only</span></span>
<span id="LC1344" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1345" class="line" lang="java"><span class="cm">     * @since  1.5</span></span>
<span id="LC1346" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1347" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">append</span><span class="o">(</span><span class="nc">CharSequence</span> <span class="n">csq</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1348" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">csq</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1349" class="line" lang="java">            <span class="k">return</span> <span class="nf">put</span><span class="o">(</span><span class="s">"null"</span><span class="o">);</span></span>
<span id="LC1350" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC1351" class="line" lang="java">            <span class="k">return</span> <span class="nf">put</span><span class="o">(</span><span class="n">csq</span><span class="o">.</span><span class="na">toString</span><span class="o">());</span></span>
...
<span id="LC1355" class="line" lang="java"><span class="cm">     * Appends a subsequence of the  specified character sequence  to this</span></span>
<span id="LC1356" class="line" lang="java"><span class="cm">     * buffer&amp;nbsp;&amp;nbsp;&lt;i&gt;(optional operation)&lt;/i&gt;.</span></span>
<span id="LC1357" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1358" class="line" lang="java"><span class="cm">     * &lt;p&gt; An invocation of this method of the form &lt;tt&gt;dst.append(csq, start,</span></span>
<span id="LC1359" class="line" lang="java"><span class="cm">     * end)&lt;/tt&gt; when &lt;tt&gt;csq&lt;/tt&gt; is not &lt;tt&gt;null&lt;/tt&gt;, behaves in exactly the</span></span>
<span id="LC1360" class="line" lang="java"><span class="cm">     * same way as the invocation</span></span>
<span id="LC1361" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1362" class="line" lang="java"><span class="cm">     * &lt;pre&gt;</span></span>
<span id="LC1363" class="line" lang="java"><span class="cm">     *     dst.put(csq.subSequence(start, end).toString()) &lt;/pre&gt;</span></span>
<span id="LC1364" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1365" class="line" lang="java"><span class="cm">     * @param  csq</span></span>
<span id="LC1366" class="line" lang="java"><span class="cm">     *         The character sequence from which a subsequence will be</span></span>
<span id="LC1367" class="line" lang="java"><span class="cm">     *         appended.  If &lt;tt&gt;csq&lt;/tt&gt; is &lt;tt&gt;null&lt;/tt&gt;, then characters</span></span>
<span id="LC1368" class="line" lang="java"><span class="cm">     *         will be appended as if &lt;tt&gt;csq&lt;/tt&gt; contained the four</span></span>
<span id="LC1369" class="line" lang="java"><span class="cm">     *         characters &lt;tt&gt;"null"&lt;/tt&gt;.</span></span>
<span id="LC1370" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1371" class="line" lang="java"><span class="cm">     * @return  This buffer</span></span>
<span id="LC1372" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1373" class="line" lang="java"><span class="cm">     * @throws  BufferOverflowException</span></span>
<span id="LC1374" class="line" lang="java"><span class="cm">     *          If there is insufficient space in this buffer</span></span>
<span id="LC1375" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1376" class="line" lang="java"><span class="cm">     * @throws  IndexOutOfBoundsException</span></span>
<span id="LC1377" class="line" lang="java"><span class="cm">     *          If &lt;tt&gt;start&lt;/tt&gt; or &lt;tt&gt;end&lt;/tt&gt; are negative, &lt;tt&gt;start&lt;/tt&gt;</span></span>
<span id="LC1378" class="line" lang="java"><span class="cm">     *          is greater than &lt;tt&gt;end&lt;/tt&gt;, or &lt;tt&gt;end&lt;/tt&gt; is greater than</span></span>
<span id="LC1379" class="line" lang="java"><span class="cm">     *          &lt;tt&gt;csq.length()&lt;/tt&gt;</span></span>
<span id="LC1380" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1381" class="line" lang="java"><span class="cm">     * @throws  ReadOnlyBufferException</span></span>
<span id="LC1382" class="line" lang="java"><span class="cm">     *          If this buffer is read-only</span></span>
<span id="LC1383" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1384" class="line" lang="java"><span class="cm">     * @since  1.5</span></span>
<span id="LC1385" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1386" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">append</span><span class="o">(</span><span class="nc">CharSequence</span> <span class="n">csq</span><span class="o">,</span> <span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">end</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1387" class="line" lang="java">        <span class="nc">CharSequence</span> <span class="n">cs</span> <span class="o">=</span> <span class="o">(</span><span class="n">csq</span> <span class="o">==</span> <span class="kc">null</span> <span class="o">?</span> <span class="s">"null"</span> <span class="o">:</span> <span class="n">csq</span><span class="o">);</span></span>
<span id="LC1388" class="line" lang="java">        <span class="k">return</span> <span class="nf">put</span><span class="o">(</span><span class="n">cs</span><span class="o">.</span><span class="na">subSequence</span><span class="o">(</span><span class="n">start</span><span class="o">,</span> <span class="n">end</span><span class="o">).</span><span class="na">toString</span><span class="o">());</span></span>
...
<span id="LC1392" class="line" lang="java"><span class="cm">     * Appends the specified char  to this</span></span>
<span id="LC1393" class="line" lang="java"><span class="cm">     * buffer&amp;nbsp;&amp;nbsp;&lt;i&gt;(optional operation)&lt;/i&gt;.</span></span>
<span id="LC1394" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1395" class="line" lang="java"><span class="cm">     * &lt;p&gt; An invocation of this method of the form &lt;tt&gt;dst.append(c)&lt;/tt&gt;</span></span>
<span id="LC1396" class="line" lang="java"><span class="cm">     * behaves in exactly the same way as the invocation</span></span>
...
<span id="LC1399" class="line" lang="java"><span class="cm">     *     dst.put(c) &lt;/pre&gt;</span></span>
<span id="LC1400" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1401" class="line" lang="java"><span class="cm">     * @param  c</span></span>
<span id="LC1402" class="line" lang="java"><span class="cm">     *         The 16-bit char to append</span></span>
<span id="LC1403" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1404" class="line" lang="java"><span class="cm">     * @return  This buffer</span></span>
<span id="LC1405" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1406" class="line" lang="java"><span class="cm">     * @throws  BufferOverflowException</span></span>
<span id="LC1407" class="line" lang="java"><span class="cm">     *          If there is insufficient space in this buffer</span></span>
<span id="LC1408" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1409" class="line" lang="java"><span class="cm">     * @throws  ReadOnlyBufferException</span></span>
<span id="LC1410" class="line" lang="java"><span class="cm">     *          If this buffer is read-only</span></span>
<span id="LC1411" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1412" class="line" lang="java"><span class="cm">     * @since  1.5</span></span>
<span id="LC1413" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1414" class="line" lang="java">    <span class="kd">public</span> <span class="nc">CharBuffer</span> <span class="nf">append</span><span class="o">(</span><span class="kt">char</span> <span class="n">c</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1415" class="line" lang="java">        <span class="k">return</span> <span class="nf">put</span><span class="o">(</span><span class="n">c</span><span class="o">);</span></span>
...
<span id="LC1426" class="line" lang="java"><span class="cm">     * Retrieves this buffer's byte order.</span></span>
<span id="LC1427" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1428" class="line" lang="java"><span class="cm">     * &lt;p&gt; The byte order of a char buffer created by allocation or by</span></span>
<span id="LC1429" class="line" lang="java"><span class="cm">     * wrapping an existing &lt;tt&gt;char&lt;/tt&gt; array is the {@link</span></span>
<span id="LC1430" class="line" lang="java"><span class="cm">     * ByteOrder#nativeOrder native order} of the underlying</span></span>
<span id="LC1431" class="line" lang="java"><span class="cm">     * hardware.  The byte order of a char buffer created as a &lt;a</span></span>
<span id="LC1432" class="line" lang="java"><span class="cm">     * href="ByteBuffer.html#views"&gt;view&lt;/a&gt; of a byte buffer is that of the</span></span>
<span id="LC1433" class="line" lang="java"><span class="cm">     * byte buffer at the moment that the view is created.  &lt;/p&gt;</span></span>
<span id="LC1434" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1435" class="line" lang="java"><span class="cm">     * @return  This buffer's byte order</span></span>
<span id="LC1436" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1437" class="line" lang="java">    <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">ByteOrder</span> <span class="nf">order</span><span class="o">();</span></span>
...
<span id="LC1494" class="line" lang="java">    <span class="nd">@Override</span></span>
<span id="LC1495" class="line" lang="java"></span>
<span id="LC1496" class="line" lang="java">    <span class="kd">public</span> <span class="nc">IntStream</span> <span class="nf">chars</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC1497" class="line" lang="java">        <span class="k">return</span> <span class="nc">StreamSupport</span><span class="o">.</span><span class="na">intStream</span><span class="o">(()</span> <span class="o">-&gt;</span> <span class="k">new</span> <span class="nc">CharBufferSpliterator</span><span class="o">(</span><span class="k">this</span><span class="o">),</span></span>
<span id="LC1498" class="line" lang="java">            <span class="nc">Buffer</span><span class="o">.</span><span class="na">SPLITERATOR_CHARACTERISTICS</span><span class="o">,</span> <span class="kc">false</span><span class="o">);</span></span>
