...
<span id="LC27" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.awt.peer.MenuComponentPeer</span><span class="o">;</span></span>
<span id="LC28" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.awt.event.ActionEvent</span><span class="o">;</span></span>
...
<span id="LC32" class="line" lang="java"><span class="kn">import</span> <span class="nn">sun.awt.AWTAccessor</span><span class="o">;</span></span>
...
<span id="LC39" class="line" lang="java"><span class="cm"> * The abstract class &lt;code&gt;MenuComponent&lt;/code&gt; is the superclass</span></span>
<span id="LC40" class="line" lang="java"><span class="cm"> * of all menu-related components. In this respect, the class</span></span>
<span id="LC41" class="line" lang="java"><span class="cm"> * &lt;code&gt;MenuComponent&lt;/code&gt; is analogous to the abstract superclass</span></span>
<span id="LC42" class="line" lang="java"><span class="cm"> * &lt;code&gt;Component&lt;/code&gt; for AWT components.</span></span>
<span id="LC43" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC44" class="line" lang="java"><span class="cm"> * Menu components receive and process AWT events, just as components do,</span></span>
<span id="LC45" class="line" lang="java"><span class="cm"> * through the method &lt;code&gt;processEvent&lt;/code&gt;.</span></span>
...
<span id="LC48" class="line" lang="java"><span class="cm"> * @since       JDK1.0</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC50" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">MenuComponent</span> <span class="kd">implements</span> <span class="n">java</span><span class="o">.</span><span class="na">io</span><span class="o">.</span><span class="na">Serializable</span> <span class="o">{</span></span>
<span id="LC51" class="line" lang="java"></span>
<span id="LC52" class="line" lang="java">    <span class="kd">static</span> <span class="o">{</span></span>
<span id="LC53" class="line" lang="java">        <span class="cm">/* ensure that the necessary native libraries are loaded */</span></span>
<span id="LC54" class="line" lang="java">        <span class="nc">Toolkit</span><span class="o">.</span><span class="na">loadLibraries</span><span class="o">();</span></span>
<span id="LC55" class="line" lang="java">        <span class="k">if</span> <span class="o">(!</span><span class="nc">GraphicsEnvironment</span><span class="o">.</span><span class="na">isHeadless</span><span class="o">())</span> <span class="o">{</span></span>
<span id="LC56" class="line" lang="java">            <span class="n">initIDs</span><span class="o">();</span></span>
...
<span id="LC60" class="line" lang="java">    <span class="kd">transient</span> <span class="nc">MenuComponentPeer</span> <span class="n">peer</span><span class="o">;</span></span>
<span id="LC61" class="line" lang="java">    <span class="kd">transient</span> <span class="nc">MenuContainer</span> <span class="n">parent</span><span class="o">;</span></span>
<span id="LC62" class="line" lang="java"></span>
<span id="LC63" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC64" class="line" lang="java"><span class="cm">     * The &lt;code&gt;AppContext&lt;/code&gt; of the &lt;code&gt;MenuComponent&lt;/code&gt;.</span></span>
<span id="LC65" class="line" lang="java"><span class="cm">     * This is set in the constructor and never changes.</span></span>
<span id="LC66" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC67" class="line" lang="java">    <span class="kd">transient</span> <span class="nc">AppContext</span> <span class="n">appContext</span><span class="o">;</span></span>
<span id="LC68" class="line" lang="java"></span>
<span id="LC69" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">     * The menu component's font. This value can be</span></span>
<span id="LC71" class="line" lang="java"><span class="cm">     * &lt;code&gt;null&lt;/code&gt; at which point a default will be used.</span></span>
<span id="LC72" class="line" lang="java"><span class="cm">     * This defaults to &lt;code&gt;null&lt;/code&gt;.</span></span>
...
<span id="LC75" class="line" lang="java"><span class="cm">     * @see #setFont(Font)</span></span>
<span id="LC76" class="line" lang="java"><span class="cm">     * @see #getFont()</span></span>
<span id="LC77" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC78" class="line" lang="java">    <span class="kd">volatile</span> <span class="nc">Font</span> <span class="n">font</span><span class="o">;</span></span>
<span id="LC79" class="line" lang="java"></span>
<span id="LC80" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">     * The menu component's name, which defaults to &lt;code&gt;null&lt;/code&gt;.</span></span>
<span id="LC82" class="line" lang="java"><span class="cm">     * @serial</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">     * @see #getName()</span></span>
<span id="LC84" class="line" lang="java"><span class="cm">     * @see #setName(String)</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC86" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">name</span><span class="o">;</span></span>
<span id="LC87" class="line" lang="java"></span>
<span id="LC88" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">     * A variable to indicate whether a name is explicitly set.</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">     * If &lt;code&gt;true&lt;/code&gt; the name will be set explicitly.</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">     * This defaults to &lt;code&gt;false&lt;/code&gt;.</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">     * @serial</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">     * @see #setName(String)</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC95" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">nameExplicitlySet</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC96" class="line" lang="java"></span>
<span id="LC97" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC98" class="line" lang="java"><span class="cm">     * Defaults to &lt;code&gt;false&lt;/code&gt;.</span></span>
<span id="LC99" class="line" lang="java"><span class="cm">     * @serial</span></span>
<span id="LC100" class="line" lang="java"><span class="cm">     * @see #dispatchEvent(AWTEvent)</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC102" class="line" lang="java">    <span class="kt">boolean</span> <span class="n">newEventsOnly</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC103" class="line" lang="java"></span>
<span id="LC104" class="line" lang="java">    <span class="cm">/*</span></span>
<span id="LC105" class="line" lang="java"><span class="cm">     * The menu's AccessControlContext.</span></span>
<span id="LC106" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC107" class="line" lang="java">    <span class="kd">private</span> <span class="kd">transient</span> <span class="kd">volatile</span> <span class="nc">AccessControlContext</span> <span class="n">acc</span> <span class="o">=</span></span>
<span id="LC108" class="line" lang="java">            <span class="nc">AccessController</span><span class="o">.</span><span class="na">getContext</span><span class="o">();</span></span>
<span id="LC109" class="line" lang="java"></span>
<span id="LC110" class="line" lang="java">    <span class="cm">/*</span></span>
<span id="LC111" class="line" lang="java"><span class="cm">     * Returns the acc this menu component was constructed with.</span></span>
<span id="LC112" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC113" class="line" lang="java">    <span class="kd">final</span> <span class="nc">AccessControlContext</span> <span class="nf">getAccessControlContext</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC114" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">acc</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC115" class="line" lang="java">            <span class="k">throw</span> <span class="k">new</span> <span class="nf">SecurityException</span><span class="o">(</span></span>
<span id="LC116" class="line" lang="java">                    <span class="s">"MenuComponent is missing AccessControlContext"</span><span class="o">);</span></span>
<span id="LC117" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC118" class="line" lang="java">        <span class="k">return</span> <span class="n">acc</span><span class="o">;</span></span>
...
<span id="LC122" class="line" lang="java"><span class="cm">     * Internal constants for serialization.</span></span>
<span id="LC123" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC124" class="line" lang="java">    <span class="kd">final</span> <span class="kd">static</span> <span class="nc">String</span> <span class="n">actionListenerK</span> <span class="o">=</span> <span class="nc">Component</span><span class="o">.</span><span class="na">actionListenerK</span><span class="o">;</span></span>
<span id="LC125" class="line" lang="java">    <span class="kd">final</span> <span class="kd">static</span> <span class="nc">String</span> <span class="n">itemListenerK</span> <span class="o">=</span> <span class="nc">Component</span><span class="o">.</span><span class="na">itemListenerK</span><span class="o">;</span></span>
<span id="LC126" class="line" lang="java"></span>
<span id="LC127" class="line" lang="java">    <span class="cm">/*</span></span>
<span id="LC128" class="line" lang="java"><span class="cm">     * JDK 1.1 serialVersionUID</span></span>
<span id="LC129" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC130" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="o">-</span><span class="mi">4536902356223894379L</span><span class="o">;</span></span>
...
<span id="LC133" class="line" lang="java">        <span class="nc">AWTAccessor</span><span class="o">.</span><span class="na">setMenuComponentAccessor</span><span class="o">(</span></span>
<span id="LC134" class="line" lang="java">            <span class="k">new</span> <span class="nc">AWTAccessor</span><span class="o">.</span><span class="na">MenuComponentAccessor</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC135" class="line" lang="java">                <span class="kd">public</span> <span class="nc">AppContext</span> <span class="nf">getAppContext</span><span class="o">(</span><span class="nc">MenuComponent</span> <span class="n">menuComp</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC136" class="line" lang="java">                    <span class="k">return</span> <span class="n">menuComp</span><span class="o">.</span><span class="na">appContext</span><span class="o">;</span></span>
<span id="LC137" class="line" lang="java">                <span class="o">}</span></span>
<span id="LC138" class="line" lang="java">                <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setAppContext</span><span class="o">(</span><span class="nc">MenuComponent</span> <span class="n">menuComp</span><span class="o">,</span></span>
<span id="LC139" class="line" lang="java">                                          <span class="nc">AppContext</span> <span class="n">appContext</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC140" class="line" lang="java">                    <span class="n">menuComp</span><span class="o">.</span><span class="na">appContext</span> <span class="o">=</span> <span class="n">appContext</span><span class="o">;</span></span>
<span id="LC141" class="line" lang="java">                <span class="o">}</span></span>
<span id="LC142" class="line" lang="java">                <span class="kd">public</span> <span class="nc">MenuContainer</span> <span class="nf">getParent</span><span class="o">(</span><span class="nc">MenuComponent</span> <span class="n">menuComp</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC143" class="line" lang="java">                    <span class="k">return</span> <span class="n">menuComp</span><span class="o">.</span><span class="na">parent</span><span class="o">;</span></span>
<span id="LC144" class="line" lang="java">                <span class="o">}</span></span>
<span id="LC145" class="line" lang="java">                <span class="kd">public</span> <span class="nc">Font</span> <span class="nf">getFont_NoClientCode</span><span class="o">(</span><span class="nc">MenuComponent</span> <span class="n">menuComp</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC146" class="line" lang="java">                    <span class="k">return</span> <span class="n">menuComp</span><span class="o">.</span><span class="na">getFont_NoClientCode</span><span class="o">();</span></span>
<span id="LC147" class="line" lang="java">                <span class="o">}</span></span>
<span id="LC148" class="line" lang="java">                <span class="nd">@SuppressWarnings</span><span class="o">(</span><span class="s">"unchecked"</span><span class="o">)</span></span>
<span id="LC149" class="line" lang="java">                <span class="kd">public</span> <span class="o">&lt;</span><span class="no">T</span> <span class="kd">extends</span> <span class="nc">MenuComponentPeer</span><span class="o">&gt;</span> <span class="no">T</span> <span class="nf">getPeer</span><span class="o">(</span><span class="nc">MenuComponent</span> <span class="n">menuComp</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC150" class="line" lang="java">                    <span class="k">return</span> <span class="o">(</span><span class="no">T</span><span class="o">)</span> <span class="n">menuComp</span><span class="o">.</span><span class="na">peer</span><span class="o">;</span></span>
...
<span id="LC156" class="line" lang="java"><span class="cm">     * Creates a &lt;code&gt;MenuComponent&lt;/code&gt;.</span></span>
<span id="LC157" class="line" lang="java"><span class="cm">     * @exception HeadlessException if</span></span>
<span id="LC158" class="line" lang="java"><span class="cm">     *    &lt;code&gt;GraphicsEnvironment.isHeadless&lt;/code&gt;</span></span>
<span id="LC159" class="line" lang="java"><span class="cm">     *    returns &lt;code&gt;true&lt;/code&gt;</span></span>
<span id="LC160" class="line" lang="java"><span class="cm">     * @see java.awt.GraphicsEnvironment#isHeadless</span></span>
<span id="LC161" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC162" class="line" lang="java">    <span class="kd">public</span> <span class="nf">MenuComponent</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">HeadlessException</span> <span class="o">{</span></span>
<span id="LC163" class="line" lang="java">        <span class="nc">GraphicsEnvironment</span><span class="o">.</span><span class="na">checkHeadless</span><span class="o">();</span></span>
<span id="LC164" class="line" lang="java">        <span class="n">appContext</span> <span class="o">=</span> <span class="nc">AppContext</span><span class="o">.</span><span class="na">getAppContext</span><span class="o">();</span></span>
...
<span id="LC168" class="line" lang="java"><span class="cm">     * Constructs a name for this &lt;code&gt;MenuComponent&lt;/code&gt;.</span></span>
<span id="LC169" class="line" lang="java"><span class="cm">     * Called by &lt;code&gt;getName&lt;/code&gt; when the name is &lt;code&gt;null&lt;/code&gt;.</span></span>
<span id="LC170" class="line" lang="java"><span class="cm">     * @return a name for this &lt;code&gt;MenuComponent&lt;/code&gt;</span></span>
<span id="LC171" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC172" class="line" lang="java">    <span class="nc">String</span> <span class="nf">constructComponentName</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC173" class="line" lang="java">        <span class="k">return</span> <span class="kc">null</span><span class="o">;</span> <span class="c1">// For strict compliance with prior platform versions, a MenuComponent</span></span>
<span id="LC174" class="line" lang="java">                     <span class="c1">// that doesn't set its name should return null from</span></span>
<span id="LC175" class="line" lang="java">                     <span class="c1">// getName()</span></span>
...
<span id="LC179" class="line" lang="java"><span class="cm">     * Gets the name of the menu component.</span></span>
<span id="LC180" class="line" lang="java"><span class="cm">     * @return        the name of the menu component</span></span>
<span id="LC181" class="line" lang="java"><span class="cm">     * @see           java.awt.MenuComponent#setName(java.lang.String)</span></span>
<span id="LC182" class="line" lang="java"><span class="cm">     * @since         JDK1.1</span></span>
<span id="LC183" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC184" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getName</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC185" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">name</span> <span class="o">==</span> <span class="kc">null</span> <span class="o">&amp;&amp;</span> <span class="o">!</span><span class="n">nameExplicitlySet</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC187" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="n">name</span> <span class="o">==</span> <span class="kc">null</span> <span class="o">&amp;&amp;</span> <span class="o">!</span><span class="n">nameExplicitlySet</span><span class="o">)</span></span>
<span id="LC188" class="line" lang="java">                    <span class="n">name</span> <span class="o">=</span> <span class="n">constructComponentName</span><span class="o">();</span></span>
<span id="LC189" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC190" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC191" class="line" lang="java">        <span class="k">return</span> <span class="n">name</span><span class="o">;</span></span>
...
<span id="LC195" class="line" lang="java"><span class="cm">     * Sets the name of the component to the specified string.</span></span>
<span id="LC196" class="line" lang="java"><span class="cm">     * @param         name    the name of the menu component</span></span>
<span id="LC197" class="line" lang="java"><span class="cm">     * @see           java.awt.MenuComponent#getName</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">     * @since         JDK1.1</span></span>
<span id="LC199" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC200" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setName</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC202" class="line" lang="java">            <span class="k">this</span><span class="o">.</span><span class="na">name</span> <span class="o">=</span> <span class="n">name</span><span class="o">;</span></span>
<span id="LC203" class="line" lang="java">            <span class="n">nameExplicitlySet</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC208" class="line" lang="java"><span class="cm">     * Returns the parent container for this menu component.</span></span>
<span id="LC209" class="line" lang="java"><span class="cm">     * @return    the menu component containing this menu component,</span></span>
<span id="LC210" class="line" lang="java"><span class="cm">     *                 or &lt;code&gt;null&lt;/code&gt; if this menu component</span></span>
<span id="LC211" class="line" lang="java"><span class="cm">     *                 is the outermost component, the menu bar itself</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC213" class="line" lang="java">    <span class="kd">public</span> <span class="nc">MenuContainer</span> <span class="nf">getParent</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC214" class="line" lang="java">        <span class="k">return</span> <span class="nf">getParent_NoClientCode</span><span class="o">();</span></span>
<span id="LC215" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC216" class="line" lang="java">    <span class="c1">// NOTE: This method may be called by privileged threads.</span></span>
<span id="LC217" class="line" lang="java">    <span class="c1">//       This functionality is implemented in a package-private method</span></span>
<span id="LC218" class="line" lang="java">    <span class="c1">//       to insure that it cannot be overridden by client subclasses.</span></span>
<span id="LC219" class="line" lang="java">    <span class="c1">//       DO NOT INVOKE CLIENT CODE ON THIS THREAD!</span></span>
<span id="LC220" class="line" lang="java">    <span class="kd">final</span> <span class="nc">MenuContainer</span> <span class="nf">getParent_NoClientCode</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC221" class="line" lang="java">        <span class="k">return</span> <span class="n">parent</span><span class="o">;</span></span>
...
<span id="LC225" class="line" lang="java"><span class="cm">     * @deprecated As of JDK version 1.1,</span></span>
<span id="LC226" class="line" lang="java"><span class="cm">     * programs should not directly manipulate peers.</span></span>
<span id="LC227" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC228" class="line" lang="java">    <span class="nd">@Deprecated</span></span>
<span id="LC229" class="line" lang="java">    <span class="kd">public</span> <span class="nc">MenuComponentPeer</span> <span class="nf">getPeer</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC230" class="line" lang="java">        <span class="k">return</span> <span class="n">peer</span><span class="o">;</span></span>
...
<span id="LC234" class="line" lang="java"><span class="cm">     * Gets the font used for this menu component.</span></span>
<span id="LC235" class="line" lang="java"><span class="cm">     * @return   the font used in this menu component, if there is one;</span></span>
<span id="LC236" class="line" lang="java"><span class="cm">     *                  &lt;code&gt;null&lt;/code&gt; otherwise</span></span>
<span id="LC237" class="line" lang="java"><span class="cm">     * @see     java.awt.MenuComponent#setFont</span></span>
<span id="LC238" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC239" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Font</span> <span class="nf">getFont</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC240" class="line" lang="java">        <span class="nc">Font</span> <span class="n">font</span> <span class="o">=</span> <span class="k">this</span><span class="o">.</span><span class="na">font</span><span class="o">;</span></span>
<span id="LC241" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">font</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC242" class="line" lang="java">            <span class="k">return</span> <span class="n">font</span><span class="o">;</span></span>
<span id="LC243" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC244" class="line" lang="java">        <span class="nc">MenuContainer</span> <span class="n">parent</span> <span class="o">=</span> <span class="k">this</span><span class="o">.</span><span class="na">parent</span><span class="o">;</span></span>
<span id="LC245" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">parent</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC246" class="line" lang="java">            <span class="k">return</span> <span class="n">parent</span><span class="o">.</span><span class="na">getFont</span><span class="o">();</span></span>
...
<span id="LC251" class="line" lang="java">    <span class="c1">// NOTE: This method may be called by privileged threads.</span></span>
<span id="LC252" class="line" lang="java">    <span class="c1">//       This functionality is implemented in a package-private method</span></span>
<span id="LC253" class="line" lang="java">    <span class="c1">//       to insure that it cannot be overridden by client subclasses.</span></span>
<span id="LC254" class="line" lang="java">    <span class="c1">//       DO NOT INVOKE CLIENT CODE ON THIS THREAD!</span></span>
<span id="LC255" class="line" lang="java">    <span class="kd">final</span> <span class="nc">Font</span> <span class="nf">getFont_NoClientCode</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC256" class="line" lang="java">        <span class="nc">Font</span> <span class="n">font</span> <span class="o">=</span> <span class="k">this</span><span class="o">.</span><span class="na">font</span><span class="o">;</span></span>
<span id="LC257" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">font</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC258" class="line" lang="java">            <span class="k">return</span> <span class="n">font</span><span class="o">;</span></span>
<span id="LC259" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC260" class="line" lang="java"></span>
<span id="LC261" class="line" lang="java">        <span class="c1">// The MenuContainer interface does not have getFont_NoClientCode()</span></span>
<span id="LC262" class="line" lang="java">        <span class="c1">// and it cannot, because it must be package-private. Because of</span></span>
<span id="LC263" class="line" lang="java">        <span class="c1">// this, we must manually cast classes that implement</span></span>
<span id="LC264" class="line" lang="java">        <span class="c1">// MenuContainer.</span></span>
<span id="LC265" class="line" lang="java">        <span class="nc">Object</span> <span class="n">parent</span> <span class="o">=</span> <span class="k">this</span><span class="o">.</span><span class="na">parent</span><span class="o">;</span></span>
<span id="LC266" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">parent</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC267" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">parent</span> <span class="k">instanceof</span> <span class="nc">Component</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC268" class="line" lang="java">                <span class="n">font</span> <span class="o">=</span> <span class="o">((</span><span class="nc">Component</span><span class="o">)</span><span class="n">parent</span><span class="o">).</span><span class="na">getFont_NoClientCode</span><span class="o">();</span></span>
<span id="LC269" class="line" lang="java">            <span class="o">}</span> <span class="k">else</span> <span class="k">if</span> <span class="o">(</span><span class="n">parent</span> <span class="k">instanceof</span> <span class="nc">MenuComponent</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC270" class="line" lang="java">                <span class="n">font</span> <span class="o">=</span> <span class="o">((</span><span class="nc">MenuComponent</span><span class="o">)</span><span class="n">parent</span><span class="o">).</span><span class="na">getFont_NoClientCode</span><span class="o">();</span></span>
<span id="LC271" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC272" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC273" class="line" lang="java">        <span class="k">return</span> <span class="n">font</span><span class="o">;</span></span>
<span id="LC274" class="line" lang="java">    <span class="o">}</span> <span class="c1">// getFont_NoClientCode()</span></span>
...
<span id="LC278" class="line" lang="java"><span class="cm">     * Sets the font to be used for this menu component to the specified</span></span>
<span id="LC279" class="line" lang="java"><span class="cm">     * font. This font is also used by all subcomponents of this menu</span></span>
<span id="LC280" class="line" lang="java"><span class="cm">     * component, unless those subcomponents specify a different font.</span></span>
<span id="LC281" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC282" class="line" lang="java"><span class="cm">     * Some platforms may not support setting of all font attributes</span></span>
<span id="LC283" class="line" lang="java"><span class="cm">     * of a menu component; in such cases, calling &lt;code&gt;setFont&lt;/code&gt;</span></span>
<span id="LC284" class="line" lang="java"><span class="cm">     * will have no effect on the unsupported font attributes of this</span></span>
<span id="LC285" class="line" lang="java"><span class="cm">     * menu component.  Unless subcomponents of this menu component</span></span>
<span id="LC286" class="line" lang="java"><span class="cm">     * specify a different font, this font will be used by those</span></span>
<span id="LC287" class="line" lang="java"><span class="cm">     * subcomponents if supported by the underlying platform.</span></span>
<span id="LC288" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">     * @param     f   the font to be set</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">     * @see       #getFont</span></span>
<span id="LC291" class="line" lang="java"><span class="cm">     * @see       Font#getAttributes</span></span>
<span id="LC292" class="line" lang="java"><span class="cm">     * @see       java.awt.font.TextAttribute</span></span>
<span id="LC293" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC294" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setFont</span><span class="o">(</span><span class="nc">Font</span> <span class="n">f</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC295" class="line" lang="java">        <span class="kd">synchronized</span> <span class="o">(</span><span class="n">getTreeLock</span><span class="o">())</span> <span class="o">{</span></span>
<span id="LC296" class="line" lang="java">            <span class="n">font</span> <span class="o">=</span> <span class="n">f</span><span class="o">;</span></span>
<span id="LC297" class="line" lang="java">            <span class="c1">//Fixed 6312943: NullPointerException in method MenuComponent.setFont(Font)</span></span>
<span id="LC298" class="line" lang="java">            <span class="nc">MenuComponentPeer</span> <span class="n">peer</span> <span class="o">=</span> <span class="k">this</span><span class="o">.</span><span class="na">peer</span><span class="o">;</span></span>
<span id="LC299" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">peer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC300" class="line" lang="java">                <span class="n">peer</span><span class="o">.</span><span class="na">setFont</span><span class="o">(</span><span class="n">f</span><span class="o">);</span></span>
...
<span id="LC306" class="line" lang="java"><span class="cm">     * Removes the menu component's peer.  The peer allows us to modify the</span></span>
<span id="LC307" class="line" lang="java"><span class="cm">     * appearance of the menu component without changing the functionality of</span></span>
<span id="LC308" class="line" lang="java"><span class="cm">     * the menu component.</span></span>
<span id="LC309" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC310" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">removeNotify</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC311" class="line" lang="java">        <span class="kd">synchronized</span> <span class="o">(</span><span class="n">getTreeLock</span><span class="o">())</span> <span class="o">{</span></span>
<span id="LC312" class="line" lang="java">            <span class="nc">MenuComponentPeer</span> <span class="n">p</span> <span class="o">=</span> <span class="k">this</span><span class="o">.</span><span class="na">peer</span><span class="o">;</span></span>
<span id="LC313" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">p</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC314" class="line" lang="java">                <span class="nc">Toolkit</span><span class="o">.</span><span class="na">getEventQueue</span><span class="o">().</span><span class="na">removeSourceEvents</span><span class="o">(</span><span class="k">this</span><span class="o">,</span> <span class="kc">true</span><span class="o">);</span></span>
<span id="LC315" class="line" lang="java">                <span class="k">this</span><span class="o">.</span><span class="na">peer</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC316" class="line" lang="java">                <span class="n">p</span><span class="o">.</span><span class="na">dispose</span><span class="o">();</span></span>
...
<span id="LC322" class="line" lang="java"><span class="cm">     * Posts the specified event to the menu.</span></span>
<span id="LC323" class="line" lang="java"><span class="cm">     * This method is part of the Java&amp;nbsp;1.0 event system</span></span>
<span id="LC324" class="line" lang="java"><span class="cm">     * and it is maintained only for backwards compatibility.</span></span>
<span id="LC325" class="line" lang="java"><span class="cm">     * Its use is discouraged, and it may not be supported</span></span>
<span id="LC326" class="line" lang="java"><span class="cm">     * in the future.</span></span>
<span id="LC327" class="line" lang="java"><span class="cm">     * @param evt the event which is to take place</span></span>
<span id="LC328" class="line" lang="java"><span class="cm">     * @deprecated As of JDK version 1.1, replaced by {@link</span></span>
<span id="LC329" class="line" lang="java"><span class="cm">     * #dispatchEvent(AWTEvent) dispatchEvent}.</span></span>
<span id="LC330" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC331" class="line" lang="java">    <span class="nd">@Deprecated</span></span>
<span id="LC332" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">postEvent</span><span class="o">(</span><span class="nc">Event</span> <span class="n">evt</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC333" class="line" lang="java">        <span class="nc">MenuContainer</span> <span class="n">parent</span> <span class="o">=</span> <span class="k">this</span><span class="o">.</span><span class="na">parent</span><span class="o">;</span></span>
<span id="LC334" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">parent</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC335" class="line" lang="java">            <span class="n">parent</span><span class="o">.</span><span class="na">postEvent</span><span class="o">(</span><span class="n">evt</span><span class="o">);</span></span>
...
<span id="LC341" class="line" lang="java"><span class="cm">     * Delivers an event to this component or one of its sub components.</span></span>
<span id="LC342" class="line" lang="java"><span class="cm">     * @param e the event</span></span>
<span id="LC343" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC344" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">dispatchEvent</span><span class="o">(</span><span class="nc">AWTEvent</span> <span class="n">e</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC345" class="line" lang="java">        <span class="n">dispatchEventImpl</span><span class="o">(</span><span class="n">e</span><span class="o">);</span></span>
<span id="LC346" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC347" class="line" lang="java"></span>
<span id="LC348" class="line" lang="java">    <span class="kt">void</span> <span class="nf">dispatchEventImpl</span><span class="o">(</span><span class="nc">AWTEvent</span> <span class="n">e</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC349" class="line" lang="java">        <span class="nc">EventQueue</span><span class="o">.</span><span class="na">setCurrentEventAndMostRecentTime</span><span class="o">(</span><span class="n">e</span><span class="o">);</span></span>
<span id="LC350" class="line" lang="java"></span>
<span id="LC351" class="line" lang="java">        <span class="nc">Toolkit</span><span class="o">.</span><span class="na">getDefaultToolkit</span><span class="o">().</span><span class="na">notifyAWTEventListeners</span><span class="o">(</span><span class="n">e</span><span class="o">);</span></span>
<span id="LC352" class="line" lang="java"></span>
<span id="LC353" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">newEventsOnly</span> <span class="o">||</span></span>
<span id="LC354" class="line" lang="java">            <span class="o">(</span><span class="n">parent</span> <span class="o">!=</span> <span class="kc">null</span> <span class="o">&amp;&amp;</span> <span class="n">parent</span> <span class="k">instanceof</span> <span class="nc">MenuComponent</span> <span class="o">&amp;&amp;</span></span>
<span id="LC355" class="line" lang="java">             <span class="o">((</span><span class="nc">MenuComponent</span><span class="o">)</span><span class="n">parent</span><span class="o">).</span><span class="na">newEventsOnly</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC356" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">eventEnabled</span><span class="o">(</span><span class="n">e</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC357" class="line" lang="java">                <span class="n">processEvent</span><span class="o">(</span><span class="n">e</span><span class="o">);</span></span>
<span id="LC358" class="line" lang="java">            <span class="o">}</span> <span class="k">else</span> <span class="k">if</span> <span class="o">(</span><span class="n">e</span> <span class="k">instanceof</span> <span class="nc">ActionEvent</span> <span class="o">&amp;&amp;</span> <span class="n">parent</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC359" class="line" lang="java">                <span class="n">e</span><span class="o">.</span><span class="na">setSource</span><span class="o">(</span><span class="n">parent</span><span class="o">);</span></span>
<span id="LC360" class="line" lang="java">                <span class="o">((</span><span class="nc">MenuComponent</span><span class="o">)</span><span class="n">parent</span><span class="o">).</span><span class="na">dispatchEvent</span><span class="o">(</span><span class="n">e</span><span class="o">);</span></span>
<span id="LC361" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC362" class="line" lang="java"></span>
<span id="LC363" class="line" lang="java">        <span class="o">}</span> <span class="k">else</span> <span class="o">{</span> <span class="c1">// backward compatibility</span></span>
<span id="LC364" class="line" lang="java">            <span class="nc">Event</span> <span class="n">olde</span> <span class="o">=</span> <span class="n">e</span><span class="o">.</span><span class="na">convertToOld</span><span class="o">();</span></span>
<span id="LC365" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">olde</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC366" class="line" lang="java">                <span class="n">postEvent</span><span class="o">(</span><span class="n">olde</span><span class="o">);</span></span>
...
<span id="LC371" class="line" lang="java">    <span class="c1">// REMIND: remove when filtering is done at lower level</span></span>
<span id="LC372" class="line" lang="java">    <span class="kt">boolean</span> <span class="nf">eventEnabled</span><span class="o">(</span><span class="nc">AWTEvent</span> <span class="n">e</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC373" class="line" lang="java">        <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC374" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC375" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC376" class="line" lang="java"><span class="cm">     * Processes events occurring on this menu component.</span></span>
<span id="LC377" class="line" lang="java"><span class="cm">     * &lt;p&gt;Note that if the event parameter is &lt;code&gt;null&lt;/code&gt;</span></span>
<span id="LC378" class="line" lang="java"><span class="cm">     * the behavior is unspecified and may result in an</span></span>
<span id="LC379" class="line" lang="java"><span class="cm">     * exception.</span></span>
<span id="LC380" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC381" class="line" lang="java"><span class="cm">     * @param e the event</span></span>
<span id="LC382" class="line" lang="java"><span class="cm">     * @since JDK1.1</span></span>
<span id="LC383" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC384" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">processEvent</span><span class="o">(</span><span class="nc">AWTEvent</span> <span class="n">e</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC388" class="line" lang="java"><span class="cm">     * Returns a string representing the state of this</span></span>
<span id="LC389" class="line" lang="java"><span class="cm">     * &lt;code&gt;MenuComponent&lt;/code&gt;. This method is intended to be used</span></span>
<span id="LC390" class="line" lang="java"><span class="cm">     * only for debugging purposes, and the content and format of the</span></span>
<span id="LC391" class="line" lang="java"><span class="cm">     * returned string may vary between implementations. The returned</span></span>
<span id="LC392" class="line" lang="java"><span class="cm">     * string may be empty but may not be &lt;code&gt;null&lt;/code&gt;.</span></span>
<span id="LC393" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC394" class="line" lang="java"><span class="cm">     * @return     the parameter string of this menu component</span></span>
<span id="LC395" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC396" class="line" lang="java">    <span class="kd">protected</span> <span class="nc">String</span> <span class="nf">paramString</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC397" class="line" lang="java">        <span class="nc">String</span> <span class="n">thisName</span> <span class="o">=</span> <span class="n">getName</span><span class="o">();</span></span>
<span id="LC398" class="line" lang="java">        <span class="k">return</span> <span class="o">(</span><span class="n">thisName</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">?</span> <span class="n">thisName</span> <span class="o">:</span> <span class="s">""</span><span class="o">);</span></span>
...
<span id="LC402" class="line" lang="java"><span class="cm">     * Returns a representation of this menu component as a string.</span></span>
<span id="LC403" class="line" lang="java"><span class="cm">     * @return  a string representation of this menu component</span></span>
...
<span id="LC406" class="line" lang="java">        <span class="k">return</span> <span class="nf">getClass</span><span class="o">().</span><span class="na">getName</span><span class="o">()</span> <span class="o">+</span> <span class="s">"["</span> <span class="o">+</span> <span class="n">paramString</span><span class="o">()</span> <span class="o">+</span> <span class="s">"]"</span><span class="o">;</span></span>
...
<span id="LC410" class="line" lang="java"><span class="cm">     * Gets this component's locking object (the object that owns the thread</span></span>
<span id="LC411" class="line" lang="java"><span class="cm">     * synchronization monitor) for AWT component-tree and layout</span></span>
<span id="LC412" class="line" lang="java"><span class="cm">     * operations.</span></span>
<span id="LC413" class="line" lang="java"><span class="cm">     * @return this component's locking object</span></span>
<span id="LC414" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC415" class="line" lang="java">    <span class="kd">protected</span> <span class="kd">final</span> <span class="nc">Object</span> <span class="nf">getTreeLock</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC416" class="line" lang="java">        <span class="k">return</span> <span class="nc">Component</span><span class="o">.</span><span class="na">LOCK</span><span class="o">;</span></span>
...
<span id="LC420" class="line" lang="java"><span class="cm">     * Reads the menu component from an object input stream.</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">     * @param s the &lt;code&gt;ObjectInputStream&lt;/code&gt; to read</span></span>
<span id="LC423" class="line" lang="java"><span class="cm">     * @exception HeadlessException if</span></span>
<span id="LC424" class="line" lang="java"><span class="cm">     *   &lt;code&gt;GraphicsEnvironment.isHeadless&lt;/code&gt; returns</span></span>
<span id="LC425" class="line" lang="java"><span class="cm">     *   &lt;code&gt;true&lt;/code&gt;</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">     * @serial</span></span>
<span id="LC427" class="line" lang="java"><span class="cm">     * @see java.awt.GraphicsEnvironment#isHeadless</span></span>
<span id="LC428" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC429" class="line" lang="java">    <span class="kd">private</span> <span class="kt">void</span> <span class="nf">readObject</span><span class="o">(</span><span class="nc">ObjectInputStream</span> <span class="n">s</span><span class="o">)</span></span>
<span id="LC430" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">ClassNotFoundException</span><span class="o">,</span> <span class="nc">IOException</span><span class="o">,</span> <span class="nc">HeadlessException</span></span>
<span id="LC431" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC432" class="line" lang="java">        <span class="nc">GraphicsEnvironment</span><span class="o">.</span><span class="na">checkHeadless</span><span class="o">();</span></span>
<span id="LC433" class="line" lang="java"></span>
<span id="LC434" class="line" lang="java">        <span class="n">acc</span> <span class="o">=</span> <span class="nc">AccessController</span><span class="o">.</span><span class="na">getContext</span><span class="o">();</span></span>
<span id="LC435" class="line" lang="java"></span>
<span id="LC436" class="line" lang="java">        <span class="n">s</span><span class="o">.</span><span class="na">defaultReadObject</span><span class="o">();</span></span>
<span id="LC437" class="line" lang="java"></span>
<span id="LC438" class="line" lang="java">        <span class="n">appContext</span> <span class="o">=</span> <span class="nc">AppContext</span><span class="o">.</span><span class="na">getAppContext</span><span class="o">();</span></span>
...
<span id="LC442" class="line" lang="java"><span class="cm">     * Initialize JNI field and method IDs.</span></span>
<span id="LC443" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC444" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="kd">native</span> <span class="kt">void</span> <span class="nf">initIDs</span><span class="o">();</span></span>
...
<span id="LC448" class="line" lang="java"><span class="cm">     * --- Accessibility Support ---</span></span>
<span id="LC449" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC450" class="line" lang="java"><span class="cm">     *  MenuComponent will contain all of the methods in interface Accessible,</span></span>
<span id="LC451" class="line" lang="java"><span class="cm">     *  though it won't actually implement the interface - that will be up</span></span>
<span id="LC452" class="line" lang="java"><span class="cm">     *  to the individual objects which extend MenuComponent.</span></span>
<span id="LC453" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC454" class="line" lang="java"></span>
<span id="LC455" class="line" lang="java">    <span class="nc">AccessibleContext</span> <span class="n">accessibleContext</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC456" class="line" lang="java"></span>
<span id="LC457" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC458" class="line" lang="java"><span class="cm">     * Gets the &lt;code&gt;AccessibleContext&lt;/code&gt; associated with</span></span>
<span id="LC459" class="line" lang="java"><span class="cm">     * this &lt;code&gt;MenuComponent&lt;/code&gt;.</span></span>
<span id="LC460" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC461" class="line" lang="java"><span class="cm">     * The method implemented by this base class returns &lt;code&gt;null&lt;/code&gt;.</span></span>
<span id="LC462" class="line" lang="java"><span class="cm">     * Classes that extend &lt;code&gt;MenuComponent&lt;/code&gt;</span></span>
<span id="LC463" class="line" lang="java"><span class="cm">     * should implement this method to return the</span></span>
<span id="LC464" class="line" lang="java"><span class="cm">     * &lt;code&gt;AccessibleContext&lt;/code&gt; associated with the subclass.</span></span>
<span id="LC465" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC466" class="line" lang="java"><span class="cm">     * @return the &lt;code&gt;AccessibleContext&lt;/code&gt; of this</span></span>
<span id="LC467" class="line" lang="java"><span class="cm">     *     &lt;code&gt;MenuComponent&lt;/code&gt;</span></span>
<span id="LC468" class="line" lang="java"><span class="cm">     * @since 1.3</span></span>
<span id="LC469" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC470" class="line" lang="java">    <span class="kd">public</span> <span class="nc">AccessibleContext</span> <span class="nf">getAccessibleContext</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC471" class="line" lang="java">        <span class="k">return</span> <span class="n">accessibleContext</span><span class="o">;</span></span>
...
<span id="LC475" class="line" lang="java"><span class="cm">     * Inner class of &lt;code&gt;MenuComponent&lt;/code&gt; used to provide</span></span>
<span id="LC476" class="line" lang="java"><span class="cm">     * default support for accessibility.  This class is not meant</span></span>
<span id="LC477" class="line" lang="java"><span class="cm">     * to be used directly by application developers, but is instead</span></span>
<span id="LC478" class="line" lang="java"><span class="cm">     * meant only to be subclassed by menu component developers.</span></span>
<span id="LC479" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC480" class="line" lang="java"><span class="cm">     * The class used to obtain the accessible role for this object.</span></span>
<span id="LC481" class="line" lang="java"><span class="cm">     * @since 1.3</span></span>
<span id="LC482" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC483" class="line" lang="java">    <span class="kd">protected</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">AccessibleAWTMenuComponent</span></span>
<span id="LC484" class="line" lang="java">        <span class="kd">extends</span> <span class="nc">AccessibleContext</span></span>
<span id="LC485" class="line" lang="java">        <span class="kd">implements</span> <span class="n">java</span><span class="o">.</span><span class="na">io</span><span class="o">.</span><span class="na">Serializable</span><span class="o">,</span> <span class="nc">AccessibleComponent</span><span class="o">,</span></span>
<span id="LC486" class="line" lang="java">                   <span class="nc">AccessibleSelection</span></span>
<span id="LC487" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC488" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC489" class="line" lang="java"><span class="cm">         * JDK 1.3 serialVersionUID</span></span>
<span id="LC490" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC491" class="line" lang="java">        <span class="kd">private</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="o">-</span><span class="mi">4269533416223798698L</span><span class="o">;</span></span>
<span id="LC492" class="line" lang="java"></span>
<span id="LC493" class="line" lang="java">        <span class="cm">/**</span></span>
<span id="LC494" class="line" lang="java"><span class="cm">         * Although the class is abstract, this should be called by</span></span>
<span id="LC495" class="line" lang="java"><span class="cm">         * all sub-classes.</span></span>
<span id="LC496" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC497" class="line" lang="java">        <span class="kd">protected</span> <span class="nf">AccessibleAWTMenuComponent</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC498" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC499" class="line" lang="java"></span>
<span id="LC500" class="line" lang="java">        <span class="c1">// AccessibleContext methods</span></span>
...
<span id="LC504" class="line" lang="java"><span class="cm">         * Gets the &lt;code&gt;AccessibleSelection&lt;/code&gt; associated with this</span></span>
<span id="LC505" class="line" lang="java"><span class="cm">         * object which allows its &lt;code&gt;Accessible&lt;/code&gt; children to be selected.</span></span>
<span id="LC506" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC507" class="line" lang="java"><span class="cm">         * @return &lt;code&gt;AccessibleSelection&lt;/code&gt; if supported by object;</span></span>
<span id="LC508" class="line" lang="java"><span class="cm">         *      else return &lt;code&gt;null&lt;/code&gt;</span></span>
<span id="LC509" class="line" lang="java"><span class="cm">         * @see AccessibleSelection</span></span>
<span id="LC510" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC511" class="line" lang="java">        <span class="kd">public</span> <span class="nc">AccessibleSelection</span> <span class="nf">getAccessibleSelection</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC512" class="line" lang="java">            <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC516" class="line" lang="java"><span class="cm">         * Gets the accessible name of this object.  This should almost never</span></span>
<span id="LC517" class="line" lang="java"><span class="cm">         * return &lt;code&gt;java.awt.MenuComponent.getName&lt;/code&gt;, as that</span></span>
<span id="LC518" class="line" lang="java"><span class="cm">         * generally isn't a localized name, and doesn't have meaning for the</span></span>
<span id="LC519" class="line" lang="java"><span class="cm">         * user.  If the object is fundamentally a text object (e.g. a menu item), the</span></span>
<span id="LC520" class="line" lang="java"><span class="cm">         * accessible name should be the text of the object (e.g. "save").</span></span>
<span id="LC521" class="line" lang="java"><span class="cm">         * If the object has a tooltip, the tooltip text may also be an</span></span>
<span id="LC522" class="line" lang="java"><span class="cm">         * appropriate String to return.</span></span>
<span id="LC523" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC524" class="line" lang="java"><span class="cm">         * @return the localized name of the object -- can be &lt;code&gt;null&lt;/code&gt;</span></span>
<span id="LC525" class="line" lang="java"><span class="cm">         *         if this object does not have a name</span></span>
<span id="LC526" class="line" lang="java"><span class="cm">         * @see AccessibleContext#setAccessibleName</span></span>
<span id="LC527" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC528" class="line" lang="java">        <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getAccessibleName</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC529" class="line" lang="java">            <span class="k">return</span> <span class="n">accessibleName</span><span class="o">;</span></span>
...
<span id="LC533" class="line" lang="java"><span class="cm">         * Gets the accessible description of this object.  This should be</span></span>
<span id="LC534" class="line" lang="java"><span class="cm">         * a concise, localized description of what this object is - what</span></span>
<span id="LC535" class="line" lang="java"><span class="cm">         * is its meaning to the user.  If the object has a tooltip, the</span></span>
<span id="LC536" class="line" lang="java"><span class="cm">         * tooltip text may be an appropriate string to return, assuming</span></span>
<span id="LC537" class="line" lang="java"><span class="cm">         * it contains a concise description of the object (instead of just</span></span>
<span id="LC538" class="line" lang="java"><span class="cm">         * the name of the object - e.g. a "Save" icon on a toolbar that</span></span>
<span id="LC539" class="line" lang="java"><span class="cm">         * had "save" as the tooltip text shouldn't return the tooltip</span></span>
<span id="LC540" class="line" lang="java"><span class="cm">         * text as the description, but something like "Saves the current</span></span>
<span id="LC541" class="line" lang="java"><span class="cm">         * text document" instead).</span></span>
<span id="LC542" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC543" class="line" lang="java"><span class="cm">         * @return the localized description of the object -- can be</span></span>
<span id="LC544" class="line" lang="java"><span class="cm">         *     &lt;code&gt;null&lt;/code&gt; if this object does not have a description</span></span>
<span id="LC545" class="line" lang="java"><span class="cm">         * @see AccessibleContext#setAccessibleDescription</span></span>
<span id="LC546" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC547" class="line" lang="java">        <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getAccessibleDescription</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC548" class="line" lang="java">            <span class="k">return</span> <span class="n">accessibleDescription</span><span class="o">;</span></span>
...
<span id="LC552" class="line" lang="java"><span class="cm">         * Gets the role of this object.</span></span>
<span id="LC553" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC554" class="line" lang="java"><span class="cm">         * @return an instance of &lt;code&gt;AccessibleRole&lt;/code&gt;</span></span>
<span id="LC555" class="line" lang="java"><span class="cm">         *     describing the role of the object</span></span>
<span id="LC556" class="line" lang="java"><span class="cm">         * @see AccessibleRole</span></span>
<span id="LC557" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC558" class="line" lang="java">        <span class="kd">public</span> <span class="nc">AccessibleRole</span> <span class="nf">getAccessibleRole</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC559" class="line" lang="java">            <span class="k">return</span> <span class="nc">AccessibleRole</span><span class="o">.</span><span class="na">AWT_COMPONENT</span><span class="o">;</span> <span class="c1">// Non-specific -- overridden in subclasses</span></span>
...
<span id="LC563" class="line" lang="java"><span class="cm">         * Gets the state of this object.</span></span>
<span id="LC564" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC565" class="line" lang="java"><span class="cm">         * @return an instance of &lt;code&gt;AccessibleStateSet&lt;/code&gt;</span></span>
<span id="LC566" class="line" lang="java"><span class="cm">         *     containing the current state set of the object</span></span>
<span id="LC567" class="line" lang="java"><span class="cm">         * @see AccessibleState</span></span>
<span id="LC568" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC569" class="line" lang="java">        <span class="kd">public</span> <span class="nc">AccessibleStateSet</span> <span class="nf">getAccessibleStateSet</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC570" class="line" lang="java">            <span class="k">return</span> <span class="nc">MenuComponent</span><span class="o">.</span><span class="na">this</span><span class="o">.</span><span class="na">getAccessibleStateSet</span><span class="o">();</span></span>
...
<span id="LC574" class="line" lang="java"><span class="cm">         * Gets the &lt;code&gt;Accessible&lt;/code&gt; parent of this object.</span></span>
<span id="LC575" class="line" lang="java"><span class="cm">         * If the parent of this object implements &lt;code&gt;Accessible&lt;/code&gt;,</span></span>
<span id="LC576" class="line" lang="java"><span class="cm">         * this method should simply return &lt;code&gt;getParent&lt;/code&gt;.</span></span>
<span id="LC577" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC578" class="line" lang="java"><span class="cm">         * @return the &lt;code&gt;Accessible&lt;/code&gt; parent of this object -- can</span></span>
<span id="LC579" class="line" lang="java"><span class="cm">         *    be &lt;code&gt;null&lt;/code&gt; if this object does not have an</span></span>
<span id="LC580" class="line" lang="java"><span class="cm">         *    &lt;code&gt;Accessible&lt;/code&gt; parent</span></span>
<span id="LC581" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC582" class="line" lang="java">        <span class="kd">public</span> <span class="nc">Accessible</span> <span class="nf">getAccessibleParent</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC583" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">accessibleParent</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC584" class="line" lang="java">                <span class="k">return</span> <span class="n">accessibleParent</span><span class="o">;</span></span>
<span id="LC585" class="line" lang="java">            <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC586" class="line" lang="java">                <span class="nc">MenuContainer</span> <span class="n">parent</span> <span class="o">=</span> <span class="nc">MenuComponent</span><span class="o">.</span><span class="na">this</span><span class="o">.</span><span class="na">getParent</span><span class="o">();</span></span>
<span id="LC587" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="n">parent</span> <span class="k">instanceof</span> <span class="nc">Accessible</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC588" class="line" lang="java">                    <span class="k">return</span> <span class="o">(</span><span class="nc">Accessible</span><span class="o">)</span> <span class="n">parent</span><span class="o">;</span></span>
...
<span id="LC595" class="line" lang="java"><span class="cm">         * Gets the index of this object in its accessible parent.</span></span>
<span id="LC596" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC597" class="line" lang="java"><span class="cm">         * @return the index of this object in its parent; -1 if this</span></span>
<span id="LC598" class="line" lang="java"><span class="cm">         *     object does not have an accessible parent</span></span>
<span id="LC599" class="line" lang="java"><span class="cm">         * @see #getAccessibleParent</span></span>
<span id="LC600" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC601" class="line" lang="java">        <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getAccessibleIndexInParent</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC602" class="line" lang="java">            <span class="k">return</span> <span class="nc">MenuComponent</span><span class="o">.</span><span class="na">this</span><span class="o">.</span><span class="na">getAccessibleIndexInParent</span><span class="o">();</span></span>
...
<span id="LC606" class="line" lang="java"><span class="cm">         * Returns the number of accessible children in the object.  If all</span></span>
<span id="LC607" class="line" lang="java"><span class="cm">         * of the children of this object implement &lt;code&gt;Accessible&lt;/code&gt;,</span></span>
<span id="LC608" class="line" lang="java"><span class="cm">         * then this method should return the number of children of this object.</span></span>
<span id="LC609" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC610" class="line" lang="java"><span class="cm">         * @return the number of accessible children in the object</span></span>
<span id="LC611" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC612" class="line" lang="java">        <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getAccessibleChildrenCount</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC613" class="line" lang="java">            <span class="k">return</span> <span class="mi">0</span><span class="o">;</span> <span class="c1">// MenuComponents don't have children</span></span>
...
<span id="LC617" class="line" lang="java"><span class="cm">         * Returns the nth &lt;code&gt;Accessible&lt;/code&gt; child of the object.</span></span>
<span id="LC618" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC619" class="line" lang="java"><span class="cm">         * @param i zero-based index of child</span></span>
<span id="LC620" class="line" lang="java"><span class="cm">         * @return the nth Accessible child of the object</span></span>
<span id="LC621" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC622" class="line" lang="java">        <span class="kd">public</span> <span class="nc">Accessible</span> <span class="nf">getAccessibleChild</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC623" class="line" lang="java">            <span class="k">return</span> <span class="kc">null</span><span class="o">;</span> <span class="c1">// MenuComponents don't have children</span></span>
...
<span id="LC627" class="line" lang="java"><span class="cm">         * Returns the locale of this object.</span></span>
<span id="LC628" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC629" class="line" lang="java"><span class="cm">         * @return the locale of this object</span></span>
<span id="LC630" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC631" class="line" lang="java">        <span class="kd">public</span> <span class="n">java</span><span class="o">.</span><span class="na">util</span><span class="o">.</span><span class="na">Locale</span> <span class="nf">getLocale</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC632" class="line" lang="java">            <span class="nc">MenuContainer</span> <span class="n">parent</span> <span class="o">=</span> <span class="nc">MenuComponent</span><span class="o">.</span><span class="na">this</span><span class="o">.</span><span class="na">getParent</span><span class="o">();</span></span>
<span id="LC633" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">parent</span> <span class="k">instanceof</span> <span class="nc">Component</span><span class="o">)</span></span>
<span id="LC634" class="line" lang="java">                <span class="k">return</span> <span class="o">((</span><span class="nc">Component</span><span class="o">)</span><span class="n">parent</span><span class="o">).</span><span class="na">getLocale</span><span class="o">();</span></span>
<span id="LC635" class="line" lang="java">            <span class="k">else</span></span>
<span id="LC636" class="line" lang="java">                <span class="k">return</span> <span class="n">java</span><span class="o">.</span><span class="na">util</span><span class="o">.</span><span class="na">Locale</span><span class="o">.</span><span class="na">getDefault</span><span class="o">();</span></span>
...
<span id="LC640" class="line" lang="java"><span class="cm">         * Gets the &lt;code&gt;AccessibleComponent&lt;/code&gt; associated with</span></span>
<span id="LC641" class="line" lang="java"><span class="cm">         * this object if one exists.  Otherwise return &lt;code&gt;null&lt;/code&gt;.</span></span>
<span id="LC642" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC643" class="line" lang="java"><span class="cm">         * @return the component</span></span>
<span id="LC644" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC645" class="line" lang="java">        <span class="kd">public</span> <span class="nc">AccessibleComponent</span> <span class="nf">getAccessibleComponent</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC650" class="line" lang="java">        <span class="c1">// AccessibleComponent methods</span></span>
<span id="LC651" class="line" lang="java">        <span class="c1">//</span></span>
<span id="LC652" class="line" lang="java">        <span class="cm">/**</span></span>
<span id="LC653" class="line" lang="java"><span class="cm">         * Gets the background color of this object.</span></span>
<span id="LC654" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC655" class="line" lang="java"><span class="cm">         * @return the background color, if supported, of the object;</span></span>
<span id="LC656" class="line" lang="java"><span class="cm">         *     otherwise, &lt;code&gt;null&lt;/code&gt;</span></span>
<span id="LC657" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC658" class="line" lang="java">        <span class="kd">public</span> <span class="nc">Color</span> <span class="nf">getBackground</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC659" class="line" lang="java">            <span class="k">return</span> <span class="kc">null</span><span class="o">;</span> <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC663" class="line" lang="java"><span class="cm">         * Sets the background color of this object.</span></span>
<span id="LC664" class="line" lang="java"><span class="cm">         * (For transparency, see &lt;code&gt;isOpaque&lt;/code&gt;.)</span></span>
<span id="LC665" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC666" class="line" lang="java"><span class="cm">         * @param c the new &lt;code&gt;Color&lt;/code&gt; for the background</span></span>
<span id="LC667" class="line" lang="java"><span class="cm">         * @see Component#isOpaque</span></span>
<span id="LC668" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC669" class="line" lang="java">        <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBackground</span><span class="o">(</span><span class="nc">Color</span> <span class="n">c</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC670" class="line" lang="java">            <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC674" class="line" lang="java"><span class="cm">         * Gets the foreground color of this object.</span></span>
<span id="LC675" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC676" class="line" lang="java"><span class="cm">         * @return the foreground color, if supported, of the object;</span></span>
<span id="LC677" class="line" lang="java"><span class="cm">         *     otherwise, &lt;code&gt;null&lt;/code&gt;</span></span>
<span id="LC678" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC679" class="line" lang="java">        <span class="kd">public</span> <span class="nc">Color</span> <span class="nf">getForeground</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC680" class="line" lang="java">            <span class="k">return</span> <span class="kc">null</span><span class="o">;</span> <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC684" class="line" lang="java"><span class="cm">         * Sets the foreground color of this object.</span></span>
<span id="LC685" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC686" class="line" lang="java"><span class="cm">         * @param c the new &lt;code&gt;Color&lt;/code&gt; for the foreground</span></span>
<span id="LC687" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC688" class="line" lang="java">        <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setForeground</span><span class="o">(</span><span class="nc">Color</span> <span class="n">c</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC689" class="line" lang="java">            <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC693" class="line" lang="java"><span class="cm">         * Gets the &lt;code&gt;Cursor&lt;/code&gt; of this object.</span></span>
<span id="LC694" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC695" class="line" lang="java"><span class="cm">         * @return the &lt;code&gt;Cursor&lt;/code&gt;, if supported, of the object;</span></span>
<span id="LC696" class="line" lang="java"><span class="cm">         *     otherwise, &lt;code&gt;null&lt;/code&gt;</span></span>
<span id="LC697" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC698" class="line" lang="java">        <span class="kd">public</span> <span class="nc">Cursor</span> <span class="nf">getCursor</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC699" class="line" lang="java">            <span class="k">return</span> <span class="kc">null</span><span class="o">;</span> <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC703" class="line" lang="java"><span class="cm">         * Sets the &lt;code&gt;Cursor&lt;/code&gt; of this object.</span></span>
<span id="LC704" class="line" lang="java"><span class="cm">         * &lt;p&gt;</span></span>
<span id="LC705" class="line" lang="java"><span class="cm">         * The method may have no visual effect if the Java platform</span></span>
<span id="LC706" class="line" lang="java"><span class="cm">         * implementation and/or the native system do not support</span></span>
<span id="LC707" class="line" lang="java"><span class="cm">         * changing the mouse cursor shape.</span></span>
<span id="LC708" class="line" lang="java"><span class="cm">         * @param cursor the new &lt;code&gt;Cursor&lt;/code&gt; for the object</span></span>
<span id="LC709" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC710" class="line" lang="java">        <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCursor</span><span class="o">(</span><span class="nc">Cursor</span> <span class="n">cursor</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC711" class="line" lang="java">            <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC715" class="line" lang="java"><span class="cm">         * Gets the &lt;code&gt;Font&lt;/code&gt; of this object.</span></span>
<span id="LC716" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC717" class="line" lang="java"><span class="cm">         * @return the &lt;code&gt;Font&lt;/code&gt;,if supported, for the object;</span></span>
<span id="LC718" class="line" lang="java"><span class="cm">         *     otherwise, &lt;code&gt;null&lt;/code&gt;</span></span>
<span id="LC719" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC720" class="line" lang="java">        <span class="kd">public</span> <span class="nc">Font</span> <span class="nf">getFont</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC721" class="line" lang="java">            <span class="k">return</span> <span class="nc">MenuComponent</span><span class="o">.</span><span class="na">this</span><span class="o">.</span><span class="na">getFont</span><span class="o">();</span></span>
...
<span id="LC725" class="line" lang="java"><span class="cm">         * Sets the &lt;code&gt;Font&lt;/code&gt; of this object.</span></span>
<span id="LC726" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC727" class="line" lang="java"><span class="cm">         * @param f the new &lt;code&gt;Font&lt;/code&gt; for the object</span></span>
<span id="LC728" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC729" class="line" lang="java">        <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setFont</span><span class="o">(</span><span class="nc">Font</span> <span class="n">f</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC730" class="line" lang="java">            <span class="nc">MenuComponent</span><span class="o">.</span><span class="na">this</span><span class="o">.</span><span class="na">setFont</span><span class="o">(</span><span class="n">f</span><span class="o">);</span></span>
...
<span id="LC734" class="line" lang="java"><span class="cm">         * Gets the &lt;code&gt;FontMetrics&lt;/code&gt; of this object.</span></span>
<span id="LC735" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC736" class="line" lang="java"><span class="cm">         * @param f the &lt;code&gt;Font&lt;/code&gt;</span></span>
<span id="LC737" class="line" lang="java"><span class="cm">         * @return the FontMetrics, if supported, the object;</span></span>
<span id="LC738" class="line" lang="java"><span class="cm">         *              otherwise, &lt;code&gt;null&lt;/code&gt;</span></span>
<span id="LC739" class="line" lang="java"><span class="cm">         * @see #getFont</span></span>
<span id="LC740" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC741" class="line" lang="java">        <span class="kd">public</span> <span class="nc">FontMetrics</span> <span class="nf">getFontMetrics</span><span class="o">(</span><span class="nc">Font</span> <span class="n">f</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC742" class="line" lang="java">            <span class="k">return</span> <span class="kc">null</span><span class="o">;</span> <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC746" class="line" lang="java"><span class="cm">         * Determines if the object is enabled.</span></span>
<span id="LC747" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC748" class="line" lang="java"><span class="cm">         * @return true if object is enabled; otherwise, false</span></span>
<span id="LC749" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC750" class="line" lang="java">        <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isEnabled</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC751" class="line" lang="java">            <span class="k">return</span> <span class="kc">true</span><span class="o">;</span> <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC755" class="line" lang="java"><span class="cm">         * Sets the enabled state of the object.</span></span>
<span id="LC756" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC757" class="line" lang="java"><span class="cm">         * @param b if true, enables this object; otherwise, disables it</span></span>
<span id="LC758" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC759" class="line" lang="java">        <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setEnabled</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">b</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC760" class="line" lang="java">            <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC764" class="line" lang="java"><span class="cm">         * Determines if the object is visible.  Note: this means that the</span></span>
<span id="LC765" class="line" lang="java"><span class="cm">         * object intends to be visible; however, it may not in fact be</span></span>
<span id="LC766" class="line" lang="java"><span class="cm">         * showing on the screen because one of the objects that this object</span></span>
<span id="LC767" class="line" lang="java"><span class="cm">         * is contained by is not visible.  To determine if an object is</span></span>
<span id="LC768" class="line" lang="java"><span class="cm">         * showing on the screen, use &lt;code&gt;isShowing&lt;/code&gt;.</span></span>
<span id="LC769" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC770" class="line" lang="java"><span class="cm">         * @return true if object is visible; otherwise, false</span></span>
<span id="LC771" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC772" class="line" lang="java">        <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isVisible</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC773" class="line" lang="java">            <span class="k">return</span> <span class="kc">true</span><span class="o">;</span> <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC777" class="line" lang="java"><span class="cm">         * Sets the visible state of the object.</span></span>
<span id="LC778" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC779" class="line" lang="java"><span class="cm">         * @param b if true, shows this object; otherwise, hides it</span></span>
<span id="LC780" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC781" class="line" lang="java">        <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setVisible</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">b</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC782" class="line" lang="java">            <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC786" class="line" lang="java"><span class="cm">         * Determines if the object is showing.  This is determined by checking</span></span>
<span id="LC787" class="line" lang="java"><span class="cm">         * the visibility of the object and ancestors of the object.  Note:</span></span>
<span id="LC788" class="line" lang="java"><span class="cm">         * this will return true even if the object is obscured by another</span></span>
<span id="LC789" class="line" lang="java"><span class="cm">         * (for example, it happens to be underneath a menu that was pulled</span></span>
<span id="LC790" class="line" lang="java"><span class="cm">         * down).</span></span>
<span id="LC791" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC792" class="line" lang="java"><span class="cm">         * @return true if object is showing; otherwise, false</span></span>
<span id="LC793" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC794" class="line" lang="java">        <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isShowing</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC795" class="line" lang="java">            <span class="k">return</span> <span class="kc">true</span><span class="o">;</span> <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC799" class="line" lang="java"><span class="cm">         * Checks whether the specified point is within this object's bounds,</span></span>
<span id="LC800" class="line" lang="java"><span class="cm">         * where the point's x and y coordinates are defined to be relative to</span></span>
<span id="LC801" class="line" lang="java"><span class="cm">         * the coordinate system of the object.</span></span>
<span id="LC802" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC803" class="line" lang="java"><span class="cm">         * @param p the &lt;code&gt;Point&lt;/code&gt; relative to the coordinate</span></span>
<span id="LC804" class="line" lang="java"><span class="cm">         *     system of the object</span></span>
<span id="LC805" class="line" lang="java"><span class="cm">         * @return true if object contains &lt;code&gt;Point&lt;/code&gt;; otherwise false</span></span>
<span id="LC806" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC807" class="line" lang="java">        <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">contains</span><span class="o">(</span><span class="nc">Point</span> <span class="n">p</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC808" class="line" lang="java">            <span class="k">return</span> <span class="kc">false</span><span class="o">;</span> <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC812" class="line" lang="java"><span class="cm">         * Returns the location of the object on the screen.</span></span>
<span id="LC813" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC814" class="line" lang="java"><span class="cm">         * @return location of object on screen -- can be &lt;code&gt;null&lt;/code&gt;</span></span>
<span id="LC815" class="line" lang="java"><span class="cm">         *     if this object is not on the screen</span></span>
<span id="LC816" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC817" class="line" lang="java">        <span class="kd">public</span> <span class="nc">Point</span> <span class="nf">getLocationOnScreen</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC818" class="line" lang="java">            <span class="k">return</span> <span class="kc">null</span><span class="o">;</span> <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC822" class="line" lang="java"><span class="cm">         * Gets the location of the object relative to the parent in the form</span></span>
<span id="LC823" class="line" lang="java"><span class="cm">         * of a point specifying the object's top-left corner in the screen's</span></span>
<span id="LC824" class="line" lang="java"><span class="cm">         * coordinate space.</span></span>
<span id="LC825" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC826" class="line" lang="java"><span class="cm">         * @return an instance of &lt;code&gt;Point&lt;/code&gt; representing the</span></span>
<span id="LC827" class="line" lang="java"><span class="cm">         *    top-left corner of the object's bounds in the coordinate</span></span>
<span id="LC828" class="line" lang="java"><span class="cm">         *    space of the screen; &lt;code&gt;null&lt;/code&gt; if</span></span>
<span id="LC829" class="line" lang="java"><span class="cm">         *    this object or its parent are not on the screen</span></span>
<span id="LC830" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC831" class="line" lang="java">        <span class="kd">public</span> <span class="nc">Point</span> <span class="nf">getLocation</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC832" class="line" lang="java">            <span class="k">return</span> <span class="kc">null</span><span class="o">;</span> <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC836" class="line" lang="java"><span class="cm">         * Sets the location of the object relative to the parent.</span></span>
<span id="LC837" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC838" class="line" lang="java">        <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setLocation</span><span class="o">(</span><span class="nc">Point</span> <span class="n">p</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC839" class="line" lang="java">            <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC843" class="line" lang="java"><span class="cm">         * Gets the bounds of this object in the form of a</span></span>
<span id="LC844" class="line" lang="java"><span class="cm">         * &lt;code&gt;Rectangle&lt;/code&gt; object.</span></span>
<span id="LC845" class="line" lang="java"><span class="cm">         * The bounds specify this object's width, height, and location</span></span>
<span id="LC846" class="line" lang="java"><span class="cm">         * relative to its parent.</span></span>
<span id="LC847" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC848" class="line" lang="java"><span class="cm">         * @return a rectangle indicating this component's bounds;</span></span>
<span id="LC849" class="line" lang="java"><span class="cm">         *     &lt;code&gt;null&lt;/code&gt; if this object is not on the screen</span></span>
<span id="LC850" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC851" class="line" lang="java">        <span class="kd">public</span> <span class="nc">Rectangle</span> <span class="nf">getBounds</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC852" class="line" lang="java">            <span class="k">return</span> <span class="kc">null</span><span class="o">;</span> <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC856" class="line" lang="java"><span class="cm">         * Sets the bounds of this object in the form of a</span></span>
<span id="LC857" class="line" lang="java"><span class="cm">         * &lt;code&gt;Rectangle&lt;/code&gt; object.</span></span>
<span id="LC858" class="line" lang="java"><span class="cm">         * The bounds specify this object's width, height, and location</span></span>
<span id="LC859" class="line" lang="java"><span class="cm">         * relative to its parent.</span></span>
<span id="LC860" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC861" class="line" lang="java"><span class="cm">         * @param r a rectangle indicating this component's bounds</span></span>
<span id="LC862" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC863" class="line" lang="java">        <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setBounds</span><span class="o">(</span><span class="nc">Rectangle</span> <span class="n">r</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC864" class="line" lang="java">            <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC868" class="line" lang="java"><span class="cm">         * Returns the size of this object in the form of a</span></span>
<span id="LC869" class="line" lang="java"><span class="cm">         * &lt;code&gt;Dimension&lt;/code&gt; object. The height field of</span></span>
<span id="LC870" class="line" lang="java"><span class="cm">         * the &lt;code&gt;Dimension&lt;/code&gt; object contains this object's</span></span>
<span id="LC871" class="line" lang="java"><span class="cm">         * height, and the width field of the &lt;code&gt;Dimension&lt;/code&gt;</span></span>
<span id="LC872" class="line" lang="java"><span class="cm">         * object contains this object's width.</span></span>
<span id="LC873" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC874" class="line" lang="java"><span class="cm">         * @return a &lt;code&gt;Dimension&lt;/code&gt; object that indicates the</span></span>
<span id="LC875" class="line" lang="java"><span class="cm">         *         size of this component; &lt;code&gt;null&lt;/code&gt;</span></span>
<span id="LC876" class="line" lang="java"><span class="cm">         *         if this object is not on the screen</span></span>
<span id="LC877" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC878" class="line" lang="java">        <span class="kd">public</span> <span class="nc">Dimension</span> <span class="nf">getSize</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC879" class="line" lang="java">            <span class="k">return</span> <span class="kc">null</span><span class="o">;</span> <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC883" class="line" lang="java"><span class="cm">         * Resizes this object.</span></span>
<span id="LC884" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC885" class="line" lang="java"><span class="cm">         * @param d - the &lt;code&gt;Dimension&lt;/code&gt; specifying the</span></span>
<span id="LC886" class="line" lang="java"><span class="cm">         *    new size of the object</span></span>
<span id="LC887" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC888" class="line" lang="java">        <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSize</span><span class="o">(</span><span class="nc">Dimension</span> <span class="n">d</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC889" class="line" lang="java">            <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC893" class="line" lang="java"><span class="cm">         * Returns the &lt;code&gt;Accessible&lt;/code&gt; child, if one exists,</span></span>
<span id="LC894" class="line" lang="java"><span class="cm">         * contained at the local coordinate &lt;code&gt;Point&lt;/code&gt;.</span></span>
<span id="LC895" class="line" lang="java"><span class="cm">         * If there is no &lt;code&gt;Accessible&lt;/code&gt; child, &lt;code&gt;null&lt;/code&gt;</span></span>
<span id="LC896" class="line" lang="java"><span class="cm">         * is returned.</span></span>
<span id="LC897" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC898" class="line" lang="java"><span class="cm">         * @param p the point defining the top-left corner of the</span></span>
<span id="LC899" class="line" lang="java"><span class="cm">         *    &lt;code&gt;Accessible&lt;/code&gt;, given in the coordinate space</span></span>
<span id="LC900" class="line" lang="java"><span class="cm">         *    of the object's parent</span></span>
<span id="LC901" class="line" lang="java"><span class="cm">         * @return the &lt;code&gt;Accessible&lt;/code&gt;, if it exists,</span></span>
<span id="LC902" class="line" lang="java"><span class="cm">         *    at the specified location; else &lt;code&gt;null&lt;/code&gt;</span></span>
<span id="LC903" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC904" class="line" lang="java">        <span class="kd">public</span> <span class="nc">Accessible</span> <span class="nf">getAccessibleAt</span><span class="o">(</span><span class="nc">Point</span> <span class="n">p</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC905" class="line" lang="java">            <span class="k">return</span> <span class="kc">null</span><span class="o">;</span> <span class="c1">// MenuComponents don't have children</span></span>
...
<span id="LC909" class="line" lang="java"><span class="cm">         * Returns whether this object can accept focus or not.</span></span>
<span id="LC910" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC911" class="line" lang="java"><span class="cm">         * @return true if object can accept focus; otherwise false</span></span>
<span id="LC912" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC913" class="line" lang="java">        <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isFocusTraversable</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC914" class="line" lang="java">            <span class="k">return</span> <span class="kc">true</span><span class="o">;</span> <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC918" class="line" lang="java"><span class="cm">         * Requests focus for this object.</span></span>
<span id="LC919" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC920" class="line" lang="java">        <span class="kd">public</span> <span class="kt">void</span> <span class="nf">requestFocus</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC921" class="line" lang="java">            <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC925" class="line" lang="java"><span class="cm">         * Adds the specified focus listener to receive focus events from this</span></span>
<span id="LC926" class="line" lang="java"><span class="cm">         * component.</span></span>
<span id="LC927" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC928" class="line" lang="java"><span class="cm">         * @param l the focus listener</span></span>
<span id="LC929" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC930" class="line" lang="java">        <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addFocusListener</span><span class="o">(</span><span class="n">java</span><span class="o">.</span><span class="na">awt</span><span class="o">.</span><span class="na">event</span><span class="o">.</span><span class="na">FocusListener</span> <span class="n">l</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC931" class="line" lang="java">            <span class="c1">// Not supported for MenuComponents</span></span>
...
<span id="LC935" class="line" lang="java"><span class="cm">         * Removes the specified focus listener so it no longer receives focus</span></span>
<span id="LC936" class="line" lang="java"><span class="cm">         * events from this component.</span></span>
<span id="LC937" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC938" class="line" lang="java"><span class="cm">         * @param l the focus listener</span></span>
<span id="LC939" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC940" class="line" lang="java">        <span class="kd">public</span> <span class="kt">void</span> <span class="nf">removeFocusListener</span><span class="o">(</span><span class="n">java</span><span class="o">.</span><span class="na">awt</span><span class="o">.</span><span class="na">event</span><span class="o">.</span><span class="na">FocusListener</span> <span class="n">l</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC941" class="line" lang="java">            <span class="c1">// Not supported for MenuComponents</span></span>
<span id="LC942" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC943" class="line" lang="java"></span>
<span id="LC944" class="line" lang="java">        <span class="c1">// AccessibleSelection methods</span></span>
...
<span id="LC948" class="line" lang="java"><span class="cm">         * Returns the number of &lt;code&gt;Accessible&lt;/code&gt; children currently selected.</span></span>
<span id="LC949" class="line" lang="java"><span class="cm">         * If no children are selected, the return value will be 0.</span></span>
<span id="LC950" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC951" class="line" lang="java"><span class="cm">         * @return the number of items currently selected</span></span>
<span id="LC952" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC953" class="line" lang="java">         <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getAccessibleSelectionCount</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC954" class="line" lang="java">             <span class="k">return</span> <span class="mi">0</span><span class="o">;</span>  <span class="c1">//  To be fully implemented in a future release</span></span>
...
<span id="LC958" class="line" lang="java"><span class="cm">         * Returns an &lt;code&gt;Accessible&lt;/code&gt; representing the specified</span></span>
<span id="LC959" class="line" lang="java"><span class="cm">         * selected child in the object.  If there isn't a selection, or there are</span></span>
<span id="LC960" class="line" lang="java"><span class="cm">         * fewer children selected than the integer passed in, the return</span></span>
<span id="LC961" class="line" lang="java"><span class="cm">         * value will be &lt;code&gt;null&lt;/code&gt;.</span></span>
<span id="LC962" class="line" lang="java"><span class="cm">         * &lt;p&gt;Note that the index represents the i-th selected child, which</span></span>
<span id="LC963" class="line" lang="java"><span class="cm">         * is different from the i-th child.</span></span>
<span id="LC964" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC965" class="line" lang="java"><span class="cm">         * @param i the zero-based index of selected children</span></span>
<span id="LC966" class="line" lang="java"><span class="cm">         * @return the i-th selected child</span></span>
<span id="LC967" class="line" lang="java"><span class="cm">         * @see #getAccessibleSelectionCount</span></span>
<span id="LC968" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC969" class="line" lang="java">         <span class="kd">public</span> <span class="nc">Accessible</span> <span class="nf">getAccessibleSelection</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC970" class="line" lang="java">             <span class="k">return</span> <span class="kc">null</span><span class="o">;</span>  <span class="c1">//  To be fully implemented in a future release</span></span>
...
<span id="LC974" class="line" lang="java"><span class="cm">         * Determines if the current child of this object is selected.</span></span>
<span id="LC975" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC976" class="line" lang="java"><span class="cm">         * @return true if the current child of this object is selected;</span></span>
<span id="LC977" class="line" lang="java"><span class="cm">         *    else false</span></span>
<span id="LC978" class="line" lang="java"><span class="cm">         * @param i the zero-based index of the child in this</span></span>
<span id="LC979" class="line" lang="java"><span class="cm">         *      &lt;code&gt;Accessible&lt;/code&gt; object</span></span>
<span id="LC980" class="line" lang="java"><span class="cm">         * @see AccessibleContext#getAccessibleChild</span></span>
<span id="LC981" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC982" class="line" lang="java">         <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isAccessibleChildSelected</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC983" class="line" lang="java">             <span class="k">return</span> <span class="kc">false</span><span class="o">;</span>  <span class="c1">//  To be fully implemented in a future release</span></span>
...
<span id="LC987" class="line" lang="java"><span class="cm">         * Adds the specified &lt;code&gt;Accessible&lt;/code&gt; child of the object</span></span>
<span id="LC988" class="line" lang="java"><span class="cm">         * to the object's selection.  If the object supports multiple selections,</span></span>
<span id="LC989" class="line" lang="java"><span class="cm">         * the specified child is added to any existing selection, otherwise</span></span>
<span id="LC990" class="line" lang="java"><span class="cm">         * it replaces any existing selection in the object.  If the</span></span>
<span id="LC991" class="line" lang="java"><span class="cm">         * specified child is already selected, this method has no effect.</span></span>
<span id="LC992" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC993" class="line" lang="java"><span class="cm">         * @param i the zero-based index of the child</span></span>
<span id="LC994" class="line" lang="java"><span class="cm">         * @see AccessibleContext#getAccessibleChild</span></span>
<span id="LC995" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC996" class="line" lang="java">         <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addAccessibleSelection</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC997" class="line" lang="java">               <span class="c1">//  To be fully implemented in a future release</span></span>
...
<span id="LC1001" class="line" lang="java"><span class="cm">         * Removes the specified child of the object from the object's</span></span>
<span id="LC1002" class="line" lang="java"><span class="cm">         * selection.  If the specified item isn't currently selected, this</span></span>
<span id="LC1003" class="line" lang="java"><span class="cm">         * method has no effect.</span></span>
<span id="LC1004" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC1005" class="line" lang="java"><span class="cm">         * @param i the zero-based index of the child</span></span>
<span id="LC1006" class="line" lang="java"><span class="cm">         * @see AccessibleContext#getAccessibleChild</span></span>
<span id="LC1007" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC1008" class="line" lang="java">         <span class="kd">public</span> <span class="kt">void</span> <span class="nf">removeAccessibleSelection</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1009" class="line" lang="java">               <span class="c1">//  To be fully implemented in a future release</span></span>
...
<span id="LC1013" class="line" lang="java"><span class="cm">         * Clears the selection in the object, so that no children in the</span></span>
<span id="LC1014" class="line" lang="java"><span class="cm">         * object are selected.</span></span>
<span id="LC1015" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC1016" class="line" lang="java">         <span class="kd">public</span> <span class="kt">void</span> <span class="nf">clearAccessibleSelection</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC1017" class="line" lang="java">               <span class="c1">//  To be fully implemented in a future release</span></span>
...
<span id="LC1021" class="line" lang="java"><span class="cm">         * Causes every child of the object to be selected</span></span>
<span id="LC1022" class="line" lang="java"><span class="cm">         * if the object supports multiple selections.</span></span>
<span id="LC1023" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC1024" class="line" lang="java">         <span class="kd">public</span> <span class="kt">void</span> <span class="nf">selectAllAccessibleSelection</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC1025" class="line" lang="java">               <span class="c1">//  To be fully implemented in a future release</span></span>
<span id="LC1026" class="line" lang="java">         <span class="o">}</span></span>
<span id="LC1027" class="line" lang="java"></span>
<span id="LC1028" class="line" lang="java">    <span class="o">}</span> <span class="c1">// inner class AccessibleAWTComponent</span></span>
<span id="LC1029" class="line" lang="java"></span>
<span id="LC1030" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1031" class="line" lang="java"><span class="cm">     * Gets the index of this object in its accessible parent.</span></span>
<span id="LC1032" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1033" class="line" lang="java"><span class="cm">     * @return -1 if this object does not have an accessible parent;</span></span>
<span id="LC1034" class="line" lang="java"><span class="cm">     *      otherwise, the index of the child in its accessible parent.</span></span>
<span id="LC1035" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1036" class="line" lang="java">    <span class="kt">int</span> <span class="nf">getAccessibleIndexInParent</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC1037" class="line" lang="java">        <span class="nc">MenuContainer</span> <span class="n">localParent</span> <span class="o">=</span> <span class="n">parent</span><span class="o">;</span></span>
<span id="LC1038" class="line" lang="java">        <span class="k">if</span> <span class="o">(!(</span><span class="n">localParent</span> <span class="k">instanceof</span> <span class="nc">MenuComponent</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC1039" class="line" lang="java">            <span class="c1">// MenuComponents only have accessible index when inside MenuComponents</span></span>
...
<span id="LC1042" class="line" lang="java">        <span class="nc">MenuComponent</span> <span class="n">localParentMenu</span> <span class="o">=</span> <span class="o">(</span><span class="nc">MenuComponent</span><span class="o">)</span><span class="n">localParent</span><span class="o">;</span></span>
<span id="LC1043" class="line" lang="java">        <span class="k">return</span> <span class="n">localParentMenu</span><span class="o">.</span><span class="na">getAccessibleChildIndex</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
...
<span id="LC1047" class="line" lang="java"><span class="cm">     * Gets the index of the child within this MenuComponent.</span></span>
<span id="LC1048" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1049" class="line" lang="java"><span class="cm">     * @param child MenuComponent whose index we are interested in.</span></span>
<span id="LC1050" class="line" lang="java"><span class="cm">     * @return -1 if this object doesn't contain the child,</span></span>
<span id="LC1051" class="line" lang="java"><span class="cm">     *      otherwise, index of the child.</span></span>
<span id="LC1052" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1053" class="line" lang="java">    <span class="kt">int</span> <span class="nf">getAccessibleChildIndex</span><span class="o">(</span><span class="nc">MenuComponent</span> <span class="n">child</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1054" class="line" lang="java">        <span class="k">return</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span> <span class="c1">// Overridden in subclasses.</span></span>
...
<span id="LC1058" class="line" lang="java"><span class="cm">     * Gets the state of this object.</span></span>
<span id="LC1059" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1060" class="line" lang="java"><span class="cm">     * @return an instance of &lt;code&gt;AccessibleStateSet&lt;/code&gt;</span></span>
<span id="LC1061" class="line" lang="java"><span class="cm">     *     containing the current state set of the object</span></span>
<span id="LC1062" class="line" lang="java"><span class="cm">     * @see AccessibleState</span></span>
<span id="LC1063" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1064" class="line" lang="java">    <span class="nc">AccessibleStateSet</span> <span class="nf">getAccessibleStateSet</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC1065" class="line" lang="java">        <span class="nc">AccessibleStateSet</span> <span class="n">states</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">AccessibleStateSet</span><span class="o">();</span></span>
<span id="LC1066" class="line" lang="java">        <span class="k">return</span> <span class="n">states</span><span class="o">;</span></span>
