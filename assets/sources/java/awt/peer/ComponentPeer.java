...
<span id="LC26" class="line" lang="java"><span class="kn">package</span> <span class="nn">java.awt.peer</span><span class="o">;</span></span>
...
<span id="LC29" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.awt.event.PaintEvent</span><span class="o">;</span></span>
...
<span id="LC31" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.awt.image.ImageObserver</span><span class="o">;</span></span>
<span id="LC32" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.awt.image.ImageProducer</span><span class="o">;</span></span>
<span id="LC33" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.awt.image.VolatileImage</span><span class="o">;</span></span>
<span id="LC34" class="line" lang="java"></span>
<span id="LC35" class="line" lang="java"><span class="kn">import</span> <span class="nn">sun.awt.CausedFocusEvent</span><span class="o">;</span></span>
<span id="LC36" class="line" lang="java"><span class="kn">import</span> <span class="nn">sun.java2d.pipe.Region</span><span class="o">;</span></span>
...
<span id="LC40" class="line" lang="java"><span class="cm"> * The peer interface for {@link Component}. This is the top level peer</span></span>
<span id="LC41" class="line" lang="java"><span class="cm"> * interface for widgets and defines the bulk of methods for AWT component</span></span>
<span id="LC42" class="line" lang="java"><span class="cm"> * peers. Most component peers have to implement this interface (via one</span></span>
<span id="LC43" class="line" lang="java"><span class="cm"> * of the subinterfaces), except menu components, which implement</span></span>
<span id="LC44" class="line" lang="java"><span class="cm"> * {@link MenuComponentPeer}.</span></span>
<span id="LC45" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> * The peer interfaces are intended only for use in porting</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * the AWT. They are not intended for use by application</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * developers, and developers should not implement peers</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * nor invoke any of the peer methods directly on the peer</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> * instances.</span></span>
<span id="LC51" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC52" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">ComponentPeer</span> <span class="o">{</span></span>
<span id="LC53" class="line" lang="java"></span>
<span id="LC54" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">     * Operation for {@link #setBounds(int, int, int, int, int)}, indicating</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">     * a change in the component location only.</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC58" class="line" lang="java"><span class="cm">     * @see #setBounds(int, int, int, int, int)</span></span>
<span id="LC59" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC60" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">SET_LOCATION</span> <span class="o">=</span> <span class="mi">1</span><span class="o">;</span></span>
<span id="LC61" class="line" lang="java"></span>
<span id="LC62" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC63" class="line" lang="java"><span class="cm">     * Operation for {@link #setBounds(int, int, int, int, int)}, indicating</span></span>
<span id="LC64" class="line" lang="java"><span class="cm">     * a change in the component size only.</span></span>
<span id="LC65" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC66" class="line" lang="java"><span class="cm">     * @see #setBounds(int, int, int, int, int)</span></span>
<span id="LC67" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC68" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">SET_SIZE</span> <span class="o">=</span> <span class="mi">2</span><span class="o">;</span></span>
<span id="LC69" class="line" lang="java"></span>
<span id="LC70" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC71" class="line" lang="java"><span class="cm">     * Operation for {@link #setBounds(int, int, int, int, int)}, indicating</span></span>
<span id="LC72" class="line" lang="java"><span class="cm">     * a change in the component size and location.</span></span>
<span id="LC73" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC74" class="line" lang="java"><span class="cm">     * @see #setBounds(int, int, int, int, int)</span></span>
<span id="LC75" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC76" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">SET_BOUNDS</span> <span class="o">=</span> <span class="mi">3</span><span class="o">;</span></span>
<span id="LC77" class="line" lang="java"></span>
<span id="LC78" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC79" class="line" lang="java"><span class="cm">     * Operation for {@link #setBounds(int, int, int, int, int)}, indicating</span></span>
<span id="LC80" class="line" lang="java"><span class="cm">     * a change in the component client size. This is used for setting</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">     * the 'inside' size of windows, without the border insets.</span></span>
<span id="LC82" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">     * @see #setBounds(int, int, int, int, int)</span></span>
<span id="LC84" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC85" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">SET_CLIENT_SIZE</span> <span class="o">=</span> <span class="mi">4</span><span class="o">;</span></span>
<span id="LC86" class="line" lang="java"></span>
<span id="LC87" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC88" class="line" lang="java"><span class="cm">     * Resets the setBounds() operation to DEFAULT_OPERATION. This is not</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">     * passed into {@link #setBounds(int, int, int, int, int)}.</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">     * TODO: This is only used internally and should probably be moved outside</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">     *       the peer interface.</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">     * @see Component#setBoundsOp</span></span>
<span id="LC95" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC96" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">RESET_OPERATION</span> <span class="o">=</span> <span class="mi">5</span><span class="o">;</span></span>
<span id="LC97" class="line" lang="java"></span>
<span id="LC98" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC99" class="line" lang="java"><span class="cm">     * A flag that is used to suppress checks for embedded frames.</span></span>
<span id="LC100" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">     * TODO: This is only used internally and should probably be moved outside</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">     *       the peer interface.</span></span>
<span id="LC103" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC104" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">NO_EMBEDDED_CHECK</span> <span class="o">=</span> <span class="o">(</span><span class="mi">1</span> <span class="o">&lt;&lt;</span> <span class="mi">14</span><span class="o">);</span></span>
<span id="LC105" class="line" lang="java"></span>
<span id="LC106" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">     * The default operation, which is to set size and location.</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC109" class="line" lang="java"><span class="cm">     * TODO: This is only used internally and should probably be moved outside</span></span>
<span id="LC110" class="line" lang="java"><span class="cm">     *       the peer interface.</span></span>
<span id="LC111" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC112" class="line" lang="java"><span class="cm">     * @see Component#setBoundsOp</span></span>
<span id="LC113" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC114" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">DEFAULT_OPERATION</span> <span class="o">=</span> <span class="no">SET_BOUNDS</span><span class="o">;</span></span>
<span id="LC115" class="line" lang="java"></span>
<span id="LC116" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC117" class="line" lang="java"><span class="cm">     * Determines if a component has been obscured, i.e. by an overlapping</span></span>
<span id="LC118" class="line" lang="java"><span class="cm">     * window or similar. This is used by JViewport for optimizing performance.</span></span>
<span id="LC119" class="line" lang="java"><span class="cm">     * This doesn't have to be implemented, when</span></span>
<span id="LC120" class="line" lang="java"><span class="cm">     * {@link #canDetermineObscurity()} returns {@code false}.</span></span>
<span id="LC121" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC122" class="line" lang="java"><span class="cm">     * @return {@code true} when the component has been obscured,</span></span>
<span id="LC123" class="line" lang="java"><span class="cm">     *         {@code false} otherwise</span></span>
<span id="LC124" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC125" class="line" lang="java"><span class="cm">     * @see #canDetermineObscurity()</span></span>
<span id="LC126" class="line" lang="java"><span class="cm">     * @see javax.swing.JViewport#needsRepaintAfterBlit</span></span>
<span id="LC127" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC128" class="line" lang="java">    <span class="kt">boolean</span> <span class="nf">isObscured</span><span class="o">();</span></span>
<span id="LC129" class="line" lang="java"></span>
<span id="LC130" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC131" class="line" lang="java"><span class="cm">     * Returns {@code true} when the peer can determine if a component</span></span>
<span id="LC132" class="line" lang="java"><span class="cm">     * has been obscured, {@code false} false otherwise.</span></span>
<span id="LC133" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC134" class="line" lang="java"><span class="cm">     * @return {@code true} when the peer can determine if a component</span></span>
<span id="LC135" class="line" lang="java"><span class="cm">     *         has been obscured, {@code false} false otherwise</span></span>
<span id="LC136" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC137" class="line" lang="java"><span class="cm">     * @see #isObscured()</span></span>
<span id="LC138" class="line" lang="java"><span class="cm">     * @see javax.swing.JViewport#needsRepaintAfterBlit</span></span>
<span id="LC139" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC140" class="line" lang="java">    <span class="kt">boolean</span> <span class="nf">canDetermineObscurity</span><span class="o">();</span></span>
<span id="LC141" class="line" lang="java"></span>
<span id="LC142" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC143" class="line" lang="java"><span class="cm">     * Makes a component visible or invisible.</span></span>
<span id="LC144" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">     * @param v {@code true} to make a component visible,</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">     *          {@code false} to make it invisible</span></span>
<span id="LC147" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC148" class="line" lang="java"><span class="cm">     * @see Component#setVisible(boolean)</span></span>
<span id="LC149" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC150" class="line" lang="java">    <span class="kt">void</span> <span class="nf">setVisible</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">v</span><span class="o">);</span></span>
<span id="LC151" class="line" lang="java"></span>
<span id="LC152" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC153" class="line" lang="java"><span class="cm">     * Enables or disables a component. Disabled components are usually grayed</span></span>
<span id="LC154" class="line" lang="java"><span class="cm">     * out and cannot be activated.</span></span>
<span id="LC155" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC156" class="line" lang="java"><span class="cm">     * @param e {@code true} to enable the component, {@code false}</span></span>
<span id="LC157" class="line" lang="java"><span class="cm">     *          to disable it</span></span>
<span id="LC158" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC159" class="line" lang="java"><span class="cm">     * @see Component#setEnabled(boolean)</span></span>
<span id="LC160" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC161" class="line" lang="java">    <span class="kt">void</span> <span class="nf">setEnabled</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">e</span><span class="o">);</span></span>
<span id="LC162" class="line" lang="java"></span>
<span id="LC163" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC164" class="line" lang="java"><span class="cm">     * Paints the component to the specified graphics context. This is called</span></span>
<span id="LC165" class="line" lang="java"><span class="cm">     * by {@link Component#paintAll(Graphics)} to paint the component.</span></span>
<span id="LC166" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC167" class="line" lang="java"><span class="cm">     * @param g the graphics context to paint to</span></span>
<span id="LC168" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC169" class="line" lang="java"><span class="cm">     * @see Component#paintAll(Graphics)</span></span>
<span id="LC170" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC171" class="line" lang="java">    <span class="kt">void</span> <span class="nf">paint</span><span class="o">(</span><span class="nc">Graphics</span> <span class="n">g</span><span class="o">);</span></span>
<span id="LC172" class="line" lang="java"></span>
<span id="LC173" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC174" class="line" lang="java"><span class="cm">     * Prints the component to the specified graphics context. This is called</span></span>
<span id="LC175" class="line" lang="java"><span class="cm">     * by {@link Component#printAll(Graphics)} to print the component.</span></span>
<span id="LC176" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC177" class="line" lang="java"><span class="cm">     * @param g the graphics context to print to</span></span>
<span id="LC178" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC179" class="line" lang="java"><span class="cm">     * @see Component#printAll(Graphics)</span></span>
<span id="LC180" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC181" class="line" lang="java">    <span class="kt">void</span> <span class="nf">print</span><span class="o">(</span><span class="nc">Graphics</span> <span class="n">g</span><span class="o">);</span></span>
<span id="LC182" class="line" lang="java"></span>
<span id="LC183" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC184" class="line" lang="java"><span class="cm">     * Sets the location or size or both of the component. The location is</span></span>
<span id="LC185" class="line" lang="java"><span class="cm">     * specified relative to the component's parent. The {@code op}</span></span>
<span id="LC186" class="line" lang="java"><span class="cm">     * parameter specifies which properties change. If it is</span></span>
<span id="LC187" class="line" lang="java"><span class="cm">     * {@link #SET_LOCATION}, then only the location changes (and the size</span></span>
<span id="LC188" class="line" lang="java"><span class="cm">     * parameters can be ignored). If {@code op} is {@link #SET_SIZE},</span></span>
<span id="LC189" class="line" lang="java"><span class="cm">     * then only the size changes (and the location can be ignored). If</span></span>
<span id="LC190" class="line" lang="java"><span class="cm">     * {@code op} is {@link #SET_BOUNDS}, then both change. There is a</span></span>
<span id="LC191" class="line" lang="java"><span class="cm">     * special value {@link #SET_CLIENT_SIZE}, which is used only for</span></span>
<span id="LC192" class="line" lang="java"><span class="cm">     * window-like components to set the size of the client (i.e. the 'inner'</span></span>
<span id="LC193" class="line" lang="java"><span class="cm">     * size, without the insets of the window borders).</span></span>
<span id="LC194" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC195" class="line" lang="java"><span class="cm">     * @param x the X location of the component</span></span>
<span id="LC196" class="line" lang="java"><span class="cm">     * @param y the Y location of the component</span></span>
<span id="LC197" class="line" lang="java"><span class="cm">     * @param width the width of the component</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">     * @param height the height of the component</span></span>
<span id="LC199" class="line" lang="java"><span class="cm">     * @param op the operation flag</span></span>
<span id="LC200" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC201" class="line" lang="java"><span class="cm">     * @see #SET_BOUNDS</span></span>
<span id="LC202" class="line" lang="java"><span class="cm">     * @see #SET_LOCATION</span></span>
<span id="LC203" class="line" lang="java"><span class="cm">     * @see #SET_SIZE</span></span>
<span id="LC204" class="line" lang="java"><span class="cm">     * @see #SET_CLIENT_SIZE</span></span>
<span id="LC205" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC206" class="line" lang="java">    <span class="kt">void</span> <span class="nf">setBounds</span><span class="o">(</span><span class="kt">int</span> <span class="n">x</span><span class="o">,</span> <span class="kt">int</span> <span class="n">y</span><span class="o">,</span> <span class="kt">int</span> <span class="n">width</span><span class="o">,</span> <span class="kt">int</span> <span class="n">height</span><span class="o">,</span> <span class="kt">int</span> <span class="n">op</span><span class="o">);</span></span>
<span id="LC207" class="line" lang="java"></span>
<span id="LC208" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC209" class="line" lang="java"><span class="cm">     * Called to let the component peer handle events.</span></span>
<span id="LC210" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC211" class="line" lang="java"><span class="cm">     * @param e the AWT event to handle</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC213" class="line" lang="java"><span class="cm">     * @see Component#dispatchEvent(AWTEvent)</span></span>
<span id="LC214" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC215" class="line" lang="java">    <span class="kt">void</span> <span class="nf">handleEvent</span><span class="o">(</span><span class="nc">AWTEvent</span> <span class="n">e</span><span class="o">);</span></span>
<span id="LC216" class="line" lang="java"></span>
<span id="LC217" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC218" class="line" lang="java"><span class="cm">     * Called to coalesce paint events.</span></span>
<span id="LC219" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC220" class="line" lang="java"><span class="cm">     * @param e the paint event to consider to coalesce</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC222" class="line" lang="java"><span class="cm">     * @see EventQueue#coalescePaintEvent</span></span>
<span id="LC223" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC224" class="line" lang="java">    <span class="kt">void</span> <span class="nf">coalescePaintEvent</span><span class="o">(</span><span class="nc">PaintEvent</span> <span class="n">e</span><span class="o">);</span></span>
<span id="LC225" class="line" lang="java"></span>
<span id="LC226" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC227" class="line" lang="java"><span class="cm">     * Determines the location of the component on the screen.</span></span>
<span id="LC228" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC229" class="line" lang="java"><span class="cm">     * @return the location of the component on the screen</span></span>
<span id="LC230" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC231" class="line" lang="java"><span class="cm">     * @see Component#getLocationOnScreen()</span></span>
<span id="LC232" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC233" class="line" lang="java">    <span class="nc">Point</span> <span class="nf">getLocationOnScreen</span><span class="o">();</span></span>
<span id="LC234" class="line" lang="java"></span>
<span id="LC235" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC236" class="line" lang="java"><span class="cm">     * Determines the preferred size of the component.</span></span>
<span id="LC237" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC238" class="line" lang="java"><span class="cm">     * @return the preferred size of the component</span></span>
<span id="LC239" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC240" class="line" lang="java"><span class="cm">     * @see Component#getPreferredSize()</span></span>
<span id="LC241" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC242" class="line" lang="java">    <span class="nc">Dimension</span> <span class="nf">getPreferredSize</span><span class="o">();</span></span>
<span id="LC243" class="line" lang="java"></span>
<span id="LC244" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC245" class="line" lang="java"><span class="cm">     * Determines the minimum size of the component.</span></span>
<span id="LC246" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC247" class="line" lang="java"><span class="cm">     * @return the minimum size of the component</span></span>
<span id="LC248" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC249" class="line" lang="java"><span class="cm">     * @see Component#getMinimumSize()</span></span>
<span id="LC250" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC251" class="line" lang="java">    <span class="nc">Dimension</span> <span class="nf">getMinimumSize</span><span class="o">();</span></span>
<span id="LC252" class="line" lang="java"></span>
<span id="LC253" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC254" class="line" lang="java"><span class="cm">     * Returns the color model used by the component.</span></span>
<span id="LC255" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC256" class="line" lang="java"><span class="cm">     * @return the color model used by the component</span></span>
<span id="LC257" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC258" class="line" lang="java"><span class="cm">     * @see Component#getColorModel()</span></span>
<span id="LC259" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC260" class="line" lang="java">    <span class="nc">ColorModel</span> <span class="nf">getColorModel</span><span class="o">();</span></span>
<span id="LC261" class="line" lang="java"></span>
<span id="LC262" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC263" class="line" lang="java"><span class="cm">     * Returns a graphics object to paint on the component.</span></span>
<span id="LC264" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC265" class="line" lang="java"><span class="cm">     * @return a graphics object to paint on the component</span></span>
<span id="LC266" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC267" class="line" lang="java"><span class="cm">     * @see Component#getGraphics()</span></span>
<span id="LC268" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC269" class="line" lang="java">    <span class="c1">// TODO: Maybe change this to force Graphics2D, since many things will</span></span>
<span id="LC270" class="line" lang="java">    <span class="c1">// break with plain Graphics nowadays.</span></span>
<span id="LC271" class="line" lang="java">    <span class="nc">Graphics</span> <span class="nf">getGraphics</span><span class="o">();</span></span>
<span id="LC272" class="line" lang="java"></span>
<span id="LC273" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC274" class="line" lang="java"><span class="cm">     * Returns a font metrics object to determine the metrics properties of</span></span>
<span id="LC275" class="line" lang="java"><span class="cm">     * the specified font.</span></span>
<span id="LC276" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC277" class="line" lang="java"><span class="cm">     * @param font the font to determine the metrics for</span></span>
<span id="LC278" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC279" class="line" lang="java"><span class="cm">     * @return a font metrics object to determine the metrics properties of</span></span>
<span id="LC280" class="line" lang="java"><span class="cm">     *         the specified font</span></span>
<span id="LC281" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC282" class="line" lang="java"><span class="cm">     * @see Component#getFontMetrics(Font)</span></span>
<span id="LC283" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC284" class="line" lang="java">    <span class="nc">FontMetrics</span> <span class="nf">getFontMetrics</span><span class="o">(</span><span class="nc">Font</span> <span class="n">font</span><span class="o">);</span></span>
<span id="LC285" class="line" lang="java"></span>
<span id="LC286" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC287" class="line" lang="java"><span class="cm">     * Disposes all resources held by the component peer. This is called</span></span>
<span id="LC288" class="line" lang="java"><span class="cm">     * when the component has been disconnected from the component hierarchy</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">     * and is about to be garbage collected.</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC291" class="line" lang="java"><span class="cm">     * @see Component#removeNotify()</span></span>
<span id="LC292" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC293" class="line" lang="java">    <span class="kt">void</span> <span class="nf">dispose</span><span class="o">();</span></span>
<span id="LC294" class="line" lang="java"></span>
<span id="LC295" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC296" class="line" lang="java"><span class="cm">     * Sets the foreground color of this component.</span></span>
<span id="LC297" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC298" class="line" lang="java"><span class="cm">     * @param c the foreground color to set</span></span>
<span id="LC299" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC300" class="line" lang="java"><span class="cm">     * @see Component#setForeground(Color)</span></span>
<span id="LC301" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC302" class="line" lang="java">    <span class="kt">void</span> <span class="nf">setForeground</span><span class="o">(</span><span class="nc">Color</span> <span class="n">c</span><span class="o">);</span></span>
<span id="LC303" class="line" lang="java"></span>
<span id="LC304" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC305" class="line" lang="java"><span class="cm">     * Sets the background color of this component.</span></span>
<span id="LC306" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC307" class="line" lang="java"><span class="cm">     * @param c the background color to set</span></span>
<span id="LC308" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC309" class="line" lang="java"><span class="cm">     * @see Component#setBackground(Color)</span></span>
<span id="LC310" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC311" class="line" lang="java">    <span class="kt">void</span> <span class="nf">setBackground</span><span class="o">(</span><span class="nc">Color</span> <span class="n">c</span><span class="o">);</span></span>
<span id="LC312" class="line" lang="java"></span>
<span id="LC313" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC314" class="line" lang="java"><span class="cm">     * Sets the font of this component.</span></span>
<span id="LC315" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC316" class="line" lang="java"><span class="cm">     * @param f the font of this component</span></span>
<span id="LC317" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC318" class="line" lang="java"><span class="cm">     * @see Component#setFont(Font)</span></span>
<span id="LC319" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC320" class="line" lang="java">    <span class="kt">void</span> <span class="nf">setFont</span><span class="o">(</span><span class="nc">Font</span> <span class="n">f</span><span class="o">);</span></span>
<span id="LC321" class="line" lang="java"></span>
<span id="LC322" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC323" class="line" lang="java"><span class="cm">     * Updates the cursor of the component.</span></span>
<span id="LC324" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC325" class="line" lang="java"><span class="cm">     * @see Component#updateCursorImmediately</span></span>
<span id="LC326" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC327" class="line" lang="java">    <span class="kt">void</span> <span class="nf">updateCursorImmediately</span><span class="o">();</span></span>
<span id="LC328" class="line" lang="java"></span>
<span id="LC329" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC330" class="line" lang="java"><span class="cm">     * Requests focus on this component.</span></span>
<span id="LC331" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC332" class="line" lang="java"><span class="cm">     * @param lightweightChild the actual lightweight child that requests the</span></span>
<span id="LC333" class="line" lang="java"><span class="cm">     *        focus</span></span>
<span id="LC334" class="line" lang="java"><span class="cm">     * @param temporary {@code true} if the focus change is temporary,</span></span>
<span id="LC335" class="line" lang="java"><span class="cm">     *        {@code false} otherwise</span></span>
<span id="LC336" class="line" lang="java"><span class="cm">     * @param focusedWindowChangeAllowed {@code true} if changing the</span></span>
<span id="LC337" class="line" lang="java"><span class="cm">     *        focus of the containing window is allowed or not</span></span>
<span id="LC338" class="line" lang="java"><span class="cm">     * @param time the time of the focus change request</span></span>
<span id="LC339" class="line" lang="java"><span class="cm">     * @param cause the cause of the focus change request</span></span>
<span id="LC340" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">     * @return {@code true} if the focus change is guaranteed to be</span></span>
<span id="LC342" class="line" lang="java"><span class="cm">     *         granted, {@code false} otherwise</span></span>
<span id="LC343" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC344" class="line" lang="java">    <span class="kt">boolean</span> <span class="nf">requestFocus</span><span class="o">(</span><span class="nc">Component</span> <span class="n">lightweightChild</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">temporary</span><span class="o">,</span></span>
<span id="LC345" class="line" lang="java">                         <span class="kt">boolean</span> <span class="n">focusedWindowChangeAllowed</span><span class="o">,</span> <span class="kt">long</span> <span class="n">time</span><span class="o">,</span></span>
<span id="LC346" class="line" lang="java">                         <span class="nc">CausedFocusEvent</span><span class="o">.</span><span class="na">Cause</span> <span class="n">cause</span><span class="o">);</span></span>
<span id="LC347" class="line" lang="java"></span>
<span id="LC348" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC349" class="line" lang="java"><span class="cm">     * Returns {@code true} when the component takes part in the focus</span></span>
<span id="LC350" class="line" lang="java"><span class="cm">     * traversal, {@code false} otherwise.</span></span>
<span id="LC351" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC352" class="line" lang="java"><span class="cm">     * @return {@code true} when the component takes part in the focus</span></span>
<span id="LC353" class="line" lang="java"><span class="cm">     *         traversal, {@code false} otherwise</span></span>
<span id="LC354" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC355" class="line" lang="java">    <span class="kt">boolean</span> <span class="nf">isFocusable</span><span class="o">();</span></span>
<span id="LC356" class="line" lang="java"></span>
<span id="LC357" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC358" class="line" lang="java"><span class="cm">     * Creates an image using the specified image producer.</span></span>
<span id="LC359" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC360" class="line" lang="java"><span class="cm">     * @param producer the image producer from which the image pixels will be</span></span>
<span id="LC361" class="line" lang="java"><span class="cm">     *        produced</span></span>
<span id="LC362" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC363" class="line" lang="java"><span class="cm">     * @return the created image</span></span>
<span id="LC364" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC365" class="line" lang="java"><span class="cm">     * @see Component#createImage(ImageProducer)</span></span>
<span id="LC366" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC367" class="line" lang="java">    <span class="nc">Image</span> <span class="nf">createImage</span><span class="o">(</span><span class="nc">ImageProducer</span> <span class="n">producer</span><span class="o">);</span></span>
<span id="LC368" class="line" lang="java"></span>
<span id="LC369" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC370" class="line" lang="java"><span class="cm">     * Creates an empty image with the specified width and height. This is</span></span>
<span id="LC371" class="line" lang="java"><span class="cm">     * generally used as a non-accelerated backbuffer for drawing onto the</span></span>
<span id="LC372" class="line" lang="java"><span class="cm">     * component (e.g. by Swing).</span></span>
<span id="LC373" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC374" class="line" lang="java"><span class="cm">     * @param width the width of the image</span></span>
<span id="LC375" class="line" lang="java"><span class="cm">     * @param height the height of the image</span></span>
<span id="LC376" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC377" class="line" lang="java"><span class="cm">     * @return the created image</span></span>
<span id="LC378" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC379" class="line" lang="java"><span class="cm">     * @see Component#createImage(int, int)</span></span>
<span id="LC380" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC381" class="line" lang="java">    <span class="c1">// TODO: Maybe make that return a BufferedImage, because some stuff will</span></span>
<span id="LC382" class="line" lang="java">    <span class="c1">// break if a different kind of image is returned.</span></span>
<span id="LC383" class="line" lang="java">    <span class="nc">Image</span> <span class="nf">createImage</span><span class="o">(</span><span class="kt">int</span> <span class="n">width</span><span class="o">,</span> <span class="kt">int</span> <span class="n">height</span><span class="o">);</span></span>
<span id="LC384" class="line" lang="java"></span>
<span id="LC385" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC386" class="line" lang="java"><span class="cm">     * Creates an empty volatile image with the specified width and height.</span></span>
<span id="LC387" class="line" lang="java"><span class="cm">     * This is generally used as an accelerated backbuffer for drawing onto</span></span>
<span id="LC388" class="line" lang="java"><span class="cm">     * the component (e.g. by Swing).</span></span>
<span id="LC389" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC390" class="line" lang="java"><span class="cm">     * @param width the width of the image</span></span>
<span id="LC391" class="line" lang="java"><span class="cm">     * @param height the height of the image</span></span>
<span id="LC392" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC393" class="line" lang="java"><span class="cm">     * @return the created volatile image</span></span>
<span id="LC394" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC395" class="line" lang="java"><span class="cm">     * @see Component#createVolatileImage(int, int)</span></span>
<span id="LC396" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC397" class="line" lang="java">    <span class="c1">// TODO: Include capabilities here and fix Component#createVolatileImage</span></span>
<span id="LC398" class="line" lang="java">    <span class="nc">VolatileImage</span> <span class="nf">createVolatileImage</span><span class="o">(</span><span class="kt">int</span> <span class="n">width</span><span class="o">,</span> <span class="kt">int</span> <span class="n">height</span><span class="o">);</span></span>
<span id="LC399" class="line" lang="java"></span>
<span id="LC400" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC401" class="line" lang="java"><span class="cm">     * Prepare the specified image for rendering on this component. This should</span></span>
<span id="LC402" class="line" lang="java"><span class="cm">     * start loading the image (if not already loaded) and create an</span></span>
<span id="LC403" class="line" lang="java"><span class="cm">     * appropriate screen representation.</span></span>
<span id="LC404" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC405" class="line" lang="java"><span class="cm">     * @param img the image to prepare</span></span>
<span id="LC406" class="line" lang="java"><span class="cm">     * @param w the width of the screen representation</span></span>
<span id="LC407" class="line" lang="java"><span class="cm">     * @param h the height of the screen representation</span></span>
<span id="LC408" class="line" lang="java"><span class="cm">     * @param o an image observer to observe the progress</span></span>
<span id="LC409" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC410" class="line" lang="java"><span class="cm">     * @return {@code true} if the image is already fully prepared,</span></span>
<span id="LC411" class="line" lang="java"><span class="cm">     *         {@code false} otherwise</span></span>
<span id="LC412" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC413" class="line" lang="java"><span class="cm">     * @see Component#prepareImage(Image, int, int, ImageObserver)</span></span>
<span id="LC414" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC415" class="line" lang="java">    <span class="kt">boolean</span> <span class="nf">prepareImage</span><span class="o">(</span><span class="nc">Image</span> <span class="n">img</span><span class="o">,</span> <span class="kt">int</span> <span class="n">w</span><span class="o">,</span> <span class="kt">int</span> <span class="n">h</span><span class="o">,</span> <span class="nc">ImageObserver</span> <span class="n">o</span><span class="o">);</span></span>
<span id="LC416" class="line" lang="java"></span>
<span id="LC417" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC418" class="line" lang="java"><span class="cm">     * Determines the status of the construction of the screen representaion</span></span>
<span id="LC419" class="line" lang="java"><span class="cm">     * of the specified image.</span></span>
<span id="LC420" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">     * @param img the image to check</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">     * @param w the target width</span></span>
<span id="LC423" class="line" lang="java"><span class="cm">     * @param h the target height</span></span>
<span id="LC424" class="line" lang="java"><span class="cm">     * @param o the image observer to notify</span></span>
<span id="LC425" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">     * @return the status as bitwise ORed ImageObserver flags</span></span>
<span id="LC427" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC428" class="line" lang="java"><span class="cm">     * @see Component#checkImage(Image, int, int, ImageObserver)</span></span>
<span id="LC429" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC430" class="line" lang="java">    <span class="kt">int</span> <span class="nf">checkImage</span><span class="o">(</span><span class="nc">Image</span> <span class="n">img</span><span class="o">,</span> <span class="kt">int</span> <span class="n">w</span><span class="o">,</span> <span class="kt">int</span> <span class="n">h</span><span class="o">,</span> <span class="nc">ImageObserver</span> <span class="n">o</span><span class="o">);</span></span>
<span id="LC431" class="line" lang="java"></span>
<span id="LC432" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC433" class="line" lang="java"><span class="cm">     * Returns the graphics configuration that corresponds to this component.</span></span>
<span id="LC434" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC435" class="line" lang="java"><span class="cm">     * @return the graphics configuration that corresponds to this component</span></span>
<span id="LC436" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC437" class="line" lang="java"><span class="cm">     * @see Component#getGraphicsConfiguration()</span></span>
<span id="LC438" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC439" class="line" lang="java">    <span class="nc">GraphicsConfiguration</span> <span class="nf">getGraphicsConfiguration</span><span class="o">();</span></span>
<span id="LC440" class="line" lang="java"></span>
<span id="LC441" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC442" class="line" lang="java"><span class="cm">     * Determines if the component handles wheel scrolling itself. Otherwise</span></span>
<span id="LC443" class="line" lang="java"><span class="cm">     * it is delegated to the component's parent.</span></span>
<span id="LC444" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC445" class="line" lang="java"><span class="cm">     * @return {@code true} if the component handles wheel scrolling,</span></span>
<span id="LC446" class="line" lang="java"><span class="cm">     *         {@code false} otherwise</span></span>
<span id="LC447" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC448" class="line" lang="java"><span class="cm">     * @see Component#dispatchEventImpl(AWTEvent)</span></span>
<span id="LC449" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC450" class="line" lang="java">    <span class="kt">boolean</span> <span class="nf">handlesWheelScrolling</span><span class="o">();</span></span>
<span id="LC451" class="line" lang="java"></span>
<span id="LC452" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC453" class="line" lang="java"><span class="cm">     * Create {@code numBuffers} flipping buffers with the specified</span></span>
<span id="LC454" class="line" lang="java"><span class="cm">     * buffer capabilities.</span></span>
<span id="LC455" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC456" class="line" lang="java"><span class="cm">     * @param numBuffers the number of buffers to create</span></span>
<span id="LC457" class="line" lang="java"><span class="cm">     * @param caps the buffer capabilities</span></span>
<span id="LC458" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC459" class="line" lang="java"><span class="cm">     * @throws AWTException if flip buffering is not supported</span></span>
<span id="LC460" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC461" class="line" lang="java"><span class="cm">     * @see Component.FlipBufferStrategy#createBuffers</span></span>
<span id="LC462" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC463" class="line" lang="java">    <span class="kt">void</span> <span class="nf">createBuffers</span><span class="o">(</span><span class="kt">int</span> <span class="n">numBuffers</span><span class="o">,</span> <span class="nc">BufferCapabilities</span> <span class="n">caps</span><span class="o">)</span></span>
<span id="LC464" class="line" lang="java">         <span class="kd">throws</span> <span class="nc">AWTException</span><span class="o">;</span></span>
<span id="LC465" class="line" lang="java"></span>
<span id="LC466" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC467" class="line" lang="java"><span class="cm">     * Returns the back buffer as image.</span></span>
<span id="LC468" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC469" class="line" lang="java"><span class="cm">     * @return the back buffer as image</span></span>
<span id="LC470" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC471" class="line" lang="java"><span class="cm">     * @see Component.FlipBufferStrategy#getBackBuffer</span></span>
<span id="LC472" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC473" class="line" lang="java">    <span class="nc">Image</span> <span class="nf">getBackBuffer</span><span class="o">();</span></span>
<span id="LC474" class="line" lang="java"></span>
<span id="LC475" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC476" class="line" lang="java"><span class="cm">     * Move the back buffer to the front buffer.</span></span>
<span id="LC477" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC478" class="line" lang="java"><span class="cm">     * @param x1 the area to be flipped, upper left X coordinate</span></span>
<span id="LC479" class="line" lang="java"><span class="cm">     * @param y1 the area to be flipped, upper left Y coordinate</span></span>
<span id="LC480" class="line" lang="java"><span class="cm">     * @param x2 the area to be flipped, lower right X coordinate</span></span>
<span id="LC481" class="line" lang="java"><span class="cm">     * @param y2 the area to be flipped, lower right Y coordinate</span></span>
<span id="LC482" class="line" lang="java"><span class="cm">     * @param flipAction the flip action to perform</span></span>
<span id="LC483" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC484" class="line" lang="java"><span class="cm">     * @see Component.FlipBufferStrategy#flip</span></span>
<span id="LC485" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC486" class="line" lang="java">    <span class="kt">void</span> <span class="nf">flip</span><span class="o">(</span><span class="kt">int</span> <span class="n">x1</span><span class="o">,</span> <span class="kt">int</span> <span class="n">y1</span><span class="o">,</span> <span class="kt">int</span> <span class="n">x2</span><span class="o">,</span> <span class="kt">int</span> <span class="n">y2</span><span class="o">,</span> <span class="nc">BufferCapabilities</span><span class="o">.</span><span class="na">FlipContents</span> <span class="n">flipAction</span><span class="o">);</span></span>
<span id="LC487" class="line" lang="java"></span>
<span id="LC488" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC489" class="line" lang="java"><span class="cm">     * Destroys all created buffers.</span></span>
<span id="LC490" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC491" class="line" lang="java"><span class="cm">     * @see Component.FlipBufferStrategy#destroyBuffers</span></span>
<span id="LC492" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC493" class="line" lang="java">    <span class="kt">void</span> <span class="nf">destroyBuffers</span><span class="o">();</span></span>
<span id="LC494" class="line" lang="java"></span>
<span id="LC495" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC496" class="line" lang="java"><span class="cm">     * Reparents this peer to the new parent referenced by</span></span>
<span id="LC497" class="line" lang="java"><span class="cm">     * {@code newContainer} peer. Implementation depends on toolkit and</span></span>
<span id="LC498" class="line" lang="java"><span class="cm">     * container.</span></span>
<span id="LC499" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC500" class="line" lang="java"><span class="cm">     * @param newContainer peer of the new parent container</span></span>
...
<span id="LC504" class="line" lang="java">    <span class="kt">void</span> <span class="nf">reparent</span><span class="o">(</span><span class="nc">ContainerPeer</span> <span class="n">newContainer</span><span class="o">);</span></span>
<span id="LC505" class="line" lang="java"></span>
<span id="LC506" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC507" class="line" lang="java"><span class="cm">     * Returns whether this peer supports reparenting to another parent without</span></span>
<span id="LC508" class="line" lang="java"><span class="cm">     * destroying the peer.</span></span>
<span id="LC509" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC510" class="line" lang="java"><span class="cm">     * @return true if appropriate reparent is supported, false otherwise</span></span>
<span id="LC511" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC512" class="line" lang="java"><span class="cm">     * @since 1.5</span></span>
<span id="LC513" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC514" class="line" lang="java">    <span class="kt">boolean</span> <span class="nf">isReparentSupported</span><span class="o">();</span></span>
<span id="LC515" class="line" lang="java"></span>
<span id="LC516" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC517" class="line" lang="java"><span class="cm">     * Used by lightweight implementations to tell a ComponentPeer to layout</span></span>
<span id="LC518" class="line" lang="java"><span class="cm">     * its sub-elements.  For instance, a lightweight Checkbox needs to layout</span></span>
<span id="LC519" class="line" lang="java"><span class="cm">     * the box, as well as the text label.</span></span>
<span id="LC520" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC521" class="line" lang="java"><span class="cm">     * @see Component#validate()</span></span>
<span id="LC522" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC523" class="line" lang="java">    <span class="kt">void</span> <span class="nf">layout</span><span class="o">();</span></span>
<span id="LC524" class="line" lang="java"></span>
<span id="LC525" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC526" class="line" lang="java"><span class="cm">     * Applies the shape to the native component window.</span></span>
<span id="LC527" class="line" lang="java"><span class="cm">     * @since 1.7</span></span>
<span id="LC528" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC529" class="line" lang="java"><span class="cm">     * @see Component#applyCompoundShape</span></span>
<span id="LC530" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC531" class="line" lang="java">    <span class="kt">void</span> <span class="nf">applyShape</span><span class="o">(</span><span class="nc">Region</span> <span class="n">shape</span><span class="o">);</span></span>
<span id="LC532" class="line" lang="java"></span>
<span id="LC533" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC534" class="line" lang="java"><span class="cm">     * Lowers this component at the bottom of the above HW peer. If the above parameter</span></span>
<span id="LC535" class="line" lang="java"><span class="cm">     * is null then the method places this component at the top of the Z-order.</span></span>
<span id="LC536" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC537" class="line" lang="java">    <span class="kt">void</span> <span class="nf">setZOrder</span><span class="o">(</span><span class="nc">ComponentPeer</span> <span class="n">above</span><span class="o">);</span></span>
<span id="LC538" class="line" lang="java"></span>
<span id="LC539" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC540" class="line" lang="java"><span class="cm">     * Updates internal data structures related to the component's GC.</span></span>
<span id="LC541" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC542" class="line" lang="java"><span class="cm">     * @return if the peer needs to be recreated for the changes to take effect</span></span>
<span id="LC543" class="line" lang="java"><span class="cm">     * @since 1.7</span></span>
<span id="LC544" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC545" class="line" lang="java">    <span class="kt">boolean</span> <span class="nf">updateGraphicsData</span><span class="o">(</span><span class="nc">GraphicsConfiguration</span> <span class="n">gc</span><span class="o">);</span></span>
