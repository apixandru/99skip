...
<span id="LC65" class="line" lang="java"><span class="cm"> * Exception used to indicate a problem while calculating a date-time.</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> * This exception is used to indicate problems with creating, querying</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> * and manipulating date-time objects.</span></span>
...
<span id="LC75" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">DateTimeException</span> <span class="kd">extends</span> <span class="nc">RuntimeException</span> <span class="o">{</span></span>
...
<span id="LC80" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="o">-</span><span class="mi">1632418723876261839L</span><span class="o">;</span></span>
<span id="LC81" class="line" lang="java"></span>
<span id="LC82" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">     * Constructs a new date-time exception with the specified message.</span></span>
...
<span id="LC87" class="line" lang="java">    <span class="kd">public</span> <span class="nf">DateTimeException</span><span class="o">(</span><span class="nc">String</span> <span class="n">message</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC92" class="line" lang="java"><span class="cm">     * Constructs a new date-time exception with the specified message and cause.</span></span>
...
<span id="LC97" class="line" lang="java">    <span class="kd">public</span> <span class="nf">DateTimeException</span><span class="o">(</span><span class="nc">String</span> <span class="n">message</span><span class="o">,</span> <span class="nc">Throwable</span> <span class="n">cause</span><span class="o">)</span> <span class="o">{</span></span>
