...
<span id="LC65" class="line" lang="java"><span class="cm"> * Enumeration of the style of a localized date, time or date-time formatter.</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> * These styles are used when obtaining a date-time style from configuration.</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> * See {@link DateTimeFormatter} and {@link DateTimeFormatterBuilder} for usage.</span></span>
...
<span id="LC71" class="line" lang="java"><span class="cm"> * This is an immutable and thread-safe enum.</span></span>
...
<span id="LC75" class="line" lang="java"><span class="kd">public</span> <span class="kd">enum</span> <span class="nc">FormatStyle</span> <span class="o">{</span></span>
<span id="LC76" class="line" lang="java">    <span class="c1">// ordered from large to small</span></span>
<span id="LC77" class="line" lang="java"></span>
<span id="LC78" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC79" class="line" lang="java"><span class="cm">     * Full text style, with the most detail.</span></span>
<span id="LC80" class="line" lang="java"><span class="cm">     * For example, the format might be 'Tuesday, April 12, 1952 AD' or '3:30:42pm PST'.</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC82" class="line" lang="java">    <span class="no">FULL</span><span class="o">,</span></span>
<span id="LC83" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC84" class="line" lang="java"><span class="cm">     * Long text style, with lots of detail.</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">     * For example, the format might be 'January 12, 1952'.</span></span>
<span id="LC86" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC87" class="line" lang="java">    <span class="no">LONG</span><span class="o">,</span></span>
<span id="LC88" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">     * Medium text style, with some detail.</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">     * For example, the format might be 'Jan 12, 1952'.</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC92" class="line" lang="java">    <span class="no">MEDIUM</span><span class="o">,</span></span>
<span id="LC93" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">     * Short text style, typically numeric.</span></span>
<span id="LC95" class="line" lang="java"><span class="cm">     * For example, the format might be '12.13.52' or '3:30pm'.</span></span>
<span id="LC96" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC97" class="line" lang="java">    <span class="no">SHORT</span><span class="o">;</span></span>
