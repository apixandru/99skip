...
<span id="LC65" class="line" lang="java"><span class="cm"> * Provides classes to print and parse dates and times.</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> * &lt;/p&gt;</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> * Printing and parsing is based around the</span></span>
<span id="LC69" class="line" lang="java"><span class="cm"> * {@link java.time.format.DateTimeFormatter DateTimeFormatter} class.</span></span>
<span id="LC70" class="line" lang="java"><span class="cm"> * Instances are generally obtained from</span></span>
<span id="LC71" class="line" lang="java"><span class="cm"> * {@link java.time.format.DateTimeFormatter DateTimeFormatter}, however</span></span>
<span id="LC72" class="line" lang="java"><span class="cm"> * {@link java.time.format.DateTimeFormatterBuilder DateTimeFormatterBuilder}</span></span>
<span id="LC73" class="line" lang="java"><span class="cm"> * can be used if more power is needed.</span></span>
<span id="LC74" class="line" lang="java"><span class="cm"> * &lt;/p&gt;</span></span>
<span id="LC75" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC76" class="line" lang="java"><span class="cm"> * Localization occurs by calling</span></span>
<span id="LC77" class="line" lang="java"><span class="cm"> * {@link java.time.format.DateTimeFormatter#withLocale(java.util.Locale) withLocale(Locale)}</span></span>
<span id="LC78" class="line" lang="java"><span class="cm"> * on the formatter. Further customization is possible using</span></span>
<span id="LC79" class="line" lang="java"><span class="cm"> * {@link java.time.format.DecimalStyle DecimalStyle}.</span></span>
<span id="LC80" class="line" lang="java"><span class="cm"> * &lt;/p&gt;</span></span>
<span id="LC81" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC82" class="line" lang="java"><span class="cm"> * &lt;h3&gt;Package specification&lt;/h3&gt;</span></span>
<span id="LC83" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC84" class="line" lang="java"><span class="cm"> * Unless otherwise noted, passing a null argument to a constructor or method in any class or interface</span></span>
<span id="LC85" class="line" lang="java"><span class="cm"> * in this package will cause a {@link java.lang.NullPointerException NullPointerException} to be thrown.</span></span>
<span id="LC86" class="line" lang="java"><span class="cm"> * The Javadoc "@param" definition is used to summarise the null-behavior.</span></span>
<span id="LC87" class="line" lang="java"><span class="cm"> * The "@throws {@link java.lang.NullPointerException}" is not explicitly documented in each method.</span></span>
<span id="LC88" class="line" lang="java"><span class="cm"> * &lt;/p&gt;</span></span>
<span id="LC89" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC90" class="line" lang="java"><span class="cm"> * All calculations should check for numeric overflow and throw either an {@link java.lang.ArithmeticException}</span></span>
<span id="LC91" class="line" lang="java"><span class="cm"> * or a {@link java.time.DateTimeException}.</span></span>
<span id="LC92" class="line" lang="java"><span class="cm"> * &lt;/p&gt;</span></span>
<span id="LC93" class="line" lang="java"><span class="cm"> * @since JDK1.8</span></span>
<span id="LC94" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC95" class="line" lang="java"><span class="kn">package</span> <span class="nn">java.time.format</span><span class="o">;</span></span>
