...
<span id="LC65" class="line" lang="java"><span class="cm"> * Enumeration of different ways to resolve dates and times.</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> * Parsing a text string occurs in two phases.</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> * Phase 1 is a basic text parse according to the fields added to the builder.</span></span>
<span id="LC69" class="line" lang="java"><span class="cm"> * Phase 2 resolves the parsed field-value pairs into date and/or time objects.</span></span>
<span id="LC70" class="line" lang="java"><span class="cm"> * This style is used to control how phase 2, resolving, happens.</span></span>
...
<span id="LC73" class="line" lang="java"><span class="cm"> * This is an immutable and thread-safe enum.</span></span>
...
<span id="LC77" class="line" lang="java"><span class="kd">public</span> <span class="kd">enum</span> <span class="nc">ResolverStyle</span> <span class="o">{</span></span>
<span id="LC78" class="line" lang="java"></span>
<span id="LC79" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC80" class="line" lang="java"><span class="cm">     * Style to resolve dates and times strictly.</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC82" class="line" lang="java"><span class="cm">     * Using strict resolution will ensure that all parsed values are within</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">     * the outer range of valid values for the field. Individual fields may</span></span>
<span id="LC84" class="line" lang="java"><span class="cm">     * be further processed for strictness.</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC86" class="line" lang="java"><span class="cm">     * For example, resolving year-month and day-of-month in the ISO calendar</span></span>
<span id="LC87" class="line" lang="java"><span class="cm">     * system using strict mode will ensure that the day-of-month is valid</span></span>
<span id="LC88" class="line" lang="java"><span class="cm">     * for the year-month, rejecting invalid values.</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC90" class="line" lang="java">    <span class="no">STRICT</span><span class="o">,</span></span>
<span id="LC91" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">     * Style to resolve dates and times in a smart, or intelligent, manner.</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">     * Using smart resolution will perform the sensible default for each</span></span>
<span id="LC95" class="line" lang="java"><span class="cm">     * field, which may be the same as strict, the same as lenient, or a third</span></span>
<span id="LC96" class="line" lang="java"><span class="cm">     * behavior. Individual fields will interpret this differently.</span></span>
<span id="LC97" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC98" class="line" lang="java"><span class="cm">     * For example, resolving year-month and day-of-month in the ISO calendar</span></span>
<span id="LC99" class="line" lang="java"><span class="cm">     * system using smart mode will ensure that the day-of-month is from</span></span>
<span id="LC100" class="line" lang="java"><span class="cm">     * 1 to 31, converting any value beyond the last valid day-of-month to be</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">     * the last valid day-of-month.</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC103" class="line" lang="java">    <span class="no">SMART</span><span class="o">,</span></span>
<span id="LC104" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC105" class="line" lang="java"><span class="cm">     * Style to resolve dates and times leniently.</span></span>
<span id="LC106" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">     * Using lenient resolution will resolve the values in an appropriate</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">     * lenient manner. Individual fields will interpret this differently.</span></span>
<span id="LC109" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC110" class="line" lang="java"><span class="cm">     * For example, lenient mode allows the month in the ISO calendar system</span></span>
<span id="LC111" class="line" lang="java"><span class="cm">     * to be outside the range 1 to 12.</span></span>
<span id="LC112" class="line" lang="java"><span class="cm">     * For example, month 15 is treated as being 3 months after month 12.</span></span>
<span id="LC113" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC114" class="line" lang="java">    <span class="no">LENIENT</span><span class="o">;</span></span>
