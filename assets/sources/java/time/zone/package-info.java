...
<span id="LC65" class="line" lang="java"><span class="cm"> * Support for time-zones and their rules.</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> * &lt;/p&gt;</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> * Daylight Saving Time and Time-Zones are concepts used by Governments to alter local time.</span></span>
<span id="LC69" class="line" lang="java"><span class="cm"> * This package provides support for time-zones, their rules and the resulting</span></span>
<span id="LC70" class="line" lang="java"><span class="cm"> * gaps and overlaps in the local time-line typically caused by Daylight Saving Time.</span></span>
<span id="LC71" class="line" lang="java"><span class="cm"> * &lt;/p&gt;</span></span>
<span id="LC72" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC73" class="line" lang="java"><span class="cm"> * &lt;h3&gt;Package specification&lt;/h3&gt;</span></span>
<span id="LC74" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC75" class="line" lang="java"><span class="cm"> * Unless otherwise noted, passing a null argument to a constructor or method in any class or interface</span></span>
<span id="LC76" class="line" lang="java"><span class="cm"> * in this package will cause a {@link java.lang.NullPointerException NullPointerException} to be thrown.</span></span>
<span id="LC77" class="line" lang="java"><span class="cm"> * The Javadoc "@param" definition is used to summarise the null-behavior.</span></span>
<span id="LC78" class="line" lang="java"><span class="cm"> * The "@throws {@link java.lang.NullPointerException}" is not explicitly documented in each method.</span></span>
<span id="LC79" class="line" lang="java"><span class="cm"> * &lt;/p&gt;</span></span>
<span id="LC80" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC81" class="line" lang="java"><span class="cm"> * All calculations should check for numeric overflow and throw either an {@link java.lang.ArithmeticException}</span></span>
<span id="LC82" class="line" lang="java"><span class="cm"> * or a {@link java.time.DateTimeException}.</span></span>
<span id="LC83" class="line" lang="java"><span class="cm"> * &lt;/p&gt;</span></span>
<span id="LC84" class="line" lang="java"><span class="cm"> * @since JDK1.8</span></span>
<span id="LC85" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC86" class="line" lang="java"><span class="kn">package</span> <span class="nn">java.time.zone</span><span class="o">;</span></span>
