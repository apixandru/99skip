...
<span id="LC67" class="line" lang="java"><span class="cm"> * UnsupportedTemporalTypeException indicates that a ChronoField or ChronoUnit is</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> * not supported for a Temporal class.</span></span>
<span id="LC69" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC70" class="line" lang="java"><span class="cm"> * @implSpec</span></span>
<span id="LC71" class="line" lang="java"><span class="cm"> * This class is intended for use in a single thread.</span></span>
...
<span id="LC75" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">UnsupportedTemporalTypeException</span> <span class="kd">extends</span> <span class="nc">DateTimeException</span> <span class="o">{</span></span>
<span id="LC76" class="line" lang="java"></span>
<span id="LC77" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC78" class="line" lang="java"><span class="cm">     * Serialization version.</span></span>
<span id="LC79" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC80" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="o">-</span><span class="mi">6158898438688206006L</span><span class="o">;</span></span>
<span id="LC81" class="line" lang="java"></span>
<span id="LC82" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">     * Constructs a new UnsupportedTemporalTypeException with the specified message.</span></span>
<span id="LC84" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">     * @param message  the message to use for this exception, may be null</span></span>
<span id="LC86" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC87" class="line" lang="java">    <span class="kd">public</span> <span class="nf">UnsupportedTemporalTypeException</span><span class="o">(</span><span class="nc">String</span> <span class="n">message</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC92" class="line" lang="java"><span class="cm">     * Constructs a new UnsupportedTemporalTypeException with the specified message and cause.</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">     * @param message  the message to use for this exception, may be null</span></span>
<span id="LC95" class="line" lang="java"><span class="cm">     * @param cause  the cause of the exception, may be null</span></span>
<span id="LC96" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC97" class="line" lang="java">    <span class="kd">public</span> <span class="nf">UnsupportedTemporalTypeException</span><span class="o">(</span><span class="nc">String</span> <span class="n">message</span><span class="o">,</span> <span class="nc">Throwable</span> <span class="n">cause</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC98" class="line" lang="java">        <span class="kd">super</span><span class="o">(</span><span class="n">message</span><span class="o">,</span> <span class="n">cause</span><span class="o">);</span></span>
