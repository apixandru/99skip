...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"><span class="kn">package</span><span> </span><span>org.apache.commons.io.output</span><span>;</span></span><span class="line" lang="java" id="LC18"></span><span class="line" lang="java" id="LC19"><span class="kn">import</span><span> </span><span>java.io.OutputStream</span><span>;</span></span><span class="line" lang="java" id="LC20"></span><span class="line" lang="java" id="LC21"><span class="cm">/**</span></span><span class="line" lang="java" id="LC22"><span class="cm"> * Proxy stream that prevents the underlying output stream from being closed.</span></span><span class="line" lang="java" id="LC23"><span class="cm"> * &lt;p&gt;</span></span><span class="line" lang="java" id="LC24"><span class="cm"> * This class is typically used in cases where an output stream needs to be</span></span><span class="line" lang="java" id="LC25"><span class="cm"> * passed to a component that wants to explicitly close the stream even if other</span></span><span class="line" lang="java" id="LC26"><span class="cm"> * components would still use the stream for output.</span></span><span class="line" lang="java" id="LC27"><span class="cm"> * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC28"><span class="cm"> *</span></span><span class="line" lang="java" id="LC29"><span class="cm"> * @since 1.4</span></span><span class="line" lang="java" id="LC30"><span class="cm"> */</span></span><span class="line" lang="java" id="LC31"><span class="kd">public</span><span> </span><span class="kd">class</span><span> </span><span class="nc">CloseShieldOutputStream</span><span> </span><span class="kd">extends</span><span> </span><span>ProxyOutputStream</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC32"></span><span class="line" lang="java" id="LC33"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC34"><span class="cm">     * Creates a proxy that shields the given output stream from being closed.</span></span><span class="line" lang="java" id="LC35"><span class="cm">     *</span></span><span class="line" lang="java" id="LC36"><span class="cm">     * @param outputStream the output stream to wrap</span></span><span class="line" lang="java" id="LC37"><span class="cm">     * @return the created proxy</span></span><span class="line" lang="java" id="LC38"><span class="cm">     * @since 2.9.0</span></span><span class="line" lang="java" id="LC39"><span class="cm">     */</span></span><span class="line" lang="java" id="LC40"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>CloseShieldOutputStream</span><span> </span><span>wrap</span><span>(</span><span class="kd">final</span><span> </span><span>OutputStream</span><span> </span><span>outputStream</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC41"><span>        </span><span class="k">return</span><span> </span><span class="k">new</span><span> </span><span>CloseShieldOutputStream</span><span>(</span><span>outputStream</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC42"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC43"></span><span class="line" lang="java" id="LC44"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC45"><span class="cm">     * Creates a proxy that shields the given output stream from being closed.</span></span><span class="line" lang="java" id="LC46"><span class="cm">     *</span></span><span class="line" lang="java" id="LC47"><span class="cm">     * @param outputStream underlying output stream</span></span><span class="line" lang="java" id="LC48"><span class="cm">     * @deprecated Using this constructor prevents IDEs from warning if the</span></span><span class="line" lang="java" id="LC49"><span class="cm">     *             underlying output stream is never closed. Use</span></span><span class="line" lang="java" id="LC50"><span class="cm">     *             {@link #wrap(OutputStream)} instead.</span></span><span class="line" lang="java" id="LC51"><span class="cm">     */</span></span><span class="line" lang="java" id="LC52"><span>    </span><span>@</span><span>Deprecated</span></span><span class="line" lang="java" id="LC53"><span>    </span><span class="kd">public</span><span> </span><span>CloseShieldOutputStream</span><span>(</span><span class="kd">final</span><span> </span><span>OutputStream</span><span> </span><span>outputStream</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC54"><span>        </span><span class="kd">super</span><span>(</span><span>outputStream</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC55"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC56"></span><span class="line" lang="java" id="LC57"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC58"><span class="cm">     * Replaces the underlying output stream with a {@link ClosedOutputStream}</span></span><span class="line" lang="java" id="LC59"><span class="cm">     * sentinel. The original output stream will remain open, but this proxy will</span></span><span class="line" lang="java" id="LC60"><span class="cm">     * appear closed.</span></span><span class="line" lang="java" id="LC61"><span class="cm">     */</span></span><span class="line" lang="java" id="LC62"><span>    </span><span>@</span><span>Override</span></span><span class="line" lang="java" id="LC63"><span>    </span><span class="kd">public</span><span> </span><span class="kt">void</span><span> </span><span>close</span><span>(</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC64"><span>        </span><span>out</span><span> </span><span>=</span><span> </span><span>ClosedOutputStream</span><span>.</span><span>CLOSED_OUTPUT_STREAM</span><span>;</span></span><span class="line" lang="java" id="LC65"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC66"></span><span class="line" lang="java" id="LC67"><span>}</span></span>
</code>
</pre>
    </div>
</div>