...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"></span><span class="line" lang="java" id="LC18"><span class="kn">package</span><span> </span><span>org.apache.commons.io.file</span><span>;</span></span><span class="line" lang="java" id="LC19"></span><span class="line" lang="java" id="LC20"><span class="kn">import</span><span> </span><span>java.io.File</span><span>;</span></span><span class="line" lang="java" id="LC21"><span class="kn">import</span><span> </span><span>java.io.IOException</span><span>;</span></span><span class="line" lang="java" id="LC22"><span class="kn">import</span><span> </span><span>java.io.InputStream</span><span>;</span></span><span class="line" lang="java" id="LC23"><span class="kn">import</span><span> </span><span>java.io.UncheckedIOException</span><span>;</span></span><span class="line" lang="java" id="LC24"><span class="kn">import</span><span> </span><span>java.net.URI</span><span>;</span></span><span class="line" lang="java" id="LC25"><span class="kn">import</span><span> </span><span>java.net.URL</span><span>;</span></span><span class="line" lang="java" id="LC26"><span class="kn">import</span><span> </span><span>java.nio.file.CopyOption</span><span>;</span></span><span class="line" lang="java" id="LC27"><span class="kn">import</span><span> </span><span>java.nio.file.DirectoryStream</span><span>;</span></span><span class="line" lang="java" id="LC28"><span class="kn">import</span><span> </span><span>java.nio.file.FileVisitOption</span><span>;</span></span><span class="line" lang="java" id="LC29"><span class="kn">import</span><span> </span><span>java.nio.file.FileVisitResult</span><span>;</span></span><span class="line" lang="java" id="LC30"><span class="kn">import</span><span> </span><span>java.nio.file.FileVisitor</span><span>;</span></span><span class="line" lang="java" id="LC31"><span class="kn">import</span><span> </span><span>java.nio.file.Files</span><span>;</span></span><span class="line" lang="java" id="LC32"><span class="kn">import</span><span> </span><span>java.nio.file.LinkOption</span><span>;</span></span><span class="line" lang="java" id="LC33"><span class="kn">import</span><span> </span><span>java.nio.file.NoSuchFileException</span><span>;</span></span><span class="line" lang="java" id="LC34"><span class="kn">import</span><span> </span><span>java.nio.file.NotDirectoryException</span><span>;</span></span><span class="line" lang="java" id="LC35"><span class="kn">import</span><span> </span><span>java.nio.file.OpenOption</span><span>;</span></span><span class="line" lang="java" id="LC36"><span class="kn">import</span><span> </span><span>java.nio.file.Path</span><span>;</span></span><span class="line" lang="java" id="LC37"><span class="kn">import</span><span> </span><span>java.nio.file.Paths</span><span>;</span></span><span class="line" lang="java" id="LC38"><span class="kn">import</span><span> </span><span>java.nio.file.attribute.AclEntry</span><span>;</span></span><span class="line" lang="java" id="LC39"><span class="kn">import</span><span> </span><span>java.nio.file.attribute.AclFileAttributeView</span><span>;</span></span><span class="line" lang="java" id="LC40"><span class="kn">import</span><span> </span><span>java.nio.file.attribute.BasicFileAttributes</span><span>;</span></span><span class="line" lang="java" id="LC41"><span class="kn">import</span><span> </span><span>java.nio.file.attribute.DosFileAttributeView</span><span>;</span></span><span class="line" lang="java" id="LC42"><span class="kn">import</span><span> </span><span>java.nio.file.attribute.FileAttribute</span><span>;</span></span><span class="line" lang="java" id="LC43"><span class="kn">import</span><span> </span><span>java.nio.file.attribute.PosixFileAttributeView</span><span>;</span></span><span class="line" lang="java" id="LC44"><span class="kn">import</span><span> </span><span>java.nio.file.attribute.PosixFileAttributes</span><span>;</span></span><span class="line" lang="java" id="LC45"><span class="kn">import</span><span> </span><span>java.nio.file.attribute.PosixFilePermission</span><span>;</span></span><span class="line" lang="java" id="LC46"><span class="kn">import</span><span> </span><span>java.util.ArrayList</span><span>;</span></span><span class="line" lang="java" id="LC47"><span class="kn">import</span><span> </span><span>java.util.Arrays</span><span>;</span></span><span class="line" lang="java" id="LC48"><span class="kn">import</span><span> </span><span>java.util.Collection</span><span>;</span></span><span class="line" lang="java" id="LC49"><span class="kn">import</span><span> </span><span>java.util.Collections</span><span>;</span></span><span class="line" lang="java" id="LC50"><span class="kn">import</span><span> </span><span>java.util.Comparator</span><span>;</span></span><span class="line" lang="java" id="LC51"><span class="kn">import</span><span> </span><span>java.util.EnumSet</span><span>;</span></span><span class="line" lang="java" id="LC52"><span class="kn">import</span><span> </span><span>java.util.List</span><span>;</span></span><span class="line" lang="java" id="LC53"><span class="kn">import</span><span> </span><span>java.util.Objects</span><span>;</span></span><span class="line" lang="java" id="LC54"><span class="kn">import</span><span> </span><span>java.util.Set</span><span>;</span></span><span class="line" lang="java" id="LC55"><span class="kn">import</span><span> </span><span>java.util.stream.Collector</span><span>;</span></span><span class="line" lang="java" id="LC56"><span class="kn">import</span><span> </span><span>java.util.stream.Collectors</span><span>;</span></span><span class="line" lang="java" id="LC57"><span class="kn">import</span><span> </span><span>java.util.stream.Stream</span><span>;</span></span><span class="line" lang="java" id="LC58"></span><span class="line" lang="java" id="LC59"><span class="kn">import</span><span> </span><span>org.apache.commons.io.IOExceptionList</span><span>;</span></span><span class="line" lang="java" id="LC60"><span class="kn">import</span><span> </span><span>org.apache.commons.io.IOUtils</span><span>;</span></span><span class="line" lang="java" id="LC61"><span class="kn">import</span><span> </span><span>org.apache.commons.io.file.Counters.PathCounters</span><span>;</span></span><span class="line" lang="java" id="LC62"><span class="kn">import</span><span> </span><span>org.apache.commons.io.filefilter.IOFileFilter</span><span>;</span></span><span class="line" lang="java" id="LC63"></span><span class="line" lang="java" id="LC64"><span class="cm">/**</span></span><span class="line" lang="java" id="LC65"><span class="cm"> * NIO Path utilities.</span></span><span class="line" lang="java" id="LC66"><span class="cm"> *</span></span><span class="line" lang="java" id="LC67"><span class="cm"> * @since 2.7</span></span><span class="line" lang="java" id="LC68"><span class="cm"> */</span></span><span class="line" lang="java" id="LC69"><span class="kd">public</span><span> </span><span class="kd">final</span><span> </span><span class="kd">class</span><span> </span><span class="nc">PathUtils</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC70"></span><span class="line" lang="java" id="LC71"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC72"><span class="cm">     * Private worker/holder that computes and tracks relative path names and their equality. We reuse the sorted</span></span><span class="line" lang="java" id="LC73"><span class="cm">     * relative lists when comparing directories.</span></span><span class="line" lang="java" id="LC74"><span class="cm">     */</span></span><span class="line" lang="java" id="LC75"><span>    </span><span class="kd">private</span><span> </span><span class="kd">static</span><span> </span><span class="kd">class</span><span> </span><span>RelativeSortedPaths</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC76"></span><span class="line" lang="java" id="LC77"><span>        </span><span class="kd">final</span><span> </span><span class="kt">boolean</span><span> </span><span>equals</span><span>;</span></span><span class="line" lang="java" id="LC78"><span>        </span><span class="cm">// final List&lt;Path&gt; relativeDirList1; // might need later?</span></span><span class="line" lang="java" id="LC79"><span>        </span><span class="cm">// final List&lt;Path&gt; relativeDirList2; // might need later?</span></span><span class="line" lang="java" id="LC80"><span>        </span><span class="kd">final</span><span> </span><span>List</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>relativeFileList1</span><span>;</span></span><span class="line" lang="java" id="LC81"><span>        </span><span class="kd">final</span><span> </span><span>List</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>relativeFileList2</span><span>;</span></span><span class="line" lang="java" id="LC82"></span><span class="line" lang="java" id="LC83"><span>        </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC84"><span class="cm">         * Constructs and initializes a new instance by accumulating directory and file info.</span></span><span class="line" lang="java" id="LC85"><span class="cm">         *</span></span><span class="line" lang="java" id="LC86"><span class="cm">         * @param dir1 First directory to compare.</span></span><span class="line" lang="java" id="LC87"><span class="cm">         * @param dir2 Seconds directory to compare.</span></span><span class="line" lang="java" id="LC88"><span class="cm">         * @param maxDepth See {@link Files#walkFileTree(Path,Set,int,FileVisitor)}.</span></span><span class="line" lang="java" id="LC89"><span class="cm">         * @param linkOptions Options indicating how symbolic links are handled.</span></span><span class="line" lang="java" id="LC90"><span class="cm">         * @param fileVisitOptions See {@link Files#walkFileTree(Path,Set,int,FileVisitor)}.</span></span><span class="line" lang="java" id="LC91"><span class="cm">         * @throws IOException if an I/O error is thrown by a visitor method.</span></span><span class="line" lang="java" id="LC92"><span class="cm">         */</span></span><span class="line" lang="java" id="LC93"><span>        </span><span class="kd">private</span><span> </span><span>RelativeSortedPaths</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>dir1</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>dir2</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span class="kt">int</span><span> </span><span>maxDepth</span><span>,</span></span><span class="line" lang="java" id="LC94"><span>            </span><span class="kd">final</span><span> </span><span>LinkOption</span><span>[</span><span>]</span><span> </span><span>linkOptions</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>FileVisitOption</span><span>[</span><span>]</span><span> </span><span>fileVisitOptions</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC95"><span>            </span><span class="kd">final</span><span> </span><span>List</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>tmpRelativeDirList1</span><span>;</span></span><span class="line" lang="java" id="LC96"><span>            </span><span class="kd">final</span><span> </span><span>List</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>tmpRelativeDirList2</span><span>;</span></span><span class="line" lang="java" id="LC97"><span>            </span><span>List</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>tmpRelativeFileList1</span><span> </span><span>=</span><span> </span><span class="kc">null</span><span>;</span></span><span class="line" lang="java" id="LC98"><span>            </span><span>List</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>tmpRelativeFileList2</span><span> </span><span>=</span><span> </span><span class="kc">null</span><span>;</span></span><span class="line" lang="java" id="LC99"><span>            </span><span class="k">if</span><span> </span><span>(</span><span>dir1</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span> </span><span>&amp;&amp;</span><span> </span><span>dir2</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC100"><span>                </span><span>equals</span><span> </span><span>=</span><span> </span><span class="kc">true</span><span>;</span></span><span class="line" lang="java" id="LC101"><span>            </span><span>}</span><span> </span><span>else</span><span> </span><span class="k">if</span><span> </span><span>(</span><span>dir1</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span> </span><span>^</span><span> </span><span>dir2</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC102"><span>                </span><span>equals</span><span> </span><span>=</span><span> </span><span class="kc">false</span><span>;</span></span><span class="line" lang="java" id="LC103"><span>            </span><span>}</span><span> </span><span>else</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC104"><span>                </span><span class="kd">final</span><span> </span><span class="kt">boolean</span><span> </span><span>parentDirNotExists1</span><span> </span><span>=</span><span> </span><span>Files</span><span>.</span><span>notExists</span><span>(</span><span>dir1</span><span>,</span><span> </span><span>linkOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC105"><span>                </span><span class="kd">final</span><span> </span><span class="kt">boolean</span><span> </span><span>parentDirNotExists2</span><span> </span><span>=</span><span> </span><span>Files</span><span>.</span><span>notExists</span><span>(</span><span>dir2</span><span>,</span><span> </span><span>linkOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC106"><span>                </span><span class="k">if</span><span> </span><span>(</span><span>parentDirNotExists1</span><span> </span><span>||</span><span> </span><span>parentDirNotExists2</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC107"><span>                    </span><span>equals</span><span> </span><span>=</span><span> </span><span>parentDirNotExists1</span><span> </span><span>&amp;&amp;</span><span> </span><span>parentDirNotExists2</span><span>;</span></span><span class="line" lang="java" id="LC108"><span>                </span><span>}</span><span> </span><span>else</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC109"><span>                    </span><span class="kd">final</span><span> </span><span>AccumulatorPathVisitor</span><span> </span><span>visitor1</span><span> </span><span>=</span><span> </span><span>accumulate</span><span>(</span><span>dir1</span><span>,</span><span> </span><span>maxDepth</span><span>,</span><span> </span><span>fileVisitOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC110"><span>                    </span><span class="kd">final</span><span> </span><span>AccumulatorPathVisitor</span><span> </span><span>visitor2</span><span> </span><span>=</span><span> </span><span>accumulate</span><span>(</span><span>dir2</span><span>,</span><span> </span><span>maxDepth</span><span>,</span><span> </span><span>fileVisitOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC111"><span>                    </span><span class="k">if</span><span> </span><span>(</span><span>visitor1</span><span>.</span><span>getDirList</span><span>(</span><span>)</span><span>.</span><span>size</span><span>(</span><span>)</span><span> </span><span>!=</span><span> </span><span>visitor2</span><span>.</span><span>getDirList</span><span>(</span><span>)</span><span>.</span><span>size</span><span>(</span><span>)</span></span><span class="line" lang="java" id="LC112"><span>                        </span><span>||</span><span> </span><span>visitor1</span><span>.</span><span>getFileList</span><span>(</span><span>)</span><span>.</span><span>size</span><span>(</span><span>)</span><span> </span><span>!=</span><span> </span><span>visitor2</span><span>.</span><span>getFileList</span><span>(</span><span>)</span><span>.</span><span>size</span><span>(</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC113"><span>                        </span><span>equals</span><span> </span><span>=</span><span> </span><span class="kc">false</span><span>;</span></span><span class="line" lang="java" id="LC114"><span>                    </span><span>}</span><span> </span><span>else</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC115"><span>                        </span><span>tmpRelativeDirList1</span><span> </span><span>=</span><span> </span><span>visitor1</span><span>.</span><span>relativizeDirectories</span><span>(</span><span>dir1</span><span>,</span><span> </span><span class="kc">true</span><span>,</span><span> </span><span class="kc">null</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC116"><span>                        </span><span>tmpRelativeDirList2</span><span> </span><span>=</span><span> </span><span>visitor2</span><span>.</span><span>relativizeDirectories</span><span>(</span><span>dir2</span><span>,</span><span> </span><span class="kc">true</span><span>,</span><span> </span><span class="kc">null</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC117"><span>                        </span><span class="k">if</span><span> </span><span>(</span><span>!</span><span>tmpRelativeDirList1</span><span>.</span><span>equals</span><span>(</span><span>tmpRelativeDirList2</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC118"><span>                            </span><span>equals</span><span> </span><span>=</span><span> </span><span class="kc">false</span><span>;</span></span><span class="line" lang="java" id="LC119"><span>                        </span><span>}</span><span> </span><span>else</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC120"><span>                            </span><span>tmpRelativeFileList1</span><span> </span><span>=</span><span> </span><span>visitor1</span><span>.</span><span>relativizeFiles</span><span>(</span><span>dir1</span><span>,</span><span> </span><span class="kc">true</span><span>,</span><span> </span><span class="kc">null</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC121"><span>                            </span><span>tmpRelativeFileList2</span><span> </span><span>=</span><span> </span><span>visitor2</span><span>.</span><span>relativizeFiles</span><span>(</span><span>dir2</span><span>,</span><span> </span><span class="kc">true</span><span>,</span><span> </span><span class="kc">null</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC122"><span>                            </span><span>equals</span><span> </span><span>=</span><span> </span><span>tmpRelativeFileList1</span><span>.</span><span>equals</span><span>(</span><span>tmpRelativeFileList2</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC123"><span>                        </span><span>}</span></span><span class="line" lang="java" id="LC124"><span>                    </span><span>}</span></span><span class="line" lang="java" id="LC125"><span>                </span><span>}</span></span><span class="line" lang="java" id="LC126"><span>            </span><span>}</span></span><span class="line" lang="java" id="LC127"><span>            </span><span class="cm">// relativeDirList1 = tmpRelativeDirList1;</span></span><span class="line" lang="java" id="LC128"><span>            </span><span class="cm">// relativeDirList2 = tmpRelativeDirList2;</span></span><span class="line" lang="java" id="LC129"><span>            </span><span>relativeFileList1</span><span> </span><span>=</span><span> </span><span>tmpRelativeFileList1</span><span>;</span></span><span class="line" lang="java" id="LC130"><span>            </span><span>relativeFileList2</span><span> </span><span>=</span><span> </span><span>tmpRelativeFileList2</span><span>;</span></span><span class="line" lang="java" id="LC131"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC132"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC133"></span><span class="line" lang="java" id="LC134"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC135"><span class="cm">     * Empty {@link CopyOption} array.</span></span><span class="line" lang="java" id="LC136"><span class="cm">     *</span></span><span class="line" lang="java" id="LC137"><span class="cm">     * @since 2.8.0</span></span><span class="line" lang="java" id="LC138"><span class="cm">     */</span></span><span class="line" lang="java" id="LC139"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kd">final</span><span> </span><span>CopyOption</span><span>[</span><span>]</span><span> </span><span>EMPTY_COPY_OPTIONS</span><span> </span><span>=</span><span> </span><span>{</span><span>}</span><span>;</span></span><span class="line" lang="java" id="LC140"></span><span class="line" lang="java" id="LC141"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC142"><span class="cm">     * Empty {@link LinkOption} array.</span></span><span class="line" lang="java" id="LC143"><span class="cm">     *</span></span><span class="line" lang="java" id="LC144"><span class="cm">     * @since 2.8.0</span></span><span class="line" lang="java" id="LC145"><span class="cm">     */</span></span><span class="line" lang="java" id="LC146"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kd">final</span><span> </span><span>DeleteOption</span><span>[</span><span>]</span><span> </span><span>EMPTY_DELETE_OPTION_ARRAY</span><span> </span><span>=</span><span> </span><span>{</span><span>}</span><span>;</span></span><span class="line" lang="java" id="LC147"></span><span class="line" lang="java" id="LC148"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC149"><span class="cm">     * Empty {@link FileVisitOption} array.</span></span><span class="line" lang="java" id="LC150"><span class="cm">     */</span></span><span class="line" lang="java" id="LC151"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kd">final</span><span> </span><span>FileVisitOption</span><span>[</span><span>]</span><span> </span><span>EMPTY_FILE_VISIT_OPTION_ARRAY</span><span> </span><span>=</span><span> </span><span>{</span><span>}</span><span>;</span></span><span class="line" lang="java" id="LC152"></span><span class="line" lang="java" id="LC153"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC154"><span class="cm">     * Empty {@link LinkOption} array.</span></span><span class="line" lang="java" id="LC155"><span class="cm">     */</span></span><span class="line" lang="java" id="LC156"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kd">final</span><span> </span><span>LinkOption</span><span>[</span><span>]</span><span> </span><span>EMPTY_LINK_OPTION_ARRAY</span><span> </span><span>=</span><span> </span><span>{</span><span>}</span><span>;</span></span><span class="line" lang="java" id="LC157"></span><span class="line" lang="java" id="LC158"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC159"><span class="cm">     * {@link LinkOption} array for {@link LinkOption#NOFOLLOW_LINKS}.</span></span><span class="line" lang="java" id="LC160"><span class="cm">     *</span></span><span class="line" lang="java" id="LC161"><span class="cm">     * @since 2.9.0</span></span><span class="line" lang="java" id="LC162"><span class="cm">     */</span></span><span class="line" lang="java" id="LC163"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kd">final</span><span> </span><span>LinkOption</span><span>[</span><span>]</span><span> </span><span>NOFOLLOW_LINK_OPTION_ARRAY</span><span> </span><span>=</span><span> </span><span>{</span><span>LinkOption</span><span>.</span><span>NOFOLLOW_LINKS</span><span>}</span><span>;</span></span><span class="line" lang="java" id="LC164"></span><span class="line" lang="java" id="LC165"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC166"><span class="cm">     * Empty {@link OpenOption} array.</span></span><span class="line" lang="java" id="LC167"><span class="cm">     */</span></span><span class="line" lang="java" id="LC168"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kd">final</span><span> </span><span>OpenOption</span><span>[</span><span>]</span><span> </span><span>EMPTY_OPEN_OPTION_ARRAY</span><span> </span><span>=</span><span> </span><span>{</span><span>}</span><span>;</span></span><span class="line" lang="java" id="LC169"></span><span class="line" lang="java" id="LC170"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC171"><span class="cm">     * Empty {@link Path} array.</span></span><span class="line" lang="java" id="LC172"><span class="cm">     *</span></span><span class="line" lang="java" id="LC173"><span class="cm">     * @since 2.9.0</span></span><span class="line" lang="java" id="LC174"><span class="cm">     */</span></span><span class="line" lang="java" id="LC175"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span>[</span><span>]</span><span> </span><span>EMPTY_PATH_ARRAY</span><span> </span><span>=</span><span> </span><span>{</span><span>}</span><span>;</span></span><span class="line" lang="java" id="LC176"></span><span class="line" lang="java" id="LC177"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC178"><span class="cm">     * Accumulates file tree information in a {@link AccumulatorPathVisitor}.</span></span><span class="line" lang="java" id="LC179"><span class="cm">     *</span></span><span class="line" lang="java" id="LC180"><span class="cm">     * @param directory The directory to accumulate information.</span></span><span class="line" lang="java" id="LC181"><span class="cm">     * @param maxDepth See {@link Files#walkFileTree(Path,Set,int,FileVisitor)}.</span></span><span class="line" lang="java" id="LC182"><span class="cm">     * @param fileVisitOptions See {@link Files#walkFileTree(Path,Set,int,FileVisitor)}.</span></span><span class="line" lang="java" id="LC183"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method.</span></span><span class="line" lang="java" id="LC184"><span class="cm">     * @return file tree information.</span></span><span class="line" lang="java" id="LC185"><span class="cm">     */</span></span><span class="line" lang="java" id="LC186"><span>    </span><span class="kd">private</span><span> </span><span class="kd">static</span><span> </span><span>AccumulatorPathVisitor</span><span> </span><span>accumulate</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>directory</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span class="kt">int</span><span> </span><span>maxDepth</span><span>,</span></span><span class="line" lang="java" id="LC187"><span>        </span><span class="kd">final</span><span> </span><span>FileVisitOption</span><span>[</span><span>]</span><span> </span><span>fileVisitOptions</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC188"><span>        </span><span class="k">return</span><span> </span><span>visitFileTree</span><span>(</span><span>AccumulatorPathVisitor</span><span>.</span><span>withLongCounters</span><span>(</span><span>)</span><span>,</span><span> </span><span>directory</span><span>,</span></span><span class="line" lang="java" id="LC189"><span>            </span><span>toFileVisitOptionSet</span><span>(</span><span>fileVisitOptions</span><span>)</span><span>,</span><span> </span><span>maxDepth</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC190"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC191"></span><span class="line" lang="java" id="LC192"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC193"><span class="cm">     * Cleans a directory including sub-directories without deleting directories.</span></span><span class="line" lang="java" id="LC194"><span class="cm">     *</span></span><span class="line" lang="java" id="LC195"><span class="cm">     * @param directory directory to clean.</span></span><span class="line" lang="java" id="LC196"><span class="cm">     * @return The visitation path counters.</span></span><span class="line" lang="java" id="LC197"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method.</span></span><span class="line" lang="java" id="LC198"><span class="cm">     */</span></span><span class="line" lang="java" id="LC199"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>PathCounters</span><span> </span><span>cleanDirectory</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>directory</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC200"><span>        </span><span class="k">return</span><span> </span><span>cleanDirectory</span><span>(</span><span>directory</span><span>,</span><span> </span><span>EMPTY_DELETE_OPTION_ARRAY</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC201"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC202"></span><span class="line" lang="java" id="LC203"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC204"><span class="cm">     * Cleans a directory including sub-directories without deleting directories.</span></span><span class="line" lang="java" id="LC205"><span class="cm">     *</span></span><span class="line" lang="java" id="LC206"><span class="cm">     * @param directory directory to clean.</span></span><span class="line" lang="java" id="LC207"><span class="cm">     * @param deleteOptions How to handle deletion.</span></span><span class="line" lang="java" id="LC208"><span class="cm">     * @return The visitation path counters.</span></span><span class="line" lang="java" id="LC209"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method.</span></span><span class="line" lang="java" id="LC210"><span class="cm">     * @since 2.8.0</span></span><span class="line" lang="java" id="LC211"><span class="cm">     */</span></span><span class="line" lang="java" id="LC212"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>PathCounters</span><span> </span><span>cleanDirectory</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>directory</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>DeleteOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>deleteOptions</span><span>)</span></span><span class="line" lang="java" id="LC213"><span>        </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC214"><span>        </span><span class="k">return</span><span> </span><span>visitFileTree</span><span>(</span><span class="k">new</span><span> </span><span>CleaningPathVisitor</span><span>(</span><span>Counters</span><span>.</span><span>longPathCounters</span><span>(</span><span>)</span><span>,</span><span> </span><span>deleteOptions</span><span>)</span><span>,</span><span> </span><span>directory</span><span>)</span></span><span class="line" lang="java" id="LC215"><span>            </span><span>.</span><span>getPathCounters</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC216"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC217"></span><span class="line" lang="java" id="LC218"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC219"><span class="cm">     * Copies a directory to another directory.</span></span><span class="line" lang="java" id="LC220"><span class="cm">     *</span></span><span class="line" lang="java" id="LC221"><span class="cm">     * @param sourceDirectory The source directory.</span></span><span class="line" lang="java" id="LC222"><span class="cm">     * @param targetDirectory The target directory.</span></span><span class="line" lang="java" id="LC223"><span class="cm">     * @param copyOptions Specifies how the copying should be done.</span></span><span class="line" lang="java" id="LC224"><span class="cm">     * @return The visitation path counters.</span></span><span class="line" lang="java" id="LC225"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method.</span></span><span class="line" lang="java" id="LC226"><span class="cm">     */</span></span><span class="line" lang="java" id="LC227"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>PathCounters</span><span> </span><span>copyDirectory</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>sourceDirectory</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>targetDirectory</span><span>,</span></span><span class="line" lang="java" id="LC228"><span>        </span><span class="kd">final</span><span> </span><span>CopyOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>copyOptions</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC229"><span>        </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>absoluteSource</span><span> </span><span>=</span><span> </span><span>sourceDirectory</span><span>.</span><span>toAbsolutePath</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC230"><span>        </span><span class="k">return</span><span> </span><span>visitFileTree</span><span>(</span></span><span class="line" lang="java" id="LC231"><span>            </span><span class="k">new</span><span> </span><span>CopyDirectoryVisitor</span><span>(</span><span>Counters</span><span>.</span><span>longPathCounters</span><span>(</span><span>)</span><span>,</span><span> </span><span>absoluteSource</span><span>,</span><span> </span><span>targetDirectory</span><span>,</span><span> </span><span>copyOptions</span><span>)</span><span>,</span></span><span class="line" lang="java" id="LC232"><span>            </span><span>absoluteSource</span><span>)</span><span>.</span><span>getPathCounters</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC233"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC234"></span><span class="line" lang="java" id="LC235"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC236"><span class="cm">     * Copies a URL to a directory.</span></span><span class="line" lang="java" id="LC237"><span class="cm">     *</span></span><span class="line" lang="java" id="LC238"><span class="cm">     * @param sourceFile The source URL.</span></span><span class="line" lang="java" id="LC239"><span class="cm">     * @param targetFile The target file.</span></span><span class="line" lang="java" id="LC240"><span class="cm">     * @param copyOptions Specifies how the copying should be done.</span></span><span class="line" lang="java" id="LC241"><span class="cm">     * @return The target file</span></span><span class="line" lang="java" id="LC242"><span class="cm">     * @throws IOException if an I/O error occurs.</span></span><span class="line" lang="java" id="LC243"><span class="cm">     * @see Files#copy(InputStream, Path, CopyOption...)</span></span><span class="line" lang="java" id="LC244"><span class="cm">     */</span></span><span class="line" lang="java" id="LC245"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>Path</span><span> </span><span>copyFile</span><span>(</span><span class="kd">final</span><span> </span><span>URL</span><span> </span><span>sourceFile</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>targetFile</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>CopyOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>copyOptions</span><span>)</span></span><span class="line" lang="java" id="LC246"><span>        </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC247"><span>        </span><span class="k">try</span><span> </span><span>(</span><span class="kd">final</span><span> </span><span>InputStream</span><span> </span><span>inputStream</span><span> </span><span>=</span><span> </span><span>sourceFile</span><span>.</span><span>openStream</span><span>(</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC248"><span>            </span><span>Files</span><span>.</span><span>copy</span><span>(</span><span>inputStream</span><span>,</span><span> </span><span>targetFile</span><span>,</span><span> </span><span>copyOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC249"><span>            </span><span class="k">return</span><span> </span><span>targetFile</span><span>;</span></span><span class="line" lang="java" id="LC250"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC251"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC252"></span><span class="line" lang="java" id="LC253"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC254"><span class="cm">     * Copies a file to a directory.</span></span><span class="line" lang="java" id="LC255"><span class="cm">     *</span></span><span class="line" lang="java" id="LC256"><span class="cm">     * @param sourceFile The source file.</span></span><span class="line" lang="java" id="LC257"><span class="cm">     * @param targetDirectory The target directory.</span></span><span class="line" lang="java" id="LC258"><span class="cm">     * @param copyOptions Specifies how the copying should be done.</span></span><span class="line" lang="java" id="LC259"><span class="cm">     * @return The target file</span></span><span class="line" lang="java" id="LC260"><span class="cm">     * @throws IOException if an I/O error occurs.</span></span><span class="line" lang="java" id="LC261"><span class="cm">     * @see Files#copy(Path, Path, CopyOption...)</span></span><span class="line" lang="java" id="LC262"><span class="cm">     */</span></span><span class="line" lang="java" id="LC263"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>Path</span><span> </span><span>copyFileToDirectory</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>sourceFile</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>targetDirectory</span><span>,</span></span><span class="line" lang="java" id="LC264"><span>        </span><span class="kd">final</span><span> </span><span>CopyOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>copyOptions</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC265"><span>        </span><span class="k">return</span><span> </span><span>Files</span><span>.</span><span>copy</span><span>(</span><span>sourceFile</span><span>,</span><span> </span><span>targetDirectory</span><span>.</span><span>resolve</span><span>(</span><span>sourceFile</span><span>.</span><span>getFileName</span><span>(</span><span>)</span><span>)</span><span>,</span><span> </span><span>copyOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC266"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC267"></span><span class="line" lang="java" id="LC268"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC269"><span class="cm">     * Copies a URL to a directory.</span></span><span class="line" lang="java" id="LC270"><span class="cm">     *</span></span><span class="line" lang="java" id="LC271"><span class="cm">     * @param sourceFile The source URL.</span></span><span class="line" lang="java" id="LC272"><span class="cm">     * @param targetDirectory The target directory.</span></span><span class="line" lang="java" id="LC273"><span class="cm">     * @param copyOptions Specifies how the copying should be done.</span></span><span class="line" lang="java" id="LC274"><span class="cm">     * @return The target file</span></span><span class="line" lang="java" id="LC275"><span class="cm">     * @throws IOException if an I/O error occurs.</span></span><span class="line" lang="java" id="LC276"><span class="cm">     * @see Files#copy(InputStream, Path, CopyOption...)</span></span><span class="line" lang="java" id="LC277"><span class="cm">     */</span></span><span class="line" lang="java" id="LC278"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>Path</span><span> </span><span>copyFileToDirectory</span><span>(</span><span class="kd">final</span><span> </span><span>URL</span><span> </span><span>sourceFile</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>targetDirectory</span><span>,</span></span><span class="line" lang="java" id="LC279"><span>        </span><span class="kd">final</span><span> </span><span>CopyOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>copyOptions</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC280"><span>        </span><span class="k">try</span><span> </span><span>(</span><span class="kd">final</span><span> </span><span>InputStream</span><span> </span><span>inputStream</span><span> </span><span>=</span><span> </span><span>sourceFile</span><span>.</span><span>openStream</span><span>(</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC281"><span>            </span><span>Files</span><span>.</span><span>copy</span><span>(</span><span>inputStream</span><span>,</span><span> </span><span>targetDirectory</span><span>.</span><span>resolve</span><span>(</span><span>sourceFile</span><span>.</span><span>getFile</span><span>(</span><span>)</span><span>)</span><span>,</span><span> </span><span>copyOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC282"><span>            </span><span class="k">return</span><span> </span><span>targetDirectory</span><span>;</span></span><span class="line" lang="java" id="LC283"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC284"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC285"></span><span class="line" lang="java" id="LC286"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC287"><span class="cm">     * Counts aspects of a directory including sub-directories.</span></span><span class="line" lang="java" id="LC288"><span class="cm">     *</span></span><span class="line" lang="java" id="LC289"><span class="cm">     * @param directory directory to delete.</span></span><span class="line" lang="java" id="LC290"><span class="cm">     * @return The visitor used to count the given directory.</span></span><span class="line" lang="java" id="LC291"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method.</span></span><span class="line" lang="java" id="LC292"><span class="cm">     */</span></span><span class="line" lang="java" id="LC293"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>PathCounters</span><span> </span><span>countDirectory</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>directory</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC294"><span>        </span><span class="k">return</span><span> </span><span>visitFileTree</span><span>(</span><span class="k">new</span><span> </span><span>CountingPathVisitor</span><span>(</span><span>Counters</span><span>.</span><span>longPathCounters</span><span>(</span><span>)</span><span>)</span><span>,</span><span> </span><span>directory</span><span>)</span><span>.</span><span>getPathCounters</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC295"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC296"></span><span class="line" lang="java" id="LC297"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC298"><span class="cm">     * Creates the parent directories for the given {@code path}.</span></span><span class="line" lang="java" id="LC299"><span class="cm">     *</span></span><span class="line" lang="java" id="LC300"><span class="cm">     * @param path The path to a file (or directory).</span></span><span class="line" lang="java" id="LC301"><span class="cm">     * @param attrs An optional list of file attributes to set atomically when creating the directories.</span></span><span class="line" lang="java" id="LC302"><span class="cm">     * @return The Path for the {@code path}&#39;s parent directory or null if the given path has no parent.</span></span><span class="line" lang="java" id="LC303"><span class="cm">     * @throws IOException if an I/O error occurs.</span></span><span class="line" lang="java" id="LC304"><span class="cm">     * @since 2.9.0</span></span><span class="line" lang="java" id="LC305"><span class="cm">     */</span></span><span class="line" lang="java" id="LC306"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>Path</span><span> </span><span>createParentDirectories</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>FileAttribute</span><span>&lt;</span><span>?</span><span>&gt;</span><span>.</span><span>.</span><span>.</span><span> </span><span>attrs</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC307"><span>        </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>parent</span><span> </span><span>=</span><span> </span><span>path</span><span>.</span><span>getParent</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC308"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>parent</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC309"><span>            </span><span class="k">return</span><span> </span><span class="kc">null</span><span>;</span></span><span class="line" lang="java" id="LC310"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC311"><span>        </span><span class="k">return</span><span> </span><span>Files</span><span>.</span><span>createDirectories</span><span>(</span><span>parent</span><span>,</span><span> </span><span>attrs</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC312"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC313"></span><span class="line" lang="java" id="LC314"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC315"><span class="cm">     * Gets the current directory.</span></span><span class="line" lang="java" id="LC316"><span class="cm">     *</span></span><span class="line" lang="java" id="LC317"><span class="cm">     * @return the current directory.</span></span><span class="line" lang="java" id="LC318"><span class="cm">     *</span></span><span class="line" lang="java" id="LC319"><span class="cm">     * @since 2.9.0</span></span><span class="line" lang="java" id="LC320"><span class="cm">     */</span></span><span class="line" lang="java" id="LC321"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>Path</span><span> </span><span>current</span><span>(</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC322"><span>        </span><span class="k">return</span><span> </span><span>Paths</span><span>.</span><span>get</span><span>(</span><span class="s">&quot;&quot;</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC323"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC324"></span><span class="line" lang="java" id="LC325"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC326"><span class="cm">     * Deletes a file or directory. If the path is a directory, delete it and all sub-directories.</span></span><span class="line" lang="java" id="LC327"><span class="cm">     * &lt;p&gt;</span></span><span class="line" lang="java" id="LC328"><span class="cm">     * The difference between File.delete() and this method are:</span></span><span class="line" lang="java" id="LC329"><span class="cm">     * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC330"><span class="cm">     * &lt;ul&gt;</span></span><span class="line" lang="java" id="LC331"><span class="cm">     * &lt;li&gt;A directory to delete does not have to be empty.&lt;/li&gt;</span></span><span class="line" lang="java" id="LC332"><span class="cm">     * &lt;li&gt;You get exceptions when a file or directory cannot be deleted; {@link java.io.File#delete()} returns a</span></span><span class="line" lang="java" id="LC333"><span class="cm">     * boolean.</span></span><span class="line" lang="java" id="LC334"><span class="cm">     * &lt;/ul&gt;</span></span><span class="line" lang="java" id="LC335"><span class="cm">     *</span></span><span class="line" lang="java" id="LC336"><span class="cm">     * @param path file or directory to delete, must not be {@code null}</span></span><span class="line" lang="java" id="LC337"><span class="cm">     * @return The visitor used to delete the given directory.</span></span><span class="line" lang="java" id="LC338"><span class="cm">     * @throws NullPointerException if the directory is {@code null}</span></span><span class="line" lang="java" id="LC339"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method or if an I/O error occurs.</span></span><span class="line" lang="java" id="LC340"><span class="cm">     */</span></span><span class="line" lang="java" id="LC341"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>PathCounters</span><span> </span><span>delete</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC342"><span>        </span><span class="k">return</span><span> </span><span>delete</span><span>(</span><span>path</span><span>,</span><span> </span><span>EMPTY_DELETE_OPTION_ARRAY</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC343"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC344"></span><span class="line" lang="java" id="LC345"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC346"><span class="cm">     * Deletes a file or directory. If the path is a directory, delete it and all sub-directories.</span></span><span class="line" lang="java" id="LC347"><span class="cm">     * &lt;p&gt;</span></span><span class="line" lang="java" id="LC348"><span class="cm">     * The difference between File.delete() and this method are:</span></span><span class="line" lang="java" id="LC349"><span class="cm">     * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC350"><span class="cm">     * &lt;ul&gt;</span></span><span class="line" lang="java" id="LC351"><span class="cm">     * &lt;li&gt;A directory to delete does not have to be empty.&lt;/li&gt;</span></span><span class="line" lang="java" id="LC352"><span class="cm">     * &lt;li&gt;You get exceptions when a file or directory cannot be deleted; {@link java.io.File#delete()} returns a</span></span><span class="line" lang="java" id="LC353"><span class="cm">     * boolean.</span></span><span class="line" lang="java" id="LC354"><span class="cm">     * &lt;/ul&gt;</span></span><span class="line" lang="java" id="LC355"><span class="cm">     *</span></span><span class="line" lang="java" id="LC356"><span class="cm">     * @param path file or directory to delete, must not be {@code null}</span></span><span class="line" lang="java" id="LC357"><span class="cm">     * @param deleteOptions How to handle deletion.</span></span><span class="line" lang="java" id="LC358"><span class="cm">     * @return The visitor used to delete the given directory.</span></span><span class="line" lang="java" id="LC359"><span class="cm">     * @throws NullPointerException if the directory is {@code null}</span></span><span class="line" lang="java" id="LC360"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method or if an I/O error occurs.</span></span><span class="line" lang="java" id="LC361"><span class="cm">     * @since 2.8.0</span></span><span class="line" lang="java" id="LC362"><span class="cm">     */</span></span><span class="line" lang="java" id="LC363"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>PathCounters</span><span> </span><span>delete</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>DeleteOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>deleteOptions</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC364"><span>        </span><span class="cm">// File deletion through Files deletes links, not targets, so use LinkOption.NOFOLLOW_LINKS.</span></span><span class="line" lang="java" id="LC365"><span>        </span><span class="k">return</span><span> </span><span>Files</span><span>.</span><span>isDirectory</span><span>(</span><span>path</span><span>,</span><span> </span><span>LinkOption</span><span>.</span><span>NOFOLLOW_LINKS</span><span>)</span><span> </span><span>?</span><span> </span><span>deleteDirectory</span><span>(</span><span>path</span><span>,</span><span> </span><span>deleteOptions</span><span>)</span></span><span class="line" lang="java" id="LC366"><span>            </span><span>:</span><span> </span><span>deleteFile</span><span>(</span><span>path</span><span>,</span><span> </span><span>deleteOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC367"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC368"></span><span class="line" lang="java" id="LC369"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC370"><span class="cm">     * Deletes a file or directory. If the path is a directory, delete it and all sub-directories.</span></span><span class="line" lang="java" id="LC371"><span class="cm">     * &lt;p&gt;</span></span><span class="line" lang="java" id="LC372"><span class="cm">     * The difference between File.delete() and this method are:</span></span><span class="line" lang="java" id="LC373"><span class="cm">     * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC374"><span class="cm">     * &lt;ul&gt;</span></span><span class="line" lang="java" id="LC375"><span class="cm">     * &lt;li&gt;A directory to delete does not have to be empty.&lt;/li&gt;</span></span><span class="line" lang="java" id="LC376"><span class="cm">     * &lt;li&gt;You get exceptions when a file or directory cannot be deleted; {@link java.io.File#delete()} returns a</span></span><span class="line" lang="java" id="LC377"><span class="cm">     * boolean.</span></span><span class="line" lang="java" id="LC378"><span class="cm">     * &lt;/ul&gt;</span></span><span class="line" lang="java" id="LC379"><span class="cm">     *</span></span><span class="line" lang="java" id="LC380"><span class="cm">     * @param path file or directory to delete, must not be {@code null}</span></span><span class="line" lang="java" id="LC381"><span class="cm">     * @param linkOptions How to handle symbolic links.</span></span><span class="line" lang="java" id="LC382"><span class="cm">     * @param deleteOptions How to handle deletion.</span></span><span class="line" lang="java" id="LC383"><span class="cm">     * @return The visitor used to delete the given directory.</span></span><span class="line" lang="java" id="LC384"><span class="cm">     * @throws NullPointerException if the directory is {@code null}</span></span><span class="line" lang="java" id="LC385"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method or if an I/O error occurs.</span></span><span class="line" lang="java" id="LC386"><span class="cm">     * @since 2.9.0</span></span><span class="line" lang="java" id="LC387"><span class="cm">     */</span></span><span class="line" lang="java" id="LC388"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>PathCounters</span><span> </span><span>delete</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>LinkOption</span><span>[</span><span>]</span><span> </span><span>linkOptions</span><span>,</span></span><span class="line" lang="java" id="LC389"><span>        </span><span class="kd">final</span><span> </span><span>DeleteOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>deleteOptions</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC390"><span>        </span><span class="cm">// File deletion through Files deletes links, not targets, so use LinkOption.NOFOLLOW_LINKS.</span></span><span class="line" lang="java" id="LC391"><span>        </span><span class="k">return</span><span> </span><span>Files</span><span>.</span><span>isDirectory</span><span>(</span><span>path</span><span>,</span><span> </span><span>linkOptions</span><span>)</span><span> </span><span>?</span><span> </span><span>deleteDirectory</span><span>(</span><span>path</span><span>,</span><span> </span><span>linkOptions</span><span>,</span><span> </span><span>deleteOptions</span><span>)</span></span><span class="line" lang="java" id="LC392"><span>            </span><span>:</span><span> </span><span>deleteFile</span><span>(</span><span>path</span><span>,</span><span> </span><span>linkOptions</span><span>,</span><span> </span><span>deleteOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC393"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC394"></span><span class="line" lang="java" id="LC395"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC396"><span class="cm">     * Deletes a directory including sub-directories.</span></span><span class="line" lang="java" id="LC397"><span class="cm">     *</span></span><span class="line" lang="java" id="LC398"><span class="cm">     * @param directory directory to delete.</span></span><span class="line" lang="java" id="LC399"><span class="cm">     * @return The visitor used to delete the given directory.</span></span><span class="line" lang="java" id="LC400"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method.</span></span><span class="line" lang="java" id="LC401"><span class="cm">     */</span></span><span class="line" lang="java" id="LC402"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>PathCounters</span><span> </span><span>deleteDirectory</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>directory</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC403"><span>        </span><span class="k">return</span><span> </span><span>deleteDirectory</span><span>(</span><span>directory</span><span>,</span><span> </span><span>EMPTY_DELETE_OPTION_ARRAY</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC404"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC405"></span><span class="line" lang="java" id="LC406"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC407"><span class="cm">     * Deletes a directory including sub-directories.</span></span><span class="line" lang="java" id="LC408"><span class="cm">     *</span></span><span class="line" lang="java" id="LC409"><span class="cm">     * @param directory directory to delete.</span></span><span class="line" lang="java" id="LC410"><span class="cm">     * @param deleteOptions How to handle deletion.</span></span><span class="line" lang="java" id="LC411"><span class="cm">     * @return The visitor used to delete the given directory.</span></span><span class="line" lang="java" id="LC412"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method.</span></span><span class="line" lang="java" id="LC413"><span class="cm">     * @since 2.8.0</span></span><span class="line" lang="java" id="LC414"><span class="cm">     */</span></span><span class="line" lang="java" id="LC415"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>PathCounters</span><span> </span><span>deleteDirectory</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>directory</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>DeleteOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>deleteOptions</span><span>)</span></span><span class="line" lang="java" id="LC416"><span>        </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC417"><span>        </span><span class="k">return</span><span> </span><span>visitFileTree</span><span>(</span></span><span class="line" lang="java" id="LC418"><span>            </span><span class="k">new</span><span> </span><span>DeletingPathVisitor</span><span>(</span><span>Counters</span><span>.</span><span>longPathCounters</span><span>(</span><span>)</span><span>,</span><span> </span><span>PathUtils</span><span>.</span><span>NOFOLLOW_LINK_OPTION_ARRAY</span><span>,</span><span> </span><span>deleteOptions</span><span>)</span><span>,</span></span><span class="line" lang="java" id="LC419"><span>            </span><span>directory</span><span>)</span><span>.</span><span>getPathCounters</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC420"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC421"></span><span class="line" lang="java" id="LC422"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC423"><span class="cm">     * Deletes a directory including sub-directories.</span></span><span class="line" lang="java" id="LC424"><span class="cm">     *</span></span><span class="line" lang="java" id="LC425"><span class="cm">     * @param directory directory to delete.</span></span><span class="line" lang="java" id="LC426"><span class="cm">     * @param linkOptions How to handle symbolic links.</span></span><span class="line" lang="java" id="LC427"><span class="cm">     * @param deleteOptions How to handle deletion.</span></span><span class="line" lang="java" id="LC428"><span class="cm">     * @return The visitor used to delete the given directory.</span></span><span class="line" lang="java" id="LC429"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method.</span></span><span class="line" lang="java" id="LC430"><span class="cm">     * @since 2.9.0</span></span><span class="line" lang="java" id="LC431"><span class="cm">     */</span></span><span class="line" lang="java" id="LC432"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>PathCounters</span><span> </span><span>deleteDirectory</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>directory</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>LinkOption</span><span>[</span><span>]</span><span> </span><span>linkOptions</span><span>,</span></span><span class="line" lang="java" id="LC433"><span>        </span><span class="kd">final</span><span> </span><span>DeleteOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>deleteOptions</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC434"><span>        </span><span class="k">return</span><span> </span><span>visitFileTree</span><span>(</span><span class="k">new</span><span> </span><span>DeletingPathVisitor</span><span>(</span><span>Counters</span><span>.</span><span>longPathCounters</span><span>(</span><span>)</span><span>,</span><span> </span><span>linkOptions</span><span>,</span><span> </span><span>deleteOptions</span><span>)</span><span>,</span></span><span class="line" lang="java" id="LC435"><span>            </span><span>directory</span><span>)</span><span>.</span><span>getPathCounters</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC436"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC437"></span><span class="line" lang="java" id="LC438"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC439"><span class="cm">     * Deletes the given file.</span></span><span class="line" lang="java" id="LC440"><span class="cm">     *</span></span><span class="line" lang="java" id="LC441"><span class="cm">     * @param file The file to delete.</span></span><span class="line" lang="java" id="LC442"><span class="cm">     * @return A visitor with path counts set to 1 file, 0 directories, and the size of the deleted file.</span></span><span class="line" lang="java" id="LC443"><span class="cm">     * @throws IOException if an I/O error occurs.</span></span><span class="line" lang="java" id="LC444"><span class="cm">     * @throws NoSuchFileException if the file is a directory.</span></span><span class="line" lang="java" id="LC445"><span class="cm">     */</span></span><span class="line" lang="java" id="LC446"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>PathCounters</span><span> </span><span>deleteFile</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>file</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC447"><span>        </span><span class="k">return</span><span> </span><span>deleteFile</span><span>(</span><span>file</span><span>,</span><span> </span><span>EMPTY_DELETE_OPTION_ARRAY</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC448"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC449"></span><span class="line" lang="java" id="LC450"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC451"><span class="cm">     * Deletes the given file.</span></span><span class="line" lang="java" id="LC452"><span class="cm">     *</span></span><span class="line" lang="java" id="LC453"><span class="cm">     * @param file The file to delete.</span></span><span class="line" lang="java" id="LC454"><span class="cm">     * @param deleteOptions How to handle deletion.</span></span><span class="line" lang="java" id="LC455"><span class="cm">     * @return A visitor with path counts set to 1 file, 0 directories, and the size of the deleted file.</span></span><span class="line" lang="java" id="LC456"><span class="cm">     * @throws IOException if an I/O error occurs.</span></span><span class="line" lang="java" id="LC457"><span class="cm">     * @throws NoSuchFileException if the file is a directory.</span></span><span class="line" lang="java" id="LC458"><span class="cm">     * @since 2.8.0</span></span><span class="line" lang="java" id="LC459"><span class="cm">     */</span></span><span class="line" lang="java" id="LC460"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>PathCounters</span><span> </span><span>deleteFile</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>file</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>DeleteOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>deleteOptions</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC461"><span>        </span><span class="cm">// Files.deleteIfExists() never follows links, so use LinkOption.NOFOLLOW_LINKS in other calls to Files.</span></span><span class="line" lang="java" id="LC462"><span>        </span><span class="k">return</span><span> </span><span>deleteFile</span><span>(</span><span>file</span><span>,</span><span> </span><span>NOFOLLOW_LINK_OPTION_ARRAY</span><span>,</span><span> </span><span>deleteOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC463"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC464"></span><span class="line" lang="java" id="LC465"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC466"><span class="cm">     * Deletes the given file.</span></span><span class="line" lang="java" id="LC467"><span class="cm">     *</span></span><span class="line" lang="java" id="LC468"><span class="cm">     * @param file The file to delete.</span></span><span class="line" lang="java" id="LC469"><span class="cm">     * @param linkOptions How to handle symbolic links.</span></span><span class="line" lang="java" id="LC470"><span class="cm">     * @param deleteOptions How to handle deletion.</span></span><span class="line" lang="java" id="LC471"><span class="cm">     * @return A visitor with path counts set to 1 file, 0 directories, and the size of the deleted file.</span></span><span class="line" lang="java" id="LC472"><span class="cm">     * @throws IOException if an I/O error occurs.</span></span><span class="line" lang="java" id="LC473"><span class="cm">     * @throws NoSuchFileException if the file is a directory.</span></span><span class="line" lang="java" id="LC474"><span class="cm">     * @since 2.9.0</span></span><span class="line" lang="java" id="LC475"><span class="cm">     */</span></span><span class="line" lang="java" id="LC476"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>PathCounters</span><span> </span><span>deleteFile</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>file</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>LinkOption</span><span>[</span><span>]</span><span> </span><span>linkOptions</span><span>,</span></span><span class="line" lang="java" id="LC477"><span>        </span><span class="kd">final</span><span> </span><span>DeleteOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>deleteOptions</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>NoSuchFileException</span><span>,</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC478"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>Files</span><span>.</span><span>isDirectory</span><span>(</span><span>file</span><span>,</span><span> </span><span>linkOptions</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC479"><span>            </span><span class="k">throw</span><span> </span><span class="k">new</span><span> </span><span>NoSuchFileException</span><span>(</span><span>file</span><span>.</span><span>toString</span><span>(</span><span>)</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC480"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC481"><span>        </span><span class="kd">final</span><span> </span><span>PathCounters</span><span> </span><span>pathCounts</span><span> </span><span>=</span><span> </span><span>Counters</span><span>.</span><span>longPathCounters</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC482"><span>        </span><span class="kd">final</span><span> </span><span class="kt">boolean</span><span> </span><span>exists</span><span> </span><span>=</span><span> </span><span>Files</span><span>.</span><span>exists</span><span>(</span><span>file</span><span>,</span><span> </span><span>linkOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC483"><span>        </span><span class="kd">final</span><span> </span><span class="kt">long</span><span> </span><span>size</span><span> </span><span>=</span><span> </span><span>exists</span><span> </span><span>&amp;&amp;</span><span> </span><span>!</span><span>Files</span><span>.</span><span>isSymbolicLink</span><span>(</span><span>file</span><span>)</span><span> </span><span>?</span><span> </span><span>Files</span><span>.</span><span>size</span><span>(</span><span>file</span><span>)</span><span> </span><span>:</span><span> </span><span>0</span><span>;</span></span><span class="line" lang="java" id="LC484"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>overrideReadOnly</span><span>(</span><span>deleteOptions</span><span>)</span><span> </span><span>&amp;&amp;</span><span> </span><span>exists</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC485"><span>            </span><span>setReadOnly</span><span>(</span><span>file</span><span>,</span><span> </span><span class="kc">false</span><span>,</span><span> </span><span>linkOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC486"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC487"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>Files</span><span>.</span><span>deleteIfExists</span><span>(</span><span>file</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC488"><span>            </span><span>pathCounts</span><span>.</span><span>getFileCounter</span><span>(</span><span>)</span><span>.</span><span>increment</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC489"><span>            </span><span>pathCounts</span><span>.</span><span>getByteCounter</span><span>(</span><span>)</span><span>.</span><span>add</span><span>(</span><span>size</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC490"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC491"><span>        </span><span class="k">return</span><span> </span><span>pathCounts</span><span>;</span></span><span class="line" lang="java" id="LC492"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC493"></span><span class="line" lang="java" id="LC494"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC495"><span class="cm">     * Compares the file sets of two Paths to determine if they are equal or not while considering file contents. The</span></span><span class="line" lang="java" id="LC496"><span class="cm">     * comparison includes all files in all sub-directories.</span></span><span class="line" lang="java" id="LC497"><span class="cm">     *</span></span><span class="line" lang="java" id="LC498"><span class="cm">     * @param path1 The first directory.</span></span><span class="line" lang="java" id="LC499"><span class="cm">     * @param path2 The second directory.</span></span><span class="line" lang="java" id="LC500"><span class="cm">     * @return Whether the two directories contain the same files while considering file contents.</span></span><span class="line" lang="java" id="LC501"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method</span></span><span class="line" lang="java" id="LC502"><span class="cm">     */</span></span><span class="line" lang="java" id="LC503"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kt">boolean</span><span> </span><span>directoryAndFileContentEquals</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path1</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path2</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC504"><span>        </span><span class="k">return</span><span> </span><span>directoryAndFileContentEquals</span><span>(</span><span>path1</span><span>,</span><span> </span><span>path2</span><span>,</span><span> </span><span>EMPTY_LINK_OPTION_ARRAY</span><span>,</span><span> </span><span>EMPTY_OPEN_OPTION_ARRAY</span><span>,</span></span><span class="line" lang="java" id="LC505"><span>            </span><span>EMPTY_FILE_VISIT_OPTION_ARRAY</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC506"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC507"></span><span class="line" lang="java" id="LC508"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC509"><span class="cm">     * Compares the file sets of two Paths to determine if they are equal or not while considering file contents. The</span></span><span class="line" lang="java" id="LC510"><span class="cm">     * comparison includes all files in all sub-directories.</span></span><span class="line" lang="java" id="LC511"><span class="cm">     *</span></span><span class="line" lang="java" id="LC512"><span class="cm">     * @param path1 The first directory.</span></span><span class="line" lang="java" id="LC513"><span class="cm">     * @param path2 The second directory.</span></span><span class="line" lang="java" id="LC514"><span class="cm">     * @param linkOptions options to follow links.</span></span><span class="line" lang="java" id="LC515"><span class="cm">     * @param openOptions options to open files.</span></span><span class="line" lang="java" id="LC516"><span class="cm">     * @param fileVisitOption options to configure traversal.</span></span><span class="line" lang="java" id="LC517"><span class="cm">     * @return Whether the two directories contain the same files while considering file contents.</span></span><span class="line" lang="java" id="LC518"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method</span></span><span class="line" lang="java" id="LC519"><span class="cm">     */</span></span><span class="line" lang="java" id="LC520"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kt">boolean</span><span> </span><span>directoryAndFileContentEquals</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path1</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path2</span><span>,</span></span><span class="line" lang="java" id="LC521"><span>        </span><span class="kd">final</span><span> </span><span>LinkOption</span><span>[</span><span>]</span><span> </span><span>linkOptions</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>OpenOption</span><span>[</span><span>]</span><span> </span><span>openOptions</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>FileVisitOption</span><span>[</span><span>]</span><span> </span><span>fileVisitOption</span><span>)</span></span><span class="line" lang="java" id="LC522"><span>        </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC523"><span>        </span><span class="cm">// First walk both file trees and gather normalized paths.</span></span><span class="line" lang="java" id="LC524"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>path1</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span> </span><span>&amp;&amp;</span><span> </span><span>path2</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC525"><span>            </span><span class="k">return</span><span> </span><span class="kc">true</span><span>;</span></span><span class="line" lang="java" id="LC526"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC527"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>path1</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span> </span><span>||</span><span> </span><span>path2</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC528"><span>            </span><span class="k">return</span><span> </span><span class="kc">false</span><span>;</span></span><span class="line" lang="java" id="LC529"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC530"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>Files</span><span>.</span><span>notExists</span><span>(</span><span>path1</span><span>)</span><span> </span><span>&amp;&amp;</span><span> </span><span>Files</span><span>.</span><span>notExists</span><span>(</span><span>path2</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC531"><span>            </span><span class="k">return</span><span> </span><span class="kc">true</span><span>;</span></span><span class="line" lang="java" id="LC532"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC533"><span>        </span><span class="kd">final</span><span> </span><span>RelativeSortedPaths</span><span> </span><span>relativeSortedPaths</span><span> </span><span>=</span><span> </span><span class="k">new</span><span> </span><span>RelativeSortedPaths</span><span>(</span><span>path1</span><span>,</span><span> </span><span>path2</span><span>,</span><span> </span><span>Integer</span><span>.</span><span>MAX_VALUE</span><span>,</span></span><span class="line" lang="java" id="LC534"><span>            </span><span>linkOptions</span><span>,</span><span> </span><span>fileVisitOption</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC535"><span>        </span><span class="cm">// If the normalized path names and counts are not the same, no need to compare contents.</span></span><span class="line" lang="java" id="LC536"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>!</span><span>relativeSortedPaths</span><span>.</span><span>equals</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC537"><span>            </span><span class="k">return</span><span> </span><span class="kc">false</span><span>;</span></span><span class="line" lang="java" id="LC538"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC539"><span>        </span><span class="cm">// Both visitors contain the same normalized paths, we can compare file contents.</span></span><span class="line" lang="java" id="LC540"><span>        </span><span class="kd">final</span><span> </span><span>List</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>fileList1</span><span> </span><span>=</span><span> </span><span>relativeSortedPaths</span><span>.</span><span>relativeFileList1</span><span>;</span></span><span class="line" lang="java" id="LC541"><span>        </span><span class="kd">final</span><span> </span><span>List</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>fileList2</span><span> </span><span>=</span><span> </span><span>relativeSortedPaths</span><span>.</span><span>relativeFileList2</span><span>;</span></span><span class="line" lang="java" id="LC542"><span>        </span><span class="k">for</span><span> </span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path</span><span> </span><span>:</span><span> </span><span>fileList1</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC543"><span>            </span><span class="kd">final</span><span> </span><span class="kt">int</span><span> </span><span>binarySearch</span><span> </span><span>=</span><span> </span><span>Collections</span><span>.</span><span>binarySearch</span><span>(</span><span>fileList2</span><span>,</span><span> </span><span>path</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC544"><span>            </span><span class="k">if</span><span> </span><span>(</span><span>binarySearch</span><span> </span><span>&lt;=</span><span> </span><span>-</span><span>1</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC545"><span>                </span><span class="k">throw</span><span> </span><span class="k">new</span><span> </span><span>IllegalStateException</span><span>(</span><span class="s">&quot;Unexpected mismatch.&quot;</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC546"><span>            </span><span>}</span></span><span class="line" lang="java" id="LC547"><span>            </span><span class="k">if</span><span> </span><span>(</span><span>!</span><span>fileContentEquals</span><span>(</span><span>path1</span><span>.</span><span>resolve</span><span>(</span><span>path</span><span>)</span><span>,</span><span> </span><span>path2</span><span>.</span><span>resolve</span><span>(</span><span>path</span><span>)</span><span>,</span><span> </span><span>linkOptions</span><span>,</span><span> </span><span>openOptions</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC548"><span>                </span><span class="k">return</span><span> </span><span class="kc">false</span><span>;</span></span><span class="line" lang="java" id="LC549"><span>            </span><span>}</span></span><span class="line" lang="java" id="LC550"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC551"><span>        </span><span class="k">return</span><span> </span><span class="kc">true</span><span>;</span></span><span class="line" lang="java" id="LC552"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC553"></span><span class="line" lang="java" id="LC554"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC555"><span class="cm">     * Compares the file sets of two Paths to determine if they are equal or not without considering file contents. The</span></span><span class="line" lang="java" id="LC556"><span class="cm">     * comparison includes all files in all sub-directories.</span></span><span class="line" lang="java" id="LC557"><span class="cm">     *</span></span><span class="line" lang="java" id="LC558"><span class="cm">     * @param path1 The first directory.</span></span><span class="line" lang="java" id="LC559"><span class="cm">     * @param path2 The second directory.</span></span><span class="line" lang="java" id="LC560"><span class="cm">     * @return Whether the two directories contain the same files without considering file contents.</span></span><span class="line" lang="java" id="LC561"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method</span></span><span class="line" lang="java" id="LC562"><span class="cm">     */</span></span><span class="line" lang="java" id="LC563"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kt">boolean</span><span> </span><span>directoryContentEquals</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path1</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path2</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC564"><span>        </span><span class="k">return</span><span> </span><span>directoryContentEquals</span><span>(</span><span>path1</span><span>,</span><span> </span><span>path2</span><span>,</span><span> </span><span>Integer</span><span>.</span><span>MAX_VALUE</span><span>,</span><span> </span><span>EMPTY_LINK_OPTION_ARRAY</span><span>,</span></span><span class="line" lang="java" id="LC565"><span>            </span><span>EMPTY_FILE_VISIT_OPTION_ARRAY</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC566"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC567"></span><span class="line" lang="java" id="LC568"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC569"><span class="cm">     * Compares the file sets of two Paths to determine if they are equal or not without considering file contents. The</span></span><span class="line" lang="java" id="LC570"><span class="cm">     * comparison includes all files in all sub-directories.</span></span><span class="line" lang="java" id="LC571"><span class="cm">     *</span></span><span class="line" lang="java" id="LC572"><span class="cm">     * @param path1 The first directory.</span></span><span class="line" lang="java" id="LC573"><span class="cm">     * @param path2 The second directory.</span></span><span class="line" lang="java" id="LC574"><span class="cm">     * @param maxDepth See {@link Files#walkFileTree(Path,Set,int,FileVisitor)}.</span></span><span class="line" lang="java" id="LC575"><span class="cm">     * @param linkOptions options to follow links.</span></span><span class="line" lang="java" id="LC576"><span class="cm">     * @param fileVisitOptions options to configure the traversal</span></span><span class="line" lang="java" id="LC577"><span class="cm">     * @return Whether the two directories contain the same files without considering file contents.</span></span><span class="line" lang="java" id="LC578"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method</span></span><span class="line" lang="java" id="LC579"><span class="cm">     */</span></span><span class="line" lang="java" id="LC580"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kt">boolean</span><span> </span><span>directoryContentEquals</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path1</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path2</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span class="kt">int</span><span> </span><span>maxDepth</span><span>,</span></span><span class="line" lang="java" id="LC581"><span>        </span><span class="kd">final</span><span> </span><span>LinkOption</span><span>[</span><span>]</span><span> </span><span>linkOptions</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>FileVisitOption</span><span>[</span><span>]</span><span> </span><span>fileVisitOptions</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC582"><span>        </span><span class="k">return</span><span> </span><span class="k">new</span><span> </span><span>RelativeSortedPaths</span><span>(</span><span>path1</span><span>,</span><span> </span><span>path2</span><span>,</span><span> </span><span>maxDepth</span><span>,</span><span> </span><span>linkOptions</span><span>,</span><span> </span><span>fileVisitOptions</span><span>)</span><span>.</span><span>equals</span><span>;</span></span><span class="line" lang="java" id="LC583"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC584"></span><span class="line" lang="java" id="LC585"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC586"><span class="cm">     * Compares the file contents of two Paths to determine if they are equal or not.</span></span><span class="line" lang="java" id="LC587"><span class="cm">     * &lt;p&gt;</span></span><span class="line" lang="java" id="LC588"><span class="cm">     * File content is accessed through {@link Files#newInputStream(Path,OpenOption...)}.</span></span><span class="line" lang="java" id="LC589"><span class="cm">     * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC590"><span class="cm">     *</span></span><span class="line" lang="java" id="LC591"><span class="cm">     * @param path1 the first stream.</span></span><span class="line" lang="java" id="LC592"><span class="cm">     * @param path2 the second stream.</span></span><span class="line" lang="java" id="LC593"><span class="cm">     * @return true if the content of the streams are equal or they both don&#39;t exist, false otherwise.</span></span><span class="line" lang="java" id="LC594"><span class="cm">     * @throws NullPointerException if either input is null.</span></span><span class="line" lang="java" id="LC595"><span class="cm">     * @throws IOException if an I/O error occurs.</span></span><span class="line" lang="java" id="LC596"><span class="cm">     * @see org.apache.commons.io.FileUtils#contentEquals(java.io.File, java.io.File)</span></span><span class="line" lang="java" id="LC597"><span class="cm">     */</span></span><span class="line" lang="java" id="LC598"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kt">boolean</span><span> </span><span>fileContentEquals</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path1</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path2</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC599"><span>        </span><span class="k">return</span><span> </span><span>fileContentEquals</span><span>(</span><span>path1</span><span>,</span><span> </span><span>path2</span><span>,</span><span> </span><span>EMPTY_LINK_OPTION_ARRAY</span><span>,</span><span> </span><span>EMPTY_OPEN_OPTION_ARRAY</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC600"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC601"></span><span class="line" lang="java" id="LC602"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC603"><span class="cm">     * Compares the file contents of two Paths to determine if they are equal or not.</span></span><span class="line" lang="java" id="LC604"><span class="cm">     * &lt;p&gt;</span></span><span class="line" lang="java" id="LC605"><span class="cm">     * File content is accessed through {@link Files#newInputStream(Path,OpenOption...)}.</span></span><span class="line" lang="java" id="LC606"><span class="cm">     * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC607"><span class="cm">     *</span></span><span class="line" lang="java" id="LC608"><span class="cm">     * @param path1 the first stream.</span></span><span class="line" lang="java" id="LC609"><span class="cm">     * @param path2 the second stream.</span></span><span class="line" lang="java" id="LC610"><span class="cm">     * @param linkOptions options specifying how files are followed.</span></span><span class="line" lang="java" id="LC611"><span class="cm">     * @param openOptions options specifying how files are opened.</span></span><span class="line" lang="java" id="LC612"><span class="cm">     * @return true if the content of the streams are equal or they both don&#39;t exist, false otherwise.</span></span><span class="line" lang="java" id="LC613"><span class="cm">     * @throws NullPointerException if either input is null.</span></span><span class="line" lang="java" id="LC614"><span class="cm">     * @throws IOException if an I/O error occurs.</span></span><span class="line" lang="java" id="LC615"><span class="cm">     * @see org.apache.commons.io.FileUtils#contentEquals(java.io.File, java.io.File)</span></span><span class="line" lang="java" id="LC616"><span class="cm">     */</span></span><span class="line" lang="java" id="LC617"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kt">boolean</span><span> </span><span>fileContentEquals</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path1</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path2</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>LinkOption</span><span>[</span><span>]</span><span> </span><span>linkOptions</span><span>,</span></span><span class="line" lang="java" id="LC618"><span>        </span><span class="kd">final</span><span> </span><span>OpenOption</span><span>[</span><span>]</span><span> </span><span>openOptions</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC619"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>path1</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span> </span><span>&amp;&amp;</span><span> </span><span>path2</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC620"><span>            </span><span class="k">return</span><span> </span><span class="kc">true</span><span>;</span></span><span class="line" lang="java" id="LC621"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC622"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>path1</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span> </span><span>||</span><span> </span><span>path2</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC623"><span>            </span><span class="k">return</span><span> </span><span class="kc">false</span><span>;</span></span><span class="line" lang="java" id="LC624"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC625"><span>        </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>nPath1</span><span> </span><span>=</span><span> </span><span>path1</span><span>.</span><span>normalize</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC626"><span>        </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>nPath2</span><span> </span><span>=</span><span> </span><span>path2</span><span>.</span><span>normalize</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC627"><span>        </span><span class="kd">final</span><span> </span><span class="kt">boolean</span><span> </span><span>path1Exists</span><span> </span><span>=</span><span> </span><span>Files</span><span>.</span><span>exists</span><span>(</span><span>nPath1</span><span>,</span><span> </span><span>linkOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC628"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>path1Exists</span><span> </span><span>!=</span><span> </span><span>Files</span><span>.</span><span>exists</span><span>(</span><span>nPath2</span><span>,</span><span> </span><span>linkOptions</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC629"><span>            </span><span class="k">return</span><span> </span><span class="kc">false</span><span>;</span></span><span class="line" lang="java" id="LC630"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC631"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>!</span><span>path1Exists</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC632"><span>            </span><span class="cm">// Two not existing files are equal?</span></span><span class="line" lang="java" id="LC633"><span>            </span><span class="cm">// Same as FileUtils</span></span><span class="line" lang="java" id="LC634"><span>            </span><span class="k">return</span><span> </span><span class="kc">true</span><span>;</span></span><span class="line" lang="java" id="LC635"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC636"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>Files</span><span>.</span><span>isDirectory</span><span>(</span><span>nPath1</span><span>,</span><span> </span><span>linkOptions</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC637"><span>            </span><span class="cm">// don&#39;t compare directory contents.</span></span><span class="line" lang="java" id="LC638"><span>            </span><span class="k">throw</span><span> </span><span class="k">new</span><span> </span><span>IOException</span><span>(</span><span class="s">&quot;Can&#39;t compare directories, only files: &quot;</span><span> </span><span>+</span><span> </span><span>nPath1</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC639"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC640"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>Files</span><span>.</span><span>isDirectory</span><span>(</span><span>nPath2</span><span>,</span><span> </span><span>linkOptions</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC641"><span>            </span><span class="cm">// don&#39;t compare directory contents.</span></span><span class="line" lang="java" id="LC642"><span>            </span><span class="k">throw</span><span> </span><span class="k">new</span><span> </span><span>IOException</span><span>(</span><span class="s">&quot;Can&#39;t compare directories, only files: &quot;</span><span> </span><span>+</span><span> </span><span>nPath2</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC643"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC644"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>Files</span><span>.</span><span>size</span><span>(</span><span>nPath1</span><span>)</span><span> </span><span>!=</span><span> </span><span>Files</span><span>.</span><span>size</span><span>(</span><span>nPath2</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC645"><span>            </span><span class="cm">// lengths differ, cannot be equal</span></span><span class="line" lang="java" id="LC646"><span>            </span><span class="k">return</span><span> </span><span class="kc">false</span><span>;</span></span><span class="line" lang="java" id="LC647"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC648"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>path1</span><span>.</span><span>equals</span><span>(</span><span>path2</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC649"><span>            </span><span class="cm">// same file</span></span><span class="line" lang="java" id="LC650"><span>            </span><span class="k">return</span><span> </span><span class="kc">true</span><span>;</span></span><span class="line" lang="java" id="LC651"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC652"><span>        </span><span class="k">try</span><span> </span><span>(</span><span class="kd">final</span><span> </span><span>InputStream</span><span> </span><span>inputStream1</span><span> </span><span>=</span><span> </span><span>Files</span><span>.</span><span>newInputStream</span><span>(</span><span>nPath1</span><span>,</span><span> </span><span>openOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC653"><span>            </span><span class="kd">final</span><span> </span><span>InputStream</span><span> </span><span>inputStream2</span><span> </span><span>=</span><span> </span><span>Files</span><span>.</span><span>newInputStream</span><span>(</span><span>nPath2</span><span>,</span><span> </span><span>openOptions</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC654"><span>            </span><span class="k">return</span><span> </span><span>IOUtils</span><span>.</span><span>contentEquals</span><span>(</span><span>inputStream1</span><span>,</span><span> </span><span>inputStream2</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC655"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC656"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC657"></span><span class="line" lang="java" id="LC658"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC659"><span class="cm">     * &lt;p&gt;</span></span><span class="line" lang="java" id="LC660"><span class="cm">     * Applies an {@link IOFileFilter} to the provided {@link File} objects. The resulting array is a subset of the</span></span><span class="line" lang="java" id="LC661"><span class="cm">     * original file list that matches the provided filter.</span></span><span class="line" lang="java" id="LC662"><span class="cm">     * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC663"><span class="cm">     *</span></span><span class="line" lang="java" id="LC664"><span class="cm">     * &lt;p&gt;</span></span><span class="line" lang="java" id="LC665"><span class="cm">     * The {@link Set} returned by this method is not guaranteed to be thread safe.</span></span><span class="line" lang="java" id="LC666"><span class="cm">     * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC667"><span class="cm">     *</span></span><span class="line" lang="java" id="LC668"><span class="cm">     * &lt;pre&gt;</span></span><span class="line" lang="java" id="LC669"><span class="cm">     * Set&amp;lt;File&amp;gt; allFiles = ...</span></span><span class="line" lang="java" id="LC670"><span class="cm">     * Set&amp;lt;File&amp;gt; javaFiles = FileFilterUtils.filterSet(allFiles,</span></span><span class="line" lang="java" id="LC671"><span class="cm">     *     FileFilterUtils.suffixFileFilter(&quot;.java&quot;));</span></span><span class="line" lang="java" id="LC672"><span class="cm">     * &lt;/pre&gt;</span></span><span class="line" lang="java" id="LC673"><span class="cm">     *</span></span><span class="line" lang="java" id="LC674"><span class="cm">     * @param filter the filter to apply to the set of files.</span></span><span class="line" lang="java" id="LC675"><span class="cm">     * @param paths the array of files to apply the filter to.</span></span><span class="line" lang="java" id="LC676"><span class="cm">     *</span></span><span class="line" lang="java" id="LC677"><span class="cm">     * @return a subset of {@code files} that is accepted by the file filter.</span></span><span class="line" lang="java" id="LC678"><span class="cm">     * @throws IllegalArgumentException if the filter is {@code null} or {@code files} contains a {@code null}</span></span><span class="line" lang="java" id="LC679"><span class="cm">     *         value.</span></span><span class="line" lang="java" id="LC680"><span class="cm">     *</span></span><span class="line" lang="java" id="LC681"><span class="cm">     * @since 2.9.0</span></span><span class="line" lang="java" id="LC682"><span class="cm">     */</span></span><span class="line" lang="java" id="LC683"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>Path</span><span>[</span><span>]</span><span> </span><span>filter</span><span>(</span><span class="kd">final</span><span> </span><span>PathFilter</span><span> </span><span>filter</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span>.</span><span>.</span><span>.</span><span> </span><span>paths</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC684"><span>        </span><span>Objects</span><span>.</span><span>requireNonNull</span><span>(</span><span>filter</span><span>,</span><span> </span><span class="s">&quot;filter&quot;</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC685"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>paths</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC686"><span>            </span><span class="k">return</span><span> </span><span>EMPTY_PATH_ARRAY</span><span>;</span></span><span class="line" lang="java" id="LC687"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC688"><span>        </span><span class="k">return</span><span> </span><span>filterPaths</span><span>(</span><span>filter</span><span>,</span><span> </span><span>Stream</span><span>.</span><span>of</span><span>(</span><span>paths</span><span>)</span><span>,</span><span> </span><span>Collectors</span><span>.</span><span>toList</span><span>(</span><span>)</span><span>)</span><span>.</span><span>toArray</span><span>(</span><span>EMPTY_PATH_ARRAY</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC689"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC690"></span><span class="line" lang="java" id="LC691"><span>    </span><span class="kd">private</span><span> </span><span class="kd">static</span><span> </span><span>&lt;</span><span>R</span><span>,</span><span> </span><span>A</span><span>&gt;</span><span> </span><span>R</span><span> </span><span>filterPaths</span><span>(</span><span class="kd">final</span><span> </span><span>PathFilter</span><span> </span><span>filter</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Stream</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>stream</span><span>,</span></span><span class="line" lang="java" id="LC692"><span>        </span><span class="kd">final</span><span> </span><span>Collector</span><span>&lt;</span><span>?</span><span> </span><span class="kd">super</span><span> </span><span>Path</span><span>,</span><span> </span><span>A</span><span>,</span><span> </span><span>R</span><span>&gt;</span><span> </span><span>collector</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC693"><span>        </span><span>Objects</span><span>.</span><span>requireNonNull</span><span>(</span><span>filter</span><span>,</span><span> </span><span class="s">&quot;filter&quot;</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC694"><span>        </span><span>Objects</span><span>.</span><span>requireNonNull</span><span>(</span><span>collector</span><span>,</span><span> </span><span class="s">&quot;collector&quot;</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC695"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>stream</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC696"><span>            </span><span class="k">return</span><span> </span><span>Stream</span><span>.</span><span>&lt;</span><span>Path</span><span>&gt;</span><span>empty</span><span>(</span><span>)</span><span>.</span><span>collect</span><span>(</span><span>collector</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC697"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC698"><span>        </span><span class="k">return</span><span> </span><span>stream</span><span>.</span><span>filter</span><span>(</span><span>p</span><span> </span><span>-</span><span>&gt;</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC699"><span>            </span><span class="k">try</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC700"><span>                </span><span class="k">return</span><span> </span><span>p</span><span> </span><span>!=</span><span> </span><span class="kc">null</span><span> </span><span>&amp;&amp;</span><span> </span><span>filter</span><span>.</span><span>accept</span><span>(</span><span>p</span><span>,</span><span> </span><span>readBasicFileAttributes</span><span>(</span><span>p</span><span>)</span><span>)</span><span> </span><span>==</span><span> </span><span>FileVisitResult</span><span>.</span><span>CONTINUE</span><span>;</span></span><span class="line" lang="java" id="LC701"><span>            </span><span>}</span><span> </span><span class="k">catch</span><span> </span><span>(</span><span class="kd">final</span><span> </span><span>IOException</span><span> </span><span>e</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC702"><span>                </span><span class="k">return</span><span> </span><span class="kc">false</span><span>;</span></span><span class="line" lang="java" id="LC703"><span>            </span><span>}</span></span><span class="line" lang="java" id="LC704"><span>        </span><span>}</span><span>)</span><span>.</span><span>collect</span><span>(</span><span>collector</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC705"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC706"></span><span class="line" lang="java" id="LC707"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC708"><span class="cm">     * Reads the access control list from a file attribute view.</span></span><span class="line" lang="java" id="LC709"><span class="cm">     *</span></span><span class="line" lang="java" id="LC710"><span class="cm">     * @param sourcePath the path to the file.</span></span><span class="line" lang="java" id="LC711"><span class="cm">     * @return a file attribute view of the specified type, or null if the attribute view type is not available.</span></span><span class="line" lang="java" id="LC712"><span class="cm">     * @throws IOException if an I/O error occurs.</span></span><span class="line" lang="java" id="LC713"><span class="cm">     * @since 2.8.0</span></span><span class="line" lang="java" id="LC714"><span class="cm">     */</span></span><span class="line" lang="java" id="LC715"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>List</span><span>&lt;</span><span>AclEntry</span><span>&gt;</span><span> </span><span>getAclEntryList</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>sourcePath</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC716"><span>        </span><span class="kd">final</span><span> </span><span>AclFileAttributeView</span><span> </span><span>fileAttributeView</span><span> </span><span>=</span><span> </span><span>Files</span><span>.</span><span>getFileAttributeView</span><span>(</span><span>sourcePath</span><span>,</span></span><span class="line" lang="java" id="LC717"><span>            </span><span>AclFileAttributeView</span><span>.</span><span class="kd">class</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC718"><span>        </span><span class="k">return</span><span> </span><span>fileAttributeView</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span> </span><span>?</span><span> </span><span class="kc">null</span><span> </span><span>:</span><span> </span><span>fileAttributeView</span><span>.</span><span>getAcl</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC719"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC720"></span><span class="line" lang="java" id="LC721"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC722"><span class="cm">     * Tests whether the specified {@code Path} is a directory or not. Implemented as a</span></span><span class="line" lang="java" id="LC723"><span class="cm">     * null-safe delegate to {@code Files.isDirectory(Path path, LinkOption... options)}.</span></span><span class="line" lang="java" id="LC724"><span class="cm">     *</span></span><span class="line" lang="java" id="LC725"><span class="cm">     * @param   path the path to the file.</span></span><span class="line" lang="java" id="LC726"><span class="cm">     * @param   options options indicating how symbolic links are handled</span></span><span class="line" lang="java" id="LC727"><span class="cm">     * @return  {@code true} if the file is a directory; {@code false} if</span></span><span class="line" lang="java" id="LC728"><span class="cm">     *          the path is null, the file does not exist, is not a directory, or it cannot</span></span><span class="line" lang="java" id="LC729"><span class="cm">     *          be determined if the file is a directory or not.</span></span><span class="line" lang="java" id="LC730"><span class="cm">     * @throws SecurityException     In the case of the default provider, and a security manager is installed, the</span></span><span class="line" lang="java" id="LC731"><span class="cm">     *                               {@link SecurityManager#checkRead(String) checkRead} method is invoked to check read</span></span><span class="line" lang="java" id="LC732"><span class="cm">     *                               access to the directory.</span></span><span class="line" lang="java" id="LC733"><span class="cm">     * @since 2.9.0</span></span><span class="line" lang="java" id="LC734"><span class="cm">     */</span></span><span class="line" lang="java" id="LC735"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kt">boolean</span><span> </span><span>isDirectory</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>LinkOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>options</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC736"><span>        </span><span class="k">return</span><span> </span><span>path</span><span> </span><span>!=</span><span> </span><span class="kc">null</span><span> </span><span>&amp;&amp;</span><span> </span><span>Files</span><span>.</span><span>isDirectory</span><span>(</span><span>path</span><span>,</span><span> </span><span>options</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC737"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC738"></span><span class="line" lang="java" id="LC739"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC740"><span class="cm">     * Tests whether the given file or directory is empty.</span></span><span class="line" lang="java" id="LC741"><span class="cm">     *</span></span><span class="line" lang="java" id="LC742"><span class="cm">     * @param path the file or directory to query.</span></span><span class="line" lang="java" id="LC743"><span class="cm">     * @return whether the file or directory is empty.</span></span><span class="line" lang="java" id="LC744"><span class="cm">     * @throws IOException if an I/O error occurs.</span></span><span class="line" lang="java" id="LC745"><span class="cm">     */</span></span><span class="line" lang="java" id="LC746"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kt">boolean</span><span> </span><span>isEmpty</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC747"><span>        </span><span class="k">return</span><span> </span><span>Files</span><span>.</span><span>isDirectory</span><span>(</span><span>path</span><span>)</span><span> </span><span>?</span><span> </span><span>isEmptyDirectory</span><span>(</span><span>path</span><span>)</span><span> </span><span>:</span><span> </span><span>isEmptyFile</span><span>(</span><span>path</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC748"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC749"></span><span class="line" lang="java" id="LC750"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC751"><span class="cm">     * Tests whether the directory is empty.</span></span><span class="line" lang="java" id="LC752"><span class="cm">     *</span></span><span class="line" lang="java" id="LC753"><span class="cm">     * @param directory the directory to query.</span></span><span class="line" lang="java" id="LC754"><span class="cm">     * @return whether the directory is empty.</span></span><span class="line" lang="java" id="LC755"><span class="cm">     * @throws NotDirectoryException if the file could not otherwise be opened because it is not a directory</span></span><span class="line" lang="java" id="LC756"><span class="cm">     *                               &lt;i&gt;(optional specific exception)&lt;/i&gt;.</span></span><span class="line" lang="java" id="LC757"><span class="cm">     * @throws IOException           if an I/O error occurs.</span></span><span class="line" lang="java" id="LC758"><span class="cm">     * @throws SecurityException     In the case of the default provider, and a security manager is installed, the</span></span><span class="line" lang="java" id="LC759"><span class="cm">     *                               {@link SecurityManager#checkRead(String) checkRead} method is invoked to check read</span></span><span class="line" lang="java" id="LC760"><span class="cm">     *                               access to the directory.</span></span><span class="line" lang="java" id="LC761"><span class="cm">     */</span></span><span class="line" lang="java" id="LC762"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kt">boolean</span><span> </span><span>isEmptyDirectory</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>directory</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC763"><span>        </span><span class="k">try</span><span> </span><span>(</span><span>DirectoryStream</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>directoryStream</span><span> </span><span>=</span><span> </span><span>Files</span><span>.</span><span>newDirectoryStream</span><span>(</span><span>directory</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC764"><span>            </span><span class="k">return</span><span> </span><span>!</span><span>directoryStream</span><span>.</span><span>iterator</span><span>(</span><span>)</span><span>.</span><span>hasNext</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC765"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC766"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC767"></span><span class="line" lang="java" id="LC768"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC769"><span class="cm">     * Tests whether the given file is empty.</span></span><span class="line" lang="java" id="LC770"><span class="cm">     *</span></span><span class="line" lang="java" id="LC771"><span class="cm">     * @param file the file to query.</span></span><span class="line" lang="java" id="LC772"><span class="cm">     * @return whether the file is empty.</span></span><span class="line" lang="java" id="LC773"><span class="cm">     * @throws IOException       if an I/O error occurs.</span></span><span class="line" lang="java" id="LC774"><span class="cm">     * @throws SecurityException In the case of the default provider, and a security manager is installed, its</span></span><span class="line" lang="java" id="LC775"><span class="cm">     *                           {@link SecurityManager#checkRead(String) checkRead} method denies read access to the</span></span><span class="line" lang="java" id="LC776"><span class="cm">     *                           file.</span></span><span class="line" lang="java" id="LC777"><span class="cm">     */</span></span><span class="line" lang="java" id="LC778"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kt">boolean</span><span> </span><span>isEmptyFile</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>file</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC779"><span>        </span><span class="k">return</span><span> </span><span>Files</span><span>.</span><span>size</span><span>(</span><span>file</span><span>)</span><span> </span><span>&lt;=</span><span> </span><span>0</span><span>;</span></span><span class="line" lang="java" id="LC780"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC781"></span><span class="line" lang="java" id="LC782"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC783"><span class="cm">     * Tests if the specified {@code Path} is newer than the specified time reference.</span></span><span class="line" lang="java" id="LC784"><span class="cm">     *</span></span><span class="line" lang="java" id="LC785"><span class="cm">     * @param file the {@code Path} of which the modification date must be compared</span></span><span class="line" lang="java" id="LC786"><span class="cm">     * @param timeMillis the time reference measured in milliseconds since the epoch (00:00:00 GMT, January 1, 1970)</span></span><span class="line" lang="java" id="LC787"><span class="cm">     * @param options options indicating how symbolic links are handled * @return true if the {@code Path} exists and</span></span><span class="line" lang="java" id="LC788"><span class="cm">     *        has been modified after the given time reference.</span></span><span class="line" lang="java" id="LC789"><span class="cm">     * @return true if the {@code Path} exists and has been modified after the given time reference.</span></span><span class="line" lang="java" id="LC790"><span class="cm">     * @throws IOException if an I/O error occurs.</span></span><span class="line" lang="java" id="LC791"><span class="cm">     * @throws NullPointerException if the file is {@code null}</span></span><span class="line" lang="java" id="LC792"><span class="cm">     * @since 2.9.0</span></span><span class="line" lang="java" id="LC793"><span class="cm">     */</span></span><span class="line" lang="java" id="LC794"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kt">boolean</span><span> </span><span>isNewer</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>file</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span class="kt">long</span><span> </span><span>timeMillis</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>LinkOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>options</span><span>)</span></span><span class="line" lang="java" id="LC795"><span>        </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC796"><span>        </span><span>Objects</span><span>.</span><span>requireNonNull</span><span>(</span><span>file</span><span>,</span><span> </span><span class="s">&quot;file&quot;</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC797"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>Files</span><span>.</span><span>notExists</span><span>(</span><span>file</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC798"><span>            </span><span class="k">return</span><span> </span><span class="kc">false</span><span>;</span></span><span class="line" lang="java" id="LC799"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC800"><span>        </span><span class="k">return</span><span> </span><span>Files</span><span>.</span><span>getLastModifiedTime</span><span>(</span><span>file</span><span>,</span><span> </span><span>options</span><span>)</span><span>.</span><span>toMillis</span><span>(</span><span>)</span><span> </span><span>&gt;</span><span> </span><span>timeMillis</span><span>;</span></span><span class="line" lang="java" id="LC801"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC802"></span><span class="line" lang="java" id="LC803"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC804"><span class="cm">     * Tests whether the specified {@code Path} is a regular file or not. Implemented as a</span></span><span class="line" lang="java" id="LC805"><span class="cm">     * null-safe delegate to {@code Files.isRegularFile(Path path, LinkOption... options)}.</span></span><span class="line" lang="java" id="LC806"><span class="cm">     *</span></span><span class="line" lang="java" id="LC807"><span class="cm">     * @param   path the path to the file.</span></span><span class="line" lang="java" id="LC808"><span class="cm">     * @param   options options indicating how symbolic links are handled</span></span><span class="line" lang="java" id="LC809"><span class="cm">     * @return  {@code true} if the file is a regular file; {@code false} if</span></span><span class="line" lang="java" id="LC810"><span class="cm">     *          the path is null, the file does not exist, is not a directory, or it cannot</span></span><span class="line" lang="java" id="LC811"><span class="cm">     *          be determined if the file is a regular file or not.</span></span><span class="line" lang="java" id="LC812"><span class="cm">     * @throws SecurityException     In the case of the default provider, and a security manager is installed, the</span></span><span class="line" lang="java" id="LC813"><span class="cm">     *                               {@link SecurityManager#checkRead(String) checkRead} method is invoked to check read</span></span><span class="line" lang="java" id="LC814"><span class="cm">     *                               access to the directory.</span></span><span class="line" lang="java" id="LC815"><span class="cm">     * @since 2.9.0</span></span><span class="line" lang="java" id="LC816"><span class="cm">     */</span></span><span class="line" lang="java" id="LC817"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kt">boolean</span><span> </span><span>isRegularFile</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>LinkOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>options</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC818"><span>        </span><span class="k">return</span><span> </span><span>path</span><span> </span><span>!=</span><span> </span><span class="kc">null</span><span> </span><span>&amp;&amp;</span><span> </span><span>Files</span><span>.</span><span>isRegularFile</span><span>(</span><span>path</span><span>,</span><span> </span><span>options</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC819"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC820"></span><span class="line" lang="java" id="LC821"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC822"><span class="cm">     * Creates a new DirectoryStream for Paths rooted at the given directory.</span></span><span class="line" lang="java" id="LC823"><span class="cm">     *</span></span><span class="line" lang="java" id="LC824"><span class="cm">     * @param dir the path to the directory to stream.</span></span><span class="line" lang="java" id="LC825"><span class="cm">     * @param pathFilter the directory stream filter.</span></span><span class="line" lang="java" id="LC826"><span class="cm">     * @return a new instance.</span></span><span class="line" lang="java" id="LC827"><span class="cm">     * @throws IOException if an I/O error occurs.</span></span><span class="line" lang="java" id="LC828"><span class="cm">     */</span></span><span class="line" lang="java" id="LC829"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>DirectoryStream</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>newDirectoryStream</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>dir</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>PathFilter</span><span> </span><span>pathFilter</span><span>)</span></span><span class="line" lang="java" id="LC830"><span>        </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC831"><span>        </span><span class="k">return</span><span> </span><span>Files</span><span>.</span><span>newDirectoryStream</span><span>(</span><span>dir</span><span>,</span><span> </span><span class="k">new</span><span> </span><span>DirectoryStreamFilter</span><span>(</span><span>pathFilter</span><span>)</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC832"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC833"></span><span class="line" lang="java" id="LC834"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC835"><span class="cm">     * Returns true if the given options contain {@link StandardDeleteOption#OVERRIDE_READ_ONLY}.</span></span><span class="line" lang="java" id="LC836"><span class="cm">     *</span></span><span class="line" lang="java" id="LC837"><span class="cm">     * @param deleteOptions the array to test</span></span><span class="line" lang="java" id="LC838"><span class="cm">     * @return true if the given options contain {@link StandardDeleteOption#OVERRIDE_READ_ONLY}.</span></span><span class="line" lang="java" id="LC839"><span class="cm">     */</span></span><span class="line" lang="java" id="LC840"><span>    </span><span class="kd">private</span><span> </span><span class="kd">static</span><span> </span><span class="kt">boolean</span><span> </span><span>overrideReadOnly</span><span>(</span><span class="kd">final</span><span> </span><span>DeleteOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>deleteOptions</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC841"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>deleteOptions</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC842"><span>            </span><span class="k">return</span><span> </span><span class="kc">false</span><span>;</span></span><span class="line" lang="java" id="LC843"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC844"><span>        </span><span class="k">return</span><span> </span><span>Stream</span><span>.</span><span>of</span><span>(</span><span>deleteOptions</span><span>)</span><span>.</span><span>anyMatch</span><span>(</span><span>e</span><span> </span><span>-</span><span>&gt;</span><span> </span><span>e</span><span> </span><span>==</span><span> </span><span>StandardDeleteOption</span><span>.</span><span>OVERRIDE_READ_ONLY</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC845"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC846"></span><span class="line" lang="java" id="LC847"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC848"><span class="cm">     * Shorthand for {@code Files.readAttributes(path, BasicFileAttributes.class)}</span></span><span class="line" lang="java" id="LC849"><span class="cm">     *</span></span><span class="line" lang="java" id="LC850"><span class="cm">     * @param path the path to read.</span></span><span class="line" lang="java" id="LC851"><span class="cm">     * @return the path attributes.</span></span><span class="line" lang="java" id="LC852"><span class="cm">     * @throws IOException if an I/O error occurs.</span></span><span class="line" lang="java" id="LC853"><span class="cm">     * @since 2.9.0</span></span><span class="line" lang="java" id="LC854"><span class="cm">     */</span></span><span class="line" lang="java" id="LC855"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>BasicFileAttributes</span><span> </span><span>readBasicFileAttributes</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC856"><span>        </span><span class="k">return</span><span> </span><span>Files</span><span>.</span><span>readAttributes</span><span>(</span><span>path</span><span>,</span><span> </span><span>BasicFileAttributes</span><span>.</span><span class="kd">class</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC857"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC858"></span><span class="line" lang="java" id="LC859"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC860"><span class="cm">     * Shorthand for {@code Files.readAttributes(path, BasicFileAttributes.class)} while wrapping {@link IOException}</span></span><span class="line" lang="java" id="LC861"><span class="cm">     * as {@link UncheckedIOException}.</span></span><span class="line" lang="java" id="LC862"><span class="cm">     *</span></span><span class="line" lang="java" id="LC863"><span class="cm">     * @param path the path to read.</span></span><span class="line" lang="java" id="LC864"><span class="cm">     * @return the path attributes.</span></span><span class="line" lang="java" id="LC865"><span class="cm">     * @throws UncheckedIOException if an I/O error occurs</span></span><span class="line" lang="java" id="LC866"><span class="cm">     * @since 2.9.0</span></span><span class="line" lang="java" id="LC867"><span class="cm">     */</span></span><span class="line" lang="java" id="LC868"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>BasicFileAttributes</span><span> </span><span>readBasicFileAttributesUnchecked</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC869"><span>        </span><span class="k">try</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC870"><span>            </span><span class="k">return</span><span> </span><span>readBasicFileAttributes</span><span>(</span><span>path</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC871"><span>        </span><span>}</span><span> </span><span class="k">catch</span><span> </span><span>(</span><span class="kd">final</span><span> </span><span>IOException</span><span> </span><span>e</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC872"><span>            </span><span class="k">throw</span><span> </span><span class="k">new</span><span> </span><span>UncheckedIOException</span><span>(</span><span>e</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC873"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC874"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC875"></span><span class="line" lang="java" id="LC876"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC877"><span class="cm">     * Relativizes all files in the given {@code collection} against a {@code parent}.</span></span><span class="line" lang="java" id="LC878"><span class="cm">     *</span></span><span class="line" lang="java" id="LC879"><span class="cm">     * @param collection The collection of paths to relativize.</span></span><span class="line" lang="java" id="LC880"><span class="cm">     * @param parent relativizes against this parent path.</span></span><span class="line" lang="java" id="LC881"><span class="cm">     * @param sort Whether to sort the result.</span></span><span class="line" lang="java" id="LC882"><span class="cm">     * @param comparator How to sort.</span></span><span class="line" lang="java" id="LC883"><span class="cm">     * @return A collection of relativized paths, optionally sorted.</span></span><span class="line" lang="java" id="LC884"><span class="cm">     */</span></span><span class="line" lang="java" id="LC885"><span>    </span><span class="kd">static</span><span> </span><span>List</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>relativize</span><span>(</span><span class="kd">final</span><span> </span><span>Collection</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>collection</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>parent</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span class="kt">boolean</span><span> </span><span>sort</span><span>,</span></span><span class="line" lang="java" id="LC886"><span>        </span><span class="kd">final</span><span> </span><span>Comparator</span><span>&lt;</span><span>?</span><span> </span><span class="kd">super</span><span> </span><span>Path</span><span>&gt;</span><span> </span><span>comparator</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC887"><span>        </span><span>Stream</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>stream</span><span> </span><span>=</span><span> </span><span>collection</span><span>.</span><span>stream</span><span>(</span><span>)</span><span>.</span><span>map</span><span>(</span><span>parent</span><span>:</span><span>:</span><span>relativize</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC888"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>sort</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC889"><span>            </span><span>stream</span><span> </span><span>=</span><span> </span><span>comparator</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span> </span><span>?</span><span> </span><span>stream</span><span>.</span><span>sorted</span><span>(</span><span>)</span><span> </span><span>:</span><span> </span><span>stream</span><span>.</span><span>sorted</span><span>(</span><span>comparator</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC890"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC891"><span>        </span><span class="k">return</span><span> </span><span>stream</span><span>.</span><span>collect</span><span>(</span><span>Collectors</span><span>.</span><span>toList</span><span>(</span><span>)</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC892"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC893"></span><span class="line" lang="java" id="LC894"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC895"><span class="cm">     * Sets the given Path to the {@code readOnly} value.</span></span><span class="line" lang="java" id="LC896"><span class="cm">     * &lt;p&gt;</span></span><span class="line" lang="java" id="LC897"><span class="cm">     * This behavior is OS dependent.</span></span><span class="line" lang="java" id="LC898"><span class="cm">     * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC899"><span class="cm">     *</span></span><span class="line" lang="java" id="LC900"><span class="cm">     * @param path The path to set.</span></span><span class="line" lang="java" id="LC901"><span class="cm">     * @param readOnly true for read-only, false for not read-only.</span></span><span class="line" lang="java" id="LC902"><span class="cm">     * @param linkOptions options indicating how symbolic links are handled.</span></span><span class="line" lang="java" id="LC903"><span class="cm">     * @return The given path.</span></span><span class="line" lang="java" id="LC904"><span class="cm">     * @throws IOException if an I/O error occurs.</span></span><span class="line" lang="java" id="LC905"><span class="cm">     * @since 2.8.0</span></span><span class="line" lang="java" id="LC906"><span class="cm">     */</span></span><span class="line" lang="java" id="LC907"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>Path</span><span> </span><span>setReadOnly</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span class="kt">boolean</span><span> </span><span>readOnly</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>LinkOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>linkOptions</span><span>)</span></span><span class="line" lang="java" id="LC908"><span>        </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC909"><span>        </span><span class="kd">final</span><span> </span><span>List</span><span>&lt;</span><span>Exception</span><span>&gt;</span><span> </span><span>causeList</span><span> </span><span>=</span><span> </span><span class="k">new</span><span> </span><span>ArrayList</span><span>&lt;</span><span>&gt;</span><span>(</span><span>2</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC910"><span>        </span><span class="kd">final</span><span> </span><span>DosFileAttributeView</span><span> </span><span>fileAttributeView</span><span> </span><span>=</span><span> </span><span>Files</span><span>.</span><span>getFileAttributeView</span><span>(</span><span>path</span><span>,</span><span> </span><span>DosFileAttributeView</span><span>.</span><span class="kd">class</span><span>,</span></span><span class="line" lang="java" id="LC911"><span>            </span><span>linkOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC912"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>fileAttributeView</span><span> </span><span>!=</span><span> </span><span class="kc">null</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC913"><span>            </span><span class="k">try</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC914"><span>                </span><span>fileAttributeView</span><span>.</span><span>setReadOnly</span><span>(</span><span>readOnly</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC915"><span>                </span><span class="k">return</span><span> </span><span>path</span><span>;</span></span><span class="line" lang="java" id="LC916"><span>            </span><span>}</span><span> </span><span class="k">catch</span><span> </span><span>(</span><span class="kd">final</span><span> </span><span>IOException</span><span> </span><span>e</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC917"><span>                </span><span class="cm">// ignore for now, retry with PosixFileAttributeView</span></span><span class="line" lang="java" id="LC918"><span>                </span><span>causeList</span><span>.</span><span>add</span><span>(</span><span>e</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC919"><span>            </span><span>}</span></span><span class="line" lang="java" id="LC920"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC921"><span>        </span><span class="kd">final</span><span> </span><span>PosixFileAttributeView</span><span> </span><span>posixFileAttributeView</span><span> </span><span>=</span><span> </span><span>Files</span><span>.</span><span>getFileAttributeView</span><span>(</span><span>path</span><span>,</span></span><span class="line" lang="java" id="LC922"><span>            </span><span>PosixFileAttributeView</span><span>.</span><span class="kd">class</span><span>,</span><span> </span><span>linkOptions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC923"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>posixFileAttributeView</span><span> </span><span>!=</span><span> </span><span class="kc">null</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC924"><span>            </span><span class="cm">// Works on Windows but not on Ubuntu:</span></span><span class="line" lang="java" id="LC925"><span>            </span><span class="cm">// Files.setAttribute(path, &quot;unix:readonly&quot;, readOnly, options);</span></span><span class="line" lang="java" id="LC926"><span>            </span><span class="cm">// java.lang.IllegalArgumentException: &#39;unix:readonly&#39; not recognized</span></span><span class="line" lang="java" id="LC927"><span>            </span><span class="kd">final</span><span> </span><span>PosixFileAttributes</span><span> </span><span>readAttributes</span><span> </span><span>=</span><span> </span><span>posixFileAttributeView</span><span>.</span><span>readAttributes</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC928"><span>            </span><span class="kd">final</span><span> </span><span>Set</span><span>&lt;</span><span>PosixFilePermission</span><span>&gt;</span><span> </span><span>permissions</span><span> </span><span>=</span><span> </span><span>readAttributes</span><span>.</span><span>permissions</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC929"><span>            </span><span>permissions</span><span>.</span><span>remove</span><span>(</span><span>PosixFilePermission</span><span>.</span><span>OWNER_WRITE</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC930"><span>            </span><span>permissions</span><span>.</span><span>remove</span><span>(</span><span>PosixFilePermission</span><span>.</span><span>GROUP_WRITE</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC931"><span>            </span><span>permissions</span><span>.</span><span>remove</span><span>(</span><span>PosixFilePermission</span><span>.</span><span>OTHERS_WRITE</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC932"><span>            </span><span class="k">try</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC933"><span>                </span><span class="k">return</span><span> </span><span>Files</span><span>.</span><span>setPosixFilePermissions</span><span>(</span><span>path</span><span>,</span><span> </span><span>permissions</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC934"><span>            </span><span>}</span><span> </span><span class="k">catch</span><span> </span><span>(</span><span class="kd">final</span><span> </span><span>IOException</span><span> </span><span>e</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC935"><span>                </span><span>causeList</span><span>.</span><span>add</span><span>(</span><span>e</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC936"><span>            </span><span>}</span></span><span class="line" lang="java" id="LC937"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC938"><span>        </span><span class="k">if</span><span> </span><span>(</span><span>!</span><span>causeList</span><span>.</span><span>isEmpty</span><span>(</span><span>)</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC939"><span>            </span><span class="k">throw</span><span> </span><span class="k">new</span><span> </span><span>IOExceptionList</span><span>(</span><span>path</span><span>.</span><span>toString</span><span>(</span><span>)</span><span>,</span><span> </span><span>causeList</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC940"><span>        </span><span>}</span></span><span class="line" lang="java" id="LC941"><span>        </span><span class="k">throw</span><span> </span><span class="k">new</span><span> </span><span>IOException</span><span>(</span></span><span class="line" lang="java" id="LC942"><span>            </span><span>String</span><span>.</span><span>format</span><span>(</span><span class="s">&quot;No DosFileAttributeView or PosixFileAttributeView for &#39;%s&#39; (linkOptions=%s)&quot;</span><span>,</span><span> </span><span>path</span><span>,</span></span><span class="line" lang="java" id="LC943"><span>                </span><span>Arrays</span><span>.</span><span>toString</span><span>(</span><span>linkOptions</span><span>)</span><span>)</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC944"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC945"></span><span class="line" lang="java" id="LC946"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC947"><span class="cm">     * Converts an array of {@link FileVisitOption} to a {@link Set}.</span></span><span class="line" lang="java" id="LC948"><span class="cm">     *</span></span><span class="line" lang="java" id="LC949"><span class="cm">     * @param fileVisitOptions input array.</span></span><span class="line" lang="java" id="LC950"><span class="cm">     * @return a new Set.</span></span><span class="line" lang="java" id="LC951"><span class="cm">     */</span></span><span class="line" lang="java" id="LC952"><span>    </span><span class="kd">static</span><span> </span><span>Set</span><span>&lt;</span><span>FileVisitOption</span><span>&gt;</span><span> </span><span>toFileVisitOptionSet</span><span>(</span><span class="kd">final</span><span> </span><span>FileVisitOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>fileVisitOptions</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC953"><span>        </span><span class="k">return</span><span> </span><span>fileVisitOptions</span><span> </span><span>==</span><span> </span><span class="kc">null</span><span> </span><span>?</span><span> </span><span>EnumSet</span><span>.</span><span>noneOf</span><span>(</span><span>FileVisitOption</span><span>.</span><span class="kd">class</span><span>)</span></span><span class="line" lang="java" id="LC954"><span>            </span><span>:</span><span> </span><span>Stream</span><span>.</span><span>of</span><span>(</span><span>fileVisitOptions</span><span>)</span><span>.</span><span>collect</span><span>(</span><span>Collectors</span><span>.</span><span>toSet</span><span>(</span><span>)</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC955"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC956"></span><span class="line" lang="java" id="LC957"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC958"><span class="cm">     * Performs {@link Files#walkFileTree(Path,FileVisitor)} and returns the given visitor.</span></span><span class="line" lang="java" id="LC959"><span class="cm">     *</span></span><span class="line" lang="java" id="LC960"><span class="cm">     * Note that {@link Files#walkFileTree(Path,FileVisitor)} returns the given path.</span></span><span class="line" lang="java" id="LC961"><span class="cm">     *</span></span><span class="line" lang="java" id="LC962"><span class="cm">     * @param visitor See {@link Files#walkFileTree(Path,FileVisitor)}.</span></span><span class="line" lang="java" id="LC963"><span class="cm">     * @param directory See {@link Files#walkFileTree(Path,FileVisitor)}.</span></span><span class="line" lang="java" id="LC964"><span class="cm">     * @param &lt;T&gt; See {@link Files#walkFileTree(Path,FileVisitor)}.</span></span><span class="line" lang="java" id="LC965"><span class="cm">     * @return the given visitor.</span></span><span class="line" lang="java" id="LC966"><span class="cm">     *</span></span><span class="line" lang="java" id="LC967"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method</span></span><span class="line" lang="java" id="LC968"><span class="cm">     */</span></span><span class="line" lang="java" id="LC969"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>&lt;</span><span>T</span><span> </span><span class="kd">extends</span><span> </span><span>FileVisitor</span><span>&lt;</span><span>?</span><span> </span><span class="kd">super</span><span> </span><span>Path</span><span>&gt;</span><span>&gt;</span><span> </span><span>T</span><span> </span><span>visitFileTree</span><span>(</span><span class="kd">final</span><span> </span><span>T</span><span> </span><span>visitor</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>directory</span><span>)</span></span><span class="line" lang="java" id="LC970"><span>        </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC971"><span>        </span><span>Files</span><span>.</span><span>walkFileTree</span><span>(</span><span>directory</span><span>,</span><span> </span><span>visitor</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC972"><span>        </span><span class="k">return</span><span> </span><span>visitor</span><span>;</span></span><span class="line" lang="java" id="LC973"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC974"></span><span class="line" lang="java" id="LC975"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC976"><span class="cm">     * Performs {@link Files#walkFileTree(Path,FileVisitor)} and returns the given visitor.</span></span><span class="line" lang="java" id="LC977"><span class="cm">     *</span></span><span class="line" lang="java" id="LC978"><span class="cm">     * Note that {@link Files#walkFileTree(Path,FileVisitor)} returns the given path.</span></span><span class="line" lang="java" id="LC979"><span class="cm">     *</span></span><span class="line" lang="java" id="LC980"><span class="cm">     * @param start See {@link Files#walkFileTree(Path,Set,int,FileVisitor)}.</span></span><span class="line" lang="java" id="LC981"><span class="cm">     * @param options See {@link Files#walkFileTree(Path,Set,int,FileVisitor)}.</span></span><span class="line" lang="java" id="LC982"><span class="cm">     * @param maxDepth See {@link Files#walkFileTree(Path,Set,int,FileVisitor)}.</span></span><span class="line" lang="java" id="LC983"><span class="cm">     * @param visitor See {@link Files#walkFileTree(Path,Set,int,FileVisitor)}.</span></span><span class="line" lang="java" id="LC984"><span class="cm">     * @param &lt;T&gt; See {@link Files#walkFileTree(Path,Set,int,FileVisitor)}.</span></span><span class="line" lang="java" id="LC985"><span class="cm">     * @return the given visitor.</span></span><span class="line" lang="java" id="LC986"><span class="cm">     *</span></span><span class="line" lang="java" id="LC987"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method</span></span><span class="line" lang="java" id="LC988"><span class="cm">     */</span></span><span class="line" lang="java" id="LC989"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>&lt;</span><span>T</span><span> </span><span class="kd">extends</span><span> </span><span>FileVisitor</span><span>&lt;</span><span>?</span><span> </span><span class="kd">super</span><span> </span><span>Path</span><span>&gt;</span><span>&gt;</span><span> </span><span>T</span><span> </span><span>visitFileTree</span><span>(</span><span class="kd">final</span><span> </span><span>T</span><span> </span><span>visitor</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>start</span><span>,</span></span><span class="line" lang="java" id="LC990"><span>        </span><span class="kd">final</span><span> </span><span>Set</span><span>&lt;</span><span>FileVisitOption</span><span>&gt;</span><span> </span><span>options</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span class="kt">int</span><span> </span><span>maxDepth</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC991"><span>        </span><span>Files</span><span>.</span><span>walkFileTree</span><span>(</span><span>start</span><span>,</span><span> </span><span>options</span><span>,</span><span> </span><span>maxDepth</span><span>,</span><span> </span><span>visitor</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC992"><span>        </span><span class="k">return</span><span> </span><span>visitor</span><span>;</span></span><span class="line" lang="java" id="LC993"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC994"></span><span class="line" lang="java" id="LC995"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC996"><span class="cm">     * Performs {@link Files#walkFileTree(Path,FileVisitor)} and returns the given visitor.</span></span><span class="line" lang="java" id="LC997"><span class="cm">     *</span></span><span class="line" lang="java" id="LC998"><span class="cm">     * Note that {@link Files#walkFileTree(Path,FileVisitor)} returns the given path.</span></span><span class="line" lang="java" id="LC999"><span class="cm">     *</span></span><span class="line" lang="java" id="LC1000"><span class="cm">     * @param visitor See {@link Files#walkFileTree(Path,FileVisitor)}.</span></span><span class="line" lang="java" id="LC1001"><span class="cm">     * @param first See {@link Paths#get(String,String[])}.</span></span><span class="line" lang="java" id="LC1002"><span class="cm">     * @param more See {@link Paths#get(String,String[])}.</span></span><span class="line" lang="java" id="LC1003"><span class="cm">     * @param &lt;T&gt; See {@link Files#walkFileTree(Path,FileVisitor)}.</span></span><span class="line" lang="java" id="LC1004"><span class="cm">     * @return the given visitor.</span></span><span class="line" lang="java" id="LC1005"><span class="cm">     *</span></span><span class="line" lang="java" id="LC1006"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method</span></span><span class="line" lang="java" id="LC1007"><span class="cm">     */</span></span><span class="line" lang="java" id="LC1008"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>&lt;</span><span>T</span><span> </span><span class="kd">extends</span><span> </span><span>FileVisitor</span><span>&lt;</span><span>?</span><span> </span><span class="kd">super</span><span> </span><span>Path</span><span>&gt;</span><span>&gt;</span><span> </span><span>T</span><span> </span><span>visitFileTree</span><span>(</span><span class="kd">final</span><span> </span><span>T</span><span> </span><span>visitor</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>String</span><span> </span><span>first</span><span>,</span></span><span class="line" lang="java" id="LC1009"><span>        </span><span class="kd">final</span><span> </span><span>String</span><span>.</span><span>.</span><span>.</span><span> </span><span>more</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC1010"><span>        </span><span class="k">return</span><span> </span><span>visitFileTree</span><span>(</span><span>visitor</span><span>,</span><span> </span><span>Paths</span><span>.</span><span>get</span><span>(</span><span>first</span><span>,</span><span> </span><span>more</span><span>)</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC1011"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC1012"></span><span class="line" lang="java" id="LC1013"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC1014"><span class="cm">     * Performs {@link Files#walkFileTree(Path,FileVisitor)} and returns the given visitor.</span></span><span class="line" lang="java" id="LC1015"><span class="cm">     *</span></span><span class="line" lang="java" id="LC1016"><span class="cm">     * Note that {@link Files#walkFileTree(Path,FileVisitor)} returns the given path.</span></span><span class="line" lang="java" id="LC1017"><span class="cm">     *</span></span><span class="line" lang="java" id="LC1018"><span class="cm">     * @param visitor See {@link Files#walkFileTree(Path,FileVisitor)}.</span></span><span class="line" lang="java" id="LC1019"><span class="cm">     * @param uri See {@link Paths#get(URI)}.</span></span><span class="line" lang="java" id="LC1020"><span class="cm">     * @param &lt;T&gt; See {@link Files#walkFileTree(Path,FileVisitor)}.</span></span><span class="line" lang="java" id="LC1021"><span class="cm">     * @return the given visitor.</span></span><span class="line" lang="java" id="LC1022"><span class="cm">     *</span></span><span class="line" lang="java" id="LC1023"><span class="cm">     * @throws IOException if an I/O error is thrown by a visitor method</span></span><span class="line" lang="java" id="LC1024"><span class="cm">     */</span></span><span class="line" lang="java" id="LC1025"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>&lt;</span><span>T</span><span> </span><span class="kd">extends</span><span> </span><span>FileVisitor</span><span>&lt;</span><span>?</span><span> </span><span class="kd">super</span><span> </span><span>Path</span><span>&gt;</span><span>&gt;</span><span> </span><span>T</span><span> </span><span>visitFileTree</span><span>(</span><span class="kd">final</span><span> </span><span>T</span><span> </span><span>visitor</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>URI</span><span> </span><span>uri</span><span>)</span></span><span class="line" lang="java" id="LC1026"><span>        </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC1027"><span>        </span><span class="k">return</span><span> </span><span>visitFileTree</span><span>(</span><span>visitor</span><span>,</span><span> </span><span>Paths</span><span>.</span><span>get</span><span>(</span><span>uri</span><span>)</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC1028"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC1029"></span><span class="line" lang="java" id="LC1030"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC1031"><span class="cm">     * Returns a stream of filtered paths.</span></span><span class="line" lang="java" id="LC1032"><span class="cm">     *</span></span><span class="line" lang="java" id="LC1033"><span class="cm">     * @param start the start path</span></span><span class="line" lang="java" id="LC1034"><span class="cm">     * @param pathFilter the path filter</span></span><span class="line" lang="java" id="LC1035"><span class="cm">     * @param maxDepth the maximum depth of directories to walk.</span></span><span class="line" lang="java" id="LC1036"><span class="cm">     * @param readAttributes whether to call the filters with file attributes (false passes null).</span></span><span class="line" lang="java" id="LC1037"><span class="cm">     * @param options the options to configure the walk.</span></span><span class="line" lang="java" id="LC1038"><span class="cm">     * @return a filtered stream of paths.</span></span><span class="line" lang="java" id="LC1039"><span class="cm">     * @throws IOException if an I/O error is thrown when accessing the starting file.</span></span><span class="line" lang="java" id="LC1040"><span class="cm">     * @since 2.9.0</span></span><span class="line" lang="java" id="LC1041"><span class="cm">     */</span></span><span class="line" lang="java" id="LC1042"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span>Stream</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>walk</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>start</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>PathFilter</span><span> </span><span>pathFilter</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span class="kt">int</span><span> </span><span>maxDepth</span><span>,</span></span><span class="line" lang="java" id="LC1043"><span>        </span><span class="kd">final</span><span> </span><span class="kt">boolean</span><span> </span><span>readAttributes</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>FileVisitOption</span><span>.</span><span>.</span><span>.</span><span> </span><span>options</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC1044"><span>        </span><span class="k">return</span><span> </span><span>Files</span><span>.</span><span>walk</span><span>(</span><span>start</span><span>,</span><span> </span><span>maxDepth</span><span>,</span><span> </span><span>options</span><span>)</span><span>.</span><span>filter</span><span>(</span><span>path</span><span> </span><span>-</span><span>&gt;</span><span> </span><span>pathFilter</span><span>.</span><span>accept</span><span>(</span><span>path</span><span>,</span></span><span class="line" lang="java" id="LC1045"><span>            </span><span>readAttributes</span><span> </span><span>?</span><span> </span><span>readBasicFileAttributesUnchecked</span><span>(</span><span>path</span><span>)</span><span> </span><span>:</span><span> </span><span class="kc">null</span><span>)</span><span> </span><span>==</span><span> </span><span>FileVisitResult</span><span>.</span><span>CONTINUE</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC1046"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC1047"></span><span class="line" lang="java" id="LC1048"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC1049"><span class="cm">     * Does allow to instantiate.</span></span><span class="line" lang="java" id="LC1050"><span class="cm">     */</span></span><span class="line" lang="java" id="LC1051"><span>    </span><span class="kd">private</span><span> </span><span>PathUtils</span><span>(</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC1052"><span>        </span><span class="cm">// do not instantiate.</span></span><span class="line" lang="java" id="LC1053"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC1054"></span><span class="line" lang="java" id="LC1055"><span>}</span></span>
</code>
</pre>
    </div>
</div>