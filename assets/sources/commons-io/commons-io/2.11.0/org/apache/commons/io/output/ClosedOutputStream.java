...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"><span class="kn">package</span><span> </span><span>org.apache.commons.io.output</span><span>;</span></span><span class="line" lang="java" id="LC18"></span><span class="line" lang="java" id="LC19"><span class="kn">import</span><span> </span><span>java.io.IOException</span><span>;</span></span><span class="line" lang="java" id="LC20"><span class="kn">import</span><span> </span><span>java.io.OutputStream</span><span>;</span></span><span class="line" lang="java" id="LC21"></span><span class="line" lang="java" id="LC22"><span class="cm">/**</span></span><span class="line" lang="java" id="LC23"><span class="cm"> * Throws an exception on all attempts to write to the stream.</span></span><span class="line" lang="java" id="LC24"><span class="cm"> * &lt;p&gt;</span></span><span class="line" lang="java" id="LC25"><span class="cm"> * Typically uses of this class include testing for corner cases in methods that accept an output stream and acting as a</span></span><span class="line" lang="java" id="LC26"><span class="cm"> * sentinel value instead of a {@code null} output stream.</span></span><span class="line" lang="java" id="LC27"><span class="cm"> * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC28"><span class="cm"> *</span></span><span class="line" lang="java" id="LC29"><span class="cm"> * @since 1.4</span></span><span class="line" lang="java" id="LC30"><span class="cm"> */</span></span><span class="line" lang="java" id="LC31"><span class="kd">public</span><span> </span><span class="kd">class</span><span> </span><span class="nc">ClosedOutputStream</span><span> </span><span class="kd">extends</span><span> </span><span>OutputStream</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC32"></span><span class="line" lang="java" id="LC33"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC34"><span class="cm">     * A singleton.</span></span><span class="line" lang="java" id="LC35"><span class="cm">     */</span></span><span class="line" lang="java" id="LC36"><span>    </span><span class="kd">public</span><span> </span><span class="kd">static</span><span> </span><span class="kd">final</span><span> </span><span>ClosedOutputStream</span><span> </span><span>CLOSED_OUTPUT_STREAM</span><span> </span><span>=</span><span> </span><span class="k">new</span><span> </span><span>ClosedOutputStream</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC37"></span><span class="line" lang="java" id="LC38"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC39"><span class="cm">     * Throws an {@link IOException} to indicate that the stream is closed.</span></span><span class="line" lang="java" id="LC40"><span class="cm">     *</span></span><span class="line" lang="java" id="LC41"><span class="cm">     * @param b ignored</span></span><span class="line" lang="java" id="LC42"><span class="cm">     * @throws IOException always thrown</span></span><span class="line" lang="java" id="LC43"><span class="cm">     */</span></span><span class="line" lang="java" id="LC44"><span>    </span><span>@</span><span>Override</span></span><span class="line" lang="java" id="LC45"><span>    </span><span class="kd">public</span><span> </span><span class="kt">void</span><span> </span><span>write</span><span>(</span><span class="kd">final</span><span> </span><span class="kt">int</span><span> </span><span>b</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC46"><span>        </span><span class="k">throw</span><span> </span><span class="k">new</span><span> </span><span>IOException</span><span>(</span><span class="s">&quot;write(&quot;</span><span> </span><span>+</span><span> </span><span>b</span><span> </span><span>+</span><span> </span><span class="s">&quot;) failed: stream is closed&quot;</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC47"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC48"></span><span class="line" lang="java" id="LC49"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC50"><span class="cm">     * Throws an {@link IOException} to indicate that the stream is closed.</span></span><span class="line" lang="java" id="LC51"><span class="cm">     *</span></span><span class="line" lang="java" id="LC52"><span class="cm">     * @throws IOException always thrown</span></span><span class="line" lang="java" id="LC53"><span class="cm">     */</span></span><span class="line" lang="java" id="LC54"><span>    </span><span>@</span><span>Override</span></span><span class="line" lang="java" id="LC55"><span>    </span><span class="kd">public</span><span> </span><span class="kt">void</span><span> </span><span>flush</span><span>(</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC56"><span>        </span><span class="k">throw</span><span> </span><span class="k">new</span><span> </span><span>IOException</span><span>(</span><span class="s">&quot;flush() failed: stream is closed&quot;</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC57"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC58"><span>}</span></span>
</code>
</pre>
    </div>
</div>