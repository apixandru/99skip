...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"></span><span class="line" lang="java" id="LC18"><span class="kn">package</span><span> </span><span>org.apache.commons.io</span><span>;</span></span><span class="line" lang="java" id="LC19"></span><span class="line" lang="java" id="LC20"><span class="kn">import</span><span> </span><span>java.nio.charset.Charset</span><span>;</span></span><span class="line" lang="java" id="LC21"><span class="kn">import</span><span> </span><span>java.util.Objects</span><span>;</span></span><span class="line" lang="java" id="LC22"></span><span class="line" lang="java" id="LC23"><span class="cm">/**</span></span><span class="line" lang="java" id="LC24"><span class="cm"> * Enumerates standard line separators: {@link #CR}, {@link #CRLF}, {@link #LF}.</span></span><span class="line" lang="java" id="LC25"><span class="cm"> *</span></span><span class="line" lang="java" id="LC26"><span class="cm"> * @since 2.9.0</span></span><span class="line" lang="java" id="LC27"><span class="cm"> */</span></span><span class="line" lang="java" id="LC28"><span class="kd">public</span><span> </span><span class="kd">enum</span><span> </span><span class="nc">StandardLineSeparator</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC29"></span><span class="line" lang="java" id="LC30"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC31"><span class="cm">     * Carriage return. This is the line ending used on Macos 9 and earlier.</span></span><span class="line" lang="java" id="LC32"><span class="cm">     */</span></span><span class="line" lang="java" id="LC33"><span>    </span><span>CR</span><span>(</span><span class="s">&quot;\r&quot;</span><span>)</span><span>,</span></span><span class="line" lang="java" id="LC34"></span><span class="line" lang="java" id="LC35"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC36"><span class="cm">     * Carriage return followed by line feed. This is the line ending used on Windows.</span></span><span class="line" lang="java" id="LC37"><span class="cm">     */</span></span><span class="line" lang="java" id="LC38"><span>    </span><span>CRLF</span><span>(</span><span class="s">&quot;\r\n&quot;</span><span>)</span><span>,</span></span><span class="line" lang="java" id="LC39"></span><span class="line" lang="java" id="LC40"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC41"><span class="cm">     * Line feed. This is the line ending used on Linux and Macos X and later.</span></span><span class="line" lang="java" id="LC42"><span class="cm">     */</span></span><span class="line" lang="java" id="LC43"><span>    </span><span>LF</span><span>(</span><span class="s">&quot;\n&quot;</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC44"></span><span class="line" lang="java" id="LC45"><span>    </span><span class="kd">private</span><span> </span><span class="kd">final</span><span> </span><span>String</span><span> </span><span>lineSeparator</span><span>;</span></span><span class="line" lang="java" id="LC46"></span><span class="line" lang="java" id="LC47"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC48"><span class="cm">     * Constructs a new instance for a non-null line separator.</span></span><span class="line" lang="java" id="LC49"><span class="cm">     *</span></span><span class="line" lang="java" id="LC50"><span class="cm">     * @param lineSeparator a non-null line separator.</span></span><span class="line" lang="java" id="LC51"><span class="cm">     */</span></span><span class="line" lang="java" id="LC52"><span>    </span><span>StandardLineSeparator</span><span>(</span><span class="kd">final</span><span> </span><span>String</span><span> </span><span>lineSeparator</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC53"><span>        </span><span>this</span><span>.</span><span>lineSeparator</span><span> </span><span>=</span><span> </span><span>Objects</span><span>.</span><span>requireNonNull</span><span>(</span><span>lineSeparator</span><span>,</span><span> </span><span class="s">&quot;lineSeparator&quot;</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC54"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC55"></span><span class="line" lang="java" id="LC56"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC57"><span class="cm">     * Gets the bytes for this instance encoded using the given Charset.</span></span><span class="line" lang="java" id="LC58"><span class="cm">     *</span></span><span class="line" lang="java" id="LC59"><span class="cm">     * @param charset the encoding Charset.</span></span><span class="line" lang="java" id="LC60"><span class="cm">     * @return the bytes for this instance encoded using the given Charset.</span></span><span class="line" lang="java" id="LC61"><span class="cm">     */</span></span><span class="line" lang="java" id="LC62"><span>    </span><span class="kd">public</span><span> </span><span class="kt">byte</span><span>[</span><span>]</span><span> </span><span>getBytes</span><span>(</span><span class="kd">final</span><span> </span><span>Charset</span><span> </span><span>charset</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC63"><span>        </span><span class="k">return</span><span> </span><span>lineSeparator</span><span>.</span><span>getBytes</span><span>(</span><span>charset</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC64"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC65"></span><span class="line" lang="java" id="LC66"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC67"><span class="cm">     * Gets the String value of this instance.</span></span><span class="line" lang="java" id="LC68"><span class="cm">     *</span></span><span class="line" lang="java" id="LC69"><span class="cm">     * @return the String value of this instance.</span></span><span class="line" lang="java" id="LC70"><span class="cm">     */</span></span><span class="line" lang="java" id="LC71"><span>    </span><span class="kd">public</span><span> </span><span>String</span><span> </span><span>getString</span><span>(</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC72"><span>        </span><span class="k">return</span><span> </span><span>lineSeparator</span><span>;</span></span><span class="line" lang="java" id="LC73"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC74"><span>}</span></span>
</code>
</pre>
    </div>
</div>