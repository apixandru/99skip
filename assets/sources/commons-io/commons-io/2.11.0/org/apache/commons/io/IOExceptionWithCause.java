...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"></span><span class="line" lang="java" id="LC18"><span class="kn">package</span><span> </span><span>org.apache.commons.io</span><span>;</span></span><span class="line" lang="java" id="LC19"></span><span class="line" lang="java" id="LC20"><span class="kn">import</span><span> </span><span>java.io.IOException</span><span>;</span></span><span class="line" lang="java" id="LC21"></span><span class="line" lang="java" id="LC22"><span class="cm">/**</span></span><span class="line" lang="java" id="LC23"><span class="cm"> * Subclasses IOException with the {@link Throwable} constructors missing before Java 6.</span></span><span class="line" lang="java" id="LC24"><span class="cm"> *</span></span><span class="line" lang="java" id="LC25"><span class="cm"> * @since 1.4</span></span><span class="line" lang="java" id="LC26"><span class="cm"> * @deprecated (since 2.5) use {@link IOException} instead</span></span><span class="line" lang="java" id="LC27"><span class="cm"> */</span></span><span class="line" lang="java" id="LC28"><span>@Deprecated</span></span><span class="line" lang="java" id="LC29"><span class="kd">public</span><span> </span><span class="kd">class</span><span> </span><span class="nc">IOExceptionWithCause</span><span> </span><span class="kd">extends</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC30"></span><span class="line" lang="java" id="LC31"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC32"><span class="cm">     * Defines the serial version UID.</span></span><span class="line" lang="java" id="LC33"><span class="cm">     */</span></span><span class="line" lang="java" id="LC34"><span>    </span><span class="kd">private</span><span> </span><span class="kd">static</span><span> </span><span class="kd">final</span><span> </span><span class="kt">long</span><span> </span><span>serialVersionUID</span><span> </span><span>=</span><span> </span><span>1</span><span>L</span><span>;</span></span><span class="line" lang="java" id="LC35"></span><span class="line" lang="java" id="LC36"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC37"><span class="cm">     * Constructs a new instance with the given message and cause.</span></span><span class="line" lang="java" id="LC38"><span class="cm">     * &lt;p&gt;</span></span><span class="line" lang="java" id="LC39"><span class="cm">     * As specified in {@link Throwable}, the message in the given {@code cause} is not used in this instance&#39;s</span></span><span class="line" lang="java" id="LC40"><span class="cm">     * message.</span></span><span class="line" lang="java" id="LC41"><span class="cm">     * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC42"><span class="cm">     *</span></span><span class="line" lang="java" id="LC43"><span class="cm">     * @param message</span></span><span class="line" lang="java" id="LC44"><span class="cm">     *            the message (see {@link #getMessage()})</span></span><span class="line" lang="java" id="LC45"><span class="cm">     * @param cause</span></span><span class="line" lang="java" id="LC46"><span class="cm">     *            the cause (see {@link #getCause()}). A {@code null} value is allowed.</span></span><span class="line" lang="java" id="LC47"><span class="cm">     */</span></span><span class="line" lang="java" id="LC48"><span>    </span><span class="kd">public</span><span> </span><span>IOExceptionWithCause</span><span>(</span><span class="kd">final</span><span> </span><span>String</span><span> </span><span>message</span><span>,</span><span> </span><span class="kd">final</span><span> </span><span>Throwable</span><span> </span><span>cause</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC49"><span>        </span><span class="kd">super</span><span>(</span><span>message</span><span>,</span><span> </span><span>cause</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC50"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC51"></span><span class="line" lang="java" id="LC52"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC53"><span class="cm">     * Constructs a new instance with the given cause.</span></span><span class="line" lang="java" id="LC54"><span class="cm">     * &lt;p&gt;</span></span><span class="line" lang="java" id="LC55"><span class="cm">     * The message is set to {@code cause==null ? null : cause.toString()}, which by default contains the class</span></span><span class="line" lang="java" id="LC56"><span class="cm">     * and message of {@code cause}. This constructor is useful for call sites that just wrap another throwable.</span></span><span class="line" lang="java" id="LC57"><span class="cm">     * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC58"><span class="cm">     *</span></span><span class="line" lang="java" id="LC59"><span class="cm">     * @param cause</span></span><span class="line" lang="java" id="LC60"><span class="cm">     *            the cause (see {@link #getCause()}). A {@code null} value is allowed.</span></span><span class="line" lang="java" id="LC61"><span class="cm">     */</span></span><span class="line" lang="java" id="LC62"><span>    </span><span class="kd">public</span><span> </span><span>IOExceptionWithCause</span><span>(</span><span class="kd">final</span><span> </span><span>Throwable</span><span> </span><span>cause</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC63"><span>        </span><span class="kd">super</span><span>(</span><span>cause</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC64"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC65"></span><span class="line" lang="java" id="LC66"><span>}</span></span>
</code>
</pre>
    </div>
</div>