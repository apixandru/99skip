...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"><span class="kn">package</span><span> </span><span>org.apache.commons.io.filefilter</span><span>;</span></span><span class="line" lang="java" id="LC18"></span><span class="line" lang="java" id="LC19"><span class="kn">import</span><span> </span><span>java.util.List</span><span>;</span></span><span class="line" lang="java" id="LC20"></span><span class="line" lang="java" id="LC21"><span class="cm">/**</span></span><span class="line" lang="java" id="LC22"><span class="cm"> * Defines operations for conditional file filters.</span></span><span class="line" lang="java" id="LC23"><span class="cm"> *</span></span><span class="line" lang="java" id="LC24"><span class="cm"> * @since 1.1</span></span><span class="line" lang="java" id="LC25"><span class="cm"> */</span></span><span class="line" lang="java" id="LC26"><span class="kd">public</span><span> </span><span class="kd">interface</span><span> </span><span class="nc">ConditionalFileFilter</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC27"></span><span class="line" lang="java" id="LC28"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC29"><span class="cm">     * Adds the specified file filter to the list of file filters at the end of</span></span><span class="line" lang="java" id="LC30"><span class="cm">     * the list.</span></span><span class="line" lang="java" id="LC31"><span class="cm">     *</span></span><span class="line" lang="java" id="LC32"><span class="cm">     * @param ioFileFilter the filter to be added</span></span><span class="line" lang="java" id="LC33"><span class="cm">     * @since 1.1</span></span><span class="line" lang="java" id="LC34"><span class="cm">     */</span></span><span class="line" lang="java" id="LC35"><span>    </span><span class="kt">void</span><span> </span><span>addFileFilter</span><span>(</span><span>IOFileFilter</span><span> </span><span>ioFileFilter</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC36"></span><span class="line" lang="java" id="LC37"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC38"><span class="cm">     * Gets this conditional file filter&#39;s list of file filters.</span></span><span class="line" lang="java" id="LC39"><span class="cm">     *</span></span><span class="line" lang="java" id="LC40"><span class="cm">     * @return the file filter list</span></span><span class="line" lang="java" id="LC41"><span class="cm">     * @since 1.1</span></span><span class="line" lang="java" id="LC42"><span class="cm">     */</span></span><span class="line" lang="java" id="LC43"><span>    </span><span>List</span><span>&lt;</span><span>IOFileFilter</span><span>&gt;</span><span> </span><span>getFileFilters</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC44"></span><span class="line" lang="java" id="LC45"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC46"><span class="cm">     * Removes the specified file filter.</span></span><span class="line" lang="java" id="LC47"><span class="cm">     *</span></span><span class="line" lang="java" id="LC48"><span class="cm">     * @param ioFileFilter filter to be removed</span></span><span class="line" lang="java" id="LC49"><span class="cm">     * @return {@code true} if the filter was found in the list,</span></span><span class="line" lang="java" id="LC50"><span class="cm">     * {@code false} otherwise</span></span><span class="line" lang="java" id="LC51"><span class="cm">     * @since 1.1</span></span><span class="line" lang="java" id="LC52"><span class="cm">     */</span></span><span class="line" lang="java" id="LC53"><span>    </span><span class="kt">boolean</span><span> </span><span>removeFileFilter</span><span>(</span><span>IOFileFilter</span><span> </span><span>ioFileFilter</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC54"></span><span class="line" lang="java" id="LC55"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC56"><span class="cm">     * Sets the list of file filters, replacing any previously configured</span></span><span class="line" lang="java" id="LC57"><span class="cm">     * file filters on this filter.</span></span><span class="line" lang="java" id="LC58"><span class="cm">     *</span></span><span class="line" lang="java" id="LC59"><span class="cm">     * @param fileFilters the list of filters</span></span><span class="line" lang="java" id="LC60"><span class="cm">     * @since 1.1</span></span><span class="line" lang="java" id="LC61"><span class="cm">     */</span></span><span class="line" lang="java" id="LC62"><span>    </span><span class="kt">void</span><span> </span><span>setFileFilters</span><span>(</span><span>List</span><span>&lt;</span><span>IOFileFilter</span><span>&gt;</span><span> </span><span>fileFilters</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC63"></span><span class="line" lang="java" id="LC64"><span>}</span></span>
</code>
</pre>
    </div>
</div>