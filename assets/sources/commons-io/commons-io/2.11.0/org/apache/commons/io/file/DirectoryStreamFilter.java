...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"></span><span class="line" lang="java" id="LC18"><span class="kn">package</span><span> </span><span>org.apache.commons.io.file</span><span>;</span></span><span class="line" lang="java" id="LC19"></span><span class="line" lang="java" id="LC20"><span class="kn">import</span><span> </span><span>java.io.IOException</span><span>;</span></span><span class="line" lang="java" id="LC21"><span class="kn">import</span><span> </span><span>java.nio.file.DirectoryStream</span><span>;</span></span><span class="line" lang="java" id="LC22"><span class="kn">import</span><span> </span><span>java.nio.file.FileVisitResult</span><span>;</span></span><span class="line" lang="java" id="LC23"><span class="kn">import</span><span> </span><span>java.nio.file.Path</span><span>;</span></span><span class="line" lang="java" id="LC24"><span class="kn">import</span><span> </span><span>java.util.Objects</span><span>;</span></span><span class="line" lang="java" id="LC25"></span><span class="line" lang="java" id="LC26"><span class="cm">/**</span></span><span class="line" lang="java" id="LC27"><span class="cm"> * A {@link java.nio.file.DirectoryStream.Filter DirectoryStream.Filter} that delegates to a {@link PathFilter}.</span></span><span class="line" lang="java" id="LC28"><span class="cm"> * &lt;p&gt;</span></span><span class="line" lang="java" id="LC29"><span class="cm"> * You pass this filter to {@link java.nio.file.Files#newDirectoryStream(Path, DirectoryStream.Filter)</span></span><span class="line" lang="java" id="LC30"><span class="cm"> * Files#newDirectoryStream(Path, DirectoryStream.Filter)}.</span></span><span class="line" lang="java" id="LC31"><span class="cm"> * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC32"><span class="cm"> *</span></span><span class="line" lang="java" id="LC33"><span class="cm"> * @since 2.9.0</span></span><span class="line" lang="java" id="LC34"><span class="cm"> */</span></span><span class="line" lang="java" id="LC35"><span class="kd">public</span><span> </span><span class="kd">class</span><span> </span><span class="nc">DirectoryStreamFilter</span><span> </span><span class="kd">implements</span><span> </span><span>DirectoryStream.Filter</span><span>&lt;</span><span>Path</span><span>&gt;</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC36"></span><span class="line" lang="java" id="LC37"><span>    </span><span class="kd">private</span><span> </span><span class="kd">final</span><span> </span><span>PathFilter</span><span> </span><span>pathFilter</span><span>;</span></span><span class="line" lang="java" id="LC38"></span><span class="line" lang="java" id="LC39"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC40"><span class="cm">     * Constructs a new instance for the given path filter.</span></span><span class="line" lang="java" id="LC41"><span class="cm">     *</span></span><span class="line" lang="java" id="LC42"><span class="cm">     * @param pathFilter How to filter paths.</span></span><span class="line" lang="java" id="LC43"><span class="cm">     */</span></span><span class="line" lang="java" id="LC44"><span>    </span><span class="kd">public</span><span> </span><span>DirectoryStreamFilter</span><span>(</span><span class="kd">final</span><span> </span><span>PathFilter</span><span> </span><span>pathFilter</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC45"><span>        </span><span class="cm">// TODO Instead of NPE, we could map null to FalseFileFilter.</span></span><span class="line" lang="java" id="LC46"><span>        </span><span>this</span><span>.</span><span>pathFilter</span><span> </span><span>=</span><span> </span><span>Objects</span><span>.</span><span>requireNonNull</span><span>(</span><span>pathFilter</span><span>,</span><span> </span><span class="s">&quot;pathFilter&quot;</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC47"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC48"></span><span class="line" lang="java" id="LC49"><span>    </span><span>@</span><span>Override</span></span><span class="line" lang="java" id="LC50"><span>    </span><span class="kd">public</span><span> </span><span class="kt">boolean</span><span> </span><span>accept</span><span>(</span><span class="kd">final</span><span> </span><span>Path</span><span> </span><span>path</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC51"><span>        </span><span class="k">return</span><span> </span><span>pathFilter</span><span>.</span><span>accept</span><span>(</span><span>path</span><span>,</span><span> </span><span>PathUtils</span><span>.</span><span>readBasicFileAttributes</span><span>(</span><span>path</span><span>)</span><span>)</span><span> </span><span>==</span><span> </span><span>FileVisitResult</span><span>.</span><span>CONTINUE</span><span>;</span></span><span class="line" lang="java" id="LC52"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC53"></span><span class="line" lang="java" id="LC54"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC55"><span class="cm">     * Gets the path filter.</span></span><span class="line" lang="java" id="LC56"><span class="cm">     *</span></span><span class="line" lang="java" id="LC57"><span class="cm">     * @return the path filter.</span></span><span class="line" lang="java" id="LC58"><span class="cm">     */</span></span><span class="line" lang="java" id="LC59"><span>    </span><span class="kd">public</span><span> </span><span>PathFilter</span><span> </span><span>getPathFilter</span><span>(</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC60"><span>        </span><span class="k">return</span><span> </span><span>pathFilter</span><span>;</span></span><span class="line" lang="java" id="LC61"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC62"></span><span class="line" lang="java" id="LC63"><span>}</span></span>
</code>
</pre>
    </div>
</div>