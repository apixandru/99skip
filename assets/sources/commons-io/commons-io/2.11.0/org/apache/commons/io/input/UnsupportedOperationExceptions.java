...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"></span><span class="line" lang="java" id="LC18"><span class="kn">package</span><span> </span><span>org.apache.commons.io.input</span><span>;</span></span><span class="line" lang="java" id="LC19"></span><span class="line" lang="java" id="LC20"><span class="cm">/**</span></span><span class="line" lang="java" id="LC21"><span class="cm"> * Package-private factory for {@link UnsupportedOperationException} to provide messages with consistent formatting.</span></span><span class="line" lang="java" id="LC22"><span class="cm"> *</span></span><span class="line" lang="java" id="LC23"><span class="cm"> * &lt;p&gt;</span></span><span class="line" lang="java" id="LC24"><span class="cm"> * TODO Consider making this public and use from LineIterator but this feels like it belongs in LANG rather than IO.</span></span><span class="line" lang="java" id="LC25"><span class="cm"> * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC26"><span class="cm"> */</span></span><span class="line" lang="java" id="LC27"><span class="kd">class</span><span> </span><span class="nc">UnsupportedOperationExceptions</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC28"></span><span class="line" lang="java" id="LC29"><span>    </span><span class="kd">private</span><span> </span><span class="kd">static</span><span> </span><span class="kd">final</span><span> </span><span>String</span><span> </span><span>MARK_RESET</span><span> </span><span>=</span><span> </span><span class="s">&quot;mark/reset&quot;</span><span>;</span></span><span class="line" lang="java" id="LC30"></span><span class="line" lang="java" id="LC31"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC32"><span class="cm">     * Creates a new instance of UnsupportedOperationException for a {@code mark} method.</span></span><span class="line" lang="java" id="LC33"><span class="cm">     *</span></span><span class="line" lang="java" id="LC34"><span class="cm">     * @return a new instance of UnsupportedOperationException</span></span><span class="line" lang="java" id="LC35"><span class="cm">     */</span></span><span class="line" lang="java" id="LC36"><span>    </span><span class="kd">static</span><span> </span><span>UnsupportedOperationException</span><span> </span><span>mark</span><span>(</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC37"><span>        </span><span class="cm">// Use the same message as in java.io.InputStream.reset() in OpenJDK 8.0.275-1.</span></span><span class="line" lang="java" id="LC38"><span>        </span><span class="k">return</span><span> </span><span>method</span><span>(</span><span>MARK_RESET</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC39"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC40"></span><span class="line" lang="java" id="LC41"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC42"><span class="cm">     * Creates a new instance of UnsupportedOperationException for the given unsupported a {@code method} name.</span></span><span class="line" lang="java" id="LC43"><span class="cm">     *</span></span><span class="line" lang="java" id="LC44"><span class="cm">     * @param method A method name</span></span><span class="line" lang="java" id="LC45"><span class="cm">     * @return a new instance of UnsupportedOperationException</span></span><span class="line" lang="java" id="LC46"><span class="cm">     */</span></span><span class="line" lang="java" id="LC47"><span>    </span><span class="kd">static</span><span> </span><span>UnsupportedOperationException</span><span> </span><span>method</span><span>(</span><span class="kd">final</span><span> </span><span>String</span><span> </span><span>method</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC48"><span>        </span><span class="k">return</span><span> </span><span class="k">new</span><span> </span><span>UnsupportedOperationException</span><span>(</span><span>method</span><span> </span><span>+</span><span> </span><span class="s">&quot; not supported&quot;</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC49"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC50"></span><span class="line" lang="java" id="LC51"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC52"><span class="cm">     * Creates a new instance of UnsupportedOperationException for a {@code reset} method.</span></span><span class="line" lang="java" id="LC53"><span class="cm">     *</span></span><span class="line" lang="java" id="LC54"><span class="cm">     * @return a new instance of UnsupportedOperationException</span></span><span class="line" lang="java" id="LC55"><span class="cm">     */</span></span><span class="line" lang="java" id="LC56"><span>    </span><span class="kd">static</span><span> </span><span>UnsupportedOperationException</span><span> </span><span>reset</span><span>(</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC57"><span>        </span><span class="cm">// Use the same message as in java.io.InputStream.reset() in OpenJDK 8.0.275-1.</span></span><span class="line" lang="java" id="LC58"><span>        </span><span class="k">return</span><span> </span><span>method</span><span>(</span><span>MARK_RESET</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC59"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC60"><span>}</span></span>
</code>
</pre>
    </div>
</div>