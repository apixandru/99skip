...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"><span class="kn">package</span><span> </span><span>org.apache.commons.io.output</span><span>;</span></span><span class="line" lang="java" id="LC18"></span><span class="line" lang="java" id="LC19"><span class="kn">import</span><span> </span><span>java.io.IOException</span><span>;</span></span><span class="line" lang="java" id="LC20"><span class="kn">import</span><span> </span><span>java.io.OutputStream</span><span>;</span></span><span class="line" lang="java" id="LC21"></span><span class="line" lang="java" id="LC22"><span class="cm">/**</span></span><span class="line" lang="java" id="LC23"><span class="cm"> * OutputStream implementation that writes the data to an {@link Appendable}</span></span><span class="line" lang="java" id="LC24"><span class="cm"> * Object.</span></span><span class="line" lang="java" id="LC25"><span class="cm"> * &lt;p&gt;</span></span><span class="line" lang="java" id="LC26"><span class="cm"> * For example, can be used with any {@link java.io.Writer} or a {@link java.lang.StringBuilder}</span></span><span class="line" lang="java" id="LC27"><span class="cm"> * or {@link java.lang.StringBuffer}.</span></span><span class="line" lang="java" id="LC28"><span class="cm"> * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC29"><span class="cm"> *</span></span><span class="line" lang="java" id="LC30"><span class="cm"> * @since 2.5</span></span><span class="line" lang="java" id="LC31"><span class="cm"> * @see java.lang.Appendable</span></span><span class="line" lang="java" id="LC32"><span class="cm"> *</span></span><span class="line" lang="java" id="LC33"><span class="cm"> * @param &lt;T&gt; The type of the {@link Appendable} wrapped by this AppendableOutputStream.</span></span><span class="line" lang="java" id="LC34"><span class="cm"> */</span></span><span class="line" lang="java" id="LC35"><span class="kd">public</span><span> </span><span class="kd">class</span><span> </span><span class="nc">AppendableOutputStream</span><span> </span><span>&lt;</span><span>T</span><span> </span><span class="kd">extends</span><span> </span><span>Appendable</span><span>&gt;</span><span> </span><span class="kd">extends</span><span> </span><span>OutputStream</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC36"></span><span class="line" lang="java" id="LC37"><span>    </span><span class="kd">private</span><span> </span><span class="kd">final</span><span> </span><span>T</span><span> </span><span>appendable</span><span>;</span></span><span class="line" lang="java" id="LC38"></span><span class="line" lang="java" id="LC39"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC40"><span class="cm">     * Construct a new instance with the specified appendable.</span></span><span class="line" lang="java" id="LC41"><span class="cm">     *</span></span><span class="line" lang="java" id="LC42"><span class="cm">     * @param appendable the appendable to write to</span></span><span class="line" lang="java" id="LC43"><span class="cm">     */</span></span><span class="line" lang="java" id="LC44"><span>    </span><span class="kd">public</span><span> </span><span>AppendableOutputStream</span><span>(</span><span class="kd">final</span><span> </span><span>T</span><span> </span><span>appendable</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC45"><span>        </span><span>this</span><span>.</span><span>appendable</span><span> </span><span>=</span><span> </span><span>appendable</span><span>;</span></span><span class="line" lang="java" id="LC46"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC47"></span><span class="line" lang="java" id="LC48"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC49"><span class="cm">     * Write a character to the underlying appendable.</span></span><span class="line" lang="java" id="LC50"><span class="cm">     *</span></span><span class="line" lang="java" id="LC51"><span class="cm">     * @param b the character to write</span></span><span class="line" lang="java" id="LC52"><span class="cm">     * @throws IOException upon error</span></span><span class="line" lang="java" id="LC53"><span class="cm">     */</span></span><span class="line" lang="java" id="LC54"><span>    </span><span>@</span><span>Override</span></span><span class="line" lang="java" id="LC55"><span>    </span><span class="kd">public</span><span> </span><span class="kt">void</span><span> </span><span>write</span><span>(</span><span class="kd">final</span><span> </span><span class="kt">int</span><span> </span><span>b</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC56"><span>        </span><span>appendable</span><span>.</span><span>append</span><span>(</span><span>(</span><span class="kt">char</span><span>)</span><span>b</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC57"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC58"></span><span class="line" lang="java" id="LC59"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC60"><span class="cm">     * Return the target appendable.</span></span><span class="line" lang="java" id="LC61"><span class="cm">     *</span></span><span class="line" lang="java" id="LC62"><span class="cm">     * @return the target appendable</span></span><span class="line" lang="java" id="LC63"><span class="cm">     */</span></span><span class="line" lang="java" id="LC64"><span>    </span><span class="kd">public</span><span> </span><span>T</span><span> </span><span>getAppendable</span><span>(</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC65"><span>        </span><span class="k">return</span><span> </span><span>appendable</span><span>;</span></span><span class="line" lang="java" id="LC66"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC67"></span><span class="line" lang="java" id="LC68"><span>}</span></span>
</code>
</pre>
    </div>
</div>