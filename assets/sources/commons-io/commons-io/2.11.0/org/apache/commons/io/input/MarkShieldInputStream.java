...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"><span class="kn">package</span><span> </span><span>org.apache.commons.io.input</span><span>;</span></span><span class="line" lang="java" id="LC18"></span><span class="line" lang="java" id="LC19"><span class="kn">import</span><span> </span><span>java.io.IOException</span><span>;</span></span><span class="line" lang="java" id="LC20"><span class="kn">import</span><span> </span><span>java.io.InputStream</span><span>;</span></span><span class="line" lang="java" id="LC21"></span><span class="line" lang="java" id="LC22"><span class="cm">/**</span></span><span class="line" lang="java" id="LC23"><span class="cm"> * This is an alternative to {@link java.io.ByteArrayInputStream}</span></span><span class="line" lang="java" id="LC24"><span class="cm"> * which removes the synchronization overhead for non-concurrent</span></span><span class="line" lang="java" id="LC25"><span class="cm"> * access; as such this class is not thread-safe.</span></span><span class="line" lang="java" id="LC26"><span class="cm"> *</span></span><span class="line" lang="java" id="LC27"><span class="cm"> * Proxy stream that prevents the underlying input stream from being marked/reset.</span></span><span class="line" lang="java" id="LC28"><span class="cm"> * &lt;p&gt;</span></span><span class="line" lang="java" id="LC29"><span class="cm"> * This class is typically used in cases where an input stream that supports</span></span><span class="line" lang="java" id="LC30"><span class="cm"> * marking needs to be passed to a component that wants to explicitly mark</span></span><span class="line" lang="java" id="LC31"><span class="cm"> * the stream, but it it is not desirable to allow marking of the stream.</span></span><span class="line" lang="java" id="LC32"><span class="cm"> * &lt;/p&gt;</span></span><span class="line" lang="java" id="LC33"><span class="cm"> *</span></span><span class="line" lang="java" id="LC34"><span class="cm"> * @since 2.8.0</span></span><span class="line" lang="java" id="LC35"><span class="cm"> */</span></span><span class="line" lang="java" id="LC36"><span class="kd">public</span><span> </span><span class="kd">class</span><span> </span><span class="nc">MarkShieldInputStream</span><span> </span><span class="kd">extends</span><span> </span><span>ProxyInputStream</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC37"></span><span class="line" lang="java" id="LC38"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC39"><span class="cm">     * Creates a proxy that shields the given input stream from being</span></span><span class="line" lang="java" id="LC40"><span class="cm">     * marked or rest.</span></span><span class="line" lang="java" id="LC41"><span class="cm">     *</span></span><span class="line" lang="java" id="LC42"><span class="cm">     * @param in underlying input stream</span></span><span class="line" lang="java" id="LC43"><span class="cm">     */</span></span><span class="line" lang="java" id="LC44"><span>    </span><span class="kd">public</span><span> </span><span>MarkShieldInputStream</span><span>(</span><span class="kd">final</span><span> </span><span>InputStream</span><span> </span><span>in</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC45"><span>        </span><span class="kd">super</span><span>(</span><span>in</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC46"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC47"></span><span class="line" lang="java" id="LC48"><span>    </span><span>@</span><span>SuppressWarnings</span><span>(</span><span class="s">&quot;sync-override&quot;</span><span>)</span></span><span class="line" lang="java" id="LC49"><span>    </span><span>@</span><span>Override</span></span><span class="line" lang="java" id="LC50"><span>    </span><span class="kd">public</span><span> </span><span class="kt">void</span><span> </span><span>mark</span><span>(</span><span class="kd">final</span><span> </span><span class="kt">int</span><span> </span><span>readlimit</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC51"><span>        </span><span class="cm">// no-op</span></span><span class="line" lang="java" id="LC52"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC53"></span><span class="line" lang="java" id="LC54"><span>    </span><span>@</span><span>Override</span></span><span class="line" lang="java" id="LC55"><span>    </span><span class="kd">public</span><span> </span><span class="kt">boolean</span><span> </span><span>markSupported</span><span>(</span><span>)</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC56"><span>        </span><span class="k">return</span><span> </span><span class="kc">false</span><span>;</span></span><span class="line" lang="java" id="LC57"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC58"></span><span class="line" lang="java" id="LC59"><span>    </span><span>@</span><span>SuppressWarnings</span><span>(</span><span class="s">&quot;sync-override&quot;</span><span>)</span></span><span class="line" lang="java" id="LC60"><span>    </span><span>@</span><span>Override</span></span><span class="line" lang="java" id="LC61"><span>    </span><span class="kd">public</span><span> </span><span class="kt">void</span><span> </span><span>reset</span><span>(</span><span>)</span><span> </span><span class="kd">throws</span><span> </span><span>IOException</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC62"><span>        </span><span class="k">throw</span><span> </span><span>UnsupportedOperationExceptions</span><span>.</span><span>reset</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC63"><span>    </span><span>}</span></span><span class="line" lang="java" id="LC64"><span>}</span></span>
</code>
</pre>
    </div>
</div>