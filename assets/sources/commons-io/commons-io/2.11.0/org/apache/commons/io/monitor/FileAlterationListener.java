...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"><span class="kn">package</span><span> </span><span>org.apache.commons.io.monitor</span><span>;</span></span><span class="line" lang="java" id="LC18"><span class="kn">import</span><span> </span><span>java.io.File</span><span>;</span></span><span class="line" lang="java" id="LC19"></span><span class="line" lang="java" id="LC20"><span class="cm">/**</span></span><span class="line" lang="java" id="LC21"><span class="cm"> * A listener that receives events of file system modifications.</span></span><span class="line" lang="java" id="LC22"><span class="cm"> * &lt;p&gt;</span></span><span class="line" lang="java" id="LC23"><span class="cm"> * Register {@link FileAlterationListener}s with a {@link FileAlterationObserver}.</span></span><span class="line" lang="java" id="LC24"><span class="cm"> *</span></span><span class="line" lang="java" id="LC25"><span class="cm"> * @see FileAlterationObserver</span></span><span class="line" lang="java" id="LC26"><span class="cm"> *</span></span><span class="line" lang="java" id="LC27"><span class="cm"> * @since 2.0</span></span><span class="line" lang="java" id="LC28"><span class="cm"> */</span></span><span class="line" lang="java" id="LC29"><span class="kd">public</span><span> </span><span class="kd">interface</span><span> </span><span class="nc">FileAlterationListener</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC30"></span><span class="line" lang="java" id="LC31"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC32"><span class="cm">     * File system observer started checking event.</span></span><span class="line" lang="java" id="LC33"><span class="cm">     *</span></span><span class="line" lang="java" id="LC34"><span class="cm">     * @param observer The file system observer</span></span><span class="line" lang="java" id="LC35"><span class="cm">     */</span></span><span class="line" lang="java" id="LC36"><span>    </span><span class="kt">void</span><span> </span><span>onStart</span><span>(</span><span class="kd">final</span><span> </span><span>FileAlterationObserver</span><span> </span><span>observer</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC37"></span><span class="line" lang="java" id="LC38"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC39"><span class="cm">     * Directory created Event.</span></span><span class="line" lang="java" id="LC40"><span class="cm">     *</span></span><span class="line" lang="java" id="LC41"><span class="cm">     * @param directory The directory created</span></span><span class="line" lang="java" id="LC42"><span class="cm">     */</span></span><span class="line" lang="java" id="LC43"><span>    </span><span class="kt">void</span><span> </span><span>onDirectoryCreate</span><span>(</span><span class="kd">final</span><span> </span><span>File</span><span> </span><span>directory</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC44"></span><span class="line" lang="java" id="LC45"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC46"><span class="cm">     * Directory changed Event.</span></span><span class="line" lang="java" id="LC47"><span class="cm">     *</span></span><span class="line" lang="java" id="LC48"><span class="cm">     * @param directory The directory changed</span></span><span class="line" lang="java" id="LC49"><span class="cm">     */</span></span><span class="line" lang="java" id="LC50"><span>    </span><span class="kt">void</span><span> </span><span>onDirectoryChange</span><span>(</span><span class="kd">final</span><span> </span><span>File</span><span> </span><span>directory</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC51"></span><span class="line" lang="java" id="LC52"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC53"><span class="cm">     * Directory deleted Event.</span></span><span class="line" lang="java" id="LC54"><span class="cm">     *</span></span><span class="line" lang="java" id="LC55"><span class="cm">     * @param directory The directory deleted</span></span><span class="line" lang="java" id="LC56"><span class="cm">     */</span></span><span class="line" lang="java" id="LC57"><span>    </span><span class="kt">void</span><span> </span><span>onDirectoryDelete</span><span>(</span><span class="kd">final</span><span> </span><span>File</span><span> </span><span>directory</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC58"></span><span class="line" lang="java" id="LC59"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC60"><span class="cm">     * File created Event.</span></span><span class="line" lang="java" id="LC61"><span class="cm">     *</span></span><span class="line" lang="java" id="LC62"><span class="cm">     * @param file The file created</span></span><span class="line" lang="java" id="LC63"><span class="cm">     */</span></span><span class="line" lang="java" id="LC64"><span>    </span><span class="kt">void</span><span> </span><span>onFileCreate</span><span>(</span><span class="kd">final</span><span> </span><span>File</span><span> </span><span>file</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC65"></span><span class="line" lang="java" id="LC66"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC67"><span class="cm">     * File changed Event.</span></span><span class="line" lang="java" id="LC68"><span class="cm">     *</span></span><span class="line" lang="java" id="LC69"><span class="cm">     * @param file The file changed</span></span><span class="line" lang="java" id="LC70"><span class="cm">     */</span></span><span class="line" lang="java" id="LC71"><span>    </span><span class="kt">void</span><span> </span><span>onFileChange</span><span>(</span><span class="kd">final</span><span> </span><span>File</span><span> </span><span>file</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC72"></span><span class="line" lang="java" id="LC73"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC74"><span class="cm">     * File deleted Event.</span></span><span class="line" lang="java" id="LC75"><span class="cm">     *</span></span><span class="line" lang="java" id="LC76"><span class="cm">     * @param file The file deleted</span></span><span class="line" lang="java" id="LC77"><span class="cm">     */</span></span><span class="line" lang="java" id="LC78"><span>    </span><span class="kt">void</span><span> </span><span>onFileDelete</span><span>(</span><span class="kd">final</span><span> </span><span>File</span><span> </span><span>file</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC79"></span><span class="line" lang="java" id="LC80"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC81"><span class="cm">     * File system observer finished checking event.</span></span><span class="line" lang="java" id="LC82"><span class="cm">     *</span></span><span class="line" lang="java" id="LC83"><span class="cm">     * @param observer The file system observer</span></span><span class="line" lang="java" id="LC84"><span class="cm">     */</span></span><span class="line" lang="java" id="LC85"><span>    </span><span class="kt">void</span><span> </span><span>onStop</span><span>(</span><span class="kd">final</span><span> </span><span>FileAlterationObserver</span><span> </span><span>observer</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC86"><span>}</span></span>
</code>
</pre>
    </div>
</div>