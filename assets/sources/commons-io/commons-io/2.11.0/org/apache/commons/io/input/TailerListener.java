...
<code>
<span class="line" lang="java" id="LC1"><span class="cm">/*</span></span><span class="line" lang="java" id="LC2"><span class="cm"> * Licensed to the Apache Software Foundation (ASF) under one or more</span></span><span class="line" lang="java" id="LC3"><span class="cm"> * contributor license agreements.  See the NOTICE file distributed with</span></span><span class="line" lang="java" id="LC4"><span class="cm"> * this work for additional information regarding copyright ownership.</span></span><span class="line" lang="java" id="LC5"><span class="cm"> * The ASF licenses this file to You under the Apache License, Version 2.0</span></span><span class="line" lang="java" id="LC6"><span class="cm"> * (the &quot;License&quot;); you may not use this file except in compliance with</span></span><span class="line" lang="java" id="LC7"><span class="cm"> * the License.  You may obtain a copy of the License at</span></span><span class="line" lang="java" id="LC8"><span class="cm"> *</span></span><span class="line" lang="java" id="LC9"><span class="cm"> *      http://www.apache.org/licenses/LICENSE-2.0</span></span><span class="line" lang="java" id="LC10"><span class="cm"> *</span></span><span class="line" lang="java" id="LC11"><span class="cm"> * Unless required by applicable law or agreed to in writing, software</span></span><span class="line" lang="java" id="LC12"><span class="cm"> * distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></span><span class="line" lang="java" id="LC13"><span class="cm"> * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></span><span class="line" lang="java" id="LC14"><span class="cm"> * See the License for the specific language governing permissions and</span></span><span class="line" lang="java" id="LC15"><span class="cm"> * limitations under the License.</span></span><span class="line" lang="java" id="LC16"><span class="cm"> */</span></span><span class="line" lang="java" id="LC17"><span class="kn">package</span><span> </span><span>org.apache.commons.io.input</span><span>;</span></span><span class="line" lang="java" id="LC18"></span><span class="line" lang="java" id="LC19"><span class="cm">/**</span></span><span class="line" lang="java" id="LC20"><span class="cm"> * Listener for events from a {@link Tailer}.</span></span><span class="line" lang="java" id="LC21"><span class="cm"> *</span></span><span class="line" lang="java" id="LC22"><span class="cm"> * @since 2.0</span></span><span class="line" lang="java" id="LC23"><span class="cm"> */</span></span><span class="line" lang="java" id="LC24"><span class="kd">public</span><span> </span><span class="kd">interface</span><span> </span><span class="nc">TailerListener</span><span> </span><span>{</span></span><span class="line" lang="java" id="LC25"></span><span class="line" lang="java" id="LC26"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC27"><span class="cm">     * The tailer will call this method during construction,</span></span><span class="line" lang="java" id="LC28"><span class="cm">     * giving the listener a method of stopping the tailer.</span></span><span class="line" lang="java" id="LC29"><span class="cm">     * @param tailer the tailer.</span></span><span class="line" lang="java" id="LC30"><span class="cm">     */</span></span><span class="line" lang="java" id="LC31"><span>    </span><span class="kt">void</span><span> </span><span>init</span><span>(</span><span>Tailer</span><span> </span><span>tailer</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC32"></span><span class="line" lang="java" id="LC33"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC34"><span class="cm">     * This method is called if the tailed file is not found.</span></span><span class="line" lang="java" id="LC35"><span class="cm">     * &lt;p&gt;</span></span><span class="line" lang="java" id="LC36"><span class="cm">     * &lt;b&gt;Note:&lt;/b&gt; this is called from the tailer thread.</span></span><span class="line" lang="java" id="LC37"><span class="cm">     */</span></span><span class="line" lang="java" id="LC38"><span>    </span><span class="kt">void</span><span> </span><span>fileNotFound</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC39"></span><span class="line" lang="java" id="LC40"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC41"><span class="cm">     * Called if a file rotation is detected.</span></span><span class="line" lang="java" id="LC42"><span class="cm">     *</span></span><span class="line" lang="java" id="LC43"><span class="cm">     * This method is called before the file is reopened, and fileNotFound may</span></span><span class="line" lang="java" id="LC44"><span class="cm">     * be called if the new file has not yet been created.</span></span><span class="line" lang="java" id="LC45"><span class="cm">     * &lt;p&gt;</span></span><span class="line" lang="java" id="LC46"><span class="cm">     * &lt;b&gt;Note:&lt;/b&gt; this is called from the tailer thread.</span></span><span class="line" lang="java" id="LC47"><span class="cm">     */</span></span><span class="line" lang="java" id="LC48"><span>    </span><span class="kt">void</span><span> </span><span>fileRotated</span><span>(</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC49"></span><span class="line" lang="java" id="LC50"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC51"><span class="cm">     * Handles a line from a Tailer.</span></span><span class="line" lang="java" id="LC52"><span class="cm">     * &lt;p&gt;</span></span><span class="line" lang="java" id="LC53"><span class="cm">     * &lt;b&gt;Note:&lt;/b&gt; this is called from the tailer thread.</span></span><span class="line" lang="java" id="LC54"><span class="cm">     * @param line the line.</span></span><span class="line" lang="java" id="LC55"><span class="cm">     */</span></span><span class="line" lang="java" id="LC56"><span>    </span><span class="kt">void</span><span> </span><span>handle</span><span>(</span><span>String</span><span> </span><span>line</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC57"></span><span class="line" lang="java" id="LC58"><span>    </span><span class="cm">/**</span></span><span class="line" lang="java" id="LC59"><span class="cm">     * Handles an Exception .</span></span><span class="line" lang="java" id="LC60"><span class="cm">     * &lt;p&gt;</span></span><span class="line" lang="java" id="LC61"><span class="cm">     * &lt;b&gt;Note:&lt;/b&gt; this is called from the tailer thread.</span></span><span class="line" lang="java" id="LC62"><span class="cm">     * @param ex the exception.</span></span><span class="line" lang="java" id="LC63"><span class="cm">     */</span></span><span class="line" lang="java" id="LC64"><span>    </span><span class="kt">void</span><span> </span><span>handle</span><span>(</span><span>Exception</span><span> </span><span>ex</span><span>)</span><span>;</span></span><span class="line" lang="java" id="LC65"></span><span class="line" lang="java" id="LC66"><span>}</span></span>
</code>
</pre>
    </div>
</div>