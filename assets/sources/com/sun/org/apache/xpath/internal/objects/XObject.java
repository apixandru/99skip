...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: XObject.java,v 1.2.4.1 2005/09/14 20:34:45 jeffsuttor Exp $</span></span>
...
<span id="LC27" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xalan.internal.res.XSLMessages</span><span class="o">;</span></span>
...
<span id="LC30" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.utils.XMLString</span><span class="o">;</span></span>
<span id="LC31" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.Expression</span><span class="o">;</span></span>
<span id="LC32" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.ExpressionOwner</span><span class="o">;</span></span>
<span id="LC33" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.NodeSetDTM</span><span class="o">;</span></span>
...
<span id="LC35" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.XPathException</span><span class="o">;</span></span>
<span id="LC36" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.XPathVisitor</span><span class="o">;</span></span>
...
<span id="LC39" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.DocumentFragment</span><span class="o">;</span></span>
...
<span id="LC41" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.traversal.NodeIterator</span><span class="o">;</span></span>
<span id="LC42" class="line" lang="java"></span>
<span id="LC43" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC44" class="line" lang="java"><span class="cm"> * This class represents an XPath object, and is capable of</span></span>
<span id="LC45" class="line" lang="java"><span class="cm"> * converting the object to various types, such as a string.</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> * This class acts as the base class to other XPath type objects,</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * such as XString, and provides polymorphic casting capabilities.</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * @xsl.usage general</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC50" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XObject</span> <span class="kd">extends</span> <span class="nc">Expression</span> <span class="kd">implements</span> <span class="nc">Serializable</span><span class="o">,</span> <span class="nc">Cloneable</span></span>
<span id="LC51" class="line" lang="java"><span class="o">{</span></span>
<span id="LC52" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="o">-</span><span class="mi">821887098985662951L</span><span class="o">;</span></span>
<span id="LC53" class="line" lang="java"></span>
<span id="LC54" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">   * The java object which this object wraps.</span></span>
...
<span id="LC58" class="line" lang="java">  <span class="kd">protected</span> <span class="nc">Object</span> <span class="n">m_obj</span><span class="o">;</span>  <span class="c1">// This may be NULL!!!</span></span>
<span id="LC59" class="line" lang="java"></span>
<span id="LC60" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC61" class="line" lang="java"><span class="cm">   * Create an XObject.</span></span>
<span id="LC62" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC63" class="line" lang="java">  <span class="kd">public</span> <span class="nf">XObject</span><span class="o">(){}</span></span>
<span id="LC64" class="line" lang="java"></span>
<span id="LC65" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC66" class="line" lang="java"><span class="cm">   * Create an XObject.</span></span>
<span id="LC67" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC68" class="line" lang="java"><span class="cm">   * @param obj Can be any object, should be a specific type</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">   * for derived classes, or null.</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC71" class="line" lang="java">  <span class="kd">public</span> <span class="nf">XObject</span><span class="o">(</span><span class="nc">Object</span> <span class="n">obj</span><span class="o">)</span></span>
<span id="LC72" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC73" class="line" lang="java">    <span class="n">setObject</span><span class="o">(</span><span class="n">obj</span><span class="o">);</span></span>
<span id="LC74" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC75" class="line" lang="java"></span>
<span id="LC76" class="line" lang="java">  <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">setObject</span><span class="o">(</span><span class="nc">Object</span> <span class="n">obj</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC77" class="line" lang="java">      <span class="n">m_obj</span> <span class="o">=</span> <span class="n">obj</span><span class="o">;</span></span>
...
<span id="LC81" class="line" lang="java"><span class="cm">   * For support of literal objects in xpaths.</span></span>
<span id="LC82" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">   * @param xctxt The XPath execution context.</span></span>
<span id="LC84" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">   * @return This object.</span></span>
<span id="LC86" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC87" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC88" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC89" class="line" lang="java">  <span class="kd">public</span> <span class="nc">XObject</span> <span class="nf">execute</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">)</span></span>
<span id="LC90" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC91" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC92" class="line" lang="java">    <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC96" class="line" lang="java"><span class="cm">   * Specify if it's OK for detach to release the iterator for reuse.</span></span>
<span id="LC97" class="line" lang="java"><span class="cm">   * This function should be called with a value of false for objects that are</span></span>
<span id="LC98" class="line" lang="java"><span class="cm">   * stored in variables.</span></span>
<span id="LC99" class="line" lang="java"><span class="cm">   * Calling this with a value of false on a XNodeSet will cause the nodeset</span></span>
<span id="LC100" class="line" lang="java"><span class="cm">   * to be cached.</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">   * @param allowRelease true if it is OK for detach to release this iterator</span></span>
<span id="LC103" class="line" lang="java"><span class="cm">   * for pooling.</span></span>
<span id="LC104" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC105" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">allowDetachToRelease</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">allowRelease</span><span class="o">){}</span></span>
<span id="LC106" class="line" lang="java"></span>
<span id="LC107" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">   * Detaches the &lt;code&gt;DTMIterator&lt;/code&gt; from the set which it iterated</span></span>
<span id="LC109" class="line" lang="java"><span class="cm">   * over, releasing any computational resources and placing the iterator</span></span>
<span id="LC110" class="line" lang="java"><span class="cm">   * in the INVALID state. After &lt;code&gt;detach&lt;/code&gt; has been invoked,</span></span>
<span id="LC111" class="line" lang="java"><span class="cm">   * calls to &lt;code&gt;nextNode&lt;/code&gt; or &lt;code&gt;previousNode&lt;/code&gt; will</span></span>
<span id="LC112" class="line" lang="java"><span class="cm">   * raise a runtime exception.</span></span>
<span id="LC113" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC114" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">detach</span><span class="o">(){}</span></span>
<span id="LC115" class="line" lang="java"></span>
<span id="LC116" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC117" class="line" lang="java"><span class="cm">   * Forces the object to release it's resources.  This is more harsh than</span></span>
<span id="LC118" class="line" lang="java"><span class="cm">   * detach().</span></span>
<span id="LC119" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC120" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">destruct</span><span class="o">()</span></span>
<span id="LC121" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC122" class="line" lang="java"></span>
<span id="LC123" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_obj</span><span class="o">)</span></span>
<span id="LC124" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC125" class="line" lang="java">      <span class="n">allowDetachToRelease</span><span class="o">(</span><span class="kc">true</span><span class="o">);</span></span>
<span id="LC126" class="line" lang="java">      <span class="n">detach</span><span class="o">();</span></span>
<span id="LC127" class="line" lang="java"></span>
<span id="LC128" class="line" lang="java">      <span class="n">setObject</span><span class="o">(</span><span class="kc">null</span><span class="o">);</span></span>
...
<span id="LC133" class="line" lang="java"><span class="cm">   * Reset for fresh reuse.</span></span>
<span id="LC134" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC135" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">reset</span><span class="o">()</span></span>
...
<span id="LC140" class="line" lang="java"><span class="cm">   * Directly call the</span></span>
<span id="LC141" class="line" lang="java"><span class="cm">   * characters method on the passed ContentHandler for the</span></span>
<span id="LC142" class="line" lang="java"><span class="cm">   * string-value. Multiple calls to the</span></span>
<span id="LC143" class="line" lang="java"><span class="cm">   * ContentHandler's characters methods may well occur for a single call to</span></span>
<span id="LC144" class="line" lang="java"><span class="cm">   * this method.</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">   * @param ch A non-null reference to a ContentHandler.</span></span>
<span id="LC147" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC148" class="line" lang="java"><span class="cm">   * @throws org.xml.sax.SAXException</span></span>
<span id="LC149" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC150" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">dispatchCharactersEvents</span><span class="o">(</span><span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">ContentHandler</span> <span class="n">ch</span><span class="o">)</span></span>
<span id="LC151" class="line" lang="java">          <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC152" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC153" class="line" lang="java">    <span class="n">xstr</span><span class="o">().</span><span class="na">dispatchCharactersEvents</span><span class="o">(</span><span class="n">ch</span><span class="o">);</span></span>
...
<span id="LC157" class="line" lang="java"><span class="cm">   * Create the right XObject based on the type of the object passed.  This</span></span>
<span id="LC158" class="line" lang="java"><span class="cm">   * function can not make an XObject that exposes DOM Nodes, NodeLists, and</span></span>
<span id="LC159" class="line" lang="java"><span class="cm">   * NodeIterators to the XSLT stylesheet as node-sets.</span></span>
<span id="LC160" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC161" class="line" lang="java"><span class="cm">   * @param val The java object which this object will wrap.</span></span>
<span id="LC162" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC163" class="line" lang="java"><span class="cm">   * @return the right XObject based on the type of the object passed.</span></span>
<span id="LC164" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC165" class="line" lang="java">  <span class="kd">static</span> <span class="kd">public</span> <span class="nc">XObject</span> <span class="nf">create</span><span class="o">(</span><span class="nc">Object</span> <span class="n">val</span><span class="o">)</span></span>
<span id="LC166" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC167" class="line" lang="java">    <span class="k">return</span> <span class="nc">XObjectFactory</span><span class="o">.</span><span class="na">create</span><span class="o">(</span><span class="n">val</span><span class="o">);</span></span>
...
<span id="LC171" class="line" lang="java"><span class="cm">   * Create the right XObject based on the type of the object passed.</span></span>
<span id="LC172" class="line" lang="java"><span class="cm">   * This function &lt;emph&gt;can&lt;/emph&gt; make an XObject that exposes DOM Nodes, NodeLists, and</span></span>
<span id="LC173" class="line" lang="java"><span class="cm">   * NodeIterators to the XSLT stylesheet as node-sets.</span></span>
<span id="LC174" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC175" class="line" lang="java"><span class="cm">   * @param val The java object which this object will wrap.</span></span>
<span id="LC176" class="line" lang="java"><span class="cm">   * @param xctxt The XPath context.</span></span>
<span id="LC177" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC178" class="line" lang="java"><span class="cm">   * @return the right XObject based on the type of the object passed.</span></span>
<span id="LC179" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC180" class="line" lang="java">  <span class="kd">static</span> <span class="kd">public</span> <span class="nc">XObject</span> <span class="nf">create</span><span class="o">(</span><span class="nc">Object</span> <span class="n">val</span><span class="o">,</span> <span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">)</span></span>
<span id="LC181" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC182" class="line" lang="java">    <span class="k">return</span> <span class="nc">XObjectFactory</span><span class="o">.</span><span class="na">create</span><span class="o">(</span><span class="n">val</span><span class="o">,</span> <span class="n">xctxt</span><span class="o">);</span></span>
<span id="LC183" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC184" class="line" lang="java"></span>
<span id="LC185" class="line" lang="java">  <span class="cm">/** Constant for NULL object type */</span></span>
<span id="LC186" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">CLASS_NULL</span> <span class="o">=</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC187" class="line" lang="java"></span>
<span id="LC188" class="line" lang="java">  <span class="cm">/** Constant for UNKNOWN object type */</span></span>
<span id="LC189" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">CLASS_UNKNOWN</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC190" class="line" lang="java"></span>
<span id="LC191" class="line" lang="java">  <span class="cm">/** Constant for BOOLEAN  object type */</span></span>
<span id="LC192" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">CLASS_BOOLEAN</span> <span class="o">=</span> <span class="mi">1</span><span class="o">;</span></span>
<span id="LC193" class="line" lang="java"></span>
<span id="LC194" class="line" lang="java">  <span class="cm">/** Constant for NUMBER object type */</span></span>
<span id="LC195" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">CLASS_NUMBER</span> <span class="o">=</span> <span class="mi">2</span><span class="o">;</span></span>
<span id="LC196" class="line" lang="java"></span>
<span id="LC197" class="line" lang="java">  <span class="cm">/** Constant for STRING object type */</span></span>
<span id="LC198" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">CLASS_STRING</span> <span class="o">=</span> <span class="mi">3</span><span class="o">;</span></span>
<span id="LC199" class="line" lang="java"></span>
<span id="LC200" class="line" lang="java">  <span class="cm">/** Constant for NODESET object type */</span></span>
<span id="LC201" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">CLASS_NODESET</span> <span class="o">=</span> <span class="mi">4</span><span class="o">;</span></span>
<span id="LC202" class="line" lang="java"></span>
<span id="LC203" class="line" lang="java">  <span class="cm">/** Constant for RESULT TREE FRAGMENT object type */</span></span>
<span id="LC204" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">CLASS_RTREEFRAG</span> <span class="o">=</span> <span class="mi">5</span><span class="o">;</span></span>
<span id="LC205" class="line" lang="java"></span>
<span id="LC206" class="line" lang="java">  <span class="cm">/** Represents an unresolved variable type as an integer. */</span></span>
<span id="LC207" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">CLASS_UNRESOLVEDVARIABLE</span> <span class="o">=</span> <span class="mi">600</span><span class="o">;</span></span>
<span id="LC208" class="line" lang="java"></span>
<span id="LC209" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC210" class="line" lang="java"><span class="cm">   * Tell what kind of class this is.</span></span>
<span id="LC211" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">   * @return CLASS_UNKNOWN</span></span>
<span id="LC213" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC214" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getType</span><span class="o">()</span></span>
<span id="LC215" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC216" class="line" lang="java">    <span class="k">return</span> <span class="no">CLASS_UNKNOWN</span><span class="o">;</span></span>
...
<span id="LC220" class="line" lang="java"><span class="cm">   * Given a request type, return the equivalent string.</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">   * For diagnostic purposes.</span></span>
<span id="LC222" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC223" class="line" lang="java"><span class="cm">   * @return type string "#UNKNOWN" + object class name</span></span>
<span id="LC224" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC225" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getTypeString</span><span class="o">()</span></span>
<span id="LC226" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC227" class="line" lang="java">    <span class="k">return</span> <span class="s">"#UNKNOWN ("</span> <span class="o">+</span> <span class="n">object</span><span class="o">().</span><span class="na">getClass</span><span class="o">().</span><span class="na">getName</span><span class="o">()</span> <span class="o">+</span> <span class="s">")"</span><span class="o">;</span></span>
...
<span id="LC231" class="line" lang="java"><span class="cm">   * Cast result object to a number. Always issues an error.</span></span>
<span id="LC232" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC233" class="line" lang="java"><span class="cm">   * @return 0.0</span></span>
<span id="LC234" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC235" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC236" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC237" class="line" lang="java">  <span class="kd">public</span> <span class="kt">double</span> <span class="nf">num</span><span class="o">()</span> <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC238" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC239" class="line" lang="java"></span>
<span id="LC240" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_CANT_CONVERT_TO_NUMBER</span><span class="o">,</span></span>
<span id="LC241" class="line" lang="java">          <span class="k">new</span> <span class="nc">Object</span><span class="o">[]{</span> <span class="n">getTypeString</span><span class="o">()</span> <span class="o">});</span>  <span class="c1">//"Can not convert "+getTypeString()+" to a number");</span></span>
<span id="LC242" class="line" lang="java"></span>
<span id="LC243" class="line" lang="java">    <span class="k">return</span> <span class="mf">0.0</span><span class="o">;</span></span>
...
<span id="LC247" class="line" lang="java"><span class="cm">   * Cast result object to a number, but allow side effects, such as the</span></span>
<span id="LC248" class="line" lang="java"><span class="cm">   * incrementing of an iterator.</span></span>
<span id="LC249" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC250" class="line" lang="java"><span class="cm">   * @return numeric value of the string conversion from the</span></span>
<span id="LC251" class="line" lang="java"><span class="cm">   * next node in the NodeSetDTM, or NAN if no node was found</span></span>
<span id="LC252" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC253" class="line" lang="java">  <span class="kd">public</span> <span class="kt">double</span> <span class="nf">numWithSideEffects</span><span class="o">()</span>  <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC254" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC255" class="line" lang="java">    <span class="k">return</span> <span class="nf">num</span><span class="o">();</span></span>
...
<span id="LC259" class="line" lang="java"><span class="cm">   * Cast result object to a boolean. Always issues an error.</span></span>
<span id="LC260" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC261" class="line" lang="java"><span class="cm">   * @return false</span></span>
<span id="LC262" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC263" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC264" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC265" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">bool</span><span class="o">()</span> <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC266" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC267" class="line" lang="java"></span>
<span id="LC268" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_CANT_CONVERT_TO_NUMBER</span><span class="o">,</span></span>
<span id="LC269" class="line" lang="java">          <span class="k">new</span> <span class="nc">Object</span><span class="o">[]{</span> <span class="n">getTypeString</span><span class="o">()</span> <span class="o">});</span>  <span class="c1">//"Can not convert "+getTypeString()+" to a number");</span></span>
...
<span id="LC275" class="line" lang="java"><span class="cm">   * Cast result object to a boolean, but allow side effects, such as the</span></span>
<span id="LC276" class="line" lang="java"><span class="cm">   * incrementing of an iterator.</span></span>
<span id="LC277" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC278" class="line" lang="java"><span class="cm">   * @return True if there is a next node in the nodeset</span></span>
<span id="LC279" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC280" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">boolWithSideEffects</span><span class="o">()</span> <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC281" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC282" class="line" lang="java">    <span class="k">return</span> <span class="nf">bool</span><span class="o">();</span></span>
...
<span id="LC287" class="line" lang="java"><span class="cm">   * Cast result object to a string.</span></span>
<span id="LC288" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">   * @return The string this wraps or the empty string if null</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC291" class="line" lang="java">  <span class="kd">public</span> <span class="nc">XMLString</span> <span class="nf">xstr</span><span class="o">()</span></span>
<span id="LC292" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC293" class="line" lang="java">    <span class="k">return</span> <span class="nc">XMLStringFactoryImpl</span><span class="o">.</span><span class="na">getFactory</span><span class="o">().</span><span class="na">newstr</span><span class="o">(</span><span class="n">str</span><span class="o">());</span></span>
...
<span id="LC297" class="line" lang="java"><span class="cm">   * Cast result object to a string.</span></span>
<span id="LC298" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC299" class="line" lang="java"><span class="cm">   * @return The object as a string</span></span>
<span id="LC300" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC301" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">str</span><span class="o">()</span></span>
<span id="LC302" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC303" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">m_obj</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">?</span> <span class="n">m_obj</span><span class="o">.</span><span class="na">toString</span><span class="o">()</span> <span class="o">:</span> <span class="s">""</span><span class="o">;</span></span>
...
<span id="LC307" class="line" lang="java"><span class="cm">   * Return the string representation of the object</span></span>
<span id="LC308" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC309" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC310" class="line" lang="java"><span class="cm">   * @return the string representation of the object</span></span>
<span id="LC311" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC312" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">toString</span><span class="o">()</span></span>
<span id="LC313" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC314" class="line" lang="java">    <span class="k">return</span> <span class="nf">str</span><span class="o">();</span></span>
...
<span id="LC318" class="line" lang="java"><span class="cm">   * Cast result object to a result tree fragment.</span></span>
<span id="LC319" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC320" class="line" lang="java"><span class="cm">   * @param support XPath context to use for the conversion</span></span>
<span id="LC321" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC322" class="line" lang="java"><span class="cm">   * @return the objec as a result tree fragment.</span></span>
<span id="LC323" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC324" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">rtf</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">support</span><span class="o">)</span></span>
<span id="LC325" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC326" class="line" lang="java"></span>
<span id="LC327" class="line" lang="java">    <span class="kt">int</span> <span class="n">result</span> <span class="o">=</span> <span class="n">rtf</span><span class="o">();</span></span>
<span id="LC328" class="line" lang="java"></span>
<span id="LC329" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">==</span> <span class="n">result</span><span class="o">)</span></span>
<span id="LC330" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC331" class="line" lang="java">      <span class="no">DTM</span> <span class="n">frag</span> <span class="o">=</span> <span class="n">support</span><span class="o">.</span><span class="na">createDocumentFragment</span><span class="o">();</span></span>
<span id="LC332" class="line" lang="java"></span>
<span id="LC333" class="line" lang="java">      <span class="c1">// %OPT%</span></span>
<span id="LC334" class="line" lang="java">      <span class="n">frag</span><span class="o">.</span><span class="na">appendTextChild</span><span class="o">(</span><span class="n">str</span><span class="o">());</span></span>
<span id="LC335" class="line" lang="java"></span>
<span id="LC336" class="line" lang="java">      <span class="n">result</span> <span class="o">=</span> <span class="n">frag</span><span class="o">.</span><span class="na">getDocument</span><span class="o">();</span></span>
<span id="LC337" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC338" class="line" lang="java"></span>
<span id="LC339" class="line" lang="java">    <span class="k">return</span> <span class="n">result</span><span class="o">;</span></span>
...
<span id="LC343" class="line" lang="java"><span class="cm">   * Cast result object to a result tree fragment.</span></span>
<span id="LC344" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC345" class="line" lang="java"><span class="cm">   * @param support XPath context to use for the conversion</span></span>
<span id="LC346" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC347" class="line" lang="java"><span class="cm">   * @return the objec as a result tree fragment.</span></span>
<span id="LC348" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC349" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DocumentFragment</span> <span class="nf">rtree</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">support</span><span class="o">)</span></span>
<span id="LC350" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC351" class="line" lang="java">    <span class="nc">DocumentFragment</span> <span class="n">docFrag</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC352" class="line" lang="java">    <span class="kt">int</span> <span class="n">result</span> <span class="o">=</span> <span class="n">rtf</span><span class="o">();</span></span>
<span id="LC353" class="line" lang="java"></span>
<span id="LC354" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">==</span> <span class="n">result</span><span class="o">)</span></span>
<span id="LC355" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC356" class="line" lang="java">      <span class="no">DTM</span> <span class="n">frag</span> <span class="o">=</span> <span class="n">support</span><span class="o">.</span><span class="na">createDocumentFragment</span><span class="o">();</span></span>
<span id="LC357" class="line" lang="java"></span>
<span id="LC358" class="line" lang="java">      <span class="c1">// %OPT%</span></span>
<span id="LC359" class="line" lang="java">      <span class="n">frag</span><span class="o">.</span><span class="na">appendTextChild</span><span class="o">(</span><span class="n">str</span><span class="o">());</span></span>
<span id="LC360" class="line" lang="java"></span>
<span id="LC361" class="line" lang="java">      <span class="n">docFrag</span> <span class="o">=</span> <span class="o">(</span><span class="nc">DocumentFragment</span><span class="o">)</span><span class="n">frag</span><span class="o">.</span><span class="na">getNode</span><span class="o">(</span><span class="n">frag</span><span class="o">.</span><span class="na">getDocument</span><span class="o">());</span></span>
...
<span id="LC365" class="line" lang="java">      <span class="no">DTM</span> <span class="n">frag</span> <span class="o">=</span> <span class="n">support</span><span class="o">.</span><span class="na">getDTM</span><span class="o">(</span><span class="n">result</span><span class="o">);</span></span>
<span id="LC366" class="line" lang="java">      <span class="n">docFrag</span> <span class="o">=</span> <span class="o">(</span><span class="nc">DocumentFragment</span><span class="o">)</span><span class="n">frag</span><span class="o">.</span><span class="na">getNode</span><span class="o">(</span><span class="n">frag</span><span class="o">.</span><span class="na">getDocument</span><span class="o">());</span></span>
<span id="LC367" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC368" class="line" lang="java"></span>
<span id="LC369" class="line" lang="java">    <span class="k">return</span> <span class="n">docFrag</span><span class="o">;</span></span>
...
<span id="LC374" class="line" lang="java"><span class="cm">   * For functions to override.</span></span>
<span id="LC375" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC376" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC377" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC378" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DocumentFragment</span> <span class="nf">rtree</span><span class="o">()</span></span>
...
<span id="LC384" class="line" lang="java"><span class="cm">   * For functions to override.</span></span>
<span id="LC385" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC386" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC387" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC388" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">rtf</span><span class="o">()</span></span>
<span id="LC389" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC390" class="line" lang="java">    <span class="k">return</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
...
<span id="LC394" class="line" lang="java"><span class="cm">   * Return a java object that's closest to the representation</span></span>
<span id="LC395" class="line" lang="java"><span class="cm">   * that should be handed to an extension.</span></span>
<span id="LC396" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC397" class="line" lang="java"><span class="cm">   * @return The object that this class wraps</span></span>
<span id="LC398" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC399" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Object</span> <span class="nf">object</span><span class="o">()</span></span>
<span id="LC400" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC401" class="line" lang="java">    <span class="k">return</span> <span class="n">m_obj</span><span class="o">;</span></span>
...
<span id="LC405" class="line" lang="java"><span class="cm">   * Cast result object to a nodelist. Always issues an error.</span></span>
<span id="LC406" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC407" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC408" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC409" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC410" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC411" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMIterator</span> <span class="nf">iter</span><span class="o">()</span> <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC412" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC413" class="line" lang="java"></span>
<span id="LC414" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_CANT_CONVERT_TO_NODELIST</span><span class="o">,</span></span>
<span id="LC415" class="line" lang="java">          <span class="k">new</span> <span class="nc">Object</span><span class="o">[]{</span> <span class="n">getTypeString</span><span class="o">()</span> <span class="o">});</span>  <span class="c1">//"Can not convert "+getTypeString()+" to a NodeList!");</span></span>
...
<span id="LC421" class="line" lang="java"><span class="cm">   * Get a fresh copy of the object.  For use with variables.</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC423" class="line" lang="java"><span class="cm">   * @return This object, unless overridden by subclass.</span></span>
<span id="LC424" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC425" class="line" lang="java">  <span class="kd">public</span> <span class="nc">XObject</span> <span class="nf">getFresh</span><span class="o">()</span></span>
<span id="LC426" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC427" class="line" lang="java">    <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC432" class="line" lang="java"><span class="cm">   * Cast result object to a nodelist. Always issues an error.</span></span>
<span id="LC433" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC434" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC435" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC436" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC437" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC438" class="line" lang="java">  <span class="kd">public</span> <span class="nc">NodeIterator</span> <span class="nf">nodeset</span><span class="o">()</span> <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC439" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC440" class="line" lang="java"></span>
<span id="LC441" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_CANT_CONVERT_TO_NODELIST</span><span class="o">,</span></span>
<span id="LC442" class="line" lang="java">          <span class="k">new</span> <span class="nc">Object</span><span class="o">[]{</span> <span class="n">getTypeString</span><span class="o">()</span> <span class="o">});</span>  <span class="c1">//"Can not convert "+getTypeString()+" to a NodeList!");</span></span>
...
<span id="LC448" class="line" lang="java"><span class="cm">   * Cast result object to a nodelist. Always issues an error.</span></span>
<span id="LC449" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC450" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC451" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC452" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC453" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC454" class="line" lang="java">  <span class="kd">public</span> <span class="nc">NodeList</span> <span class="nf">nodelist</span><span class="o">()</span> <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC455" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC456" class="line" lang="java"></span>
<span id="LC457" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_CANT_CONVERT_TO_NODELIST</span><span class="o">,</span></span>
<span id="LC458" class="line" lang="java">          <span class="k">new</span> <span class="nc">Object</span><span class="o">[]{</span> <span class="n">getTypeString</span><span class="o">()</span> <span class="o">});</span>  <span class="c1">//"Can not convert "+getTypeString()+" to a NodeList!");</span></span>
<span id="LC459" class="line" lang="java"></span>
<span id="LC460" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC465" class="line" lang="java"><span class="cm">   * Cast result object to a nodelist. Always issues an error.</span></span>
<span id="LC466" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC467" class="line" lang="java"><span class="cm">   * @return The object as a NodeSetDTM.</span></span>
<span id="LC468" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC469" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC470" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC471" class="line" lang="java">  <span class="kd">public</span> <span class="nc">NodeSetDTM</span> <span class="nf">mutableNodeset</span><span class="o">()</span></span>
<span id="LC472" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC473" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC474" class="line" lang="java"></span>
<span id="LC475" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_CANT_CONVERT_TO_MUTABLENODELIST</span><span class="o">,</span></span>
<span id="LC476" class="line" lang="java">          <span class="k">new</span> <span class="nc">Object</span><span class="o">[]{</span> <span class="n">getTypeString</span><span class="o">()</span> <span class="o">});</span>  <span class="c1">//"Can not convert "+getTypeString()+" to a NodeSetDTM!");</span></span>
<span id="LC477" class="line" lang="java"></span>
<span id="LC478" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="nc">NodeSetDTM</span><span class="o">)</span> <span class="n">m_obj</span><span class="o">;</span></span>
...
<span id="LC482" class="line" lang="java"><span class="cm">   * Cast object to type t.</span></span>
<span id="LC483" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC484" class="line" lang="java"><span class="cm">   * @param t Type of object to cast this to</span></span>
<span id="LC485" class="line" lang="java"><span class="cm">   * @param support XPath context to use for the conversion</span></span>
<span id="LC486" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC487" class="line" lang="java"><span class="cm">   * @return This object as the given type t</span></span>
<span id="LC488" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC489" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC490" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC491" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Object</span> <span class="nf">castToType</span><span class="o">(</span><span class="kt">int</span> <span class="n">t</span><span class="o">,</span> <span class="nc">XPathContext</span> <span class="n">support</span><span class="o">)</span></span>
<span id="LC492" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC493" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC494" class="line" lang="java"></span>
<span id="LC495" class="line" lang="java">    <span class="nc">Object</span> <span class="n">result</span><span class="o">;</span></span>
<span id="LC496" class="line" lang="java"></span>
<span id="LC497" class="line" lang="java">    <span class="k">switch</span> <span class="o">(</span><span class="n">t</span><span class="o">)</span></span>
<span id="LC498" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC499" class="line" lang="java">    <span class="k">case</span> <span class="no">CLASS_STRING</span> <span class="o">:</span></span>
<span id="LC500" class="line" lang="java">      <span class="n">result</span> <span class="o">=</span> <span class="n">str</span><span class="o">();</span></span>
<span id="LC501" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC502" class="line" lang="java">    <span class="k">case</span> <span class="no">CLASS_NUMBER</span> <span class="o">:</span></span>
<span id="LC503" class="line" lang="java">      <span class="n">result</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Double</span><span class="o">(</span><span class="n">num</span><span class="o">());</span></span>
<span id="LC504" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC505" class="line" lang="java">    <span class="k">case</span> <span class="no">CLASS_NODESET</span> <span class="o">:</span></span>
<span id="LC506" class="line" lang="java">      <span class="n">result</span> <span class="o">=</span> <span class="n">iter</span><span class="o">();</span></span>
<span id="LC507" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC508" class="line" lang="java">    <span class="k">case</span> <span class="no">CLASS_BOOLEAN</span> <span class="o">:</span></span>
<span id="LC509" class="line" lang="java">      <span class="n">result</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Boolean</span><span class="o">(</span><span class="n">bool</span><span class="o">());</span></span>
<span id="LC510" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC511" class="line" lang="java">    <span class="k">case</span> <span class="no">CLASS_UNKNOWN</span> <span class="o">:</span></span>
<span id="LC512" class="line" lang="java">      <span class="n">result</span> <span class="o">=</span> <span class="n">m_obj</span><span class="o">;</span></span>
<span id="LC513" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC514" class="line" lang="java"></span>
<span id="LC515" class="line" lang="java">    <span class="c1">// %TBD%  What to do here?</span></span>
<span id="LC516" class="line" lang="java">    <span class="c1">//    case CLASS_RTREEFRAG :</span></span>
<span id="LC517" class="line" lang="java">    <span class="c1">//      result = rtree(support);</span></span>
<span id="LC518" class="line" lang="java">    <span class="c1">//      break;</span></span>
<span id="LC519" class="line" lang="java">    <span class="k">default</span> <span class="o">:</span></span>
<span id="LC520" class="line" lang="java">      <span class="n">error</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_CANT_CONVERT_TO_TYPE</span><span class="o">,</span></span>
<span id="LC521" class="line" lang="java">            <span class="k">new</span> <span class="nc">Object</span><span class="o">[]{</span> <span class="n">getTypeString</span><span class="o">(),</span></span>
<span id="LC522" class="line" lang="java">                          <span class="nc">Integer</span><span class="o">.</span><span class="na">toString</span><span class="o">(</span><span class="n">t</span><span class="o">)</span> <span class="o">});</span>  <span class="c1">//"Can not convert "+getTypeString()+" to a type#"+t);</span></span>
<span id="LC523" class="line" lang="java"></span>
<span id="LC524" class="line" lang="java">      <span class="n">result</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC525" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC526" class="line" lang="java"></span>
<span id="LC527" class="line" lang="java">    <span class="k">return</span> <span class="n">result</span><span class="o">;</span></span>
...
<span id="LC531" class="line" lang="java"><span class="cm">   * Tell if one object is less than the other.</span></span>
<span id="LC532" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC533" class="line" lang="java"><span class="cm">   * @param obj2 Object to compare this to</span></span>
<span id="LC534" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC535" class="line" lang="java"><span class="cm">   * @return True if this object is less than the given object</span></span>
<span id="LC536" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC537" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC538" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC539" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">lessThan</span><span class="o">(</span><span class="nc">XObject</span> <span class="n">obj2</span><span class="o">)</span></span>
<span id="LC540" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC541" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC542" class="line" lang="java"></span>
<span id="LC543" class="line" lang="java">    <span class="c1">// In order to handle the 'all' semantics of</span></span>
<span id="LC544" class="line" lang="java">    <span class="c1">// nodeset comparisons, we always call the</span></span>
<span id="LC545" class="line" lang="java">    <span class="c1">// nodeset function.  Because the arguments</span></span>
<span id="LC546" class="line" lang="java">    <span class="c1">// are backwards, we call the opposite comparison</span></span>
<span id="LC547" class="line" lang="java">    <span class="c1">// function.</span></span>
<span id="LC548" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">obj2</span><span class="o">.</span><span class="na">getType</span><span class="o">()</span> <span class="o">==</span> <span class="nc">XObject</span><span class="o">.</span><span class="na">CLASS_NODESET</span><span class="o">)</span></span>
<span id="LC549" class="line" lang="java">      <span class="k">return</span> <span class="n">obj2</span><span class="o">.</span><span class="na">greaterThan</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC550" class="line" lang="java"></span>
<span id="LC551" class="line" lang="java">    <span class="k">return</span> <span class="k">this</span><span class="o">.</span><span class="na">num</span><span class="o">()</span> <span class="o">&lt;</span> <span class="n">obj2</span><span class="o">.</span><span class="na">num</span><span class="o">();</span></span>
...
<span id="LC555" class="line" lang="java"><span class="cm">   * Tell if one object is less than or equal to the other.</span></span>
<span id="LC556" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC557" class="line" lang="java"><span class="cm">   * @param obj2 Object to compare this to</span></span>
<span id="LC558" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC559" class="line" lang="java"><span class="cm">   * @return True if this object is less than or equal to the given object</span></span>
<span id="LC560" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC561" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC562" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC563" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">lessThanOrEqual</span><span class="o">(</span><span class="nc">XObject</span> <span class="n">obj2</span><span class="o">)</span></span>
<span id="LC564" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC565" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC566" class="line" lang="java"></span>
<span id="LC567" class="line" lang="java">    <span class="c1">// In order to handle the 'all' semantics of</span></span>
<span id="LC568" class="line" lang="java">    <span class="c1">// nodeset comparisons, we always call the</span></span>
<span id="LC569" class="line" lang="java">    <span class="c1">// nodeset function.  Because the arguments</span></span>
<span id="LC570" class="line" lang="java">    <span class="c1">// are backwards, we call the opposite comparison</span></span>
<span id="LC571" class="line" lang="java">    <span class="c1">// function.</span></span>
<span id="LC572" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">obj2</span><span class="o">.</span><span class="na">getType</span><span class="o">()</span> <span class="o">==</span> <span class="nc">XObject</span><span class="o">.</span><span class="na">CLASS_NODESET</span><span class="o">)</span></span>
<span id="LC573" class="line" lang="java">      <span class="k">return</span> <span class="n">obj2</span><span class="o">.</span><span class="na">greaterThanOrEqual</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC574" class="line" lang="java"></span>
<span id="LC575" class="line" lang="java">    <span class="k">return</span> <span class="k">this</span><span class="o">.</span><span class="na">num</span><span class="o">()</span> <span class="o">&lt;=</span> <span class="n">obj2</span><span class="o">.</span><span class="na">num</span><span class="o">();</span></span>
...
<span id="LC579" class="line" lang="java"><span class="cm">   * Tell if one object is greater than the other.</span></span>
<span id="LC580" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC581" class="line" lang="java"><span class="cm">   * @param obj2 Object to compare this to</span></span>
<span id="LC582" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC583" class="line" lang="java"><span class="cm">   * @return True if this object is greater than the given object</span></span>
<span id="LC584" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC585" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC586" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC587" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">greaterThan</span><span class="o">(</span><span class="nc">XObject</span> <span class="n">obj2</span><span class="o">)</span></span>
<span id="LC588" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC589" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC590" class="line" lang="java"></span>
<span id="LC591" class="line" lang="java">    <span class="c1">// In order to handle the 'all' semantics of</span></span>
<span id="LC592" class="line" lang="java">    <span class="c1">// nodeset comparisons, we always call the</span></span>
<span id="LC593" class="line" lang="java">    <span class="c1">// nodeset function.  Because the arguments</span></span>
<span id="LC594" class="line" lang="java">    <span class="c1">// are backwards, we call the opposite comparison</span></span>
<span id="LC595" class="line" lang="java">    <span class="c1">// function.</span></span>
<span id="LC596" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">obj2</span><span class="o">.</span><span class="na">getType</span><span class="o">()</span> <span class="o">==</span> <span class="nc">XObject</span><span class="o">.</span><span class="na">CLASS_NODESET</span><span class="o">)</span></span>
<span id="LC597" class="line" lang="java">      <span class="k">return</span> <span class="n">obj2</span><span class="o">.</span><span class="na">lessThan</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC598" class="line" lang="java"></span>
<span id="LC599" class="line" lang="java">    <span class="k">return</span> <span class="k">this</span><span class="o">.</span><span class="na">num</span><span class="o">()</span> <span class="o">&gt;</span> <span class="n">obj2</span><span class="o">.</span><span class="na">num</span><span class="o">();</span></span>
...
<span id="LC603" class="line" lang="java"><span class="cm">   * Tell if one object is greater than or equal to the other.</span></span>
<span id="LC604" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC605" class="line" lang="java"><span class="cm">   * @param obj2 Object to compare this to</span></span>
<span id="LC606" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC607" class="line" lang="java"><span class="cm">   * @return True if this object is greater than or equal to the given object</span></span>
<span id="LC608" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC609" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC610" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC611" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">greaterThanOrEqual</span><span class="o">(</span><span class="nc">XObject</span> <span class="n">obj2</span><span class="o">)</span></span>
<span id="LC612" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC613" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC614" class="line" lang="java"></span>
<span id="LC615" class="line" lang="java">    <span class="c1">// In order to handle the 'all' semantics of</span></span>
<span id="LC616" class="line" lang="java">    <span class="c1">// nodeset comparisons, we always call the</span></span>
<span id="LC617" class="line" lang="java">    <span class="c1">// nodeset function.  Because the arguments</span></span>
<span id="LC618" class="line" lang="java">    <span class="c1">// are backwards, we call the opposite comparison</span></span>
<span id="LC619" class="line" lang="java">    <span class="c1">// function.</span></span>
<span id="LC620" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">obj2</span><span class="o">.</span><span class="na">getType</span><span class="o">()</span> <span class="o">==</span> <span class="nc">XObject</span><span class="o">.</span><span class="na">CLASS_NODESET</span><span class="o">)</span></span>
<span id="LC621" class="line" lang="java">      <span class="k">return</span> <span class="n">obj2</span><span class="o">.</span><span class="na">lessThanOrEqual</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC622" class="line" lang="java"></span>
<span id="LC623" class="line" lang="java">    <span class="k">return</span> <span class="k">this</span><span class="o">.</span><span class="na">num</span><span class="o">()</span> <span class="o">&gt;=</span> <span class="n">obj2</span><span class="o">.</span><span class="na">num</span><span class="o">();</span></span>
...
<span id="LC627" class="line" lang="java"><span class="cm">   * Tell if two objects are functionally equal.</span></span>
<span id="LC628" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC629" class="line" lang="java"><span class="cm">   * @param obj2 Object to compare this to</span></span>
<span id="LC630" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC631" class="line" lang="java"><span class="cm">   * @return True if this object is equal to the given object</span></span>
<span id="LC632" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC633" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC634" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC635" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">equals</span><span class="o">(</span><span class="nc">XObject</span> <span class="n">obj2</span><span class="o">)</span></span>
<span id="LC636" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC637" class="line" lang="java"></span>
<span id="LC638" class="line" lang="java">    <span class="c1">// In order to handle the 'all' semantics of</span></span>
<span id="LC639" class="line" lang="java">    <span class="c1">// nodeset comparisons, we always call the</span></span>
<span id="LC640" class="line" lang="java">    <span class="c1">// nodeset function.</span></span>
<span id="LC641" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">obj2</span><span class="o">.</span><span class="na">getType</span><span class="o">()</span> <span class="o">==</span> <span class="nc">XObject</span><span class="o">.</span><span class="na">CLASS_NODESET</span><span class="o">)</span></span>
<span id="LC642" class="line" lang="java">      <span class="k">return</span> <span class="n">obj2</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC643" class="line" lang="java"></span>
<span id="LC644" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_obj</span><span class="o">)</span></span>
<span id="LC645" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC646" class="line" lang="java">      <span class="k">return</span> <span class="n">m_obj</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">obj2</span><span class="o">.</span><span class="na">m_obj</span><span class="o">);</span></span>
...
<span id="LC650" class="line" lang="java">      <span class="k">return</span> <span class="n">obj2</span><span class="o">.</span><span class="na">m_obj</span> <span class="o">==</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC655" class="line" lang="java"><span class="cm">   * Tell if two objects are functionally not equal.</span></span>
<span id="LC656" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC657" class="line" lang="java"><span class="cm">   * @param obj2 Object to compare this to</span></span>
<span id="LC658" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC659" class="line" lang="java"><span class="cm">   * @return True if this object is not equal to the given object</span></span>
<span id="LC660" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC661" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC662" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC663" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">notEquals</span><span class="o">(</span><span class="nc">XObject</span> <span class="n">obj2</span><span class="o">)</span></span>
<span id="LC664" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC665" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC666" class="line" lang="java"></span>
<span id="LC667" class="line" lang="java">    <span class="c1">// In order to handle the 'all' semantics of</span></span>
<span id="LC668" class="line" lang="java">    <span class="c1">// nodeset comparisons, we always call the</span></span>
<span id="LC669" class="line" lang="java">    <span class="c1">// nodeset function.</span></span>
<span id="LC670" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">obj2</span><span class="o">.</span><span class="na">getType</span><span class="o">()</span> <span class="o">==</span> <span class="nc">XObject</span><span class="o">.</span><span class="na">CLASS_NODESET</span><span class="o">)</span></span>
<span id="LC671" class="line" lang="java">      <span class="k">return</span> <span class="n">obj2</span><span class="o">.</span><span class="na">notEquals</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC672" class="line" lang="java"></span>
<span id="LC673" class="line" lang="java">    <span class="k">return</span> <span class="o">!</span><span class="n">equals</span><span class="o">(</span><span class="n">obj2</span><span class="o">);</span></span>
...
<span id="LC677" class="line" lang="java"><span class="cm">   * Tell the user of an error, and probably throw an</span></span>
<span id="LC678" class="line" lang="java"><span class="cm">   * exception.</span></span>
<span id="LC679" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC680" class="line" lang="java"><span class="cm">   * @param msg Error message to issue</span></span>
<span id="LC681" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC682" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC683" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC684" class="line" lang="java">  <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">error</span><span class="o">(</span><span class="nc">String</span> <span class="n">msg</span><span class="o">)</span></span>
<span id="LC685" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC686" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC687" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="n">msg</span><span class="o">,</span> <span class="kc">null</span><span class="o">);</span></span>
...
<span id="LC691" class="line" lang="java"><span class="cm">   * Tell the user of an error, and probably throw an</span></span>
<span id="LC692" class="line" lang="java"><span class="cm">   * exception.</span></span>
<span id="LC693" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC694" class="line" lang="java"><span class="cm">   * @param msg Error message to issue</span></span>
<span id="LC695" class="line" lang="java"><span class="cm">   * @param args Arguments to use in the message</span></span>
<span id="LC696" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC697" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC698" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC699" class="line" lang="java">  <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">error</span><span class="o">(</span><span class="nc">String</span> <span class="n">msg</span><span class="o">,</span> <span class="nc">Object</span><span class="o">[]</span> <span class="n">args</span><span class="o">)</span></span>
<span id="LC700" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC701" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC702" class="line" lang="java"></span>
<span id="LC703" class="line" lang="java">    <span class="nc">String</span> <span class="n">fmsg</span> <span class="o">=</span> <span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="n">msg</span><span class="o">,</span> <span class="n">args</span><span class="o">);</span></span>
<span id="LC704" class="line" lang="java"></span>
<span id="LC705" class="line" lang="java">    <span class="c1">// boolean shouldThrow = support.problem(m_support.XPATHPROCESSOR,</span></span>
<span id="LC706" class="line" lang="java">    <span class="c1">//                                      m_support.ERROR,</span></span>
<span id="LC707" class="line" lang="java">    <span class="c1">//                                      null,</span></span>
<span id="LC708" class="line" lang="java">    <span class="c1">//                                      null, fmsg, 0, 0);</span></span>
<span id="LC709" class="line" lang="java">    <span class="c1">// if(shouldThrow)</span></span>
<span id="LC710" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC711" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">XPathException</span><span class="o">(</span><span class="n">fmsg</span><span class="o">,</span> <span class="k">this</span><span class="o">);</span></span>
...
<span id="LC726" class="line" lang="java"><span class="cm">   * Cast result object to a string.</span></span>
<span id="LC727" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC728" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC729" class="line" lang="java"><span class="cm">   * NEEDSDOC @param fsb</span></span>
<span id="LC730" class="line" lang="java"><span class="cm">   * @return The string this wraps or the empty string if null</span></span>
<span id="LC731" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC732" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">appendToFsb</span><span class="o">(</span><span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">utils</span><span class="o">.</span><span class="na">FastStringBuffer</span> <span class="n">fsb</span><span class="o">)</span></span>
<span id="LC733" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC734" class="line" lang="java">    <span class="n">fsb</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="n">str</span><span class="o">());</span></span>
...
<span id="LC738" class="line" lang="java"><span class="cm">   * @see com.sun.org.apache.xpath.internal.XPathVisitable#callVisitors(ExpressionOwner, XPathVisitor)</span></span>
<span id="LC739" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC740" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">callVisitors</span><span class="o">(</span><span class="nc">ExpressionOwner</span> <span class="n">owner</span><span class="o">,</span> <span class="nc">XPathVisitor</span> <span class="n">visitor</span><span class="o">)</span></span>
<span id="LC741" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC742" class="line" lang="java">        <span class="n">assertion</span><span class="o">(</span><span class="kc">false</span><span class="o">,</span> <span class="s">"callVisitors should not be called for this object!!!"</span><span class="o">);</span></span>
<span id="LC743" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC744" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC745" class="line" lang="java"><span class="cm">   * @see Expression#deepEquals(Expression)</span></span>
<span id="LC746" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC747" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">deepEquals</span><span class="o">(</span><span class="nc">Expression</span> <span class="n">expr</span><span class="o">)</span></span>
<span id="LC748" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC749" class="line" lang="java">        <span class="k">if</span><span class="o">(!</span><span class="n">isSameClass</span><span class="o">(</span><span class="n">expr</span><span class="o">))</span></span>
...
<span id="LC752" class="line" lang="java">        <span class="c1">// If equals at the expression level calls deepEquals, I think we're</span></span>
<span id="LC753" class="line" lang="java">        <span class="c1">// still safe from infinite recursion since this object overrides</span></span>
<span id="LC754" class="line" lang="java">        <span class="c1">// equals.  I hope.</span></span>
<span id="LC755" class="line" lang="java">        <span class="k">if</span><span class="o">(!</span><span class="k">this</span><span class="o">.</span><span class="na">equals</span><span class="o">((</span><span class="nc">XObject</span><span class="o">)</span><span class="n">expr</span><span class="o">))</span></span>
...
<span id="LC758" class="line" lang="java">        <span class="k">return</span> <span class="kc">true</span><span class="o">;</span></span>
