...
<span id="LC34" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XPATHErrorResources_pt_BR</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span></span>
...
<span id="LC361" class="line" lang="java">  <span class="o">{</span> <span class="no">ER_CURRENT_NOT_ALLOWED_IN_MATCH</span><span class="o">,</span> <span class="s">"A fun\u00E7\u00E3o current() n\u00E3o \u00E9 permitida em um padr\u00E3o de correspond\u00EAncia!"</span> <span class="o">},</span></span>
<span id="LC362" class="line" lang="java"></span>
<span id="LC363" class="line" lang="java">  <span class="o">{</span> <span class="no">ER_CURRENT_TAKES_NO_ARGS</span><span class="o">,</span> <span class="s">"A fun\u00E7\u00E3o current() n\u00E3o aceita argumentos!"</span> <span class="o">},</span></span>
...
<span id="LC366" class="line" lang="java">      <span class="s">"a implementa\u00E7\u00E3o da fun\u00E7\u00E3o document() foi substitu\u00EDda por com.sun.org.apache.xalan.internal.xslt.FuncDocument!"</span><span class="o">},</span></span>
...
<span id="LC369" class="line" lang="java">      <span class="s">"o contexto n\u00E3o tem um documento de propriet\u00E1rio!"</span><span class="o">},</span></span>
...
<span id="LC372" class="line" lang="java">      <span class="s">"local-name() tem muitos argumentos."</span><span class="o">},</span></span>
...
<span id="LC375" class="line" lang="java">      <span class="s">"namespace-uri() tem muitos argumentos."</span><span class="o">},</span></span>
...
<span id="LC378" class="line" lang="java">      <span class="s">"normalize-space() tem muitos argumentos."</span><span class="o">},</span></span>
...
<span id="LC381" class="line" lang="java">      <span class="s">"number() tem muitos argumentos."</span><span class="o">},</span></span>
...
<span id="LC384" class="line" lang="java">     <span class="s">"name() tem muitos argumentos."</span><span class="o">},</span></span>
...
<span id="LC387" class="line" lang="java">      <span class="s">"string() tem muitos argumentos."</span><span class="o">},</span></span>
...
<span id="LC390" class="line" lang="java">      <span class="s">"string-length() tem muitos argumentos."</span><span class="o">},</span></span>
...
<span id="LC393" class="line" lang="java">      <span class="s">"A fun\u00E7\u00E3o translate() tem tr\u00EAs argumentos!"</span><span class="o">},</span></span>
...
<span id="LC396" class="line" lang="java">      <span class="s">"A fun\u00E7\u00E3o unparsed-entity-uri deve ter um argumento!"</span><span class="o">},</span></span>
...
<span id="LC399" class="line" lang="java">      <span class="s">"o eixo do namespace ainda n\u00E3o foi implementado!"</span><span class="o">},</span></span>
...
<span id="LC402" class="line" lang="java">     <span class="s">"eixo desconhecido: {0}"</span><span class="o">},</span></span>
...
<span id="LC405" class="line" lang="java">     <span class="s">"Opera\u00E7\u00E3o correspondente desconhecida!"</span><span class="o">},</span></span>
...
<span id="LC408" class="line" lang="java">      <span class="s">"O tamanho do argumento do teste de n\u00F3 de processing-instruction() est\u00E1 incorreto!"</span><span class="o">},</span></span>
...
<span id="LC411" class="line" lang="java">      <span class="s">"N\u00E3o \u00E9 poss\u00EDvel converter {0} em um n\u00FAmero"</span><span class="o">},</span></span>
...
<span id="LC414" class="line" lang="java">      <span class="s">"N\u00E3o \u00E9 poss\u00EDvel converter {0} em uma NodeList!"</span><span class="o">},</span></span>
...
<span id="LC417" class="line" lang="java">      <span class="s">"N\u00E3o \u00E9 poss\u00EDvel converter {0} em um NodeSetDTM!"</span><span class="o">},</span></span>
...
<span id="LC420" class="line" lang="java">      <span class="s">"N\u00E3o \u00E9 poss\u00EDvel converter {0} em um tipo n\u00BA{1}"</span><span class="o">},</span></span>
...
<span id="LC423" class="line" lang="java">      <span class="s">"Padr\u00E3o de correspond\u00EAncia esperado em getMatchScore!"</span><span class="o">},</span></span>
...
<span id="LC426" class="line" lang="java">      <span class="s">"N\u00E3o foi poss\u00EDvel obter a vari\u00E1vel com o nome {0}"</span><span class="o">},</span></span>
...
<span id="LC429" class="line" lang="java">     <span class="s">"ERRO! C\u00F3digo da opera\u00E7\u00E3o desconhecido: {0}"</span><span class="o">},</span></span>
...
<span id="LC432" class="line" lang="java">     <span class="s">"Tokens inv\u00E1lidos extras: {0}"</span><span class="o">},</span></span>
...
<span id="LC435" class="line" lang="java">      <span class="s">"literal com aspas incorretas... esperava-se aspas duplas!"</span><span class="o">},</span></span>
...
<span id="LC438" class="line" lang="java">      <span class="s">"literal com aspas incorretas... esperava-se aspas simples!"</span><span class="o">},</span></span>
...
<span id="LC441" class="line" lang="java">     <span class="s">"Express\u00E3o vazia!"</span><span class="o">},</span></span>
...
<span id="LC444" class="line" lang="java">     <span class="s">"Esperava {0}, mas encontrou: {1}"</span><span class="o">},</span></span>
...
<span id="LC447" class="line" lang="java">      <span class="s">"Asser\u00E7\u00E3o do programador incorreta! - {0}"</span><span class="o">},</span></span>
...
<span id="LC450" class="line" lang="java">      <span class="s">"O argumento boolean(...) n\u00E3o \u00E9 mais opcional com o rascunho XPath 19990709."</span><span class="o">},</span></span>
...
<span id="LC453" class="line" lang="java">      <span class="s">"Encontrou ',' mas sem um argumento precedente!"</span><span class="o">},</span></span>
...
<span id="LC456" class="line" lang="java">      <span class="s">"Encontrou ',' mas sem o argumento a seguir!"</span><span class="o">},</span></span>
...
<span id="LC459" class="line" lang="java">      <span class="s">"'..[predicate]' ou '.[predicate]' \u00E9 uma sintaxe inv\u00E1lida. Use 'self::node()[predicate]'."</span><span class="o">},</span></span>
...
<span id="LC462" class="line" lang="java">     <span class="s">"nome do eixo inv\u00E1lido: {0}"</span><span class="o">},</span></span>
...
<span id="LC465" class="line" lang="java">     <span class="s">"Tipo de n\u00F3 desconhecido: {0}"</span><span class="o">},</span></span>
...
<span id="LC468" class="line" lang="java">      <span class="s">"A literal padr\u00E3o ({0}) precisa estar entre aspas!"</span><span class="o">},</span></span>
...
<span id="LC471" class="line" lang="java">      <span class="s">"n\u00E3o foi poss\u00EDvel formatar {0} como um n\u00FAmero!"</span><span class="o">},</span></span>
...
<span id="LC474" class="line" lang="java">      <span class="s">"N\u00E3o foi poss\u00EDvel criar a Liga\u00E7\u00E3o TransformerFactory XML: {0}"</span><span class="o">},</span></span>
...
<span id="LC477" class="line" lang="java">      <span class="s">"Erro! N\u00E3o foi poss\u00EDvel localizar a express\u00E3o de sele\u00E7\u00E3o xpath (-select)."</span><span class="o">},</span></span>
...
<span id="LC480" class="line" lang="java">      <span class="s">"ERRO! N\u00E3o foi poss\u00EDvel localizar ENDOP ap\u00F3s OP_LOCATIONPATH"</span><span class="o">},</span></span>
...
<span id="LC483" class="line" lang="java">     <span class="s">"Ocorreu um erro!"</span><span class="o">},</span></span>
...
<span id="LC486" class="line" lang="java">      <span class="s">"VariableReference fornecida para a vari\u00E1vel fora do contexto ou sem defini\u00E7\u00E3o! Nome = {0}"</span><span class="o">},</span></span>
...
<span id="LC489" class="line" lang="java">      <span class="s">"Somente eixos filho:: e atributo:: s\u00E3o permitidos nos padr\u00F5es de correspond\u00EAncia! Eixos incorretos = {0}"</span><span class="o">},</span></span>
...
<span id="LC492" class="line" lang="java">      <span class="s">"key() tem um n\u00FAmero incorreto de argumentos."</span><span class="o">},</span></span>
...
<span id="LC495" class="line" lang="java">      <span class="s">"A fun\u00E7\u00E3o count deve ter um argumento!"</span><span class="o">},</span></span>
...
<span id="LC498" class="line" lang="java">     <span class="s">"N\u00E3o foi poss\u00EDvel localizar a fun\u00E7\u00E3o: {0}"</span><span class="o">},</span></span>
...
<span id="LC501" class="line" lang="java">     <span class="s">"Codifica\u00E7\u00E3o n\u00E3o suportada: {0}"</span><span class="o">},</span></span>
...
<span id="LC504" class="line" lang="java">      <span class="s">"Ocorreu um problema no DTM em getNextSibling... tentando recuperar"</span><span class="o">},</span></span>
...
<span id="LC507" class="line" lang="java">      <span class="s">"Erro do programador: EmptyNodeList n\u00E3o pode ser gravado."</span><span class="o">},</span></span>
...
<span id="LC510" class="line" lang="java">      <span class="s">"setDOMFactory n\u00E3o suportado por XPathContext!"</span><span class="o">},</span></span>
...
<span id="LC513" class="line" lang="java">      <span class="s">"O prefixo deve ser resolvido para um namespace: {0}"</span><span class="o">},</span></span>
...
<span id="LC516" class="line" lang="java">      <span class="s">"parsing (InputSource source) n\u00E3o suportado em XPathContext! N\u00E3o \u00E9 poss\u00EDvel abrir {0}"</span><span class="o">},</span></span>
...
<span id="LC519" class="line" lang="java">      <span class="s">"Caracteres SAX API(char ch[]... n\u00E3o tratados por DTM!"</span><span class="o">},</span></span>
...
<span id="LC522" class="line" lang="java">      <span class="s">"ignorableWhitespace(char ch[]... n\u00E3o tratado pelo DTM!"</span><span class="o">},</span></span>
...
<span id="LC525" class="line" lang="java">      <span class="s">"DTMLiaison n\u00E3o pode tratar n\u00F3s do tipo {0}"</span><span class="o">},</span></span>
...
<span id="LC528" class="line" lang="java">      <span class="s">"DOM2Helper n\u00E3o pode tratar n\u00F3s do tipo {0}"</span><span class="o">},</span></span>
...
<span id="LC531" class="line" lang="java">      <span class="s">"Erro de DOM2Helper.parse: SystemID - {0} linha - {1}"</span><span class="o">},</span></span>
...
<span id="LC534" class="line" lang="java">     <span class="s">"Erro de DOM2Helper.parse"</span><span class="o">},</span></span>
...
<span id="LC537" class="line" lang="java">      <span class="s">"Foi detectado um substituto de UTF-16 inv\u00E1lido: {0} ?"</span><span class="o">},</span></span>
...
<span id="LC540" class="line" lang="java">     <span class="s">"Erro de E/S"</span><span class="o">},</span></span>
...
<span id="LC543" class="line" lang="java">     <span class="s">"N\u00E3o \u00E9 poss\u00EDvel criar o url para: {0}"</span><span class="o">},</span></span>
...
<span id="LC546" class="line" lang="java">     <span class="s">"No XPath.readObject: {0}"</span><span class="o">},</span></span>
...
<span id="LC549" class="line" lang="java">      <span class="s">"token da fun\u00E7\u00E3o n\u00E3o encontrado."</span><span class="o">},</span></span>
...
<span id="LC552" class="line" lang="java">       <span class="s">"N\u00E3o \u00E9 poss\u00EDvel lidar com o tipo de XPath: {0}"</span><span class="o">},</span></span>
...
<span id="LC555" class="line" lang="java">       <span class="s">"Este NodeSet n\u00E3o \u00E9 mut\u00E1vel"</span><span class="o">},</span></span>
...
<span id="LC558" class="line" lang="java">       <span class="s">"Este NodeSetDTM n\u00E3o \u00E9 mut\u00E1vel"</span><span class="o">},</span></span>
...
<span id="LC561" class="line" lang="java">        <span class="s">"Vari\u00E1vel n\u00E3o resolv\u00EDvel: {0}"</span><span class="o">},</span></span>
...
<span id="LC564" class="line" lang="java">        <span class="s">"Handler de erro nulo"</span><span class="o">},</span></span>
...
<span id="LC567" class="line" lang="java">       <span class="s">"Asser\u00E7\u00E3o do programador: opcode desconhecido: {0}"</span><span class="o">},</span></span>
...
<span id="LC573" class="line" lang="java">       <span class="s">"rtf() n\u00E3o suportado por XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC576" class="line" lang="java">       <span class="s">"asNodeIterator() n\u00E3o suportado por XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC580" class="line" lang="java">                <span class="s">"detach() n\u00E3o suportado por XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC584" class="line" lang="java">                <span class="s">"num() n\u00E3o suportado por XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC588" class="line" lang="java">                <span class="s">"xstr() n\u00E3o suportado por XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC592" class="line" lang="java">                <span class="s">"str() n\u00E3o suportado por XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC595" class="line" lang="java">       <span class="s">"fsb() n\u00E3o suportado para XStringForChars"</span><span class="o">},</span></span>
...
<span id="LC598" class="line" lang="java">      <span class="s">"N\u00E3o foi poss\u00EDvel localizar a vari\u00E1vel com o nome {0}"</span><span class="o">},</span></span>
...
<span id="LC601" class="line" lang="java">      <span class="s">"XStringForChars n\u00E3o pode ter uma string para um argumento"</span><span class="o">},</span></span>
...
<span id="LC604" class="line" lang="java">      <span class="s">"O argumento FastStringBuffer n\u00E3o pode ser nulo"</span><span class="o">},</span></span>
...
<span id="LC610" class="line" lang="java">       <span class="s">"Vari\u00E1vel acessada antes de ser associada!"</span><span class="o">},</span></span>
...
<span id="LC613" class="line" lang="java">       <span class="s">"XStringForFSB n\u00E3o pode obter uma string para um argumento!"</span><span class="o">},</span></span>
...
<span id="LC616" class="line" lang="java">       <span class="s">"\n !!!! Erro! Definindo a raiz de um walker como nula!!!"</span><span class="o">},</span></span>
...
<span id="LC619" class="line" lang="java">       <span class="s">"Este NodeSetDTM n\u00E3o pode fazer itera\u00E7\u00F5es para um n\u00F3 anterior!"</span><span class="o">},</span></span>
...
<span id="LC622" class="line" lang="java">       <span class="s">"Este NodeSet n\u00E3o pode fazer itera\u00E7\u00F5es para um n\u00F3 anterior!"</span><span class="o">},</span></span>
...
<span id="LC625" class="line" lang="java">       <span class="s">"Este NodeSetDTM n\u00E3o pode executar as fun\u00E7\u00F5es de indexa\u00E7\u00E3o ou de contagem!"</span><span class="o">},</span></span>
...
<span id="LC628" class="line" lang="java">       <span class="s">"Este NodeSet n\u00E3o pode executar as fun\u00E7\u00F5es de indexa\u00E7\u00E3o ou de contagem!"</span><span class="o">},</span></span>
...
<span id="LC631" class="line" lang="java">       <span class="s">"N\u00E3o \u00E9 poss\u00EDvel chamar setShouldCacheNodes depois de nextNode ter sido chamado!"</span><span class="o">},</span></span>
...
<span id="LC634" class="line" lang="java">       <span class="s">"{0} s\u00F3 permite {1} argumentos"</span><span class="o">},</span></span>
...
<span id="LC637" class="line" lang="java">       <span class="s">"Asser\u00E7\u00E3o do programador em getNextStepPos: stepType desconhecido: {0}"</span><span class="o">},</span></span>
...
<span id="LC643" class="line" lang="java">      <span class="s">"Esperava-se um caminho de localiza\u00E7\u00E3o relativo, mas o seguinte token foi encontrado: '/' ou '//'."</span><span class="o">},</span></span>
...
<span id="LC649" class="line" lang="java">       <span class="s">"Esperava-se um caminho de localiza\u00E7\u00E3o, mas o seguinte token foi encontrado:  {0}"</span><span class="o">},</span></span>
...
<span id="LC655" class="line" lang="java">       <span class="s">"Esperava-se um caminho de localiza\u00E7\u00E3o, mas, em vez disso, o fim da express\u00E3o XPath foi encontrado."</span><span class="o">},</span></span>
...
<span id="LC661" class="line" lang="java">       <span class="s">"Esperava-se uma etapa de localiza\u00E7\u00E3o seguinte ao token '/' ou '//'."</span><span class="o">},</span></span>
...
<span id="LC668" class="line" lang="java">       <span class="s">"Esperava-se um teste de n\u00F3 que corresponde a NCName:* ou QName."</span><span class="o">},</span></span>
...
<span id="LC674" class="line" lang="java">       <span class="s">"Esperava-se um padr\u00E3o da etapa, mas '/' foi encontrado."</span><span class="o">},</span></span>
...
<span id="LC680" class="line" lang="java">       <span class="s">"Esperava-se um padr\u00E3o de caminho relativo."</span><span class="o">},</span></span>
...
<span id="LC686" class="line" lang="java">       <span class="s">"O XPathResult da express\u00E3o de XPath ''{0}'' tem um XPathResultType de {1} que n\u00E3o pode ser convertido em um booliano."</span><span class="o">},</span></span>
...
<span id="LC691" class="line" lang="java">       <span class="s">"O XPathResult da express\u00E3o de XPath ''{0}'' tem um XPathResultType de {1} que n\u00E3o pode ser convertido em um n\u00F3 simples. O m\u00E9todo getSingleNodeValue aplica-se somente aos tipos ANY_UNORDERED_NODE_TYPE e FIRST_ORDERED_NODE_TYPE."</span><span class="o">},</span></span>
...
<span id="LC696" class="line" lang="java">       <span class="s">"O m\u00E9todo getSnapshotLength n\u00E3o pode ser chamado no XPathResult da express\u00E3o XPath ''{0}'' porque seu XPathResultType \u00E9 {1}. Este m\u00E9todo se aplica somente a tipos UNORDERED_NODE_SNAPSHOT_TYPE e ORDERED_NODE_SNAPSHOT_TYPE."</span><span class="o">},</span></span>
...
<span id="LC699" class="line" lang="java">       <span class="s">"O m\u00E9todo iterateNext n\u00E3o pode ser chamado no XPathResult da express\u00E3o XPath ''{0}'' porque seu XPathResultType \u00E9 {1}. Este m\u00E9todo se aplica somente a tipos UNORDERED_NODE_ITERATOR_TYPE e ORDERED_NODE_ITERATOR_TYPE."</span><span class="o">},</span></span>
...
<span id="LC705" class="line" lang="java">       <span class="s">"Documento alterado desde que o resultado foi devolvido. O iterador \u00E9 inv\u00E1lido."</span><span class="o">},</span></span>
...
<span id="LC708" class="line" lang="java">       <span class="s">"Argumento de tipo XPath inv\u00E1lido: {0}"</span><span class="o">},</span></span>
...
<span id="LC711" class="line" lang="java">       <span class="s">"Objeto de resultado de XPath vazio"</span><span class="o">},</span></span>
...
<span id="LC714" class="line" lang="java">       <span class="s">"O XPathResult da express\u00E3o XPath ''{0}'' tem um XPathResultType {1} que n\u00E3o pode estar delimitado no XPathResultType especificado {2}."</span><span class="o">},</span></span>
...
<span id="LC717" class="line" lang="java">       <span class="s">"N\u00E3o \u00E9 poss\u00EDvel resolver o prefixo com solucionador de prefixo nulo."</span><span class="o">},</span></span>
...
<span id="LC723" class="line" lang="java">       <span class="s">"O XPathResult da express\u00E3o XPath ''{0}'' tem um XPathResultType {1} que n\u00E3o pode ser convertido em string."</span><span class="o">},</span></span>
...
<span id="LC728" class="line" lang="java">       <span class="s">"O m\u00E9todo snapshotItem n\u00E3o pode ser chamado no XPathResult da express\u00E3o XPath ''{0}'' porque seu XPathResultType \u00E9 {1}. Este m\u00E9todo se aplica somente a tipos UNORDERED_NODE_SNAPSHOT_TYPE e ORDERED_NODE_SNAPSHOT_TYPE."</span><span class="o">},</span></span>
...
<span id="LC735" class="line" lang="java">       <span class="s">"O n\u00F3 de contexto n\u00E3o pertence ao documento que est\u00E1 vinculado a este XPathEvaluator."</span><span class="o">},</span></span>
...
<span id="LC740" class="line" lang="java">       <span class="s">"O tipo do n\u00F3 de contexto n\u00E3o \u00E9 suportado."</span><span class="o">},</span></span>
...
<span id="LC743" class="line" lang="java">       <span class="s">"Erro desconhecido no XPath."</span><span class="o">},</span></span>
...
<span id="LC746" class="line" lang="java">        <span class="s">"O XPathResult da express\u00E3o XPath ''{0}'' tem um XPathResultType {1} que n\u00E3o pode ser convertido em n\u00FAmero."</span><span class="o">},</span></span>
...
<span id="LC753" class="line" lang="java">       <span class="s">"Fun\u00E7\u00E3o de extens\u00E3o: ''{0}'' n\u00E3o pode ser chamado quando o recurso XMLConstants.FEATURE_SECURE_PROCESSING estiver definido como verdadeiro."</span><span class="o">},</span></span>
...
<span id="LC758" class="line" lang="java">       <span class="s">"resolveVariable da vari\u00E1vel {0} retornando nulo"</span><span class="o">},</span></span>
...
<span id="LC763" class="line" lang="java">       <span class="s">"Tipo de Retorno N\u00E3o Suportado : {0}"</span><span class="o">},</span></span>
...
<span id="LC768" class="line" lang="java">       <span class="s">"O Tipo de Origem e/ou Retorno n\u00E3o pode ser nulo"</span><span class="o">},</span></span>
...
<span id="LC773" class="line" lang="java">       <span class="s">"O Tipo de Origem e/ou Retorno n\u00E3o pode ser nulo"</span><span class="o">},</span></span>
...
<span id="LC778" class="line" lang="java">       <span class="s">"O argumento {0} n\u00E3o pode ser nulo"</span><span class="o">},</span></span>
...
<span id="LC783" class="line" lang="java">       <span class="s">"{0}#isObjectModelSupported( String objectModel ) n\u00E3o pode ser chamado com objectModel == null"</span><span class="o">},</span></span>
...
<span id="LC788" class="line" lang="java">       <span class="s">"{0}#isObjectModelSupported( String objectModel ) n\u00E3o pode ser chamado com objectModel ==  \"\""</span><span class="o">},</span></span>
...
<span id="LC793" class="line" lang="java">       <span class="s">"Tentativa de definir um recurso com um nome nulo: {0}#setFeature( null, {1})"</span><span class="o">},</span></span>
...
<span id="LC798" class="line" lang="java">       <span class="s">"Tentativa de definir o recurso desconhecido \"{0}\":{1}#setFeature({0},{2})"</span><span class="o">},</span></span>
...
<span id="LC803" class="line" lang="java">       <span class="s">"Tentativa de obter um recurso com um nome nulo: {0}#getFeature(null)"</span><span class="o">},</span></span>
...
<span id="LC808" class="line" lang="java">       <span class="s">"Tentativa de obter o recurso desconhecido \"{0}\":{1}#getFeature({0})"</span><span class="o">},</span></span>
...
<span id="LC811" class="line" lang="java">        <span class="s">"FEATURE_SECURE_PROCESSING: N\u00E3o \u00E9 poss\u00EDvel definir o recurso como falso quando o gerenciador de seguran\u00E7a est\u00E1 presente: {1}#setFeature({0},{2})"</span><span class="o">},</span></span>
...
<span id="LC816" class="line" lang="java">       <span class="s">"Tentativa de definir um XPathFunctionResolver nulo:{0}#setXPathFunctionResolver(null)"</span><span class="o">},</span></span>
...
<span id="LC821" class="line" lang="java">       <span class="s">"Tentativa de definir um XPathVariableResolver nulo:{0}#setXPathVariableResolver(null)"</span><span class="o">},</span></span>
...
<span id="LC828" class="line" lang="java">      <span class="s">"nome das configura\u00E7\u00F5es regionais na fun\u00E7\u00E3o format-number ainda n\u00E3o tratado!"</span><span class="o">},</span></span>
...
<span id="LC831" class="line" lang="java">      <span class="s">"Propriedade XSL n\u00E3o suportada: {0}"</span><span class="o">},</span></span>
...
<span id="LC834" class="line" lang="java">      <span class="s">"Nenhuma a\u00E7\u00E3o a ser tomada com o namespace {0} na propriedade: {1}"</span><span class="o">},</span></span>
...
<span id="LC837" class="line" lang="java">      <span class="s">"SecurityException ao tentar acessar a propriedade de sistema XSL: {0}"</span><span class="o">},</span></span>
...
<span id="LC840" class="line" lang="java">      <span class="s">"Sintaxe antiga: quo(...) n\u00E3o est\u00E1 mais definido no XPath."</span><span class="o">},</span></span>
...
<span id="LC843" class="line" lang="java">      <span class="s">"XPath requer um objeto derivado para implementar nodeTest!"</span><span class="o">},</span></span>
...
<span id="LC846" class="line" lang="java">      <span class="s">"token da fun\u00E7\u00E3o n\u00E3o encontrado."</span><span class="o">},</span></span>
...
<span id="LC849" class="line" lang="java">      <span class="s">"N\u00E3o foi poss\u00EDvel localizar a fun\u00E7\u00E3o: {0}"</span><span class="o">},</span></span>
...
<span id="LC852" class="line" lang="java">      <span class="s">"N\u00E3o \u00E9 poss\u00EDvel criar o URL de: {0}"</span><span class="o">},</span></span>
...
<span id="LC855" class="line" lang="java">      <span class="s">"Op\u00E7\u00E3o -E n\u00E3o suportada para o parser DTM"</span><span class="o">},</span></span>
...
<span id="LC858" class="line" lang="java">      <span class="s">"VariableReference fornecida para a vari\u00E1vel fora do contexto ou sem defini\u00E7\u00E3o! Nome = {0}"</span><span class="o">},</span></span>
...
<span id="LC861" class="line" lang="java">     <span class="s">"Codifica\u00E7\u00E3o n\u00E3o suportada: {0}"</span><span class="o">},</span></span>
...
<span id="LC866" class="line" lang="java">  <span class="o">{</span> <span class="s">"ui_language"</span><span class="o">,</span> <span class="s">"pt-BR"</span><span class="o">},</span></span>
<span id="LC867" class="line" lang="java">  <span class="o">{</span> <span class="s">"help_language"</span><span class="o">,</span> <span class="s">"pt-BR"</span><span class="o">},</span></span>
<span id="LC868" class="line" lang="java">  <span class="o">{</span> <span class="s">"language"</span><span class="o">,</span> <span class="s">"pt-BR"</span><span class="o">},</span></span>
<span id="LC869" class="line" lang="java">  <span class="o">{</span> <span class="s">"BAD_CODE"</span><span class="o">,</span> <span class="s">"O par\u00E2metro para createMessage estava fora dos limites"</span><span class="o">},</span></span>
<span id="LC870" class="line" lang="java">  <span class="o">{</span> <span class="s">"FORMAT_FAILED"</span><span class="o">,</span> <span class="s">"Exce\u00E7\u00E3o gerada durante a chamada messageFormat"</span><span class="o">},</span></span>
<span id="LC871" class="line" lang="java">  <span class="o">{</span> <span class="s">"version"</span><span class="o">,</span> <span class="s">"&gt;&gt;&gt;&gt;&gt;&gt;&gt; Vers\u00E3o do Xalan "</span><span class="o">},</span></span>
...
<span id="LC873" class="line" lang="java">  <span class="o">{</span> <span class="s">"yes"</span><span class="o">,</span> <span class="s">"sim"</span><span class="o">},</span></span>
<span id="LC874" class="line" lang="java">  <span class="o">{</span> <span class="s">"line"</span><span class="o">,</span> <span class="s">"N\u00B0 da Linha"</span><span class="o">},</span></span>
<span id="LC875" class="line" lang="java">  <span class="o">{</span> <span class="s">"column"</span><span class="o">,</span> <span class="s">"N\u00B0 da Coluna"</span><span class="o">},</span></span>
<span id="LC876" class="line" lang="java">  <span class="o">{</span> <span class="s">"xsldone"</span><span class="o">,</span> <span class="s">"XSLProcessor: conclu\u00EDdo"</span><span class="o">},</span></span>
<span id="LC877" class="line" lang="java">  <span class="o">{</span> <span class="s">"xpath_option"</span><span class="o">,</span> <span class="s">"op\u00E7\u00F5es de xpath: "</span><span class="o">},</span></span>
...
<span id="LC880" class="line" lang="java">  <span class="o">{</span> <span class="s">"optionMatch"</span><span class="o">,</span> <span class="s">"   [-match match pattern (para diagn\u00F3sticos correspondentes)]"</span><span class="o">},</span></span>
<span id="LC881" class="line" lang="java">  <span class="o">{</span> <span class="s">"optionAnyExpr"</span><span class="o">,</span> <span class="s">"Ou apenas uma express\u00E3o xpath far\u00E1 uma elimina\u00E7\u00E3o de diagn\u00F3sticos"</span><span class="o">},</span></span>
<span id="LC882" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg1"</span><span class="o">,</span> <span class="s">"Processo XSL malsucedido."</span><span class="o">},</span></span>
<span id="LC883" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg2"</span><span class="o">,</span> <span class="s">"** N\u00E3o foi poss\u00EDvel localizar o parser **"</span><span class="o">},</span></span>
<span id="LC884" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg3"</span><span class="o">,</span> <span class="s">"Verifique seu classpath."</span><span class="o">},</span></span>
<span id="LC885" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg4"</span><span class="o">,</span> <span class="s">"Se voc\u00EA n\u00E3o tiver um Parser XML da IBM para Java, poder\u00E1 fazer download dele em"</span><span class="o">},</span></span>
<span id="LC886" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg5"</span><span class="o">,</span> <span class="s">"AlphaWorks da IBM: http://www.alphaworks.ibm.com/formula/xml"</span><span class="o">},</span></span>
