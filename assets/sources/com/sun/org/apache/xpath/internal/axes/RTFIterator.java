...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: RTFIterator.java,v 1.2.4.1 2005/09/14 19:45:16 jeffsuttor Exp $</span></span>
<span id="LC22" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC23" class="line" lang="java"></span>
<span id="LC24" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC25" class="line" lang="java"><span class="cm"> * This class implements an RTF Iterator. Currently exists for sole</span></span>
<span id="LC26" class="line" lang="java"><span class="cm"> * purpose of enabling EXSLT object-type function to return "RTF".</span></span>
...
<span id="LC30" class="line" lang="java"><span class="kn">package</span> <span class="nn">com.sun.org.apache.xpath.internal.axes</span><span class="o">;</span></span>
...
<span id="LC35" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">RTFIterator</span> <span class="kd">extends</span> <span class="nc">NodeSetDTM</span> <span class="o">{</span></span>
<span id="LC36" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="mi">7658117366258528996L</span><span class="o">;</span></span>
<span id="LC37" class="line" lang="java"></span>
<span id="LC38" class="line" lang="java">        <span class="cm">/**</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">         * Constructor for RTFIterator</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC41" class="line" lang="java">        <span class="kd">public</span> <span class="nf">RTFIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">root</span><span class="o">,</span> <span class="nc">DTMManager</span> <span class="n">manager</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC42" class="line" lang="java">                <span class="kd">super</span><span class="o">(</span><span class="n">root</span><span class="o">,</span> <span class="n">manager</span><span class="o">);</span></span>
