...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: XPathVisitable.java,v 1.1.2.1 2005/08/01 01:30:13 jeffsuttor Exp $</span></span>
...
<span id="LC26" class="line" lang="java"><span class="cm"> * A class that implements this interface will call a XPathVisitor</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * for itself and members within it's heararchy.  If the XPathVisitor's</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> * method returns false, the sub-member heararchy will not be</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> * traversed.</span></span>
<span id="LC30" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC31" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">XPathVisitable</span></span>
<span id="LC32" class="line" lang="java"><span class="o">{</span></span>
<span id="LC33" class="line" lang="java">        <span class="cm">/**</span></span>
<span id="LC34" class="line" lang="java"><span class="cm">         * This will traverse the heararchy, calling the visitor for</span></span>
<span id="LC35" class="line" lang="java"><span class="cm">         * each member.  If the called visitor method returns</span></span>
<span id="LC36" class="line" lang="java"><span class="cm">         * false, the subtree should not be called.</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC38" class="line" lang="java"><span class="cm">         * @param owner The owner of the visitor, where that path may be</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">         *              rewritten if needed.</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">         * @param visitor The visitor whose appropriate method will be called.</span></span>
<span id="LC41" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC42" class="line" lang="java">        <span class="kd">public</span> <span class="kt">void</span> <span class="nf">callVisitors</span><span class="o">(</span><span class="nc">ExpressionOwner</span> <span class="n">owner</span><span class="o">,</span> <span class="nc">XPathVisitor</span> <span class="n">visitor</span><span class="o">);</span></span>
