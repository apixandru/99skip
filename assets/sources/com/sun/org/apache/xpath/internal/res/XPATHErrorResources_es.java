...
<span id="LC34" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XPATHErrorResources_es</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span></span>
...
<span id="LC361" class="line" lang="java">  <span class="o">{</span> <span class="no">ER_CURRENT_NOT_ALLOWED_IN_MATCH</span><span class="o">,</span> <span class="s">"La funci\u00F3n current() no est\u00E1 permitida en un patr\u00F3n de coincidencia."</span> <span class="o">},</span></span>
<span id="LC362" class="line" lang="java"></span>
<span id="LC363" class="line" lang="java">  <span class="o">{</span> <span class="no">ER_CURRENT_TAKES_NO_ARGS</span><span class="o">,</span> <span class="s">"La funci\u00F3n current() no acepta argumentos."</span> <span class="o">},</span></span>
...
<span id="LC366" class="line" lang="java">      <span class="s">"La implantaci\u00F3n de la funci\u00F3n document() se ha sustituido por com.sun.org.apache.xalan.internal.xslt.FuncDocument!"</span><span class="o">},</span></span>
...
<span id="LC369" class="line" lang="java">      <span class="s">"El contexto no tiene un documento de propietario."</span><span class="o">},</span></span>
...
<span id="LC372" class="line" lang="java">      <span class="s">"local-name() tiene demasiados argumentos."</span><span class="o">},</span></span>
...
<span id="LC375" class="line" lang="java">      <span class="s">"namespace-uri() tiene demasiados argumentos."</span><span class="o">},</span></span>
...
<span id="LC378" class="line" lang="java">      <span class="s">"normalize-space() tiene demasiados argumentos."</span><span class="o">},</span></span>
...
<span id="LC381" class="line" lang="java">      <span class="s">"number() tiene demasiados argumentos."</span><span class="o">},</span></span>
...
<span id="LC384" class="line" lang="java">     <span class="s">"name() tiene demasiados argumentos."</span><span class="o">},</span></span>
...
<span id="LC387" class="line" lang="java">      <span class="s">"string() tiene demasiados argumentos."</span><span class="o">},</span></span>
...
<span id="LC390" class="line" lang="java">      <span class="s">"string-length() tiene demasiados argumentos."</span><span class="o">},</span></span>
...
<span id="LC393" class="line" lang="java">      <span class="s">"La funci\u00F3n translate() necesita tres argumentos."</span><span class="o">},</span></span>
...
<span id="LC396" class="line" lang="java">      <span class="s">"La funci\u00F3n unparsed-entity-uri necesita un argumento."</span><span class="o">},</span></span>
...
<span id="LC399" class="line" lang="java">      <span class="s">"El eje de espacio de nombres no se ha implantado a\u00FAn."</span><span class="o">},</span></span>
...
<span id="LC402" class="line" lang="java">     <span class="s">"eje desconocido: {0}"</span><span class="o">},</span></span>
...
<span id="LC405" class="line" lang="java">     <span class="s">"Operaci\u00F3n de coincidencia desconocida."</span><span class="o">},</span></span>
...
<span id="LC408" class="line" lang="java">      <span class="s">"La longitud del argumento de la prueba del nodo processing-instruction() es incorrecta."</span><span class="o">},</span></span>
...
<span id="LC411" class="line" lang="java">      <span class="s">"No se puede convertir {0} en un n\u00FAmero"</span><span class="o">},</span></span>
...
<span id="LC414" class="line" lang="java">      <span class="s">"No se puede convertir {0} en una lista de nodos."</span><span class="o">},</span></span>
...
<span id="LC417" class="line" lang="java">      <span class="s">"No se puede convertir {0} en un DTM de juego de nodos."</span><span class="o">},</span></span>
...
<span id="LC420" class="line" lang="java">      <span class="s">"No se puede convertir {0} en el n\u00FAmero de tipo {1}"</span><span class="o">},</span></span>
...
<span id="LC423" class="line" lang="java">      <span class="s">"Patr\u00F3n de coincidencia esperado en getMatchScore."</span><span class="o">},</span></span>
...
<span id="LC426" class="line" lang="java">      <span class="s">"No se ha encontrado la variable llamada {0}"</span><span class="o">},</span></span>
...
<span id="LC429" class="line" lang="java">     <span class="s">"ERROR. C\u00F3digo de operaci\u00F3n desconocido: {0}"</span><span class="o">},</span></span>
...
<span id="LC432" class="line" lang="java">     <span class="s">"Tokens no permitidos adicionales: {0}"</span><span class="o">},</span></span>
...
<span id="LC435" class="line" lang="java">      <span class="s">"literal con comillas incorrectas... se esperaban comillas dobles"</span><span class="o">},</span></span>
...
<span id="LC438" class="line" lang="java">      <span class="s">"literal con comillas incorrectas... se esperaban comillas simples"</span><span class="o">},</span></span>
...
<span id="LC441" class="line" lang="java">     <span class="s">"Expresi\u00F3n vac\u00EDa"</span><span class="o">},</span></span>
...
<span id="LC444" class="line" lang="java">     <span class="s">"Se esperaba {0} pero se ha encontrado: {1}"</span><span class="o">},</span></span>
...
<span id="LC447" class="line" lang="java">      <span class="s">"La afirmaci\u00F3n del programador es incorrecta - {0}"</span><span class="o">},</span></span>
...
<span id="LC450" class="line" lang="java">      <span class="s">"El argumento boolean(...) ya no es opcional con el borrador de XPath 19990709."</span><span class="o">},</span></span>
...
<span id="LC453" class="line" lang="java">      <span class="s">"Se han encontrado ',' pero no va seguido de ning\u00FAn argumento"</span><span class="o">},</span></span>
...
<span id="LC456" class="line" lang="java">      <span class="s">"Se han encontrado ',' pero no le sigue ning\u00FAn argumento"</span><span class="o">},</span></span>
...
<span id="LC459" class="line" lang="java">      <span class="s">"'..[predicate]' o '.[predicate]' es una sintaxis no v\u00E1lida. Utilice 'self::node()[predicate]' en su lugar."</span><span class="o">},</span></span>
...
<span id="LC462" class="line" lang="java">     <span class="s">"nombre de eje no permitido: {0}"</span><span class="o">},</span></span>
...
<span id="LC465" class="line" lang="java">     <span class="s">"Tipo de nodo desconocido: {0}"</span><span class="o">},</span></span>
...
<span id="LC468" class="line" lang="java">      <span class="s">"El patr\u00F3n literal ({0}) debe incluirse entre comillas"</span><span class="o">},</span></span>
...
<span id="LC471" class="line" lang="java">      <span class="s">"{0} no se ha podido formatear en un n\u00FAmero."</span><span class="o">},</span></span>
...
<span id="LC474" class="line" lang="java">      <span class="s">"No se ha podido crear el enlace TransformerFactory XML: {0}"</span><span class="o">},</span></span>
...
<span id="LC477" class="line" lang="java">      <span class="s">"Error. No se ha encontrado la expresi\u00F3n de selecci\u00F3n xpath (-select)."</span><span class="o">},</span></span>
...
<span id="LC480" class="line" lang="java">      <span class="s">"ERROR. No se ha encontrado ENDOP despu\u00E9s de OP_LOCATIONPATH"</span><span class="o">},</span></span>
...
<span id="LC483" class="line" lang="java">     <span class="s">"Se ha producido un error."</span><span class="o">},</span></span>
...
<span id="LC486" class="line" lang="java">      <span class="s">"La referencia de variable proporcionada para la variable est\u00E1 fuera de contexto o no tiene definici\u00F3n. Nombre = {0}"</span><span class="o">},</span></span>
...
<span id="LC489" class="line" lang="java">      <span class="s">"S\u00F3lo los ejes child:: y attribute:: est\u00E1n permitidos en los patrones de coincidencia. Ejes incorrectos = {0}"</span><span class="o">},</span></span>
...
<span id="LC492" class="line" lang="java">      <span class="s">"key() tiene un n\u00FAmero incorrecto de argumentos."</span><span class="o">},</span></span>
...
<span id="LC495" class="line" lang="java">      <span class="s">"La funci\u00F3n count necesita un argumento."</span><span class="o">},</span></span>
...
<span id="LC498" class="line" lang="java">     <span class="s">"No se ha encontrado la funci\u00F3n: {0}"</span><span class="o">},</span></span>
...
<span id="LC501" class="line" lang="java">     <span class="s">"Codificaci\u00F3n no soportada: {0}"</span><span class="o">},</span></span>
...
<span id="LC504" class="line" lang="java">      <span class="s">"Se ha producido un problema en DTM en getNextSibling... intentando la recuperaci\u00F3n"</span><span class="o">},</span></span>
...
<span id="LC507" class="line" lang="java">      <span class="s">"Error de programador: no se puede escribir en EmptyNodeList."</span><span class="o">},</span></span>
...
<span id="LC510" class="line" lang="java">      <span class="s">"setDOMFactory no est\u00E1 soportado por XPathContext."</span><span class="o">},</span></span>
...
<span id="LC513" class="line" lang="java">      <span class="s">"El prefijo se debe resolver en un espacio de nombres: {0}"</span><span class="o">},</span></span>
...
<span id="LC516" class="line" lang="java">      <span class="s">"El an\u00E1lisis (origen de InputSource) no est\u00E1 soportado en XPathContext. No se puede abrir {0}"</span><span class="o">},</span></span>
...
<span id="LC519" class="line" lang="java">      <span class="s">"Los caracteres de API SAX (char ch[]... no los gestiona el DTM."</span><span class="o">},</span></span>
...
<span id="LC522" class="line" lang="java">      <span class="s">"ignorableWhitespace(char ch[]... no gestionado por DTM."</span><span class="o">},</span></span>
...
<span id="LC525" class="line" lang="java">      <span class="s">"DTMLiaison no puede gestionar los nodos de tipo {0}"</span><span class="o">},</span></span>
...
<span id="LC528" class="line" lang="java">      <span class="s">"DOM2Helper no puede gestionar los nodos de tipo {0}"</span><span class="o">},</span></span>
...
<span id="LC531" class="line" lang="java">      <span class="s">"Error de DOM2Helper.parse: identificador de sistema - {0} l\u00EDnea - {1}"</span><span class="o">},</span></span>
...
<span id="LC534" class="line" lang="java">     <span class="s">"Error de DOM2Helper.parse"</span><span class="o">},</span></span>
...
<span id="LC537" class="line" lang="java">      <span class="s">"\u00BFSe ha detectado un sustituto UTF-16 no v\u00E1lido: {0}?"</span><span class="o">},</span></span>
...
<span id="LC540" class="line" lang="java">     <span class="s">"Error de ES"</span><span class="o">},</span></span>
...
<span id="LC543" class="line" lang="java">     <span class="s">"No se puede crear la URL para: {0}"</span><span class="o">},</span></span>
...
<span id="LC546" class="line" lang="java">     <span class="s">"En XPath.readObject: {0}"</span><span class="o">},</span></span>
...
<span id="LC549" class="line" lang="java">      <span class="s">"No se ha encontrado el token de funci\u00F3n."</span><span class="o">},</span></span>
...
<span id="LC552" class="line" lang="java">       <span class="s">"No se puede negociar con el tipo de XPath: {0}"</span><span class="o">},</span></span>
...
<span id="LC555" class="line" lang="java">       <span class="s">"Este juego de nodos no es modificable"</span><span class="o">},</span></span>
...
<span id="LC558" class="line" lang="java">       <span class="s">"Este DTM de juego de nodos no es modificable"</span><span class="o">},</span></span>
...
<span id="LC561" class="line" lang="java">        <span class="s">"La variable no se puede resolver: {0}"</span><span class="o">},</span></span>
...
<span id="LC564" class="line" lang="java">        <span class="s">"Manejador de errores nulo"</span><span class="o">},</span></span>
...
<span id="LC567" class="line" lang="java">       <span class="s">"Afirmaci\u00F3n del programador: c\u00F3digo de operaci\u00F3n desconocido: {0}"</span><span class="o">},</span></span>
...
<span id="LC570" class="line" lang="java">       <span class="s">"0 o 1"</span><span class="o">},</span></span>
...
<span id="LC573" class="line" lang="java">       <span class="s">"rtf() no soportado por XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC576" class="line" lang="java">       <span class="s">"asNodeIterator() no soportado por XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC580" class="line" lang="java">                <span class="s">"detach() no soportado por XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC584" class="line" lang="java">                <span class="s">"num() no soportado por XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC588" class="line" lang="java">                <span class="s">"xstr() no soportado por XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC592" class="line" lang="java">                <span class="s">"str() no soportado por XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC595" class="line" lang="java">       <span class="s">"fsb() no soportado para XStringForChars"</span><span class="o">},</span></span>
...
<span id="LC598" class="line" lang="java">      <span class="s">"No se ha encontrado la variable con el nombre de {0}"</span><span class="o">},</span></span>
...
<span id="LC601" class="line" lang="java">      <span class="s">"XStringForChars no puede utilizar una cadena para un argumento"</span><span class="o">},</span></span>
...
<span id="LC604" class="line" lang="java">      <span class="s">"El argumento FastStringBuffer no puede ser nulo"</span><span class="o">},</span></span>
...
<span id="LC607" class="line" lang="java">       <span class="s">"2 o 3"</span><span class="o">},</span></span>
...
<span id="LC610" class="line" lang="java">       <span class="s">"Se ha accedido a la variable antes de que se haya enlazado."</span><span class="o">},</span></span>
...
<span id="LC613" class="line" lang="java">       <span class="s">"XStringForFSB no puede utilizar una cadena para un argumento."</span><span class="o">},</span></span>
...
<span id="LC616" class="line" lang="java">       <span class="s">"\n Error. Definici\u00F3n de una ra\u00EDz de un walker como nula."</span><span class="o">},</span></span>
...
<span id="LC619" class="line" lang="java">       <span class="s">"Este DTM de juego de nodos no puede iterarse en un nodo anterior."</span><span class="o">},</span></span>
...
<span id="LC622" class="line" lang="java">       <span class="s">"Este juego de nodos no se puede iterar en un nodo anterior."</span><span class="o">},</span></span>
...
<span id="LC625" class="line" lang="java">       <span class="s">"Este DTM de juego de nodos no puede realizar funciones de indexaci\u00F3n o recuento."</span><span class="o">},</span></span>
...
<span id="LC628" class="line" lang="java">       <span class="s">"Este juego de nodos no puede realizar funciones de indexaci\u00F3n o recuento."</span><span class="o">},</span></span>
...
<span id="LC631" class="line" lang="java">       <span class="s">"No se puede llamar a setShouldCacheNodes despu\u00E9s de haber llamado a nextNode."</span><span class="o">},</span></span>
...
<span id="LC634" class="line" lang="java">       <span class="s">"{0} s\u00F3lo permite {1} argumentos"</span><span class="o">},</span></span>
...
<span id="LC637" class="line" lang="java">       <span class="s">"Afirmaci\u00F3n del programador en getNextStepPos: tipo de paso desconocido: {0}"</span><span class="o">},</span></span>
...
<span id="LC643" class="line" lang="java">      <span class="s">"Se esperaba una ruta de acceso de ubicaci\u00F3n relativa despu\u00E9s del token '/' o '//'."</span><span class="o">},</span></span>
...
<span id="LC649" class="line" lang="java">       <span class="s">"Se esperaba una ruta de acceso de ubicaci\u00F3n, pero se ha encontrado el siguiente token: {0}"</span><span class="o">},</span></span>
...
<span id="LC655" class="line" lang="java">       <span class="s">"Se esperaba una ruta de acceso de ubicaci\u00F3n, pero se ha encontrado el final de la expresi\u00F3n XPath en su lugar."</span><span class="o">},</span></span>
...
<span id="LC661" class="line" lang="java">       <span class="s">"Se esperaba un paso de ubicaci\u00F3n despu\u00E9s del token '/' o '//'."</span><span class="o">},</span></span>
...
<span id="LC668" class="line" lang="java">       <span class="s">"Se esperaba una prueba de nodo que coincidiera con el NCName:* o QName."</span><span class="o">},</span></span>
...
<span id="LC674" class="line" lang="java">       <span class="s">"Se esperaba un patr\u00F3n de paso, pero se ha encontrado '/'."</span><span class="o">},</span></span>
...
<span id="LC680" class="line" lang="java">       <span class="s">"Se esperaba un patr\u00F3n de ruta de acceso relativa."</span><span class="o">},</span></span>
...
<span id="LC686" class="line" lang="java">       <span class="s">"El valor de XPathResult de la expresi\u00F3n XPath ''{0}'' tiene un valor de XPathResultType de {1} que no se puede convertir en un valor booleano."</span><span class="o">},</span></span>
...
<span id="LC691" class="line" lang="java">       <span class="s">"El valor de XPathResult de la expresi\u00F3n XPath ''{0}'' tiene un valor de XPathResultType de {1} que no se puede convertir a un nodo \u00FAnico. El m\u00E9todo getSingleNodeValue se aplica s\u00F3lo a los tipos ANY_UNORDERED_NODE_TYPE y FIRST_ORDERED_NODE_TYPE."</span><span class="o">},</span></span>
...
<span id="LC696" class="line" lang="java">       <span class="s">"No se puede llamar al m\u00E9todo getSnapshotLength en la expresi\u00F3n XPathResult de XPath ''{0}'' porque el valor de su XPathResultType es {1}. Este m\u00E9todo se aplica s\u00F3lo a los tipos UNORDERED_NODE_SNAPSHOT_TYPE y ORDERED_NODE_SNAPSHOT_TYPE."</span><span class="o">},</span></span>
...
<span id="LC699" class="line" lang="java">       <span class="s">"No se puede llamar al m\u00E9todo iterateNext en el XPathResult de la expresi\u00F3n XPath ''{0}'' porque el valor de su XPathResultType es {1}. Este m\u00E9todo se aplica s\u00F3lo a los tipos UNORDERED_NODE_ITERATOR_TYPE y ORDERED_NODE_ITERATOR_TYPE."</span><span class="o">},</span></span>
...
<span id="LC705" class="line" lang="java">       <span class="s">"Documento mutado debido a que se ha devuelto el resultado. El iterador no es v\u00E1lido."</span><span class="o">},</span></span>
...
<span id="LC708" class="line" lang="java">       <span class="s">"Argumento de tipo XPath no v\u00E1lido: {0}"</span><span class="o">},</span></span>
...
<span id="LC711" class="line" lang="java">       <span class="s">"Objeto de resultado XPath vac\u00EDo"</span><span class="o">},</span></span>
...
<span id="LC714" class="line" lang="java">       <span class="s">"El valor de XPathResult de la expresi\u00F3n XPath ''{0}'' tiene un valor de XPathResultType de {1} que no se puede forzar en el XPathResultType especificado de {2}."</span><span class="o">},</span></span>
...
<span id="LC717" class="line" lang="java">       <span class="s">"No se ha podido resolver el prefijo con el sistema de resoluci\u00F3n de prefijos nulo."</span><span class="o">},</span></span>
...
<span id="LC723" class="line" lang="java">       <span class="s">"El valor de XPathResult de la expresi\u00F3n XPath ''{0}'' tiene un valor de XPathResultType de {1} que no se puede convertir en una cadena."</span><span class="o">},</span></span>
...
<span id="LC728" class="line" lang="java">       <span class="s">"No se puede llamar al m\u00E9todo snapshotItem en la expresi\u00F3n XPathResult de XPath ''{0}'' porque el valor de su XPathResultType es {1}. Este m\u00E9todo se aplica s\u00F3lo a los tipos UNORDERED_NODE_SNAPSHOT_TYPE y ORDERED_NODE_SNAPSHOT_TYPE."</span><span class="o">},</span></span>
...
<span id="LC735" class="line" lang="java">       <span class="s">"El nodo de contexto no pertenece al documento que est\u00E1 enlazado a este XPathEvaluator."</span><span class="o">},</span></span>
...
<span id="LC740" class="line" lang="java">       <span class="s">"El tipo de nodo de contexto no est\u00E1 soportado."</span><span class="o">},</span></span>
...
<span id="LC743" class="line" lang="java">       <span class="s">"Error desconocido en XPath."</span><span class="o">},</span></span>
...
<span id="LC746" class="line" lang="java">        <span class="s">"El valor de XPathResult de la expresi\u00F3n XPath ''{0}'' tiene un valor de XPathResultType de {1} que no se puede convertir en un n\u00FAmero"</span><span class="o">},</span></span>
...
<span id="LC753" class="line" lang="java">       <span class="s">"Funci\u00F3n de extensi\u00F3n: no se puede llamar a ''{0}'' cuando la funci\u00F3n XMLConstants.FEATURE_SECURE_PROCESSING est\u00E1 definida en true."</span><span class="o">},</span></span>
...
<span id="LC758" class="line" lang="java">       <span class="s">"resolveVariable para la variable {0} devuelve un valor nulo"</span><span class="o">},</span></span>
...
<span id="LC763" class="line" lang="java">       <span class="s">"Tipo de retorno no soportado: {0}"</span><span class="o">},</span></span>
...
<span id="LC768" class="line" lang="java">       <span class="s">"El tipo de origen y/o retorno no puede ser nulo"</span><span class="o">},</span></span>
...
<span id="LC773" class="line" lang="java">       <span class="s">"El tipo de origen y/o retorno no puede ser nulo"</span><span class="o">},</span></span>
...
<span id="LC778" class="line" lang="java">       <span class="s">"El argumento {0} no puede ser nulo"</span><span class="o">},</span></span>
...
<span id="LC783" class="line" lang="java">       <span class="s">"{0}#isObjectModelSupported( Cadena objectModel ) no se puede llamar con objectModel == null"</span><span class="o">},</span></span>
...
<span id="LC788" class="line" lang="java">       <span class="s">"{0}#isObjectModelSupported( Cadena objectModel ) no se puede llamar con objectModel == \"\""</span><span class="o">},</span></span>
...
<span id="LC793" class="line" lang="java">       <span class="s">"Intentando definir una funci\u00F3n con un nombre nulo: {0}#setFeature( null, {1})"</span><span class="o">},</span></span>
...
<span id="LC798" class="line" lang="java">       <span class="s">"Intentando definir la funci\u00F3n desconocida \"{0}\":{1}#setFeature({0},{2})"</span><span class="o">},</span></span>
...
<span id="LC803" class="line" lang="java">       <span class="s">"Intentando obtener una funci\u00F3n con un nombre nulo: {0}#getFeature(null)"</span><span class="o">},</span></span>
...
<span id="LC808" class="line" lang="java">       <span class="s">"Intentando obtener la funci\u00F3n desconocida \"{0}\":{1}#getFeature({0})"</span><span class="o">},</span></span>
...
<span id="LC811" class="line" lang="java">        <span class="s">"FEATURE_SECURE_PROCESSING: no se puede definir la funci\u00F3n en false cuando est\u00E1 presente el gestor de seguridad: {1}#setFeature({0},{2})"</span><span class="o">},</span></span>
...
<span id="LC816" class="line" lang="java">       <span class="s">"Se est\u00E1 intentando definir un valor de XPathFunctionResolver nulo:{0}#setXPathFunctionResolver(null)"</span><span class="o">},</span></span>
...
<span id="LC821" class="line" lang="java">       <span class="s">"Se est\u00E1 intentando definir un valor XPathVariableResolver nulo:{0}#setXPathVariableResolver(null)"</span><span class="o">},</span></span>
...
<span id="LC828" class="line" lang="java">      <span class="s">"El nombre de la configuraci\u00F3n regional en la funci\u00F3n format-number no se ha manejado a\u00FAn."</span><span class="o">},</span></span>
...
<span id="LC831" class="line" lang="java">      <span class="s">"Propiedad XSL no soportada: {0}"</span><span class="o">},</span></span>
...
<span id="LC834" class="line" lang="java">      <span class="s">"No realice ninguna acci\u00F3n con el espacio de nombres {0} en la propiedad: {1}"</span><span class="o">},</span></span>
...
<span id="LC837" class="line" lang="java">      <span class="s">"Excepci\u00F3n de seguridad al intentar acceder a la propiedad del sistema XSL: {0}"</span><span class="o">},</span></span>
...
<span id="LC840" class="line" lang="java">      <span class="s">"Sintaxis anterior: quo(...) ya no se define en XPath."</span><span class="o">},</span></span>
...
<span id="LC843" class="line" lang="java">      <span class="s">"XPath necesita un objeto derivado para implantar una prueba de nodo."</span><span class="o">},</span></span>
...
<span id="LC846" class="line" lang="java">      <span class="s">"No se ha encontrado el token de funci\u00F3n."</span><span class="o">},</span></span>
...
<span id="LC849" class="line" lang="java">      <span class="s">"No se ha encontrado la funci\u00F3n: {0}"</span><span class="o">},</span></span>
...
<span id="LC852" class="line" lang="java">      <span class="s">"No se puede crear la URL desde: {0}"</span><span class="o">},</span></span>
...
<span id="LC855" class="line" lang="java">      <span class="s">"Opci\u00F3n -E no soportada para el analizador DTM"</span><span class="o">},</span></span>
...
<span id="LC858" class="line" lang="java">      <span class="s">"La referencia de variable proporcionada para la variable est\u00E1 fuera de contexto o no tiene definici\u00F3n. Nombre = {0}"</span><span class="o">},</span></span>
...
<span id="LC861" class="line" lang="java">     <span class="s">"Codificaci\u00F3n no soportada: {0}"</span><span class="o">},</span></span>
...
<span id="LC866" class="line" lang="java">  <span class="o">{</span> <span class="s">"ui_language"</span><span class="o">,</span> <span class="s">"es"</span><span class="o">},</span></span>
<span id="LC867" class="line" lang="java">  <span class="o">{</span> <span class="s">"help_language"</span><span class="o">,</span> <span class="s">"es"</span><span class="o">},</span></span>
<span id="LC868" class="line" lang="java">  <span class="o">{</span> <span class="s">"language"</span><span class="o">,</span> <span class="s">"es"</span><span class="o">},</span></span>
<span id="LC869" class="line" lang="java">  <span class="o">{</span> <span class="s">"BAD_CODE"</span><span class="o">,</span> <span class="s">"El par\u00E1metro para crear un mensaje est\u00E1 fuera de los l\u00EDmites"</span><span class="o">},</span></span>
<span id="LC870" class="line" lang="java">  <span class="o">{</span> <span class="s">"FORMAT_FAILED"</span><span class="o">,</span> <span class="s">"Se ha emitido una excepci\u00F3n durante la llamada a messageFormat"</span><span class="o">},</span></span>
<span id="LC871" class="line" lang="java">  <span class="o">{</span> <span class="s">"version"</span><span class="o">,</span> <span class="s">"&gt;&gt;&gt;&gt;&gt;&gt;&gt; Versi\u00F3n Xalan "</span><span class="o">},</span></span>
...
<span id="LC873" class="line" lang="java">  <span class="o">{</span> <span class="s">"yes"</span><span class="o">,</span> <span class="s">"s\u00ED"</span><span class="o">},</span></span>
<span id="LC874" class="line" lang="java">  <span class="o">{</span> <span class="s">"line"</span><span class="o">,</span> <span class="s">"N\u00BA de L\u00EDnea"</span><span class="o">},</span></span>
<span id="LC875" class="line" lang="java">  <span class="o">{</span> <span class="s">"column"</span><span class="o">,</span> <span class="s">"N\u00BA de Columna"</span><span class="o">},</span></span>
<span id="LC876" class="line" lang="java">  <span class="o">{</span> <span class="s">"xsldone"</span><span class="o">,</span> <span class="s">"XSLProcessor: listo"</span><span class="o">},</span></span>
<span id="LC877" class="line" lang="java">  <span class="o">{</span> <span class="s">"xpath_option"</span><span class="o">,</span> <span class="s">"Opciones de xpath: "</span><span class="o">},</span></span>
...
<span id="LC879" class="line" lang="java">  <span class="o">{</span> <span class="s">"optionSelect"</span><span class="o">,</span> <span class="s">"   [-select expresi\u00F3n xpath]"</span><span class="o">},</span></span>
<span id="LC880" class="line" lang="java">  <span class="o">{</span> <span class="s">"optionMatch"</span><span class="o">,</span> <span class="s">"   [-match patr\u00F3n de coincidencia (para diagn\u00F3sticos de coincidencia)]"</span><span class="o">},</span></span>
<span id="LC881" class="line" lang="java">  <span class="o">{</span> <span class="s">"optionAnyExpr"</span><span class="o">,</span> <span class="s">"O s\u00F3lo una expresi\u00F3n xpath realizar\u00E1 un volcado de diagn\u00F3stico"</span><span class="o">},</span></span>
<span id="LC882" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg1"</span><span class="o">,</span> <span class="s">"El proceso XSL no se ha realizado correctamente."</span><span class="o">},</span></span>
<span id="LC883" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg2"</span><span class="o">,</span> <span class="s">"** No se ha encontrado el analizador **"</span><span class="o">},</span></span>
<span id="LC884" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg3"</span><span class="o">,</span> <span class="s">"Compruebe la classpath."</span><span class="o">},</span></span>
<span id="LC885" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg4"</span><span class="o">,</span> <span class="s">"Si no tiene un analizador XML de IBM para Java, puede descargarlo de"</span><span class="o">},</span></span>
<span id="LC886" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg5"</span><span class="o">,</span> <span class="s">"AlphaWorks de IBM: http://www.alphaworks.ibm.com/formula/xml"</span><span class="o">},</span></span>
