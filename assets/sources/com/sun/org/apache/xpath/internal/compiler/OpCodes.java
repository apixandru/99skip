...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: OpCodes.java,v 1.1.2.1 2005/08/01 01:30:33 jeffsuttor Exp $</span></span>
...
<span id="LC26" class="line" lang="java"><span class="cm"> * Operations codes for XPath.</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> * Code for the descriptions of the operations codes:</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> * [UPPER CASE] indicates a literal value,</span></span>
<span id="LC30" class="line" lang="java"><span class="cm"> * [lower case] is a description of a value,</span></span>
<span id="LC31" class="line" lang="java"><span class="cm"> *      ([length] always indicates the length of the operation,</span></span>
<span id="LC32" class="line" lang="java"><span class="cm"> *       including the operations code and the length integer.)</span></span>
<span id="LC33" class="line" lang="java"><span class="cm"> * {UPPER CASE} indicates the given production,</span></span>
<span id="LC34" class="line" lang="java"><span class="cm"> * {description} is the description of a new production,</span></span>
<span id="LC35" class="line" lang="java"><span class="cm"> *      (For instance, {boolean expression} means some expression</span></span>
<span id="LC36" class="line" lang="java"><span class="cm"> *       that should be resolved to a boolean.)</span></span>
<span id="LC37" class="line" lang="java"><span class="cm"> *  * means that it occurs zero or more times,</span></span>
<span id="LC38" class="line" lang="java"><span class="cm"> *  + means that it occurs one or more times,</span></span>
<span id="LC39" class="line" lang="java"><span class="cm"> *  ? means that it is optional.</span></span>
<span id="LC40" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC41" class="line" lang="java"><span class="cm"> * returns: indicates what the production should return.</span></span>
<span id="LC42" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC43" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">OpCodes</span></span>
...
<span id="LC47" class="line" lang="java"><span class="cm">   * [ENDOP]</span></span>
<span id="LC48" class="line" lang="java"><span class="cm">   * Some operators may like to have a terminator.</span></span>
...
<span id="LC51" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">ENDOP</span> <span class="o">=</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC52" class="line" lang="java"></span>
<span id="LC53" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC54" class="line" lang="java"><span class="cm">   * [EMPTY]</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">   * Empty slot to indicate NULL.</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC57" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">EMPTY</span> <span class="o">=</span> <span class="o">-</span><span class="mi">2</span><span class="o">;</span></span>
<span id="LC58" class="line" lang="java"></span>
<span id="LC59" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC60" class="line" lang="java"><span class="cm">   * [ELEMWILDCARD]</span></span>
<span id="LC61" class="line" lang="java"><span class="cm">   * Means ELEMWILDCARD ("*"), used instead</span></span>
<span id="LC62" class="line" lang="java"><span class="cm">   * of string index in some places.</span></span>
<span id="LC63" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC64" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC65" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">ELEMWILDCARD</span> <span class="o">=</span> <span class="o">-</span><span class="mi">3</span><span class="o">;</span></span>
<span id="LC66" class="line" lang="java"></span>
<span id="LC67" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC68" class="line" lang="java"><span class="cm">   * [OP_XPATH]</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">   *  {expression}</span></span>
<span id="LC71" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC72" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC73" class="line" lang="java"><span class="cm">   *  XNodeSet</span></span>
<span id="LC74" class="line" lang="java"><span class="cm">   *  XNumber</span></span>
<span id="LC75" class="line" lang="java"><span class="cm">   *  XString</span></span>
<span id="LC76" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC77" class="line" lang="java"><span class="cm">   *  XRTree</span></span>
<span id="LC78" class="line" lang="java"><span class="cm">   *  XObject</span></span>
<span id="LC79" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC80" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC81" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_XPATH</span> <span class="o">=</span> <span class="mi">1</span><span class="o">;</span></span>
<span id="LC82" class="line" lang="java"></span>
<span id="LC83" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC84" class="line" lang="java"><span class="cm">   * [OP_OR]</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC86" class="line" lang="java"><span class="cm">   *  {boolean expression}</span></span>
<span id="LC87" class="line" lang="java"><span class="cm">   *  {boolean expression}</span></span>
<span id="LC88" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC93" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_OR</span> <span class="o">=</span> <span class="mi">2</span><span class="o">;</span></span>
<span id="LC94" class="line" lang="java"></span>
<span id="LC95" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC96" class="line" lang="java"><span class="cm">   * [OP_AND]</span></span>
<span id="LC97" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC98" class="line" lang="java"><span class="cm">   *  {boolean expression}</span></span>
<span id="LC99" class="line" lang="java"><span class="cm">   *  {boolean expression}</span></span>
<span id="LC100" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC103" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC104" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC105" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_AND</span> <span class="o">=</span> <span class="mi">3</span><span class="o">;</span></span>
<span id="LC106" class="line" lang="java"></span>
<span id="LC107" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">   * [OP_NOTEQUALS]</span></span>
<span id="LC109" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC110" class="line" lang="java"><span class="cm">   *  {expression}</span></span>
<span id="LC111" class="line" lang="java"><span class="cm">   *  {expression}</span></span>
<span id="LC112" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC113" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC114" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC115" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC116" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC117" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_NOTEQUALS</span> <span class="o">=</span> <span class="mi">4</span><span class="o">;</span></span>
<span id="LC118" class="line" lang="java"></span>
<span id="LC119" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC120" class="line" lang="java"><span class="cm">   * [OP_EQUALS]</span></span>
<span id="LC121" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC122" class="line" lang="java"><span class="cm">   *  {expression}</span></span>
<span id="LC123" class="line" lang="java"><span class="cm">   *  {expression}</span></span>
<span id="LC124" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC125" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC126" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC127" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC128" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC129" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_EQUALS</span> <span class="o">=</span> <span class="mi">5</span><span class="o">;</span></span>
<span id="LC130" class="line" lang="java"></span>
<span id="LC131" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC132" class="line" lang="java"><span class="cm">   * [OP_LTE] (less-than-or-equals)</span></span>
<span id="LC133" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC134" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC135" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC136" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC137" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC138" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC139" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC140" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC141" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_LTE</span> <span class="o">=</span> <span class="mi">6</span><span class="o">;</span></span>
<span id="LC142" class="line" lang="java"></span>
<span id="LC143" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC144" class="line" lang="java"><span class="cm">   * [OP_LT] (less-than)</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC147" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC148" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC149" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC150" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC151" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC152" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC153" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_LT</span> <span class="o">=</span> <span class="mi">7</span><span class="o">;</span></span>
<span id="LC154" class="line" lang="java"></span>
<span id="LC155" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC156" class="line" lang="java"><span class="cm">   * [OP_GTE] (greater-than-or-equals)</span></span>
<span id="LC157" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC158" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC159" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC160" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC161" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC162" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC163" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC164" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC165" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_GTE</span> <span class="o">=</span> <span class="mi">8</span><span class="o">;</span></span>
<span id="LC166" class="line" lang="java"></span>
<span id="LC167" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC168" class="line" lang="java"><span class="cm">   * [OP_GT] (greater-than)</span></span>
<span id="LC169" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC170" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC171" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC172" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC173" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC174" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC175" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC176" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC177" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_GT</span> <span class="o">=</span> <span class="mi">9</span><span class="o">;</span></span>
<span id="LC178" class="line" lang="java"></span>
<span id="LC179" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC180" class="line" lang="java"><span class="cm">   * [OP_PLUS]</span></span>
<span id="LC181" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC182" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC183" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC184" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC185" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC186" class="line" lang="java"><span class="cm">   *  XNumber</span></span>
<span id="LC187" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC188" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC189" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_PLUS</span> <span class="o">=</span> <span class="mi">10</span><span class="o">;</span></span>
<span id="LC190" class="line" lang="java"></span>
<span id="LC191" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC192" class="line" lang="java"><span class="cm">   * [OP_MINUS]</span></span>
<span id="LC193" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC194" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC195" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC196" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC197" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">   *  XNumber</span></span>
<span id="LC199" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC200" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC201" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_MINUS</span> <span class="o">=</span> <span class="mi">11</span><span class="o">;</span></span>
<span id="LC202" class="line" lang="java"></span>
<span id="LC203" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC204" class="line" lang="java"><span class="cm">   * [OP_MULT]</span></span>
<span id="LC205" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC206" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC207" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC208" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC209" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC210" class="line" lang="java"><span class="cm">   *  XNumber</span></span>
<span id="LC211" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC213" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_MULT</span> <span class="o">=</span> <span class="mi">12</span><span class="o">;</span></span>
<span id="LC214" class="line" lang="java"></span>
<span id="LC215" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC216" class="line" lang="java"><span class="cm">   * [OP_DIV]</span></span>
<span id="LC217" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC218" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC219" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC220" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC222" class="line" lang="java"><span class="cm">   *  XNumber</span></span>
<span id="LC223" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC224" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC225" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_DIV</span> <span class="o">=</span> <span class="mi">13</span><span class="o">;</span></span>
<span id="LC226" class="line" lang="java"></span>
<span id="LC227" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC228" class="line" lang="java"><span class="cm">   * [OP_MOD]</span></span>
<span id="LC229" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC230" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC231" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC232" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC233" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC234" class="line" lang="java"><span class="cm">   *  XNumber</span></span>
<span id="LC235" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC236" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC237" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_MOD</span> <span class="o">=</span> <span class="mi">14</span><span class="o">;</span></span>
<span id="LC238" class="line" lang="java"></span>
<span id="LC239" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC240" class="line" lang="java"><span class="cm">   * [OP_QUO]</span></span>
<span id="LC241" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC242" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC243" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC244" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC245" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC246" class="line" lang="java"><span class="cm">   *  XNumber</span></span>
<span id="LC247" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC248" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC249" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_QUO</span> <span class="o">=</span> <span class="mi">15</span><span class="o">;</span></span>
<span id="LC250" class="line" lang="java"></span>
<span id="LC251" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC252" class="line" lang="java"><span class="cm">   * [OP_NEG]</span></span>
<span id="LC253" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC254" class="line" lang="java"><span class="cm">   *  {number expression}</span></span>
<span id="LC255" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC256" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC257" class="line" lang="java"><span class="cm">   *  XNumber</span></span>
<span id="LC258" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC259" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC260" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_NEG</span> <span class="o">=</span> <span class="mi">16</span><span class="o">;</span></span>
<span id="LC261" class="line" lang="java"></span>
<span id="LC262" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC263" class="line" lang="java"><span class="cm">   * [OP_STRING] (cast operation)</span></span>
<span id="LC264" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC265" class="line" lang="java"><span class="cm">   *  {expression}</span></span>
<span id="LC266" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC267" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC268" class="line" lang="java"><span class="cm">   *  XString</span></span>
<span id="LC269" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC270" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC271" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_STRING</span> <span class="o">=</span> <span class="mi">17</span><span class="o">;</span></span>
<span id="LC272" class="line" lang="java"></span>
<span id="LC273" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC274" class="line" lang="java"><span class="cm">   * [OP_BOOL] (cast operation)</span></span>
<span id="LC275" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC276" class="line" lang="java"><span class="cm">   *  {expression}</span></span>
<span id="LC277" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC278" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC279" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC280" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC281" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC282" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_BOOL</span> <span class="o">=</span> <span class="mi">18</span><span class="o">;</span></span>
<span id="LC283" class="line" lang="java"></span>
<span id="LC284" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC285" class="line" lang="java"><span class="cm">   * [OP_NUMBER] (cast operation)</span></span>
<span id="LC286" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC287" class="line" lang="java"><span class="cm">   *  {expression}</span></span>
<span id="LC288" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC291" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC292" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC293" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_NUMBER</span> <span class="o">=</span> <span class="mi">19</span><span class="o">;</span></span>
<span id="LC294" class="line" lang="java"></span>
<span id="LC295" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC296" class="line" lang="java"><span class="cm">   * [OP_UNION]</span></span>
<span id="LC297" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC298" class="line" lang="java"><span class="cm">   *  {PathExpr}+</span></span>
<span id="LC299" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC300" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC301" class="line" lang="java"><span class="cm">   *  XNodeSet</span></span>
<span id="LC302" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC303" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC304" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_UNION</span> <span class="o">=</span> <span class="mi">20</span><span class="o">;</span></span>
<span id="LC305" class="line" lang="java"></span>
<span id="LC306" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC307" class="line" lang="java"><span class="cm">   * [OP_LITERAL]</span></span>
<span id="LC308" class="line" lang="java"><span class="cm">   * [3]</span></span>
<span id="LC309" class="line" lang="java"><span class="cm">   * [index to token]</span></span>
<span id="LC310" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC311" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC312" class="line" lang="java"><span class="cm">   *  XString</span></span>
<span id="LC313" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC314" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC315" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_LITERAL</span> <span class="o">=</span> <span class="mi">21</span><span class="o">;</span></span>
<span id="LC316" class="line" lang="java"></span>
<span id="LC317" class="line" lang="java">  <span class="cm">/** The low opcode for nodesets, needed by getFirstPredicateOpPos and</span></span>
<span id="LC318" class="line" lang="java"><span class="cm">   *  getNextStepPos.          */</span></span>
<span id="LC319" class="line" lang="java">  <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">FIRST_NODESET_OP</span> <span class="o">=</span> <span class="mi">22</span><span class="o">;</span></span>
<span id="LC320" class="line" lang="java"></span>
<span id="LC321" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC322" class="line" lang="java"><span class="cm">   * [OP_VARIABLE]</span></span>
<span id="LC323" class="line" lang="java"><span class="cm">   * [4]</span></span>
<span id="LC324" class="line" lang="java"><span class="cm">   * [index to namespace token, or EMPTY]</span></span>
<span id="LC325" class="line" lang="java"><span class="cm">   * [index to function name token]</span></span>
<span id="LC326" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC327" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC328" class="line" lang="java"><span class="cm">   *  XString</span></span>
<span id="LC329" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC330" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC331" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_VARIABLE</span> <span class="o">=</span> <span class="mi">22</span><span class="o">;</span></span>
<span id="LC332" class="line" lang="java"></span>
<span id="LC333" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC334" class="line" lang="java"><span class="cm">   * [OP_GROUP]</span></span>
<span id="LC335" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC336" class="line" lang="java"><span class="cm">   *  {expression}</span></span>
<span id="LC337" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC338" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC339" class="line" lang="java"><span class="cm">   *  XNodeSet</span></span>
<span id="LC340" class="line" lang="java"><span class="cm">   *  XNumber</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">   *  XString</span></span>
<span id="LC342" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC343" class="line" lang="java"><span class="cm">   *  XRTree</span></span>
<span id="LC344" class="line" lang="java"><span class="cm">   *  XObject</span></span>
...
<span id="LC347" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_GROUP</span> <span class="o">=</span> <span class="mi">23</span><span class="o">;</span></span>
<span id="LC348" class="line" lang="java"></span>
<span id="LC349" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC350" class="line" lang="java"><span class="cm">   * [OP_EXTFUNCTION] (Extension function.)</span></span>
<span id="LC351" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC352" class="line" lang="java"><span class="cm">   * [index to namespace token]</span></span>
<span id="LC353" class="line" lang="java"><span class="cm">   * [index to function name token]</span></span>
<span id="LC354" class="line" lang="java"><span class="cm">   *  {OP_ARGUMENT}</span></span>
<span id="LC355" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC356" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC357" class="line" lang="java"><span class="cm">   *  XNodeSet</span></span>
<span id="LC358" class="line" lang="java"><span class="cm">   *  XNumber</span></span>
<span id="LC359" class="line" lang="java"><span class="cm">   *  XString</span></span>
<span id="LC360" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC361" class="line" lang="java"><span class="cm">   *  XRTree</span></span>
<span id="LC362" class="line" lang="java"><span class="cm">   *  XObject</span></span>
<span id="LC363" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC364" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC365" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_EXTFUNCTION</span> <span class="o">=</span> <span class="mi">24</span><span class="o">;</span></span>
<span id="LC366" class="line" lang="java"></span>
<span id="LC367" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC368" class="line" lang="java"><span class="cm">   * [OP_FUNCTION]</span></span>
<span id="LC369" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC370" class="line" lang="java"><span class="cm">   * [FUNC_name]</span></span>
<span id="LC371" class="line" lang="java"><span class="cm">   *  {OP_ARGUMENT}</span></span>
<span id="LC372" class="line" lang="java"><span class="cm">   * [ENDOP]</span></span>
<span id="LC373" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC374" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC375" class="line" lang="java"><span class="cm">   *  XNodeSet</span></span>
<span id="LC376" class="line" lang="java"><span class="cm">   *  XNumber</span></span>
<span id="LC377" class="line" lang="java"><span class="cm">   *  XString</span></span>
<span id="LC378" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC379" class="line" lang="java"><span class="cm">   *  XRTree</span></span>
<span id="LC380" class="line" lang="java"><span class="cm">   *  XObject</span></span>
<span id="LC381" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC382" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC383" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_FUNCTION</span> <span class="o">=</span> <span class="mi">25</span><span class="o">;</span></span>
<span id="LC384" class="line" lang="java"></span>
<span id="LC385" class="line" lang="java">  <span class="cm">/** The last opcode for stuff that can be a nodeset.         */</span></span>
<span id="LC386" class="line" lang="java">  <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">LAST_NODESET_OP</span> <span class="o">=</span> <span class="mi">25</span><span class="o">;</span></span>
<span id="LC387" class="line" lang="java"></span>
<span id="LC388" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC389" class="line" lang="java"><span class="cm">   * [OP_ARGUMENT] (Function argument.)</span></span>
<span id="LC390" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC391" class="line" lang="java"><span class="cm">   *  {expression}</span></span>
<span id="LC392" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC393" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC394" class="line" lang="java"><span class="cm">   *  XNodeSet</span></span>
<span id="LC395" class="line" lang="java"><span class="cm">   *  XNumber</span></span>
<span id="LC396" class="line" lang="java"><span class="cm">   *  XString</span></span>
<span id="LC397" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC398" class="line" lang="java"><span class="cm">   *  XRTree</span></span>
<span id="LC399" class="line" lang="java"><span class="cm">   *  XObject</span></span>
<span id="LC400" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC401" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC402" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_ARGUMENT</span> <span class="o">=</span> <span class="mi">26</span><span class="o">;</span></span>
<span id="LC403" class="line" lang="java"></span>
<span id="LC404" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC405" class="line" lang="java"><span class="cm">   * [OP_NUMBERLIT] (Number literal.)</span></span>
<span id="LC406" class="line" lang="java"><span class="cm">   * [3]</span></span>
<span id="LC407" class="line" lang="java"><span class="cm">   * [index to token]</span></span>
<span id="LC408" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC409" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC410" class="line" lang="java"><span class="cm">   *  XString</span></span>
<span id="LC411" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC412" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC413" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_NUMBERLIT</span> <span class="o">=</span> <span class="mi">27</span><span class="o">;</span></span>
<span id="LC414" class="line" lang="java"></span>
<span id="LC415" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC416" class="line" lang="java"><span class="cm">   * [OP_LOCATIONPATH]</span></span>
<span id="LC417" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC418" class="line" lang="java"><span class="cm">   *   {FROM_stepType}</span></span>
<span id="LC419" class="line" lang="java"><span class="cm">   * | {function}</span></span>
<span id="LC420" class="line" lang="java"><span class="cm">   * {predicate}</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">   * [ENDOP]</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC423" class="line" lang="java"><span class="cm">   * (Note that element and attribute namespaces and</span></span>
<span id="LC424" class="line" lang="java"><span class="cm">   * names can be wildcarded '*'.)</span></span>
<span id="LC425" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC427" class="line" lang="java"><span class="cm">   *  XNodeSet</span></span>
<span id="LC428" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC429" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC430" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_LOCATIONPATH</span> <span class="o">=</span> <span class="mi">28</span><span class="o">;</span></span>
<span id="LC431" class="line" lang="java"></span>
<span id="LC432" class="line" lang="java">  <span class="c1">// public static final int LOCATIONPATHEX_MASK = 0x0000FFFF;</span></span>
<span id="LC433" class="line" lang="java">  <span class="c1">// public static final int LOCATIONPATHEX_ISSIMPLE = 0x00010000;</span></span>
<span id="LC434" class="line" lang="java">  <span class="c1">// public static final int OP_LOCATIONPATH_EX = (28 | 0x00010000);</span></span>
<span id="LC435" class="line" lang="java"></span>
<span id="LC436" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC437" class="line" lang="java"><span class="cm">   * [OP_PREDICATE]</span></span>
<span id="LC438" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC439" class="line" lang="java"><span class="cm">   *  {expression}</span></span>
<span id="LC440" class="line" lang="java"><span class="cm">   * [ENDOP] (For safety)</span></span>
<span id="LC441" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC442" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC443" class="line" lang="java"><span class="cm">   *  XBoolean or XNumber</span></span>
<span id="LC444" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC445" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC446" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_PREDICATE</span> <span class="o">=</span> <span class="mi">29</span><span class="o">;</span></span>
<span id="LC447" class="line" lang="java"></span>
<span id="LC448" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC449" class="line" lang="java"><span class="cm">   * [OP_MATCHPATTERN]</span></span>
<span id="LC450" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC451" class="line" lang="java"><span class="cm">   *  {PathExpr}+</span></span>
<span id="LC452" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC453" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC454" class="line" lang="java"><span class="cm">   *  XNodeSet</span></span>
<span id="LC455" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC456" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC457" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_MATCHPATTERN</span> <span class="o">=</span> <span class="mi">30</span><span class="o">;</span></span>
<span id="LC458" class="line" lang="java"></span>
<span id="LC459" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC460" class="line" lang="java"><span class="cm">   * [OP_LOCATIONPATHPATTERN]</span></span>
<span id="LC461" class="line" lang="java"><span class="cm">   * [length]</span></span>
<span id="LC462" class="line" lang="java"><span class="cm">   *   {FROM_stepType}</span></span>
<span id="LC463" class="line" lang="java"><span class="cm">   * | {function}{predicate}</span></span>
<span id="LC464" class="line" lang="java"><span class="cm">   * [ENDOP]</span></span>
<span id="LC465" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC466" class="line" lang="java"><span class="cm">   *  XNodeSet</span></span>
<span id="LC467" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC468" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC469" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">OP_LOCATIONPATHPATTERN</span> <span class="o">=</span> <span class="mi">31</span><span class="o">;</span></span>
<span id="LC470" class="line" lang="java"></span>
<span id="LC471" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC472" class="line" lang="java"><span class="cm">   * [NODETYPE_COMMENT]</span></span>
<span id="LC473" class="line" lang="java"><span class="cm">   * No size or arguments.</span></span>
<span id="LC474" class="line" lang="java"><span class="cm">   * Note: must not overlap function OP number!</span></span>
<span id="LC475" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC476" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC477" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC478" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC479" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC480" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">NODETYPE_COMMENT</span> <span class="o">=</span> <span class="mi">1030</span><span class="o">;</span></span>
<span id="LC481" class="line" lang="java"></span>
<span id="LC482" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC483" class="line" lang="java"><span class="cm">   * [NODETYPE_TEXT]</span></span>
<span id="LC484" class="line" lang="java"><span class="cm">   * No size or arguments.</span></span>
<span id="LC485" class="line" lang="java"><span class="cm">   * Note: must not overlap function OP number!</span></span>
<span id="LC486" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC487" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC488" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC489" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC490" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC491" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">NODETYPE_TEXT</span> <span class="o">=</span> <span class="mi">1031</span><span class="o">;</span></span>
<span id="LC492" class="line" lang="java"></span>
<span id="LC493" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC494" class="line" lang="java"><span class="cm">   * [NODETYPE_PI]</span></span>
<span id="LC495" class="line" lang="java"><span class="cm">   * [index to token]</span></span>
<span id="LC496" class="line" lang="java"><span class="cm">   * Note: must not overlap function OP number!</span></span>
<span id="LC497" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC498" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC499" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC500" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC501" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC502" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">NODETYPE_PI</span> <span class="o">=</span> <span class="mi">1032</span><span class="o">;</span></span>
<span id="LC503" class="line" lang="java"></span>
<span id="LC504" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC505" class="line" lang="java"><span class="cm">   * [NODETYPE_NODE]</span></span>
<span id="LC506" class="line" lang="java"><span class="cm">   * No size or arguments.</span></span>
<span id="LC507" class="line" lang="java"><span class="cm">   * Note: must not overlap function OP number!</span></span>
<span id="LC508" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC509" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC510" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC511" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC512" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC513" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">NODETYPE_NODE</span> <span class="o">=</span> <span class="mi">1033</span><span class="o">;</span></span>
<span id="LC514" class="line" lang="java"></span>
<span id="LC515" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC516" class="line" lang="java"><span class="cm">   * [NODENAME]</span></span>
<span id="LC517" class="line" lang="java"><span class="cm">   * [index to ns token or EMPTY]</span></span>
<span id="LC518" class="line" lang="java"><span class="cm">   * [index to name token]</span></span>
<span id="LC519" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC520" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC521" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC522" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC523" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC524" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">NODENAME</span> <span class="o">=</span> <span class="mi">34</span><span class="o">;</span></span>
<span id="LC525" class="line" lang="java"></span>
<span id="LC526" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC527" class="line" lang="java"><span class="cm">   * [NODETYPE_ROOT]</span></span>
<span id="LC528" class="line" lang="java"><span class="cm">   * No size or arguments.</span></span>
<span id="LC529" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC530" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC531" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC532" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC533" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC534" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">NODETYPE_ROOT</span> <span class="o">=</span> <span class="mi">35</span><span class="o">;</span></span>
<span id="LC535" class="line" lang="java"></span>
<span id="LC536" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC537" class="line" lang="java"><span class="cm">   * [NODETYPE_ANY]</span></span>
<span id="LC538" class="line" lang="java"><span class="cm">   * No size or arguments.</span></span>
<span id="LC539" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC540" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC541" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC542" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC543" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC544" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">NODETYPE_ANYELEMENT</span> <span class="o">=</span> <span class="mi">36</span><span class="o">;</span></span>
<span id="LC545" class="line" lang="java"></span>
<span id="LC546" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC547" class="line" lang="java"><span class="cm">   * [NODETYPE_ANY]</span></span>
<span id="LC548" class="line" lang="java"><span class="cm">   * No size or arguments.</span></span>
<span id="LC549" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC550" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC551" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC552" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC553" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC554" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">NODETYPE_FUNCTEST</span> <span class="o">=</span> <span class="mi">1034</span><span class="o">;</span></span>
<span id="LC555" class="line" lang="java"></span>
<span id="LC556" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC557" class="line" lang="java"><span class="cm">   * [FROM_stepType]</span></span>
<span id="LC558" class="line" lang="java"><span class="cm">   * [length, including predicates]</span></span>
<span id="LC559" class="line" lang="java"><span class="cm">   * [length of just the step, without the predicates]</span></span>
<span id="LC560" class="line" lang="java"><span class="cm">   * {node test}</span></span>
<span id="LC561" class="line" lang="java"><span class="cm">   * {predicates}?</span></span>
<span id="LC562" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC563" class="line" lang="java"><span class="cm">   * returns:</span></span>
<span id="LC564" class="line" lang="java"><span class="cm">   *  XBoolean</span></span>
<span id="LC565" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC566" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC567" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">AXES_START_TYPES</span> <span class="o">=</span> <span class="mi">37</span><span class="o">;</span></span>
<span id="LC568" class="line" lang="java"></span>
<span id="LC569" class="line" lang="java">  <span class="cm">/** ancestor axes opcode.         */</span></span>
<span id="LC570" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">FROM_ANCESTORS</span> <span class="o">=</span> <span class="mi">37</span><span class="o">;</span></span>
<span id="LC571" class="line" lang="java"></span>
<span id="LC572" class="line" lang="java">  <span class="cm">/** ancestor-or-self axes opcode.         */</span></span>
<span id="LC573" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">FROM_ANCESTORS_OR_SELF</span> <span class="o">=</span> <span class="mi">38</span><span class="o">;</span></span>
<span id="LC574" class="line" lang="java"></span>
<span id="LC575" class="line" lang="java">  <span class="cm">/** attribute axes opcode.         */</span></span>
<span id="LC576" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">FROM_ATTRIBUTES</span> <span class="o">=</span> <span class="mi">39</span><span class="o">;</span></span>
<span id="LC577" class="line" lang="java"></span>
<span id="LC578" class="line" lang="java">  <span class="cm">/** children axes opcode.         */</span></span>
<span id="LC579" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">FROM_CHILDREN</span> <span class="o">=</span> <span class="mi">40</span><span class="o">;</span></span>
<span id="LC580" class="line" lang="java"></span>
<span id="LC581" class="line" lang="java">  <span class="cm">/** descendants axes opcode.         */</span></span>
<span id="LC582" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">FROM_DESCENDANTS</span> <span class="o">=</span> <span class="mi">41</span><span class="o">;</span></span>
<span id="LC583" class="line" lang="java"></span>
<span id="LC584" class="line" lang="java">  <span class="cm">/** descendants-of-self axes opcode.         */</span></span>
<span id="LC585" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">FROM_DESCENDANTS_OR_SELF</span> <span class="o">=</span> <span class="mi">42</span><span class="o">;</span></span>
<span id="LC586" class="line" lang="java"></span>
<span id="LC587" class="line" lang="java">  <span class="cm">/** following axes opcode.         */</span></span>
<span id="LC588" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">FROM_FOLLOWING</span> <span class="o">=</span> <span class="mi">43</span><span class="o">;</span></span>
<span id="LC589" class="line" lang="java"></span>
<span id="LC590" class="line" lang="java">  <span class="cm">/** following-siblings axes opcode.         */</span></span>
<span id="LC591" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">FROM_FOLLOWING_SIBLINGS</span> <span class="o">=</span> <span class="mi">44</span><span class="o">;</span></span>
<span id="LC592" class="line" lang="java"></span>
<span id="LC593" class="line" lang="java">  <span class="cm">/** parent axes opcode.         */</span></span>
<span id="LC594" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">FROM_PARENT</span> <span class="o">=</span> <span class="mi">45</span><span class="o">;</span></span>
<span id="LC595" class="line" lang="java"></span>
<span id="LC596" class="line" lang="java">  <span class="cm">/** preceding axes opcode.         */</span></span>
<span id="LC597" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">FROM_PRECEDING</span> <span class="o">=</span> <span class="mi">46</span><span class="o">;</span></span>
<span id="LC598" class="line" lang="java"></span>
<span id="LC599" class="line" lang="java">  <span class="cm">/** preceding-sibling axes opcode.         */</span></span>
<span id="LC600" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">FROM_PRECEDING_SIBLINGS</span> <span class="o">=</span> <span class="mi">47</span><span class="o">;</span></span>
<span id="LC601" class="line" lang="java"></span>
<span id="LC602" class="line" lang="java">  <span class="cm">/** self axes opcode.         */</span></span>
<span id="LC603" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">FROM_SELF</span> <span class="o">=</span> <span class="mi">48</span><span class="o">;</span></span>
<span id="LC604" class="line" lang="java"></span>
<span id="LC605" class="line" lang="java">  <span class="cm">/** namespace axes opcode.         */</span></span>
<span id="LC606" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">FROM_NAMESPACE</span> <span class="o">=</span> <span class="mi">49</span><span class="o">;</span></span>
<span id="LC607" class="line" lang="java"></span>
<span id="LC608" class="line" lang="java">  <span class="cm">/** '/' axes opcode.         */</span></span>
<span id="LC609" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">FROM_ROOT</span> <span class="o">=</span> <span class="mi">50</span><span class="o">;</span></span>
<span id="LC610" class="line" lang="java"></span>
<span id="LC611" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC612" class="line" lang="java"><span class="cm">   * For match patterns.</span></span>
<span id="LC613" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC614" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC615" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">MATCH_ATTRIBUTE</span> <span class="o">=</span> <span class="mi">51</span><span class="o">;</span></span>
<span id="LC616" class="line" lang="java"></span>
<span id="LC617" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC618" class="line" lang="java"><span class="cm">   * For match patterns.</span></span>
<span id="LC619" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC620" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC621" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">MATCH_ANY_ANCESTOR</span> <span class="o">=</span> <span class="mi">52</span><span class="o">;</span></span>
<span id="LC622" class="line" lang="java"></span>
<span id="LC623" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC624" class="line" lang="java"><span class="cm">   * For match patterns.</span></span>
<span id="LC625" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC626" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC627" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">MATCH_IMMEDIATE_ANCESTOR</span> <span class="o">=</span> <span class="mi">53</span><span class="o">;</span></span>
<span id="LC628" class="line" lang="java"></span>
<span id="LC629" class="line" lang="java">  <span class="cm">/** The end of the axes types.    */</span></span>
<span id="LC630" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">AXES_END_TYPES</span> <span class="o">=</span> <span class="mi">53</span><span class="o">;</span></span>
<span id="LC631" class="line" lang="java"></span>
<span id="LC632" class="line" lang="java">  <span class="cm">/** The next free ID.  Please keep this up to date.  */</span></span>
<span id="LC633" class="line" lang="java">  <span class="kd">private</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">NEXT_FREE_ID</span> <span class="o">=</span> <span class="mi">99</span><span class="o">;</span></span>
