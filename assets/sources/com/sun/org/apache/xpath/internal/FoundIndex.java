...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: FoundIndex.java,v 1.2.4.1 2005/09/14 19:50:20 jeffsuttor Exp $</span></span>
...
<span id="LC26" class="line" lang="java"><span class="cm"> * Class to let us know when it's time to do</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * a search from the parent because of indexing.</span></span>
...
<span id="LC30" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">FoundIndex</span> <span class="kd">extends</span> <span class="nc">RuntimeException</span></span>
<span id="LC31" class="line" lang="java"><span class="o">{</span></span>
<span id="LC32" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="o">-</span><span class="mi">4643975335243078270L</span><span class="o">;</span></span>
<span id="LC33" class="line" lang="java"></span>
<span id="LC34" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC35" class="line" lang="java"><span class="cm">   * Constructor FoundIndex</span></span>
<span id="LC36" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC38" class="line" lang="java">  <span class="kd">public</span> <span class="nf">FoundIndex</span><span class="o">(){}</span></span>
