...
<span id="LC5" class="line" lang="java"><span class="cm"> * Copyright 1999-2004 The Apache Software Foundation.</span></span>
...
<span id="LC20" class="line" lang="java"><span class="cm"> * $Id: XPathContext.java,v 1.2.4.2 2005/09/15 01:37:55 jeffsuttor Exp $</span></span>
<span id="LC21" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC22" class="line" lang="java"><span class="kn">package</span> <span class="nn">com.sun.org.apache.xpath.internal</span><span class="o">;</span></span>
<span id="LC23" class="line" lang="java"></span>
<span id="LC24" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xalan.internal.extensions.ExpressionContext</span><span class="o">;</span></span>
...
<span id="LC28" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.dtm.DTMFilter</span><span class="o">;</span></span>
<span id="LC29" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.dtm.DTMIterator</span><span class="o">;</span></span>
...
<span id="LC32" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.dtm.ref.sax2dtm.SAX2RTFDTM</span><span class="o">;</span></span>
<span id="LC33" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.utils.IntStack</span><span class="o">;</span></span>
<span id="LC34" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.utils.NodeVector</span><span class="o">;</span></span>
<span id="LC35" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.utils.ObjectStack</span><span class="o">;</span></span>
<span id="LC36" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.utils.PrefixResolver</span><span class="o">;</span></span>
<span id="LC37" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.utils.XMLString</span><span class="o">;</span></span>
<span id="LC38" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.axes.SubContextList</span><span class="o">;</span></span>
<span id="LC39" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.objects.DTMXRTreeFrag</span><span class="o">;</span></span>
<span id="LC40" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.objects.XObject</span><span class="o">;</span></span>
<span id="LC41" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.objects.XString</span><span class="o">;</span></span>
<span id="LC42" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.res.XPATHErrorResources</span><span class="o">;</span></span>
...
<span id="LC44" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.util.HashMap</span><span class="o">;</span></span>
<span id="LC45" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.util.Iterator</span><span class="o">;</span></span>
<span id="LC46" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.util.Stack</span><span class="o">;</span></span>
<span id="LC47" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.util.Vector</span><span class="o">;</span></span>
<span id="LC48" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.transform.ErrorListener</span><span class="o">;</span></span>
<span id="LC49" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.transform.SourceLocator</span><span class="o">;</span></span>
<span id="LC50" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.transform.TransformerException</span><span class="o">;</span></span>
<span id="LC51" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.transform.URIResolver</span><span class="o">;</span></span>
<span id="LC52" class="line" lang="java"><span class="kn">import</span> <span class="nn">jdk.xml.internal.JdkXmlUtils</span><span class="o">;</span></span>
<span id="LC53" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.XMLReader</span><span class="o">;</span></span>
<span id="LC54" class="line" lang="java"></span>
<span id="LC55" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC56" class="line" lang="java"><span class="cm"> * Default class for the runtime execution context for XPath.</span></span>
<span id="LC57" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC58" class="line" lang="java"><span class="cm"> * &lt;p&gt;This class extends DTMManager but does not directly implement it.&lt;/p&gt;</span></span>
...
<span id="LC61" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XPathContext</span> <span class="kd">extends</span> <span class="nc">DTMManager</span> <span class="c1">// implements ExpressionContext</span></span>
<span id="LC62" class="line" lang="java"><span class="o">{</span></span>
<span id="LC63" class="line" lang="java">        <span class="nc">IntStack</span> <span class="n">m_last_pushed_rtfdtm</span><span class="o">=</span><span class="k">new</span> <span class="nc">IntStack</span><span class="o">();</span></span>
<span id="LC64" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC65" class="line" lang="java"><span class="cm">   * Stack of cached "reusable" DTMs for Result Tree Fragments.</span></span>
<span id="LC66" class="line" lang="java"><span class="cm">   * This is a kluge to handle the problem of starting an RTF before</span></span>
<span id="LC67" class="line" lang="java"><span class="cm">   * the old one is complete.</span></span>
<span id="LC68" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">   * %REVIEW% I'm using a Vector rather than Stack so we can reuse</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">   * the DTMs if the problem occurs multiple times. I'm not sure that's</span></span>
<span id="LC71" class="line" lang="java"><span class="cm">   * really a net win versus discarding the DTM and starting a new one...</span></span>
<span id="LC72" class="line" lang="java"><span class="cm">   * but the retained RTF DTM will have been tail-pruned so should be small.</span></span>
<span id="LC73" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC74" class="line" lang="java">  <span class="kd">private</span> <span class="nc">Vector</span> <span class="n">m_rtfdtm_stack</span><span class="o">=</span><span class="kc">null</span><span class="o">;</span></span>
<span id="LC75" class="line" lang="java">  <span class="cm">/** Index of currently active RTF DTM in m_rtfdtm_stack */</span></span>
<span id="LC76" class="line" lang="java">  <span class="kd">private</span> <span class="kt">int</span> <span class="n">m_which_rtfdtm</span><span class="o">=-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC77" class="line" lang="java"></span>
<span id="LC78" class="line" lang="java"> <span class="cm">/**</span></span>
<span id="LC79" class="line" lang="java"><span class="cm">   * Most recent "reusable" DTM for Global Result Tree Fragments. No stack is</span></span>
<span id="LC80" class="line" lang="java"><span class="cm">   * required since we're never going to pop these.</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC82" class="line" lang="java">  <span class="kd">private</span> <span class="no">SAX2RTFDTM</span> <span class="n">m_global_rtfdtm</span><span class="o">=</span><span class="kc">null</span><span class="o">;</span></span>
<span id="LC83" class="line" lang="java"></span>
<span id="LC84" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">   * HashMap of cached the DTMXRTreeFrag objects, which are identified by DTM IDs.</span></span>
<span id="LC86" class="line" lang="java"><span class="cm">   * The object are just wrappers for DTMs which are used in  XRTreeFrag.</span></span>
<span id="LC87" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC88" class="line" lang="java">  <span class="kd">private</span> <span class="nc">HashMap</span> <span class="n">m_DTMXRTreeFrags</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC89" class="line" lang="java"></span>
<span id="LC90" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">   * state of the secure processing feature.</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC93" class="line" lang="java">  <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">m_isSecureProcessing</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC94" class="line" lang="java"></span>
<span id="LC95" class="line" lang="java">  <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">m_overrideDefaultParser</span><span class="o">;</span></span>
<span id="LC96" class="line" lang="java"></span>
<span id="LC97" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC98" class="line" lang="java"><span class="cm">   * Though XPathContext context extends</span></span>
<span id="LC99" class="line" lang="java"><span class="cm">   * the DTMManager, it really is a proxy for this object, which</span></span>
<span id="LC100" class="line" lang="java"><span class="cm">   * is the real DTMManager.</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC102" class="line" lang="java">  <span class="kd">protected</span> <span class="nc">DTMManager</span> <span class="n">m_dtmManager</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC103" class="line" lang="java"></span>
<span id="LC104" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC105" class="line" lang="java"><span class="cm">   * Return the DTMManager object.  Though XPathContext context extends</span></span>
<span id="LC106" class="line" lang="java"><span class="cm">   * the DTMManager, it really is a proxy for the real DTMManager.  If a</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">   * caller needs to make a lot of calls to the DTMManager, it is faster</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">   * if it gets the real one from this function.</span></span>
<span id="LC109" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC110" class="line" lang="java">   <span class="kd">public</span> <span class="nc">DTMManager</span> <span class="nf">getDTMManager</span><span class="o">()</span></span>
<span id="LC111" class="line" lang="java">   <span class="o">{</span></span>
<span id="LC112" class="line" lang="java">     <span class="k">return</span> <span class="n">m_dtmManager</span><span class="o">;</span></span>
...
<span id="LC116" class="line" lang="java"><span class="cm">   * Set the state of the secure processing feature</span></span>
<span id="LC117" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC118" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSecureProcessing</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">flag</span><span class="o">)</span></span>
<span id="LC119" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC120" class="line" lang="java">    <span class="n">m_isSecureProcessing</span> <span class="o">=</span> <span class="n">flag</span><span class="o">;</span></span>
...
<span id="LC124" class="line" lang="java"><span class="cm">   * Return the state of the secure processing feature</span></span>
<span id="LC125" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC126" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isSecureProcessing</span><span class="o">()</span></span>
<span id="LC127" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC128" class="line" lang="java">    <span class="k">return</span> <span class="n">m_isSecureProcessing</span><span class="o">;</span></span>
...
<span id="LC132" class="line" lang="java"><span class="cm">   * Get an instance of a DTM, loaded with the content from the</span></span>
<span id="LC133" class="line" lang="java"><span class="cm">   * specified source.  If the unique flag is true, a new instance will</span></span>
<span id="LC134" class="line" lang="java"><span class="cm">   * always be returned.  Otherwise it is up to the DTMManager to return a</span></span>
<span id="LC135" class="line" lang="java"><span class="cm">   * new instance or an instance that it already created and may be being used</span></span>
<span id="LC136" class="line" lang="java"><span class="cm">   * by someone else.</span></span>
<span id="LC137" class="line" lang="java"><span class="cm">   * (I think more parameters will need to be added for error handling, and entity</span></span>
<span id="LC138" class="line" lang="java"><span class="cm">   * resolution).</span></span>
<span id="LC139" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC140" class="line" lang="java"><span class="cm">   * @param source the specification of the source object, which may be null,</span></span>
<span id="LC141" class="line" lang="java"><span class="cm">   *               in which case it is assumed that node construction will take</span></span>
<span id="LC142" class="line" lang="java"><span class="cm">   *               by some other means.</span></span>
<span id="LC143" class="line" lang="java"><span class="cm">   * @param unique true if the returned DTM must be unique, probably because it</span></span>
<span id="LC144" class="line" lang="java"><span class="cm">   * is going to be mutated.</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">   * @param wsfilter Enables filtering of whitespace nodes, and may be null.</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">   * @param incremental true if the construction should try and be incremental.</span></span>
<span id="LC147" class="line" lang="java"><span class="cm">   * @param doIndexing true if the caller considers it worth it to use</span></span>
<span id="LC148" class="line" lang="java"><span class="cm">   *                   indexing schemes.</span></span>
<span id="LC149" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC150" class="line" lang="java"><span class="cm">   * @return a non-null DTM reference.</span></span>
<span id="LC151" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC152" class="line" lang="java">  <span class="kd">public</span> <span class="no">DTM</span> <span class="nf">getDTM</span><span class="o">(</span><span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">Source</span> <span class="n">source</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">unique</span><span class="o">,</span></span>
<span id="LC153" class="line" lang="java">                    <span class="nc">DTMWSFilter</span> <span class="n">wsfilter</span><span class="o">,</span></span>
<span id="LC154" class="line" lang="java">                    <span class="kt">boolean</span> <span class="n">incremental</span><span class="o">,</span></span>
<span id="LC155" class="line" lang="java">                    <span class="kt">boolean</span> <span class="n">doIndexing</span><span class="o">)</span></span>
<span id="LC156" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC157" class="line" lang="java">    <span class="k">return</span> <span class="n">m_dtmManager</span><span class="o">.</span><span class="na">getDTM</span><span class="o">(</span><span class="n">source</span><span class="o">,</span> <span class="n">unique</span><span class="o">,</span> <span class="n">wsfilter</span><span class="o">,</span></span>
<span id="LC158" class="line" lang="java">                               <span class="n">incremental</span><span class="o">,</span> <span class="n">doIndexing</span><span class="o">);</span></span>
...
<span id="LC162" class="line" lang="java"><span class="cm">   * Get an instance of a DTM that "owns" a node handle.</span></span>
<span id="LC163" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC164" class="line" lang="java"><span class="cm">   * @param nodeHandle the nodeHandle.</span></span>
<span id="LC165" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC166" class="line" lang="java"><span class="cm">   * @return a non-null DTM reference.</span></span>
<span id="LC167" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC168" class="line" lang="java">  <span class="kd">public</span> <span class="no">DTM</span> <span class="nf">getDTM</span><span class="o">(</span><span class="kt">int</span> <span class="n">nodeHandle</span><span class="o">)</span></span>
<span id="LC169" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC170" class="line" lang="java">    <span class="k">return</span> <span class="n">m_dtmManager</span><span class="o">.</span><span class="na">getDTM</span><span class="o">(</span><span class="n">nodeHandle</span><span class="o">);</span></span>
...
<span id="LC174" class="line" lang="java"><span class="cm">   * Given a W3C DOM node, try and return a DTM handle.</span></span>
<span id="LC175" class="line" lang="java"><span class="cm">   * Note: calling this may be non-optimal.</span></span>
<span id="LC176" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC177" class="line" lang="java"><span class="cm">   * @param node Non-null reference to a DOM node.</span></span>
<span id="LC178" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC179" class="line" lang="java"><span class="cm">   * @return a valid DTM handle.</span></span>
<span id="LC180" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC181" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getDTMHandleFromNode</span><span class="o">(</span><span class="n">org</span><span class="o">.</span><span class="na">w3c</span><span class="o">.</span><span class="na">dom</span><span class="o">.</span><span class="na">Node</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC182" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC183" class="line" lang="java">    <span class="k">return</span> <span class="n">m_dtmManager</span><span class="o">.</span><span class="na">getDTMHandleFromNode</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC184" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC185" class="line" lang="java"><span class="c1">//</span></span>
<span id="LC186" class="line" lang="java"><span class="c1">//</span></span>
<span id="LC187" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC188" class="line" lang="java"><span class="cm">   * %TBD% Doc</span></span>
<span id="LC189" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC190" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getDTMIdentity</span><span class="o">(</span><span class="no">DTM</span> <span class="n">dtm</span><span class="o">)</span></span>
<span id="LC191" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC192" class="line" lang="java">    <span class="k">return</span> <span class="n">m_dtmManager</span><span class="o">.</span><span class="na">getDTMIdentity</span><span class="o">(</span><span class="n">dtm</span><span class="o">);</span></span>
...
<span id="LC196" class="line" lang="java"><span class="cm">   * Creates an empty &lt;code&gt;DocumentFragment&lt;/code&gt; object.</span></span>
<span id="LC197" class="line" lang="java"><span class="cm">   * @return A new &lt;code&gt;DocumentFragment handle&lt;/code&gt;.</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC199" class="line" lang="java">  <span class="kd">public</span> <span class="no">DTM</span> <span class="nf">createDocumentFragment</span><span class="o">()</span></span>
<span id="LC200" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC201" class="line" lang="java">    <span class="k">return</span> <span class="n">m_dtmManager</span><span class="o">.</span><span class="na">createDocumentFragment</span><span class="o">();</span></span>
...
<span id="LC205" class="line" lang="java"><span class="cm">   * Release a DTM either to a lru pool, or completely remove reference.</span></span>
<span id="LC206" class="line" lang="java"><span class="cm">   * DTMs without system IDs are always hard deleted.</span></span>
<span id="LC207" class="line" lang="java"><span class="cm">   * State: experimental.</span></span>
<span id="LC208" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC209" class="line" lang="java"><span class="cm">   * @param dtm The DTM to be released.</span></span>
<span id="LC210" class="line" lang="java"><span class="cm">   * @param shouldHardDelete True if the DTM should be removed no matter what.</span></span>
<span id="LC211" class="line" lang="java"><span class="cm">   * @return true if the DTM was removed, false if it was put back in a lru pool.</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC213" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">release</span><span class="o">(</span><span class="no">DTM</span> <span class="n">dtm</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">shouldHardDelete</span><span class="o">)</span></span>
<span id="LC214" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC215" class="line" lang="java">    <span class="c1">// %REVIEW% If it's a DTM which may contain multiple Result Tree</span></span>
<span id="LC216" class="line" lang="java">    <span class="c1">// Fragments, we can't discard it unless we know not only that it</span></span>
<span id="LC217" class="line" lang="java">    <span class="c1">// is empty, but that the XPathContext itself is going away. So do</span></span>
<span id="LC218" class="line" lang="java">    <span class="c1">// _not_ accept the request. (May want to do it as part of</span></span>
<span id="LC219" class="line" lang="java">    <span class="c1">// reset(), though.)</span></span>
<span id="LC220" class="line" lang="java">    <span class="k">if</span><span class="o">(</span><span class="n">m_rtfdtm_stack</span><span class="o">!=</span><span class="kc">null</span> <span class="o">&amp;&amp;</span> <span class="n">m_rtfdtm_stack</span><span class="o">.</span><span class="na">contains</span><span class="o">(</span><span class="n">dtm</span><span class="o">))</span></span>
<span id="LC221" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC222" class="line" lang="java">      <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC223" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC224" class="line" lang="java"></span>
<span id="LC225" class="line" lang="java">    <span class="k">return</span> <span class="n">m_dtmManager</span><span class="o">.</span><span class="na">release</span><span class="o">(</span><span class="n">dtm</span><span class="o">,</span> <span class="n">shouldHardDelete</span><span class="o">);</span></span>
...
<span id="LC229" class="line" lang="java"><span class="cm">   * Create a new &lt;code&gt;DTMIterator&lt;/code&gt; based on an XPath</span></span>
<span id="LC230" class="line" lang="java"><span class="cm">   * &lt;a href="http://www.w3.org/TR/xpath#NT-LocationPath&gt;LocationPath&lt;/a&gt; or</span></span>
<span id="LC231" class="line" lang="java"><span class="cm">   * a &lt;a href="http://www.w3.org/TR/xpath#NT-UnionExpr"&gt;UnionExpr&lt;/a&gt;.</span></span>
<span id="LC232" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC233" class="line" lang="java"><span class="cm">   * @param xpathCompiler ??? Somehow we need to pass in a subpart of the</span></span>
<span id="LC234" class="line" lang="java"><span class="cm">   * expression.  I hate to do this with strings, since the larger expression</span></span>
<span id="LC235" class="line" lang="java"><span class="cm">   * has already been parsed.</span></span>
<span id="LC236" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC237" class="line" lang="java"><span class="cm">   * @param pos The position in the expression.</span></span>
<span id="LC238" class="line" lang="java"><span class="cm">   * @return The newly created &lt;code&gt;DTMIterator&lt;/code&gt;.</span></span>
<span id="LC239" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC240" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMIterator</span> <span class="nf">createDTMIterator</span><span class="o">(</span><span class="nc">Object</span> <span class="n">xpathCompiler</span><span class="o">,</span> <span class="kt">int</span> <span class="n">pos</span><span class="o">)</span></span>
<span id="LC241" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC242" class="line" lang="java">    <span class="k">return</span> <span class="n">m_dtmManager</span><span class="o">.</span><span class="na">createDTMIterator</span><span class="o">(</span><span class="n">xpathCompiler</span><span class="o">,</span> <span class="n">pos</span><span class="o">);</span></span>
...
<span id="LC246" class="line" lang="java"><span class="cm">   * Create a new &lt;code&gt;DTMIterator&lt;/code&gt; based on an XPath</span></span>
<span id="LC247" class="line" lang="java"><span class="cm">   * &lt;a href="http://www.w3.org/TR/xpath#NT-LocationPath&gt;LocationPath&lt;/a&gt; or</span></span>
<span id="LC248" class="line" lang="java"><span class="cm">   * a &lt;a href="http://www.w3.org/TR/xpath#NT-UnionExpr"&gt;UnionExpr&lt;/a&gt;.</span></span>
<span id="LC249" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC250" class="line" lang="java"><span class="cm">   * @param xpathString Must be a valid string expressing a</span></span>
<span id="LC251" class="line" lang="java"><span class="cm">   * &lt;a href="http://www.w3.org/TR/xpath#NT-LocationPath&gt;LocationPath&lt;/a&gt; or</span></span>
<span id="LC252" class="line" lang="java"><span class="cm">   * a &lt;a href="http://www.w3.org/TR/xpath#NT-UnionExpr"&gt;UnionExpr&lt;/a&gt;.</span></span>
<span id="LC253" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC254" class="line" lang="java"><span class="cm">   * @param presolver An object that can resolve prefixes to namespace URLs.</span></span>
<span id="LC255" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC256" class="line" lang="java"><span class="cm">   * @return The newly created &lt;code&gt;DTMIterator&lt;/code&gt;.</span></span>
<span id="LC257" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC258" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMIterator</span> <span class="nf">createDTMIterator</span><span class="o">(</span><span class="nc">String</span> <span class="n">xpathString</span><span class="o">,</span></span>
<span id="LC259" class="line" lang="java">          <span class="nc">PrefixResolver</span> <span class="n">presolver</span><span class="o">)</span></span>
<span id="LC260" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC261" class="line" lang="java">    <span class="k">return</span> <span class="n">m_dtmManager</span><span class="o">.</span><span class="na">createDTMIterator</span><span class="o">(</span><span class="n">xpathString</span><span class="o">,</span> <span class="n">presolver</span><span class="o">);</span></span>
...
<span id="LC265" class="line" lang="java"><span class="cm">   * Create a new &lt;code&gt;DTMIterator&lt;/code&gt; based only on a whatToShow and</span></span>
<span id="LC266" class="line" lang="java"><span class="cm">   * a DTMFilter.  The traversal semantics are defined as the descendant</span></span>
<span id="LC267" class="line" lang="java"><span class="cm">   * access.</span></span>
<span id="LC268" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC269" class="line" lang="java"><span class="cm">   * @param whatToShow This flag specifies which node types may appear in</span></span>
<span id="LC270" class="line" lang="java"><span class="cm">   *   the logical view of the tree presented by the iterator. See the</span></span>
<span id="LC271" class="line" lang="java"><span class="cm">   *   description of &lt;code&gt;NodeFilter&lt;/code&gt; for the set of possible</span></span>
<span id="LC272" class="line" lang="java"><span class="cm">   *   &lt;code&gt;SHOW_&lt;/code&gt; values.These flags can be combined using</span></span>
<span id="LC273" class="line" lang="java"><span class="cm">   *   &lt;code&gt;OR&lt;/code&gt;.</span></span>
<span id="LC274" class="line" lang="java"><span class="cm">   * @param filter The &lt;code&gt;NodeFilter&lt;/code&gt; to be used with this</span></span>
<span id="LC275" class="line" lang="java"><span class="cm">   *   &lt;code&gt;TreeWalker&lt;/code&gt;, or &lt;code&gt;null&lt;/code&gt; to indicate no filter.</span></span>
<span id="LC276" class="line" lang="java"><span class="cm">   * @param entityReferenceExpansion The value of this flag determines</span></span>
<span id="LC277" class="line" lang="java"><span class="cm">   *   whether entity reference nodes are expanded.</span></span>
<span id="LC278" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC279" class="line" lang="java"><span class="cm">   * @return The newly created &lt;code&gt;NodeIterator&lt;/code&gt;.</span></span>
<span id="LC280" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC281" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMIterator</span> <span class="nf">createDTMIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">whatToShow</span><span class="o">,</span></span>
<span id="LC282" class="line" lang="java">          <span class="nc">DTMFilter</span> <span class="n">filter</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">entityReferenceExpansion</span><span class="o">)</span></span>
<span id="LC283" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC284" class="line" lang="java">    <span class="k">return</span> <span class="n">m_dtmManager</span><span class="o">.</span><span class="na">createDTMIterator</span><span class="o">(</span><span class="n">whatToShow</span><span class="o">,</span> <span class="n">filter</span><span class="o">,</span> <span class="n">entityReferenceExpansion</span><span class="o">);</span></span>
...
<span id="LC288" class="line" lang="java"><span class="cm">   * Create a new &lt;code&gt;DTMIterator&lt;/code&gt; that holds exactly one node.</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">   * @param node The node handle that the DTMIterator will iterate to.</span></span>
<span id="LC291" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC292" class="line" lang="java"><span class="cm">   * @return The newly created &lt;code&gt;DTMIterator&lt;/code&gt;.</span></span>
<span id="LC293" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC294" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMIterator</span> <span class="nf">createDTMIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC295" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC296" class="line" lang="java">    <span class="c1">// DescendantIterator iter = new DescendantIterator();</span></span>
<span id="LC297" class="line" lang="java">    <span class="nc">DTMIterator</span> <span class="n">iter</span> <span class="o">=</span> <span class="k">new</span> <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xpath</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">axes</span><span class="o">.</span><span class="na">OneStepIteratorForward</span><span class="o">(</span><span class="nc">Axis</span><span class="o">.</span><span class="na">SELF</span><span class="o">);</span></span>
<span id="LC298" class="line" lang="java">    <span class="n">iter</span><span class="o">.</span><span class="na">setRoot</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="k">this</span><span class="o">);</span></span>
<span id="LC299" class="line" lang="java">    <span class="k">return</span> <span class="n">iter</span><span class="o">;</span></span>
<span id="LC300" class="line" lang="java">    <span class="c1">// return m_dtmManager.createDTMIterator(node);</span></span>
...
<span id="LC304" class="line" lang="java"><span class="cm">   * Create an XPathContext instance.</span></span>
<span id="LC305" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC306" class="line" lang="java">  <span class="kd">public</span> <span class="nf">XPathContext</span><span class="o">()</span></span>
<span id="LC307" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC308" class="line" lang="java">    <span class="k">this</span><span class="o">(</span><span class="kc">false</span><span class="o">);</span></span>
<span id="LC309" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC310" class="line" lang="java"></span>
<span id="LC311" class="line" lang="java">  <span class="kd">public</span> <span class="nf">XPathContext</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">overrideDefaultParser</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC312" class="line" lang="java">      <span class="n">init</span><span class="o">(</span><span class="n">overrideDefaultParser</span><span class="o">);</span></span>
<span id="LC313" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC314" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC315" class="line" lang="java"><span class="cm">   **This constructor doesn't seem to be used anywhere -- huizhe wang**</span></span>
<span id="LC316" class="line" lang="java"><span class="cm">   * Create an XPathContext instance.</span></span>
<span id="LC317" class="line" lang="java"><span class="cm">   * @param owner Value that can be retrieved via the getOwnerObject() method.</span></span>
<span id="LC318" class="line" lang="java"><span class="cm">   * @see #getOwnerObject</span></span>
<span id="LC319" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC320" class="line" lang="java">  <span class="kd">public</span> <span class="nf">XPathContext</span><span class="o">(</span><span class="nc">Object</span> <span class="n">owner</span><span class="o">)</span></span>
<span id="LC321" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC322" class="line" lang="java">    <span class="n">m_owner</span> <span class="o">=</span> <span class="n">owner</span><span class="o">;</span></span>
<span id="LC323" class="line" lang="java">    <span class="k">try</span> <span class="o">{</span></span>
<span id="LC324" class="line" lang="java">      <span class="n">m_ownerGetErrorListener</span> <span class="o">=</span> <span class="n">m_owner</span><span class="o">.</span><span class="na">getClass</span><span class="o">().</span><span class="na">getMethod</span><span class="o">(</span><span class="s">"getErrorListener"</span><span class="o">,</span> <span class="k">new</span> <span class="nc">Class</span><span class="o">[]</span> <span class="o">{});</span></span>
<span id="LC325" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC326" class="line" lang="java">    <span class="k">catch</span> <span class="o">(</span><span class="nc">NoSuchMethodException</span> <span class="n">nsme</span><span class="o">)</span> <span class="o">{}</span></span>
<span id="LC327" class="line" lang="java">    <span class="n">init</span><span class="o">(</span><span class="kc">false</span><span class="o">);</span></span>
<span id="LC328" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC329" class="line" lang="java"></span>
<span id="LC330" class="line" lang="java">  <span class="kd">private</span> <span class="kt">void</span> <span class="nf">init</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">overrideDefaultParser</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC331" class="line" lang="java">    <span class="n">m_prefixResolvers</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="kc">null</span><span class="o">);</span></span>
<span id="LC332" class="line" lang="java">    <span class="n">m_currentNodes</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">);</span></span>
<span id="LC333" class="line" lang="java">    <span class="n">m_currentExpressionNodes</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">);</span></span>
<span id="LC334" class="line" lang="java">    <span class="n">m_saxLocations</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="kc">null</span><span class="o">);</span></span>
<span id="LC335" class="line" lang="java">    <span class="n">m_overrideDefaultParser</span> <span class="o">=</span> <span class="n">overrideDefaultParser</span><span class="o">;</span></span>
<span id="LC336" class="line" lang="java">    <span class="n">m_dtmManager</span> <span class="o">=</span> <span class="nc">DTMManager</span><span class="o">.</span><span class="na">newInstance</span><span class="o">(</span></span>
<span id="LC337" class="line" lang="java">                   <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xpath</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">objects</span><span class="o">.</span><span class="na">XMLStringFactoryImpl</span><span class="o">.</span><span class="na">getFactory</span><span class="o">()</span></span>
...
<span id="LC342" class="line" lang="java"><span class="cm">   * Reset for new run.</span></span>
<span id="LC343" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC344" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">reset</span><span class="o">()</span></span>
<span id="LC345" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC346" class="line" lang="java">    <span class="n">releaseDTMXRTreeFrags</span><span class="o">();</span></span>
<span id="LC347" class="line" lang="java">        <span class="c1">// These couldn't be disposed of earlier (see comments in release()); zap them now.</span></span>
<span id="LC348" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">m_rtfdtm_stack</span><span class="o">!=</span><span class="kc">null</span><span class="o">)</span></span>
<span id="LC349" class="line" lang="java">                 <span class="k">for</span> <span class="o">(</span><span class="n">java</span><span class="o">.</span><span class="na">util</span><span class="o">.</span><span class="na">Enumeration</span> <span class="n">e</span> <span class="o">=</span> <span class="n">m_rtfdtm_stack</span><span class="o">.</span><span class="na">elements</span><span class="o">()</span> <span class="o">;</span> <span class="n">e</span><span class="o">.</span><span class="na">hasMoreElements</span><span class="o">()</span> <span class="o">;)</span></span>
<span id="LC350" class="line" lang="java">                        <span class="n">m_dtmManager</span><span class="o">.</span><span class="na">release</span><span class="o">((</span><span class="no">DTM</span><span class="o">)</span><span class="n">e</span><span class="o">.</span><span class="na">nextElement</span><span class="o">(),</span> <span class="kc">true</span><span class="o">);</span></span>
<span id="LC351" class="line" lang="java"></span>
<span id="LC352" class="line" lang="java">    <span class="n">m_rtfdtm_stack</span><span class="o">=</span><span class="kc">null</span><span class="o">;</span> <span class="c1">// drop our references too</span></span>
<span id="LC353" class="line" lang="java">    <span class="n">m_which_rtfdtm</span><span class="o">=-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC354" class="line" lang="java"></span>
<span id="LC355" class="line" lang="java">    <span class="k">if</span><span class="o">(</span><span class="n">m_global_rtfdtm</span><span class="o">!=</span><span class="kc">null</span><span class="o">)</span></span>
<span id="LC356" class="line" lang="java">                        <span class="n">m_dtmManager</span><span class="o">.</span><span class="na">release</span><span class="o">(</span><span class="n">m_global_rtfdtm</span><span class="o">,</span><span class="kc">true</span><span class="o">);</span></span>
<span id="LC357" class="line" lang="java">    <span class="n">m_global_rtfdtm</span><span class="o">=</span><span class="kc">null</span><span class="o">;</span></span>
<span id="LC358" class="line" lang="java"></span>
<span id="LC359" class="line" lang="java"></span>
<span id="LC360" class="line" lang="java">    <span class="n">m_dtmManager</span> <span class="o">=</span> <span class="nc">DTMManager</span><span class="o">.</span><span class="na">newInstance</span><span class="o">(</span></span>
<span id="LC361" class="line" lang="java">                   <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xpath</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">objects</span><span class="o">.</span><span class="na">XMLStringFactoryImpl</span><span class="o">.</span><span class="na">getFactory</span><span class="o">()</span></span>
<span id="LC362" class="line" lang="java">                   <span class="o">);</span></span>
<span id="LC363" class="line" lang="java"></span>
<span id="LC364" class="line" lang="java">    <span class="n">m_saxLocations</span><span class="o">.</span><span class="na">removeAllElements</span><span class="o">();</span></span>
<span id="LC365" class="line" lang="java">        <span class="n">m_axesIteratorStack</span><span class="o">.</span><span class="na">removeAllElements</span><span class="o">();</span></span>
<span id="LC366" class="line" lang="java">        <span class="n">m_contextNodeLists</span><span class="o">.</span><span class="na">removeAllElements</span><span class="o">();</span></span>
<span id="LC367" class="line" lang="java">        <span class="n">m_currentExpressionNodes</span><span class="o">.</span><span class="na">removeAllElements</span><span class="o">();</span></span>
<span id="LC368" class="line" lang="java">        <span class="n">m_currentNodes</span><span class="o">.</span><span class="na">removeAllElements</span><span class="o">();</span></span>
<span id="LC369" class="line" lang="java">        <span class="n">m_iteratorRoots</span><span class="o">.</span><span class="na">RemoveAllNoClear</span><span class="o">();</span></span>
<span id="LC370" class="line" lang="java">        <span class="n">m_predicatePos</span><span class="o">.</span><span class="na">removeAllElements</span><span class="o">();</span></span>
<span id="LC371" class="line" lang="java">        <span class="n">m_predicateRoots</span><span class="o">.</span><span class="na">RemoveAllNoClear</span><span class="o">();</span></span>
<span id="LC372" class="line" lang="java">        <span class="n">m_prefixResolvers</span><span class="o">.</span><span class="na">removeAllElements</span><span class="o">();</span></span>
<span id="LC373" class="line" lang="java"></span>
<span id="LC374" class="line" lang="java">        <span class="n">m_prefixResolvers</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="kc">null</span><span class="o">);</span></span>
<span id="LC375" class="line" lang="java">    <span class="n">m_currentNodes</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">);</span></span>
<span id="LC376" class="line" lang="java">    <span class="n">m_currentExpressionNodes</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">);</span></span>
<span id="LC377" class="line" lang="java">    <span class="n">m_saxLocations</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="kc">null</span><span class="o">);</span></span>
<span id="LC378" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC379" class="line" lang="java"></span>
<span id="LC380" class="line" lang="java">  <span class="cm">/** The current stylesheet locator. */</span></span>
<span id="LC381" class="line" lang="java">  <span class="nc">ObjectStack</span> <span class="n">m_saxLocations</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">ObjectStack</span><span class="o">(</span><span class="no">RECURSIONLIMIT</span><span class="o">);</span></span>
<span id="LC382" class="line" lang="java"></span>
<span id="LC383" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC384" class="line" lang="java"><span class="cm">   * Set the current locater in the stylesheet.</span></span>
<span id="LC385" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC386" class="line" lang="java"><span class="cm">   * @param location The location within the stylesheet.</span></span>
<span id="LC387" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC388" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSAXLocator</span><span class="o">(</span><span class="nc">SourceLocator</span> <span class="n">location</span><span class="o">)</span></span>
<span id="LC389" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC390" class="line" lang="java">    <span class="n">m_saxLocations</span><span class="o">.</span><span class="na">setTop</span><span class="o">(</span><span class="n">location</span><span class="o">);</span></span>
...
<span id="LC394" class="line" lang="java"><span class="cm">   * Set the current locater in the stylesheet.</span></span>
<span id="LC395" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC396" class="line" lang="java"><span class="cm">   * @param location The location within the stylesheet.</span></span>
<span id="LC397" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC398" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">pushSAXLocator</span><span class="o">(</span><span class="nc">SourceLocator</span> <span class="n">location</span><span class="o">)</span></span>
<span id="LC399" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC400" class="line" lang="java">    <span class="n">m_saxLocations</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="n">location</span><span class="o">);</span></span>
...
<span id="LC404" class="line" lang="java"><span class="cm">   * Push a slot on the locations stack so that setSAXLocator can be</span></span>
<span id="LC405" class="line" lang="java"><span class="cm">   * repeatedly called.</span></span>
<span id="LC406" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC407" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC408" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">pushSAXLocatorNull</span><span class="o">()</span></span>
<span id="LC409" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC410" class="line" lang="java">    <span class="n">m_saxLocations</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="kc">null</span><span class="o">);</span></span>
...
<span id="LC415" class="line" lang="java"><span class="cm">   * Pop the current locater.</span></span>
<span id="LC416" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC417" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">popSAXLocator</span><span class="o">()</span></span>
<span id="LC418" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC419" class="line" lang="java">    <span class="n">m_saxLocations</span><span class="o">.</span><span class="na">pop</span><span class="o">();</span></span>
...
<span id="LC423" class="line" lang="java"><span class="cm">   * Get the current locater in the stylesheet.</span></span>
<span id="LC424" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC425" class="line" lang="java"><span class="cm">   * @return The location within the stylesheet, or null if not known.</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC427" class="line" lang="java">  <span class="kd">public</span> <span class="nc">SourceLocator</span> <span class="nf">getSAXLocator</span><span class="o">()</span></span>
<span id="LC428" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC429" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="nc">SourceLocator</span><span class="o">)</span> <span class="n">m_saxLocations</span><span class="o">.</span><span class="na">peek</span><span class="o">();</span></span>
<span id="LC430" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC431" class="line" lang="java"></span>
<span id="LC432" class="line" lang="java">  <span class="cm">/** The owner context of this XPathContext.  In the case of XSLT, this will be a</span></span>
<span id="LC433" class="line" lang="java"><span class="cm">   *  Transformer object.</span></span>
<span id="LC434" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC435" class="line" lang="java">  <span class="kd">private</span> <span class="nc">Object</span> <span class="n">m_owner</span><span class="o">;</span></span>
<span id="LC436" class="line" lang="java"></span>
<span id="LC437" class="line" lang="java">  <span class="cm">/** The owner context of this XPathContext.  In the case of XSLT, this will be a</span></span>
<span id="LC438" class="line" lang="java"><span class="cm">   *  Transformer object.</span></span>
<span id="LC439" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC440" class="line" lang="java">  <span class="kd">private</span> <span class="nc">Method</span> <span class="n">m_ownerGetErrorListener</span><span class="o">;</span></span>
<span id="LC441" class="line" lang="java"></span>
<span id="LC442" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC443" class="line" lang="java"><span class="cm">   * Get the "owner" context of this context, which should be,</span></span>
<span id="LC444" class="line" lang="java"><span class="cm">   * in the case of XSLT, the Transformer object.  This is needed</span></span>
<span id="LC445" class="line" lang="java"><span class="cm">   * so that XSLT functions can get the Transformer.</span></span>
<span id="LC446" class="line" lang="java"><span class="cm">   * @return The owner object passed into the constructor, or null.</span></span>
<span id="LC447" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC448" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Object</span> <span class="nf">getOwnerObject</span><span class="o">()</span></span>
<span id="LC449" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC450" class="line" lang="java">    <span class="k">return</span> <span class="n">m_owner</span><span class="o">;</span></span>
<span id="LC451" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC452" class="line" lang="java"></span>
<span id="LC453" class="line" lang="java">  <span class="c1">// ================ VarStack ===================</span></span>
<span id="LC454" class="line" lang="java"></span>
<span id="LC455" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC456" class="line" lang="java"><span class="cm">   * The stack of Variable stacks.  A VariableStack will be</span></span>
<span id="LC457" class="line" lang="java"><span class="cm">   * pushed onto this stack for each template invocation.</span></span>
<span id="LC458" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC459" class="line" lang="java">  <span class="kd">private</span> <span class="nc">VariableStack</span> <span class="n">m_variableStacks</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">VariableStack</span><span class="o">();</span></span>
<span id="LC460" class="line" lang="java"></span>
<span id="LC461" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC462" class="line" lang="java"><span class="cm">   * Get the variable stack, which is in charge of variables and</span></span>
<span id="LC463" class="line" lang="java"><span class="cm">   * parameters.</span></span>
<span id="LC464" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC465" class="line" lang="java"><span class="cm">   * @return the variable stack, which should not be null.</span></span>
<span id="LC466" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC467" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">VariableStack</span> <span class="nf">getVarStack</span><span class="o">()</span></span>
<span id="LC468" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC469" class="line" lang="java">    <span class="k">return</span> <span class="n">m_variableStacks</span><span class="o">;</span></span>
...
<span id="LC473" class="line" lang="java"><span class="cm">   * Get the variable stack, which is in charge of variables and</span></span>
<span id="LC474" class="line" lang="java"><span class="cm">   * parameters.</span></span>
<span id="LC475" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC476" class="line" lang="java"><span class="cm">   * @param varStack non-null reference to the variable stack.</span></span>
<span id="LC477" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC478" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">setVarStack</span><span class="o">(</span><span class="nc">VariableStack</span> <span class="n">varStack</span><span class="o">)</span></span>
<span id="LC479" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC480" class="line" lang="java">    <span class="n">m_variableStacks</span> <span class="o">=</span> <span class="n">varStack</span><span class="o">;</span></span>
<span id="LC481" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC482" class="line" lang="java"></span>
<span id="LC483" class="line" lang="java">  <span class="c1">// ================ SourceTreeManager ===================</span></span>
<span id="LC484" class="line" lang="java"></span>
<span id="LC485" class="line" lang="java">  <span class="cm">/** The source tree manager, which associates Source objects to source</span></span>
<span id="LC486" class="line" lang="java"><span class="cm">   *  tree nodes. */</span></span>
<span id="LC487" class="line" lang="java">  <span class="kd">private</span> <span class="nc">SourceTreeManager</span> <span class="n">m_sourceTreeManager</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">SourceTreeManager</span><span class="o">();</span></span>
<span id="LC488" class="line" lang="java"></span>
<span id="LC489" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC490" class="line" lang="java"><span class="cm">   * Get the SourceTreeManager associated with this execution context.</span></span>
<span id="LC491" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC492" class="line" lang="java"><span class="cm">   * @return the SourceTreeManager associated with this execution context.</span></span>
<span id="LC493" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC494" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">SourceTreeManager</span> <span class="nf">getSourceTreeManager</span><span class="o">()</span></span>
<span id="LC495" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC496" class="line" lang="java">    <span class="k">return</span> <span class="n">m_sourceTreeManager</span><span class="o">;</span></span>
...
<span id="LC500" class="line" lang="java"><span class="cm">   * Set the SourceTreeManager associated with this execution context.</span></span>
<span id="LC501" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC502" class="line" lang="java"><span class="cm">   * @param mgr the SourceTreeManager to be associated with this</span></span>
<span id="LC503" class="line" lang="java"><span class="cm">   *        execution context.</span></span>
<span id="LC504" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC505" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSourceTreeManager</span><span class="o">(</span><span class="nc">SourceTreeManager</span> <span class="n">mgr</span><span class="o">)</span></span>
<span id="LC506" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC507" class="line" lang="java">    <span class="n">m_sourceTreeManager</span> <span class="o">=</span> <span class="n">mgr</span><span class="o">;</span></span>
...
<span id="LC512" class="line" lang="java">  <span class="cm">/** The ErrorListener where errors and warnings are to be reported.   */</span></span>
<span id="LC513" class="line" lang="java">  <span class="kd">private</span> <span class="nc">ErrorListener</span> <span class="n">m_errorListener</span><span class="o">;</span></span>
<span id="LC514" class="line" lang="java"></span>
<span id="LC515" class="line" lang="java">  <span class="cm">/** A default ErrorListener in case our m_errorListener was not specified and our</span></span>
<span id="LC516" class="line" lang="java"><span class="cm">   *  owner either does not have an ErrorListener or has a null one.</span></span>
<span id="LC517" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC518" class="line" lang="java">  <span class="kd">private</span> <span class="nc">ErrorListener</span> <span class="n">m_defaultErrorListener</span><span class="o">;</span></span>
<span id="LC519" class="line" lang="java"></span>
<span id="LC520" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC521" class="line" lang="java"><span class="cm">   * Get the ErrorListener where errors and warnings are to be reported.</span></span>
<span id="LC522" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC523" class="line" lang="java"><span class="cm">   * @return A non-null ErrorListener reference.</span></span>
<span id="LC524" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC525" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">ErrorListener</span> <span class="nf">getErrorListener</span><span class="o">()</span></span>
<span id="LC526" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC527" class="line" lang="java"></span>
<span id="LC528" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_errorListener</span><span class="o">)</span></span>
<span id="LC529" class="line" lang="java">        <span class="k">return</span> <span class="n">m_errorListener</span><span class="o">;</span></span>
<span id="LC530" class="line" lang="java"></span>
<span id="LC531" class="line" lang="java">    <span class="nc">ErrorListener</span> <span class="n">retval</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC532" class="line" lang="java"></span>
<span id="LC533" class="line" lang="java">    <span class="k">try</span> <span class="o">{</span></span>
<span id="LC534" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_ownerGetErrorListener</span><span class="o">)</span></span>
<span id="LC535" class="line" lang="java">        <span class="n">retval</span> <span class="o">=</span> <span class="o">(</span><span class="nc">ErrorListener</span><span class="o">)</span> <span class="n">m_ownerGetErrorListener</span><span class="o">.</span><span class="na">invoke</span><span class="o">(</span><span class="n">m_owner</span><span class="o">,</span> <span class="k">new</span> <span class="nc">Object</span><span class="o">[]</span> <span class="o">{});</span></span>
<span id="LC536" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC537" class="line" lang="java">    <span class="k">catch</span> <span class="o">(</span><span class="nc">Exception</span> <span class="n">e</span><span class="o">)</span> <span class="o">{}</span></span>
<span id="LC538" class="line" lang="java"></span>
<span id="LC539" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">retval</span><span class="o">)</span></span>
<span id="LC540" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC541" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_defaultErrorListener</span><span class="o">)</span></span>
<span id="LC542" class="line" lang="java">        <span class="n">m_defaultErrorListener</span> <span class="o">=</span> <span class="k">new</span> <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">utils</span><span class="o">.</span><span class="na">DefaultErrorHandler</span><span class="o">();</span></span>
<span id="LC543" class="line" lang="java">      <span class="n">retval</span> <span class="o">=</span> <span class="n">m_defaultErrorListener</span><span class="o">;</span></span>
<span id="LC544" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC545" class="line" lang="java"></span>
<span id="LC546" class="line" lang="java">    <span class="k">return</span> <span class="n">retval</span><span class="o">;</span></span>
...
<span id="LC550" class="line" lang="java"><span class="cm">   * Set the ErrorListener where errors and warnings are to be reported.</span></span>
<span id="LC551" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC552" class="line" lang="java"><span class="cm">   * @param listener A non-null ErrorListener reference.</span></span>
<span id="LC553" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC554" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setErrorListener</span><span class="o">(</span><span class="nc">ErrorListener</span> <span class="n">listener</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">IllegalArgumentException</span></span>
<span id="LC555" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC556" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">listener</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC557" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">IllegalArgumentException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NULL_ERROR_HANDLER</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"Null error handler");</span></span>
<span id="LC558" class="line" lang="java">    <span class="n">m_errorListener</span> <span class="o">=</span> <span class="n">listener</span><span class="o">;</span></span>
...
<span id="LC564" class="line" lang="java">  <span class="cm">/** The TrAX URI Resolver for resolving URIs from the document(...)</span></span>
<span id="LC565" class="line" lang="java"><span class="cm">   *  function to source tree nodes.  */</span></span>
<span id="LC566" class="line" lang="java">  <span class="kd">private</span> <span class="nc">URIResolver</span> <span class="n">m_uriResolver</span><span class="o">;</span></span>
<span id="LC567" class="line" lang="java"></span>
<span id="LC568" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC569" class="line" lang="java"><span class="cm">   * Get the URIResolver associated with this execution context.</span></span>
<span id="LC570" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC571" class="line" lang="java"><span class="cm">   * @return a URI resolver, which may be null.</span></span>
<span id="LC572" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC573" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">URIResolver</span> <span class="nf">getURIResolver</span><span class="o">()</span></span>
<span id="LC574" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC575" class="line" lang="java">    <span class="k">return</span> <span class="n">m_uriResolver</span><span class="o">;</span></span>
...
<span id="LC579" class="line" lang="java"><span class="cm">   * Set the URIResolver associated with this execution context.</span></span>
<span id="LC580" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC581" class="line" lang="java"><span class="cm">   * @param resolver the URIResolver to be associated with this</span></span>
<span id="LC582" class="line" lang="java"><span class="cm">   *        execution context, may be null to clear an already set resolver.</span></span>
<span id="LC583" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC584" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setURIResolver</span><span class="o">(</span><span class="nc">URIResolver</span> <span class="n">resolver</span><span class="o">)</span></span>
<span id="LC585" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC586" class="line" lang="java">    <span class="n">m_uriResolver</span> <span class="o">=</span> <span class="n">resolver</span><span class="o">;</span></span>
<span id="LC587" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC588" class="line" lang="java"></span>
<span id="LC589" class="line" lang="java">  <span class="c1">// =================================================</span></span>
<span id="LC590" class="line" lang="java"></span>
<span id="LC591" class="line" lang="java">  <span class="cm">/** The reader of the primary source tree.    */</span></span>
<span id="LC592" class="line" lang="java">  <span class="kd">public</span> <span class="nc">XMLReader</span> <span class="n">m_primaryReader</span><span class="o">;</span></span>
<span id="LC593" class="line" lang="java"></span>
<span id="LC594" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC595" class="line" lang="java"><span class="cm">   * Get primary XMLReader associated with this execution context.</span></span>
<span id="LC596" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC597" class="line" lang="java"><span class="cm">   * @return The reader of the primary source tree.</span></span>
<span id="LC598" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC599" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">XMLReader</span> <span class="nf">getPrimaryReader</span><span class="o">()</span></span>
<span id="LC600" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC601" class="line" lang="java">    <span class="k">return</span> <span class="n">m_primaryReader</span><span class="o">;</span></span>
...
<span id="LC605" class="line" lang="java"><span class="cm">   * Set primary XMLReader associated with this execution context.</span></span>
<span id="LC606" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC607" class="line" lang="java"><span class="cm">   * @param reader The reader of the primary source tree.</span></span>
<span id="LC608" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC609" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPrimaryReader</span><span class="o">(</span><span class="nc">XMLReader</span> <span class="n">reader</span><span class="o">)</span></span>
<span id="LC610" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC611" class="line" lang="java">    <span class="n">m_primaryReader</span> <span class="o">=</span> <span class="n">reader</span><span class="o">;</span></span>
...
<span id="LC617" class="line" lang="java">  <span class="cm">/** Misnamed string manager for XPath messages.  */</span></span>
<span id="LC618" class="line" lang="java">  <span class="c1">// private static XSLMessages m_XSLMessages = new XSLMessages();</span></span>
<span id="LC619" class="line" lang="java"></span>
<span id="LC620" class="line" lang="java">  <span class="c1">//==========================================================</span></span>
<span id="LC621" class="line" lang="java">  <span class="c1">// SECTION: Execution context state tracking</span></span>
...
<span id="LC625" class="line" lang="java"><span class="cm">   * The current context node list.</span></span>
<span id="LC626" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC627" class="line" lang="java">  <span class="kd">private</span> <span class="nc">Stack</span> <span class="n">m_contextNodeLists</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Stack</span><span class="o">();</span></span>
<span id="LC628" class="line" lang="java"></span>
<span id="LC629" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Stack</span> <span class="nf">getContextNodeListsStack</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">m_contextNodeLists</span><span class="o">;</span> <span class="o">}</span></span>
<span id="LC630" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setContextNodeListsStack</span><span class="o">(</span><span class="nc">Stack</span> <span class="n">s</span><span class="o">)</span> <span class="o">{</span> <span class="n">m_contextNodeLists</span> <span class="o">=</span> <span class="n">s</span><span class="o">;</span> <span class="o">}</span></span>
<span id="LC631" class="line" lang="java"></span>
<span id="LC632" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC633" class="line" lang="java"><span class="cm">   * Get the current context node list.</span></span>
<span id="LC634" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC635" class="line" lang="java"><span class="cm">   * @return  the &lt;a href="http://www.w3.org/TR/xslt#dt-current-node-list"&gt;current node list&lt;/a&gt;,</span></span>
<span id="LC636" class="line" lang="java"><span class="cm">   * also referred to here as a &lt;term&gt;context node list&lt;/term&gt;.</span></span>
<span id="LC637" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC638" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">DTMIterator</span> <span class="nf">getContextNodeList</span><span class="o">()</span></span>
<span id="LC639" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC640" class="line" lang="java"></span>
<span id="LC641" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">m_contextNodeLists</span><span class="o">.</span><span class="na">size</span><span class="o">()</span> <span class="o">&gt;</span> <span class="mi">0</span><span class="o">)</span></span>
<span id="LC642" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="nc">DTMIterator</span><span class="o">)</span> <span class="n">m_contextNodeLists</span><span class="o">.</span><span class="na">peek</span><span class="o">();</span></span>
...
<span id="LC648" class="line" lang="java"><span class="cm">   * Set the current context node list.</span></span>
<span id="LC649" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC650" class="line" lang="java"><span class="cm">   * @param nl the &lt;a href="http://www.w3.org/TR/xslt#dt-current-node-list"&gt;current node list&lt;/a&gt;,</span></span>
<span id="LC651" class="line" lang="java"><span class="cm">   * also referred to here as a &lt;term&gt;context node list&lt;/term&gt;.</span></span>
<span id="LC652" class="line" lang="java"><span class="cm">   * @xsl.usage internal</span></span>
<span id="LC653" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC654" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">pushContextNodeList</span><span class="o">(</span><span class="nc">DTMIterator</span> <span class="n">nl</span><span class="o">)</span></span>
<span id="LC655" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC656" class="line" lang="java">    <span class="n">m_contextNodeLists</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="n">nl</span><span class="o">);</span></span>
...
<span id="LC660" class="line" lang="java"><span class="cm">   * Pop the current context node list.</span></span>
<span id="LC661" class="line" lang="java"><span class="cm">   * @xsl.usage internal</span></span>
<span id="LC662" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC663" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">popContextNodeList</span><span class="o">()</span></span>
<span id="LC664" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC665" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">m_contextNodeLists</span><span class="o">.</span><span class="na">isEmpty</span><span class="o">())</span></span>
<span id="LC666" class="line" lang="java">          <span class="nc">System</span><span class="o">.</span><span class="na">err</span><span class="o">.</span><span class="na">println</span><span class="o">(</span><span class="s">"Warning: popContextNodeList when stack is empty!"</span><span class="o">);</span></span>
<span id="LC667" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC668" class="line" lang="java">      <span class="n">m_contextNodeLists</span><span class="o">.</span><span class="na">pop</span><span class="o">();</span></span>
...
<span id="LC672" class="line" lang="java"><span class="cm">   * The amount to use for stacks that record information during the</span></span>
<span id="LC673" class="line" lang="java"><span class="cm">   * recursive execution.</span></span>
<span id="LC674" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC675" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="no">RECURSIONLIMIT</span> <span class="o">=</span> <span class="o">(</span><span class="mi">1024</span><span class="o">*</span><span class="mi">4</span><span class="o">);</span></span>
<span id="LC676" class="line" lang="java"></span>
<span id="LC677" class="line" lang="java">  <span class="cm">/** The stack of &lt;a href="http://www.w3.org/TR/xslt#dt-current-node"&gt;current node&lt;/a&gt; objects.</span></span>
<span id="LC678" class="line" lang="java"><span class="cm">   *  Not to be confused with the current node list.  %REVIEW% Note that there</span></span>
<span id="LC679" class="line" lang="java"><span class="cm">   *  are no bounds check and resize for this stack, so if it is blown, it's all</span></span>
<span id="LC680" class="line" lang="java"><span class="cm">   *  over.  */</span></span>
<span id="LC681" class="line" lang="java">  <span class="kd">private</span> <span class="nc">IntStack</span> <span class="n">m_currentNodes</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">IntStack</span><span class="o">(</span><span class="no">RECURSIONLIMIT</span><span class="o">);</span></span>
<span id="LC682" class="line" lang="java"></span>
<span id="LC683" class="line" lang="java"><span class="c1">//  private NodeVector m_currentNodes = new NodeVector();</span></span>
<span id="LC684" class="line" lang="java"></span>
<span id="LC685" class="line" lang="java">  <span class="kd">public</span> <span class="nc">IntStack</span> <span class="nf">getCurrentNodeStack</span><span class="o">()</span> <span class="o">{</span><span class="k">return</span> <span class="n">m_currentNodes</span><span class="o">;</span> <span class="o">}</span></span>
<span id="LC686" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCurrentNodeStack</span><span class="o">(</span><span class="nc">IntStack</span> <span class="n">nv</span><span class="o">)</span> <span class="o">{</span> <span class="n">m_currentNodes</span> <span class="o">=</span> <span class="n">nv</span><span class="o">;</span> <span class="o">}</span></span>
<span id="LC687" class="line" lang="java"></span>
<span id="LC688" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC689" class="line" lang="java"><span class="cm">   * Get the current context node.</span></span>
<span id="LC690" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC691" class="line" lang="java"><span class="cm">   * @return the &lt;a href="http://www.w3.org/TR/xslt#dt-current-node"&gt;current node&lt;/a&gt;.</span></span>
<span id="LC692" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC693" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nf">getCurrentNode</span><span class="o">()</span></span>
<span id="LC694" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC695" class="line" lang="java">    <span class="k">return</span> <span class="n">m_currentNodes</span><span class="o">.</span><span class="na">peek</span><span class="o">();</span></span>
...
<span id="LC699" class="line" lang="java"><span class="cm">   * Set the current context node and expression node.</span></span>
<span id="LC700" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC701" class="line" lang="java"><span class="cm">   * @param cn the &lt;a href="http://www.w3.org/TR/xslt#dt-current-node"&gt;current node&lt;/a&gt;.</span></span>
<span id="LC702" class="line" lang="java"><span class="cm">   * @param en the sub-expression context node.</span></span>
<span id="LC703" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC704" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">pushCurrentNodeAndExpression</span><span class="o">(</span><span class="kt">int</span> <span class="n">cn</span><span class="o">,</span> <span class="kt">int</span> <span class="n">en</span><span class="o">)</span></span>
<span id="LC705" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC706" class="line" lang="java">    <span class="n">m_currentNodes</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="n">cn</span><span class="o">);</span></span>
<span id="LC707" class="line" lang="java">    <span class="n">m_currentExpressionNodes</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="n">cn</span><span class="o">);</span></span>
...
<span id="LC711" class="line" lang="java"><span class="cm">   * Set the current context node.</span></span>
<span id="LC712" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC713" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">popCurrentNodeAndExpression</span><span class="o">()</span></span>
<span id="LC714" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC715" class="line" lang="java">    <span class="n">m_currentNodes</span><span class="o">.</span><span class="na">quickPop</span><span class="o">(</span><span class="mi">1</span><span class="o">);</span></span>
<span id="LC716" class="line" lang="java">    <span class="n">m_currentExpressionNodes</span><span class="o">.</span><span class="na">quickPop</span><span class="o">(</span><span class="mi">1</span><span class="o">);</span></span>
...
<span id="LC720" class="line" lang="java"><span class="cm">   * Push the current context node, expression node, and prefix resolver.</span></span>
<span id="LC721" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC722" class="line" lang="java"><span class="cm">   * @param cn the &lt;a href="http://www.w3.org/TR/xslt#dt-current-node"&gt;current node&lt;/a&gt;.</span></span>
<span id="LC723" class="line" lang="java"><span class="cm">   * @param en the sub-expression context node.</span></span>
<span id="LC724" class="line" lang="java"><span class="cm">   * @param nc the namespace context (prefix resolver.</span></span>
<span id="LC725" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC726" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">pushExpressionState</span><span class="o">(</span><span class="kt">int</span> <span class="n">cn</span><span class="o">,</span> <span class="kt">int</span> <span class="n">en</span><span class="o">,</span> <span class="nc">PrefixResolver</span> <span class="n">nc</span><span class="o">)</span></span>
<span id="LC727" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC728" class="line" lang="java">    <span class="n">m_currentNodes</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="n">cn</span><span class="o">);</span></span>
<span id="LC729" class="line" lang="java">    <span class="n">m_currentExpressionNodes</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="n">cn</span><span class="o">);</span></span>
<span id="LC730" class="line" lang="java">    <span class="n">m_prefixResolvers</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="n">nc</span><span class="o">);</span></span>
...
<span id="LC734" class="line" lang="java"><span class="cm">   * Pop the current context node, expression node, and prefix resolver.</span></span>
<span id="LC735" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC736" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">popExpressionState</span><span class="o">()</span></span>
<span id="LC737" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC738" class="line" lang="java">    <span class="n">m_currentNodes</span><span class="o">.</span><span class="na">quickPop</span><span class="o">(</span><span class="mi">1</span><span class="o">);</span></span>
<span id="LC739" class="line" lang="java">    <span class="n">m_currentExpressionNodes</span><span class="o">.</span><span class="na">quickPop</span><span class="o">(</span><span class="mi">1</span><span class="o">);</span></span>
<span id="LC740" class="line" lang="java">    <span class="n">m_prefixResolvers</span><span class="o">.</span><span class="na">pop</span><span class="o">();</span></span>
...
<span id="LC746" class="line" lang="java"><span class="cm">   * Set the current context node.</span></span>
<span id="LC747" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC748" class="line" lang="java"><span class="cm">   * @param n the &lt;a href="http://www.w3.org/TR/xslt#dt-current-node"&gt;current node&lt;/a&gt;.</span></span>
<span id="LC749" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC750" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">pushCurrentNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC751" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC752" class="line" lang="java">    <span class="n">m_currentNodes</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="n">n</span><span class="o">);</span></span>
...
<span id="LC756" class="line" lang="java"><span class="cm">   * Pop the current context node.</span></span>
<span id="LC757" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC758" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">popCurrentNode</span><span class="o">()</span></span>
<span id="LC759" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC760" class="line" lang="java">    <span class="n">m_currentNodes</span><span class="o">.</span><span class="na">quickPop</span><span class="o">(</span><span class="mi">1</span><span class="o">);</span></span>
...
<span id="LC764" class="line" lang="java"><span class="cm">   * Set the current predicate root.</span></span>
<span id="LC765" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC766" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">pushPredicateRoot</span><span class="o">(</span><span class="kt">int</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC767" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC768" class="line" lang="java">    <span class="n">m_predicateRoots</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="n">n</span><span class="o">);</span></span>
...
<span id="LC772" class="line" lang="java"><span class="cm">   * Pop the current predicate root.</span></span>
<span id="LC773" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC774" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">popPredicateRoot</span><span class="o">()</span></span>
<span id="LC775" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC776" class="line" lang="java">    <span class="n">m_predicateRoots</span><span class="o">.</span><span class="na">popQuick</span><span class="o">();</span></span>
...
<span id="LC780" class="line" lang="java"><span class="cm">   * Get the current predicate root.</span></span>
<span id="LC781" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC782" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nf">getPredicateRoot</span><span class="o">()</span></span>
<span id="LC783" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC784" class="line" lang="java">    <span class="k">return</span> <span class="n">m_predicateRoots</span><span class="o">.</span><span class="na">peepOrNull</span><span class="o">();</span></span>
...
<span id="LC788" class="line" lang="java"><span class="cm">   * Set the current location path iterator root.</span></span>
<span id="LC789" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC790" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">pushIteratorRoot</span><span class="o">(</span><span class="kt">int</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC791" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC792" class="line" lang="java">    <span class="n">m_iteratorRoots</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="n">n</span><span class="o">);</span></span>
...
<span id="LC796" class="line" lang="java"><span class="cm">   * Pop the current location path iterator root.</span></span>
<span id="LC797" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC798" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">popIteratorRoot</span><span class="o">()</span></span>
<span id="LC799" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC800" class="line" lang="java">    <span class="n">m_iteratorRoots</span><span class="o">.</span><span class="na">popQuick</span><span class="o">();</span></span>
...
<span id="LC804" class="line" lang="java"><span class="cm">   * Get the current location path iterator root.</span></span>
<span id="LC805" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC806" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nf">getIteratorRoot</span><span class="o">()</span></span>
<span id="LC807" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC808" class="line" lang="java">    <span class="k">return</span> <span class="n">m_iteratorRoots</span><span class="o">.</span><span class="na">peepOrNull</span><span class="o">();</span></span>
<span id="LC809" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC810" class="line" lang="java"></span>
<span id="LC811" class="line" lang="java">  <span class="cm">/** A stack of the current sub-expression nodes.  */</span></span>
<span id="LC812" class="line" lang="java">  <span class="kd">private</span> <span class="nc">NodeVector</span> <span class="n">m_iteratorRoots</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">NodeVector</span><span class="o">();</span></span>
<span id="LC813" class="line" lang="java"></span>
<span id="LC814" class="line" lang="java">  <span class="cm">/** A stack of the current sub-expression nodes.  */</span></span>
<span id="LC815" class="line" lang="java">  <span class="kd">private</span> <span class="nc">NodeVector</span> <span class="n">m_predicateRoots</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">NodeVector</span><span class="o">();</span></span>
<span id="LC816" class="line" lang="java"></span>
<span id="LC817" class="line" lang="java">  <span class="cm">/** A stack of the current sub-expression nodes.  */</span></span>
<span id="LC818" class="line" lang="java">  <span class="kd">private</span> <span class="nc">IntStack</span> <span class="n">m_currentExpressionNodes</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">IntStack</span><span class="o">(</span><span class="no">RECURSIONLIMIT</span><span class="o">);</span></span>
<span id="LC819" class="line" lang="java"></span>
<span id="LC820" class="line" lang="java"></span>
<span id="LC821" class="line" lang="java">  <span class="kd">public</span> <span class="nc">IntStack</span> <span class="nf">getCurrentExpressionNodeStack</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">m_currentExpressionNodes</span><span class="o">;</span> <span class="o">}</span></span>
<span id="LC822" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCurrentExpressionNodeStack</span><span class="o">(</span><span class="nc">IntStack</span> <span class="n">nv</span><span class="o">)</span> <span class="o">{</span> <span class="n">m_currentExpressionNodes</span> <span class="o">=</span> <span class="n">nv</span><span class="o">;</span> <span class="o">}</span></span>
<span id="LC823" class="line" lang="java"></span>
<span id="LC824" class="line" lang="java">  <span class="kd">private</span> <span class="nc">IntStack</span> <span class="n">m_predicatePos</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">IntStack</span><span class="o">();</span></span>
<span id="LC825" class="line" lang="java"></span>
<span id="LC826" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nf">getPredicatePos</span><span class="o">()</span></span>
<span id="LC827" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC828" class="line" lang="java">    <span class="k">return</span> <span class="n">m_predicatePos</span><span class="o">.</span><span class="na">peek</span><span class="o">();</span></span>
<span id="LC829" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC830" class="line" lang="java"></span>
<span id="LC831" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">pushPredicatePos</span><span class="o">(</span><span class="kt">int</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC832" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC833" class="line" lang="java">    <span class="n">m_predicatePos</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="n">n</span><span class="o">);</span></span>
<span id="LC834" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC835" class="line" lang="java"></span>
<span id="LC836" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">popPredicatePos</span><span class="o">()</span></span>
<span id="LC837" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC838" class="line" lang="java">    <span class="n">m_predicatePos</span><span class="o">.</span><span class="na">pop</span><span class="o">();</span></span>
...
<span id="LC842" class="line" lang="java"><span class="cm">   * Get the current node that is the expression's context (i.e. for current() support).</span></span>
<span id="LC843" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC844" class="line" lang="java"><span class="cm">   * @return The current sub-expression node.</span></span>
<span id="LC845" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC846" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nf">getCurrentExpressionNode</span><span class="o">()</span></span>
<span id="LC847" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC848" class="line" lang="java">    <span class="k">return</span> <span class="n">m_currentExpressionNodes</span><span class="o">.</span><span class="na">peek</span><span class="o">();</span></span>
...
<span id="LC852" class="line" lang="java"><span class="cm">   * Set the current node that is the expression's context (i.e. for current() support).</span></span>
<span id="LC853" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC854" class="line" lang="java"><span class="cm">   * @param n The sub-expression node to be current.</span></span>
<span id="LC855" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC856" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">pushCurrentExpressionNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC857" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC858" class="line" lang="java">    <span class="n">m_currentExpressionNodes</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="n">n</span><span class="o">);</span></span>
...
<span id="LC862" class="line" lang="java"><span class="cm">   * Pop the current node that is the expression's context</span></span>
<span id="LC863" class="line" lang="java"><span class="cm">   * (i.e. for current() support).</span></span>
<span id="LC864" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC865" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">popCurrentExpressionNode</span><span class="o">()</span></span>
<span id="LC866" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC867" class="line" lang="java">    <span class="n">m_currentExpressionNodes</span><span class="o">.</span><span class="na">quickPop</span><span class="o">(</span><span class="mi">1</span><span class="o">);</span></span>
<span id="LC868" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC869" class="line" lang="java"></span>
<span id="LC870" class="line" lang="java">  <span class="kd">private</span> <span class="nc">ObjectStack</span> <span class="n">m_prefixResolvers</span></span>
<span id="LC871" class="line" lang="java">                                   <span class="o">=</span> <span class="k">new</span> <span class="nc">ObjectStack</span><span class="o">(</span><span class="no">RECURSIONLIMIT</span><span class="o">);</span></span>
<span id="LC872" class="line" lang="java"></span>
<span id="LC873" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC874" class="line" lang="java"><span class="cm">   * Get the current namespace context for the xpath.</span></span>
<span id="LC875" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC876" class="line" lang="java"><span class="cm">   * @return the current prefix resolver for resolving prefixes to</span></span>
<span id="LC877" class="line" lang="java"><span class="cm">   *         namespace URLs.</span></span>
<span id="LC878" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC879" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">PrefixResolver</span> <span class="nf">getNamespaceContext</span><span class="o">()</span></span>
<span id="LC880" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC881" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="nc">PrefixResolver</span><span class="o">)</span> <span class="n">m_prefixResolvers</span><span class="o">.</span><span class="na">peek</span><span class="o">();</span></span>
...
<span id="LC885" class="line" lang="java"><span class="cm">   * Get the current namespace context for the xpath.</span></span>
<span id="LC886" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC887" class="line" lang="java"><span class="cm">   * @param pr the prefix resolver to be used for resolving prefixes to</span></span>
<span id="LC888" class="line" lang="java"><span class="cm">   *         namespace URLs.</span></span>
<span id="LC889" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC890" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">setNamespaceContext</span><span class="o">(</span><span class="nc">PrefixResolver</span> <span class="n">pr</span><span class="o">)</span></span>
<span id="LC891" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC892" class="line" lang="java">    <span class="n">m_prefixResolvers</span><span class="o">.</span><span class="na">setTop</span><span class="o">(</span><span class="n">pr</span><span class="o">);</span></span>
...
<span id="LC896" class="line" lang="java"><span class="cm">   * Push a current namespace context for the xpath.</span></span>
<span id="LC897" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC898" class="line" lang="java"><span class="cm">   * @param pr the prefix resolver to be used for resolving prefixes to</span></span>
<span id="LC899" class="line" lang="java"><span class="cm">   *         namespace URLs.</span></span>
<span id="LC900" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC901" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">pushNamespaceContext</span><span class="o">(</span><span class="nc">PrefixResolver</span> <span class="n">pr</span><span class="o">)</span></span>
<span id="LC902" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC903" class="line" lang="java">    <span class="n">m_prefixResolvers</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="n">pr</span><span class="o">);</span></span>
...
<span id="LC907" class="line" lang="java"><span class="cm">   * Just increment the namespace contest stack, so that setNamespaceContext</span></span>
<span id="LC908" class="line" lang="java"><span class="cm">   * can be used on the slot.</span></span>
<span id="LC909" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC910" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">pushNamespaceContextNull</span><span class="o">()</span></span>
<span id="LC911" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC912" class="line" lang="java">    <span class="n">m_prefixResolvers</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="kc">null</span><span class="o">);</span></span>
...
<span id="LC916" class="line" lang="java"><span class="cm">   * Pop the current namespace context for the xpath.</span></span>
<span id="LC917" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC918" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">popNamespaceContext</span><span class="o">()</span></span>
<span id="LC919" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC920" class="line" lang="java">    <span class="n">m_prefixResolvers</span><span class="o">.</span><span class="na">pop</span><span class="o">();</span></span>
...
<span id="LC924" class="line" lang="java">  <span class="c1">// SECTION: Current TreeWalker contexts (for internal use)</span></span>
...
<span id="LC928" class="line" lang="java"><span class="cm">   * Stack of AxesIterators.</span></span>
<span id="LC929" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC930" class="line" lang="java">  <span class="kd">private</span> <span class="nc">Stack</span> <span class="n">m_axesIteratorStack</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Stack</span><span class="o">();</span></span>
<span id="LC931" class="line" lang="java"></span>
<span id="LC932" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Stack</span> <span class="nf">getAxesIteratorStackStacks</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">m_axesIteratorStack</span><span class="o">;</span> <span class="o">}</span></span>
<span id="LC933" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setAxesIteratorStackStacks</span><span class="o">(</span><span class="nc">Stack</span> <span class="n">s</span><span class="o">)</span> <span class="o">{</span> <span class="n">m_axesIteratorStack</span> <span class="o">=</span> <span class="n">s</span><span class="o">;</span> <span class="o">}</span></span>
<span id="LC934" class="line" lang="java"></span>
<span id="LC935" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC936" class="line" lang="java"><span class="cm">   * Push a TreeWalker on the stack.</span></span>
<span id="LC937" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC938" class="line" lang="java"><span class="cm">   * @param iter A sub-context AxesWalker.</span></span>
<span id="LC939" class="line" lang="java"><span class="cm">   * @xsl.usage internal</span></span>
<span id="LC940" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC941" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">pushSubContextList</span><span class="o">(</span><span class="nc">SubContextList</span> <span class="n">iter</span><span class="o">)</span></span>
<span id="LC942" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC943" class="line" lang="java">    <span class="n">m_axesIteratorStack</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="n">iter</span><span class="o">);</span></span>
...
<span id="LC947" class="line" lang="java"><span class="cm">   * Pop the last pushed axes iterator.</span></span>
<span id="LC948" class="line" lang="java"><span class="cm">   * @xsl.usage internal</span></span>
<span id="LC949" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC950" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">popSubContextList</span><span class="o">()</span></span>
<span id="LC951" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC952" class="line" lang="java">    <span class="n">m_axesIteratorStack</span><span class="o">.</span><span class="na">pop</span><span class="o">();</span></span>
...
<span id="LC956" class="line" lang="java"><span class="cm">   * Get the current axes iterator, or return null if none.</span></span>
<span id="LC957" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC958" class="line" lang="java"><span class="cm">   * @return the sub-context node list.</span></span>
<span id="LC959" class="line" lang="java"><span class="cm">   * @xsl.usage internal</span></span>
<span id="LC960" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC961" class="line" lang="java">  <span class="kd">public</span> <span class="nc">SubContextList</span> <span class="nf">getSubContextList</span><span class="o">()</span></span>
<span id="LC962" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC963" class="line" lang="java">    <span class="k">return</span> <span class="n">m_axesIteratorStack</span><span class="o">.</span><span class="na">isEmpty</span><span class="o">()</span></span>
<span id="LC964" class="line" lang="java">           <span class="o">?</span> <span class="kc">null</span> <span class="o">:</span> <span class="o">(</span><span class="nc">SubContextList</span><span class="o">)</span> <span class="n">m_axesIteratorStack</span><span class="o">.</span><span class="na">peek</span><span class="o">();</span></span>
...
<span id="LC968" class="line" lang="java"><span class="cm">   * Get the &lt;a href="http://www.w3.org/TR/xslt#dt-current-node-list"&gt;current node list&lt;/a&gt;</span></span>
<span id="LC969" class="line" lang="java"><span class="cm">   * as defined by the XSLT spec.</span></span>
<span id="LC970" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC971" class="line" lang="java"><span class="cm">   * @return the &lt;a href="http://www.w3.org/TR/xslt#dt-current-node-list"&gt;current node list&lt;/a&gt;.</span></span>
<span id="LC972" class="line" lang="java"><span class="cm">   * @xsl.usage internal</span></span>
<span id="LC973" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC974" class="line" lang="java"></span>
<span id="LC975" class="line" lang="java">  <span class="kd">public</span> <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xpath</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">axes</span><span class="o">.</span><span class="na">SubContextList</span> <span class="nf">getCurrentNodeList</span><span class="o">()</span></span>
<span id="LC976" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC977" class="line" lang="java">    <span class="k">return</span> <span class="n">m_axesIteratorStack</span><span class="o">.</span><span class="na">isEmpty</span><span class="o">()</span></span>
<span id="LC978" class="line" lang="java">           <span class="o">?</span> <span class="kc">null</span> <span class="o">:</span> <span class="o">(</span><span class="nc">SubContextList</span><span class="o">)</span> <span class="n">m_axesIteratorStack</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="mi">0</span><span class="o">);</span></span>
<span id="LC979" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC980" class="line" lang="java">  <span class="c1">//==========================================================</span></span>
<span id="LC981" class="line" lang="java">  <span class="c1">// SECTION: Implementation of ExpressionContext interface</span></span>
...
<span id="LC985" class="line" lang="java"><span class="cm">   * Get the current context node.</span></span>
<span id="LC986" class="line" lang="java"><span class="cm">   * @return The current context node.</span></span>
<span id="LC987" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC988" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nf">getContextNode</span><span class="o">()</span></span>
<span id="LC989" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC990" class="line" lang="java">    <span class="k">return</span> <span class="k">this</span><span class="o">.</span><span class="na">getCurrentNode</span><span class="o">();</span></span>
...
<span id="LC994" class="line" lang="java"><span class="cm">   * Get the current context node list.</span></span>
<span id="LC995" class="line" lang="java"><span class="cm">   * @return An iterator for the current context list, as</span></span>
<span id="LC996" class="line" lang="java"><span class="cm">   * defined in XSLT.</span></span>
<span id="LC997" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC998" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">DTMIterator</span> <span class="nf">getContextNodes</span><span class="o">()</span></span>
...
<span id="LC1003" class="line" lang="java">      <span class="nc">DTMIterator</span> <span class="n">cnl</span> <span class="o">=</span> <span class="n">getContextNodeList</span><span class="o">();</span></span>
<span id="LC1004" class="line" lang="java"></span>
<span id="LC1005" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">cnl</span><span class="o">)</span></span>
<span id="LC1006" class="line" lang="java">        <span class="k">return</span> <span class="n">cnl</span><span class="o">.</span><span class="na">cloneWithReset</span><span class="o">();</span></span>
<span id="LC1007" class="line" lang="java">      <span class="k">else</span></span>
<span id="LC1008" class="line" lang="java">        <span class="k">return</span> <span class="kc">null</span><span class="o">;</span>  <span class="c1">// for now... this might ought to be an empty iterator.</span></span>
<span id="LC1009" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1010" class="line" lang="java">    <span class="k">catch</span> <span class="o">(</span><span class="nc">CloneNotSupportedException</span> <span class="n">cnse</span><span class="o">)</span></span>
<span id="LC1011" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1012" class="line" lang="java">      <span class="k">return</span> <span class="kc">null</span><span class="o">;</span>  <span class="c1">// error reporting?</span></span>
...
<span id="LC1016" class="line" lang="java">  <span class="nc">XPathExpressionContext</span> <span class="n">expressionContext</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">XPathExpressionContext</span><span class="o">();</span></span>
<span id="LC1017" class="line" lang="java"></span>
<span id="LC1018" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC1019" class="line" lang="java"><span class="cm">   * The the expression context for extensions for this context.</span></span>
<span id="LC1020" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1021" class="line" lang="java"><span class="cm">   * @return An object that implements the ExpressionContext.</span></span>
<span id="LC1022" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1023" class="line" lang="java">  <span class="kd">public</span> <span class="nc">ExpressionContext</span> <span class="nf">getExpressionContext</span><span class="o">()</span></span>
<span id="LC1024" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1025" class="line" lang="java">    <span class="k">return</span> <span class="n">expressionContext</span><span class="o">;</span></span>
<span id="LC1026" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC1027" class="line" lang="java"></span>
<span id="LC1028" class="line" lang="java">  <span class="kd">public</span> <span class="kd">class</span> <span class="nc">XPathExpressionContext</span> <span class="kd">implements</span> <span class="nc">ExpressionContext</span></span>
<span id="LC1029" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1030" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1031" class="line" lang="java"><span class="cm">     * Return the XPathContext associated with this XPathExpressionContext.</span></span>
<span id="LC1032" class="line" lang="java"><span class="cm">     * Extensions should use this judiciously and only when special processing</span></span>
<span id="LC1033" class="line" lang="java"><span class="cm">     * requirements cannot be met another way.  Consider requesting an enhancement</span></span>
<span id="LC1034" class="line" lang="java"><span class="cm">     * to the ExpressionContext interface to avoid having to call this method.</span></span>
<span id="LC1035" class="line" lang="java"><span class="cm">     * @return the XPathContext associated with this XPathExpressionContext.</span></span>
<span id="LC1036" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1037" class="line" lang="java">     <span class="kd">public</span> <span class="nc">XPathContext</span> <span class="nf">getXPathContext</span><span class="o">()</span></span>
<span id="LC1038" class="line" lang="java">     <span class="o">{</span></span>
<span id="LC1039" class="line" lang="java">       <span class="k">return</span> <span class="nc">XPathContext</span><span class="o">.</span><span class="na">this</span><span class="o">;</span></span>
...
<span id="LC1043" class="line" lang="java"><span class="cm">     * Return the DTMManager object.  Though XPathContext context extends</span></span>
<span id="LC1044" class="line" lang="java"><span class="cm">     * the DTMManager, it really is a proxy for the real DTMManager.  If a</span></span>
<span id="LC1045" class="line" lang="java"><span class="cm">     * caller needs to make a lot of calls to the DTMManager, it is faster</span></span>
<span id="LC1046" class="line" lang="java"><span class="cm">     * if it gets the real one from this function.</span></span>
<span id="LC1047" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1048" class="line" lang="java">     <span class="kd">public</span> <span class="nc">DTMManager</span> <span class="nf">getDTMManager</span><span class="o">()</span></span>
<span id="LC1049" class="line" lang="java">     <span class="o">{</span></span>
<span id="LC1050" class="line" lang="java">       <span class="k">return</span> <span class="n">m_dtmManager</span><span class="o">;</span></span>
...
<span id="LC1054" class="line" lang="java"><span class="cm">     * Get the current context node.</span></span>
<span id="LC1055" class="line" lang="java"><span class="cm">     * @return The current context node.</span></span>
<span id="LC1056" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1057" class="line" lang="java">    <span class="kd">public</span> <span class="n">org</span><span class="o">.</span><span class="na">w3c</span><span class="o">.</span><span class="na">dom</span><span class="o">.</span><span class="na">Node</span> <span class="nf">getContextNode</span><span class="o">()</span></span>
<span id="LC1058" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1059" class="line" lang="java">      <span class="kt">int</span> <span class="n">context</span> <span class="o">=</span> <span class="n">getCurrentNode</span><span class="o">();</span></span>
<span id="LC1060" class="line" lang="java"></span>
<span id="LC1061" class="line" lang="java">      <span class="k">return</span> <span class="nf">getDTM</span><span class="o">(</span><span class="n">context</span><span class="o">).</span><span class="na">getNode</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
...
<span id="LC1065" class="line" lang="java"><span class="cm">     * Get the current context node list.</span></span>
<span id="LC1066" class="line" lang="java"><span class="cm">     * @return An iterator for the current context list, as</span></span>
<span id="LC1067" class="line" lang="java"><span class="cm">     * defined in XSLT.</span></span>
<span id="LC1068" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1069" class="line" lang="java">    <span class="kd">public</span> <span class="n">org</span><span class="o">.</span><span class="na">w3c</span><span class="o">.</span><span class="na">dom</span><span class="o">.</span><span class="na">traversal</span><span class="o">.</span><span class="na">NodeIterator</span> <span class="nf">getContextNodes</span><span class="o">()</span></span>
<span id="LC1070" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1071" class="line" lang="java">      <span class="k">return</span> <span class="k">new</span> <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">dtm</span><span class="o">.</span><span class="na">ref</span><span class="o">.</span><span class="na">DTMNodeIterator</span><span class="o">(</span><span class="n">getContextNodeList</span><span class="o">());</span></span>
...
<span id="LC1075" class="line" lang="java"><span class="cm">     * Get the error listener.</span></span>
<span id="LC1076" class="line" lang="java"><span class="cm">     * @return The registered error listener.</span></span>
<span id="LC1077" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1078" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ErrorListener</span> <span class="nf">getErrorListener</span><span class="o">()</span></span>
<span id="LC1079" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1080" class="line" lang="java">      <span class="k">return</span> <span class="nc">XPathContext</span><span class="o">.</span><span class="na">this</span><span class="o">.</span><span class="na">getErrorListener</span><span class="o">();</span></span>
<span id="LC1081" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1082" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1083" class="line" lang="java"><span class="cm">     * Return the state of the services mechanism feature.</span></span>
<span id="LC1084" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1085" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">overrideDefaultParser</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC1086" class="line" lang="java">        <span class="k">return</span> <span class="n">m_overrideDefaultParser</span><span class="o">;</span></span>
...
<span id="LC1090" class="line" lang="java"><span class="cm">     * Set the state of the services mechanism feature.</span></span>
<span id="LC1091" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1092" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOverrideDefaultParser</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">flag</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1093" class="line" lang="java">        <span class="n">m_overrideDefaultParser</span> <span class="o">=</span> <span class="n">flag</span><span class="o">;</span></span>
...
<span id="LC1097" class="line" lang="java"><span class="cm">     * Get the value of a node as a number.</span></span>
<span id="LC1098" class="line" lang="java"><span class="cm">     * @param n Node to be converted to a number.  May be null.</span></span>
<span id="LC1099" class="line" lang="java"><span class="cm">     * @return value of n as a number.</span></span>
<span id="LC1100" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1101" class="line" lang="java">    <span class="kd">public</span> <span class="kt">double</span> <span class="nf">toNumber</span><span class="o">(</span><span class="n">org</span><span class="o">.</span><span class="na">w3c</span><span class="o">.</span><span class="na">dom</span><span class="o">.</span><span class="na">Node</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC1102" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1103" class="line" lang="java">      <span class="c1">// %REVIEW% You can't get much uglier than this...</span></span>
<span id="LC1104" class="line" lang="java">      <span class="kt">int</span> <span class="n">nodeHandle</span> <span class="o">=</span> <span class="n">getDTMHandleFromNode</span><span class="o">(</span><span class="n">n</span><span class="o">);</span></span>
<span id="LC1105" class="line" lang="java">      <span class="no">DTM</span> <span class="n">dtm</span> <span class="o">=</span> <span class="n">getDTM</span><span class="o">(</span><span class="n">nodeHandle</span><span class="o">);</span></span>
<span id="LC1106" class="line" lang="java">      <span class="nc">XString</span> <span class="n">xobj</span> <span class="o">=</span> <span class="o">(</span><span class="nc">XString</span><span class="o">)</span><span class="n">dtm</span><span class="o">.</span><span class="na">getStringValue</span><span class="o">(</span><span class="n">nodeHandle</span><span class="o">);</span></span>
<span id="LC1107" class="line" lang="java">      <span class="k">return</span> <span class="n">xobj</span><span class="o">.</span><span class="na">num</span><span class="o">();</span></span>
...
<span id="LC1111" class="line" lang="java"><span class="cm">     * Get the value of a node as a string.</span></span>
<span id="LC1112" class="line" lang="java"><span class="cm">     * @param n Node to be converted to a string.  May be null.</span></span>
<span id="LC1113" class="line" lang="java"><span class="cm">     * @return value of n as a string, or an empty string if n is null.</span></span>
<span id="LC1114" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1115" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">toString</span><span class="o">(</span><span class="n">org</span><span class="o">.</span><span class="na">w3c</span><span class="o">.</span><span class="na">dom</span><span class="o">.</span><span class="na">Node</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC1116" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1117" class="line" lang="java">      <span class="c1">// %REVIEW% You can't get much uglier than this...</span></span>
<span id="LC1118" class="line" lang="java">      <span class="kt">int</span> <span class="n">nodeHandle</span> <span class="o">=</span> <span class="n">getDTMHandleFromNode</span><span class="o">(</span><span class="n">n</span><span class="o">);</span></span>
<span id="LC1119" class="line" lang="java">      <span class="no">DTM</span> <span class="n">dtm</span> <span class="o">=</span> <span class="n">getDTM</span><span class="o">(</span><span class="n">nodeHandle</span><span class="o">);</span></span>
<span id="LC1120" class="line" lang="java">      <span class="nc">XMLString</span> <span class="n">strVal</span> <span class="o">=</span> <span class="n">dtm</span><span class="o">.</span><span class="na">getStringValue</span><span class="o">(</span><span class="n">nodeHandle</span><span class="o">);</span></span>
<span id="LC1121" class="line" lang="java">      <span class="k">return</span> <span class="n">strVal</span><span class="o">.</span><span class="na">toString</span><span class="o">();</span></span>
...
<span id="LC1125" class="line" lang="java"><span class="cm">     * Get a variable based on it's qualified name.</span></span>
<span id="LC1126" class="line" lang="java"><span class="cm">     * @param qname The qualified name of the variable.</span></span>
<span id="LC1127" class="line" lang="java"><span class="cm">     * @return The evaluated value of the variable.</span></span>
...
<span id="LC1131" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="nc">XObject</span> <span class="nf">getVariableOrParam</span><span class="o">(</span><span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">utils</span><span class="o">.</span><span class="na">QName</span> <span class="n">qname</span><span class="o">)</span></span>
<span id="LC1132" class="line" lang="java">              <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC1133" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1134" class="line" lang="java">      <span class="k">return</span> <span class="n">m_variableStacks</span><span class="o">.</span><span class="na">getVariableOrParam</span><span class="o">(</span><span class="nc">XPathContext</span><span class="o">.</span><span class="na">this</span><span class="o">,</span> <span class="n">qname</span><span class="o">);</span></span>
...
<span id="LC1140" class="line" lang="java"><span class="cm">   * Get a DTM to be used as a container for a global Result Tree</span></span>
<span id="LC1141" class="line" lang="java"><span class="cm">   * Fragment. This will always be an instance of (derived from? equivalent to?)</span></span>
<span id="LC1142" class="line" lang="java"><span class="cm">   * SAX2DTM, since each RTF is constructed by temporarily redirecting our SAX</span></span>
<span id="LC1143" class="line" lang="java"><span class="cm">   * output to it. It may be a single DTM containing for multiple fragments,</span></span>
<span id="LC1144" class="line" lang="java"><span class="cm">   * if the implementation supports that.</span></span>
<span id="LC1145" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1146" class="line" lang="java"><span class="cm">   * Note: The distinction between this method and getRTFDTM() is that the latter</span></span>
<span id="LC1147" class="line" lang="java"><span class="cm">   * allocates space from the dynamic variable stack (m_rtfdtm_stack), which may</span></span>
<span id="LC1148" class="line" lang="java"><span class="cm">   * be pruned away again as the templates which defined those variables are exited.</span></span>
<span id="LC1149" class="line" lang="java"><span class="cm">   * Global variables may be bound late (see XUnresolvedVariable), and never want to</span></span>
<span id="LC1150" class="line" lang="java"><span class="cm">   * be discarded, hence we need to allocate them separately and don't actually need</span></span>
<span id="LC1151" class="line" lang="java"><span class="cm">   * a stack to track them.</span></span>
<span id="LC1152" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1153" class="line" lang="java"><span class="cm">   * @return a non-null DTM reference.</span></span>
<span id="LC1154" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1155" class="line" lang="java">  <span class="kd">public</span> <span class="no">DTM</span> <span class="nf">getGlobalRTFDTM</span><span class="o">()</span></span>
<span id="LC1156" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1157" class="line" lang="java">        <span class="c1">// We probably should _NOT_ be applying whitespace filtering at this stage!</span></span>
<span id="LC1158" class="line" lang="java">        <span class="c1">//</span></span>
<span id="LC1159" class="line" lang="java">        <span class="c1">// Some magic has been applied in DTMManagerDefault to recognize this set of options</span></span>
<span id="LC1160" class="line" lang="java">        <span class="c1">// and generate an instance of DTM which can contain multiple documents</span></span>
<span id="LC1161" class="line" lang="java">        <span class="c1">// (SAX2RTFDTM). Perhaps not the optimal way of achieving that result, but</span></span>
<span id="LC1162" class="line" lang="java">        <span class="c1">// I didn't want to change the manager API at this time, or expose</span></span>
<span id="LC1163" class="line" lang="java">        <span class="c1">// too many dependencies on its internals. (Ideally, I'd like to move</span></span>
<span id="LC1164" class="line" lang="java">        <span class="c1">// isTreeIncomplete all the way up to DTM, so we wouldn't need to explicitly</span></span>
<span id="LC1165" class="line" lang="java">        <span class="c1">// specify the subclass here.)</span></span>
<span id="LC1166" class="line" lang="java"></span>
<span id="LC1167" class="line" lang="java">        <span class="c1">// If it doesn't exist, or if the one already existing is in the middle of</span></span>
<span id="LC1168" class="line" lang="java">        <span class="c1">// being constructed, we need to obtain a new DTM to write into. I'm not sure</span></span>
<span id="LC1169" class="line" lang="java">        <span class="c1">// the latter will ever arise, but I'd rather be just a bit paranoid..</span></span>
<span id="LC1170" class="line" lang="java">        <span class="k">if</span><span class="o">(</span> <span class="n">m_global_rtfdtm</span><span class="o">==</span><span class="kc">null</span> <span class="o">||</span> <span class="n">m_global_rtfdtm</span><span class="o">.</span><span class="na">isTreeIncomplete</span><span class="o">()</span> <span class="o">)</span></span>
<span id="LC1171" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1172" class="line" lang="java">                <span class="n">m_global_rtfdtm</span><span class="o">=(</span><span class="no">SAX2RTFDTM</span><span class="o">)</span><span class="n">m_dtmManager</span><span class="o">.</span><span class="na">getDTM</span><span class="o">(</span><span class="kc">null</span><span class="o">,</span><span class="kc">true</span><span class="o">,</span><span class="kc">null</span><span class="o">,</span><span class="kc">false</span><span class="o">,</span><span class="kc">false</span><span class="o">);</span></span>
<span id="LC1173" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1174" class="line" lang="java">    <span class="k">return</span> <span class="n">m_global_rtfdtm</span><span class="o">;</span></span>
...
<span id="LC1181" class="line" lang="java"><span class="cm">   * Get a DTM to be used as a container for a dynamic Result Tree</span></span>
<span id="LC1182" class="line" lang="java"><span class="cm">   * Fragment. This will always be an instance of (derived from? equivalent to?)</span></span>
<span id="LC1183" class="line" lang="java"><span class="cm">   * SAX2DTM, since each RTF is constructed by temporarily redirecting our SAX</span></span>
<span id="LC1184" class="line" lang="java"><span class="cm">   * output to it. It may be a single DTM containing for multiple fragments,</span></span>
<span id="LC1185" class="line" lang="java"><span class="cm">   * if the implementation supports that.</span></span>
<span id="LC1186" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1187" class="line" lang="java"><span class="cm">   * @return a non-null DTM reference.</span></span>
<span id="LC1188" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1189" class="line" lang="java">  <span class="kd">public</span> <span class="no">DTM</span> <span class="nf">getRTFDTM</span><span class="o">()</span></span>
<span id="LC1190" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1191" class="line" lang="java">        <span class="no">SAX2RTFDTM</span> <span class="n">rtfdtm</span><span class="o">;</span></span>
<span id="LC1192" class="line" lang="java"></span>
<span id="LC1193" class="line" lang="java">        <span class="c1">// We probably should _NOT_ be applying whitespace filtering at this stage!</span></span>
<span id="LC1194" class="line" lang="java">        <span class="c1">//</span></span>
<span id="LC1195" class="line" lang="java">        <span class="c1">// Some magic has been applied in DTMManagerDefault to recognize this set of options</span></span>
<span id="LC1196" class="line" lang="java">        <span class="c1">// and generate an instance of DTM which can contain multiple documents</span></span>
<span id="LC1197" class="line" lang="java">        <span class="c1">// (SAX2RTFDTM). Perhaps not the optimal way of achieving that result, but</span></span>
<span id="LC1198" class="line" lang="java">        <span class="c1">// I didn't want to change the manager API at this time, or expose</span></span>
<span id="LC1199" class="line" lang="java">        <span class="c1">// too many dependencies on its internals. (Ideally, I'd like to move</span></span>
<span id="LC1200" class="line" lang="java">        <span class="c1">// isTreeIncomplete all the way up to DTM, so we wouldn't need to explicitly</span></span>
<span id="LC1201" class="line" lang="java">        <span class="c1">// specify the subclass here.)</span></span>
<span id="LC1202" class="line" lang="java"></span>
<span id="LC1203" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">m_rtfdtm_stack</span><span class="o">==</span><span class="kc">null</span><span class="o">)</span></span>
<span id="LC1204" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1205" class="line" lang="java">                <span class="n">m_rtfdtm_stack</span><span class="o">=</span><span class="k">new</span> <span class="nc">Vector</span><span class="o">();</span></span>
<span id="LC1206" class="line" lang="java">                <span class="n">rtfdtm</span><span class="o">=(</span><span class="no">SAX2RTFDTM</span><span class="o">)</span><span class="n">m_dtmManager</span><span class="o">.</span><span class="na">getDTM</span><span class="o">(</span><span class="kc">null</span><span class="o">,</span><span class="kc">true</span><span class="o">,</span><span class="kc">null</span><span class="o">,</span><span class="kc">false</span><span class="o">,</span><span class="kc">false</span><span class="o">);</span></span>
<span id="LC1207" class="line" lang="java">    <span class="n">m_rtfdtm_stack</span><span class="o">.</span><span class="na">addElement</span><span class="o">(</span><span class="n">rtfdtm</span><span class="o">);</span></span>
<span id="LC1208" class="line" lang="java">                <span class="o">++</span><span class="n">m_which_rtfdtm</span><span class="o">;</span></span>
<span id="LC1209" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1210" class="line" lang="java">        <span class="k">else</span> <span class="nf">if</span><span class="o">(</span><span class="n">m_which_rtfdtm</span><span class="o">&lt;</span><span class="mi">0</span><span class="o">)</span></span>
<span id="LC1211" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1212" class="line" lang="java">                <span class="n">rtfdtm</span><span class="o">=(</span><span class="no">SAX2RTFDTM</span><span class="o">)</span><span class="n">m_rtfdtm_stack</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(++</span><span class="n">m_which_rtfdtm</span><span class="o">);</span></span>
<span id="LC1213" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1214" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC1215" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1216" class="line" lang="java">                <span class="n">rtfdtm</span><span class="o">=(</span><span class="no">SAX2RTFDTM</span><span class="o">)</span><span class="n">m_rtfdtm_stack</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">m_which_rtfdtm</span><span class="o">);</span></span>
<span id="LC1217" class="line" lang="java"></span>
<span id="LC1218" class="line" lang="java">                <span class="c1">// It might already be under construction -- the classic example would be</span></span>
<span id="LC1219" class="line" lang="java">                <span class="c1">// an xsl:variable which uses xsl:call-template as part of its value. To</span></span>
<span id="LC1220" class="line" lang="java">                <span class="c1">// handle this recursion, we have to start a new RTF DTM, pushing the old</span></span>
<span id="LC1221" class="line" lang="java">                <span class="c1">// one onto a stack so we can return to it. This is not as uncommon a case</span></span>
<span id="LC1222" class="line" lang="java">                <span class="c1">// as we might wish, unfortunately, as some folks insist on coding XSLT</span></span>
<span id="LC1223" class="line" lang="java">                <span class="c1">// as if it were a procedural language...</span></span>
<span id="LC1224" class="line" lang="java">                <span class="k">if</span><span class="o">(</span><span class="n">rtfdtm</span><span class="o">.</span><span class="na">isTreeIncomplete</span><span class="o">())</span></span>
<span id="LC1225" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC1226" class="line" lang="java">                        <span class="k">if</span><span class="o">(++</span><span class="n">m_which_rtfdtm</span> <span class="o">&lt;</span> <span class="n">m_rtfdtm_stack</span><span class="o">.</span><span class="na">size</span><span class="o">())</span></span>
<span id="LC1227" class="line" lang="java">                                <span class="n">rtfdtm</span><span class="o">=(</span><span class="no">SAX2RTFDTM</span><span class="o">)</span><span class="n">m_rtfdtm_stack</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">m_which_rtfdtm</span><span class="o">);</span></span>
...
<span id="LC1230" class="line" lang="java">                                <span class="n">rtfdtm</span><span class="o">=(</span><span class="no">SAX2RTFDTM</span><span class="o">)</span><span class="n">m_dtmManager</span><span class="o">.</span><span class="na">getDTM</span><span class="o">(</span><span class="kc">null</span><span class="o">,</span><span class="kc">true</span><span class="o">,</span><span class="kc">null</span><span class="o">,</span><span class="kc">false</span><span class="o">,</span><span class="kc">false</span><span class="o">);</span></span>
<span id="LC1231" class="line" lang="java">          <span class="n">m_rtfdtm_stack</span><span class="o">.</span><span class="na">addElement</span><span class="o">(</span><span class="n">rtfdtm</span><span class="o">);</span></span>
...
<span id="LC1236" class="line" lang="java">    <span class="k">return</span> <span class="n">rtfdtm</span><span class="o">;</span></span>
<span id="LC1237" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC1238" class="line" lang="java"></span>
<span id="LC1239" class="line" lang="java">  <span class="cm">/** Push the RTFDTM's context mark, to allows discarding RTFs added after this</span></span>
<span id="LC1240" class="line" lang="java"><span class="cm">   * point. (If it doesn't exist we don't push, since we might still be able to</span></span>
<span id="LC1241" class="line" lang="java"><span class="cm">   * get away with not creating it. That requires that excessive pops be harmless.)</span></span>
<span id="LC1242" class="line" lang="java"><span class="cm">   * */</span></span>
<span id="LC1243" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">pushRTFContext</span><span class="o">()</span></span>
<span id="LC1244" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1245" class="line" lang="java">        <span class="n">m_last_pushed_rtfdtm</span><span class="o">.</span><span class="na">push</span><span class="o">(</span><span class="n">m_which_rtfdtm</span><span class="o">);</span></span>
<span id="LC1246" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="kc">null</span><span class="o">!=</span><span class="n">m_rtfdtm_stack</span><span class="o">)</span></span>
<span id="LC1247" class="line" lang="java">                <span class="o">((</span><span class="no">SAX2RTFDTM</span><span class="o">)(</span><span class="n">getRTFDTM</span><span class="o">())).</span><span class="na">pushRewindMark</span><span class="o">();</span></span>
<span id="LC1248" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC1249" class="line" lang="java"></span>
<span id="LC1250" class="line" lang="java">  <span class="cm">/** Pop the RTFDTM's context mark. This discards any RTFs added after the last</span></span>
<span id="LC1251" class="line" lang="java"><span class="cm">   * mark was set.</span></span>
<span id="LC1252" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1253" class="line" lang="java"><span class="cm">   * If there is no RTF DTM, there's nothing to pop so this</span></span>
<span id="LC1254" class="line" lang="java"><span class="cm">   * becomes a no-op. If pushes were issued before this was called, we count on</span></span>
<span id="LC1255" class="line" lang="java"><span class="cm">   * the fact that popRewindMark is defined such that overpopping just resets</span></span>
<span id="LC1256" class="line" lang="java"><span class="cm">   * to empty.</span></span>
<span id="LC1257" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1258" class="line" lang="java"><span class="cm">   * Complicating factor: We need to handle the case of popping back to a previous</span></span>
<span id="LC1259" class="line" lang="java"><span class="cm">   * RTF DTM, if one of the weird produce-an-RTF-to-build-an-RTF cases arose.</span></span>
<span id="LC1260" class="line" lang="java"><span class="cm">   * Basically: If pop says this DTM is now empty, then return to the previous</span></span>
<span id="LC1261" class="line" lang="java"><span class="cm">   * if one exists, in whatever state we left it in. UGLY, but hopefully the</span></span>
<span id="LC1262" class="line" lang="java"><span class="cm">   * situation which forces us to consider this will arise exceedingly rarely.</span></span>
<span id="LC1263" class="line" lang="java"><span class="cm">   * */</span></span>
<span id="LC1264" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">popRTFContext</span><span class="o">()</span></span>
<span id="LC1265" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1266" class="line" lang="java">        <span class="kt">int</span> <span class="n">previous</span><span class="o">=</span><span class="n">m_last_pushed_rtfdtm</span><span class="o">.</span><span class="na">pop</span><span class="o">();</span></span>
<span id="LC1267" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="kc">null</span><span class="o">==</span><span class="n">m_rtfdtm_stack</span><span class="o">)</span></span>
<span id="LC1268" class="line" lang="java">                <span class="k">return</span><span class="o">;</span></span>
<span id="LC1269" class="line" lang="java"></span>
<span id="LC1270" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">m_which_rtfdtm</span><span class="o">==</span><span class="n">previous</span><span class="o">)</span></span>
<span id="LC1271" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1272" class="line" lang="java">                <span class="k">if</span><span class="o">(</span><span class="n">previous</span><span class="o">&gt;=</span><span class="mi">0</span><span class="o">)</span> <span class="c1">// guard against none-active</span></span>
<span id="LC1273" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC1274" class="line" lang="java">                        <span class="kt">boolean</span> <span class="n">isEmpty</span><span class="o">=((</span><span class="no">SAX2RTFDTM</span><span class="o">)(</span><span class="n">m_rtfdtm_stack</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">previous</span><span class="o">))).</span><span class="na">popRewindMark</span><span class="o">();</span></span>
<span id="LC1275" class="line" lang="java">                <span class="o">}</span></span>
<span id="LC1276" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1277" class="line" lang="java">        <span class="k">else</span> <span class="nf">while</span><span class="o">(</span><span class="n">m_which_rtfdtm</span><span class="o">!=</span><span class="n">previous</span><span class="o">)</span></span>
<span id="LC1278" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1279" class="line" lang="java">                <span class="c1">// Empty each DTM before popping, so it's ready for reuse</span></span>
<span id="LC1280" class="line" lang="java">                <span class="c1">// _DON'T_ pop the previous, since it's still open (which is why we</span></span>
<span id="LC1281" class="line" lang="java">                <span class="c1">// stacked up more of these) and did not receive a mark.</span></span>
<span id="LC1282" class="line" lang="java">                <span class="kt">boolean</span> <span class="n">isEmpty</span><span class="o">=((</span><span class="no">SAX2RTFDTM</span><span class="o">)(</span><span class="n">m_rtfdtm_stack</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">m_which_rtfdtm</span><span class="o">))).</span><span class="na">popRewindMark</span><span class="o">();</span></span>
<span id="LC1283" class="line" lang="java">                <span class="o">--</span><span class="n">m_which_rtfdtm</span><span class="o">;</span></span>
...
<span id="LC1288" class="line" lang="java"><span class="cm">   * Gets DTMXRTreeFrag object if one has already been created.</span></span>
<span id="LC1289" class="line" lang="java"><span class="cm">   * Creates new DTMXRTreeFrag object and adds to m_DTMXRTreeFrags  HashMap,</span></span>
<span id="LC1290" class="line" lang="java"><span class="cm">   * otherwise.</span></span>
<span id="LC1291" class="line" lang="java"><span class="cm">   * @param dtmIdentity</span></span>
<span id="LC1292" class="line" lang="java"><span class="cm">   * @return DTMXRTreeFrag</span></span>
<span id="LC1293" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1294" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMXRTreeFrag</span> <span class="nf">getDTMXRTreeFrag</span><span class="o">(</span><span class="kt">int</span> <span class="n">dtmIdentity</span><span class="o">){</span></span>
<span id="LC1295" class="line" lang="java">    <span class="k">if</span><span class="o">(</span><span class="n">m_DTMXRTreeFrags</span> <span class="o">==</span> <span class="kc">null</span><span class="o">){</span></span>
<span id="LC1296" class="line" lang="java">      <span class="n">m_DTMXRTreeFrags</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">HashMap</span><span class="o">();</span></span>
<span id="LC1297" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1298" class="line" lang="java"></span>
<span id="LC1299" class="line" lang="java">    <span class="k">if</span><span class="o">(</span><span class="n">m_DTMXRTreeFrags</span><span class="o">.</span><span class="na">containsKey</span><span class="o">(</span><span class="k">new</span> <span class="nc">Integer</span><span class="o">(</span><span class="n">dtmIdentity</span><span class="o">))){</span></span>
<span id="LC1300" class="line" lang="java">       <span class="k">return</span> <span class="o">(</span><span class="nc">DTMXRTreeFrag</span><span class="o">)</span><span class="n">m_DTMXRTreeFrags</span><span class="o">.</span><span class="na">get</span><span class="o">(</span><span class="k">new</span> <span class="nc">Integer</span><span class="o">(</span><span class="n">dtmIdentity</span><span class="o">));</span></span>
<span id="LC1301" class="line" lang="java">    <span class="o">}</span><span class="k">else</span><span class="o">{</span></span>
<span id="LC1302" class="line" lang="java">      <span class="kd">final</span> <span class="nc">DTMXRTreeFrag</span> <span class="n">frag</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DTMXRTreeFrag</span><span class="o">(</span><span class="n">dtmIdentity</span><span class="o">,</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC1303" class="line" lang="java">      <span class="n">m_DTMXRTreeFrags</span><span class="o">.</span><span class="na">put</span><span class="o">(</span><span class="k">new</span> <span class="nc">Integer</span><span class="o">(</span><span class="n">dtmIdentity</span><span class="o">),</span><span class="n">frag</span><span class="o">);</span></span>
<span id="LC1304" class="line" lang="java">      <span class="k">return</span> <span class="n">frag</span> <span class="o">;</span></span>
...
<span id="LC1309" class="line" lang="java"><span class="cm">   * Cleans DTMXRTreeFrag objects by removing references</span></span>
<span id="LC1310" class="line" lang="java"><span class="cm">   * to DTM and XPathContext objects.</span></span>
<span id="LC1311" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1312" class="line" lang="java">  <span class="kd">private</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">releaseDTMXRTreeFrags</span><span class="o">(){</span></span>
<span id="LC1313" class="line" lang="java">    <span class="k">if</span><span class="o">(</span><span class="n">m_DTMXRTreeFrags</span> <span class="o">==</span> <span class="kc">null</span><span class="o">){</span></span>
...
<span id="LC1316" class="line" lang="java">    <span class="kd">final</span> <span class="nc">Iterator</span> <span class="n">iter</span> <span class="o">=</span> <span class="o">(</span><span class="n">m_DTMXRTreeFrags</span><span class="o">.</span><span class="na">values</span><span class="o">()).</span><span class="na">iterator</span><span class="o">();</span></span>
<span id="LC1317" class="line" lang="java">    <span class="k">while</span><span class="o">(</span><span class="n">iter</span><span class="o">.</span><span class="na">hasNext</span><span class="o">()){</span></span>
<span id="LC1318" class="line" lang="java">      <span class="nc">DTMXRTreeFrag</span> <span class="n">frag</span> <span class="o">=</span> <span class="o">(</span><span class="nc">DTMXRTreeFrag</span><span class="o">)</span><span class="n">iter</span><span class="o">.</span><span class="na">next</span><span class="o">();</span></span>
<span id="LC1319" class="line" lang="java">      <span class="n">frag</span><span class="o">.</span><span class="na">destruct</span><span class="o">();</span></span>
<span id="LC1320" class="line" lang="java">      <span class="n">iter</span><span class="o">.</span><span class="na">remove</span><span class="o">();</span></span>
<span id="LC1321" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1322" class="line" lang="java">    <span class="n">m_DTMXRTreeFrags</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
