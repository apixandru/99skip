...
<span id="LC34" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XPATHErrorResources_it</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span></span>
...
<span id="LC361" class="line" lang="java">  <span class="o">{</span> <span class="no">ER_CURRENT_NOT_ALLOWED_IN_MATCH</span><span class="o">,</span> <span class="s">"La funzione current() non \u00E8 consentita in un pattern di corrispondenza."</span> <span class="o">},</span></span>
<span id="LC362" class="line" lang="java"></span>
<span id="LC363" class="line" lang="java">  <span class="o">{</span> <span class="no">ER_CURRENT_TAKES_NO_ARGS</span><span class="o">,</span> <span class="s">"La funzione current() non accetta argomenti."</span> <span class="o">},</span></span>
...
<span id="LC366" class="line" lang="java">      <span class="s">"L'implementazione della funzione document() \u00E8 stata sostituita da com.sun.org.apache.xalan.internal.xslt.FuncDocument."</span><span class="o">},</span></span>
...
<span id="LC369" class="line" lang="java">      <span class="s">"il contesto non dispone di un documento proprietario."</span><span class="o">},</span></span>
...
<span id="LC372" class="line" lang="java">      <span class="s">"local-name() contiene troppi argomenti."</span><span class="o">},</span></span>
...
<span id="LC375" class="line" lang="java">      <span class="s">"namespace-uri() contiene troppi argomenti."</span><span class="o">},</span></span>
...
<span id="LC378" class="line" lang="java">      <span class="s">"normalize-space() contiene troppi argomenti."</span><span class="o">},</span></span>
...
<span id="LC381" class="line" lang="java">      <span class="s">"number() contiene troppi argomenti."</span><span class="o">},</span></span>
...
<span id="LC384" class="line" lang="java">     <span class="s">"name() contiene troppi argomenti."</span><span class="o">},</span></span>
...
<span id="LC387" class="line" lang="java">      <span class="s">"string() contiene troppi argomenti."</span><span class="o">},</span></span>
...
<span id="LC390" class="line" lang="java">      <span class="s">"string-length() contiene troppi argomenti."</span><span class="o">},</span></span>
...
<span id="LC393" class="line" lang="java">      <span class="s">"La funzione translate() ha tre argomenti."</span><span class="o">},</span></span>
...
<span id="LC396" class="line" lang="java">      <span class="s">"La funzione unparsed-entity-uri deve avere un solo argomento."</span><span class="o">},</span></span>
...
<span id="LC399" class="line" lang="java">      <span class="s">"l'asse dello spazio di nomi non \u00E8 ancora implementato."</span><span class="o">},</span></span>
...
<span id="LC402" class="line" lang="java">     <span class="s">"asse sconosciuto: {0}"</span><span class="o">},</span></span>
...
<span id="LC405" class="line" lang="java">     <span class="s">"operazione di corrispondenza sconosciuta."</span><span class="o">},</span></span>
...
<span id="LC408" class="line" lang="java">      <span class="s">"La lunghezza degli argomenti del testo del nodo processing-instruction() \u00E8 errata."</span><span class="o">},</span></span>
...
<span id="LC411" class="line" lang="java">      <span class="s">"Impossibile convertire {0} in un numero"</span><span class="o">},</span></span>
...
<span id="LC414" class="line" lang="java">      <span class="s">"Impossibile convertire {0} in NodeList."</span><span class="o">},</span></span>
...
<span id="LC417" class="line" lang="java">      <span class="s">"Impossibile convertire {0} in NodeSetDTM."</span><span class="o">},</span></span>
...
<span id="LC420" class="line" lang="java">      <span class="s">"Impossibile convertire {0} in type#{1}"</span><span class="o">},</span></span>
...
<span id="LC423" class="line" lang="java">      <span class="s">"\u00C8 previsto un pattern di corrispondenza in getMatchScore."</span><span class="o">},</span></span>
...
<span id="LC426" class="line" lang="java">      <span class="s">"Impossibile recuperare la variabile denominata {0}"</span><span class="o">},</span></span>
...
<span id="LC429" class="line" lang="java">     <span class="s">"ERRORE. Codice di operazione sconosciuto: {0}"</span><span class="o">},</span></span>
...
<span id="LC432" class="line" lang="java">     <span class="s">"Esistono altri token non validi: {0}"</span><span class="o">},</span></span>
...
<span id="LC435" class="line" lang="java">      <span class="s">"valore non tra apici... sono previste le virgolette."</span><span class="o">},</span></span>
...
<span id="LC438" class="line" lang="java">      <span class="s">"valore non tra apici... \u00E8 previsto un apice."</span><span class="o">},</span></span>
...
<span id="LC441" class="line" lang="java">     <span class="s">"Espressione vuota."</span><span class="o">},</span></span>
...
<span id="LC444" class="line" lang="java">     <span class="s">"Previsto {0}, trovato {1}."</span><span class="o">},</span></span>
...
<span id="LC447" class="line" lang="java">      <span class="s">"L''asserzione del programmatore \u00E8 errata - {0}"</span><span class="o">},</span></span>
...
<span id="LC450" class="line" lang="java">      <span class="s">"L'argomento boolean(...) non \u00E8 pi\u00F9 facoltativo nella bozza XPath 19990709."</span><span class="o">},</span></span>
...
<span id="LC453" class="line" lang="java">      <span class="s">"\u00C8 stata trovata la virgola (','), ma non l'argomento che la precede."</span><span class="o">},</span></span>
...
<span id="LC456" class="line" lang="java">      <span class="s">"\u00C8 stata trovata la virgola (','), ma non l'argomento che la segue."</span><span class="o">},</span></span>
...
<span id="LC459" class="line" lang="java">      <span class="s">"'..[predicate]' o '.[predicate]' \u00E8 una sintassi non valida.  Utilizzare 'self::node()[predicate]'."</span><span class="o">},</span></span>
...
<span id="LC462" class="line" lang="java">     <span class="s">"nome asse non valido: {0}"</span><span class="o">},</span></span>
...
<span id="LC465" class="line" lang="java">     <span class="s">"Tipo di nodo sconosciuto: {0}"</span><span class="o">},</span></span>
...
<span id="LC468" class="line" lang="java">      <span class="s">"Il valore del pattern ({0}) deve essere compreso tra apici."</span><span class="o">},</span></span>
...
<span id="LC471" class="line" lang="java">      <span class="s">"Impossibile formattare {0} in un numero."</span><span class="o">},</span></span>
...
<span id="LC474" class="line" lang="java">      <span class="s">"Impossibile creare la relazione TransformerFactory XML {0}"</span><span class="o">},</span></span>
...
<span id="LC477" class="line" lang="java">      <span class="s">"Errore. L'espressione di selezione dell'xpath (-select) non \u00E8 stata trovata."</span><span class="o">},</span></span>
...
<span id="LC480" class="line" lang="java">      <span class="s">"ERRORE. Impossibile trovare ENDOP dopo OP_LOCATIONPATH."</span><span class="o">},</span></span>
...
<span id="LC483" class="line" lang="java">     <span class="s">"Si \u00E8 verificato un errore."</span><span class="o">},</span></span>
...
<span id="LC486" class="line" lang="java">      <span class="s">"Il valore di VariableReference specificato per la variabile \u00E8 fuori contesto o senza definizione. Nome = {0}"</span><span class="o">},</span></span>
...
<span id="LC489" class="line" lang="java">      <span class="s">"Solo gli assi child:: e attribute:: sono consentiti nei pattern di corrispondenza. Assi errati = {0}"</span><span class="o">},</span></span>
...
<span id="LC492" class="line" lang="java">      <span class="s">"key() contiene un numero di argomenti errato."</span><span class="o">},</span></span>
...
<span id="LC495" class="line" lang="java">      <span class="s">"La funzione count deve avere un solo argomento."</span><span class="o">},</span></span>
...
<span id="LC498" class="line" lang="java">     <span class="s">"Impossibile trovare la funzione {0}"</span><span class="o">},</span></span>
...
<span id="LC501" class="line" lang="java">     <span class="s">"Codifica non supportata: {0}"</span><span class="o">},</span></span>
...
<span id="LC504" class="line" lang="java">      <span class="s">"Si \u00E8 verificato un problema in DTM in getNextSibling... Tentativo di recupero in corso."</span><span class="o">},</span></span>
...
<span id="LC507" class="line" lang="java">      <span class="s">"Errore del programmatore: impossibile scrivere EmptyNodeList."</span><span class="o">},</span></span>
...
<span id="LC510" class="line" lang="java">      <span class="s">"setDOMFactory non supportato da XPathContext"</span><span class="o">},</span></span>
...
<span id="LC513" class="line" lang="java">      <span class="s">"Il prefisso deve essere risolto in uno spazio di nomi: {0}"</span><span class="o">},</span></span>
...
<span id="LC516" class="line" lang="java">      <span class="s">"analisi (origine InputSource) non supportata in XPathContext. Impossibile aprire {0}."</span><span class="o">},</span></span>
...
<span id="LC519" class="line" lang="java">      <span class="s">"Caratteri API SAX (char ch[]... non gestiti da DTM."</span><span class="o">},</span></span>
...
<span id="LC522" class="line" lang="java">      <span class="s">"ignorableWhitespace(char ch[]... non gestito da DTM."</span><span class="o">},</span></span>
...
<span id="LC525" class="line" lang="java">      <span class="s">"DTMLiaison non pu\u00F2 gestire i nodi di tipo {0}"</span><span class="o">},</span></span>
...
<span id="LC528" class="line" lang="java">      <span class="s">"DOM2Helper non pu\u00F2 gestire i nodi di tipo {0}"</span><span class="o">},</span></span>
...
<span id="LC531" class="line" lang="java">      <span class="s">"Errore DOM2Helper.parse: SystemID - {0} Riga - {1}"</span><span class="o">},</span></span>
...
<span id="LC534" class="line" lang="java">     <span class="s">"Errore DOM2Helper.parse"</span><span class="o">},</span></span>
...
<span id="LC537" class="line" lang="java">      <span class="s">"Rilevato surrogato UTF-16 non valido: {0}?"</span><span class="o">},</span></span>
...
<span id="LC540" class="line" lang="java">     <span class="s">"Errore IO"</span><span class="o">},</span></span>
...
<span id="LC543" class="line" lang="java">     <span class="s">"Impossibile creare l''URL per {0}"</span><span class="o">},</span></span>
...
<span id="LC546" class="line" lang="java">     <span class="s">"In XPath.readObject: {0}"</span><span class="o">},</span></span>
...
<span id="LC549" class="line" lang="java">      <span class="s">"token di funzione non trovato."</span><span class="o">},</span></span>
...
<span id="LC552" class="line" lang="java">       <span class="s">"Impossibile utilizzare il tipo XPath: {0}"</span><span class="o">},</span></span>
...
<span id="LC555" class="line" lang="java">       <span class="s">"Impossibile modificare questo NodeSet"</span><span class="o">},</span></span>
...
<span id="LC558" class="line" lang="java">       <span class="s">"Impossibile modificare questo NodeSetDTM"</span><span class="o">},</span></span>
...
<span id="LC561" class="line" lang="java">        <span class="s">"Impossibile risolvere la variabile: {0}"</span><span class="o">},</span></span>
...
<span id="LC564" class="line" lang="java">        <span class="s">"Handler degli errori nullo"</span><span class="o">},</span></span>
...
<span id="LC567" class="line" lang="java">       <span class="s">"Asserzione del programmatore: opcode {0} sconosciuto"</span><span class="o">},</span></span>
...
<span id="LC573" class="line" lang="java">       <span class="s">"rtf() non supportato da XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC576" class="line" lang="java">       <span class="s">"asNodeIterator() non supportato da XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC580" class="line" lang="java">                <span class="s">"detach() non supportato da XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC584" class="line" lang="java">                <span class="s">"num() non supportato da XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC588" class="line" lang="java">                <span class="s">"xstr() non supportato da XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC592" class="line" lang="java">                <span class="s">"str() non supportato da XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC595" class="line" lang="java">       <span class="s">"fsb() non supportato per XStringForChars"</span><span class="o">},</span></span>
...
<span id="LC598" class="line" lang="java">      <span class="s">"Impossibile trovare la variabile con nome {0}"</span><span class="o">},</span></span>
...
<span id="LC601" class="line" lang="java">      <span class="s">"XStringForChars non pu\u00F2 avere una stringa per un argomento"</span><span class="o">},</span></span>
...
<span id="LC604" class="line" lang="java">      <span class="s">"L'argomento FastStringBuffer non pu\u00F2 essere nullo"</span><span class="o">},</span></span>
...
<span id="LC610" class="line" lang="java">       <span class="s">"Accesso alla variabile eseguito prima che fosse associata."</span><span class="o">},</span></span>
...
<span id="LC613" class="line" lang="java">       <span class="s">"XStringForFSB non pu\u00F2 avere una stringa per un argomento"</span><span class="o">},</span></span>
...
<span id="LC616" class="line" lang="java">       <span class="s">"\n !!!! Errore. Si sta impostando radice di un walker su un valore nullo."</span><span class="o">},</span></span>
...
<span id="LC619" class="line" lang="java">       <span class="s">"Questo NodeSetDTM non pu\u00F2 eseguire un'iterazione a un nodo precedente."</span><span class="o">},</span></span>
...
<span id="LC622" class="line" lang="java">       <span class="s">"Questo NodeSet non pu\u00F2 eseguire un'iterazione a un nodo precedente."</span><span class="o">},</span></span>
...
<span id="LC625" class="line" lang="java">       <span class="s">"Questo NodeSetDTM non pu\u00F2 eseguire l'indicizzazione o il conteggio delle funzioni."</span><span class="o">},</span></span>
...
<span id="LC628" class="line" lang="java">       <span class="s">"Questo NodeSet non pu\u00F2 eseguire l'indicizzazione o il conteggio delle funzioni."</span><span class="o">},</span></span>
...
<span id="LC631" class="line" lang="java">       <span class="s">"Impossibile richiamare setShouldCacheNodes dopo aver richiamato nextNode."</span><span class="o">},</span></span>
...
<span id="LC634" class="line" lang="java">       <span class="s">"{0} consente solo {1} argomenti"</span><span class="o">},</span></span>
...
<span id="LC637" class="line" lang="java">       <span class="s">"Asserzione del programmatore in getNextStepPos: stepType {0} sconosciuto"</span><span class="o">},</span></span>
...
<span id="LC643" class="line" lang="java">      <span class="s">"\u00C8 previsto un percorso di posizione relativa dopo il token '/' o '//'."</span><span class="o">},</span></span>
...
<span id="LC649" class="line" lang="java">       <span class="s">"\u00C8 previsto un percorso di posizione, ma \u00E8 stato trovato il seguente token:  {0}"</span><span class="o">},</span></span>
...
<span id="LC655" class="line" lang="java">       <span class="s">"\u00C8 previsto un percorso di posizione, ma \u00E8 stata trovata la fine dell'espressione XPath."</span><span class="o">},</span></span>
...
<span id="LC661" class="line" lang="java">       <span class="s">"\u00C8 previsto un passo di posizione dopo il token '/' o '//'."</span><span class="o">},</span></span>
...
<span id="LC668" class="line" lang="java">       <span class="s">"\u00C8 previsto un test del nodo che corrisponda a NCName:* o a QName."</span><span class="o">},</span></span>
...
<span id="LC674" class="line" lang="java">       <span class="s">"\u00C8 previsto un pattern di passo, ma \u00E8 stato trovato '/'."</span><span class="o">},</span></span>
...
<span id="LC680" class="line" lang="java">       <span class="s">"\u00C8 previsto un pattern di percorso relativo."</span><span class="o">},</span></span>
...
<span id="LC686" class="line" lang="java">       <span class="s">"XPathResult dell''espressione XPath ''{0}'' a un valore di XPathResultType pari a {1} che non pu\u00F2 essere convertito in un valore booleano."</span><span class="o">},</span></span>
...
<span id="LC691" class="line" lang="java">       <span class="s">"XPathResult dell''espressione XPath ''{0}'' a un valore di XPathResultType pari a {1} che non pu\u00F2 essere convertito in un nodo singolo. Il metodo getSingleNodeValue \u00E8 valido solo per i tipi ANY_UNORDERED_NODE_TYPE e FIRST_ORDERED_NODE_TYPE."</span><span class="o">},</span></span>
...
<span id="LC699" class="line" lang="java">       <span class="s">"Impossibile richiamare il metodo iterateNext nell''XPathResult dell''espressione XPath ''{0}'' poich\u00E9 il valore di XPathResultType \u00E8 {1}. Questo metodo \u00E8 valido solo per i tipi UNORDERED_NODE_ITERATOR_TYPE e ORDERED_NODE_ITERATOR_TYPE."</span><span class="o">},</span></span>
...
<span id="LC705" class="line" lang="java">       <span class="s">"Il documento \u00E8 cambiato da quando \u00E8 stato restituito l'ultimo risultato. L'iteratore non \u00E8 valido."</span><span class="o">},</span></span>
...
<span id="LC708" class="line" lang="java">       <span class="s">"Tipo di argomento XPath non valido: {0}"</span><span class="o">},</span></span>
...
<span id="LC711" class="line" lang="java">       <span class="s">"Oggetto risultati XPath vuoto"</span><span class="o">},</span></span>
...
<span id="LC714" class="line" lang="java">       <span class="s">"XPathResult dell''espressione XPath ''{0}'' a un valore di XPathResultType pari a {1} che non pu\u00F2 essere convertito forzatamente nel valore XPathResultType {2}."</span><span class="o">},</span></span>
...
<span id="LC717" class="line" lang="java">       <span class="s">"Impossibile risolvere il prefisso con un resolver di prefissi nullo."</span><span class="o">},</span></span>
...
<span id="LC723" class="line" lang="java">       <span class="s">"XPathResult dell''espressione XPath ''{0}'' a un valore di XPathResultType pari a {1} che non pu\u00F2 essere convertito in una stringa."</span><span class="o">},</span></span>
...
<span id="LC728" class="line" lang="java">       <span class="s">"Impossibile richiamare il metodo snapshotItem nell''XPathResult dell''espressione XPath ''{0}'' poich\u00E9 il valore di XPathResultType \u00E8 {1}. Questo metodo \u00E8 valido solo per i tipi UNORDERED_NODE_SNAPSHOT_TYPE e ORDERED_NODE_SNAPSHOT_TYPE."</span><span class="o">},</span></span>
...
<span id="LC735" class="line" lang="java">       <span class="s">"Il nodo di contesto non appartiene al documento associato a questo XPathEvaluator."</span><span class="o">},</span></span>
...
<span id="LC740" class="line" lang="java">       <span class="s">"Il tipo di nodo di contesto non \u00E8 supportato."</span><span class="o">},</span></span>
...
<span id="LC743" class="line" lang="java">       <span class="s">"Errore sconosciuto nell'XPath."</span><span class="o">},</span></span>
...
<span id="LC746" class="line" lang="java">        <span class="s">"XPathResult dell''espressione XPath ''{0}'' a un valore di XPathResultType pari a {1} che non pu\u00F2 essere convertito in un numero."</span><span class="o">},</span></span>
...
<span id="LC753" class="line" lang="java">       <span class="s">"Impossibile richiamare la funzione di estensione ''{0}'' se la funzione XMLConstants.FEATURE_SECURE_PROCESSING \u00E8 impostata su true."</span><span class="o">},</span></span>
...
<span id="LC758" class="line" lang="java">       <span class="s">"resolveVariable per la variabile {0} ha restituito un valore nullo"</span><span class="o">},</span></span>
...
<span id="LC763" class="line" lang="java">       <span class="s">"Tipo restituito non supportato: {0}"</span><span class="o">},</span></span>
...
<span id="LC768" class="line" lang="java">       <span class="s">"Il tipo di origine e/o restituito non pu\u00F2 essere nullo"</span><span class="o">},</span></span>
...
<span id="LC773" class="line" lang="java">       <span class="s">"Il tipo di origine e/o restituito non pu\u00F2 essere nullo"</span><span class="o">},</span></span>
...
<span id="LC778" class="line" lang="java">       <span class="s">"L''argomento {0} non pu\u00F2 essere nullo"</span><span class="o">},</span></span>
...
<span id="LC783" class="line" lang="java">       <span class="s">"{0}#isObjectModelSupported( String objectModel ) non pu\u00F2 essere richiamato se objectModel == null"</span><span class="o">},</span></span>
...
<span id="LC788" class="line" lang="java">       <span class="s">"{0}#isObjectModelSupported( String objectModel ) non pu\u00F2 essere richiamato se objectModel == \"\""</span><span class="o">},</span></span>
...
<span id="LC793" class="line" lang="java">       <span class="s">"Tentativo di impostare una funzione con nome nullo: {0}#setFeature( null, {1})"</span><span class="o">},</span></span>
...
<span id="LC798" class="line" lang="java">       <span class="s">"Tentativo di impostare la funzione sconosciuta \"{0}\":{1}#setFeature({0},{2})"</span><span class="o">},</span></span>
...
<span id="LC803" class="line" lang="java">       <span class="s">"Tentativo di recuperare una funzione con nome nullo: {0}#getFeature(null)"</span><span class="o">},</span></span>
...
<span id="LC808" class="line" lang="java">       <span class="s">"Tentativo di recuperare la funzione sconosciuta \"{0}\":{1}#getFeature({0})"</span><span class="o">},</span></span>
...
<span id="LC811" class="line" lang="java">        <span class="s">"FEATURE_SECURE_PROCESSING: impossibile impostare la funzione su false se \u00E8 presente Security Manager: {1}#setFeature({0},{2})"</span><span class="o">},</span></span>
...
<span id="LC816" class="line" lang="java">       <span class="s">"Tentativo di impostare un valore  nullo per XPathFunctionResolver:{0}#setXPathFunctionResolver(null)"</span><span class="o">},</span></span>
...
<span id="LC821" class="line" lang="java">       <span class="s">"Tentativo di impostare un valore  nullo per XPathVariableResolver:{0}#setXPathVariableResolver(null)"</span><span class="o">},</span></span>
...
<span id="LC828" class="line" lang="java">      <span class="s">"il nome di impostazioni nazionali nella funzione format-number non \u00E8 ancora gestito."</span><span class="o">},</span></span>
...
<span id="LC831" class="line" lang="java">      <span class="s">"Propriet\u00E0 XSL non supportata: {0}"</span><span class="o">},</span></span>
...
<span id="LC834" class="line" lang="java">      <span class="s">"Non effettuare alcuna operazione sullo spazio di nomi {0} nella propriet\u00E0: {1}"</span><span class="o">},</span></span>
...
<span id="LC837" class="line" lang="java">      <span class="s">"SecurityException nel tentativo di accedere alla propriet\u00E0 di sistema XSL {0}"</span><span class="o">},</span></span>
...
<span id="LC840" class="line" lang="java">      <span class="s">"Sintassi obsoleta: quo(...) non \u00E8 pi\u00F9 definito nell'XPath."</span><span class="o">},</span></span>
...
<span id="LC843" class="line" lang="java">      <span class="s">"L'XPath richiede un oggetto derivato che implementi nodeTest."</span><span class="o">},</span></span>
...
<span id="LC846" class="line" lang="java">      <span class="s">"token di funzione non trovato."</span><span class="o">},</span></span>
...
<span id="LC849" class="line" lang="java">      <span class="s">"Impossibile trovare la funzione {0}"</span><span class="o">},</span></span>
...
<span id="LC852" class="line" lang="java">      <span class="s">"Impossibile creare un URL da {0}"</span><span class="o">},</span></span>
...
<span id="LC855" class="line" lang="java">      <span class="s">"Opzione -E non supportata per il parser DTM"</span><span class="o">},</span></span>
...
<span id="LC858" class="line" lang="java">      <span class="s">"Il valore di VariableReference specificato per la variabile \u00E8 fuori contesto o senza definizione. Nome = {0}"</span><span class="o">},</span></span>
...
<span id="LC861" class="line" lang="java">     <span class="s">"Codifica non supportata: {0}"</span><span class="o">},</span></span>
...
<span id="LC866" class="line" lang="java">  <span class="o">{</span> <span class="s">"ui_language"</span><span class="o">,</span> <span class="s">"it"</span><span class="o">},</span></span>
<span id="LC867" class="line" lang="java">  <span class="o">{</span> <span class="s">"help_language"</span><span class="o">,</span> <span class="s">"it"</span><span class="o">},</span></span>
<span id="LC868" class="line" lang="java">  <span class="o">{</span> <span class="s">"language"</span><span class="o">,</span> <span class="s">"it"</span><span class="o">},</span></span>
<span id="LC869" class="line" lang="java">  <span class="o">{</span> <span class="s">"BAD_CODE"</span><span class="o">,</span> <span class="s">"Parametro per createMessage fuori limite"</span><span class="o">},</span></span>
<span id="LC870" class="line" lang="java">  <span class="o">{</span> <span class="s">"FORMAT_FAILED"</span><span class="o">,</span> <span class="s">"Eccezione durante la chiamata messageFormat"</span><span class="o">},</span></span>
<span id="LC871" class="line" lang="java">  <span class="o">{</span> <span class="s">"version"</span><span class="o">,</span> <span class="s">"&gt;&gt;&gt;&gt;&gt;&gt;&gt; Versione Xalan "</span><span class="o">},</span></span>
...
<span id="LC873" class="line" lang="java">  <span class="o">{</span> <span class="s">"yes"</span><span class="o">,</span> <span class="s">"s\u00EC"</span><span class="o">},</span></span>
<span id="LC874" class="line" lang="java">  <span class="o">{</span> <span class="s">"line"</span><span class="o">,</span> <span class="s">"N. riga"</span><span class="o">},</span></span>
<span id="LC875" class="line" lang="java">  <span class="o">{</span> <span class="s">"column"</span><span class="o">,</span> <span class="s">"N. colonna"</span><span class="o">},</span></span>
<span id="LC876" class="line" lang="java">  <span class="o">{</span> <span class="s">"xsldone"</span><span class="o">,</span> <span class="s">"XSLProcessor: operazione completata"</span><span class="o">},</span></span>
<span id="LC877" class="line" lang="java">  <span class="o">{</span> <span class="s">"xpath_option"</span><span class="o">,</span> <span class="s">"opzioni xpath: "</span><span class="o">},</span></span>
...
<span id="LC880" class="line" lang="java">  <span class="o">{</span> <span class="s">"optionMatch"</span><span class="o">,</span> <span class="s">"   [-match match pattern (per la diagnostica delle corrispondenze)]"</span><span class="o">},</span></span>
<span id="LC881" class="line" lang="java">  <span class="o">{</span> <span class="s">"optionAnyExpr"</span><span class="o">,</span> <span class="s">"In alternativa, un'espressione xpath eseguir\u00E0 il dump della diagnostica."</span><span class="o">},</span></span>
<span id="LC882" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg1"</span><span class="o">,</span> <span class="s">"Processo XSL non riuscito."</span><span class="o">},</span></span>
<span id="LC883" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg2"</span><span class="o">,</span> <span class="s">"** Impossibile trovare il parser **"</span><span class="o">},</span></span>
<span id="LC884" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg3"</span><span class="o">,</span> <span class="s">"Controllare il classpath."</span><span class="o">},</span></span>
<span id="LC885" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg4"</span><span class="o">,</span> <span class="s">"Se non \u00E8 disponibile un parser XML di IBM per Java, \u00E8 possibile scaricarlo da"</span><span class="o">},</span></span>
<span id="LC886" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg5"</span><span class="o">,</span> <span class="s">"AlphaWorks di IBM: http://www.alphaworks.ibm.com/formula/xml"</span><span class="o">},</span></span>
