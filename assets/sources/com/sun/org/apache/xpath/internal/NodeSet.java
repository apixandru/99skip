...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: NodeSet.java,v 1.2.4.1 2005/09/10 17:39:49 jeffsuttor Exp $</span></span>
...
<span id="LC26" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.utils.DOM2Helper</span><span class="o">;</span></span>
<span id="LC27" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.axes.ContextNodeList</span><span class="o">;</span></span>
<span id="LC28" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.res.XPATHErrorResources</span><span class="o">;</span></span>
...
<span id="LC33" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.traversal.NodeFilter</span><span class="o">;</span></span>
<span id="LC34" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.traversal.NodeIterator</span><span class="o">;</span></span>
...
<span id="LC38" class="line" lang="java"><span class="cm"> * &lt;p&gt;The NodeSet class can act as either a NodeVector,</span></span>
<span id="LC39" class="line" lang="java"><span class="cm"> * NodeList, or NodeIterator.  However, in order for it to</span></span>
<span id="LC40" class="line" lang="java"><span class="cm"> * act as a NodeVector or NodeList, it's required that</span></span>
<span id="LC41" class="line" lang="java"><span class="cm"> * setShouldCacheNodes(true) be called before the first</span></span>
<span id="LC42" class="line" lang="java"><span class="cm"> * nextNode() is called, in order that nodes can be added</span></span>
<span id="LC43" class="line" lang="java"><span class="cm"> * as they are fetched.  Derived classes that implement iterators</span></span>
<span id="LC44" class="line" lang="java"><span class="cm"> * must override runTo(int index), in order that they may</span></span>
<span id="LC45" class="line" lang="java"><span class="cm"> * run the iteration to the given index. &lt;/p&gt;</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * &lt;p&gt;Note that we directly implement the DOM's NodeIterator</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * interface. We do not emulate all the behavior of the</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * standard NodeIterator. In particular, we do not guarantee</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> * to present a "live view" of the document ... but in XSLT,</span></span>
<span id="LC51" class="line" lang="java"><span class="cm"> * the source document should never be mutated, so this should</span></span>
<span id="LC52" class="line" lang="java"><span class="cm"> * never be an issue.&lt;/p&gt;</span></span>
<span id="LC53" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC54" class="line" lang="java"><span class="cm"> * &lt;p&gt;Thought: Should NodeSet really implement NodeList and NodeIterator,</span></span>
<span id="LC55" class="line" lang="java"><span class="cm"> * or should there be specific subclasses of it which do so? The</span></span>
<span id="LC56" class="line" lang="java"><span class="cm"> * advantage of doing it all here is that all NodeSets will respond</span></span>
<span id="LC57" class="line" lang="java"><span class="cm"> * to the same calls; the disadvantage is that some of them may return</span></span>
<span id="LC58" class="line" lang="java"><span class="cm"> * less-than-enlightening results when you do so.&lt;/p&gt;</span></span>
<span id="LC59" class="line" lang="java"><span class="cm"> * @xsl.usage advanced</span></span>
<span id="LC60" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC61" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">NodeSet</span></span>
<span id="LC62" class="line" lang="java">        <span class="kd">implements</span> <span class="nc">NodeList</span><span class="o">,</span> <span class="nc">NodeIterator</span><span class="o">,</span> <span class="nc">Cloneable</span><span class="o">,</span> <span class="nc">ContextNodeList</span></span>
...
<span id="LC66" class="line" lang="java"><span class="cm">   * Create an empty nodelist.</span></span>
<span id="LC67" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC68" class="line" lang="java">  <span class="kd">public</span> <span class="nf">NodeSet</span><span class="o">()</span></span>
<span id="LC69" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC70" class="line" lang="java">    <span class="n">m_blocksize</span> <span class="o">=</span> <span class="mi">32</span><span class="o">;</span></span>
<span id="LC71" class="line" lang="java">    <span class="n">m_mapSize</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
...
<span id="LC75" class="line" lang="java"><span class="cm">   * Create an empty, using the given block size.</span></span>
<span id="LC76" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC77" class="line" lang="java"><span class="cm">   * @param blocksize Size of blocks to allocate</span></span>
<span id="LC78" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC79" class="line" lang="java">  <span class="kd">public</span> <span class="nf">NodeSet</span><span class="o">(</span><span class="kt">int</span> <span class="n">blocksize</span><span class="o">)</span></span>
<span id="LC80" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC81" class="line" lang="java">    <span class="n">m_blocksize</span> <span class="o">=</span> <span class="n">blocksize</span><span class="o">;</span></span>
<span id="LC82" class="line" lang="java">    <span class="n">m_mapSize</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
...
<span id="LC86" class="line" lang="java"><span class="cm">   * Create a NodeSet, and copy the members of the</span></span>
<span id="LC87" class="line" lang="java"><span class="cm">   * given nodelist into it.</span></span>
<span id="LC88" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">   * @param nodelist List of Nodes to be made members of the new set.</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC91" class="line" lang="java">  <span class="kd">public</span> <span class="nf">NodeSet</span><span class="o">(</span><span class="nc">NodeList</span> <span class="n">nodelist</span><span class="o">)</span></span>
<span id="LC92" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC93" class="line" lang="java"></span>
<span id="LC94" class="line" lang="java">    <span class="k">this</span><span class="o">(</span><span class="mi">32</span><span class="o">);</span></span>
<span id="LC95" class="line" lang="java"></span>
<span id="LC96" class="line" lang="java">    <span class="n">addNodes</span><span class="o">(</span><span class="n">nodelist</span><span class="o">);</span></span>
...
<span id="LC100" class="line" lang="java"><span class="cm">   * Create a NodeSet, and copy the members of the</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">   * given NodeSet into it.</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC103" class="line" lang="java"><span class="cm">   * @param nodelist Set of Nodes to be made members of the new set.</span></span>
<span id="LC104" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC105" class="line" lang="java">  <span class="kd">public</span> <span class="nf">NodeSet</span><span class="o">(</span><span class="nc">NodeSet</span> <span class="n">nodelist</span><span class="o">)</span></span>
<span id="LC106" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC107" class="line" lang="java"></span>
<span id="LC108" class="line" lang="java">    <span class="k">this</span><span class="o">(</span><span class="mi">32</span><span class="o">);</span></span>
<span id="LC109" class="line" lang="java"></span>
<span id="LC110" class="line" lang="java">    <span class="n">addNodes</span><span class="o">((</span><span class="nc">NodeIterator</span><span class="o">)</span> <span class="n">nodelist</span><span class="o">);</span></span>
...
<span id="LC114" class="line" lang="java"><span class="cm">   * Create a NodeSet, and copy the members of the</span></span>
<span id="LC115" class="line" lang="java"><span class="cm">   * given NodeIterator into it.</span></span>
<span id="LC116" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC117" class="line" lang="java"><span class="cm">   * @param ni Iterator which yields Nodes to be made members of the new set.</span></span>
<span id="LC118" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC119" class="line" lang="java">  <span class="kd">public</span> <span class="nf">NodeSet</span><span class="o">(</span><span class="nc">NodeIterator</span> <span class="n">ni</span><span class="o">)</span></span>
<span id="LC120" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC121" class="line" lang="java"></span>
<span id="LC122" class="line" lang="java">    <span class="k">this</span><span class="o">(</span><span class="mi">32</span><span class="o">);</span></span>
<span id="LC123" class="line" lang="java"></span>
<span id="LC124" class="line" lang="java">    <span class="n">addNodes</span><span class="o">(</span><span class="n">ni</span><span class="o">);</span></span>
...
<span id="LC128" class="line" lang="java"><span class="cm">   * Create a NodeSet which contains the given Node.</span></span>
<span id="LC129" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC130" class="line" lang="java"><span class="cm">   * @param node Single node to be added to the new set.</span></span>
<span id="LC131" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC132" class="line" lang="java">  <span class="kd">public</span> <span class="nf">NodeSet</span><span class="o">(</span><span class="nc">Node</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC133" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC134" class="line" lang="java"></span>
<span id="LC135" class="line" lang="java">    <span class="k">this</span><span class="o">(</span><span class="mi">32</span><span class="o">);</span></span>
<span id="LC136" class="line" lang="java"></span>
<span id="LC137" class="line" lang="java">    <span class="n">addNode</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
...
<span id="LC141" class="line" lang="java"><span class="cm">   * @return The root node of the Iterator, as specified when it was created.</span></span>
<span id="LC142" class="line" lang="java"><span class="cm">   * For non-Iterator NodeSets, this will be null.</span></span>
<span id="LC143" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC144" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">getRoot</span><span class="o">()</span></span>
<span id="LC145" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC146" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC150" class="line" lang="java"><span class="cm">   * Get a cloned Iterator, and reset its state to the beginning of the</span></span>
<span id="LC151" class="line" lang="java"><span class="cm">   * iteration.</span></span>
<span id="LC152" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC153" class="line" lang="java"><span class="cm">   * @return a new NodeSet of the same type, having the same state...</span></span>
<span id="LC154" class="line" lang="java"><span class="cm">   * except that the reset() operation has been called.</span></span>
<span id="LC155" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC156" class="line" lang="java"><span class="cm">   * @throws CloneNotSupportedException if this subclass of NodeSet</span></span>
<span id="LC157" class="line" lang="java"><span class="cm">   * does not support the clone() operation.</span></span>
<span id="LC158" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC159" class="line" lang="java">  <span class="kd">public</span> <span class="nc">NodeIterator</span> <span class="nf">cloneWithReset</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">CloneNotSupportedException</span></span>
<span id="LC160" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC161" class="line" lang="java"></span>
<span id="LC162" class="line" lang="java">    <span class="nc">NodeSet</span> <span class="n">clone</span> <span class="o">=</span> <span class="o">(</span><span class="nc">NodeSet</span><span class="o">)</span> <span class="n">clone</span><span class="o">();</span></span>
<span id="LC163" class="line" lang="java"></span>
<span id="LC164" class="line" lang="java">    <span class="n">clone</span><span class="o">.</span><span class="na">reset</span><span class="o">();</span></span>
<span id="LC165" class="line" lang="java"></span>
<span id="LC166" class="line" lang="java">    <span class="k">return</span> <span class="n">clone</span><span class="o">;</span></span>
...
<span id="LC170" class="line" lang="java"><span class="cm">   * Reset the iterator. May have no effect on non-iterator Nodesets.</span></span>
<span id="LC171" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC172" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">reset</span><span class="o">()</span></span>
<span id="LC173" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC174" class="line" lang="java">    <span class="n">m_next</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
...
<span id="LC178" class="line" lang="java"><span class="cm">   *  This attribute determines which node types are presented via the</span></span>
<span id="LC179" class="line" lang="java"><span class="cm">   * iterator. The available set of constants is defined in the</span></span>
<span id="LC180" class="line" lang="java"><span class="cm">   * &lt;code&gt;NodeFilter&lt;/code&gt; interface. For NodeSets, the mask has been</span></span>
<span id="LC181" class="line" lang="java"><span class="cm">   * hardcoded to show all nodes except EntityReference nodes, which have</span></span>
<span id="LC182" class="line" lang="java"><span class="cm">   * no equivalent in the XPath data model.</span></span>
<span id="LC183" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC184" class="line" lang="java"><span class="cm">   * @return integer used as a bit-array, containing flags defined in</span></span>
<span id="LC185" class="line" lang="java"><span class="cm">   * the DOM's NodeFilter class. The value will be</span></span>
<span id="LC186" class="line" lang="java"><span class="cm">   * &lt;code&gt;SHOW_ALL &amp; ~SHOW_ENTITY_REFERENCE&lt;/code&gt;, meaning that</span></span>
<span id="LC187" class="line" lang="java"><span class="cm">   * only entity references are suppressed.</span></span>
<span id="LC188" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC189" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getWhatToShow</span><span class="o">()</span></span>
<span id="LC190" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC191" class="line" lang="java">    <span class="k">return</span> <span class="nc">NodeFilter</span><span class="o">.</span><span class="na">SHOW_ALL</span> <span class="o">&amp;</span> <span class="o">~</span><span class="nc">NodeFilter</span><span class="o">.</span><span class="na">SHOW_ENTITY_REFERENCE</span><span class="o">;</span></span>
...
<span id="LC195" class="line" lang="java"><span class="cm">   * The filter object used to screen nodes. Filters are applied to</span></span>
<span id="LC196" class="line" lang="java"><span class="cm">   * further reduce (and restructure) the NodeIterator's view of the</span></span>
<span id="LC197" class="line" lang="java"><span class="cm">   * document. In our case, we will be using hardcoded filters built</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">   * into our iterators... but getFilter() is part of the DOM's</span></span>
<span id="LC199" class="line" lang="java"><span class="cm">   * NodeIterator interface, so we have to support it.</span></span>
<span id="LC200" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC201" class="line" lang="java"><span class="cm">   * @return null, which is slightly misleading. True, there is no</span></span>
<span id="LC202" class="line" lang="java"><span class="cm">   * user-written filter object, but in fact we are doing some very</span></span>
<span id="LC203" class="line" lang="java"><span class="cm">   * sophisticated custom filtering. A DOM purist might suggest</span></span>
<span id="LC204" class="line" lang="java"><span class="cm">   * returning a placeholder object just to indicate that this is</span></span>
<span id="LC205" class="line" lang="java"><span class="cm">   * not going to return all nodes selected by whatToShow.</span></span>
<span id="LC206" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC207" class="line" lang="java">  <span class="kd">public</span> <span class="nc">NodeFilter</span> <span class="nf">getFilter</span><span class="o">()</span></span>
<span id="LC208" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC209" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC213" class="line" lang="java"><span class="cm">   *  The value of this flag determines whether the children of entity</span></span>
<span id="LC214" class="line" lang="java"><span class="cm">   * reference nodes are visible to the iterator. If false, they will be</span></span>
<span id="LC215" class="line" lang="java"><span class="cm">   * skipped over.</span></span>
<span id="LC216" class="line" lang="java"><span class="cm">   * &lt;br&gt; To produce a view of the document that has entity references</span></span>
<span id="LC217" class="line" lang="java"><span class="cm">   * expanded and does not expose the entity reference node itself, use the</span></span>
<span id="LC218" class="line" lang="java"><span class="cm">   * whatToShow flags to hide the entity reference node and set</span></span>
<span id="LC219" class="line" lang="java"><span class="cm">   * expandEntityReferences to true when creating the iterator. To produce</span></span>
<span id="LC220" class="line" lang="java"><span class="cm">   * a view of the document that has entity reference nodes but no entity</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">   * expansion, use the whatToShow flags to show the entity reference node</span></span>
<span id="LC222" class="line" lang="java"><span class="cm">   * and set expandEntityReferences to false.</span></span>
<span id="LC223" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC224" class="line" lang="java"><span class="cm">   * @return true for all iterators based on NodeSet, meaning that the</span></span>
<span id="LC225" class="line" lang="java"><span class="cm">   * contents of EntityRefrence nodes may be returned (though whatToShow</span></span>
<span id="LC226" class="line" lang="java"><span class="cm">   * says that the EntityReferences themselves are not shown.)</span></span>
<span id="LC227" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC228" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getExpandEntityReferences</span><span class="o">()</span></span>
...
<span id="LC234" class="line" lang="java"><span class="cm">   *  Returns the next node in the set and advances the position of the</span></span>
<span id="LC235" class="line" lang="java"><span class="cm">   * iterator in the set. After a NodeIterator is created, the first call</span></span>
<span id="LC236" class="line" lang="java"><span class="cm">   * to nextNode() returns the first node in the set.</span></span>
<span id="LC237" class="line" lang="java"><span class="cm">   * @return  The next &lt;code&gt;Node&lt;/code&gt; in the set being iterated over, or</span></span>
<span id="LC238" class="line" lang="java"><span class="cm">   *   &lt;code&gt;null&lt;/code&gt; if there are no more members in that set.</span></span>
<span id="LC239" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC240" class="line" lang="java"><span class="cm">   *    INVALID_STATE_ERR: Raised if this method is called after the</span></span>
<span id="LC241" class="line" lang="java"><span class="cm">   *   &lt;code&gt;detach&lt;/code&gt; method was invoked.</span></span>
<span id="LC242" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC243" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">nextNode</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC244" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC245" class="line" lang="java"></span>
<span id="LC246" class="line" lang="java">    <span class="k">if</span> <span class="o">((</span><span class="n">m_next</span><span class="o">)</span> <span class="o">&lt;</span> <span class="k">this</span><span class="o">.</span><span class="na">size</span><span class="o">())</span></span>
<span id="LC247" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC248" class="line" lang="java">      <span class="nc">Node</span> <span class="n">next</span> <span class="o">=</span> <span class="k">this</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">m_next</span><span class="o">);</span></span>
<span id="LC249" class="line" lang="java"></span>
<span id="LC250" class="line" lang="java">      <span class="n">m_next</span><span class="o">++;</span></span>
<span id="LC251" class="line" lang="java"></span>
<span id="LC252" class="line" lang="java">      <span class="k">return</span> <span class="n">next</span><span class="o">;</span></span>
<span id="LC253" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC254" class="line" lang="java">    <span class="k">else</span></span>
...
<span id="LC259" class="line" lang="java"><span class="cm">   *  Returns the previous node in the set and moves the position of the</span></span>
<span id="LC260" class="line" lang="java"><span class="cm">   * iterator backwards in the set.</span></span>
<span id="LC261" class="line" lang="java"><span class="cm">   * @return  The previous &lt;code&gt;Node&lt;/code&gt; in the set being iterated over,</span></span>
<span id="LC262" class="line" lang="java"><span class="cm">   *   or&lt;code&gt;null&lt;/code&gt; if there are no more members in that set.</span></span>
<span id="LC263" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC264" class="line" lang="java"><span class="cm">   *    INVALID_STATE_ERR: Raised if this method is called after the</span></span>
<span id="LC265" class="line" lang="java"><span class="cm">   *   &lt;code&gt;detach&lt;/code&gt; method was invoked.</span></span>
<span id="LC266" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSet is not of</span></span>
<span id="LC267" class="line" lang="java"><span class="cm">   * a cached type, and hence doesn't know what the previous node was.</span></span>
<span id="LC268" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC269" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">previousNode</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC270" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC271" class="line" lang="java"></span>
<span id="LC272" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_cacheNodes</span><span class="o">)</span></span>
<span id="LC273" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span></span>
<span id="LC274" class="line" lang="java">        <span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_CANNOT_ITERATE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet can not iterate to a previous node!");</span></span>
<span id="LC275" class="line" lang="java"></span>
<span id="LC276" class="line" lang="java">    <span class="k">if</span> <span class="o">((</span><span class="n">m_next</span> <span class="o">-</span> <span class="mi">1</span><span class="o">)</span> <span class="o">&gt;</span> <span class="mi">0</span><span class="o">)</span></span>
<span id="LC277" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC278" class="line" lang="java">      <span class="n">m_next</span><span class="o">--;</span></span>
<span id="LC279" class="line" lang="java"></span>
<span id="LC280" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">m_next</span><span class="o">);</span></span>
<span id="LC281" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC282" class="line" lang="java">    <span class="k">else</span></span>
...
<span id="LC287" class="line" lang="java"><span class="cm">   * Detaches the iterator from the set which it iterated over, releasing</span></span>
<span id="LC288" class="line" lang="java"><span class="cm">   * any computational resources and placing the iterator in the INVALID</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">   * state. After&lt;code&gt;detach&lt;/code&gt; has been invoked, calls to</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">   * &lt;code&gt;nextNode&lt;/code&gt; or&lt;code&gt;previousNode&lt;/code&gt; will raise the</span></span>
<span id="LC291" class="line" lang="java"><span class="cm">   * exception INVALID_STATE_ERR.</span></span>
<span id="LC292" class="line" lang="java"><span class="cm">   * &lt;p&gt;</span></span>
<span id="LC293" class="line" lang="java"><span class="cm">   * This operation is a no-op in NodeSet, and will not cause</span></span>
<span id="LC294" class="line" lang="java"><span class="cm">   * INVALID_STATE_ERR to be raised by later operations.</span></span>
<span id="LC295" class="line" lang="java"><span class="cm">   * &lt;/p&gt;</span></span>
<span id="LC296" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC297" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">detach</span><span class="o">(){}</span></span>
<span id="LC298" class="line" lang="java"></span>
<span id="LC299" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC300" class="line" lang="java"><span class="cm">   * Tells if this NodeSet is "fresh", in other words, if</span></span>
<span id="LC301" class="line" lang="java"><span class="cm">   * the first nextNode() that is called will return the</span></span>
<span id="LC302" class="line" lang="java"><span class="cm">   * first node in the set.</span></span>
<span id="LC303" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC304" class="line" lang="java"><span class="cm">   * @return true if nextNode() would return the first node in the set,</span></span>
<span id="LC305" class="line" lang="java"><span class="cm">   * false if it would return a later one.</span></span>
<span id="LC306" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC307" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isFresh</span><span class="o">()</span></span>
<span id="LC308" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC309" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">m_next</span> <span class="o">==</span> <span class="mi">0</span><span class="o">);</span></span>
...
<span id="LC313" class="line" lang="java"><span class="cm">   * If an index is requested, NodeSet will call this method</span></span>
<span id="LC314" class="line" lang="java"><span class="cm">   * to run the iterator to the index.  By default this sets</span></span>
<span id="LC315" class="line" lang="java"><span class="cm">   * m_next to the index.  If the index argument is -1, this</span></span>
<span id="LC316" class="line" lang="java"><span class="cm">   * signals that the iterator should be run to the end.</span></span>
<span id="LC317" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC318" class="line" lang="java"><span class="cm">   * @param index Position to advance (or retreat) to, with</span></span>
<span id="LC319" class="line" lang="java"><span class="cm">   * 0 requesting the reset ("fresh") position and -1 (or indeed</span></span>
<span id="LC320" class="line" lang="java"><span class="cm">   * any out-of-bounds value) requesting the final position.</span></span>
<span id="LC321" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSet is not</span></span>
<span id="LC322" class="line" lang="java"><span class="cm">   * one of the types which supports indexing/counting.</span></span>
<span id="LC323" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC324" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">runTo</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span></span>
<span id="LC325" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC326" class="line" lang="java"></span>
<span id="LC327" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_cacheNodes</span><span class="o">)</span></span>
<span id="LC328" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span></span>
<span id="LC329" class="line" lang="java">        <span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_CANNOT_INDEX</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet can not do indexing or counting functions!");</span></span>
<span id="LC330" class="line" lang="java"></span>
<span id="LC331" class="line" lang="java">    <span class="k">if</span> <span class="o">((</span><span class="n">index</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="o">(</span><span class="n">m_next</span> <span class="o">&lt;</span> <span class="n">m_firstFree</span><span class="o">))</span></span>
<span id="LC332" class="line" lang="java">      <span class="n">m_next</span> <span class="o">=</span> <span class="n">index</span><span class="o">;</span></span>
<span id="LC333" class="line" lang="java">    <span class="k">else</span></span>
<span id="LC334" class="line" lang="java">      <span class="n">m_next</span> <span class="o">=</span> <span class="n">m_firstFree</span> <span class="o">-</span> <span class="mi">1</span><span class="o">;</span></span>
...
<span id="LC338" class="line" lang="java"><span class="cm">   * Returns the &lt;code&gt;index&lt;/code&gt;th item in the collection. If</span></span>
<span id="LC339" class="line" lang="java"><span class="cm">   * &lt;code&gt;index&lt;/code&gt; is greater than or equal to the number of nodes in</span></span>
<span id="LC340" class="line" lang="java"><span class="cm">   * the list, this returns &lt;code&gt;null&lt;/code&gt;.</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC342" class="line" lang="java"><span class="cm">   * TODO: What happens if index is out of range?</span></span>
<span id="LC343" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC344" class="line" lang="java"><span class="cm">   * @param index Index into the collection.</span></span>
<span id="LC345" class="line" lang="java"><span class="cm">   * @return The node at the &lt;code&gt;index&lt;/code&gt;th position in the</span></span>
<span id="LC346" class="line" lang="java"><span class="cm">   *   &lt;code&gt;NodeList&lt;/code&gt;, or &lt;code&gt;null&lt;/code&gt; if that is not a valid</span></span>
<span id="LC347" class="line" lang="java"><span class="cm">   *   index.</span></span>
<span id="LC348" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC349" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">item</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span></span>
<span id="LC350" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC351" class="line" lang="java"></span>
<span id="LC352" class="line" lang="java">    <span class="n">runTo</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
<span id="LC353" class="line" lang="java"></span>
<span id="LC354" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="nc">Node</span><span class="o">)</span> <span class="k">this</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
...
<span id="LC358" class="line" lang="java"><span class="cm">   * The number of nodes in the list. The range of valid child node indices is</span></span>
<span id="LC359" class="line" lang="java"><span class="cm">   * 0 to &lt;code&gt;length-1&lt;/code&gt; inclusive. Note that this operation requires</span></span>
<span id="LC360" class="line" lang="java"><span class="cm">   * finding all the matching nodes, which may defeat attempts to defer</span></span>
<span id="LC361" class="line" lang="java"><span class="cm">   * that work.</span></span>
<span id="LC362" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC363" class="line" lang="java"><span class="cm">   * @return integer indicating how many nodes are represented by this list.</span></span>
<span id="LC364" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC365" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getLength</span><span class="o">()</span></span>
<span id="LC366" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC367" class="line" lang="java"></span>
<span id="LC368" class="line" lang="java">    <span class="n">runTo</span><span class="o">(-</span><span class="mi">1</span><span class="o">);</span></span>
<span id="LC369" class="line" lang="java"></span>
<span id="LC370" class="line" lang="java">    <span class="k">return</span> <span class="k">this</span><span class="o">.</span><span class="na">size</span><span class="o">();</span></span>
...
<span id="LC374" class="line" lang="java"><span class="cm">   * Add a node to the NodeSet. Not all types of NodeSets support this</span></span>
<span id="LC375" class="line" lang="java"><span class="cm">   * operation</span></span>
<span id="LC376" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC377" class="line" lang="java"><span class="cm">   * @param n Node to be added</span></span>
<span id="LC378" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSet is not of</span></span>
<span id="LC379" class="line" lang="java"><span class="cm">   * a mutable type.</span></span>
<span id="LC380" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC381" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addNode</span><span class="o">(</span><span class="nc">Node</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC382" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC383" class="line" lang="java"></span>
<span id="LC384" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_mutable</span><span class="o">)</span></span>
<span id="LC385" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_NOT_MUTABLE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet is not mutable!");</span></span>
<span id="LC386" class="line" lang="java"></span>
<span id="LC387" class="line" lang="java">    <span class="k">this</span><span class="o">.</span><span class="na">addElement</span><span class="o">(</span><span class="n">n</span><span class="o">);</span></span>
...
<span id="LC391" class="line" lang="java"><span class="cm">   * Insert a node at a given position.</span></span>
<span id="LC392" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC393" class="line" lang="java"><span class="cm">   * @param n Node to be added</span></span>
<span id="LC394" class="line" lang="java"><span class="cm">   * @param pos Offset at which the node is to be inserted,</span></span>
<span id="LC395" class="line" lang="java"><span class="cm">   * with 0 being the first position.</span></span>
<span id="LC396" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSet is not of</span></span>
<span id="LC397" class="line" lang="java"><span class="cm">   * a mutable type.</span></span>
<span id="LC398" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC399" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">insertNode</span><span class="o">(</span><span class="nc">Node</span> <span class="n">n</span><span class="o">,</span> <span class="kt">int</span> <span class="n">pos</span><span class="o">)</span></span>
<span id="LC400" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC401" class="line" lang="java"></span>
<span id="LC402" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_mutable</span><span class="o">)</span></span>
<span id="LC403" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_NOT_MUTABLE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet is not mutable!");</span></span>
<span id="LC404" class="line" lang="java"></span>
<span id="LC405" class="line" lang="java">    <span class="n">insertElementAt</span><span class="o">(</span><span class="n">n</span><span class="o">,</span> <span class="n">pos</span><span class="o">);</span></span>
...
<span id="LC409" class="line" lang="java"><span class="cm">   * Remove a node.</span></span>
<span id="LC410" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC411" class="line" lang="java"><span class="cm">   * @param n Node to be added</span></span>
<span id="LC412" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSet is not of</span></span>
<span id="LC413" class="line" lang="java"><span class="cm">   * a mutable type.</span></span>
<span id="LC414" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC415" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">removeNode</span><span class="o">(</span><span class="nc">Node</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC416" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC417" class="line" lang="java"></span>
<span id="LC418" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_mutable</span><span class="o">)</span></span>
<span id="LC419" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_NOT_MUTABLE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet is not mutable!");</span></span>
<span id="LC420" class="line" lang="java"></span>
<span id="LC421" class="line" lang="java">    <span class="k">this</span><span class="o">.</span><span class="na">removeElement</span><span class="o">(</span><span class="n">n</span><span class="o">);</span></span>
...
<span id="LC425" class="line" lang="java"><span class="cm">   * Copy NodeList members into this nodelist, adding in</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">   * document order.  If a node is null, don't add it.</span></span>
<span id="LC427" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC428" class="line" lang="java"><span class="cm">   * @param nodelist List of nodes which should now be referenced by</span></span>
<span id="LC429" class="line" lang="java"><span class="cm">   * this NodeSet.</span></span>
<span id="LC430" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSet is not of</span></span>
<span id="LC431" class="line" lang="java"><span class="cm">   * a mutable type.</span></span>
<span id="LC432" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC433" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addNodes</span><span class="o">(</span><span class="nc">NodeList</span> <span class="n">nodelist</span><span class="o">)</span></span>
<span id="LC434" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC435" class="line" lang="java"></span>
<span id="LC436" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_mutable</span><span class="o">)</span></span>
<span id="LC437" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_NOT_MUTABLE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet is not mutable!");</span></span>
<span id="LC438" class="line" lang="java"></span>
<span id="LC439" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">nodelist</span><span class="o">)</span>  <span class="c1">// defensive to fix a bug that Sanjiva reported.</span></span>
<span id="LC440" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC441" class="line" lang="java">      <span class="kt">int</span> <span class="n">nChildren</span> <span class="o">=</span> <span class="n">nodelist</span><span class="o">.</span><span class="na">getLength</span><span class="o">();</span></span>
<span id="LC442" class="line" lang="java"></span>
<span id="LC443" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">nChildren</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC444" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC445" class="line" lang="java">        <span class="nc">Node</span> <span class="n">obj</span> <span class="o">=</span> <span class="n">nodelist</span><span class="o">.</span><span class="na">item</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC446" class="line" lang="java"></span>
<span id="LC447" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">obj</span><span class="o">)</span></span>
<span id="LC448" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC449" class="line" lang="java">          <span class="n">addElement</span><span class="o">(</span><span class="n">obj</span><span class="o">);</span></span>
...
<span id="LC454" class="line" lang="java">    <span class="c1">// checkDups();</span></span>
...
<span id="LC458" class="line" lang="java"><span class="cm">   * &lt;p&gt;Copy NodeList members into this nodelist, adding in</span></span>
<span id="LC459" class="line" lang="java"><span class="cm">   * document order.  Only genuine node references will be copied;</span></span>
<span id="LC460" class="line" lang="java"><span class="cm">   * nulls appearing in the source NodeSet will</span></span>
<span id="LC461" class="line" lang="java"><span class="cm">   * not be added to this one. &lt;/p&gt;</span></span>
<span id="LC462" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC463" class="line" lang="java"><span class="cm">   * &lt;p&gt; In case you're wondering why this function is needed: NodeSet</span></span>
<span id="LC464" class="line" lang="java"><span class="cm">   * implements both NodeIterator and NodeList. If this method isn't</span></span>
<span id="LC465" class="line" lang="java"><span class="cm">   * provided, Java can't decide which of those to use when addNodes()</span></span>
<span id="LC466" class="line" lang="java"><span class="cm">   * is invoked. Providing the more-explicit match avoids that</span></span>
<span id="LC467" class="line" lang="java"><span class="cm">   * ambiguity.)&lt;/p&gt;</span></span>
<span id="LC468" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC469" class="line" lang="java"><span class="cm">   * @param ns NodeSet whose members should be merged into this NodeSet.</span></span>
<span id="LC470" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSet is not of</span></span>
<span id="LC471" class="line" lang="java"><span class="cm">   * a mutable type.</span></span>
<span id="LC472" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC473" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addNodes</span><span class="o">(</span><span class="nc">NodeSet</span> <span class="n">ns</span><span class="o">)</span></span>
<span id="LC474" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC475" class="line" lang="java"></span>
<span id="LC476" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_mutable</span><span class="o">)</span></span>
<span id="LC477" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_NOT_MUTABLE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet is not mutable!");</span></span>
<span id="LC478" class="line" lang="java"></span>
<span id="LC479" class="line" lang="java">    <span class="n">addNodes</span><span class="o">((</span><span class="nc">NodeIterator</span><span class="o">)</span> <span class="n">ns</span><span class="o">);</span></span>
...
<span id="LC483" class="line" lang="java"><span class="cm">   * Copy NodeList members into this nodelist, adding in</span></span>
<span id="LC484" class="line" lang="java"><span class="cm">   * document order.  Null references are not added.</span></span>
<span id="LC485" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC486" class="line" lang="java"><span class="cm">   * @param iterator NodeIterator which yields the nodes to be added.</span></span>
<span id="LC487" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSet is not of</span></span>
<span id="LC488" class="line" lang="java"><span class="cm">   * a mutable type.</span></span>
<span id="LC489" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC490" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addNodes</span><span class="o">(</span><span class="nc">NodeIterator</span> <span class="n">iterator</span><span class="o">)</span></span>
<span id="LC491" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC492" class="line" lang="java"></span>
<span id="LC493" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_mutable</span><span class="o">)</span></span>
<span id="LC494" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_NOT_MUTABLE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet is not mutable!");</span></span>
<span id="LC495" class="line" lang="java"></span>
<span id="LC496" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">iterator</span><span class="o">)</span>  <span class="c1">// defensive to fix a bug that Sanjiva reported.</span></span>
<span id="LC497" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC498" class="line" lang="java">      <span class="nc">Node</span> <span class="n">obj</span><span class="o">;</span></span>
<span id="LC499" class="line" lang="java"></span>
<span id="LC500" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="o">(</span><span class="n">obj</span> <span class="o">=</span> <span class="n">iterator</span><span class="o">.</span><span class="na">nextNode</span><span class="o">()))</span></span>
<span id="LC501" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC502" class="line" lang="java">        <span class="n">addElement</span><span class="o">(</span><span class="n">obj</span><span class="o">);</span></span>
...
<span id="LC506" class="line" lang="java">    <span class="c1">// checkDups();</span></span>
...
<span id="LC510" class="line" lang="java"><span class="cm">   * Copy NodeList members into this nodelist, adding in</span></span>
<span id="LC511" class="line" lang="java"><span class="cm">   * document order.  If a node is null, don't add it.</span></span>
<span id="LC512" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC513" class="line" lang="java"><span class="cm">   * @param nodelist List of nodes to be added</span></span>
<span id="LC514" class="line" lang="java"><span class="cm">   * @param support The XPath runtime context.</span></span>
<span id="LC515" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSet is not of</span></span>
<span id="LC516" class="line" lang="java"><span class="cm">   * a mutable type.</span></span>
<span id="LC517" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC518" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addNodesInDocOrder</span><span class="o">(</span><span class="nc">NodeList</span> <span class="n">nodelist</span><span class="o">,</span> <span class="nc">XPathContext</span> <span class="n">support</span><span class="o">)</span></span>
<span id="LC519" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC520" class="line" lang="java"></span>
<span id="LC521" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_mutable</span><span class="o">)</span></span>
<span id="LC522" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_NOT_MUTABLE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet is not mutable!");</span></span>
<span id="LC523" class="line" lang="java"></span>
<span id="LC524" class="line" lang="java">    <span class="kt">int</span> <span class="n">nChildren</span> <span class="o">=</span> <span class="n">nodelist</span><span class="o">.</span><span class="na">getLength</span><span class="o">();</span></span>
<span id="LC525" class="line" lang="java"></span>
<span id="LC526" class="line" lang="java">    <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">nChildren</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC527" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC528" class="line" lang="java">      <span class="nc">Node</span> <span class="n">node</span> <span class="o">=</span> <span class="n">nodelist</span><span class="o">.</span><span class="na">item</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC529" class="line" lang="java"></span>
<span id="LC530" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC531" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC532" class="line" lang="java">        <span class="n">addNodeInDocOrder</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="n">support</span><span class="o">);</span></span>
...
<span id="LC538" class="line" lang="java"><span class="cm">   * Copy NodeList members into this nodelist, adding in</span></span>
<span id="LC539" class="line" lang="java"><span class="cm">   * document order.  If a node is null, don't add it.</span></span>
<span id="LC540" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC541" class="line" lang="java"><span class="cm">   * @param iterator NodeIterator which yields the nodes to be added.</span></span>
<span id="LC542" class="line" lang="java"><span class="cm">   * @param support The XPath runtime context.</span></span>
<span id="LC543" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSet is not of</span></span>
<span id="LC544" class="line" lang="java"><span class="cm">   * a mutable type.</span></span>
<span id="LC545" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC546" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addNodesInDocOrder</span><span class="o">(</span><span class="nc">NodeIterator</span> <span class="n">iterator</span><span class="o">,</span> <span class="nc">XPathContext</span> <span class="n">support</span><span class="o">)</span></span>
<span id="LC547" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC548" class="line" lang="java"></span>
<span id="LC549" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_mutable</span><span class="o">)</span></span>
<span id="LC550" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_NOT_MUTABLE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet is not mutable!");</span></span>
<span id="LC551" class="line" lang="java"></span>
<span id="LC552" class="line" lang="java">    <span class="nc">Node</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC553" class="line" lang="java"></span>
<span id="LC554" class="line" lang="java">    <span class="k">while</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="o">(</span><span class="n">node</span> <span class="o">=</span> <span class="n">iterator</span><span class="o">.</span><span class="na">nextNode</span><span class="o">()))</span></span>
<span id="LC555" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC556" class="line" lang="java">      <span class="n">addNodeInDocOrder</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="n">support</span><span class="o">);</span></span>
...
<span id="LC561" class="line" lang="java"><span class="cm">   * Add the node list to this node set in document order.</span></span>
<span id="LC562" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC563" class="line" lang="java"><span class="cm">   * @param start index.</span></span>
<span id="LC564" class="line" lang="java"><span class="cm">   * @param end index.</span></span>
<span id="LC565" class="line" lang="java"><span class="cm">   * @param testIndex index.</span></span>
<span id="LC566" class="line" lang="java"><span class="cm">   * @param nodelist The nodelist to add.</span></span>
<span id="LC567" class="line" lang="java"><span class="cm">   * @param support The XPath runtime context.</span></span>
<span id="LC568" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC569" class="line" lang="java"><span class="cm">   * @return false always.</span></span>
<span id="LC570" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSet is not of</span></span>
<span id="LC571" class="line" lang="java"><span class="cm">   * a mutable type.</span></span>
<span id="LC572" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC573" class="line" lang="java">  <span class="kd">private</span> <span class="kt">boolean</span> <span class="nf">addNodesInDocOrder</span><span class="o">(</span><span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">end</span><span class="o">,</span> <span class="kt">int</span> <span class="n">testIndex</span><span class="o">,</span></span>
<span id="LC574" class="line" lang="java">                                     <span class="nc">NodeList</span> <span class="n">nodelist</span><span class="o">,</span> <span class="nc">XPathContext</span> <span class="n">support</span><span class="o">)</span></span>
<span id="LC575" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC576" class="line" lang="java"></span>
<span id="LC577" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_mutable</span><span class="o">)</span></span>
<span id="LC578" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_NOT_MUTABLE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet is not mutable!");</span></span>
<span id="LC579" class="line" lang="java"></span>
<span id="LC580" class="line" lang="java">    <span class="kt">boolean</span> <span class="n">foundit</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC581" class="line" lang="java">    <span class="kt">int</span> <span class="n">i</span><span class="o">;</span></span>
<span id="LC582" class="line" lang="java">    <span class="nc">Node</span> <span class="n">node</span> <span class="o">=</span> <span class="n">nodelist</span><span class="o">.</span><span class="na">item</span><span class="o">(</span><span class="n">testIndex</span><span class="o">);</span></span>
<span id="LC583" class="line" lang="java"></span>
<span id="LC584" class="line" lang="java">    <span class="k">for</span> <span class="o">(</span><span class="n">i</span> <span class="o">=</span> <span class="n">end</span><span class="o">;</span> <span class="n">i</span> <span class="o">&gt;=</span> <span class="n">start</span><span class="o">;</span> <span class="n">i</span><span class="o">--)</span></span>
<span id="LC585" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC586" class="line" lang="java">      <span class="nc">Node</span> <span class="n">child</span> <span class="o">=</span> <span class="o">(</span><span class="nc">Node</span><span class="o">)</span> <span class="n">elementAt</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC587" class="line" lang="java"></span>
<span id="LC588" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">child</span> <span class="o">==</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC589" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC590" class="line" lang="java">        <span class="n">i</span> <span class="o">=</span> <span class="o">-</span><span class="mi">2</span><span class="o">;</span>  <span class="c1">// Duplicate, suppress insert</span></span>
...
<span id="LC595" class="line" lang="java">      <span class="k">if</span> <span class="o">(!</span><span class="nc">DOM2Helper</span><span class="o">.</span><span class="na">isNodeAfter</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="n">child</span><span class="o">))</span></span>
<span id="LC596" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC597" class="line" lang="java">        <span class="n">insertElementAt</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="n">i</span> <span class="o">+</span> <span class="mi">1</span><span class="o">);</span></span>
<span id="LC598" class="line" lang="java"></span>
<span id="LC599" class="line" lang="java">        <span class="n">testIndex</span><span class="o">--;</span></span>
<span id="LC600" class="line" lang="java"></span>
<span id="LC601" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">testIndex</span> <span class="o">&gt;</span> <span class="mi">0</span><span class="o">)</span></span>
<span id="LC602" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC603" class="line" lang="java">          <span class="kt">boolean</span> <span class="n">foundPrev</span> <span class="o">=</span> <span class="n">addNodesInDocOrder</span><span class="o">(</span><span class="mi">0</span><span class="o">,</span> <span class="n">i</span><span class="o">,</span> <span class="n">testIndex</span><span class="o">,</span> <span class="n">nodelist</span><span class="o">,</span></span>
<span id="LC604" class="line" lang="java">                                                 <span class="n">support</span><span class="o">);</span></span>
<span id="LC605" class="line" lang="java"></span>
<span id="LC606" class="line" lang="java">          <span class="k">if</span> <span class="o">(!</span><span class="n">foundPrev</span><span class="o">)</span></span>
<span id="LC607" class="line" lang="java">          <span class="o">{</span></span>
<span id="LC608" class="line" lang="java">            <span class="n">addNodesInDocOrder</span><span class="o">(</span><span class="n">i</span><span class="o">,</span> <span class="n">size</span><span class="o">()</span> <span class="o">-</span> <span class="mi">1</span><span class="o">,</span> <span class="n">testIndex</span><span class="o">,</span> <span class="n">nodelist</span><span class="o">,</span> <span class="n">support</span><span class="o">);</span></span>
...
<span id="LC616" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">i</span> <span class="o">==</span> <span class="o">-</span><span class="mi">1</span><span class="o">)</span></span>
<span id="LC617" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC618" class="line" lang="java">      <span class="n">insertElementAt</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="mi">0</span><span class="o">);</span></span>
<span id="LC619" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC620" class="line" lang="java"></span>
<span id="LC621" class="line" lang="java">    <span class="k">return</span> <span class="n">foundit</span><span class="o">;</span></span>
...
<span id="LC625" class="line" lang="java"><span class="cm">   * Add the node into a vector of nodes where it should occur in</span></span>
<span id="LC626" class="line" lang="java"><span class="cm">   * document order.</span></span>
<span id="LC627" class="line" lang="java"><span class="cm">   * @param node The node to be added.</span></span>
<span id="LC628" class="line" lang="java"><span class="cm">   * @param test true if we should test for doc order</span></span>
<span id="LC629" class="line" lang="java"><span class="cm">   * @param support The XPath runtime context.</span></span>
<span id="LC630" class="line" lang="java"><span class="cm">   * @return insertIndex.</span></span>
<span id="LC631" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSet is not of</span></span>
<span id="LC632" class="line" lang="java"><span class="cm">   * a mutable type.</span></span>
<span id="LC633" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC634" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">addNodeInDocOrder</span><span class="o">(</span><span class="nc">Node</span> <span class="n">node</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">test</span><span class="o">,</span> <span class="nc">XPathContext</span> <span class="n">support</span><span class="o">)</span></span>
<span id="LC635" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC636" class="line" lang="java"></span>
<span id="LC637" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_mutable</span><span class="o">)</span></span>
<span id="LC638" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_NOT_MUTABLE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//XSLMessages.createXPATHMessage(XPATHErrorResources.ER_NODESET_NOT_MUTABLE, null)); //"This NodeSet is not mutable!");</span></span>
<span id="LC639" class="line" lang="java"></span>
<span id="LC640" class="line" lang="java">    <span class="kt">int</span> <span class="n">insertIndex</span> <span class="o">=</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC641" class="line" lang="java"></span>
<span id="LC642" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">test</span><span class="o">)</span></span>
<span id="LC643" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC644" class="line" lang="java"></span>
<span id="LC645" class="line" lang="java">      <span class="c1">// This needs to do a binary search, but a binary search</span></span>
<span id="LC646" class="line" lang="java">      <span class="c1">// is somewhat tough because the sequence test involves</span></span>
<span id="LC647" class="line" lang="java">      <span class="c1">// two nodes.</span></span>
<span id="LC648" class="line" lang="java">      <span class="kt">int</span> <span class="n">size</span> <span class="o">=</span> <span class="n">size</span><span class="o">(),</span> <span class="n">i</span><span class="o">;</span></span>
<span id="LC649" class="line" lang="java"></span>
<span id="LC650" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="n">i</span> <span class="o">=</span> <span class="n">size</span> <span class="o">-</span> <span class="mi">1</span><span class="o">;</span> <span class="n">i</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span><span class="o">--)</span></span>
<span id="LC651" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC652" class="line" lang="java">        <span class="nc">Node</span> <span class="n">child</span> <span class="o">=</span> <span class="o">(</span><span class="nc">Node</span><span class="o">)</span> <span class="n">elementAt</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC653" class="line" lang="java"></span>
<span id="LC654" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">child</span> <span class="o">==</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC655" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC656" class="line" lang="java">          <span class="n">i</span> <span class="o">=</span> <span class="o">-</span><span class="mi">2</span><span class="o">;</span>  <span class="c1">// Duplicate, suppress insert</span></span>
...
<span id="LC661" class="line" lang="java">        <span class="k">if</span> <span class="o">(!</span><span class="nc">DOM2Helper</span><span class="o">.</span><span class="na">isNodeAfter</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="n">child</span><span class="o">))</span></span>
<span id="LC662" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC663" class="line" lang="java">          <span class="k">break</span><span class="o">;</span></span>
...
<span id="LC667" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">i</span> <span class="o">!=</span> <span class="o">-</span><span class="mi">2</span><span class="o">)</span></span>
<span id="LC668" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC669" class="line" lang="java">        <span class="n">insertIndex</span> <span class="o">=</span> <span class="n">i</span> <span class="o">+</span> <span class="mi">1</span><span class="o">;</span></span>
<span id="LC670" class="line" lang="java"></span>
<span id="LC671" class="line" lang="java">        <span class="n">insertElementAt</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="n">insertIndex</span><span class="o">);</span></span>
<span id="LC672" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC673" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC674" class="line" lang="java">    <span class="k">else</span></span>
<span id="LC675" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC676" class="line" lang="java">      <span class="n">insertIndex</span> <span class="o">=</span> <span class="k">this</span><span class="o">.</span><span class="na">size</span><span class="o">();</span></span>
<span id="LC677" class="line" lang="java"></span>
<span id="LC678" class="line" lang="java">      <span class="kt">boolean</span> <span class="n">foundit</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC679" class="line" lang="java"></span>
<span id="LC680" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">insertIndex</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC681" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC682" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="k">this</span><span class="o">.</span><span class="na">item</span><span class="o">(</span><span class="n">i</span><span class="o">).</span><span class="na">equals</span><span class="o">(</span><span class="n">node</span><span class="o">))</span></span>
<span id="LC683" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC684" class="line" lang="java">          <span class="n">foundit</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC690" class="line" lang="java">      <span class="k">if</span> <span class="o">(!</span><span class="n">foundit</span><span class="o">)</span></span>
<span id="LC691" class="line" lang="java">        <span class="n">addElement</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC692" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC693" class="line" lang="java"></span>
<span id="LC694" class="line" lang="java">    <span class="c1">// checkDups();</span></span>
<span id="LC695" class="line" lang="java">    <span class="k">return</span> <span class="n">insertIndex</span><span class="o">;</span></span>
<span id="LC696" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end addNodeInDocOrder(Vector v, Object obj)</span></span>
<span id="LC697" class="line" lang="java"></span>
<span id="LC698" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC699" class="line" lang="java"><span class="cm">   * Add the node into a vector of nodes where it should occur in</span></span>
<span id="LC700" class="line" lang="java"><span class="cm">   * document order.</span></span>
<span id="LC701" class="line" lang="java"><span class="cm">   * @param node The node to be added.</span></span>
<span id="LC702" class="line" lang="java"><span class="cm">   * @param support The XPath runtime context.</span></span>
<span id="LC703" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC704" class="line" lang="java"><span class="cm">   * @return The index where it was inserted.</span></span>
<span id="LC705" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSet is not of</span></span>
<span id="LC706" class="line" lang="java"><span class="cm">   * a mutable type.</span></span>
<span id="LC707" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC708" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">addNodeInDocOrder</span><span class="o">(</span><span class="nc">Node</span> <span class="n">node</span><span class="o">,</span> <span class="nc">XPathContext</span> <span class="n">support</span><span class="o">)</span></span>
<span id="LC709" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC710" class="line" lang="java"></span>
<span id="LC711" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_mutable</span><span class="o">)</span></span>
<span id="LC712" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_NOT_MUTABLE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet is not mutable!");</span></span>
<span id="LC713" class="line" lang="java"></span>
<span id="LC714" class="line" lang="java">    <span class="k">return</span> <span class="nf">addNodeInDocOrder</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="kc">true</span><span class="o">,</span> <span class="n">support</span><span class="o">);</span></span>
<span id="LC715" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end addNodeInDocOrder(Vector v, Object obj)</span></span>
<span id="LC716" class="line" lang="java"></span>
<span id="LC717" class="line" lang="java"></span>
<span id="LC718" class="line" lang="java">  <span class="cm">/** If this node is being used as an iterator, the next index that nextNode()</span></span>
<span id="LC719" class="line" lang="java"><span class="cm">   *  will return.  */</span></span>
<span id="LC720" class="line" lang="java">  <span class="kd">transient</span> <span class="kd">protected</span> <span class="kt">int</span> <span class="n">m_next</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC721" class="line" lang="java"></span>
<span id="LC722" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC723" class="line" lang="java"><span class="cm">   * Get the current position, which is one less than</span></span>
<span id="LC724" class="line" lang="java"><span class="cm">   * the next nextNode() call will retrieve.  i.e. if</span></span>
<span id="LC725" class="line" lang="java"><span class="cm">   * you call getCurrentPos() and the return is 0, the next</span></span>
<span id="LC726" class="line" lang="java"><span class="cm">   * fetch will take place at index 1.</span></span>
<span id="LC727" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC728" class="line" lang="java"><span class="cm">   * @return The the current position index.</span></span>
<span id="LC729" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC730" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getCurrentPos</span><span class="o">()</span></span>
<span id="LC731" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC732" class="line" lang="java">    <span class="k">return</span> <span class="n">m_next</span><span class="o">;</span></span>
...
<span id="LC736" class="line" lang="java"><span class="cm">   * Set the current position in the node set.</span></span>
<span id="LC737" class="line" lang="java"><span class="cm">   * @param i Must be a valid index.</span></span>
<span id="LC738" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSet is not of</span></span>
<span id="LC739" class="line" lang="java"><span class="cm">   * a cached type, and thus doesn't permit indexed access.</span></span>
<span id="LC740" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC741" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCurrentPos</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span></span>
<span id="LC742" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC743" class="line" lang="java"></span>
<span id="LC744" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_cacheNodes</span><span class="o">)</span></span>
<span id="LC745" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span></span>
<span id="LC746" class="line" lang="java">        <span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_CANNOT_INDEX</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet can not do indexing or counting functions!");</span></span>
<span id="LC747" class="line" lang="java"></span>
<span id="LC748" class="line" lang="java">    <span class="n">m_next</span> <span class="o">=</span> <span class="n">i</span><span class="o">;</span></span>
...
<span id="LC752" class="line" lang="java"><span class="cm">   * Return the last fetched node.  Needed to support the UnionPathIterator.</span></span>
<span id="LC753" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC754" class="line" lang="java"><span class="cm">   * @return the last fetched node.</span></span>
<span id="LC755" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSet is not of</span></span>
<span id="LC756" class="line" lang="java"><span class="cm">   * a cached type, and thus doesn't permit indexed access.</span></span>
<span id="LC757" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC758" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">getCurrentNode</span><span class="o">()</span></span>
<span id="LC759" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC760" class="line" lang="java"></span>
<span id="LC761" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_cacheNodes</span><span class="o">)</span></span>
<span id="LC762" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span></span>
<span id="LC763" class="line" lang="java">        <span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_CANNOT_INDEX</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet can not do indexing or counting functions!");</span></span>
<span id="LC764" class="line" lang="java"></span>
<span id="LC765" class="line" lang="java">    <span class="kt">int</span> <span class="n">saved</span> <span class="o">=</span> <span class="n">m_next</span><span class="o">;</span></span>
<span id="LC766" class="line" lang="java">    <span class="nc">Node</span> <span class="n">n</span> <span class="o">=</span> <span class="o">(</span><span class="n">m_next</span> <span class="o">&lt;</span> <span class="n">m_firstFree</span><span class="o">)</span> <span class="o">?</span> <span class="n">elementAt</span><span class="o">(</span><span class="n">m_next</span><span class="o">)</span> <span class="o">:</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC767" class="line" lang="java">    <span class="n">m_next</span> <span class="o">=</span> <span class="n">saved</span><span class="o">;</span> <span class="c1">// HACK: I think this is a bit of a hack.  -sb</span></span>
<span id="LC768" class="line" lang="java">    <span class="k">return</span> <span class="n">n</span><span class="o">;</span></span>
<span id="LC769" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC770" class="line" lang="java"></span>
<span id="LC771" class="line" lang="java">  <span class="cm">/** True if this list can be mutated.  */</span></span>
<span id="LC772" class="line" lang="java">  <span class="kd">transient</span> <span class="kd">protected</span> <span class="kt">boolean</span> <span class="n">m_mutable</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC773" class="line" lang="java"></span>
<span id="LC774" class="line" lang="java">  <span class="cm">/** True if this list is cached.</span></span>
<span id="LC775" class="line" lang="java"><span class="cm">   *  @serial  */</span></span>
<span id="LC776" class="line" lang="java">  <span class="kd">transient</span> <span class="kd">protected</span> <span class="kt">boolean</span> <span class="n">m_cacheNodes</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC777" class="line" lang="java"></span>
<span id="LC778" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC779" class="line" lang="java"><span class="cm">   * Get whether or not this is a cached node set.</span></span>
<span id="LC780" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC781" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC782" class="line" lang="java"><span class="cm">   * @return True if this list is cached.</span></span>
<span id="LC783" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC784" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getShouldCacheNodes</span><span class="o">()</span></span>
<span id="LC785" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC786" class="line" lang="java">    <span class="k">return</span> <span class="n">m_cacheNodes</span><span class="o">;</span></span>
...
<span id="LC790" class="line" lang="java"><span class="cm">   * If setShouldCacheNodes(true) is called, then nodes will</span></span>
<span id="LC791" class="line" lang="java"><span class="cm">   * be cached.  They are not cached by default. This switch must</span></span>
<span id="LC792" class="line" lang="java"><span class="cm">   * be set before the first call to nextNode is made, to ensure</span></span>
<span id="LC793" class="line" lang="java"><span class="cm">   * that all nodes are cached.</span></span>
<span id="LC794" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC795" class="line" lang="java"><span class="cm">   * @param b true if this node set should be cached.</span></span>
<span id="LC796" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if an attempt is made to</span></span>
<span id="LC797" class="line" lang="java"><span class="cm">   * request caching after we've already begun stepping through the</span></span>
<span id="LC798" class="line" lang="java"><span class="cm">   * nodes in this set.</span></span>
<span id="LC799" class="line" lang="java"><span class="cm">  */</span></span>
<span id="LC800" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setShouldCacheNodes</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">b</span><span class="o">)</span></span>
<span id="LC801" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC802" class="line" lang="java"></span>
<span id="LC803" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">isFresh</span><span class="o">())</span></span>
<span id="LC804" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span></span>
<span id="LC805" class="line" lang="java">        <span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_CANNOT_CALL_SETSHOULDCACHENODE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"Can not call setShouldCacheNodes after nextNode has been called!");</span></span>
<span id="LC806" class="line" lang="java"></span>
<span id="LC807" class="line" lang="java">    <span class="n">m_cacheNodes</span> <span class="o">=</span> <span class="n">b</span><span class="o">;</span></span>
<span id="LC808" class="line" lang="java">    <span class="n">m_mutable</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC812" class="line" lang="java">  <span class="kd">transient</span> <span class="kd">private</span> <span class="kt">int</span> <span class="n">m_last</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC813" class="line" lang="java"></span>
<span id="LC814" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getLast</span><span class="o">()</span></span>
<span id="LC815" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC816" class="line" lang="java">    <span class="k">return</span> <span class="n">m_last</span><span class="o">;</span></span>
<span id="LC817" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC818" class="line" lang="java"></span>
<span id="LC819" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setLast</span><span class="o">(</span><span class="kt">int</span> <span class="n">last</span><span class="o">)</span></span>
<span id="LC820" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC821" class="line" lang="java">    <span class="n">m_last</span> <span class="o">=</span> <span class="n">last</span><span class="o">;</span></span>
<span id="LC822" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC823" class="line" lang="java"></span>
<span id="LC824" class="line" lang="java">  <span class="cm">/** Size of blocks to allocate.</span></span>
<span id="LC825" class="line" lang="java"><span class="cm">   *  @serial          */</span></span>
<span id="LC826" class="line" lang="java">  <span class="kd">private</span> <span class="kt">int</span> <span class="n">m_blocksize</span><span class="o">;</span></span>
<span id="LC827" class="line" lang="java"></span>
<span id="LC828" class="line" lang="java">  <span class="cm">/** Array of nodes this points to.</span></span>
<span id="LC829" class="line" lang="java"><span class="cm">   *  @serial          */</span></span>
<span id="LC830" class="line" lang="java">  <span class="nc">Node</span> <span class="n">m_map</span><span class="o">[];</span></span>
<span id="LC831" class="line" lang="java"></span>
<span id="LC832" class="line" lang="java">  <span class="cm">/** Number of nodes in this NodeVector.</span></span>
<span id="LC833" class="line" lang="java"><span class="cm">   *  @serial          */</span></span>
<span id="LC834" class="line" lang="java">  <span class="kd">protected</span> <span class="kt">int</span> <span class="n">m_firstFree</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC835" class="line" lang="java"></span>
<span id="LC836" class="line" lang="java">  <span class="cm">/** Size of the array this points to.</span></span>
<span id="LC837" class="line" lang="java"><span class="cm">   *  @serial           */</span></span>
<span id="LC838" class="line" lang="java">  <span class="kd">private</span> <span class="kt">int</span> <span class="n">m_mapSize</span><span class="o">;</span>  <span class="c1">// lazy initialization</span></span>
<span id="LC839" class="line" lang="java"></span>
<span id="LC840" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC841" class="line" lang="java"><span class="cm">   * Get a cloned LocPathIterator.</span></span>
<span id="LC842" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC843" class="line" lang="java"><span class="cm">   * @return A clone of this</span></span>
<span id="LC844" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC845" class="line" lang="java"><span class="cm">   * @throws CloneNotSupportedException</span></span>
<span id="LC846" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC847" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Object</span> <span class="nf">clone</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">CloneNotSupportedException</span></span>
<span id="LC848" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC849" class="line" lang="java"></span>
<span id="LC850" class="line" lang="java">    <span class="nc">NodeSet</span> <span class="n">clone</span> <span class="o">=</span> <span class="o">(</span><span class="nc">NodeSet</span><span class="o">)</span> <span class="kd">super</span><span class="o">.</span><span class="na">clone</span><span class="o">();</span></span>
<span id="LC851" class="line" lang="java"></span>
<span id="LC852" class="line" lang="java">    <span class="k">if</span> <span class="o">((</span><span class="kc">null</span> <span class="o">!=</span> <span class="k">this</span><span class="o">.</span><span class="na">m_map</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="o">(</span><span class="k">this</span><span class="o">.</span><span class="na">m_map</span> <span class="o">==</span> <span class="n">clone</span><span class="o">.</span><span class="na">m_map</span><span class="o">))</span></span>
<span id="LC853" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC854" class="line" lang="java">      <span class="n">clone</span><span class="o">.</span><span class="na">m_map</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Node</span><span class="o">[</span><span class="k">this</span><span class="o">.</span><span class="na">m_map</span><span class="o">.</span><span class="na">length</span><span class="o">];</span></span>
<span id="LC855" class="line" lang="java"></span>
<span id="LC856" class="line" lang="java">      <span class="nc">System</span><span class="o">.</span><span class="na">arraycopy</span><span class="o">(</span><span class="k">this</span><span class="o">.</span><span class="na">m_map</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">clone</span><span class="o">.</span><span class="na">m_map</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="k">this</span><span class="o">.</span><span class="na">m_map</span><span class="o">.</span><span class="na">length</span><span class="o">);</span></span>
<span id="LC857" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC858" class="line" lang="java"></span>
<span id="LC859" class="line" lang="java">    <span class="k">return</span> <span class="n">clone</span><span class="o">;</span></span>
...
<span id="LC863" class="line" lang="java"><span class="cm">   * Get the length of the list.</span></span>
<span id="LC864" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC865" class="line" lang="java"><span class="cm">   * @return Number of nodes in this NodeVector</span></span>
<span id="LC866" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC867" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">size</span><span class="o">()</span></span>
<span id="LC868" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC869" class="line" lang="java">    <span class="k">return</span> <span class="n">m_firstFree</span><span class="o">;</span></span>
...
<span id="LC873" class="line" lang="java"><span class="cm">   * Append a Node onto the vector.</span></span>
<span id="LC874" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC875" class="line" lang="java"><span class="cm">   * @param value Node to add to the vector</span></span>
<span id="LC876" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC877" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addElement</span><span class="o">(</span><span class="nc">Node</span> <span class="n">value</span><span class="o">)</span></span>
<span id="LC878" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC879" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_mutable</span><span class="o">)</span></span>
<span id="LC880" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_NOT_MUTABLE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet is not mutable!");</span></span>
<span id="LC881" class="line" lang="java"></span>
<span id="LC882" class="line" lang="java">    <span class="k">if</span> <span class="o">((</span><span class="n">m_firstFree</span> <span class="o">+</span> <span class="mi">1</span><span class="o">)</span> <span class="o">&gt;=</span> <span class="n">m_mapSize</span><span class="o">)</span></span>
<span id="LC883" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC884" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_map</span><span class="o">)</span></span>
<span id="LC885" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC886" class="line" lang="java">        <span class="n">m_map</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Node</span><span class="o">[</span><span class="n">m_blocksize</span><span class="o">];</span></span>
<span id="LC887" class="line" lang="java">        <span class="n">m_mapSize</span> <span class="o">=</span> <span class="n">m_blocksize</span><span class="o">;</span></span>
<span id="LC888" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC889" class="line" lang="java">      <span class="k">else</span></span>
<span id="LC890" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC891" class="line" lang="java">        <span class="n">m_mapSize</span> <span class="o">+=</span> <span class="n">m_blocksize</span><span class="o">;</span></span>
<span id="LC892" class="line" lang="java"></span>
<span id="LC893" class="line" lang="java">        <span class="nc">Node</span> <span class="n">newMap</span><span class="o">[]</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Node</span><span class="o">[</span><span class="n">m_mapSize</span><span class="o">];</span></span>
<span id="LC894" class="line" lang="java"></span>
<span id="LC895" class="line" lang="java">        <span class="nc">System</span><span class="o">.</span><span class="na">arraycopy</span><span class="o">(</span><span class="n">m_map</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">newMap</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">m_firstFree</span> <span class="o">+</span> <span class="mi">1</span><span class="o">);</span></span>
<span id="LC896" class="line" lang="java"></span>
<span id="LC897" class="line" lang="java">        <span class="n">m_map</span> <span class="o">=</span> <span class="n">newMap</span><span class="o">;</span></span>
...
<span id="LC901" class="line" lang="java">    <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span><span class="o">]</span> <span class="o">=</span> <span class="n">value</span><span class="o">;</span></span>
<span id="LC902" class="line" lang="java"></span>
<span id="LC903" class="line" lang="java">    <span class="n">m_firstFree</span><span class="o">++;</span></span>
...
<span id="LC907" class="line" lang="java"><span class="cm">   * Append a Node onto the vector.</span></span>
<span id="LC908" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC909" class="line" lang="java"><span class="cm">   * @param value Node to add to the vector</span></span>
<span id="LC910" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC911" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">push</span><span class="o">(</span><span class="nc">Node</span> <span class="n">value</span><span class="o">)</span></span>
<span id="LC912" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC913" class="line" lang="java"></span>
<span id="LC914" class="line" lang="java">    <span class="kt">int</span> <span class="n">ff</span> <span class="o">=</span> <span class="n">m_firstFree</span><span class="o">;</span></span>
<span id="LC915" class="line" lang="java"></span>
<span id="LC916" class="line" lang="java">    <span class="k">if</span> <span class="o">((</span><span class="n">ff</span> <span class="o">+</span> <span class="mi">1</span><span class="o">)</span> <span class="o">&gt;=</span> <span class="n">m_mapSize</span><span class="o">)</span></span>
<span id="LC917" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC918" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_map</span><span class="o">)</span></span>
<span id="LC919" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC920" class="line" lang="java">        <span class="n">m_map</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Node</span><span class="o">[</span><span class="n">m_blocksize</span><span class="o">];</span></span>
<span id="LC921" class="line" lang="java">        <span class="n">m_mapSize</span> <span class="o">=</span> <span class="n">m_blocksize</span><span class="o">;</span></span>
<span id="LC922" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC923" class="line" lang="java">      <span class="k">else</span></span>
<span id="LC924" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC925" class="line" lang="java">        <span class="n">m_mapSize</span> <span class="o">+=</span> <span class="n">m_blocksize</span><span class="o">;</span></span>
<span id="LC926" class="line" lang="java"></span>
<span id="LC927" class="line" lang="java">        <span class="nc">Node</span> <span class="n">newMap</span><span class="o">[]</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Node</span><span class="o">[</span><span class="n">m_mapSize</span><span class="o">];</span></span>
<span id="LC928" class="line" lang="java"></span>
<span id="LC929" class="line" lang="java">        <span class="nc">System</span><span class="o">.</span><span class="na">arraycopy</span><span class="o">(</span><span class="n">m_map</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">newMap</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">ff</span> <span class="o">+</span> <span class="mi">1</span><span class="o">);</span></span>
<span id="LC930" class="line" lang="java"></span>
<span id="LC931" class="line" lang="java">        <span class="n">m_map</span> <span class="o">=</span> <span class="n">newMap</span><span class="o">;</span></span>
...
<span id="LC935" class="line" lang="java">    <span class="n">m_map</span><span class="o">[</span><span class="n">ff</span><span class="o">]</span> <span class="o">=</span> <span class="n">value</span><span class="o">;</span></span>
<span id="LC936" class="line" lang="java"></span>
<span id="LC937" class="line" lang="java">    <span class="n">ff</span><span class="o">++;</span></span>
<span id="LC938" class="line" lang="java"></span>
<span id="LC939" class="line" lang="java">    <span class="n">m_firstFree</span> <span class="o">=</span> <span class="n">ff</span><span class="o">;</span></span>
...
<span id="LC943" class="line" lang="java"><span class="cm">   * Pop a node from the tail of the vector and return the result.</span></span>
<span id="LC944" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC945" class="line" lang="java"><span class="cm">   * @return the node at the tail of the vector</span></span>
<span id="LC946" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC947" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">Node</span> <span class="nf">pop</span><span class="o">()</span></span>
<span id="LC948" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC949" class="line" lang="java"></span>
<span id="LC950" class="line" lang="java">    <span class="n">m_firstFree</span><span class="o">--;</span></span>
<span id="LC951" class="line" lang="java"></span>
<span id="LC952" class="line" lang="java">    <span class="nc">Node</span> <span class="n">n</span> <span class="o">=</span> <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span><span class="o">];</span></span>
<span id="LC953" class="line" lang="java"></span>
<span id="LC954" class="line" lang="java">    <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span><span class="o">]</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC955" class="line" lang="java"></span>
<span id="LC956" class="line" lang="java">    <span class="k">return</span> <span class="n">n</span><span class="o">;</span></span>
...
<span id="LC960" class="line" lang="java"><span class="cm">   * Pop a node from the tail of the vector and return the</span></span>
<span id="LC961" class="line" lang="java"><span class="cm">   * top of the stack after the pop.</span></span>
<span id="LC962" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC963" class="line" lang="java"><span class="cm">   * @return The top of the stack after it's been popped</span></span>
<span id="LC964" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC965" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">Node</span> <span class="nf">popAndTop</span><span class="o">()</span></span>
<span id="LC966" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC967" class="line" lang="java"></span>
<span id="LC968" class="line" lang="java">    <span class="n">m_firstFree</span><span class="o">--;</span></span>
<span id="LC969" class="line" lang="java"></span>
<span id="LC970" class="line" lang="java">    <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span><span class="o">]</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC971" class="line" lang="java"></span>
<span id="LC972" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">m_firstFree</span> <span class="o">==</span> <span class="mi">0</span><span class="o">)</span> <span class="o">?</span> <span class="kc">null</span> <span class="o">:</span> <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span> <span class="o">-</span> <span class="mi">1</span><span class="o">];</span></span>
...
<span id="LC976" class="line" lang="java"><span class="cm">   * Pop a node from the tail of the vector.</span></span>
<span id="LC977" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC978" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">popQuick</span><span class="o">()</span></span>
<span id="LC979" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC980" class="line" lang="java"></span>
<span id="LC981" class="line" lang="java">    <span class="n">m_firstFree</span><span class="o">--;</span></span>
<span id="LC982" class="line" lang="java"></span>
<span id="LC983" class="line" lang="java">    <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span><span class="o">]</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC987" class="line" lang="java"><span class="cm">   * Return the node at the top of the stack without popping the stack.</span></span>
<span id="LC988" class="line" lang="java"><span class="cm">   * Special purpose method for TransformerImpl, pushElemTemplateElement.</span></span>
<span id="LC989" class="line" lang="java"><span class="cm">   * Performance critical.</span></span>
<span id="LC990" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC991" class="line" lang="java"><span class="cm">   * @return Node at the top of the stack or null if stack is empty.</span></span>
<span id="LC992" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC993" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">Node</span> <span class="nf">peepOrNull</span><span class="o">()</span></span>
<span id="LC994" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC995" class="line" lang="java">    <span class="k">return</span> <span class="o">((</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_map</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="o">(</span><span class="n">m_firstFree</span> <span class="o">&gt;</span> <span class="mi">0</span><span class="o">))</span></span>
<span id="LC996" class="line" lang="java">           <span class="o">?</span> <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span> <span class="o">-</span> <span class="mi">1</span><span class="o">]</span> <span class="o">:</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC1000" class="line" lang="java"><span class="cm">   * Push a pair of nodes into the stack.</span></span>
<span id="LC1001" class="line" lang="java"><span class="cm">   * Special purpose method for TransformerImpl, pushElemTemplateElement.</span></span>
<span id="LC1002" class="line" lang="java"><span class="cm">   * Performance critical.</span></span>
<span id="LC1003" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1004" class="line" lang="java"><span class="cm">   * @param v1 First node to add to vector</span></span>
<span id="LC1005" class="line" lang="java"><span class="cm">   * @param v2 Second node to add to vector</span></span>
<span id="LC1006" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1007" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">pushPair</span><span class="o">(</span><span class="nc">Node</span> <span class="n">v1</span><span class="o">,</span> <span class="nc">Node</span> <span class="n">v2</span><span class="o">)</span></span>
<span id="LC1008" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1009" class="line" lang="java"></span>
<span id="LC1010" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_map</span><span class="o">)</span></span>
<span id="LC1011" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1012" class="line" lang="java">      <span class="n">m_map</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Node</span><span class="o">[</span><span class="n">m_blocksize</span><span class="o">];</span></span>
<span id="LC1013" class="line" lang="java">      <span class="n">m_mapSize</span> <span class="o">=</span> <span class="n">m_blocksize</span><span class="o">;</span></span>
<span id="LC1014" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1015" class="line" lang="java">    <span class="k">else</span></span>
<span id="LC1016" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1017" class="line" lang="java">      <span class="k">if</span> <span class="o">((</span><span class="n">m_firstFree</span> <span class="o">+</span> <span class="mi">2</span><span class="o">)</span> <span class="o">&gt;=</span> <span class="n">m_mapSize</span><span class="o">)</span></span>
<span id="LC1018" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1019" class="line" lang="java">        <span class="n">m_mapSize</span> <span class="o">+=</span> <span class="n">m_blocksize</span><span class="o">;</span></span>
<span id="LC1020" class="line" lang="java"></span>
<span id="LC1021" class="line" lang="java">        <span class="nc">Node</span> <span class="n">newMap</span><span class="o">[]</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Node</span><span class="o">[</span><span class="n">m_mapSize</span><span class="o">];</span></span>
<span id="LC1022" class="line" lang="java"></span>
<span id="LC1023" class="line" lang="java">        <span class="nc">System</span><span class="o">.</span><span class="na">arraycopy</span><span class="o">(</span><span class="n">m_map</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">newMap</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">m_firstFree</span><span class="o">);</span></span>
<span id="LC1024" class="line" lang="java"></span>
<span id="LC1025" class="line" lang="java">        <span class="n">m_map</span> <span class="o">=</span> <span class="n">newMap</span><span class="o">;</span></span>
...
<span id="LC1029" class="line" lang="java">    <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span><span class="o">]</span> <span class="o">=</span> <span class="n">v1</span><span class="o">;</span></span>
<span id="LC1030" class="line" lang="java">    <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span> <span class="o">+</span> <span class="mi">1</span><span class="o">]</span> <span class="o">=</span> <span class="n">v2</span><span class="o">;</span></span>
<span id="LC1031" class="line" lang="java">    <span class="n">m_firstFree</span> <span class="o">+=</span> <span class="mi">2</span><span class="o">;</span></span>
...
<span id="LC1035" class="line" lang="java"><span class="cm">   * Pop a pair of nodes from the tail of the stack.</span></span>
<span id="LC1036" class="line" lang="java"><span class="cm">   * Special purpose method for TransformerImpl, pushElemTemplateElement.</span></span>
<span id="LC1037" class="line" lang="java"><span class="cm">   * Performance critical.</span></span>
<span id="LC1038" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1039" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">popPair</span><span class="o">()</span></span>
<span id="LC1040" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1041" class="line" lang="java"></span>
<span id="LC1042" class="line" lang="java">    <span class="n">m_firstFree</span> <span class="o">-=</span> <span class="mi">2</span><span class="o">;</span></span>
<span id="LC1043" class="line" lang="java">    <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span><span class="o">]</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1044" class="line" lang="java">    <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span> <span class="o">+</span> <span class="mi">1</span><span class="o">]</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC1048" class="line" lang="java"><span class="cm">   * Set the tail of the stack to the given node.</span></span>
<span id="LC1049" class="line" lang="java"><span class="cm">   * Special purpose method for TransformerImpl, pushElemTemplateElement.</span></span>
<span id="LC1050" class="line" lang="java"><span class="cm">   * Performance critical.</span></span>
<span id="LC1051" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1052" class="line" lang="java"><span class="cm">   * @param n Node to set at the tail of vector</span></span>
<span id="LC1053" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1054" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">setTail</span><span class="o">(</span><span class="nc">Node</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC1055" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1056" class="line" lang="java">    <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span> <span class="o">-</span> <span class="mi">1</span><span class="o">]</span> <span class="o">=</span> <span class="n">n</span><span class="o">;</span></span>
...
<span id="LC1060" class="line" lang="java"><span class="cm">   * Set the given node one position from the tail.</span></span>
<span id="LC1061" class="line" lang="java"><span class="cm">   * Special purpose method for TransformerImpl, pushElemTemplateElement.</span></span>
<span id="LC1062" class="line" lang="java"><span class="cm">   * Performance critical.</span></span>
<span id="LC1063" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1064" class="line" lang="java"><span class="cm">   * @param n Node to set</span></span>
<span id="LC1065" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1066" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">setTailSub1</span><span class="o">(</span><span class="nc">Node</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC1067" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1068" class="line" lang="java">    <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span> <span class="o">-</span> <span class="mi">2</span><span class="o">]</span> <span class="o">=</span> <span class="n">n</span><span class="o">;</span></span>
...
<span id="LC1072" class="line" lang="java"><span class="cm">   * Return the node at the tail of the vector without popping</span></span>
<span id="LC1073" class="line" lang="java"><span class="cm">   * Special purpose method for TransformerImpl, pushElemTemplateElement.</span></span>
<span id="LC1074" class="line" lang="java"><span class="cm">   * Performance critical.</span></span>
<span id="LC1075" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1076" class="line" lang="java"><span class="cm">   * @return Node at the tail of the vector</span></span>
<span id="LC1077" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1078" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">Node</span> <span class="nf">peepTail</span><span class="o">()</span></span>
<span id="LC1079" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1080" class="line" lang="java">    <span class="k">return</span> <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span> <span class="o">-</span> <span class="mi">1</span><span class="o">];</span></span>
...
<span id="LC1084" class="line" lang="java"><span class="cm">   * Return the node one position from the tail without popping.</span></span>
<span id="LC1085" class="line" lang="java"><span class="cm">   * Special purpose method for TransformerImpl, pushElemTemplateElement.</span></span>
<span id="LC1086" class="line" lang="java"><span class="cm">   * Performance critical.</span></span>
<span id="LC1087" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1088" class="line" lang="java"><span class="cm">   * @return Node one away from the tail</span></span>
<span id="LC1089" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1090" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">Node</span> <span class="nf">peepTailSub1</span><span class="o">()</span></span>
<span id="LC1091" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1092" class="line" lang="java">    <span class="k">return</span> <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span> <span class="o">-</span> <span class="mi">2</span><span class="o">];</span></span>
...
<span id="LC1096" class="line" lang="java"><span class="cm">   * Inserts the specified node in this vector at the specified index.</span></span>
<span id="LC1097" class="line" lang="java"><span class="cm">   * Each component in this vector with an index greater or equal to</span></span>
<span id="LC1098" class="line" lang="java"><span class="cm">   * the specified index is shifted upward to have an index one greater</span></span>
<span id="LC1099" class="line" lang="java"><span class="cm">   * than the value it had previously.</span></span>
<span id="LC1100" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1101" class="line" lang="java"><span class="cm">   * @param value Node to insert</span></span>
<span id="LC1102" class="line" lang="java"><span class="cm">   * @param at Position where to insert</span></span>
<span id="LC1103" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1104" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">insertElementAt</span><span class="o">(</span><span class="nc">Node</span> <span class="n">value</span><span class="o">,</span> <span class="kt">int</span> <span class="n">at</span><span class="o">)</span></span>
<span id="LC1105" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1106" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_mutable</span><span class="o">)</span></span>
<span id="LC1107" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_NOT_MUTABLE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet is not mutable!");</span></span>
<span id="LC1108" class="line" lang="java"></span>
<span id="LC1109" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_map</span><span class="o">)</span></span>
<span id="LC1110" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1111" class="line" lang="java">      <span class="n">m_map</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Node</span><span class="o">[</span><span class="n">m_blocksize</span><span class="o">];</span></span>
<span id="LC1112" class="line" lang="java">      <span class="n">m_mapSize</span> <span class="o">=</span> <span class="n">m_blocksize</span><span class="o">;</span></span>
<span id="LC1113" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1114" class="line" lang="java">    <span class="k">else</span> <span class="nf">if</span> <span class="o">((</span><span class="n">m_firstFree</span> <span class="o">+</span> <span class="mi">1</span><span class="o">)</span> <span class="o">&gt;=</span> <span class="n">m_mapSize</span><span class="o">)</span></span>
<span id="LC1115" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1116" class="line" lang="java">      <span class="n">m_mapSize</span> <span class="o">+=</span> <span class="n">m_blocksize</span><span class="o">;</span></span>
<span id="LC1117" class="line" lang="java"></span>
<span id="LC1118" class="line" lang="java">      <span class="nc">Node</span> <span class="n">newMap</span><span class="o">[]</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Node</span><span class="o">[</span><span class="n">m_mapSize</span><span class="o">];</span></span>
<span id="LC1119" class="line" lang="java"></span>
<span id="LC1120" class="line" lang="java">      <span class="nc">System</span><span class="o">.</span><span class="na">arraycopy</span><span class="o">(</span><span class="n">m_map</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">newMap</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">m_firstFree</span> <span class="o">+</span> <span class="mi">1</span><span class="o">);</span></span>
<span id="LC1121" class="line" lang="java"></span>
<span id="LC1122" class="line" lang="java">      <span class="n">m_map</span> <span class="o">=</span> <span class="n">newMap</span><span class="o">;</span></span>
<span id="LC1123" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1124" class="line" lang="java"></span>
<span id="LC1125" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">at</span> <span class="o">&lt;=</span> <span class="o">(</span><span class="n">m_firstFree</span> <span class="o">-</span> <span class="mi">1</span><span class="o">))</span></span>
<span id="LC1126" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1127" class="line" lang="java">      <span class="nc">System</span><span class="o">.</span><span class="na">arraycopy</span><span class="o">(</span><span class="n">m_map</span><span class="o">,</span> <span class="n">at</span><span class="o">,</span> <span class="n">m_map</span><span class="o">,</span> <span class="n">at</span> <span class="o">+</span> <span class="mi">1</span><span class="o">,</span> <span class="n">m_firstFree</span> <span class="o">-</span> <span class="n">at</span><span class="o">);</span></span>
<span id="LC1128" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1129" class="line" lang="java"></span>
<span id="LC1130" class="line" lang="java">    <span class="n">m_map</span><span class="o">[</span><span class="n">at</span><span class="o">]</span> <span class="o">=</span> <span class="n">value</span><span class="o">;</span></span>
<span id="LC1131" class="line" lang="java"></span>
<span id="LC1132" class="line" lang="java">    <span class="n">m_firstFree</span><span class="o">++;</span></span>
...
<span id="LC1136" class="line" lang="java"><span class="cm">   * Append the nodes to the list.</span></span>
<span id="LC1137" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1138" class="line" lang="java"><span class="cm">   * @param nodes NodeVector to append to this list</span></span>
<span id="LC1139" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1140" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">appendNodes</span><span class="o">(</span><span class="nc">NodeSet</span> <span class="n">nodes</span><span class="o">)</span></span>
<span id="LC1141" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1142" class="line" lang="java"></span>
<span id="LC1143" class="line" lang="java">    <span class="kt">int</span> <span class="n">nNodes</span> <span class="o">=</span> <span class="n">nodes</span><span class="o">.</span><span class="na">size</span><span class="o">();</span></span>
<span id="LC1144" class="line" lang="java"></span>
<span id="LC1145" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_map</span><span class="o">)</span></span>
<span id="LC1146" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1147" class="line" lang="java">      <span class="n">m_mapSize</span> <span class="o">=</span> <span class="n">nNodes</span> <span class="o">+</span> <span class="n">m_blocksize</span><span class="o">;</span></span>
<span id="LC1148" class="line" lang="java">      <span class="n">m_map</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Node</span><span class="o">[</span><span class="n">m_mapSize</span><span class="o">];</span></span>
<span id="LC1149" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1150" class="line" lang="java">    <span class="k">else</span> <span class="nf">if</span> <span class="o">((</span><span class="n">m_firstFree</span> <span class="o">+</span> <span class="n">nNodes</span><span class="o">)</span> <span class="o">&gt;=</span> <span class="n">m_mapSize</span><span class="o">)</span></span>
<span id="LC1151" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1152" class="line" lang="java">      <span class="n">m_mapSize</span> <span class="o">+=</span> <span class="o">(</span><span class="n">nNodes</span> <span class="o">+</span> <span class="n">m_blocksize</span><span class="o">);</span></span>
<span id="LC1153" class="line" lang="java"></span>
<span id="LC1154" class="line" lang="java">      <span class="nc">Node</span> <span class="n">newMap</span><span class="o">[]</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Node</span><span class="o">[</span><span class="n">m_mapSize</span><span class="o">];</span></span>
<span id="LC1155" class="line" lang="java"></span>
<span id="LC1156" class="line" lang="java">      <span class="nc">System</span><span class="o">.</span><span class="na">arraycopy</span><span class="o">(</span><span class="n">m_map</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">newMap</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">m_firstFree</span> <span class="o">+</span> <span class="n">nNodes</span><span class="o">);</span></span>
<span id="LC1157" class="line" lang="java"></span>
<span id="LC1158" class="line" lang="java">      <span class="n">m_map</span> <span class="o">=</span> <span class="n">newMap</span><span class="o">;</span></span>
<span id="LC1159" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1160" class="line" lang="java"></span>
<span id="LC1161" class="line" lang="java">    <span class="nc">System</span><span class="o">.</span><span class="na">arraycopy</span><span class="o">(</span><span class="n">nodes</span><span class="o">.</span><span class="na">m_map</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">m_map</span><span class="o">,</span> <span class="n">m_firstFree</span><span class="o">,</span> <span class="n">nNodes</span><span class="o">);</span></span>
<span id="LC1162" class="line" lang="java"></span>
<span id="LC1163" class="line" lang="java">    <span class="n">m_firstFree</span> <span class="o">+=</span> <span class="n">nNodes</span><span class="o">;</span></span>
...
<span id="LC1167" class="line" lang="java"><span class="cm">   * Inserts the specified node in this vector at the specified index.</span></span>
<span id="LC1168" class="line" lang="java"><span class="cm">   * Each component in this vector with an index greater or equal to</span></span>
<span id="LC1169" class="line" lang="java"><span class="cm">   * the specified index is shifted upward to have an index one greater</span></span>
<span id="LC1170" class="line" lang="java"><span class="cm">   * than the value it had previously.</span></span>
<span id="LC1171" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1172" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">removeAllElements</span><span class="o">()</span></span>
<span id="LC1173" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1174" class="line" lang="java"></span>
<span id="LC1175" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_map</span><span class="o">)</span></span>
...
<span id="LC1178" class="line" lang="java">    <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">m_firstFree</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC1179" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1180" class="line" lang="java">      <span class="n">m_map</span><span class="o">[</span><span class="n">i</span><span class="o">]</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1181" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1182" class="line" lang="java"></span>
<span id="LC1183" class="line" lang="java">    <span class="n">m_firstFree</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
...
<span id="LC1187" class="line" lang="java"><span class="cm">   * Removes the first occurrence of the argument from this vector.</span></span>
<span id="LC1188" class="line" lang="java"><span class="cm">   * If the object is found in this vector, each component in the vector</span></span>
<span id="LC1189" class="line" lang="java"><span class="cm">   * with an index greater or equal to the object's index is shifted</span></span>
<span id="LC1190" class="line" lang="java"><span class="cm">   * downward to have an index one smaller than the value it had</span></span>
<span id="LC1191" class="line" lang="java"><span class="cm">   * previously.</span></span>
<span id="LC1192" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1193" class="line" lang="java"><span class="cm">   * @param s Node to remove from the list</span></span>
<span id="LC1194" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1195" class="line" lang="java"><span class="cm">   * @return True if the node was successfully removed</span></span>
<span id="LC1196" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1197" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">removeElement</span><span class="o">(</span><span class="nc">Node</span> <span class="n">s</span><span class="o">)</span></span>
<span id="LC1198" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1199" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_mutable</span><span class="o">)</span></span>
<span id="LC1200" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_NOT_MUTABLE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet is not mutable!");</span></span>
<span id="LC1201" class="line" lang="java"></span>
<span id="LC1202" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_map</span><span class="o">)</span></span>
<span id="LC1203" class="line" lang="java">      <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1204" class="line" lang="java"></span>
<span id="LC1205" class="line" lang="java">    <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">m_firstFree</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC1206" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1207" class="line" lang="java">      <span class="nc">Node</span> <span class="n">node</span> <span class="o">=</span> <span class="n">m_map</span><span class="o">[</span><span class="n">i</span><span class="o">];</span></span>
<span id="LC1208" class="line" lang="java"></span>
<span id="LC1209" class="line" lang="java">      <span class="k">if</span> <span class="o">((</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">node</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="n">node</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">s</span><span class="o">))</span></span>
<span id="LC1210" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1211" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">i</span> <span class="o">&lt;</span> <span class="n">m_firstFree</span> <span class="o">-</span> <span class="mi">1</span><span class="o">)</span></span>
<span id="LC1212" class="line" lang="java">          <span class="nc">System</span><span class="o">.</span><span class="na">arraycopy</span><span class="o">(</span><span class="n">m_map</span><span class="o">,</span> <span class="n">i</span> <span class="o">+</span> <span class="mi">1</span><span class="o">,</span> <span class="n">m_map</span><span class="o">,</span> <span class="n">i</span><span class="o">,</span> <span class="n">m_firstFree</span> <span class="o">-</span> <span class="n">i</span> <span class="o">-</span> <span class="mi">1</span><span class="o">);</span></span>
<span id="LC1213" class="line" lang="java"></span>
<span id="LC1214" class="line" lang="java">        <span class="n">m_firstFree</span><span class="o">--;</span></span>
<span id="LC1215" class="line" lang="java">        <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span><span class="o">]</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1216" class="line" lang="java"></span>
<span id="LC1217" class="line" lang="java">        <span class="k">return</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC1221" class="line" lang="java">    <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC1225" class="line" lang="java"><span class="cm">   * Deletes the component at the specified index. Each component in</span></span>
<span id="LC1226" class="line" lang="java"><span class="cm">   * this vector with an index greater or equal to the specified</span></span>
<span id="LC1227" class="line" lang="java"><span class="cm">   * index is shifted downward to have an index one smaller than</span></span>
<span id="LC1228" class="line" lang="java"><span class="cm">   * the value it had previously.</span></span>
<span id="LC1229" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1230" class="line" lang="java"><span class="cm">   * @param i Index of node to remove</span></span>
<span id="LC1231" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1232" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">removeElementAt</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span></span>
<span id="LC1233" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1234" class="line" lang="java"></span>
<span id="LC1235" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_map</span><span class="o">)</span></span>
<span id="LC1236" class="line" lang="java">      <span class="k">return</span><span class="o">;</span></span>
<span id="LC1237" class="line" lang="java"></span>
<span id="LC1238" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">i</span> <span class="o">&gt;=</span> <span class="n">m_firstFree</span><span class="o">)</span></span>
<span id="LC1239" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">ArrayIndexOutOfBoundsException</span><span class="o">(</span><span class="n">i</span> <span class="o">+</span> <span class="s">" &gt;= "</span> <span class="o">+</span> <span class="n">m_firstFree</span><span class="o">);</span></span>
<span id="LC1240" class="line" lang="java">    <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="n">i</span> <span class="o">&lt;</span> <span class="mi">0</span><span class="o">)</span></span>
<span id="LC1241" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">ArrayIndexOutOfBoundsException</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC1242" class="line" lang="java"></span>
<span id="LC1243" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">i</span> <span class="o">&lt;</span> <span class="n">m_firstFree</span> <span class="o">-</span> <span class="mi">1</span><span class="o">)</span></span>
<span id="LC1244" class="line" lang="java">      <span class="nc">System</span><span class="o">.</span><span class="na">arraycopy</span><span class="o">(</span><span class="n">m_map</span><span class="o">,</span> <span class="n">i</span> <span class="o">+</span> <span class="mi">1</span><span class="o">,</span> <span class="n">m_map</span><span class="o">,</span> <span class="n">i</span><span class="o">,</span> <span class="n">m_firstFree</span> <span class="o">-</span> <span class="n">i</span> <span class="o">-</span> <span class="mi">1</span><span class="o">);</span></span>
<span id="LC1245" class="line" lang="java"></span>
<span id="LC1246" class="line" lang="java">    <span class="n">m_firstFree</span><span class="o">--;</span></span>
<span id="LC1247" class="line" lang="java">    <span class="n">m_map</span><span class="o">[</span><span class="n">m_firstFree</span><span class="o">]</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC1251" class="line" lang="java"><span class="cm">   * Sets the component at the specified index of this vector to be the</span></span>
<span id="LC1252" class="line" lang="java"><span class="cm">   * specified object. The previous component at that position is discarded.</span></span>
<span id="LC1253" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1254" class="line" lang="java"><span class="cm">   * The index must be a value greater than or equal to 0 and less</span></span>
<span id="LC1255" class="line" lang="java"><span class="cm">   * than the current size of the vector.</span></span>
<span id="LC1256" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1257" class="line" lang="java"><span class="cm">   * @param node Node to set</span></span>
<span id="LC1258" class="line" lang="java"><span class="cm">   * @param index Index of where to set the node</span></span>
<span id="LC1259" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1260" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setElementAt</span><span class="o">(</span><span class="nc">Node</span> <span class="n">node</span><span class="o">,</span> <span class="kt">int</span> <span class="n">index</span><span class="o">)</span></span>
<span id="LC1261" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1262" class="line" lang="java">    <span class="k">if</span> <span class="o">(!</span><span class="n">m_mutable</span><span class="o">)</span></span>
<span id="LC1263" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESET_NOT_MUTABLE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSet is not mutable!");</span></span>
<span id="LC1264" class="line" lang="java"></span>
<span id="LC1265" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_map</span><span class="o">)</span></span>
<span id="LC1266" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1267" class="line" lang="java">      <span class="n">m_map</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Node</span><span class="o">[</span><span class="n">m_blocksize</span><span class="o">];</span></span>
<span id="LC1268" class="line" lang="java">      <span class="n">m_mapSize</span> <span class="o">=</span> <span class="n">m_blocksize</span><span class="o">;</span></span>
<span id="LC1269" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1270" class="line" lang="java"></span>
<span id="LC1271" class="line" lang="java">    <span class="n">m_map</span><span class="o">[</span><span class="n">index</span><span class="o">]</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
...
<span id="LC1275" class="line" lang="java"><span class="cm">   * Get the nth element.</span></span>
<span id="LC1276" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1277" class="line" lang="java"><span class="cm">   * @param i Index of node to get</span></span>
<span id="LC1278" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1279" class="line" lang="java"><span class="cm">   * @return Node at specified index</span></span>
<span id="LC1280" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1281" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">elementAt</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span></span>
<span id="LC1282" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1283" class="line" lang="java"></span>
<span id="LC1284" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_map</span><span class="o">)</span></span>
<span id="LC1285" class="line" lang="java">      <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1286" class="line" lang="java"></span>
<span id="LC1287" class="line" lang="java">    <span class="k">return</span> <span class="n">m_map</span><span class="o">[</span><span class="n">i</span><span class="o">];</span></span>
...
<span id="LC1291" class="line" lang="java"><span class="cm">   * Tell if the table contains the given node.</span></span>
<span id="LC1292" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1293" class="line" lang="java"><span class="cm">   * @param s Node to look for</span></span>
<span id="LC1294" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1295" class="line" lang="java"><span class="cm">   * @return True if the given node was found.</span></span>
<span id="LC1296" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1297" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">contains</span><span class="o">(</span><span class="nc">Node</span> <span class="n">s</span><span class="o">)</span></span>
<span id="LC1298" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1299" class="line" lang="java">    <span class="n">runTo</span><span class="o">(-</span><span class="mi">1</span><span class="o">);</span></span>
<span id="LC1300" class="line" lang="java"></span>
<span id="LC1301" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_map</span><span class="o">)</span></span>
<span id="LC1302" class="line" lang="java">      <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1303" class="line" lang="java"></span>
<span id="LC1304" class="line" lang="java">    <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">m_firstFree</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC1305" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1306" class="line" lang="java">      <span class="nc">Node</span> <span class="n">node</span> <span class="o">=</span> <span class="n">m_map</span><span class="o">[</span><span class="n">i</span><span class="o">];</span></span>
<span id="LC1307" class="line" lang="java"></span>
<span id="LC1308" class="line" lang="java">      <span class="k">if</span> <span class="o">((</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">node</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="n">node</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">s</span><span class="o">))</span></span>
<span id="LC1309" class="line" lang="java">        <span class="k">return</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC1310" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1311" class="line" lang="java"></span>
<span id="LC1312" class="line" lang="java">    <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC1316" class="line" lang="java"><span class="cm">   * Searches for the first occurence of the given argument,</span></span>
<span id="LC1317" class="line" lang="java"><span class="cm">   * beginning the search at index, and testing for equality</span></span>
<span id="LC1318" class="line" lang="java"><span class="cm">   * using the equals method.</span></span>
<span id="LC1319" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1320" class="line" lang="java"><span class="cm">   * @param elem Node to look for</span></span>
<span id="LC1321" class="line" lang="java"><span class="cm">   * @param index Index of where to start the search</span></span>
<span id="LC1322" class="line" lang="java"><span class="cm">   * @return the index of the first occurrence of the object</span></span>
<span id="LC1323" class="line" lang="java"><span class="cm">   * argument in this vector at position index or later in the</span></span>
<span id="LC1324" class="line" lang="java"><span class="cm">   * vector; returns -1 if the object is not found.</span></span>
<span id="LC1325" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1326" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">indexOf</span><span class="o">(</span><span class="nc">Node</span> <span class="n">elem</span><span class="o">,</span> <span class="kt">int</span> <span class="n">index</span><span class="o">)</span></span>
<span id="LC1327" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1328" class="line" lang="java">    <span class="n">runTo</span><span class="o">(-</span><span class="mi">1</span><span class="o">);</span></span>
<span id="LC1329" class="line" lang="java"></span>
<span id="LC1330" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_map</span><span class="o">)</span></span>
...
<span id="LC1333" class="line" lang="java">    <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="n">index</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">m_firstFree</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC1334" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1335" class="line" lang="java">      <span class="nc">Node</span> <span class="n">node</span> <span class="o">=</span> <span class="n">m_map</span><span class="o">[</span><span class="n">i</span><span class="o">];</span></span>
<span id="LC1336" class="line" lang="java"></span>
<span id="LC1337" class="line" lang="java">      <span class="k">if</span> <span class="o">((</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">node</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="n">node</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">elem</span><span class="o">))</span></span>
<span id="LC1338" class="line" lang="java">        <span class="k">return</span> <span class="n">i</span><span class="o">;</span></span>
...
<span id="LC1345" class="line" lang="java"><span class="cm">   * Searches for the first occurence of the given argument,</span></span>
<span id="LC1346" class="line" lang="java"><span class="cm">   * beginning the search at index, and testing for equality</span></span>
<span id="LC1347" class="line" lang="java"><span class="cm">   * using the equals method.</span></span>
<span id="LC1348" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1349" class="line" lang="java"><span class="cm">   * @param elem Node to look for</span></span>
<span id="LC1350" class="line" lang="java"><span class="cm">   * @return the index of the first occurrence of the object</span></span>
<span id="LC1351" class="line" lang="java"><span class="cm">   * argument in this vector at position index or later in the</span></span>
<span id="LC1352" class="line" lang="java"><span class="cm">   * vector; returns -1 if the object is not found.</span></span>
<span id="LC1353" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1354" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">indexOf</span><span class="o">(</span><span class="nc">Node</span> <span class="n">elem</span><span class="o">)</span></span>
<span id="LC1355" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1356" class="line" lang="java">    <span class="n">runTo</span><span class="o">(-</span><span class="mi">1</span><span class="o">);</span></span>
<span id="LC1357" class="line" lang="java"></span>
<span id="LC1358" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_map</span><span class="o">)</span></span>
...
<span id="LC1361" class="line" lang="java">    <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">m_firstFree</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC1362" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1363" class="line" lang="java">      <span class="nc">Node</span> <span class="n">node</span> <span class="o">=</span> <span class="n">m_map</span><span class="o">[</span><span class="n">i</span><span class="o">];</span></span>
<span id="LC1364" class="line" lang="java"></span>
<span id="LC1365" class="line" lang="java">      <span class="k">if</span> <span class="o">((</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">node</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="n">node</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">elem</span><span class="o">))</span></span>
<span id="LC1366" class="line" lang="java">        <span class="k">return</span> <span class="n">i</span><span class="o">;</span></span>
<span id="LC1367" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1368" class="line" lang="java"></span>
<span id="LC1369" class="line" lang="java">    <span class="k">return</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span></span>
