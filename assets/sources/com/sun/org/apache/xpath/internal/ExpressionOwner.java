...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: ExpressionOwner.java,v 1.1.2.1 2005/08/01 01:30:12 jeffsuttor Exp $</span></span>
...
<span id="LC26" class="line" lang="java"><span class="cm"> * Classes that implement this interface own an expression, which</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * can be rewritten.</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC29" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">ExpressionOwner</span></span>
<span id="LC30" class="line" lang="java"><span class="o">{</span></span>
<span id="LC31" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC32" class="line" lang="java"><span class="cm">   * Get the raw Expression object that this class wraps.</span></span>
<span id="LC33" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC34" class="line" lang="java"><span class="cm">   * @return the raw Expression object, which should not normally be null.</span></span>
<span id="LC35" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC36" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Expression</span> <span class="nf">getExpression</span><span class="o">();</span></span>
<span id="LC37" class="line" lang="java"></span>
<span id="LC38" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">   * Set the raw expression object for this object.</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC41" class="line" lang="java"><span class="cm">   * @param exp the raw Expression object, which should not normally be null.</span></span>
<span id="LC42" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC43" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setExpression</span><span class="o">(</span><span class="nc">Expression</span> <span class="n">exp</span><span class="o">);</span></span>
