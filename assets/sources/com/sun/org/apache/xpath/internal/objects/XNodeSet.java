...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: XNodeSet.java,v 1.2.4.2 2005/09/14 20:34:45 jeffsuttor Exp $</span></span>
...
<span id="LC25" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.dtm.DTM</span><span class="o">;</span></span>
<span id="LC26" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.dtm.DTMIterator</span><span class="o">;</span></span>
...
<span id="LC29" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.NodeSetDTM</span><span class="o">;</span></span>
<span id="LC30" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.axes.NodeSequence</span><span class="o">;</span></span>
...
<span id="LC33" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.traversal.NodeIterator</span><span class="o">;</span></span>
<span id="LC34" class="line" lang="java"></span>
<span id="LC35" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC36" class="line" lang="java"><span class="cm"> * This class represents an XPath nodeset object, and is capable of</span></span>
<span id="LC37" class="line" lang="java"><span class="cm"> * converting the nodeset to other types, such as a string.</span></span>
...
<span id="LC40" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XNodeSet</span> <span class="kd">extends</span> <span class="nc">NodeSequence</span></span>
<span id="LC41" class="line" lang="java"><span class="o">{</span></span>
<span id="LC42" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="mi">1916026368035639667L</span><span class="o">;</span></span>
<span id="LC43" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC44" class="line" lang="java"><span class="cm">   * Default constructor for derived objects.</span></span>
<span id="LC45" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC46" class="line" lang="java">  <span class="kd">protected</span> <span class="nf">XNodeSet</span><span class="o">()</span></span>
...
<span id="LC51" class="line" lang="java"><span class="cm">   * Construct a XNodeSet object.</span></span>
<span id="LC52" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC53" class="line" lang="java"><span class="cm">   * @param val Value of the XNodeSet object</span></span>
<span id="LC54" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC55" class="line" lang="java">  <span class="kd">public</span> <span class="nf">XNodeSet</span><span class="o">(</span><span class="nc">DTMIterator</span> <span class="n">val</span><span class="o">)</span></span>
<span id="LC56" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC57" class="line" lang="java">        <span class="kd">super</span><span class="o">();</span></span>
<span id="LC58" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">val</span> <span class="k">instanceof</span> <span class="nc">XNodeSet</span><span class="o">)</span></span>
<span id="LC59" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC60" class="line" lang="java">            <span class="kd">final</span> <span class="nc">XNodeSet</span> <span class="n">nodeSet</span> <span class="o">=</span> <span class="o">(</span><span class="nc">XNodeSet</span><span class="o">)</span> <span class="n">val</span><span class="o">;</span></span>
<span id="LC61" class="line" lang="java">            <span class="n">setIter</span><span class="o">(</span><span class="n">nodeSet</span><span class="o">.</span><span class="na">m_iter</span><span class="o">);</span></span>
<span id="LC62" class="line" lang="java">            <span class="n">m_dtmMgr</span> <span class="o">=</span> <span class="n">nodeSet</span><span class="o">.</span><span class="na">m_dtmMgr</span><span class="o">;</span></span>
<span id="LC63" class="line" lang="java">            <span class="n">m_last</span> <span class="o">=</span> <span class="n">nodeSet</span><span class="o">.</span><span class="na">m_last</span><span class="o">;</span></span>
<span id="LC64" class="line" lang="java">            <span class="c1">// First make sure the DTMIterator val has a cache,</span></span>
<span id="LC65" class="line" lang="java">            <span class="c1">// so if it doesn't have one, make one.</span></span>
<span id="LC66" class="line" lang="java">            <span class="k">if</span><span class="o">(!</span><span class="n">nodeSet</span><span class="o">.</span><span class="na">hasCache</span><span class="o">())</span></span>
<span id="LC67" class="line" lang="java">                <span class="n">nodeSet</span><span class="o">.</span><span class="na">setShouldCacheNodes</span><span class="o">(</span><span class="kc">true</span><span class="o">);</span></span>
<span id="LC68" class="line" lang="java"></span>
<span id="LC69" class="line" lang="java">            <span class="c1">// Get the cache from val and use it ourselves (we share it).</span></span>
<span id="LC70" class="line" lang="java">            <span class="n">setObject</span><span class="o">(</span><span class="n">nodeSet</span><span class="o">.</span><span class="na">getIteratorCache</span><span class="o">());</span></span>
<span id="LC71" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC72" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC73" class="line" lang="java">        <span class="nf">setIter</span><span class="o">(</span><span class="n">val</span><span class="o">);</span></span>
...
<span id="LC77" class="line" lang="java"><span class="cm">   * Construct a XNodeSet object.</span></span>
<span id="LC78" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC79" class="line" lang="java"><span class="cm">   * @param val Value of the XNodeSet object</span></span>
<span id="LC80" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC81" class="line" lang="java">  <span class="kd">public</span> <span class="nf">XNodeSet</span><span class="o">(</span><span class="nc">XNodeSet</span> <span class="n">val</span><span class="o">)</span></span>
<span id="LC82" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC83" class="line" lang="java">        <span class="kd">super</span><span class="o">();</span></span>
<span id="LC84" class="line" lang="java">    <span class="n">setIter</span><span class="o">(</span><span class="n">val</span><span class="o">.</span><span class="na">m_iter</span><span class="o">);</span></span>
<span id="LC85" class="line" lang="java">    <span class="n">m_dtmMgr</span> <span class="o">=</span> <span class="n">val</span><span class="o">.</span><span class="na">m_dtmMgr</span><span class="o">;</span></span>
<span id="LC86" class="line" lang="java">    <span class="n">m_last</span> <span class="o">=</span> <span class="n">val</span><span class="o">.</span><span class="na">m_last</span><span class="o">;</span></span>
<span id="LC87" class="line" lang="java">    <span class="k">if</span><span class="o">(!</span><span class="n">val</span><span class="o">.</span><span class="na">hasCache</span><span class="o">())</span></span>
<span id="LC88" class="line" lang="java">        <span class="n">val</span><span class="o">.</span><span class="na">setShouldCacheNodes</span><span class="o">(</span><span class="kc">true</span><span class="o">);</span></span>
<span id="LC89" class="line" lang="java">    <span class="n">setObject</span><span class="o">(</span><span class="n">val</span><span class="o">.</span><span class="na">m_obj</span><span class="o">);</span></span>
...
<span id="LC94" class="line" lang="java"><span class="cm">   * Construct an empty XNodeSet object.  This is used to create a mutable</span></span>
<span id="LC95" class="line" lang="java"><span class="cm">   * nodeset to which random nodes may be added.</span></span>
<span id="LC96" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC97" class="line" lang="java">  <span class="kd">public</span> <span class="nf">XNodeSet</span><span class="o">(</span><span class="nc">DTMManager</span> <span class="n">dtmMgr</span><span class="o">)</span></span>
<span id="LC98" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC99" class="line" lang="java">     <span class="k">this</span><span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">,</span><span class="n">dtmMgr</span><span class="o">);</span></span>
...
<span id="LC103" class="line" lang="java"><span class="cm">   * Construct a XNodeSet object for one node.</span></span>
<span id="LC104" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC105" class="line" lang="java"><span class="cm">   * @param n Node to add to the new XNodeSet object</span></span>
<span id="LC106" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC107" class="line" lang="java">  <span class="kd">public</span> <span class="nf">XNodeSet</span><span class="o">(</span><span class="kt">int</span> <span class="n">n</span><span class="o">,</span> <span class="nc">DTMManager</span> <span class="n">dtmMgr</span><span class="o">)</span></span>
<span id="LC108" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC109" class="line" lang="java"></span>
<span id="LC110" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="k">new</span> <span class="nc">NodeSetDTM</span><span class="o">(</span><span class="n">dtmMgr</span><span class="o">));</span></span>
<span id="LC111" class="line" lang="java">    <span class="n">m_dtmMgr</span> <span class="o">=</span> <span class="n">dtmMgr</span><span class="o">;</span></span>
<span id="LC112" class="line" lang="java"></span>
<span id="LC113" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC114" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC115" class="line" lang="java">      <span class="o">((</span><span class="nc">NodeSetDTM</span><span class="o">)</span> <span class="n">m_obj</span><span class="o">).</span><span class="na">addNode</span><span class="o">(</span><span class="n">n</span><span class="o">);</span></span>
<span id="LC116" class="line" lang="java">      <span class="n">m_last</span> <span class="o">=</span> <span class="mi">1</span><span class="o">;</span></span>
<span id="LC117" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC118" class="line" lang="java">    <span class="k">else</span></span>
<span id="LC119" class="line" lang="java">        <span class="n">m_last</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
...
<span id="LC123" class="line" lang="java"><span class="cm">   * Tell that this is a CLASS_NODESET.</span></span>
<span id="LC124" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC125" class="line" lang="java"><span class="cm">   * @return type CLASS_NODESET</span></span>
<span id="LC126" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC127" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getType</span><span class="o">()</span></span>
<span id="LC128" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC129" class="line" lang="java">    <span class="k">return</span> <span class="no">CLASS_NODESET</span><span class="o">;</span></span>
...
<span id="LC133" class="line" lang="java"><span class="cm">   * Given a request type, return the equivalent string.</span></span>
<span id="LC134" class="line" lang="java"><span class="cm">   * For diagnostic purposes.</span></span>
<span id="LC135" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC136" class="line" lang="java"><span class="cm">   * @return type string "#NODESET"</span></span>
<span id="LC137" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC138" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getTypeString</span><span class="o">()</span></span>
<span id="LC139" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC140" class="line" lang="java">    <span class="k">return</span> <span class="s">"#NODESET"</span><span class="o">;</span></span>
...
<span id="LC144" class="line" lang="java"><span class="cm">   * Get numeric value of the string conversion from a single node.</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">   * @param n Node to convert</span></span>
<span id="LC147" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC148" class="line" lang="java"><span class="cm">   * @return numeric value of the string conversion from a single node.</span></span>
<span id="LC149" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC150" class="line" lang="java">  <span class="kd">public</span> <span class="kt">double</span> <span class="nf">getNumberFromNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC151" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC152" class="line" lang="java">    <span class="nc">XMLString</span> <span class="n">xstr</span> <span class="o">=</span> <span class="n">m_dtmMgr</span><span class="o">.</span><span class="na">getDTM</span><span class="o">(</span><span class="n">n</span><span class="o">).</span><span class="na">getStringValue</span><span class="o">(</span><span class="n">n</span><span class="o">);</span></span>
<span id="LC153" class="line" lang="java">    <span class="k">return</span> <span class="n">xstr</span><span class="o">.</span><span class="na">toDouble</span><span class="o">();</span></span>
...
<span id="LC157" class="line" lang="java"><span class="cm">   * Cast result object to a number.</span></span>
<span id="LC158" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC159" class="line" lang="java"><span class="cm">   * @return numeric value of the string conversion from the</span></span>
<span id="LC160" class="line" lang="java"><span class="cm">   * next node in the NodeSetDTM, or NAN if no node was found</span></span>
<span id="LC161" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC162" class="line" lang="java">  <span class="kd">public</span> <span class="kt">double</span> <span class="nf">num</span><span class="o">()</span></span>
<span id="LC163" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC164" class="line" lang="java"></span>
<span id="LC165" class="line" lang="java">    <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">item</span><span class="o">(</span><span class="mi">0</span><span class="o">);</span></span>
<span id="LC166" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">node</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span> <span class="o">?</span> <span class="n">getNumberFromNode</span><span class="o">(</span><span class="n">node</span><span class="o">)</span> <span class="o">:</span> <span class="nc">Double</span><span class="o">.</span><span class="na">NaN</span><span class="o">;</span></span>
...
<span id="LC170" class="line" lang="java"><span class="cm">   * Cast result object to a number, but allow side effects, such as the</span></span>
<span id="LC171" class="line" lang="java"><span class="cm">   * incrementing of an iterator.</span></span>
<span id="LC172" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC173" class="line" lang="java"><span class="cm">   * @return numeric value of the string conversion from the</span></span>
<span id="LC174" class="line" lang="java"><span class="cm">   * next node in the NodeSetDTM, or NAN if no node was found</span></span>
<span id="LC175" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC176" class="line" lang="java">  <span class="kd">public</span> <span class="kt">double</span> <span class="nf">numWithSideEffects</span><span class="o">()</span></span>
<span id="LC177" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC178" class="line" lang="java">    <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">nextNode</span><span class="o">();</span></span>
<span id="LC179" class="line" lang="java"></span>
<span id="LC180" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">node</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span> <span class="o">?</span> <span class="n">getNumberFromNode</span><span class="o">(</span><span class="n">node</span><span class="o">)</span> <span class="o">:</span> <span class="nc">Double</span><span class="o">.</span><span class="na">NaN</span><span class="o">;</span></span>
...
<span id="LC185" class="line" lang="java"><span class="cm">   * Cast result object to a boolean.</span></span>
<span id="LC186" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC187" class="line" lang="java"><span class="cm">   * @return True if there is a next node in the nodeset</span></span>
<span id="LC188" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC189" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">bool</span><span class="o">()</span></span>
<span id="LC190" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC191" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">item</span><span class="o">(</span><span class="mi">0</span><span class="o">)</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">);</span></span>
...
<span id="LC195" class="line" lang="java"><span class="cm">   * Cast result object to a boolean, but allow side effects, such as the</span></span>
<span id="LC196" class="line" lang="java"><span class="cm">   * incrementing of an iterator.</span></span>
<span id="LC197" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">   * @return True if there is a next node in the nodeset</span></span>
<span id="LC199" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC200" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">boolWithSideEffects</span><span class="o">()</span></span>
<span id="LC201" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC202" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">nextNode</span><span class="o">()</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">);</span></span>
...
<span id="LC207" class="line" lang="java"><span class="cm">   * Get the string conversion from a single node.</span></span>
<span id="LC208" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC209" class="line" lang="java"><span class="cm">   * @param n Node to convert</span></span>
<span id="LC210" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC211" class="line" lang="java"><span class="cm">   * @return the string conversion from a single node.</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC213" class="line" lang="java">  <span class="kd">public</span> <span class="nc">XMLString</span> <span class="nf">getStringFromNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC214" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC215" class="line" lang="java">    <span class="c1">// %OPT%</span></span>
<span id="LC216" class="line" lang="java">    <span class="c1">// I guess we'll have to get a static instance of the DTM manager...</span></span>
<span id="LC217" class="line" lang="java">    <span class="k">if</span><span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC218" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC219" class="line" lang="java">      <span class="k">return</span> <span class="n">m_dtmMgr</span><span class="o">.</span><span class="na">getDTM</span><span class="o">(</span><span class="n">n</span><span class="o">).</span><span class="na">getStringValue</span><span class="o">(</span><span class="n">n</span><span class="o">);</span></span>
...
<span id="LC223" class="line" lang="java">      <span class="k">return</span> <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xpath</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">objects</span><span class="o">.</span><span class="na">XString</span><span class="o">.</span><span class="na">EMPTYSTRING</span><span class="o">;</span></span>
...
<span id="LC228" class="line" lang="java"><span class="cm">   * Directly call the</span></span>
<span id="LC229" class="line" lang="java"><span class="cm">   * characters method on the passed ContentHandler for the</span></span>
<span id="LC230" class="line" lang="java"><span class="cm">   * string-value. Multiple calls to the</span></span>
<span id="LC231" class="line" lang="java"><span class="cm">   * ContentHandler's characters methods may well occur for a single call to</span></span>
<span id="LC232" class="line" lang="java"><span class="cm">   * this method.</span></span>
<span id="LC233" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC234" class="line" lang="java"><span class="cm">   * @param ch A non-null reference to a ContentHandler.</span></span>
<span id="LC235" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC236" class="line" lang="java"><span class="cm">   * @throws org.xml.sax.SAXException</span></span>
<span id="LC237" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC238" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">dispatchCharactersEvents</span><span class="o">(</span><span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">ContentHandler</span> <span class="n">ch</span><span class="o">)</span></span>
...
<span id="LC241" class="line" lang="java">    <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">item</span><span class="o">(</span><span class="mi">0</span><span class="o">);</span></span>
<span id="LC242" class="line" lang="java"></span>
<span id="LC243" class="line" lang="java">    <span class="k">if</span><span class="o">(</span><span class="n">node</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span></span>
<span id="LC244" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC245" class="line" lang="java">      <span class="n">m_dtmMgr</span><span class="o">.</span><span class="na">getDTM</span><span class="o">(</span><span class="n">node</span><span class="o">).</span><span class="na">dispatchCharactersEvents</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="n">ch</span><span class="o">,</span> <span class="kc">false</span><span class="o">);</span></span>
...
<span id="LC251" class="line" lang="java"><span class="cm">   * Cast result object to an XMLString.</span></span>
<span id="LC252" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC253" class="line" lang="java"><span class="cm">   * @return The document fragment node data or the empty string.</span></span>
<span id="LC254" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC255" class="line" lang="java">  <span class="kd">public</span> <span class="nc">XMLString</span> <span class="nf">xstr</span><span class="o">()</span></span>
<span id="LC256" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC257" class="line" lang="java">    <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">item</span><span class="o">(</span><span class="mi">0</span><span class="o">);</span></span>
<span id="LC258" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">node</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span> <span class="o">?</span> <span class="n">getStringFromNode</span><span class="o">(</span><span class="n">node</span><span class="o">)</span> <span class="o">:</span> <span class="nc">XString</span><span class="o">.</span><span class="na">EMPTYSTRING</span><span class="o">;</span></span>
...
<span id="LC262" class="line" lang="java"><span class="cm">   * Cast result object to a string.</span></span>
<span id="LC263" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC264" class="line" lang="java"><span class="cm">   * @return The string this wraps or the empty string if null</span></span>
<span id="LC265" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC266" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">appendToFsb</span><span class="o">(</span><span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">utils</span><span class="o">.</span><span class="na">FastStringBuffer</span> <span class="n">fsb</span><span class="o">)</span></span>
<span id="LC267" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC268" class="line" lang="java">    <span class="nc">XString</span> <span class="n">xstring</span> <span class="o">=</span> <span class="o">(</span><span class="nc">XString</span><span class="o">)</span><span class="n">xstr</span><span class="o">();</span></span>
<span id="LC269" class="line" lang="java">    <span class="n">xstring</span><span class="o">.</span><span class="na">appendToFsb</span><span class="o">(</span><span class="n">fsb</span><span class="o">);</span></span>
...
<span id="LC274" class="line" lang="java"><span class="cm">   * Cast result object to a string.</span></span>
<span id="LC275" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC276" class="line" lang="java"><span class="cm">   * @return the string conversion from the next node in the nodeset</span></span>
<span id="LC277" class="line" lang="java"><span class="cm">   * or "" if there is no next node</span></span>
<span id="LC278" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC279" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">str</span><span class="o">()</span></span>
<span id="LC280" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC281" class="line" lang="java">    <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">item</span><span class="o">(</span><span class="mi">0</span><span class="o">);</span></span>
<span id="LC282" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">node</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span> <span class="o">?</span> <span class="n">getStringFromNode</span><span class="o">(</span><span class="n">node</span><span class="o">).</span><span class="na">toString</span><span class="o">()</span> <span class="o">:</span> <span class="s">""</span><span class="o">;</span></span>
...
<span id="LC286" class="line" lang="java"><span class="cm">   * Return a java object that's closest to the representation</span></span>
<span id="LC287" class="line" lang="java"><span class="cm">   * that should be handed to an extension.</span></span>
<span id="LC288" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">   * @return The object that this class wraps</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC291" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Object</span> <span class="nf">object</span><span class="o">()</span></span>
<span id="LC292" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC293" class="line" lang="java">    <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_obj</span><span class="o">)</span></span>
<span id="LC294" class="line" lang="java">        <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
<span id="LC295" class="line" lang="java">    <span class="k">else</span></span>
<span id="LC296" class="line" lang="java">        <span class="k">return</span> <span class="n">m_obj</span><span class="o">;</span></span>
<span id="LC297" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC298" class="line" lang="java"></span>
<span id="LC299" class="line" lang="java">  <span class="c1">// %REVIEW%</span></span>
<span id="LC300" class="line" lang="java">  <span class="c1">// hmmm...</span></span>
<span id="LC301" class="line" lang="java"><span class="c1">//  /**</span></span>
<span id="LC302" class="line" lang="java"><span class="c1">//   * Cast result object to a result tree fragment.</span></span>
<span id="LC303" class="line" lang="java"><span class="c1">//   *</span></span>
<span id="LC304" class="line" lang="java"><span class="c1">//   * @param support The XPath context to use for the conversion</span></span>
<span id="LC305" class="line" lang="java"><span class="c1">//   *</span></span>
<span id="LC306" class="line" lang="java"><span class="c1">//   * @return the nodeset as a result tree fragment.</span></span>
<span id="LC307" class="line" lang="java"><span class="c1">//   */</span></span>
<span id="LC308" class="line" lang="java"><span class="c1">//  public DocumentFragment rtree(XPathContext support)</span></span>
<span id="LC309" class="line" lang="java"><span class="c1">//  {</span></span>
<span id="LC310" class="line" lang="java"><span class="c1">//    DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();</span></span>
<span id="LC311" class="line" lang="java"><span class="c1">//    DocumentBuilder db = dbf.newDocumentBuilder();</span></span>
<span id="LC312" class="line" lang="java"><span class="c1">//    Document myDoc = db.newDocument();</span></span>
<span id="LC313" class="line" lang="java"><span class="c1">//</span></span>
<span id="LC314" class="line" lang="java"><span class="c1">//    DocumentFragment docFrag = myDoc.createDocumentFragment();</span></span>
<span id="LC315" class="line" lang="java"><span class="c1">//</span></span>
<span id="LC316" class="line" lang="java"><span class="c1">//    DTMIterator nl = iter();</span></span>
<span id="LC317" class="line" lang="java"><span class="c1">//    int node;</span></span>
<span id="LC318" class="line" lang="java"><span class="c1">//</span></span>
<span id="LC319" class="line" lang="java"><span class="c1">//    while (DTM.NULL != (node = nl.nextNode()))</span></span>
<span id="LC320" class="line" lang="java"><span class="c1">//    {</span></span>
<span id="LC321" class="line" lang="java"><span class="c1">//      frag.appendChild(node, true, true);</span></span>
<span id="LC322" class="line" lang="java"><span class="c1">//    }</span></span>
<span id="LC323" class="line" lang="java"><span class="c1">//</span></span>
<span id="LC324" class="line" lang="java"><span class="c1">//    return frag.getDocument();</span></span>
...
<span id="LC328" class="line" lang="java"><span class="cm">   * Cast result object to a nodelist.</span></span>
<span id="LC329" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC330" class="line" lang="java"><span class="cm">   * @return a NodeIterator.</span></span>
<span id="LC331" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC332" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC333" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC334" class="line" lang="java">  <span class="kd">public</span> <span class="nc">NodeIterator</span> <span class="nf">nodeset</span><span class="o">()</span> <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC335" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC336" class="line" lang="java">    <span class="k">return</span> <span class="k">new</span> <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">dtm</span><span class="o">.</span><span class="na">ref</span><span class="o">.</span><span class="na">DTMNodeIterator</span><span class="o">(</span><span class="n">iter</span><span class="o">());</span></span>
...
<span id="LC340" class="line" lang="java"><span class="cm">   * Cast result object to a nodelist.</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC342" class="line" lang="java"><span class="cm">   * @return a NodeList.</span></span>
<span id="LC343" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC344" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC345" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC346" class="line" lang="java">  <span class="kd">public</span> <span class="nc">NodeList</span> <span class="nf">nodelist</span><span class="o">()</span> <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC347" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC348" class="line" lang="java">    <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">dtm</span><span class="o">.</span><span class="na">ref</span><span class="o">.</span><span class="na">DTMNodeList</span> <span class="n">nodelist</span> <span class="o">=</span> <span class="k">new</span> <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">dtm</span><span class="o">.</span><span class="na">ref</span><span class="o">.</span><span class="na">DTMNodeList</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC349" class="line" lang="java">    <span class="c1">// Creating a DTMNodeList has the side-effect that it will create a clone</span></span>
<span id="LC350" class="line" lang="java">    <span class="c1">// XNodeSet with cache and run m_iter to the end. You cannot get any node</span></span>
<span id="LC351" class="line" lang="java">    <span class="c1">// from m_iter after this call. As a fix, we call SetVector() on the clone's</span></span>
<span id="LC352" class="line" lang="java">    <span class="c1">// cache. See Bugzilla 14406.</span></span>
<span id="LC353" class="line" lang="java">    <span class="nc">XNodeSet</span> <span class="n">clone</span> <span class="o">=</span> <span class="o">(</span><span class="nc">XNodeSet</span><span class="o">)</span><span class="n">nodelist</span><span class="o">.</span><span class="na">getDTMIterator</span><span class="o">();</span></span>
<span id="LC354" class="line" lang="java">    <span class="nc">SetVector</span><span class="o">(</span><span class="n">clone</span><span class="o">.</span><span class="na">getVector</span><span class="o">());</span></span>
<span id="LC355" class="line" lang="java">    <span class="k">return</span> <span class="n">nodelist</span><span class="o">;</span></span>
...
<span id="LC360" class="line" lang="java"><span class="c1">//   * Return a java object that's closest to the representation</span></span>
<span id="LC361" class="line" lang="java"><span class="c1">//   * that should be handed to an extension.</span></span>
<span id="LC362" class="line" lang="java"><span class="c1">//   *</span></span>
<span id="LC363" class="line" lang="java"><span class="c1">//   * @return The object that this class wraps</span></span>
<span id="LC364" class="line" lang="java"><span class="c1">//   */</span></span>
<span id="LC365" class="line" lang="java"><span class="c1">//  public Object object()</span></span>
<span id="LC366" class="line" lang="java"><span class="c1">//  {</span></span>
<span id="LC367" class="line" lang="java"><span class="c1">//    return new com.sun.org.apache.xml.internal.dtm.ref.DTMNodeList(iter());</span></span>
...
<span id="LC371" class="line" lang="java"><span class="cm">   * Return the iterator without cloning, etc.</span></span>
<span id="LC372" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC373" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMIterator</span> <span class="nf">iterRaw</span><span class="o">()</span></span>
<span id="LC374" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC375" class="line" lang="java">    <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
<span id="LC376" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC377" class="line" lang="java"></span>
<span id="LC378" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">release</span><span class="o">(</span><span class="nc">DTMIterator</span> <span class="n">iter</span><span class="o">)</span></span>
...
<span id="LC383" class="line" lang="java"><span class="cm">   * Cast result object to a nodelist.</span></span>
<span id="LC384" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC385" class="line" lang="java"><span class="cm">   * @return The nodeset as a nodelist</span></span>
<span id="LC386" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC387" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMIterator</span> <span class="nf">iter</span><span class="o">()</span></span>
<span id="LC388" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC389" class="line" lang="java">    <span class="k">try</span></span>
<span id="LC390" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC391" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">hasCache</span><span class="o">())</span></span>
<span id="LC392" class="line" lang="java">                <span class="k">return</span> <span class="nf">cloneWithReset</span><span class="o">();</span></span>
<span id="LC393" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC394" class="line" lang="java">                <span class="k">return</span> <span class="k">this</span><span class="o">;</span> <span class="c1">// don't bother to clone... won't do any good!</span></span>
<span id="LC395" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC396" class="line" lang="java">    <span class="k">catch</span> <span class="o">(</span><span class="nc">CloneNotSupportedException</span> <span class="n">cnse</span><span class="o">)</span></span>
<span id="LC397" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC398" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="n">cnse</span><span class="o">.</span><span class="na">getMessage</span><span class="o">());</span></span>
...
<span id="LC403" class="line" lang="java"><span class="cm">   * Get a fresh copy of the object.  For use with variables.</span></span>
<span id="LC404" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC405" class="line" lang="java"><span class="cm">   * @return A fresh nodelist.</span></span>
<span id="LC406" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC407" class="line" lang="java">  <span class="kd">public</span> <span class="nc">XObject</span> <span class="nf">getFresh</span><span class="o">()</span></span>
<span id="LC408" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC409" class="line" lang="java">    <span class="k">try</span></span>
<span id="LC410" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC411" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">hasCache</span><span class="o">())</span></span>
<span id="LC412" class="line" lang="java">                <span class="k">return</span> <span class="o">(</span><span class="nc">XObject</span><span class="o">)</span><span class="n">cloneWithReset</span><span class="o">();</span></span>
<span id="LC413" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC414" class="line" lang="java">                <span class="k">return</span> <span class="k">this</span><span class="o">;</span> <span class="c1">// don't bother to clone... won't do any good!</span></span>
<span id="LC415" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC416" class="line" lang="java">    <span class="k">catch</span> <span class="o">(</span><span class="nc">CloneNotSupportedException</span> <span class="n">cnse</span><span class="o">)</span></span>
<span id="LC417" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC418" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="n">cnse</span><span class="o">.</span><span class="na">getMessage</span><span class="o">());</span></span>
...
<span id="LC423" class="line" lang="java"><span class="cm">   * Cast result object to a mutableNodeset.</span></span>
<span id="LC424" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC425" class="line" lang="java"><span class="cm">   * @return The nodeset as a mutableNodeset</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC427" class="line" lang="java">  <span class="kd">public</span> <span class="nc">NodeSetDTM</span> <span class="nf">mutableNodeset</span><span class="o">()</span></span>
<span id="LC428" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC429" class="line" lang="java">    <span class="nc">NodeSetDTM</span> <span class="n">mnl</span><span class="o">;</span></span>
<span id="LC430" class="line" lang="java"></span>
<span id="LC431" class="line" lang="java">    <span class="k">if</span><span class="o">(</span><span class="n">m_obj</span> <span class="k">instanceof</span> <span class="nc">NodeSetDTM</span><span class="o">)</span></span>
<span id="LC432" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC433" class="line" lang="java">      <span class="n">mnl</span> <span class="o">=</span> <span class="o">(</span><span class="nc">NodeSetDTM</span><span class="o">)</span> <span class="n">m_obj</span><span class="o">;</span></span>
<span id="LC434" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC435" class="line" lang="java">    <span class="k">else</span></span>
<span id="LC436" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC437" class="line" lang="java">      <span class="n">mnl</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">NodeSetDTM</span><span class="o">(</span><span class="n">iter</span><span class="o">());</span></span>
<span id="LC438" class="line" lang="java">      <span class="n">setObject</span><span class="o">(</span><span class="n">mnl</span><span class="o">);</span></span>
<span id="LC439" class="line" lang="java">      <span class="n">setCurrentPos</span><span class="o">(</span><span class="mi">0</span><span class="o">);</span></span>
<span id="LC440" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC441" class="line" lang="java"></span>
<span id="LC442" class="line" lang="java">    <span class="k">return</span> <span class="n">mnl</span><span class="o">;</span></span>
<span id="LC443" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC444" class="line" lang="java"></span>
<span id="LC445" class="line" lang="java">  <span class="cm">/** Less than comparator         */</span></span>
<span id="LC446" class="line" lang="java">  <span class="kd">static</span> <span class="kd">final</span> <span class="nc">LessThanComparator</span> <span class="no">S_LT</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">LessThanComparator</span><span class="o">();</span></span>
<span id="LC447" class="line" lang="java"></span>
<span id="LC448" class="line" lang="java">  <span class="cm">/** Less than or equal comparator          */</span></span>
<span id="LC449" class="line" lang="java">  <span class="kd">static</span> <span class="kd">final</span> <span class="nc">LessThanOrEqualComparator</span> <span class="no">S_LTE</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">LessThanOrEqualComparator</span><span class="o">();</span></span>
<span id="LC450" class="line" lang="java"></span>
<span id="LC451" class="line" lang="java">  <span class="cm">/** Greater than comparator         */</span></span>
<span id="LC452" class="line" lang="java">  <span class="kd">static</span> <span class="kd">final</span> <span class="nc">GreaterThanComparator</span> <span class="no">S_GT</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">GreaterThanComparator</span><span class="o">();</span></span>
<span id="LC453" class="line" lang="java"></span>
<span id="LC454" class="line" lang="java">  <span class="cm">/** Greater than or equal comparator          */</span></span>
<span id="LC455" class="line" lang="java">  <span class="kd">static</span> <span class="kd">final</span> <span class="nc">GreaterThanOrEqualComparator</span> <span class="no">S_GTE</span> <span class="o">=</span></span>
<span id="LC456" class="line" lang="java">    <span class="k">new</span> <span class="nf">GreaterThanOrEqualComparator</span><span class="o">();</span></span>
<span id="LC457" class="line" lang="java"></span>
<span id="LC458" class="line" lang="java">  <span class="cm">/** Equal comparator         */</span></span>
<span id="LC459" class="line" lang="java">  <span class="kd">static</span> <span class="kd">final</span> <span class="nc">EqualComparator</span> <span class="no">S_EQ</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">EqualComparator</span><span class="o">();</span></span>
<span id="LC460" class="line" lang="java"></span>
<span id="LC461" class="line" lang="java">  <span class="cm">/** Not equal comparator         */</span></span>
<span id="LC462" class="line" lang="java">  <span class="kd">static</span> <span class="kd">final</span> <span class="nc">NotEqualComparator</span> <span class="no">S_NEQ</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">NotEqualComparator</span><span class="o">();</span></span>
<span id="LC463" class="line" lang="java"></span>
<span id="LC464" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC465" class="line" lang="java"><span class="cm">   * Tell if one object is less than the other.</span></span>
<span id="LC466" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC467" class="line" lang="java"><span class="cm">   * @param obj2 Object to compare this nodeset to</span></span>
<span id="LC468" class="line" lang="java"><span class="cm">   * @param comparator Comparator to use</span></span>
<span id="LC469" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC470" class="line" lang="java"><span class="cm">   * @return See the comments below for each object type comparison</span></span>
<span id="LC471" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC472" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC473" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC474" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">compare</span><span class="o">(</span><span class="nc">XObject</span> <span class="n">obj2</span><span class="o">,</span> <span class="nc">Comparator</span> <span class="n">comparator</span><span class="o">)</span></span>
<span id="LC475" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC476" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC477" class="line" lang="java"></span>
<span id="LC478" class="line" lang="java">    <span class="kt">boolean</span> <span class="n">result</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC479" class="line" lang="java">    <span class="kt">int</span> <span class="n">type</span> <span class="o">=</span> <span class="n">obj2</span><span class="o">.</span><span class="na">getType</span><span class="o">();</span></span>
<span id="LC480" class="line" lang="java"></span>
<span id="LC481" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="nc">XObject</span><span class="o">.</span><span class="na">CLASS_NODESET</span> <span class="o">==</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC482" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC483" class="line" lang="java">      <span class="c1">// %OPT% This should be XMLString based instead of string based...</span></span>
<span id="LC484" class="line" lang="java"></span>
<span id="LC485" class="line" lang="java">      <span class="c1">// From http://www.w3.org/TR/xpath:</span></span>
<span id="LC486" class="line" lang="java">      <span class="c1">// If both objects to be compared are node-sets, then the comparison</span></span>
<span id="LC487" class="line" lang="java">      <span class="c1">// will be true if and only if there is a node in the first node-set</span></span>
<span id="LC488" class="line" lang="java">      <span class="c1">// and a node in the second node-set such that the result of performing</span></span>
<span id="LC489" class="line" lang="java">      <span class="c1">// the comparison on the string-values of the two nodes is true.</span></span>
<span id="LC490" class="line" lang="java">      <span class="c1">// Note this little gem from the draft:</span></span>
<span id="LC491" class="line" lang="java">      <span class="c1">// NOTE: If $x is bound to a node-set, then $x="foo"</span></span>
<span id="LC492" class="line" lang="java">      <span class="c1">// does not mean the same as not($x!="foo"): the former</span></span>
<span id="LC493" class="line" lang="java">      <span class="c1">// is true if and only if some node in $x has the string-value</span></span>
<span id="LC494" class="line" lang="java">      <span class="c1">// foo; the latter is true if and only if all nodes in $x have</span></span>
<span id="LC495" class="line" lang="java">      <span class="c1">// the string-value foo.</span></span>
<span id="LC496" class="line" lang="java">      <span class="nc">DTMIterator</span> <span class="n">list1</span> <span class="o">=</span> <span class="n">iterRaw</span><span class="o">();</span></span>
<span id="LC497" class="line" lang="java">      <span class="nc">DTMIterator</span> <span class="n">list2</span> <span class="o">=</span> <span class="o">((</span><span class="nc">XNodeSet</span><span class="o">)</span> <span class="n">obj2</span><span class="o">).</span><span class="na">iterRaw</span><span class="o">();</span></span>
<span id="LC498" class="line" lang="java">      <span class="kt">int</span> <span class="n">node1</span><span class="o">;</span></span>
<span id="LC499" class="line" lang="java">      <span class="n">java</span><span class="o">.</span><span class="na">util</span><span class="o">.</span><span class="na">Vector</span> <span class="n">node2Strings</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC500" class="line" lang="java"></span>
<span id="LC501" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">node1</span> <span class="o">=</span> <span class="n">list1</span><span class="o">.</span><span class="na">nextNode</span><span class="o">()))</span></span>
<span id="LC502" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC503" class="line" lang="java">        <span class="nc">XMLString</span> <span class="n">s1</span> <span class="o">=</span> <span class="n">getStringFromNode</span><span class="o">(</span><span class="n">node1</span><span class="o">);</span></span>
<span id="LC504" class="line" lang="java"></span>
<span id="LC505" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">node2Strings</span><span class="o">)</span></span>
<span id="LC506" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC507" class="line" lang="java">          <span class="kt">int</span> <span class="n">node2</span><span class="o">;</span></span>
<span id="LC508" class="line" lang="java"></span>
<span id="LC509" class="line" lang="java">          <span class="k">while</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">node2</span> <span class="o">=</span> <span class="n">list2</span><span class="o">.</span><span class="na">nextNode</span><span class="o">()))</span></span>
<span id="LC510" class="line" lang="java">          <span class="o">{</span></span>
<span id="LC511" class="line" lang="java">            <span class="nc">XMLString</span> <span class="n">s2</span> <span class="o">=</span> <span class="n">getStringFromNode</span><span class="o">(</span><span class="n">node2</span><span class="o">);</span></span>
<span id="LC512" class="line" lang="java"></span>
<span id="LC513" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">comparator</span><span class="o">.</span><span class="na">compareStrings</span><span class="o">(</span><span class="n">s1</span><span class="o">,</span> <span class="n">s2</span><span class="o">))</span></span>
<span id="LC514" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC515" class="line" lang="java">              <span class="n">result</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC520" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">node2Strings</span><span class="o">)</span></span>
<span id="LC521" class="line" lang="java">              <span class="n">node2Strings</span> <span class="o">=</span> <span class="k">new</span> <span class="n">java</span><span class="o">.</span><span class="na">util</span><span class="o">.</span><span class="na">Vector</span><span class="o">();</span></span>
<span id="LC522" class="line" lang="java"></span>
<span id="LC523" class="line" lang="java">            <span class="n">node2Strings</span><span class="o">.</span><span class="na">addElement</span><span class="o">(</span><span class="n">s2</span><span class="o">);</span></span>
...
<span id="LC528" class="line" lang="java">          <span class="kt">int</span> <span class="n">n</span> <span class="o">=</span> <span class="n">node2Strings</span><span class="o">.</span><span class="na">size</span><span class="o">();</span></span>
<span id="LC529" class="line" lang="java"></span>
<span id="LC530" class="line" lang="java">          <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">n</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC531" class="line" lang="java">          <span class="o">{</span></span>
<span id="LC532" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">comparator</span><span class="o">.</span><span class="na">compareStrings</span><span class="o">(</span><span class="n">s1</span><span class="o">,</span> <span class="o">(</span><span class="nc">XMLString</span><span class="o">)</span><span class="n">node2Strings</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">i</span><span class="o">)))</span></span>
<span id="LC533" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC534" class="line" lang="java">              <span class="n">result</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC541" class="line" lang="java">      <span class="n">list1</span><span class="o">.</span><span class="na">reset</span><span class="o">();</span></span>
<span id="LC542" class="line" lang="java">      <span class="n">list2</span><span class="o">.</span><span class="na">reset</span><span class="o">();</span></span>
<span id="LC543" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC544" class="line" lang="java">    <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="nc">XObject</span><span class="o">.</span><span class="na">CLASS_BOOLEAN</span> <span class="o">==</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC545" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC546" class="line" lang="java"></span>
<span id="LC547" class="line" lang="java">      <span class="c1">// From http://www.w3.org/TR/xpath:</span></span>
<span id="LC548" class="line" lang="java">      <span class="c1">// If one object to be compared is a node-set and the other is a boolean,</span></span>
<span id="LC549" class="line" lang="java">      <span class="c1">// then the comparison will be true if and only if the result of</span></span>
<span id="LC550" class="line" lang="java">      <span class="c1">// performing the comparison on the boolean and on the result of</span></span>
<span id="LC551" class="line" lang="java">      <span class="c1">// converting the node-set to a boolean using the boolean function</span></span>
<span id="LC552" class="line" lang="java">      <span class="c1">// is true.</span></span>
<span id="LC553" class="line" lang="java">      <span class="kt">double</span> <span class="n">num1</span> <span class="o">=</span> <span class="n">bool</span><span class="o">()</span> <span class="o">?</span> <span class="mf">1.0</span> <span class="o">:</span> <span class="mf">0.0</span><span class="o">;</span></span>
<span id="LC554" class="line" lang="java">      <span class="kt">double</span> <span class="n">num2</span> <span class="o">=</span> <span class="n">obj2</span><span class="o">.</span><span class="na">num</span><span class="o">();</span></span>
<span id="LC555" class="line" lang="java"></span>
<span id="LC556" class="line" lang="java">      <span class="n">result</span> <span class="o">=</span> <span class="n">comparator</span><span class="o">.</span><span class="na">compareNumbers</span><span class="o">(</span><span class="n">num1</span><span class="o">,</span> <span class="n">num2</span><span class="o">);</span></span>
<span id="LC557" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC558" class="line" lang="java">    <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="nc">XObject</span><span class="o">.</span><span class="na">CLASS_NUMBER</span> <span class="o">==</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC559" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC560" class="line" lang="java"></span>
<span id="LC561" class="line" lang="java">      <span class="c1">// From http://www.w3.org/TR/xpath:</span></span>
<span id="LC562" class="line" lang="java">      <span class="c1">// If one object to be compared is a node-set and the other is a number,</span></span>
<span id="LC563" class="line" lang="java">      <span class="c1">// then the comparison will be true if and only if there is a</span></span>
<span id="LC564" class="line" lang="java">      <span class="c1">// node in the node-set such that the result of performing the</span></span>
<span id="LC565" class="line" lang="java">      <span class="c1">// comparison on the number to be compared and on the result of</span></span>
<span id="LC566" class="line" lang="java">      <span class="c1">// converting the string-value of that node to a number using</span></span>
<span id="LC567" class="line" lang="java">      <span class="c1">// the number function is true.</span></span>
<span id="LC568" class="line" lang="java">      <span class="nc">DTMIterator</span> <span class="n">list1</span> <span class="o">=</span> <span class="n">iterRaw</span><span class="o">();</span></span>
<span id="LC569" class="line" lang="java">      <span class="kt">double</span> <span class="n">num2</span> <span class="o">=</span> <span class="n">obj2</span><span class="o">.</span><span class="na">num</span><span class="o">();</span></span>
<span id="LC570" class="line" lang="java">      <span class="kt">int</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC571" class="line" lang="java"></span>
<span id="LC572" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">node</span> <span class="o">=</span> <span class="n">list1</span><span class="o">.</span><span class="na">nextNode</span><span class="o">()))</span></span>
<span id="LC573" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC574" class="line" lang="java">        <span class="kt">double</span> <span class="n">num1</span> <span class="o">=</span> <span class="n">getNumberFromNode</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC575" class="line" lang="java"></span>
<span id="LC576" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">comparator</span><span class="o">.</span><span class="na">compareNumbers</span><span class="o">(</span><span class="n">num1</span><span class="o">,</span> <span class="n">num2</span><span class="o">))</span></span>
<span id="LC577" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC578" class="line" lang="java">          <span class="n">result</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC579" class="line" lang="java"></span>
<span id="LC580" class="line" lang="java">          <span class="k">break</span><span class="o">;</span></span>
<span id="LC581" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC582" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC583" class="line" lang="java">      <span class="n">list1</span><span class="o">.</span><span class="na">reset</span><span class="o">();</span></span>
<span id="LC584" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC585" class="line" lang="java">    <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="nc">XObject</span><span class="o">.</span><span class="na">CLASS_RTREEFRAG</span> <span class="o">==</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC586" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC587" class="line" lang="java">      <span class="nc">XMLString</span> <span class="n">s2</span> <span class="o">=</span> <span class="n">obj2</span><span class="o">.</span><span class="na">xstr</span><span class="o">();</span></span>
<span id="LC588" class="line" lang="java">      <span class="nc">DTMIterator</span> <span class="n">list1</span> <span class="o">=</span> <span class="n">iterRaw</span><span class="o">();</span></span>
<span id="LC589" class="line" lang="java">      <span class="kt">int</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC590" class="line" lang="java"></span>
<span id="LC591" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">node</span> <span class="o">=</span> <span class="n">list1</span><span class="o">.</span><span class="na">nextNode</span><span class="o">()))</span></span>
<span id="LC592" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC593" class="line" lang="java">        <span class="nc">XMLString</span> <span class="n">s1</span> <span class="o">=</span> <span class="n">getStringFromNode</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC594" class="line" lang="java"></span>
<span id="LC595" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">comparator</span><span class="o">.</span><span class="na">compareStrings</span><span class="o">(</span><span class="n">s1</span><span class="o">,</span> <span class="n">s2</span><span class="o">))</span></span>
<span id="LC596" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC597" class="line" lang="java">          <span class="n">result</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC602" class="line" lang="java">      <span class="n">list1</span><span class="o">.</span><span class="na">reset</span><span class="o">();</span></span>
<span id="LC603" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC604" class="line" lang="java">    <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="nc">XObject</span><span class="o">.</span><span class="na">CLASS_STRING</span> <span class="o">==</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC605" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC606" class="line" lang="java"></span>
<span id="LC607" class="line" lang="java">      <span class="c1">// From http://www.w3.org/TR/xpath:</span></span>
<span id="LC608" class="line" lang="java">      <span class="c1">// If one object to be compared is a node-set and the other is a</span></span>
<span id="LC609" class="line" lang="java">      <span class="c1">// string, then the comparison will be true if and only if there</span></span>
<span id="LC610" class="line" lang="java">      <span class="c1">// is a node in the node-set such that the result of performing</span></span>
<span id="LC611" class="line" lang="java">      <span class="c1">// the comparison on the string-value of the node and the other</span></span>
<span id="LC612" class="line" lang="java">      <span class="c1">// string is true.</span></span>
<span id="LC613" class="line" lang="java">      <span class="nc">XMLString</span> <span class="n">s2</span> <span class="o">=</span> <span class="n">obj2</span><span class="o">.</span><span class="na">xstr</span><span class="o">();</span></span>
<span id="LC614" class="line" lang="java">      <span class="nc">DTMIterator</span> <span class="n">list1</span> <span class="o">=</span> <span class="n">iterRaw</span><span class="o">();</span></span>
<span id="LC615" class="line" lang="java">      <span class="kt">int</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC616" class="line" lang="java"></span>
<span id="LC617" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">node</span> <span class="o">=</span> <span class="n">list1</span><span class="o">.</span><span class="na">nextNode</span><span class="o">()))</span></span>
<span id="LC618" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC619" class="line" lang="java">        <span class="nc">XMLString</span> <span class="n">s1</span> <span class="o">=</span> <span class="n">getStringFromNode</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC620" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">comparator</span><span class="o">.</span><span class="na">compareStrings</span><span class="o">(</span><span class="n">s1</span><span class="o">,</span> <span class="n">s2</span><span class="o">))</span></span>
<span id="LC621" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC622" class="line" lang="java">          <span class="n">result</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC627" class="line" lang="java">      <span class="n">list1</span><span class="o">.</span><span class="na">reset</span><span class="o">();</span></span>
<span id="LC628" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC629" class="line" lang="java">    <span class="k">else</span></span>
<span id="LC630" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC631" class="line" lang="java">      <span class="n">result</span> <span class="o">=</span> <span class="n">comparator</span><span class="o">.</span><span class="na">compareNumbers</span><span class="o">(</span><span class="k">this</span><span class="o">.</span><span class="na">num</span><span class="o">(),</span> <span class="n">obj2</span><span class="o">.</span><span class="na">num</span><span class="o">());</span></span>
<span id="LC632" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC633" class="line" lang="java"></span>
<span id="LC634" class="line" lang="java">    <span class="k">return</span> <span class="n">result</span><span class="o">;</span></span>
...
<span id="LC638" class="line" lang="java"><span class="cm">   * Tell if one object is less than the other.</span></span>
<span id="LC639" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC640" class="line" lang="java"><span class="cm">   * @param obj2 object to compare this nodeset to</span></span>
<span id="LC641" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC642" class="line" lang="java"><span class="cm">   * @return see this.compare(...)</span></span>
<span id="LC643" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC644" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC645" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC646" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">lessThan</span><span class="o">(</span><span class="nc">XObject</span> <span class="n">obj2</span><span class="o">)</span> <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC647" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC648" class="line" lang="java">    <span class="k">return</span> <span class="nf">compare</span><span class="o">(</span><span class="n">obj2</span><span class="o">,</span> <span class="no">S_LT</span><span class="o">);</span></span>
...
<span id="LC652" class="line" lang="java"><span class="cm">   * Tell if one object is less than or equal to the other.</span></span>
<span id="LC653" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC654" class="line" lang="java"><span class="cm">   * @param obj2 object to compare this nodeset to</span></span>
<span id="LC655" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC656" class="line" lang="java"><span class="cm">   * @return see this.compare(...)</span></span>
<span id="LC657" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC658" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC659" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC660" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">lessThanOrEqual</span><span class="o">(</span><span class="nc">XObject</span> <span class="n">obj2</span><span class="o">)</span> <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC661" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC662" class="line" lang="java">    <span class="k">return</span> <span class="nf">compare</span><span class="o">(</span><span class="n">obj2</span><span class="o">,</span> <span class="no">S_LTE</span><span class="o">);</span></span>
...
<span id="LC666" class="line" lang="java"><span class="cm">   * Tell if one object is less than the other.</span></span>
<span id="LC667" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC668" class="line" lang="java"><span class="cm">   * @param obj2 object to compare this nodeset to</span></span>
<span id="LC669" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC670" class="line" lang="java"><span class="cm">   * @return see this.compare(...)</span></span>
<span id="LC671" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC672" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC673" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC674" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">greaterThan</span><span class="o">(</span><span class="nc">XObject</span> <span class="n">obj2</span><span class="o">)</span> <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC675" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC676" class="line" lang="java">    <span class="k">return</span> <span class="nf">compare</span><span class="o">(</span><span class="n">obj2</span><span class="o">,</span> <span class="no">S_GT</span><span class="o">);</span></span>
...
<span id="LC680" class="line" lang="java"><span class="cm">   * Tell if one object is less than the other.</span></span>
<span id="LC681" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC682" class="line" lang="java"><span class="cm">   * @param obj2 object to compare this nodeset to</span></span>
<span id="LC683" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC684" class="line" lang="java"><span class="cm">   * @return see this.compare(...)</span></span>
<span id="LC685" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC686" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC687" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC688" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">greaterThanOrEqual</span><span class="o">(</span><span class="nc">XObject</span> <span class="n">obj2</span><span class="o">)</span></span>
<span id="LC689" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC690" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC691" class="line" lang="java">    <span class="k">return</span> <span class="nf">compare</span><span class="o">(</span><span class="n">obj2</span><span class="o">,</span> <span class="no">S_GTE</span><span class="o">);</span></span>
...
<span id="LC695" class="line" lang="java"><span class="cm">   * Tell if two objects are functionally equal.</span></span>
<span id="LC696" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC697" class="line" lang="java"><span class="cm">   * @param obj2 object to compare this nodeset to</span></span>
<span id="LC698" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC699" class="line" lang="java"><span class="cm">   * @return see this.compare(...)</span></span>
<span id="LC700" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC701" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC702" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC703" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">equals</span><span class="o">(</span><span class="nc">XObject</span> <span class="n">obj2</span><span class="o">)</span></span>
<span id="LC704" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC705" class="line" lang="java">    <span class="k">try</span></span>
<span id="LC706" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC707" class="line" lang="java">      <span class="k">return</span> <span class="nf">compare</span><span class="o">(</span><span class="n">obj2</span><span class="o">,</span> <span class="no">S_EQ</span><span class="o">);</span></span>
<span id="LC708" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC709" class="line" lang="java">    <span class="k">catch</span><span class="o">(</span><span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span> <span class="n">te</span><span class="o">)</span></span>
<span id="LC710" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC711" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">utils</span><span class="o">.</span><span class="na">WrappedRuntimeException</span><span class="o">(</span><span class="n">te</span><span class="o">);</span></span>
...
<span id="LC716" class="line" lang="java"><span class="cm">   * Tell if two objects are functionally not equal.</span></span>
<span id="LC717" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC718" class="line" lang="java"><span class="cm">   * @param obj2 object to compare this nodeset to</span></span>
<span id="LC719" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC720" class="line" lang="java"><span class="cm">   * @return see this.compare(...)</span></span>
<span id="LC721" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC722" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC723" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC724" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">notEquals</span><span class="o">(</span><span class="nc">XObject</span> <span class="n">obj2</span><span class="o">)</span> <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC725" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC726" class="line" lang="java">    <span class="k">return</span> <span class="nf">compare</span><span class="o">(</span><span class="n">obj2</span><span class="o">,</span> <span class="no">S_NEQ</span><span class="o">);</span></span>
...
<span id="LC731" class="line" lang="java"><span class="cm"> * compares nodes for various boolean operations.</span></span>
<span id="LC732" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC733" class="line" lang="java"><span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">Comparator</span></span>
...
<span id="LC737" class="line" lang="java"><span class="cm">   * Compare two strings</span></span>
<span id="LC738" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC739" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC740" class="line" lang="java"><span class="cm">   * @param s1 First string to compare</span></span>
<span id="LC741" class="line" lang="java"><span class="cm">   * @param s2 Second String to compare</span></span>
<span id="LC742" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC743" class="line" lang="java"><span class="cm">   * @return Whether the strings are equal or not</span></span>
<span id="LC744" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC745" class="line" lang="java">  <span class="kd">abstract</span> <span class="kt">boolean</span> <span class="nf">compareStrings</span><span class="o">(</span><span class="nc">XMLString</span> <span class="n">s1</span><span class="o">,</span> <span class="nc">XMLString</span> <span class="n">s2</span><span class="o">);</span></span>
<span id="LC746" class="line" lang="java"></span>
<span id="LC747" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC748" class="line" lang="java"><span class="cm">   * Compare two numbers</span></span>
<span id="LC749" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC750" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC751" class="line" lang="java"><span class="cm">   * @param n1 First number to compare</span></span>
<span id="LC752" class="line" lang="java"><span class="cm">   * @param n2 Second number to compare</span></span>
<span id="LC753" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC754" class="line" lang="java"><span class="cm">   * @return Whether the numbers are equal or not</span></span>
<span id="LC755" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC756" class="line" lang="java">  <span class="kd">abstract</span> <span class="kt">boolean</span> <span class="nf">compareNumbers</span><span class="o">(</span><span class="kt">double</span> <span class="n">n1</span><span class="o">,</span> <span class="kt">double</span> <span class="n">n2</span><span class="o">);</span></span>
...
<span id="LC760" class="line" lang="java"><span class="cm"> * Compare strings or numbers for less than.</span></span>
<span id="LC761" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC762" class="line" lang="java"><span class="kd">class</span> <span class="nc">LessThanComparator</span> <span class="kd">extends</span> <span class="nc">Comparator</span></span>
...
<span id="LC766" class="line" lang="java"><span class="cm">   * Compare two strings for less than.</span></span>
<span id="LC767" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC768" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC769" class="line" lang="java"><span class="cm">   * @param s1 First string to compare</span></span>
<span id="LC770" class="line" lang="java"><span class="cm">   * @param s2 Second String to compare</span></span>
<span id="LC771" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC772" class="line" lang="java"><span class="cm">   * @return True if s1 is less than s2</span></span>
<span id="LC773" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC774" class="line" lang="java">  <span class="kt">boolean</span> <span class="nf">compareStrings</span><span class="o">(</span><span class="nc">XMLString</span> <span class="n">s1</span><span class="o">,</span> <span class="nc">XMLString</span> <span class="n">s2</span><span class="o">)</span></span>
<span id="LC775" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC776" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">s1</span><span class="o">.</span><span class="na">toDouble</span><span class="o">()</span> <span class="o">&lt;</span> <span class="n">s2</span><span class="o">.</span><span class="na">toDouble</span><span class="o">());</span></span>
<span id="LC777" class="line" lang="java">    <span class="c1">// return s1.compareTo(s2) &lt; 0;</span></span>
...
<span id="LC781" class="line" lang="java"><span class="cm">   * Compare two numbers for less than.</span></span>
<span id="LC782" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC783" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC784" class="line" lang="java"><span class="cm">   * @param n1 First number to compare</span></span>
<span id="LC785" class="line" lang="java"><span class="cm">   * @param n2 Second number to compare</span></span>
<span id="LC786" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC787" class="line" lang="java"><span class="cm">   * @return true if n1 is less than n2</span></span>
<span id="LC788" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC789" class="line" lang="java">  <span class="kt">boolean</span> <span class="nf">compareNumbers</span><span class="o">(</span><span class="kt">double</span> <span class="n">n1</span><span class="o">,</span> <span class="kt">double</span> <span class="n">n2</span><span class="o">)</span></span>
<span id="LC790" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC791" class="line" lang="java">    <span class="k">return</span> <span class="n">n1</span> <span class="o">&lt;</span> <span class="n">n2</span><span class="o">;</span></span>
...
<span id="LC796" class="line" lang="java"><span class="cm"> * Compare strings or numbers for less than or equal.</span></span>
<span id="LC797" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC798" class="line" lang="java"><span class="kd">class</span> <span class="nc">LessThanOrEqualComparator</span> <span class="kd">extends</span> <span class="nc">Comparator</span></span>
...
<span id="LC802" class="line" lang="java"><span class="cm">   * Compare two strings for less than or equal.</span></span>
<span id="LC803" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC804" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC805" class="line" lang="java"><span class="cm">   * @param s1 First string to compare</span></span>
<span id="LC806" class="line" lang="java"><span class="cm">   * @param s2 Second String to compare</span></span>
<span id="LC807" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC808" class="line" lang="java"><span class="cm">   * @return true if s1 is less than or equal to s2</span></span>
<span id="LC809" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC810" class="line" lang="java">  <span class="kt">boolean</span> <span class="nf">compareStrings</span><span class="o">(</span><span class="nc">XMLString</span> <span class="n">s1</span><span class="o">,</span> <span class="nc">XMLString</span> <span class="n">s2</span><span class="o">)</span></span>
<span id="LC811" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC812" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">s1</span><span class="o">.</span><span class="na">toDouble</span><span class="o">()</span> <span class="o">&lt;=</span> <span class="n">s2</span><span class="o">.</span><span class="na">toDouble</span><span class="o">());</span></span>
<span id="LC813" class="line" lang="java">    <span class="c1">// return s1.compareTo(s2) &lt;= 0;</span></span>
...
<span id="LC817" class="line" lang="java"><span class="cm">   * Compare two numbers for less than or equal.</span></span>
<span id="LC818" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC819" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC820" class="line" lang="java"><span class="cm">   * @param n1 First number to compare</span></span>
<span id="LC821" class="line" lang="java"><span class="cm">   * @param n2 Second number to compare</span></span>
<span id="LC822" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC823" class="line" lang="java"><span class="cm">   * @return true if n1 is less than or equal to n2</span></span>
<span id="LC824" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC825" class="line" lang="java">  <span class="kt">boolean</span> <span class="nf">compareNumbers</span><span class="o">(</span><span class="kt">double</span> <span class="n">n1</span><span class="o">,</span> <span class="kt">double</span> <span class="n">n2</span><span class="o">)</span></span>
<span id="LC826" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC827" class="line" lang="java">    <span class="k">return</span> <span class="n">n1</span> <span class="o">&lt;=</span> <span class="n">n2</span><span class="o">;</span></span>
...
<span id="LC832" class="line" lang="java"><span class="cm"> * Compare strings or numbers for greater than.</span></span>
<span id="LC833" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC834" class="line" lang="java"><span class="kd">class</span> <span class="nc">GreaterThanComparator</span> <span class="kd">extends</span> <span class="nc">Comparator</span></span>
...
<span id="LC838" class="line" lang="java"><span class="cm">   * Compare two strings for greater than.</span></span>
<span id="LC839" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC840" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC841" class="line" lang="java"><span class="cm">   * @param s1 First string to compare</span></span>
<span id="LC842" class="line" lang="java"><span class="cm">   * @param s2 Second String to compare</span></span>
<span id="LC843" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC844" class="line" lang="java"><span class="cm">   * @return true if s1 is greater than s2</span></span>
<span id="LC845" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC846" class="line" lang="java">  <span class="kt">boolean</span> <span class="nf">compareStrings</span><span class="o">(</span><span class="nc">XMLString</span> <span class="n">s1</span><span class="o">,</span> <span class="nc">XMLString</span> <span class="n">s2</span><span class="o">)</span></span>
<span id="LC847" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC848" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">s1</span><span class="o">.</span><span class="na">toDouble</span><span class="o">()</span> <span class="o">&gt;</span> <span class="n">s2</span><span class="o">.</span><span class="na">toDouble</span><span class="o">());</span></span>
<span id="LC849" class="line" lang="java">    <span class="c1">// return s1.compareTo(s2) &gt; 0;</span></span>
...
<span id="LC853" class="line" lang="java"><span class="cm">   * Compare two numbers for greater than.</span></span>
<span id="LC854" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC855" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC856" class="line" lang="java"><span class="cm">   * @param n1 First number to compare</span></span>
<span id="LC857" class="line" lang="java"><span class="cm">   * @param n2 Second number to compare</span></span>
<span id="LC858" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC859" class="line" lang="java"><span class="cm">   * @return true if n1 is greater than n2</span></span>
<span id="LC860" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC861" class="line" lang="java">  <span class="kt">boolean</span> <span class="nf">compareNumbers</span><span class="o">(</span><span class="kt">double</span> <span class="n">n1</span><span class="o">,</span> <span class="kt">double</span> <span class="n">n2</span><span class="o">)</span></span>
<span id="LC862" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC863" class="line" lang="java">    <span class="k">return</span> <span class="n">n1</span> <span class="o">&gt;</span> <span class="n">n2</span><span class="o">;</span></span>
...
<span id="LC868" class="line" lang="java"><span class="cm"> * Compare strings or numbers for greater than or equal.</span></span>
<span id="LC869" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC870" class="line" lang="java"><span class="kd">class</span> <span class="nc">GreaterThanOrEqualComparator</span> <span class="kd">extends</span> <span class="nc">Comparator</span></span>
...
<span id="LC874" class="line" lang="java"><span class="cm">   * Compare two strings for greater than or equal.</span></span>
<span id="LC875" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC876" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC877" class="line" lang="java"><span class="cm">   * @param s1 First string to compare</span></span>
<span id="LC878" class="line" lang="java"><span class="cm">   * @param s2 Second String to compare</span></span>
<span id="LC879" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC880" class="line" lang="java"><span class="cm">   * @return true if s1 is greater than or equal to s2</span></span>
<span id="LC881" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC882" class="line" lang="java">  <span class="kt">boolean</span> <span class="nf">compareStrings</span><span class="o">(</span><span class="nc">XMLString</span> <span class="n">s1</span><span class="o">,</span> <span class="nc">XMLString</span> <span class="n">s2</span><span class="o">)</span></span>
<span id="LC883" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC884" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">s1</span><span class="o">.</span><span class="na">toDouble</span><span class="o">()</span> <span class="o">&gt;=</span> <span class="n">s2</span><span class="o">.</span><span class="na">toDouble</span><span class="o">());</span></span>
<span id="LC885" class="line" lang="java">    <span class="c1">// return s1.compareTo(s2) &gt;= 0;</span></span>
...
<span id="LC889" class="line" lang="java"><span class="cm">   * Compare two numbers for greater than or equal.</span></span>
<span id="LC890" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC891" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC892" class="line" lang="java"><span class="cm">   * @param n1 First number to compare</span></span>
<span id="LC893" class="line" lang="java"><span class="cm">   * @param n2 Second number to compare</span></span>
<span id="LC894" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC895" class="line" lang="java"><span class="cm">   * @return true if n1 is greater than or equal to n2</span></span>
<span id="LC896" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC897" class="line" lang="java">  <span class="kt">boolean</span> <span class="nf">compareNumbers</span><span class="o">(</span><span class="kt">double</span> <span class="n">n1</span><span class="o">,</span> <span class="kt">double</span> <span class="n">n2</span><span class="o">)</span></span>
<span id="LC898" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC899" class="line" lang="java">    <span class="k">return</span> <span class="n">n1</span> <span class="o">&gt;=</span> <span class="n">n2</span><span class="o">;</span></span>
...
<span id="LC904" class="line" lang="java"><span class="cm"> * Compare strings or numbers for equality.</span></span>
<span id="LC905" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC906" class="line" lang="java"><span class="kd">class</span> <span class="nc">EqualComparator</span> <span class="kd">extends</span> <span class="nc">Comparator</span></span>
...
<span id="LC910" class="line" lang="java"><span class="cm">   * Compare two strings for equality.</span></span>
<span id="LC911" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC912" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC913" class="line" lang="java"><span class="cm">   * @param s1 First string to compare</span></span>
<span id="LC914" class="line" lang="java"><span class="cm">   * @param s2 Second String to compare</span></span>
<span id="LC915" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC916" class="line" lang="java"><span class="cm">   * @return true if s1 is equal to s2</span></span>
<span id="LC917" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC918" class="line" lang="java">  <span class="kt">boolean</span> <span class="nf">compareStrings</span><span class="o">(</span><span class="nc">XMLString</span> <span class="n">s1</span><span class="o">,</span> <span class="nc">XMLString</span> <span class="n">s2</span><span class="o">)</span></span>
<span id="LC919" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC920" class="line" lang="java">    <span class="k">return</span> <span class="n">s1</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">s2</span><span class="o">);</span></span>
...
<span id="LC924" class="line" lang="java"><span class="cm">   * Compare two numbers for equality.</span></span>
<span id="LC925" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC926" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC927" class="line" lang="java"><span class="cm">   * @param n1 First number to compare</span></span>
<span id="LC928" class="line" lang="java"><span class="cm">   * @param n2 Second number to compare</span></span>
<span id="LC929" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC930" class="line" lang="java"><span class="cm">   * @return true if n1 is equal to n2</span></span>
<span id="LC931" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC932" class="line" lang="java">  <span class="kt">boolean</span> <span class="nf">compareNumbers</span><span class="o">(</span><span class="kt">double</span> <span class="n">n1</span><span class="o">,</span> <span class="kt">double</span> <span class="n">n2</span><span class="o">)</span></span>
<span id="LC933" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC934" class="line" lang="java">    <span class="k">return</span> <span class="n">n1</span> <span class="o">==</span> <span class="n">n2</span><span class="o">;</span></span>
...
<span id="LC939" class="line" lang="java"><span class="cm"> * Compare strings or numbers for non-equality.</span></span>
<span id="LC940" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC941" class="line" lang="java"><span class="kd">class</span> <span class="nc">NotEqualComparator</span> <span class="kd">extends</span> <span class="nc">Comparator</span></span>
...
<span id="LC945" class="line" lang="java"><span class="cm">   * Compare two strings for non-equality.</span></span>
<span id="LC946" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC947" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC948" class="line" lang="java"><span class="cm">   * @param s1 First string to compare</span></span>
<span id="LC949" class="line" lang="java"><span class="cm">   * @param s2 Second String to compare</span></span>
<span id="LC950" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC951" class="line" lang="java"><span class="cm">   * @return true if s1 is not equal to s2</span></span>
<span id="LC952" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC953" class="line" lang="java">  <span class="kt">boolean</span> <span class="nf">compareStrings</span><span class="o">(</span><span class="nc">XMLString</span> <span class="n">s1</span><span class="o">,</span> <span class="nc">XMLString</span> <span class="n">s2</span><span class="o">)</span></span>
<span id="LC954" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC955" class="line" lang="java">    <span class="k">return</span> <span class="o">!</span><span class="n">s1</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">s2</span><span class="o">);</span></span>
...
<span id="LC959" class="line" lang="java"><span class="cm">   * Compare two numbers for non-equality.</span></span>
<span id="LC960" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC961" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC962" class="line" lang="java"><span class="cm">   * @param n1 First number to compare</span></span>
<span id="LC963" class="line" lang="java"><span class="cm">   * @param n2 Second number to compare</span></span>
<span id="LC964" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC965" class="line" lang="java"><span class="cm">   * @return true if n1 is not equal to n2</span></span>
<span id="LC966" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC967" class="line" lang="java">  <span class="kt">boolean</span> <span class="nf">compareNumbers</span><span class="o">(</span><span class="kt">double</span> <span class="n">n1</span><span class="o">,</span> <span class="kt">double</span> <span class="n">n2</span><span class="o">)</span></span>
<span id="LC968" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC969" class="line" lang="java">    <span class="k">return</span> <span class="n">n1</span> <span class="o">!=</span> <span class="n">n2</span><span class="o">;</span></span>
