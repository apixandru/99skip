...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: NodeTestFilter.java,v 1.1.2.1 2005/08/01 01:30:30 jeffsuttor Exp $</span></span>
...
<span id="LC26" class="line" lang="java"><span class="cm"> * This interface should be implemented by Nodes and/or iterators,</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * when they need to know what the node test is before they do</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> * getNextChild, etc.</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC30" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">NodeTestFilter</span></span>
...
<span id="LC34" class="line" lang="java"><span class="cm">   * Set the node test for this filter.</span></span>
<span id="LC35" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC36" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">   * @param nodeTest Reference to a NodeTest that may be used to predetermine</span></span>
<span id="LC38" class="line" lang="java"><span class="cm">   *                 what nodes to return.</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC40" class="line" lang="java">  <span class="kt">void</span> <span class="nf">setNodeTest</span><span class="o">(</span><span class="nc">NodeTest</span> <span class="n">nodeTest</span><span class="o">);</span></span>
