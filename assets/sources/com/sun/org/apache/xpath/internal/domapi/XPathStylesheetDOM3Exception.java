...
<span id="LC42" class="line" lang="java"><span class="kn">package</span> <span class="nn">com.sun.org.apache.xpath.internal.domapi</span><span class="o">;</span></span>
<span id="LC43" class="line" lang="java"></span>
<span id="LC44" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.transform.SourceLocator</span><span class="o">;</span></span>
...
<span id="LC49" class="line" lang="java"><span class="cm"> * A new exception to add support for DOM Level 3 XPath API.</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> * This class is needed to throw a org.w3c.dom.DOMException with proper error code in</span></span>
<span id="LC51" class="line" lang="java"><span class="cm"> * createExpression method of XPathEvaluatorImpl (a DOM Level 3 class).</span></span>
<span id="LC52" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC53" class="line" lang="java"><span class="cm"> * This class extends TransformerException because the error message includes information</span></span>
<span id="LC54" class="line" lang="java"><span class="cm"> * about where the XPath problem is in the stylesheet as well as the XPath expression itself.</span></span>
<span id="LC55" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC56" class="line" lang="java"><span class="cm"> * @xsl.usage internal</span></span>
<span id="LC57" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC58" class="line" lang="java"><span class="kd">final</span> <span class="kd">public</span> <span class="kd">class</span> <span class="nc">XPathStylesheetDOM3Exception</span> <span class="kd">extends</span> <span class="nc">TransformerException</span> <span class="o">{</span></span>
<span id="LC59" class="line" lang="java">        <span class="kd">public</span> <span class="nf">XPathStylesheetDOM3Exception</span><span class="o">(</span><span class="nc">String</span> <span class="n">msg</span><span class="o">,</span> <span class="nc">SourceLocator</span> <span class="n">arg1</span><span class="o">)</span></span>
<span id="LC60" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC61" class="line" lang="java">                <span class="kd">super</span><span class="o">(</span><span class="n">msg</span><span class="o">,</span> <span class="n">arg1</span><span class="o">);</span></span>
