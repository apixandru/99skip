...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: NodeSequence.java,v 1.6 2007/01/12 19:26:42 spericas Exp $</span></span>
...
<span id="LC31" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.utils.NodeVector</span><span class="o">;</span></span>
<span id="LC32" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.NodeSetDTM</span><span class="o">;</span></span>
<span id="LC33" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.XPathContext</span><span class="o">;</span></span>
<span id="LC34" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.objects.XObject</span><span class="o">;</span></span>
<span id="LC35" class="line" lang="java"></span>
<span id="LC36" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC37" class="line" lang="java"><span class="cm"> * This class is the dynamic wrapper for a Xalan DTMIterator instance, and</span></span>
<span id="LC38" class="line" lang="java"><span class="cm"> * provides random access capabilities.</span></span>
<span id="LC39" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC40" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">NodeSequence</span> <span class="kd">extends</span> <span class="nc">XObject</span></span>
<span id="LC41" class="line" lang="java">  <span class="kd">implements</span> <span class="nc">DTMIterator</span><span class="o">,</span> <span class="nc">Cloneable</span><span class="o">,</span> <span class="nc">PathComponent</span></span>
<span id="LC42" class="line" lang="java"><span class="o">{</span></span>
<span id="LC43" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="mi">3866261934726581044L</span><span class="o">;</span></span>
<span id="LC44" class="line" lang="java">  <span class="cm">/** The index of the last node in the iteration. */</span></span>
<span id="LC45" class="line" lang="java">  <span class="kd">protected</span> <span class="kt">int</span> <span class="n">m_last</span> <span class="o">=</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC46" class="line" lang="java"></span>
<span id="LC47" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC48" class="line" lang="java"><span class="cm">   * The index of the next node to be fetched.  Useful if this</span></span>
<span id="LC49" class="line" lang="java"><span class="cm">   * is a cached iterator, and is being used as random access</span></span>
<span id="LC50" class="line" lang="java"><span class="cm">   * NodeList.</span></span>
<span id="LC51" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC52" class="line" lang="java">  <span class="kd">protected</span> <span class="kt">int</span> <span class="n">m_next</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC53" class="line" lang="java"></span>
<span id="LC54" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">   * A cache of a list of nodes obtained from the iterator so far.</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">   * This list is appended to until the iterator is exhausted and</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">   * the cache is complete.</span></span>
<span id="LC58" class="line" lang="java"><span class="cm">   * &lt;p&gt;</span></span>
<span id="LC59" class="line" lang="java"><span class="cm">   * Multiple NodeSequence objects may share the same cache.</span></span>
<span id="LC60" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC61" class="line" lang="java">  <span class="kd">private</span> <span class="nc">IteratorCache</span> <span class="n">m_cache</span><span class="o">;</span></span>
<span id="LC62" class="line" lang="java"></span>
<span id="LC63" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC64" class="line" lang="java"><span class="cm">   * If this iterator needs to cache nodes that are fetched, they</span></span>
<span id="LC65" class="line" lang="java"><span class="cm">   * are stored in the Vector in the generic object.</span></span>
<span id="LC66" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC67" class="line" lang="java">  <span class="kd">protected</span> <span class="nc">NodeVector</span> <span class="nf">getVector</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC68" class="line" lang="java">      <span class="nc">NodeVector</span> <span class="n">nv</span> <span class="o">=</span> <span class="o">(</span><span class="n">m_cache</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">?</span>  <span class="n">m_cache</span><span class="o">.</span><span class="na">getVector</span><span class="o">()</span> <span class="o">:</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC69" class="line" lang="java">      <span class="k">return</span> <span class="n">nv</span><span class="o">;</span></span>
...
<span id="LC73" class="line" lang="java"><span class="cm">   * Get the cache (if any) of nodes obtained from</span></span>
<span id="LC74" class="line" lang="java"><span class="cm">   * the iterator so far. Note that the cache keeps</span></span>
<span id="LC75" class="line" lang="java"><span class="cm">   * growing until the iterator is walked to exhaustion,</span></span>
<span id="LC76" class="line" lang="java"><span class="cm">   * at which point the cache is "complete".</span></span>
<span id="LC77" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC78" class="line" lang="java">  <span class="kd">private</span> <span class="nc">IteratorCache</span> <span class="nf">getCache</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC79" class="line" lang="java">      <span class="k">return</span> <span class="n">m_cache</span><span class="o">;</span></span>
...
<span id="LC83" class="line" lang="java"><span class="cm">   * Set the vector where nodes will be cached.</span></span>
<span id="LC84" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC85" class="line" lang="java">  <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">SetVector</span><span class="o">(</span><span class="nc">NodeVector</span> <span class="n">v</span><span class="o">)</span></span>
<span id="LC86" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC87" class="line" lang="java">        <span class="n">setObject</span><span class="o">(</span><span class="n">v</span><span class="o">);</span></span>
...
<span id="LC92" class="line" lang="java"><span class="cm">   * If the iterator needs to cache nodes as they are fetched,</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">   * then this method returns true.</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC95" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">hasCache</span><span class="o">()</span></span>
<span id="LC96" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC97" class="line" lang="java">    <span class="kd">final</span> <span class="nc">NodeVector</span> <span class="n">nv</span> <span class="o">=</span> <span class="n">getVector</span><span class="o">();</span></span>
<span id="LC98" class="line" lang="java">        <span class="k">return</span> <span class="o">(</span><span class="n">nv</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">);</span></span>
...
<span id="LC102" class="line" lang="java"><span class="cm">   * If this NodeSequence has a cache, and that cache is</span></span>
<span id="LC103" class="line" lang="java"><span class="cm">   * fully populated then this method returns true, otherwise</span></span>
<span id="LC104" class="line" lang="java"><span class="cm">   * if there is no cache or it is not complete it returns false.</span></span>
<span id="LC105" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC106" class="line" lang="java">  <span class="kd">private</span> <span class="kt">boolean</span> <span class="nf">cacheComplete</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC107" class="line" lang="java">      <span class="kd">final</span> <span class="kt">boolean</span> <span class="n">complete</span><span class="o">;</span></span>
<span id="LC108" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">m_cache</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC109" class="line" lang="java">          <span class="n">complete</span> <span class="o">=</span> <span class="n">m_cache</span><span class="o">.</span><span class="na">isComplete</span><span class="o">();</span></span>
<span id="LC110" class="line" lang="java">      <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC111" class="line" lang="java">          <span class="n">complete</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC112" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC113" class="line" lang="java">      <span class="k">return</span> <span class="n">complete</span><span class="o">;</span></span>
...
<span id="LC117" class="line" lang="java"><span class="cm">   * If this NodeSequence has a cache, mark that it is complete.</span></span>
<span id="LC118" class="line" lang="java"><span class="cm">   * This method should be called after the iterator is exhausted.</span></span>
<span id="LC119" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC120" class="line" lang="java">  <span class="kd">private</span> <span class="kt">void</span> <span class="nf">markCacheComplete</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC121" class="line" lang="java">      <span class="nc">NodeVector</span> <span class="n">nv</span> <span class="o">=</span> <span class="n">getVector</span><span class="o">();</span></span>
<span id="LC122" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">nv</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC123" class="line" lang="java">          <span class="n">m_cache</span><span class="o">.</span><span class="na">setCacheComplete</span><span class="o">(</span><span class="kc">true</span><span class="o">);</span></span>
...
<span id="LC129" class="line" lang="java"><span class="cm">   * The functional iterator that fetches nodes.</span></span>
<span id="LC130" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC131" class="line" lang="java">  <span class="kd">protected</span> <span class="nc">DTMIterator</span> <span class="n">m_iter</span><span class="o">;</span></span>
<span id="LC132" class="line" lang="java"></span>
<span id="LC133" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC134" class="line" lang="java"><span class="cm">   * Set the functional iterator that fetches nodes.</span></span>
<span id="LC135" class="line" lang="java"><span class="cm">   * @param iter The iterator that is to be contained.</span></span>
<span id="LC136" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC137" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">setIter</span><span class="o">(</span><span class="nc">DTMIterator</span> <span class="n">iter</span><span class="o">)</span></span>
<span id="LC138" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC139" class="line" lang="java">        <span class="n">m_iter</span> <span class="o">=</span> <span class="n">iter</span><span class="o">;</span></span>
...
<span id="LC143" class="line" lang="java"><span class="cm">   * Get the functional iterator that fetches nodes.</span></span>
<span id="LC144" class="line" lang="java"><span class="cm">   * @return The contained iterator.</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC146" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">DTMIterator</span> <span class="nf">getContainedIter</span><span class="o">()</span></span>
<span id="LC147" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC148" class="line" lang="java">        <span class="k">return</span> <span class="n">m_iter</span><span class="o">;</span></span>
...
<span id="LC152" class="line" lang="java"><span class="cm">   * The DTMManager to use if we're using a NodeVector only.</span></span>
<span id="LC153" class="line" lang="java"><span class="cm">   * We may well want to do away with this, and store it in the NodeVector.</span></span>
<span id="LC154" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC155" class="line" lang="java">  <span class="kd">protected</span> <span class="nc">DTMManager</span> <span class="n">m_dtmMgr</span><span class="o">;</span></span>
<span id="LC156" class="line" lang="java"></span>
<span id="LC157" class="line" lang="java">  <span class="c1">// ==== Constructors ====</span></span>
<span id="LC158" class="line" lang="java"></span>
<span id="LC159" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC160" class="line" lang="java"><span class="cm">   * Create a new NodeSequence from a (already cloned) iterator.</span></span>
<span id="LC161" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC162" class="line" lang="java"><span class="cm">   * @param iter Cloned (not static) DTMIterator.</span></span>
<span id="LC163" class="line" lang="java"><span class="cm">   * @param context The initial context node.</span></span>
<span id="LC164" class="line" lang="java"><span class="cm">   * @param xctxt The execution context.</span></span>
<span id="LC165" class="line" lang="java"><span class="cm">   * @param shouldCacheNodes True if this sequence can random access.</span></span>
<span id="LC166" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC167" class="line" lang="java">  <span class="kd">private</span> <span class="nf">NodeSequence</span><span class="o">(</span><span class="nc">DTMIterator</span> <span class="n">iter</span><span class="o">,</span> <span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">shouldCacheNodes</span><span class="o">)</span></span>
<span id="LC168" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC169" class="line" lang="java">        <span class="n">setIter</span><span class="o">(</span><span class="n">iter</span><span class="o">);</span></span>
<span id="LC170" class="line" lang="java">        <span class="n">setRoot</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="n">xctxt</span><span class="o">);</span></span>
<span id="LC171" class="line" lang="java">        <span class="n">setShouldCacheNodes</span><span class="o">(</span><span class="n">shouldCacheNodes</span><span class="o">);</span></span>
...
<span id="LC175" class="line" lang="java"><span class="cm">   * Create a new NodeSequence from a (already cloned) iterator.</span></span>
<span id="LC176" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC177" class="line" lang="java"><span class="cm">   * @param nodeVector</span></span>
<span id="LC178" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC179" class="line" lang="java">  <span class="kd">public</span> <span class="nf">NodeSequence</span><span class="o">(</span><span class="nc">Object</span> <span class="n">nodeVector</span><span class="o">)</span></span>
<span id="LC180" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC181" class="line" lang="java">        <span class="kd">super</span><span class="o">(</span><span class="n">nodeVector</span><span class="o">);</span></span>
<span id="LC182" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">nodeVector</span> <span class="k">instanceof</span> <span class="nc">NodeVector</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC183" class="line" lang="java">        <span class="nc">SetVector</span><span class="o">((</span><span class="nc">NodeVector</span><span class="o">)</span> <span class="n">nodeVector</span><span class="o">);</span></span>
<span id="LC184" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC185" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">nodeVector</span><span class="o">)</span></span>
<span id="LC186" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC187" class="line" lang="java">                <span class="n">assertion</span><span class="o">(</span><span class="n">nodeVector</span> <span class="k">instanceof</span> <span class="nc">NodeVector</span><span class="o">,</span></span>
<span id="LC188" class="line" lang="java">                        <span class="s">"Must have a NodeVector as the object for NodeSequence!"</span><span class="o">);</span></span>
<span id="LC189" class="line" lang="java">                <span class="k">if</span><span class="o">(</span><span class="n">nodeVector</span> <span class="k">instanceof</span> <span class="nc">DTMIterator</span><span class="o">)</span></span>
<span id="LC190" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC191" class="line" lang="java">                        <span class="n">setIter</span><span class="o">((</span><span class="nc">DTMIterator</span><span class="o">)</span><span class="n">nodeVector</span><span class="o">);</span></span>
<span id="LC192" class="line" lang="java">                        <span class="n">m_last</span> <span class="o">=</span> <span class="o">((</span><span class="nc">DTMIterator</span><span class="o">)</span><span class="n">nodeVector</span><span class="o">).</span><span class="na">getLength</span><span class="o">();</span></span>
...
<span id="LC199" class="line" lang="java"><span class="cm">   * Construct an empty XNodeSet object.  This is used to create a mutable</span></span>
<span id="LC200" class="line" lang="java"><span class="cm">   * nodeset to which random nodes may be added.</span></span>
<span id="LC201" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC202" class="line" lang="java">  <span class="kd">private</span> <span class="nf">NodeSequence</span><span class="o">(</span><span class="nc">DTMManager</span> <span class="n">dtmMgr</span><span class="o">)</span></span>
<span id="LC203" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC204" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="k">new</span> <span class="nc">NodeVector</span><span class="o">());</span></span>
<span id="LC205" class="line" lang="java">    <span class="n">m_last</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC206" class="line" lang="java">    <span class="n">m_dtmMgr</span> <span class="o">=</span> <span class="n">dtmMgr</span><span class="o">;</span></span>
...
<span id="LC211" class="line" lang="java"><span class="cm">   * Create a new NodeSequence in an invalid (null) state.</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC213" class="line" lang="java">  <span class="kd">public</span> <span class="nf">NodeSequence</span><span class="o">()</span></span>
<span id="LC214" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC215" class="line" lang="java">      <span class="k">return</span><span class="o">;</span></span>
...
<span id="LC220" class="line" lang="java"><span class="cm">   * @see DTMIterator#getDTM(int)</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC222" class="line" lang="java">  <span class="kd">public</span> <span class="no">DTM</span> <span class="nf">getDTM</span><span class="o">(</span><span class="kt">int</span> <span class="n">nodeHandle</span><span class="o">)</span></span>
<span id="LC223" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC224" class="line" lang="java">        <span class="nc">DTMManager</span> <span class="n">mgr</span> <span class="o">=</span> <span class="n">getDTMManager</span><span class="o">();</span></span>
<span id="LC225" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">mgr</span><span class="o">)</span></span>
<span id="LC226" class="line" lang="java">        <span class="k">return</span> <span class="nf">getDTMManager</span><span class="o">().</span><span class="na">getDTM</span><span class="o">(</span><span class="n">nodeHandle</span><span class="o">);</span></span>
<span id="LC227" class="line" lang="java">    <span class="k">else</span></span>
<span id="LC228" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC229" class="line" lang="java">        <span class="n">assertion</span><span class="o">(</span><span class="kc">false</span><span class="o">,</span> <span class="s">"Can not get a DTM Unless a DTMManager has been set!"</span><span class="o">);</span></span>
<span id="LC230" class="line" lang="java">        <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC235" class="line" lang="java"><span class="cm">   * @see DTMIterator#getDTMManager()</span></span>
<span id="LC236" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC237" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMManager</span> <span class="nf">getDTMManager</span><span class="o">()</span></span>
<span id="LC238" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC239" class="line" lang="java">    <span class="k">return</span> <span class="n">m_dtmMgr</span><span class="o">;</span></span>
...
<span id="LC243" class="line" lang="java"><span class="cm">   * @see DTMIterator#getRoot()</span></span>
<span id="LC244" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC245" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getRoot</span><span class="o">()</span></span>
<span id="LC246" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC247" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_iter</span><span class="o">)</span></span>
<span id="LC248" class="line" lang="java">        <span class="k">return</span> <span class="n">m_iter</span><span class="o">.</span><span class="na">getRoot</span><span class="o">();</span></span>
<span id="LC249" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC250" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC251" class="line" lang="java">                <span class="c1">// NodeSetDTM will call this, and so it's not a good thing to throw</span></span>
<span id="LC252" class="line" lang="java">                <span class="c1">// an assertion here.</span></span>
<span id="LC253" class="line" lang="java">                <span class="c1">// assertion(false, "Can not get the root from a non-iterated NodeSequence!");</span></span>
<span id="LC254" class="line" lang="java">                <span class="k">return</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
...
<span id="LC259" class="line" lang="java"><span class="cm">   * @see DTMIterator#setRoot(int, Object)</span></span>
<span id="LC260" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC261" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setRoot</span><span class="o">(</span><span class="kt">int</span> <span class="n">nodeHandle</span><span class="o">,</span> <span class="nc">Object</span> <span class="n">environment</span><span class="o">)</span></span>
<span id="LC262" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC263" class="line" lang="java">        <span class="c1">// If root is DTM.NULL, then something's wrong with the context</span></span>
<span id="LC264" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">nodeHandle</span> <span class="o">==</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span></span>
<span id="LC265" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC266" class="line" lang="java">            <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="s">"Unable to evaluate expression using "</span> <span class="o">+</span></span>
<span id="LC267" class="line" lang="java">                    <span class="s">"this context"</span><span class="o">);</span></span>
<span id="LC268" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC269" class="line" lang="java"></span>
<span id="LC270" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_iter</span><span class="o">)</span></span>
<span id="LC271" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC272" class="line" lang="java">                <span class="nc">XPathContext</span> <span class="n">xctxt</span> <span class="o">=</span> <span class="o">(</span><span class="nc">XPathContext</span><span class="o">)</span><span class="n">environment</span><span class="o">;</span></span>
<span id="LC273" class="line" lang="java">                <span class="n">m_dtmMgr</span> <span class="o">=</span> <span class="n">xctxt</span><span class="o">.</span><span class="na">getDTMManager</span><span class="o">();</span></span>
<span id="LC274" class="line" lang="java">                <span class="n">m_iter</span><span class="o">.</span><span class="na">setRoot</span><span class="o">(</span><span class="n">nodeHandle</span><span class="o">,</span> <span class="n">environment</span><span class="o">);</span></span>
<span id="LC275" class="line" lang="java">                <span class="k">if</span><span class="o">(!</span><span class="n">m_iter</span><span class="o">.</span><span class="na">isDocOrdered</span><span class="o">())</span></span>
<span id="LC276" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC277" class="line" lang="java">                        <span class="k">if</span><span class="o">(!</span><span class="n">hasCache</span><span class="o">())</span></span>
<span id="LC278" class="line" lang="java">                                <span class="n">setShouldCacheNodes</span><span class="o">(</span><span class="kc">true</span><span class="o">);</span></span>
<span id="LC279" class="line" lang="java">                        <span class="n">runTo</span><span class="o">(-</span><span class="mi">1</span><span class="o">);</span></span>
<span id="LC280" class="line" lang="java">                        <span class="n">m_next</span><span class="o">=</span><span class="mi">0</span><span class="o">;</span></span>
...
<span id="LC284" class="line" lang="java">                <span class="nf">assertion</span><span class="o">(</span><span class="kc">false</span><span class="o">,</span> <span class="s">"Can not setRoot on a non-iterated NodeSequence!"</span><span class="o">);</span></span>
...
<span id="LC288" class="line" lang="java"><span class="cm">   * @see DTMIterator#reset()</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC290" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">reset</span><span class="o">()</span></span>
<span id="LC291" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC292" class="line" lang="java">        <span class="n">m_next</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC293" class="line" lang="java">        <span class="c1">// not resetting the iterator on purpose!!!</span></span>
...
<span id="LC297" class="line" lang="java"><span class="cm">   * @see DTMIterator#getWhatToShow()</span></span>
<span id="LC298" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC299" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getWhatToShow</span><span class="o">()</span></span>
<span id="LC300" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC301" class="line" lang="java">    <span class="k">return</span> <span class="nf">hasCache</span><span class="o">()</span> <span class="o">?</span> <span class="o">(</span><span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_ALL</span> <span class="o">&amp;</span> <span class="o">~</span><span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_ENTITY_REFERENCE</span><span class="o">)</span></span>
<span id="LC302" class="line" lang="java">        <span class="o">:</span> <span class="n">m_iter</span><span class="o">.</span><span class="na">getWhatToShow</span><span class="o">();</span></span>
...
<span id="LC306" class="line" lang="java"><span class="cm">   * @see DTMIterator#getExpandEntityReferences()</span></span>
<span id="LC307" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC308" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getExpandEntityReferences</span><span class="o">()</span></span>
<span id="LC309" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC310" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_iter</span><span class="o">)</span></span>
<span id="LC311" class="line" lang="java">                <span class="k">return</span> <span class="n">m_iter</span><span class="o">.</span><span class="na">getExpandEntityReferences</span><span class="o">();</span></span>
...
<span id="LC317" class="line" lang="java"><span class="cm">   * @see DTMIterator#nextNode()</span></span>
<span id="LC318" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC319" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">nextNode</span><span class="o">()</span></span>
<span id="LC320" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC321" class="line" lang="java">    <span class="c1">// If the cache is on, and the node has already been found, then</span></span>
<span id="LC322" class="line" lang="java">    <span class="c1">// just return from the list.</span></span>
<span id="LC323" class="line" lang="java">    <span class="nc">NodeVector</span> <span class="n">vec</span> <span class="o">=</span> <span class="n">getVector</span><span class="o">();</span></span>
<span id="LC324" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">vec</span><span class="o">)</span></span>
<span id="LC325" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC326" class="line" lang="java">        <span class="c1">// There is a cache</span></span>
<span id="LC327" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">m_next</span> <span class="o">&lt;</span> <span class="n">vec</span><span class="o">.</span><span class="na">size</span><span class="o">())</span></span>
<span id="LC328" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC329" class="line" lang="java">            <span class="c1">// The node is in the cache, so just return it.</span></span>
<span id="LC330" class="line" lang="java">                        <span class="kt">int</span> <span class="n">next</span> <span class="o">=</span> <span class="n">vec</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">m_next</span><span class="o">);</span></span>
<span id="LC331" class="line" lang="java">                <span class="n">m_next</span><span class="o">++;</span></span>
<span id="LC332" class="line" lang="java">                <span class="k">return</span> <span class="n">next</span><span class="o">;</span></span>
<span id="LC333" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC334" class="line" lang="java">        <span class="k">else</span> <span class="nf">if</span><span class="o">(</span><span class="n">cacheComplete</span><span class="o">()</span> <span class="o">||</span> <span class="o">(-</span><span class="mi">1</span> <span class="o">!=</span> <span class="n">m_last</span><span class="o">)</span> <span class="o">||</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_iter</span><span class="o">))</span></span>
<span id="LC335" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC336" class="line" lang="java">                <span class="n">m_next</span><span class="o">++;</span></span>
<span id="LC337" class="line" lang="java">                <span class="k">return</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
...
<span id="LC341" class="line" lang="java">  <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_iter</span><span class="o">)</span></span>
<span id="LC342" class="line" lang="java">    <span class="k">return</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC343" class="line" lang="java"></span>
<span id="LC344" class="line" lang="java">        <span class="kt">int</span> <span class="n">next</span> <span class="o">=</span> <span class="n">m_iter</span><span class="o">.</span><span class="na">nextNode</span><span class="o">();</span></span>
<span id="LC345" class="line" lang="java">    <span class="k">if</span><span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="n">next</span><span class="o">)</span></span>
<span id="LC346" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC347" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">hasCache</span><span class="o">())</span></span>
<span id="LC348" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC349" class="line" lang="java">                <span class="k">if</span><span class="o">(</span><span class="n">m_iter</span><span class="o">.</span><span class="na">isDocOrdered</span><span class="o">())</span></span>
<span id="LC350" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC351" class="line" lang="java">                        <span class="n">getVector</span><span class="o">().</span><span class="na">addElement</span><span class="o">(</span><span class="n">next</span><span class="o">);</span></span>
<span id="LC352" class="line" lang="java">                        <span class="n">m_next</span><span class="o">++;</span></span>
<span id="LC353" class="line" lang="java">                <span class="o">}</span></span>
<span id="LC354" class="line" lang="java">                <span class="k">else</span></span>
<span id="LC355" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC356" class="line" lang="java">                        <span class="kt">int</span> <span class="n">insertIndex</span> <span class="o">=</span> <span class="n">addNodeInDocOrder</span><span class="o">(</span><span class="n">next</span><span class="o">);</span></span>
<span id="LC357" class="line" lang="java">                        <span class="k">if</span><span class="o">(</span><span class="n">insertIndex</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="o">)</span></span>
<span id="LC358" class="line" lang="java">                                <span class="n">m_next</span><span class="o">++;</span></span>
...
<span id="LC362" class="line" lang="java">                <span class="n">m_next</span><span class="o">++;</span></span>
...
<span id="LC366" class="line" lang="java">        <span class="c1">// We have exhausted the iterator, and if there is a cache</span></span>
<span id="LC367" class="line" lang="java">        <span class="c1">// it must have all nodes in it by now, so let the cache</span></span>
<span id="LC368" class="line" lang="java">        <span class="c1">// know that it is complete.</span></span>
<span id="LC369" class="line" lang="java">        <span class="n">markCacheComplete</span><span class="o">();</span></span>
<span id="LC370" class="line" lang="java"></span>
<span id="LC371" class="line" lang="java">        <span class="n">m_last</span> <span class="o">=</span> <span class="n">m_next</span><span class="o">;</span></span>
<span id="LC372" class="line" lang="java">        <span class="n">m_next</span><span class="o">++;</span></span>
<span id="LC373" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC374" class="line" lang="java"></span>
<span id="LC375" class="line" lang="java">    <span class="k">return</span> <span class="n">next</span><span class="o">;</span></span>
...
<span id="LC379" class="line" lang="java"><span class="cm">   * @see DTMIterator#previousNode()</span></span>
<span id="LC380" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC381" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">previousNode</span><span class="o">()</span></span>
<span id="LC382" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC383" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">hasCache</span><span class="o">())</span></span>
<span id="LC384" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC385" class="line" lang="java">                <span class="k">if</span><span class="o">(</span><span class="n">m_next</span> <span class="o">&lt;=</span> <span class="mi">0</span><span class="o">)</span></span>
<span id="LC386" class="line" lang="java">                        <span class="k">return</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC387" class="line" lang="java">                <span class="k">else</span></span>
<span id="LC388" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC389" class="line" lang="java">                        <span class="n">m_next</span><span class="o">--;</span></span>
<span id="LC390" class="line" lang="java">                        <span class="k">return</span> <span class="nf">item</span><span class="o">(</span><span class="n">m_next</span><span class="o">);</span></span>
<span id="LC391" class="line" lang="java">                <span class="o">}</span></span>
<span id="LC392" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC393" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC394" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC395" class="line" lang="java">            <span class="kt">int</span> <span class="n">n</span> <span class="o">=</span> <span class="n">m_iter</span><span class="o">.</span><span class="na">previousNode</span><span class="o">();</span></span>
<span id="LC396" class="line" lang="java">            <span class="n">m_next</span> <span class="o">=</span> <span class="n">m_iter</span><span class="o">.</span><span class="na">getCurrentPos</span><span class="o">();</span></span>
<span id="LC397" class="line" lang="java">            <span class="k">return</span> <span class="n">m_next</span><span class="o">;</span></span>
...
<span id="LC402" class="line" lang="java"><span class="cm">   * @see DTMIterator#detach()</span></span>
<span id="LC403" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC404" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">detach</span><span class="o">()</span></span>
<span id="LC405" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC406" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_iter</span><span class="o">)</span></span>
<span id="LC407" class="line" lang="java">                <span class="n">m_iter</span><span class="o">.</span><span class="na">detach</span><span class="o">();</span></span>
<span id="LC408" class="line" lang="java">        <span class="kd">super</span><span class="o">.</span><span class="na">detach</span><span class="o">();</span></span>
...
<span id="LC412" class="line" lang="java"><span class="cm">   * Calling this with a value of false will cause the nodeset</span></span>
<span id="LC413" class="line" lang="java"><span class="cm">   * to be cached.</span></span>
<span id="LC414" class="line" lang="java"><span class="cm">   * @see DTMIterator#allowDetachToRelease(boolean)</span></span>
<span id="LC415" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC416" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">allowDetachToRelease</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">allowRelease</span><span class="o">)</span></span>
<span id="LC417" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC418" class="line" lang="java">        <span class="k">if</span><span class="o">((</span><span class="kc">false</span> <span class="o">==</span> <span class="n">allowRelease</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="o">!</span><span class="n">hasCache</span><span class="o">())</span></span>
<span id="LC419" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC420" class="line" lang="java">                <span class="n">setShouldCacheNodes</span><span class="o">(</span><span class="kc">true</span><span class="o">);</span></span>
<span id="LC421" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC422" class="line" lang="java"></span>
<span id="LC423" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_iter</span><span class="o">)</span></span>
<span id="LC424" class="line" lang="java">                <span class="n">m_iter</span><span class="o">.</span><span class="na">allowDetachToRelease</span><span class="o">(</span><span class="n">allowRelease</span><span class="o">);</span></span>
<span id="LC425" class="line" lang="java">        <span class="kd">super</span><span class="o">.</span><span class="na">allowDetachToRelease</span><span class="o">(</span><span class="n">allowRelease</span><span class="o">);</span></span>
...
<span id="LC429" class="line" lang="java"><span class="cm">   * @see DTMIterator#getCurrentNode()</span></span>
<span id="LC430" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC431" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getCurrentNode</span><span class="o">()</span></span>
<span id="LC432" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC433" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">hasCache</span><span class="o">())</span></span>
<span id="LC434" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC435" class="line" lang="java">                <span class="kt">int</span> <span class="n">currentIndex</span> <span class="o">=</span> <span class="n">m_next</span><span class="o">-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC436" class="line" lang="java">                <span class="nc">NodeVector</span> <span class="n">vec</span> <span class="o">=</span> <span class="n">getVector</span><span class="o">();</span></span>
<span id="LC437" class="line" lang="java">                <span class="k">if</span><span class="o">((</span><span class="n">currentIndex</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="o">(</span><span class="n">currentIndex</span> <span class="o">&lt;</span> <span class="n">vec</span><span class="o">.</span><span class="na">size</span><span class="o">()))</span></span>
<span id="LC438" class="line" lang="java">                        <span class="k">return</span> <span class="n">vec</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">currentIndex</span><span class="o">);</span></span>
<span id="LC439" class="line" lang="java">                <span class="k">else</span></span>
<span id="LC440" class="line" lang="java">                        <span class="k">return</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC441" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC442" class="line" lang="java"></span>
<span id="LC443" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_iter</span><span class="o">)</span></span>
<span id="LC444" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC445" class="line" lang="java">        <span class="k">return</span> <span class="n">m_iter</span><span class="o">.</span><span class="na">getCurrentNode</span><span class="o">();</span></span>
<span id="LC446" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC447" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC448" class="line" lang="java">                <span class="k">return</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
...
<span id="LC452" class="line" lang="java"><span class="cm">   * @see DTMIterator#isFresh()</span></span>
<span id="LC453" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC454" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isFresh</span><span class="o">()</span></span>
<span id="LC455" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC456" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="mi">0</span> <span class="o">==</span> <span class="n">m_next</span><span class="o">);</span></span>
...
<span id="LC460" class="line" lang="java"><span class="cm">   * @see DTMIterator#setShouldCacheNodes(boolean)</span></span>
<span id="LC461" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC462" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setShouldCacheNodes</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">b</span><span class="o">)</span></span>
<span id="LC463" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC464" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">b</span><span class="o">)</span></span>
<span id="LC465" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC466" class="line" lang="java">      <span class="k">if</span><span class="o">(!</span><span class="n">hasCache</span><span class="o">())</span></span>
<span id="LC467" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC468" class="line" lang="java">        <span class="nc">SetVector</span><span class="o">(</span><span class="k">new</span> <span class="nc">NodeVector</span><span class="o">());</span></span>
<span id="LC469" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC470" class="line" lang="java"><span class="c1">//        else</span></span>
<span id="LC471" class="line" lang="java"><span class="c1">//          getVector().RemoveAllNoClear();  // Is this good?</span></span>
<span id="LC472" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC473" class="line" lang="java">    <span class="k">else</span></span>
<span id="LC474" class="line" lang="java">      <span class="nf">SetVector</span><span class="o">(</span><span class="kc">null</span><span class="o">);</span></span>
...
<span id="LC478" class="line" lang="java"><span class="cm">   * @see DTMIterator#isMutable()</span></span>
<span id="LC479" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC480" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isMutable</span><span class="o">()</span></span>
<span id="LC481" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC482" class="line" lang="java">    <span class="k">return</span> <span class="nf">hasCache</span><span class="o">();</span> <span class="c1">// though may be surprising if it also has an iterator!</span></span>
...
<span id="LC486" class="line" lang="java"><span class="cm">   * @see DTMIterator#getCurrentPos()</span></span>
<span id="LC487" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC488" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getCurrentPos</span><span class="o">()</span></span>
<span id="LC489" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC490" class="line" lang="java">    <span class="k">return</span> <span class="n">m_next</span><span class="o">;</span></span>
...
<span id="LC494" class="line" lang="java"><span class="cm">   * @see DTMIterator#runTo(int)</span></span>
<span id="LC495" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC496" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">runTo</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span></span>
<span id="LC497" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC498" class="line" lang="java">    <span class="kt">int</span> <span class="n">n</span><span class="o">;</span></span>
<span id="LC499" class="line" lang="java"></span>
<span id="LC500" class="line" lang="java">    <span class="k">if</span> <span class="o">(-</span><span class="mi">1</span> <span class="o">==</span> <span class="n">index</span><span class="o">)</span></span>
<span id="LC501" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC502" class="line" lang="java">      <span class="kt">int</span> <span class="n">pos</span> <span class="o">=</span> <span class="n">m_next</span><span class="o">;</span></span>
<span id="LC503" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">n</span> <span class="o">=</span> <span class="n">nextNode</span><span class="o">()));</span></span>
<span id="LC504" class="line" lang="java">      <span class="n">m_next</span> <span class="o">=</span> <span class="n">pos</span><span class="o">;</span></span>
<span id="LC505" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC506" class="line" lang="java">    <span class="k">else</span> <span class="nf">if</span><span class="o">(</span><span class="n">m_next</span> <span class="o">==</span> <span class="n">index</span><span class="o">)</span></span>
...
<span id="LC510" class="line" lang="java">    <span class="k">else</span> <span class="nf">if</span><span class="o">(</span><span class="n">hasCache</span><span class="o">()</span> <span class="o">&amp;&amp;</span> <span class="n">index</span> <span class="o">&lt;</span> <span class="n">getVector</span><span class="o">().</span><span class="na">size</span><span class="o">())</span></span>
<span id="LC511" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC512" class="line" lang="java">      <span class="n">m_next</span> <span class="o">=</span> <span class="n">index</span><span class="o">;</span></span>
<span id="LC513" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC514" class="line" lang="java">    <span class="k">else</span> <span class="nf">if</span><span class="o">((</span><span class="kc">null</span> <span class="o">==</span> <span class="n">getVector</span><span class="o">())</span> <span class="o">&amp;&amp;</span> <span class="o">(</span><span class="n">index</span> <span class="o">&lt;</span> <span class="n">m_next</span><span class="o">))</span></span>
<span id="LC515" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC516" class="line" lang="java">      <span class="k">while</span> <span class="o">((</span><span class="n">m_next</span> <span class="o">&gt;=</span> <span class="n">index</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">n</span> <span class="o">=</span> <span class="n">previousNode</span><span class="o">()));</span></span>
...
<span id="LC520" class="line" lang="java">      <span class="k">while</span> <span class="o">((</span><span class="n">m_next</span> <span class="o">&lt;</span> <span class="n">index</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">n</span> <span class="o">=</span> <span class="n">nextNode</span><span class="o">()));</span></span>
...
<span id="LC526" class="line" lang="java"><span class="cm">   * @see DTMIterator#setCurrentPos(int)</span></span>
<span id="LC527" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC528" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCurrentPos</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span></span>
<span id="LC529" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC530" class="line" lang="java">        <span class="n">runTo</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
...
<span id="LC534" class="line" lang="java"><span class="cm">   * @see DTMIterator#item(int)</span></span>
<span id="LC535" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC536" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">item</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span></span>
<span id="LC537" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC538" class="line" lang="java">        <span class="n">setCurrentPos</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
<span id="LC539" class="line" lang="java">        <span class="kt">int</span> <span class="n">n</span> <span class="o">=</span> <span class="n">nextNode</span><span class="o">();</span></span>
<span id="LC540" class="line" lang="java">        <span class="n">m_next</span> <span class="o">=</span> <span class="n">index</span><span class="o">;</span></span>
<span id="LC541" class="line" lang="java">        <span class="k">return</span> <span class="n">n</span><span class="o">;</span></span>
...
<span id="LC545" class="line" lang="java"><span class="cm">   * @see DTMIterator#setItem(int, int)</span></span>
<span id="LC546" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC547" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setItem</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">,</span> <span class="kt">int</span> <span class="n">index</span><span class="o">)</span></span>
<span id="LC548" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC549" class="line" lang="java">        <span class="nc">NodeVector</span> <span class="n">vec</span> <span class="o">=</span> <span class="n">getVector</span><span class="o">();</span></span>
<span id="LC550" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">vec</span><span class="o">)</span></span>
<span id="LC551" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC552" class="line" lang="java">        <span class="kt">int</span> <span class="n">oldNode</span> <span class="o">=</span> <span class="n">vec</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
<span id="LC553" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">oldNode</span> <span class="o">!=</span> <span class="n">node</span> <span class="o">&amp;&amp;</span> <span class="n">m_cache</span><span class="o">.</span><span class="na">useCount</span><span class="o">()</span> <span class="o">&gt;</span> <span class="mi">1</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC554" class="line" lang="java">            <span class="cm">/* If we are going to set the node at the given index</span></span>
<span id="LC555" class="line" lang="java"><span class="cm">             * to a different value, and the cache is shared</span></span>
<span id="LC556" class="line" lang="java"><span class="cm">             * (has a use count greater than 1)</span></span>
<span id="LC557" class="line" lang="java"><span class="cm">             * then make a copy of the cache and use it</span></span>
<span id="LC558" class="line" lang="java"><span class="cm">             * so we don't overwrite the value for other</span></span>
<span id="LC559" class="line" lang="java"><span class="cm">             * users of the cache.</span></span>
<span id="LC560" class="line" lang="java"><span class="cm">             */</span></span>
<span id="LC561" class="line" lang="java">            <span class="nc">IteratorCache</span> <span class="n">newCache</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">IteratorCache</span><span class="o">();</span></span>
<span id="LC562" class="line" lang="java">            <span class="kd">final</span> <span class="nc">NodeVector</span> <span class="n">nv</span><span class="o">;</span></span>
<span id="LC563" class="line" lang="java">            <span class="k">try</span> <span class="o">{</span></span>
<span id="LC564" class="line" lang="java">                <span class="n">nv</span> <span class="o">=</span> <span class="o">(</span><span class="nc">NodeVector</span><span class="o">)</span> <span class="n">vec</span><span class="o">.</span><span class="na">clone</span><span class="o">();</span></span>
<span id="LC565" class="line" lang="java">            <span class="o">}</span> <span class="k">catch</span> <span class="o">(</span><span class="nc">CloneNotSupportedException</span> <span class="n">e</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC566" class="line" lang="java">                <span class="c1">// This should never happen</span></span>
<span id="LC567" class="line" lang="java">                <span class="n">e</span><span class="o">.</span><span class="na">printStackTrace</span><span class="o">();</span></span>
<span id="LC568" class="line" lang="java">                <span class="nc">RuntimeException</span> <span class="n">rte</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">RuntimeException</span><span class="o">(</span><span class="n">e</span><span class="o">.</span><span class="na">getMessage</span><span class="o">());</span></span>
<span id="LC569" class="line" lang="java">                <span class="k">throw</span> <span class="n">rte</span><span class="o">;</span></span>
<span id="LC570" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC571" class="line" lang="java">            <span class="n">newCache</span><span class="o">.</span><span class="na">setVector</span><span class="o">(</span><span class="n">nv</span><span class="o">);</span></span>
<span id="LC572" class="line" lang="java">            <span class="n">newCache</span><span class="o">.</span><span class="na">setCacheComplete</span><span class="o">(</span><span class="kc">true</span><span class="o">);</span></span>
<span id="LC573" class="line" lang="java">            <span class="n">m_cache</span> <span class="o">=</span> <span class="n">newCache</span><span class="o">;</span></span>
<span id="LC574" class="line" lang="java">            <span class="n">vec</span> <span class="o">=</span> <span class="n">nv</span><span class="o">;</span></span>
<span id="LC575" class="line" lang="java"></span>
<span id="LC576" class="line" lang="java">            <span class="c1">// Keep our superclass informed of the current NodeVector</span></span>
<span id="LC577" class="line" lang="java">            <span class="kd">super</span><span class="o">.</span><span class="na">setObject</span><span class="o">(</span><span class="n">nv</span><span class="o">);</span></span>
<span id="LC578" class="line" lang="java"></span>
<span id="LC579" class="line" lang="java">            <span class="cm">/* When we get to here the new cache has</span></span>
<span id="LC580" class="line" lang="java"><span class="cm">             * a use count of 1 and when setting a</span></span>
<span id="LC581" class="line" lang="java"><span class="cm">             * bunch of values on the same NodeSequence,</span></span>
<span id="LC582" class="line" lang="java"><span class="cm">             * such as when sorting, we will keep setting</span></span>
<span id="LC583" class="line" lang="java"><span class="cm">             * values in that same copy which has a use count of 1.</span></span>
<span id="LC584" class="line" lang="java"><span class="cm">             */</span></span>
<span id="LC585" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC586" class="line" lang="java">                <span class="n">vec</span><span class="o">.</span><span class="na">setElementAt</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="n">index</span><span class="o">);</span></span>
<span id="LC587" class="line" lang="java">                <span class="n">m_last</span> <span class="o">=</span> <span class="n">vec</span><span class="o">.</span><span class="na">size</span><span class="o">();</span></span>
<span id="LC588" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC589" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC590" class="line" lang="java">                <span class="n">m_iter</span><span class="o">.</span><span class="na">setItem</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="n">index</span><span class="o">);</span></span>
...
<span id="LC594" class="line" lang="java"><span class="cm">   * @see DTMIterator#getLength()</span></span>
<span id="LC595" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC596" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getLength</span><span class="o">()</span></span>
<span id="LC597" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC598" class="line" lang="java">    <span class="nc">IteratorCache</span> <span class="n">cache</span> <span class="o">=</span> <span class="n">getCache</span><span class="o">();</span></span>
<span id="LC599" class="line" lang="java"></span>
<span id="LC600" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">cache</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC601" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC602" class="line" lang="java">        <span class="c1">// Nodes from the iterator are cached</span></span>
<span id="LC603" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">cache</span><span class="o">.</span><span class="na">isComplete</span><span class="o">())</span> <span class="o">{</span></span>
<span id="LC604" class="line" lang="java">            <span class="c1">// All of the nodes from the iterator are cached</span></span>
<span id="LC605" class="line" lang="java">            <span class="c1">// so just return the number of nodes in the cache</span></span>
<span id="LC606" class="line" lang="java">            <span class="nc">NodeVector</span> <span class="n">nv</span> <span class="o">=</span> <span class="n">cache</span><span class="o">.</span><span class="na">getVector</span><span class="o">();</span></span>
<span id="LC607" class="line" lang="java">            <span class="k">return</span> <span class="n">nv</span><span class="o">.</span><span class="na">size</span><span class="o">();</span></span>
<span id="LC608" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC609" class="line" lang="java"></span>
<span id="LC610" class="line" lang="java">        <span class="c1">// If this NodeSequence wraps a mutable nodeset, then</span></span>
<span id="LC611" class="line" lang="java">        <span class="c1">// m_last will not reflect the size of the nodeset if</span></span>
<span id="LC612" class="line" lang="java">        <span class="c1">// it has been mutated...</span></span>
<span id="LC613" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_iter</span> <span class="k">instanceof</span> <span class="nc">NodeSetDTM</span><span class="o">)</span></span>
<span id="LC614" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC615" class="line" lang="java">            <span class="k">return</span> <span class="n">m_iter</span><span class="o">.</span><span class="na">getLength</span><span class="o">();</span></span>
<span id="LC616" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC617" class="line" lang="java"></span>
<span id="LC618" class="line" lang="java">                <span class="k">if</span><span class="o">(-</span><span class="mi">1</span> <span class="o">==</span> <span class="n">m_last</span><span class="o">)</span></span>
<span id="LC619" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC620" class="line" lang="java">                        <span class="kt">int</span> <span class="n">pos</span> <span class="o">=</span> <span class="n">m_next</span><span class="o">;</span></span>
<span id="LC621" class="line" lang="java">                        <span class="n">runTo</span><span class="o">(-</span><span class="mi">1</span><span class="o">);</span></span>
<span id="LC622" class="line" lang="java">                        <span class="n">m_next</span> <span class="o">=</span> <span class="n">pos</span><span class="o">;</span></span>
<span id="LC623" class="line" lang="java">                <span class="o">}</span></span>
<span id="LC624" class="line" lang="java">            <span class="k">return</span> <span class="n">m_last</span><span class="o">;</span></span>
...
<span id="LC628" class="line" lang="java">                <span class="k">return</span> <span class="o">(-</span><span class="mi">1</span> <span class="o">==</span> <span class="n">m_last</span><span class="o">)</span> <span class="o">?</span> <span class="o">(</span><span class="n">m_last</span> <span class="o">=</span> <span class="n">m_iter</span><span class="o">.</span><span class="na">getLength</span><span class="o">())</span> <span class="o">:</span> <span class="n">m_last</span><span class="o">;</span></span>
...
<span id="LC633" class="line" lang="java"><span class="cm">   * Note: Not a deep clone.</span></span>
<span id="LC634" class="line" lang="java"><span class="cm">   * @see DTMIterator#cloneWithReset()</span></span>
<span id="LC635" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC636" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMIterator</span> <span class="nf">cloneWithReset</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">CloneNotSupportedException</span></span>
<span id="LC637" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC638" class="line" lang="java">        <span class="nc">NodeSequence</span> <span class="n">seq</span> <span class="o">=</span> <span class="o">(</span><span class="nc">NodeSequence</span><span class="o">)</span><span class="kd">super</span><span class="o">.</span><span class="na">clone</span><span class="o">();</span></span>
<span id="LC639" class="line" lang="java">    <span class="n">seq</span><span class="o">.</span><span class="na">m_next</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC640" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">m_cache</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC641" class="line" lang="java">        <span class="c1">// In making this clone of an iterator we are making</span></span>
<span id="LC642" class="line" lang="java">        <span class="c1">// another NodeSequence object it has a reference</span></span>
<span id="LC643" class="line" lang="java">        <span class="c1">// to the same IteratorCache object as the original</span></span>
<span id="LC644" class="line" lang="java">        <span class="c1">// so we need to remember that more than one</span></span>
<span id="LC645" class="line" lang="java">        <span class="c1">// NodeSequence object shares the cache.</span></span>
<span id="LC646" class="line" lang="java">        <span class="n">m_cache</span><span class="o">.</span><span class="na">increaseUseCount</span><span class="o">();</span></span>
<span id="LC647" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC648" class="line" lang="java"></span>
<span id="LC649" class="line" lang="java">    <span class="k">return</span> <span class="n">seq</span><span class="o">;</span></span>
...
<span id="LC653" class="line" lang="java"><span class="cm">   * Get a clone of this iterator, but don't reset the iteration in the</span></span>
<span id="LC654" class="line" lang="java"><span class="cm">   * process, so that it may be used from the current position.</span></span>
<span id="LC655" class="line" lang="java"><span class="cm">   * Note: Not a deep clone.</span></span>
<span id="LC656" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC657" class="line" lang="java"><span class="cm">   * @return A clone of this object.</span></span>
<span id="LC658" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC659" class="line" lang="java"><span class="cm">   * @throws CloneNotSupportedException</span></span>
<span id="LC660" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC661" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Object</span> <span class="nf">clone</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">CloneNotSupportedException</span></span>
<span id="LC662" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC663" class="line" lang="java">          <span class="nc">NodeSequence</span> <span class="n">clone</span> <span class="o">=</span> <span class="o">(</span><span class="nc">NodeSequence</span><span class="o">)</span> <span class="kd">super</span><span class="o">.</span><span class="na">clone</span><span class="o">();</span></span>
<span id="LC664" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_iter</span><span class="o">)</span> <span class="n">clone</span><span class="o">.</span><span class="na">m_iter</span> <span class="o">=</span> <span class="o">(</span><span class="nc">DTMIterator</span><span class="o">)</span> <span class="n">m_iter</span><span class="o">.</span><span class="na">clone</span><span class="o">();</span></span>
<span id="LC665" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="n">m_cache</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC666" class="line" lang="java">              <span class="c1">// In making this clone of an iterator we are making</span></span>
<span id="LC667" class="line" lang="java">              <span class="c1">// another NodeSequence object it has a reference</span></span>
<span id="LC668" class="line" lang="java">              <span class="c1">// to the same IteratorCache object as the original</span></span>
<span id="LC669" class="line" lang="java">              <span class="c1">// so we need to remember that more than one</span></span>
<span id="LC670" class="line" lang="java">              <span class="c1">// NodeSequence object shares the cache.</span></span>
<span id="LC671" class="line" lang="java">              <span class="n">m_cache</span><span class="o">.</span><span class="na">increaseUseCount</span><span class="o">();</span></span>
<span id="LC672" class="line" lang="java">          <span class="o">}</span></span>
<span id="LC673" class="line" lang="java"></span>
<span id="LC674" class="line" lang="java">          <span class="k">return</span> <span class="n">clone</span><span class="o">;</span></span>
...
<span id="LC679" class="line" lang="java"><span class="cm">   * @see DTMIterator#isDocOrdered()</span></span>
<span id="LC680" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC681" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isDocOrdered</span><span class="o">()</span></span>
<span id="LC682" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC683" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_iter</span><span class="o">)</span></span>
<span id="LC684" class="line" lang="java">                <span class="k">return</span> <span class="n">m_iter</span><span class="o">.</span><span class="na">isDocOrdered</span><span class="o">();</span></span>
<span id="LC685" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC686" class="line" lang="java">        <span class="k">return</span> <span class="kc">true</span><span class="o">;</span> <span class="c1">// can't be sure?</span></span>
...
<span id="LC690" class="line" lang="java"><span class="cm">   * @see DTMIterator#getAxis()</span></span>
<span id="LC691" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC692" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getAxis</span><span class="o">()</span></span>
<span id="LC693" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC694" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_iter</span><span class="o">)</span></span>
<span id="LC695" class="line" lang="java">        <span class="k">return</span> <span class="n">m_iter</span><span class="o">.</span><span class="na">getAxis</span><span class="o">();</span></span>
<span id="LC696" class="line" lang="java">    <span class="k">else</span></span>
<span id="LC697" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC698" class="line" lang="java">        <span class="n">assertion</span><span class="o">(</span><span class="kc">false</span><span class="o">,</span> <span class="s">"Can not getAxis from a non-iterated node sequence!"</span><span class="o">);</span></span>
<span id="LC699" class="line" lang="java">        <span class="k">return</span> <span class="mi">0</span><span class="o">;</span></span>
...
<span id="LC704" class="line" lang="java"><span class="cm">   * @see PathComponent#getAnalysisBits()</span></span>
<span id="LC705" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC706" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getAnalysisBits</span><span class="o">()</span></span>
<span id="LC707" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC708" class="line" lang="java">        <span class="k">if</span><span class="o">((</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_iter</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="o">(</span><span class="n">m_iter</span> <span class="k">instanceof</span> <span class="nc">PathComponent</span><span class="o">))</span></span>
<span id="LC709" class="line" lang="java">        <span class="k">return</span> <span class="o">((</span><span class="nc">PathComponent</span><span class="o">)</span><span class="n">m_iter</span><span class="o">).</span><span class="na">getAnalysisBits</span><span class="o">();</span></span>
<span id="LC710" class="line" lang="java">    <span class="k">else</span></span>
<span id="LC711" class="line" lang="java">        <span class="k">return</span> <span class="mi">0</span><span class="o">;</span></span>
...
<span id="LC715" class="line" lang="java"><span class="cm">   * @see org.apache.xpath.Expression#fixupVariables(Vector, int)</span></span>
<span id="LC716" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC717" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">fixupVariables</span><span class="o">(</span><span class="nc">Vector</span> <span class="n">vars</span><span class="o">,</span> <span class="kt">int</span> <span class="n">globalsSize</span><span class="o">)</span></span>
<span id="LC718" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC719" class="line" lang="java">        <span class="kd">super</span><span class="o">.</span><span class="na">fixupVariables</span><span class="o">(</span><span class="n">vars</span><span class="o">,</span> <span class="n">globalsSize</span><span class="o">);</span></span>
...
<span id="LC723" class="line" lang="java"><span class="cm">   * Add the node into a vector of nodes where it should occur in</span></span>
<span id="LC724" class="line" lang="java"><span class="cm">   * document order.</span></span>
<span id="LC725" class="line" lang="java"><span class="cm">   * @param node The node to be added.</span></span>
<span id="LC726" class="line" lang="java"><span class="cm">   * @return insertIndex.</span></span>
<span id="LC727" class="line" lang="java"><span class="cm">   * @throws RuntimeException thrown if this NodeSetDTM is not of</span></span>
<span id="LC728" class="line" lang="java"><span class="cm">   * a mutable type.</span></span>
<span id="LC729" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC730" class="line" lang="java">   <span class="kd">protected</span> <span class="kt">int</span> <span class="nf">addNodeInDocOrder</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC731" class="line" lang="java">   <span class="o">{</span></span>
<span id="LC732" class="line" lang="java">      <span class="n">assertion</span><span class="o">(</span><span class="n">hasCache</span><span class="o">(),</span> <span class="s">"addNodeInDocOrder must be done on a mutable sequence!"</span><span class="o">);</span></span>
<span id="LC733" class="line" lang="java"></span>
<span id="LC734" class="line" lang="java">      <span class="kt">int</span> <span class="n">insertIndex</span> <span class="o">=</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC735" class="line" lang="java"></span>
<span id="LC736" class="line" lang="java">      <span class="nc">NodeVector</span> <span class="n">vec</span> <span class="o">=</span> <span class="n">getVector</span><span class="o">();</span></span>
<span id="LC737" class="line" lang="java"></span>
<span id="LC738" class="line" lang="java">      <span class="c1">// This needs to do a binary search, but a binary search</span></span>
<span id="LC739" class="line" lang="java">      <span class="c1">// is somewhat tough because the sequence test involves</span></span>
<span id="LC740" class="line" lang="java">      <span class="c1">// two nodes.</span></span>
<span id="LC741" class="line" lang="java">      <span class="kt">int</span> <span class="n">size</span> <span class="o">=</span> <span class="n">vec</span><span class="o">.</span><span class="na">size</span><span class="o">(),</span> <span class="n">i</span><span class="o">;</span></span>
<span id="LC742" class="line" lang="java"></span>
<span id="LC743" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="n">i</span> <span class="o">=</span> <span class="n">size</span> <span class="o">-</span> <span class="mi">1</span><span class="o">;</span> <span class="n">i</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span><span class="o">--)</span></span>
<span id="LC744" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC745" class="line" lang="java">        <span class="kt">int</span> <span class="n">child</span> <span class="o">=</span> <span class="n">vec</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC746" class="line" lang="java"></span>
<span id="LC747" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">child</span> <span class="o">==</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC748" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC749" class="line" lang="java">          <span class="n">i</span> <span class="o">=</span> <span class="o">-</span><span class="mi">2</span><span class="o">;</span> <span class="c1">// Duplicate, suppress insert</span></span>
...
<span id="LC754" class="line" lang="java">        <span class="no">DTM</span> <span class="n">dtm</span> <span class="o">=</span> <span class="n">m_dtmMgr</span><span class="o">.</span><span class="na">getDTM</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC755" class="line" lang="java">        <span class="k">if</span> <span class="o">(!</span><span class="n">dtm</span><span class="o">.</span><span class="na">isNodeAfter</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="n">child</span><span class="o">))</span></span>
...
<span id="LC761" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">i</span> <span class="o">!=</span> <span class="o">-</span><span class="mi">2</span><span class="o">)</span></span>
<span id="LC762" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC763" class="line" lang="java">        <span class="n">insertIndex</span> <span class="o">=</span> <span class="n">i</span> <span class="o">+</span> <span class="mi">1</span><span class="o">;</span></span>
<span id="LC764" class="line" lang="java"></span>
<span id="LC765" class="line" lang="java">        <span class="n">vec</span><span class="o">.</span><span class="na">insertElementAt</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="n">insertIndex</span><span class="o">);</span></span>
<span id="LC766" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC767" class="line" lang="java"></span>
<span id="LC768" class="line" lang="java">      <span class="c1">// checkDups();</span></span>
<span id="LC769" class="line" lang="java">      <span class="k">return</span> <span class="n">insertIndex</span><span class="o">;</span></span>
<span id="LC770" class="line" lang="java">    <span class="o">}</span> <span class="c1">// end addNodeInDocOrder(Vector v, Object obj)</span></span>
<span id="LC771" class="line" lang="java"></span>
<span id="LC772" class="line" lang="java">   <span class="cm">/**</span></span>
<span id="LC773" class="line" lang="java"><span class="cm">    * It used to be that many locations in the code simply</span></span>
<span id="LC774" class="line" lang="java"><span class="cm">    * did an assignment to this.m_obj directly, rather than</span></span>
<span id="LC775" class="line" lang="java"><span class="cm">    * calling the setObject(Object) method. The problem is</span></span>
<span id="LC776" class="line" lang="java"><span class="cm">    * that our super-class would be updated on what the</span></span>
<span id="LC777" class="line" lang="java"><span class="cm">    * cache associated with this NodeSequence, but</span></span>
<span id="LC778" class="line" lang="java"><span class="cm">    * we wouldn't know ourselves.</span></span>
<span id="LC779" class="line" lang="java"><span class="cm">    * &lt;p&gt;</span></span>
<span id="LC780" class="line" lang="java"><span class="cm">    * All setting of m_obj is done through setObject() now,</span></span>
<span id="LC781" class="line" lang="java"><span class="cm">    * and this method over-rides the super-class method.</span></span>
<span id="LC782" class="line" lang="java"><span class="cm">    * So now we are in the loop have an opportunity</span></span>
<span id="LC783" class="line" lang="java"><span class="cm">    * to update some caching information.</span></span>
<span id="LC784" class="line" lang="java"><span class="cm">    *</span></span>
<span id="LC785" class="line" lang="java"><span class="cm">    */</span></span>
<span id="LC786" class="line" lang="java">   <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">setObject</span><span class="o">(</span><span class="nc">Object</span> <span class="n">obj</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC787" class="line" lang="java">       <span class="k">if</span> <span class="o">(</span><span class="n">obj</span> <span class="k">instanceof</span> <span class="nc">NodeVector</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC788" class="line" lang="java">           <span class="c1">// Keep our superclass informed of the current NodeVector</span></span>
<span id="LC789" class="line" lang="java">           <span class="c1">// ... if we don't the smoketest fails (don't know why).</span></span>
<span id="LC790" class="line" lang="java">           <span class="kd">super</span><span class="o">.</span><span class="na">setObject</span><span class="o">(</span><span class="n">obj</span><span class="o">);</span></span>
<span id="LC791" class="line" lang="java"></span>
<span id="LC792" class="line" lang="java">           <span class="c1">// A copy of the code of what SetVector() would do.</span></span>
<span id="LC793" class="line" lang="java">           <span class="nc">NodeVector</span> <span class="n">v</span> <span class="o">=</span> <span class="o">(</span><span class="nc">NodeVector</span><span class="o">)</span><span class="n">obj</span><span class="o">;</span></span>
<span id="LC794" class="line" lang="java">           <span class="k">if</span> <span class="o">(</span><span class="n">m_cache</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC795" class="line" lang="java">               <span class="n">m_cache</span><span class="o">.</span><span class="na">setVector</span><span class="o">(</span><span class="n">v</span><span class="o">);</span></span>
<span id="LC796" class="line" lang="java">           <span class="o">}</span> <span class="k">else</span> <span class="k">if</span> <span class="o">(</span><span class="n">v</span><span class="o">!=</span><span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC797" class="line" lang="java">               <span class="n">m_cache</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">IteratorCache</span><span class="o">();</span></span>
<span id="LC798" class="line" lang="java">               <span class="n">m_cache</span><span class="o">.</span><span class="na">setVector</span><span class="o">(</span><span class="n">v</span><span class="o">);</span></span>
<span id="LC799" class="line" lang="java">           <span class="o">}</span></span>
<span id="LC800" class="line" lang="java">       <span class="o">}</span> <span class="k">else</span> <span class="k">if</span> <span class="o">(</span><span class="n">obj</span> <span class="k">instanceof</span> <span class="nc">IteratorCache</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC801" class="line" lang="java">           <span class="nc">IteratorCache</span> <span class="n">cache</span> <span class="o">=</span> <span class="o">(</span><span class="nc">IteratorCache</span><span class="o">)</span> <span class="n">obj</span><span class="o">;</span></span>
<span id="LC802" class="line" lang="java">           <span class="n">m_cache</span> <span class="o">=</span> <span class="n">cache</span><span class="o">;</span></span>
<span id="LC803" class="line" lang="java">           <span class="n">m_cache</span><span class="o">.</span><span class="na">increaseUseCount</span><span class="o">();</span></span>
<span id="LC804" class="line" lang="java"></span>
<span id="LC805" class="line" lang="java">           <span class="c1">// Keep our superclass informed of the current NodeVector</span></span>
<span id="LC806" class="line" lang="java">           <span class="kd">super</span><span class="o">.</span><span class="na">setObject</span><span class="o">(</span><span class="n">cache</span><span class="o">.</span><span class="na">getVector</span><span class="o">());</span></span>
<span id="LC807" class="line" lang="java">       <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC808" class="line" lang="java">           <span class="kd">super</span><span class="o">.</span><span class="na">setObject</span><span class="o">(</span><span class="n">obj</span><span class="o">);</span></span>
...
<span id="LC814" class="line" lang="java"><span class="cm">    * Each NodeSequence object has an iterator which is "walked".</span></span>
<span id="LC815" class="line" lang="java"><span class="cm">    * As an iterator is walked one obtains nodes from it.</span></span>
<span id="LC816" class="line" lang="java"><span class="cm">    * As those nodes are obtained they may be cached, making</span></span>
<span id="LC817" class="line" lang="java"><span class="cm">    * the next walking of a copy or clone of the iterator faster.</span></span>
<span id="LC818" class="line" lang="java"><span class="cm">    * This field (m_cache) is a reference to such a cache,</span></span>
<span id="LC819" class="line" lang="java"><span class="cm">    * which is populated as the iterator is walked.</span></span>
<span id="LC820" class="line" lang="java"><span class="cm">    * &lt;p&gt;</span></span>
<span id="LC821" class="line" lang="java"><span class="cm">    * Note that multiple NodeSequence objects may hold a</span></span>
<span id="LC822" class="line" lang="java"><span class="cm">    * reference to the same cache, and also</span></span>
<span id="LC823" class="line" lang="java"><span class="cm">    * (and this is important) the same iterator.</span></span>
<span id="LC824" class="line" lang="java"><span class="cm">    * The iterator and its cache may be shared among</span></span>
<span id="LC825" class="line" lang="java"><span class="cm">    * many NodeSequence objects.</span></span>
<span id="LC826" class="line" lang="java"><span class="cm">    * &lt;p&gt;</span></span>
<span id="LC827" class="line" lang="java"><span class="cm">    * If one of the NodeSequence objects walks ahead</span></span>
<span id="LC828" class="line" lang="java"><span class="cm">    * of the others it fills in the cache.</span></span>
<span id="LC829" class="line" lang="java"><span class="cm">    * As the others NodeSequence objects catch up they</span></span>
<span id="LC830" class="line" lang="java"><span class="cm">    * get their values from</span></span>
<span id="LC831" class="line" lang="java"><span class="cm">    * the cache rather than the iterator itself, so</span></span>
<span id="LC832" class="line" lang="java"><span class="cm">    * the iterator is only ever walked once and everyone</span></span>
<span id="LC833" class="line" lang="java"><span class="cm">    * benefits from the cache.</span></span>
<span id="LC834" class="line" lang="java"><span class="cm">    * &lt;p&gt;</span></span>
<span id="LC835" class="line" lang="java"><span class="cm">    * At some point the cache may be</span></span>
<span id="LC836" class="line" lang="java"><span class="cm">    * complete due to walking to the end of one of</span></span>
<span id="LC837" class="line" lang="java"><span class="cm">    * the copies of the iterator, and the cache is</span></span>
<span id="LC838" class="line" lang="java"><span class="cm">    * then marked as "complete".</span></span>
<span id="LC839" class="line" lang="java"><span class="cm">    * and the cache will have no more nodes added to it.</span></span>
<span id="LC840" class="line" lang="java"><span class="cm">    * &lt;p&gt;</span></span>
<span id="LC841" class="line" lang="java"><span class="cm">    * Its use-count is the number of NodeSequence objects that use it.</span></span>
<span id="LC842" class="line" lang="java"><span class="cm">    */</span></span>
<span id="LC843" class="line" lang="java">   <span class="kd">private</span> <span class="kd">final</span> <span class="kd">static</span> <span class="kd">class</span> <span class="nc">IteratorCache</span> <span class="o">{</span></span>
<span id="LC844" class="line" lang="java">       <span class="cm">/**</span></span>
<span id="LC845" class="line" lang="java"><span class="cm">        * A list of nodes already obtained from the iterator.</span></span>
<span id="LC846" class="line" lang="java"><span class="cm">        * As the iterator is walked the nodes obtained from</span></span>
<span id="LC847" class="line" lang="java"><span class="cm">        * it are appended to this list.</span></span>
<span id="LC848" class="line" lang="java"><span class="cm">        * &lt;p&gt;</span></span>
<span id="LC849" class="line" lang="java"><span class="cm">        * Both an iterator and its corresponding cache can</span></span>
<span id="LC850" class="line" lang="java"><span class="cm">        * be shared by multiple NodeSequence objects.</span></span>
<span id="LC851" class="line" lang="java"><span class="cm">        * &lt;p&gt;</span></span>
<span id="LC852" class="line" lang="java"><span class="cm">        * For example, consider three NodeSequence objects</span></span>
<span id="LC853" class="line" lang="java"><span class="cm">        * ns1, ns2 and ns3 doing such sharing, and the</span></span>
<span id="LC854" class="line" lang="java"><span class="cm">        * nodes to be obtaind from the iterator being</span></span>
<span id="LC855" class="line" lang="java"><span class="cm">        * the sequence { 33, 11, 44, 22, 55 }.</span></span>
<span id="LC856" class="line" lang="java"><span class="cm">        * &lt;p&gt;</span></span>
<span id="LC857" class="line" lang="java"><span class="cm">        * If ns3.nextNode() is called 3 times the the</span></span>
<span id="LC858" class="line" lang="java"><span class="cm">        * underlying iterator will have walked through</span></span>
<span id="LC859" class="line" lang="java"><span class="cm">        * 33, 11, 55 and these three nodes will have been put</span></span>
<span id="LC860" class="line" lang="java"><span class="cm">        * in the cache.</span></span>
<span id="LC861" class="line" lang="java"><span class="cm">        * &lt;p&gt;</span></span>
<span id="LC862" class="line" lang="java"><span class="cm">        * If ns2.nextNode() is called 2 times it will return</span></span>
<span id="LC863" class="line" lang="java"><span class="cm">        * 33 and 11 from the cache, leaving the iterator alone.</span></span>
<span id="LC864" class="line" lang="java"><span class="cm">        * &lt;p&gt;</span></span>
<span id="LC865" class="line" lang="java"><span class="cm">        * If ns1.nextNode() is called 6 times it will return</span></span>
<span id="LC866" class="line" lang="java"><span class="cm">        * 33 and 11 from the cache, then get 44, 22, 55 from</span></span>
<span id="LC867" class="line" lang="java"><span class="cm">        * the iterator, and appending 44, 22, 55 to the cache.</span></span>
<span id="LC868" class="line" lang="java"><span class="cm">        * On the sixth call it is found that the iterator is</span></span>
<span id="LC869" class="line" lang="java"><span class="cm">        * exhausted and the cache is marked complete.</span></span>
<span id="LC870" class="line" lang="java"><span class="cm">        * &lt;p&gt;</span></span>
<span id="LC871" class="line" lang="java"><span class="cm">        * Should ns2 or ns3 have nextNode() called they will</span></span>
<span id="LC872" class="line" lang="java"><span class="cm">        * know that the cache is complete, and they will</span></span>
<span id="LC873" class="line" lang="java"><span class="cm">        * obtain all subsequent nodes from the cache.</span></span>
<span id="LC874" class="line" lang="java"><span class="cm">        * &lt;p&gt;</span></span>
<span id="LC875" class="line" lang="java"><span class="cm">        * Note that the underlying iterator, though shared</span></span>
<span id="LC876" class="line" lang="java"><span class="cm">        * is only ever walked once.</span></span>
<span id="LC877" class="line" lang="java"><span class="cm">        */</span></span>
<span id="LC878" class="line" lang="java">        <span class="kd">private</span> <span class="nc">NodeVector</span> <span class="n">m_vec2</span><span class="o">;</span></span>
<span id="LC879" class="line" lang="java"></span>
<span id="LC880" class="line" lang="java">        <span class="cm">/**</span></span>
<span id="LC881" class="line" lang="java"><span class="cm">         * true if the associated iterator is exhausted and</span></span>
<span id="LC882" class="line" lang="java"><span class="cm">         * all nodes obtained from it are in the cache.</span></span>
<span id="LC883" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC884" class="line" lang="java">        <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">m_isComplete2</span><span class="o">;</span></span>
<span id="LC885" class="line" lang="java"></span>
<span id="LC886" class="line" lang="java">        <span class="kd">private</span> <span class="kt">int</span> <span class="n">m_useCount2</span><span class="o">;</span></span>
<span id="LC887" class="line" lang="java"></span>
<span id="LC888" class="line" lang="java">        <span class="nc">IteratorCache</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC889" class="line" lang="java">            <span class="n">m_vec2</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC890" class="line" lang="java">            <span class="n">m_isComplete2</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC891" class="line" lang="java">            <span class="n">m_useCount2</span> <span class="o">=</span> <span class="mi">1</span><span class="o">;</span></span>
...
<span id="LC896" class="line" lang="java"><span class="cm">         * Returns count of how many NodeSequence objects share this</span></span>
<span id="LC897" class="line" lang="java"><span class="cm">         * IteratorCache object.</span></span>
<span id="LC898" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC899" class="line" lang="java">        <span class="kd">private</span> <span class="kt">int</span> <span class="nf">useCount</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC900" class="line" lang="java">            <span class="k">return</span> <span class="n">m_useCount2</span><span class="o">;</span></span>
...
<span id="LC904" class="line" lang="java"><span class="cm">         * This method is called when yet another</span></span>
<span id="LC905" class="line" lang="java"><span class="cm">         * NodeSequence object uses, or shares</span></span>
<span id="LC906" class="line" lang="java"><span class="cm">         * this same cache.</span></span>
<span id="LC907" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC908" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC909" class="line" lang="java">        <span class="kd">private</span> <span class="kt">void</span> <span class="nf">increaseUseCount</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC910" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">m_vec2</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC911" class="line" lang="java">                <span class="n">m_useCount2</span><span class="o">++;</span></span>
...
<span id="LC916" class="line" lang="java"><span class="cm">         * Sets the NodeVector that holds the</span></span>
<span id="LC917" class="line" lang="java"><span class="cm">         * growing list of nodes as they are appended</span></span>
<span id="LC918" class="line" lang="java"><span class="cm">         * to the cached list.</span></span>
<span id="LC919" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC920" class="line" lang="java">        <span class="kd">private</span> <span class="kt">void</span> <span class="nf">setVector</span><span class="o">(</span><span class="nc">NodeVector</span> <span class="n">nv</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC921" class="line" lang="java">            <span class="n">m_vec2</span> <span class="o">=</span> <span class="n">nv</span><span class="o">;</span></span>
<span id="LC922" class="line" lang="java">            <span class="n">m_useCount2</span> <span class="o">=</span> <span class="mi">1</span><span class="o">;</span></span>
...
<span id="LC926" class="line" lang="java"><span class="cm">         * Get the cached list of nodes obtained from</span></span>
<span id="LC927" class="line" lang="java"><span class="cm">         * the iterator so far.</span></span>
<span id="LC928" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC929" class="line" lang="java">        <span class="kd">private</span> <span class="nc">NodeVector</span> <span class="nf">getVector</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC930" class="line" lang="java">            <span class="k">return</span> <span class="n">m_vec2</span><span class="o">;</span></span>
...
<span id="LC934" class="line" lang="java"><span class="cm">         * Call this method with 'true' if the</span></span>
<span id="LC935" class="line" lang="java"><span class="cm">         * iterator is exhausted and the cached list</span></span>
<span id="LC936" class="line" lang="java"><span class="cm">         * is complete, or no longer growing.</span></span>
<span id="LC937" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC938" class="line" lang="java">        <span class="kd">private</span> <span class="kt">void</span> <span class="nf">setCacheComplete</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">b</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC939" class="line" lang="java">            <span class="n">m_isComplete2</span> <span class="o">=</span> <span class="n">b</span><span class="o">;</span></span>
...
<span id="LC944" class="line" lang="java"><span class="cm">         * Returns true if no cache is complete</span></span>
<span id="LC945" class="line" lang="java"><span class="cm">         * and immutable.</span></span>
<span id="LC946" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC947" class="line" lang="java">        <span class="kd">private</span> <span class="kt">boolean</span> <span class="nf">isComplete</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC948" class="line" lang="java">            <span class="k">return</span> <span class="n">m_isComplete2</span><span class="o">;</span></span>
...
<span id="LC953" class="line" lang="java"><span class="cm">     * Get the cached list of nodes appended with</span></span>
<span id="LC954" class="line" lang="java"><span class="cm">     * values obtained from the iterator as</span></span>
<span id="LC955" class="line" lang="java"><span class="cm">     * a NodeSequence is walked when its</span></span>
<span id="LC956" class="line" lang="java"><span class="cm">     * nextNode() method is called.</span></span>
<span id="LC957" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC958" class="line" lang="java">    <span class="kd">protected</span> <span class="nc">IteratorCache</span> <span class="nf">getIteratorCache</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC959" class="line" lang="java">        <span class="k">return</span> <span class="n">m_cache</span><span class="o">;</span></span>
