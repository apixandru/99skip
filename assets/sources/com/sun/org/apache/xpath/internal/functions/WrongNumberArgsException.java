...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: WrongNumberArgsException.java,v 1.2.4.1 2005/09/14 20:27:04 jeffsuttor Exp $</span></span>
...
<span id="LC26" class="line" lang="java"><span class="cm"> * An exception that is thrown if the wrong number of arguments to an exception</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * are specified by the stylesheet.</span></span>
...
<span id="LC30" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">WrongNumberArgsException</span> <span class="kd">extends</span> <span class="nc">Exception</span></span>
<span id="LC31" class="line" lang="java"><span class="o">{</span></span>
<span id="LC32" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="o">-</span><span class="mi">4551577097576242432L</span><span class="o">;</span></span>
<span id="LC33" class="line" lang="java"></span>
<span id="LC34" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC35" class="line" lang="java"><span class="cm">   * Constructor WrongNumberArgsException</span></span>
<span id="LC36" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">   * @param argsExpected Error message that tells the number of arguments that</span></span>
<span id="LC38" class="line" lang="java"><span class="cm">   * were expected.</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC40" class="line" lang="java">  <span class="kd">public</span> <span class="nf">WrongNumberArgsException</span><span class="o">(</span><span class="nc">String</span> <span class="n">argsExpected</span><span class="o">)</span></span>
<span id="LC41" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC42" class="line" lang="java"></span>
<span id="LC43" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">argsExpected</span><span class="o">);</span></span>
