...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: LocPathIterator.java,v 1.2.4.2 2005/09/14 19:45:22 jeffsuttor Exp $</span></span>
...
<span id="LC30" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.utils.PrefixResolver</span><span class="o">;</span></span>
...
<span id="LC34" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.compiler.Compiler</span><span class="o">;</span></span>
<span id="LC35" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.objects.XNodeSet</span><span class="o">;</span></span>
...
<span id="LC37" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.res.XPATHErrorResources</span><span class="o">;</span></span>
<span id="LC38" class="line" lang="java"></span>
<span id="LC39" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC40" class="line" lang="java"><span class="cm"> * This class extends NodeSetDTM, which implements NodeIterator,</span></span>
<span id="LC41" class="line" lang="java"><span class="cm"> * and fetches nodes one at a time in document order based on a XPath</span></span>
<span id="LC42" class="line" lang="java"><span class="cm"> * &lt;a href="http://www.w3.org/TR/xpath#NT-LocationPath&gt;LocationPath&lt;/a&gt;.</span></span>
<span id="LC43" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC44" class="line" lang="java"><span class="cm"> * &lt;p&gt;If setShouldCacheNodes(true) is called,</span></span>
<span id="LC45" class="line" lang="java"><span class="cm"> * as each node is iterated via nextNode(), the node is also stored</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> * in the NodeVector, so that previousNode() can easily be done, except in</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * the case where the LocPathIterator is "owned" by a UnionPathIterator,</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * in which case the UnionPathIterator will cache the nodes.&lt;/p&gt;</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * @xsl.usage advanced</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC51" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">LocPathIterator</span> <span class="kd">extends</span> <span class="nc">PredicatedNodeTest</span></span>
<span id="LC52" class="line" lang="java">        <span class="kd">implements</span> <span class="nc">Cloneable</span><span class="o">,</span> <span class="nc">DTMIterator</span><span class="o">,</span> <span class="n">java</span><span class="o">.</span><span class="na">io</span><span class="o">.</span><span class="na">Serializable</span><span class="o">,</span> <span class="nc">PathComponent</span></span>
<span id="LC53" class="line" lang="java"><span class="o">{</span></span>
<span id="LC54" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="o">-</span><span class="mi">4602476357268405754L</span><span class="o">;</span></span>
<span id="LC55" class="line" lang="java"></span>
<span id="LC56" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">   * Create a LocPathIterator object.</span></span>
<span id="LC58" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC59" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC60" class="line" lang="java">  <span class="kd">protected</span> <span class="nf">LocPathIterator</span><span class="o">()</span></span>
...
<span id="LC66" class="line" lang="java"><span class="cm">   * Create a LocPathIterator object.</span></span>
<span id="LC67" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC68" class="line" lang="java"><span class="cm">   * @param nscontext The namespace context for this iterator,</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">   * should be OK if null.</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC71" class="line" lang="java">  <span class="kd">protected</span> <span class="nf">LocPathIterator</span><span class="o">(</span><span class="nc">PrefixResolver</span> <span class="n">nscontext</span><span class="o">)</span></span>
<span id="LC72" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC73" class="line" lang="java"></span>
<span id="LC74" class="line" lang="java">    <span class="n">setLocPathIterator</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC75" class="line" lang="java">    <span class="n">m_prefixResolver</span> <span class="o">=</span> <span class="n">nscontext</span><span class="o">;</span></span>
...
<span id="LC79" class="line" lang="java"><span class="cm">   * Create a LocPathIterator object, including creation</span></span>
<span id="LC80" class="line" lang="java"><span class="cm">   * of step walkers from the opcode list, and call back</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">   * into the Compiler to create predicate expressions.</span></span>
<span id="LC82" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">   * @param compiler The Compiler which is creating</span></span>
<span id="LC84" class="line" lang="java"><span class="cm">   * this expression.</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">   * @param opPos The position of this iterator in the</span></span>
<span id="LC86" class="line" lang="java"><span class="cm">   * opcode list from the compiler.</span></span>
<span id="LC87" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC88" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC90" class="line" lang="java">  <span class="kd">protected</span> <span class="nf">LocPathIterator</span><span class="o">(</span><span class="nc">Compiler</span> <span class="n">compiler</span><span class="o">,</span> <span class="kt">int</span> <span class="n">opPos</span><span class="o">,</span> <span class="kt">int</span> <span class="n">analysis</span><span class="o">)</span></span>
<span id="LC91" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC92" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC93" class="line" lang="java">    <span class="k">this</span><span class="o">(</span><span class="n">compiler</span><span class="o">,</span> <span class="n">opPos</span><span class="o">,</span> <span class="n">analysis</span><span class="o">,</span> <span class="kc">true</span><span class="o">);</span></span>
...
<span id="LC97" class="line" lang="java"><span class="cm">   * Create a LocPathIterator object, including creation</span></span>
<span id="LC98" class="line" lang="java"><span class="cm">   * of step walkers from the opcode list, and call back</span></span>
<span id="LC99" class="line" lang="java"><span class="cm">   * into the Compiler to create predicate expressions.</span></span>
<span id="LC100" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">   * @param compiler The Compiler which is creating</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">   * this expression.</span></span>
<span id="LC103" class="line" lang="java"><span class="cm">   * @param opPos The position of this iterator in the</span></span>
<span id="LC104" class="line" lang="java"><span class="cm">   * opcode list from the compiler.</span></span>
<span id="LC105" class="line" lang="java"><span class="cm">   * @param shouldLoadWalkers True if walkers should be</span></span>
<span id="LC106" class="line" lang="java"><span class="cm">   * loaded, or false if this is a derived iterator and</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">   * it doesn't wish to load child walkers.</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC109" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC110" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC111" class="line" lang="java">  <span class="kd">protected</span> <span class="nf">LocPathIterator</span><span class="o">(</span></span>
<span id="LC112" class="line" lang="java">          <span class="nc">Compiler</span> <span class="n">compiler</span><span class="o">,</span> <span class="kt">int</span> <span class="n">opPos</span><span class="o">,</span> <span class="kt">int</span> <span class="n">analysis</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">shouldLoadWalkers</span><span class="o">)</span></span>
<span id="LC113" class="line" lang="java">            <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC114" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC115" class="line" lang="java">    <span class="n">setLocPathIterator</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
...
<span id="LC119" class="line" lang="java"><span class="cm">   * Get the analysis bits for this walker, as defined in the WalkerFactory.</span></span>
<span id="LC120" class="line" lang="java"><span class="cm">   * @return One of WalkerFactory#BIT_DESCENDANT, etc.</span></span>
<span id="LC121" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC122" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getAnalysisBits</span><span class="o">()</span></span>
<span id="LC123" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC124" class="line" lang="java">        <span class="kt">int</span> <span class="n">axis</span> <span class="o">=</span> <span class="n">getAxis</span><span class="o">();</span></span>
<span id="LC125" class="line" lang="java">        <span class="kt">int</span> <span class="n">bit</span> <span class="o">=</span> <span class="nc">WalkerFactory</span><span class="o">.</span><span class="na">getAnalysisBitFromAxes</span><span class="o">(</span><span class="n">axis</span><span class="o">);</span></span>
<span id="LC126" class="line" lang="java">        <span class="k">return</span> <span class="n">bit</span><span class="o">;</span></span>
...
<span id="LC130" class="line" lang="java"><span class="cm">   * Read the object from a serialization stream.</span></span>
<span id="LC131" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC132" class="line" lang="java"><span class="cm">   * @param stream Input stream to read from</span></span>
<span id="LC133" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC134" class="line" lang="java"><span class="cm">   * @throws java.io.IOException</span></span>
<span id="LC135" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC136" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC137" class="line" lang="java">  <span class="kd">private</span> <span class="kt">void</span> <span class="nf">readObject</span><span class="o">(</span><span class="n">java</span><span class="o">.</span><span class="na">io</span><span class="o">.</span><span class="na">ObjectInputStream</span> <span class="n">stream</span><span class="o">)</span></span>
<span id="LC138" class="line" lang="java">          <span class="kd">throws</span> <span class="n">java</span><span class="o">.</span><span class="na">io</span><span class="o">.</span><span class="na">IOException</span><span class="o">,</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC139" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC140" class="line" lang="java">    <span class="k">try</span></span>
<span id="LC141" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC142" class="line" lang="java">      <span class="n">stream</span><span class="o">.</span><span class="na">defaultReadObject</span><span class="o">();</span></span>
<span id="LC143" class="line" lang="java">      <span class="n">m_clones</span> <span class="o">=</span>  <span class="k">new</span> <span class="nc">IteratorPool</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC144" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC145" class="line" lang="java">    <span class="k">catch</span> <span class="o">(</span><span class="nc">ClassNotFoundException</span> <span class="n">cnfe</span><span class="o">)</span></span>
<span id="LC146" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC147" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span><span class="o">(</span><span class="n">cnfe</span><span class="o">);</span></span>
...
<span id="LC152" class="line" lang="java"><span class="cm">   * Set the environment in which this iterator operates, which should provide:</span></span>
<span id="LC153" class="line" lang="java"><span class="cm">   * a node (the context node... same value as "root" defined below)</span></span>
<span id="LC154" class="line" lang="java"><span class="cm">   * a pair of non-zero positive integers (the context position and the context size)</span></span>
<span id="LC155" class="line" lang="java"><span class="cm">   * a set of variable bindings</span></span>
<span id="LC156" class="line" lang="java"><span class="cm">   * a function library</span></span>
<span id="LC157" class="line" lang="java"><span class="cm">   * the set of namespace declarations in scope for the expression.</span></span>
<span id="LC158" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC159" class="line" lang="java"><span class="cm">   * &lt;p&gt;At this time the exact implementation of this environment is application</span></span>
<span id="LC160" class="line" lang="java"><span class="cm">   * dependent.  Probably a proper interface will be created fairly soon.&lt;/p&gt;</span></span>
<span id="LC161" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC162" class="line" lang="java"><span class="cm">   * @param environment The environment object.</span></span>
<span id="LC163" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC164" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setEnvironment</span><span class="o">(</span><span class="nc">Object</span> <span class="n">environment</span><span class="o">)</span></span>
<span id="LC165" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC166" class="line" lang="java">    <span class="c1">// no-op for now.</span></span>
...
<span id="LC170" class="line" lang="java"><span class="cm">   * Get an instance of a DTM that "owns" a node handle.  Since a node</span></span>
<span id="LC171" class="line" lang="java"><span class="cm">   * iterator may be passed without a DTMManager, this allows the</span></span>
<span id="LC172" class="line" lang="java"><span class="cm">   * caller to easily get the DTM using just the iterator.</span></span>
<span id="LC173" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC174" class="line" lang="java"><span class="cm">   * @param nodeHandle the nodeHandle.</span></span>
<span id="LC175" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC176" class="line" lang="java"><span class="cm">   * @return a non-null DTM reference.</span></span>
<span id="LC177" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC178" class="line" lang="java">  <span class="kd">public</span> <span class="no">DTM</span> <span class="nf">getDTM</span><span class="o">(</span><span class="kt">int</span> <span class="n">nodeHandle</span><span class="o">)</span></span>
<span id="LC179" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC180" class="line" lang="java">    <span class="c1">// %OPT%</span></span>
<span id="LC181" class="line" lang="java">    <span class="k">return</span> <span class="n">m_execContext</span><span class="o">.</span><span class="na">getDTM</span><span class="o">(</span><span class="n">nodeHandle</span><span class="o">);</span></span>
...
<span id="LC185" class="line" lang="java"><span class="cm">   * Get an instance of the DTMManager.  Since a node</span></span>
<span id="LC186" class="line" lang="java"><span class="cm">   * iterator may be passed without a DTMManager, this allows the</span></span>
<span id="LC187" class="line" lang="java"><span class="cm">   * caller to easily get the DTMManager using just the iterator.</span></span>
<span id="LC188" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC189" class="line" lang="java"><span class="cm">   * @return a non-null DTMManager reference.</span></span>
<span id="LC190" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC191" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMManager</span> <span class="nf">getDTMManager</span><span class="o">()</span></span>
<span id="LC192" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC193" class="line" lang="java">    <span class="k">return</span> <span class="n">m_execContext</span><span class="o">.</span><span class="na">getDTMManager</span><span class="o">();</span></span>
...
<span id="LC197" class="line" lang="java"><span class="cm">   * Execute this iterator, meaning create a clone that can</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">   * store state, and initialize it for fast execution from</span></span>
<span id="LC199" class="line" lang="java"><span class="cm">   * the current runtime state.  When this is called, no actual</span></span>
<span id="LC200" class="line" lang="java"><span class="cm">   * query from the current context node is performed.</span></span>
<span id="LC201" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC202" class="line" lang="java"><span class="cm">   * @param xctxt The XPath execution context.</span></span>
<span id="LC203" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC204" class="line" lang="java"><span class="cm">   * @return An XNodeSet reference that holds this iterator.</span></span>
<span id="LC205" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC206" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC207" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC208" class="line" lang="java">  <span class="kd">public</span> <span class="nc">XObject</span> <span class="nf">execute</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">)</span></span>
<span id="LC209" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC210" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC211" class="line" lang="java"></span>
<span id="LC212" class="line" lang="java">    <span class="nc">XNodeSet</span> <span class="n">iter</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">XNodeSet</span><span class="o">((</span><span class="nc">LocPathIterator</span><span class="o">)</span><span class="n">m_clones</span><span class="o">.</span><span class="na">getInstance</span><span class="o">());</span></span>
<span id="LC213" class="line" lang="java"></span>
<span id="LC214" class="line" lang="java">    <span class="n">iter</span><span class="o">.</span><span class="na">setRoot</span><span class="o">(</span><span class="n">xctxt</span><span class="o">.</span><span class="na">getCurrentNode</span><span class="o">(),</span> <span class="n">xctxt</span><span class="o">);</span></span>
<span id="LC215" class="line" lang="java"></span>
<span id="LC216" class="line" lang="java">    <span class="k">return</span> <span class="n">iter</span><span class="o">;</span></span>
...
<span id="LC220" class="line" lang="java"><span class="cm">   * Execute an expression in the XPath runtime context, and return the</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">   * result of the expression.</span></span>
<span id="LC222" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC223" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC224" class="line" lang="java"><span class="cm">   * @param xctxt The XPath runtime context.</span></span>
<span id="LC225" class="line" lang="java"><span class="cm">   * @param handler The target content handler.</span></span>
<span id="LC226" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC227" class="line" lang="java"><span class="cm">   * @return The result of the expression in the form of a &lt;code&gt;XObject&lt;/code&gt;.</span></span>
<span id="LC228" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC229" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException if a runtime exception</span></span>
<span id="LC230" class="line" lang="java"><span class="cm">   *         occurs.</span></span>
<span id="LC231" class="line" lang="java"><span class="cm">   * @throws org.xml.sax.SAXException</span></span>
<span id="LC232" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC233" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">executeCharsToContentHandler</span><span class="o">(</span></span>
<span id="LC234" class="line" lang="java">          <span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">,</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">ContentHandler</span> <span class="n">handler</span><span class="o">)</span></span>
<span id="LC235" class="line" lang="java">            <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span><span class="o">,</span></span>
<span id="LC236" class="line" lang="java">                   <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC237" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC238" class="line" lang="java">    <span class="nc">LocPathIterator</span> <span class="n">clone</span> <span class="o">=</span> <span class="o">(</span><span class="nc">LocPathIterator</span><span class="o">)</span><span class="n">m_clones</span><span class="o">.</span><span class="na">getInstance</span><span class="o">();</span></span>
<span id="LC239" class="line" lang="java"></span>
<span id="LC240" class="line" lang="java">    <span class="kt">int</span> <span class="n">current</span> <span class="o">=</span> <span class="n">xctxt</span><span class="o">.</span><span class="na">getCurrentNode</span><span class="o">();</span></span>
<span id="LC241" class="line" lang="java">    <span class="n">clone</span><span class="o">.</span><span class="na">setRoot</span><span class="o">(</span><span class="n">current</span><span class="o">,</span> <span class="n">xctxt</span><span class="o">);</span></span>
<span id="LC242" class="line" lang="java"></span>
<span id="LC243" class="line" lang="java">    <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">clone</span><span class="o">.</span><span class="na">nextNode</span><span class="o">();</span></span>
<span id="LC244" class="line" lang="java">    <span class="no">DTM</span> <span class="n">dtm</span> <span class="o">=</span> <span class="n">clone</span><span class="o">.</span><span class="na">getDTM</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC245" class="line" lang="java">    <span class="n">clone</span><span class="o">.</span><span class="na">detach</span><span class="o">();</span></span>
<span id="LC246" class="line" lang="java"></span>
<span id="LC247" class="line" lang="java">    <span class="k">if</span><span class="o">(</span><span class="n">node</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span></span>
<span id="LC248" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC249" class="line" lang="java">      <span class="n">dtm</span><span class="o">.</span><span class="na">dispatchCharactersEvents</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="n">handler</span><span class="o">,</span> <span class="kc">false</span><span class="o">);</span></span>
...
<span id="LC254" class="line" lang="java"><span class="cm">   * Given an select expression and a context, evaluate the XPath</span></span>
<span id="LC255" class="line" lang="java"><span class="cm">   * and return the resulting iterator.</span></span>
<span id="LC256" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC257" class="line" lang="java"><span class="cm">   * @param xctxt The execution context.</span></span>
<span id="LC258" class="line" lang="java"><span class="cm">   * @param contextNode The node that "." expresses.</span></span>
<span id="LC259" class="line" lang="java"><span class="cm">   * @throws TransformerException thrown if the active ProblemListener decides</span></span>
<span id="LC260" class="line" lang="java"><span class="cm">   * the error condition is severe enough to halt processing.</span></span>
<span id="LC261" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC262" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC263" class="line" lang="java"><span class="cm">   * @xsl.usage experimental</span></span>
<span id="LC264" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC265" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMIterator</span> <span class="nf">asIterator</span><span class="o">(</span></span>
<span id="LC266" class="line" lang="java">          <span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">,</span> <span class="kt">int</span> <span class="n">contextNode</span><span class="o">)</span></span>
<span id="LC267" class="line" lang="java">            <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC268" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC269" class="line" lang="java">    <span class="nc">XNodeSet</span> <span class="n">iter</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">XNodeSet</span><span class="o">((</span><span class="nc">LocPathIterator</span><span class="o">)</span><span class="n">m_clones</span><span class="o">.</span><span class="na">getInstance</span><span class="o">());</span></span>
<span id="LC270" class="line" lang="java"></span>
<span id="LC271" class="line" lang="java">    <span class="n">iter</span><span class="o">.</span><span class="na">setRoot</span><span class="o">(</span><span class="n">contextNode</span><span class="o">,</span> <span class="n">xctxt</span><span class="o">);</span></span>
<span id="LC272" class="line" lang="java"></span>
<span id="LC273" class="line" lang="java">    <span class="k">return</span> <span class="n">iter</span><span class="o">;</span></span>
...
<span id="LC278" class="line" lang="java"><span class="cm">   * Tell if the expression is a nodeset expression.</span></span>
<span id="LC279" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC280" class="line" lang="java"><span class="cm">   * @return true if the expression can be represented as a nodeset.</span></span>
<span id="LC281" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC282" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isNodesetExpr</span><span class="o">()</span></span>
<span id="LC283" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC284" class="line" lang="java">    <span class="k">return</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC288" class="line" lang="java"><span class="cm">   * Return the first node out of the nodeset, if this expression is</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">   * a nodeset expression.  This is the default implementation for</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">   * nodesets.  Derived classes should try and override this and return a</span></span>
<span id="LC291" class="line" lang="java"><span class="cm">   * value without having to do a clone operation.</span></span>
<span id="LC292" class="line" lang="java"><span class="cm">   * @param xctxt The XPath runtime context.</span></span>
<span id="LC293" class="line" lang="java"><span class="cm">   * @return the first node out of the nodeset, or DTM.NULL.</span></span>
<span id="LC294" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC295" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">asNode</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">)</span></span>
<span id="LC296" class="line" lang="java">    <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC297" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC298" class="line" lang="java">    <span class="nc">DTMIterator</span> <span class="n">iter</span> <span class="o">=</span> <span class="o">(</span><span class="nc">DTMIterator</span><span class="o">)</span><span class="n">m_clones</span><span class="o">.</span><span class="na">getInstance</span><span class="o">();</span></span>
<span id="LC299" class="line" lang="java"></span>
<span id="LC300" class="line" lang="java">    <span class="kt">int</span> <span class="n">current</span> <span class="o">=</span> <span class="n">xctxt</span><span class="o">.</span><span class="na">getCurrentNode</span><span class="o">();</span></span>
<span id="LC301" class="line" lang="java"></span>
<span id="LC302" class="line" lang="java">    <span class="n">iter</span><span class="o">.</span><span class="na">setRoot</span><span class="o">(</span><span class="n">current</span><span class="o">,</span> <span class="n">xctxt</span><span class="o">);</span></span>
<span id="LC303" class="line" lang="java"></span>
<span id="LC304" class="line" lang="java">    <span class="kt">int</span> <span class="n">next</span> <span class="o">=</span> <span class="n">iter</span><span class="o">.</span><span class="na">nextNode</span><span class="o">();</span></span>
<span id="LC305" class="line" lang="java">    <span class="c1">// m_clones.freeInstance(iter);</span></span>
<span id="LC306" class="line" lang="java">    <span class="n">iter</span><span class="o">.</span><span class="na">detach</span><span class="o">();</span></span>
<span id="LC307" class="line" lang="java">    <span class="k">return</span> <span class="n">next</span><span class="o">;</span></span>
...
<span id="LC311" class="line" lang="java"><span class="cm">   * Evaluate this operation directly to a boolean.</span></span>
<span id="LC312" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC313" class="line" lang="java"><span class="cm">   * @param xctxt The runtime execution context.</span></span>
<span id="LC314" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC315" class="line" lang="java"><span class="cm">   * @return The result of the operation as a boolean.</span></span>
<span id="LC316" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC317" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC318" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC319" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">bool</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">)</span></span>
<span id="LC320" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC321" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC322" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">asNode</span><span class="o">(</span><span class="n">xctxt</span><span class="o">)</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">);</span></span>
...
<span id="LC327" class="line" lang="java"><span class="cm">   * Set if this is an iterator at the upper level of</span></span>
<span id="LC328" class="line" lang="java"><span class="cm">   * the XPath.</span></span>
<span id="LC329" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC330" class="line" lang="java"><span class="cm">   * @param b true if this location path is at the top level of the</span></span>
<span id="LC331" class="line" lang="java"><span class="cm">   *          expression.</span></span>
<span id="LC332" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC333" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC334" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIsTopLevel</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">b</span><span class="o">)</span></span>
<span id="LC335" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC336" class="line" lang="java">    <span class="n">m_isTopLevel</span> <span class="o">=</span> <span class="n">b</span><span class="o">;</span></span>
...
<span id="LC340" class="line" lang="java"><span class="cm">   * Get if this is an iterator at the upper level of</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">   * the XPath.</span></span>
<span id="LC342" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC343" class="line" lang="java"><span class="cm">   * @return true if this location path is at the top level of the</span></span>
<span id="LC344" class="line" lang="java"><span class="cm">   *          expression.</span></span>
<span id="LC345" class="line" lang="java"><span class="cm">   * @xsl.usage advanced</span></span>
<span id="LC346" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC347" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getIsTopLevel</span><span class="o">()</span></span>
<span id="LC348" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC349" class="line" lang="java">    <span class="k">return</span> <span class="n">m_isTopLevel</span><span class="o">;</span></span>
...
<span id="LC353" class="line" lang="java"><span class="cm">   * Initialize the context values for this expression</span></span>
<span id="LC354" class="line" lang="java"><span class="cm">   * after it is cloned.</span></span>
<span id="LC355" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC356" class="line" lang="java"><span class="cm">   * @param context The XPath runtime context for this</span></span>
<span id="LC357" class="line" lang="java"><span class="cm">   * transformation.</span></span>
<span id="LC358" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC359" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setRoot</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="nc">Object</span> <span class="n">environment</span><span class="o">)</span></span>
<span id="LC360" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC361" class="line" lang="java"></span>
<span id="LC362" class="line" lang="java">    <span class="n">m_context</span> <span class="o">=</span> <span class="n">context</span><span class="o">;</span></span>
<span id="LC363" class="line" lang="java"></span>
<span id="LC364" class="line" lang="java">    <span class="nc">XPathContext</span> <span class="n">xctxt</span> <span class="o">=</span> <span class="o">(</span><span class="nc">XPathContext</span><span class="o">)</span><span class="n">environment</span><span class="o">;</span></span>
<span id="LC365" class="line" lang="java">    <span class="n">m_execContext</span> <span class="o">=</span> <span class="n">xctxt</span><span class="o">;</span></span>
<span id="LC366" class="line" lang="java">    <span class="n">m_cdtm</span> <span class="o">=</span> <span class="n">xctxt</span><span class="o">.</span><span class="na">getDTM</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC367" class="line" lang="java"></span>
<span id="LC368" class="line" lang="java">    <span class="n">m_currentContextNode</span> <span class="o">=</span> <span class="n">context</span><span class="o">;</span> <span class="c1">// only if top level?</span></span>
<span id="LC369" class="line" lang="java"></span>
<span id="LC370" class="line" lang="java">    <span class="c1">// Yech, shouldn't have to do this.  -sb</span></span>
<span id="LC371" class="line" lang="java">    <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_prefixResolver</span><span class="o">)</span></span>
<span id="LC372" class="line" lang="java">        <span class="n">m_prefixResolver</span> <span class="o">=</span> <span class="n">xctxt</span><span class="o">.</span><span class="na">getNamespaceContext</span><span class="o">();</span></span>
<span id="LC373" class="line" lang="java"></span>
<span id="LC374" class="line" lang="java">    <span class="n">m_lastFetched</span> <span class="o">=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC375" class="line" lang="java">    <span class="n">m_foundLast</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC376" class="line" lang="java">    <span class="n">m_pos</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC377" class="line" lang="java">    <span class="n">m_length</span> <span class="o">=</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC378" class="line" lang="java"></span>
<span id="LC379" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">m_isTopLevel</span><span class="o">)</span></span>
<span id="LC380" class="line" lang="java">      <span class="k">this</span><span class="o">.</span><span class="na">m_stackFrame</span> <span class="o">=</span> <span class="n">xctxt</span><span class="o">.</span><span class="na">getVarStack</span><span class="o">().</span><span class="na">getStackFrame</span><span class="o">();</span></span>
<span id="LC381" class="line" lang="java"></span>
<span id="LC382" class="line" lang="java">    <span class="c1">// reset();</span></span>
...
<span id="LC386" class="line" lang="java"><span class="cm">   * Set the next position index of this iterator.</span></span>
<span id="LC387" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC388" class="line" lang="java"><span class="cm">   * @param next A value greater than or equal to zero that indicates the next</span></span>
<span id="LC389" class="line" lang="java"><span class="cm">   * node position to fetch.</span></span>
<span id="LC390" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC391" class="line" lang="java">  <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">setNextPosition</span><span class="o">(</span><span class="kt">int</span> <span class="n">next</span><span class="o">)</span></span>
<span id="LC392" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC393" class="line" lang="java">    <span class="n">assertion</span><span class="o">(</span><span class="kc">false</span><span class="o">,</span> <span class="s">"setNextPosition not supported in this iterator!"</span><span class="o">);</span></span>
...
<span id="LC397" class="line" lang="java"><span class="cm">   * Get the current position, which is one less than</span></span>
<span id="LC398" class="line" lang="java"><span class="cm">   * the next nextNode() call will retrieve.  i.e. if</span></span>
<span id="LC399" class="line" lang="java"><span class="cm">   * you call getCurrentPos() and the return is 0, the next</span></span>
<span id="LC400" class="line" lang="java"><span class="cm">   * fetch will take place at index 1.</span></span>
<span id="LC401" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC402" class="line" lang="java"><span class="cm">   * @return A value greater than or equal to zero that indicates the next</span></span>
<span id="LC403" class="line" lang="java"><span class="cm">   * node position to fetch.</span></span>
<span id="LC404" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC405" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nf">getCurrentPos</span><span class="o">()</span></span>
<span id="LC406" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC407" class="line" lang="java">    <span class="k">return</span> <span class="n">m_pos</span><span class="o">;</span></span>
...
<span id="LC412" class="line" lang="java"><span class="cm">   * If setShouldCacheNodes(true) is called, then nodes will</span></span>
<span id="LC413" class="line" lang="java"><span class="cm">   * be cached.  They are not cached by default.</span></span>
<span id="LC414" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC415" class="line" lang="java"><span class="cm">   * @param b True if this iterator should cache nodes.</span></span>
<span id="LC416" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC417" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setShouldCacheNodes</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">b</span><span class="o">)</span></span>
<span id="LC418" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC419" class="line" lang="java"></span>
<span id="LC420" class="line" lang="java">    <span class="n">assertion</span><span class="o">(</span><span class="kc">false</span><span class="o">,</span> <span class="s">"setShouldCacheNodes not supported by this iterater!"</span><span class="o">);</span></span>
...
<span id="LC424" class="line" lang="java"><span class="cm">   * Tells if this iterator can have nodes added to it or set via</span></span>
<span id="LC425" class="line" lang="java"><span class="cm">   * the &lt;code&gt;setItem(int node, int index)&lt;/code&gt; method.</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC427" class="line" lang="java"><span class="cm">   * @return True if the nodelist can be mutated.</span></span>
<span id="LC428" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC429" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isMutable</span><span class="o">()</span></span>
...
<span id="LC435" class="line" lang="java"><span class="cm">   * Set the current position in the node set.</span></span>
<span id="LC436" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC437" class="line" lang="java"><span class="cm">   * @param i Must be a valid index greater</span></span>
<span id="LC438" class="line" lang="java"><span class="cm">   * than or equal to zero and less than m_cachedNodes.size().</span></span>
<span id="LC439" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC440" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCurrentPos</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span></span>
<span id="LC441" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC442" class="line" lang="java">        <span class="n">assertion</span><span class="o">(</span><span class="kc">false</span><span class="o">,</span> <span class="s">"setCurrentPos not supported by this iterator!"</span><span class="o">);</span></span>
...
<span id="LC446" class="line" lang="java"><span class="cm">   * Increment the current position in the node set.</span></span>
<span id="LC447" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC448" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">incrementCurrentPos</span><span class="o">()</span></span>
<span id="LC449" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC450" class="line" lang="java">        <span class="n">m_pos</span><span class="o">++;</span></span>
...
<span id="LC455" class="line" lang="java"><span class="cm">   * Get the length of the cached nodes.</span></span>
<span id="LC456" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC457" class="line" lang="java"><span class="cm">   * &lt;p&gt;Note: for the moment at least, this only returns</span></span>
<span id="LC458" class="line" lang="java"><span class="cm">   * the size of the nodes that have been fetched to date,</span></span>
<span id="LC459" class="line" lang="java"><span class="cm">   * it doesn't attempt to run to the end to make sure we</span></span>
<span id="LC460" class="line" lang="java"><span class="cm">   * have found everything.  This should be reviewed.&lt;/p&gt;</span></span>
<span id="LC461" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC462" class="line" lang="java"><span class="cm">   * @return The size of the current cache list.</span></span>
<span id="LC463" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC464" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">size</span><span class="o">()</span></span>
<span id="LC465" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC466" class="line" lang="java">        <span class="n">assertion</span><span class="o">(</span><span class="kc">false</span><span class="o">,</span> <span class="s">"size() not supported by this iterator!"</span><span class="o">);</span></span>
<span id="LC467" class="line" lang="java">        <span class="k">return</span> <span class="mi">0</span><span class="o">;</span></span>
...
<span id="LC471" class="line" lang="java"><span class="cm">   *  Returns the &lt;code&gt;index&lt;/code&gt; th item in the collection. If</span></span>
<span id="LC472" class="line" lang="java"><span class="cm">   * &lt;code&gt;index&lt;/code&gt; is greater than or equal to the number of nodes in</span></span>
<span id="LC473" class="line" lang="java"><span class="cm">   * the list, this returns &lt;code&gt;null&lt;/code&gt; .</span></span>
<span id="LC474" class="line" lang="java"><span class="cm">   * @param index  Index into the collection.</span></span>
<span id="LC475" class="line" lang="java"><span class="cm">   * @return  The node at the &lt;code&gt;index&lt;/code&gt; th position in the</span></span>
<span id="LC476" class="line" lang="java"><span class="cm">   *   &lt;code&gt;NodeList&lt;/code&gt; , or &lt;code&gt;null&lt;/code&gt; if that is not a valid</span></span>
<span id="LC477" class="line" lang="java"><span class="cm">   *   index.</span></span>
<span id="LC478" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC479" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">item</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span></span>
<span id="LC480" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC481" class="line" lang="java">        <span class="n">assertion</span><span class="o">(</span><span class="kc">false</span><span class="o">,</span> <span class="s">"item(int index) not supported by this iterator!"</span><span class="o">);</span></span>
<span id="LC482" class="line" lang="java">        <span class="k">return</span> <span class="mi">0</span><span class="o">;</span></span>
...
<span id="LC486" class="line" lang="java"><span class="cm">   * Sets the node at the specified index of this vector to be the</span></span>
<span id="LC487" class="line" lang="java"><span class="cm">   * specified node. The previous component at that position is discarded.</span></span>
<span id="LC488" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC489" class="line" lang="java"><span class="cm">   * &lt;p&gt;The index must be a value greater than or equal to 0 and less</span></span>
<span id="LC490" class="line" lang="java"><span class="cm">   * than the current size of the vector.</span></span>
<span id="LC491" class="line" lang="java"><span class="cm">   * The iterator must be in cached mode.&lt;/p&gt;</span></span>
<span id="LC492" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC493" class="line" lang="java"><span class="cm">   * &lt;p&gt;Meant to be used for sorted iterators.&lt;/p&gt;</span></span>
<span id="LC494" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC495" class="line" lang="java"><span class="cm">   * @param node Node to set</span></span>
<span id="LC496" class="line" lang="java"><span class="cm">   * @param index Index of where to set the node</span></span>
<span id="LC497" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC498" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setItem</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">,</span> <span class="kt">int</span> <span class="n">index</span><span class="o">)</span></span>
<span id="LC499" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC500" class="line" lang="java">        <span class="n">assertion</span><span class="o">(</span><span class="kc">false</span><span class="o">,</span> <span class="s">"setItem not supported by this iterator!"</span><span class="o">);</span></span>
...
<span id="LC504" class="line" lang="java"><span class="cm">   *  The number of nodes in the list. The range of valid child node indices</span></span>
<span id="LC505" class="line" lang="java"><span class="cm">   * is 0 to &lt;code&gt;length-1&lt;/code&gt; inclusive.</span></span>
<span id="LC506" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC507" class="line" lang="java"><span class="cm">   * @return The number of nodes in the list, always greater or equal to zero.</span></span>
<span id="LC508" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC509" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getLength</span><span class="o">()</span></span>
<span id="LC510" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC511" class="line" lang="java">    <span class="c1">// Tell if this is being called from within a predicate.</span></span>
<span id="LC512" class="line" lang="java">        <span class="kt">boolean</span> <span class="n">isPredicateTest</span> <span class="o">=</span> <span class="o">(</span><span class="k">this</span> <span class="o">==</span> <span class="n">m_execContext</span><span class="o">.</span><span class="na">getSubContextList</span><span class="o">());</span></span>
<span id="LC513" class="line" lang="java"></span>
<span id="LC514" class="line" lang="java">    <span class="c1">// And get how many total predicates are part of this step.</span></span>
<span id="LC515" class="line" lang="java">        <span class="kt">int</span> <span class="n">predCount</span> <span class="o">=</span> <span class="n">getPredicateCount</span><span class="o">();</span></span>
<span id="LC516" class="line" lang="java"></span>
<span id="LC517" class="line" lang="java">    <span class="c1">// If we have already calculated the length, and the current predicate</span></span>
<span id="LC518" class="line" lang="java">    <span class="c1">// is the first predicate, then return the length.  We don't cache</span></span>
<span id="LC519" class="line" lang="java">    <span class="c1">// the anything but the length of the list to the first predicate.</span></span>
<span id="LC520" class="line" lang="java">    <span class="k">if</span> <span class="o">(-</span><span class="mi">1</span> <span class="o">!=</span> <span class="n">m_length</span> <span class="o">&amp;&amp;</span> <span class="n">isPredicateTest</span> <span class="o">&amp;&amp;</span> <span class="n">m_predicateIndex</span> <span class="o">&lt;</span> <span class="mi">1</span><span class="o">)</span></span>
<span id="LC521" class="line" lang="java">                <span class="k">return</span> <span class="n">m_length</span><span class="o">;</span></span>
<span id="LC522" class="line" lang="java"></span>
<span id="LC523" class="line" lang="java">    <span class="c1">// I'm a bit worried about this one, since it doesn't have the</span></span>
<span id="LC524" class="line" lang="java">    <span class="c1">// checks found above.  I suspect it's fine.  -sb</span></span>
<span id="LC525" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">m_foundLast</span><span class="o">)</span></span>
<span id="LC526" class="line" lang="java">                <span class="k">return</span> <span class="n">m_pos</span><span class="o">;</span></span>
<span id="LC527" class="line" lang="java"></span>
<span id="LC528" class="line" lang="java">    <span class="c1">// Create a clone, and count from the current position to the end</span></span>
<span id="LC529" class="line" lang="java">    <span class="c1">// of the list, not taking into account the current predicate and</span></span>
<span id="LC530" class="line" lang="java">    <span class="c1">// predicates after the current one.</span></span>
<span id="LC531" class="line" lang="java">    <span class="kt">int</span> <span class="n">pos</span> <span class="o">=</span> <span class="o">(</span><span class="n">m_predicateIndex</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="o">)</span> <span class="o">?</span> <span class="n">getProximityPosition</span><span class="o">()</span> <span class="o">:</span> <span class="n">m_pos</span><span class="o">;</span></span>
<span id="LC532" class="line" lang="java"></span>
<span id="LC533" class="line" lang="java">    <span class="nc">LocPathIterator</span> <span class="n">clone</span><span class="o">;</span></span>
<span id="LC534" class="line" lang="java"></span>
<span id="LC535" class="line" lang="java">    <span class="k">try</span></span>
<span id="LC536" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC537" class="line" lang="java">      <span class="n">clone</span> <span class="o">=</span> <span class="o">(</span><span class="nc">LocPathIterator</span><span class="o">)</span> <span class="n">clone</span><span class="o">();</span></span>
<span id="LC538" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC539" class="line" lang="java">    <span class="k">catch</span> <span class="o">(</span><span class="nc">CloneNotSupportedException</span> <span class="n">cnse</span><span class="o">)</span></span>
<span id="LC540" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC541" class="line" lang="java">      <span class="k">return</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC542" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC543" class="line" lang="java"></span>
<span id="LC544" class="line" lang="java">    <span class="c1">// We want to clip off the last predicate, but only if we are a sub</span></span>
<span id="LC545" class="line" lang="java">    <span class="c1">// context node list, NOT if we are a context list.  See pos68 test,</span></span>
<span id="LC546" class="line" lang="java">    <span class="c1">// also test against bug4638.</span></span>
<span id="LC547" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">predCount</span> <span class="o">&gt;</span> <span class="mi">0</span> <span class="o">&amp;&amp;</span> <span class="n">isPredicateTest</span><span class="o">)</span></span>
<span id="LC548" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC549" class="line" lang="java">      <span class="c1">// Don't call setPredicateCount, because it clones and is slower.</span></span>
<span id="LC550" class="line" lang="java">      <span class="n">clone</span><span class="o">.</span><span class="na">m_predCount</span> <span class="o">=</span> <span class="n">m_predicateIndex</span><span class="o">;</span></span>
<span id="LC551" class="line" lang="java">      <span class="c1">// The line above used to be:</span></span>
<span id="LC552" class="line" lang="java">      <span class="c1">// clone.m_predCount = predCount - 1;</span></span>
<span id="LC553" class="line" lang="java">      <span class="c1">// ...which looks like a dumb bug to me. -sb</span></span>
<span id="LC554" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC555" class="line" lang="java"></span>
<span id="LC556" class="line" lang="java">    <span class="kt">int</span> <span class="n">next</span><span class="o">;</span></span>
<span id="LC557" class="line" lang="java"></span>
<span id="LC558" class="line" lang="java">    <span class="k">while</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">next</span> <span class="o">=</span> <span class="n">clone</span><span class="o">.</span><span class="na">nextNode</span><span class="o">()))</span></span>
<span id="LC559" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC560" class="line" lang="java">      <span class="n">pos</span><span class="o">++;</span></span>
<span id="LC561" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC562" class="line" lang="java"></span>
<span id="LC563" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">isPredicateTest</span> <span class="o">&amp;&amp;</span> <span class="n">m_predicateIndex</span> <span class="o">&lt;</span> <span class="mi">1</span><span class="o">)</span></span>
<span id="LC564" class="line" lang="java">      <span class="n">m_length</span> <span class="o">=</span> <span class="n">pos</span><span class="o">;</span></span>
<span id="LC565" class="line" lang="java"></span>
<span id="LC566" class="line" lang="java">    <span class="k">return</span> <span class="n">pos</span><span class="o">;</span></span>
...
<span id="LC570" class="line" lang="java"><span class="cm">   * Tells if this NodeSetDTM is "fresh", in other words, if</span></span>
<span id="LC571" class="line" lang="java"><span class="cm">   * the first nextNode() that is called will return the</span></span>
<span id="LC572" class="line" lang="java"><span class="cm">   * first node in the set.</span></span>
<span id="LC573" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC574" class="line" lang="java"><span class="cm">   * @return true of nextNode has not been called.</span></span>
<span id="LC575" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC576" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isFresh</span><span class="o">()</span></span>
<span id="LC577" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC578" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">m_pos</span> <span class="o">==</span> <span class="mi">0</span><span class="o">);</span></span>
...
<span id="LC582" class="line" lang="java"><span class="cm">   *  Returns the previous node in the set and moves the position of the</span></span>
<span id="LC583" class="line" lang="java"><span class="cm">   * iterator backwards in the set.</span></span>
<span id="LC584" class="line" lang="java"><span class="cm">   * @return  The previous &lt;code&gt;Node&lt;/code&gt; in the set being iterated over,</span></span>
<span id="LC585" class="line" lang="java"><span class="cm">   *   or&lt;code&gt;null&lt;/code&gt; if there are no more members in that set.</span></span>
<span id="LC586" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC587" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">previousNode</span><span class="o">()</span></span>
<span id="LC588" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC589" class="line" lang="java">    <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span></span>
<span id="LC590" class="line" lang="java">      <span class="nc">XSLMessages</span><span class="o">.</span><span class="na">createXPATHMessage</span><span class="o">(</span><span class="nc">XPATHErrorResources</span><span class="o">.</span><span class="na">ER_NODESETDTM_CANNOT_ITERATE</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"This NodeSetDTM can not iterate to a previous node!");</span></span>
...
<span id="LC594" class="line" lang="java"><span class="cm">   * This attribute determines which node types are presented via the</span></span>
<span id="LC595" class="line" lang="java"><span class="cm">   * iterator. The available set of constants is defined in the</span></span>
<span id="LC596" class="line" lang="java"><span class="cm">   * &lt;code&gt;NodeFilter&lt;/code&gt; interface.</span></span>
<span id="LC597" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC598" class="line" lang="java"><span class="cm">   * &lt;p&gt;This is somewhat useless at this time, since it doesn't</span></span>
<span id="LC599" class="line" lang="java"><span class="cm">   * really return information that tells what this iterator will</span></span>
<span id="LC600" class="line" lang="java"><span class="cm">   * show.  It is here only to fullfill the DOM NodeIterator</span></span>
<span id="LC601" class="line" lang="java"><span class="cm">   * interface.&lt;/p&gt;</span></span>
<span id="LC602" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC603" class="line" lang="java"><span class="cm">   * @return For now, always NodeFilter.SHOW_ALL &amp; ~NodeFilter.SHOW_ENTITY_REFERENCE.</span></span>
<span id="LC604" class="line" lang="java"><span class="cm">   * @see org.w3c.dom.traversal.NodeIterator</span></span>
<span id="LC605" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC606" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getWhatToShow</span><span class="o">()</span></span>
<span id="LC607" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC608" class="line" lang="java"></span>
<span id="LC609" class="line" lang="java">    <span class="c1">// TODO: ??</span></span>
<span id="LC610" class="line" lang="java">    <span class="k">return</span> <span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_ALL</span> <span class="o">&amp;</span> <span class="o">~</span><span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_ENTITY_REFERENCE</span><span class="o">;</span></span>
...
<span id="LC614" class="line" lang="java"><span class="cm">   *  The filter used to screen nodes.  Not used at this time,</span></span>
<span id="LC615" class="line" lang="java"><span class="cm">   * this is here only to fullfill the DOM NodeIterator</span></span>
<span id="LC616" class="line" lang="java"><span class="cm">   * interface.</span></span>
<span id="LC617" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC618" class="line" lang="java"><span class="cm">   * @return Always null.</span></span>
<span id="LC619" class="line" lang="java"><span class="cm">   * @see org.w3c.dom.traversal.NodeIterator</span></span>
<span id="LC620" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC621" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMFilter</span> <span class="nf">getFilter</span><span class="o">()</span></span>
<span id="LC622" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC623" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC627" class="line" lang="java"><span class="cm">   * The root node of the Iterator, as specified when it was created.</span></span>
<span id="LC628" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC629" class="line" lang="java"><span class="cm">   * @return The "root" of this iterator, which, in XPath terms,</span></span>
<span id="LC630" class="line" lang="java"><span class="cm">   * is the node context for this iterator.</span></span>
<span id="LC631" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC632" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getRoot</span><span class="o">()</span></span>
<span id="LC633" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC634" class="line" lang="java">    <span class="k">return</span> <span class="n">m_context</span><span class="o">;</span></span>
...
<span id="LC638" class="line" lang="java"><span class="cm">   *  The value of this flag determines whether the children of entity</span></span>
<span id="LC639" class="line" lang="java"><span class="cm">   * reference nodes are visible to the iterator. If false, they will be</span></span>
<span id="LC640" class="line" lang="java"><span class="cm">   * skipped over.</span></span>
<span id="LC641" class="line" lang="java"><span class="cm">   * &lt;br&gt; To produce a view of the document that has entity references</span></span>
<span id="LC642" class="line" lang="java"><span class="cm">   * expanded and does not expose the entity reference node itself, use the</span></span>
<span id="LC643" class="line" lang="java"><span class="cm">   * whatToShow flags to hide the entity reference node and set</span></span>
<span id="LC644" class="line" lang="java"><span class="cm">   * expandEntityReferences to true when creating the iterator. To produce</span></span>
<span id="LC645" class="line" lang="java"><span class="cm">   * a view of the document that has entity reference nodes but no entity</span></span>
<span id="LC646" class="line" lang="java"><span class="cm">   * expansion, use the whatToShow flags to show the entity reference node</span></span>
<span id="LC647" class="line" lang="java"><span class="cm">   * and set expandEntityReferences to false.</span></span>
<span id="LC648" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC649" class="line" lang="java"><span class="cm">   * @return Always true, since entity reference nodes are not</span></span>
<span id="LC650" class="line" lang="java"><span class="cm">   * visible in the XPath model.</span></span>
<span id="LC651" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC652" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getExpandEntityReferences</span><span class="o">()</span></span>
...
<span id="LC657" class="line" lang="java">  <span class="cm">/** Control over whether it is OK for detach to reset the iterator. */</span></span>
<span id="LC658" class="line" lang="java">  <span class="kd">protected</span> <span class="kt">boolean</span> <span class="n">m_allowDetach</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC659" class="line" lang="java"></span>
<span id="LC660" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC661" class="line" lang="java"><span class="cm">   * Specify if it's OK for detach to release the iterator for reuse.</span></span>
<span id="LC662" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC663" class="line" lang="java"><span class="cm">   * @param allowRelease true if it is OK for detach to release this iterator</span></span>
<span id="LC664" class="line" lang="java"><span class="cm">   * for pooling.</span></span>
<span id="LC665" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC666" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">allowDetachToRelease</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">allowRelease</span><span class="o">)</span></span>
<span id="LC667" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC668" class="line" lang="java">    <span class="n">m_allowDetach</span> <span class="o">=</span> <span class="n">allowRelease</span><span class="o">;</span></span>
...
<span id="LC672" class="line" lang="java"><span class="cm">   *  Detaches the iterator from the set which it iterated over, releasing</span></span>
<span id="LC673" class="line" lang="java"><span class="cm">   * any computational resources and placing the iterator in the INVALID</span></span>
<span id="LC674" class="line" lang="java"><span class="cm">   * state. After&lt;code&gt;detach&lt;/code&gt; has been invoked, calls to</span></span>
<span id="LC675" class="line" lang="java"><span class="cm">   * &lt;code&gt;nextNode&lt;/code&gt; or&lt;code&gt;previousNode&lt;/code&gt; will raise the</span></span>
<span id="LC676" class="line" lang="java"><span class="cm">   * exception INVALID_STATE_ERR.</span></span>
<span id="LC677" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC678" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">detach</span><span class="o">()</span></span>
<span id="LC679" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC680" class="line" lang="java">    <span class="k">if</span><span class="o">(</span><span class="n">m_allowDetach</span><span class="o">)</span></span>
<span id="LC681" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC682" class="line" lang="java">      <span class="c1">// sb: allow reusing of cached nodes when possible?</span></span>
<span id="LC683" class="line" lang="java">      <span class="c1">// m_cachedNodes = null;</span></span>
<span id="LC684" class="line" lang="java">      <span class="n">m_execContext</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC685" class="line" lang="java">      <span class="c1">// m_prefixResolver = null;  sb: Why would this ever want to be null?</span></span>
<span id="LC686" class="line" lang="java">      <span class="n">m_cdtm</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC687" class="line" lang="java">      <span class="n">m_length</span> <span class="o">=</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC688" class="line" lang="java">      <span class="n">m_pos</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC689" class="line" lang="java">      <span class="n">m_lastFetched</span> <span class="o">=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC690" class="line" lang="java">      <span class="n">m_context</span> <span class="o">=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC691" class="line" lang="java">      <span class="n">m_currentContextNode</span> <span class="o">=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC692" class="line" lang="java"></span>
<span id="LC693" class="line" lang="java">      <span class="n">m_clones</span><span class="o">.</span><span class="na">freeInstance</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
...
<span id="LC698" class="line" lang="java"><span class="cm">   * Reset the iterator.</span></span>
<span id="LC699" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC700" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">reset</span><span class="o">()</span></span>
<span id="LC701" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC702" class="line" lang="java">        <span class="n">assertion</span><span class="o">(</span><span class="kc">false</span><span class="o">,</span> <span class="s">"This iterator can not reset!"</span><span class="o">);</span></span>
...
<span id="LC706" class="line" lang="java"><span class="cm">   * Get a cloned Iterator that is reset to the beginning</span></span>
<span id="LC707" class="line" lang="java"><span class="cm">   * of the query.</span></span>
<span id="LC708" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC709" class="line" lang="java"><span class="cm">   * @return A cloned NodeIterator set of the start of the query.</span></span>
<span id="LC710" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC711" class="line" lang="java"><span class="cm">   * @throws CloneNotSupportedException</span></span>
<span id="LC712" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC713" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMIterator</span> <span class="nf">cloneWithReset</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">CloneNotSupportedException</span></span>
<span id="LC714" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC715" class="line" lang="java">    <span class="nc">LocPathIterator</span> <span class="n">clone</span><span class="o">;</span></span>
<span id="LC716" class="line" lang="java"><span class="c1">//    clone = (LocPathIterator) clone();</span></span>
<span id="LC717" class="line" lang="java">    <span class="n">clone</span> <span class="o">=</span> <span class="o">(</span><span class="nc">LocPathIterator</span><span class="o">)</span><span class="n">m_clones</span><span class="o">.</span><span class="na">getInstanceOrThrow</span><span class="o">();</span></span>
<span id="LC718" class="line" lang="java">    <span class="n">clone</span><span class="o">.</span><span class="na">m_execContext</span> <span class="o">=</span> <span class="n">m_execContext</span><span class="o">;</span></span>
<span id="LC719" class="line" lang="java">    <span class="n">clone</span><span class="o">.</span><span class="na">m_cdtm</span> <span class="o">=</span> <span class="n">m_cdtm</span><span class="o">;</span></span>
<span id="LC720" class="line" lang="java"></span>
<span id="LC721" class="line" lang="java">    <span class="n">clone</span><span class="o">.</span><span class="na">m_context</span> <span class="o">=</span> <span class="n">m_context</span><span class="o">;</span></span>
<span id="LC722" class="line" lang="java">    <span class="n">clone</span><span class="o">.</span><span class="na">m_currentContextNode</span> <span class="o">=</span> <span class="n">m_currentContextNode</span><span class="o">;</span></span>
<span id="LC723" class="line" lang="java">    <span class="n">clone</span><span class="o">.</span><span class="na">m_stackFrame</span> <span class="o">=</span> <span class="n">m_stackFrame</span><span class="o">;</span></span>
<span id="LC724" class="line" lang="java"></span>
<span id="LC725" class="line" lang="java">    <span class="c1">// clone.reset();</span></span>
<span id="LC726" class="line" lang="java"></span>
<span id="LC727" class="line" lang="java">    <span class="k">return</span> <span class="n">clone</span><span class="o">;</span></span>
...
<span id="LC731" class="line" lang="java"><span class="c1">//   * Get a cloned LocPathIterator that holds the same</span></span>
<span id="LC732" class="line" lang="java"><span class="c1">//   * position as this iterator.</span></span>
<span id="LC733" class="line" lang="java"><span class="c1">//   *</span></span>
<span id="LC734" class="line" lang="java"><span class="c1">//   * @return A clone of this iterator that holds the same node position.</span></span>
<span id="LC735" class="line" lang="java"><span class="c1">//   *</span></span>
<span id="LC736" class="line" lang="java"><span class="c1">//   * @throws CloneNotSupportedException</span></span>
<span id="LC737" class="line" lang="java"><span class="c1">//   */</span></span>
<span id="LC738" class="line" lang="java"><span class="c1">//  public Object clone() throws CloneNotSupportedException</span></span>
<span id="LC739" class="line" lang="java"><span class="c1">//  {</span></span>
<span id="LC740" class="line" lang="java"><span class="c1">//</span></span>
<span id="LC741" class="line" lang="java"><span class="c1">//    LocPathIterator clone = (LocPathIterator) super.clone();</span></span>
<span id="LC742" class="line" lang="java"><span class="c1">//</span></span>
<span id="LC743" class="line" lang="java"><span class="c1">//    return clone;</span></span>
...
<span id="LC747" class="line" lang="java"><span class="cm">   *  Returns the next node in the set and advances the position of the</span></span>
<span id="LC748" class="line" lang="java"><span class="cm">   * iterator in the set. After a NodeIterator is created, the first call</span></span>
<span id="LC749" class="line" lang="java"><span class="cm">   * to nextNode() returns the first node in the set.</span></span>
<span id="LC750" class="line" lang="java"><span class="cm">   * @return  The next &lt;code&gt;Node&lt;/code&gt; in the set being iterated over, or</span></span>
<span id="LC751" class="line" lang="java"><span class="cm">   *   &lt;code&gt;null&lt;/code&gt; if there are no more members in that set.</span></span>
<span id="LC752" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC753" class="line" lang="java">  <span class="kd">public</span> <span class="kd">abstract</span> <span class="kt">int</span> <span class="nf">nextNode</span><span class="o">();</span></span>
<span id="LC754" class="line" lang="java"></span>
<span id="LC755" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC756" class="line" lang="java"><span class="cm">   * Bottleneck the return of a next node, to make returns</span></span>
<span id="LC757" class="line" lang="java"><span class="cm">   * easier from nextNode().</span></span>
<span id="LC758" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC759" class="line" lang="java"><span class="cm">   * @param nextNode The next node found, may be null.</span></span>
<span id="LC760" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC761" class="line" lang="java"><span class="cm">   * @return The same node that was passed as an argument.</span></span>
<span id="LC762" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC763" class="line" lang="java">  <span class="kd">protected</span> <span class="kt">int</span> <span class="nf">returnNextNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">nextNode</span><span class="o">)</span></span>
<span id="LC764" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC765" class="line" lang="java"></span>
<span id="LC766" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="n">nextNode</span><span class="o">)</span></span>
<span id="LC767" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC768" class="line" lang="java">      <span class="n">m_pos</span><span class="o">++;</span></span>
<span id="LC769" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC770" class="line" lang="java"></span>
<span id="LC771" class="line" lang="java">    <span class="n">m_lastFetched</span> <span class="o">=</span> <span class="n">nextNode</span><span class="o">;</span></span>
<span id="LC772" class="line" lang="java"></span>
<span id="LC773" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">==</span> <span class="n">nextNode</span><span class="o">)</span></span>
<span id="LC774" class="line" lang="java">      <span class="n">m_foundLast</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC775" class="line" lang="java"></span>
<span id="LC776" class="line" lang="java">    <span class="k">return</span> <span class="n">nextNode</span><span class="o">;</span></span>
...
<span id="LC780" class="line" lang="java"><span class="cm">   * Return the last fetched node.  Needed to support the UnionPathIterator.</span></span>
<span id="LC781" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC782" class="line" lang="java"><span class="cm">   * @return The last fetched node, or null if the last fetch was null.</span></span>
<span id="LC783" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC784" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getCurrentNode</span><span class="o">()</span></span>
<span id="LC785" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC786" class="line" lang="java">    <span class="k">return</span> <span class="n">m_lastFetched</span><span class="o">;</span></span>
...
<span id="LC790" class="line" lang="java"><span class="cm">   * If an index is requested, NodeSetDTM will call this method</span></span>
<span id="LC791" class="line" lang="java"><span class="cm">   * to run the iterator to the index.  By default this sets</span></span>
<span id="LC792" class="line" lang="java"><span class="cm">   * m_next to the index.  If the index argument is -1, this</span></span>
<span id="LC793" class="line" lang="java"><span class="cm">   * signals that the iterator should be run to the end.</span></span>
<span id="LC794" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC795" class="line" lang="java"><span class="cm">   * @param index The index to run to, or -1 if the iterator</span></span>
<span id="LC796" class="line" lang="java"><span class="cm">   * should run to the end.</span></span>
<span id="LC797" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC798" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">runTo</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span></span>
<span id="LC799" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC800" class="line" lang="java"></span>
<span id="LC801" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">m_foundLast</span> <span class="o">||</span> <span class="o">((</span><span class="n">index</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="o">(</span><span class="n">index</span> <span class="o">&lt;=</span> <span class="n">getCurrentPos</span><span class="o">())))</span></span>
...
<span id="LC804" class="line" lang="java">    <span class="kt">int</span> <span class="n">n</span><span class="o">;</span></span>
<span id="LC805" class="line" lang="java"></span>
<span id="LC806" class="line" lang="java">    <span class="k">if</span> <span class="o">(-</span><span class="mi">1</span> <span class="o">==</span> <span class="n">index</span><span class="o">)</span></span>
<span id="LC807" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC808" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">n</span> <span class="o">=</span> <span class="n">nextNode</span><span class="o">()));</span></span>
<span id="LC809" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC810" class="line" lang="java">    <span class="k">else</span></span>
<span id="LC811" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC812" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">n</span> <span class="o">=</span> <span class="n">nextNode</span><span class="o">()))</span></span>
<span id="LC813" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC814" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">getCurrentPos</span><span class="o">()</span> <span class="o">&gt;=</span> <span class="n">index</span><span class="o">)</span></span>
...
<span id="LC821" class="line" lang="java"><span class="cm">   * Tells if we've found the last node yet.</span></span>
<span id="LC822" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC823" class="line" lang="java"><span class="cm">   * @return true if the last nextNode returned null.</span></span>
<span id="LC824" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC825" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">boolean</span> <span class="nf">getFoundLast</span><span class="o">()</span></span>
<span id="LC826" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC827" class="line" lang="java">    <span class="k">return</span> <span class="n">m_foundLast</span><span class="o">;</span></span>
...
<span id="LC831" class="line" lang="java"><span class="cm">   * The XPath execution context we are operating on.</span></span>
<span id="LC832" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC833" class="line" lang="java"><span class="cm">   * @return XPath execution context this iterator is operating on,</span></span>
<span id="LC834" class="line" lang="java"><span class="cm">   * or null if setRoot has not been called.</span></span>
<span id="LC835" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC836" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">XPathContext</span> <span class="nf">getXPathContext</span><span class="o">()</span></span>
<span id="LC837" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC838" class="line" lang="java">    <span class="k">return</span> <span class="n">m_execContext</span><span class="o">;</span></span>
...
<span id="LC842" class="line" lang="java"><span class="cm">   * The node context for the iterator.</span></span>
<span id="LC843" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC844" class="line" lang="java"><span class="cm">   * @return The node context, same as getRoot().</span></span>
<span id="LC845" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC846" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nf">getContext</span><span class="o">()</span></span>
<span id="LC847" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC848" class="line" lang="java">    <span class="k">return</span> <span class="n">m_context</span><span class="o">;</span></span>
...
<span id="LC852" class="line" lang="java"><span class="cm">   * The node context from where the expression is being</span></span>
<span id="LC853" class="line" lang="java"><span class="cm">   * executed from (i.e. for current() support).</span></span>
<span id="LC854" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC855" class="line" lang="java"><span class="cm">   * @return The top-level node context of the entire expression.</span></span>
<span id="LC856" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC857" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nf">getCurrentContextNode</span><span class="o">()</span></span>
<span id="LC858" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC859" class="line" lang="java">    <span class="k">return</span> <span class="n">m_currentContextNode</span><span class="o">;</span></span>
...
<span id="LC863" class="line" lang="java"><span class="cm">   * Set the current context node for this iterator.</span></span>
<span id="LC864" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC865" class="line" lang="java"><span class="cm">   * @param n Must be a non-null reference to the node context.</span></span>
<span id="LC866" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC867" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">setCurrentContextNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">n</span><span class="o">)</span></span>
<span id="LC868" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC869" class="line" lang="java">    <span class="n">m_currentContextNode</span> <span class="o">=</span> <span class="n">n</span><span class="o">;</span></span>
...
<span id="LC873" class="line" lang="java"><span class="c1">//   * Set the current context node for this iterator.</span></span>
<span id="LC874" class="line" lang="java"><span class="c1">//   *</span></span>
<span id="LC875" class="line" lang="java"><span class="c1">//   * @param n Must be a non-null reference to the node context.</span></span>
<span id="LC876" class="line" lang="java"><span class="c1">//   */</span></span>
<span id="LC877" class="line" lang="java"><span class="c1">//  public void setRoot(int n)</span></span>
<span id="LC878" class="line" lang="java"><span class="c1">//  {</span></span>
<span id="LC879" class="line" lang="java"><span class="c1">//    m_context = n;</span></span>
<span id="LC880" class="line" lang="java"><span class="c1">//    m_cdtm = m_execContext.getDTM(n);</span></span>
...
<span id="LC884" class="line" lang="java"><span class="cm">   * Return the saved reference to the prefix resolver that</span></span>
<span id="LC885" class="line" lang="java"><span class="cm">   * was in effect when this iterator was created.</span></span>
<span id="LC886" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC887" class="line" lang="java"><span class="cm">   * @return The prefix resolver or this iterator, which may be null.</span></span>
<span id="LC888" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC889" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">PrefixResolver</span> <span class="nf">getPrefixResolver</span><span class="o">()</span></span>
<span id="LC890" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC891" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_prefixResolver</span><span class="o">)</span></span>
<span id="LC892" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC893" class="line" lang="java">        <span class="n">m_prefixResolver</span> <span class="o">=</span> <span class="o">(</span><span class="nc">PrefixResolver</span><span class="o">)</span><span class="n">getExpressionOwner</span><span class="o">();</span></span>
<span id="LC894" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC895" class="line" lang="java"></span>
<span id="LC896" class="line" lang="java">    <span class="k">return</span> <span class="n">m_prefixResolver</span><span class="o">;</span></span>
...
<span id="LC900" class="line" lang="java"><span class="c1">//   * Get the analysis pattern built by the WalkerFactory.</span></span>
<span id="LC901" class="line" lang="java"><span class="c1">//   *</span></span>
<span id="LC902" class="line" lang="java"><span class="c1">//   * @return The analysis pattern built by the WalkerFactory.</span></span>
<span id="LC903" class="line" lang="java"><span class="c1">//   */</span></span>
<span id="LC904" class="line" lang="java"><span class="c1">//  int getAnalysis()</span></span>
<span id="LC905" class="line" lang="java"><span class="c1">//  {</span></span>
<span id="LC906" class="line" lang="java"><span class="c1">//    return m_analysis;</span></span>
...
<span id="LC910" class="line" lang="java"><span class="c1">//   * Set the analysis pattern built by the WalkerFactory.</span></span>
<span id="LC911" class="line" lang="java"><span class="c1">//   *</span></span>
<span id="LC912" class="line" lang="java"><span class="c1">//   * @param a The analysis pattern built by the WalkerFactory.</span></span>
<span id="LC913" class="line" lang="java"><span class="c1">//   */</span></span>
<span id="LC914" class="line" lang="java"><span class="c1">//  void setAnalysis(int a)</span></span>
<span id="LC915" class="line" lang="java"><span class="c1">//  {</span></span>
<span id="LC916" class="line" lang="java"><span class="c1">//    m_analysis = a;</span></span>
<span id="LC917" class="line" lang="java"><span class="c1">//  }</span></span>
<span id="LC918" class="line" lang="java"></span>
<span id="LC919" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC920" class="line" lang="java"><span class="cm">   * @see com.sun.org.apache.xpath.internal.XPathVisitable#callVisitors(ExpressionOwner, XPathVisitor)</span></span>
<span id="LC921" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC922" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">callVisitors</span><span class="o">(</span><span class="nc">ExpressionOwner</span> <span class="n">owner</span><span class="o">,</span> <span class="nc">XPathVisitor</span> <span class="n">visitor</span><span class="o">)</span></span>
<span id="LC923" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC924" class="line" lang="java">                <span class="k">if</span><span class="o">(</span><span class="n">visitor</span><span class="o">.</span><span class="na">visitLocationPath</span><span class="o">(</span><span class="n">owner</span><span class="o">,</span> <span class="k">this</span><span class="o">))</span></span>
<span id="LC925" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC926" class="line" lang="java">                        <span class="n">visitor</span><span class="o">.</span><span class="na">visitStep</span><span class="o">(</span><span class="n">owner</span><span class="o">,</span> <span class="k">this</span><span class="o">);</span></span>
<span id="LC927" class="line" lang="java">                        <span class="n">callPredicateVisitors</span><span class="o">(</span><span class="n">visitor</span><span class="o">);</span></span>
...
<span id="LC932" class="line" lang="java">  <span class="c1">//============= State Data =============</span></span>
<span id="LC933" class="line" lang="java"></span>
<span id="LC934" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC935" class="line" lang="java"><span class="cm">   * The pool for cloned iterators.  Iterators need to be cloned</span></span>
<span id="LC936" class="line" lang="java"><span class="cm">   * because the hold running state, and thus the original iterator</span></span>
<span id="LC937" class="line" lang="java"><span class="cm">   * expression from the stylesheet pool can not be used.</span></span>
<span id="LC938" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC939" class="line" lang="java">  <span class="kd">transient</span> <span class="kd">protected</span> <span class="nc">IteratorPool</span> <span class="n">m_clones</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">IteratorPool</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC940" class="line" lang="java"></span>
<span id="LC941" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC942" class="line" lang="java"><span class="cm">   * The dtm of the context node.  Careful about using this... it may not</span></span>
<span id="LC943" class="line" lang="java"><span class="cm">   * be the dtm of the current node.</span></span>
<span id="LC944" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC945" class="line" lang="java">  <span class="kd">transient</span> <span class="kd">protected</span> <span class="no">DTM</span> <span class="n">m_cdtm</span><span class="o">;</span></span>
<span id="LC946" class="line" lang="java"></span>
<span id="LC947" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC948" class="line" lang="java"><span class="cm">   * The stack frame index for this iterator.</span></span>
<span id="LC949" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC950" class="line" lang="java">  <span class="kd">transient</span> <span class="kt">int</span> <span class="n">m_stackFrame</span> <span class="o">=</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC951" class="line" lang="java"></span>
<span id="LC952" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC953" class="line" lang="java"><span class="cm">   * Value determined at compile time, indicates that this is an</span></span>
<span id="LC954" class="line" lang="java"><span class="cm">   * iterator at the top level of the expression, rather than inside</span></span>
<span id="LC955" class="line" lang="java"><span class="cm">   * a predicate.</span></span>
<span id="LC956" class="line" lang="java"><span class="cm">   * @serial</span></span>
<span id="LC957" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC958" class="line" lang="java">  <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">m_isTopLevel</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC959" class="line" lang="java"></span>
<span id="LC960" class="line" lang="java">  <span class="cm">/** The last node that was fetched, usually by nextNode. */</span></span>
<span id="LC961" class="line" lang="java">  <span class="kd">transient</span> <span class="kd">public</span> <span class="kt">int</span> <span class="n">m_lastFetched</span> <span class="o">=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC962" class="line" lang="java"></span>
<span id="LC963" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC964" class="line" lang="java"><span class="cm">   * The context node for this iterator, which doesn't change through</span></span>
<span id="LC965" class="line" lang="java"><span class="cm">   * the course of the iteration.</span></span>
<span id="LC966" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC967" class="line" lang="java">  <span class="kd">transient</span> <span class="kd">protected</span> <span class="kt">int</span> <span class="n">m_context</span> <span class="o">=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC968" class="line" lang="java"></span>
<span id="LC969" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC970" class="line" lang="java"><span class="cm">   * The node context from where the expression is being</span></span>
<span id="LC971" class="line" lang="java"><span class="cm">   * executed from (i.e. for current() support).  Different</span></span>
<span id="LC972" class="line" lang="java"><span class="cm">   * from m_context in that this is the context for the entire</span></span>
<span id="LC973" class="line" lang="java"><span class="cm">   * expression, rather than the context for the subexpression.</span></span>
<span id="LC974" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC975" class="line" lang="java">  <span class="kd">transient</span> <span class="kd">protected</span> <span class="kt">int</span> <span class="n">m_currentContextNode</span> <span class="o">=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC976" class="line" lang="java"></span>
<span id="LC977" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC978" class="line" lang="java"><span class="cm">   * The current position of the context node.</span></span>
<span id="LC979" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC980" class="line" lang="java">  <span class="kd">transient</span> <span class="kd">protected</span> <span class="kt">int</span> <span class="n">m_pos</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC981" class="line" lang="java"></span>
<span id="LC982" class="line" lang="java">  <span class="kd">transient</span> <span class="kd">protected</span> <span class="kt">int</span> <span class="n">m_length</span> <span class="o">=</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC983" class="line" lang="java"></span>
<span id="LC984" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC985" class="line" lang="java"><span class="cm">   * Fast access to the current prefix resolver.  It isn't really</span></span>
<span id="LC986" class="line" lang="java"><span class="cm">   * clear that this is needed.</span></span>
<span id="LC987" class="line" lang="java"><span class="cm">   * @serial</span></span>
<span id="LC988" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC989" class="line" lang="java">  <span class="kd">private</span> <span class="nc">PrefixResolver</span> <span class="n">m_prefixResolver</span><span class="o">;</span></span>
<span id="LC990" class="line" lang="java"></span>
<span id="LC991" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC992" class="line" lang="java"><span class="cm">   * The XPathContext reference, needed for execution of many</span></span>
<span id="LC993" class="line" lang="java"><span class="cm">   * operations.</span></span>
<span id="LC994" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC995" class="line" lang="java">  <span class="kd">transient</span> <span class="kd">protected</span> <span class="nc">XPathContext</span> <span class="n">m_execContext</span><span class="o">;</span></span>
<span id="LC996" class="line" lang="java"></span>
<span id="LC997" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC998" class="line" lang="java"><span class="cm">   * Returns true if all the nodes in the iteration well be returned in document</span></span>
<span id="LC999" class="line" lang="java"><span class="cm">   * order.</span></span>
<span id="LC1000" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1001" class="line" lang="java"><span class="cm">   * @return true as a default.</span></span>
<span id="LC1002" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1003" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isDocOrdered</span><span class="o">()</span></span>
...
<span id="LC1009" class="line" lang="java"><span class="cm">   * Returns the axis being iterated, if it is known.</span></span>
<span id="LC1010" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1011" class="line" lang="java"><span class="cm">   * @return Axis.CHILD, etc., or -1 if the axis is not known or is of multiple</span></span>
<span id="LC1012" class="line" lang="java"><span class="cm">   * types.</span></span>
<span id="LC1013" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1014" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getAxis</span><span class="o">()</span></span>
...
<span id="LC1021" class="line" lang="java"><span class="c1">//   * The analysis pattern built by the WalkerFactory.</span></span>
<span id="LC1022" class="line" lang="java"><span class="c1">//   * TODO: Move to LocPathIterator.</span></span>
<span id="LC1023" class="line" lang="java"><span class="c1">//   * @see com.sun.org.apache.xpath.internal.axes.WalkerFactory</span></span>
<span id="LC1024" class="line" lang="java"><span class="c1">//   * @serial</span></span>
<span id="LC1025" class="line" lang="java"><span class="c1">//   */</span></span>
<span id="LC1026" class="line" lang="java"><span class="c1">//  protected int m_analysis = 0x00000000;</span></span>
<span id="LC1027" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC1028" class="line" lang="java"><span class="cm">   * @see PredicatedNodeTest#getLastPos(XPathContext)</span></span>
<span id="LC1029" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1030" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getLastPos</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">)</span></span>
<span id="LC1031" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1032" class="line" lang="java">    <span class="k">return</span> <span class="nf">getLength</span><span class="o">();</span></span>
