...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: StepPattern.java,v 1.2.4.2 2005/09/15 00:21:16 jeffsuttor Exp $</span></span>
<span id="LC22" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC23" class="line" lang="java"><span class="kn">package</span> <span class="nn">com.sun.org.apache.xpath.internal.patterns</span><span class="o">;</span></span>
<span id="LC24" class="line" lang="java"></span>
<span id="LC25" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.dtm.Axis</span><span class="o">;</span></span>
...
<span id="LC27" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.dtm.DTMAxisTraverser</span><span class="o">;</span></span>
...
<span id="LC30" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.ExpressionOwner</span><span class="o">;</span></span>
<span id="LC31" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.XPathContext</span><span class="o">;</span></span>
<span id="LC32" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.XPathVisitor</span><span class="o">;</span></span>
<span id="LC33" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.axes.SubContextList</span><span class="o">;</span></span>
<span id="LC34" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.compiler.PsuedoNames</span><span class="o">;</span></span>
<span id="LC35" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xpath.internal.objects.XObject</span><span class="o">;</span></span>
<span id="LC36" class="line" lang="java"></span>
<span id="LC37" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC38" class="line" lang="java"><span class="cm"> * This class represents a single pattern match step.</span></span>
<span id="LC39" class="line" lang="java"><span class="cm"> * @xsl.usage advanced</span></span>
<span id="LC40" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC41" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">StepPattern</span> <span class="kd">extends</span> <span class="nc">NodeTest</span> <span class="kd">implements</span> <span class="nc">SubContextList</span><span class="o">,</span> <span class="nc">ExpressionOwner</span></span>
<span id="LC42" class="line" lang="java"><span class="o">{</span></span>
<span id="LC43" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="mi">9071668960168152644L</span><span class="o">;</span></span>
<span id="LC44" class="line" lang="java"></span>
<span id="LC45" class="line" lang="java">  <span class="cm">/** The axis for this test. */</span></span>
<span id="LC46" class="line" lang="java">  <span class="kd">protected</span> <span class="kt">int</span> <span class="n">m_axis</span><span class="o">;</span></span>
<span id="LC47" class="line" lang="java"></span>
<span id="LC48" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC49" class="line" lang="java"><span class="cm">   * Construct a StepPattern that tests for namespaces and node names.</span></span>
<span id="LC50" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC51" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC52" class="line" lang="java"><span class="cm">   * @param whatToShow Bit set defined mainly by {@link org.w3c.dom.traversal.NodeFilter}.</span></span>
<span id="LC53" class="line" lang="java"><span class="cm">   * @param namespace The namespace to be tested.</span></span>
<span id="LC54" class="line" lang="java"><span class="cm">   * @param name The local name to be tested.</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">   * @param axis The Axis for this test, one of of Axes.ANCESTORORSELF, etc.</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">   * @param axisForPredicate No longer used.</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC58" class="line" lang="java">  <span class="kd">public</span> <span class="nf">StepPattern</span><span class="o">(</span><span class="kt">int</span> <span class="n">whatToShow</span><span class="o">,</span> <span class="nc">String</span> <span class="n">namespace</span><span class="o">,</span> <span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="kt">int</span> <span class="n">axis</span><span class="o">,</span></span>
<span id="LC59" class="line" lang="java">                     <span class="kt">int</span> <span class="n">axisForPredicate</span><span class="o">)</span></span>
<span id="LC60" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC61" class="line" lang="java"></span>
<span id="LC62" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">whatToShow</span><span class="o">,</span> <span class="n">namespace</span><span class="o">,</span> <span class="n">name</span><span class="o">);</span></span>
<span id="LC63" class="line" lang="java"></span>
<span id="LC64" class="line" lang="java">    <span class="n">m_axis</span> <span class="o">=</span> <span class="n">axis</span><span class="o">;</span></span>
...
<span id="LC68" class="line" lang="java"><span class="cm">   * Construct a StepPattern that doesn't test for node names.</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC71" class="line" lang="java"><span class="cm">   * @param whatToShow Bit set defined mainly by {@link org.w3c.dom.traversal.NodeFilter}.</span></span>
<span id="LC72" class="line" lang="java"><span class="cm">   * @param axis The Axis for this test, one of of Axes.ANCESTORORSELF, etc.</span></span>
<span id="LC73" class="line" lang="java"><span class="cm">   * @param axisForPredicate No longer used.</span></span>
<span id="LC74" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC75" class="line" lang="java">  <span class="kd">public</span> <span class="nf">StepPattern</span><span class="o">(</span><span class="kt">int</span> <span class="n">whatToShow</span><span class="o">,</span> <span class="kt">int</span> <span class="n">axis</span><span class="o">,</span> <span class="kt">int</span> <span class="n">axisForPredicate</span><span class="o">)</span></span>
<span id="LC76" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC77" class="line" lang="java"></span>
<span id="LC78" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">whatToShow</span><span class="o">);</span></span>
<span id="LC79" class="line" lang="java"></span>
<span id="LC80" class="line" lang="java">    <span class="n">m_axis</span> <span class="o">=</span> <span class="n">axis</span><span class="o">;</span></span>
...
<span id="LC84" class="line" lang="java"><span class="cm">   * The target local name or psuedo name, for hash table lookup optimization.</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">   *  @serial</span></span>
<span id="LC86" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC87" class="line" lang="java">  <span class="nc">String</span> <span class="n">m_targetString</span><span class="o">;</span>  <span class="c1">// only calculate on head</span></span>
<span id="LC88" class="line" lang="java"></span>
<span id="LC89" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">   * Calculate the local name or psuedo name of the node that this pattern will test,</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">   * for hash table lookup optimization.</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">   * @see com.sun.org.apache.xpath.internal.compiler.PsuedoNames</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC95" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">calcTargetString</span><span class="o">()</span></span>
<span id="LC96" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC97" class="line" lang="java"></span>
<span id="LC98" class="line" lang="java">    <span class="kt">int</span> <span class="n">whatToShow</span> <span class="o">=</span> <span class="n">getWhatToShow</span><span class="o">();</span></span>
<span id="LC99" class="line" lang="java"></span>
<span id="LC100" class="line" lang="java">    <span class="k">switch</span> <span class="o">(</span><span class="n">whatToShow</span><span class="o">)</span></span>
<span id="LC101" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC102" class="line" lang="java">    <span class="k">case</span> <span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_COMMENT</span> <span class="o">:</span></span>
<span id="LC103" class="line" lang="java">      <span class="n">m_targetString</span> <span class="o">=</span> <span class="nc">PsuedoNames</span><span class="o">.</span><span class="na">PSEUDONAME_COMMENT</span><span class="o">;</span></span>
<span id="LC104" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC105" class="line" lang="java">    <span class="k">case</span> <span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_TEXT</span> <span class="o">:</span></span>
<span id="LC106" class="line" lang="java">    <span class="k">case</span> <span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_CDATA_SECTION</span> <span class="o">:</span></span>
<span id="LC107" class="line" lang="java">    <span class="k">case</span> <span class="o">(</span><span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_TEXT</span> <span class="o">|</span> <span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_CDATA_SECTION</span><span class="o">)</span> <span class="o">:</span></span>
<span id="LC108" class="line" lang="java">      <span class="n">m_targetString</span> <span class="o">=</span> <span class="nc">PsuedoNames</span><span class="o">.</span><span class="na">PSEUDONAME_TEXT</span><span class="o">;</span></span>
<span id="LC109" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC110" class="line" lang="java">    <span class="k">case</span> <span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_ALL</span> <span class="o">:</span></span>
<span id="LC111" class="line" lang="java">      <span class="n">m_targetString</span> <span class="o">=</span> <span class="nc">PsuedoNames</span><span class="o">.</span><span class="na">PSEUDONAME_ANY</span><span class="o">;</span></span>
<span id="LC112" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC113" class="line" lang="java">    <span class="k">case</span> <span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_DOCUMENT</span> <span class="o">:</span></span>
<span id="LC114" class="line" lang="java">    <span class="k">case</span> <span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_DOCUMENT</span> <span class="o">|</span> <span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_DOCUMENT_FRAGMENT</span> <span class="o">:</span></span>
<span id="LC115" class="line" lang="java">      <span class="n">m_targetString</span> <span class="o">=</span> <span class="nc">PsuedoNames</span><span class="o">.</span><span class="na">PSEUDONAME_ROOT</span><span class="o">;</span></span>
<span id="LC116" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC117" class="line" lang="java">    <span class="k">case</span> <span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_ELEMENT</span> <span class="o">:</span></span>
<span id="LC118" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="k">this</span><span class="o">.</span><span class="na">WILD</span> <span class="o">==</span> <span class="n">m_name</span><span class="o">)</span></span>
<span id="LC119" class="line" lang="java">        <span class="n">m_targetString</span> <span class="o">=</span> <span class="nc">PsuedoNames</span><span class="o">.</span><span class="na">PSEUDONAME_ANY</span><span class="o">;</span></span>
<span id="LC120" class="line" lang="java">      <span class="k">else</span></span>
<span id="LC121" class="line" lang="java">        <span class="n">m_targetString</span> <span class="o">=</span> <span class="n">m_name</span><span class="o">;</span></span>
<span id="LC122" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC123" class="line" lang="java">    <span class="k">default</span> <span class="o">:</span></span>
<span id="LC124" class="line" lang="java">      <span class="n">m_targetString</span> <span class="o">=</span> <span class="nc">PsuedoNames</span><span class="o">.</span><span class="na">PSEUDONAME_ANY</span><span class="o">;</span></span>
...
<span id="LC130" class="line" lang="java"><span class="cm">   * Get the local name or psuedo name of the node that this pattern will test,</span></span>
<span id="LC131" class="line" lang="java"><span class="cm">   * for hash table lookup optimization.</span></span>
<span id="LC132" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC133" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC134" class="line" lang="java"><span class="cm">   * @return local name or psuedo name of the node.</span></span>
<span id="LC135" class="line" lang="java"><span class="cm">   * @see com.sun.org.apache.xpath.internal.compiler.PsuedoNames</span></span>
<span id="LC136" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC137" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getTargetString</span><span class="o">()</span></span>
<span id="LC138" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC139" class="line" lang="java">    <span class="k">return</span> <span class="n">m_targetString</span><span class="o">;</span></span>
...
<span id="LC143" class="line" lang="java"><span class="cm">   * Reference to nodetest and predicate for</span></span>
<span id="LC144" class="line" lang="java"><span class="cm">   * parent or ancestor.</span></span>
...
<span id="LC147" class="line" lang="java">  <span class="nc">StepPattern</span> <span class="n">m_relativePathPattern</span><span class="o">;</span></span>
<span id="LC148" class="line" lang="java"></span>
<span id="LC149" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC150" class="line" lang="java"><span class="cm">   * This function is used to fixup variables from QNames to stack frame</span></span>
<span id="LC151" class="line" lang="java"><span class="cm">   * indexes at stylesheet build time.</span></span>
<span id="LC152" class="line" lang="java"><span class="cm">   * @param vars List of QNames that correspond to variables.  This list</span></span>
<span id="LC153" class="line" lang="java"><span class="cm">   * should be searched backwards for the first qualified name that</span></span>
<span id="LC154" class="line" lang="java"><span class="cm">   * corresponds to the variable reference qname.  The position of the</span></span>
<span id="LC155" class="line" lang="java"><span class="cm">   * QName in the vector from the start of the vector will be its position</span></span>
<span id="LC156" class="line" lang="java"><span class="cm">   * in the stack frame (but variables above the globalsTop value will need</span></span>
<span id="LC157" class="line" lang="java"><span class="cm">   * to be offset to the current stack frame).</span></span>
<span id="LC158" class="line" lang="java"><span class="cm">   * @param globalsSize The number of variables in the global variable area.</span></span>
<span id="LC159" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC160" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">fixupVariables</span><span class="o">(</span><span class="n">java</span><span class="o">.</span><span class="na">util</span><span class="o">.</span><span class="na">Vector</span> <span class="n">vars</span><span class="o">,</span> <span class="kt">int</span> <span class="n">globalsSize</span><span class="o">)</span></span>
<span id="LC161" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC162" class="line" lang="java"></span>
<span id="LC163" class="line" lang="java">    <span class="kd">super</span><span class="o">.</span><span class="na">fixupVariables</span><span class="o">(</span><span class="n">vars</span><span class="o">,</span> <span class="n">globalsSize</span><span class="o">);</span></span>
<span id="LC164" class="line" lang="java"></span>
<span id="LC165" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_predicates</span><span class="o">)</span></span>
<span id="LC166" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC167" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">m_predicates</span><span class="o">.</span><span class="na">length</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC168" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC169" class="line" lang="java">        <span class="n">m_predicates</span><span class="o">[</span><span class="n">i</span><span class="o">].</span><span class="na">fixupVariables</span><span class="o">(</span><span class="n">vars</span><span class="o">,</span> <span class="n">globalsSize</span><span class="o">);</span></span>
...
<span id="LC173" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_relativePathPattern</span><span class="o">)</span></span>
<span id="LC174" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC175" class="line" lang="java">      <span class="n">m_relativePathPattern</span><span class="o">.</span><span class="na">fixupVariables</span><span class="o">(</span><span class="n">vars</span><span class="o">,</span> <span class="n">globalsSize</span><span class="o">);</span></span>
...
<span id="LC180" class="line" lang="java"><span class="cm">   * Set the reference to nodetest and predicate for</span></span>
<span id="LC181" class="line" lang="java"><span class="cm">   * parent or ancestor.</span></span>
<span id="LC182" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC183" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC184" class="line" lang="java"><span class="cm">   * @param expr The relative pattern expression.</span></span>
<span id="LC185" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC186" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setRelativePathPattern</span><span class="o">(</span><span class="nc">StepPattern</span> <span class="n">expr</span><span class="o">)</span></span>
<span id="LC187" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC188" class="line" lang="java"></span>
<span id="LC189" class="line" lang="java">    <span class="n">m_relativePathPattern</span> <span class="o">=</span> <span class="n">expr</span><span class="o">;</span></span>
<span id="LC190" class="line" lang="java">    <span class="n">expr</span><span class="o">.</span><span class="na">exprSetParent</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC191" class="line" lang="java"></span>
<span id="LC192" class="line" lang="java">    <span class="n">calcScore</span><span class="o">();</span></span>
...
<span id="LC196" class="line" lang="java"><span class="cm">   * Get the reference to nodetest and predicate for</span></span>
<span id="LC197" class="line" lang="java"><span class="cm">   * parent or ancestor.</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC199" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC200" class="line" lang="java"><span class="cm">   * @return The relative pattern expression.</span></span>
<span id="LC201" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC202" class="line" lang="java">  <span class="kd">public</span> <span class="nc">StepPattern</span> <span class="nf">getRelativePathPattern</span><span class="o">()</span></span>
<span id="LC203" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC204" class="line" lang="java">    <span class="k">return</span> <span class="n">m_relativePathPattern</span><span class="o">;</span></span>
...
<span id="LC208" class="line" lang="java">  <span class="c1">//   * Set the list of predicate expressions for this pattern step.</span></span>
<span id="LC209" class="line" lang="java">  <span class="c1">//   * @param predicates List of expression objects.</span></span>
<span id="LC210" class="line" lang="java">  <span class="c1">//   */</span></span>
<span id="LC211" class="line" lang="java">  <span class="c1">//  public void setPredicates(Expression[] predicates)</span></span>
<span id="LC212" class="line" lang="java">  <span class="c1">//  {</span></span>
<span id="LC213" class="line" lang="java">  <span class="c1">//    m_predicates = predicates;</span></span>
...
<span id="LC217" class="line" lang="java"><span class="cm">   * Set the list of predicate expressions for this pattern step.</span></span>
<span id="LC218" class="line" lang="java"><span class="cm">   * @return List of expression objects.</span></span>
<span id="LC219" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC220" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Expression</span><span class="o">[]</span> <span class="nf">getPredicates</span><span class="o">()</span></span>
<span id="LC221" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC222" class="line" lang="java">    <span class="k">return</span> <span class="n">m_predicates</span><span class="o">;</span></span>
...
<span id="LC226" class="line" lang="java"><span class="cm">   * The list of predicate expressions for this pattern step.</span></span>
...
<span id="LC229" class="line" lang="java">  <span class="nc">Expression</span><span class="o">[]</span> <span class="n">m_predicates</span><span class="o">;</span></span>
<span id="LC230" class="line" lang="java"></span>
<span id="LC231" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC232" class="line" lang="java"><span class="cm">   * Tell if this expression or it's subexpressions can traverse outside</span></span>
<span id="LC233" class="line" lang="java"><span class="cm">   * the current subtree.</span></span>
<span id="LC234" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC235" class="line" lang="java"><span class="cm">   * NOTE: Ancestors tests with predicates are problematic, and will require</span></span>
<span id="LC236" class="line" lang="java"><span class="cm">   * special treatment.</span></span>
<span id="LC237" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC238" class="line" lang="java"><span class="cm">   * @return true if traversal outside the context node's subtree can occur.</span></span>
<span id="LC239" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC240" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">canTraverseOutsideSubtree</span><span class="o">()</span></span>
<span id="LC241" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC242" class="line" lang="java"></span>
<span id="LC243" class="line" lang="java">    <span class="kt">int</span> <span class="n">n</span> <span class="o">=</span> <span class="n">getPredicateCount</span><span class="o">();</span></span>
<span id="LC244" class="line" lang="java"></span>
<span id="LC245" class="line" lang="java">    <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">n</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC246" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC247" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">getPredicate</span><span class="o">(</span><span class="n">i</span><span class="o">).</span><span class="na">canTraverseOutsideSubtree</span><span class="o">())</span></span>
<span id="LC248" class="line" lang="java">        <span class="k">return</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC255" class="line" lang="java"><span class="cm">   * Get a predicate expression.</span></span>
<span id="LC256" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC257" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC258" class="line" lang="java"><span class="cm">   * @param i The index of the predicate.</span></span>
<span id="LC259" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC260" class="line" lang="java"><span class="cm">   * @return A predicate expression.</span></span>
<span id="LC261" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC262" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Expression</span> <span class="nf">getPredicate</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">)</span></span>
<span id="LC263" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC264" class="line" lang="java">    <span class="k">return</span> <span class="n">m_predicates</span><span class="o">[</span><span class="n">i</span><span class="o">];</span></span>
...
<span id="LC268" class="line" lang="java"><span class="cm">   * Get the number of predicates for this match pattern step.</span></span>
<span id="LC269" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC270" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC271" class="line" lang="java"><span class="cm">   * @return the number of predicates for this match pattern step.</span></span>
<span id="LC272" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC273" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nf">getPredicateCount</span><span class="o">()</span></span>
<span id="LC274" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC275" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_predicates</span><span class="o">)</span> <span class="o">?</span> <span class="mi">0</span> <span class="o">:</span> <span class="n">m_predicates</span><span class="o">.</span><span class="na">length</span><span class="o">;</span></span>
...
<span id="LC279" class="line" lang="java"><span class="cm">   * Set the predicates for this match pattern step.</span></span>
<span id="LC280" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC281" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC282" class="line" lang="java"><span class="cm">   * @param predicates An array of expressions that define predicates</span></span>
<span id="LC283" class="line" lang="java"><span class="cm">   *                   for this step.</span></span>
<span id="LC284" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC285" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPredicates</span><span class="o">(</span><span class="nc">Expression</span><span class="o">[]</span> <span class="n">predicates</span><span class="o">)</span></span>
<span id="LC286" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC287" class="line" lang="java"></span>
<span id="LC288" class="line" lang="java">    <span class="n">m_predicates</span> <span class="o">=</span> <span class="n">predicates</span><span class="o">;</span></span>
<span id="LC289" class="line" lang="java">    <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">predicates</span><span class="o">)</span></span>
<span id="LC290" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC291" class="line" lang="java">        <span class="k">for</span><span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">predicates</span><span class="o">.</span><span class="na">length</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC292" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC293" class="line" lang="java">                <span class="n">predicates</span><span class="o">[</span><span class="n">i</span><span class="o">].</span><span class="na">exprSetParent</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
...
<span id="LC297" class="line" lang="java">    <span class="n">calcScore</span><span class="o">();</span></span>
...
<span id="LC301" class="line" lang="java"><span class="cm">   * Static calc of match score.</span></span>
<span id="LC302" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC303" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">calcScore</span><span class="o">()</span></span>
<span id="LC304" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC305" class="line" lang="java"></span>
<span id="LC306" class="line" lang="java">    <span class="k">if</span> <span class="o">((</span><span class="n">getPredicateCount</span><span class="o">()</span> <span class="o">&gt;</span> <span class="mi">0</span><span class="o">)</span> <span class="o">||</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_relativePathPattern</span><span class="o">))</span></span>
<span id="LC307" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC308" class="line" lang="java">      <span class="n">m_score</span> <span class="o">=</span> <span class="no">SCORE_OTHER</span><span class="o">;</span></span>
<span id="LC309" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC310" class="line" lang="java">    <span class="k">else</span></span>
<span id="LC311" class="line" lang="java">      <span class="kd">super</span><span class="o">.</span><span class="na">calcScore</span><span class="o">();</span></span>
<span id="LC312" class="line" lang="java"></span>
<span id="LC313" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_targetString</span><span class="o">)</span></span>
<span id="LC314" class="line" lang="java">      <span class="n">calcTargetString</span><span class="o">();</span></span>
...
<span id="LC318" class="line" lang="java"><span class="cm">   * Execute this pattern step, including predicates.</span></span>
<span id="LC319" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC320" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC321" class="line" lang="java"><span class="cm">   * @param xctxt XPath runtime context.</span></span>
<span id="LC322" class="line" lang="java"><span class="cm">   * @param currentNode The current node context.</span></span>
<span id="LC323" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC324" class="line" lang="java"><span class="cm">   * @return {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_NODETEST},</span></span>
<span id="LC325" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_NONE},</span></span>
<span id="LC326" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_NSWILD},</span></span>
<span id="LC327" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_QNAME}, or</span></span>
<span id="LC328" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_OTHER}.</span></span>
<span id="LC329" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC330" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC331" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC332" class="line" lang="java">  <span class="kd">public</span> <span class="nc">XObject</span> <span class="nf">execute</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">,</span> <span class="kt">int</span> <span class="n">currentNode</span><span class="o">)</span></span>
<span id="LC333" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC334" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC335" class="line" lang="java"></span>
<span id="LC336" class="line" lang="java">    <span class="no">DTM</span> <span class="n">dtm</span> <span class="o">=</span> <span class="n">xctxt</span><span class="o">.</span><span class="na">getDTM</span><span class="o">(</span><span class="n">currentNode</span><span class="o">);</span></span>
<span id="LC337" class="line" lang="java"></span>
<span id="LC338" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">dtm</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC339" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC340" class="line" lang="java">      <span class="kt">int</span> <span class="n">expType</span> <span class="o">=</span> <span class="n">dtm</span><span class="o">.</span><span class="na">getExpandedTypeID</span><span class="o">(</span><span class="n">currentNode</span><span class="o">);</span></span>
<span id="LC341" class="line" lang="java"></span>
<span id="LC342" class="line" lang="java">      <span class="k">return</span> <span class="nf">execute</span><span class="o">(</span><span class="n">xctxt</span><span class="o">,</span> <span class="n">currentNode</span><span class="o">,</span> <span class="n">dtm</span><span class="o">,</span> <span class="n">expType</span><span class="o">);</span></span>
<span id="LC343" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC344" class="line" lang="java"></span>
<span id="LC345" class="line" lang="java">    <span class="k">return</span> <span class="nc">NodeTest</span><span class="o">.</span><span class="na">SCORE_NONE</span><span class="o">;</span></span>
...
<span id="LC349" class="line" lang="java"><span class="cm">   * Execute this pattern step, including predicates.</span></span>
<span id="LC350" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC351" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC352" class="line" lang="java"><span class="cm">   * @param xctxt XPath runtime context.</span></span>
<span id="LC353" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC354" class="line" lang="java"><span class="cm">   * @return {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_NODETEST},</span></span>
<span id="LC355" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_NONE},</span></span>
<span id="LC356" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_NSWILD},</span></span>
<span id="LC357" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_QNAME}, or</span></span>
<span id="LC358" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_OTHER}.</span></span>
<span id="LC359" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC360" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC361" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC362" class="line" lang="java">  <span class="kd">public</span> <span class="nc">XObject</span> <span class="nf">execute</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">)</span></span>
<span id="LC363" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC364" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC365" class="line" lang="java">    <span class="k">return</span> <span class="nf">execute</span><span class="o">(</span><span class="n">xctxt</span><span class="o">,</span> <span class="n">xctxt</span><span class="o">.</span><span class="na">getCurrentNode</span><span class="o">());</span></span>
...
<span id="LC369" class="line" lang="java"><span class="cm">   * Execute an expression in the XPath runtime context, and return the</span></span>
<span id="LC370" class="line" lang="java"><span class="cm">   * result of the expression.</span></span>
<span id="LC371" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC372" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC373" class="line" lang="java"><span class="cm">   * @param xctxt The XPath runtime context.</span></span>
<span id="LC374" class="line" lang="java"><span class="cm">   * @param currentNode The currentNode.</span></span>
<span id="LC375" class="line" lang="java"><span class="cm">   * @param dtm The DTM of the current node.</span></span>
<span id="LC376" class="line" lang="java"><span class="cm">   * @param expType The expanded type ID of the current node.</span></span>
<span id="LC377" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC378" class="line" lang="java"><span class="cm">   * @return The result of the expression in the form of a &lt;code&gt;XObject&lt;/code&gt;.</span></span>
<span id="LC379" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC380" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException if a runtime exception</span></span>
<span id="LC381" class="line" lang="java"><span class="cm">   *         occurs.</span></span>
<span id="LC382" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC383" class="line" lang="java">  <span class="kd">public</span> <span class="nc">XObject</span> <span class="nf">execute</span><span class="o">(</span></span>
<span id="LC384" class="line" lang="java">          <span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">,</span> <span class="kt">int</span> <span class="n">currentNode</span><span class="o">,</span> <span class="no">DTM</span> <span class="n">dtm</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expType</span><span class="o">)</span></span>
<span id="LC385" class="line" lang="java">            <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC386" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC387" class="line" lang="java"></span>
<span id="LC388" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">m_whatToShow</span> <span class="o">==</span> <span class="nc">NodeTest</span><span class="o">.</span><span class="na">SHOW_BYFUNCTION</span><span class="o">)</span></span>
<span id="LC389" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC390" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_relativePathPattern</span><span class="o">)</span></span>
<span id="LC391" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC392" class="line" lang="java">        <span class="k">return</span> <span class="n">m_relativePathPattern</span><span class="o">.</span><span class="na">execute</span><span class="o">(</span><span class="n">xctxt</span><span class="o">);</span></span>
<span id="LC393" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC394" class="line" lang="java">      <span class="k">else</span></span>
<span id="LC395" class="line" lang="java">        <span class="k">return</span> <span class="nc">NodeTest</span><span class="o">.</span><span class="na">SCORE_NONE</span><span class="o">;</span></span>
<span id="LC396" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC397" class="line" lang="java"></span>
<span id="LC398" class="line" lang="java">    <span class="nc">XObject</span> <span class="n">score</span><span class="o">;</span></span>
<span id="LC399" class="line" lang="java"></span>
<span id="LC400" class="line" lang="java">    <span class="n">score</span> <span class="o">=</span> <span class="kd">super</span><span class="o">.</span><span class="na">execute</span><span class="o">(</span><span class="n">xctxt</span><span class="o">,</span> <span class="n">currentNode</span><span class="o">,</span> <span class="n">dtm</span><span class="o">,</span> <span class="n">expType</span><span class="o">);</span></span>
<span id="LC401" class="line" lang="java"></span>
<span id="LC402" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">score</span> <span class="o">==</span> <span class="nc">NodeTest</span><span class="o">.</span><span class="na">SCORE_NONE</span><span class="o">)</span></span>
<span id="LC403" class="line" lang="java">      <span class="k">return</span> <span class="nc">NodeTest</span><span class="o">.</span><span class="na">SCORE_NONE</span><span class="o">;</span></span>
<span id="LC404" class="line" lang="java"></span>
<span id="LC405" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="n">getPredicateCount</span><span class="o">()</span> <span class="o">!=</span> <span class="mi">0</span><span class="o">)</span></span>
<span id="LC406" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC407" class="line" lang="java">      <span class="k">if</span> <span class="o">(!</span><span class="n">executePredicates</span><span class="o">(</span><span class="n">xctxt</span><span class="o">,</span> <span class="n">dtm</span><span class="o">,</span> <span class="n">currentNode</span><span class="o">))</span></span>
<span id="LC408" class="line" lang="java">        <span class="k">return</span> <span class="nc">NodeTest</span><span class="o">.</span><span class="na">SCORE_NONE</span><span class="o">;</span></span>
<span id="LC409" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC410" class="line" lang="java"></span>
<span id="LC411" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_relativePathPattern</span><span class="o">)</span></span>
<span id="LC412" class="line" lang="java">      <span class="k">return</span> <span class="n">m_relativePathPattern</span><span class="o">.</span><span class="na">executeRelativePathPattern</span><span class="o">(</span><span class="n">xctxt</span><span class="o">,</span> <span class="n">dtm</span><span class="o">,</span></span>
<span id="LC413" class="line" lang="java">              <span class="n">currentNode</span><span class="o">);</span></span>
<span id="LC414" class="line" lang="java"></span>
<span id="LC415" class="line" lang="java">    <span class="k">return</span> <span class="n">score</span><span class="o">;</span></span>
...
<span id="LC419" class="line" lang="java"><span class="cm">   * New Method to check whether the current node satisfies a position predicate</span></span>
<span id="LC420" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">   * @param xctxt The XPath runtime context.</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">   * @param predPos Which predicate we're evaluating of foo[1][2][3].</span></span>
<span id="LC423" class="line" lang="java"><span class="cm">   * @param dtm The DTM of the current node.</span></span>
<span id="LC424" class="line" lang="java"><span class="cm">   * @param context The currentNode.</span></span>
<span id="LC425" class="line" lang="java"><span class="cm">   * @param pos The position being requested, i.e. the value returned by</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">   *            m_predicates[predPos].execute(xctxt).</span></span>
<span id="LC427" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC428" class="line" lang="java"><span class="cm">   * @return true of the position of the context matches pos, false otherwise.</span></span>
<span id="LC429" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC430" class="line" lang="java">  <span class="kd">private</span> <span class="kd">final</span> <span class="kt">boolean</span> <span class="nf">checkProximityPosition</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">,</span></span>
<span id="LC431" class="line" lang="java">          <span class="kt">int</span> <span class="n">predPos</span><span class="o">,</span> <span class="no">DTM</span> <span class="n">dtm</span><span class="o">,</span> <span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">pos</span><span class="o">)</span></span>
<span id="LC432" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC433" class="line" lang="java"></span>
<span id="LC434" class="line" lang="java">    <span class="k">try</span></span>
<span id="LC435" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC436" class="line" lang="java">      <span class="nc">DTMAxisTraverser</span> <span class="n">traverser</span> <span class="o">=</span></span>
<span id="LC437" class="line" lang="java">        <span class="n">dtm</span><span class="o">.</span><span class="na">getAxisTraverser</span><span class="o">(</span><span class="nc">Axis</span><span class="o">.</span><span class="na">PRECEDINGSIBLING</span><span class="o">);</span></span>
<span id="LC438" class="line" lang="java"></span>
<span id="LC439" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">child</span> <span class="o">=</span> <span class="n">traverser</span><span class="o">.</span><span class="na">first</span><span class="o">(</span><span class="n">context</span><span class="o">);</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="n">child</span><span class="o">;</span></span>
<span id="LC440" class="line" lang="java">              <span class="n">child</span> <span class="o">=</span> <span class="n">traverser</span><span class="o">.</span><span class="na">next</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="n">child</span><span class="o">))</span></span>
<span id="LC441" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC442" class="line" lang="java">        <span class="k">try</span></span>
<span id="LC443" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC444" class="line" lang="java">          <span class="n">xctxt</span><span class="o">.</span><span class="na">pushCurrentNode</span><span class="o">(</span><span class="n">child</span><span class="o">);</span></span>
<span id="LC445" class="line" lang="java"></span>
<span id="LC446" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="nc">NodeTest</span><span class="o">.</span><span class="na">SCORE_NONE</span> <span class="o">!=</span> <span class="kd">super</span><span class="o">.</span><span class="na">execute</span><span class="o">(</span><span class="n">xctxt</span><span class="o">,</span> <span class="n">child</span><span class="o">))</span></span>
<span id="LC447" class="line" lang="java">          <span class="o">{</span></span>
<span id="LC448" class="line" lang="java">            <span class="kt">boolean</span> <span class="n">pass</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC449" class="line" lang="java"></span>
<span id="LC450" class="line" lang="java">            <span class="k">try</span></span>
<span id="LC451" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC452" class="line" lang="java">              <span class="n">xctxt</span><span class="o">.</span><span class="na">pushSubContextList</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC453" class="line" lang="java"></span>
<span id="LC454" class="line" lang="java">              <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">predPos</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC455" class="line" lang="java">              <span class="o">{</span></span>
<span id="LC456" class="line" lang="java">                <span class="n">xctxt</span><span class="o">.</span><span class="na">pushPredicatePos</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC457" class="line" lang="java">                <span class="k">try</span></span>
<span id="LC458" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC459" class="line" lang="java">                  <span class="nc">XObject</span> <span class="n">pred</span> <span class="o">=</span> <span class="n">m_predicates</span><span class="o">[</span><span class="n">i</span><span class="o">].</span><span class="na">execute</span><span class="o">(</span><span class="n">xctxt</span><span class="o">);</span></span>
...
<span id="LC463" class="line" lang="java">                    <span class="k">if</span> <span class="o">(</span><span class="nc">XObject</span><span class="o">.</span><span class="na">CLASS_NUMBER</span> <span class="o">==</span> <span class="n">pred</span><span class="o">.</span><span class="na">getType</span><span class="o">())</span></span>
<span id="LC464" class="line" lang="java">                    <span class="o">{</span></span>
<span id="LC465" class="line" lang="java">                      <span class="k">throw</span> <span class="k">new</span> <span class="nf">Error</span><span class="o">(</span><span class="s">"Why: Should never have been called"</span><span class="o">);</span></span>
<span id="LC466" class="line" lang="java">                    <span class="o">}</span></span>
<span id="LC467" class="line" lang="java">                    <span class="k">else</span> <span class="nf">if</span> <span class="o">(!</span><span class="n">pred</span><span class="o">.</span><span class="na">boolWithSideEffects</span><span class="o">())</span></span>
<span id="LC468" class="line" lang="java">                    <span class="o">{</span></span>
<span id="LC469" class="line" lang="java">                      <span class="n">pass</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC474" class="line" lang="java">                  <span class="k">finally</span></span>
<span id="LC475" class="line" lang="java">                  <span class="o">{</span></span>
<span id="LC476" class="line" lang="java">                    <span class="n">pred</span><span class="o">.</span><span class="na">detach</span><span class="o">();</span></span>
<span id="LC477" class="line" lang="java">                  <span class="o">}</span></span>
<span id="LC478" class="line" lang="java">                <span class="o">}</span></span>
<span id="LC479" class="line" lang="java">                <span class="k">finally</span></span>
<span id="LC480" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC481" class="line" lang="java">                  <span class="n">xctxt</span><span class="o">.</span><span class="na">popPredicatePos</span><span class="o">();</span></span>
...
<span id="LC485" class="line" lang="java">            <span class="k">finally</span></span>
<span id="LC486" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC487" class="line" lang="java">              <span class="n">xctxt</span><span class="o">.</span><span class="na">popSubContextList</span><span class="o">();</span></span>
<span id="LC488" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC489" class="line" lang="java"></span>
<span id="LC490" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">pass</span><span class="o">)</span></span>
<span id="LC491" class="line" lang="java">              <span class="n">pos</span><span class="o">--;</span></span>
<span id="LC492" class="line" lang="java"></span>
<span id="LC493" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">pos</span> <span class="o">&lt;</span> <span class="mi">1</span><span class="o">)</span></span>
...
<span id="LC497" class="line" lang="java">        <span class="k">finally</span></span>
<span id="LC498" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC499" class="line" lang="java">          <span class="n">xctxt</span><span class="o">.</span><span class="na">popCurrentNode</span><span class="o">();</span></span>
...
<span id="LC503" class="line" lang="java">    <span class="k">catch</span> <span class="o">(</span><span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span> <span class="n">se</span><span class="o">)</span></span>
<span id="LC504" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC505" class="line" lang="java"></span>
<span id="LC506" class="line" lang="java">      <span class="c1">// TODO: should keep throw sax exception...</span></span>
<span id="LC507" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="n">java</span><span class="o">.</span><span class="na">lang</span><span class="o">.</span><span class="na">RuntimeException</span><span class="o">(</span><span class="n">se</span><span class="o">.</span><span class="na">getMessage</span><span class="o">());</span></span>
<span id="LC508" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC509" class="line" lang="java"></span>
<span id="LC510" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">pos</span> <span class="o">==</span> <span class="mi">1</span><span class="o">);</span></span>
...
<span id="LC514" class="line" lang="java"><span class="cm">   * Get the proximity position index of the current node based on this</span></span>
<span id="LC515" class="line" lang="java"><span class="cm">   * node test.</span></span>
<span id="LC516" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC517" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC518" class="line" lang="java"><span class="cm">   * @param xctxt XPath runtime context.</span></span>
<span id="LC519" class="line" lang="java"><span class="cm">   * @param predPos Which predicate we're evaluating of foo[1][2][3].</span></span>
<span id="LC520" class="line" lang="java"><span class="cm">   * @param findLast If true, don't terminate when the context node is found.</span></span>
<span id="LC521" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC522" class="line" lang="java"><span class="cm">   * @return the proximity position index of the current node based on the</span></span>
<span id="LC523" class="line" lang="java"><span class="cm">   *         node test.</span></span>
<span id="LC524" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC525" class="line" lang="java">  <span class="kd">private</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nf">getProximityPosition</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">,</span> <span class="kt">int</span> <span class="n">predPos</span><span class="o">,</span></span>
<span id="LC526" class="line" lang="java">                    <span class="kt">boolean</span> <span class="n">findLast</span><span class="o">)</span></span>
<span id="LC527" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC528" class="line" lang="java"></span>
<span id="LC529" class="line" lang="java">    <span class="kt">int</span> <span class="n">pos</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC530" class="line" lang="java">    <span class="kt">int</span> <span class="n">context</span> <span class="o">=</span> <span class="n">xctxt</span><span class="o">.</span><span class="na">getCurrentNode</span><span class="o">();</span></span>
<span id="LC531" class="line" lang="java">    <span class="no">DTM</span> <span class="n">dtm</span> <span class="o">=</span> <span class="n">xctxt</span><span class="o">.</span><span class="na">getDTM</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC532" class="line" lang="java">    <span class="kt">int</span> <span class="n">parent</span> <span class="o">=</span> <span class="n">dtm</span><span class="o">.</span><span class="na">getParent</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC533" class="line" lang="java"></span>
<span id="LC534" class="line" lang="java">    <span class="k">try</span></span>
<span id="LC535" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC536" class="line" lang="java">      <span class="nc">DTMAxisTraverser</span> <span class="n">traverser</span> <span class="o">=</span> <span class="n">dtm</span><span class="o">.</span><span class="na">getAxisTraverser</span><span class="o">(</span><span class="nc">Axis</span><span class="o">.</span><span class="na">CHILD</span><span class="o">);</span></span>
<span id="LC537" class="line" lang="java"></span>
<span id="LC538" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">child</span> <span class="o">=</span> <span class="n">traverser</span><span class="o">.</span><span class="na">first</span><span class="o">(</span><span class="n">parent</span><span class="o">);</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="n">child</span><span class="o">;</span></span>
<span id="LC539" class="line" lang="java">              <span class="n">child</span> <span class="o">=</span> <span class="n">traverser</span><span class="o">.</span><span class="na">next</span><span class="o">(</span><span class="n">parent</span><span class="o">,</span> <span class="n">child</span><span class="o">))</span></span>
<span id="LC540" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC541" class="line" lang="java">        <span class="k">try</span></span>
<span id="LC542" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC543" class="line" lang="java">          <span class="n">xctxt</span><span class="o">.</span><span class="na">pushCurrentNode</span><span class="o">(</span><span class="n">child</span><span class="o">);</span></span>
<span id="LC544" class="line" lang="java"></span>
<span id="LC545" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="nc">NodeTest</span><span class="o">.</span><span class="na">SCORE_NONE</span> <span class="o">!=</span> <span class="kd">super</span><span class="o">.</span><span class="na">execute</span><span class="o">(</span><span class="n">xctxt</span><span class="o">,</span> <span class="n">child</span><span class="o">))</span></span>
<span id="LC546" class="line" lang="java">          <span class="o">{</span></span>
<span id="LC547" class="line" lang="java">            <span class="kt">boolean</span> <span class="n">pass</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC548" class="line" lang="java"></span>
<span id="LC549" class="line" lang="java">            <span class="k">try</span></span>
<span id="LC550" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC551" class="line" lang="java">              <span class="n">xctxt</span><span class="o">.</span><span class="na">pushSubContextList</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC552" class="line" lang="java"></span>
<span id="LC553" class="line" lang="java">              <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">predPos</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC554" class="line" lang="java">              <span class="o">{</span></span>
<span id="LC555" class="line" lang="java">                <span class="n">xctxt</span><span class="o">.</span><span class="na">pushPredicatePos</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC556" class="line" lang="java">                <span class="k">try</span></span>
<span id="LC557" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC558" class="line" lang="java">                  <span class="nc">XObject</span> <span class="n">pred</span> <span class="o">=</span> <span class="n">m_predicates</span><span class="o">[</span><span class="n">i</span><span class="o">].</span><span class="na">execute</span><span class="o">(</span><span class="n">xctxt</span><span class="o">);</span></span>
<span id="LC559" class="line" lang="java"></span>
<span id="LC560" class="line" lang="java">                  <span class="k">try</span></span>
<span id="LC561" class="line" lang="java">                  <span class="o">{</span></span>
<span id="LC562" class="line" lang="java">                    <span class="k">if</span> <span class="o">(</span><span class="nc">XObject</span><span class="o">.</span><span class="na">CLASS_NUMBER</span> <span class="o">==</span> <span class="n">pred</span><span class="o">.</span><span class="na">getType</span><span class="o">())</span></span>
<span id="LC563" class="line" lang="java">                    <span class="o">{</span></span>
<span id="LC564" class="line" lang="java">                      <span class="k">if</span> <span class="o">((</span><span class="n">pos</span> <span class="o">+</span> <span class="mi">1</span><span class="o">)</span> <span class="o">!=</span> <span class="o">(</span><span class="kt">int</span><span class="o">)</span> <span class="n">pred</span><span class="o">.</span><span class="na">numWithSideEffects</span><span class="o">())</span></span>
<span id="LC565" class="line" lang="java">                      <span class="o">{</span></span>
<span id="LC566" class="line" lang="java">                        <span class="n">pass</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC571" class="line" lang="java">                    <span class="k">else</span> <span class="nf">if</span> <span class="o">(!</span><span class="n">pred</span><span class="o">.</span><span class="na">boolWithSideEffects</span><span class="o">())</span></span>
<span id="LC572" class="line" lang="java">                    <span class="o">{</span></span>
<span id="LC573" class="line" lang="java">                      <span class="n">pass</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC574" class="line" lang="java"></span>
<span id="LC575" class="line" lang="java">                      <span class="k">break</span><span class="o">;</span></span>
<span id="LC576" class="line" lang="java">                    <span class="o">}</span></span>
<span id="LC577" class="line" lang="java">                  <span class="o">}</span></span>
<span id="LC578" class="line" lang="java">                  <span class="k">finally</span></span>
<span id="LC579" class="line" lang="java">                  <span class="o">{</span></span>
<span id="LC580" class="line" lang="java">                    <span class="n">pred</span><span class="o">.</span><span class="na">detach</span><span class="o">();</span></span>
<span id="LC581" class="line" lang="java">                  <span class="o">}</span></span>
<span id="LC582" class="line" lang="java">                <span class="o">}</span></span>
<span id="LC583" class="line" lang="java">                <span class="k">finally</span></span>
<span id="LC584" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC585" class="line" lang="java">                  <span class="n">xctxt</span><span class="o">.</span><span class="na">popPredicatePos</span><span class="o">();</span></span>
...
<span id="LC589" class="line" lang="java">            <span class="k">finally</span></span>
<span id="LC590" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC591" class="line" lang="java">              <span class="n">xctxt</span><span class="o">.</span><span class="na">popSubContextList</span><span class="o">();</span></span>
<span id="LC592" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC593" class="line" lang="java"></span>
<span id="LC594" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">pass</span><span class="o">)</span></span>
<span id="LC595" class="line" lang="java">              <span class="n">pos</span><span class="o">++;</span></span>
<span id="LC596" class="line" lang="java"></span>
<span id="LC597" class="line" lang="java">            <span class="k">if</span> <span class="o">(!</span><span class="n">findLast</span> <span class="o">&amp;&amp;</span> <span class="n">child</span> <span class="o">==</span> <span class="n">context</span><span class="o">)</span></span>
<span id="LC598" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC599" class="line" lang="java">              <span class="k">return</span> <span class="n">pos</span><span class="o">;</span></span>
...
<span id="LC603" class="line" lang="java">        <span class="k">finally</span></span>
<span id="LC604" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC605" class="line" lang="java">          <span class="n">xctxt</span><span class="o">.</span><span class="na">popCurrentNode</span><span class="o">();</span></span>
...
<span id="LC609" class="line" lang="java">    <span class="k">catch</span> <span class="o">(</span><span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span> <span class="n">se</span><span class="o">)</span></span>
<span id="LC610" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC611" class="line" lang="java"></span>
<span id="LC612" class="line" lang="java">      <span class="c1">// TODO: should keep throw sax exception...</span></span>
<span id="LC613" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="n">java</span><span class="o">.</span><span class="na">lang</span><span class="o">.</span><span class="na">RuntimeException</span><span class="o">(</span><span class="n">se</span><span class="o">.</span><span class="na">getMessage</span><span class="o">());</span></span>
<span id="LC614" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC615" class="line" lang="java"></span>
<span id="LC616" class="line" lang="java">    <span class="k">return</span> <span class="n">pos</span><span class="o">;</span></span>
...
<span id="LC620" class="line" lang="java"><span class="cm">   * Get the proximity position index of the current node based on this</span></span>
<span id="LC621" class="line" lang="java"><span class="cm">   * node test.</span></span>
<span id="LC622" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC623" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC624" class="line" lang="java"><span class="cm">   * @param xctxt XPath runtime context.</span></span>
<span id="LC625" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC626" class="line" lang="java"><span class="cm">   * @return the proximity position index of the current node based on the</span></span>
<span id="LC627" class="line" lang="java"><span class="cm">   *         node test.</span></span>
<span id="LC628" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC629" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getProximityPosition</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">)</span></span>
<span id="LC630" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC631" class="line" lang="java">    <span class="k">return</span> <span class="nf">getProximityPosition</span><span class="o">(</span><span class="n">xctxt</span><span class="o">,</span> <span class="n">xctxt</span><span class="o">.</span><span class="na">getPredicatePos</span><span class="o">(),</span> <span class="kc">false</span><span class="o">);</span></span>
...
<span id="LC635" class="line" lang="java"><span class="cm">   * Get the count of the nodes that match the test, which is the proximity</span></span>
<span id="LC636" class="line" lang="java"><span class="cm">   * position of the last node that can pass this test in the sub context</span></span>
<span id="LC637" class="line" lang="java"><span class="cm">   * selection.  In XSLT 1-based indexing, this count is the index of the last</span></span>
<span id="LC638" class="line" lang="java"><span class="cm">   * node.</span></span>
<span id="LC639" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC640" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC641" class="line" lang="java"><span class="cm">   * @param xctxt XPath runtime context.</span></span>
<span id="LC642" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC643" class="line" lang="java"><span class="cm">   * @return the count of the nodes that match the test.</span></span>
<span id="LC644" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC645" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getLastPos</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">)</span></span>
<span id="LC646" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC647" class="line" lang="java">    <span class="k">return</span> <span class="nf">getProximityPosition</span><span class="o">(</span><span class="n">xctxt</span><span class="o">,</span> <span class="n">xctxt</span><span class="o">.</span><span class="na">getPredicatePos</span><span class="o">(),</span> <span class="kc">true</span><span class="o">);</span></span>
...
<span id="LC651" class="line" lang="java"><span class="cm">   * Execute the match pattern step relative to another step.</span></span>
<span id="LC652" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC653" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC654" class="line" lang="java"><span class="cm">   * @param xctxt The XPath runtime context.</span></span>
<span id="LC655" class="line" lang="java"><span class="cm">   * @param dtm The DTM of the current node.</span></span>
<span id="LC656" class="line" lang="java"><span class="cm">   * @param currentNode The current node context.</span></span>
<span id="LC657" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC658" class="line" lang="java"><span class="cm">   * @return {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_NODETEST},</span></span>
<span id="LC659" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_NONE},</span></span>
<span id="LC660" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_NSWILD},</span></span>
<span id="LC661" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_QNAME}, or</span></span>
<span id="LC662" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_OTHER}.</span></span>
...
<span id="LC666" class="line" lang="java">  <span class="kd">protected</span> <span class="kd">final</span> <span class="nc">XObject</span> <span class="nf">executeRelativePathPattern</span><span class="o">(</span></span>
<span id="LC667" class="line" lang="java">          <span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">,</span> <span class="no">DTM</span> <span class="n">dtm</span><span class="o">,</span> <span class="kt">int</span> <span class="n">currentNode</span><span class="o">)</span></span>
...
<span id="LC671" class="line" lang="java">    <span class="nc">XObject</span> <span class="n">score</span> <span class="o">=</span> <span class="nc">NodeTest</span><span class="o">.</span><span class="na">SCORE_NONE</span><span class="o">;</span></span>
<span id="LC672" class="line" lang="java">    <span class="kt">int</span> <span class="n">context</span> <span class="o">=</span> <span class="n">currentNode</span><span class="o">;</span></span>
<span id="LC673" class="line" lang="java">    <span class="nc">DTMAxisTraverser</span> <span class="n">traverser</span><span class="o">;</span></span>
<span id="LC674" class="line" lang="java"></span>
<span id="LC675" class="line" lang="java">    <span class="n">traverser</span> <span class="o">=</span> <span class="n">dtm</span><span class="o">.</span><span class="na">getAxisTraverser</span><span class="o">(</span><span class="n">m_axis</span><span class="o">);</span></span>
<span id="LC676" class="line" lang="java"></span>
<span id="LC677" class="line" lang="java">    <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">relative</span> <span class="o">=</span> <span class="n">traverser</span><span class="o">.</span><span class="na">first</span><span class="o">(</span><span class="n">context</span><span class="o">);</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="n">relative</span><span class="o">;</span></span>
<span id="LC678" class="line" lang="java">            <span class="n">relative</span> <span class="o">=</span> <span class="n">traverser</span><span class="o">.</span><span class="na">next</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="n">relative</span><span class="o">))</span></span>
<span id="LC679" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC680" class="line" lang="java">      <span class="k">try</span></span>
<span id="LC681" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC682" class="line" lang="java">        <span class="n">xctxt</span><span class="o">.</span><span class="na">pushCurrentNode</span><span class="o">(</span><span class="n">relative</span><span class="o">);</span></span>
<span id="LC683" class="line" lang="java"></span>
<span id="LC684" class="line" lang="java">        <span class="n">score</span> <span class="o">=</span> <span class="n">execute</span><span class="o">(</span><span class="n">xctxt</span><span class="o">);</span></span>
<span id="LC685" class="line" lang="java"></span>
<span id="LC686" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">score</span> <span class="o">!=</span> <span class="nc">NodeTest</span><span class="o">.</span><span class="na">SCORE_NONE</span><span class="o">)</span></span>
...
<span id="LC689" class="line" lang="java">      <span class="k">finally</span></span>
<span id="LC690" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC691" class="line" lang="java">        <span class="n">xctxt</span><span class="o">.</span><span class="na">popCurrentNode</span><span class="o">();</span></span>
...
<span id="LC695" class="line" lang="java">    <span class="k">return</span> <span class="n">score</span><span class="o">;</span></span>
...
<span id="LC699" class="line" lang="java"><span class="cm">   * Execute the predicates on this step to determine if the current node</span></span>
<span id="LC700" class="line" lang="java"><span class="cm">   * should be filtered or accepted.</span></span>
<span id="LC701" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC702" class="line" lang="java"><span class="cm">   * @param xctxt The XPath runtime context.</span></span>
<span id="LC703" class="line" lang="java"><span class="cm">   * @param dtm The DTM of the current node.</span></span>
<span id="LC704" class="line" lang="java"><span class="cm">   * @param currentNode The current node context.</span></span>
<span id="LC705" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC706" class="line" lang="java"><span class="cm">   * @return true if the node should be accepted, false otherwise.</span></span>
<span id="LC707" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC708" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC709" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC710" class="line" lang="java">  <span class="kd">protected</span> <span class="kd">final</span> <span class="kt">boolean</span> <span class="nf">executePredicates</span><span class="o">(</span></span>
<span id="LC711" class="line" lang="java">          <span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">,</span> <span class="no">DTM</span> <span class="n">dtm</span><span class="o">,</span> <span class="kt">int</span> <span class="n">currentNode</span><span class="o">)</span></span>
<span id="LC712" class="line" lang="java">            <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC713" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC714" class="line" lang="java"></span>
<span id="LC715" class="line" lang="java">    <span class="kt">boolean</span> <span class="n">result</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC716" class="line" lang="java">    <span class="kt">boolean</span> <span class="n">positionAlreadySeen</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC717" class="line" lang="java">    <span class="kt">int</span> <span class="n">n</span> <span class="o">=</span> <span class="n">getPredicateCount</span><span class="o">();</span></span>
...
<span id="LC721" class="line" lang="java">      <span class="n">xctxt</span><span class="o">.</span><span class="na">pushSubContextList</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC722" class="line" lang="java"></span>
<span id="LC723" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">n</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC724" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC725" class="line" lang="java">        <span class="n">xctxt</span><span class="o">.</span><span class="na">pushPredicatePos</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC726" class="line" lang="java"></span>
<span id="LC727" class="line" lang="java">        <span class="k">try</span></span>
<span id="LC728" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC729" class="line" lang="java">          <span class="nc">XObject</span> <span class="n">pred</span> <span class="o">=</span> <span class="n">m_predicates</span><span class="o">[</span><span class="n">i</span><span class="o">].</span><span class="na">execute</span><span class="o">(</span><span class="n">xctxt</span><span class="o">);</span></span>
<span id="LC730" class="line" lang="java"></span>
<span id="LC731" class="line" lang="java">          <span class="k">try</span></span>
<span id="LC732" class="line" lang="java">          <span class="o">{</span></span>
<span id="LC733" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="nc">XObject</span><span class="o">.</span><span class="na">CLASS_NUMBER</span> <span class="o">==</span> <span class="n">pred</span><span class="o">.</span><span class="na">getType</span><span class="o">())</span></span>
<span id="LC734" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC735" class="line" lang="java">              <span class="kt">int</span> <span class="n">pos</span> <span class="o">=</span> <span class="o">(</span><span class="kt">int</span><span class="o">)</span> <span class="n">pred</span><span class="o">.</span><span class="na">num</span><span class="o">();</span></span>
<span id="LC736" class="line" lang="java"></span>
<span id="LC737" class="line" lang="java">              <span class="k">if</span> <span class="o">(</span><span class="n">positionAlreadySeen</span><span class="o">)</span></span>
<span id="LC738" class="line" lang="java">              <span class="o">{</span></span>
<span id="LC739" class="line" lang="java">                <span class="n">result</span> <span class="o">=</span> <span class="o">(</span><span class="n">pos</span> <span class="o">==</span> <span class="mi">1</span><span class="o">);</span></span>
...
<span id="LC745" class="line" lang="java">                <span class="n">positionAlreadySeen</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC746" class="line" lang="java"></span>
<span id="LC747" class="line" lang="java">                <span class="k">if</span> <span class="o">(!</span><span class="n">checkProximityPosition</span><span class="o">(</span><span class="n">xctxt</span><span class="o">,</span> <span class="n">i</span><span class="o">,</span> <span class="n">dtm</span><span class="o">,</span> <span class="n">currentNode</span><span class="o">,</span> <span class="n">pos</span><span class="o">))</span></span>
<span id="LC748" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC749" class="line" lang="java">                  <span class="n">result</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC756" class="line" lang="java">            <span class="k">else</span> <span class="nf">if</span> <span class="o">(!</span><span class="n">pred</span><span class="o">.</span><span class="na">boolWithSideEffects</span><span class="o">())</span></span>
<span id="LC757" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC758" class="line" lang="java">              <span class="n">result</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC763" class="line" lang="java">          <span class="k">finally</span></span>
<span id="LC764" class="line" lang="java">          <span class="o">{</span></span>
<span id="LC765" class="line" lang="java">            <span class="n">pred</span><span class="o">.</span><span class="na">detach</span><span class="o">();</span></span>
<span id="LC766" class="line" lang="java">          <span class="o">}</span></span>
<span id="LC767" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC768" class="line" lang="java">        <span class="k">finally</span></span>
<span id="LC769" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC770" class="line" lang="java">          <span class="n">xctxt</span><span class="o">.</span><span class="na">popPredicatePos</span><span class="o">();</span></span>
...
<span id="LC774" class="line" lang="java">    <span class="k">finally</span></span>
<span id="LC775" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC776" class="line" lang="java">      <span class="n">xctxt</span><span class="o">.</span><span class="na">popSubContextList</span><span class="o">();</span></span>
<span id="LC777" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC778" class="line" lang="java"></span>
<span id="LC779" class="line" lang="java">    <span class="k">return</span> <span class="n">result</span><span class="o">;</span></span>
...
<span id="LC783" class="line" lang="java"><span class="cm">   * Get the string represenentation of this step for diagnostic purposes.</span></span>
<span id="LC784" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC785" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC786" class="line" lang="java"><span class="cm">   * @return A string representation of this step, built by reverse-engineering</span></span>
<span id="LC787" class="line" lang="java"><span class="cm">   * the contained info.</span></span>
<span id="LC788" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC789" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">toString</span><span class="o">()</span></span>
<span id="LC790" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC791" class="line" lang="java"></span>
<span id="LC792" class="line" lang="java">    <span class="nc">StringBuffer</span> <span class="n">buf</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">StringBuffer</span><span class="o">();</span></span>
<span id="LC793" class="line" lang="java"></span>
<span id="LC794" class="line" lang="java">    <span class="k">for</span> <span class="o">(</span><span class="nc">StepPattern</span> <span class="n">pat</span> <span class="o">=</span> <span class="k">this</span><span class="o">;</span> <span class="n">pat</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">;</span> <span class="n">pat</span> <span class="o">=</span> <span class="n">pat</span><span class="o">.</span><span class="na">m_relativePathPattern</span><span class="o">)</span></span>
<span id="LC795" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC796" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">pat</span> <span class="o">!=</span> <span class="k">this</span><span class="o">)</span></span>
<span id="LC797" class="line" lang="java">        <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">"/"</span><span class="o">);</span></span>
<span id="LC798" class="line" lang="java"></span>
<span id="LC799" class="line" lang="java">      <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="nc">Axis</span><span class="o">.</span><span class="na">getNames</span><span class="o">(</span><span class="n">pat</span><span class="o">.</span><span class="na">m_axis</span><span class="o">));</span></span>
<span id="LC800" class="line" lang="java">      <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">"::"</span><span class="o">);</span></span>
<span id="LC801" class="line" lang="java"></span>
<span id="LC802" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="mh">0x000005000</span> <span class="o">==</span> <span class="n">pat</span><span class="o">.</span><span class="na">m_whatToShow</span><span class="o">)</span></span>
<span id="LC803" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC804" class="line" lang="java">        <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">"doc()"</span><span class="o">);</span></span>
<span id="LC805" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC806" class="line" lang="java">      <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_BYFUNCTION</span> <span class="o">==</span> <span class="n">pat</span><span class="o">.</span><span class="na">m_whatToShow</span><span class="o">)</span></span>
<span id="LC807" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC808" class="line" lang="java">        <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">"function()"</span><span class="o">);</span></span>
<span id="LC809" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC810" class="line" lang="java">      <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_ALL</span> <span class="o">==</span> <span class="n">pat</span><span class="o">.</span><span class="na">m_whatToShow</span><span class="o">)</span></span>
<span id="LC811" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC812" class="line" lang="java">        <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">"node()"</span><span class="o">);</span></span>
<span id="LC813" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC814" class="line" lang="java">      <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_TEXT</span> <span class="o">==</span> <span class="n">pat</span><span class="o">.</span><span class="na">m_whatToShow</span><span class="o">)</span></span>
<span id="LC815" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC816" class="line" lang="java">        <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">"text()"</span><span class="o">);</span></span>
<span id="LC817" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC818" class="line" lang="java">      <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_PROCESSING_INSTRUCTION</span> <span class="o">==</span> <span class="n">pat</span><span class="o">.</span><span class="na">m_whatToShow</span><span class="o">)</span></span>
<span id="LC819" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC820" class="line" lang="java">        <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">"processing-instruction("</span><span class="o">);</span></span>
<span id="LC821" class="line" lang="java"></span>
<span id="LC822" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">pat</span><span class="o">.</span><span class="na">m_name</span><span class="o">)</span></span>
<span id="LC823" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC824" class="line" lang="java">          <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="n">pat</span><span class="o">.</span><span class="na">m_name</span><span class="o">);</span></span>
<span id="LC825" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC826" class="line" lang="java"></span>
<span id="LC827" class="line" lang="java">        <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">")"</span><span class="o">);</span></span>
<span id="LC828" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC829" class="line" lang="java">      <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_COMMENT</span> <span class="o">==</span> <span class="n">pat</span><span class="o">.</span><span class="na">m_whatToShow</span><span class="o">)</span></span>
<span id="LC830" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC831" class="line" lang="java">        <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">"comment()"</span><span class="o">);</span></span>
<span id="LC832" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC833" class="line" lang="java">      <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">pat</span><span class="o">.</span><span class="na">m_name</span><span class="o">)</span></span>
<span id="LC834" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC835" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_ATTRIBUTE</span> <span class="o">==</span> <span class="n">pat</span><span class="o">.</span><span class="na">m_whatToShow</span><span class="o">)</span></span>
<span id="LC836" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC837" class="line" lang="java">          <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">"@"</span><span class="o">);</span></span>
<span id="LC838" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC839" class="line" lang="java"></span>
<span id="LC840" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">pat</span><span class="o">.</span><span class="na">m_namespace</span><span class="o">)</span></span>
<span id="LC841" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC842" class="line" lang="java">          <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">"{"</span><span class="o">);</span></span>
<span id="LC843" class="line" lang="java">          <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="n">pat</span><span class="o">.</span><span class="na">m_namespace</span><span class="o">);</span></span>
<span id="LC844" class="line" lang="java">          <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">"}"</span><span class="o">);</span></span>
<span id="LC845" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC846" class="line" lang="java"></span>
<span id="LC847" class="line" lang="java">        <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="n">pat</span><span class="o">.</span><span class="na">m_name</span><span class="o">);</span></span>
<span id="LC848" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC849" class="line" lang="java">      <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_ATTRIBUTE</span> <span class="o">==</span> <span class="n">pat</span><span class="o">.</span><span class="na">m_whatToShow</span><span class="o">)</span></span>
<span id="LC850" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC851" class="line" lang="java">        <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">"@"</span><span class="o">);</span></span>
<span id="LC852" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC853" class="line" lang="java">      <span class="k">else</span> <span class="nf">if</span> <span class="o">((</span><span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_DOCUMENT</span> <span class="o">|</span> <span class="nc">DTMFilter</span><span class="o">.</span><span class="na">SHOW_DOCUMENT_FRAGMENT</span><span class="o">)</span></span>
<span id="LC854" class="line" lang="java">               <span class="o">==</span> <span class="n">pat</span><span class="o">.</span><span class="na">m_whatToShow</span><span class="o">)</span></span>
<span id="LC855" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC856" class="line" lang="java">        <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">"doc-root()"</span><span class="o">);</span></span>
...
<span id="LC860" class="line" lang="java">        <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="sc">'?'</span><span class="o">).</span><span class="na">append</span><span class="o">(</span><span class="nc">Integer</span><span class="o">.</span><span class="na">toHexString</span><span class="o">(</span><span class="n">pat</span><span class="o">.</span><span class="na">m_whatToShow</span><span class="o">));</span></span>
<span id="LC861" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC862" class="line" lang="java"></span>
<span id="LC863" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">pat</span><span class="o">.</span><span class="na">m_predicates</span><span class="o">)</span></span>
<span id="LC864" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC865" class="line" lang="java">        <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">pat</span><span class="o">.</span><span class="na">m_predicates</span><span class="o">.</span><span class="na">length</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC866" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC867" class="line" lang="java">          <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">"["</span><span class="o">);</span></span>
<span id="LC868" class="line" lang="java">          <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="n">pat</span><span class="o">.</span><span class="na">m_predicates</span><span class="o">[</span><span class="n">i</span><span class="o">]);</span></span>
<span id="LC869" class="line" lang="java">          <span class="n">buf</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="s">"]"</span><span class="o">);</span></span>
...
<span id="LC874" class="line" lang="java">    <span class="k">return</span> <span class="n">buf</span><span class="o">.</span><span class="na">toString</span><span class="o">();</span></span>
<span id="LC875" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC876" class="line" lang="java"></span>
<span id="LC877" class="line" lang="java">  <span class="cm">/** Set to true to send diagnostics about pattern matches to the consol. */</span></span>
<span id="LC878" class="line" lang="java">  <span class="kd">private</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">boolean</span> <span class="no">DEBUG_MATCHES</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC879" class="line" lang="java"></span>
<span id="LC880" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC881" class="line" lang="java"><span class="cm">   * Get the match score of the given node.</span></span>
<span id="LC882" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC883" class="line" lang="java"><span class="cm">   * @param xctxt The XPath runtime context.</span></span>
<span id="LC884" class="line" lang="java"><span class="cm">   * @param context The node to be tested.</span></span>
<span id="LC885" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC886" class="line" lang="java"><span class="cm">   * @return {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_NODETEST},</span></span>
<span id="LC887" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_NONE},</span></span>
<span id="LC888" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_NSWILD},</span></span>
<span id="LC889" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_QNAME}, or</span></span>
<span id="LC890" class="line" lang="java"><span class="cm">   *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_OTHER}.</span></span>
<span id="LC891" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC892" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC893" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC894" class="line" lang="java">  <span class="kd">public</span> <span class="kt">double</span> <span class="nf">getMatchScore</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">,</span> <span class="kt">int</span> <span class="n">context</span><span class="o">)</span></span>
<span id="LC895" class="line" lang="java">          <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span></span>
<span id="LC896" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC897" class="line" lang="java"></span>
<span id="LC898" class="line" lang="java">    <span class="n">xctxt</span><span class="o">.</span><span class="na">pushCurrentNode</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC899" class="line" lang="java">    <span class="n">xctxt</span><span class="o">.</span><span class="na">pushCurrentExpressionNode</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC900" class="line" lang="java"></span>
<span id="LC901" class="line" lang="java">    <span class="k">try</span></span>
<span id="LC902" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC903" class="line" lang="java">      <span class="nc">XObject</span> <span class="n">score</span> <span class="o">=</span> <span class="n">execute</span><span class="o">(</span><span class="n">xctxt</span><span class="o">);</span></span>
<span id="LC904" class="line" lang="java"></span>
<span id="LC905" class="line" lang="java">      <span class="k">return</span> <span class="n">score</span><span class="o">.</span><span class="na">num</span><span class="o">();</span></span>
<span id="LC906" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC907" class="line" lang="java">    <span class="k">finally</span></span>
<span id="LC908" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC909" class="line" lang="java">      <span class="n">xctxt</span><span class="o">.</span><span class="na">popCurrentNode</span><span class="o">();</span></span>
<span id="LC910" class="line" lang="java">      <span class="n">xctxt</span><span class="o">.</span><span class="na">popCurrentExpressionNode</span><span class="o">();</span></span>
<span id="LC911" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC912" class="line" lang="java"></span>
<span id="LC913" class="line" lang="java">    <span class="c1">// return XPath.MATCH_SCORE_NONE;</span></span>
...
<span id="LC917" class="line" lang="java"><span class="cm">   * Set the axis that this step should follow.</span></span>
<span id="LC918" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC919" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC920" class="line" lang="java"><span class="cm">   * @param axis The Axis for this test, one of of Axes.ANCESTORORSELF, etc.</span></span>
<span id="LC921" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC922" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setAxis</span><span class="o">(</span><span class="kt">int</span> <span class="n">axis</span><span class="o">)</span></span>
<span id="LC923" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC924" class="line" lang="java">    <span class="n">m_axis</span> <span class="o">=</span> <span class="n">axis</span><span class="o">;</span></span>
...
<span id="LC928" class="line" lang="java"><span class="cm">   * Get the axis that this step follows.</span></span>
<span id="LC929" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC930" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC931" class="line" lang="java"><span class="cm">   * @return The Axis for this test, one of of Axes.ANCESTORORSELF, etc.</span></span>
<span id="LC932" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC933" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getAxis</span><span class="o">()</span></span>
<span id="LC934" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC935" class="line" lang="java">    <span class="k">return</span> <span class="n">m_axis</span><span class="o">;</span></span>
<span id="LC936" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC937" class="line" lang="java"></span>
<span id="LC938" class="line" lang="java">  <span class="kd">class</span> <span class="nc">PredOwner</span> <span class="kd">implements</span> <span class="nc">ExpressionOwner</span></span>
<span id="LC939" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC940" class="line" lang="java">        <span class="kt">int</span> <span class="n">m_index</span><span class="o">;</span></span>
<span id="LC941" class="line" lang="java"></span>
<span id="LC942" class="line" lang="java">        <span class="nc">PredOwner</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span></span>
<span id="LC943" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC944" class="line" lang="java">                <span class="n">m_index</span> <span class="o">=</span> <span class="n">index</span><span class="o">;</span></span>
...
<span id="LC948" class="line" lang="java"><span class="cm">     * @see ExpressionOwner#getExpression()</span></span>
<span id="LC949" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC950" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Expression</span> <span class="nf">getExpression</span><span class="o">()</span></span>
<span id="LC951" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC952" class="line" lang="java">      <span class="k">return</span> <span class="n">m_predicates</span><span class="o">[</span><span class="n">m_index</span><span class="o">];</span></span>
...
<span id="LC957" class="line" lang="java"><span class="cm">     * @see ExpressionOwner#setExpression(Expression)</span></span>
<span id="LC958" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC959" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setExpression</span><span class="o">(</span><span class="nc">Expression</span> <span class="n">exp</span><span class="o">)</span></span>
<span id="LC960" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC961" class="line" lang="java">        <span class="n">exp</span><span class="o">.</span><span class="na">exprSetParent</span><span class="o">(</span><span class="nc">StepPattern</span><span class="o">.</span><span class="na">this</span><span class="o">);</span></span>
<span id="LC962" class="line" lang="java">        <span class="n">m_predicates</span><span class="o">[</span><span class="n">m_index</span><span class="o">]</span> <span class="o">=</span> <span class="n">exp</span><span class="o">;</span></span>
...
<span id="LC967" class="line" lang="java"><span class="cm">   * @see com.sun.org.apache.xpath.internal.XPathVisitable#callVisitors(ExpressionOwner, XPathVisitor)</span></span>
<span id="LC968" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC969" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">callVisitors</span><span class="o">(</span><span class="nc">ExpressionOwner</span> <span class="n">owner</span><span class="o">,</span> <span class="nc">XPathVisitor</span> <span class="n">visitor</span><span class="o">)</span></span>
<span id="LC970" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC971" class="line" lang="java">                <span class="k">if</span><span class="o">(</span><span class="n">visitor</span><span class="o">.</span><span class="na">visitMatchPattern</span><span class="o">(</span><span class="n">owner</span><span class="o">,</span> <span class="k">this</span><span class="o">))</span></span>
<span id="LC972" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC973" class="line" lang="java">                        <span class="n">callSubtreeVisitors</span><span class="o">(</span><span class="n">visitor</span><span class="o">);</span></span>
...
<span id="LC978" class="line" lang="java"><span class="cm">   * Call the visitors on the subtree.  Factored out from callVisitors</span></span>
<span id="LC979" class="line" lang="java"><span class="cm">   * so it may be called by derived classes.</span></span>
<span id="LC980" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC981" class="line" lang="java">  <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">callSubtreeVisitors</span><span class="o">(</span><span class="nc">XPathVisitor</span> <span class="n">visitor</span><span class="o">)</span></span>
<span id="LC982" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC983" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_predicates</span><span class="o">)</span></span>
<span id="LC984" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC985" class="line" lang="java">      <span class="kt">int</span> <span class="n">n</span> <span class="o">=</span> <span class="n">m_predicates</span><span class="o">.</span><span class="na">length</span><span class="o">;</span></span>
<span id="LC986" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">n</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC987" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC988" class="line" lang="java">        <span class="nc">ExpressionOwner</span> <span class="n">predOwner</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">PredOwner</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC989" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">visitor</span><span class="o">.</span><span class="na">visitPredicate</span><span class="o">(</span><span class="n">predOwner</span><span class="o">,</span> <span class="n">m_predicates</span><span class="o">[</span><span class="n">i</span><span class="o">]))</span></span>
<span id="LC990" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC991" class="line" lang="java">          <span class="n">m_predicates</span><span class="o">[</span><span class="n">i</span><span class="o">].</span><span class="na">callVisitors</span><span class="o">(</span><span class="n">predOwner</span><span class="o">,</span> <span class="n">visitor</span><span class="o">);</span></span>
...
<span id="LC995" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_relativePathPattern</span><span class="o">)</span></span>
<span id="LC996" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC997" class="line" lang="java">      <span class="n">m_relativePathPattern</span><span class="o">.</span><span class="na">callVisitors</span><span class="o">(</span><span class="k">this</span><span class="o">,</span> <span class="n">visitor</span><span class="o">);</span></span>
...
<span id="LC1003" class="line" lang="java"><span class="cm">   * @see ExpressionOwner#getExpression()</span></span>
<span id="LC1004" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1005" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Expression</span> <span class="nf">getExpression</span><span class="o">()</span></span>
<span id="LC1006" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1007" class="line" lang="java">    <span class="k">return</span> <span class="n">m_relativePathPattern</span><span class="o">;</span></span>
...
<span id="LC1011" class="line" lang="java"><span class="cm">   * @see ExpressionOwner#setExpression(Expression)</span></span>
<span id="LC1012" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1013" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setExpression</span><span class="o">(</span><span class="nc">Expression</span> <span class="n">exp</span><span class="o">)</span></span>
<span id="LC1014" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1015" class="line" lang="java">    <span class="n">exp</span><span class="o">.</span><span class="na">exprSetParent</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC1016" class="line" lang="java">        <span class="n">m_relativePathPattern</span> <span class="o">=</span> <span class="o">(</span><span class="nc">StepPattern</span><span class="o">)</span><span class="n">exp</span><span class="o">;</span></span>
...
<span id="LC1020" class="line" lang="java"><span class="cm">   * @see Expression#deepEquals(Expression)</span></span>
<span id="LC1021" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1022" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">deepEquals</span><span class="o">(</span><span class="nc">Expression</span> <span class="n">expr</span><span class="o">)</span></span>
<span id="LC1023" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1024" class="line" lang="java">        <span class="k">if</span><span class="o">(!</span><span class="kd">super</span><span class="o">.</span><span class="na">deepEquals</span><span class="o">(</span><span class="n">expr</span><span class="o">))</span></span>
<span id="LC1025" class="line" lang="java">                <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1026" class="line" lang="java"></span>
<span id="LC1027" class="line" lang="java">        <span class="nc">StepPattern</span> <span class="n">sp</span> <span class="o">=</span> <span class="o">(</span><span class="nc">StepPattern</span><span class="o">)</span><span class="n">expr</span><span class="o">;</span></span>
<span id="LC1028" class="line" lang="java"></span>
<span id="LC1029" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_predicates</span><span class="o">)</span></span>
<span id="LC1030" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1031" class="line" lang="java">        <span class="kt">int</span> <span class="n">n</span> <span class="o">=</span> <span class="n">m_predicates</span><span class="o">.</span><span class="na">length</span><span class="o">;</span></span>
<span id="LC1032" class="line" lang="java">        <span class="k">if</span> <span class="o">((</span><span class="kc">null</span> <span class="o">==</span> <span class="n">sp</span><span class="o">.</span><span class="na">m_predicates</span><span class="o">)</span> <span class="o">||</span> <span class="o">(</span><span class="n">sp</span><span class="o">.</span><span class="na">m_predicates</span><span class="o">.</span><span class="na">length</span> <span class="o">!=</span> <span class="n">n</span><span class="o">))</span></span>
<span id="LC1033" class="line" lang="java">              <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1034" class="line" lang="java">        <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">n</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC1035" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1036" class="line" lang="java">          <span class="k">if</span> <span class="o">(!</span><span class="n">m_predicates</span><span class="o">[</span><span class="n">i</span><span class="o">].</span><span class="na">deepEquals</span><span class="o">(</span><span class="n">sp</span><span class="o">.</span><span class="na">m_predicates</span><span class="o">[</span><span class="n">i</span><span class="o">]))</span></span>
<span id="LC1037" class="line" lang="java">                <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1038" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1039" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1040" class="line" lang="java">    <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">sp</span><span class="o">.</span><span class="na">m_predicates</span><span class="o">)</span></span>
<span id="LC1041" class="line" lang="java">        <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1042" class="line" lang="java"></span>
<span id="LC1043" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_relativePathPattern</span><span class="o">)</span></span>
<span id="LC1044" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1045" class="line" lang="java">                <span class="k">if</span><span class="o">(!</span><span class="n">m_relativePathPattern</span><span class="o">.</span><span class="na">deepEquals</span><span class="o">(</span><span class="n">sp</span><span class="o">.</span><span class="na">m_relativePathPattern</span><span class="o">))</span></span>
<span id="LC1046" class="line" lang="java">                        <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1047" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1048" class="line" lang="java">        <span class="k">else</span> <span class="nf">if</span><span class="o">(</span><span class="n">sp</span><span class="o">.</span><span class="na">m_relativePathPattern</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
...
<span id="LC1051" class="line" lang="java">        <span class="k">return</span> <span class="kc">true</span><span class="o">;</span></span>
