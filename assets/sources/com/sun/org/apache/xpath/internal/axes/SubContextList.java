...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: SubContextList.java,v 1.1.2.1 2005/08/01 01:30:28 jeffsuttor Exp $</span></span>
...
<span id="LC28" class="line" lang="java"><span class="cm"> * A class that implements this interface is a sub context node list, meaning it</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> * is a node list for a location path step for a predicate.</span></span>
...
<span id="LC32" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">SubContextList</span></span>
...
<span id="LC36" class="line" lang="java"><span class="cm">   * Get the number of nodes in the node list, which, in the XSLT 1 based</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">   * counting system, is the last index position.</span></span>
<span id="LC38" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">   * @param xctxt The XPath runtime context.</span></span>
<span id="LC41" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC42" class="line" lang="java"><span class="cm">   * @return the number of nodes in the node list.</span></span>
<span id="LC43" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC44" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getLastPos</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">);</span></span>
<span id="LC45" class="line" lang="java"></span>
<span id="LC46" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC47" class="line" lang="java"><span class="cm">   * Get the current sub-context position.</span></span>
<span id="LC48" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC49" class="line" lang="java"><span class="cm">   * @param xctxt The XPath runtime context.</span></span>
<span id="LC50" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC51" class="line" lang="java"><span class="cm">   * @return The position of the current node in the list.</span></span>
<span id="LC52" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC53" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getProximityPosition</span><span class="o">(</span><span class="nc">XPathContext</span> <span class="n">xctxt</span><span class="o">);</span></span>
