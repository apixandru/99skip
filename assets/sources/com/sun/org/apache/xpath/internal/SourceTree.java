...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: SourceTree.java,v 1.1.2.1 2005/08/01 01:30:15 jeffsuttor Exp $</span></span>
...
<span id="LC27" class="line" lang="java"><span class="cm"> * This object represents a Source Tree, and any associated</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> * information.</span></span>
...
<span id="LC31" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">SourceTree</span></span>
...
<span id="LC35" class="line" lang="java"><span class="cm">   * Constructor SourceTree</span></span>
<span id="LC36" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC38" class="line" lang="java"><span class="cm">   * @param root The root of the source tree, which may or may not be a</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">   * {@link org.w3c.dom.Document} node.</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">   * @param url The URI of the source tree.</span></span>
<span id="LC41" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC42" class="line" lang="java">  <span class="kd">public</span> <span class="nf">SourceTree</span><span class="o">(</span><span class="kt">int</span> <span class="n">root</span><span class="o">,</span> <span class="nc">String</span> <span class="n">url</span><span class="o">)</span></span>
<span id="LC43" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC44" class="line" lang="java">    <span class="n">m_root</span> <span class="o">=</span> <span class="n">root</span><span class="o">;</span></span>
<span id="LC45" class="line" lang="java">    <span class="n">m_url</span> <span class="o">=</span> <span class="n">url</span><span class="o">;</span></span>
<span id="LC46" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC47" class="line" lang="java"></span>
<span id="LC48" class="line" lang="java">  <span class="cm">/** The URI of the source tree.   */</span></span>
<span id="LC49" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="n">m_url</span><span class="o">;</span></span>
<span id="LC50" class="line" lang="java"></span>
<span id="LC51" class="line" lang="java">  <span class="cm">/** The root of the source tree, which may or may not be a</span></span>
<span id="LC52" class="line" lang="java"><span class="cm">   * {@link org.w3c.dom.Document} node.  */</span></span>
<span id="LC53" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="n">m_root</span><span class="o">;</span></span>
