...
<span id="LC34" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XPATHErrorResources_fr</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span></span>
...
<span id="LC361" class="line" lang="java">  <span class="o">{</span> <span class="no">ER_CURRENT_NOT_ALLOWED_IN_MATCH</span><span class="o">,</span> <span class="s">"La fonction current() n'est pas autoris\u00E9e dans un mod\u00E8le de recherche."</span> <span class="o">},</span></span>
<span id="LC362" class="line" lang="java"></span>
<span id="LC363" class="line" lang="java">  <span class="o">{</span> <span class="no">ER_CURRENT_TAKES_NO_ARGS</span><span class="o">,</span> <span class="s">"La fonction current() n'accepte pas d'argument."</span> <span class="o">},</span></span>
...
<span id="LC366" class="line" lang="java">      <span class="s">"L'impl\u00E9mentation de la fonction document() a \u00E9t\u00E9 remplac\u00E9e par com.sun.org.apache.xalan.internal.xslt.FuncDocument."</span><span class="o">},</span></span>
...
<span id="LC369" class="line" lang="java">      <span class="s">"le contexte ne poss\u00E8de pas de document propri\u00E9taire."</span><span class="o">},</span></span>
...
<span id="LC372" class="line" lang="java">      <span class="s">"local-name() poss\u00E8de trop d'arguments."</span><span class="o">},</span></span>
...
<span id="LC375" class="line" lang="java">      <span class="s">"namespace-uri() poss\u00E8de trop d'arguments."</span><span class="o">},</span></span>
...
<span id="LC378" class="line" lang="java">      <span class="s">"normalize-space() poss\u00E8de trop d'arguments."</span><span class="o">},</span></span>
...
<span id="LC381" class="line" lang="java">      <span class="s">"number() poss\u00E8de trop d'arguments."</span><span class="o">},</span></span>
...
<span id="LC384" class="line" lang="java">     <span class="s">"name() poss\u00E8de trop d'arguments."</span><span class="o">},</span></span>
...
<span id="LC387" class="line" lang="java">      <span class="s">"string() poss\u00E8de trop d'arguments."</span><span class="o">},</span></span>
...
<span id="LC390" class="line" lang="java">      <span class="s">"string-length() poss\u00E8de trop d'arguments."</span><span class="o">},</span></span>
...
<span id="LC393" class="line" lang="java">      <span class="s">"La fonction translate() accepte trois arguments."</span><span class="o">},</span></span>
...
<span id="LC396" class="line" lang="java">      <span class="s">"Un argument doit \u00EAtre fourni \u00E0 la fonction unparsed-entity-uri."</span><span class="o">},</span></span>
...
<span id="LC399" class="line" lang="java">      <span class="s">"l'axe de l'espace de noms n'est pas impl\u00E9ment\u00E9."</span><span class="o">},</span></span>
...
<span id="LC402" class="line" lang="java">     <span class="s">"axe inconnu : {0}"</span><span class="o">},</span></span>
...
<span id="LC405" class="line" lang="java">     <span class="s">"op\u00E9ration de correspondance inconnue."</span><span class="o">},</span></span>
...
<span id="LC408" class="line" lang="java">      <span class="s">"La longueur d'argument du test du noeud processing-instruction() n'est pas correcte."</span><span class="o">},</span></span>
...
<span id="LC411" class="line" lang="java">      <span class="s">"Impossible de convertir {0} en nombre"</span><span class="o">},</span></span>
...
<span id="LC414" class="line" lang="java">      <span class="s">"Impossible de convertir {0} en NodeList."</span><span class="o">},</span></span>
...
<span id="LC417" class="line" lang="java">      <span class="s">"Impossible de convertir {0} en NodeSetDTM."</span><span class="o">},</span></span>
...
<span id="LC420" class="line" lang="java">      <span class="s">"Impossible de convertir {0} en type#{1}"</span><span class="o">},</span></span>
...
<span id="LC423" class="line" lang="java">      <span class="s">"Mod\u00E8le de recherche attendu dans getMatchScore."</span><span class="o">},</span></span>
...
<span id="LC426" class="line" lang="java">      <span class="s">"Impossible d''obtenir la variable nomm\u00E9e {0}"</span><span class="o">},</span></span>
...
<span id="LC429" class="line" lang="java">     <span class="s">"ERREUR. Code d''op\u00E9ration inconnu : {0}"</span><span class="o">},</span></span>
...
<span id="LC432" class="line" lang="java">     <span class="s">"Jetons non admis suppl\u00E9mentaires : {0}"</span><span class="o">},</span></span>
...
<span id="LC435" class="line" lang="java">      <span class="s">"Erreur de guillemets dans un litt\u00E9ral... Guillemets obligatoires."</span><span class="o">},</span></span>
...
<span id="LC438" class="line" lang="java">      <span class="s">"Erreur d'apostrophe dans un litt\u00E9ral... Apostrophe obligatoire."</span><span class="o">},</span></span>
...
<span id="LC441" class="line" lang="java">     <span class="s">"Expression vide."</span><span class="o">},</span></span>
...
<span id="LC444" class="line" lang="java">     <span class="s">"Valeur attendue : {0}, mais {1} a \u00E9t\u00E9 trouv\u00E9"</span><span class="o">},</span></span>
...
<span id="LC447" class="line" lang="java">      <span class="s">"Assertion de programmeur incorrecte. - {0}"</span><span class="o">},</span></span>
...
<span id="LC450" class="line" lang="java">      <span class="s">"L'argument boolean(...) n'est plus facultatif avec le brouillon (draft) XPath 19990709."</span><span class="o">},</span></span>
...
<span id="LC453" class="line" lang="java">      <span class="s">"Caract\u00E8re ',' trouv\u00E9 sans argument le pr\u00E9c\u00E9dant."</span><span class="o">},</span></span>
...
<span id="LC456" class="line" lang="java">      <span class="s">"Caract\u00E8re ',' trouv\u00E9 sans argument le suivant."</span><span class="o">},</span></span>
...
<span id="LC459" class="line" lang="java">      <span class="s">"Syntaxe '..[predicate]' ou '.[predicate]' non admise. Utilisez 'self::node()[predicate]' \u00E0 la place."</span><span class="o">},</span></span>
...
<span id="LC462" class="line" lang="java">     <span class="s">"nom d''axe non admis : {0}"</span><span class="o">},</span></span>
...
<span id="LC465" class="line" lang="java">     <span class="s">"Type de noeud inconnu : {0}"</span><span class="o">},</span></span>
...
<span id="LC468" class="line" lang="java">      <span class="s">"Le litt\u00E9ral de mod\u00E8le ({0}) doit figurer entre guillemets."</span><span class="o">},</span></span>
...
<span id="LC471" class="line" lang="java">      <span class="s">"Impossible de formater {0} en nombre."</span><span class="o">},</span></span>
...
<span id="LC474" class="line" lang="java">      <span class="s">"Impossible de cr\u00E9er la liaison XML TransformerFactory : {0}"</span><span class="o">},</span></span>
...
<span id="LC477" class="line" lang="java">      <span class="s">"Erreur. Expression de s\u00E9lection XPath (-select) introuvable."</span><span class="o">},</span></span>
...
<span id="LC480" class="line" lang="java">      <span class="s">"ERREUR. ENDOP introuvable apr\u00E8s OP_LOCATIONPATH"</span><span class="o">},</span></span>
...
<span id="LC483" class="line" lang="java">     <span class="s">"Une erreur est survenue."</span><span class="o">},</span></span>
...
<span id="LC486" class="line" lang="java">      <span class="s">"L''\u00E9l\u00E9ment VariableReference indiqu\u00E9 pour la variable est hors contexte ou sans d\u00E9finition. Nom = {0}"</span><span class="o">},</span></span>
...
<span id="LC489" class="line" lang="java">      <span class="s">"Seuls les axes child:: et attribute:: sont autoris\u00E9s dans des mod\u00E8les de recherche. Axes en cause = {0}"</span><span class="o">},</span></span>
...
<span id="LC492" class="line" lang="java">      <span class="s">"key() poss\u00E8de un nombre incorrect d'arguments."</span><span class="o">},</span></span>
...
<span id="LC495" class="line" lang="java">      <span class="s">"Un seul argument doit \u00EAtre fourni \u00E0 la fonction de d\u00E9compte."</span><span class="o">},</span></span>
...
<span id="LC498" class="line" lang="java">     <span class="s">"Impossible de trouver la fonction : {0}"</span><span class="o">},</span></span>
...
<span id="LC501" class="line" lang="java">     <span class="s">"Encodage non pris en charge : {0}"</span><span class="o">},</span></span>
...
<span id="LC504" class="line" lang="java">      <span class="s">"Une erreur est survenue dans le DTM de getNextSibling... Tentative de r\u00E9cup\u00E9ration"</span><span class="o">},</span></span>
...
<span id="LC507" class="line" lang="java">      <span class="s">"Erreur de programmeur : \u00E9criture impossible dans EmptyNodeList."</span><span class="o">},</span></span>
...
<span id="LC510" class="line" lang="java">      <span class="s">"SetDOMFactory n'est pas pris en charge par XPathContext."</span><span class="o">},</span></span>
...
<span id="LC513" class="line" lang="java">      <span class="s">"Le pr\u00E9fixe doit produire un espace de noms : {0}"</span><span class="o">},</span></span>
...
<span id="LC516" class="line" lang="java">      <span class="s">"analyse (source InputSource) non prise en charge dans XPathContext. Impossible d''ouvrir {0}"</span><span class="o">},</span></span>
...
<span id="LC519" class="line" lang="java">      <span class="s">"Caract\u00E8res (char ch[]...) de l'API SAX non pris en charge par le DTM."</span><span class="o">},</span></span>
...
<span id="LC522" class="line" lang="java">      <span class="s">"ignorableWhitespace(char ch[]... non pris en charge par le DTM."</span><span class="o">},</span></span>
...
<span id="LC525" class="line" lang="java">      <span class="s">"DTMLiaison ne prend pas en charge les noeuds de type {0}"</span><span class="o">},</span></span>
...
<span id="LC528" class="line" lang="java">      <span class="s">"DOM2Helper ne prend pas en charge les noeuds de type {0}"</span><span class="o">},</span></span>
...
<span id="LC531" class="line" lang="java">      <span class="s">"Erreur de DOM2Helper.parse : SystemID - {0} ligne - {1}"</span><span class="o">},</span></span>
...
<span id="LC534" class="line" lang="java">     <span class="s">"Erreur de DOM2Helper.parse"</span><span class="o">},</span></span>
...
<span id="LC537" class="line" lang="java">      <span class="s">"Substitut UTF-16 non valide d\u00E9tect\u00E9 : {0} ?"</span><span class="o">},</span></span>
...
<span id="LC540" class="line" lang="java">     <span class="s">"Erreur d'E/S"</span><span class="o">},</span></span>
...
<span id="LC543" class="line" lang="java">     <span class="s">"Impossible de cr\u00E9er une URL pour : {0}"</span><span class="o">},</span></span>
...
<span id="LC546" class="line" lang="java">     <span class="s">"Dans XPath.readObject : {0}"</span><span class="o">},</span></span>
...
<span id="LC549" class="line" lang="java">      <span class="s">"jeton de fonction introuvable."</span><span class="o">},</span></span>
...
<span id="LC552" class="line" lang="java">       <span class="s">"Impossible de traiter le type XPath : {0}"</span><span class="o">},</span></span>
...
<span id="LC555" class="line" lang="java">       <span class="s">"NodeSet non mutable"</span><span class="o">},</span></span>
...
<span id="LC558" class="line" lang="java">       <span class="s">"NodeSetDTM non mutable"</span><span class="o">},</span></span>
...
<span id="LC561" class="line" lang="java">        <span class="s">"Impossible de r\u00E9soudre la variable : {0}"</span><span class="o">},</span></span>
...
<span id="LC564" class="line" lang="java">        <span class="s">"Gestionnaire d'erreurs NULL"</span><span class="o">},</span></span>
...
<span id="LC567" class="line" lang="java">       <span class="s">"Assertion de programmeur : code d''op\u00E9ration inconnu : {0}"</span><span class="o">},</span></span>
...
<span id="LC570" class="line" lang="java">       <span class="s">"0 ou 1"</span><span class="o">},</span></span>
...
<span id="LC573" class="line" lang="java">       <span class="s">"rtf() non pris en charge par XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC576" class="line" lang="java">       <span class="s">"asNodeIterator() non pris en charge par XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC580" class="line" lang="java">                <span class="s">"detach() non pris en charge par XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC584" class="line" lang="java">                <span class="s">"num() non pris en charge par XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC588" class="line" lang="java">                <span class="s">"xstr() non pris en charge par XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC592" class="line" lang="java">                <span class="s">"str() non pris en charge par XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC595" class="line" lang="java">       <span class="s">"fsb() non pris en charge pour XStringForChars"</span><span class="o">},</span></span>
...
<span id="LC598" class="line" lang="java">      <span class="s">"Impossible de trouver la variable portant le nom {0}"</span><span class="o">},</span></span>
...
<span id="LC601" class="line" lang="java">      <span class="s">"XStringForChars n'accepte pas de cha\u00EEne comme argument"</span><span class="o">},</span></span>
...
<span id="LC604" class="line" lang="java">      <span class="s">"L'argument FastStringBuffer ne doit pas \u00EAtre NULL"</span><span class="o">},</span></span>
...
<span id="LC607" class="line" lang="java">       <span class="s">"2 ou 3"</span><span class="o">},</span></span>
...
<span id="LC610" class="line" lang="java">       <span class="s">"L'acc\u00E8s \u00E0 la variable a pr\u00E9c\u00E9d\u00E9 la liaison de celle-ci."</span><span class="o">},</span></span>
...
<span id="LC613" class="line" lang="java">       <span class="s">"XStringForFSB n'accepte pas de cha\u00EEne comme argument."</span><span class="o">},</span></span>
...
<span id="LC616" class="line" lang="java">       <span class="s">"\n Erreur. D\u00E9finition de la racine d'un composant d'exploration sur NULL."</span><span class="o">},</span></span>
...
<span id="LC619" class="line" lang="java">       <span class="s">"Ce NodeSetDTM ne permet pas d'it\u00E9ration vers un noeud pr\u00E9c\u00E9dent."</span><span class="o">},</span></span>
...
<span id="LC622" class="line" lang="java">       <span class="s">"Ce NodeSet ne permet pas d'it\u00E9ration vers un noeud pr\u00E9c\u00E9dent."</span><span class="o">},</span></span>
...
<span id="LC625" class="line" lang="java">       <span class="s">"Ce NodeSetDTM ne peut pas utiliser de fonctions d'indexation ou de d\u00E9compte."</span><span class="o">},</span></span>
...
<span id="LC628" class="line" lang="java">       <span class="s">"Ce NodeSet ne peut pas utiliser de fonctions d'indexation ou de d\u00E9compte."</span><span class="o">},</span></span>
...
<span id="LC631" class="line" lang="java">       <span class="s">"Impossible d'appeler setShouldCacheNodes apr\u00E8s nextNode."</span><span class="o">},</span></span>
...
<span id="LC634" class="line" lang="java">       <span class="s">"{0} accepte uniquement {1} arguments"</span><span class="o">},</span></span>
...
<span id="LC637" class="line" lang="java">       <span class="s">"Assertion du programmeur dans getNextStepPos : stepType inconnu : {0}"</span><span class="o">},</span></span>
...
<span id="LC643" class="line" lang="java">      <span class="s">"Un chemin d'acc\u00E8s relatif \u00E9tait attendu apr\u00E8s le jeton '/' ou '//'."</span><span class="o">},</span></span>
...
<span id="LC649" class="line" lang="java">       <span class="s">"Un chemin d''acc\u00E8s \u00E9tait attendu, mais le jeton suivant a \u00E9t\u00E9 d\u00E9tect\u00E9 : {0}"</span><span class="o">},</span></span>
...
<span id="LC655" class="line" lang="java">       <span class="s">"Un chemin d'acc\u00E8s \u00E9tait attendu, mais la fin de l'expression XPath a \u00E9t\u00E9 d\u00E9tect\u00E9e \u00E0 la place."</span><span class="o">},</span></span>
...
<span id="LC661" class="line" lang="java">       <span class="s">"Une \u00E9tape d'emplacement \u00E9tait attendue apr\u00E8s le jeton '/' ou '//'."</span><span class="o">},</span></span>
...
<span id="LC668" class="line" lang="java">       <span class="s">"Un test de noeud correspondant \u00E0 NCName:* ou QName \u00E9tait attendu."</span><span class="o">},</span></span>
...
<span id="LC674" class="line" lang="java">       <span class="s">"Un mod\u00E8le d'\u00E9tape \u00E9tait attendu, mais '/' a \u00E9t\u00E9 d\u00E9tect\u00E9."</span><span class="o">},</span></span>
...
<span id="LC680" class="line" lang="java">       <span class="s">"Un mod\u00E8le de chemin relatif \u00E9tait attendu."</span><span class="o">},</span></span>
...
<span id="LC686" class="line" lang="java">       <span class="s">"L''\u00E9l\u00E9ment XPathResult de l''expression XPath ''{0}'' comporte un \u00E9l\u00E9ment XPathResultType de {1} qui ne peut pas \u00EAtre converti en valeur bool\u00E9enne."</span><span class="o">},</span></span>
...
<span id="LC691" class="line" lang="java">       <span class="s">"L''\u00E9l\u00E9ment XPathResult de l''expression XPath ''{0}'' comporte un \u00E9l\u00E9ment XPathResultType de {1} qui ne peut pas \u00EAtre converti en noeud unique. La m\u00E9thode getSingleNodeValue est applicable uniquement aux types ANY_UNORDERED_NODE_TYPE et FIRST_ORDERED_NODE_TYPE."</span><span class="o">},</span></span>
...
<span id="LC696" class="line" lang="java">       <span class="s">"La m\u00E9thode getSnapshotLength ne peut pas \u00EAtre appel\u00E9e sur l''\u00E9l\u00E9ment XPathResult de l''expression XPath ''{0}'' car son \u00E9l\u00E9ment XPathResultType est {1}. Cette m\u00E9thode est applicable uniquement aux types UNORDERED_NODE_SNAPSHOT_TYPE et ORDERED_NODE_SNAPSHOT_TYPE."</span><span class="o">},</span></span>
...
<span id="LC699" class="line" lang="java">       <span class="s">"La m\u00E9thode iterateNext ne peut pas \u00EAtre appel\u00E9e sur l''\u00E9l\u00E9ment XPathResult de l''expression XPath ''{0}'' car son \u00E9l\u00E9ment XPathResultType est {1}. Cette m\u00E9thode est applicable uniquement aux types UNORDERED_NODE_ITERATOR_TYPE et ORDERED_NODE_ITERATOR_TYPE."</span><span class="o">},</span></span>
...
<span id="LC705" class="line" lang="java">       <span class="s">"Mutation du document suite au renvoi du r\u00E9sultat. L'it\u00E9rateur est incorrect."</span><span class="o">},</span></span>
...
<span id="LC708" class="line" lang="java">       <span class="s">"Argument de type XPath incorrect : {0}"</span><span class="o">},</span></span>
...
<span id="LC711" class="line" lang="java">       <span class="s">"Objet de r\u00E9sultat XPath vide"</span><span class="o">},</span></span>
...
<span id="LC714" class="line" lang="java">       <span class="s">"L''\u00E9l\u00E9ment XPathResult de l''expression XPath ''{0}'' comporte un \u00E9l\u00E9ment XPathResultType de {1} qui ne peut pas \u00EAtre forc\u00E9 dans l''\u00E9l\u00E9ment XPathResultType de {2} indiqu\u00E9."</span><span class="o">},</span></span>
...
<span id="LC717" class="line" lang="java">       <span class="s">"Impossible de r\u00E9soudre le pr\u00E9fixe avec un r\u00E9solveur de pr\u00E9fixe NULL."</span><span class="o">},</span></span>
...
<span id="LC723" class="line" lang="java">       <span class="s">"L''\u00E9l\u00E9ment XPathResult de l''expression XPath ''{0}'' comporte un \u00E9l\u00E9ment XPathResultType de {1} qui ne peut pas \u00EAtre converti en cha\u00EEne."</span><span class="o">},</span></span>
...
<span id="LC728" class="line" lang="java">       <span class="s">"La m\u00E9thode snapshotItem ne peut pas \u00EAtre appel\u00E9e sur l''\u00E9l\u00E9ment XPathResult de l''expression XPath ''{0}'' car son \u00E9l\u00E9ment XPathResultType est {1}. Cette m\u00E9thode est applicable uniquement aux types UNORDERED_NODE_SNAPSHOT_TYPE et ORDERED_NODE_SNAPSHOT_TYPE."</span><span class="o">},</span></span>
...
<span id="LC735" class="line" lang="java">       <span class="s">"Le noeud de contexte n'appartient pas au document li\u00E9 \u00E0 ce XPathEvaluator."</span><span class="o">},</span></span>
...
<span id="LC740" class="line" lang="java">       <span class="s">"Le type de noeud de contexte n'est pas pris en charge."</span><span class="o">},</span></span>
...
<span id="LC743" class="line" lang="java">       <span class="s">"Erreur inconnue d\u00E9tect\u00E9e dans XPath."</span><span class="o">},</span></span>
...
<span id="LC746" class="line" lang="java">        <span class="s">"L''\u00E9l\u00E9ment XPathResult de l''expression XPath ''{0}'' comporte un \u00E9l\u00E9ment XPathResultType de {1} qui ne peut pas \u00EAtre converti en nombre"</span><span class="o">},</span></span>
...
<span id="LC753" class="line" lang="java">       <span class="s">"La fonction d''extension ''{0}'' ne peut pas \u00EAtre appel\u00E9e lorsque la fonctionnalit\u00E9 XMLConstants.FEATURE_SECURE_PROCESSING est d\u00E9finie sur True."</span><span class="o">},</span></span>
...
<span id="LC758" class="line" lang="java">       <span class="s">"resolveVariable pour la variable {0} renvoie la valeur NULL"</span><span class="o">},</span></span>
...
<span id="LC763" class="line" lang="java">       <span class="s">"Type de retour non pris en charge : {0}"</span><span class="o">},</span></span>
...
<span id="LC768" class="line" lang="java">       <span class="s">"Le type de source et/ou de retour ne peut pas \u00EAtre NULL"</span><span class="o">},</span></span>
...
<span id="LC773" class="line" lang="java">       <span class="s">"Le type de source et/ou de retour ne peut pas \u00EAtre NULL"</span><span class="o">},</span></span>
...
<span id="LC778" class="line" lang="java">       <span class="s">"L''argument {0} ne doit pas \u00EAtre NULL"</span><span class="o">},</span></span>
...
<span id="LC783" class="line" lang="java">       <span class="s">"{0}#isObjectModelSupported(String objectModel) ne peut pas \u00EAtre appel\u00E9 avec objectModel == null"</span><span class="o">},</span></span>
...
<span id="LC788" class="line" lang="java">       <span class="s">"{0}#isObjectModelSupported(String objectModel) ne peut pas \u00EAtre appel\u00E9 avec objectModel == \"\""</span><span class="o">},</span></span>
...
<span id="LC793" class="line" lang="java">       <span class="s">"Tentative de d\u00E9finition d''une fonctionnalit\u00E9 portant un nom NULL : {0}#setFeature(null, {1})"</span><span class="o">},</span></span>
...
<span id="LC798" class="line" lang="java">       <span class="s">"Tentative de d\u00E9finition de la fonctionnalit\u00E9 inconnue \"{0}\" : {1}#setFeature({0},{2})"</span><span class="o">},</span></span>
...
<span id="LC803" class="line" lang="java">       <span class="s">"Tentative d''obtention d''une fonctionnalit\u00E9 portant un nom NULL : {0}#getFeature(null)"</span><span class="o">},</span></span>
...
<span id="LC808" class="line" lang="java">       <span class="s">"Tentative d''obtention de la fonctionnalit\u00E9 inconnue \"{0}\" : {1}#getFeature({0})"</span><span class="o">},</span></span>
...
<span id="LC811" class="line" lang="java">        <span class="s">"FEATURE_SECURE_PROCESSING : impossible de d\u00E9finir la fonctionnalit\u00E9 sur False en pr\u00E9sence du gestionnaire de s\u00E9curit\u00E9 : {1}#setFeature({0},{2})"</span><span class="o">},</span></span>
...
<span id="LC816" class="line" lang="java">       <span class="s">"Tentative de d\u00E9finition d''un \u00E9l\u00E9ment XPathFunctionResolver NULL : {0}#setXPathFunctionResolver(null)"</span><span class="o">},</span></span>
...
<span id="LC821" class="line" lang="java">       <span class="s">"Tentative de d\u00E9finition d''un \u00E9l\u00E9ment XPathVariableResolver NULL : {0}#setXPathVariableResolver(null)"</span><span class="o">},</span></span>
...
<span id="LC828" class="line" lang="java">      <span class="s">"le nom d'environnement local de la fonction format-number n'est pas encore pris en charge."</span><span class="o">},</span></span>
...
<span id="LC831" class="line" lang="java">      <span class="s">"Propri\u00E9t\u00E9 XSL non prise en charge : {0}"</span><span class="o">},</span></span>
...
<span id="LC834" class="line" lang="java">      <span class="s">"Espace de noms {0} inexploitable dans la propri\u00E9t\u00E9 : {1}"</span><span class="o">},</span></span>
...
<span id="LC837" class="line" lang="java">      <span class="s">"Exception SecurityException g\u00E9n\u00E9r\u00E9e lors de la tentative d''acc\u00E8s \u00E0 la propri\u00E9t\u00E9 syst\u00E8me XSL : {0}"</span><span class="o">},</span></span>
...
<span id="LC840" class="line" lang="java">      <span class="s">"L'ancienne syntaxe quo(...) n'est plus d\u00E9finie dans XPath."</span><span class="o">},</span></span>
...
<span id="LC843" class="line" lang="java">      <span class="s">"XPath requiert un objet d\u00E9riv\u00E9 pour impl\u00E9menter nodeTest."</span><span class="o">},</span></span>
...
<span id="LC846" class="line" lang="java">      <span class="s">"jeton de fonction introuvable."</span><span class="o">},</span></span>
...
<span id="LC849" class="line" lang="java">      <span class="s">"Impossible de trouver la fonction : {0}"</span><span class="o">},</span></span>
...
<span id="LC852" class="line" lang="java">      <span class="s">"Impossible de cr\u00E9er l''URL \u00E0 partir de : {0}"</span><span class="o">},</span></span>
...
<span id="LC855" class="line" lang="java">      <span class="s">"L'option -E n'est pas prise en charge pour l'analyseur DTM"</span><span class="o">},</span></span>
...
<span id="LC858" class="line" lang="java">      <span class="s">"L''\u00E9l\u00E9ment VariableReference indiqu\u00E9 pour la variable est hors contexte ou sans d\u00E9finition. Nom = {0}"</span><span class="o">},</span></span>
...
<span id="LC861" class="line" lang="java">     <span class="s">"Encodage non pris en charge : {0}"</span><span class="o">},</span></span>
...
<span id="LC866" class="line" lang="java">  <span class="o">{</span> <span class="s">"ui_language"</span><span class="o">,</span> <span class="s">"fr"</span><span class="o">},</span></span>
<span id="LC867" class="line" lang="java">  <span class="o">{</span> <span class="s">"help_language"</span><span class="o">,</span> <span class="s">"fr"</span><span class="o">},</span></span>
<span id="LC868" class="line" lang="java">  <span class="o">{</span> <span class="s">"language"</span><span class="o">,</span> <span class="s">"fr"</span><span class="o">},</span></span>
<span id="LC869" class="line" lang="java">  <span class="o">{</span> <span class="s">"BAD_CODE"</span><span class="o">,</span> <span class="s">"Le param\u00E8tre de createMessage est hors limites"</span><span class="o">},</span></span>
<span id="LC870" class="line" lang="java">  <span class="o">{</span> <span class="s">"FORMAT_FAILED"</span><span class="o">,</span> <span class="s">"Exception g\u00E9n\u00E9r\u00E9e lors de l'appel de messageFormat"</span><span class="o">},</span></span>
<span id="LC871" class="line" lang="java">  <span class="o">{</span> <span class="s">"version"</span><span class="o">,</span> <span class="s">"&gt;&gt;&gt;&gt;&gt;&gt;&gt; Version de Xalan "</span><span class="o">},</span></span>
...
<span id="LC873" class="line" lang="java">  <span class="o">{</span> <span class="s">"yes"</span><span class="o">,</span> <span class="s">"oui"</span><span class="o">},</span></span>
<span id="LC874" class="line" lang="java">  <span class="o">{</span> <span class="s">"line"</span><span class="o">,</span> <span class="s">"Ligne n\u00B0"</span><span class="o">},</span></span>
<span id="LC875" class="line" lang="java">  <span class="o">{</span> <span class="s">"column"</span><span class="o">,</span> <span class="s">"Colonne n\u00B0"</span><span class="o">},</span></span>
<span id="LC876" class="line" lang="java">  <span class="o">{</span> <span class="s">"xsldone"</span><span class="o">,</span> <span class="s">"XSLProcessor : termin\u00E9"</span><span class="o">},</span></span>
<span id="LC877" class="line" lang="java">  <span class="o">{</span> <span class="s">"xpath_option"</span><span class="o">,</span> <span class="s">"options xpath : "</span><span class="o">},</span></span>
...
<span id="LC879" class="line" lang="java">  <span class="o">{</span> <span class="s">"optionSelect"</span><span class="o">,</span> <span class="s">"   [-select xpath expression]"</span><span class="o">},</span></span>
<span id="LC880" class="line" lang="java">  <span class="o">{</span> <span class="s">"optionMatch"</span><span class="o">,</span> <span class="s">"   [-match match pattern (pour les diagnostics de correspondance)]"</span><span class="o">},</span></span>
<span id="LC881" class="line" lang="java">  <span class="o">{</span> <span class="s">"optionAnyExpr"</span><span class="o">,</span> <span class="s">"Ou seulement une expression XPath g\u00E9n\u00E9rera un fichier dump de diagnostic"</span><span class="o">},</span></span>
<span id="LC882" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg1"</span><span class="o">,</span> <span class="s">"Echec du processus XSL."</span><span class="o">},</span></span>
<span id="LC883" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg2"</span><span class="o">,</span> <span class="s">"** Analyseur introuvable **"</span><span class="o">},</span></span>
<span id="LC884" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg3"</span><span class="o">,</span> <span class="s">"V\u00E9rifiez votre variable d'environnement CLASSPATH."</span><span class="o">},</span></span>
<span id="LC885" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg4"</span><span class="o">,</span> <span class="s">"Si vous ne disposez pas de l'analyseur XML pour Java d'IBM, vous pouvez le t\u00E9l\u00E9charger sur le site"</span><span class="o">},</span></span>
<span id="LC886" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg5"</span><span class="o">,</span> <span class="s">"AlphaWorks d'IBM : http://www.alphaworks.ibm.com/formula/xml"</span><span class="o">},</span></span>
