...
<span id="LC34" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XPATHErrorResources_zh_TW</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span></span>
...
<span id="LC361" class="line" lang="java">  <span class="o">{</span> <span class="no">ER_CURRENT_NOT_ALLOWED_IN_MATCH</span><span class="o">,</span> <span class="s">"\u914D\u5C0D\u6A23\u5F0F\u4E2D\u4E0D\u5141\u8A31 current() \u51FD\u6578\uFF01"</span> <span class="o">},</span></span>
<span id="LC362" class="line" lang="java"></span>
<span id="LC363" class="line" lang="java">  <span class="o">{</span> <span class="no">ER_CURRENT_TAKES_NO_ARGS</span><span class="o">,</span> <span class="s">"current() \u51FD\u6578\u4E0D\u63A5\u53D7\u5F15\u6578\uFF01"</span> <span class="o">},</span></span>
...
<span id="LC366" class="line" lang="java">      <span class="s">"document() \u51FD\u6578\u5BE6\u884C\u5DF2\u7531 com.sun.org.apache.xalan.internal.xslt.FuncDocument \u53D6\u4EE3\u3002"</span><span class="o">},</span></span>
...
<span id="LC369" class="line" lang="java">      <span class="s">"\u76F8\u95DC\u8CC7\u8A0A\u74B0\u5883\u4E0D\u5177\u6709\u64C1\u6709\u8005\u6587\u4EF6\uFF01"</span><span class="o">},</span></span>
...
<span id="LC372" class="line" lang="java">      <span class="s">"local-name() \u5177\u6709\u904E\u591A\u7684\u5F15\u6578\u3002"</span><span class="o">},</span></span>
...
<span id="LC375" class="line" lang="java">      <span class="s">"namespace-uri() \u5177\u6709\u904E\u591A\u7684\u5F15\u6578\u3002"</span><span class="o">},</span></span>
...
<span id="LC378" class="line" lang="java">      <span class="s">"normalize-space() \u5177\u6709\u904E\u591A\u7684\u5F15\u6578\u3002"</span><span class="o">},</span></span>
...
<span id="LC381" class="line" lang="java">      <span class="s">"number() \u5177\u6709\u904E\u591A\u7684\u5F15\u6578\u3002"</span><span class="o">},</span></span>
...
<span id="LC384" class="line" lang="java">     <span class="s">"name() \u5177\u6709\u904E\u591A\u7684\u5F15\u6578\u3002"</span><span class="o">},</span></span>
...
<span id="LC387" class="line" lang="java">      <span class="s">"string() \u5177\u6709\u904E\u591A\u7684\u5F15\u6578\u3002"</span><span class="o">},</span></span>
...
<span id="LC390" class="line" lang="java">      <span class="s">"string-length() \u5177\u6709\u904E\u591A\u7684\u5F15\u6578\u3002"</span><span class="o">},</span></span>
...
<span id="LC393" class="line" lang="java">      <span class="s">"translate() \u51FD\u6578\u63A5\u53D7\u4E09\u500B\u5F15\u6578\uFF01"</span><span class="o">},</span></span>
...
<span id="LC396" class="line" lang="java">      <span class="s">"unparsed-entity-uri \u51FD\u6578\u61C9\u63A5\u53D7\u4E00\u500B\u5F15\u6578\uFF01"</span><span class="o">},</span></span>
...
<span id="LC399" class="line" lang="java">      <span class="s">"\u5C1A\u672A\u5BE6\u884C\u547D\u540D\u7A7A\u9593\u8EF8\uFF01"</span><span class="o">},</span></span>
...
<span id="LC402" class="line" lang="java">     <span class="s">"\u4E0D\u660E\u7684\u8EF8: {0}"</span><span class="o">},</span></span>
...
<span id="LC405" class="line" lang="java">     <span class="s">"\u4E0D\u660E\u7684\u914D\u5C0D\u4F5C\u696D\uFF01"</span><span class="o">},</span></span>
...
<span id="LC408" class="line" lang="java">      <span class="s">"processing-instruction() \u7BC0\u9EDE\u7684\u5F15\u6578\u9577\u5EA6\u4E0D\u6B63\u78BA\uFF01"</span><span class="o">},</span></span>
...
<span id="LC411" class="line" lang="java">      <span class="s">"\u7121\u6CD5\u8F49\u63DB {0} \u70BA\u6578\u5B57"</span><span class="o">},</span></span>
...
<span id="LC414" class="line" lang="java">      <span class="s">"\u7121\u6CD5\u8F49\u63DB {0} \u70BA NodeList\uFF01"</span><span class="o">},</span></span>
...
<span id="LC417" class="line" lang="java">      <span class="s">"\u7121\u6CD5\u8F49\u63DB {0} \u70BA NodeSetDTM\uFF01"</span><span class="o">},</span></span>
...
<span id="LC420" class="line" lang="java">      <span class="s">"\u7121\u6CD5\u8F49\u63DB {0} \u70BA type#{1}"</span><span class="o">},</span></span>
...
<span id="LC423" class="line" lang="java">      <span class="s">"\u5728 getMatchScore \u4E2D\u9810\u671F\u914D\u5C0D\u6A23\u5F0F"</span><span class="o">},</span></span>
...
<span id="LC426" class="line" lang="java">      <span class="s">"\u7121\u6CD5\u53D6\u5F97\u540D\u7A31\u70BA {0} \u7684\u8B8A\u6578"</span><span class="o">},</span></span>
...
<span id="LC429" class="line" lang="java">     <span class="s">"\u932F\u8AA4\uFF01\u4E0D\u660E\u7684\u4F5C\u696D\u4EE3\u78BC: {0}"</span><span class="o">},</span></span>
...
<span id="LC432" class="line" lang="java">     <span class="s">"\u984D\u5916\u7684\u7121\u6548\u8A18\u865F: {0}"</span><span class="o">},</span></span>
...
<span id="LC435" class="line" lang="java">      <span class="s">"\u5F15\u865F\u932F\u8AA4\u7684\u6587\u5B57... \u9810\u671F\u96D9\u5F15\u865F\uFF01"</span><span class="o">},</span></span>
...
<span id="LC438" class="line" lang="java">      <span class="s">"\u5F15\u865F\u932F\u8AA4\u7684\u6587\u5B57... \u9810\u671F\u55AE\u5F15\u865F\uFF01"</span><span class="o">},</span></span>
...
<span id="LC441" class="line" lang="java">     <span class="s">"\u7A7A\u767D\u8868\u793A\u5F0F\uFF01"</span><span class="o">},</span></span>
...
<span id="LC444" class="line" lang="java">     <span class="s">"\u9810\u671F {0}\uFF0C\u4F46\u627E\u5230: {1}"</span><span class="o">},</span></span>
...
<span id="LC447" class="line" lang="java">      <span class="s">"\u7A0B\u5F0F\u8A2D\u8A08\u4EBA\u54E1\u5BA3\u544A\u4E0D\u6B63\u78BA\uFF01- {0}"</span><span class="o">},</span></span>
...
<span id="LC450" class="line" lang="java">      <span class="s">"\u6839\u64DA 19990709 XPath \u8349\u6848\uFF0Cboolean(...) \u4E0D\u518D\u662F\u9078\u64C7\u6027\u5F15\u6578\u3002"</span><span class="o">},</span></span>
...
<span id="LC453" class="line" lang="java">      <span class="s">"\u627E\u5230 ',' \u4F46\u6C92\u6709\u5148\u524D\u7684\u5F15\u6578\uFF01"</span><span class="o">},</span></span>
...
<span id="LC456" class="line" lang="java">      <span class="s">"\u627E\u5230 ',' \u4F46\u6C92\u6709\u5F8C\u7E8C\u7684\u5F15\u6578\uFF01"</span><span class="o">},</span></span>
...
<span id="LC459" class="line" lang="java">      <span class="s">"'..[predicate]' \u6216 '.[predicate]' \u662F\u7121\u6548\u7684\u8A9E\u6CD5\u3002\u8ACB\u6539\u7528 'self::node()[predicate]'\u3002"</span><span class="o">},</span></span>
...
<span id="LC462" class="line" lang="java">     <span class="s">"\u7121\u6548\u7684\u8EF8\u540D\u7A31: {0}"</span><span class="o">},</span></span>
...
<span id="LC465" class="line" lang="java">     <span class="s">"\u4E0D\u660E\u7684 nodetype: {0}"</span><span class="o">},</span></span>
...
<span id="LC468" class="line" lang="java">      <span class="s">"\u6A23\u5F0F\u6587\u5B57 ({0}) \u9700\u8981\u52A0\u4E0A\u5F15\u865F\uFF01"</span><span class="o">},</span></span>
...
<span id="LC471" class="line" lang="java">      <span class="s">"{0} \u7121\u6CD5\u683C\u5F0F\u5316\u70BA\u6578\u5B57\uFF01"</span><span class="o">},</span></span>
...
<span id="LC474" class="line" lang="java">      <span class="s">"\u7121\u6CD5\u5EFA\u7ACB XML TransformerFactory Liaison: {0}"</span><span class="o">},</span></span>
...
<span id="LC477" class="line" lang="java">      <span class="s">"\u932F\u8AA4\uFF01\u627E\u4E0D\u5230 xpath \u9078\u53D6\u8868\u793A\u5F0F (-select)\u3002"</span><span class="o">},</span></span>
...
<span id="LC480" class="line" lang="java">      <span class="s">"\u932F\u8AA4\uFF01\u5728 OP_LOCATIONPATH \u4E4B\u5F8C\u627E\u4E0D\u5230 ENDOP"</span><span class="o">},</span></span>
...
<span id="LC483" class="line" lang="java">     <span class="s">"\u767C\u751F\u932F\u8AA4\uFF01"</span><span class="o">},</span></span>
...
<span id="LC486" class="line" lang="java">      <span class="s">"\u70BA\u8B8A\u6578\u6307\u5B9A\u7684 VariableReference \u8D85\u51FA\u76F8\u95DC\u8CC7\u8A0A\u74B0\u5883\u6216\u6C92\u6709\u5B9A\u7FA9\uFF01\u540D\u7A31 = {0}"</span><span class="o">},</span></span>
...
<span id="LC489" class="line" lang="java">      <span class="s">"\u914D\u5C0D\u6A23\u5F0F\u4E2D\u50C5\u5141\u8A31 child:: \u8207 attribute:: \u8EF8\uFF01\u9055\u53CD\u7684\u8EF8 = {0}"</span><span class="o">},</span></span>
...
<span id="LC492" class="line" lang="java">      <span class="s">"key() \u5177\u6709\u4E0D\u6B63\u78BA\u7684\u5F15\u6578\u6578\u76EE\u3002"</span><span class="o">},</span></span>
...
<span id="LC495" class="line" lang="java">      <span class="s">"count \u51FD\u6578\u61C9\u63A5\u53D7\u4E00\u500B\u5F15\u6578\uFF01"</span><span class="o">},</span></span>
...
<span id="LC498" class="line" lang="java">     <span class="s">"\u627E\u4E0D\u5230\u51FD\u6578: {0}"</span><span class="o">},</span></span>
...
<span id="LC501" class="line" lang="java">     <span class="s">"\u4E0D\u652F\u63F4\u7684\u7DE8\u78BC: {0}"</span><span class="o">},</span></span>
...
<span id="LC504" class="line" lang="java">      <span class="s">"\u5728 getNextSibling \u7684 DTM \u4E2D\u767C\u751F\u554F\u984C... \u6B63\u5728\u5617\u8A66\u5FA9\u539F"</span><span class="o">},</span></span>
...
<span id="LC507" class="line" lang="java">      <span class="s">"\u7A0B\u5F0F\u8A2D\u8A08\u4EBA\u54E1\u932F\u8AA4: \u7121\u6CD5\u5BEB\u5165 EmptyNodeList\u3002"</span><span class="o">},</span></span>
...
<span id="LC510" class="line" lang="java">      <span class="s">"XPathContext \u4E0D\u652F\u63F4 setDOMFactory\uFF01"</span><span class="o">},</span></span>
...
<span id="LC513" class="line" lang="java">      <span class="s">"\u524D\u7F6E\u78BC\u5FC5\u9808\u89E3\u6790\u70BA\u547D\u540D\u7A7A\u9593: {0}"</span><span class="o">},</span></span>
...
<span id="LC516" class="line" lang="java">      <span class="s">"XPathContext \u4E2D\u4E0D\u652F\u63F4 parse (InputSource \u4F86\u6E90)\u3002\u7121\u6CD5\u958B\u555F {0}"</span><span class="o">},</span></span>
...
<span id="LC519" class="line" lang="java">      <span class="s">"SAX API characters(char ch[]... \u4E26\u975E\u7531 DTM \u8655\u7406\uFF01"</span><span class="o">},</span></span>
...
<span id="LC522" class="line" lang="java">      <span class="s">"ignorableWhitespace(char ch[]... \u4E26\u975E\u7531 DTM \u8655\u7406\uFF01"</span><span class="o">},</span></span>
...
<span id="LC525" class="line" lang="java">      <span class="s">"DTMLiaison \u7121\u6CD5\u8655\u7406\u985E\u578B {0} \u7684\u63A7\u5236\u4EE3\u78BC\u7BC0\u9EDE"</span><span class="o">},</span></span>
...
<span id="LC528" class="line" lang="java">      <span class="s">"DOM2Helper \u7121\u6CD5\u8655\u7406\u985E\u578B {0} \u7684\u63A7\u5236\u4EE3\u78BC\u7BC0\u9EDE"</span><span class="o">},</span></span>
...
<span id="LC531" class="line" lang="java">      <span class="s">"DOM2Helper.parse \u932F\u8AA4: SystemID - {0} \u884C - {1}"</span><span class="o">},</span></span>
...
<span id="LC534" class="line" lang="java">     <span class="s">"DOM2Helper.parse \u932F\u8AA4"</span><span class="o">},</span></span>
...
<span id="LC537" class="line" lang="java">      <span class="s">"\u5075\u6E2C\u5230\u7121\u6548\u7684 UTF-16 \u4EE3\u7406: {0}\uFF1F"</span><span class="o">},</span></span>
...
<span id="LC540" class="line" lang="java">     <span class="s">"IO \u932F\u8AA4"</span><span class="o">},</span></span>
...
<span id="LC543" class="line" lang="java">     <span class="s">"\u7121\u6CD5\u70BA {0} \u5EFA\u7ACB url"</span><span class="o">},</span></span>
...
<span id="LC546" class="line" lang="java">     <span class="s">"\u5728 XPath.readObject \u4E2D: {0}"</span><span class="o">},</span></span>
...
<span id="LC549" class="line" lang="java">      <span class="s">"\u627E\u4E0D\u5230\u51FD\u6578\u8A18\u865F\u3002"</span><span class="o">},</span></span>
...
<span id="LC552" class="line" lang="java">       <span class="s">"\u7121\u6CD5\u8655\u7406 XPath \u985E\u578B: {0}"</span><span class="o">},</span></span>
...
<span id="LC555" class="line" lang="java">       <span class="s">"\u6B64 NodeSet \u4E0D\u53EF\u8B8A\u66F4"</span><span class="o">},</span></span>
...
<span id="LC558" class="line" lang="java">       <span class="s">"\u6B64 NodeSetDTM \u4E0D\u53EF\u8B8A\u66F4"</span><span class="o">},</span></span>
...
<span id="LC561" class="line" lang="java">        <span class="s">"\u8B8A\u6578\u7121\u6CD5\u89E3\u6790: {0}"</span><span class="o">},</span></span>
...
<span id="LC564" class="line" lang="java">        <span class="s">"\u7A7A\u503C\u932F\u8AA4\u8655\u7406\u7A0B\u5F0F"</span><span class="o">},</span></span>
...
<span id="LC567" class="line" lang="java">       <span class="s">"\u7A0B\u5F0F\u8A2D\u8A08\u4EBA\u54E1\u5BA3\u544A: \u4E0D\u660E\u7684 opcode: {0}"</span><span class="o">},</span></span>
...
<span id="LC570" class="line" lang="java">       <span class="s">"0 \u6216 1"</span><span class="o">},</span></span>
...
<span id="LC573" class="line" lang="java">       <span class="s">"XRTreeFragSelectWrapper \u4E0D\u652F\u63F4 rtf()"</span><span class="o">},</span></span>
...
<span id="LC576" class="line" lang="java">       <span class="s">"XRTreeFragSelectWrapper \u4E0D\u652F\u63F4 asNodeIterator()"</span><span class="o">},</span></span>
...
<span id="LC580" class="line" lang="java">                <span class="s">"XRTreeFragSelectWrapper \u4E0D\u652F\u63F4 detach()"</span><span class="o">},</span></span>
...
<span id="LC584" class="line" lang="java">                <span class="s">"XRTreeFragSelectWrapper \u4E0D\u652F\u63F4 num()"</span><span class="o">},</span></span>
...
<span id="LC588" class="line" lang="java">                <span class="s">"XRTreeFragSelectWrapper \u4E0D\u652F\u63F4 xstr()"</span><span class="o">},</span></span>
...
<span id="LC592" class="line" lang="java">                <span class="s">"XRTreeFragSelectWrapper \u4E0D\u652F\u63F4 str()"</span><span class="o">},</span></span>
...
<span id="LC595" class="line" lang="java">       <span class="s">"XStringForChars \u4E0D\u652F\u63F4 fsb()"</span><span class="o">},</span></span>
...
<span id="LC598" class="line" lang="java">      <span class="s">"\u627E\u4E0D\u5230\u540D\u7A31\u70BA {0} \u7684\u8B8A\u6578"</span><span class="o">},</span></span>
...
<span id="LC601" class="line" lang="java">      <span class="s">"XStringForChars \u7121\u6CD5\u63A5\u53D7\u5B57\u4E32\u4F5C\u70BA\u5F15\u6578"</span><span class="o">},</span></span>
...
<span id="LC604" class="line" lang="java">      <span class="s">"FastStringBuffer \u5F15\u6578\u4E0D\u53EF\u70BA\u7A7A\u503C"</span><span class="o">},</span></span>
...
<span id="LC607" class="line" lang="java">       <span class="s">"2 \u6216 3"</span><span class="o">},</span></span>
...
<span id="LC610" class="line" lang="java">       <span class="s">"\u8B8A\u6578\u9023\u7D50\u4E4B\u524D\u4FBF\u9032\u884C\u5B58\u53D6\uFF01"</span><span class="o">},</span></span>
...
<span id="LC613" class="line" lang="java">       <span class="s">"XStringForFSB \u7121\u6CD5\u63A5\u53D7\u5B57\u4E32\u4F5C\u70BA\u5F15\u6578\uFF01"</span><span class="o">},</span></span>
...
<span id="LC619" class="line" lang="java">       <span class="s">"\u6B64 NodeSetDTM \u7121\u6CD5\u91CD\u8907\u5148\u524D\u7684\u7BC0\u9EDE\uFF01"</span><span class="o">},</span></span>
...
<span id="LC622" class="line" lang="java">       <span class="s">"\u6B64 NodeSet \u7121\u6CD5\u91CD\u8907\u5148\u524D\u7684\u7BC0\u9EDE\uFF01"</span><span class="o">},</span></span>
...
<span id="LC625" class="line" lang="java">       <span class="s">"\u6B64 NodeSetDTM \u7121\u6CD5\u57F7\u884C\u88FD\u4F5C\u7D22\u5F15\u6216\u8A08\u6578\u529F\u80FD\uFF01"</span><span class="o">},</span></span>
...
<span id="LC628" class="line" lang="java">       <span class="s">"\u6B64 NodeSet \u7121\u6CD5\u57F7\u884C\u88FD\u4F5C\u7D22\u5F15\u6216\u8A08\u6578\u529F\u80FD\uFF01"</span><span class="o">},</span></span>
...
<span id="LC631" class="line" lang="java">       <span class="s">"\u547C\u53EB nextNode \u4E4B\u5F8C\uFF0C\u7121\u6CD5\u547C\u53EB setShouldCacheNodes\uFF01"</span><span class="o">},</span></span>
...
<span id="LC634" class="line" lang="java">       <span class="s">"{0} \u50C5\u5141\u8A31 {1} \u500B\u5F15\u6578"</span><span class="o">},</span></span>
...
<span id="LC637" class="line" lang="java">       <span class="s">"\u5728 getNextStepPos \u4E2D\u7A0B\u5F0F\u8A2D\u8A08\u4EBA\u54E1\u7684\u5BA3\u544A: \u4E0D\u660E\u7684 stepType: {0}"</span><span class="o">},</span></span>
...
<span id="LC643" class="line" lang="java">      <span class="s">"'/' \u6216 '//' \u8A18\u865F\u4E4B\u5F8C\uFF0C\u9810\u671F\u76F8\u5C0D\u4F4D\u7F6E\u8DEF\u5F91\u3002"</span><span class="o">},</span></span>
...
<span id="LC649" class="line" lang="java">       <span class="s">"\u9810\u671F\u4F4D\u7F6E\u8DEF\u5F91\uFF0C\u4F46\u51FA\u73FE\u4E0B\u5217\u8A18\u865F:  {0}"</span><span class="o">},</span></span>
...
<span id="LC655" class="line" lang="java">       <span class="s">"\u9810\u671F\u4F4D\u7F6E\u8DEF\u5F91\uFF0C\u4F46\u51FA\u73FE XPath \u8868\u793A\u5F0F\u7684\u7D50\u5C3E\u3002"</span><span class="o">},</span></span>
...
<span id="LC661" class="line" lang="java">       <span class="s">"'/' \u6216 '//' \u8A18\u865F\u4E4B\u5F8C\uFF0C\u9810\u671F\u4F4D\u7F6E\u6B65\u9A5F\u3002"</span><span class="o">},</span></span>
...
<span id="LC668" class="line" lang="java">       <span class="s">"\u9810\u671F\u7B26\u5408 NCName:* \u6216 QName \u7684\u7BC0\u9EDE\u6E2C\u8A66\u3002"</span><span class="o">},</span></span>
...
<span id="LC674" class="line" lang="java">       <span class="s">"\u9810\u671F\u6B65\u9A5F\u6A23\u5F0F\uFF0C\u4F46\u51FA\u73FE '/'\u3002"</span><span class="o">},</span></span>
...
<span id="LC680" class="line" lang="java">       <span class="s">"\u9810\u671F\u76F8\u5C0D\u8DEF\u5F91\u6A23\u5F0F\u3002"</span><span class="o">},</span></span>
...
<span id="LC686" class="line" lang="java">       <span class="s">"XPath \u8868\u793A\u5F0F ''{0}'' \u7684 XPathResult \u5177\u6709 XPathResultType \u7684 {1}\uFF0C\u5B83\u7121\u6CD5\u8F49\u63DB\u70BA\u5E03\u6797\u503C\u3002"</span><span class="o">},</span></span>
...
<span id="LC691" class="line" lang="java">       <span class="s">"XPath \u8868\u793A\u5F0F ''{0}'' \u7684 XPathResult \u5177\u6709 XPathResultType \u7684 {1}\uFF0C\u5B83\u7121\u6CD5\u8F49\u63DB\u70BA\u55AE\u4E00\u7BC0\u9EDE\u3002\u65B9\u6CD5 getSingleNodeValue \u50C5\u9069\u7528\u65BC\u985E\u578B ANY_UNORDERED_NODE_TYPE \u8207 FIRST_ORDERED_NODE_TYPE\u3002"</span><span class="o">},</span></span>
...
<span id="LC696" class="line" lang="java">       <span class="s">"\u7121\u6CD5\u5728 XPath \u8868\u793A\u5F0F ''{0}'' \u7684 XPathResult \u4E0A\u547C\u53EB\u65B9\u6CD5 getSnapshotLength\uFF0C\u56E0\u70BA\u5B83\u7684 XPathResultType \u662F {1}\u3002\u6B64\u65B9\u6CD5\u50C5\u9069\u7528\u65BC\u985E\u578B UNORDERED_NODE_SNAPSHOT_TYPE \u8207 ORDERED_NODE_SNAPSHOT_TYPE\u3002"</span><span class="o">},</span></span>
...
<span id="LC699" class="line" lang="java">       <span class="s">"\u7121\u6CD5\u5728 XPath \u8868\u793A\u5F0F ''{0}'' \u7684 XPathResult \u4E0A\u547C\u53EB\u65B9\u6CD5 iterateNext\uFF0C\u56E0\u70BA\u5B83\u7684 XPathResultType \u662F {1}\u3002\u6B64\u65B9\u6CD5\u50C5\u9069\u7528\u65BC\u985E\u578B UNORDERED_NODE_ITERATOR_TYPE \u8207 ORDERED_NODE_ITERATOR_TYPE\u3002"</span><span class="o">},</span></span>
...
<span id="LC705" class="line" lang="java">       <span class="s">"\u7D50\u679C\u50B3\u56DE\u5F8C\u6587\u4EF6\u5DF2\u8B8A\u66F4\u3002\u91CD\u8907\u7A0B\u5F0F\u7121\u6548\u3002"</span><span class="o">},</span></span>
...
<span id="LC708" class="line" lang="java">       <span class="s">"\u7121\u6548\u7684 XPath \u985E\u578B\u5F15\u6578: {0}"</span><span class="o">},</span></span>
...
<span id="LC711" class="line" lang="java">       <span class="s">"\u7A7A\u767D\u7684 XPath \u7D50\u679C\u7269\u4EF6"</span><span class="o">},</span></span>
...
<span id="LC714" class="line" lang="java">       <span class="s">"XPath \u8868\u793A\u5F0F ''{0}'' \u7684 XPathResult \u5177\u6709 XPathResultType \u7684 {1}\uFF0C\u5B83\u7121\u6CD5\u5F37\u5236\u8F49\u6210 {2} \u6307\u5B9A\u7684 XPathResultType\u3002"</span><span class="o">},</span></span>
...
<span id="LC717" class="line" lang="java">       <span class="s">"\u7121\u6CD5\u4EE5\u7A7A\u503C\u524D\u7F6E\u78BC\u89E3\u6790\u5668\u4F86\u89E3\u6790\u524D\u7F6E\u78BC\u3002"</span><span class="o">},</span></span>
...
<span id="LC723" class="line" lang="java">       <span class="s">"XPath \u8868\u793A\u5F0F ''{0}'' \u7684 XPathResult \u5177\u6709 XPathResultType \u7684 {1}\uFF0C\u5B83\u7121\u6CD5\u8F49\u63DB\u70BA\u5B57\u4E32\u3002"</span><span class="o">},</span></span>
...
<span id="LC728" class="line" lang="java">       <span class="s">"\u7121\u6CD5\u5728 XPath \u8868\u793A\u5F0F ''{0}'' \u7684 XPathResult \u4E0A\u547C\u53EB\u65B9\u6CD5 snapshotItem\uFF0C\u56E0\u70BA\u5B83\u7684 XPathResultType \u662F {1}\u3002\u6B64\u65B9\u6CD5\u50C5\u9069\u7528\u65BC\u985E\u578B UNORDERED_NODE_SNAPSHOT_TYPE \u8207 ORDERED_NODE_SNAPSHOT_TYPE\u3002"</span><span class="o">},</span></span>
...
<span id="LC735" class="line" lang="java">       <span class="s">"\u76F8\u95DC\u8CC7\u8A0A\u74B0\u5883\u7BC0\u9EDE\u4E0D\u5C6C\u65BC\u9023\u7D50\u81F3\u6B64 XPathEvaluator \u7684\u6587\u4EF6\u3002"</span><span class="o">},</span></span>
...
<span id="LC740" class="line" lang="java">       <span class="s">"\u4E0D\u652F\u63F4\u76F8\u95DC\u8CC7\u8A0A\u74B0\u5883\u7BC0\u9EDE\u985E\u578B\u3002"</span><span class="o">},</span></span>
...
<span id="LC743" class="line" lang="java">       <span class="s">"XPath \u767C\u751F\u4E0D\u660E\u7684\u932F\u8AA4\u3002"</span><span class="o">},</span></span>
...
<span id="LC746" class="line" lang="java">        <span class="s">"XPath \u8868\u793A\u5F0F ''{0}'' \u7684 XPathResult \u5177\u6709 XPathResultType \u7684 {1}\uFF0C\u5B83\u7121\u6CD5\u8F49\u63DB\u70BA\u6578\u5B57\u3002"</span><span class="o">},</span></span>
...
<span id="LC753" class="line" lang="java">       <span class="s">"\u7576 XMLConstants.FEATURE_SECURE_PROCESSING \u529F\u80FD\u8A2D\u70BA\u771F\u6642\uFF0C\u7121\u6CD5\u547C\u53EB\u64F4\u5145\u51FD\u6578: ''{0}''\u3002"</span><span class="o">},</span></span>
...
<span id="LC758" class="line" lang="java">       <span class="s">"\u8B8A\u6578 {0} \u7684 resolveVariable \u50B3\u56DE\u7A7A\u503C"</span><span class="o">},</span></span>
...
<span id="LC763" class="line" lang="java">       <span class="s">"\u4E0D\u652F\u63F4\u7684\u50B3\u56DE\u985E\u578B: {0}"</span><span class="o">},</span></span>
...
<span id="LC768" class="line" lang="java">       <span class="s">"\u4F86\u6E90\u548C (\u6216) \u50B3\u56DE\u985E\u578B\u4E0D\u53EF\u70BA\u7A7A\u503C"</span><span class="o">},</span></span>
...
<span id="LC773" class="line" lang="java">       <span class="s">"\u4F86\u6E90\u548C (\u6216) \u50B3\u56DE\u985E\u578B\u4E0D\u53EF\u70BA\u7A7A\u503C"</span><span class="o">},</span></span>
...
<span id="LC778" class="line" lang="java">       <span class="s">"{0} \u5F15\u6578\u4E0D\u53EF\u70BA\u7A7A\u503C"</span><span class="o">},</span></span>
...
<span id="LC783" class="line" lang="java">       <span class="s">"{0}#isObjectModelSupported( String objectModel ) \u7121\u6CD5\u4F7F\u7528 objectModel == null \u4F86\u547C\u53EB"</span><span class="o">},</span></span>
...
<span id="LC788" class="line" lang="java">       <span class="s">"{0}#isObjectModelSupported( String objectModel ) \u7121\u6CD5\u4F7F\u7528 objectModel == \"\" \u4F86\u547C\u53EB"</span><span class="o">},</span></span>
...
<span id="LC793" class="line" lang="java">       <span class="s">"\u5617\u8A66\u4EE5\u7A7A\u503C\u540D\u7A31\u8A2D\u5B9A\u529F\u80FD: {0}#setFeature( null, {1})"</span><span class="o">},</span></span>
...
<span id="LC798" class="line" lang="java">       <span class="s">"\u5617\u8A66\u8A2D\u5B9A\u4E0D\u660E\u7684\u529F\u80FD \"{0}\":{1}#setFeature({0},{2})"</span><span class="o">},</span></span>
...
<span id="LC803" class="line" lang="java">       <span class="s">"\u5617\u8A66\u4EE5\u7A7A\u503C\u540D\u7A31\u53D6\u5F97\u529F\u80FD: {0}#getFeature(null)"</span><span class="o">},</span></span>
...
<span id="LC808" class="line" lang="java">       <span class="s">"\u5617\u8A66\u53D6\u5F97\u4E0D\u660E\u7684\u529F\u80FD \"{0}\":{1}#getFeature({0})"</span><span class="o">},</span></span>
...
<span id="LC811" class="line" lang="java">        <span class="s">"FEATURE_SECURE_PROCESSING: \u5B89\u5168\u7BA1\u7406\u7A0B\u5F0F\u5B58\u5728\u6642\uFF0C\u7121\u6CD5\u5C07\u529F\u80FD\u8A2D\u70BA\u507D: {1}#setFeature({0},{2})"</span><span class="o">},</span></span>
...
<span id="LC816" class="line" lang="java">       <span class="s">"\u5617\u8A66\u8A2D\u5B9A\u7A7A\u503C XPathFunctionResolver:{0}#setXPathFunctionResolver(null)"</span><span class="o">},</span></span>
...
<span id="LC821" class="line" lang="java">       <span class="s">"\u5617\u8A66\u8A2D\u5B9A\u7A7A\u503C XPathVariableResolver:{0}#setXPathVariableResolver(null)"</span><span class="o">},</span></span>
...
<span id="LC828" class="line" lang="java">      <span class="s">"\u5C1A\u672A\u8655\u7406 format-number \u51FD\u6578\u4E2D\u7684\u5730\u5340\u8A2D\u5B9A\u540D\u7A31\uFF01"</span><span class="o">},</span></span>
...
<span id="LC831" class="line" lang="java">      <span class="s">"\u4E0D\u652F\u63F4 XSL \u5C6C\u6027: {0}"</span><span class="o">},</span></span>
...
<span id="LC834" class="line" lang="java">      <span class="s">"\u76EE\u524D\u4E0D\u6703\u8655\u7406\u5C6C\u6027\u4E2D\u7684\u547D\u540D\u7A7A\u9593 {0}: {1}"</span><span class="o">},</span></span>
...
<span id="LC837" class="line" lang="java">      <span class="s">"\u5617\u8A66\u5B58\u53D6 XSL \u7CFB\u7D71\u5C6C\u6027\u6642\u767C\u751F SecurityException: {0}"</span><span class="o">},</span></span>
...
<span id="LC840" class="line" lang="java">      <span class="s">"\u820A\u8A9E\u6CD5: XPath \u4E2D\u4E0D\u518D\u5B9A\u7FA9 quo(...)\u3002"</span><span class="o">},</span></span>
...
<span id="LC843" class="line" lang="java">      <span class="s">"XPath \u9700\u8981\u884D\u751F\u7684\u7269\u4EF6\u4F86\u5BE6\u884C nodeTest\uFF01"</span><span class="o">},</span></span>
...
<span id="LC846" class="line" lang="java">      <span class="s">"\u627E\u4E0D\u5230\u51FD\u6578\u8A18\u865F\u3002"</span><span class="o">},</span></span>
...
<span id="LC849" class="line" lang="java">      <span class="s">"\u627E\u4E0D\u5230\u51FD\u6578: {0}"</span><span class="o">},</span></span>
...
<span id="LC852" class="line" lang="java">      <span class="s">"\u7121\u6CD5\u5F9E {0} \u5EFA\u7ACB URL"</span><span class="o">},</span></span>
...
<span id="LC855" class="line" lang="java">      <span class="s">"DTM \u5256\u6790\u5668\u4E0D\u652F\u63F4 -E \u9078\u9805"</span><span class="o">},</span></span>
...
<span id="LC858" class="line" lang="java">      <span class="s">"\u70BA\u8B8A\u6578\u6307\u5B9A\u7684 VariableReference \u8D85\u51FA\u76F8\u95DC\u8CC7\u8A0A\u74B0\u5883\u6216\u6C92\u6709\u5B9A\u7FA9\uFF01\u540D\u7A31 = {0}"</span><span class="o">},</span></span>
...
<span id="LC861" class="line" lang="java">     <span class="s">"\u4E0D\u652F\u63F4\u7684\u7DE8\u78BC: {0}"</span><span class="o">},</span></span>
...
<span id="LC866" class="line" lang="java">  <span class="o">{</span> <span class="s">"ui_language"</span><span class="o">,</span> <span class="s">"tw"</span><span class="o">},</span></span>
<span id="LC867" class="line" lang="java">  <span class="o">{</span> <span class="s">"help_language"</span><span class="o">,</span> <span class="s">"tw"</span><span class="o">},</span></span>
<span id="LC868" class="line" lang="java">  <span class="o">{</span> <span class="s">"language"</span><span class="o">,</span> <span class="s">"tw"</span><span class="o">},</span></span>
<span id="LC869" class="line" lang="java">  <span class="o">{</span> <span class="s">"BAD_CODE"</span><span class="o">,</span> <span class="s">"createMessage \u7684\u53C3\u6578\u8D85\u51FA\u7BC4\u570D"</span><span class="o">},</span></span>
<span id="LC870" class="line" lang="java">  <span class="o">{</span> <span class="s">"FORMAT_FAILED"</span><span class="o">,</span> <span class="s">"messageFormat \u547C\u53EB\u671F\u9593\u767C\u751F\u7570\u5E38\u72C0\u6CC1"</span><span class="o">},</span></span>
<span id="LC871" class="line" lang="java">  <span class="o">{</span> <span class="s">"version"</span><span class="o">,</span> <span class="s">"&gt;&gt;&gt;&gt;&gt;&gt;&gt; Xalan \u7248\u672C "</span><span class="o">},</span></span>
...
<span id="LC873" class="line" lang="java">  <span class="o">{</span> <span class="s">"yes"</span><span class="o">,</span> <span class="s">"\u662F"</span><span class="o">},</span></span>
<span id="LC874" class="line" lang="java">  <span class="o">{</span> <span class="s">"line"</span><span class="o">,</span> <span class="s">"\u884C\u865F"</span><span class="o">},</span></span>
<span id="LC875" class="line" lang="java">  <span class="o">{</span> <span class="s">"column"</span><span class="o">,</span> <span class="s">"\u8CC7\u6599\u6B04\u7DE8\u865F"</span><span class="o">},</span></span>
<span id="LC876" class="line" lang="java">  <span class="o">{</span> <span class="s">"xsldone"</span><span class="o">,</span> <span class="s">"XSLProcessor: \u5B8C\u6210"</span><span class="o">},</span></span>
<span id="LC877" class="line" lang="java">  <span class="o">{</span> <span class="s">"xpath_option"</span><span class="o">,</span> <span class="s">"xpath \u9078\u9805: "</span><span class="o">},</span></span>
...
<span id="LC879" class="line" lang="java">  <span class="o">{</span> <span class="s">"optionSelect"</span><span class="o">,</span> <span class="s">"   [-select xpath \u8868\u793A\u5F0F]"</span><span class="o">},</span></span>
<span id="LC880" class="line" lang="java">  <span class="o">{</span> <span class="s">"optionMatch"</span><span class="o">,</span> <span class="s">"   [-match \u914D\u5C0D\u6A23\u5F0F (\u91DD\u5C0D\u914D\u5C0D\u8A3A\u65B7)]"</span><span class="o">},</span></span>
<span id="LC881" class="line" lang="java">  <span class="o">{</span> <span class="s">"optionAnyExpr"</span><span class="o">,</span> <span class="s">"\u6216\u8005\uFF0C\u53EA\u6709 xpath \u8868\u793A\u5F0F\u6642\u5C07\u9032\u884C\u8A3A\u65B7\u50BE\u5370"</span><span class="o">},</span></span>
<span id="LC882" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg1"</span><span class="o">,</span> <span class="s">"XSL \u8655\u7406\u4F5C\u696D\u5931\u6557\u3002"</span><span class="o">},</span></span>
<span id="LC883" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg2"</span><span class="o">,</span> <span class="s">"** \u627E\u4E0D\u5230\u5256\u6790\u5668 **"</span><span class="o">},</span></span>
<span id="LC884" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg3"</span><span class="o">,</span> <span class="s">"\u8ACB\u6AA2\u67E5\u985E\u5225\u8DEF\u5F91\u3002"</span><span class="o">},</span></span>
<span id="LC885" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg4"</span><span class="o">,</span> <span class="s">"\u82E5\u7121 IBM \u7684 XML Parser for Java\uFF0C\u53EF\u4E0B\u8F09\u81EA"</span><span class="o">},</span></span>
<span id="LC886" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg5"</span><span class="o">,</span> <span class="s">"IBM \u7684 AlphaWorks: http://www.alphaworks.ibm.com/formula/xml"</span><span class="o">},</span></span>
