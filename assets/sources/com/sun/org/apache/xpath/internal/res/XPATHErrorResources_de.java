...
<span id="LC34" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XPATHErrorResources_de</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span></span>
...
<span id="LC361" class="line" lang="java">  <span class="o">{</span> <span class="no">ER_CURRENT_NOT_ALLOWED_IN_MATCH</span><span class="o">,</span> <span class="s">"current()-Funktion ist nicht zul\u00E4ssig in einem Vergleichsmuster."</span> <span class="o">},</span></span>
<span id="LC362" class="line" lang="java"></span>
<span id="LC363" class="line" lang="java">  <span class="o">{</span> <span class="no">ER_CURRENT_TAKES_NO_ARGS</span><span class="o">,</span> <span class="s">"current()-Funktion akzeptiert keine Argumente."</span> <span class="o">},</span></span>
...
<span id="LC366" class="line" lang="java">      <span class="s">"document()-Funktionsimplementierung wurde durch com.sun.org.apache.xalan.internal.xslt.FuncDocument ersetzt."</span><span class="o">},</span></span>
...
<span id="LC369" class="line" lang="java">      <span class="s">"Kontext hat kein Eigent\u00FCmerdokument."</span><span class="o">},</span></span>
...
<span id="LC372" class="line" lang="java">      <span class="s">"local-name() hat zu viele Argumente."</span><span class="o">},</span></span>
...
<span id="LC375" class="line" lang="java">      <span class="s">"namespace-uri() hat zu viele Argumente."</span><span class="o">},</span></span>
...
<span id="LC378" class="line" lang="java">      <span class="s">"normalize-space() hat zu viele Argumente."</span><span class="o">},</span></span>
...
<span id="LC381" class="line" lang="java">      <span class="s">"number() hat zu viele Argumente."</span><span class="o">},</span></span>
...
<span id="LC384" class="line" lang="java">     <span class="s">"name() hat zu viele Argumente."</span><span class="o">},</span></span>
...
<span id="LC387" class="line" lang="java">      <span class="s">"string() hat zu viele Argumente."</span><span class="o">},</span></span>
...
<span id="LC390" class="line" lang="java">      <span class="s">"string-length() hat zu viele Argumente."</span><span class="o">},</span></span>
...
<span id="LC393" class="line" lang="java">      <span class="s">"translate()-Funktion akzeptiert drei Argumente."</span><span class="o">},</span></span>
...
<span id="LC396" class="line" lang="java">      <span class="s">"unparsed-entity-uri-Funktion sollte ein Argument akzeptieren."</span><span class="o">},</span></span>
...
<span id="LC399" class="line" lang="java">      <span class="s">"Namespace-Achse noch nicht implementiert."</span><span class="o">},</span></span>
...
<span id="LC402" class="line" lang="java">     <span class="s">"Unbekannte Achse: {0}"</span><span class="o">},</span></span>
...
<span id="LC405" class="line" lang="java">     <span class="s">"Unbekannter Vergleichsvorgang."</span><span class="o">},</span></span>
...
<span id="LC408" class="line" lang="java">      <span class="s">"Argumentl\u00E4nge von processing-instruction()-Knotentest ist falsch."</span><span class="o">},</span></span>
...
<span id="LC411" class="line" lang="java">      <span class="s">"{0} kann nicht in eine Zahl konvertiert werden"</span><span class="o">},</span></span>
...
<span id="LC414" class="line" lang="java">      <span class="s">"{0} kann nicht in eine NodeList konvertiert werden."</span><span class="o">},</span></span>
...
<span id="LC417" class="line" lang="java">      <span class="s">"{0} kann nicht in NodeSetDTM konvertiert werden."</span><span class="o">},</span></span>
...
<span id="LC420" class="line" lang="java">      <span class="s">"{0} kann nicht in type#{1} konvertiert werden"</span><span class="o">},</span></span>
...
<span id="LC423" class="line" lang="java">      <span class="s">"Vergleichsmuster in getMatchScore erwartet."</span><span class="o">},</span></span>
...
<span id="LC426" class="line" lang="java">      <span class="s">"Variable mit Namen {0} kann nicht abgerufen werden"</span><span class="o">},</span></span>
...
<span id="LC429" class="line" lang="java">     <span class="s">"ERROR. Unbekannter Vorgangscode: {0}"</span><span class="o">},</span></span>
...
<span id="LC432" class="line" lang="java">     <span class="s">"Zus\u00E4tzliche unzul\u00E4ssige Tokens: {0}"</span><span class="o">},</span></span>
...
<span id="LC435" class="line" lang="java">      <span class="s">"Literal in falschen Anf\u00FChrungszeichen... Doppelte Anf\u00FChrungszeichen erwartet."</span><span class="o">},</span></span>
...
<span id="LC438" class="line" lang="java">      <span class="s">"Literal in falschen Anf\u00FChrungszeichen... Einzelne Anf\u00FChrungszeichen erwartet."</span><span class="o">},</span></span>
...
<span id="LC441" class="line" lang="java">     <span class="s">"Leerer Ausdruck."</span><span class="o">},</span></span>
...
<span id="LC444" class="line" lang="java">     <span class="s">"{0} erwartet, aber {1} gefunden"</span><span class="o">},</span></span>
...
<span id="LC447" class="line" lang="java">      <span class="s">"Programmierer-Assertion ist falsch. - {0}"</span><span class="o">},</span></span>
...
<span id="LC450" class="line" lang="java">      <span class="s">"boolean(...)-Argument ist nicht mehr optional bei 19990709 XPath-Entwurf."</span><span class="o">},</span></span>
...
<span id="LC453" class="line" lang="java">      <span class="s">"\",\" gefunden, aber kein vorausgehendes Argument vorhanden."</span><span class="o">},</span></span>
...
<span id="LC456" class="line" lang="java">      <span class="s">"\",\" gefunden, aber kein folgendes Argument vorhanden."</span><span class="o">},</span></span>
...
<span id="LC459" class="line" lang="java">      <span class="s">"\"..[predicate]\" oder \".[predicate]\" ist unzul\u00E4ssige Syntax. Verwenden Sie stattdessen \"self::node()[predicate]\"."</span><span class="o">},</span></span>
...
<span id="LC462" class="line" lang="java">     <span class="s">"Unzul\u00E4ssiger Achsenname: {0}"</span><span class="o">},</span></span>
...
<span id="LC465" class="line" lang="java">     <span class="s">"Unbekannter Knotentyp: {0}"</span><span class="o">},</span></span>
...
<span id="LC468" class="line" lang="java">      <span class="s">"Musterliteral ({0}) muss in Anf\u00FChrungszeichen gesetzt werden."</span><span class="o">},</span></span>
...
<span id="LC471" class="line" lang="java">      <span class="s">"{0} konnte nicht als Zahl formatiert werden."</span><span class="o">},</span></span>
...
<span id="LC474" class="line" lang="java">      <span class="s">"XML-TransformerFactory-Liaison konnte nicht erstellt werden: {0}"</span><span class="o">},</span></span>
...
<span id="LC477" class="line" lang="java">      <span class="s">"Fehler. xpath-SELECT-Ausdruck (-select) nicht gefunden."</span><span class="o">},</span></span>
...
<span id="LC480" class="line" lang="java">      <span class="s">"ERROR. ENDOP nach OP_LOCATIONPATH konnte nicht gefunden werden"</span><span class="o">},</span></span>
...
<span id="LC483" class="line" lang="java">     <span class="s">"Fehler aufgetreten."</span><span class="o">},</span></span>
...
<span id="LC486" class="line" lang="java">      <span class="s">"VariableReference au\u00DFerhalb des Kontexts oder ohne Definition f\u00FCr Variable angegeben. Name = {0}"</span><span class="o">},</span></span>
...
<span id="LC489" class="line" lang="java">      <span class="s">"Nur \"child::\"- und \"attribute::\"-Achsen sind in Vergleichsmustern zul\u00E4ssig. Betreffende Achsen = {0}"</span><span class="o">},</span></span>
...
<span id="LC492" class="line" lang="java">      <span class="s">"key() hat eine falsche Anzahl Argumente."</span><span class="o">},</span></span>
...
<span id="LC495" class="line" lang="java">      <span class="s">"count-Funktion sollte ein Argument akzeptieren."</span><span class="o">},</span></span>
...
<span id="LC498" class="line" lang="java">     <span class="s">"Funktion konnte nicht gefunden werden: {0}"</span><span class="o">},</span></span>
...
<span id="LC501" class="line" lang="java">     <span class="s">"Nicht unterst\u00FCtzte Codierung: {0}"</span><span class="o">},</span></span>
...
<span id="LC504" class="line" lang="java">      <span class="s">"Problem in DTM in getNextSibling aufgetreten... Es wird versucht, das Problem zu beheben"</span><span class="o">},</span></span>
...
<span id="LC507" class="line" lang="java">      <span class="s">"Programmiererfehler: Es kann nicht in EmptyNodeList geschrieben werden."</span><span class="o">},</span></span>
...
<span id="LC510" class="line" lang="java">      <span class="s">"setDOMFactory wird nicht von XPathContext unterst\u00FCtzt."</span><span class="o">},</span></span>
...
<span id="LC513" class="line" lang="java">      <span class="s">"Pr\u00E4fix muss als Namespace aufgel\u00F6st werden: {0}"</span><span class="o">},</span></span>
...
<span id="LC516" class="line" lang="java">      <span class="s">"parse (InputSource-Quelle) nicht unterst\u00FCtzt in XPathContext. {0} kann nicht ge\u00F6ffnet werden"</span><span class="o">},</span></span>
...
<span id="LC519" class="line" lang="java">      <span class="s">"SAX-API-Zeichen(char ch[]... nicht verarbeitet von DTM."</span><span class="o">},</span></span>
...
<span id="LC522" class="line" lang="java">      <span class="s">"ignorableWhitespace(char ch[]... nicht verarbeitet von DTM."</span><span class="o">},</span></span>
...
<span id="LC525" class="line" lang="java">      <span class="s">"DTMLiaison kann keine Knoten des Typs {0} verarbeiten"</span><span class="o">},</span></span>
...
<span id="LC528" class="line" lang="java">      <span class="s">"DOM2Helper kann keine Knoten des Typs {0} verarbeiten"</span><span class="o">},</span></span>
...
<span id="LC531" class="line" lang="java">      <span class="s">"DOM2Helper.parse-Fehler: SystemID - {0} Zeile - {1}"</span><span class="o">},</span></span>
...
<span id="LC534" class="line" lang="java">     <span class="s">"DOM2Helper.parse-Fehler"</span><span class="o">},</span></span>
...
<span id="LC537" class="line" lang="java">      <span class="s">"Ung\u00FCltige UTF-16-Ersetzung festgestellt: {0}?"</span><span class="o">},</span></span>
...
<span id="LC540" class="line" lang="java">     <span class="s">"I/O-Fehler"</span><span class="o">},</span></span>
...
<span id="LC543" class="line" lang="java">     <span class="s">"URL f\u00FCr {0} kann nicht erstellt werden"</span><span class="o">},</span></span>
...
<span id="LC549" class="line" lang="java">      <span class="s">"Funktionstoken nicht gefunden."</span><span class="o">},</span></span>
...
<span id="LC552" class="line" lang="java">       <span class="s">"XPath-Typ {0} kann nicht bearbeitet werden"</span><span class="o">},</span></span>
...
<span id="LC555" class="line" lang="java">       <span class="s">"Dieses NodeSet ist nicht mutierbar"</span><span class="o">},</span></span>
...
<span id="LC558" class="line" lang="java">       <span class="s">"Dieses NodeSetDTM ist nicht mutierbar"</span><span class="o">},</span></span>
...
<span id="LC561" class="line" lang="java">        <span class="s">"Variable kann nicht aufgel\u00F6st werden: {0}"</span><span class="o">},</span></span>
...
<span id="LC564" class="line" lang="java">        <span class="s">"Null-Error Handler"</span><span class="o">},</span></span>
...
<span id="LC567" class="line" lang="java">       <span class="s">"Programmierer-Assertion: Unbekannter Vorgangscode: {0}"</span><span class="o">},</span></span>
...
<span id="LC570" class="line" lang="java">       <span class="s">"0 oder 1"</span><span class="o">},</span></span>
...
<span id="LC573" class="line" lang="java">       <span class="s">"rtf() nicht unterst\u00FCtzt von XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC576" class="line" lang="java">       <span class="s">"asNodeIterator() nicht unterst\u00FCtzt von XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC580" class="line" lang="java">                <span class="s">"detach() nicht unterst\u00FCtzt von XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC584" class="line" lang="java">                <span class="s">"num() nicht unterst\u00FCtzt von XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC588" class="line" lang="java">                <span class="s">"xstr() nicht unterst\u00FCtzt von XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC592" class="line" lang="java">                <span class="s">"str() nicht unterst\u00FCtzt von XRTreeFragSelectWrapper"</span><span class="o">},</span></span>
...
<span id="LC595" class="line" lang="java">       <span class="s">"fsb() nicht unterst\u00FCtzt f\u00FCr XStringForChars"</span><span class="o">},</span></span>
...
<span id="LC598" class="line" lang="java">      <span class="s">"Variable mit Namen {0} konnte nicht gefunden werden"</span><span class="o">},</span></span>
...
<span id="LC601" class="line" lang="java">      <span class="s">"XStringForChars kann keine Zeichenfolge als Argument akzeptieren"</span><span class="o">},</span></span>
...
<span id="LC604" class="line" lang="java">      <span class="s">"FastStringBuffer-Argument darf nicht null sein"</span><span class="o">},</span></span>
...
<span id="LC607" class="line" lang="java">       <span class="s">"2 oder 3"</span><span class="o">},</span></span>
...
<span id="LC610" class="line" lang="java">       <span class="s">"Auf Variable wurde zugegriffen, bevor sie gebunden wurde."</span><span class="o">},</span></span>
...
<span id="LC613" class="line" lang="java">       <span class="s">"XStringForFSB kann keine Zeichenfolge als Argument akzeptieren."</span><span class="o">},</span></span>
...
<span id="LC616" class="line" lang="java">       <span class="s">"\n !!!! Fehler. Root eines Walkers wird auf null gesetzt."</span><span class="o">},</span></span>
...
<span id="LC619" class="line" lang="java">       <span class="s">"NodeSetDTM kann nicht zu einem vorherigen Knoten iterieren."</span><span class="o">},</span></span>
...
<span id="LC622" class="line" lang="java">       <span class="s">"NodeSet kann nicht zu einem vorherigen Knoten iterieren."</span><span class="o">},</span></span>
...
<span id="LC625" class="line" lang="java">       <span class="s">"NodeSetDTM kann keine Indexierungs- oder Z\u00E4hlfunktionen ausf\u00FChren."</span><span class="o">},</span></span>
...
<span id="LC628" class="line" lang="java">       <span class="s">"NodeSet kann keine Indexierungs- oder Z\u00E4hlfunktionen ausf\u00FChren."</span><span class="o">},</span></span>
...
<span id="LC631" class="line" lang="java">       <span class="s">"setShouldCacheNodes kann nicht aufgerufen werden, nachdem nextNode aufgerufen wurde."</span><span class="o">},</span></span>
...
<span id="LC634" class="line" lang="java">       <span class="s">"{0} l\u00E4sst nur {1} Argumente zu"</span><span class="o">},</span></span>
...
<span id="LC637" class="line" lang="java">       <span class="s">"Programmierer-Assertion in getNextStepPos: Unbekannter stepType: {0}"</span><span class="o">},</span></span>
...
<span id="LC643" class="line" lang="java">      <span class="s">"Nach dem Token \"/\" oder \"//\" wurde ein relativer Verzeichnispfad erwartet."</span><span class="o">},</span></span>
...
<span id="LC649" class="line" lang="java">       <span class="s">"Ein Verzeichnispfad wurde erwartet, aber das folgende Token wurde gefunden: {0}"</span><span class="o">},</span></span>
...
<span id="LC655" class="line" lang="java">       <span class="s">"Ein Verzeichnispfad wurde erwartet, aber stattdessen wurde das Ende des XPath-Ausdrucks gefunden."</span><span class="o">},</span></span>
...
<span id="LC661" class="line" lang="java">       <span class="s">"Nach dem Token \"/\" oder \"//\" wurde ein Verzeichnisschritt erwartet."</span><span class="o">},</span></span>
...
<span id="LC668" class="line" lang="java">       <span class="s">"Es wurde ein Knotentest erwartet, der entweder NCName:* oder QName entspricht."</span><span class="o">},</span></span>
...
<span id="LC674" class="line" lang="java">       <span class="s">"Ein Schrittmuster wurde erwartet, aber \"/\" wurde gefunden."</span><span class="o">},</span></span>
...
<span id="LC680" class="line" lang="java">       <span class="s">"Ein relatives Pfadmuster wurde erwartet."</span><span class="o">},</span></span>
...
<span id="LC686" class="line" lang="java">       <span class="s">"XPathResult von XPath-Ausdruck \"{0}\" hat XPathResultType {1}, der nicht in einen booleschen Wert konvertiert werden kann."</span><span class="o">},</span></span>
...
<span id="LC691" class="line" lang="java">       <span class="s">"XPathResult von XPath-Ausdruck \"{0}\" hat XPathResultType {1}, der nicht in einen einzelnen Knoten konvertiert werden kann. Die Methode \"getSingleNodeValue\" gilt nur f\u00FCr die Typen ANY_UNORDERED_NODE_TYPE und FIRST_ORDERED_NODE_TYPE."</span><span class="o">},</span></span>
...
<span id="LC696" class="line" lang="java">       <span class="s">"Die Methode \"getSnapshotLength\" kann nicht f\u00FCr XPathResult von XPath-Ausdruck \"{0}\" aufgerufen werden, da der zugeh\u00F6rige XPathResultType {1} ist. Diese Methode gilt nur f\u00FCr die Typen UNORDERED_NODE_SNAPSHOT_TYPE und ORDERED_NODE_SNAPSHOT_TYPE."</span><span class="o">},</span></span>
...
<span id="LC699" class="line" lang="java">       <span class="s">"Die Methode \"iterateNext\" kann nicht f\u00FCr XPathResult von XPath-Ausdruck \"{0}\" aufgerufen werden, da der zugeh\u00F6rige XPathResultType {1} ist. Diese Methode gilt nur f\u00FCr die Typen UNORDERED_NODE_ITERATOR_TYPE und ORDERED_NODE_ITERATOR_TYPE."</span><span class="o">},</span></span>
...
<span id="LC705" class="line" lang="java">       <span class="s">"Dokument ge\u00E4ndert, seit Ergebnis zur\u00FCckgegeben wurde. Iterator ist ung\u00FCltig."</span><span class="o">},</span></span>
...
<span id="LC708" class="line" lang="java">       <span class="s">"Ung\u00FCltiges XPath-Typargument: {0}"</span><span class="o">},</span></span>
...
<span id="LC711" class="line" lang="java">       <span class="s">"Leeres XPath-Ergebnisobjekt"</span><span class="o">},</span></span>
...
<span id="LC714" class="line" lang="java">       <span class="s">"XPathResult von XPath-Ausdruck \"{0}\" hat XPathResultType {1}, der nicht in den angegebenen XPathResultType {2} ge\u00E4ndert werden kann."</span><span class="o">},</span></span>
...
<span id="LC717" class="line" lang="java">       <span class="s">"Pr\u00E4fix kann nicht mit Null-Pr\u00E4fix-Resolver aufgel\u00F6st werden."</span><span class="o">},</span></span>
...
<span id="LC723" class="line" lang="java">       <span class="s">"XPathResult von XPath-Ausdruck \"{0}\" hat XPathResultType {1}, der nicht in eine Zeichenfolge konvertiert werden kann."</span><span class="o">},</span></span>
...
<span id="LC728" class="line" lang="java">       <span class="s">"Die Methode \"snapshotItem\" kann nicht f\u00FCr XPathResult von XPath-Ausdruck \"{0}\" aufgerufen werden, da der zugeh\u00F6rige XPathResultType {1} ist. Diese Methode gilt nur f\u00FCr die Typen UNORDERED_NODE_SNAPSHOT_TYPE und ORDERED_NODE_SNAPSHOT_TYPE."</span><span class="o">},</span></span>
...
<span id="LC735" class="line" lang="java">       <span class="s">"Kontextknoten geh\u00F6rt nicht zum Dokument, das an diesen XPathEvaluator gebunden ist."</span><span class="o">},</span></span>
...
<span id="LC740" class="line" lang="java">       <span class="s">"Kontextknotentyp wird nicht unterst\u00FCtzt."</span><span class="o">},</span></span>
...
<span id="LC743" class="line" lang="java">       <span class="s">"Unbekannter Fehler in XPath."</span><span class="o">},</span></span>
...
<span id="LC746" class="line" lang="java">        <span class="s">"XPathResult von XPath-Ausdruck \"{0}\" hat XPathResultType {1}, der nicht in eine Zahl konvertiert werden kann"</span><span class="o">},</span></span>
...
<span id="LC753" class="line" lang="java">       <span class="s">"Erweiterungsfunktion \"{0}\" kann nicht aufgerufen werden, wenn das Feature \"XMLConstants.FEATURE_SECURE_PROCESSING\" auf \"true\" gesetzt ist."</span><span class="o">},</span></span>
...
<span id="LC758" class="line" lang="java">       <span class="s">"resolveVariable f\u00FCr Variable {0} gibt null zur\u00FCck"</span><span class="o">},</span></span>
...
<span id="LC763" class="line" lang="java">       <span class="s">"Nicht unterst\u00FCtzter R\u00FCckgabetyp: {0}"</span><span class="o">},</span></span>
...
<span id="LC768" class="line" lang="java">       <span class="s">"Quelle und/oder R\u00FCckgabetyp d\u00FCrfen nicht null sein"</span><span class="o">},</span></span>
...
<span id="LC773" class="line" lang="java">       <span class="s">"Quelle und/oder R\u00FCckgabetyp d\u00FCrfen nicht null sein"</span><span class="o">},</span></span>
...
<span id="LC778" class="line" lang="java">       <span class="s">"{0}-Argument darf nicht null sein"</span><span class="o">},</span></span>
...
<span id="LC783" class="line" lang="java">       <span class="s">"{0}#isObjectModelSupported( String objectModel ) kann nicht mit objectModel == null aufgerufen werden"</span><span class="o">},</span></span>
...
<span id="LC788" class="line" lang="java">       <span class="s">"{0}#isObjectModelSupported( String objectModel ) kann nicht mit objectModel == \"\" aufgerufen werden"</span><span class="o">},</span></span>
...
<span id="LC793" class="line" lang="java">       <span class="s">"Es wird versucht, ein Feature mit einem Null-Namen festzulegen: {0}#setFeature( null, {1})"</span><span class="o">},</span></span>
...
<span id="LC798" class="line" lang="java">       <span class="s">"Es wird versucht, ein unbekanntes Feature \"{0}\" festzulegen:{1}#setFeature({0},{2})"</span><span class="o">},</span></span>
...
<span id="LC803" class="line" lang="java">       <span class="s">"Es wird versucht, ein Feature mit einem Null-Namen abzurufen: {0}#getFeature(null)"</span><span class="o">},</span></span>
...
<span id="LC808" class="line" lang="java">       <span class="s">"Es wird versucht, das unbekannte Feature \"{0}\" abzurufen:{1}#getFeature({0})"</span><span class="o">},</span></span>
...
<span id="LC811" class="line" lang="java">        <span class="s">"FEATURE_SECURE_PROCESSING: Feature kann nicht auf \"false\" gesetzt werden, wenn Security Manager vorhanden ist: {1}#setFeature({0},{2})"</span><span class="o">},</span></span>
...
<span id="LC816" class="line" lang="java">       <span class="s">"Versuch, Null-XPathFunctionResolver festzulegen:{0}#setXPathFunctionResolver(null)"</span><span class="o">},</span></span>
...
<span id="LC821" class="line" lang="java">       <span class="s">"Versuch, Null-XPathVariableResolver festzulegen:{0}#setXPathVariableResolver(null)"</span><span class="o">},</span></span>
...
<span id="LC828" class="line" lang="java">      <span class="s">"Gebietsschemaname in der format-number-Funktion wird noch nicht verarbeitet."</span><span class="o">},</span></span>
...
<span id="LC831" class="line" lang="java">      <span class="s">"XSL-Eigenschaft nicht unterst\u00FCtzt: {0}"</span><span class="o">},</span></span>
...
<span id="LC834" class="line" lang="java">      <span class="s">"Derzeit keine Aktion mit Namespace {0} in Eigenschaft {1} ausf\u00FChren"</span><span class="o">},</span></span>
...
<span id="LC837" class="line" lang="java">      <span class="s">"SecurityException beim Versuch, auf XSL-Systemeigenschaft {0} zuzugreifen"</span><span class="o">},</span></span>
...
<span id="LC840" class="line" lang="java">      <span class="s">"Alte Syntax: quo(...) nicht mehr definiert in XPath."</span><span class="o">},</span></span>
...
<span id="LC843" class="line" lang="java">      <span class="s">"XPath ben\u00F6tigt ein abgeleitetes Objekt, um nodeTest zu implementieren."</span><span class="o">},</span></span>
...
<span id="LC846" class="line" lang="java">      <span class="s">"Funktionstoken nicht gefunden."</span><span class="o">},</span></span>
...
<span id="LC849" class="line" lang="java">      <span class="s">"Funktion konnte nicht gefunden werden: {0}"</span><span class="o">},</span></span>
...
<span id="LC852" class="line" lang="java">      <span class="s">"URL kann nicht erstellt werden aus: {0}"</span><span class="o">},</span></span>
...
<span id="LC855" class="line" lang="java">      <span class="s">"Option \"-E\" nicht unterst\u00FCtzt f\u00FCr DTM-Parser"</span><span class="o">},</span></span>
...
<span id="LC858" class="line" lang="java">      <span class="s">"VariableReference au\u00DFerhalb des Kontexts oder ohne Definition f\u00FCr Variable angegeben. Name = {0}"</span><span class="o">},</span></span>
...
<span id="LC861" class="line" lang="java">     <span class="s">"Nicht unterst\u00FCtzte Codierung: {0}"</span><span class="o">},</span></span>
...
<span id="LC866" class="line" lang="java">  <span class="o">{</span> <span class="s">"ui_language"</span><span class="o">,</span> <span class="s">"de"</span><span class="o">},</span></span>
<span id="LC867" class="line" lang="java">  <span class="o">{</span> <span class="s">"help_language"</span><span class="o">,</span> <span class="s">"de"</span><span class="o">},</span></span>
<span id="LC868" class="line" lang="java">  <span class="o">{</span> <span class="s">"language"</span><span class="o">,</span> <span class="s">"de"</span><span class="o">},</span></span>
<span id="LC869" class="line" lang="java">  <span class="o">{</span> <span class="s">"BAD_CODE"</span><span class="o">,</span> <span class="s">"Parameter f\u00FCr createMessage war au\u00DFerhalb des g\u00FCltigen Bereichs"</span><span class="o">},</span></span>
<span id="LC870" class="line" lang="java">  <span class="o">{</span> <span class="s">"FORMAT_FAILED"</span><span class="o">,</span> <span class="s">"Ausnahme bei messageFormat-Aufruf ausgel\u00F6st"</span><span class="o">},</span></span>
...
<span id="LC874" class="line" lang="java">  <span class="o">{</span> <span class="s">"line"</span><span class="o">,</span> <span class="s">"Zeilennummer"</span><span class="o">},</span></span>
<span id="LC875" class="line" lang="java">  <span class="o">{</span> <span class="s">"column"</span><span class="o">,</span> <span class="s">"Spaltennummer"</span><span class="o">},</span></span>
<span id="LC876" class="line" lang="java">  <span class="o">{</span> <span class="s">"xsldone"</span><span class="o">,</span> <span class="s">"XSLProcessor: Fertig"</span><span class="o">},</span></span>
<span id="LC877" class="line" lang="java">  <span class="o">{</span> <span class="s">"xpath_option"</span><span class="o">,</span> <span class="s">"xpath-Optionen: "</span><span class="o">},</span></span>
...
<span id="LC880" class="line" lang="java">  <span class="o">{</span> <span class="s">"optionMatch"</span><span class="o">,</span> <span class="s">"   [-match match pattern (f\u00FCr Vergleichsdiagnose)]"</span><span class="o">},</span></span>
<span id="LC881" class="line" lang="java">  <span class="o">{</span> <span class="s">"optionAnyExpr"</span><span class="o">,</span> <span class="s">"Oder nur ein XPath-Ausdruck f\u00FChrt einen Diagnosedump aus"</span><span class="o">},</span></span>
<span id="LC882" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg1"</span><span class="o">,</span> <span class="s">"XSL-Prozess war nicht erfolgreich."</span><span class="o">},</span></span>
<span id="LC883" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg2"</span><span class="o">,</span> <span class="s">"** Parser konnte nicht gefunden werden **"</span><span class="o">},</span></span>
<span id="LC884" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg3"</span><span class="o">,</span> <span class="s">"Pr\u00FCfen Sie den Classpath."</span><span class="o">},</span></span>
<span id="LC885" class="line" lang="java">  <span class="o">{</span> <span class="s">"noParsermsg4"</span><span class="o">,</span> <span class="s">"Wenn Sie nicht \u00FCber den XML-Parser f\u00FCr Java von IBM verf\u00FCgen, k\u00F6nnen Sie ihn hier herunterladen:"</span><span class="o">},</span></span>
