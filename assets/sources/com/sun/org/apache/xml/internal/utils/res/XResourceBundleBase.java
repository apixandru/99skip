...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: XResourceBundleBase.java,v 1.2.4.1 2005/09/15 08:16:05 suresh_emailid Exp $</span></span>
...
<span id="LC25" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.util.ListResourceBundle</span><span class="o">;</span></span>
<span id="LC26" class="line" lang="java"></span>
<span id="LC27" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> * This is an interface for error messages.  This class is misnamed,</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> * and should be called XalanResourceBundle, or some such.</span></span>
...
<span id="LC32" class="line" lang="java"><span class="kd">abstract</span> <span class="kd">public</span> <span class="kd">class</span> <span class="nc">XResourceBundleBase</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span></span>
...
<span id="LC36" class="line" lang="java"><span class="cm">   * Get the error string associated with the error code</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC38" class="line" lang="java"><span class="cm">   * @param errorCode Error code</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">   * @return error string associated with the given error code</span></span>
<span id="LC41" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC42" class="line" lang="java">  <span class="kd">abstract</span> <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMessageKey</span><span class="o">(</span><span class="kt">int</span> <span class="n">errorCode</span><span class="o">);</span></span>
<span id="LC43" class="line" lang="java"></span>
<span id="LC44" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC45" class="line" lang="java"><span class="cm">   * Get the warning string associated with the error code</span></span>
<span id="LC46" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC47" class="line" lang="java"><span class="cm">   * @param errorCode Error code</span></span>
<span id="LC48" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC49" class="line" lang="java"><span class="cm">   * @return warning string associated with the given error code</span></span>
<span id="LC50" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC51" class="line" lang="java">  <span class="kd">abstract</span> <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getWarningKey</span><span class="o">(</span><span class="kt">int</span> <span class="n">errorCode</span><span class="o">);</span></span>
