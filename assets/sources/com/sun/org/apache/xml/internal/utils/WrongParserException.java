...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: WrongParserException.java,v 1.2.4.1 2005/09/15 08:16:00 suresh_emailid Exp $</span></span>
...
<span id="LC26" class="line" lang="java"><span class="cm"> * Certain functions may throw this error if they are paired with</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * the incorrect parser.</span></span>
...
<span id="LC30" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">WrongParserException</span> <span class="kd">extends</span> <span class="nc">RuntimeException</span></span>
<span id="LC31" class="line" lang="java"><span class="o">{</span></span>
<span id="LC32" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="mi">6481643018533043846L</span><span class="o">;</span></span>
<span id="LC33" class="line" lang="java"></span>
<span id="LC34" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC35" class="line" lang="java"><span class="cm">   * Create a WrongParserException object.</span></span>
<span id="LC36" class="line" lang="java"><span class="cm">   * @param message The error message that should be reported to the user.</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC38" class="line" lang="java">  <span class="kd">public</span> <span class="nf">WrongParserException</span><span class="o">(</span><span class="nc">String</span> <span class="n">message</span><span class="o">)</span></span>
<span id="LC39" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC40" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">message</span><span class="o">);</span></span>
