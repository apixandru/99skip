...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: ToUnknownStream.java,v 1.3 2005/09/28 13:49:08 pvedula Exp $</span></span>
...
<span id="LC27" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.io.Writer</span><span class="o">;</span></span>
...
<span id="LC31" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.transform.SourceLocator</span><span class="o">;</span></span>
<span id="LC32" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.transform.Transformer</span><span class="o">;</span></span>
...
<span id="LC35" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.Attributes</span><span class="o">;</span></span>
<span id="LC36" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.ContentHandler</span><span class="o">;</span></span>
<span id="LC37" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.Locator</span><span class="o">;</span></span>
<span id="LC38" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.SAXException</span><span class="o">;</span></span>
...
<span id="LC42" class="line" lang="java"><span class="cm"> *This class wraps another SerializationHandler. The wrapped object will either</span></span>
<span id="LC43" class="line" lang="java"><span class="cm"> * handler XML or HTML, which is not known until a little later when the first XML</span></span>
<span id="LC44" class="line" lang="java"><span class="cm"> * tag is seen.  If the first tag is &lt;html&gt; then the wrapped object is an HTML</span></span>
<span id="LC45" class="line" lang="java"><span class="cm"> * handler, otherwise it is an XML handler.</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * This class effectively caches the first few calls to it then passes them</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * on to the wrapped handler (once it exists).  After that subsequent calls a</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * simply passed directly to the wrapped handler.</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC51" class="line" lang="java"><span class="cm"> * The user of this class doesn't know if the output is ultimatley XML or HTML.</span></span>
<span id="LC52" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC53" class="line" lang="java"><span class="cm"> * This class is not a public API, it is public because it is used within Xalan.</span></span>
<span id="LC54" class="line" lang="java"><span class="cm"> * @xsl.usage internal</span></span>
<span id="LC55" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC56" class="line" lang="java"><span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">ToUnknownStream</span> <span class="kd">extends</span> <span class="nc">SerializerBase</span></span>
...
<span id="LC60" class="line" lang="java"><span class="cm">     * The wrapped handler, initially XML but possibly switched to HTML</span></span>
<span id="LC61" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC62" class="line" lang="java">    <span class="kd">private</span> <span class="nc">SerializationHandler</span> <span class="n">m_handler</span><span class="o">;</span></span>
<span id="LC63" class="line" lang="java"></span>
<span id="LC64" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC65" class="line" lang="java"><span class="cm">     * A String with no characters</span></span>
<span id="LC66" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC67" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">String</span> <span class="no">EMPTYSTRING</span> <span class="o">=</span> <span class="s">""</span><span class="o">;</span></span>
<span id="LC68" class="line" lang="java"></span>
<span id="LC69" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">     * true if the underlying handler (XML or HTML) is fully initialized</span></span>
<span id="LC71" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC72" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">m_wrapped_handler_not_initialized</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC76" class="line" lang="java"><span class="cm">     * the prefix of the very first tag in the document</span></span>
<span id="LC77" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC78" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">m_firstElementPrefix</span><span class="o">;</span></span>
<span id="LC79" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC80" class="line" lang="java"><span class="cm">     * the element name (including any prefix) of the very first tag in the document</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC82" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">m_firstElementName</span><span class="o">;</span></span>
<span id="LC83" class="line" lang="java"></span>
<span id="LC84" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">     * the namespace URI associated with the first element</span></span>
<span id="LC86" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC87" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">m_firstElementURI</span><span class="o">;</span></span>
<span id="LC88" class="line" lang="java"></span>
<span id="LC89" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">     * the local name (no prefix) associated with the first element</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC92" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">m_firstElementLocalName</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC93" class="line" lang="java"></span>
<span id="LC94" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC95" class="line" lang="java"><span class="cm">     * true if the first tag has been emitted to the wrapped handler</span></span>
<span id="LC96" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC97" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">m_firstTagNotEmitted</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC98" class="line" lang="java"></span>
<span id="LC99" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC100" class="line" lang="java"><span class="cm">     * A collection of namespace URI's (only for first element).</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">     * _namespacePrefix has the matching prefix for these URI's</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC103" class="line" lang="java">    <span class="kd">private</span> <span class="nc">Vector</span> <span class="n">m_namespaceURI</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC104" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC105" class="line" lang="java"><span class="cm">     * A collection of namespace Prefix (only for first element)</span></span>
<span id="LC106" class="line" lang="java"><span class="cm">     * _namespaceURI has the matching URIs for these prefix'</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC108" class="line" lang="java">    <span class="kd">private</span> <span class="nc">Vector</span> <span class="n">m_namespacePrefix</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC109" class="line" lang="java"></span>
<span id="LC110" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC111" class="line" lang="java"><span class="cm">     * true if startDocument() was called before the underlying handler</span></span>
<span id="LC112" class="line" lang="java"><span class="cm">     * was initialized</span></span>
<span id="LC113" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC114" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">m_needToCallStartDocument</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC115" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC116" class="line" lang="java"><span class="cm">     * true if setVersion() was called before the underlying handler</span></span>
<span id="LC117" class="line" lang="java"><span class="cm">     * was initialized</span></span>
<span id="LC118" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC119" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">m_setVersion_called</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC120" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC121" class="line" lang="java"><span class="cm">     * true if setDoctypeSystem() was called before the underlying handler</span></span>
<span id="LC122" class="line" lang="java"><span class="cm">     * was initialized</span></span>
<span id="LC123" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC124" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">m_setDoctypeSystem_called</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC125" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC126" class="line" lang="java"><span class="cm">     * true if setDoctypePublic() was called before the underlying handler</span></span>
<span id="LC127" class="line" lang="java"><span class="cm">     * was initialized</span></span>
<span id="LC128" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC129" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">m_setDoctypePublic_called</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC130" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC131" class="line" lang="java"><span class="cm">     * true if setMediaType() was called before the underlying handler</span></span>
<span id="LC132" class="line" lang="java"><span class="cm">     * was initialized</span></span>
<span id="LC133" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC134" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">m_setMediaType_called</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC135" class="line" lang="java"></span>
<span id="LC136" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC137" class="line" lang="java"><span class="cm">     * Default constructor.</span></span>
<span id="LC138" class="line" lang="java"><span class="cm">     * Initially this object wraps an XML Stream object, so _handler is never null.</span></span>
<span id="LC139" class="line" lang="java"><span class="cm">     * That may change later to an HTML Stream object.</span></span>
<span id="LC140" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC141" class="line" lang="java">    <span class="kd">public</span> <span class="nf">ToUnknownStream</span><span class="o">()</span></span>
<span id="LC142" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC143" class="line" lang="java">        <span class="n">m_handler</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">ToXMLStream</span><span class="o">();</span></span>
...
<span id="LC147" class="line" lang="java"><span class="cm">     * @see Serializer#asContentHandler()</span></span>
<span id="LC148" class="line" lang="java"><span class="cm">     * @return the wrapped XML or HTML handler</span></span>
<span id="LC149" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC150" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ContentHandler</span> <span class="nf">asContentHandler</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
<span id="LC151" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC152" class="line" lang="java">        <span class="cm">/* don't return the real handler ( m_handler ) because</span></span>
<span id="LC153" class="line" lang="java"><span class="cm">         * that would expose the real handler to the outside.</span></span>
<span id="LC154" class="line" lang="java"><span class="cm">         * Keep m_handler private so it can be internally swapped</span></span>
<span id="LC155" class="line" lang="java"><span class="cm">         * to an HTML handler.</span></span>
<span id="LC156" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC157" class="line" lang="java">        <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC161" class="line" lang="java"><span class="cm">     * @see SerializationHandler#close()</span></span>
<span id="LC162" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC163" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">close</span><span class="o">()</span></span>
<span id="LC164" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC165" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">close</span><span class="o">();</span></span>
...
<span id="LC169" class="line" lang="java"><span class="cm">     * @see Serializer#getOutputFormat()</span></span>
<span id="LC170" class="line" lang="java"><span class="cm">     * @return the properties of the underlying handler</span></span>
<span id="LC171" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC172" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Properties</span> <span class="nf">getOutputFormat</span><span class="o">()</span></span>
<span id="LC173" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC174" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getOutputFormat</span><span class="o">();</span></span>
...
<span id="LC178" class="line" lang="java"><span class="cm">     * @see Serializer#getOutputStream()</span></span>
<span id="LC179" class="line" lang="java"><span class="cm">     * @return the OutputStream of the underlying XML or HTML handler</span></span>
<span id="LC180" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC181" class="line" lang="java">    <span class="kd">public</span> <span class="nc">OutputStream</span> <span class="nf">getOutputStream</span><span class="o">()</span></span>
<span id="LC182" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC183" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getOutputStream</span><span class="o">();</span></span>
...
<span id="LC187" class="line" lang="java"><span class="cm">     * @see Serializer#getWriter()</span></span>
<span id="LC188" class="line" lang="java"><span class="cm">     * @return the Writer of the underlying XML or HTML handler</span></span>
<span id="LC189" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC190" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Writer</span> <span class="nf">getWriter</span><span class="o">()</span></span>
<span id="LC191" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC192" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getWriter</span><span class="o">();</span></span>
...
<span id="LC196" class="line" lang="java"><span class="cm">     * passes the call on to the underlying HTML or XML handler</span></span>
<span id="LC197" class="line" lang="java"><span class="cm">     * @see Serializer#reset()</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">     * @return ???</span></span>
<span id="LC199" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC200" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">reset</span><span class="o">()</span></span>
<span id="LC201" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC202" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">reset</span><span class="o">();</span></span>
...
<span id="LC206" class="line" lang="java"><span class="cm">     * Converts the DOM node to output</span></span>
<span id="LC207" class="line" lang="java"><span class="cm">     * @param node the DOM node to transform to output</span></span>
<span id="LC208" class="line" lang="java"><span class="cm">     * @see DOMSerializer#serialize(Node)</span></span>
<span id="LC209" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC210" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC211" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">serialize</span><span class="o">(</span><span class="nc">Node</span> <span class="n">node</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
<span id="LC212" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC213" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC214" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC215" class="line" lang="java">            <span class="n">flush</span><span class="o">();</span></span>
<span id="LC216" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC217" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">serialize</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
...
<span id="LC221" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setEscaping(boolean)</span></span>
<span id="LC222" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC223" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">setEscaping</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">escape</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC224" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC225" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">setEscaping</span><span class="o">(</span><span class="n">escape</span><span class="o">);</span></span>
...
<span id="LC229" class="line" lang="java"><span class="cm">     * Set the properties of the handler</span></span>
<span id="LC230" class="line" lang="java"><span class="cm">     * @param format the output properties to set</span></span>
<span id="LC231" class="line" lang="java"><span class="cm">     * @see Serializer#setOutputFormat(Properties)</span></span>
<span id="LC232" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC233" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOutputFormat</span><span class="o">(</span><span class="nc">Properties</span> <span class="n">format</span><span class="o">)</span></span>
<span id="LC234" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC235" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setOutputFormat</span><span class="o">(</span><span class="n">format</span><span class="o">);</span></span>
...
<span id="LC239" class="line" lang="java"><span class="cm">     * Sets the output stream to write to</span></span>
<span id="LC240" class="line" lang="java"><span class="cm">     * @param output the OutputStream to write to</span></span>
<span id="LC241" class="line" lang="java"><span class="cm">     * @see Serializer#setOutputStream(OutputStream)</span></span>
<span id="LC242" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC243" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOutputStream</span><span class="o">(</span><span class="nc">OutputStream</span> <span class="n">output</span><span class="o">)</span></span>
<span id="LC244" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC245" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setOutputStream</span><span class="o">(</span><span class="n">output</span><span class="o">);</span></span>
...
<span id="LC249" class="line" lang="java"><span class="cm">     * Sets the writer to write to</span></span>
<span id="LC250" class="line" lang="java"><span class="cm">     * @param writer the writer to write to</span></span>
<span id="LC251" class="line" lang="java"><span class="cm">     * @see Serializer#setWriter(Writer)</span></span>
<span id="LC252" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC253" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setWriter</span><span class="o">(</span><span class="nc">Writer</span> <span class="n">writer</span><span class="o">)</span></span>
<span id="LC254" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC255" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setWriter</span><span class="o">(</span><span class="n">writer</span><span class="o">);</span></span>
...
<span id="LC259" class="line" lang="java"><span class="cm">     * Adds an attribute to the currenly open tag</span></span>
<span id="LC260" class="line" lang="java"><span class="cm">     * @param uri the URI of a namespace</span></span>
<span id="LC261" class="line" lang="java"><span class="cm">     * @param localName the attribute name, without prefix</span></span>
<span id="LC262" class="line" lang="java"><span class="cm">     * @param rawName the attribute name, with prefix (if any)</span></span>
<span id="LC263" class="line" lang="java"><span class="cm">     * @param type the type of the attribute, typically "CDATA"</span></span>
<span id="LC264" class="line" lang="java"><span class="cm">     * @param value the value of the parameter</span></span>
<span id="LC265" class="line" lang="java"><span class="cm">     * @param XSLAttribute true if this attribute is coming from an xsl:attribute element</span></span>
<span id="LC266" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#addAttribute(String, String, String, String, String)</span></span>
<span id="LC267" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC268" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addAttribute</span><span class="o">(</span></span>
<span id="LC269" class="line" lang="java">        <span class="nc">String</span> <span class="n">uri</span><span class="o">,</span></span>
<span id="LC270" class="line" lang="java">        <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span></span>
<span id="LC271" class="line" lang="java">        <span class="nc">String</span> <span class="n">rawName</span><span class="o">,</span></span>
<span id="LC272" class="line" lang="java">        <span class="nc">String</span> <span class="n">type</span><span class="o">,</span></span>
<span id="LC273" class="line" lang="java">        <span class="nc">String</span> <span class="n">value</span><span class="o">)</span></span>
<span id="LC274" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC275" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC276" class="line" lang="java">        <span class="n">addAttribute</span><span class="o">(</span><span class="n">uri</span><span class="o">,</span> <span class="n">localName</span><span class="o">,</span> <span class="n">rawName</span><span class="o">,</span> <span class="n">type</span><span class="o">,</span> <span class="n">value</span><span class="o">,</span> <span class="kc">false</span><span class="o">);</span></span>
...
<span id="LC280" class="line" lang="java"><span class="cm">     * Adds an attribute to the currenly open tag</span></span>
<span id="LC281" class="line" lang="java"><span class="cm">     * @param uri the URI of a namespace</span></span>
<span id="LC282" class="line" lang="java"><span class="cm">     * @param localName the attribute name, without prefix</span></span>
<span id="LC283" class="line" lang="java"><span class="cm">     * @param rawName the attribute name, with prefix (if any)</span></span>
<span id="LC284" class="line" lang="java"><span class="cm">     * @param type the type of the attribute, typically "CDATA"</span></span>
<span id="LC285" class="line" lang="java"><span class="cm">     * @param value the value of the parameter</span></span>
<span id="LC286" class="line" lang="java"><span class="cm">     * @param XSLAttribute true if this attribute is coming from an xsl:attribute element</span></span>
<span id="LC287" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#addAttribute(String, String, String, String, String)</span></span>
<span id="LC288" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC289" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addAttribute</span><span class="o">(</span></span>
<span id="LC290" class="line" lang="java">        <span class="nc">String</span> <span class="n">uri</span><span class="o">,</span></span>
<span id="LC291" class="line" lang="java">        <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span></span>
<span id="LC292" class="line" lang="java">        <span class="nc">String</span> <span class="n">rawName</span><span class="o">,</span></span>
<span id="LC293" class="line" lang="java">        <span class="nc">String</span> <span class="n">type</span><span class="o">,</span></span>
<span id="LC294" class="line" lang="java">        <span class="nc">String</span> <span class="n">value</span><span class="o">,</span></span>
<span id="LC295" class="line" lang="java">        <span class="kt">boolean</span> <span class="nc">XSLAttribute</span><span class="o">)</span></span>
<span id="LC296" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC297" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC298" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC299" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC300" class="line" lang="java">            <span class="n">flush</span><span class="o">();</span></span>
<span id="LC301" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC302" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">addAttribute</span><span class="o">(</span><span class="n">uri</span><span class="o">,</span> <span class="n">localName</span><span class="o">,</span> <span class="n">rawName</span><span class="o">,</span> <span class="n">type</span><span class="o">,</span> <span class="n">value</span><span class="o">,</span> <span class="nc">XSLAttribute</span><span class="o">);</span></span>
<span id="LC303" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC304" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC305" class="line" lang="java"><span class="cm">     * Adds an attribute to the currenly open tag</span></span>
<span id="LC306" class="line" lang="java"><span class="cm">     * @param rawName the attribute name, with prefix (if any)</span></span>
<span id="LC307" class="line" lang="java"><span class="cm">     * @param value the value of the parameter</span></span>
<span id="LC308" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#addAttribute(String, String)</span></span>
<span id="LC309" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC310" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addAttribute</span><span class="o">(</span><span class="nc">String</span> <span class="n">rawName</span><span class="o">,</span> <span class="nc">String</span> <span class="n">value</span><span class="o">)</span></span>
<span id="LC311" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC312" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC313" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC314" class="line" lang="java">            <span class="n">flush</span><span class="o">();</span></span>
<span id="LC315" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC316" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">addAttribute</span><span class="o">(</span><span class="n">rawName</span><span class="o">,</span> <span class="n">value</span><span class="o">);</span></span>
...
<span id="LC321" class="line" lang="java"><span class="cm">     * Adds a unique attribute to the currenly open tag</span></span>
<span id="LC322" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC323" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addUniqueAttribute</span><span class="o">(</span><span class="nc">String</span> <span class="n">rawName</span><span class="o">,</span> <span class="nc">String</span> <span class="n">value</span><span class="o">,</span> <span class="kt">int</span> <span class="n">flags</span><span class="o">)</span></span>
<span id="LC324" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC325" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC326" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC327" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC328" class="line" lang="java">            <span class="n">flush</span><span class="o">();</span></span>
<span id="LC329" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC330" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">addUniqueAttribute</span><span class="o">(</span><span class="n">rawName</span><span class="o">,</span> <span class="n">value</span><span class="o">,</span> <span class="n">flags</span><span class="o">);</span></span>
...
<span id="LC335" class="line" lang="java"><span class="cm">     * Converts the String to a character array and calls the SAX method</span></span>
<span id="LC336" class="line" lang="java"><span class="cm">     * characters(char[],int,int);</span></span>
<span id="LC337" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC338" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#characters(String)</span></span>
<span id="LC339" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC340" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">characters</span><span class="o">(</span><span class="nc">String</span> <span class="n">chars</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC341" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC342" class="line" lang="java">        <span class="kd">final</span> <span class="kt">int</span> <span class="n">length</span> <span class="o">=</span> <span class="n">chars</span><span class="o">.</span><span class="na">length</span><span class="o">();</span></span>
<span id="LC343" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">length</span> <span class="o">&gt;</span> <span class="n">m_charsBuff</span><span class="o">.</span><span class="na">length</span><span class="o">)</span></span>
<span id="LC344" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC345" class="line" lang="java">            <span class="n">m_charsBuff</span> <span class="o">=</span> <span class="k">new</span> <span class="kt">char</span><span class="o">[</span><span class="n">length</span><span class="o">*</span><span class="mi">2</span> <span class="o">+</span> <span class="mi">1</span><span class="o">];</span></span>
<span id="LC346" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC347" class="line" lang="java">        <span class="n">chars</span><span class="o">.</span><span class="na">getChars</span><span class="o">(</span><span class="mi">0</span><span class="o">,</span> <span class="n">length</span><span class="o">,</span> <span class="n">m_charsBuff</span><span class="o">,</span> <span class="mi">0</span><span class="o">);</span></span>
<span id="LC348" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">characters</span><span class="o">(</span><span class="n">m_charsBuff</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">length</span><span class="o">);</span></span>
...
<span id="LC352" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC353" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#endElement(String)</span></span>
<span id="LC354" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC355" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endElement</span><span class="o">(</span><span class="nc">String</span> <span class="n">elementName</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC356" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC357" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC358" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC359" class="line" lang="java">            <span class="n">flush</span><span class="o">();</span></span>
<span id="LC360" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC361" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">endElement</span><span class="o">(</span><span class="n">elementName</span><span class="o">);</span></span>
...
<span id="LC366" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#startPrefixMapping(String, String)</span></span>
<span id="LC367" class="line" lang="java"><span class="cm">     * @param prefix The prefix that maps to the URI</span></span>
<span id="LC368" class="line" lang="java"><span class="cm">     * @param uri The URI for the namespace</span></span>
<span id="LC369" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC370" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startPrefixMapping</span><span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">,</span> <span class="nc">String</span> <span class="n">uri</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC371" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC372" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">startPrefixMapping</span><span class="o">(</span><span class="n">prefix</span><span class="o">,</span><span class="n">uri</span><span class="o">,</span> <span class="kc">true</span><span class="o">);</span></span>
...
<span id="LC376" class="line" lang="java"><span class="cm">     * This method is used when a prefix/uri namespace mapping</span></span>
<span id="LC377" class="line" lang="java"><span class="cm">     * is indicated after the element was started with a</span></span>
<span id="LC378" class="line" lang="java"><span class="cm">     * startElement() and before and endElement().</span></span>
<span id="LC379" class="line" lang="java"><span class="cm">     * startPrefixMapping(prefix,uri) would be used before the</span></span>
<span id="LC380" class="line" lang="java"><span class="cm">     * startElement() call.</span></span>
<span id="LC381" class="line" lang="java"><span class="cm">     * @param uri the URI of the namespace</span></span>
<span id="LC382" class="line" lang="java"><span class="cm">     * @param prefix the prefix associated with the given URI.</span></span>
<span id="LC383" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC384" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#namespaceAfterStartElement(String, String)</span></span>
<span id="LC385" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC386" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">namespaceAfterStartElement</span><span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">,</span> <span class="nc">String</span> <span class="n">uri</span><span class="o">)</span></span>
<span id="LC387" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC388" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC389" class="line" lang="java">        <span class="c1">// hack for XSLTC with finding URI for default namespace</span></span>
<span id="LC390" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span> <span class="o">&amp;&amp;</span> <span class="n">m_firstElementURI</span> <span class="o">==</span> <span class="kc">null</span> <span class="o">&amp;&amp;</span> <span class="n">m_firstElementName</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC391" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC392" class="line" lang="java">            <span class="nc">String</span> <span class="n">prefix1</span> <span class="o">=</span> <span class="n">getPrefixPart</span><span class="o">(</span><span class="n">m_firstElementName</span><span class="o">);</span></span>
<span id="LC393" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">prefix1</span> <span class="o">==</span> <span class="kc">null</span> <span class="o">&amp;&amp;</span> <span class="no">EMPTYSTRING</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">prefix</span><span class="o">))</span></span>
<span id="LC394" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC395" class="line" lang="java">                <span class="c1">// the elements URI is not known yet, and it</span></span>
<span id="LC396" class="line" lang="java">                <span class="c1">// doesn't have a prefix, and we are currently</span></span>
<span id="LC397" class="line" lang="java">                <span class="c1">// setting the uri for prefix "", so we have</span></span>
<span id="LC398" class="line" lang="java">                <span class="c1">// the uri for the element... lets remember it</span></span>
<span id="LC399" class="line" lang="java">                <span class="n">m_firstElementURI</span> <span class="o">=</span> <span class="n">uri</span><span class="o">;</span></span>
<span id="LC400" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC401" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC402" class="line" lang="java">        <span class="n">startPrefixMapping</span><span class="o">(</span><span class="n">prefix</span><span class="o">,</span><span class="n">uri</span><span class="o">,</span> <span class="kc">false</span><span class="o">);</span></span>
<span id="LC403" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC404" class="line" lang="java"></span>
<span id="LC405" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">startPrefixMapping</span><span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">,</span> <span class="nc">String</span> <span class="n">uri</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">shouldFlush</span><span class="o">)</span></span>
<span id="LC406" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC407" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC408" class="line" lang="java">        <span class="kt">boolean</span> <span class="n">pushed</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC409" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC410" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC411" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">m_firstElementName</span> <span class="o">!=</span> <span class="kc">null</span> <span class="o">&amp;&amp;</span> <span class="n">shouldFlush</span><span class="o">)</span></span>
<span id="LC412" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC413" class="line" lang="java">                <span class="cm">/* we've already seen a startElement, and this is a prefix mapping</span></span>
<span id="LC414" class="line" lang="java"><span class="cm">                 * for the up coming element, so flush the old element</span></span>
<span id="LC415" class="line" lang="java"><span class="cm">                 * then send this event on its way.</span></span>
<span id="LC416" class="line" lang="java"><span class="cm">                 */</span></span>
<span id="LC417" class="line" lang="java">                <span class="n">flush</span><span class="o">();</span></span>
<span id="LC418" class="line" lang="java">                <span class="n">pushed</span> <span class="o">=</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">startPrefixMapping</span><span class="o">(</span><span class="n">prefix</span><span class="o">,</span> <span class="n">uri</span><span class="o">,</span> <span class="n">shouldFlush</span><span class="o">);</span></span>
<span id="LC419" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC420" class="line" lang="java">            <span class="k">else</span></span>
<span id="LC421" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC422" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="n">m_namespacePrefix</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC423" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC424" class="line" lang="java">                    <span class="n">m_namespacePrefix</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Vector</span><span class="o">();</span></span>
<span id="LC425" class="line" lang="java">                    <span class="n">m_namespaceURI</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">Vector</span><span class="o">();</span></span>
<span id="LC426" class="line" lang="java">                <span class="o">}</span></span>
<span id="LC427" class="line" lang="java">                <span class="n">m_namespacePrefix</span><span class="o">.</span><span class="na">addElement</span><span class="o">(</span><span class="n">prefix</span><span class="o">);</span></span>
<span id="LC428" class="line" lang="java">                <span class="n">m_namespaceURI</span><span class="o">.</span><span class="na">addElement</span><span class="o">(</span><span class="n">uri</span><span class="o">);</span></span>
<span id="LC429" class="line" lang="java"></span>
<span id="LC430" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="n">m_firstElementURI</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC431" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC432" class="line" lang="java">                    <span class="k">if</span> <span class="o">(</span><span class="n">prefix</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">m_firstElementPrefix</span><span class="o">))</span></span>
<span id="LC433" class="line" lang="java">                        <span class="n">m_firstElementURI</span> <span class="o">=</span> <span class="n">uri</span><span class="o">;</span></span>
...
<span id="LC440" class="line" lang="java">           <span class="n">pushed</span> <span class="o">=</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">startPrefixMapping</span><span class="o">(</span><span class="n">prefix</span><span class="o">,</span> <span class="n">uri</span><span class="o">,</span> <span class="n">shouldFlush</span><span class="o">);</span></span>
<span id="LC441" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC442" class="line" lang="java">        <span class="k">return</span> <span class="n">pushed</span><span class="o">;</span></span>
...
<span id="LC446" class="line" lang="java"><span class="cm">      * This method cannot be cached because default is different in</span></span>
<span id="LC447" class="line" lang="java"><span class="cm">      * HTML and XML (we need more than a boolean).</span></span>
<span id="LC448" class="line" lang="java"><span class="cm">      */</span></span>
<span id="LC449" class="line" lang="java"></span>
<span id="LC450" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setVersion</span><span class="o">(</span><span class="nc">String</span> <span class="n">version</span><span class="o">)</span></span>
<span id="LC451" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC452" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setVersion</span><span class="o">(</span><span class="n">version</span><span class="o">);</span></span>
<span id="LC453" class="line" lang="java"></span>
<span id="LC454" class="line" lang="java">        <span class="c1">// Cache call to setVersion()</span></span>
<span id="LC455" class="line" lang="java">        <span class="c1">//       super.setVersion(version);</span></span>
<span id="LC456" class="line" lang="java">        <span class="n">m_setVersion_called</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC460" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#startDocument()</span></span>
<span id="LC461" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC462" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startDocument</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC463" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC464" class="line" lang="java">        <span class="n">m_needToCallStartDocument</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC469" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startElement</span><span class="o">(</span><span class="nc">String</span> <span class="n">qName</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC470" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC471" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">startElement</span><span class="o">(</span><span class="kc">null</span><span class="o">,</span> <span class="kc">null</span><span class="o">,</span> <span class="n">qName</span><span class="o">,</span> <span class="kc">null</span><span class="o">);</span></span>
<span id="LC472" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC473" class="line" lang="java"></span>
<span id="LC474" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startElement</span><span class="o">(</span><span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">,</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span> <span class="nc">String</span> <span class="n">qName</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC475" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC476" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">startElement</span><span class="o">(</span><span class="n">namespaceURI</span><span class="o">,</span> <span class="n">localName</span><span class="o">,</span> <span class="n">qName</span><span class="o">,</span> <span class="kc">null</span><span class="o">);</span></span>
<span id="LC477" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC478" class="line" lang="java"></span>
<span id="LC479" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startElement</span><span class="o">(</span></span>
<span id="LC480" class="line" lang="java">        <span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">,</span></span>
<span id="LC481" class="line" lang="java">        <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span></span>
<span id="LC482" class="line" lang="java">        <span class="nc">String</span> <span class="n">elementName</span><span class="o">,</span></span>
<span id="LC483" class="line" lang="java">        <span class="nc">Attributes</span> <span class="n">atts</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC484" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC485" class="line" lang="java"></span>
<span id="LC486" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_needToCallSetDocumentInfo</span><span class="o">){</span></span>
<span id="LC487" class="line" lang="java">            <span class="kd">super</span><span class="o">.</span><span class="na">setDocumentInfo</span><span class="o">();</span></span>
<span id="LC488" class="line" lang="java">            <span class="n">m_needToCallSetDocumentInfo</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC489" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC490" class="line" lang="java"></span>
<span id="LC491" class="line" lang="java">        <span class="cm">/* we are notified of the start of an element */</span></span>
<span id="LC492" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC493" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC494" class="line" lang="java">            <span class="cm">/* we have not yet sent the first element on its way */</span></span>
<span id="LC495" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">m_firstElementName</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC496" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC497" class="line" lang="java">                <span class="cm">/* this is not the first element, but a later one.</span></span>
<span id="LC498" class="line" lang="java"><span class="cm">                 * But we have the old element pending, so flush it out,</span></span>
<span id="LC499" class="line" lang="java"><span class="cm">                 * then send this one on its way.</span></span>
<span id="LC500" class="line" lang="java"><span class="cm">                 */</span></span>
<span id="LC501" class="line" lang="java">                <span class="n">flush</span><span class="o">();</span></span>
<span id="LC502" class="line" lang="java">                <span class="n">m_handler</span><span class="o">.</span><span class="na">startElement</span><span class="o">(</span><span class="n">namespaceURI</span><span class="o">,</span> <span class="n">localName</span><span class="o">,</span> <span class="n">elementName</span><span class="o">,</span>  <span class="n">atts</span><span class="o">);</span></span>
<span id="LC503" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC504" class="line" lang="java">            <span class="k">else</span></span>
<span id="LC505" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC506" class="line" lang="java">                <span class="cm">/* this is the very first element that we have seen,</span></span>
<span id="LC507" class="line" lang="java"><span class="cm">                 * so save it for flushing later.  We may yet get to know its</span></span>
<span id="LC508" class="line" lang="java"><span class="cm">                 * URI due to added attributes.</span></span>
<span id="LC509" class="line" lang="java"><span class="cm">                 */</span></span>
<span id="LC510" class="line" lang="java"></span>
<span id="LC511" class="line" lang="java">                <span class="n">m_wrapped_handler_not_initialized</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC512" class="line" lang="java">                <span class="n">m_firstElementName</span> <span class="o">=</span> <span class="n">elementName</span><span class="o">;</span></span>
<span id="LC513" class="line" lang="java"></span>
<span id="LC514" class="line" lang="java">                <span class="c1">// null if not known</span></span>
<span id="LC515" class="line" lang="java">                <span class="n">m_firstElementPrefix</span> <span class="o">=</span> <span class="n">getPrefixPartUnknown</span><span class="o">(</span><span class="n">elementName</span><span class="o">);</span></span>
<span id="LC516" class="line" lang="java"></span>
<span id="LC517" class="line" lang="java">                <span class="c1">// null if not known</span></span>
<span id="LC518" class="line" lang="java">                <span class="n">m_firstElementURI</span> <span class="o">=</span> <span class="n">namespaceURI</span><span class="o">;</span></span>
<span id="LC519" class="line" lang="java"></span>
<span id="LC520" class="line" lang="java">                <span class="c1">// null if not known</span></span>
<span id="LC521" class="line" lang="java">                <span class="n">m_firstElementLocalName</span> <span class="o">=</span> <span class="n">localName</span><span class="o">;</span></span>
<span id="LC522" class="line" lang="java"></span>
<span id="LC523" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC524" class="line" lang="java">                    <span class="n">firePseudoElement</span><span class="o">(</span><span class="n">elementName</span><span class="o">);</span></span>
<span id="LC525" class="line" lang="java"></span>
<span id="LC526" class="line" lang="java">                <span class="cm">/* we don't want to call our own addAttributes, which</span></span>
<span id="LC527" class="line" lang="java"><span class="cm">                 * merely delegates to the wrapped handler, but we want to</span></span>
<span id="LC528" class="line" lang="java"><span class="cm">                 * add these attributes to m_attributes. So me must call super.</span></span>
<span id="LC529" class="line" lang="java"><span class="cm">                 * addAttributes() In this case m_attributes is only used for the</span></span>
<span id="LC530" class="line" lang="java"><span class="cm">                 * first element, after that this class totally delegates to the</span></span>
<span id="LC531" class="line" lang="java"><span class="cm">                 * wrapped handler which is either XML or HTML.</span></span>
<span id="LC532" class="line" lang="java"><span class="cm">                 */</span></span>
<span id="LC533" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="n">atts</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC534" class="line" lang="java">                    <span class="kd">super</span><span class="o">.</span><span class="na">addAttributes</span><span class="o">(</span><span class="n">atts</span><span class="o">);</span></span>
<span id="LC535" class="line" lang="java"></span>
<span id="LC536" class="line" lang="java">                <span class="c1">// if there are attributes, then lets make the flush()</span></span>
<span id="LC537" class="line" lang="java">                <span class="c1">// call the startElement on the handler and send the</span></span>
<span id="LC538" class="line" lang="java">                <span class="c1">// attributes on their way.</span></span>
<span id="LC539" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="n">atts</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC540" class="line" lang="java">                    <span class="n">flush</span><span class="o">();</span></span>
...
<span id="LC544" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC545" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC546" class="line" lang="java">            <span class="c1">// this is not the first element, but a later one, so just</span></span>
<span id="LC547" class="line" lang="java">            <span class="c1">// send it on its way.</span></span>
<span id="LC548" class="line" lang="java">            <span class="n">m_handler</span><span class="o">.</span><span class="na">startElement</span><span class="o">(</span><span class="n">namespaceURI</span><span class="o">,</span> <span class="n">localName</span><span class="o">,</span> <span class="n">elementName</span><span class="o">,</span>  <span class="n">atts</span><span class="o">);</span></span>
...
<span id="LC553" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC554" class="line" lang="java"><span class="cm">     * @see ExtendedLexicalHandler#comment(String)</span></span>
<span id="LC555" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC556" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">comment</span><span class="o">(</span><span class="nc">String</span> <span class="n">comment</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC557" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC558" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span> <span class="o">&amp;&amp;</span> <span class="n">m_firstElementName</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC559" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC560" class="line" lang="java">            <span class="n">emitFirstTag</span><span class="o">();</span></span>
<span id="LC561" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC562" class="line" lang="java">        <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="n">m_needToCallStartDocument</span><span class="o">)</span></span>
<span id="LC563" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC564" class="line" lang="java">            <span class="n">m_handler</span><span class="o">.</span><span class="na">startDocument</span><span class="o">();</span></span>
<span id="LC565" class="line" lang="java">            <span class="n">m_needToCallStartDocument</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC566" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC567" class="line" lang="java"></span>
<span id="LC568" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">comment</span><span class="o">(</span><span class="n">comment</span><span class="o">);</span></span>
...
<span id="LC572" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC573" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getDoctypePublic()</span></span>
<span id="LC574" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC575" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getDoctypePublic</span><span class="o">()</span></span>
<span id="LC576" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC577" class="line" lang="java"></span>
<span id="LC578" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getDoctypePublic</span><span class="o">();</span></span>
...
<span id="LC582" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC583" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getDoctypeSystem()</span></span>
<span id="LC584" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC585" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getDoctypeSystem</span><span class="o">()</span></span>
<span id="LC586" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC587" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getDoctypeSystem</span><span class="o">();</span></span>
...
<span id="LC591" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC592" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getEncoding()</span></span>
<span id="LC593" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC594" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getEncoding</span><span class="o">()</span></span>
<span id="LC595" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC596" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getEncoding</span><span class="o">();</span></span>
...
<span id="LC600" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC601" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getIndent()</span></span>
<span id="LC602" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC603" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getIndent</span><span class="o">()</span></span>
<span id="LC604" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC605" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getIndent</span><span class="o">();</span></span>
...
<span id="LC609" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC610" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getIndentAmount()</span></span>
<span id="LC611" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC612" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getIndentAmount</span><span class="o">()</span></span>
<span id="LC613" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC614" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getIndentAmount</span><span class="o">();</span></span>
...
<span id="LC618" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC619" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getMediaType()</span></span>
<span id="LC620" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC621" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMediaType</span><span class="o">()</span></span>
<span id="LC622" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC623" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getMediaType</span><span class="o">();</span></span>
...
<span id="LC627" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC628" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getOmitXMLDeclaration()</span></span>
<span id="LC629" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC630" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getOmitXMLDeclaration</span><span class="o">()</span></span>
<span id="LC631" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC632" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getOmitXMLDeclaration</span><span class="o">();</span></span>
...
<span id="LC636" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC637" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getStandalone()</span></span>
<span id="LC638" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC639" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getStandalone</span><span class="o">()</span></span>
<span id="LC640" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC641" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getStandalone</span><span class="o">();</span></span>
...
<span id="LC645" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC646" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getVersion()</span></span>
<span id="LC647" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC648" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getVersion</span><span class="o">()</span></span>
<span id="LC649" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC650" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getVersion</span><span class="o">();</span></span>
...
<span id="LC654" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setDoctype(String, String)</span></span>
<span id="LC655" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC656" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDoctype</span><span class="o">(</span><span class="nc">String</span> <span class="n">system</span><span class="o">,</span> <span class="nc">String</span> <span class="n">pub</span><span class="o">)</span></span>
<span id="LC657" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC658" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setDoctypePublic</span><span class="o">(</span><span class="n">pub</span><span class="o">);</span></span>
<span id="LC659" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setDoctypeSystem</span><span class="o">(</span><span class="n">system</span><span class="o">);</span></span>
...
<span id="LC663" class="line" lang="java"><span class="cm">     * Set the doctype in the underlying XML handler. Remember that this method</span></span>
<span id="LC664" class="line" lang="java"><span class="cm">     * was called, just in case we need to transfer this doctype to an HTML handler</span></span>
<span id="LC665" class="line" lang="java"><span class="cm">     * @param doctype the public doctype to set</span></span>
<span id="LC666" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setDoctypePublic(String)</span></span>
<span id="LC667" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC668" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDoctypePublic</span><span class="o">(</span><span class="nc">String</span> <span class="n">doctype</span><span class="o">)</span></span>
<span id="LC669" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC670" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setDoctypePublic</span><span class="o">(</span><span class="n">doctype</span><span class="o">);</span></span>
<span id="LC671" class="line" lang="java">        <span class="n">m_setDoctypePublic_called</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC675" class="line" lang="java"><span class="cm">     * Set the doctype in the underlying XML handler. Remember that this method</span></span>
<span id="LC676" class="line" lang="java"><span class="cm">     * was called, just in case we need to transfer this doctype to an HTML handler</span></span>
<span id="LC677" class="line" lang="java"><span class="cm">     * @param doctype the system doctype to set</span></span>
<span id="LC678" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setDoctypeSystem(String)</span></span>
<span id="LC679" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC680" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDoctypeSystem</span><span class="o">(</span><span class="nc">String</span> <span class="n">doctype</span><span class="o">)</span></span>
<span id="LC681" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC682" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setDoctypeSystem</span><span class="o">(</span><span class="n">doctype</span><span class="o">);</span></span>
<span id="LC683" class="line" lang="java">        <span class="n">m_setDoctypeSystem_called</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC687" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC688" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setEncoding(String)</span></span>
<span id="LC689" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC690" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setEncoding</span><span class="o">(</span><span class="nc">String</span> <span class="n">encoding</span><span class="o">)</span></span>
<span id="LC691" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC692" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setEncoding</span><span class="o">(</span><span class="n">encoding</span><span class="o">);</span></span>
...
<span id="LC696" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC697" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setIndent(boolean)</span></span>
<span id="LC698" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC699" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIndent</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">indent</span><span class="o">)</span></span>
<span id="LC700" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC701" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setIndent</span><span class="o">(</span><span class="n">indent</span><span class="o">);</span></span>
...
<span id="LC705" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC706" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC707" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIndentAmount</span><span class="o">(</span><span class="kt">int</span> <span class="n">value</span><span class="o">)</span></span>
<span id="LC708" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC709" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setIndentAmount</span><span class="o">(</span><span class="n">value</span><span class="o">);</span></span>
...
<span id="LC713" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setMediaType(String)</span></span>
<span id="LC714" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC715" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMediaType</span><span class="o">(</span><span class="nc">String</span> <span class="n">mediaType</span><span class="o">)</span></span>
<span id="LC716" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC717" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setMediaType</span><span class="o">(</span><span class="n">mediaType</span><span class="o">);</span></span>
<span id="LC718" class="line" lang="java">        <span class="n">m_setMediaType_called</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC722" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC723" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setOmitXMLDeclaration(boolean)</span></span>
<span id="LC724" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC725" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOmitXMLDeclaration</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">b</span><span class="o">)</span></span>
<span id="LC726" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC727" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setOmitXMLDeclaration</span><span class="o">(</span><span class="n">b</span><span class="o">);</span></span>
...
<span id="LC731" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC732" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setStandalone(String)</span></span>
<span id="LC733" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC734" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setStandalone</span><span class="o">(</span><span class="nc">String</span> <span class="n">standalone</span><span class="o">)</span></span>
<span id="LC735" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC736" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setStandalone</span><span class="o">(</span><span class="n">standalone</span><span class="o">);</span></span>
...
<span id="LC740" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setVersion(String)</span></span>
...
<span id="LC744" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC745" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.DeclHandler#attributeDecl(String, String, String, String, String)</span></span>
<span id="LC746" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC747" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">attributeDecl</span><span class="o">(</span></span>
<span id="LC748" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span></span>
<span id="LC749" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg1</span><span class="o">,</span></span>
<span id="LC750" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg2</span><span class="o">,</span></span>
<span id="LC751" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg3</span><span class="o">,</span></span>
<span id="LC752" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg4</span><span class="o">)</span></span>
<span id="LC753" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC754" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC755" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">attributeDecl</span><span class="o">(</span><span class="n">arg0</span><span class="o">,</span> <span class="n">arg1</span><span class="o">,</span> <span class="n">arg2</span><span class="o">,</span> <span class="n">arg3</span><span class="o">,</span> <span class="n">arg4</span><span class="o">);</span></span>
...
<span id="LC759" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC760" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.DeclHandler#elementDecl(String, String)</span></span>
<span id="LC761" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC762" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">elementDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg1</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC763" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC764" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC765" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC766" class="line" lang="java">            <span class="n">emitFirstTag</span><span class="o">();</span></span>
<span id="LC767" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC768" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">elementDecl</span><span class="o">(</span><span class="n">arg0</span><span class="o">,</span> <span class="n">arg1</span><span class="o">);</span></span>
...
<span id="LC772" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC773" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.DeclHandler#externalEntityDecl(String, String, String)</span></span>
<span id="LC774" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC775" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">externalEntityDecl</span><span class="o">(</span></span>
<span id="LC776" class="line" lang="java">        <span class="nc">String</span> <span class="n">name</span><span class="o">,</span></span>
<span id="LC777" class="line" lang="java">        <span class="nc">String</span> <span class="n">publicId</span><span class="o">,</span></span>
<span id="LC778" class="line" lang="java">        <span class="nc">String</span> <span class="n">systemId</span><span class="o">)</span></span>
<span id="LC779" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC780" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC781" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC782" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC783" class="line" lang="java">            <span class="n">flush</span><span class="o">();</span></span>
<span id="LC784" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC785" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">externalEntityDecl</span><span class="o">(</span><span class="n">name</span><span class="o">,</span> <span class="n">publicId</span><span class="o">,</span> <span class="n">systemId</span><span class="o">);</span></span>
...
<span id="LC789" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC790" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.DeclHandler#internalEntityDecl(String, String)</span></span>
<span id="LC791" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC792" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">internalEntityDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg1</span><span class="o">)</span></span>
<span id="LC793" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC794" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC795" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC796" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC797" class="line" lang="java">            <span class="n">flush</span><span class="o">();</span></span>
<span id="LC798" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC799" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">internalEntityDecl</span><span class="o">(</span><span class="n">arg0</span><span class="o">,</span> <span class="n">arg1</span><span class="o">);</span></span>
...
<span id="LC803" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC804" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#characters(char[], int, int)</span></span>
<span id="LC805" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC806" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">characters</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">characters</span><span class="o">,</span> <span class="kt">int</span> <span class="n">offset</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span></span>
<span id="LC807" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC808" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC809" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC810" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC811" class="line" lang="java">            <span class="n">flush</span><span class="o">();</span></span>
<span id="LC812" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC813" class="line" lang="java"></span>
<span id="LC814" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">characters</span><span class="o">(</span><span class="n">characters</span><span class="o">,</span> <span class="n">offset</span><span class="o">,</span> <span class="n">length</span><span class="o">);</span></span>
...
<span id="LC819" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC820" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#endDocument()</span></span>
<span id="LC821" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC822" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endDocument</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC823" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC824" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC825" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC826" class="line" lang="java">            <span class="n">flush</span><span class="o">();</span></span>
<span id="LC827" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC828" class="line" lang="java"></span>
<span id="LC829" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">endDocument</span><span class="o">();</span></span>
...
<span id="LC835" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC836" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#endElement(String, String, String)</span></span>
<span id="LC837" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC838" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endElement</span><span class="o">(</span><span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">,</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span> <span class="nc">String</span> <span class="n">qName</span><span class="o">)</span></span>
<span id="LC839" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC840" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC841" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC842" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC843" class="line" lang="java">            <span class="n">flush</span><span class="o">();</span></span>
<span id="LC844" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">namespaceURI</span> <span class="o">==</span> <span class="kc">null</span> <span class="o">&amp;&amp;</span> <span class="n">m_firstElementURI</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC845" class="line" lang="java">                <span class="n">namespaceURI</span> <span class="o">=</span> <span class="n">m_firstElementURI</span><span class="o">;</span></span>
<span id="LC846" class="line" lang="java"></span>
<span id="LC847" class="line" lang="java"></span>
<span id="LC848" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">localName</span> <span class="o">==</span> <span class="kc">null</span> <span class="o">&amp;&amp;</span> <span class="n">m_firstElementLocalName</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC849" class="line" lang="java">                <span class="n">localName</span> <span class="o">=</span> <span class="n">m_firstElementLocalName</span><span class="o">;</span></span>
<span id="LC850" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC851" class="line" lang="java"></span>
<span id="LC852" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">endElement</span><span class="o">(</span><span class="n">namespaceURI</span><span class="o">,</span> <span class="n">localName</span><span class="o">,</span> <span class="n">qName</span><span class="o">);</span></span>
...
<span id="LC856" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC857" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#endPrefixMapping(String)</span></span>
<span id="LC858" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC859" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endPrefixMapping</span><span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC860" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC861" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">endPrefixMapping</span><span class="o">(</span><span class="n">prefix</span><span class="o">);</span></span>
...
<span id="LC865" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC866" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#ignorableWhitespace(char[], int, int)</span></span>
<span id="LC867" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC868" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">ignorableWhitespace</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">ch</span><span class="o">,</span> <span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span></span>
<span id="LC869" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC870" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC871" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC872" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC873" class="line" lang="java">            <span class="n">flush</span><span class="o">();</span></span>
<span id="LC874" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC875" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">ignorableWhitespace</span><span class="o">(</span><span class="n">ch</span><span class="o">,</span> <span class="n">start</span><span class="o">,</span> <span class="n">length</span><span class="o">);</span></span>
...
<span id="LC879" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC880" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#processingInstruction(String, String)</span></span>
<span id="LC881" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC882" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">processingInstruction</span><span class="o">(</span><span class="nc">String</span> <span class="n">target</span><span class="o">,</span> <span class="nc">String</span> <span class="n">data</span><span class="o">)</span></span>
<span id="LC883" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC884" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC885" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC886" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC887" class="line" lang="java">            <span class="n">flush</span><span class="o">();</span></span>
<span id="LC888" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC889" class="line" lang="java"></span>
<span id="LC890" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">processingInstruction</span><span class="o">(</span><span class="n">target</span><span class="o">,</span> <span class="n">data</span><span class="o">);</span></span>
...
<span id="LC894" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC895" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#setDocumentLocator(Locator)</span></span>
<span id="LC896" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC897" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDocumentLocator</span><span class="o">(</span><span class="nc">Locator</span> <span class="n">locator</span><span class="o">)</span></span>
<span id="LC898" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC899" class="line" lang="java">        <span class="kd">super</span><span class="o">.</span><span class="na">setDocumentLocator</span><span class="o">(</span><span class="n">locator</span><span class="o">);</span></span>
<span id="LC900" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setDocumentLocator</span><span class="o">(</span><span class="n">locator</span><span class="o">);</span></span>
...
<span id="LC904" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC905" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#skippedEntity(String)</span></span>
<span id="LC906" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC907" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">skippedEntity</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC908" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC909" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">skippedEntity</span><span class="o">(</span><span class="n">name</span><span class="o">);</span></span>
...
<span id="LC915" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC916" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.LexicalHandler#comment(char[], int, int)</span></span>
<span id="LC917" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC918" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">comment</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">ch</span><span class="o">,</span> <span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC919" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC920" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC921" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC922" class="line" lang="java">            <span class="n">flush</span><span class="o">();</span></span>
<span id="LC923" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC924" class="line" lang="java"></span>
<span id="LC925" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">comment</span><span class="o">(</span><span class="n">ch</span><span class="o">,</span> <span class="n">start</span><span class="o">,</span> <span class="n">length</span><span class="o">);</span></span>
...
<span id="LC929" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC930" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.LexicalHandler#endCDATA()</span></span>
<span id="LC931" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC932" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endCDATA</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC933" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC934" class="line" lang="java"></span>
<span id="LC935" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">endCDATA</span><span class="o">();</span></span>
...
<span id="LC939" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC940" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.LexicalHandler#endDTD()</span></span>
<span id="LC941" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC942" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endDTD</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC943" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC944" class="line" lang="java"></span>
<span id="LC945" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">endDTD</span><span class="o">();</span></span>
...
<span id="LC949" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC950" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.LexicalHandler#endEntity(String)</span></span>
<span id="LC951" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC952" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endEntity</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC953" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC954" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC955" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC956" class="line" lang="java">            <span class="n">emitFirstTag</span><span class="o">();</span></span>
<span id="LC957" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC958" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">endEntity</span><span class="o">(</span><span class="n">name</span><span class="o">);</span></span>
...
<span id="LC962" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC963" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.LexicalHandler#startCDATA()</span></span>
<span id="LC964" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC965" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startCDATA</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC966" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC967" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">startCDATA</span><span class="o">();</span></span>
...
<span id="LC971" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC972" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.LexicalHandler#startDTD(String, String, String)</span></span>
<span id="LC973" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC974" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startDTD</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="nc">String</span> <span class="n">publicId</span><span class="o">,</span> <span class="nc">String</span> <span class="n">systemId</span><span class="o">)</span></span>
<span id="LC975" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC976" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC977" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">startDTD</span><span class="o">(</span><span class="n">name</span><span class="o">,</span> <span class="n">publicId</span><span class="o">,</span> <span class="n">systemId</span><span class="o">);</span></span>
...
<span id="LC981" class="line" lang="java"><span class="cm">     * Pass the call on to the underlying handler</span></span>
<span id="LC982" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.LexicalHandler#startEntity(String)</span></span>
<span id="LC983" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC984" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startEntity</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC985" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC986" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">startEntity</span><span class="o">(</span><span class="n">name</span><span class="o">);</span></span>
...
<span id="LC990" class="line" lang="java"><span class="cm">     * Initialize the wrapped output stream (XML or HTML).</span></span>
<span id="LC991" class="line" lang="java"><span class="cm">     * If the stream handler should be HTML, then replace the XML handler with</span></span>
<span id="LC992" class="line" lang="java"><span class="cm">     * an HTML handler. After than send the starting method calls that were cached</span></span>
<span id="LC993" class="line" lang="java"><span class="cm">     * to the wrapped handler.</span></span>
<span id="LC994" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC995" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC996" class="line" lang="java">    <span class="kd">private</span> <span class="kt">void</span> <span class="nf">initStreamOutput</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC997" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC998" class="line" lang="java"></span>
<span id="LC999" class="line" lang="java">        <span class="c1">// Try to rule out if this is an not to be an HTML document based on prefix</span></span>
<span id="LC1000" class="line" lang="java">        <span class="kt">boolean</span> <span class="n">firstElementIsHTML</span> <span class="o">=</span> <span class="n">isFirstElemHTML</span><span class="o">();</span></span>
<span id="LC1001" class="line" lang="java"></span>
<span id="LC1002" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">firstElementIsHTML</span><span class="o">)</span></span>
<span id="LC1003" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1004" class="line" lang="java">            <span class="c1">// create an HTML output handler, and initialize it</span></span>
<span id="LC1005" class="line" lang="java"></span>
<span id="LC1006" class="line" lang="java">            <span class="c1">// keep a reference to the old handler, ... it will soon be gone</span></span>
<span id="LC1007" class="line" lang="java">            <span class="nc">SerializationHandler</span> <span class="n">oldHandler</span> <span class="o">=</span> <span class="n">m_handler</span><span class="o">;</span></span>
<span id="LC1008" class="line" lang="java"></span>
<span id="LC1009" class="line" lang="java">            <span class="cm">/* We have to make sure we get an output properties with the proper</span></span>
<span id="LC1010" class="line" lang="java"><span class="cm">             * defaults for the HTML method.  The easiest way to do this is to</span></span>
<span id="LC1011" class="line" lang="java"><span class="cm">             * have the OutputProperties class do it.</span></span>
<span id="LC1012" class="line" lang="java"><span class="cm">             */</span></span>
<span id="LC1013" class="line" lang="java"></span>
<span id="LC1014" class="line" lang="java">            <span class="nc">Properties</span> <span class="n">htmlProperties</span> <span class="o">=</span></span>
<span id="LC1015" class="line" lang="java">                <span class="nc">OutputPropertiesFactory</span><span class="o">.</span><span class="na">getDefaultMethodProperties</span><span class="o">(</span><span class="nc">Method</span><span class="o">.</span><span class="na">HTML</span><span class="o">);</span></span>
<span id="LC1016" class="line" lang="java">            <span class="nc">Serializer</span> <span class="n">serializer</span> <span class="o">=</span></span>
<span id="LC1017" class="line" lang="java">                <span class="nc">SerializerFactory</span><span class="o">.</span><span class="na">getSerializer</span><span class="o">(</span><span class="n">htmlProperties</span><span class="o">);</span></span>
<span id="LC1018" class="line" lang="java"></span>
<span id="LC1019" class="line" lang="java">            <span class="c1">// The factory should be returning a ToStream</span></span>
<span id="LC1020" class="line" lang="java">            <span class="c1">// Don't know what to do if it doesn't</span></span>
<span id="LC1021" class="line" lang="java">            <span class="c1">// i.e. the user has over-ridden the content-handler property</span></span>
<span id="LC1022" class="line" lang="java">            <span class="c1">// for html</span></span>
<span id="LC1023" class="line" lang="java">            <span class="n">m_handler</span> <span class="o">=</span> <span class="o">(</span><span class="nc">SerializationHandler</span><span class="o">)</span> <span class="n">serializer</span><span class="o">;</span></span>
<span id="LC1024" class="line" lang="java">            <span class="c1">//m_handler = new ToHTMLStream();</span></span>
<span id="LC1025" class="line" lang="java"></span>
<span id="LC1026" class="line" lang="java">            <span class="nc">Writer</span> <span class="n">writer</span> <span class="o">=</span> <span class="n">oldHandler</span><span class="o">.</span><span class="na">getWriter</span><span class="o">();</span></span>
<span id="LC1027" class="line" lang="java"></span>
<span id="LC1028" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">writer</span><span class="o">)</span></span>
<span id="LC1029" class="line" lang="java">                <span class="n">m_handler</span><span class="o">.</span><span class="na">setWriter</span><span class="o">(</span><span class="n">writer</span><span class="o">);</span></span>
<span id="LC1030" class="line" lang="java">            <span class="k">else</span></span>
<span id="LC1031" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC1032" class="line" lang="java">                <span class="nc">OutputStream</span> <span class="n">os</span> <span class="o">=</span> <span class="n">oldHandler</span><span class="o">.</span><span class="na">getOutputStream</span><span class="o">();</span></span>
<span id="LC1033" class="line" lang="java"></span>
<span id="LC1034" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">os</span><span class="o">)</span></span>
<span id="LC1035" class="line" lang="java">                    <span class="n">m_handler</span><span class="o">.</span><span class="na">setOutputStream</span><span class="o">(</span><span class="n">os</span><span class="o">);</span></span>
<span id="LC1036" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC1037" class="line" lang="java"></span>
<span id="LC1038" class="line" lang="java">            <span class="c1">// need to copy things from the old handler to the new one here</span></span>
<span id="LC1039" class="line" lang="java"></span>
<span id="LC1040" class="line" lang="java">            <span class="c1">//            if (_setVersion_called)</span></span>
<span id="LC1041" class="line" lang="java">            <span class="c1">//            {</span></span>
<span id="LC1042" class="line" lang="java">            <span class="n">m_handler</span><span class="o">.</span><span class="na">setVersion</span><span class="o">(</span><span class="n">oldHandler</span><span class="o">.</span><span class="na">getVersion</span><span class="o">());</span></span>
<span id="LC1043" class="line" lang="java">            <span class="c1">//            }</span></span>
<span id="LC1044" class="line" lang="java">            <span class="c1">//            if (_setDoctypeSystem_called)</span></span>
<span id="LC1045" class="line" lang="java">            <span class="c1">//            {</span></span>
<span id="LC1046" class="line" lang="java">            <span class="n">m_handler</span><span class="o">.</span><span class="na">setDoctypeSystem</span><span class="o">(</span><span class="n">oldHandler</span><span class="o">.</span><span class="na">getDoctypeSystem</span><span class="o">());</span></span>
<span id="LC1047" class="line" lang="java">            <span class="c1">//            }</span></span>
<span id="LC1048" class="line" lang="java">            <span class="c1">//            if (_setDoctypePublic_called)</span></span>
<span id="LC1049" class="line" lang="java">            <span class="c1">//            {</span></span>
<span id="LC1050" class="line" lang="java">            <span class="n">m_handler</span><span class="o">.</span><span class="na">setDoctypePublic</span><span class="o">(</span><span class="n">oldHandler</span><span class="o">.</span><span class="na">getDoctypePublic</span><span class="o">());</span></span>
<span id="LC1051" class="line" lang="java">            <span class="c1">//            }</span></span>
<span id="LC1052" class="line" lang="java">            <span class="c1">//            if (_setMediaType_called)</span></span>
<span id="LC1053" class="line" lang="java">            <span class="c1">//            {</span></span>
<span id="LC1054" class="line" lang="java">            <span class="n">m_handler</span><span class="o">.</span><span class="na">setMediaType</span><span class="o">(</span><span class="n">oldHandler</span><span class="o">.</span><span class="na">getMediaType</span><span class="o">());</span></span>
<span id="LC1055" class="line" lang="java">            <span class="c1">//            }</span></span>
<span id="LC1056" class="line" lang="java"></span>
<span id="LC1057" class="line" lang="java">            <span class="n">m_handler</span><span class="o">.</span><span class="na">setTransformer</span><span class="o">(</span><span class="n">oldHandler</span><span class="o">.</span><span class="na">getTransformer</span><span class="o">());</span></span>
<span id="LC1058" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1059" class="line" lang="java"></span>
<span id="LC1060" class="line" lang="java">        <span class="cm">/* Now that we have a real wrapped handler (XML or HTML) lets</span></span>
<span id="LC1061" class="line" lang="java"><span class="cm">         * pass any cached calls to it</span></span>
<span id="LC1062" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC1063" class="line" lang="java">        <span class="c1">// Call startDocument() if necessary</span></span>
<span id="LC1064" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_needToCallStartDocument</span><span class="o">)</span></span>
<span id="LC1065" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1066" class="line" lang="java">            <span class="n">m_handler</span><span class="o">.</span><span class="na">startDocument</span><span class="o">();</span></span>
<span id="LC1067" class="line" lang="java">            <span class="n">m_needToCallStartDocument</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1068" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1069" class="line" lang="java"></span>
<span id="LC1070" class="line" lang="java">        <span class="c1">// the wrapped handler is now fully initialized</span></span>
<span id="LC1071" class="line" lang="java">        <span class="n">m_wrapped_handler_not_initialized</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1072" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1073" class="line" lang="java"></span>
<span id="LC1074" class="line" lang="java">    <span class="kd">private</span> <span class="kt">void</span> <span class="nf">emitFirstTag</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC1075" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1076" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstElementName</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1077" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1078" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">m_wrapped_handler_not_initialized</span><span class="o">)</span></span>
<span id="LC1079" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC1080" class="line" lang="java">                <span class="n">initStreamOutput</span><span class="o">();</span></span>
<span id="LC1081" class="line" lang="java">                <span class="n">m_wrapped_handler_not_initialized</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1082" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC1083" class="line" lang="java">            <span class="c1">// Output first tag</span></span>
<span id="LC1084" class="line" lang="java">            <span class="n">m_handler</span><span class="o">.</span><span class="na">startElement</span><span class="o">(</span><span class="n">m_firstElementURI</span><span class="o">,</span> <span class="kc">null</span><span class="o">,</span> <span class="n">m_firstElementName</span><span class="o">,</span> <span class="n">m_attributes</span><span class="o">);</span></span>
<span id="LC1085" class="line" lang="java">            <span class="c1">// don't need the collected attributes of the first element anymore.</span></span>
<span id="LC1086" class="line" lang="java">            <span class="n">m_attributes</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1087" class="line" lang="java"></span>
<span id="LC1088" class="line" lang="java">            <span class="c1">// Output namespaces of first tag</span></span>
<span id="LC1089" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">m_namespacePrefix</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1090" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC1091" class="line" lang="java">                <span class="kd">final</span> <span class="kt">int</span> <span class="n">n</span> <span class="o">=</span> <span class="n">m_namespacePrefix</span><span class="o">.</span><span class="na">size</span><span class="o">();</span></span>
<span id="LC1092" class="line" lang="java">                <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">n</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC1093" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC1094" class="line" lang="java">                    <span class="kd">final</span> <span class="nc">String</span> <span class="n">prefix</span> <span class="o">=</span></span>
<span id="LC1095" class="line" lang="java">                        <span class="o">(</span><span class="nc">String</span><span class="o">)</span> <span class="n">m_namespacePrefix</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC1096" class="line" lang="java">                    <span class="kd">final</span> <span class="nc">String</span> <span class="n">uri</span> <span class="o">=</span> <span class="o">(</span><span class="nc">String</span><span class="o">)</span> <span class="n">m_namespaceURI</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC1097" class="line" lang="java">                    <span class="n">m_handler</span><span class="o">.</span><span class="na">startPrefixMapping</span><span class="o">(</span><span class="n">prefix</span><span class="o">,</span> <span class="n">uri</span><span class="o">,</span> <span class="kc">false</span><span class="o">);</span></span>
<span id="LC1098" class="line" lang="java">                <span class="o">}</span></span>
<span id="LC1099" class="line" lang="java">                <span class="n">m_namespacePrefix</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1100" class="line" lang="java">                <span class="n">m_namespaceURI</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1101" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC1102" class="line" lang="java">            <span class="n">m_firstTagNotEmitted</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC1107" class="line" lang="java"><span class="cm">     * Utility function for calls to local-name().</span></span>
<span id="LC1108" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1109" class="line" lang="java"><span class="cm">     * Don't want to override static function on SerializerBase</span></span>
<span id="LC1110" class="line" lang="java"><span class="cm">     * So added Unknown suffix to method name.</span></span>
<span id="LC1111" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1112" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="nf">getLocalNameUnknown</span><span class="o">(</span><span class="nc">String</span> <span class="n">value</span><span class="o">)</span></span>
<span id="LC1113" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1114" class="line" lang="java">        <span class="kt">int</span> <span class="n">idx</span> <span class="o">=</span> <span class="n">value</span><span class="o">.</span><span class="na">lastIndexOf</span><span class="o">(</span><span class="sc">':'</span><span class="o">);</span></span>
<span id="LC1115" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">idx</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="o">)</span></span>
<span id="LC1116" class="line" lang="java">            <span class="n">value</span> <span class="o">=</span> <span class="n">value</span><span class="o">.</span><span class="na">substring</span><span class="o">(</span><span class="n">idx</span> <span class="o">+</span> <span class="mi">1</span><span class="o">);</span></span>
<span id="LC1117" class="line" lang="java">        <span class="n">idx</span> <span class="o">=</span> <span class="n">value</span><span class="o">.</span><span class="na">lastIndexOf</span><span class="o">(</span><span class="sc">'@'</span><span class="o">);</span></span>
<span id="LC1118" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">idx</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="o">)</span></span>
<span id="LC1119" class="line" lang="java">            <span class="n">value</span> <span class="o">=</span> <span class="n">value</span><span class="o">.</span><span class="na">substring</span><span class="o">(</span><span class="n">idx</span> <span class="o">+</span> <span class="mi">1</span><span class="o">);</span></span>
<span id="LC1120" class="line" lang="java">        <span class="k">return</span> <span class="o">(</span><span class="n">value</span><span class="o">);</span></span>
...
<span id="LC1124" class="line" lang="java"><span class="cm">         * Utility function to return prefix</span></span>
<span id="LC1125" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC1126" class="line" lang="java"><span class="cm">         * Don't want to override static function on SerializerBase</span></span>
<span id="LC1127" class="line" lang="java"><span class="cm">         * So added Unknown suffix to method name.</span></span>
<span id="LC1128" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC1129" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="nf">getPrefixPartUnknown</span><span class="o">(</span><span class="nc">String</span> <span class="n">qname</span><span class="o">)</span></span>
<span id="LC1130" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1131" class="line" lang="java">        <span class="kd">final</span> <span class="kt">int</span> <span class="n">index</span> <span class="o">=</span> <span class="n">qname</span><span class="o">.</span><span class="na">indexOf</span><span class="o">(</span><span class="sc">':'</span><span class="o">);</span></span>
<span id="LC1132" class="line" lang="java">        <span class="k">return</span> <span class="o">(</span><span class="n">index</span> <span class="o">&gt;</span> <span class="mi">0</span><span class="o">)</span> <span class="o">?</span> <span class="n">qname</span><span class="o">.</span><span class="na">substring</span><span class="o">(</span><span class="mi">0</span><span class="o">,</span> <span class="n">index</span><span class="o">)</span> <span class="o">:</span> <span class="no">EMPTYSTRING</span><span class="o">;</span></span>
...
<span id="LC1136" class="line" lang="java"><span class="cm">     * Determine if the firts element in the document is &lt;html&gt; or &lt;HTML&gt;</span></span>
<span id="LC1137" class="line" lang="java"><span class="cm">     * This uses the cached first element name, first element prefix and the</span></span>
<span id="LC1138" class="line" lang="java"><span class="cm">     * cached namespaces from previous method calls</span></span>
<span id="LC1139" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1140" class="line" lang="java"><span class="cm">     * @return true if the first element is an opening &lt;html&gt; tag</span></span>
<span id="LC1141" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1142" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="nf">isFirstElemHTML</span><span class="o">()</span></span>
<span id="LC1143" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1144" class="line" lang="java">        <span class="kt">boolean</span> <span class="n">isHTML</span><span class="o">;</span></span>
<span id="LC1145" class="line" lang="java"></span>
<span id="LC1146" class="line" lang="java">        <span class="c1">// is the first tag html, not considering the prefix ?</span></span>
<span id="LC1147" class="line" lang="java">        <span class="n">isHTML</span> <span class="o">=</span></span>
<span id="LC1148" class="line" lang="java">            <span class="n">getLocalNameUnknown</span><span class="o">(</span><span class="n">m_firstElementName</span><span class="o">).</span><span class="na">equalsIgnoreCase</span><span class="o">(</span><span class="s">"html"</span><span class="o">);</span></span>
<span id="LC1149" class="line" lang="java"></span>
<span id="LC1150" class="line" lang="java">        <span class="c1">// Try to rule out if this is not to be an HTML document based on URI</span></span>
<span id="LC1151" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">isHTML</span></span>
<span id="LC1152" class="line" lang="java">            <span class="o">&amp;&amp;</span> <span class="n">m_firstElementURI</span> <span class="o">!=</span> <span class="kc">null</span></span>
<span id="LC1153" class="line" lang="java">            <span class="o">&amp;&amp;</span> <span class="o">!</span><span class="no">EMPTYSTRING</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">m_firstElementURI</span><span class="o">))</span></span>
<span id="LC1154" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1155" class="line" lang="java">            <span class="c1">// the &lt;html&gt; element has a non-trivial namespace</span></span>
<span id="LC1156" class="line" lang="java">            <span class="n">isHTML</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1157" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1158" class="line" lang="java">        <span class="c1">// Try to rule out if this is an not to be an HTML document based on prefix</span></span>
<span id="LC1159" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">isHTML</span> <span class="o">&amp;&amp;</span> <span class="n">m_namespacePrefix</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1160" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1161" class="line" lang="java">            <span class="cm">/* the first element has a name of "html", but lets check the prefix.</span></span>
<span id="LC1162" class="line" lang="java"><span class="cm">             * If the prefix points to a namespace with a URL that is not ""</span></span>
<span id="LC1163" class="line" lang="java"><span class="cm">             * then the doecument doesn't start with an &lt;html&gt; tag, and isn't html</span></span>
<span id="LC1164" class="line" lang="java"><span class="cm">             */</span></span>
<span id="LC1165" class="line" lang="java">            <span class="kd">final</span> <span class="kt">int</span> <span class="n">max</span> <span class="o">=</span> <span class="n">m_namespacePrefix</span><span class="o">.</span><span class="na">size</span><span class="o">();</span></span>
<span id="LC1166" class="line" lang="java">            <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">max</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC1167" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC1168" class="line" lang="java">                <span class="kd">final</span> <span class="nc">String</span> <span class="n">prefix</span> <span class="o">=</span> <span class="o">(</span><span class="nc">String</span><span class="o">)</span> <span class="n">m_namespacePrefix</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC1169" class="line" lang="java">                <span class="kd">final</span> <span class="nc">String</span> <span class="n">uri</span> <span class="o">=</span> <span class="o">(</span><span class="nc">String</span><span class="o">)</span> <span class="n">m_namespaceURI</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC1170" class="line" lang="java"></span>
<span id="LC1171" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="n">m_firstElementPrefix</span> <span class="o">!=</span> <span class="kc">null</span></span>
<span id="LC1172" class="line" lang="java">                    <span class="o">&amp;&amp;</span> <span class="n">m_firstElementPrefix</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">prefix</span><span class="o">)</span></span>
<span id="LC1173" class="line" lang="java">                    <span class="o">&amp;&amp;</span> <span class="o">!</span><span class="no">EMPTYSTRING</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">uri</span><span class="o">))</span></span>
<span id="LC1174" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC1175" class="line" lang="java">                    <span class="c1">// The first element has a prefix, so it can't be &lt;html&gt;</span></span>
<span id="LC1176" class="line" lang="java">                    <span class="n">isHTML</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC1182" class="line" lang="java">        <span class="k">return</span> <span class="n">isHTML</span><span class="o">;</span></span>
<span id="LC1183" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1184" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1185" class="line" lang="java"><span class="cm">     * @see Serializer#asDOMSerializer()</span></span>
<span id="LC1186" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1187" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DOMSerializer</span> <span class="nf">asDOMSerializer</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
<span id="LC1188" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1189" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">asDOMSerializer</span><span class="o">();</span></span>
...
<span id="LC1193" class="line" lang="java"><span class="cm">     * @param URI_and_localNames Vector a list of pairs of URI/localName</span></span>
<span id="LC1194" class="line" lang="java"><span class="cm">     * specified in the cdata-section-elements attribute.</span></span>
<span id="LC1195" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setCdataSectionElements(java.util.Vector)</span></span>
<span id="LC1196" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1197" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCdataSectionElements</span><span class="o">(</span><span class="nc">Vector</span> <span class="n">URI_and_localNames</span><span class="o">)</span></span>
<span id="LC1198" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1199" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setCdataSectionElements</span><span class="o">(</span><span class="n">URI_and_localNames</span><span class="o">);</span></span>
<span id="LC1200" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1201" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1202" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#addAttributes(org.xml.sax.Attributes)</span></span>
<span id="LC1203" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1204" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addAttributes</span><span class="o">(</span><span class="nc">Attributes</span> <span class="n">atts</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC1205" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1206" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">addAttributes</span><span class="o">(</span><span class="n">atts</span><span class="o">);</span></span>
...
<span id="LC1210" class="line" lang="java"><span class="cm">     * Get the current namespace mappings.</span></span>
<span id="LC1211" class="line" lang="java"><span class="cm">     * Simply returns the mappings of the wrapped handler.</span></span>
<span id="LC1212" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#getNamespaceMappings()</span></span>
<span id="LC1213" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1214" class="line" lang="java">    <span class="kd">public</span> <span class="nc">NamespaceMappings</span> <span class="nf">getNamespaceMappings</span><span class="o">()</span></span>
<span id="LC1215" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1216" class="line" lang="java">        <span class="nc">NamespaceMappings</span> <span class="n">mappings</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1217" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_handler</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1218" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1219" class="line" lang="java">            <span class="n">mappings</span> <span class="o">=</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getNamespaceMappings</span><span class="o">();</span></span>
<span id="LC1220" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1221" class="line" lang="java">        <span class="k">return</span> <span class="n">mappings</span><span class="o">;</span></span>
<span id="LC1222" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1223" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1224" class="line" lang="java"><span class="cm">     * @see SerializationHandler#flushPending()</span></span>
<span id="LC1225" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1226" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">flushPending</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC1227" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1228" class="line" lang="java"></span>
<span id="LC1229" class="line" lang="java">        <span class="n">flush</span><span class="o">();</span></span>
<span id="LC1230" class="line" lang="java"></span>
<span id="LC1231" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">flushPending</span><span class="o">();</span></span>
<span id="LC1232" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1233" class="line" lang="java"></span>
<span id="LC1234" class="line" lang="java">    <span class="kd">private</span> <span class="kt">void</span> <span class="nf">flush</span><span class="o">()</span></span>
<span id="LC1235" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1236" class="line" lang="java">        <span class="k">try</span></span>
<span id="LC1237" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1238" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_firstTagNotEmitted</span><span class="o">)</span></span>
<span id="LC1239" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1240" class="line" lang="java">            <span class="n">emitFirstTag</span><span class="o">();</span></span>
<span id="LC1241" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1242" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_needToCallStartDocument</span><span class="o">)</span></span>
<span id="LC1243" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1244" class="line" lang="java">            <span class="n">m_handler</span><span class="o">.</span><span class="na">startDocument</span><span class="o">();</span></span>
<span id="LC1245" class="line" lang="java">            <span class="n">m_needToCallStartDocument</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1246" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1247" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1248" class="line" lang="java">        <span class="k">catch</span><span class="o">(</span><span class="nc">SAXException</span> <span class="n">e</span><span class="o">)</span></span>
<span id="LC1249" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1250" class="line" lang="java">            <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="n">e</span><span class="o">.</span><span class="na">toString</span><span class="o">());</span></span>
...
<span id="LC1257" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#getPrefix</span></span>
<span id="LC1258" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1259" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPrefix</span><span class="o">(</span><span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">)</span></span>
<span id="LC1260" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1261" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getPrefix</span><span class="o">(</span><span class="n">namespaceURI</span><span class="o">);</span></span>
<span id="LC1262" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1263" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1264" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#entityReference(java.lang.String)</span></span>
<span id="LC1265" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1266" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">entityReference</span><span class="o">(</span><span class="nc">String</span> <span class="n">entityName</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC1267" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1268" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">entityReference</span><span class="o">(</span><span class="n">entityName</span><span class="o">);</span></span>
...
<span id="LC1272" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#getNamespaceURI(java.lang.String, boolean)</span></span>
<span id="LC1273" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1274" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getNamespaceURI</span><span class="o">(</span><span class="nc">String</span> <span class="n">qname</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">isElement</span><span class="o">)</span></span>
<span id="LC1275" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1276" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getNamespaceURI</span><span class="o">(</span><span class="n">qname</span><span class="o">,</span> <span class="n">isElement</span><span class="o">);</span></span>
<span id="LC1277" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1278" class="line" lang="java"></span>
<span id="LC1279" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getNamespaceURIFromPrefix</span><span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">)</span></span>
<span id="LC1280" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1281" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getNamespaceURIFromPrefix</span><span class="o">(</span><span class="n">prefix</span><span class="o">);</span></span>
<span id="LC1282" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1283" class="line" lang="java"></span>
<span id="LC1284" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTransformer</span><span class="o">(</span><span class="nc">Transformer</span> <span class="n">t</span><span class="o">)</span></span>
<span id="LC1285" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1286" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setTransformer</span><span class="o">(</span><span class="n">t</span><span class="o">);</span></span>
<span id="LC1287" class="line" lang="java">        <span class="k">if</span> <span class="o">((</span><span class="n">t</span> <span class="k">instanceof</span> <span class="nc">SerializerTrace</span><span class="o">)</span> <span class="o">&amp;&amp;</span></span>
<span id="LC1288" class="line" lang="java">            <span class="o">(((</span><span class="nc">SerializerTrace</span><span class="o">)</span> <span class="n">t</span><span class="o">).</span><span class="na">hasTraceListeners</span><span class="o">()))</span> <span class="o">{</span></span>
<span id="LC1289" class="line" lang="java">           <span class="n">m_tracer</span> <span class="o">=</span> <span class="o">(</span><span class="nc">SerializerTrace</span><span class="o">)</span> <span class="n">t</span><span class="o">;</span></span>
<span id="LC1290" class="line" lang="java">        <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC1291" class="line" lang="java">           <span class="n">m_tracer</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1292" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1293" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1294" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Transformer</span> <span class="nf">getTransformer</span><span class="o">()</span></span>
<span id="LC1295" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1296" class="line" lang="java">        <span class="k">return</span> <span class="n">m_handler</span><span class="o">.</span><span class="na">getTransformer</span><span class="o">();</span></span>
...
<span id="LC1300" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setContentHandler(org.xml.sax.ContentHandler)</span></span>
<span id="LC1301" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1302" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setContentHandler</span><span class="o">(</span><span class="nc">ContentHandler</span> <span class="n">ch</span><span class="o">)</span></span>
<span id="LC1303" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1304" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setContentHandler</span><span class="o">(</span><span class="n">ch</span><span class="o">);</span></span>
<span id="LC1305" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1306" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1307" class="line" lang="java"><span class="cm">     * This method is used to set the source locator, which might be used to</span></span>
<span id="LC1308" class="line" lang="java"><span class="cm">     * generated an error message.</span></span>
<span id="LC1309" class="line" lang="java"><span class="cm">     * @param locator the source locator</span></span>
<span id="LC1310" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1311" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#setSourceLocator(javax.xml.transform.SourceLocator)</span></span>
<span id="LC1312" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1313" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSourceLocator</span><span class="o">(</span><span class="nc">SourceLocator</span> <span class="n">locator</span><span class="o">)</span></span>
<span id="LC1314" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1315" class="line" lang="java">        <span class="n">m_handler</span><span class="o">.</span><span class="na">setSourceLocator</span><span class="o">(</span><span class="n">locator</span><span class="o">);</span></span>
<span id="LC1316" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1317" class="line" lang="java"></span>
<span id="LC1318" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">firePseudoElement</span><span class="o">(</span><span class="nc">String</span> <span class="n">elementName</span><span class="o">)</span></span>
<span id="LC1319" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1320" class="line" lang="java"></span>
<span id="LC1321" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1322" class="line" lang="java">            <span class="nc">StringBuffer</span> <span class="n">sb</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">StringBuffer</span><span class="o">();</span></span>
<span id="LC1323" class="line" lang="java"></span>
<span id="LC1324" class="line" lang="java">            <span class="n">sb</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="sc">'&lt;'</span><span class="o">);</span></span>
<span id="LC1325" class="line" lang="java">            <span class="n">sb</span><span class="o">.</span><span class="na">append</span><span class="o">(</span><span class="n">elementName</span><span class="o">);</span></span>
<span id="LC1326" class="line" lang="java"></span>
<span id="LC1327" class="line" lang="java">            <span class="c1">// convert the StringBuffer to a char array and</span></span>
<span id="LC1328" class="line" lang="java">            <span class="c1">// emit the trace event that these characters "might"</span></span>
<span id="LC1329" class="line" lang="java">            <span class="c1">// be written</span></span>
<span id="LC1330" class="line" lang="java">            <span class="kt">char</span> <span class="n">ch</span><span class="o">[]</span> <span class="o">=</span> <span class="n">sb</span><span class="o">.</span><span class="na">toString</span><span class="o">().</span><span class="na">toCharArray</span><span class="o">();</span></span>
<span id="LC1331" class="line" lang="java">            <span class="n">m_tracer</span><span class="o">.</span><span class="na">fireGenerateEvent</span><span class="o">(</span></span>
<span id="LC1332" class="line" lang="java">                <span class="nc">SerializerTrace</span><span class="o">.</span><span class="na">EVENTTYPE_OUTPUT_PSEUDO_CHARACTERS</span><span class="o">,</span></span>
<span id="LC1333" class="line" lang="java">                <span class="n">ch</span><span class="o">,</span></span>
<span id="LC1334" class="line" lang="java">                <span class="mi">0</span><span class="o">,</span></span>
<span id="LC1335" class="line" lang="java">                <span class="n">ch</span><span class="o">.</span><span class="na">length</span><span class="o">);</span></span>
