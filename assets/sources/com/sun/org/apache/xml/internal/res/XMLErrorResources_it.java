...
<span id="LC35" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XMLErrorResources_it</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span></span>
...
<span id="LC185" class="line" lang="java">      <span class="s">"Funzione non supportata."</span><span class="o">},</span></span>
...
<span id="LC188" class="line" lang="java">      <span class="s">"Impossibile sovrascrivere la causa"</span><span class="o">},</span></span>
...
<span id="LC191" class="line" lang="java">      <span class="s">"Nessuna implementazione predefinita trovata "</span><span class="o">},</span></span>
...
<span id="LC194" class="line" lang="java">      <span class="s">"ChunkedIntArray({0}) non supportato al momento"</span><span class="o">},</span></span>
...
<span id="LC197" class="line" lang="java">      <span class="s">"Offset pi\u00F9 grande dello slot"</span><span class="o">},</span></span>
...
<span id="LC200" class="line" lang="java">      <span class="s">"Co-routine non disponibile, ID={0}"</span><span class="o">},</span></span>
...
<span id="LC203" class="line" lang="java">      <span class="s">"CoroutineManager ha ricevuto una richiesta co_exit()"</span><span class="o">},</span></span>
...
<span id="LC206" class="line" lang="java">      <span class="s">"co_joinCoroutineSet() non riuscito"</span><span class="o">},</span></span>
...
<span id="LC209" class="line" lang="java">      <span class="s">"Errore del parametro di co-routine ({0})"</span><span class="o">},</span></span>
...
<span id="LC212" class="line" lang="java">      <span class="s">"\nIMPREVISTO: risposte doTerminate del parser {0}"</span><span class="o">},</span></span>
...
<span id="LC215" class="line" lang="java">      <span class="s">"impossibile richiamare parse mentre \u00E8 in corso un'analisi"</span><span class="o">},</span></span>
...
<span id="LC218" class="line" lang="java">      <span class="s">"Errore: l''iteratore con tipo per l''asse {0} non \u00E8 implementato"</span><span class="o">},</span></span>
...
<span id="LC221" class="line" lang="java">      <span class="s">"Errore: l''iteratore per l''asse {0} non \u00E8 implementato "</span><span class="o">},</span></span>
...
<span id="LC224" class="line" lang="java">      <span class="s">"Duplicazione dell'iteratore non supportata"</span><span class="o">},</span></span>
...
<span id="LC227" class="line" lang="java">      <span class="s">"Tipo di asse trasversale sconosciuto: {0}"</span><span class="o">},</span></span>
...
<span id="LC230" class="line" lang="java">      <span class="s">"Asse trasversale non supportato: {0}"</span><span class="o">},</span></span>
...
<span id="LC233" class="line" lang="java">      <span class="s">"Non sono disponibili altri ID DTM"</span><span class="o">},</span></span>
...
<span id="LC236" class="line" lang="java">      <span class="s">"Non supportato: {0}"</span><span class="o">},</span></span>
...
<span id="LC239" class="line" lang="java">      <span class="s">"Il nodo deve essere non nullo per getDTMHandleFromNode"</span><span class="o">},</span></span>
...
<span id="LC242" class="line" lang="java">      <span class="s">"Impossibile risolvere il nodo in un handle"</span><span class="o">},</span></span>
...
<span id="LC245" class="line" lang="java">       <span class="s">"impossibile richiamare startParse mentre \u00E8 in corso un'analisi"</span><span class="o">},</span></span>
...
<span id="LC248" class="line" lang="java">       <span class="s">"startParse richiede un valore non nullo per SAXParser"</span><span class="o">},</span></span>
...
<span id="LC251" class="line" lang="java">       <span class="s">"impossibile inizializzare il parser con"</span><span class="o">},</span></span>
...
<span id="LC254" class="line" lang="java">       <span class="s">"eccezione durante la creazione di una nuova istanza per il pool"</span><span class="o">},</span></span>
...
<span id="LC257" class="line" lang="java">       <span class="s">"Il percorso contiene sequenza di escape non valida"</span><span class="o">},</span></span>
...
<span id="LC260" class="line" lang="java">       <span class="s">"Lo schema \u00E8 obbligatorio."</span><span class="o">},</span></span>
...
<span id="LC263" class="line" lang="java">       <span class="s">"Nessuno schema trovato nell''URI: {0}"</span><span class="o">},</span></span>
...
<span id="LC266" class="line" lang="java">       <span class="s">"Nessuno schema trovato nell'URI"</span><span class="o">},</span></span>
...
<span id="LC269" class="line" lang="java">       <span class="s">"Il percorso contiene un carattere non valido: {0}"</span><span class="o">},</span></span>
...
<span id="LC272" class="line" lang="java">       <span class="s">"Impossibile impostare lo schema da una stringa nulla"</span><span class="o">},</span></span>
...
<span id="LC275" class="line" lang="java">       <span class="s">"Lo schema non \u00E8 conforme."</span><span class="o">},</span></span>
...
<span id="LC278" class="line" lang="java">       <span class="s">"Host non \u00E8 un indirizzo corretto"</span><span class="o">},</span></span>
...
<span id="LC281" class="line" lang="java">       <span class="s">"La porta non pu\u00F2 essere impostata se l'host \u00E8 nullo"</span><span class="o">},</span></span>
...
<span id="LC284" class="line" lang="java">       <span class="s">"Numero di porta non valido"</span><span class="o">},</span></span>
...
<span id="LC287" class="line" lang="java">       <span class="s">"Il frammento pu\u00F2 essere impostato solo per un URI generico"</span><span class="o">},</span></span>
...
<span id="LC290" class="line" lang="java">       <span class="s">"Il frammento non pu\u00F2 essere impostato se il percorso \u00E8 nullo"</span><span class="o">},</span></span>
...
<span id="LC293" class="line" lang="java">       <span class="s">"Il frammento contiene un carattere non valido"</span><span class="o">},</span></span>
...
<span id="LC296" class="line" lang="java">      <span class="s">"Parser gi\u00E0 in uso"</span><span class="o">},</span></span>
...
<span id="LC299" class="line" lang="java">      <span class="s">"Impossibile modificare {0} {1} durante l''analisi"</span><span class="o">},</span></span>
...
<span id="LC302" class="line" lang="java">      <span class="s">"Creazione automatica della causa non consentita"</span><span class="o">},</span></span>
...
<span id="LC305" class="line" lang="java">      <span class="s">"Userinfo non pu\u00F2 essere specificato se l'host non \u00E8 specificato"</span><span class="o">},</span></span>
...
<span id="LC308" class="line" lang="java">      <span class="s">"La porta non pu\u00F2 essere specificata se l'host non \u00E8 specificato"</span><span class="o">},</span></span>
...
<span id="LC311" class="line" lang="java">      <span class="s">"La stringa di query non pu\u00F2 essere specificata nella stringa di percorso e query."</span><span class="o">},</span></span>
...
<span id="LC314" class="line" lang="java">      <span class="s">"Il frammento non pu\u00F2 essere specificato sia nel percorso che nel frammento"</span><span class="o">},</span></span>
...
<span id="LC317" class="line" lang="java">      <span class="s">"Impossibile inizializzare l'URI con i parametri vuoti"</span><span class="o">},</span></span>
...
<span id="LC320" class="line" lang="java">      <span class="s">"Metodo attualmente non supportato "</span><span class="o">},</span></span>
...
<span id="LC323" class="line" lang="java">      <span class="s">"IncrementalSAXSource_Filter attualmente non riavviabile"</span><span class="o">},</span></span>
...
<span id="LC326" class="line" lang="java">      <span class="s">"XMLReader non si trova prima della richiesta startParse"</span><span class="o">},</span></span>
...
<span id="LC329" class="line" lang="java">      <span class="s">"Asse trasversale non supportato: {0}"</span><span class="o">},</span></span>
...
<span id="LC332" class="line" lang="java">      <span class="s">"ListingErrorHandler creato con PrintWriter nullo."</span><span class="o">},</span></span>
...
<span id="LC335" class="line" lang="java">      <span class="s">"SystemId sconosciuto"</span><span class="o">},</span></span>
...
<span id="LC338" class="line" lang="java">      <span class="s">"Posizione sconosciuta dell'errore"</span><span class="o">},</span></span>
...
<span id="LC341" class="line" lang="java">      <span class="s">"Il prefisso deve essere risolto in uno spazio di nomi: {0}"</span><span class="o">},</span></span>
...
<span id="LC344" class="line" lang="java">      <span class="s">"createDocument() non supportato in XPathContext"</span><span class="o">},</span></span>
...
<span id="LC347" class="line" lang="java">      <span class="s">"L'elemento figlio dell'attributo non dispone di un documento proprietario."</span><span class="o">},</span></span>
...
<span id="LC350" class="line" lang="java">      <span class="s">"L'elemento figlio dell'attributo non dispone di un elemento di documento proprietario."</span><span class="o">},</span></span>
...
<span id="LC353" class="line" lang="java">      <span class="s">"Avvertenza: impossibile creare l'output del testo prima dell'elemento del documento. Operazione ignorata..."</span><span class="o">},</span></span>
...
<span id="LC356" class="line" lang="java">      <span class="s">"Non possono esistere pi\u00F9 radici in un DOM."</span><span class="o">},</span></span>
...
<span id="LC359" class="line" lang="java">       <span class="s">"L'argomento 'localName' \u00E8 nullo"</span><span class="o">},</span></span>
...
<span id="LC365" class="line" lang="java">       <span class="s">"Localname in QNAME deve essere un NCName valido"</span><span class="o">},</span></span>
...
<span id="LC371" class="line" lang="java">       <span class="s">"Il prefisso in QNAME deve essere un NCName valido"</span><span class="o">},</span></span>
...
<span id="LC374" class="line" lang="java">      <span class="s">"Il nome non pu\u00F2 iniziare con i due punti"</span><span class="o">},</span></span>
<span id="LC375" class="line" lang="java"></span>
<span id="LC376" class="line" lang="java">    <span class="o">{</span> <span class="s">"BAD_CODE"</span><span class="o">,</span> <span class="s">"Parametro per createMessage fuori limite"</span><span class="o">},</span></span>
<span id="LC377" class="line" lang="java">    <span class="o">{</span> <span class="s">"FORMAT_FAILED"</span><span class="o">,</span> <span class="s">"Eccezione durante la chiamata messageFormat"</span><span class="o">},</span></span>
<span id="LC378" class="line" lang="java">    <span class="o">{</span> <span class="s">"line"</span><span class="o">,</span> <span class="s">"N. riga"</span><span class="o">},</span></span>
<span id="LC379" class="line" lang="java">    <span class="o">{</span> <span class="s">"column"</span><span class="o">,</span><span class="s">"N. colonna"</span><span class="o">},</span></span>
...
<span id="LC382" class="line" lang="java">      <span class="s">"La classe serializzatore ''{0}'' non implementa org.xml.sax.ContentHandler."</span><span class="o">},</span></span>
...
<span id="LC385" class="line" lang="java">      <span class="s">"Risorsa [ {0} ] non trovata.\n {1}"</span> <span class="o">},</span></span>
...
<span id="LC388" class="line" lang="java">      <span class="s">"Impossibile caricare la risorsa [ {0} ]: {1} \n {2} \t {3}"</span> <span class="o">},</span></span>
...
<span id="LC391" class="line" lang="java">      <span class="s">"Dimensione buffer &lt;=0"</span> <span class="o">},</span></span>
...
<span id="LC394" class="line" lang="java">      <span class="s">"Rilevato surrogato UTF-16 non valido: {0}?"</span> <span class="o">},</span></span>
...
<span id="LC397" class="line" lang="java">      <span class="s">"Errore IO"</span> <span class="o">},</span></span>
...
<span id="LC400" class="line" lang="java">      <span class="s">"Impossibile aggiungere l''attributo {0} dopo i nodi figlio o prima che sia prodotto un elemento. L''attributo verr\u00E0 ignorato."</span><span class="o">},</span></span>
...
<span id="LC408" class="line" lang="java">      <span class="s">"Lo spazio di nomi per il prefisso ''{0}'' non \u00E8 stato dichiarato."</span> <span class="o">},</span></span>
...
<span id="LC416" class="line" lang="java">      <span class="s">"Attributo ''{0}'' al di fuori dell''elemento."</span> <span class="o">},</span></span>
...
<span id="LC426" class="line" lang="java">      <span class="s">"Dichiarazione dello spazio di nomi ''{0}''=''{1}'' al di fuori dell''elemento."</span> <span class="o">},</span></span>
...
<span id="LC429" class="line" lang="java">      <span class="s">"Impossibile caricare ''{0}'' (verificare CLASSPATH); verranno utilizzati i valori predefiniti"</span><span class="o">},</span></span>
...
<span id="LC432" class="line" lang="java">       <span class="s">"Tentativo di eseguire l''output di un carattere di valore integrale {0} non rappresentato nella codifica di output {1} specificata."</span><span class="o">},</span></span>
...
<span id="LC435" class="line" lang="java">      <span class="s">"Impossibile caricare il file delle propriet\u00E0 ''{0}'' per il metodo di emissione ''{1}'' (verificare CLASSPATH)"</span> <span class="o">}</span></span>
