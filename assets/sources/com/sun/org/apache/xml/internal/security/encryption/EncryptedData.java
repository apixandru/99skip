...
<span id="LC26" class="line" lang="java"><span class="cm"> * The &lt;code&gt;EncryptedData&lt;/code&gt; element is the core element in the syntax. Not</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * only does its &lt;code&gt;CipherData&lt;/code&gt; child contain the encrypted data, but</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> * it's also the element that replaces the encrypted element, or serves as the</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> * new document root.</span></span>
<span id="LC30" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC31" class="line" lang="java"><span class="cm"> * It's schema definition is as follows:</span></span>
<span id="LC32" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC33" class="line" lang="java"><span class="cm"> * &lt;xmp&gt;</span></span>
<span id="LC34" class="line" lang="java"><span class="cm"> * &lt;element name='EncryptedData' type='xenc:EncryptedDataType'/&gt;</span></span>
<span id="LC35" class="line" lang="java"><span class="cm"> * &lt;complexType name='EncryptedDataType'&gt;</span></span>
<span id="LC36" class="line" lang="java"><span class="cm"> *     &lt;complexContent&gt;</span></span>
<span id="LC37" class="line" lang="java"><span class="cm"> *         &lt;extension base='xenc:EncryptedType'/&gt;</span></span>
<span id="LC38" class="line" lang="java"><span class="cm"> *     &lt;/complexContent&gt;</span></span>
<span id="LC39" class="line" lang="java"><span class="cm"> * &lt;/complexType&gt;</span></span>
<span id="LC40" class="line" lang="java"><span class="cm"> * &lt;/xmp&gt;</span></span>
<span id="LC41" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC42" class="line" lang="java"><span class="cm"> * @author Axl Mattheus</span></span>
<span id="LC43" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC44" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">EncryptedData</span> <span class="kd">extends</span> <span class="nc">EncryptedType</span> <span class="o">{</span></span>
