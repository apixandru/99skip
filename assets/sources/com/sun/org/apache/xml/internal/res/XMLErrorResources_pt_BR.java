...
<span id="LC35" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XMLErrorResources_pt_BR</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span></span>
...
<span id="LC185" class="line" lang="java">      <span class="s">"Fun\u00E7\u00E3o n\u00E3o suportada!"</span><span class="o">},</span></span>
...
<span id="LC188" class="line" lang="java">      <span class="s">"N\u00E3o \u00E9 poss\u00EDvel substituir a causa"</span><span class="o">},</span></span>
...
<span id="LC191" class="line" lang="java">      <span class="s">"Nenhuma implementa\u00E7\u00E3o padr\u00E3o encontrada "</span><span class="o">},</span></span>
...
<span id="LC194" class="line" lang="java">      <span class="s">"ChunkedIntArray({0}) n\u00E3o suportado atualmente"</span><span class="o">},</span></span>
...
<span id="LC197" class="line" lang="java">      <span class="s">"Deslocamento maior que o slot"</span><span class="o">},</span></span>
...
<span id="LC200" class="line" lang="java">      <span class="s">"Co-rotina n\u00E3o dispon\u00EDvel, id={0}"</span><span class="o">},</span></span>
...
<span id="LC203" class="line" lang="java">      <span class="s">"CoroutineManager recebeu a solicita\u00E7\u00E3o co_exit()"</span><span class="o">},</span></span>
...
<span id="LC206" class="line" lang="java">      <span class="s">"Falha em co_joinCoroutineSet()"</span><span class="o">},</span></span>
...
<span id="LC209" class="line" lang="java">      <span class="s">"Erro no par\u00E2metro da co-rotina ({0})"</span><span class="o">},</span></span>
...
<span id="LC212" class="line" lang="java">      <span class="s">"\nINESPERADO: Parser doTerminate responde {0}"</span><span class="o">},</span></span>
...
<span id="LC215" class="line" lang="java">      <span class="s">"o parsing n\u00E3o pode ser chamado durante o parsing"</span><span class="o">},</span></span>
...
<span id="LC218" class="line" lang="java">      <span class="s">"Erro: iterador digitado para o eixo {0} n\u00E3o implementado"</span><span class="o">},</span></span>
...
<span id="LC221" class="line" lang="java">      <span class="s">"Erro: iterador para o eixo {0} n\u00E3o implementado "</span><span class="o">},</span></span>
...
<span id="LC224" class="line" lang="java">      <span class="s">"clonagem do iterador n\u00E3o suportada"</span><span class="o">},</span></span>
...
<span id="LC227" class="line" lang="java">      <span class="s">"Tipo transversal de eixo desconhecido: {0}"</span><span class="o">},</span></span>
...
<span id="LC230" class="line" lang="java">      <span class="s">"Transversor de eixo n\u00E3o suportado: {0}"</span><span class="o">},</span></span>
...
<span id="LC233" class="line" lang="java">      <span class="s">"N\u00E3o h\u00E1 mais IDs de DTM dispon\u00EDveis"</span><span class="o">},</span></span>
...
<span id="LC236" class="line" lang="java">      <span class="s">"N\u00E3o suportado: {0}"</span><span class="o">},</span></span>
...
<span id="LC239" class="line" lang="java">      <span class="s">"O n\u00F3 deve ser n\u00E3o-nulo para getDTMHandleFromNode"</span><span class="o">},</span></span>
...
<span id="LC242" class="line" lang="java">      <span class="s">"N\u00E3o foi poss\u00EDvel resolver o n\u00F3 para um handle"</span><span class="o">},</span></span>
...
<span id="LC245" class="line" lang="java">       <span class="s">"startParse n\u00E3o pode ser chamado durante o parsing"</span><span class="o">},</span></span>
...
<span id="LC248" class="line" lang="java">       <span class="s">"startParse requer um SAXParser n\u00E3o nulo"</span><span class="o">},</span></span>
...
<span id="LC251" class="line" lang="java">       <span class="s">"n\u00E3o foi poss\u00EDvel inicializar o parser com"</span><span class="o">},</span></span>
...
<span id="LC254" class="line" lang="java">       <span class="s">"exce\u00E7\u00E3o ao criar a nova inst\u00E2ncia do pool"</span><span class="o">},</span></span>
...
<span id="LC257" class="line" lang="java">       <span class="s">"O caminho cont\u00E9m uma sequ\u00EAncia inv\u00E1lida de caracteres de escape"</span><span class="o">},</span></span>
...
<span id="LC260" class="line" lang="java">       <span class="s">"O esquema \u00E9 obrigat\u00F3rio!"</span><span class="o">},</span></span>
...
<span id="LC263" class="line" lang="java">       <span class="s">"Nenhum esquema encontrado no URI: {0}"</span><span class="o">},</span></span>
...
<span id="LC266" class="line" lang="java">       <span class="s">"Nenhum esquema encontrado no URI"</span><span class="o">},</span></span>
...
<span id="LC269" class="line" lang="java">       <span class="s">"O caminho cont\u00E9m um caractere inv\u00E1lido: {0}"</span><span class="o">},</span></span>
...
<span id="LC272" class="line" lang="java">       <span class="s">"N\u00E3o \u00E9 poss\u00EDvel definir o esquema de uma string nula"</span><span class="o">},</span></span>
...
<span id="LC275" class="line" lang="java">       <span class="s">"O esquema n\u00E3o \u00E9 compat\u00EDvel."</span><span class="o">},</span></span>
...
<span id="LC278" class="line" lang="java">       <span class="s">"O host n\u00E3o \u00E9 um endere\u00E7o correto"</span><span class="o">},</span></span>
...
<span id="LC281" class="line" lang="java">       <span class="s">"A porta n\u00E3o pode ser definida quando o host \u00E9 nulo"</span><span class="o">},</span></span>
...
<span id="LC284" class="line" lang="java">       <span class="s">"N\u00FAmero de porta inv\u00E1lido"</span><span class="o">},</span></span>
...
<span id="LC287" class="line" lang="java">       <span class="s">"O fragmento s\u00F3 pode ser definido para um URI gen\u00E9rico"</span><span class="o">},</span></span>
...
<span id="LC290" class="line" lang="java">       <span class="s">"O fragmento n\u00E3o pode ser definido quando o caminho \u00E9 nulo"</span><span class="o">},</span></span>
...
<span id="LC293" class="line" lang="java">       <span class="s">"O fragmento cont\u00E9m um caractere inv\u00E1lido"</span><span class="o">},</span></span>
...
<span id="LC296" class="line" lang="java">      <span class="s">"O parser j\u00E1 est\u00E1 sendo usado"</span><span class="o">},</span></span>
...
<span id="LC299" class="line" lang="java">      <span class="s">"N\u00E3o \u00E9 poss\u00EDvel alterar {0} {1} durante o parsing"</span><span class="o">},</span></span>
...
<span id="LC302" class="line" lang="java">      <span class="s">"Autoaverigua\u00E7\u00E3o n\u00E3o permitida"</span><span class="o">},</span></span>
...
<span id="LC305" class="line" lang="java">      <span class="s">"As informa\u00E7\u00F5es do usu\u00E1rio n\u00E3o podem ser especificadas se o host n\u00E3o tiver sido especificado"</span><span class="o">},</span></span>
...
<span id="LC308" class="line" lang="java">      <span class="s">"A porta n\u00E3o pode ser especificada se o host n\u00E3o tiver sido especificado"</span><span class="o">},</span></span>
...
<span id="LC311" class="line" lang="java">      <span class="s">"A string de consulta n\u00E3o pode ser especificada no caminho nem na string de consulta"</span><span class="o">},</span></span>
...
<span id="LC314" class="line" lang="java">      <span class="s">"O fragmento n\u00E3o pode ser especificado no caminho nem no fragmento"</span><span class="o">},</span></span>
...
<span id="LC317" class="line" lang="java">      <span class="s">"N\u00E3o \u00E9 poss\u00EDvel inicializar o URI com par\u00E2metros vazios"</span><span class="o">},</span></span>
...
<span id="LC320" class="line" lang="java">      <span class="s">"M\u00E9todo ainda n\u00E3o suportado "</span><span class="o">},</span></span>
...
<span id="LC323" class="line" lang="java">      <span class="s">"IncrementalSAXSource_Filter atualmente n\u00E3o reinicializ\u00E1vel"</span><span class="o">},</span></span>
...
<span id="LC326" class="line" lang="java">      <span class="s">"XMLReader n\u00E3o anterior \u00E0 solicita\u00E7\u00E3o de startParse"</span><span class="o">},</span></span>
...
<span id="LC329" class="line" lang="java">      <span class="s">"Transversor de eixo n\u00E3o suportado: {0}"</span><span class="o">},</span></span>
...
<span id="LC332" class="line" lang="java">      <span class="s">"ListingErrorHandler criado com PrintWriter nulo!"</span><span class="o">},</span></span>
...
<span id="LC335" class="line" lang="java">      <span class="s">"SystemId Desconhecido"</span><span class="o">},</span></span>
...
<span id="LC338" class="line" lang="java">      <span class="s">"Localiza\u00E7\u00E3o de erro desconhecida"</span><span class="o">},</span></span>
...
<span id="LC341" class="line" lang="java">      <span class="s">"O prefixo deve ser resolvido para um namespace: {0}"</span><span class="o">},</span></span>
...
<span id="LC344" class="line" lang="java">      <span class="s">"createDocument() n\u00E3o suportado no XPathContext!"</span><span class="o">},</span></span>
...
<span id="LC347" class="line" lang="java">      <span class="s">"O filho do atributo n\u00E3o tem um documento do propriet\u00E1rio!"</span><span class="o">},</span></span>
...
<span id="LC350" class="line" lang="java">      <span class="s">"O filho do atributo n\u00E3o tem um elemento do documento do propriet\u00E1rio!"</span><span class="o">},</span></span>
...
<span id="LC353" class="line" lang="java">      <span class="s">"Advert\u00EAncia: n\u00E3o pode haver texto antes do elemento do documento! Ignorando..."</span><span class="o">},</span></span>
...
<span id="LC356" class="line" lang="java">      <span class="s">"N\u00E3o pode ter mais de uma raiz em um DOM!"</span><span class="o">},</span></span>
...
<span id="LC359" class="line" lang="java">       <span class="s">"O argumento 'localName' \u00E9 nulo"</span><span class="o">},</span></span>
...
<span id="LC365" class="line" lang="java">       <span class="s">"Localname em QNAME deve ser um NCName v\u00E1lido"</span><span class="o">},</span></span>
...
<span id="LC371" class="line" lang="java">       <span class="s">"O prefixo em QNAME deve ser um NCName v\u00E1lido"</span><span class="o">},</span></span>
...
<span id="LC374" class="line" lang="java">      <span class="s">"O nome n\u00E3o pode come\u00E7ar com dois pontos"</span><span class="o">},</span></span>
<span id="LC375" class="line" lang="java"></span>
<span id="LC376" class="line" lang="java">    <span class="o">{</span> <span class="s">"BAD_CODE"</span><span class="o">,</span> <span class="s">"O par\u00E2metro para createMessage estava fora dos limites"</span><span class="o">},</span></span>
<span id="LC377" class="line" lang="java">    <span class="o">{</span> <span class="s">"FORMAT_FAILED"</span><span class="o">,</span> <span class="s">"Exce\u00E7\u00E3o gerada durante a chamada messageFormat"</span><span class="o">},</span></span>
<span id="LC378" class="line" lang="java">    <span class="o">{</span> <span class="s">"line"</span><span class="o">,</span> <span class="s">"N\u00B0 da Linha"</span><span class="o">},</span></span>
<span id="LC379" class="line" lang="java">    <span class="o">{</span> <span class="s">"column"</span><span class="o">,</span><span class="s">"N\u00B0 da Coluna"</span><span class="o">},</span></span>
...
<span id="LC382" class="line" lang="java">      <span class="s">"A classe ''{0}'' do serializador n\u00E3o implementa org.xml.sax.ContentHandler."</span><span class="o">},</span></span>
...
<span id="LC385" class="line" lang="java">      <span class="s">"N\u00E3o foi poss\u00EDvel encontrar o recurso [ {0} ].\n {1}"</span> <span class="o">},</span></span>
...
<span id="LC388" class="line" lang="java">      <span class="s">"O recurso [ {0} ] n\u00E3o foi carregado: {1} \n {2} \t {3}"</span> <span class="o">},</span></span>
...
<span id="LC391" class="line" lang="java">      <span class="s">"Tamanho do buffer &lt;=0"</span> <span class="o">},</span></span>
...
<span id="LC394" class="line" lang="java">      <span class="s">"Foi detectado um substituto de UTF-16 inv\u00E1lido: {0} ?"</span> <span class="o">},</span></span>
...
<span id="LC397" class="line" lang="java">      <span class="s">"Erro de E/S"</span> <span class="o">},</span></span>
...
<span id="LC400" class="line" lang="java">      <span class="s">"N\u00E3o \u00E9 poss\u00EDvel adicionar o atributo {0} depois dos n\u00F3s filhos ou antes que um elemento seja produzido. O atributo ser\u00E1 ignorado."</span><span class="o">},</span></span>
...
<span id="LC408" class="line" lang="java">      <span class="s">"O namespace do prefixo ''{0}'' n\u00E3o foi declarado."</span> <span class="o">},</span></span>
...
<span id="LC416" class="line" lang="java">      <span class="s">"Atributo ''{0}'' fora do elemento."</span> <span class="o">},</span></span>
...
<span id="LC426" class="line" lang="java">      <span class="s">"Declara\u00E7\u00E3o de namespace ''{0}''=''{1}'' fora do elemento."</span> <span class="o">},</span></span>
...
<span id="LC429" class="line" lang="java">      <span class="s">"N\u00E3o foi poss\u00EDvel carregar ''{0}'' (verificar CLASSPATH); usando agora apenas os padr\u00F5es"</span><span class="o">},</span></span>
...
<span id="LC432" class="line" lang="java">       <span class="s">"Tentativa de exibir um caractere de valor integral {0} que n\u00E3o est\u00E1 representado na codifica\u00E7\u00E3o de sa\u00EDda especificada de {1}."</span><span class="o">},</span></span>
...
<span id="LC435" class="line" lang="java">      <span class="s">"N\u00E3o foi poss\u00EDvel carregar o arquivo de propriedade ''{0}'' para o m\u00E9todo de sa\u00EDda ''{1}'' (verificar CLASSPATH)"</span> <span class="o">}</span></span>
