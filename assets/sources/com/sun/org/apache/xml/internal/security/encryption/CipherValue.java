...
<span id="LC26" class="line" lang="java"><span class="cm"> * &lt;code&gt;CipherValue&lt;/code&gt; is the wrapper for cipher text.</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> * @author Axl Mattheus</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC30" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">CipherValue</span> <span class="o">{</span></span>
<span id="LC31" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC32" class="line" lang="java"><span class="cm">     * Returns the Base 64 encoded, encrypted octets that is the</span></span>
<span id="LC33" class="line" lang="java"><span class="cm">     * &lt;code&gt;CipherValue&lt;/code&gt;.</span></span>
<span id="LC34" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC35" class="line" lang="java"><span class="cm">     * @return cipher value.</span></span>
<span id="LC36" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC37" class="line" lang="java">    <span class="nc">String</span> <span class="nf">getValue</span><span class="o">();</span></span>
<span id="LC38" class="line" lang="java"></span>
<span id="LC39" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">     * Sets the Base 64 encoded, encrypted octets that is the</span></span>
<span id="LC41" class="line" lang="java"><span class="cm">     * &lt;code&gt;CipherValue&lt;/code&gt;.</span></span>
<span id="LC42" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC43" class="line" lang="java"><span class="cm">     * @param value the cipher value.</span></span>
<span id="LC44" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC45" class="line" lang="java">    <span class="kt">void</span> <span class="nf">setValue</span><span class="o">(</span><span class="nc">String</span> <span class="n">value</span><span class="o">);</span></span>
