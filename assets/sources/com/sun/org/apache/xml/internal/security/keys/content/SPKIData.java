...
<span id="LC31" class="line" lang="java"><span class="cm"> * @author $Author: coheigea $</span></span>
<span id="LC32" class="line" lang="java"><span class="cm"> * $todo$ implement</span></span>
<span id="LC33" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC34" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">SPKIData</span> <span class="kd">extends</span> <span class="nc">SignatureElementProxy</span> <span class="kd">implements</span> <span class="nc">KeyInfoContent</span> <span class="o">{</span></span>
<span id="LC35" class="line" lang="java"></span>
<span id="LC36" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">     * Constructor SPKIData</span></span>
...
<span id="LC43" class="line" lang="java">    <span class="kd">public</span> <span class="nf">SPKIData</span><span class="o">(</span><span class="nc">Element</span> <span class="n">element</span><span class="o">,</span> <span class="nc">String</span> <span class="nc">BaseURI</span><span class="o">)</span></span>
...
<span id="LC49" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBaseLocalName</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC50" class="line" lang="java">        <span class="k">return</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">_TAG_SPKIDATA</span><span class="o">;</span></span>
