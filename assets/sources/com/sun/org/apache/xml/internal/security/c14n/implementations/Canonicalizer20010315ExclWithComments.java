...
<span id="LC28" class="line" lang="java"><span class="cm"> * Class Canonicalizer20010315ExclWithComments</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC30" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">Canonicalizer20010315ExclWithComments</span> <span class="kd">extends</span> <span class="nc">Canonicalizer20010315Excl</span> <span class="o">{</span></span>
<span id="LC31" class="line" lang="java"></span>
<span id="LC32" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC33" class="line" lang="java"><span class="cm">     * Constructor Canonicalizer20010315ExclWithComments</span></span>
<span id="LC34" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC35" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC36" class="line" lang="java">    <span class="kd">public</span> <span class="nf">Canonicalizer20010315ExclWithComments</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC37" class="line" lang="java">        <span class="kd">super</span><span class="o">(</span><span class="kc">true</span><span class="o">);</span></span>
<span id="LC38" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC39" class="line" lang="java"></span>
<span id="LC40" class="line" lang="java">    <span class="cm">/** @inheritDoc */</span></span>
<span id="LC41" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="nc">String</span> <span class="nf">engineGetURI</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC42" class="line" lang="java">        <span class="k">return</span> <span class="nc">Canonicalizer</span><span class="o">.</span><span class="na">ALGO_ID_C14N_EXCL_WITH_COMMENTS</span><span class="o">;</span></span>
...
<span id="LC46" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="kt">boolean</span> <span class="nf">engineGetIncludeComments</span><span class="o">()</span> <span class="o">{</span></span>
