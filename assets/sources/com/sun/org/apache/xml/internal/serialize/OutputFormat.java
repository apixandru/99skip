...
<span id="LC22" class="line" lang="java"><span class="c1">// Aug 21, 2000:</span></span>
<span id="LC23" class="line" lang="java"><span class="c1">//  Added ability to omit DOCTYPE declaration.</span></span>
<span id="LC24" class="line" lang="java"><span class="c1">//  Reported by Lars Martin &lt;lars@smb-tec.com&gt;</span></span>
<span id="LC25" class="line" lang="java"><span class="c1">// Aug 25, 2000:</span></span>
<span id="LC26" class="line" lang="java"><span class="c1">//  Added ability to omit comments.</span></span>
<span id="LC27" class="line" lang="java"><span class="c1">//  Contributed by Anupam Bagchi &lt;abagchi@jtcsv.com&gt;</span></span>
<span id="LC28" class="line" lang="java"></span>
<span id="LC29" class="line" lang="java"></span>
<span id="LC30" class="line" lang="java"><span class="kn">package</span> <span class="nn">com.sun.org.apache.xml.internal.serialize</span><span class="o">;</span></span>
...
<span id="LC35" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.Document</span><span class="o">;</span></span>
<span id="LC36" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.DocumentType</span><span class="o">;</span></span>
<span id="LC37" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.Node</span><span class="o">;</span></span>
<span id="LC38" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.html.HTMLDocument</span><span class="o">;</span></span>
...
<span id="LC42" class="line" lang="java"><span class="cm"> * Specifies an output format to control the serializer. Based on the</span></span>
<span id="LC43" class="line" lang="java"><span class="cm"> * XSLT specification for output format, plus additional parameters.</span></span>
<span id="LC44" class="line" lang="java"><span class="cm"> * Used to select the suitable serializer and determine how the</span></span>
<span id="LC45" class="line" lang="java"><span class="cm"> * document should be formatted on output.</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> * &lt;p&gt;</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> * The two interesting constructors are:</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * &lt;ul&gt;</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * &lt;li&gt;{@link #OutputFormat(String,String,boolean)} creates a format</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> *  for the specified method (XML, HTML, Text, etc), encoding and indentation</span></span>
<span id="LC51" class="line" lang="java"><span class="cm"> * &lt;li&gt;{@link #OutputFormat(Document,String,boolean)} creates a format</span></span>
<span id="LC52" class="line" lang="java"><span class="cm"> *  compatible with the document type (XML, HTML, Text, etc), encoding and</span></span>
<span id="LC53" class="line" lang="java"><span class="cm"> *  indentation</span></span>
...
<span id="LC57" class="line" lang="java"><span class="cm"> * @author &lt;a href="mailto:arkin@intalio.com"&gt;Assaf Arkin&lt;/a&gt;</span></span>
<span id="LC58" class="line" lang="java"><span class="cm"> *         &lt;a href="mailto:visco@intalio.com"&gt;Keith Visco&lt;/a&gt;</span></span>
<span id="LC59" class="line" lang="java"><span class="cm"> * @see Serializer</span></span>
<span id="LC60" class="line" lang="java"><span class="cm"> * @see Method</span></span>
<span id="LC61" class="line" lang="java"><span class="cm"> * @see LineSeparator</span></span>
<span id="LC62" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC63" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">OutputFormat</span></span>
...
<span id="LC67" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">class</span> <span class="nc">DTD</span></span>
...
<span id="LC71" class="line" lang="java"><span class="cm">         * Public identifier for HTML 4.01 (Strict) document type.</span></span>
<span id="LC72" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC73" class="line" lang="java">        <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">String</span> <span class="nc">HTMLPublicId</span> <span class="o">=</span> <span class="s">"-//W3C//DTD HTML 4.01//EN"</span><span class="o">;</span></span>
<span id="LC74" class="line" lang="java"></span>
<span id="LC75" class="line" lang="java">        <span class="cm">/**</span></span>
<span id="LC76" class="line" lang="java"><span class="cm">         * System identifier for HTML 4.01 (Strict) document type.</span></span>
<span id="LC77" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC78" class="line" lang="java">        <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">String</span> <span class="nc">HTMLSystemId</span> <span class="o">=</span></span>
<span id="LC79" class="line" lang="java">            <span class="s">"http://www.w3.org/TR/html4/strict.dtd"</span><span class="o">;</span></span>
<span id="LC80" class="line" lang="java"></span>
<span id="LC81" class="line" lang="java">        <span class="cm">/**</span></span>
<span id="LC82" class="line" lang="java"><span class="cm">         * Public identifier for XHTML 1.0 (Strict) document type.</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC84" class="line" lang="java">        <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">String</span> <span class="nc">XHTMLPublicId</span> <span class="o">=</span></span>
<span id="LC85" class="line" lang="java">            <span class="s">"-//W3C//DTD XHTML 1.0 Strict//EN"</span><span class="o">;</span></span>
<span id="LC86" class="line" lang="java"></span>
<span id="LC87" class="line" lang="java">        <span class="cm">/**</span></span>
<span id="LC88" class="line" lang="java"><span class="cm">         * System identifier for XHTML 1.0 (Strict) document type.</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC90" class="line" lang="java">        <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">String</span> <span class="nc">XHTMLSystemId</span> <span class="o">=</span></span>
<span id="LC91" class="line" lang="java">            <span class="s">"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"</span><span class="o">;</span></span>
...
<span id="LC96" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="kd">class</span> <span class="nc">Defaults</span></span>
...
<span id="LC100" class="line" lang="java"><span class="cm">         * If indentation is turned on, the default identation</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">         * level is 4.</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC103" class="line" lang="java"><span class="cm">         * @see #setIndenting(boolean)</span></span>
<span id="LC104" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC105" class="line" lang="java">        <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nc">Indent</span> <span class="o">=</span> <span class="mi">4</span><span class="o">;</span></span>
<span id="LC106" class="line" lang="java"></span>
<span id="LC107" class="line" lang="java">        <span class="cm">/**</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">         * The default encoding for Web documents it UTF-8.</span></span>
<span id="LC109" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC110" class="line" lang="java"><span class="cm">         * @see #getEncoding()</span></span>
<span id="LC111" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC112" class="line" lang="java">        <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">String</span> <span class="nc">Encoding</span> <span class="o">=</span> <span class="s">"UTF-8"</span><span class="o">;</span></span>
<span id="LC113" class="line" lang="java"></span>
<span id="LC114" class="line" lang="java">        <span class="cm">/**</span></span>
<span id="LC115" class="line" lang="java"><span class="cm">         * The default line width at which to break long lines</span></span>
<span id="LC116" class="line" lang="java"><span class="cm">         * when identing. This is set to 72.</span></span>
<span id="LC117" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC118" class="line" lang="java">        <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nc">LineWidth</span> <span class="o">=</span> <span class="mi">72</span><span class="o">;</span></span>
...
<span id="LC124" class="line" lang="java"><span class="cm">     * Holds the output method specified for this document,</span></span>
<span id="LC125" class="line" lang="java"><span class="cm">     * or null if no method was specified.</span></span>
<span id="LC126" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC127" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">_method</span><span class="o">;</span></span>
...
<span id="LC131" class="line" lang="java"><span class="cm">     * Specifies the version of the output method.</span></span>
<span id="LC132" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC133" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">_version</span><span class="o">;</span></span>
...
<span id="LC137" class="line" lang="java"><span class="cm">     * The indentation level, or zero if no indentation</span></span>
<span id="LC138" class="line" lang="java"><span class="cm">     * was requested.</span></span>
<span id="LC139" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC140" class="line" lang="java">    <span class="kd">private</span> <span class="kt">int</span> <span class="n">_indent</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
...
<span id="LC144" class="line" lang="java"><span class="cm">     * The encoding to use, if an input stream is used.</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">     * The default is always UTF-8.</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC147" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">_encoding</span> <span class="o">=</span> <span class="nc">Defaults</span><span class="o">.</span><span class="na">Encoding</span><span class="o">;</span></span>
<span id="LC148" class="line" lang="java"></span>
<span id="LC149" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC150" class="line" lang="java"><span class="cm">     * The EncodingInfo instance for _encoding.</span></span>
<span id="LC151" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC152" class="line" lang="java">    <span class="kd">private</span> <span class="nc">EncodingInfo</span> <span class="n">_encodingInfo</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC153" class="line" lang="java"></span>
<span id="LC154" class="line" lang="java">    <span class="c1">// whether java names for encodings are permitted</span></span>
<span id="LC155" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">_allowJavaNames</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC156" class="line" lang="java"></span>
<span id="LC157" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC158" class="line" lang="java"><span class="cm">     * The specified media type or null.</span></span>
<span id="LC159" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC160" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">_mediaType</span><span class="o">;</span></span>
...
<span id="LC164" class="line" lang="java"><span class="cm">     * The specified document type system identifier, or null.</span></span>
<span id="LC165" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC166" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">_doctypeSystem</span><span class="o">;</span></span>
...
<span id="LC170" class="line" lang="java"><span class="cm">     * The specified document type public identifier, or null.</span></span>
<span id="LC171" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC172" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">_doctypePublic</span><span class="o">;</span></span>
...
<span id="LC176" class="line" lang="java"><span class="cm">     * Ture if the XML declaration should be ommited;</span></span>
<span id="LC177" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC178" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">_omitXmlDeclaration</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC182" class="line" lang="java"><span class="cm">     * Ture if the DOCTYPE declaration should be ommited;</span></span>
<span id="LC183" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC184" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">_omitDoctype</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC188" class="line" lang="java"><span class="cm">     * Ture if comments should be ommited;</span></span>
<span id="LC189" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC190" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">_omitComments</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC194" class="line" lang="java"><span class="cm">     * Ture if the comments should be ommited;</span></span>
<span id="LC195" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC196" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">_stripComments</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC200" class="line" lang="java"><span class="cm">     * True if the document type should be marked as standalone.</span></span>
<span id="LC201" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC202" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">_standalone</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC206" class="line" lang="java"><span class="cm">     * List of element tag names whose text node children must</span></span>
<span id="LC207" class="line" lang="java"><span class="cm">     * be output as CDATA.</span></span>
<span id="LC208" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC209" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span><span class="o">[]</span> <span class="n">_cdataElements</span><span class="o">;</span></span>
...
<span id="LC213" class="line" lang="java"><span class="cm">     * List of element tag names whose text node children must</span></span>
<span id="LC214" class="line" lang="java"><span class="cm">     * be output unescaped.</span></span>
<span id="LC215" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC216" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span><span class="o">[]</span> <span class="n">_nonEscapingElements</span><span class="o">;</span></span>
...
<span id="LC220" class="line" lang="java"><span class="cm">     * The selected line separator.</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC222" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">_lineSeparator</span> <span class="o">=</span> <span class="nc">LineSeparator</span><span class="o">.</span><span class="na">Web</span><span class="o">;</span></span>
...
<span id="LC226" class="line" lang="java"><span class="cm">     * The line width at which to wrap long lines when indenting.</span></span>
<span id="LC227" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC228" class="line" lang="java">    <span class="kd">private</span> <span class="kt">int</span> <span class="n">_lineWidth</span> <span class="o">=</span> <span class="nc">Defaults</span><span class="o">.</span><span class="na">LineWidth</span><span class="o">;</span></span>
...
<span id="LC232" class="line" lang="java"><span class="cm">     * True if spaces should be preserved in elements that do not</span></span>
<span id="LC233" class="line" lang="java"><span class="cm">     * specify otherwise, or specify the default behavior.</span></span>
<span id="LC234" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC235" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">_preserve</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC236" class="line" lang="java">        <span class="cm">/** If true, an empty string valued attribute is output as "". If false and</span></span>
<span id="LC237" class="line" lang="java"><span class="cm">         * and we are using the HTMLSerializer, then only the attribute name is</span></span>
<span id="LC238" class="line" lang="java"><span class="cm">         * serialized. Defaults to false for backwards compatibility.</span></span>
<span id="LC239" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC240" class="line" lang="java">        <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">_preserveEmptyAttributes</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC241" class="line" lang="java"></span>
<span id="LC242" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC243" class="line" lang="java"><span class="cm">     * Constructs a new output format with the default values.</span></span>
<span id="LC244" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC245" class="line" lang="java">    <span class="kd">public</span> <span class="nf">OutputFormat</span><span class="o">()</span></span>
...
<span id="LC251" class="line" lang="java"><span class="cm">     * Constructs a new output format with the default values for</span></span>
<span id="LC252" class="line" lang="java"><span class="cm">     * the specified method and encoding. If &lt;tt&gt;indent&lt;/tt&gt;</span></span>
<span id="LC253" class="line" lang="java"><span class="cm">     * is true, the document will be pretty printed with the default</span></span>
<span id="LC254" class="line" lang="java"><span class="cm">     * indentation level and default line wrapping.</span></span>
<span id="LC255" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC256" class="line" lang="java"><span class="cm">     * @param method The specified output method</span></span>
<span id="LC257" class="line" lang="java"><span class="cm">     * @param encoding The specified encoding</span></span>
<span id="LC258" class="line" lang="java"><span class="cm">     * @param indenting True for pretty printing</span></span>
<span id="LC259" class="line" lang="java"><span class="cm">     * @see #setEncoding</span></span>
<span id="LC260" class="line" lang="java"><span class="cm">     * @see #setIndenting</span></span>
<span id="LC261" class="line" lang="java"><span class="cm">     * @see #setMethod</span></span>
<span id="LC262" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC263" class="line" lang="java">    <span class="kd">public</span> <span class="nf">OutputFormat</span><span class="o">(</span> <span class="nc">String</span> <span class="n">method</span><span class="o">,</span> <span class="nc">String</span> <span class="n">encoding</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">indenting</span> <span class="o">)</span></span>
<span id="LC264" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC265" class="line" lang="java">        <span class="n">setMethod</span><span class="o">(</span> <span class="n">method</span> <span class="o">);</span></span>
<span id="LC266" class="line" lang="java">        <span class="n">setEncoding</span><span class="o">(</span> <span class="n">encoding</span> <span class="o">);</span></span>
<span id="LC267" class="line" lang="java">        <span class="n">setIndenting</span><span class="o">(</span> <span class="n">indenting</span> <span class="o">);</span></span>
...
<span id="LC272" class="line" lang="java"><span class="cm">     * Constructs a new output format with the proper method,</span></span>
<span id="LC273" class="line" lang="java"><span class="cm">     * document type identifiers and media type for the specified</span></span>
<span id="LC274" class="line" lang="java"><span class="cm">     * document.</span></span>
<span id="LC275" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC276" class="line" lang="java"><span class="cm">     * @param doc The document to output</span></span>
<span id="LC277" class="line" lang="java"><span class="cm">     * @see #whichMethod</span></span>
<span id="LC278" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC279" class="line" lang="java">    <span class="kd">public</span> <span class="nf">OutputFormat</span><span class="o">(</span> <span class="nc">Document</span> <span class="n">doc</span> <span class="o">)</span></span>
<span id="LC280" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC281" class="line" lang="java">        <span class="n">setMethod</span><span class="o">(</span> <span class="n">whichMethod</span><span class="o">(</span> <span class="n">doc</span> <span class="o">)</span> <span class="o">);</span></span>
<span id="LC282" class="line" lang="java">        <span class="n">setDoctype</span><span class="o">(</span> <span class="n">whichDoctypePublic</span><span class="o">(</span> <span class="n">doc</span> <span class="o">),</span> <span class="n">whichDoctypeSystem</span><span class="o">(</span> <span class="n">doc</span> <span class="o">)</span> <span class="o">);</span></span>
<span id="LC283" class="line" lang="java">        <span class="n">setMediaType</span><span class="o">(</span> <span class="n">whichMediaType</span><span class="o">(</span> <span class="n">getMethod</span><span class="o">()</span> <span class="o">)</span> <span class="o">);</span></span>
...
<span id="LC288" class="line" lang="java"><span class="cm">     * Constructs a new output format with the proper method,</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">     * document type identifiers and media type for the specified</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">     * document, and with the specified encoding. If &lt;tt&gt;indent&lt;/tt&gt;</span></span>
<span id="LC291" class="line" lang="java"><span class="cm">     * is true, the document will be pretty printed with the default</span></span>
<span id="LC292" class="line" lang="java"><span class="cm">     * indentation level and default line wrapping.</span></span>
<span id="LC293" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC294" class="line" lang="java"><span class="cm">     * @param doc The document to output</span></span>
<span id="LC295" class="line" lang="java"><span class="cm">     * @param encoding The specified encoding</span></span>
<span id="LC296" class="line" lang="java"><span class="cm">     * @param indenting True for pretty printing</span></span>
<span id="LC297" class="line" lang="java"><span class="cm">     * @see #setEncoding</span></span>
<span id="LC298" class="line" lang="java"><span class="cm">     * @see #setIndenting</span></span>
<span id="LC299" class="line" lang="java"><span class="cm">     * @see #whichMethod</span></span>
<span id="LC300" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC301" class="line" lang="java">    <span class="kd">public</span> <span class="nf">OutputFormat</span><span class="o">(</span> <span class="nc">Document</span> <span class="n">doc</span><span class="o">,</span> <span class="nc">String</span> <span class="n">encoding</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">indenting</span> <span class="o">)</span></span>
<span id="LC302" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC303" class="line" lang="java">        <span class="k">this</span><span class="o">(</span> <span class="n">doc</span> <span class="o">);</span></span>
<span id="LC304" class="line" lang="java">        <span class="n">setEncoding</span><span class="o">(</span> <span class="n">encoding</span> <span class="o">);</span></span>
<span id="LC305" class="line" lang="java">        <span class="n">setIndenting</span><span class="o">(</span> <span class="n">indenting</span> <span class="o">);</span></span>
...
<span id="LC310" class="line" lang="java"><span class="cm">     * Returns the method specified for this output format.</span></span>
<span id="LC311" class="line" lang="java"><span class="cm">     * Typically the method will be &lt;tt&gt;xml&lt;/tt&gt;, &lt;tt&gt;html&lt;/tt&gt;</span></span>
<span id="LC312" class="line" lang="java"><span class="cm">     * or &lt;tt&gt;text&lt;/tt&gt;, but it might be other values.</span></span>
<span id="LC313" class="line" lang="java"><span class="cm">     * If no method was specified, null will be returned</span></span>
<span id="LC314" class="line" lang="java"><span class="cm">     * and the most suitable method will be determined for</span></span>
<span id="LC315" class="line" lang="java"><span class="cm">     * the document by calling {@link #whichMethod}.</span></span>
<span id="LC316" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC317" class="line" lang="java"><span class="cm">     * @return The specified output method, or null</span></span>
<span id="LC318" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC319" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMethod</span><span class="o">()</span></span>
<span id="LC320" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC321" class="line" lang="java">        <span class="k">return</span> <span class="n">_method</span><span class="o">;</span></span>
...
<span id="LC326" class="line" lang="java"><span class="cm">     * Sets the method for this output format.</span></span>
<span id="LC327" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC328" class="line" lang="java"><span class="cm">     * @see #getMethod</span></span>
<span id="LC329" class="line" lang="java"><span class="cm">     * @param method The output method, or null</span></span>
<span id="LC330" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC331" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMethod</span><span class="o">(</span> <span class="nc">String</span> <span class="n">method</span> <span class="o">)</span></span>
<span id="LC332" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC333" class="line" lang="java">        <span class="n">_method</span> <span class="o">=</span> <span class="n">method</span><span class="o">;</span></span>
...
<span id="LC338" class="line" lang="java"><span class="cm">     * Returns the version for this output method.</span></span>
<span id="LC339" class="line" lang="java"><span class="cm">     * If no version was specified, will return null</span></span>
<span id="LC340" class="line" lang="java"><span class="cm">     * and the default version number will be used.</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">     * If the serializerr does not support that particular</span></span>
<span id="LC342" class="line" lang="java"><span class="cm">     * version, it should default to a supported version.</span></span>
<span id="LC343" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC344" class="line" lang="java"><span class="cm">     * @return The specified method version, or null</span></span>
<span id="LC345" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC346" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getVersion</span><span class="o">()</span></span>
<span id="LC347" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC348" class="line" lang="java">        <span class="k">return</span> <span class="n">_version</span><span class="o">;</span></span>
...
<span id="LC353" class="line" lang="java"><span class="cm">     * Sets the version for this output method.</span></span>
<span id="LC354" class="line" lang="java"><span class="cm">     * For XML the value would be "1.0", for HTML</span></span>
<span id="LC355" class="line" lang="java"><span class="cm">     * it would be "4.0".</span></span>
<span id="LC356" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC357" class="line" lang="java"><span class="cm">     * @see #getVersion</span></span>
<span id="LC358" class="line" lang="java"><span class="cm">     * @param version The output method version, or null</span></span>
<span id="LC359" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC360" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setVersion</span><span class="o">(</span> <span class="nc">String</span> <span class="n">version</span> <span class="o">)</span></span>
<span id="LC361" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC362" class="line" lang="java">        <span class="n">_version</span> <span class="o">=</span> <span class="n">version</span><span class="o">;</span></span>
...
<span id="LC367" class="line" lang="java"><span class="cm">     * Returns the indentation specified. If no indentation</span></span>
<span id="LC368" class="line" lang="java"><span class="cm">     * was specified, zero is returned and the document</span></span>
<span id="LC369" class="line" lang="java"><span class="cm">     * should not be indented.</span></span>
<span id="LC370" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC371" class="line" lang="java"><span class="cm">     * @return The indentation or zero</span></span>
<span id="LC372" class="line" lang="java"><span class="cm">     * @see #setIndenting</span></span>
<span id="LC373" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC374" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getIndent</span><span class="o">()</span></span>
<span id="LC375" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC376" class="line" lang="java">        <span class="k">return</span> <span class="n">_indent</span><span class="o">;</span></span>
...
<span id="LC381" class="line" lang="java"><span class="cm">     * Returns true if indentation was specified.</span></span>
<span id="LC382" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC383" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getIndenting</span><span class="o">()</span></span>
<span id="LC384" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC385" class="line" lang="java">        <span class="k">return</span> <span class="o">(</span> <span class="n">_indent</span> <span class="o">&gt;</span> <span class="mi">0</span> <span class="o">);</span></span>
...
<span id="LC390" class="line" lang="java"><span class="cm">     * Sets the indentation. The document will not be</span></span>
<span id="LC391" class="line" lang="java"><span class="cm">     * indented if the indentation is set to zero.</span></span>
<span id="LC392" class="line" lang="java"><span class="cm">     * Calling {@link #setIndenting} will reset this</span></span>
<span id="LC393" class="line" lang="java"><span class="cm">     * value to zero (off) or the default (on).</span></span>
<span id="LC394" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC395" class="line" lang="java"><span class="cm">     * @param indent The indentation, or zero</span></span>
<span id="LC396" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC397" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIndent</span><span class="o">(</span> <span class="kt">int</span> <span class="n">indent</span> <span class="o">)</span></span>
<span id="LC398" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC399" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span> <span class="n">indent</span> <span class="o">&lt;</span> <span class="mi">0</span> <span class="o">)</span></span>
<span id="LC400" class="line" lang="java">            <span class="n">_indent</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC401" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC402" class="line" lang="java">            <span class="n">_indent</span> <span class="o">=</span> <span class="n">indent</span><span class="o">;</span></span>
...
<span id="LC407" class="line" lang="java"><span class="cm">     * Sets the indentation on and off. When set on, the default</span></span>
<span id="LC408" class="line" lang="java"><span class="cm">     * indentation level and default line wrapping is used</span></span>
<span id="LC409" class="line" lang="java"><span class="cm">     * (see {@link Defaults#Indent} and {@link Defaults#LineWidth}).</span></span>
<span id="LC410" class="line" lang="java"><span class="cm">     * To specify a different indentation level or line wrapping,</span></span>
<span id="LC411" class="line" lang="java"><span class="cm">     * use {@link #setIndent} and {@link #setLineWidth}.</span></span>
<span id="LC412" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC413" class="line" lang="java"><span class="cm">     * @param on True if indentation should be on</span></span>
<span id="LC414" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC415" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIndenting</span><span class="o">(</span> <span class="kt">boolean</span> <span class="n">on</span> <span class="o">)</span></span>
<span id="LC416" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC417" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span> <span class="n">on</span> <span class="o">)</span> <span class="o">{</span></span>
<span id="LC418" class="line" lang="java">            <span class="n">_indent</span> <span class="o">=</span> <span class="nc">Defaults</span><span class="o">.</span><span class="na">Indent</span><span class="o">;</span></span>
<span id="LC419" class="line" lang="java">            <span class="n">_lineWidth</span> <span class="o">=</span> <span class="nc">Defaults</span><span class="o">.</span><span class="na">LineWidth</span><span class="o">;</span></span>
<span id="LC420" class="line" lang="java">        <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC421" class="line" lang="java">            <span class="n">_indent</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC422" class="line" lang="java">            <span class="n">_lineWidth</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
...
<span id="LC428" class="line" lang="java"><span class="cm">     * Returns the specified encoding. If no encoding was</span></span>
<span id="LC429" class="line" lang="java"><span class="cm">     * specified, the default is always "UTF-8".</span></span>
<span id="LC430" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC431" class="line" lang="java"><span class="cm">     * @return The encoding</span></span>
<span id="LC432" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC433" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getEncoding</span><span class="o">()</span></span>
<span id="LC434" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC435" class="line" lang="java">        <span class="k">return</span> <span class="n">_encoding</span><span class="o">;</span></span>
...
<span id="LC440" class="line" lang="java"><span class="cm">     * Sets the encoding for this output method. If no</span></span>
<span id="LC441" class="line" lang="java"><span class="cm">     * encoding was specified, the default is always "UTF-8".</span></span>
<span id="LC442" class="line" lang="java"><span class="cm">     * Make sure the encoding is compatible with the one</span></span>
<span id="LC443" class="line" lang="java"><span class="cm">     * used by the {@link java.io.Writer}.</span></span>
<span id="LC444" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC445" class="line" lang="java"><span class="cm">     * @see #getEncoding</span></span>
<span id="LC446" class="line" lang="java"><span class="cm">     * @param encoding The encoding, or null</span></span>
<span id="LC447" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC448" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setEncoding</span><span class="o">(</span> <span class="nc">String</span> <span class="n">encoding</span> <span class="o">)</span></span>
<span id="LC449" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC450" class="line" lang="java">        <span class="n">_encoding</span> <span class="o">=</span> <span class="n">encoding</span><span class="o">;</span></span>
<span id="LC451" class="line" lang="java">        <span class="n">_encodingInfo</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC455" class="line" lang="java"><span class="cm">     * Sets the encoding for this output method with an &lt;code&gt;EncodingInfo&lt;/code&gt;</span></span>
<span id="LC456" class="line" lang="java"><span class="cm">     * instance.</span></span>
<span id="LC457" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC458" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setEncoding</span><span class="o">(</span><span class="nc">EncodingInfo</span> <span class="n">encInfo</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC459" class="line" lang="java">        <span class="n">_encoding</span> <span class="o">=</span> <span class="n">encInfo</span><span class="o">.</span><span class="na">getIANAName</span><span class="o">();</span></span>
<span id="LC460" class="line" lang="java">        <span class="n">_encodingInfo</span> <span class="o">=</span> <span class="n">encInfo</span><span class="o">;</span></span>
...
<span id="LC464" class="line" lang="java"><span class="cm">     * Returns an &lt;code&gt;EncodingInfo&lt;code&gt; instance for the encoding.</span></span>
<span id="LC465" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC466" class="line" lang="java"><span class="cm">     * @see #setEncoding</span></span>
<span id="LC467" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC468" class="line" lang="java">    <span class="kd">public</span> <span class="nc">EncodingInfo</span> <span class="nf">getEncodingInfo</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">UnsupportedEncodingException</span> <span class="o">{</span></span>
<span id="LC469" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">_encodingInfo</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC470" class="line" lang="java">            <span class="n">_encodingInfo</span> <span class="o">=</span> <span class="nc">Encodings</span><span class="o">.</span><span class="na">getEncodingInfo</span><span class="o">(</span><span class="n">_encoding</span><span class="o">,</span> <span class="n">_allowJavaNames</span><span class="o">);</span></span>
<span id="LC471" class="line" lang="java">        <span class="k">return</span> <span class="n">_encodingInfo</span><span class="o">;</span></span>
...
<span id="LC475" class="line" lang="java"><span class="cm">     * Sets whether java encoding names are permitted</span></span>
<span id="LC476" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC477" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setAllowJavaNames</span> <span class="o">(</span><span class="kt">boolean</span> <span class="n">allow</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC478" class="line" lang="java">        <span class="n">_allowJavaNames</span> <span class="o">=</span> <span class="n">allow</span><span class="o">;</span></span>
...
<span id="LC482" class="line" lang="java"><span class="cm">     * Returns whether java encoding names are permitted</span></span>
<span id="LC483" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC484" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">setAllowJavaNames</span> <span class="o">()</span> <span class="o">{</span></span>
<span id="LC485" class="line" lang="java">        <span class="k">return</span> <span class="n">_allowJavaNames</span><span class="o">;</span></span>
...
<span id="LC489" class="line" lang="java"><span class="cm">     * Returns the specified media type, or null.</span></span>
<span id="LC490" class="line" lang="java"><span class="cm">     * To determine the media type based on the</span></span>
<span id="LC491" class="line" lang="java"><span class="cm">     * document type, use {@link #whichMediaType}.</span></span>
<span id="LC492" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC493" class="line" lang="java"><span class="cm">     * @return The specified media type, or null</span></span>
<span id="LC494" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC495" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMediaType</span><span class="o">()</span></span>
<span id="LC496" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC497" class="line" lang="java">        <span class="k">return</span> <span class="n">_mediaType</span><span class="o">;</span></span>
...
<span id="LC502" class="line" lang="java"><span class="cm">     * Sets the media type.</span></span>
<span id="LC503" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC504" class="line" lang="java"><span class="cm">     * @see #getMediaType</span></span>
<span id="LC505" class="line" lang="java"><span class="cm">     * @param mediaType The specified media type</span></span>
<span id="LC506" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC507" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMediaType</span><span class="o">(</span> <span class="nc">String</span> <span class="n">mediaType</span> <span class="o">)</span></span>
<span id="LC508" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC509" class="line" lang="java">        <span class="n">_mediaType</span> <span class="o">=</span> <span class="n">mediaType</span><span class="o">;</span></span>
...
<span id="LC514" class="line" lang="java"><span class="cm">     * Sets the document type public and system identifiers.</span></span>
<span id="LC515" class="line" lang="java"><span class="cm">     * Required only if the DOM Document or SAX events do not</span></span>
<span id="LC516" class="line" lang="java"><span class="cm">     * specify the document type, and one must be present in</span></span>
<span id="LC517" class="line" lang="java"><span class="cm">     * the serialized document. Any document type specified</span></span>
<span id="LC518" class="line" lang="java"><span class="cm">     * by the DOM Document or SAX events will override these</span></span>
<span id="LC519" class="line" lang="java"><span class="cm">     * values.</span></span>
<span id="LC520" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC521" class="line" lang="java"><span class="cm">     * @param publicId The public identifier, or null</span></span>
<span id="LC522" class="line" lang="java"><span class="cm">     * @param systemId The system identifier, or null</span></span>
<span id="LC523" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC524" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDoctype</span><span class="o">(</span> <span class="nc">String</span> <span class="n">publicId</span><span class="o">,</span> <span class="nc">String</span> <span class="n">systemId</span> <span class="o">)</span></span>
<span id="LC525" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC526" class="line" lang="java">        <span class="n">_doctypePublic</span> <span class="o">=</span> <span class="n">publicId</span><span class="o">;</span></span>
<span id="LC527" class="line" lang="java">        <span class="n">_doctypeSystem</span> <span class="o">=</span> <span class="n">systemId</span><span class="o">;</span></span>
...
<span id="LC532" class="line" lang="java"><span class="cm">     * Returns the specified document type public identifier,</span></span>
<span id="LC533" class="line" lang="java"><span class="cm">     * or null.</span></span>
<span id="LC534" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC535" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getDoctypePublic</span><span class="o">()</span></span>
<span id="LC536" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC537" class="line" lang="java">        <span class="k">return</span> <span class="n">_doctypePublic</span><span class="o">;</span></span>
...
<span id="LC542" class="line" lang="java"><span class="cm">     * Returns the specified document type system identifier,</span></span>
<span id="LC543" class="line" lang="java"><span class="cm">     * or null.</span></span>
<span id="LC544" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC545" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getDoctypeSystem</span><span class="o">()</span></span>
<span id="LC546" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC547" class="line" lang="java">        <span class="k">return</span> <span class="n">_doctypeSystem</span><span class="o">;</span></span>
...
<span id="LC552" class="line" lang="java"><span class="cm">     * Returns true if comments should be ommited.</span></span>
<span id="LC553" class="line" lang="java"><span class="cm">     * The default is false.</span></span>
<span id="LC554" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC555" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getOmitComments</span><span class="o">()</span></span>
<span id="LC556" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC557" class="line" lang="java">        <span class="k">return</span> <span class="n">_omitComments</span><span class="o">;</span></span>
...
<span id="LC562" class="line" lang="java"><span class="cm">     * Sets comment omitting on and off.</span></span>
<span id="LC563" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC564" class="line" lang="java"><span class="cm">     * @param omit True if comments should be ommited</span></span>
<span id="LC565" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC566" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOmitComments</span><span class="o">(</span> <span class="kt">boolean</span> <span class="n">omit</span> <span class="o">)</span></span>
<span id="LC567" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC568" class="line" lang="java">        <span class="n">_omitComments</span> <span class="o">=</span> <span class="n">omit</span><span class="o">;</span></span>
...
<span id="LC573" class="line" lang="java"><span class="cm">     * Returns true if the DOCTYPE declaration should</span></span>
<span id="LC574" class="line" lang="java"><span class="cm">     * be ommited. The default is false.</span></span>
<span id="LC575" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC576" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getOmitDocumentType</span><span class="o">()</span></span>
<span id="LC577" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC578" class="line" lang="java">        <span class="k">return</span> <span class="n">_omitDoctype</span><span class="o">;</span></span>
...
<span id="LC583" class="line" lang="java"><span class="cm">     * Sets DOCTYPE declaration omitting on and off.</span></span>
<span id="LC584" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC585" class="line" lang="java"><span class="cm">     * @param omit True if DOCTYPE declaration should be ommited</span></span>
<span id="LC586" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC587" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOmitDocumentType</span><span class="o">(</span> <span class="kt">boolean</span> <span class="n">omit</span> <span class="o">)</span></span>
<span id="LC588" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC589" class="line" lang="java">        <span class="n">_omitDoctype</span> <span class="o">=</span> <span class="n">omit</span><span class="o">;</span></span>
...
<span id="LC594" class="line" lang="java"><span class="cm">     * Returns true if the XML document declaration should</span></span>
<span id="LC595" class="line" lang="java"><span class="cm">     * be ommited. The default is false.</span></span>
<span id="LC596" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC597" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getOmitXMLDeclaration</span><span class="o">()</span></span>
<span id="LC598" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC599" class="line" lang="java">        <span class="k">return</span> <span class="n">_omitXmlDeclaration</span><span class="o">;</span></span>
...
<span id="LC604" class="line" lang="java"><span class="cm">     * Sets XML declaration omitting on and off.</span></span>
<span id="LC605" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC606" class="line" lang="java"><span class="cm">     * @param omit True if XML declaration should be ommited</span></span>
<span id="LC607" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC608" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOmitXMLDeclaration</span><span class="o">(</span> <span class="kt">boolean</span> <span class="n">omit</span> <span class="o">)</span></span>
<span id="LC609" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC610" class="line" lang="java">        <span class="n">_omitXmlDeclaration</span> <span class="o">=</span> <span class="n">omit</span><span class="o">;</span></span>
...
<span id="LC615" class="line" lang="java"><span class="cm">     * Returns true if the document type is standalone.</span></span>
<span id="LC616" class="line" lang="java"><span class="cm">     * The default is false.</span></span>
<span id="LC617" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC618" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getStandalone</span><span class="o">()</span></span>
<span id="LC619" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC620" class="line" lang="java">        <span class="k">return</span> <span class="n">_standalone</span><span class="o">;</span></span>
...
<span id="LC625" class="line" lang="java"><span class="cm">     * Sets document DTD standalone. The public and system</span></span>
<span id="LC626" class="line" lang="java"><span class="cm">     * identifiers must be null for the document to be</span></span>
<span id="LC627" class="line" lang="java"><span class="cm">     * serialized as standalone.</span></span>
<span id="LC628" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC629" class="line" lang="java"><span class="cm">     * @param standalone True if document DTD is standalone</span></span>
<span id="LC630" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC631" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setStandalone</span><span class="o">(</span> <span class="kt">boolean</span> <span class="n">standalone</span> <span class="o">)</span></span>
<span id="LC632" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC633" class="line" lang="java">        <span class="n">_standalone</span> <span class="o">=</span> <span class="n">standalone</span><span class="o">;</span></span>
...
<span id="LC638" class="line" lang="java"><span class="cm">     * Returns a list of all the elements whose text node children</span></span>
<span id="LC639" class="line" lang="java"><span class="cm">     * should be output as CDATA, or null if no such elements were</span></span>
<span id="LC640" class="line" lang="java"><span class="cm">     * specified.</span></span>
<span id="LC641" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC642" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span><span class="o">[]</span> <span class="nf">getCDataElements</span><span class="o">()</span></span>
<span id="LC643" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC644" class="line" lang="java">        <span class="k">return</span> <span class="n">_cdataElements</span><span class="o">;</span></span>
...
<span id="LC649" class="line" lang="java"><span class="cm">     * Returns true if the text node children of the given elements</span></span>
<span id="LC650" class="line" lang="java"><span class="cm">     * should be output as CDATA.</span></span>
<span id="LC651" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC652" class="line" lang="java"><span class="cm">     * @param tagName The element's tag name</span></span>
<span id="LC653" class="line" lang="java"><span class="cm">     * @return True if should serialize as CDATA</span></span>
<span id="LC654" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC655" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isCDataElement</span><span class="o">(</span> <span class="nc">String</span> <span class="n">tagName</span> <span class="o">)</span></span>
<span id="LC656" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC657" class="line" lang="java">        <span class="kt">int</span> <span class="n">i</span><span class="o">;</span></span>
<span id="LC658" class="line" lang="java"></span>
<span id="LC659" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span> <span class="n">_cdataElements</span> <span class="o">==</span> <span class="kc">null</span> <span class="o">)</span></span>
<span id="LC660" class="line" lang="java">            <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC661" class="line" lang="java">        <span class="k">for</span> <span class="o">(</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span> <span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">_cdataElements</span><span class="o">.</span><span class="na">length</span> <span class="o">;</span> <span class="o">++</span><span class="n">i</span> <span class="o">)</span></span>
<span id="LC662" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span> <span class="n">_cdataElements</span><span class="o">[</span> <span class="n">i</span> <span class="o">].</span><span class="na">equals</span><span class="o">(</span> <span class="n">tagName</span> <span class="o">)</span> <span class="o">)</span></span>
...
<span id="LC669" class="line" lang="java"><span class="cm">     * Sets the list of elements for which text node children</span></span>
<span id="LC670" class="line" lang="java"><span class="cm">     * should be output as CDATA.</span></span>
<span id="LC671" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC672" class="line" lang="java"><span class="cm">     * @param cdataElements List of CDATA element tag names</span></span>
<span id="LC673" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC674" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCDataElements</span><span class="o">(</span> <span class="nc">String</span><span class="o">[]</span> <span class="n">cdataElements</span> <span class="o">)</span></span>
<span id="LC675" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC676" class="line" lang="java">        <span class="n">_cdataElements</span> <span class="o">=</span> <span class="n">cdataElements</span><span class="o">;</span></span>
...
<span id="LC681" class="line" lang="java"><span class="cm">     * Returns a list of all the elements whose text node children</span></span>
<span id="LC682" class="line" lang="java"><span class="cm">     * should be output unescaped (no character references), or null</span></span>
<span id="LC683" class="line" lang="java"><span class="cm">     * if no such elements were specified.</span></span>
<span id="LC684" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC685" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span><span class="o">[]</span> <span class="nf">getNonEscapingElements</span><span class="o">()</span></span>
<span id="LC686" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC687" class="line" lang="java">        <span class="k">return</span> <span class="n">_nonEscapingElements</span><span class="o">;</span></span>
...
<span id="LC692" class="line" lang="java"><span class="cm">     * Returns true if the text node children of the given elements</span></span>
<span id="LC693" class="line" lang="java"><span class="cm">     * should be output unescaped.</span></span>
<span id="LC694" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC695" class="line" lang="java"><span class="cm">     * @param tagName The element's tag name</span></span>
<span id="LC696" class="line" lang="java"><span class="cm">     * @return True if should serialize unescaped</span></span>
<span id="LC697" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC698" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isNonEscapingElement</span><span class="o">(</span> <span class="nc">String</span> <span class="n">tagName</span> <span class="o">)</span></span>
...
<span id="LC702" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span> <span class="n">_nonEscapingElements</span> <span class="o">==</span> <span class="kc">null</span> <span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC705" class="line" lang="java">        <span class="k">for</span> <span class="o">(</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span> <span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">_nonEscapingElements</span><span class="o">.</span><span class="na">length</span> <span class="o">;</span> <span class="o">++</span><span class="n">i</span> <span class="o">)</span></span>
<span id="LC706" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span> <span class="n">_nonEscapingElements</span><span class="o">[</span> <span class="n">i</span> <span class="o">].</span><span class="na">equals</span><span class="o">(</span> <span class="n">tagName</span> <span class="o">)</span> <span class="o">)</span></span>
...
<span id="LC713" class="line" lang="java"><span class="cm">     * Sets the list of elements for which text node children</span></span>
<span id="LC714" class="line" lang="java"><span class="cm">     * should be output unescaped (no character references).</span></span>
<span id="LC715" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC716" class="line" lang="java"><span class="cm">     * @param nonEscapingElements List of unescaped element tag names</span></span>
<span id="LC717" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC718" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setNonEscapingElements</span><span class="o">(</span> <span class="nc">String</span><span class="o">[]</span> <span class="n">nonEscapingElements</span> <span class="o">)</span></span>
<span id="LC719" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC720" class="line" lang="java">        <span class="n">_nonEscapingElements</span> <span class="o">=</span> <span class="n">nonEscapingElements</span><span class="o">;</span></span>
...
<span id="LC726" class="line" lang="java"><span class="cm">     * Returns a specific line separator to use. The default is the</span></span>
<span id="LC727" class="line" lang="java"><span class="cm">     * Web line separator (&lt;tt&gt;\n&lt;/tt&gt;). A string is returned to</span></span>
<span id="LC728" class="line" lang="java"><span class="cm">     * support double codes (CR + LF).</span></span>
<span id="LC729" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC730" class="line" lang="java"><span class="cm">     * @return The specified line separator</span></span>
<span id="LC731" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC732" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getLineSeparator</span><span class="o">()</span></span>
<span id="LC733" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC734" class="line" lang="java">        <span class="k">return</span> <span class="n">_lineSeparator</span><span class="o">;</span></span>
...
<span id="LC739" class="line" lang="java"><span class="cm">     * Sets the line separator. The default is the Web line separator</span></span>
<span id="LC740" class="line" lang="java"><span class="cm">     * (&lt;tt&gt;\n&lt;/tt&gt;). The machine's line separator can be obtained</span></span>
<span id="LC741" class="line" lang="java"><span class="cm">     * from the system property &lt;tt&gt;line.separator&lt;/tt&gt;, but is only</span></span>
<span id="LC742" class="line" lang="java"><span class="cm">     * useful if the document is edited on machines of the same type.</span></span>
<span id="LC743" class="line" lang="java"><span class="cm">     * For general documents, use the Web line separator.</span></span>
<span id="LC744" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC745" class="line" lang="java"><span class="cm">     * @param lineSeparator The specified line separator</span></span>
<span id="LC746" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC747" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setLineSeparator</span><span class="o">(</span> <span class="nc">String</span> <span class="n">lineSeparator</span> <span class="o">)</span></span>
<span id="LC748" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC749" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span> <span class="n">lineSeparator</span> <span class="o">==</span> <span class="kc">null</span> <span class="o">)</span></span>
<span id="LC750" class="line" lang="java">            <span class="n">_lineSeparator</span> <span class="o">=</span>  <span class="nc">LineSeparator</span><span class="o">.</span><span class="na">Web</span><span class="o">;</span></span>
<span id="LC751" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC752" class="line" lang="java">            <span class="n">_lineSeparator</span> <span class="o">=</span> <span class="n">lineSeparator</span><span class="o">;</span></span>
...
<span id="LC757" class="line" lang="java"><span class="cm">     * Returns true if the default behavior for this format is to</span></span>
<span id="LC758" class="line" lang="java"><span class="cm">     * preserve spaces. All elements that do not specify otherwise</span></span>
<span id="LC759" class="line" lang="java"><span class="cm">     * or specify the default behavior will be formatted based on</span></span>
<span id="LC760" class="line" lang="java"><span class="cm">     * this rule. All elements that specify space preserving will</span></span>
<span id="LC761" class="line" lang="java"><span class="cm">     * always preserve space.</span></span>
<span id="LC762" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC763" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getPreserveSpace</span><span class="o">()</span></span>
<span id="LC764" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC765" class="line" lang="java">        <span class="k">return</span> <span class="n">_preserve</span><span class="o">;</span></span>
...
<span id="LC770" class="line" lang="java"><span class="cm">     * Sets space preserving as the default behavior. The default is</span></span>
<span id="LC771" class="line" lang="java"><span class="cm">     * space stripping and all elements that do not specify otherwise</span></span>
<span id="LC772" class="line" lang="java"><span class="cm">     * or use the default value will not preserve spaces.</span></span>
<span id="LC773" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC774" class="line" lang="java"><span class="cm">     * @param preserve True if spaces should be preserved</span></span>
<span id="LC775" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC776" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPreserveSpace</span><span class="o">(</span> <span class="kt">boolean</span> <span class="n">preserve</span> <span class="o">)</span></span>
<span id="LC777" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC778" class="line" lang="java">        <span class="n">_preserve</span> <span class="o">=</span> <span class="n">preserve</span><span class="o">;</span></span>
...
<span id="LC783" class="line" lang="java"><span class="cm">     * Return the selected line width for breaking up long lines.</span></span>
<span id="LC784" class="line" lang="java"><span class="cm">     * When indenting, and only when indenting, long lines will be</span></span>
<span id="LC785" class="line" lang="java"><span class="cm">     * broken at space boundaries based on this line width.</span></span>
<span id="LC786" class="line" lang="java"><span class="cm">     * No line wrapping occurs if this value is zero.</span></span>
<span id="LC787" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC788" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getLineWidth</span><span class="o">()</span></span>
<span id="LC789" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC790" class="line" lang="java">        <span class="k">return</span> <span class="n">_lineWidth</span><span class="o">;</span></span>
...
<span id="LC795" class="line" lang="java"><span class="cm">     * Sets the line width. If zero then no line wrapping will</span></span>
<span id="LC796" class="line" lang="java"><span class="cm">     * occur. Calling {@link #setIndenting} will reset this</span></span>
<span id="LC797" class="line" lang="java"><span class="cm">     * value to zero (off) or the default (on).</span></span>
<span id="LC798" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC799" class="line" lang="java"><span class="cm">     * @param lineWidth The line width to use, zero for default</span></span>
<span id="LC800" class="line" lang="java"><span class="cm">     * @see #getLineWidth</span></span>
<span id="LC801" class="line" lang="java"><span class="cm">     * @see #setIndenting</span></span>
<span id="LC802" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC803" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setLineWidth</span><span class="o">(</span> <span class="kt">int</span> <span class="n">lineWidth</span> <span class="o">)</span></span>
<span id="LC804" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC805" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span> <span class="n">lineWidth</span> <span class="o">&lt;=</span> <span class="mi">0</span> <span class="o">)</span></span>
<span id="LC806" class="line" lang="java">            <span class="n">_lineWidth</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC807" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC808" class="line" lang="java">            <span class="n">_lineWidth</span> <span class="o">=</span> <span class="n">lineWidth</span><span class="o">;</span></span>
<span id="LC809" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC810" class="line" lang="java">        <span class="cm">/**</span></span>
<span id="LC811" class="line" lang="java"><span class="cm">         * Returns the preserveEmptyAttribute flag. If flag is false, then'</span></span>
<span id="LC812" class="line" lang="java"><span class="cm">         * attributes with empty string values are output as the attribute</span></span>
<span id="LC813" class="line" lang="java"><span class="cm">         * name only (in HTML mode).</span></span>
<span id="LC814" class="line" lang="java"><span class="cm">         * @return preserve the preserve flag</span></span>
<span id="LC815" class="line" lang="java"><span class="cm">         */</span>     <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getPreserveEmptyAttributes</span> <span class="o">()</span> <span class="o">{</span>          <span class="k">return</span> <span class="n">_preserveEmptyAttributes</span><span class="o">;</span>        <span class="o">}</span>       <span class="cm">/**</span></span>
<span id="LC816" class="line" lang="java"><span class="cm">         * Sets the preserveEmptyAttribute flag. If flag is false, then'</span></span>
<span id="LC817" class="line" lang="java"><span class="cm">         * attributes with empty string values are output as the attribute</span></span>
<span id="LC818" class="line" lang="java"><span class="cm">         * name only (in HTML mode).</span></span>
<span id="LC819" class="line" lang="java"><span class="cm">         * @param preserve the preserve flag</span></span>
<span id="LC820" class="line" lang="java"><span class="cm">         */</span>     <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPreserveEmptyAttributes</span> <span class="o">(</span><span class="kt">boolean</span> <span class="n">preserve</span><span class="o">)</span> <span class="o">{</span>             <span class="n">_preserveEmptyAttributes</span> <span class="o">=</span> <span class="n">preserve</span><span class="o">;</span>    <span class="o">}</span></span>
<span id="LC821" class="line" lang="java"></span>
<span id="LC822" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC823" class="line" lang="java"><span class="cm">     * Returns the last printable character based on the selected</span></span>
<span id="LC824" class="line" lang="java"><span class="cm">     * encoding. Control characters and non-printable characters</span></span>
<span id="LC825" class="line" lang="java"><span class="cm">     * are always printed as character references.</span></span>
<span id="LC826" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC827" class="line" lang="java">    <span class="kd">public</span> <span class="kt">char</span> <span class="nf">getLastPrintable</span><span class="o">()</span></span>
<span id="LC828" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC829" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span> <span class="n">getEncoding</span><span class="o">()</span> <span class="o">!=</span> <span class="kc">null</span> <span class="o">&amp;&amp;</span></span>
<span id="LC830" class="line" lang="java">             <span class="o">(</span> <span class="n">getEncoding</span><span class="o">().</span><span class="na">equalsIgnoreCase</span><span class="o">(</span> <span class="s">"ASCII"</span> <span class="o">)</span> <span class="o">)</span> <span class="o">)</span></span>
<span id="LC831" class="line" lang="java">            <span class="k">return</span> <span class="mh">0xFF</span><span class="o">;</span></span>
<span id="LC832" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC833" class="line" lang="java">            <span class="k">return</span> <span class="mh">0xFFFF</span><span class="o">;</span></span>
...
<span id="LC838" class="line" lang="java"><span class="cm">     * Determine the output method for the specified document.</span></span>
<span id="LC839" class="line" lang="java"><span class="cm">     * If the document is an instance of {@link org.w3c.dom.html.HTMLDocument}</span></span>
<span id="LC840" class="line" lang="java"><span class="cm">     * then the method is said to be &lt;tt&gt;html&lt;/tt&gt;. If the root</span></span>
<span id="LC841" class="line" lang="java"><span class="cm">     * element is 'html' and all text nodes preceding the root</span></span>
<span id="LC842" class="line" lang="java"><span class="cm">     * element are all whitespace, then the method is said to be</span></span>
<span id="LC843" class="line" lang="java"><span class="cm">     * &lt;tt&gt;html&lt;/tt&gt;. Otherwise the method is &lt;tt&gt;xml&lt;/tt&gt;.</span></span>
<span id="LC844" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC845" class="line" lang="java"><span class="cm">     * @param doc The document to check</span></span>
<span id="LC846" class="line" lang="java"><span class="cm">     * @return The suitable method</span></span>
<span id="LC847" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC848" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="nc">String</span> <span class="nf">whichMethod</span><span class="o">(</span> <span class="nc">Document</span> <span class="n">doc</span> <span class="o">)</span></span>
<span id="LC849" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC850" class="line" lang="java">        <span class="nc">Node</span>    <span class="n">node</span><span class="o">;</span></span>
<span id="LC851" class="line" lang="java">        <span class="nc">String</span>  <span class="n">value</span><span class="o">;</span></span>
<span id="LC852" class="line" lang="java">        <span class="kt">int</span>     <span class="n">i</span><span class="o">;</span></span>
<span id="LC853" class="line" lang="java"></span>
<span id="LC854" class="line" lang="java">        <span class="c1">// If document is derived from HTMLDocument then the default</span></span>
<span id="LC855" class="line" lang="java">        <span class="c1">// method is html.</span></span>
<span id="LC856" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span> <span class="n">doc</span> <span class="k">instanceof</span> <span class="nc">HTMLDocument</span> <span class="o">)</span></span>
<span id="LC857" class="line" lang="java">            <span class="k">return</span> <span class="nc">Method</span><span class="o">.</span><span class="na">HTML</span><span class="o">;</span></span>
<span id="LC858" class="line" lang="java"></span>
<span id="LC859" class="line" lang="java">        <span class="c1">// Lookup the root element and the text nodes preceding it.</span></span>
<span id="LC860" class="line" lang="java">        <span class="c1">// If root element is html and all text nodes contain whitespace</span></span>
<span id="LC861" class="line" lang="java">        <span class="c1">// only, the method is html.</span></span>
<span id="LC862" class="line" lang="java"></span>
<span id="LC863" class="line" lang="java">        <span class="c1">// FIXME (SM) should we care about namespaces here?</span></span>
<span id="LC864" class="line" lang="java"></span>
<span id="LC865" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">doc</span><span class="o">.</span><span class="na">getFirstChild</span><span class="o">();</span></span>
<span id="LC866" class="line" lang="java">        <span class="k">while</span> <span class="o">(</span><span class="n">node</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC867" class="line" lang="java">            <span class="c1">// If the root element is html, the method is html.</span></span>
<span id="LC868" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span> <span class="n">node</span><span class="o">.</span><span class="na">getNodeType</span><span class="o">()</span> <span class="o">==</span> <span class="nc">Node</span><span class="o">.</span><span class="na">ELEMENT_NODE</span> <span class="o">)</span> <span class="o">{</span></span>
<span id="LC869" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span> <span class="n">node</span><span class="o">.</span><span class="na">getNodeName</span><span class="o">().</span><span class="na">equalsIgnoreCase</span><span class="o">(</span> <span class="s">"html"</span> <span class="o">)</span> <span class="o">)</span> <span class="o">{</span></span>
<span id="LC870" class="line" lang="java">                    <span class="k">return</span> <span class="nc">Method</span><span class="o">.</span><span class="na">HTML</span><span class="o">;</span></span>
<span id="LC871" class="line" lang="java">                <span class="o">}</span> <span class="k">else</span> <span class="k">if</span> <span class="o">(</span> <span class="n">node</span><span class="o">.</span><span class="na">getNodeName</span><span class="o">().</span><span class="na">equalsIgnoreCase</span><span class="o">(</span> <span class="s">"root"</span> <span class="o">)</span> <span class="o">)</span> <span class="o">{</span></span>
<span id="LC872" class="line" lang="java">                    <span class="k">return</span> <span class="nc">Method</span><span class="o">.</span><span class="na">FOP</span><span class="o">;</span></span>
<span id="LC873" class="line" lang="java">                <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC874" class="line" lang="java">                    <span class="k">return</span> <span class="nc">Method</span><span class="o">.</span><span class="na">XML</span><span class="o">;</span></span>
<span id="LC875" class="line" lang="java">                <span class="o">}</span></span>
<span id="LC876" class="line" lang="java">            <span class="o">}</span> <span class="k">else</span> <span class="k">if</span> <span class="o">(</span> <span class="n">node</span><span class="o">.</span><span class="na">getNodeType</span><span class="o">()</span> <span class="o">==</span> <span class="nc">Node</span><span class="o">.</span><span class="na">TEXT_NODE</span> <span class="o">)</span> <span class="o">{</span></span>
<span id="LC877" class="line" lang="java">                <span class="c1">// If a text node preceding the root element contains</span></span>
<span id="LC878" class="line" lang="java">                <span class="c1">// only whitespace, this might be html, otherwise it's</span></span>
<span id="LC879" class="line" lang="java">                <span class="c1">// definitely xml.</span></span>
<span id="LC880" class="line" lang="java">                <span class="n">value</span> <span class="o">=</span> <span class="n">node</span><span class="o">.</span><span class="na">getNodeValue</span><span class="o">();</span></span>
<span id="LC881" class="line" lang="java">                <span class="k">for</span> <span class="o">(</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span> <span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">value</span><span class="o">.</span><span class="na">length</span><span class="o">()</span> <span class="o">;</span> <span class="o">++</span><span class="n">i</span> <span class="o">)</span></span>
<span id="LC882" class="line" lang="java">                    <span class="k">if</span> <span class="o">(</span> <span class="n">value</span><span class="o">.</span><span class="na">charAt</span><span class="o">(</span> <span class="n">i</span> <span class="o">)</span> <span class="o">!=</span> <span class="mh">0x20</span> <span class="o">&amp;&amp;</span> <span class="n">value</span><span class="o">.</span><span class="na">charAt</span><span class="o">(</span> <span class="n">i</span> <span class="o">)</span> <span class="o">!=</span> <span class="mh">0x0A</span> <span class="o">&amp;&amp;</span></span>
<span id="LC883" class="line" lang="java">                         <span class="n">value</span><span class="o">.</span><span class="na">charAt</span><span class="o">(</span> <span class="n">i</span> <span class="o">)</span> <span class="o">!=</span> <span class="mh">0x09</span> <span class="o">&amp;&amp;</span> <span class="n">value</span><span class="o">.</span><span class="na">charAt</span><span class="o">(</span> <span class="n">i</span> <span class="o">)</span> <span class="o">!=</span> <span class="mh">0x0D</span> <span class="o">)</span></span>
<span id="LC884" class="line" lang="java">                        <span class="k">return</span> <span class="nc">Method</span><span class="o">.</span><span class="na">XML</span><span class="o">;</span></span>
<span id="LC885" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC886" class="line" lang="java">            <span class="n">node</span> <span class="o">=</span> <span class="n">node</span><span class="o">.</span><span class="na">getNextSibling</span><span class="o">();</span></span>
<span id="LC887" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC888" class="line" lang="java">        <span class="c1">// Anything else, the method is xml.</span></span>
<span id="LC889" class="line" lang="java">        <span class="k">return</span> <span class="nc">Method</span><span class="o">.</span><span class="na">XML</span><span class="o">;</span></span>
...
<span id="LC894" class="line" lang="java"><span class="cm">     * Returns the document type public identifier</span></span>
<span id="LC895" class="line" lang="java"><span class="cm">     * specified for this document, or null.</span></span>
<span id="LC896" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC897" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="nc">String</span> <span class="nf">whichDoctypePublic</span><span class="o">(</span> <span class="nc">Document</span> <span class="n">doc</span> <span class="o">)</span></span>
<span id="LC898" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC899" class="line" lang="java">        <span class="nc">DocumentType</span> <span class="n">doctype</span><span class="o">;</span></span>
<span id="LC900" class="line" lang="java"></span>
<span id="LC901" class="line" lang="java">           <span class="cm">/*  DOM Level 2 was introduced into the code base*/</span></span>
<span id="LC902" class="line" lang="java">           <span class="n">doctype</span> <span class="o">=</span> <span class="n">doc</span><span class="o">.</span><span class="na">getDoctype</span><span class="o">();</span></span>
<span id="LC903" class="line" lang="java">           <span class="k">if</span> <span class="o">(</span> <span class="n">doctype</span> <span class="o">!=</span> <span class="kc">null</span> <span class="o">)</span> <span class="o">{</span></span>
<span id="LC904" class="line" lang="java">           <span class="c1">// Note on catch: DOM Level 1 does not specify this method</span></span>
<span id="LC905" class="line" lang="java">           <span class="c1">// and the code will throw a NoSuchMethodError</span></span>
<span id="LC906" class="line" lang="java">           <span class="k">try</span> <span class="o">{</span></span>
<span id="LC907" class="line" lang="java">           <span class="k">return</span> <span class="n">doctype</span><span class="o">.</span><span class="na">getPublicId</span><span class="o">();</span></span>
<span id="LC908" class="line" lang="java">           <span class="o">}</span> <span class="k">catch</span> <span class="o">(</span> <span class="nc">Error</span> <span class="n">except</span> <span class="o">)</span> <span class="o">{</span>  <span class="o">}</span></span>
<span id="LC909" class="line" lang="java">           <span class="o">}</span></span>
<span id="LC910" class="line" lang="java"></span>
<span id="LC911" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span> <span class="n">doc</span> <span class="k">instanceof</span> <span class="nc">HTMLDocument</span> <span class="o">)</span></span>
<span id="LC912" class="line" lang="java">            <span class="k">return</span> <span class="no">DTD</span><span class="o">.</span><span class="na">XHTMLPublicId</span><span class="o">;</span></span>
...
<span id="LC918" class="line" lang="java"><span class="cm">     * Returns the document type system identifier</span></span>
<span id="LC919" class="line" lang="java"><span class="cm">     * specified for this document, or null.</span></span>
<span id="LC920" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC921" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="nc">String</span> <span class="nf">whichDoctypeSystem</span><span class="o">(</span> <span class="nc">Document</span> <span class="n">doc</span> <span class="o">)</span></span>
<span id="LC922" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC923" class="line" lang="java">        <span class="nc">DocumentType</span> <span class="n">doctype</span><span class="o">;</span></span>
<span id="LC924" class="line" lang="java"></span>
<span id="LC925" class="line" lang="java">        <span class="cm">/* DOM Level 2 was introduced into the code base*/</span></span>
<span id="LC926" class="line" lang="java">           <span class="n">doctype</span> <span class="o">=</span> <span class="n">doc</span><span class="o">.</span><span class="na">getDoctype</span><span class="o">();</span></span>
<span id="LC927" class="line" lang="java">           <span class="k">if</span> <span class="o">(</span> <span class="n">doctype</span> <span class="o">!=</span> <span class="kc">null</span> <span class="o">)</span> <span class="o">{</span></span>
<span id="LC928" class="line" lang="java">           <span class="c1">// Note on catch: DOM Level 1 does not specify this method</span></span>
<span id="LC929" class="line" lang="java">           <span class="c1">// and the code will throw a NoSuchMethodError</span></span>
<span id="LC930" class="line" lang="java">           <span class="k">try</span> <span class="o">{</span></span>
<span id="LC931" class="line" lang="java">           <span class="k">return</span> <span class="n">doctype</span><span class="o">.</span><span class="na">getSystemId</span><span class="o">();</span></span>
<span id="LC932" class="line" lang="java">           <span class="o">}</span> <span class="k">catch</span> <span class="o">(</span> <span class="nc">Error</span> <span class="n">except</span> <span class="o">)</span> <span class="o">{</span> <span class="o">}</span></span>
<span id="LC933" class="line" lang="java">           <span class="o">}</span></span>
<span id="LC934" class="line" lang="java"></span>
<span id="LC935" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span> <span class="n">doc</span> <span class="k">instanceof</span> <span class="nc">HTMLDocument</span> <span class="o">)</span></span>
<span id="LC936" class="line" lang="java">            <span class="k">return</span> <span class="no">DTD</span><span class="o">.</span><span class="na">XHTMLSystemId</span><span class="o">;</span></span>
...
<span id="LC942" class="line" lang="java"><span class="cm">     * Returns the suitable media format for a document</span></span>
<span id="LC943" class="line" lang="java"><span class="cm">     * output with the specified method.</span></span>
<span id="LC944" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC945" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="nc">String</span> <span class="nf">whichMediaType</span><span class="o">(</span> <span class="nc">String</span> <span class="n">method</span> <span class="o">)</span></span>
<span id="LC946" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC947" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span> <span class="n">method</span><span class="o">.</span><span class="na">equalsIgnoreCase</span><span class="o">(</span> <span class="nc">Method</span><span class="o">.</span><span class="na">XML</span> <span class="o">)</span> <span class="o">)</span></span>
<span id="LC948" class="line" lang="java">            <span class="k">return</span> <span class="s">"text/xml"</span><span class="o">;</span></span>
<span id="LC949" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span> <span class="n">method</span><span class="o">.</span><span class="na">equalsIgnoreCase</span><span class="o">(</span> <span class="nc">Method</span><span class="o">.</span><span class="na">HTML</span> <span class="o">)</span> <span class="o">)</span></span>
<span id="LC950" class="line" lang="java">            <span class="k">return</span> <span class="s">"text/html"</span><span class="o">;</span></span>
<span id="LC951" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span> <span class="n">method</span><span class="o">.</span><span class="na">equalsIgnoreCase</span><span class="o">(</span> <span class="nc">Method</span><span class="o">.</span><span class="na">XHTML</span> <span class="o">)</span> <span class="o">)</span></span>
<span id="LC952" class="line" lang="java">            <span class="k">return</span> <span class="s">"text/html"</span><span class="o">;</span></span>
<span id="LC953" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span> <span class="n">method</span><span class="o">.</span><span class="na">equalsIgnoreCase</span><span class="o">(</span> <span class="nc">Method</span><span class="o">.</span><span class="na">TEXT</span> <span class="o">)</span> <span class="o">)</span></span>
<span id="LC954" class="line" lang="java">            <span class="k">return</span> <span class="s">"text/plain"</span><span class="o">;</span></span>
<span id="LC955" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span> <span class="n">method</span><span class="o">.</span><span class="na">equalsIgnoreCase</span><span class="o">(</span> <span class="nc">Method</span><span class="o">.</span><span class="na">FOP</span> <span class="o">)</span> <span class="o">)</span></span>
<span id="LC956" class="line" lang="java">            <span class="k">return</span> <span class="s">"application/pdf"</span><span class="o">;</span></span>
