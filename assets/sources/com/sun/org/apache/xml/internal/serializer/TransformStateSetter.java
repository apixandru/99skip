...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: TransformStateSetter.java,v 1.2.4.1 2005/09/15 08:15:29 suresh_emailid Exp $</span></span>
...
<span id="LC25" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.transform.Transformer</span><span class="o">;</span></span>
...
<span id="LC29" class="line" lang="java"><span class="cm"> * This interface is meant to be used by a base interface to</span></span>
<span id="LC30" class="line" lang="java"><span class="cm"> * TransformState, but which as only the setters which have non Xalan</span></span>
<span id="LC31" class="line" lang="java"><span class="cm"> * specific types in their signature, so that there are no dependancies</span></span>
<span id="LC32" class="line" lang="java"><span class="cm"> * of the serializer on Xalan.</span></span>
<span id="LC33" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC34" class="line" lang="java"><span class="cm"> * This interface is not a public API, it is only public because it is</span></span>
<span id="LC35" class="line" lang="java"><span class="cm"> * used by Xalan.</span></span>
<span id="LC36" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC37" class="line" lang="java"><span class="cm"> * @see com.sun.org.apache.xalan.internal.transformer.TransformState</span></span>
...
<span id="LC40" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">TransformStateSetter</span></span>
...
<span id="LC45" class="line" lang="java"><span class="cm">   * Set the current node.</span></span>
<span id="LC46" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC47" class="line" lang="java"><span class="cm">   * @param n The current node.</span></span>
<span id="LC48" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC49" class="line" lang="java">  <span class="kt">void</span> <span class="nf">setCurrentNode</span><span class="o">(</span><span class="nc">Node</span> <span class="n">n</span><span class="o">);</span></span>
<span id="LC50" class="line" lang="java"></span>
<span id="LC51" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC52" class="line" lang="java"><span class="cm">   * Reset the state on the given transformer object.</span></span>
<span id="LC53" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC54" class="line" lang="java"><span class="cm">   * @param transformer</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC56" class="line" lang="java">  <span class="kt">void</span> <span class="nf">resetState</span><span class="o">(</span><span class="nc">Transformer</span> <span class="n">transformer</span><span class="o">);</span></span>
