...
<span id="LC43" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">SerializerMessages_de</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span> <span class="o">{</span></span>
...
<span id="LC73" class="line" lang="java">                <span class="s">"Der Nachrichtenschl\u00FCssel \"{0}\" ist nicht in der Nachrichtenklasse \"{1}\" enthalten"</span> <span class="o">},</span></span>
...
<span id="LC76" class="line" lang="java">                <span class="s">"Das Format der Nachricht \"{0}\" in der Nachrichtenklasse \"{1}\" war nicht erfolgreich."</span> <span class="o">},</span></span>
...
<span id="LC79" class="line" lang="java">                <span class="s">"Serializer-Klasse \"{0}\" implementiert org.xml.sax.ContentHandler nicht."</span> <span class="o">},</span></span>
...
<span id="LC82" class="line" lang="java">                    <span class="s">"Ressource [ {0} ] konnte nicht gefunden werden.\n {1}"</span> <span class="o">},</span></span>
...
<span id="LC85" class="line" lang="java">                    <span class="s">"Ressource [ {0} ] konnte nicht geladen werden: {1} \n {2} \t {3}"</span> <span class="o">},</span></span>
...
<span id="LC88" class="line" lang="java">                    <span class="s">"Puffergr\u00F6\u00DFe &lt;=0"</span> <span class="o">},</span></span>
...
<span id="LC91" class="line" lang="java">                    <span class="s">"Ung\u00FCltige UTF-16-Ersetzung festgestellt: {0}?"</span> <span class="o">},</span></span>
...
<span id="LC94" class="line" lang="java">                <span class="s">"I/O-Fehler"</span> <span class="o">},</span></span>
...
<span id="LC97" class="line" lang="java">                <span class="s">"Attribut {0} kann nicht nach untergeordneten Knoten oder vor dem Erstellen eines Elements hinzugef\u00FCgt werden. Attribut wird ignoriert."</span> <span class="o">},</span></span>
...
<span id="LC105" class="line" lang="java">                <span class="s">"Namespace f\u00FCr Pr\u00E4fix \"{0}\" wurde nicht deklariert."</span> <span class="o">},</span></span>
...
<span id="LC114" class="line" lang="java">                <span class="s">"Attribut \"{0}\" au\u00DFerhalb des Elements."</span> <span class="o">},</span></span>
...
<span id="LC124" class="line" lang="java">                <span class="s">"Namespace-Deklaration {0}={1} au\u00DFerhalb des Elements."</span> <span class="o">},</span></span>
...
<span id="LC127" class="line" lang="java">                <span class="s">"\"{0}\" konnte nicht geladen werden (CLASSPATH pr\u00FCfen). Die Standardwerte werden verwendet"</span> <span class="o">},</span></span>
...
<span id="LC130" class="line" lang="java">                <span class="s">"Versuch, Zeichen mit Integralwert {0} auszugeben, das nicht in der speziellen Ausgabecodierung von {1} dargestellt wird."</span> <span class="o">},</span></span>
...
<span id="LC133" class="line" lang="java">                <span class="s">"Property-Datei \"{0}\" konnte f\u00FCr Ausgabemethode \"{1}\" nicht geladen werden (CLASSPATH pr\u00FCfen)"</span> <span class="o">},</span></span>
...
<span id="LC136" class="line" lang="java">                <span class="s">"Ung\u00FCltige Portnummer"</span> <span class="o">},</span></span>
...
<span id="LC139" class="line" lang="java">                <span class="s">"Port kann nicht festgelegt werden, wenn der Host null ist"</span> <span class="o">},</span></span>
...
<span id="LC142" class="line" lang="java">                <span class="s">"Host ist keine wohlgeformte Adresse"</span> <span class="o">},</span></span>
...
<span id="LC145" class="line" lang="java">                <span class="s">"Schema ist nicht konform."</span> <span class="o">},</span></span>
...
<span id="LC148" class="line" lang="java">                <span class="s">"Schema kann nicht von Nullzeichenfolge festgelegt werden"</span> <span class="o">},</span></span>
...
<span id="LC151" class="line" lang="java">                <span class="s">"Pfad enth\u00E4lt eine ung\u00FCltige Escapesequenz"</span> <span class="o">},</span></span>
...
<span id="LC154" class="line" lang="java">                <span class="s">"Pfad enth\u00E4lt ung\u00FCltiges Zeichen: {0}"</span> <span class="o">},</span></span>
...
<span id="LC157" class="line" lang="java">                <span class="s">"Fragment enth\u00E4lt ein ung\u00FCltiges Zeichen"</span> <span class="o">},</span></span>
...
<span id="LC160" class="line" lang="java">                <span class="s">"Fragment kann nicht festgelegt werden, wenn der Pfad null ist"</span> <span class="o">},</span></span>
...
<span id="LC163" class="line" lang="java">                <span class="s">"Fragment kann nur f\u00FCr einen generischen URI festgelegt werden"</span> <span class="o">},</span></span>
...
<span id="LC166" class="line" lang="java">                <span class="s">"Kein Schema gefunden in URI"</span> <span class="o">},</span></span>
...
<span id="LC169" class="line" lang="java">                <span class="s">"URI kann nicht mit leeren Parametern initialisiert werden"</span> <span class="o">},</span></span>
...
<span id="LC172" class="line" lang="java">                <span class="s">"Fragment kann nicht im Pfad und im Fragment angegeben werden"</span> <span class="o">},</span></span>
...
<span id="LC175" class="line" lang="java">                <span class="s">"Abfragezeichenfolge kann nicht im Pfad und in der Abfragezeichenfolge angegeben werden"</span> <span class="o">},</span></span>
...
<span id="LC178" class="line" lang="java">                <span class="s">"Port kann nicht angegeben werden, wenn der Host nicht angegeben wurde"</span> <span class="o">},</span></span>
...
<span id="LC181" class="line" lang="java">                <span class="s">"Benutzerinformationen k\u00F6nnen nicht angegeben werden, wenn der Host nicht angegeben wurde"</span> <span class="o">},</span></span>
...
<span id="LC184" class="line" lang="java">                <span class="s">"Warnung: Die Version des Ausgabedokuments soll \"{0}\" sein. Diese Version von XML wird nicht unterst\u00FCtzt. Die Version des Ausgabedokuments wird \"1.0\" sein."</span> <span class="o">},</span></span>
...
<span id="LC187" class="line" lang="java">                <span class="s">"Schema ist erforderlich."</span> <span class="o">},</span></span>
...
<span id="LC195" class="line" lang="java">                <span class="s">"Das an die SerializerFactory \u00FCbergebene Properties-Objekt verf\u00FCgt \u00FCber keine Eigenschaft \"{0}\"."</span> <span class="o">},</span></span>
...
<span id="LC198" class="line" lang="java">                <span class="s">"Warnung: Die Codierung \"{0}\" wird nicht von der Java-Laufzeit unterst\u00FCtzt."</span> <span class="o">},</span></span>
