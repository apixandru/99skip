...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: CharKey.java,v 1.3 2005/09/28 13:49:18 pvedula Exp $</span></span>
...
<span id="LC26" class="line" lang="java"><span class="cm"> * Simple class for fast lookup of char values, when used with</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * hashtables.  You can set the char, then use it as a key.</span></span>
...
<span id="LC30" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">CharKey</span> <span class="kd">extends</span> <span class="nc">Object</span></span>
<span id="LC31" class="line" lang="java"><span class="o">{</span></span>
<span id="LC32" class="line" lang="java"></span>
<span id="LC33" class="line" lang="java">  <span class="cm">/** String value          */</span></span>
<span id="LC34" class="line" lang="java">  <span class="kd">private</span> <span class="kt">char</span> <span class="n">m_char</span><span class="o">;</span></span>
<span id="LC35" class="line" lang="java"></span>
<span id="LC36" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">   * Constructor CharKey</span></span>
<span id="LC38" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">   * @param key char value of this object.</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC41" class="line" lang="java">  <span class="kd">public</span> <span class="nf">CharKey</span><span class="o">(</span><span class="kt">char</span> <span class="n">key</span><span class="o">)</span></span>
<span id="LC42" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC43" class="line" lang="java">    <span class="n">m_char</span> <span class="o">=</span> <span class="n">key</span><span class="o">;</span></span>
...
<span id="LC47" class="line" lang="java"><span class="cm">   * Default constructor for a CharKey.</span></span>
<span id="LC48" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC49" class="line" lang="java">  <span class="kd">public</span> <span class="nf">CharKey</span><span class="o">()</span></span>
...
<span id="LC54" class="line" lang="java"><span class="cm">   * Get the hash value of the character.</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">   * @return hash value of the character.</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC58" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">setChar</span><span class="o">(</span><span class="kt">char</span> <span class="n">c</span><span class="o">)</span></span>
<span id="LC59" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC60" class="line" lang="java">    <span class="n">m_char</span> <span class="o">=</span> <span class="n">c</span><span class="o">;</span></span>
...
<span id="LC66" class="line" lang="java"><span class="cm">   * Get the hash value of the character.</span></span>
<span id="LC67" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC68" class="line" lang="java"><span class="cm">   * @return hash value of the character.</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC70" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nf">hashCode</span><span class="o">()</span></span>
<span id="LC71" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC72" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="kt">int</span><span class="o">)</span><span class="n">m_char</span><span class="o">;</span></span>
...
<span id="LC76" class="line" lang="java"><span class="cm">   * Override of equals() for this object</span></span>
<span id="LC77" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC78" class="line" lang="java"><span class="cm">   * @param obj to compare to</span></span>
<span id="LC79" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC80" class="line" lang="java"><span class="cm">   * @return True if this object equals this string value</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC82" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">boolean</span> <span class="nf">equals</span><span class="o">(</span><span class="nc">Object</span> <span class="n">obj</span><span class="o">)</span></span>
<span id="LC83" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC84" class="line" lang="java">    <span class="k">return</span> <span class="o">((</span><span class="nc">CharKey</span><span class="o">)</span><span class="n">obj</span><span class="o">).</span><span class="na">m_char</span> <span class="o">==</span> <span class="n">m_char</span><span class="o">;</span></span>
