...
<span id="LC36" class="line" lang="java"><span class="cm"> * An abstract representation of a &lt;code&gt;ReferenceData&lt;/code&gt; type containing a node-set.</span></span>
<span id="LC37" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC38" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">ReferenceNodeSetData</span> <span class="kd">extends</span> <span class="nc">ReferenceData</span> <span class="o">{</span></span>
<span id="LC39" class="line" lang="java"></span>
<span id="LC40" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC41" class="line" lang="java"><span class="cm">     * Returns a read-only iterator over the nodes contained in this</span></span>
<span id="LC42" class="line" lang="java"><span class="cm">     * &lt;code&gt;NodeSetData&lt;/code&gt; in</span></span>
<span id="LC43" class="line" lang="java"><span class="cm">     * &lt;a href="http://www.w3.org/TR/1999/REC-xpath-19991116#dt-document-order"&gt;</span></span>
<span id="LC44" class="line" lang="java"><span class="cm">     * document order&lt;/a&gt;. Attempts to modify the returned iterator</span></span>
<span id="LC45" class="line" lang="java"><span class="cm">     * via the &lt;code&gt;remove&lt;/code&gt; method throw</span></span>
<span id="LC46" class="line" lang="java"><span class="cm">     * &lt;code&gt;UnsupportedOperationException&lt;/code&gt;.</span></span>
<span id="LC47" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC48" class="line" lang="java"><span class="cm">     * @return an &lt;code&gt;Iterator&lt;/code&gt; over the nodes in this</span></span>
<span id="LC49" class="line" lang="java"><span class="cm">     *    &lt;code&gt;NodeSetData&lt;/code&gt; in document order</span></span>
<span id="LC50" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC51" class="line" lang="java">    <span class="nc">Iterator</span><span class="o">&lt;</span><span class="nc">Node</span><span class="o">&gt;</span> <span class="nf">iterator</span><span class="o">();</span></span>
