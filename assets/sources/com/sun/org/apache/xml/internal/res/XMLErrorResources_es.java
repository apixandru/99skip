...
<span id="LC35" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XMLErrorResources_es</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span></span>
...
<span id="LC185" class="line" lang="java">      <span class="s">"Funci\u00F3n no soportada."</span><span class="o">},</span></span>
...
<span id="LC188" class="line" lang="java">      <span class="s">"No se puede sobrescribir la causa"</span><span class="o">},</span></span>
...
<span id="LC191" class="line" lang="java">      <span class="s">"No se ha encontrado la implantaci\u00F3n por defecto "</span><span class="o">},</span></span>
...
<span id="LC194" class="line" lang="java">      <span class="s">"ChunkedIntArray({0}) no est\u00E1 soportado actualmente"</span><span class="o">},</span></span>
...
<span id="LC197" class="line" lang="java">      <span class="s">"El desplazamiento es mayor que la ranura"</span><span class="o">},</span></span>
...
<span id="LC200" class="line" lang="java">      <span class="s">"Corrutina no disponible, id={0}"</span><span class="o">},</span></span>
...
<span id="LC203" class="line" lang="java">      <span class="s">"CoroutineManager ha recibido la solicitud co_exit()"</span><span class="o">},</span></span>
...
<span id="LC206" class="line" lang="java">      <span class="s">"Fallo de co_joinCoroutineSet()"</span><span class="o">},</span></span>
...
<span id="LC209" class="line" lang="java">      <span class="s">"Error de par\u00E1metro de corrutina ({0})"</span><span class="o">},</span></span>
...
<span id="LC212" class="line" lang="java">      <span class="s">"\nINESPERADO: respuestas doTerminate del analizador {0}"</span><span class="o">},</span></span>
...
<span id="LC215" class="line" lang="java">      <span class="s">"no se puede realizar un an\u00E1lisis mientras se lleva a cabo otro"</span><span class="o">},</span></span>
...
<span id="LC218" class="line" lang="java">      <span class="s">"Error: el iterador introducido para el eje {0} no se ha implantado"</span><span class="o">},</span></span>
...
<span id="LC221" class="line" lang="java">      <span class="s">"Error: el iterador para el eje {0} no se ha implantado "</span><span class="o">},</span></span>
...
<span id="LC224" class="line" lang="java">      <span class="s">"La clonaci\u00F3n del iterador no est\u00E1 soportada"</span><span class="o">},</span></span>
...
<span id="LC227" class="line" lang="java">      <span class="s">"Tipo de recorrido de eje desconocido: {0}"</span><span class="o">},</span></span>
...
<span id="LC230" class="line" lang="java">      <span class="s">"Traverser de eje no soportado: {0}"</span><span class="o">},</span></span>
...
<span id="LC233" class="line" lang="java">      <span class="s">"No hay m\u00E1s identificadores de DTM disponibles"</span><span class="o">},</span></span>
...
<span id="LC236" class="line" lang="java">      <span class="s">"No soportado: {0}"</span><span class="o">},</span></span>
...
<span id="LC239" class="line" lang="java">      <span class="s">"El nodo debe ser no nulo para getDTMHandleFromNode"</span><span class="o">},</span></span>
...
<span id="LC242" class="line" lang="java">      <span class="s">"No se ha podido resolver el nodo en un identificador"</span><span class="o">},</span></span>
...
<span id="LC245" class="line" lang="java">       <span class="s">"startParse no puede llamarse durante el an\u00E1lisis"</span><span class="o">},</span></span>
...
<span id="LC248" class="line" lang="java">       <span class="s">"startParse necesita un SAXParser no nulo"</span><span class="o">},</span></span>
...
<span id="LC251" class="line" lang="java">       <span class="s">"no se ha podido inicializar el analizador con"</span><span class="o">},</span></span>
...
<span id="LC254" class="line" lang="java">       <span class="s">"excepci\u00F3n al crear la nueva instancia para el pool"</span><span class="o">},</span></span>
...
<span id="LC257" class="line" lang="java">       <span class="s">"La ruta de acceso contiene una secuencia de escape no v\u00E1lida"</span><span class="o">},</span></span>
...
<span id="LC260" class="line" lang="java">       <span class="s">"Se necesita un esquema."</span><span class="o">},</span></span>
...
<span id="LC263" class="line" lang="java">       <span class="s">"No se ha encontrado un esquema en el URI: {0}"</span><span class="o">},</span></span>
...
<span id="LC266" class="line" lang="java">       <span class="s">"No se ha encontrado un esquema en el URI"</span><span class="o">},</span></span>
...
<span id="LC269" class="line" lang="java">       <span class="s">"La ruta de acceso contiene un car\u00E1cter no v\u00E1lido: {0}"</span><span class="o">},</span></span>
...
<span id="LC272" class="line" lang="java">       <span class="s">"No se puede definir un esquema a partir de una cadena nula"</span><span class="o">},</span></span>
...
<span id="LC275" class="line" lang="java">       <span class="s">"El esquema no es v\u00E1lido."</span><span class="o">},</span></span>
...
<span id="LC278" class="line" lang="java">       <span class="s">"El formato de la direcci\u00F3n de host no es correcto"</span><span class="o">},</span></span>
...
<span id="LC281" class="line" lang="java">       <span class="s">"No se puede definir el puerto si el host es nulo"</span><span class="o">},</span></span>
...
<span id="LC284" class="line" lang="java">       <span class="s">"N\u00FAmero de puerto no v\u00E1lido"</span><span class="o">},</span></span>
...
<span id="LC287" class="line" lang="java">       <span class="s">"S\u00F3lo se puede definir el fragmento para un URI gen\u00E9rico"</span><span class="o">},</span></span>
...
<span id="LC290" class="line" lang="java">       <span class="s">"No se puede definir el fragmento si la ruta de acceso es nula"</span><span class="o">},</span></span>
...
<span id="LC293" class="line" lang="java">       <span class="s">"El fragmento contiene un car\u00E1cter no v\u00E1lido"</span><span class="o">},</span></span>
...
<span id="LC296" class="line" lang="java">      <span class="s">"El analizador ya se est\u00E1 utilizando"</span><span class="o">},</span></span>
...
<span id="LC299" class="line" lang="java">      <span class="s">"No se puede cambiar {0} {1} durante el an\u00E1lisis"</span><span class="o">},</span></span>
...
<span id="LC302" class="line" lang="java">      <span class="s">"La autocausalidad no est\u00E1 permitida"</span><span class="o">},</span></span>
...
<span id="LC305" class="line" lang="java">      <span class="s">"No se puede especificar la informaci\u00F3n de usuario si no se ha especificado el host"</span><span class="o">},</span></span>
...
<span id="LC308" class="line" lang="java">      <span class="s">"No se puede especificar el puerto si no se ha especificado el host"</span><span class="o">},</span></span>
...
<span id="LC311" class="line" lang="java">      <span class="s">"No se puede especificar la cadena de consulta en la ruta de acceso y en la cadena de consulta"</span><span class="o">},</span></span>
...
<span id="LC314" class="line" lang="java">      <span class="s">"No se puede especificar el fragmento en la ruta de acceso y en el fragmento"</span><span class="o">},</span></span>
...
<span id="LC317" class="line" lang="java">      <span class="s">"No se puede inicializar el URI con par\u00E1metros vac\u00EDos"</span><span class="o">},</span></span>
...
<span id="LC320" class="line" lang="java">      <span class="s">"M\u00E9todo no soportado a\u00FAn "</span><span class="o">},</span></span>
...
<span id="LC323" class="line" lang="java">      <span class="s">"IncrementalSAXSource_Filter no se puede reiniciar actualmente"</span><span class="o">},</span></span>
...
<span id="LC326" class="line" lang="java">      <span class="s">"XMLReader no anterior a la solicitud startParse"</span><span class="o">},</span></span>
...
<span id="LC329" class="line" lang="java">      <span class="s">"Traverser de eje no soportado: {0}"</span><span class="o">},</span></span>
...
<span id="LC332" class="line" lang="java">      <span class="s">"ListingErrorHandler se ha creado con un valor de PrintWriter nulo"</span><span class="o">},</span></span>
...
<span id="LC335" class="line" lang="java">      <span class="s">"Identificador de Sistema Desconocido"</span><span class="o">},</span></span>
...
<span id="LC338" class="line" lang="java">      <span class="s">"Ubicaci\u00F3n del error desconocida"</span><span class="o">},</span></span>
...
<span id="LC341" class="line" lang="java">      <span class="s">"El prefijo se debe resolver en un espacio de nombres: {0}"</span><span class="o">},</span></span>
...
<span id="LC344" class="line" lang="java">      <span class="s">"createDocument() no soportado en XPathContext"</span><span class="o">},</span></span>
...
<span id="LC347" class="line" lang="java">      <span class="s">"El atributo child no tiene un documento de propietario."</span><span class="o">},</span></span>
...
<span id="LC350" class="line" lang="java">      <span class="s">"El atributo child no tiene un elemento de documento de propietario."</span><span class="o">},</span></span>
...
<span id="LC353" class="line" lang="java">      <span class="s">"Advertencia: no se puede realizar la salida de texto antes del elemento del documento. Ignorando..."</span><span class="o">},</span></span>
...
<span id="LC356" class="line" lang="java">      <span class="s">"No se puede tener m\u00E1s de una ra\u00EDz en un DOM."</span><span class="o">},</span></span>
...
<span id="LC359" class="line" lang="java">       <span class="s">"El argumento 'localName' es nulo"</span><span class="o">},</span></span>
...
<span id="LC365" class="line" lang="java">       <span class="s">"El nombre local de QNAME debe ser un NCName v\u00E1lido"</span><span class="o">},</span></span>
...
<span id="LC371" class="line" lang="java">       <span class="s">"El prefijo de QNAME debe ser un NCName v\u00E1lido"</span><span class="o">},</span></span>
...
<span id="LC374" class="line" lang="java">      <span class="s">"El nombre no puede empezar con dos puntos"</span><span class="o">},</span></span>
<span id="LC375" class="line" lang="java"></span>
<span id="LC376" class="line" lang="java">    <span class="o">{</span> <span class="s">"BAD_CODE"</span><span class="o">,</span> <span class="s">"El par\u00E1metro para crear un mensaje est\u00E1 fuera de los l\u00EDmites"</span><span class="o">},</span></span>
<span id="LC377" class="line" lang="java">    <span class="o">{</span> <span class="s">"FORMAT_FAILED"</span><span class="o">,</span> <span class="s">"Se ha emitido una excepci\u00F3n durante la llamada a messageFormat"</span><span class="o">},</span></span>
<span id="LC378" class="line" lang="java">    <span class="o">{</span> <span class="s">"line"</span><span class="o">,</span> <span class="s">"N\u00BA de L\u00EDnea"</span><span class="o">},</span></span>
<span id="LC379" class="line" lang="java">    <span class="o">{</span> <span class="s">"column"</span><span class="o">,</span><span class="s">"N\u00BA de Columna"</span><span class="o">},</span></span>
...
<span id="LC382" class="line" lang="java">      <span class="s">"La clase de serializador ''{0}'' no implanta org.xml.sax.ContentHandler."</span><span class="o">},</span></span>
...
<span id="LC385" class="line" lang="java">      <span class="s">"No se ha encontrado el recurso [ {0} ].\n {1}"</span> <span class="o">},</span></span>
...
<span id="LC388" class="line" lang="java">      <span class="s">"No se ha podido cargar el recurso [ {0} ]: {1} \n {2} \t {3}"</span> <span class="o">},</span></span>
...
<span id="LC391" class="line" lang="java">      <span class="s">"Tama\u00F1o de buffer menor o igual que 0"</span> <span class="o">},</span></span>
...
<span id="LC394" class="line" lang="java">      <span class="s">"\u00BFSe ha detectado un sustituto UTF-16 no v\u00E1lido: {0}?"</span> <span class="o">},</span></span>
...
<span id="LC397" class="line" lang="java">      <span class="s">"Error de ES"</span> <span class="o">},</span></span>
...
<span id="LC400" class="line" lang="java">      <span class="s">"No se puede agregar el atributo {0} despu\u00E9s de nodos secundarios o antes de que se produzca un elemento. Se ignorar\u00E1 el atributo."</span><span class="o">},</span></span>
...
<span id="LC408" class="line" lang="java">      <span class="s">"No se ha declarado el espacio de nombres para el prefijo ''{0}''."</span> <span class="o">},</span></span>
...
<span id="LC416" class="line" lang="java">      <span class="s">"El atributo ''{0}'' est\u00E1 fuera del elemento."</span> <span class="o">},</span></span>
...
<span id="LC426" class="line" lang="java">      <span class="s">"Declaraci\u00F3n del espacio de nombres ''{0}''=''{1}'' fuera del elemento."</span> <span class="o">},</span></span>
...
<span id="LC429" class="line" lang="java">      <span class="s">"No se ha podido cargar ''{0}'' (compruebe la CLASSPATH), ahora s\u00F3lo se est\u00E1n utilizando los valores por defecto"</span><span class="o">},</span></span>
...
<span id="LC432" class="line" lang="java">       <span class="s">"Intento de realizar la salida del car\u00E1cter del valor integral {0}, que no est\u00E1 representado en la codificaci\u00F3n de salida de {1}."</span><span class="o">},</span></span>
...
<span id="LC435" class="line" lang="java">      <span class="s">"No se ha podido cargar el archivo de propiedades ''{0}'' para el m\u00E9todo de salida ''{1}'' (compruebe la CLASSPATH)"</span> <span class="o">}</span></span>
