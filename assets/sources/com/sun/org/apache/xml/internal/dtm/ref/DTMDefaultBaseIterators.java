...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: DTMDefaultBaseIterators.java,v 1.2.4.1 2005/09/15 08:15:00 suresh_emailid Exp $</span></span>
...
<span id="LC27" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.transform.Source</span><span class="o">;</span></span>
<span id="LC28" class="line" lang="java"></span>
<span id="LC29" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.utils.XMLStringFactory</span><span class="o">;</span></span>
<span id="LC30" class="line" lang="java"></span>
<span id="LC31" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.res.XMLErrorResources</span><span class="o">;</span></span>
<span id="LC32" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.res.XMLMessages</span><span class="o">;</span></span>
<span id="LC33" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xalan.internal.xsltc.dom.NodeCounter</span><span class="o">;</span></span>
<span id="LC34" class="line" lang="java"></span>
<span id="LC35" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC36" class="line" lang="java"><span class="cm"> * This class implements the traversers for DTMDefaultBase.</span></span>
<span id="LC37" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC38" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">DTMDefaultBaseIterators</span> <span class="kd">extends</span> <span class="nc">DTMDefaultBaseTraversers</span></span>
...
<span id="LC42" class="line" lang="java"><span class="cm">   * Construct a DTMDefaultBaseTraversers object from a DOM node.</span></span>
<span id="LC43" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC44" class="line" lang="java"><span class="cm">   * @param mgr The DTMManager who owns this DTM.</span></span>
<span id="LC45" class="line" lang="java"><span class="cm">   * @param source The object that is used to specify the construction source.</span></span>
<span id="LC46" class="line" lang="java"><span class="cm">   * @param dtmIdentity The DTM identity ID for this DTM.</span></span>
<span id="LC47" class="line" lang="java"><span class="cm">   * @param whiteSpaceFilter The white space filter for this DTM, which may</span></span>
<span id="LC48" class="line" lang="java"><span class="cm">   *                         be null.</span></span>
<span id="LC49" class="line" lang="java"><span class="cm">   * @param xstringfactory The factory to use for creating XMLStrings.</span></span>
<span id="LC50" class="line" lang="java"><span class="cm">   * @param doIndexing true if the caller considers it worth it to use</span></span>
<span id="LC51" class="line" lang="java"><span class="cm">   *                   indexing schemes.</span></span>
<span id="LC52" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC53" class="line" lang="java">  <span class="kd">public</span> <span class="nf">DTMDefaultBaseIterators</span><span class="o">(</span><span class="nc">DTMManager</span> <span class="n">mgr</span><span class="o">,</span> <span class="nc">Source</span> <span class="n">source</span><span class="o">,</span></span>
<span id="LC54" class="line" lang="java">                                 <span class="kt">int</span> <span class="n">dtmIdentity</span><span class="o">,</span></span>
<span id="LC55" class="line" lang="java">                                 <span class="nc">DTMWSFilter</span> <span class="n">whiteSpaceFilter</span><span class="o">,</span></span>
<span id="LC56" class="line" lang="java">                                 <span class="nc">XMLStringFactory</span> <span class="n">xstringfactory</span><span class="o">,</span></span>
<span id="LC57" class="line" lang="java">                                 <span class="kt">boolean</span> <span class="n">doIndexing</span><span class="o">)</span></span>
<span id="LC58" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC59" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">mgr</span><span class="o">,</span> <span class="n">source</span><span class="o">,</span> <span class="n">dtmIdentity</span><span class="o">,</span> <span class="n">whiteSpaceFilter</span><span class="o">,</span></span>
<span id="LC60" class="line" lang="java">          <span class="n">xstringfactory</span><span class="o">,</span> <span class="n">doIndexing</span><span class="o">);</span></span>
...
<span id="LC64" class="line" lang="java"><span class="cm">   * Construct a DTMDefaultBaseTraversers object from a DOM node.</span></span>
<span id="LC65" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC66" class="line" lang="java"><span class="cm">   * @param mgr The DTMManager who owns this DTM.</span></span>
<span id="LC67" class="line" lang="java"><span class="cm">   * @param source The object that is used to specify the construction source.</span></span>
<span id="LC68" class="line" lang="java"><span class="cm">   * @param dtmIdentity The DTM identity ID for this DTM.</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">   * @param whiteSpaceFilter The white space filter for this DTM, which may</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">   *                         be null.</span></span>
<span id="LC71" class="line" lang="java"><span class="cm">   * @param xstringfactory The factory to use for creating XMLStrings.</span></span>
<span id="LC72" class="line" lang="java"><span class="cm">   * @param doIndexing true if the caller considers it worth it to use</span></span>
<span id="LC73" class="line" lang="java"><span class="cm">   *                   indexing schemes.</span></span>
<span id="LC74" class="line" lang="java"><span class="cm">   * @param blocksize The block size of the DTM.</span></span>
<span id="LC75" class="line" lang="java"><span class="cm">   * @param usePrevsib true if we want to build the previous sibling node array.</span></span>
<span id="LC76" class="line" lang="java"><span class="cm">   * @param newNameTable true if we want to use a new ExpandedNameTable for this DTM.</span></span>
<span id="LC77" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC78" class="line" lang="java">  <span class="kd">public</span> <span class="nf">DTMDefaultBaseIterators</span><span class="o">(</span><span class="nc">DTMManager</span> <span class="n">mgr</span><span class="o">,</span> <span class="nc">Source</span> <span class="n">source</span><span class="o">,</span></span>
<span id="LC79" class="line" lang="java">                                 <span class="kt">int</span> <span class="n">dtmIdentity</span><span class="o">,</span></span>
<span id="LC80" class="line" lang="java">                                 <span class="nc">DTMWSFilter</span> <span class="n">whiteSpaceFilter</span><span class="o">,</span></span>
<span id="LC81" class="line" lang="java">                                 <span class="nc">XMLStringFactory</span> <span class="n">xstringfactory</span><span class="o">,</span></span>
<span id="LC82" class="line" lang="java">                                 <span class="kt">boolean</span> <span class="n">doIndexing</span><span class="o">,</span></span>
<span id="LC83" class="line" lang="java">                                 <span class="kt">int</span> <span class="n">blocksize</span><span class="o">,</span></span>
<span id="LC84" class="line" lang="java">                                 <span class="kt">boolean</span> <span class="n">usePrevsib</span><span class="o">,</span></span>
<span id="LC85" class="line" lang="java">                                 <span class="kt">boolean</span> <span class="n">newNameTable</span><span class="o">)</span></span>
<span id="LC86" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC87" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">mgr</span><span class="o">,</span> <span class="n">source</span><span class="o">,</span> <span class="n">dtmIdentity</span><span class="o">,</span> <span class="n">whiteSpaceFilter</span><span class="o">,</span></span>
<span id="LC88" class="line" lang="java">          <span class="n">xstringfactory</span><span class="o">,</span> <span class="n">doIndexing</span><span class="o">,</span> <span class="n">blocksize</span><span class="o">,</span> <span class="n">usePrevsib</span><span class="o">,</span> <span class="n">newNameTable</span><span class="o">);</span></span>
...
<span id="LC92" class="line" lang="java"><span class="cm">   * Get an iterator that can navigate over an XPath Axis, predicated by</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">   * the extended type ID.</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">   * Returns an iterator that must be initialized</span></span>
<span id="LC95" class="line" lang="java"><span class="cm">   * with a start node (using iterator.setStartNode()).</span></span>
<span id="LC96" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC97" class="line" lang="java"><span class="cm">   * @param axis One of Axes.ANCESTORORSELF, etc.</span></span>
<span id="LC98" class="line" lang="java"><span class="cm">   * @param type An extended type ID.</span></span>
<span id="LC99" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC100" class="line" lang="java"><span class="cm">   * @return A DTMAxisIterator, or null if the given axis isn't supported.</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC102" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">getTypedAxisIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">axis</span><span class="o">,</span> <span class="kt">int</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC103" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC104" class="line" lang="java"></span>
<span id="LC105" class="line" lang="java">    <span class="nc">DTMAxisIterator</span> <span class="n">iterator</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC106" class="line" lang="java"></span>
<span id="LC107" class="line" lang="java">    <span class="cm">/* This causes an error when using patterns for elements that</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">       do not exist in the DOM (translet types which do not correspond</span></span>
<span id="LC109" class="line" lang="java"><span class="cm">       to a DOM type are mapped to the DOM.ELEMENT type).</span></span>
<span id="LC110" class="line" lang="java"><span class="cm">    */</span></span>
<span id="LC111" class="line" lang="java"></span>
<span id="LC112" class="line" lang="java">    <span class="c1">//        if (type == NO_TYPE) {</span></span>
<span id="LC113" class="line" lang="java">    <span class="c1">//            return(EMPTYITERATOR);</span></span>
<span id="LC114" class="line" lang="java">    <span class="c1">//        }</span></span>
<span id="LC115" class="line" lang="java">    <span class="c1">//        else if (type == ELEMENT) {</span></span>
<span id="LC116" class="line" lang="java">    <span class="c1">//            iterator = new FilterIterator(getAxisIterator(axis),</span></span>
<span id="LC117" class="line" lang="java">    <span class="c1">//                                          getElementFilter());</span></span>
<span id="LC118" class="line" lang="java">    <span class="c1">//        }</span></span>
<span id="LC119" class="line" lang="java">    <span class="c1">//        else</span></span>
<span id="LC120" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC121" class="line" lang="java">      <span class="k">switch</span> <span class="o">(</span><span class="n">axis</span><span class="o">)</span></span>
<span id="LC122" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC123" class="line" lang="java">      <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">SELF</span> <span class="o">:</span></span>
<span id="LC124" class="line" lang="java">        <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">TypedSingletonIterator</span><span class="o">(</span><span class="n">type</span><span class="o">);</span></span>
<span id="LC125" class="line" lang="java">        <span class="k">break</span><span class="o">;</span></span>
<span id="LC126" class="line" lang="java">      <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">CHILD</span> <span class="o">:</span></span>
<span id="LC127" class="line" lang="java">        <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">TypedChildrenIterator</span><span class="o">(</span><span class="n">type</span><span class="o">);</span></span>
<span id="LC128" class="line" lang="java">        <span class="k">break</span><span class="o">;</span></span>
<span id="LC129" class="line" lang="java">      <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">PARENT</span> <span class="o">:</span></span>
<span id="LC130" class="line" lang="java">        <span class="k">return</span> <span class="o">(</span><span class="k">new</span> <span class="nc">ParentIterator</span><span class="o">().</span><span class="na">setNodeType</span><span class="o">(</span><span class="n">type</span><span class="o">));</span></span>
<span id="LC131" class="line" lang="java">      <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">ANCESTOR</span> <span class="o">:</span></span>
<span id="LC132" class="line" lang="java">        <span class="k">return</span> <span class="o">(</span><span class="k">new</span> <span class="nc">TypedAncestorIterator</span><span class="o">(</span><span class="n">type</span><span class="o">));</span></span>
<span id="LC133" class="line" lang="java">      <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">ANCESTORORSELF</span> <span class="o">:</span></span>
<span id="LC134" class="line" lang="java">        <span class="k">return</span> <span class="o">((</span><span class="k">new</span> <span class="nc">TypedAncestorIterator</span><span class="o">(</span><span class="n">type</span><span class="o">)).</span><span class="na">includeSelf</span><span class="o">());</span></span>
<span id="LC135" class="line" lang="java">      <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">ATTRIBUTE</span> <span class="o">:</span></span>
<span id="LC136" class="line" lang="java">        <span class="k">return</span> <span class="o">(</span><span class="k">new</span> <span class="nc">TypedAttributeIterator</span><span class="o">(</span><span class="n">type</span><span class="o">));</span></span>
<span id="LC137" class="line" lang="java">      <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">DESCENDANT</span> <span class="o">:</span></span>
<span id="LC138" class="line" lang="java">        <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">TypedDescendantIterator</span><span class="o">(</span><span class="n">type</span><span class="o">);</span></span>
<span id="LC139" class="line" lang="java">        <span class="k">break</span><span class="o">;</span></span>
<span id="LC140" class="line" lang="java">      <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">DESCENDANTORSELF</span> <span class="o">:</span></span>
<span id="LC141" class="line" lang="java">        <span class="n">iterator</span> <span class="o">=</span> <span class="o">(</span><span class="k">new</span> <span class="nc">TypedDescendantIterator</span><span class="o">(</span><span class="n">type</span><span class="o">)).</span><span class="na">includeSelf</span><span class="o">();</span></span>
<span id="LC142" class="line" lang="java">        <span class="k">break</span><span class="o">;</span></span>
<span id="LC143" class="line" lang="java">      <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">FOLLOWING</span> <span class="o">:</span></span>
<span id="LC144" class="line" lang="java">        <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">TypedFollowingIterator</span><span class="o">(</span><span class="n">type</span><span class="o">);</span></span>
<span id="LC145" class="line" lang="java">        <span class="k">break</span><span class="o">;</span></span>
<span id="LC146" class="line" lang="java">      <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">PRECEDING</span> <span class="o">:</span></span>
<span id="LC147" class="line" lang="java">        <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">TypedPrecedingIterator</span><span class="o">(</span><span class="n">type</span><span class="o">);</span></span>
<span id="LC148" class="line" lang="java">        <span class="k">break</span><span class="o">;</span></span>
<span id="LC149" class="line" lang="java">      <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">FOLLOWINGSIBLING</span> <span class="o">:</span></span>
<span id="LC150" class="line" lang="java">        <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">TypedFollowingSiblingIterator</span><span class="o">(</span><span class="n">type</span><span class="o">);</span></span>
<span id="LC151" class="line" lang="java">        <span class="k">break</span><span class="o">;</span></span>
<span id="LC152" class="line" lang="java">      <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">PRECEDINGSIBLING</span> <span class="o">:</span></span>
<span id="LC153" class="line" lang="java">        <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">TypedPrecedingSiblingIterator</span><span class="o">(</span><span class="n">type</span><span class="o">);</span></span>
<span id="LC154" class="line" lang="java">        <span class="k">break</span><span class="o">;</span></span>
<span id="LC155" class="line" lang="java">      <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">NAMESPACE</span> <span class="o">:</span></span>
<span id="LC156" class="line" lang="java">        <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">TypedNamespaceIterator</span><span class="o">(</span><span class="n">type</span><span class="o">);</span></span>
<span id="LC157" class="line" lang="java">        <span class="k">break</span><span class="o">;</span></span>
<span id="LC158" class="line" lang="java">      <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">ROOT</span> <span class="o">:</span></span>
<span id="LC159" class="line" lang="java">        <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">TypedRootIterator</span><span class="o">(</span><span class="n">type</span><span class="o">);</span></span>
<span id="LC160" class="line" lang="java">        <span class="k">break</span><span class="o">;</span></span>
<span id="LC161" class="line" lang="java">      <span class="k">default</span> <span class="o">:</span></span>
<span id="LC162" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">DTMException</span><span class="o">(</span><span class="nc">XMLMessages</span><span class="o">.</span><span class="na">createXMLMessage</span><span class="o">(</span></span>
<span id="LC163" class="line" lang="java">            <span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_TYPED_ITERATOR_AXIS_NOT_IMPLEMENTED</span><span class="o">,</span></span>
<span id="LC164" class="line" lang="java">            <span class="k">new</span> <span class="nc">Object</span><span class="o">[]{</span><span class="nc">Axis</span><span class="o">.</span><span class="na">getNames</span><span class="o">(</span><span class="n">axis</span><span class="o">)}));</span></span>
<span id="LC165" class="line" lang="java">            <span class="c1">//"Error: typed iterator for axis "</span></span>
<span id="LC166" class="line" lang="java">                               <span class="c1">//+ Axis.names[axis] + "not implemented");</span></span>
...
<span id="LC170" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">iterator</span><span class="o">);</span></span>
...
<span id="LC174" class="line" lang="java"><span class="cm">   * This is a shortcut to the iterators that implement the</span></span>
<span id="LC175" class="line" lang="java"><span class="cm">   * XPath axes.</span></span>
<span id="LC176" class="line" lang="java"><span class="cm">   * Returns a bare-bones iterator that must be initialized</span></span>
<span id="LC177" class="line" lang="java"><span class="cm">   * with a start node (using iterator.setStartNode()).</span></span>
<span id="LC178" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC179" class="line" lang="java"><span class="cm">   * @param axis One of Axes.ANCESTORORSELF, etc.</span></span>
<span id="LC180" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC181" class="line" lang="java"><span class="cm">   * @return A DTMAxisIterator, or null if the given axis isn't supported.</span></span>
<span id="LC182" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC183" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">getAxisIterator</span><span class="o">(</span><span class="kd">final</span> <span class="kt">int</span> <span class="n">axis</span><span class="o">)</span></span>
<span id="LC184" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC185" class="line" lang="java"></span>
<span id="LC186" class="line" lang="java">    <span class="nc">DTMAxisIterator</span> <span class="n">iterator</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC187" class="line" lang="java"></span>
<span id="LC188" class="line" lang="java">    <span class="k">switch</span> <span class="o">(</span><span class="n">axis</span><span class="o">)</span></span>
<span id="LC189" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC190" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">SELF</span> <span class="o">:</span></span>
<span id="LC191" class="line" lang="java">      <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">SingletonIterator</span><span class="o">();</span></span>
<span id="LC192" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC193" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">CHILD</span> <span class="o">:</span></span>
<span id="LC194" class="line" lang="java">      <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">ChildrenIterator</span><span class="o">();</span></span>
<span id="LC195" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC196" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">PARENT</span> <span class="o">:</span></span>
<span id="LC197" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="k">new</span> <span class="nc">ParentIterator</span><span class="o">());</span></span>
<span id="LC198" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">ANCESTOR</span> <span class="o">:</span></span>
<span id="LC199" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="k">new</span> <span class="nc">AncestorIterator</span><span class="o">());</span></span>
<span id="LC200" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">ANCESTORORSELF</span> <span class="o">:</span></span>
<span id="LC201" class="line" lang="java">      <span class="k">return</span> <span class="o">((</span><span class="k">new</span> <span class="nc">AncestorIterator</span><span class="o">()).</span><span class="na">includeSelf</span><span class="o">());</span></span>
<span id="LC202" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">ATTRIBUTE</span> <span class="o">:</span></span>
<span id="LC203" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="k">new</span> <span class="nc">AttributeIterator</span><span class="o">());</span></span>
<span id="LC204" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">DESCENDANT</span> <span class="o">:</span></span>
<span id="LC205" class="line" lang="java">      <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DescendantIterator</span><span class="o">();</span></span>
<span id="LC206" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC207" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">DESCENDANTORSELF</span> <span class="o">:</span></span>
<span id="LC208" class="line" lang="java">      <span class="n">iterator</span> <span class="o">=</span> <span class="o">(</span><span class="k">new</span> <span class="nc">DescendantIterator</span><span class="o">()).</span><span class="na">includeSelf</span><span class="o">();</span></span>
<span id="LC209" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC210" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">FOLLOWING</span> <span class="o">:</span></span>
<span id="LC211" class="line" lang="java">      <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">FollowingIterator</span><span class="o">();</span></span>
<span id="LC212" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC213" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">PRECEDING</span> <span class="o">:</span></span>
<span id="LC214" class="line" lang="java">      <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">PrecedingIterator</span><span class="o">();</span></span>
<span id="LC215" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC216" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">FOLLOWINGSIBLING</span> <span class="o">:</span></span>
<span id="LC217" class="line" lang="java">      <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">FollowingSiblingIterator</span><span class="o">();</span></span>
<span id="LC218" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC219" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">PRECEDINGSIBLING</span> <span class="o">:</span></span>
<span id="LC220" class="line" lang="java">      <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">PrecedingSiblingIterator</span><span class="o">();</span></span>
<span id="LC221" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC222" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">NAMESPACE</span> <span class="o">:</span></span>
<span id="LC223" class="line" lang="java">      <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">NamespaceIterator</span><span class="o">();</span></span>
<span id="LC224" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC225" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">ROOT</span> <span class="o">:</span></span>
<span id="LC226" class="line" lang="java">      <span class="n">iterator</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">RootIterator</span><span class="o">();</span></span>
<span id="LC227" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC228" class="line" lang="java">    <span class="k">default</span> <span class="o">:</span></span>
<span id="LC229" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">DTMException</span><span class="o">(</span><span class="nc">XMLMessages</span><span class="o">.</span><span class="na">createXMLMessage</span><span class="o">(</span></span>
<span id="LC230" class="line" lang="java">        <span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_ITERATOR_AXIS_NOT_IMPLEMENTED</span><span class="o">,</span></span>
<span id="LC231" class="line" lang="java">        <span class="k">new</span> <span class="nc">Object</span><span class="o">[]{</span><span class="nc">Axis</span><span class="o">.</span><span class="na">getNames</span><span class="o">(</span><span class="n">axis</span><span class="o">)}));</span></span>
<span id="LC232" class="line" lang="java">        <span class="c1">//"Error: iterator for axis '" + Axis.names[axis]</span></span>
<span id="LC233" class="line" lang="java">                             <span class="c1">//+ "' not implemented");</span></span>
<span id="LC234" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC235" class="line" lang="java"></span>
<span id="LC236" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">iterator</span><span class="o">);</span></span>
...
<span id="LC240" class="line" lang="java"><span class="cm">   * Abstract superclass defining behaviors shared by all DTMDefault's</span></span>
<span id="LC241" class="line" lang="java"><span class="cm">   * internal implementations of DTMAxisIterator. Subclass this (and</span></span>
<span id="LC242" class="line" lang="java"><span class="cm">   * override, if necessary) to implement the specifics of an</span></span>
<span id="LC243" class="line" lang="java"><span class="cm">   * individual axis iterator.</span></span>
<span id="LC244" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC245" class="line" lang="java"><span class="cm">   * Currently there isn't a lot here</span></span>
<span id="LC246" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC247" class="line" lang="java">  <span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">InternalAxisIteratorBase</span> <span class="kd">extends</span> <span class="nc">DTMAxisIteratorBase</span></span>
<span id="LC248" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC249" class="line" lang="java"></span>
<span id="LC250" class="line" lang="java">    <span class="c1">// %REVIEW% We could opt to share _nodeType and setNodeType() as</span></span>
<span id="LC251" class="line" lang="java">    <span class="c1">// well, and simply ignore them in iterators which don't use them.</span></span>
<span id="LC252" class="line" lang="java">    <span class="c1">// But Scott's worried about the overhead involved in cloning</span></span>
<span id="LC253" class="line" lang="java">    <span class="c1">// these, and wants them to have as few fields as possible. Note</span></span>
<span id="LC254" class="line" lang="java">    <span class="c1">// that we can't create a TypedInternalAxisIteratorBase because</span></span>
<span id="LC255" class="line" lang="java">    <span class="c1">// those are often based on the untyped versions and Java doesn't</span></span>
<span id="LC256" class="line" lang="java">    <span class="c1">// support multiple inheritance. &lt;sigh/&gt;</span></span>
<span id="LC257" class="line" lang="java"></span>
<span id="LC258" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC259" class="line" lang="java"><span class="cm">     * Current iteration location. Usually this is the last location</span></span>
<span id="LC260" class="line" lang="java"><span class="cm">     * returned (starting point for the next() search); for single-node</span></span>
<span id="LC261" class="line" lang="java"><span class="cm">     * iterators it may instead be initialized to point to that single node.</span></span>
<span id="LC262" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC263" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">int</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC264" class="line" lang="java"></span>
<span id="LC265" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC266" class="line" lang="java"><span class="cm">     * Remembers the current node for the next call to gotoMark().</span></span>
<span id="LC267" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC268" class="line" lang="java"><span class="cm">     * %REVIEW% Should this save _position too?</span></span>
<span id="LC269" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC270" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMark</span><span class="o">()</span></span>
<span id="LC271" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC272" class="line" lang="java">      <span class="n">_markedNode</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
...
<span id="LC276" class="line" lang="java"><span class="cm">     * Restores the current node remembered by setMark().</span></span>
<span id="LC277" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC278" class="line" lang="java"><span class="cm">     * %REVEIW% Should this restore _position too?</span></span>
<span id="LC279" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC280" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">gotoMark</span><span class="o">()</span></span>
<span id="LC281" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC282" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">_markedNode</span><span class="o">;</span></span>
<span id="LC283" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC284" class="line" lang="java"></span>
<span id="LC285" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of InternalAxisIteratorBase</span></span>
<span id="LC286" class="line" lang="java"></span>
<span id="LC287" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC288" class="line" lang="java"><span class="cm">   * Iterator that returns all immediate children of a given node</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC290" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">ChildrenIterator</span> <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
...
<span id="LC294" class="line" lang="java"><span class="cm">     * Setting start to END should 'close' the iterator,</span></span>
<span id="LC295" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC296" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC297" class="line" lang="java"><span class="cm">     * If the iterator is not restartable, this has no effect.</span></span>
<span id="LC298" class="line" lang="java"><span class="cm">     * %REVIEW% Should it return/throw something in that case,</span></span>
<span id="LC299" class="line" lang="java"><span class="cm">     * or set current node to END, to indicate request-not-honored?</span></span>
<span id="LC300" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC301" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC302" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC303" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC304" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC305" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC306" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC307" class="line" lang="java"><span class="c1">//%HZ%: Added reference to DTMDefaultBase.ROOTNODE back in, temporarily</span></span>
<span id="LC308" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="nc">DTMDefaultBase</span><span class="o">.</span><span class="na">ROOTNODE</span><span class="o">)</span></span>
<span id="LC309" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">getDocument</span><span class="o">();</span></span>
<span id="LC310" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC311" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC312" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC313" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span> <span class="o">?</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span></span>
<span id="LC314" class="line" lang="java">                                          <span class="o">:</span> <span class="n">_firstch</span><span class="o">(</span><span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">node</span><span class="o">));</span></span>
<span id="LC315" class="line" lang="java"></span>
<span id="LC316" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC317" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC318" class="line" lang="java"></span>
<span id="LC319" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC323" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC324" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC325" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END if no more</span></span>
<span id="LC326" class="line" lang="java"><span class="cm">     * are available.</span></span>
<span id="LC327" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC328" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC329" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC330" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_currentNode</span> <span class="o">!=</span> <span class="no">NULL</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC331" class="line" lang="java">        <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC332" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC333" class="line" lang="java">        <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">node</span><span class="o">));</span></span>
<span id="LC334" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC335" class="line" lang="java"></span>
<span id="LC336" class="line" lang="java">      <span class="k">return</span> <span class="no">END</span><span class="o">;</span></span>
<span id="LC337" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC338" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of ChildrenIterator</span></span>
<span id="LC339" class="line" lang="java"></span>
<span id="LC340" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">   * Iterator that returns the parent of a given node. Note that</span></span>
<span id="LC342" class="line" lang="java"><span class="cm">   * this delivers only a single node; if you want all the ancestors,</span></span>
<span id="LC343" class="line" lang="java"><span class="cm">   * see AncestorIterator.</span></span>
<span id="LC344" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC345" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">ParentIterator</span> <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
<span id="LC346" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC347" class="line" lang="java"></span>
<span id="LC348" class="line" lang="java">    <span class="cm">/** The extended type ID that was requested. */</span></span>
<span id="LC349" class="line" lang="java">    <span class="kd">private</span> <span class="kt">int</span> <span class="n">_nodeType</span> <span class="o">=</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC350" class="line" lang="java"></span>
<span id="LC351" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC352" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC353" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC354" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC355" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC356" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC357" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC358" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC359" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC360" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC361" class="line" lang="java"><span class="c1">//%HZ%: Added reference to DTMDefaultBase.ROOTNODE back in, temporarily</span></span>
<span id="LC362" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="nc">DTMDefaultBase</span><span class="o">.</span><span class="na">ROOTNODE</span><span class="o">)</span></span>
<span id="LC363" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">getDocument</span><span class="o">();</span></span>
<span id="LC364" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC365" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC366" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC367" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">getParent</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC368" class="line" lang="java"></span>
<span id="LC369" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC370" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC371" class="line" lang="java"></span>
<span id="LC372" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC376" class="line" lang="java"><span class="cm">     * Set the node type of the parent that we're looking for.</span></span>
<span id="LC377" class="line" lang="java"><span class="cm">     * Note that this does _not_ mean "find the nearest ancestor of</span></span>
<span id="LC378" class="line" lang="java"><span class="cm">     * this type", but "yield the parent if it is of this type".</span></span>
<span id="LC379" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC380" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC381" class="line" lang="java"><span class="cm">     * @param type extended type ID.</span></span>
<span id="LC382" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC383" class="line" lang="java"><span class="cm">     * @return ParentIterator configured with the type filter set.</span></span>
<span id="LC384" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC385" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setNodeType</span><span class="o">(</span><span class="kd">final</span> <span class="kt">int</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC386" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC387" class="line" lang="java"></span>
<span id="LC388" class="line" lang="java">      <span class="n">_nodeType</span> <span class="o">=</span> <span class="n">type</span><span class="o">;</span></span>
<span id="LC389" class="line" lang="java"></span>
<span id="LC390" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC394" class="line" lang="java"><span class="cm">     * Get the next node in the iteration. In this case, we return</span></span>
<span id="LC395" class="line" lang="java"><span class="cm">     * only the immediate parent, _if_ it matches the requested nodeType.</span></span>
<span id="LC396" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC397" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC398" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC399" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC400" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC401" class="line" lang="java">      <span class="kt">int</span> <span class="n">result</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC402" class="line" lang="java"></span>
<span id="LC403" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_nodeType</span> <span class="o">&gt;=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NTYPES</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC404" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">_nodeType</span> <span class="o">!=</span> <span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">_currentNode</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC405" class="line" lang="java">          <span class="n">result</span> <span class="o">=</span> <span class="no">END</span><span class="o">;</span></span>
<span id="LC406" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC407" class="line" lang="java">      <span class="o">}</span> <span class="k">else</span> <span class="k">if</span> <span class="o">(</span><span class="n">_nodeType</span> <span class="o">!=</span> <span class="no">NULL</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC408" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">_nodeType</span> <span class="o">!=</span> <span class="n">getNodeType</span><span class="o">(</span><span class="n">_currentNode</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC409" class="line" lang="java">          <span class="n">result</span> <span class="o">=</span> <span class="no">END</span><span class="o">;</span></span>
...
<span id="LC413" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="no">END</span><span class="o">;</span></span>
<span id="LC414" class="line" lang="java"></span>
<span id="LC415" class="line" lang="java">      <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">result</span><span class="o">);</span></span>
<span id="LC416" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC417" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of ParentIterator</span></span>
<span id="LC418" class="line" lang="java"></span>
<span id="LC419" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC420" class="line" lang="java"><span class="cm">   * Iterator that returns children of a given type for a given node.</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">   * The functionality chould be achieved by putting a filter on top</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">   * of a basic child iterator, but a specialised iterator is used</span></span>
<span id="LC423" class="line" lang="java"><span class="cm">   * for efficiency (both speed and size of translet).</span></span>
<span id="LC424" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC425" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">TypedChildrenIterator</span> <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
<span id="LC426" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC427" class="line" lang="java"></span>
<span id="LC428" class="line" lang="java">    <span class="cm">/** The extended type ID that was requested. */</span></span>
<span id="LC429" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">int</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC430" class="line" lang="java"></span>
<span id="LC431" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC432" class="line" lang="java"><span class="cm">     * Constructor TypedChildrenIterator</span></span>
<span id="LC433" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC434" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC435" class="line" lang="java"><span class="cm">     * @param nodeType The extended type ID being requested.</span></span>
<span id="LC436" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC437" class="line" lang="java">    <span class="kd">public</span> <span class="nf">TypedChildrenIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">nodeType</span><span class="o">)</span></span>
<span id="LC438" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC439" class="line" lang="java">      <span class="n">_nodeType</span> <span class="o">=</span> <span class="n">nodeType</span><span class="o">;</span></span>
...
<span id="LC443" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC444" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC445" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC446" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC447" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC448" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC449" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC450" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC451" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC452" class="line" lang="java"><span class="c1">//%HZ%: Added reference to DTMDefaultBase.ROOTNODE back in, temporarily</span></span>
<span id="LC453" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="nc">DTMDefaultBase</span><span class="o">.</span><span class="na">ROOTNODE</span><span class="o">)</span></span>
<span id="LC454" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">getDocument</span><span class="o">();</span></span>
<span id="LC455" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC456" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC457" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC458" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span></span>
<span id="LC459" class="line" lang="java">                                   <span class="o">?</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span></span>
<span id="LC460" class="line" lang="java">                                   <span class="o">:</span> <span class="n">_firstch</span><span class="o">(</span><span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">_startNode</span><span class="o">));</span></span>
<span id="LC461" class="line" lang="java"></span>
<span id="LC462" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
...
<span id="LC475" class="line" lang="java">      <span class="kt">int</span> <span class="n">eType</span><span class="o">;</span></span>
<span id="LC476" class="line" lang="java">      <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC477" class="line" lang="java"></span>
<span id="LC478" class="line" lang="java">      <span class="kt">int</span> <span class="n">nodeType</span> <span class="o">=</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC479" class="line" lang="java"></span>
<span id="LC480" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">nodeType</span> <span class="o">&gt;=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NTYPES</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC481" class="line" lang="java">        <span class="k">while</span> <span class="o">(</span><span class="n">node</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">&amp;&amp;</span> <span class="n">_exptype</span><span class="o">(</span><span class="n">node</span><span class="o">)</span> <span class="o">!=</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC482" class="line" lang="java">          <span class="n">node</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
...
<span id="LC485" class="line" lang="java">        <span class="k">while</span> <span class="o">(</span><span class="n">node</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC486" class="line" lang="java">          <span class="n">eType</span> <span class="o">=</span> <span class="n">_exptype</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC487" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="n">eType</span> <span class="o">&lt;</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NTYPES</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC488" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">eType</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC491" class="line" lang="java">          <span class="o">}</span> <span class="k">else</span> <span class="k">if</span> <span class="o">(</span><span class="n">m_expandedNameTable</span><span class="o">.</span><span class="na">getType</span><span class="o">(</span><span class="n">eType</span><span class="o">)</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC494" class="line" lang="java">          <span class="n">node</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
...
<span id="LC498" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC499" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC500" class="line" lang="java">        <span class="k">return</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC501" class="line" lang="java">      <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC502" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC503" class="line" lang="java">        <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">node</span><span class="o">));</span></span>
...
<span id="LC507" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of TypedChildrenIterator</span></span>
<span id="LC508" class="line" lang="java"></span>
<span id="LC509" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC510" class="line" lang="java"><span class="cm">   * Iterator that returns children within a given namespace for a</span></span>
<span id="LC511" class="line" lang="java"><span class="cm">   * given node. The functionality chould be achieved by putting a</span></span>
<span id="LC512" class="line" lang="java"><span class="cm">   * filter on top of a basic child iterator, but a specialised</span></span>
<span id="LC513" class="line" lang="java"><span class="cm">   * iterator is used for efficiency (both speed and size of translet).</span></span>
<span id="LC514" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC515" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">NamespaceChildrenIterator</span></span>
<span id="LC516" class="line" lang="java">          <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
<span id="LC517" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC518" class="line" lang="java"></span>
<span id="LC519" class="line" lang="java">    <span class="cm">/** The extended type ID being requested. */</span></span>
<span id="LC520" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">int</span> <span class="n">_nsType</span><span class="o">;</span></span>
<span id="LC521" class="line" lang="java"></span>
<span id="LC522" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC523" class="line" lang="java"><span class="cm">     * Constructor NamespaceChildrenIterator</span></span>
<span id="LC524" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC525" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC526" class="line" lang="java"><span class="cm">     * @param type The extended type ID being requested.</span></span>
<span id="LC527" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC528" class="line" lang="java">    <span class="kd">public</span> <span class="nf">NamespaceChildrenIterator</span><span class="o">(</span><span class="kd">final</span> <span class="kt">int</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC529" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC530" class="line" lang="java">      <span class="n">_nsType</span> <span class="o">=</span> <span class="n">type</span><span class="o">;</span></span>
...
<span id="LC534" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC535" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC536" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC537" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC538" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC539" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC540" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC541" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC542" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC543" class="line" lang="java"><span class="c1">//%HZ%: Added reference to DTMDefaultBase.ROOTNODE back in, temporarily</span></span>
<span id="LC544" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="nc">DTMDefaultBase</span><span class="o">.</span><span class="na">ROOTNODE</span><span class="o">)</span></span>
<span id="LC545" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">getDocument</span><span class="o">();</span></span>
<span id="LC546" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC547" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC548" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC549" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span> <span class="o">?</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">:</span> <span class="no">NOTPROCESSED</span><span class="o">;</span></span>
<span id="LC550" class="line" lang="java"></span>
<span id="LC551" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC552" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC553" class="line" lang="java"></span>
<span id="LC554" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC558" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC559" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC560" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC561" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC562" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC563" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC564" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_currentNode</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC565" class="line" lang="java">        <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="o">(</span><span class="no">NOTPROCESSED</span> <span class="o">==</span> <span class="n">_currentNode</span><span class="o">)</span></span>
<span id="LC566" class="line" lang="java">                                  <span class="o">?</span> <span class="n">_firstch</span><span class="o">(</span><span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">_startNode</span><span class="o">))</span></span>
<span id="LC567" class="line" lang="java">                                  <span class="o">:</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">_currentNode</span><span class="o">);</span></span>
<span id="LC568" class="line" lang="java">             <span class="n">node</span> <span class="o">!=</span> <span class="no">END</span><span class="o">;</span></span>
<span id="LC569" class="line" lang="java">             <span class="n">node</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">node</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC570" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="n">m_expandedNameTable</span><span class="o">.</span><span class="na">getNamespaceID</span><span class="o">(</span><span class="n">_exptype</span><span class="o">(</span><span class="n">node</span><span class="o">))</span> <span class="o">==</span> <span class="n">_nsType</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC571" class="line" lang="java">            <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC572" class="line" lang="java"></span>
<span id="LC573" class="line" lang="java">            <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
...
<span id="LC578" class="line" lang="java">      <span class="k">return</span> <span class="no">END</span><span class="o">;</span></span>
<span id="LC579" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC580" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of NamespaceChildrenIterator</span></span>
<span id="LC581" class="line" lang="java"></span>
<span id="LC582" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC583" class="line" lang="java"><span class="cm">   * Iterator that returns the namespace nodes as defined by the XPath data model</span></span>
<span id="LC584" class="line" lang="java"><span class="cm">   * for a given node.</span></span>
<span id="LC585" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC586" class="line" lang="java">  <span class="kd">public</span> <span class="kd">class</span> <span class="nc">NamespaceIterator</span></span>
<span id="LC587" class="line" lang="java">          <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
...
<span id="LC591" class="line" lang="java"><span class="cm">     * Constructor NamespaceAttributeIterator</span></span>
<span id="LC592" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC593" class="line" lang="java">    <span class="kd">public</span> <span class="nf">NamespaceIterator</span><span class="o">()</span></span>
<span id="LC594" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC595" class="line" lang="java"></span>
<span id="LC596" class="line" lang="java">      <span class="kd">super</span><span class="o">();</span></span>
...
<span id="LC600" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC601" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC602" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC603" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC604" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC605" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC606" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC607" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC608" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC609" class="line" lang="java"><span class="c1">//%HZ%: Added reference to DTMDefaultBase.ROOTNODE back in, temporarily</span></span>
<span id="LC610" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="nc">DTMDefaultBase</span><span class="o">.</span><span class="na">ROOTNODE</span><span class="o">)</span></span>
<span id="LC611" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">getDocument</span><span class="o">();</span></span>
<span id="LC612" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC613" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC614" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC615" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">getFirstNamespaceNode</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="kc">true</span><span class="o">);</span></span>
<span id="LC616" class="line" lang="java"></span>
<span id="LC617" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC618" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC619" class="line" lang="java"></span>
<span id="LC620" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC624" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC625" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC626" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC627" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC628" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC629" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC630" class="line" lang="java"></span>
<span id="LC631" class="line" lang="java">      <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC632" class="line" lang="java"></span>
<span id="LC633" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC634" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">getNextNamespaceNode</span><span class="o">(</span><span class="n">_startNode</span><span class="o">,</span> <span class="n">node</span><span class="o">,</span> <span class="kc">true</span><span class="o">);</span></span>
<span id="LC635" class="line" lang="java"></span>
<span id="LC636" class="line" lang="java">      <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC637" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC638" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of NamespaceIterator</span></span>
<span id="LC639" class="line" lang="java"></span>
<span id="LC640" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC641" class="line" lang="java"><span class="cm">   * Iterator that returns the namespace nodes as defined by the XPath data model</span></span>
<span id="LC642" class="line" lang="java"><span class="cm">   * for a given node, filtered by extended type ID.</span></span>
<span id="LC643" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC644" class="line" lang="java">  <span class="kd">public</span> <span class="kd">class</span> <span class="nc">TypedNamespaceIterator</span> <span class="kd">extends</span> <span class="nc">NamespaceIterator</span></span>
<span id="LC645" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC646" class="line" lang="java"></span>
<span id="LC647" class="line" lang="java">    <span class="cm">/** The extended type ID that was requested. */</span></span>
<span id="LC648" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">int</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC649" class="line" lang="java"></span>
<span id="LC650" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC651" class="line" lang="java"><span class="cm">     * Constructor TypedNamespaceIterator</span></span>
<span id="LC652" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC653" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC654" class="line" lang="java"><span class="cm">     * @param nodeType The extended type ID being requested.</span></span>
<span id="LC655" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC656" class="line" lang="java">    <span class="kd">public</span> <span class="nf">TypedNamespaceIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">nodeType</span><span class="o">)</span></span>
<span id="LC657" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC658" class="line" lang="java">      <span class="kd">super</span><span class="o">();</span></span>
<span id="LC659" class="line" lang="java">      <span class="n">_nodeType</span> <span class="o">=</span> <span class="n">nodeType</span><span class="o">;</span></span>
...
<span id="LC663" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC664" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC665" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC666" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC667" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC668" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC669" class="line" lang="java">        <span class="kt">int</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC670" class="line" lang="java"></span>
<span id="LC671" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="n">node</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC672" class="line" lang="java">           <span class="n">node</span> <span class="o">!=</span> <span class="no">END</span><span class="o">;</span></span>
<span id="LC673" class="line" lang="java">           <span class="n">node</span> <span class="o">=</span> <span class="n">getNextNamespaceNode</span><span class="o">(</span><span class="n">_startNode</span><span class="o">,</span> <span class="n">node</span><span class="o">,</span> <span class="kc">true</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC674" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">node</span><span class="o">)</span> <span class="o">==</span> <span class="n">_nodeType</span></span>
<span id="LC675" class="line" lang="java">            <span class="o">||</span> <span class="n">getNodeType</span><span class="o">(</span><span class="n">node</span><span class="o">)</span> <span class="o">==</span> <span class="n">_nodeType</span></span>
<span id="LC676" class="line" lang="java">            <span class="o">||</span> <span class="n">getNamespaceType</span><span class="o">(</span><span class="n">node</span><span class="o">)</span> <span class="o">==</span> <span class="n">_nodeType</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC677" class="line" lang="java">          <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC678" class="line" lang="java"></span>
<span id="LC679" class="line" lang="java">          <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
...
<span id="LC683" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="n">_currentNode</span> <span class="o">=</span><span class="no">END</span><span class="o">);</span></span>
<span id="LC684" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC685" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of TypedNamespaceIterator</span></span>
<span id="LC686" class="line" lang="java"></span>
<span id="LC687" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC688" class="line" lang="java"><span class="cm">   * Iterator that returns the the root node as defined by the XPath data model</span></span>
<span id="LC689" class="line" lang="java"><span class="cm">   * for a given node.</span></span>
<span id="LC690" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC691" class="line" lang="java">  <span class="kd">public</span> <span class="kd">class</span> <span class="nc">RootIterator</span></span>
<span id="LC692" class="line" lang="java">          <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
...
<span id="LC696" class="line" lang="java"><span class="cm">     * Constructor RootIterator</span></span>
<span id="LC697" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC698" class="line" lang="java">    <span class="kd">public</span> <span class="nf">RootIterator</span><span class="o">()</span></span>
<span id="LC699" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC700" class="line" lang="java"></span>
<span id="LC701" class="line" lang="java">      <span class="kd">super</span><span class="o">();</span></span>
...
<span id="LC705" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC706" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC707" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC708" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC709" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC710" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC711" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC712" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC713" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC714" class="line" lang="java"></span>
<span id="LC715" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC716" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC717" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">getDocumentRoot</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC718" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC719" class="line" lang="java"></span>
<span id="LC720" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC721" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC722" class="line" lang="java"></span>
<span id="LC723" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC727" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC728" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC729" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC730" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC731" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC732" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC733" class="line" lang="java">      <span class="k">if</span><span class="o">(</span><span class="n">_startNode</span> <span class="o">==</span> <span class="n">_currentNode</span><span class="o">)</span></span>
<span id="LC734" class="line" lang="java">        <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC735" class="line" lang="java"></span>
<span id="LC736" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">_startNode</span><span class="o">;</span></span>
<span id="LC737" class="line" lang="java"></span>
<span id="LC738" class="line" lang="java">      <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">_startNode</span><span class="o">);</span></span>
<span id="LC739" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC740" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of RootIterator</span></span>
<span id="LC741" class="line" lang="java"></span>
<span id="LC742" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC743" class="line" lang="java"><span class="cm">   * Iterator that returns the namespace nodes as defined by the XPath data model</span></span>
<span id="LC744" class="line" lang="java"><span class="cm">   * for a given node, filtered by extended type ID.</span></span>
<span id="LC745" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC746" class="line" lang="java">  <span class="kd">public</span> <span class="kd">class</span> <span class="nc">TypedRootIterator</span> <span class="kd">extends</span> <span class="nc">RootIterator</span></span>
<span id="LC747" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC748" class="line" lang="java"></span>
<span id="LC749" class="line" lang="java">    <span class="cm">/** The extended type ID that was requested. */</span></span>
<span id="LC750" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">int</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC751" class="line" lang="java"></span>
<span id="LC752" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC753" class="line" lang="java"><span class="cm">     * Constructor TypedRootIterator</span></span>
<span id="LC754" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC755" class="line" lang="java"><span class="cm">     * @param nodeType The extended type ID being requested.</span></span>
<span id="LC756" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC757" class="line" lang="java">    <span class="kd">public</span> <span class="nf">TypedRootIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">nodeType</span><span class="o">)</span></span>
<span id="LC758" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC759" class="line" lang="java">      <span class="kd">super</span><span class="o">();</span></span>
<span id="LC760" class="line" lang="java">      <span class="n">_nodeType</span> <span class="o">=</span> <span class="n">nodeType</span><span class="o">;</span></span>
...
<span id="LC764" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC765" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC766" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC767" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC768" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC769" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC770" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">_startNode</span> <span class="o">==</span> <span class="n">_currentNode</span><span class="o">)</span></span>
<span id="LC771" class="line" lang="java">        <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC772" class="line" lang="java"></span>
<span id="LC773" class="line" lang="java">      <span class="kt">int</span> <span class="n">nodeType</span> <span class="o">=</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC774" class="line" lang="java">      <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">_startNode</span><span class="o">;</span></span>
<span id="LC775" class="line" lang="java">      <span class="kt">int</span> <span class="n">expType</span> <span class="o">=</span> <span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC776" class="line" lang="java"></span>
<span id="LC777" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC778" class="line" lang="java"></span>
<span id="LC779" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">nodeType</span> <span class="o">&gt;=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NTYPES</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC780" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">nodeType</span> <span class="o">==</span> <span class="n">expType</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC781" class="line" lang="java">          <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC782" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC783" class="line" lang="java">      <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC784" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">expType</span> <span class="o">&lt;</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NTYPES</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC785" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="n">expType</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC786" class="line" lang="java">            <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
...
<span id="LC789" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="n">m_expandedNameTable</span><span class="o">.</span><span class="na">getType</span><span class="o">(</span><span class="n">expType</span><span class="o">)</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC790" class="line" lang="java">            <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
...
<span id="LC795" class="line" lang="java">      <span class="k">return</span> <span class="no">END</span><span class="o">;</span></span>
<span id="LC796" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC797" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of TypedRootIterator</span></span>
<span id="LC798" class="line" lang="java"></span>
<span id="LC799" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC800" class="line" lang="java"><span class="cm">   * Iterator that returns attributes within a given namespace for a node.</span></span>
<span id="LC801" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC802" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">NamespaceAttributeIterator</span></span>
<span id="LC803" class="line" lang="java">          <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
<span id="LC804" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC805" class="line" lang="java"></span>
<span id="LC806" class="line" lang="java">    <span class="cm">/** The extended type ID being requested. */</span></span>
<span id="LC807" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">int</span> <span class="n">_nsType</span><span class="o">;</span></span>
<span id="LC808" class="line" lang="java"></span>
<span id="LC809" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC810" class="line" lang="java"><span class="cm">     * Constructor NamespaceAttributeIterator</span></span>
<span id="LC811" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC812" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC813" class="line" lang="java"><span class="cm">     * @param nsType The extended type ID being requested.</span></span>
<span id="LC814" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC815" class="line" lang="java">    <span class="kd">public</span> <span class="nf">NamespaceAttributeIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">nsType</span><span class="o">)</span></span>
<span id="LC816" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC817" class="line" lang="java"></span>
<span id="LC818" class="line" lang="java">      <span class="kd">super</span><span class="o">();</span></span>
<span id="LC819" class="line" lang="java"></span>
<span id="LC820" class="line" lang="java">      <span class="n">_nsType</span> <span class="o">=</span> <span class="n">nsType</span><span class="o">;</span></span>
...
<span id="LC824" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC825" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC826" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC827" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC828" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC829" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC830" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC831" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC832" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC833" class="line" lang="java"><span class="c1">//%HZ%: Added reference to DTMDefaultBase.ROOTNODE back in, temporarily</span></span>
<span id="LC834" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="nc">DTMDefaultBase</span><span class="o">.</span><span class="na">ROOTNODE</span><span class="o">)</span></span>
<span id="LC835" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">getDocument</span><span class="o">();</span></span>
<span id="LC836" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC837" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC838" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC839" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">getFirstNamespaceNode</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="kc">false</span><span class="o">);</span></span>
<span id="LC840" class="line" lang="java"></span>
<span id="LC841" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC842" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC843" class="line" lang="java"></span>
<span id="LC844" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC848" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC849" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC850" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC851" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC852" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC853" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC854" class="line" lang="java"></span>
<span id="LC855" class="line" lang="java">      <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC856" class="line" lang="java"></span>
<span id="LC857" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC858" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">getNextNamespaceNode</span><span class="o">(</span><span class="n">_startNode</span><span class="o">,</span> <span class="n">node</span><span class="o">,</span> <span class="kc">false</span><span class="o">);</span></span>
<span id="LC859" class="line" lang="java"></span>
<span id="LC860" class="line" lang="java">      <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC861" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC862" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of NamespaceAttributeIterator</span></span>
<span id="LC863" class="line" lang="java"></span>
<span id="LC864" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC865" class="line" lang="java"><span class="cm">   * Iterator that returns all siblings of a given node.</span></span>
<span id="LC866" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC867" class="line" lang="java">  <span class="kd">public</span> <span class="kd">class</span> <span class="nc">FollowingSiblingIterator</span> <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
...
<span id="LC871" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC872" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC873" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC874" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC875" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC876" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC877" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC878" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC879" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC880" class="line" lang="java"><span class="c1">//%HZ%: Added reference to DTMDefaultBase.ROOTNODE back in, temporarily</span></span>
<span id="LC881" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="nc">DTMDefaultBase</span><span class="o">.</span><span class="na">ROOTNODE</span><span class="o">)</span></span>
<span id="LC882" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">getDocument</span><span class="o">();</span></span>
<span id="LC883" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC884" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC885" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC886" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC887" class="line" lang="java"></span>
<span id="LC888" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC889" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC890" class="line" lang="java"></span>
<span id="LC891" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC895" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC896" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC897" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC898" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC899" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC900" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC901" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="o">(</span><span class="n">_currentNode</span> <span class="o">==</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span> <span class="o">?</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span></span>
<span id="LC902" class="line" lang="java">                                                <span class="o">:</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">_currentNode</span><span class="o">);</span></span>
<span id="LC903" class="line" lang="java">      <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">_currentNode</span><span class="o">));</span></span>
<span id="LC904" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC905" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of FollowingSiblingIterator</span></span>
<span id="LC906" class="line" lang="java"></span>
<span id="LC907" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC908" class="line" lang="java"><span class="cm">   * Iterator that returns all following siblings of a given node.</span></span>
<span id="LC909" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC910" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">TypedFollowingSiblingIterator</span></span>
<span id="LC911" class="line" lang="java">          <span class="kd">extends</span> <span class="nc">FollowingSiblingIterator</span></span>
<span id="LC912" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC913" class="line" lang="java"></span>
<span id="LC914" class="line" lang="java">    <span class="cm">/** The extended type ID that was requested. */</span></span>
<span id="LC915" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">int</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC916" class="line" lang="java"></span>
<span id="LC917" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC918" class="line" lang="java"><span class="cm">     * Constructor TypedFollowingSiblingIterator</span></span>
<span id="LC919" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC920" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC921" class="line" lang="java"><span class="cm">     * @param type The extended type ID being requested.</span></span>
<span id="LC922" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC923" class="line" lang="java">    <span class="kd">public</span> <span class="nf">TypedFollowingSiblingIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC924" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC925" class="line" lang="java">      <span class="n">_nodeType</span> <span class="o">=</span> <span class="n">type</span><span class="o">;</span></span>
...
<span id="LC929" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC930" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC931" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC932" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC933" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC934" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC935" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_currentNode</span> <span class="o">==</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC936" class="line" lang="java">        <span class="k">return</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC937" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC938" class="line" lang="java"></span>
<span id="LC939" class="line" lang="java">      <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC940" class="line" lang="java">      <span class="kt">int</span> <span class="n">eType</span><span class="o">;</span></span>
<span id="LC941" class="line" lang="java">      <span class="kt">int</span> <span class="n">nodeType</span> <span class="o">=</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC942" class="line" lang="java"></span>
<span id="LC943" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">nodeType</span> <span class="o">&gt;=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NTYPES</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC944" class="line" lang="java">        <span class="k">do</span> <span class="o">{</span></span>
<span id="LC945" class="line" lang="java">          <span class="n">node</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC946" class="line" lang="java">        <span class="o">}</span> <span class="k">while</span> <span class="o">(</span><span class="n">node</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">&amp;&amp;</span> <span class="n">_exptype</span><span class="o">(</span><span class="n">node</span><span class="o">)</span> <span class="o">!=</span> <span class="n">nodeType</span><span class="o">);</span></span>
<span id="LC947" class="line" lang="java">      <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC948" class="line" lang="java">        <span class="k">while</span> <span class="o">((</span><span class="n">node</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">node</span><span class="o">))</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC949" class="line" lang="java">          <span class="n">eType</span> <span class="o">=</span> <span class="n">_exptype</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC950" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="n">eType</span> <span class="o">&lt;</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NTYPES</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC951" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">eType</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC954" class="line" lang="java">          <span class="o">}</span> <span class="k">else</span> <span class="k">if</span> <span class="o">(</span><span class="n">m_expandedNameTable</span><span class="o">.</span><span class="na">getType</span><span class="o">(</span><span class="n">eType</span><span class="o">)</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC960" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC961" class="line" lang="java"></span>
<span id="LC962" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="n">_currentNode</span> <span class="o">==</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span></span>
<span id="LC963" class="line" lang="java">                      <span class="o">?</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span></span>
<span id="LC964" class="line" lang="java">                      <span class="o">:</span> <span class="n">returnNode</span><span class="o">(</span><span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">_currentNode</span><span class="o">));</span></span>
<span id="LC965" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC966" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of TypedFollowingSiblingIterator</span></span>
<span id="LC967" class="line" lang="java"></span>
<span id="LC968" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC969" class="line" lang="java"><span class="cm">   * Iterator that returns attribute nodes (of what nodes?)</span></span>
<span id="LC970" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC971" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">AttributeIterator</span> <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
<span id="LC972" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC973" class="line" lang="java"></span>
<span id="LC974" class="line" lang="java">    <span class="c1">// assumes caller will pass element nodes</span></span>
<span id="LC975" class="line" lang="java"></span>
<span id="LC976" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC977" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC978" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC979" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC980" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC981" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC982" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC983" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC984" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC985" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC986" class="line" lang="java"><span class="c1">//%HZ%: Added reference to DTMDefaultBase.ROOTNODE back in, temporarily</span></span>
<span id="LC987" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="nc">DTMDefaultBase</span><span class="o">.</span><span class="na">ROOTNODE</span><span class="o">)</span></span>
<span id="LC988" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">getDocument</span><span class="o">();</span></span>
<span id="LC989" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC990" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC991" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC992" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">getFirstAttributeIdentity</span><span class="o">(</span><span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">node</span><span class="o">));</span></span>
<span id="LC993" class="line" lang="java"></span>
<span id="LC994" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC995" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC996" class="line" lang="java"></span>
<span id="LC997" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC1001" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC1002" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1003" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC1004" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1005" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC1006" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1007" class="line" lang="java"></span>
<span id="LC1008" class="line" lang="java">      <span class="kd">final</span> <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC1009" class="line" lang="java"></span>
<span id="LC1010" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">!=</span> <span class="no">NULL</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1011" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">getNextAttributeIdentity</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1012" class="line" lang="java">        <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">node</span><span class="o">));</span></span>
<span id="LC1013" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1014" class="line" lang="java"></span>
<span id="LC1015" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC1016" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1017" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of AttributeIterator</span></span>
<span id="LC1018" class="line" lang="java"></span>
<span id="LC1019" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC1020" class="line" lang="java"><span class="cm">   * Iterator that returns attribute nodes of a given type</span></span>
<span id="LC1021" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1022" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">TypedAttributeIterator</span> <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
<span id="LC1023" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1024" class="line" lang="java"></span>
<span id="LC1025" class="line" lang="java">    <span class="cm">/** The extended type ID that was requested. */</span></span>
<span id="LC1026" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">int</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC1027" class="line" lang="java"></span>
<span id="LC1028" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1029" class="line" lang="java"><span class="cm">     * Constructor TypedAttributeIterator</span></span>
<span id="LC1030" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1031" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1032" class="line" lang="java"><span class="cm">     * @param nodeType The extended type ID that is requested.</span></span>
<span id="LC1033" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1034" class="line" lang="java">    <span class="kd">public</span> <span class="nf">TypedAttributeIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">nodeType</span><span class="o">)</span></span>
<span id="LC1035" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1036" class="line" lang="java">      <span class="n">_nodeType</span> <span class="o">=</span> <span class="n">nodeType</span><span class="o">;</span></span>
<span id="LC1037" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1038" class="line" lang="java"></span>
<span id="LC1039" class="line" lang="java">    <span class="c1">// assumes caller will pass element nodes</span></span>
<span id="LC1040" class="line" lang="java"></span>
<span id="LC1041" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1042" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC1043" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC1044" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1045" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC1046" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1047" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC1048" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1049" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC1050" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1051" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC1052" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1053" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1054" class="line" lang="java"></span>
<span id="LC1055" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">getTypedAttribute</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="n">_nodeType</span><span class="o">);</span></span>
<span id="LC1056" class="line" lang="java"></span>
<span id="LC1057" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC1058" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1059" class="line" lang="java"></span>
<span id="LC1060" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC1064" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC1065" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1066" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC1067" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1068" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC1069" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1070" class="line" lang="java"></span>
<span id="LC1071" class="line" lang="java">      <span class="kd">final</span> <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC1072" class="line" lang="java"></span>
<span id="LC1073" class="line" lang="java">      <span class="c1">// singleton iterator, since there can only be one attribute of</span></span>
<span id="LC1074" class="line" lang="java">      <span class="c1">// a given type.</span></span>
<span id="LC1075" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC1076" class="line" lang="java"></span>
<span id="LC1077" class="line" lang="java">      <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1078" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1079" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of TypedAttributeIterator</span></span>
<span id="LC1080" class="line" lang="java"></span>
<span id="LC1081" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC1082" class="line" lang="java"><span class="cm">   * Iterator that returns preceding siblings of a given node</span></span>
<span id="LC1083" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1084" class="line" lang="java">  <span class="kd">public</span> <span class="kd">class</span> <span class="nc">PrecedingSiblingIterator</span> <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
...
<span id="LC1088" class="line" lang="java"><span class="cm">     * The node identity of _startNode for this iterator</span></span>
<span id="LC1089" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1090" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">int</span> <span class="n">_startNodeID</span><span class="o">;</span></span>
<span id="LC1091" class="line" lang="java"></span>
<span id="LC1092" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1093" class="line" lang="java"><span class="cm">     * True if this iterator has a reversed axis.</span></span>
<span id="LC1094" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1095" class="line" lang="java"><span class="cm">     * @return true.</span></span>
<span id="LC1096" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1097" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isReverse</span><span class="o">()</span></span>
...
<span id="LC1103" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC1104" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC1105" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1106" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC1107" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1108" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC1109" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1110" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC1111" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1112" class="line" lang="java"><span class="c1">//%HZ%: Added reference to DTMDefaultBase.ROOTNODE back in, temporarily</span></span>
<span id="LC1113" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="nc">DTMDefaultBase</span><span class="o">.</span><span class="na">ROOTNODE</span><span class="o">)</span></span>
<span id="LC1114" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">getDocument</span><span class="o">();</span></span>
<span id="LC1115" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC1116" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1117" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1118" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">_startNodeID</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1119" class="line" lang="java"></span>
<span id="LC1120" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="no">NULL</span><span class="o">)</span></span>
<span id="LC1121" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1122" class="line" lang="java">          <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1123" class="line" lang="java">          <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC1124" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1125" class="line" lang="java"></span>
<span id="LC1126" class="line" lang="java">        <span class="kt">int</span> <span class="n">type</span> <span class="o">=</span> <span class="n">m_expandedNameTable</span><span class="o">.</span><span class="na">getType</span><span class="o">(</span><span class="n">_exptype</span><span class="o">(</span><span class="n">node</span><span class="o">));</span></span>
<span id="LC1127" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="nc">ExpandedNameTable</span><span class="o">.</span><span class="na">ATTRIBUTE</span> <span class="o">==</span> <span class="n">type</span></span>
<span id="LC1128" class="line" lang="java">           <span class="o">||</span> <span class="nc">ExpandedNameTable</span><span class="o">.</span><span class="na">NAMESPACE</span> <span class="o">==</span> <span class="n">type</span> <span class="o">)</span></span>
<span id="LC1129" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1130" class="line" lang="java">          <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1131" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1132" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC1133" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1134" class="line" lang="java">          <span class="c1">// Be careful to handle the Document node properly</span></span>
<span id="LC1135" class="line" lang="java">          <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">_parent</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1136" class="line" lang="java">          <span class="k">if</span><span class="o">(</span><span class="no">NULL</span><span class="o">!=</span><span class="n">_currentNode</span><span class="o">)</span></span>
<span id="LC1137" class="line" lang="java">            <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">_firstch</span><span class="o">(</span><span class="n">_currentNode</span><span class="o">);</span></span>
<span id="LC1138" class="line" lang="java">          <span class="k">else</span></span>
<span id="LC1139" class="line" lang="java">            <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1140" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1141" class="line" lang="java"></span>
<span id="LC1142" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
...
<span id="LC1149" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC1150" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1151" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC1152" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1153" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC1154" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1155" class="line" lang="java"></span>
<span id="LC1156" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_currentNode</span> <span class="o">==</span> <span class="n">_startNodeID</span> <span class="o">||</span> <span class="n">_currentNode</span> <span class="o">==</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span></span>
<span id="LC1157" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1158" class="line" lang="java">        <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC1159" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1160" class="line" lang="java">      <span class="k">else</span></span>
<span id="LC1161" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1162" class="line" lang="java">        <span class="kd">final</span> <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC1163" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1164" class="line" lang="java"></span>
<span id="LC1165" class="line" lang="java">        <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">node</span><span class="o">));</span></span>
<span id="LC1166" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1167" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1168" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of PrecedingSiblingIterator</span></span>
<span id="LC1169" class="line" lang="java"></span>
<span id="LC1170" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC1171" class="line" lang="java"><span class="cm">   * Iterator that returns preceding siblings of a given type for</span></span>
<span id="LC1172" class="line" lang="java"><span class="cm">   * a given node</span></span>
<span id="LC1173" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1174" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">TypedPrecedingSiblingIterator</span></span>
<span id="LC1175" class="line" lang="java">          <span class="kd">extends</span> <span class="nc">PrecedingSiblingIterator</span></span>
<span id="LC1176" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1177" class="line" lang="java"></span>
<span id="LC1178" class="line" lang="java">    <span class="cm">/** The extended type ID that was requested. */</span></span>
<span id="LC1179" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">int</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC1180" class="line" lang="java"></span>
<span id="LC1181" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1182" class="line" lang="java"><span class="cm">     * Constructor TypedPrecedingSiblingIterator</span></span>
<span id="LC1183" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1184" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1185" class="line" lang="java"><span class="cm">     * @param type The extended type ID being requested.</span></span>
<span id="LC1186" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1187" class="line" lang="java">    <span class="kd">public</span> <span class="nf">TypedPrecedingSiblingIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC1188" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1189" class="line" lang="java">      <span class="n">_nodeType</span> <span class="o">=</span> <span class="n">type</span><span class="o">;</span></span>
...
<span id="LC1193" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC1194" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1195" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC1196" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1197" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC1198" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1199" class="line" lang="java">      <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC1200" class="line" lang="java">      <span class="kt">int</span> <span class="n">expType</span><span class="o">;</span></span>
<span id="LC1201" class="line" lang="java"></span>
<span id="LC1202" class="line" lang="java">      <span class="kt">int</span> <span class="n">nodeType</span> <span class="o">=</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC1203" class="line" lang="java">      <span class="kt">int</span> <span class="n">startID</span> <span class="o">=</span> <span class="n">_startNodeID</span><span class="o">;</span></span>
<span id="LC1204" class="line" lang="java"></span>
<span id="LC1205" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">nodeType</span> <span class="o">&gt;=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NTYPES</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1206" class="line" lang="java">        <span class="k">while</span> <span class="o">(</span><span class="n">node</span> <span class="o">!=</span> <span class="no">NULL</span> <span class="o">&amp;&amp;</span> <span class="n">node</span> <span class="o">!=</span> <span class="n">startID</span> <span class="o">&amp;&amp;</span> <span class="n">_exptype</span><span class="o">(</span><span class="n">node</span><span class="o">)</span> <span class="o">!=</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1207" class="line" lang="java">          <span class="n">node</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1208" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1209" class="line" lang="java">      <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC1210" class="line" lang="java">        <span class="k">while</span> <span class="o">(</span><span class="n">node</span> <span class="o">!=</span> <span class="no">NULL</span> <span class="o">&amp;&amp;</span> <span class="n">node</span> <span class="o">!=</span> <span class="n">startID</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1211" class="line" lang="java">          <span class="n">expType</span> <span class="o">=</span> <span class="n">_exptype</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1212" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="n">expType</span> <span class="o">&lt;</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NTYPES</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1213" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">expType</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1214" class="line" lang="java">              <span class="k">break</span><span class="o">;</span></span>
...
<span id="LC1217" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">m_expandedNameTable</span><span class="o">.</span><span class="na">getType</span><span class="o">(</span><span class="n">expType</span><span class="o">)</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC1221" class="line" lang="java">          <span class="n">node</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
...
<span id="LC1225" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">||</span> <span class="n">node</span> <span class="o">==</span> <span class="n">_startNodeID</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1226" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC1227" class="line" lang="java">        <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC1228" class="line" lang="java">      <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC1229" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1230" class="line" lang="java">        <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">node</span><span class="o">));</span></span>
<span id="LC1231" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1232" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1233" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of TypedPrecedingSiblingIterator</span></span>
<span id="LC1234" class="line" lang="java"></span>
<span id="LC1235" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC1236" class="line" lang="java"><span class="cm">   * Iterator that returns preceding nodes of a given node.</span></span>
<span id="LC1237" class="line" lang="java"><span class="cm">   * This includes the node set {root+1, start-1}, but excludes</span></span>
<span id="LC1238" class="line" lang="java"><span class="cm">   * all ancestors, attributes, and namespace nodes.</span></span>
<span id="LC1239" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1240" class="line" lang="java">  <span class="kd">public</span> <span class="kd">class</span> <span class="nc">PrecedingIterator</span> <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
<span id="LC1241" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1242" class="line" lang="java"></span>
<span id="LC1243" class="line" lang="java">    <span class="cm">/** The max ancestors, but it can grow... */</span></span>
<span id="LC1244" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">int</span> <span class="n">_maxAncestors</span> <span class="o">=</span> <span class="mi">8</span><span class="o">;</span></span>
<span id="LC1245" class="line" lang="java"></span>
<span id="LC1246" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1247" class="line" lang="java"><span class="cm">     * The stack of start node + ancestors up to the root of the tree,</span></span>
<span id="LC1248" class="line" lang="java"><span class="cm">     *  which we must avoid.</span></span>
<span id="LC1249" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1250" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">int</span><span class="o">[]</span> <span class="n">_stack</span> <span class="o">=</span> <span class="k">new</span> <span class="kt">int</span><span class="o">[</span><span class="n">_maxAncestors</span><span class="o">];</span></span>
<span id="LC1251" class="line" lang="java"></span>
<span id="LC1252" class="line" lang="java">    <span class="cm">/** (not sure yet... -sb) */</span></span>
<span id="LC1253" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">int</span> <span class="n">_sp</span><span class="o">,</span> <span class="n">_oldsp</span><span class="o">;</span></span>
<span id="LC1254" class="line" lang="java"></span>
<span id="LC1255" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">int</span> <span class="n">_markedsp</span><span class="o">,</span> <span class="n">_markedNode</span><span class="o">,</span> <span class="n">_markedDescendant</span><span class="o">;</span></span>
<span id="LC1256" class="line" lang="java"></span>
<span id="LC1257" class="line" lang="java">    <span class="cm">/* _currentNode precedes candidates.  This is the identity, not the handle! */</span></span>
<span id="LC1258" class="line" lang="java"></span>
<span id="LC1259" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1260" class="line" lang="java"><span class="cm">     * True if this iterator has a reversed axis.</span></span>
<span id="LC1261" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1262" class="line" lang="java"><span class="cm">     * @return true since this iterator is a reversed axis.</span></span>
<span id="LC1263" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1264" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isReverse</span><span class="o">()</span></span>
<span id="LC1265" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1266" class="line" lang="java">      <span class="k">return</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC1270" class="line" lang="java"><span class="cm">     * Returns a deep copy of this iterator.   The cloned iterator is not reset.</span></span>
<span id="LC1271" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1272" class="line" lang="java"><span class="cm">     * @return a deep copy of this iterator.</span></span>
<span id="LC1273" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1274" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">cloneIterator</span><span class="o">()</span></span>
<span id="LC1275" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1276" class="line" lang="java">      <span class="n">_isRestartable</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1277" class="line" lang="java"></span>
<span id="LC1278" class="line" lang="java">      <span class="k">try</span></span>
<span id="LC1279" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1280" class="line" lang="java">        <span class="kd">final</span> <span class="nc">PrecedingIterator</span> <span class="n">clone</span> <span class="o">=</span> <span class="o">(</span><span class="nc">PrecedingIterator</span><span class="o">)</span> <span class="kd">super</span><span class="o">.</span><span class="na">clone</span><span class="o">();</span></span>
<span id="LC1281" class="line" lang="java">        <span class="kd">final</span> <span class="kt">int</span><span class="o">[]</span> <span class="n">stackCopy</span> <span class="o">=</span> <span class="k">new</span> <span class="kt">int</span><span class="o">[</span><span class="n">_stack</span><span class="o">.</span><span class="na">length</span><span class="o">];</span></span>
<span id="LC1282" class="line" lang="java">        <span class="nc">System</span><span class="o">.</span><span class="na">arraycopy</span><span class="o">(</span><span class="n">_stack</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">stackCopy</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">_stack</span><span class="o">.</span><span class="na">length</span><span class="o">);</span></span>
<span id="LC1283" class="line" lang="java"></span>
<span id="LC1284" class="line" lang="java">        <span class="n">clone</span><span class="o">.</span><span class="na">_stack</span> <span class="o">=</span> <span class="n">stackCopy</span><span class="o">;</span></span>
<span id="LC1285" class="line" lang="java"></span>
<span id="LC1286" class="line" lang="java">        <span class="c1">// return clone.reset();</span></span>
<span id="LC1287" class="line" lang="java">        <span class="k">return</span> <span class="n">clone</span><span class="o">;</span></span>
<span id="LC1288" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1289" class="line" lang="java">      <span class="k">catch</span> <span class="o">(</span><span class="nc">CloneNotSupportedException</span> <span class="n">e</span><span class="o">)</span></span>
<span id="LC1290" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1291" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">DTMException</span><span class="o">(</span><span class="nc">XMLMessages</span><span class="o">.</span><span class="na">createXMLMessage</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_ITERATOR_CLONE_NOT_SUPPORTED</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"Iterator clone not supported.");</span></span>
...
<span id="LC1296" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC1297" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC1298" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1299" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC1300" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1301" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC1302" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1303" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC1304" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1305" class="line" lang="java"><span class="c1">//%HZ%: Added reference to DTMDefaultBase.ROOTNODE back in, temporarily</span></span>
<span id="LC1306" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="nc">DTMDefaultBase</span><span class="o">.</span><span class="na">ROOTNODE</span><span class="o">)</span></span>
<span id="LC1307" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">getDocument</span><span class="o">();</span></span>
<span id="LC1308" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC1309" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1310" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1311" class="line" lang="java"></span>
<span id="LC1312" class="line" lang="java">        <span class="c1">// iterator is not a clone</span></span>
<span id="LC1313" class="line" lang="java">        <span class="kt">int</span> <span class="n">parent</span><span class="o">,</span> <span class="n">index</span><span class="o">;</span></span>
<span id="LC1314" class="line" lang="java"></span>
<span id="LC1315" class="line" lang="java">       <span class="k">if</span> <span class="o">(</span><span class="n">_type</span><span class="o">(</span><span class="n">node</span><span class="o">)</span> <span class="o">==</span> <span class="no">DTM</span><span class="o">.</span><span class="na">ATTRIBUTE_NODE</span><span class="o">)</span></span>
<span id="LC1316" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">_parent</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1317" class="line" lang="java"></span>
<span id="LC1318" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1319" class="line" lang="java">        <span class="n">_stack</span><span class="o">[</span><span class="n">index</span> <span class="o">=</span> <span class="mi">0</span><span class="o">]</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1320" class="line" lang="java"></span>
<span id="LC1321" class="line" lang="java"></span>
<span id="LC1322" class="line" lang="java"></span>
<span id="LC1323" class="line" lang="java">                <span class="n">parent</span><span class="o">=</span><span class="n">node</span><span class="o">;</span></span>
<span id="LC1324" class="line" lang="java">                <span class="k">while</span> <span class="o">((</span><span class="n">parent</span> <span class="o">=</span> <span class="n">_parent</span><span class="o">(</span><span class="n">parent</span><span class="o">))</span> <span class="o">!=</span> <span class="no">NULL</span><span class="o">)</span></span>
<span id="LC1325" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC1326" class="line" lang="java">                        <span class="k">if</span> <span class="o">(++</span><span class="n">index</span> <span class="o">==</span> <span class="n">_stack</span><span class="o">.</span><span class="na">length</span><span class="o">)</span></span>
<span id="LC1327" class="line" lang="java">                        <span class="o">{</span></span>
<span id="LC1328" class="line" lang="java">                                <span class="kd">final</span> <span class="kt">int</span><span class="o">[]</span> <span class="n">stack</span> <span class="o">=</span> <span class="k">new</span> <span class="kt">int</span><span class="o">[</span><span class="n">index</span> <span class="o">+</span> <span class="mi">4</span><span class="o">];</span></span>
<span id="LC1329" class="line" lang="java">                                <span class="nc">System</span><span class="o">.</span><span class="na">arraycopy</span><span class="o">(</span><span class="n">_stack</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">stack</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">index</span><span class="o">);</span></span>
<span id="LC1330" class="line" lang="java">                                <span class="n">_stack</span> <span class="o">=</span> <span class="n">stack</span><span class="o">;</span></span>
<span id="LC1331" class="line" lang="java">                        <span class="o">}</span></span>
<span id="LC1332" class="line" lang="java">                        <span class="n">_stack</span><span class="o">[</span><span class="n">index</span><span class="o">]</span> <span class="o">=</span> <span class="n">parent</span><span class="o">;</span></span>
<span id="LC1333" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1334" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">index</span><span class="o">&gt;</span><span class="mi">0</span><span class="o">)</span></span>
<span id="LC1335" class="line" lang="java">                <span class="o">--</span><span class="n">index</span><span class="o">;</span> <span class="c1">// Pop actual root node (if not start) back off the stack</span></span>
<span id="LC1336" class="line" lang="java"></span>
<span id="LC1337" class="line" lang="java">        <span class="n">_currentNode</span><span class="o">=</span><span class="n">_stack</span><span class="o">[</span><span class="n">index</span><span class="o">];</span> <span class="c1">// Last parent before root node</span></span>
<span id="LC1338" class="line" lang="java"></span>
<span id="LC1339" class="line" lang="java">        <span class="n">_oldsp</span> <span class="o">=</span> <span class="n">_sp</span> <span class="o">=</span> <span class="n">index</span><span class="o">;</span></span>
<span id="LC1340" class="line" lang="java"></span>
<span id="LC1341" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC1342" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1343" class="line" lang="java"></span>
<span id="LC1344" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC1348" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC1349" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1350" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC1351" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1352" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC1353" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1354" class="line" lang="java">        <span class="c1">// Bugzilla 8324: We were forgetting to skip Attrs and NS nodes.</span></span>
<span id="LC1355" class="line" lang="java">        <span class="c1">// Also recoded the loop controls for clarity and to flatten out</span></span>
<span id="LC1356" class="line" lang="java">        <span class="c1">// the tail-recursion.</span></span>
<span id="LC1357" class="line" lang="java">                <span class="k">for</span><span class="o">(++</span><span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC1358" class="line" lang="java">                        <span class="n">_sp</span><span class="o">&gt;=</span><span class="mi">0</span><span class="o">;</span></span>
<span id="LC1359" class="line" lang="java">                        <span class="o">++</span><span class="n">_currentNode</span><span class="o">)</span></span>
<span id="LC1360" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC1361" class="line" lang="java">                        <span class="k">if</span><span class="o">(</span><span class="n">_currentNode</span> <span class="o">&lt;</span> <span class="n">_stack</span><span class="o">[</span><span class="n">_sp</span><span class="o">])</span></span>
<span id="LC1362" class="line" lang="java">                        <span class="o">{</span></span>
<span id="LC1363" class="line" lang="java">                                <span class="k">if</span><span class="o">(</span><span class="n">_type</span><span class="o">(</span><span class="n">_currentNode</span><span class="o">)</span> <span class="o">!=</span> <span class="no">ATTRIBUTE_NODE</span> <span class="o">&amp;&amp;</span></span>
<span id="LC1364" class="line" lang="java">                                        <span class="n">_type</span><span class="o">(</span><span class="n">_currentNode</span><span class="o">)</span> <span class="o">!=</span> <span class="no">NAMESPACE_NODE</span><span class="o">)</span></span>
<span id="LC1365" class="line" lang="java">                                        <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">_currentNode</span><span class="o">));</span></span>
...
<span id="LC1368" class="line" lang="java">                                <span class="o">--</span><span class="n">_sp</span><span class="o">;</span></span>
<span id="LC1369" class="line" lang="java">                <span class="o">}</span></span>
<span id="LC1370" class="line" lang="java">                <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC1371" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1372" class="line" lang="java"></span>
<span id="LC1373" class="line" lang="java">    <span class="c1">// redefine DTMAxisIteratorBase's reset</span></span>
<span id="LC1374" class="line" lang="java"></span>
<span id="LC1375" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1376" class="line" lang="java"><span class="cm">     * Resets the iterator to the last start node.</span></span>
<span id="LC1377" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1378" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator, which may or may not be the same as this</span></span>
<span id="LC1379" class="line" lang="java"><span class="cm">     *         iterator.</span></span>
<span id="LC1380" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1381" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">reset</span><span class="o">()</span></span>
<span id="LC1382" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1383" class="line" lang="java"></span>
<span id="LC1384" class="line" lang="java">      <span class="n">_sp</span> <span class="o">=</span> <span class="n">_oldsp</span><span class="o">;</span></span>
<span id="LC1385" class="line" lang="java"></span>
<span id="LC1386" class="line" lang="java">      <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC1387" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1388" class="line" lang="java"></span>
<span id="LC1389" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMark</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC1390" class="line" lang="java">        <span class="n">_markedsp</span> <span class="o">=</span> <span class="n">_sp</span><span class="o">;</span></span>
<span id="LC1391" class="line" lang="java">        <span class="n">_markedNode</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC1392" class="line" lang="java">        <span class="n">_markedDescendant</span> <span class="o">=</span> <span class="n">_stack</span><span class="o">[</span><span class="mi">0</span><span class="o">];</span></span>
<span id="LC1393" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1394" class="line" lang="java"></span>
<span id="LC1395" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">gotoMark</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC1396" class="line" lang="java">        <span class="n">_sp</span> <span class="o">=</span> <span class="n">_markedsp</span><span class="o">;</span></span>
<span id="LC1397" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">_markedNode</span><span class="o">;</span></span>
<span id="LC1398" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1399" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of PrecedingIterator</span></span>
<span id="LC1400" class="line" lang="java"></span>
<span id="LC1401" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC1402" class="line" lang="java"><span class="cm">   * Iterator that returns preceding nodes of agiven type for a</span></span>
<span id="LC1403" class="line" lang="java"><span class="cm">   * given node. This includes the node set {root+1, start-1}, but</span></span>
<span id="LC1404" class="line" lang="java"><span class="cm">   * excludes all ancestors.</span></span>
<span id="LC1405" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1406" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">TypedPrecedingIterator</span> <span class="kd">extends</span> <span class="nc">PrecedingIterator</span></span>
<span id="LC1407" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1408" class="line" lang="java"></span>
<span id="LC1409" class="line" lang="java">    <span class="cm">/** The extended type ID that was requested. */</span></span>
<span id="LC1410" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">int</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC1411" class="line" lang="java"></span>
<span id="LC1412" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1413" class="line" lang="java"><span class="cm">     * Constructor TypedPrecedingIterator</span></span>
<span id="LC1414" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1415" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1416" class="line" lang="java"><span class="cm">     * @param type The extended type ID being requested.</span></span>
<span id="LC1417" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1418" class="line" lang="java">    <span class="kd">public</span> <span class="nf">TypedPrecedingIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC1419" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1420" class="line" lang="java">      <span class="n">_nodeType</span> <span class="o">=</span> <span class="n">type</span><span class="o">;</span></span>
...
<span id="LC1424" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC1425" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1426" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC1427" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1428" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC1429" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1430" class="line" lang="java">      <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC1431" class="line" lang="java">      <span class="kt">int</span> <span class="n">nodeType</span> <span class="o">=</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC1432" class="line" lang="java"></span>
<span id="LC1433" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">nodeType</span> <span class="o">&gt;=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NTYPES</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1434" class="line" lang="java">        <span class="k">while</span> <span class="o">(</span><span class="kc">true</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1435" class="line" lang="java">          <span class="n">node</span> <span class="o">=</span> <span class="n">node</span> <span class="o">+</span> <span class="mi">1</span><span class="o">;</span></span>
<span id="LC1436" class="line" lang="java"></span>
<span id="LC1437" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="n">_sp</span> <span class="o">&lt;</span> <span class="mi">0</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1438" class="line" lang="java">            <span class="n">node</span> <span class="o">=</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC1439" class="line" lang="java">            <span class="k">break</span><span class="o">;</span></span>
<span id="LC1440" class="line" lang="java">          <span class="o">}</span> <span class="k">else</span> <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">&gt;=</span> <span class="n">_stack</span><span class="o">[</span><span class="n">_sp</span><span class="o">])</span> <span class="o">{</span></span>
<span id="LC1441" class="line" lang="java">            <span class="k">if</span> <span class="o">(--</span><span class="n">_sp</span> <span class="o">&lt;</span> <span class="mi">0</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1442" class="line" lang="java">              <span class="n">node</span> <span class="o">=</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1445" class="line" lang="java">          <span class="o">}</span> <span class="k">else</span> <span class="k">if</span> <span class="o">(</span><span class="n">_exptype</span><span class="o">(</span><span class="n">node</span><span class="o">)</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC1449" class="line" lang="java">      <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC1450" class="line" lang="java">        <span class="kt">int</span> <span class="n">expType</span><span class="o">;</span></span>
<span id="LC1451" class="line" lang="java"></span>
<span id="LC1452" class="line" lang="java">        <span class="k">while</span> <span class="o">(</span><span class="kc">true</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1453" class="line" lang="java">          <span class="n">node</span> <span class="o">=</span> <span class="n">node</span> <span class="o">+</span> <span class="mi">1</span><span class="o">;</span></span>
<span id="LC1454" class="line" lang="java"></span>
<span id="LC1455" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="n">_sp</span> <span class="o">&lt;</span> <span class="mi">0</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1456" class="line" lang="java">            <span class="n">node</span> <span class="o">=</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC1457" class="line" lang="java">            <span class="k">break</span><span class="o">;</span></span>
<span id="LC1458" class="line" lang="java">          <span class="o">}</span> <span class="k">else</span> <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">&gt;=</span> <span class="n">_stack</span><span class="o">[</span><span class="n">_sp</span><span class="o">])</span> <span class="o">{</span></span>
<span id="LC1459" class="line" lang="java">            <span class="k">if</span> <span class="o">(--</span><span class="n">_sp</span> <span class="o">&lt;</span> <span class="mi">0</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1460" class="line" lang="java">              <span class="n">node</span> <span class="o">=</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1463" class="line" lang="java">          <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC1464" class="line" lang="java">            <span class="n">expType</span> <span class="o">=</span> <span class="n">_exptype</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1465" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">expType</span> <span class="o">&lt;</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NTYPES</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1466" class="line" lang="java">              <span class="k">if</span> <span class="o">(</span><span class="n">expType</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC1470" class="line" lang="java">              <span class="k">if</span> <span class="o">(</span><span class="n">m_expandedNameTable</span><span class="o">.</span><span class="na">getType</span><span class="o">(</span><span class="n">expType</span><span class="o">)</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC1478" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1479" class="line" lang="java"></span>
<span id="LC1480" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="no">NULL</span><span class="o">)</span> <span class="o">?</span> <span class="no">NULL</span> <span class="o">:</span> <span class="n">returnNode</span><span class="o">(</span><span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">node</span><span class="o">));</span></span>
<span id="LC1481" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1482" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of TypedPrecedingIterator</span></span>
<span id="LC1483" class="line" lang="java"></span>
<span id="LC1484" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC1485" class="line" lang="java"><span class="cm">   * Iterator that returns following nodes of for a given node.</span></span>
<span id="LC1486" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1487" class="line" lang="java">  <span class="kd">public</span> <span class="kd">class</span> <span class="nc">FollowingIterator</span> <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
<span id="LC1488" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1489" class="line" lang="java">    <span class="nc">DTMAxisTraverser</span> <span class="n">m_traverser</span><span class="o">;</span> <span class="c1">// easier for now</span></span>
<span id="LC1490" class="line" lang="java"></span>
<span id="LC1491" class="line" lang="java">    <span class="kd">public</span> <span class="nf">FollowingIterator</span><span class="o">()</span></span>
<span id="LC1492" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1493" class="line" lang="java">      <span class="n">m_traverser</span> <span class="o">=</span> <span class="n">getAxisTraverser</span><span class="o">(</span><span class="nc">Axis</span><span class="o">.</span><span class="na">FOLLOWING</span><span class="o">);</span></span>
...
<span id="LC1497" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC1498" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC1499" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1500" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC1501" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1502" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC1503" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1504" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC1505" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1506" class="line" lang="java"><span class="c1">//%HZ%: Added reference to DTMDefaultBase.ROOTNODE back in, temporarily</span></span>
<span id="LC1507" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="nc">DTMDefaultBase</span><span class="o">.</span><span class="na">ROOTNODE</span><span class="o">)</span></span>
<span id="LC1508" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">getDocument</span><span class="o">();</span></span>
<span id="LC1509" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC1510" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1511" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1512" class="line" lang="java"></span>
<span id="LC1513" class="line" lang="java">        <span class="c1">// ?? -sb</span></span>
<span id="LC1514" class="line" lang="java">        <span class="c1">// find rightmost descendant (or self)</span></span>
<span id="LC1515" class="line" lang="java">        <span class="c1">// int current;</span></span>
<span id="LC1516" class="line" lang="java">        <span class="c1">// while ((node = getLastChild(current = node)) != NULL){}</span></span>
<span id="LC1517" class="line" lang="java">        <span class="c1">// _currentNode = current;</span></span>
<span id="LC1518" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">m_traverser</span><span class="o">.</span><span class="na">first</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1519" class="line" lang="java"></span>
<span id="LC1520" class="line" lang="java">        <span class="c1">// _currentNode precedes possible following(node) nodes</span></span>
<span id="LC1521" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC1522" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1523" class="line" lang="java"></span>
<span id="LC1524" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC1528" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC1529" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1530" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC1531" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1532" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC1533" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1534" class="line" lang="java"></span>
<span id="LC1535" class="line" lang="java">      <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC1536" class="line" lang="java"></span>
<span id="LC1537" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">m_traverser</span><span class="o">.</span><span class="na">next</span><span class="o">(</span><span class="n">_startNode</span><span class="o">,</span> <span class="n">_currentNode</span><span class="o">);</span></span>
<span id="LC1538" class="line" lang="java"></span>
<span id="LC1539" class="line" lang="java">      <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1540" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1541" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of FollowingIterator</span></span>
<span id="LC1542" class="line" lang="java"></span>
<span id="LC1543" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC1544" class="line" lang="java"><span class="cm">   * Iterator that returns following nodes of a given type for a given node.</span></span>
<span id="LC1545" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1546" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">TypedFollowingIterator</span> <span class="kd">extends</span> <span class="nc">FollowingIterator</span></span>
<span id="LC1547" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1548" class="line" lang="java"></span>
<span id="LC1549" class="line" lang="java">    <span class="cm">/** The extended type ID that was requested. */</span></span>
<span id="LC1550" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">int</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC1551" class="line" lang="java"></span>
<span id="LC1552" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1553" class="line" lang="java"><span class="cm">     * Constructor TypedFollowingIterator</span></span>
<span id="LC1554" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1555" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1556" class="line" lang="java"><span class="cm">     * @param type The extended type ID being requested.</span></span>
<span id="LC1557" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1558" class="line" lang="java">    <span class="kd">public</span> <span class="nf">TypedFollowingIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC1559" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1560" class="line" lang="java">      <span class="n">_nodeType</span> <span class="o">=</span> <span class="n">type</span><span class="o">;</span></span>
...
<span id="LC1564" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC1565" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1566" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC1567" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1568" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC1569" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1570" class="line" lang="java"></span>
<span id="LC1571" class="line" lang="java">      <span class="kt">int</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1572" class="line" lang="java"></span>
<span id="LC1573" class="line" lang="java">      <span class="k">do</span><span class="o">{</span></span>
<span id="LC1574" class="line" lang="java">       <span class="n">node</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC1575" class="line" lang="java"></span>
<span id="LC1576" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">m_traverser</span><span class="o">.</span><span class="na">next</span><span class="o">(</span><span class="n">_startNode</span><span class="o">,</span> <span class="n">_currentNode</span><span class="o">);</span></span>
<span id="LC1577" class="line" lang="java"></span>
<span id="LC1578" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1579" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="n">node</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span></span>
<span id="LC1580" class="line" lang="java">             <span class="o">&amp;&amp;</span> <span class="o">(</span><span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">node</span><span class="o">)</span> <span class="o">!=</span> <span class="n">_nodeType</span> <span class="o">&amp;&amp;</span> <span class="n">getNodeType</span><span class="o">(</span><span class="n">node</span><span class="o">)</span> <span class="o">!=</span> <span class="n">_nodeType</span><span class="o">));</span></span>
<span id="LC1581" class="line" lang="java"></span>
<span id="LC1582" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">?</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">:</span><span class="n">returnNode</span><span class="o">(</span><span class="n">node</span><span class="o">));</span></span>
<span id="LC1583" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1584" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of TypedFollowingIterator</span></span>
<span id="LC1585" class="line" lang="java"></span>
<span id="LC1586" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC1587" class="line" lang="java"><span class="cm">   * Iterator that returns the ancestors of a given node in document</span></span>
<span id="LC1588" class="line" lang="java"><span class="cm">   * order.  (NOTE!  This was changed from the XSLTC code!)</span></span>
<span id="LC1589" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1590" class="line" lang="java">  <span class="kd">public</span> <span class="kd">class</span> <span class="nc">AncestorIterator</span> <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
<span id="LC1591" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1592" class="line" lang="java">    <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">utils</span><span class="o">.</span><span class="na">NodeVector</span> <span class="n">m_ancestors</span> <span class="o">=</span></span>
<span id="LC1593" class="line" lang="java">         <span class="k">new</span> <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">utils</span><span class="o">.</span><span class="na">NodeVector</span><span class="o">();</span></span>
<span id="LC1594" class="line" lang="java"></span>
<span id="LC1595" class="line" lang="java">    <span class="kt">int</span> <span class="n">m_ancestorsPos</span><span class="o">;</span></span>
<span id="LC1596" class="line" lang="java"></span>
<span id="LC1597" class="line" lang="java">    <span class="kt">int</span> <span class="n">m_markedPos</span><span class="o">;</span></span>
<span id="LC1598" class="line" lang="java"></span>
<span id="LC1599" class="line" lang="java">    <span class="cm">/** The real start node for this axes, since _startNode will be adjusted. */</span></span>
<span id="LC1600" class="line" lang="java">    <span class="kt">int</span> <span class="n">m_realStartNode</span><span class="o">;</span></span>
<span id="LC1601" class="line" lang="java"></span>
<span id="LC1602" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1603" class="line" lang="java"><span class="cm">     * Get start to END should 'close' the iterator,</span></span>
<span id="LC1604" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC1605" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1606" class="line" lang="java"><span class="cm">     * @return The root node of the iteration.</span></span>
<span id="LC1607" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1608" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getStartNode</span><span class="o">()</span></span>
<span id="LC1609" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1610" class="line" lang="java">      <span class="k">return</span> <span class="n">m_realStartNode</span><span class="o">;</span></span>
...
<span id="LC1614" class="line" lang="java"><span class="cm">     * True if this iterator has a reversed axis.</span></span>
<span id="LC1615" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1616" class="line" lang="java"><span class="cm">     * @return true since this iterator is a reversed axis.</span></span>
<span id="LC1617" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1618" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="kt">boolean</span> <span class="nf">isReverse</span><span class="o">()</span></span>
<span id="LC1619" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1620" class="line" lang="java">      <span class="k">return</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC1624" class="line" lang="java"><span class="cm">     * Returns a deep copy of this iterator.  The cloned iterator is not reset.</span></span>
<span id="LC1625" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1626" class="line" lang="java"><span class="cm">     * @return a deep copy of this iterator.</span></span>
<span id="LC1627" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1628" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">cloneIterator</span><span class="o">()</span></span>
<span id="LC1629" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1630" class="line" lang="java">      <span class="n">_isRestartable</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span>  <span class="c1">// must set to false for any clone</span></span>
<span id="LC1631" class="line" lang="java"></span>
<span id="LC1632" class="line" lang="java">      <span class="k">try</span></span>
<span id="LC1633" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1634" class="line" lang="java">        <span class="kd">final</span> <span class="nc">AncestorIterator</span> <span class="n">clone</span> <span class="o">=</span> <span class="o">(</span><span class="nc">AncestorIterator</span><span class="o">)</span> <span class="kd">super</span><span class="o">.</span><span class="na">clone</span><span class="o">();</span></span>
<span id="LC1635" class="line" lang="java"></span>
<span id="LC1636" class="line" lang="java">        <span class="n">clone</span><span class="o">.</span><span class="na">_startNode</span> <span class="o">=</span> <span class="n">_startNode</span><span class="o">;</span></span>
<span id="LC1637" class="line" lang="java"></span>
<span id="LC1638" class="line" lang="java">        <span class="c1">// return clone.reset();</span></span>
<span id="LC1639" class="line" lang="java">        <span class="k">return</span> <span class="n">clone</span><span class="o">;</span></span>
<span id="LC1640" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1641" class="line" lang="java">      <span class="k">catch</span> <span class="o">(</span><span class="nc">CloneNotSupportedException</span> <span class="n">e</span><span class="o">)</span></span>
<span id="LC1642" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1643" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">DTMException</span><span class="o">(</span><span class="nc">XMLMessages</span><span class="o">.</span><span class="na">createXMLMessage</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_ITERATOR_CLONE_NOT_SUPPORTED</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span> <span class="c1">//"Iterator clone not supported.");</span></span>
...
<span id="LC1648" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC1649" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC1650" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1651" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC1652" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1653" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC1654" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1655" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC1656" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1657" class="line" lang="java"><span class="c1">//%HZ%: Added reference to DTMDefaultBase.ROOTNODE back in, temporarily</span></span>
<span id="LC1658" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="nc">DTMDefaultBase</span><span class="o">.</span><span class="na">ROOTNODE</span><span class="o">)</span></span>
<span id="LC1659" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">getDocument</span><span class="o">();</span></span>
<span id="LC1660" class="line" lang="java">      <span class="n">m_realStartNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1661" class="line" lang="java"></span>
<span id="LC1662" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC1663" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1664" class="line" lang="java">        <span class="kt">int</span> <span class="n">nodeID</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1665" class="line" lang="java"></span>
<span id="LC1666" class="line" lang="java">        <span class="k">if</span> <span class="o">(!</span><span class="n">_includeSelf</span> <span class="o">&amp;&amp;</span> <span class="n">node</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1667" class="line" lang="java">          <span class="n">nodeID</span> <span class="o">=</span> <span class="n">_parent</span><span class="o">(</span><span class="n">nodeID</span><span class="o">);</span></span>
<span id="LC1668" class="line" lang="java">          <span class="n">node</span> <span class="o">=</span> <span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">nodeID</span><span class="o">);</span></span>
<span id="LC1669" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1670" class="line" lang="java"></span>
<span id="LC1671" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1672" class="line" lang="java"></span>
<span id="LC1673" class="line" lang="java">        <span class="k">while</span> <span class="o">(</span><span class="n">nodeID</span> <span class="o">!=</span> <span class="no">END</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1674" class="line" lang="java">          <span class="n">m_ancestors</span><span class="o">.</span><span class="na">addElement</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1675" class="line" lang="java">          <span class="n">nodeID</span> <span class="o">=</span> <span class="n">_parent</span><span class="o">(</span><span class="n">nodeID</span><span class="o">);</span></span>
<span id="LC1676" class="line" lang="java">          <span class="n">node</span> <span class="o">=</span> <span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">nodeID</span><span class="o">);</span></span>
<span id="LC1677" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1678" class="line" lang="java">        <span class="n">m_ancestorsPos</span> <span class="o">=</span> <span class="n">m_ancestors</span><span class="o">.</span><span class="na">size</span><span class="o">()-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC1679" class="line" lang="java"></span>
<span id="LC1680" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="o">(</span><span class="n">m_ancestorsPos</span><span class="o">&gt;=</span><span class="mi">0</span><span class="o">)</span></span>
<span id="LC1681" class="line" lang="java">                               <span class="o">?</span> <span class="n">m_ancestors</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">m_ancestorsPos</span><span class="o">)</span></span>
<span id="LC1682" class="line" lang="java">                               <span class="o">:</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC1683" class="line" lang="java"></span>
<span id="LC1684" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC1685" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1686" class="line" lang="java"></span>
<span id="LC1687" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC1691" class="line" lang="java"><span class="cm">     * Resets the iterator to the last start node.</span></span>
<span id="LC1692" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1693" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator, which may or may not be the same as this</span></span>
<span id="LC1694" class="line" lang="java"><span class="cm">     *         iterator.</span></span>
<span id="LC1695" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1696" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">reset</span><span class="o">()</span></span>
<span id="LC1697" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1698" class="line" lang="java"></span>
<span id="LC1699" class="line" lang="java">      <span class="n">m_ancestorsPos</span> <span class="o">=</span> <span class="n">m_ancestors</span><span class="o">.</span><span class="na">size</span><span class="o">()-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC1700" class="line" lang="java"></span>
<span id="LC1701" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="o">(</span><span class="n">m_ancestorsPos</span><span class="o">&gt;=</span><span class="mi">0</span><span class="o">)</span> <span class="o">?</span> <span class="n">m_ancestors</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">m_ancestorsPos</span><span class="o">)</span></span>
<span id="LC1702" class="line" lang="java">                                         <span class="o">:</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC1703" class="line" lang="java"></span>
<span id="LC1704" class="line" lang="java">      <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
...
<span id="LC1708" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC1709" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1710" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC1711" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1712" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC1713" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1714" class="line" lang="java"></span>
<span id="LC1715" class="line" lang="java">      <span class="kt">int</span> <span class="n">next</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC1716" class="line" lang="java"></span>
<span id="LC1717" class="line" lang="java">      <span class="kt">int</span> <span class="n">pos</span> <span class="o">=</span> <span class="o">--</span><span class="n">m_ancestorsPos</span><span class="o">;</span></span>
<span id="LC1718" class="line" lang="java"></span>
<span id="LC1719" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="o">(</span><span class="n">pos</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="o">)</span> <span class="o">?</span> <span class="n">m_ancestors</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">m_ancestorsPos</span><span class="o">)</span></span>
<span id="LC1720" class="line" lang="java">                                <span class="o">:</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC1721" class="line" lang="java"></span>
<span id="LC1722" class="line" lang="java">      <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">next</span><span class="o">);</span></span>
<span id="LC1723" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1724" class="line" lang="java"></span>
<span id="LC1725" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMark</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC1726" class="line" lang="java">        <span class="n">m_markedPos</span> <span class="o">=</span> <span class="n">m_ancestorsPos</span><span class="o">;</span></span>
<span id="LC1727" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1728" class="line" lang="java"></span>
<span id="LC1729" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">gotoMark</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC1730" class="line" lang="java">        <span class="n">m_ancestorsPos</span> <span class="o">=</span> <span class="n">m_markedPos</span><span class="o">;</span></span>
<span id="LC1731" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">m_ancestorsPos</span><span class="o">&gt;=</span><span class="mi">0</span> <span class="o">?</span> <span class="n">m_ancestors</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">m_ancestorsPos</span><span class="o">)</span></span>
<span id="LC1732" class="line" lang="java">                                         <span class="o">:</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC1733" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1734" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of AncestorIterator</span></span>
<span id="LC1735" class="line" lang="java"></span>
<span id="LC1736" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC1737" class="line" lang="java"><span class="cm">   * Typed iterator that returns the ancestors of a given node.</span></span>
<span id="LC1738" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1739" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">TypedAncestorIterator</span> <span class="kd">extends</span> <span class="nc">AncestorIterator</span></span>
<span id="LC1740" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1741" class="line" lang="java"></span>
<span id="LC1742" class="line" lang="java">    <span class="cm">/** The extended type ID that was requested. */</span></span>
<span id="LC1743" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">int</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC1744" class="line" lang="java"></span>
<span id="LC1745" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1746" class="line" lang="java"><span class="cm">     * Constructor TypedAncestorIterator</span></span>
<span id="LC1747" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1748" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1749" class="line" lang="java"><span class="cm">     * @param type The extended type ID being requested.</span></span>
<span id="LC1750" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1751" class="line" lang="java">    <span class="kd">public</span> <span class="nf">TypedAncestorIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC1752" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1753" class="line" lang="java">      <span class="n">_nodeType</span> <span class="o">=</span> <span class="n">type</span><span class="o">;</span></span>
...
<span id="LC1757" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC1758" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC1759" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1760" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC1761" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1762" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC1763" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1764" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC1765" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1766" class="line" lang="java"><span class="c1">//%HZ%: Added reference to DTMDefaultBase.ROOTNODE back in, temporarily</span></span>
<span id="LC1767" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="nc">DTMDefaultBase</span><span class="o">.</span><span class="na">ROOTNODE</span><span class="o">)</span></span>
<span id="LC1768" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">getDocument</span><span class="o">();</span></span>
<span id="LC1769" class="line" lang="java">      <span class="n">m_realStartNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1770" class="line" lang="java"></span>
<span id="LC1771" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC1772" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1773" class="line" lang="java">        <span class="kt">int</span> <span class="n">nodeID</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1774" class="line" lang="java">        <span class="kt">int</span> <span class="n">nodeType</span> <span class="o">=</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC1775" class="line" lang="java"></span>
<span id="LC1776" class="line" lang="java">        <span class="k">if</span> <span class="o">(!</span><span class="n">_includeSelf</span> <span class="o">&amp;&amp;</span> <span class="n">node</span> <span class="o">!=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1777" class="line" lang="java">          <span class="n">nodeID</span> <span class="o">=</span> <span class="n">_parent</span><span class="o">(</span><span class="n">nodeID</span><span class="o">);</span></span>
<span id="LC1778" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1779" class="line" lang="java"></span>
<span id="LC1780" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1781" class="line" lang="java"></span>
<span id="LC1782" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">nodeType</span> <span class="o">&gt;=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NTYPES</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1783" class="line" lang="java">          <span class="k">while</span> <span class="o">(</span><span class="n">nodeID</span> <span class="o">!=</span> <span class="no">END</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1784" class="line" lang="java">            <span class="kt">int</span> <span class="n">eType</span> <span class="o">=</span> <span class="n">_exptype</span><span class="o">(</span><span class="n">nodeID</span><span class="o">);</span></span>
<span id="LC1785" class="line" lang="java"></span>
<span id="LC1786" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">eType</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1787" class="line" lang="java">              <span class="n">m_ancestors</span><span class="o">.</span><span class="na">addElement</span><span class="o">(</span><span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">nodeID</span><span class="o">));</span></span>
<span id="LC1788" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC1789" class="line" lang="java">            <span class="n">nodeID</span> <span class="o">=</span> <span class="n">_parent</span><span class="o">(</span><span class="n">nodeID</span><span class="o">);</span></span>
<span id="LC1790" class="line" lang="java">          <span class="o">}</span></span>
<span id="LC1791" class="line" lang="java">        <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC1792" class="line" lang="java">          <span class="k">while</span> <span class="o">(</span><span class="n">nodeID</span> <span class="o">!=</span> <span class="no">END</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1793" class="line" lang="java">            <span class="kt">int</span> <span class="n">eType</span> <span class="o">=</span> <span class="n">_exptype</span><span class="o">(</span><span class="n">nodeID</span><span class="o">);</span></span>
<span id="LC1794" class="line" lang="java"></span>
<span id="LC1795" class="line" lang="java">            <span class="k">if</span> <span class="o">((</span><span class="n">eType</span> <span class="o">&gt;=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NTYPES</span></span>
<span id="LC1796" class="line" lang="java">                    <span class="o">&amp;&amp;</span> <span class="n">m_expandedNameTable</span><span class="o">.</span><span class="na">getType</span><span class="o">(</span><span class="n">eType</span><span class="o">)</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">)</span></span>
<span id="LC1797" class="line" lang="java">                <span class="o">||</span> <span class="o">(</span><span class="n">eType</span> <span class="o">&lt;</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NTYPES</span> <span class="o">&amp;&amp;</span> <span class="n">eType</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC1798" class="line" lang="java">              <span class="n">m_ancestors</span><span class="o">.</span><span class="na">addElement</span><span class="o">(</span><span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">nodeID</span><span class="o">));</span></span>
<span id="LC1799" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC1800" class="line" lang="java">            <span class="n">nodeID</span> <span class="o">=</span> <span class="n">_parent</span><span class="o">(</span><span class="n">nodeID</span><span class="o">);</span></span>
<span id="LC1801" class="line" lang="java">          <span class="o">}</span></span>
<span id="LC1802" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1803" class="line" lang="java">        <span class="n">m_ancestorsPos</span> <span class="o">=</span> <span class="n">m_ancestors</span><span class="o">.</span><span class="na">size</span><span class="o">()-</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC1804" class="line" lang="java"></span>
<span id="LC1805" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="o">(</span><span class="n">m_ancestorsPos</span><span class="o">&gt;=</span><span class="mi">0</span><span class="o">)</span></span>
<span id="LC1806" class="line" lang="java">                               <span class="o">?</span> <span class="n">m_ancestors</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">m_ancestorsPos</span><span class="o">)</span></span>
<span id="LC1807" class="line" lang="java">                               <span class="o">:</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
<span id="LC1808" class="line" lang="java"></span>
<span id="LC1809" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC1810" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1811" class="line" lang="java"></span>
<span id="LC1812" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
<span id="LC1813" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1814" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of TypedAncestorIterator</span></span>
<span id="LC1815" class="line" lang="java"></span>
<span id="LC1816" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC1817" class="line" lang="java"><span class="cm">   * Iterator that returns the descendants of a given node.</span></span>
<span id="LC1818" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1819" class="line" lang="java">  <span class="kd">public</span> <span class="kd">class</span> <span class="nc">DescendantIterator</span> <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
...
<span id="LC1823" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC1824" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC1825" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1826" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC1827" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1828" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC1829" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1830" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC1831" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1832" class="line" lang="java"><span class="c1">//%HZ%: Added reference to DTMDefaultBase.ROOTNODE back in, temporarily</span></span>
<span id="LC1833" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="nc">DTMDefaultBase</span><span class="o">.</span><span class="na">ROOTNODE</span><span class="o">)</span></span>
<span id="LC1834" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">getDocument</span><span class="o">();</span></span>
<span id="LC1835" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC1836" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1837" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1838" class="line" lang="java">        <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1839" class="line" lang="java"></span>
<span id="LC1840" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">_includeSelf</span><span class="o">)</span></span>
<span id="LC1841" class="line" lang="java">          <span class="n">node</span><span class="o">--;</span></span>
<span id="LC1842" class="line" lang="java"></span>
<span id="LC1843" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1844" class="line" lang="java"></span>
<span id="LC1845" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC1846" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1847" class="line" lang="java"></span>
<span id="LC1848" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC1852" class="line" lang="java"><span class="cm">     * Tell if this node identity is a descendant.  Assumes that</span></span>
<span id="LC1853" class="line" lang="java"><span class="cm">     * the node info for the element has already been obtained.</span></span>
<span id="LC1854" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1855" class="line" lang="java"><span class="cm">     * This one-sided test works only if the parent has been</span></span>
<span id="LC1856" class="line" lang="java"><span class="cm">     * previously tested and is known to be a descendent. It fails if</span></span>
<span id="LC1857" class="line" lang="java"><span class="cm">     * the parent is the _startNode's next sibling, or indeed any node</span></span>
<span id="LC1858" class="line" lang="java"><span class="cm">     * that follows _startNode in document order.  That may suffice</span></span>
<span id="LC1859" class="line" lang="java"><span class="cm">     * for this iterator, but it's not really an isDescendent() test.</span></span>
<span id="LC1860" class="line" lang="java"><span class="cm">     * %REVIEW% rename?</span></span>
<span id="LC1861" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1862" class="line" lang="java"><span class="cm">     * @param identity The index number of the node in question.</span></span>
<span id="LC1863" class="line" lang="java"><span class="cm">     * @return true if the index is a descendant of _startNode.</span></span>
<span id="LC1864" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1865" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">boolean</span> <span class="nf">isDescendant</span><span class="o">(</span><span class="kt">int</span> <span class="n">identity</span><span class="o">)</span></span>
<span id="LC1866" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1867" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="n">_parent</span><span class="o">(</span><span class="n">identity</span><span class="o">)</span> <span class="o">&gt;=</span> <span class="n">_startNode</span><span class="o">)</span> <span class="o">||</span> <span class="o">(</span><span class="n">_startNode</span> <span class="o">==</span> <span class="n">identity</span><span class="o">);</span></span>
...
<span id="LC1871" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC1872" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1873" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC1874" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1875" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC1876" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1877" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_startNode</span> <span class="o">==</span> <span class="no">NULL</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1878" class="line" lang="java">        <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC1879" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1880" class="line" lang="java"></span>
<span id="LC1881" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_includeSelf</span> <span class="o">&amp;&amp;</span> <span class="o">(</span><span class="n">_currentNode</span> <span class="o">+</span> <span class="mi">1</span><span class="o">)</span> <span class="o">==</span> <span class="n">_startNode</span><span class="o">)</span></span>
<span id="LC1882" class="line" lang="java">          <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">makeNodeHandle</span><span class="o">(++</span><span class="n">_currentNode</span><span class="o">));</span> <span class="c1">// | m_dtmIdent);</span></span>
<span id="LC1883" class="line" lang="java"></span>
<span id="LC1884" class="line" lang="java">      <span class="kt">int</span> <span class="n">node</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC1885" class="line" lang="java">      <span class="kt">int</span> <span class="n">type</span><span class="o">;</span></span>
<span id="LC1886" class="line" lang="java"></span>
<span id="LC1887" class="line" lang="java">      <span class="k">do</span> <span class="o">{</span></span>
<span id="LC1888" class="line" lang="java">        <span class="n">node</span><span class="o">++;</span></span>
<span id="LC1889" class="line" lang="java">        <span class="n">type</span> <span class="o">=</span> <span class="n">_type</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1890" class="line" lang="java"></span>
<span id="LC1891" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="no">NULL</span> <span class="o">==</span> <span class="n">type</span> <span class="o">||!</span><span class="n">isDescendant</span><span class="o">(</span><span class="n">node</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC1892" class="line" lang="java">          <span class="n">_currentNode</span> <span class="o">=</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC1893" class="line" lang="java">          <span class="k">return</span> <span class="no">END</span><span class="o">;</span></span>
<span id="LC1894" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1895" class="line" lang="java">      <span class="o">}</span> <span class="k">while</span><span class="o">(</span><span class="no">ATTRIBUTE_NODE</span> <span class="o">==</span> <span class="n">type</span> <span class="o">||</span> <span class="no">TEXT_NODE</span> <span class="o">==</span> <span class="n">type</span></span>
<span id="LC1896" class="line" lang="java">                 <span class="o">||</span> <span class="no">NAMESPACE_NODE</span> <span class="o">==</span> <span class="n">type</span><span class="o">);</span></span>
<span id="LC1897" class="line" lang="java"></span>
<span id="LC1898" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1899" class="line" lang="java">      <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">node</span><span class="o">));</span>  <span class="c1">// make handle.</span></span>
...
<span id="LC1903" class="line" lang="java"><span class="cm">     * Reset.</span></span>
<span id="LC1904" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1905" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1906" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">reset</span><span class="o">()</span></span>
<span id="LC1907" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1908" class="line" lang="java"></span>
<span id="LC1909" class="line" lang="java">    <span class="kd">final</span> <span class="kt">boolean</span> <span class="n">temp</span> <span class="o">=</span> <span class="n">_isRestartable</span><span class="o">;</span></span>
<span id="LC1910" class="line" lang="java"></span>
<span id="LC1911" class="line" lang="java">    <span class="n">_isRestartable</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC1912" class="line" lang="java"></span>
<span id="LC1913" class="line" lang="java">    <span class="n">setStartNode</span><span class="o">(</span><span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">_startNode</span><span class="o">));</span></span>
<span id="LC1914" class="line" lang="java"></span>
<span id="LC1915" class="line" lang="java">    <span class="n">_isRestartable</span> <span class="o">=</span> <span class="n">temp</span><span class="o">;</span></span>
<span id="LC1916" class="line" lang="java"></span>
<span id="LC1917" class="line" lang="java">    <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
<span id="LC1918" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC1919" class="line" lang="java"></span>
<span id="LC1920" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of DescendantIterator</span></span>
<span id="LC1921" class="line" lang="java"></span>
<span id="LC1922" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC1923" class="line" lang="java"><span class="cm">   * Typed iterator that returns the descendants of a given node.</span></span>
<span id="LC1924" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1925" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">TypedDescendantIterator</span> <span class="kd">extends</span> <span class="nc">DescendantIterator</span></span>
<span id="LC1926" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1927" class="line" lang="java"></span>
<span id="LC1928" class="line" lang="java">    <span class="cm">/** The extended type ID that was requested. */</span></span>
<span id="LC1929" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">int</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC1930" class="line" lang="java"></span>
<span id="LC1931" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1932" class="line" lang="java"><span class="cm">     * Constructor TypedDescendantIterator</span></span>
<span id="LC1933" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1934" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1935" class="line" lang="java"><span class="cm">     * @param nodeType Extended type ID being requested.</span></span>
<span id="LC1936" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1937" class="line" lang="java">    <span class="kd">public</span> <span class="nf">TypedDescendantIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">nodeType</span><span class="o">)</span></span>
<span id="LC1938" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1939" class="line" lang="java">      <span class="n">_nodeType</span> <span class="o">=</span> <span class="n">nodeType</span><span class="o">;</span></span>
...
<span id="LC1943" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC1944" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1945" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC1946" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1947" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC1948" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1949" class="line" lang="java">      <span class="kt">int</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1950" class="line" lang="java">      <span class="kt">int</span> <span class="n">type</span><span class="o">;</span></span>
<span id="LC1951" class="line" lang="java"></span>
<span id="LC1952" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_startNode</span> <span class="o">==</span> <span class="no">NULL</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1953" class="line" lang="java">        <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC1954" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1955" class="line" lang="java"></span>
<span id="LC1956" class="line" lang="java">      <span class="n">node</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC1957" class="line" lang="java"></span>
<span id="LC1958" class="line" lang="java">      <span class="k">do</span></span>
<span id="LC1959" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1960" class="line" lang="java">        <span class="n">node</span><span class="o">++;</span></span>
<span id="LC1961" class="line" lang="java">        <span class="n">type</span> <span class="o">=</span> <span class="n">_type</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC1962" class="line" lang="java"></span>
<span id="LC1963" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="no">NULL</span> <span class="o">==</span> <span class="n">type</span> <span class="o">||!</span><span class="n">isDescendant</span><span class="o">(</span><span class="n">node</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC1964" class="line" lang="java">          <span class="n">_currentNode</span> <span class="o">=</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC1965" class="line" lang="java">          <span class="k">return</span> <span class="no">END</span><span class="o">;</span></span>
<span id="LC1966" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1967" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1968" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="n">type</span> <span class="o">!=</span> <span class="n">_nodeType</span> <span class="o">&amp;&amp;</span> <span class="n">_exptype</span><span class="o">(</span><span class="n">node</span><span class="o">)</span> <span class="o">!=</span> <span class="n">_nodeType</span><span class="o">);</span></span>
<span id="LC1969" class="line" lang="java"></span>
<span id="LC1970" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC1971" class="line" lang="java">      <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">makeNodeHandle</span><span class="o">(</span><span class="n">node</span><span class="o">));</span></span>
<span id="LC1972" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1973" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of TypedDescendantIterator</span></span>
<span id="LC1974" class="line" lang="java"></span>
<span id="LC1975" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC1976" class="line" lang="java"><span class="cm">   * Iterator that returns the descendants of a given node.</span></span>
<span id="LC1977" class="line" lang="java"><span class="cm">   * I'm not exactly clear about this one... -sb</span></span>
<span id="LC1978" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1979" class="line" lang="java">  <span class="kd">public</span> <span class="kd">class</span> <span class="nc">NthDescendantIterator</span> <span class="kd">extends</span> <span class="nc">DescendantIterator</span></span>
<span id="LC1980" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1981" class="line" lang="java"></span>
<span id="LC1982" class="line" lang="java">    <span class="cm">/** The current nth position. */</span></span>
<span id="LC1983" class="line" lang="java">    <span class="kt">int</span> <span class="n">_pos</span><span class="o">;</span></span>
<span id="LC1984" class="line" lang="java"></span>
<span id="LC1985" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1986" class="line" lang="java"><span class="cm">     * Constructor NthDescendantIterator</span></span>
<span id="LC1987" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1988" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1989" class="line" lang="java"><span class="cm">     * @param pos The nth position being requested.</span></span>
<span id="LC1990" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1991" class="line" lang="java">    <span class="kd">public</span> <span class="nf">NthDescendantIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">pos</span><span class="o">)</span></span>
<span id="LC1992" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1993" class="line" lang="java">      <span class="n">_pos</span> <span class="o">=</span> <span class="n">pos</span><span class="o">;</span></span>
...
<span id="LC1997" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC1998" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1999" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC2000" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC2001" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC2002" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC2003" class="line" lang="java"></span>
<span id="LC2004" class="line" lang="java">      <span class="c1">// I'm not exactly clear yet what this is doing... -sb</span></span>
<span id="LC2005" class="line" lang="java">      <span class="kt">int</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC2006" class="line" lang="java"></span>
<span id="LC2007" class="line" lang="java">      <span class="k">while</span> <span class="o">((</span><span class="n">node</span> <span class="o">=</span> <span class="kd">super</span><span class="o">.</span><span class="na">next</span><span class="o">())</span> <span class="o">!=</span> <span class="no">END</span><span class="o">)</span></span>
<span id="LC2008" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC2009" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC2010" class="line" lang="java"></span>
<span id="LC2011" class="line" lang="java">        <span class="kt">int</span> <span class="n">parent</span> <span class="o">=</span> <span class="n">_parent</span><span class="o">(</span><span class="n">node</span><span class="o">);</span></span>
<span id="LC2012" class="line" lang="java">        <span class="kt">int</span> <span class="n">child</span> <span class="o">=</span> <span class="n">_firstch</span><span class="o">(</span><span class="n">parent</span><span class="o">);</span></span>
<span id="LC2013" class="line" lang="java">        <span class="kt">int</span> <span class="n">pos</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC2014" class="line" lang="java"></span>
<span id="LC2015" class="line" lang="java">        <span class="k">do</span></span>
<span id="LC2016" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC2017" class="line" lang="java">          <span class="kt">int</span> <span class="n">type</span> <span class="o">=</span> <span class="n">_type</span><span class="o">(</span><span class="n">child</span><span class="o">);</span></span>
<span id="LC2018" class="line" lang="java"></span>
<span id="LC2019" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="no">ELEMENT_NODE</span> <span class="o">==</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC2020" class="line" lang="java">            <span class="n">pos</span><span class="o">++;</span></span>
<span id="LC2021" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC2022" class="line" lang="java">        <span class="k">while</span> <span class="o">((</span><span class="n">pos</span> <span class="o">&lt;</span> <span class="n">_pos</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="o">(</span><span class="n">child</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">child</span><span class="o">))</span> <span class="o">!=</span> <span class="no">END</span><span class="o">);</span></span>
<span id="LC2023" class="line" lang="java"></span>
<span id="LC2024" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="n">child</span><span class="o">)</span></span>
<span id="LC2025" class="line" lang="java">          <span class="k">return</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC2026" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC2027" class="line" lang="java"></span>
<span id="LC2028" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="no">END</span><span class="o">);</span></span>
<span id="LC2029" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC2030" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of NthDescendantIterator</span></span>
<span id="LC2031" class="line" lang="java"></span>
<span id="LC2032" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC2033" class="line" lang="java"><span class="cm">   * Class SingletonIterator.</span></span>
<span id="LC2034" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC2035" class="line" lang="java">  <span class="kd">public</span> <span class="kd">class</span> <span class="nc">SingletonIterator</span> <span class="kd">extends</span> <span class="nc">InternalAxisIteratorBase</span></span>
<span id="LC2036" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC2037" class="line" lang="java"></span>
<span id="LC2038" class="line" lang="java">    <span class="cm">/** (not sure yet what this is.  -sb)  (sc &amp; sb remove final to compile in JDK 1.1.8) */</span></span>
<span id="LC2039" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">_isConstant</span><span class="o">;</span></span>
<span id="LC2040" class="line" lang="java"></span>
<span id="LC2041" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC2042" class="line" lang="java"><span class="cm">     * Constructor SingletonIterator</span></span>
<span id="LC2043" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC2044" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC2045" class="line" lang="java">    <span class="kd">public</span> <span class="nf">SingletonIterator</span><span class="o">()</span></span>
<span id="LC2046" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC2047" class="line" lang="java">      <span class="k">this</span><span class="o">(</span><span class="nc">Integer</span><span class="o">.</span><span class="na">MIN_VALUE</span><span class="o">,</span> <span class="kc">false</span><span class="o">);</span></span>
...
<span id="LC2051" class="line" lang="java"><span class="cm">     * Constructor SingletonIterator</span></span>
<span id="LC2052" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC2053" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC2054" class="line" lang="java"><span class="cm">     * @param node The node handle to return.</span></span>
<span id="LC2055" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC2056" class="line" lang="java">    <span class="kd">public</span> <span class="nf">SingletonIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC2057" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC2058" class="line" lang="java">      <span class="k">this</span><span class="o">(</span><span class="n">node</span><span class="o">,</span> <span class="kc">false</span><span class="o">);</span></span>
...
<span id="LC2062" class="line" lang="java"><span class="cm">     * Constructor SingletonIterator</span></span>
<span id="LC2063" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC2064" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC2065" class="line" lang="java"><span class="cm">     * @param node the node handle to return.</span></span>
<span id="LC2066" class="line" lang="java"><span class="cm">     * @param constant (Not sure what this is yet.  -sb)</span></span>
<span id="LC2067" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC2068" class="line" lang="java">    <span class="kd">public</span> <span class="nf">SingletonIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">constant</span><span class="o">)</span></span>
<span id="LC2069" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC2070" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC2071" class="line" lang="java">      <span class="n">_isConstant</span> <span class="o">=</span> <span class="n">constant</span><span class="o">;</span></span>
...
<span id="LC2075" class="line" lang="java"><span class="cm">     * Set start to END should 'close' the iterator,</span></span>
<span id="LC2076" class="line" lang="java"><span class="cm">     * i.e. subsequent call to next() should return END.</span></span>
<span id="LC2077" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC2078" class="line" lang="java"><span class="cm">     * @param node Sets the root of the iteration.</span></span>
<span id="LC2079" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC2080" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator set to the start of the iteration.</span></span>
<span id="LC2081" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC2082" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">setStartNode</span><span class="o">(</span><span class="kt">int</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC2083" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC2084" class="line" lang="java"><span class="c1">//%HZ%: Added reference to DTMDefaultBase.ROOTNODE back in, temporarily</span></span>
<span id="LC2085" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">node</span> <span class="o">==</span> <span class="nc">DTMDefaultBase</span><span class="o">.</span><span class="na">ROOTNODE</span><span class="o">)</span></span>
<span id="LC2086" class="line" lang="java">        <span class="n">node</span> <span class="o">=</span> <span class="n">getDocument</span><span class="o">();</span></span>
<span id="LC2087" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isConstant</span><span class="o">)</span></span>
<span id="LC2088" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC2089" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">_startNode</span><span class="o">;</span></span>
<span id="LC2090" class="line" lang="java"></span>
<span id="LC2091" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC2092" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC2093" class="line" lang="java">      <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="n">_isRestartable</span><span class="o">)</span></span>
<span id="LC2094" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC2095" class="line" lang="java">          <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">_startNode</span> <span class="o">=</span> <span class="n">node</span><span class="o">;</span></span>
<span id="LC2096" class="line" lang="java"></span>
<span id="LC2097" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC2098" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC2099" class="line" lang="java"></span>
<span id="LC2100" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC2104" class="line" lang="java"><span class="cm">     * Resets the iterator to the last start node.</span></span>
<span id="LC2105" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC2106" class="line" lang="java"><span class="cm">     * @return A DTMAxisIterator, which may or may not be the same as this</span></span>
<span id="LC2107" class="line" lang="java"><span class="cm">     *         iterator.</span></span>
<span id="LC2108" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC2109" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DTMAxisIterator</span> <span class="nf">reset</span><span class="o">()</span></span>
<span id="LC2110" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC2111" class="line" lang="java"></span>
<span id="LC2112" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">_isConstant</span><span class="o">)</span></span>
<span id="LC2113" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC2114" class="line" lang="java">        <span class="n">_currentNode</span> <span class="o">=</span> <span class="n">_startNode</span><span class="o">;</span></span>
<span id="LC2115" class="line" lang="java"></span>
<span id="LC2116" class="line" lang="java">        <span class="k">return</span> <span class="nf">resetPosition</span><span class="o">();</span></span>
<span id="LC2117" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC2118" class="line" lang="java">      <span class="k">else</span></span>
<span id="LC2119" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC2120" class="line" lang="java">        <span class="kd">final</span> <span class="kt">boolean</span> <span class="n">temp</span> <span class="o">=</span> <span class="n">_isRestartable</span><span class="o">;</span></span>
<span id="LC2121" class="line" lang="java"></span>
<span id="LC2122" class="line" lang="java">        <span class="n">_isRestartable</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC2123" class="line" lang="java"></span>
<span id="LC2124" class="line" lang="java">        <span class="n">setStartNode</span><span class="o">(</span><span class="n">_startNode</span><span class="o">);</span></span>
<span id="LC2125" class="line" lang="java"></span>
<span id="LC2126" class="line" lang="java">        <span class="n">_isRestartable</span> <span class="o">=</span> <span class="n">temp</span><span class="o">;</span></span>
<span id="LC2127" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC2128" class="line" lang="java"></span>
<span id="LC2129" class="line" lang="java">      <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC2133" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC2134" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC2135" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC2136" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC2137" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC2138" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC2139" class="line" lang="java"></span>
<span id="LC2140" class="line" lang="java">      <span class="kd">final</span> <span class="kt">int</span> <span class="n">result</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC2141" class="line" lang="java"></span>
<span id="LC2142" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="no">END</span><span class="o">;</span></span>
<span id="LC2143" class="line" lang="java"></span>
<span id="LC2144" class="line" lang="java">      <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">result</span><span class="o">);</span></span>
<span id="LC2145" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC2146" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of SingletonIterator</span></span>
<span id="LC2147" class="line" lang="java"></span>
<span id="LC2148" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC2149" class="line" lang="java"><span class="cm">   * Iterator that returns a given node only if it is of a given type.</span></span>
<span id="LC2150" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC2151" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">TypedSingletonIterator</span> <span class="kd">extends</span> <span class="nc">SingletonIterator</span></span>
<span id="LC2152" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC2153" class="line" lang="java"></span>
<span id="LC2154" class="line" lang="java">    <span class="cm">/** The extended type ID that was requested. */</span></span>
<span id="LC2155" class="line" lang="java">    <span class="kd">private</span> <span class="kd">final</span> <span class="kt">int</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC2156" class="line" lang="java"></span>
<span id="LC2157" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC2158" class="line" lang="java"><span class="cm">     * Constructor TypedSingletonIterator</span></span>
<span id="LC2159" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC2160" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC2161" class="line" lang="java"><span class="cm">     * @param nodeType The extended type ID being requested.</span></span>
<span id="LC2162" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC2163" class="line" lang="java">    <span class="kd">public</span> <span class="nf">TypedSingletonIterator</span><span class="o">(</span><span class="kt">int</span> <span class="n">nodeType</span><span class="o">)</span></span>
<span id="LC2164" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC2165" class="line" lang="java">      <span class="n">_nodeType</span> <span class="o">=</span> <span class="n">nodeType</span><span class="o">;</span></span>
...
<span id="LC2169" class="line" lang="java"><span class="cm">     * Get the next node in the iteration.</span></span>
<span id="LC2170" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC2171" class="line" lang="java"><span class="cm">     * @return The next node handle in the iteration, or END.</span></span>
<span id="LC2172" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC2173" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span></span>
<span id="LC2174" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC2175" class="line" lang="java"></span>
<span id="LC2176" class="line" lang="java">      <span class="c1">//final int result = super.next();</span></span>
<span id="LC2177" class="line" lang="java">      <span class="kd">final</span> <span class="kt">int</span> <span class="n">result</span> <span class="o">=</span> <span class="n">_currentNode</span><span class="o">;</span></span>
<span id="LC2178" class="line" lang="java">      <span class="kt">int</span> <span class="n">nodeType</span> <span class="o">=</span> <span class="n">_nodeType</span><span class="o">;</span></span>
<span id="LC2179" class="line" lang="java"></span>
<span id="LC2180" class="line" lang="java">      <span class="n">_currentNode</span> <span class="o">=</span> <span class="no">END</span><span class="o">;</span></span>
<span id="LC2181" class="line" lang="java"></span>
<span id="LC2182" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">nodeType</span> <span class="o">&gt;=</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NTYPES</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC2183" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">result</span><span class="o">)</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC2184" class="line" lang="java">          <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">result</span><span class="o">);</span></span>
<span id="LC2185" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC2186" class="line" lang="java">      <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC2187" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">getNodeType</span><span class="o">(</span><span class="n">result</span><span class="o">)</span> <span class="o">==</span> <span class="n">nodeType</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC2188" class="line" lang="java">          <span class="k">return</span> <span class="nf">returnNode</span><span class="o">(</span><span class="n">result</span><span class="o">);</span></span>
...
<span id="LC2192" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC2193" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC2194" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// end of TypedSingletonIterator</span></span>
