...
<span id="LC29" class="line" lang="java"><span class="cm"> * Holds the state of the currently serialized element.</span></span>
<span id="LC30" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC31" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC32" class="line" lang="java"><span class="cm"> * @author &lt;a href="mailto:arkin@intalio.com"&gt;Assaf Arkin&lt;/a&gt;</span></span>
<span id="LC33" class="line" lang="java"><span class="cm"> * @see BaseMarkupSerializer</span></span>
<span id="LC34" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC35" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">ElementState</span></span>
...
<span id="LC40" class="line" lang="java"><span class="cm">     * The element's raw tag name (local or prefix:local).</span></span>
<span id="LC41" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC42" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="n">rawName</span><span class="o">;</span></span>
...
<span id="LC46" class="line" lang="java"><span class="cm">     * The element's local tag name.</span></span>
<span id="LC47" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC48" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">;</span></span>
...
<span id="LC52" class="line" lang="java"><span class="cm">     * The element's namespace URI.</span></span>
<span id="LC53" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC54" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">;</span></span>
...
<span id="LC58" class="line" lang="java"><span class="cm">     * True if element is space preserving.</span></span>
<span id="LC59" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC60" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="n">preserveSpace</span><span class="o">;</span></span>
...
<span id="LC64" class="line" lang="java"><span class="cm">     * True if element is empty. Turns false immediately</span></span>
<span id="LC65" class="line" lang="java"><span class="cm">     * after serializing the first contents of the element.</span></span>
<span id="LC66" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC67" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="n">empty</span><span class="o">;</span></span>
...
<span id="LC71" class="line" lang="java"><span class="cm">     * True if the last serialized node was an element node.</span></span>
<span id="LC72" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC73" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="n">afterElement</span><span class="o">;</span></span>
...
<span id="LC77" class="line" lang="java"><span class="cm">     * True if the last serialized node was a comment node.</span></span>
<span id="LC78" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC79" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="n">afterComment</span><span class="o">;</span></span>
...
<span id="LC83" class="line" lang="java"><span class="cm">     * True if textual content of current element should be</span></span>
<span id="LC84" class="line" lang="java"><span class="cm">     * serialized as CDATA section.</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC86" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="n">doCData</span><span class="o">;</span></span>
...
<span id="LC90" class="line" lang="java"><span class="cm">     * True if textual content of current element should be</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">     * serialized as raw characters (unescaped).</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC93" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="n">unescaped</span><span class="o">;</span></span>
...
<span id="LC97" class="line" lang="java"><span class="cm">     * True while inside CData and printing text as CData.</span></span>
<span id="LC98" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC99" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="n">inCData</span><span class="o">;</span></span>
...
<span id="LC103" class="line" lang="java"><span class="cm">     * Association between namespace URIs (keys) and prefixes (values).</span></span>
<span id="LC104" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC105" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Map</span><span class="o">&lt;</span><span class="nc">String</span><span class="o">,</span> <span class="nc">String</span><span class="o">&gt;</span> <span class="n">prefixes</span><span class="o">;</span></span>
