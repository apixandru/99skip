...
<span id="LC43" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">SerializerMessages_it</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span> <span class="o">{</span></span>
...
<span id="LC73" class="line" lang="java">                <span class="s">"La chiave di messaggio ''{0}'' non si trova nella classe messaggio ''{1}''"</span> <span class="o">},</span></span>
...
<span id="LC76" class="line" lang="java">                <span class="s">"Formato di messaggio ''{0}'' in classe messaggio ''{1}'' non riuscito."</span> <span class="o">},</span></span>
...
<span id="LC79" class="line" lang="java">                <span class="s">"La classe serializzatore ''{0}'' non implementa org.xml.sax.ContentHandler."</span> <span class="o">},</span></span>
...
<span id="LC82" class="line" lang="java">                    <span class="s">"Risorsa [ {0} ] non trovata.\n {1}"</span> <span class="o">},</span></span>
...
<span id="LC85" class="line" lang="java">                    <span class="s">"Impossibile caricare la risorsa [ {0} ]: {1} \n {2} \t {3}"</span> <span class="o">},</span></span>
...
<span id="LC88" class="line" lang="java">                    <span class="s">"Dimensione buffer &lt;=0"</span> <span class="o">},</span></span>
...
<span id="LC91" class="line" lang="java">                    <span class="s">"Rilevato surrogato UTF-16 non valido: {0}?"</span> <span class="o">},</span></span>
...
<span id="LC94" class="line" lang="java">                <span class="s">"Errore di I/O"</span> <span class="o">},</span></span>
...
<span id="LC97" class="line" lang="java">                <span class="s">"Impossibile aggiungere l''attributo {0} dopo i nodi figlio o prima che sia prodotto un elemento. L''attributo verr\u00E0 ignorato."</span> <span class="o">},</span></span>
...
<span id="LC105" class="line" lang="java">                <span class="s">"Lo spazio di nomi per il prefisso ''{0}'' non \u00E8 stato dichiarato."</span> <span class="o">},</span></span>
...
<span id="LC114" class="line" lang="java">                <span class="s">"Attributo ''{0}'' al di fuori dell''elemento."</span> <span class="o">},</span></span>
...
<span id="LC124" class="line" lang="java">                <span class="s">"Dichiarazione dello spazio di nomi ''{0}''=''{1}'' al di fuori dell''elemento."</span> <span class="o">},</span></span>
...
<span id="LC127" class="line" lang="java">                <span class="s">"Impossibile caricare ''{0}'' (verificare CLASSPATH); verranno utilizzati i valori predefiniti"</span> <span class="o">},</span></span>
...
<span id="LC130" class="line" lang="java">                <span class="s">"Tentativo di eseguire l''output di un carattere di valore integrale {0} non rappresentato nella codifica di output {1} specificata."</span> <span class="o">},</span></span>
...
<span id="LC133" class="line" lang="java">                <span class="s">"Impossibile caricare il file delle propriet\u00E0 ''{0}'' per il metodo di emissione ''{1}'' (verificare CLASSPATH)"</span> <span class="o">},</span></span>
...
<span id="LC136" class="line" lang="java">                <span class="s">"Numero di porta non valido"</span> <span class="o">},</span></span>
...
<span id="LC139" class="line" lang="java">                <span class="s">"La porta non pu\u00F2 essere impostata se l'host \u00E8 nullo"</span> <span class="o">},</span></span>
...
<span id="LC142" class="line" lang="java">                <span class="s">"Host non \u00E8 un indirizzo corretto"</span> <span class="o">},</span></span>
...
<span id="LC145" class="line" lang="java">                <span class="s">"Lo schema non \u00E8 conforme."</span> <span class="o">},</span></span>
...
<span id="LC148" class="line" lang="java">                <span class="s">"Impossibile impostare lo schema da una stringa nulla"</span> <span class="o">},</span></span>
...
<span id="LC151" class="line" lang="java">                <span class="s">"Il percorso contiene sequenza di escape non valida"</span> <span class="o">},</span></span>
...
<span id="LC154" class="line" lang="java">                <span class="s">"Il percorso contiene un carattere non valido: {0}"</span> <span class="o">},</span></span>
...
<span id="LC157" class="line" lang="java">                <span class="s">"Il frammento contiene un carattere non valido"</span> <span class="o">},</span></span>
...
<span id="LC160" class="line" lang="java">                <span class="s">"Il frammento non pu\u00F2 essere impostato se il percorso \u00E8 nullo"</span> <span class="o">},</span></span>
...
<span id="LC163" class="line" lang="java">                <span class="s">"Il frammento pu\u00F2 essere impostato solo per un URI generico"</span> <span class="o">},</span></span>
...
<span id="LC166" class="line" lang="java">                <span class="s">"Nessuno schema trovato nell'URI"</span> <span class="o">},</span></span>
...
<span id="LC169" class="line" lang="java">                <span class="s">"Impossibile inizializzare l'URI con i parametri vuoti"</span> <span class="o">},</span></span>
...
<span id="LC172" class="line" lang="java">                <span class="s">"Il frammento non pu\u00F2 essere specificato sia nel percorso che nel frammento"</span> <span class="o">},</span></span>
...
<span id="LC175" class="line" lang="java">                <span class="s">"La stringa di query non pu\u00F2 essere specificata nella stringa di percorso e query."</span> <span class="o">},</span></span>
...
<span id="LC178" class="line" lang="java">                <span class="s">"La porta non pu\u00F2 essere specificata se l'host non \u00E8 specificato"</span> <span class="o">},</span></span>
...
<span id="LC181" class="line" lang="java">                <span class="s">"Userinfo non pu\u00F2 essere specificato se l'host non \u00E8 specificato"</span> <span class="o">},</span></span>
...
<span id="LC184" class="line" lang="java">                <span class="s">"Avvertenza: la versione del documento di output deve essere ''{0}''. Questa versione di XML non \u00E8 supportata. La versione del documento di output sar\u00E0 ''1.0''."</span> <span class="o">},</span></span>
...
<span id="LC187" class="line" lang="java">                <span class="s">"Lo schema \u00E8 obbligatorio."</span> <span class="o">},</span></span>
...
<span id="LC195" class="line" lang="java">                <span class="s">"L''oggetto Properties passato a SerializerFactory non dispone di una propriet\u00E0 ''{0}''."</span> <span class="o">},</span></span>
...
<span id="LC198" class="line" lang="java">                <span class="s">"Avvertenza: la codifica ''{0}'' non \u00E8 supportata da Java Runtime."</span> <span class="o">},</span></span>
