...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: NodeConsumer.java,v 1.2.4.1 2005/09/15 08:15:50 suresh_emailid Exp $</span></span>
...
<span id="LC28" class="line" lang="java"><span class="cm"> * The tree walker will test for this interface, and call</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> * setOriginatingNode before calling the SAX event.  For creating</span></span>
<span id="LC30" class="line" lang="java"><span class="cm"> * DOM backpointers for things that are normally created via</span></span>
<span id="LC31" class="line" lang="java"><span class="cm"> * SAX events.</span></span>
<span id="LC32" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC33" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">NodeConsumer</span></span>
...
<span id="LC37" class="line" lang="java"><span class="cm">   * Set the node that is originating the SAX event.</span></span>
<span id="LC38" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">   * @param n Reference to node that originated the current event.</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC41" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOriginatingNode</span><span class="o">(</span><span class="nc">Node</span> <span class="n">n</span><span class="o">);</span></span>
