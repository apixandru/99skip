...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: UnImplNode.java,v</span></span>
...
<span id="LC25" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.res.XMLErrorResources</span><span class="o">;</span></span>
<span id="LC26" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.res.XMLMessages</span><span class="o">;</span></span>
<span id="LC27" class="line" lang="java"></span>
<span id="LC28" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.Attr</span><span class="o">;</span></span>
<span id="LC29" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.CDATASection</span><span class="o">;</span></span>
<span id="LC30" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.Comment</span><span class="o">;</span></span>
<span id="LC31" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.DOMException</span><span class="o">;</span></span>
<span id="LC32" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.DOMImplementation</span><span class="o">;</span></span>
<span id="LC33" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.Document</span><span class="o">;</span></span>
<span id="LC34" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.DocumentFragment</span><span class="o">;</span></span>
<span id="LC35" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.DocumentType</span><span class="o">;</span></span>
<span id="LC36" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.Element</span><span class="o">;</span></span>
<span id="LC37" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.EntityReference</span><span class="o">;</span></span>
<span id="LC38" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.NamedNodeMap</span><span class="o">;</span></span>
<span id="LC39" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.Node</span><span class="o">;</span></span>
<span id="LC40" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.NodeList</span><span class="o">;</span></span>
<span id="LC41" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.ProcessingInstruction</span><span class="o">;</span></span>
<span id="LC42" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.Text</span><span class="o">;</span></span>
<span id="LC43" class="line" lang="java"></span>
<span id="LC44" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.UserDataHandler</span><span class="o">;</span></span>
<span id="LC45" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.DOMConfiguration</span><span class="o">;</span></span>
<span id="LC46" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.TypeInfo</span><span class="o">;</span></span>
<span id="LC47" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> * &lt;meta name="usage" content="internal"/&gt;</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> * To be subclassed by classes that wish to fake being nodes.</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC51" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">UnImplNode</span> <span class="kd">implements</span> <span class="nc">Node</span><span class="o">,</span> <span class="nc">Element</span><span class="o">,</span> <span class="nc">NodeList</span><span class="o">,</span> <span class="nc">Document</span></span>
...
<span id="LC55" class="line" lang="java"><span class="cm">   * Constructor UnImplNode</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC58" class="line" lang="java">  <span class="kd">public</span> <span class="nf">UnImplNode</span><span class="o">(){}</span></span>
<span id="LC59" class="line" lang="java"></span>
<span id="LC60" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC61" class="line" lang="java"><span class="cm">   * Throw an error.</span></span>
<span id="LC62" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC63" class="line" lang="java"><span class="cm">   * @param msg Message Key for the error</span></span>
<span id="LC64" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC65" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">error</span><span class="o">(</span><span class="nc">String</span> <span class="n">msg</span><span class="o">)</span></span>
<span id="LC66" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC67" class="line" lang="java"></span>
<span id="LC68" class="line" lang="java">    <span class="nc">System</span><span class="o">.</span><span class="na">out</span><span class="o">.</span><span class="na">println</span><span class="o">(</span><span class="s">"DOM ERROR! class: "</span> <span class="o">+</span> <span class="k">this</span><span class="o">.</span><span class="na">getClass</span><span class="o">().</span><span class="na">getName</span><span class="o">());</span></span>
<span id="LC69" class="line" lang="java"></span>
<span id="LC70" class="line" lang="java">    <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XMLMessages</span><span class="o">.</span><span class="na">createXMLMessage</span><span class="o">(</span><span class="n">msg</span><span class="o">,</span> <span class="kc">null</span><span class="o">));</span></span>
...
<span id="LC74" class="line" lang="java"><span class="cm">   * Throw an error.</span></span>
<span id="LC75" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC76" class="line" lang="java"><span class="cm">   * @param msg Message Key for the error</span></span>
<span id="LC77" class="line" lang="java"><span class="cm">   * @param args Array of arguments to be used in the error message</span></span>
<span id="LC78" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC79" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">error</span><span class="o">(</span><span class="nc">String</span> <span class="n">msg</span><span class="o">,</span> <span class="nc">Object</span><span class="o">[]</span> <span class="n">args</span><span class="o">)</span></span>
<span id="LC80" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC81" class="line" lang="java"></span>
<span id="LC82" class="line" lang="java">    <span class="nc">System</span><span class="o">.</span><span class="na">out</span><span class="o">.</span><span class="na">println</span><span class="o">(</span><span class="s">"DOM ERROR! class: "</span> <span class="o">+</span> <span class="k">this</span><span class="o">.</span><span class="na">getClass</span><span class="o">().</span><span class="na">getName</span><span class="o">());</span></span>
<span id="LC83" class="line" lang="java"></span>
<span id="LC84" class="line" lang="java">    <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="nc">XMLMessages</span><span class="o">.</span><span class="na">createXMLMessage</span><span class="o">(</span><span class="n">msg</span><span class="o">,</span> <span class="n">args</span><span class="o">));</span>  <span class="c1">//"UnImplNode error: "+msg);</span></span>
...
<span id="LC88" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">   * @param newChild New node to append to the list of this node's children</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC95" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC96" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">appendChild</span><span class="o">(</span><span class="nc">Node</span> <span class="n">newChild</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC97" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC98" class="line" lang="java"></span>
<span id="LC99" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"appendChild not supported!");</span></span>
...
<span id="LC105" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC106" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">   * @return false</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC109" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">hasChildNodes</span><span class="o">()</span></span>
<span id="LC110" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC111" class="line" lang="java"></span>
<span id="LC112" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"hasChildNodes not supported!");</span></span>
<span id="LC113" class="line" lang="java"></span>
<span id="LC114" class="line" lang="java">    <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC118" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC119" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC120" class="line" lang="java"><span class="cm">   * @return 0</span></span>
<span id="LC121" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC122" class="line" lang="java">  <span class="kd">public</span> <span class="kt">short</span> <span class="nf">getNodeType</span><span class="o">()</span></span>
<span id="LC123" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC124" class="line" lang="java"></span>
<span id="LC125" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getNodeType not supported!");</span></span>
<span id="LC126" class="line" lang="java"></span>
<span id="LC127" class="line" lang="java">    <span class="k">return</span> <span class="mi">0</span><span class="o">;</span></span>
...
<span id="LC131" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC132" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC133" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC134" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC135" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">getParentNode</span><span class="o">()</span></span>
<span id="LC136" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC137" class="line" lang="java"></span>
<span id="LC138" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getParentNode not supported!");</span></span>
<span id="LC139" class="line" lang="java"></span>
<span id="LC140" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC144" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC147" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC148" class="line" lang="java">  <span class="kd">public</span> <span class="nc">NodeList</span> <span class="nf">getChildNodes</span><span class="o">()</span></span>
<span id="LC149" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC150" class="line" lang="java"></span>
<span id="LC151" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getChildNodes not supported!");</span></span>
<span id="LC152" class="line" lang="java"></span>
<span id="LC153" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC157" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC158" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC159" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC160" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC161" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">getFirstChild</span><span class="o">()</span></span>
<span id="LC162" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC163" class="line" lang="java"></span>
<span id="LC164" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getFirstChild not supported!");</span></span>
<span id="LC165" class="line" lang="java"></span>
<span id="LC166" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC170" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC171" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC172" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC173" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC174" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">getLastChild</span><span class="o">()</span></span>
<span id="LC175" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC176" class="line" lang="java"></span>
<span id="LC177" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getLastChild not supported!");</span></span>
<span id="LC178" class="line" lang="java"></span>
<span id="LC179" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC183" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC184" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC185" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC186" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC187" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">getNextSibling</span><span class="o">()</span></span>
<span id="LC188" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC189" class="line" lang="java"></span>
<span id="LC190" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getNextSibling not supported!");</span></span>
<span id="LC191" class="line" lang="java"></span>
<span id="LC192" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC196" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.NodeList</span></span>
<span id="LC197" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">   * @return 0</span></span>
<span id="LC199" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC200" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getLength</span><span class="o">()</span></span>
<span id="LC201" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC202" class="line" lang="java"></span>
<span id="LC203" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getLength not supported!");</span></span>
...
<span id="LC206" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// getLength():int</span></span>
<span id="LC207" class="line" lang="java"></span>
<span id="LC208" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC209" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.NodeList</span></span>
<span id="LC210" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC211" class="line" lang="java"><span class="cm">   * @param index index of a child of this node in its list of children</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC213" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC214" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC215" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">item</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span></span>
<span id="LC216" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC217" class="line" lang="java"></span>
<span id="LC218" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"item not supported!");</span></span>
<span id="LC219" class="line" lang="java"></span>
<span id="LC220" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC221" class="line" lang="java">  <span class="o">}</span>  <span class="c1">// item(int):Node</span></span>
<span id="LC222" class="line" lang="java"></span>
<span id="LC223" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC224" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC225" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC226" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC227" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC228" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Document</span> <span class="nf">getOwnerDocument</span><span class="o">()</span></span>
<span id="LC229" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC230" class="line" lang="java"></span>
<span id="LC231" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getOwnerDocument not supported!");</span></span>
<span id="LC232" class="line" lang="java"></span>
<span id="LC233" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC237" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC238" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC239" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC240" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC241" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getTagName</span><span class="o">()</span></span>
<span id="LC242" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC243" class="line" lang="java"></span>
<span id="LC244" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getTagName not supported!");</span></span>
...
<span id="LC250" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC251" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC252" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC253" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC254" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getNodeName</span><span class="o">()</span></span>
<span id="LC255" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC256" class="line" lang="java"></span>
<span id="LC257" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getNodeName not supported!");</span></span>
<span id="LC258" class="line" lang="java"></span>
<span id="LC259" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC260" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC261" class="line" lang="java"></span>
<span id="LC262" class="line" lang="java">  <span class="cm">/** Unimplemented. See org.w3c.dom.Node */</span></span>
<span id="LC263" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">normalize</span><span class="o">()</span></span>
<span id="LC264" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC265" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"normalize not supported!");</span></span>
...
<span id="LC269" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Element</span></span>
<span id="LC270" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC271" class="line" lang="java"><span class="cm">   * @param name Name of the element</span></span>
<span id="LC272" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC273" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC274" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC275" class="line" lang="java">  <span class="kd">public</span> <span class="nc">NodeList</span> <span class="nf">getElementsByTagName</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span></span>
<span id="LC276" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC277" class="line" lang="java"></span>
<span id="LC278" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getElementsByTagName not supported!");</span></span>
...
<span id="LC284" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Element</span></span>
<span id="LC285" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC286" class="line" lang="java"><span class="cm">   * @param oldAttr Attribute to be removed from this node's list of attributes</span></span>
<span id="LC287" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC288" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC291" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC292" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Attr</span> <span class="nf">removeAttributeNode</span><span class="o">(</span><span class="nc">Attr</span> <span class="n">oldAttr</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC293" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC294" class="line" lang="java"></span>
<span id="LC295" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"removeAttributeNode not supported!");</span></span>
...
<span id="LC301" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Element</span></span>
<span id="LC302" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC303" class="line" lang="java"><span class="cm">   * @param newAttr Attribute node to be added to this node's list of attributes</span></span>
<span id="LC304" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC305" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC306" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC307" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC308" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC309" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Attr</span> <span class="nf">setAttributeNode</span><span class="o">(</span><span class="nc">Attr</span> <span class="n">newAttr</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC310" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC311" class="line" lang="java"></span>
<span id="LC312" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"setAttributeNode not supported!");</span></span>
<span id="LC313" class="line" lang="java"></span>
<span id="LC314" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC318" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Element</span></span>
<span id="LC319" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC320" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC321" class="line" lang="java"><span class="cm">   * @param name Name of an attribute</span></span>
<span id="LC322" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC323" class="line" lang="java"><span class="cm">   * @return false</span></span>
<span id="LC324" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC325" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">hasAttribute</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span></span>
<span id="LC326" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC327" class="line" lang="java"></span>
<span id="LC328" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"hasAttribute not supported!");</span></span>
...
<span id="LC334" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Element</span></span>
<span id="LC335" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC336" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC337" class="line" lang="java"><span class="cm">   * @param name</span></span>
<span id="LC338" class="line" lang="java"><span class="cm">   * @param x</span></span>
<span id="LC339" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC340" class="line" lang="java"><span class="cm">   * @return false</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC342" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">hasAttributeNS</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="nc">String</span> <span class="n">x</span><span class="o">)</span></span>
<span id="LC343" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC344" class="line" lang="java"></span>
<span id="LC345" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"hasAttributeNS not supported!");</span></span>
<span id="LC346" class="line" lang="java"></span>
<span id="LC347" class="line" lang="java">    <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC351" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Element</span></span>
<span id="LC352" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC353" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC354" class="line" lang="java"><span class="cm">   * @param name Attribute node name</span></span>
<span id="LC355" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC356" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC357" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC358" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Attr</span> <span class="nf">getAttributeNode</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span></span>
<span id="LC359" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC360" class="line" lang="java"></span>
<span id="LC361" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getAttributeNode not supported!");</span></span>
...
<span id="LC367" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Element</span></span>
<span id="LC368" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC369" class="line" lang="java"><span class="cm">   * @param name Attribute node name to remove from list of attributes</span></span>
<span id="LC370" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC371" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC372" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC373" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">removeAttribute</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC374" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC375" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"removeAttribute not supported!");</span></span>
...
<span id="LC379" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Element</span></span>
<span id="LC380" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC381" class="line" lang="java"><span class="cm">   * @param name Name of attribute to set</span></span>
<span id="LC382" class="line" lang="java"><span class="cm">   * @param value Value of attribute</span></span>
<span id="LC383" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC384" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC385" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC386" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setAttribute</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="nc">String</span> <span class="n">value</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC387" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC388" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"setAttribute not supported!");</span></span>
...
<span id="LC392" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Element</span></span>
<span id="LC393" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC394" class="line" lang="java"><span class="cm">   * @param name Name of attribute to get</span></span>
<span id="LC395" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC396" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC397" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC398" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getAttribute</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span></span>
<span id="LC399" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC400" class="line" lang="java"></span>
<span id="LC401" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getAttribute not supported!");</span></span>
...
<span id="LC407" class="line" lang="java"><span class="cm">   * Unimplemented. Introduced in DOM Level 2.</span></span>
<span id="LC408" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC409" class="line" lang="java"><span class="cm">   * @return false</span></span>
<span id="LC410" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC411" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">hasAttributes</span><span class="o">()</span></span>
<span id="LC412" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC413" class="line" lang="java"></span>
<span id="LC414" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"hasAttributes not supported!");</span></span>
<span id="LC415" class="line" lang="java"></span>
<span id="LC416" class="line" lang="java">    <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC420" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Element</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">   * @param namespaceURI Namespace URI of the element</span></span>
<span id="LC423" class="line" lang="java"><span class="cm">   * @param localName Local part of qualified name of the element</span></span>
<span id="LC424" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC425" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC427" class="line" lang="java">  <span class="kd">public</span> <span class="nc">NodeList</span> <span class="nf">getElementsByTagNameNS</span><span class="o">(</span><span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">,</span></span>
<span id="LC428" class="line" lang="java">                                         <span class="nc">String</span> <span class="n">localName</span><span class="o">)</span></span>
<span id="LC429" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC430" class="line" lang="java"></span>
<span id="LC431" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getElementsByTagNameNS not supported!");</span></span>
<span id="LC432" class="line" lang="java"></span>
<span id="LC433" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC437" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Element</span></span>
<span id="LC438" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC439" class="line" lang="java"><span class="cm">   * @param newAttr Attribute to set</span></span>
<span id="LC440" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC441" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC442" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC443" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC444" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC445" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Attr</span> <span class="nf">setAttributeNodeNS</span><span class="o">(</span><span class="nc">Attr</span> <span class="n">newAttr</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC446" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC447" class="line" lang="java"></span>
<span id="LC448" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"setAttributeNodeNS not supported!");</span></span>
<span id="LC449" class="line" lang="java"></span>
<span id="LC450" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC454" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Element</span></span>
<span id="LC455" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC456" class="line" lang="java"><span class="cm">   * @param namespaceURI Namespace URI of attribute node to get</span></span>
<span id="LC457" class="line" lang="java"><span class="cm">   * @param localName Local part of qualified name of attribute node to get</span></span>
<span id="LC458" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC459" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC460" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC461" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Attr</span> <span class="nf">getAttributeNodeNS</span><span class="o">(</span><span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">,</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">)</span></span>
<span id="LC462" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC463" class="line" lang="java"></span>
<span id="LC464" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getAttributeNodeNS not supported!");</span></span>
<span id="LC465" class="line" lang="java"></span>
<span id="LC466" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC470" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Element</span></span>
<span id="LC471" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC472" class="line" lang="java"><span class="cm">   * @param namespaceURI Namespace URI of attribute node to remove</span></span>
<span id="LC473" class="line" lang="java"><span class="cm">   * @param localName Local part of qualified name of attribute node to remove</span></span>
<span id="LC474" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC475" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC476" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC477" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">removeAttributeNS</span><span class="o">(</span><span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">,</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">)</span></span>
<span id="LC478" class="line" lang="java">          <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC479" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC480" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"removeAttributeNS not supported!");</span></span>
...
<span id="LC484" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Element</span></span>
<span id="LC485" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC486" class="line" lang="java"><span class="cm">   * @param namespaceURI Namespace URI of attribute node to set</span></span>
<span id="LC487" class="line" lang="java"><span class="cm">   * @param qualifiedName qualified name of attribute</span></span>
<span id="LC488" class="line" lang="java"><span class="cm">   * @param value value of attribute</span></span>
<span id="LC489" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC490" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC491" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC492" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setAttributeNS</span><span class="o">(</span></span>
<span id="LC493" class="line" lang="java">          <span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">,</span> <span class="nc">String</span> <span class="n">qualifiedName</span><span class="o">,</span> <span class="nc">String</span> <span class="n">value</span><span class="o">)</span></span>
<span id="LC494" class="line" lang="java">            <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC495" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC496" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"setAttributeNS not supported!");</span></span>
...
<span id="LC500" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Element</span></span>
<span id="LC501" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC502" class="line" lang="java"><span class="cm">   * @param namespaceURI Namespace URI of attribute node to get</span></span>
<span id="LC503" class="line" lang="java"><span class="cm">   * @param localName Local part of qualified name of attribute node to get</span></span>
<span id="LC504" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC505" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC506" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC507" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getAttributeNS</span><span class="o">(</span><span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">,</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">)</span></span>
<span id="LC508" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC509" class="line" lang="java"></span>
<span id="LC510" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getAttributeNS not supported!");</span></span>
...
<span id="LC516" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC517" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC518" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC519" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC520" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">getPreviousSibling</span><span class="o">()</span></span>
<span id="LC521" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC522" class="line" lang="java"></span>
<span id="LC523" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getPreviousSibling not supported!");</span></span>
<span id="LC524" class="line" lang="java"></span>
<span id="LC525" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC529" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC530" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC531" class="line" lang="java"><span class="cm">   * @param deep Flag indicating whether to clone deep (clone member variables)</span></span>
<span id="LC532" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC533" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC534" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC535" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">cloneNode</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">deep</span><span class="o">)</span></span>
<span id="LC536" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC537" class="line" lang="java"></span>
<span id="LC538" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"cloneNode not supported!");</span></span>
<span id="LC539" class="line" lang="java"></span>
<span id="LC540" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC544" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC545" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC546" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC547" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC548" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC549" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC550" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getNodeValue</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC551" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC552" class="line" lang="java"></span>
<span id="LC553" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getNodeValue not supported!");</span></span>
<span id="LC554" class="line" lang="java"></span>
<span id="LC555" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC559" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC560" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC561" class="line" lang="java"><span class="cm">   * @param nodeValue Value to set this node to</span></span>
<span id="LC562" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC563" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC564" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC565" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setNodeValue</span><span class="o">(</span><span class="nc">String</span> <span class="n">nodeValue</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC566" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC567" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"setNodeValue not supported!");</span></span>
...
<span id="LC571" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC572" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC573" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC574" class="line" lang="java"><span class="cm">   * NEEDSDOC @param value</span></span>
<span id="LC575" class="line" lang="java"><span class="cm">   * @return value Node value</span></span>
<span id="LC576" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC577" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC578" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC579" class="line" lang="java"></span>
<span id="LC580" class="line" lang="java">  <span class="c1">// public String getValue ()</span></span>
<span id="LC581" class="line" lang="java">  <span class="c1">// {</span></span>
<span id="LC582" class="line" lang="java">  <span class="c1">//  error(XMLErrorResources.ER_FUNCTION_NOT_SUPPORTED); //"getValue not supported!");</span></span>
<span id="LC583" class="line" lang="java">  <span class="c1">//  return null;</span></span>
...
<span id="LC587" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC588" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC589" class="line" lang="java"><span class="cm">   * @param value Value to set this node to</span></span>
<span id="LC590" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC591" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC592" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC593" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setValue</span><span class="o">(</span><span class="nc">String</span> <span class="n">value</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC594" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC595" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"setValue not supported!");</span></span>
...
<span id="LC599" class="line" lang="java"><span class="cm">   *  Returns the name of this attribute.</span></span>
<span id="LC600" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC601" class="line" lang="java"><span class="cm">   * @return the name of this attribute.</span></span>
<span id="LC602" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC603" class="line" lang="java"></span>
<span id="LC604" class="line" lang="java">  <span class="c1">// public String getName()</span></span>
<span id="LC605" class="line" lang="java">  <span class="c1">// {</span></span>
<span id="LC606" class="line" lang="java">  <span class="c1">//  return this.getNodeName();</span></span>
<span id="LC607" class="line" lang="java">  <span class="c1">// }</span></span>
<span id="LC608" class="line" lang="java"></span>
<span id="LC609" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC610" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC611" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC612" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC613" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC614" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Element</span> <span class="nf">getOwnerElement</span><span class="o">()</span></span>
<span id="LC615" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC616" class="line" lang="java"></span>
<span id="LC617" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getOwnerElement not supported!");</span></span>
<span id="LC618" class="line" lang="java"></span>
<span id="LC619" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC623" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC624" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC625" class="line" lang="java"><span class="cm">   * @return False</span></span>
<span id="LC626" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC627" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getSpecified</span><span class="o">()</span></span>
<span id="LC628" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC629" class="line" lang="java"></span>
<span id="LC630" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"setValue not supported!");</span></span>
<span id="LC631" class="line" lang="java"></span>
<span id="LC632" class="line" lang="java">    <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC636" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC637" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC638" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC639" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC640" class="line" lang="java">  <span class="kd">public</span> <span class="nc">NamedNodeMap</span> <span class="nf">getAttributes</span><span class="o">()</span></span>
<span id="LC641" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC642" class="line" lang="java"></span>
<span id="LC643" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getAttributes not supported!");</span></span>
...
<span id="LC649" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC650" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC651" class="line" lang="java"><span class="cm">   * @param newChild New child node to insert</span></span>
<span id="LC652" class="line" lang="java"><span class="cm">   * @param refChild Insert in front of this child</span></span>
<span id="LC653" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC654" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC655" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC656" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC657" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC658" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">insertBefore</span><span class="o">(</span><span class="nc">Node</span> <span class="n">newChild</span><span class="o">,</span> <span class="nc">Node</span> <span class="n">refChild</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC659" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC660" class="line" lang="java"></span>
<span id="LC661" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"insertBefore not supported!");</span></span>
...
<span id="LC667" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC668" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC669" class="line" lang="java"><span class="cm">   * @param newChild Replace existing child with this one</span></span>
<span id="LC670" class="line" lang="java"><span class="cm">   * @param oldChild Existing child to be replaced</span></span>
<span id="LC671" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC672" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC673" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC674" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC675" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC676" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">replaceChild</span><span class="o">(</span><span class="nc">Node</span> <span class="n">newChild</span><span class="o">,</span> <span class="nc">Node</span> <span class="n">oldChild</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC677" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC678" class="line" lang="java"></span>
<span id="LC679" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"replaceChild not supported!");</span></span>
...
<span id="LC685" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC686" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC687" class="line" lang="java"><span class="cm">   * @param oldChild Child to be removed</span></span>
<span id="LC688" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC689" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC690" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC691" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC692" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC693" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">removeChild</span><span class="o">(</span><span class="nc">Node</span> <span class="n">oldChild</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC694" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC695" class="line" lang="java"></span>
<span id="LC696" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"replaceChild not supported!");</span></span>
<span id="LC697" class="line" lang="java"></span>
<span id="LC698" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC702" class="line" lang="java"><span class="cm">   * Tests whether the DOM implementation implements a specific feature and</span></span>
<span id="LC703" class="line" lang="java"><span class="cm">   * that feature is supported by this node.</span></span>
<span id="LC704" class="line" lang="java"><span class="cm">   * @param feature The name of the feature to test. This is the same name</span></span>
<span id="LC705" class="line" lang="java"><span class="cm">   *   which can be passed to the method &lt;code&gt;hasFeature&lt;/code&gt; on</span></span>
<span id="LC706" class="line" lang="java"><span class="cm">   *   &lt;code&gt;DOMImplementation&lt;/code&gt;.</span></span>
<span id="LC707" class="line" lang="java"><span class="cm">   * @param version This is the version number of the feature to test. In</span></span>
<span id="LC708" class="line" lang="java"><span class="cm">   *   Level 2, version 1, this is the string "2.0". If the version is not</span></span>
<span id="LC709" class="line" lang="java"><span class="cm">   *   specified, supporting any version of the feature will cause the</span></span>
<span id="LC710" class="line" lang="java"><span class="cm">   *   method to return &lt;code&gt;true&lt;/code&gt;.</span></span>
<span id="LC711" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC712" class="line" lang="java"><span class="cm">   * @return Returns &lt;code&gt;false&lt;/code&gt;</span></span>
<span id="LC713" class="line" lang="java"><span class="cm">   * @since DOM Level 2</span></span>
<span id="LC714" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC715" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isSupported</span><span class="o">(</span><span class="nc">String</span> <span class="n">feature</span><span class="o">,</span> <span class="nc">String</span> <span class="n">version</span><span class="o">)</span></span>
<span id="LC716" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC717" class="line" lang="java">    <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC721" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC722" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC723" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC724" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC725" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getNamespaceURI</span><span class="o">()</span></span>
<span id="LC726" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC727" class="line" lang="java"></span>
<span id="LC728" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getNamespaceURI not supported!");</span></span>
...
<span id="LC734" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC735" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC736" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC737" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC738" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPrefix</span><span class="o">()</span></span>
<span id="LC739" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC740" class="line" lang="java"></span>
<span id="LC741" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getPrefix not supported!");</span></span>
<span id="LC742" class="line" lang="java"></span>
<span id="LC743" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC747" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC748" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC749" class="line" lang="java"><span class="cm">   * @param prefix Prefix to set for this node</span></span>
<span id="LC750" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC751" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC752" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC753" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setPrefix</span><span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC754" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC755" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"setPrefix not supported!");</span></span>
...
<span id="LC759" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Node</span></span>
<span id="LC760" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC761" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC762" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC763" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getLocalName</span><span class="o">()</span></span>
<span id="LC764" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC765" class="line" lang="java"></span>
<span id="LC766" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span>  <span class="c1">//"getLocalName not supported!");</span></span>
<span id="LC767" class="line" lang="java"></span>
<span id="LC768" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC772" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Document</span></span>
<span id="LC773" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC774" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC775" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC776" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DocumentType</span> <span class="nf">getDoctype</span><span class="o">()</span></span>
<span id="LC777" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC778" class="line" lang="java"></span>
<span id="LC779" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
<span id="LC780" class="line" lang="java"></span>
<span id="LC781" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC785" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Document</span></span>
<span id="LC786" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC787" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC788" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC789" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DOMImplementation</span> <span class="nf">getImplementation</span><span class="o">()</span></span>
<span id="LC790" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC791" class="line" lang="java"></span>
<span id="LC792" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
<span id="LC793" class="line" lang="java"></span>
<span id="LC794" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC798" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Document</span></span>
<span id="LC799" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC800" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC801" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC802" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Element</span> <span class="nf">getDocumentElement</span><span class="o">()</span></span>
<span id="LC803" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC804" class="line" lang="java"></span>
<span id="LC805" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
<span id="LC806" class="line" lang="java"></span>
<span id="LC807" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC811" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Document</span></span>
<span id="LC812" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC813" class="line" lang="java"><span class="cm">   * @param tagName Element tag name</span></span>
<span id="LC814" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC815" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC816" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC817" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC818" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC819" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Element</span> <span class="nf">createElement</span><span class="o">(</span><span class="nc">String</span> <span class="n">tagName</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC820" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC821" class="line" lang="java"></span>
<span id="LC822" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
<span id="LC823" class="line" lang="java"></span>
<span id="LC824" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC828" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Document</span></span>
<span id="LC829" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC830" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC831" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC832" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DocumentFragment</span> <span class="nf">createDocumentFragment</span><span class="o">()</span></span>
<span id="LC833" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC834" class="line" lang="java"></span>
<span id="LC835" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
<span id="LC836" class="line" lang="java"></span>
<span id="LC837" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC841" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Document</span></span>
<span id="LC842" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC843" class="line" lang="java"><span class="cm">   * @param data Data for text node</span></span>
<span id="LC844" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC845" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC846" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC847" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Text</span> <span class="nf">createTextNode</span><span class="o">(</span><span class="nc">String</span> <span class="n">data</span><span class="o">)</span></span>
<span id="LC848" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC849" class="line" lang="java"></span>
<span id="LC850" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
<span id="LC851" class="line" lang="java"></span>
<span id="LC852" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC856" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Document</span></span>
<span id="LC857" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC858" class="line" lang="java"><span class="cm">   * @param data Data for comment</span></span>
<span id="LC859" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC860" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC861" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC862" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Comment</span> <span class="nf">createComment</span><span class="o">(</span><span class="nc">String</span> <span class="n">data</span><span class="o">)</span></span>
<span id="LC863" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC864" class="line" lang="java"></span>
<span id="LC865" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
<span id="LC866" class="line" lang="java"></span>
<span id="LC867" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC871" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Document</span></span>
<span id="LC872" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC873" class="line" lang="java"><span class="cm">   * @param data Data for CDATA section</span></span>
<span id="LC874" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC875" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC876" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC877" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC878" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC879" class="line" lang="java">  <span class="kd">public</span> <span class="nc">CDATASection</span> <span class="nf">createCDATASection</span><span class="o">(</span><span class="nc">String</span> <span class="n">data</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC880" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC881" class="line" lang="java"></span>
<span id="LC882" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC888" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Document</span></span>
<span id="LC889" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC890" class="line" lang="java"><span class="cm">   * @param target Target for Processing instruction</span></span>
<span id="LC891" class="line" lang="java"><span class="cm">   * @param data Data for Processing instruction</span></span>
<span id="LC892" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC893" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC894" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC895" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC896" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC897" class="line" lang="java">  <span class="kd">public</span> <span class="nc">ProcessingInstruction</span> <span class="nf">createProcessingInstruction</span><span class="o">(</span></span>
<span id="LC898" class="line" lang="java">          <span class="nc">String</span> <span class="n">target</span><span class="o">,</span> <span class="nc">String</span> <span class="n">data</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC899" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC900" class="line" lang="java"></span>
<span id="LC901" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC907" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Document</span></span>
<span id="LC908" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC909" class="line" lang="java"><span class="cm">   * @param name Attribute name</span></span>
<span id="LC910" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC911" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC912" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC913" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC914" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC915" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Attr</span> <span class="nf">createAttribute</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC916" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC917" class="line" lang="java"></span>
<span id="LC918" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC924" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Document</span></span>
<span id="LC925" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC926" class="line" lang="java"><span class="cm">   * @param name Entity Reference name</span></span>
<span id="LC927" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC928" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC929" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC930" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC931" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC932" class="line" lang="java">  <span class="kd">public</span> <span class="nc">EntityReference</span> <span class="nf">createEntityReference</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span></span>
<span id="LC933" class="line" lang="java">          <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC934" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC935" class="line" lang="java"></span>
<span id="LC936" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC942" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Document</span></span>
<span id="LC943" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC944" class="line" lang="java"><span class="cm">   * @param importedNode The node to import.</span></span>
<span id="LC945" class="line" lang="java"><span class="cm">   * @param deep If &lt;code&gt;true&lt;/code&gt;, recursively import the subtree under</span></span>
<span id="LC946" class="line" lang="java"><span class="cm">   *   the specified node; if &lt;code&gt;false&lt;/code&gt;, import only the node</span></span>
<span id="LC947" class="line" lang="java"><span class="cm">   *   itself, as explained above. This has no effect on &lt;code&gt;Attr&lt;/code&gt;</span></span>
<span id="LC948" class="line" lang="java"><span class="cm">   *   , &lt;code&gt;EntityReference&lt;/code&gt;, and &lt;code&gt;Notation&lt;/code&gt; nodes.</span></span>
<span id="LC949" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC950" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC951" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC952" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC953" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC954" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">importNode</span><span class="o">(</span><span class="nc">Node</span> <span class="n">importedNode</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">deep</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC955" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC956" class="line" lang="java"></span>
<span id="LC957" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
<span id="LC958" class="line" lang="java"></span>
<span id="LC959" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC963" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Document</span></span>
<span id="LC964" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC965" class="line" lang="java"><span class="cm">   * @param namespaceURI Namespace URI for the element</span></span>
<span id="LC966" class="line" lang="java"><span class="cm">   * @param qualifiedName Qualified name of the element</span></span>
<span id="LC967" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC968" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC969" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC970" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC971" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC972" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Element</span> <span class="nf">createElementNS</span><span class="o">(</span><span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">,</span> <span class="nc">String</span> <span class="n">qualifiedName</span><span class="o">)</span></span>
<span id="LC973" class="line" lang="java">          <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC974" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC975" class="line" lang="java"></span>
<span id="LC976" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
<span id="LC977" class="line" lang="java"></span>
<span id="LC978" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC982" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Document</span></span>
<span id="LC983" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC984" class="line" lang="java"><span class="cm">   * @param namespaceURI Namespace URI of the attribute</span></span>
<span id="LC985" class="line" lang="java"><span class="cm">   * @param qualifiedName Qualified name of the attribute</span></span>
<span id="LC986" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC987" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC988" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC989" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC990" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC991" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Attr</span> <span class="nf">createAttributeNS</span><span class="o">(</span><span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">,</span> <span class="nc">String</span> <span class="n">qualifiedName</span><span class="o">)</span></span>
<span id="LC992" class="line" lang="java">          <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC993" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC994" class="line" lang="java"></span>
<span id="LC995" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC1001" class="line" lang="java"><span class="cm">   * Unimplemented. See org.w3c.dom.Document</span></span>
<span id="LC1002" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1003" class="line" lang="java"><span class="cm">   * @param elementId ID of the element to get</span></span>
<span id="LC1004" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1005" class="line" lang="java"><span class="cm">   * @return null</span></span>
<span id="LC1006" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1007" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Element</span> <span class="nf">getElementById</span><span class="o">(</span><span class="nc">String</span> <span class="n">elementId</span><span class="o">)</span></span>
<span id="LC1008" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1009" class="line" lang="java"></span>
<span id="LC1010" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC1016" class="line" lang="java"><span class="cm">   * Set Node data</span></span>
<span id="LC1017" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1018" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1019" class="line" lang="java"><span class="cm">   * @param data data to set for this node</span></span>
<span id="LC1020" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1021" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC1022" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1023" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setData</span><span class="o">(</span><span class="nc">String</span> <span class="n">data</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC1024" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1025" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC1029" class="line" lang="java"><span class="cm">   * Unimplemented.</span></span>
<span id="LC1030" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1031" class="line" lang="java"><span class="cm">   * @param offset Start offset of substring to extract.</span></span>
<span id="LC1032" class="line" lang="java"><span class="cm">   * @param count The length of the substring to extract.</span></span>
<span id="LC1033" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1034" class="line" lang="java"><span class="cm">   * @return null</span></span>
...
<span id="LC1038" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">substringData</span><span class="o">(</span><span class="kt">int</span> <span class="n">offset</span><span class="o">,</span> <span class="kt">int</span> <span class="n">count</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC1039" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1040" class="line" lang="java"></span>
<span id="LC1041" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC1047" class="line" lang="java"><span class="cm">   * Unimplemented.</span></span>
<span id="LC1048" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1049" class="line" lang="java"><span class="cm">   * @param arg String data to append</span></span>
<span id="LC1050" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1051" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC1052" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1053" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">appendData</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC1054" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1055" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC1059" class="line" lang="java"><span class="cm">   * Unimplemented.</span></span>
<span id="LC1060" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1061" class="line" lang="java"><span class="cm">   * @param offset Start offset of substring to insert.</span></span>
<span id="LC1062" class="line" lang="java"><span class="cm">   * @param arg The (sub)string to insert.</span></span>
...
<span id="LC1066" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">insertData</span><span class="o">(</span><span class="kt">int</span> <span class="n">offset</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC1067" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1068" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC1072" class="line" lang="java"><span class="cm">   * Unimplemented.</span></span>
<span id="LC1073" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1074" class="line" lang="java"><span class="cm">   * @param offset Start offset of substring to delete.</span></span>
<span id="LC1075" class="line" lang="java"><span class="cm">   * @param count The length of the substring to delete.</span></span>
...
<span id="LC1079" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">deleteData</span><span class="o">(</span><span class="kt">int</span> <span class="n">offset</span><span class="o">,</span> <span class="kt">int</span> <span class="n">count</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC1080" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1081" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC1085" class="line" lang="java"><span class="cm">   * Unimplemented.</span></span>
<span id="LC1086" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1087" class="line" lang="java"><span class="cm">   * @param offset Start offset of substring to replace.</span></span>
<span id="LC1088" class="line" lang="java"><span class="cm">   * @param count The length of the substring to replace.</span></span>
<span id="LC1089" class="line" lang="java"><span class="cm">   * @param arg substring to replace with</span></span>
...
<span id="LC1093" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">replaceData</span><span class="o">(</span><span class="kt">int</span> <span class="n">offset</span><span class="o">,</span> <span class="kt">int</span> <span class="n">count</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg</span><span class="o">)</span></span>
<span id="LC1094" class="line" lang="java">          <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC1095" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1096" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC1100" class="line" lang="java"><span class="cm">   * Unimplemented.</span></span>
<span id="LC1101" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1102" class="line" lang="java"><span class="cm">   * @param offset Offset into text to split</span></span>
<span id="LC1103" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1104" class="line" lang="java"><span class="cm">   * @return null, unimplemented</span></span>
<span id="LC1105" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1106" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC1107" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1108" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Text</span> <span class="nf">splitText</span><span class="o">(</span><span class="kt">int</span> <span class="n">offset</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC1109" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1110" class="line" lang="java"></span>
<span id="LC1111" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC1117" class="line" lang="java"><span class="cm">   * NEEDSDOC Method adoptNode</span></span>
<span id="LC1118" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1119" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1120" class="line" lang="java"><span class="cm">   * NEEDSDOC @param source</span></span>
<span id="LC1121" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1122" class="line" lang="java"><span class="cm">   * NEEDSDOC (adoptNode) @return</span></span>
<span id="LC1123" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1124" class="line" lang="java"><span class="cm">   * @throws DOMException</span></span>
<span id="LC1125" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1126" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">adoptNode</span><span class="o">(</span><span class="nc">Node</span> <span class="n">source</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span></span>
<span id="LC1127" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1128" class="line" lang="java"></span>
<span id="LC1129" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC1135" class="line" lang="java"><span class="cm">   * &lt;p&gt;EXPERIMENTAL! Based on the &lt;a</span></span>
<span id="LC1136" class="line" lang="java"><span class="cm">   * href='http://www.w3.org/TR/2001/WD-DOM-Level-3-Core-20010605'&gt;Document</span></span>
<span id="LC1137" class="line" lang="java"><span class="cm">   * Object Model (DOM) Level 3 Core Working Draft of 5 June 2001.&lt;/a&gt;.</span></span>
<span id="LC1138" class="line" lang="java"><span class="cm">   * &lt;p&gt;</span></span>
<span id="LC1139" class="line" lang="java"><span class="cm">   * An attribute specifying, as part of the XML declaration, the encoding</span></span>
<span id="LC1140" class="line" lang="java"><span class="cm">   * of this document. This is &lt;code&gt;null&lt;/code&gt; when unspecified.</span></span>
<span id="LC1141" class="line" lang="java"><span class="cm">   * @since DOM Level 3</span></span>
<span id="LC1142" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1143" class="line" lang="java"><span class="cm">   * NEEDSDOC ($objectName$) @return</span></span>
<span id="LC1144" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1145" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getInputEncoding</span><span class="o">()</span></span>
<span id="LC1146" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1147" class="line" lang="java"></span>
<span id="LC1148" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
<span id="LC1149" class="line" lang="java"></span>
<span id="LC1150" class="line" lang="java">    <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC1154" class="line" lang="java"><span class="cm">   * &lt;p&gt;EXPERIMENTAL! Based on the &lt;a</span></span>
<span id="LC1155" class="line" lang="java"><span class="cm">   * href='http://www.w3.org/TR/2001/WD-DOM-Level-3-Core-20010605'&gt;Document</span></span>
<span id="LC1156" class="line" lang="java"><span class="cm">   * Object Model (DOM) Level 3 Core Working Draft of 5 June 2001.&lt;/a&gt;.</span></span>
<span id="LC1157" class="line" lang="java"><span class="cm">   * &lt;p&gt;</span></span>
<span id="LC1158" class="line" lang="java"><span class="cm">   * An attribute specifying, as part of the XML declaration, the encoding</span></span>
<span id="LC1159" class="line" lang="java"><span class="cm">   * of this document. This is &lt;code&gt;null&lt;/code&gt; when unspecified.</span></span>
<span id="LC1160" class="line" lang="java"><span class="cm">   * @since DOM Level 3</span></span>
<span id="LC1161" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1162" class="line" lang="java"><span class="cm">   * NEEDSDOC @param encoding</span></span>
<span id="LC1163" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1164" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setInputEncoding</span><span class="o">(</span><span class="nc">String</span> <span class="n">encoding</span><span class="o">)</span></span>
<span id="LC1165" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1166" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC1170" class="line" lang="java"><span class="cm">   * &lt;p&gt;EXPERIMENTAL! Based on the &lt;a</span></span>
<span id="LC1171" class="line" lang="java"><span class="cm">   * href='http://www.w3.org/TR/2001/WD-DOM-Level-3-Core-20010605'&gt;Document</span></span>
<span id="LC1172" class="line" lang="java"><span class="cm">   * Object Model (DOM) Level 3 Core Working Draft of 5 June 2001.&lt;/a&gt;.</span></span>
<span id="LC1173" class="line" lang="java"><span class="cm">   * &lt;p&gt;</span></span>
<span id="LC1174" class="line" lang="java"><span class="cm">   * An attribute specifying, as part of the XML declaration, whether this</span></span>
<span id="LC1175" class="line" lang="java"><span class="cm">   * document is standalone.</span></span>
<span id="LC1176" class="line" lang="java"><span class="cm">   * @since DOM Level 3</span></span>
<span id="LC1177" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1178" class="line" lang="java"><span class="cm">   * NEEDSDOC ($objectName$) @return</span></span>
<span id="LC1179" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1180" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getStandalone</span><span class="o">()</span></span>
<span id="LC1181" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1182" class="line" lang="java"></span>
<span id="LC1183" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
<span id="LC1184" class="line" lang="java"></span>
<span id="LC1185" class="line" lang="java">    <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC1189" class="line" lang="java"><span class="cm">   * &lt;p&gt;EXPERIMENTAL! Based on the &lt;a</span></span>
<span id="LC1190" class="line" lang="java"><span class="cm">   * href='http://www.w3.org/TR/2001/WD-DOM-Level-3-Core-20010605'&gt;Document</span></span>
<span id="LC1191" class="line" lang="java"><span class="cm">   * Object Model (DOM) Level 3 Core Working Draft of 5 June 2001.&lt;/a&gt;.</span></span>
<span id="LC1192" class="line" lang="java"><span class="cm">   * &lt;p&gt;</span></span>
<span id="LC1193" class="line" lang="java"><span class="cm">   * An attribute specifying, as part of the XML declaration, whether this</span></span>
<span id="LC1194" class="line" lang="java"><span class="cm">   * document is standalone.</span></span>
<span id="LC1195" class="line" lang="java"><span class="cm">   * @since DOM Level 3</span></span>
<span id="LC1196" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1197" class="line" lang="java"><span class="cm">   * NEEDSDOC @param standalone</span></span>
<span id="LC1198" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1199" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setStandalone</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">standalone</span><span class="o">)</span></span>
<span id="LC1200" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1201" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC1205" class="line" lang="java"><span class="cm">   * &lt;p&gt;EXPERIMENTAL! Based on the &lt;a</span></span>
<span id="LC1206" class="line" lang="java"><span class="cm">   * href='http://www.w3.org/TR/2001/WD-DOM-Level-3-Core-20010605'&gt;Document</span></span>
<span id="LC1207" class="line" lang="java"><span class="cm">   * Object Model (DOM) Level 3 Core Working Draft of 5 June 2001.&lt;/a&gt;.</span></span>
<span id="LC1208" class="line" lang="java"><span class="cm">   * &lt;p&gt;</span></span>
<span id="LC1209" class="line" lang="java"><span class="cm">   * An attribute specifying whether errors checking is enforced or not.</span></span>
<span id="LC1210" class="line" lang="java"><span class="cm">   * When set to &lt;code&gt;false&lt;/code&gt;, the implementation is free to not</span></span>
<span id="LC1211" class="line" lang="java"><span class="cm">   * test every possible error case normally defined on DOM operations,</span></span>
<span id="LC1212" class="line" lang="java"><span class="cm">   * and not raise any &lt;code&gt;DOMException&lt;/code&gt;. In case of error, the</span></span>
<span id="LC1213" class="line" lang="java"><span class="cm">   * behavior is undefined. This attribute is &lt;code&gt;true&lt;/code&gt; by</span></span>
<span id="LC1214" class="line" lang="java"><span class="cm">   * defaults.</span></span>
<span id="LC1215" class="line" lang="java"><span class="cm">   * @since DOM Level 3</span></span>
<span id="LC1216" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1217" class="line" lang="java"><span class="cm">   * NEEDSDOC ($objectName$) @return</span></span>
<span id="LC1218" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1219" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getStrictErrorChecking</span><span class="o">()</span></span>
<span id="LC1220" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1221" class="line" lang="java"></span>
<span id="LC1222" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
<span id="LC1223" class="line" lang="java"></span>
<span id="LC1224" class="line" lang="java">    <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC1228" class="line" lang="java"><span class="cm">   * &lt;p&gt;EXPERIMENTAL! Based on the &lt;a</span></span>
<span id="LC1229" class="line" lang="java"><span class="cm">   * href='http://www.w3.org/TR/2001/WD-DOM-Level-3-Core-20010605'&gt;Document</span></span>
<span id="LC1230" class="line" lang="java"><span class="cm">   * Object Model (DOM) Level 3 Core Working Draft of 5 June 2001.&lt;/a&gt;.</span></span>
<span id="LC1231" class="line" lang="java"><span class="cm">   * &lt;p&gt;</span></span>
<span id="LC1232" class="line" lang="java"><span class="cm">   * An attribute specifying whether errors checking is enforced or not.</span></span>
<span id="LC1233" class="line" lang="java"><span class="cm">   * When set to &lt;code&gt;false&lt;/code&gt;, the implementation is free to not</span></span>
<span id="LC1234" class="line" lang="java"><span class="cm">   * test every possible error case normally defined on DOM operations,</span></span>
<span id="LC1235" class="line" lang="java"><span class="cm">   * and not raise any &lt;code&gt;DOMException&lt;/code&gt;. In case of error, the</span></span>
<span id="LC1236" class="line" lang="java"><span class="cm">   * behavior is undefined. This attribute is &lt;code&gt;true&lt;/code&gt; by</span></span>
<span id="LC1237" class="line" lang="java"><span class="cm">   * defaults.</span></span>
<span id="LC1238" class="line" lang="java"><span class="cm">   * @since DOM Level 3</span></span>
<span id="LC1239" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1240" class="line" lang="java"><span class="cm">   * NEEDSDOC @param strictErrorChecking</span></span>
<span id="LC1241" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1242" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setStrictErrorChecking</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">strictErrorChecking</span><span class="o">)</span></span>
<span id="LC1243" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1244" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC1248" class="line" lang="java"><span class="cm">   * &lt;p&gt;EXPERIMENTAL! Based on the &lt;a</span></span>
<span id="LC1249" class="line" lang="java"><span class="cm">   * href='http://www.w3.org/TR/2001/WD-DOM-Level-3-Core-20010605'&gt;Document</span></span>
<span id="LC1250" class="line" lang="java"><span class="cm">   * Object Model (DOM) Level 3 Core Working Draft of 5 June 2001.&lt;/a&gt;.</span></span>
<span id="LC1251" class="line" lang="java"><span class="cm">   * &lt;p&gt;</span></span>
<span id="LC1252" class="line" lang="java"><span class="cm">   * An attribute specifying, as part of the XML declaration, the version</span></span>
<span id="LC1253" class="line" lang="java"><span class="cm">   * number of this document. This is &lt;code&gt;null&lt;/code&gt; when unspecified.</span></span>
<span id="LC1254" class="line" lang="java"><span class="cm">   * @since DOM Level 3</span></span>
<span id="LC1255" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1256" class="line" lang="java"><span class="cm">   * NEEDSDOC ($objectName$) @return</span></span>
<span id="LC1257" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1258" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getVersion</span><span class="o">()</span></span>
<span id="LC1259" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1260" class="line" lang="java"></span>
<span id="LC1261" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC1267" class="line" lang="java"><span class="cm">   * &lt;p&gt;EXPERIMENTAL! Based on the &lt;a</span></span>
<span id="LC1268" class="line" lang="java"><span class="cm">   * href='http://www.w3.org/TR/2001/WD-DOM-Level-3-Core-20010605'&gt;Document</span></span>
<span id="LC1269" class="line" lang="java"><span class="cm">   * Object Model (DOM) Level 3 Core Working Draft of 5 June 2001.&lt;/a&gt;.</span></span>
<span id="LC1270" class="line" lang="java"><span class="cm">   * &lt;p&gt;</span></span>
<span id="LC1271" class="line" lang="java"><span class="cm">   * An attribute specifying, as part of the XML declaration, the version</span></span>
<span id="LC1272" class="line" lang="java"><span class="cm">   * number of this document. This is &lt;code&gt;null&lt;/code&gt; when unspecified.</span></span>
<span id="LC1273" class="line" lang="java"><span class="cm">   * @since DOM Level 3</span></span>
<span id="LC1274" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC1275" class="line" lang="java"><span class="cm">   * NEEDSDOC @param version</span></span>
<span id="LC1276" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1277" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setVersion</span><span class="o">(</span><span class="nc">String</span> <span class="n">version</span><span class="o">)</span></span>
<span id="LC1278" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1279" class="line" lang="java">    <span class="n">error</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_FUNCTION_NOT_SUPPORTED</span><span class="o">);</span></span>
...
<span id="LC1284" class="line" lang="java"><span class="c1">//RAMESH : Pending proper implementation of DOM Level 3</span></span>
<span id="LC1285" class="line" lang="java"></span>
<span id="LC1286" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Object</span> <span class="nf">setUserData</span><span class="o">(</span><span class="nc">String</span> <span class="n">key</span><span class="o">,</span></span>
<span id="LC1287" class="line" lang="java">                              <span class="nc">Object</span> <span class="n">data</span><span class="o">,</span></span>
<span id="LC1288" class="line" lang="java">                              <span class="nc">UserDataHandler</span> <span class="n">handler</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1289" class="line" lang="java">        <span class="k">return</span> <span class="nf">getOwnerDocument</span><span class="o">().</span><span class="na">setUserData</span><span class="o">(</span> <span class="n">key</span><span class="o">,</span> <span class="n">data</span><span class="o">,</span> <span class="n">handler</span><span class="o">);</span></span>
...
<span id="LC1293" class="line" lang="java"><span class="cm">     * Retrieves the object associated to a key on a this node. The object</span></span>
<span id="LC1294" class="line" lang="java"><span class="cm">     * must first have been set to this node by calling</span></span>
<span id="LC1295" class="line" lang="java"><span class="cm">     * &lt;code&gt;setUserData&lt;/code&gt; with the same key.</span></span>
<span id="LC1296" class="line" lang="java"><span class="cm">     * @param key The key the object is associated to.</span></span>
<span id="LC1297" class="line" lang="java"><span class="cm">     * @return Returns the &lt;code&gt;DOMObject&lt;/code&gt; associated to the given key</span></span>
<span id="LC1298" class="line" lang="java"><span class="cm">     *   on this node, or &lt;code&gt;null&lt;/code&gt; if there was none.</span></span>
<span id="LC1299" class="line" lang="java"><span class="cm">     * @since DOM Level 3</span></span>
<span id="LC1300" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1301" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Object</span> <span class="nf">getUserData</span><span class="o">(</span><span class="nc">String</span> <span class="n">key</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1302" class="line" lang="java">        <span class="k">return</span> <span class="nf">getOwnerDocument</span><span class="o">().</span><span class="na">getUserData</span><span class="o">(</span> <span class="n">key</span><span class="o">);</span></span>
...
<span id="LC1306" class="line" lang="java"><span class="cm">     *  This method returns a specialized object which implements the</span></span>
<span id="LC1307" class="line" lang="java"><span class="cm">     * specialized APIs of the specified feature and version. The</span></span>
<span id="LC1308" class="line" lang="java"><span class="cm">     * specialized object may also be obtained by using binding-specific</span></span>
<span id="LC1309" class="line" lang="java"><span class="cm">     * casting methods but is not necessarily expected to, as discussed in Mixed DOM implementations.</span></span>
<span id="LC1310" class="line" lang="java"><span class="cm">     * @param feature The name of the feature requested (case-insensitive).</span></span>
<span id="LC1311" class="line" lang="java"><span class="cm">     * @param version  This is the version number of the feature to test. If</span></span>
<span id="LC1312" class="line" lang="java"><span class="cm">     *   the version is &lt;code&gt;null&lt;/code&gt; or the empty string, supporting</span></span>
<span id="LC1313" class="line" lang="java"><span class="cm">     *   any version of the feature will cause the method to return an</span></span>
<span id="LC1314" class="line" lang="java"><span class="cm">     *   object that supports at least one version of the feature.</span></span>
<span id="LC1315" class="line" lang="java"><span class="cm">     * @return  Returns an object which implements the specialized APIs of</span></span>
<span id="LC1316" class="line" lang="java"><span class="cm">     *   the specified feature and version, if any, or &lt;code&gt;null&lt;/code&gt; if</span></span>
<span id="LC1317" class="line" lang="java"><span class="cm">     *   there is no object which implements interfaces associated with that</span></span>
<span id="LC1318" class="line" lang="java"><span class="cm">     *   feature. If the &lt;code&gt;DOMObject&lt;/code&gt; returned by this method</span></span>
<span id="LC1319" class="line" lang="java"><span class="cm">     *   implements the &lt;code&gt;Node&lt;/code&gt; interface, it must delegate to the</span></span>
<span id="LC1320" class="line" lang="java"><span class="cm">     *   primary core &lt;code&gt;Node&lt;/code&gt; and not return results inconsistent</span></span>
<span id="LC1321" class="line" lang="java"><span class="cm">     *   with the primary core &lt;code&gt;Node&lt;/code&gt; such as attributes,</span></span>
<span id="LC1322" class="line" lang="java"><span class="cm">     *   childNodes, etc.</span></span>
<span id="LC1323" class="line" lang="java"><span class="cm">     * @since DOM Level 3</span></span>
<span id="LC1324" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1325" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Object</span> <span class="nf">getFeature</span><span class="o">(</span><span class="nc">String</span> <span class="n">feature</span><span class="o">,</span> <span class="nc">String</span> <span class="n">version</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1326" class="line" lang="java">        <span class="c1">// we don't have any alternate node, either this node does the job</span></span>
<span id="LC1327" class="line" lang="java">        <span class="c1">// or we don't have anything that does</span></span>
<span id="LC1328" class="line" lang="java">        <span class="k">return</span> <span class="nf">isSupported</span><span class="o">(</span><span class="n">feature</span><span class="o">,</span> <span class="n">version</span><span class="o">)</span> <span class="o">?</span> <span class="k">this</span> <span class="o">:</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC1332" class="line" lang="java"><span class="cm">     * Tests whether two nodes are equal.</span></span>
<span id="LC1333" class="line" lang="java"><span class="cm">     * &lt;br&gt;This method tests for equality of nodes, not sameness (i.e.,</span></span>
<span id="LC1334" class="line" lang="java"><span class="cm">     * whether the two nodes are references to the same object) which can be</span></span>
<span id="LC1335" class="line" lang="java"><span class="cm">     * tested with &lt;code&gt;Node.isSameNode&lt;/code&gt;. All nodes that are the same</span></span>
<span id="LC1336" class="line" lang="java"><span class="cm">     * will also be equal, though the reverse may not be true.</span></span>
<span id="LC1337" class="line" lang="java"><span class="cm">     * &lt;br&gt;Two nodes are equal if and only if the following conditions are</span></span>
<span id="LC1338" class="line" lang="java"><span class="cm">     * satisfied: The two nodes are of the same type.The following string</span></span>
<span id="LC1339" class="line" lang="java"><span class="cm">     * attributes are equal: &lt;code&gt;nodeName&lt;/code&gt;, &lt;code&gt;localName&lt;/code&gt;,</span></span>
<span id="LC1340" class="line" lang="java"><span class="cm">     * &lt;code&gt;namespaceURI&lt;/code&gt;, &lt;code&gt;prefix&lt;/code&gt;, &lt;code&gt;nodeValue&lt;/code&gt;</span></span>
<span id="LC1341" class="line" lang="java"><span class="cm">     * , &lt;code&gt;baseURI&lt;/code&gt;. This is: they are both &lt;code&gt;null&lt;/code&gt;, or</span></span>
<span id="LC1342" class="line" lang="java"><span class="cm">     * they have the same length and are character for character identical.</span></span>
<span id="LC1343" class="line" lang="java"><span class="cm">     * The &lt;code&gt;attributes&lt;/code&gt; &lt;code&gt;NamedNodeMaps&lt;/code&gt; are equal.</span></span>
<span id="LC1344" class="line" lang="java"><span class="cm">     * This is: they are both &lt;code&gt;null&lt;/code&gt;, or they have the same</span></span>
<span id="LC1345" class="line" lang="java"><span class="cm">     * length and for each node that exists in one map there is a node that</span></span>
<span id="LC1346" class="line" lang="java"><span class="cm">     * exists in the other map and is equal, although not necessarily at the</span></span>
<span id="LC1347" class="line" lang="java"><span class="cm">     * same index.The &lt;code&gt;childNodes&lt;/code&gt; &lt;code&gt;NodeLists&lt;/code&gt; are</span></span>
<span id="LC1348" class="line" lang="java"><span class="cm">     * equal. This is: they are both &lt;code&gt;null&lt;/code&gt;, or they have the</span></span>
<span id="LC1349" class="line" lang="java"><span class="cm">     * same length and contain equal nodes at the same index. This is true</span></span>
<span id="LC1350" class="line" lang="java"><span class="cm">     * for &lt;code&gt;Attr&lt;/code&gt; nodes as for any other type of node. Note that</span></span>
<span id="LC1351" class="line" lang="java"><span class="cm">     * normalization can affect equality; to avoid this, nodes should be</span></span>
<span id="LC1352" class="line" lang="java"><span class="cm">     * normalized before being compared.</span></span>
<span id="LC1353" class="line" lang="java"><span class="cm">     * &lt;br&gt;For two &lt;code&gt;DocumentType&lt;/code&gt; nodes to be equal, the following</span></span>
<span id="LC1354" class="line" lang="java"><span class="cm">     * conditions must also be satisfied: The following string attributes</span></span>
<span id="LC1355" class="line" lang="java"><span class="cm">     * are equal: &lt;code&gt;publicId&lt;/code&gt;, &lt;code&gt;systemId&lt;/code&gt;,</span></span>
<span id="LC1356" class="line" lang="java"><span class="cm">     * &lt;code&gt;internalSubset&lt;/code&gt;.The &lt;code&gt;entities&lt;/code&gt;</span></span>
<span id="LC1357" class="line" lang="java"><span class="cm">     * &lt;code&gt;NamedNodeMaps&lt;/code&gt; are equal.The &lt;code&gt;notations&lt;/code&gt;</span></span>
<span id="LC1358" class="line" lang="java"><span class="cm">     * &lt;code&gt;NamedNodeMaps&lt;/code&gt; are equal.</span></span>
<span id="LC1359" class="line" lang="java"><span class="cm">     * &lt;br&gt;On the other hand, the following do not affect equality: the</span></span>
<span id="LC1360" class="line" lang="java"><span class="cm">     * &lt;code&gt;ownerDocument&lt;/code&gt; attribute, the &lt;code&gt;specified&lt;/code&gt;</span></span>
<span id="LC1361" class="line" lang="java"><span class="cm">     * attribute for &lt;code&gt;Attr&lt;/code&gt; nodes, the</span></span>
<span id="LC1362" class="line" lang="java"><span class="cm">     * &lt;code&gt;isWhitespaceInElementContent&lt;/code&gt; attribute for</span></span>
<span id="LC1363" class="line" lang="java"><span class="cm">     * &lt;code&gt;Text&lt;/code&gt; nodes, as well as any user data or event listeners</span></span>
<span id="LC1364" class="line" lang="java"><span class="cm">     * registered on the nodes.</span></span>
<span id="LC1365" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1366" class="line" lang="java"><span class="cm">     * @param arg The node to compare equality with.</span></span>
<span id="LC1367" class="line" lang="java"><span class="cm">     * @return If the nodes, and possibly subtrees are equal,</span></span>
<span id="LC1368" class="line" lang="java"><span class="cm">     *   &lt;code&gt;true&lt;/code&gt; otherwise &lt;code&gt;false&lt;/code&gt;.</span></span>
<span id="LC1369" class="line" lang="java"><span class="cm">     * @since DOM Level 3</span></span>
<span id="LC1370" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1371" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isEqualNode</span><span class="o">(</span><span class="nc">Node</span> <span class="n">arg</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1372" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">arg</span> <span class="o">==</span> <span class="k">this</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1373" class="line" lang="java">            <span class="k">return</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC1374" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1375" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">arg</span><span class="o">.</span><span class="na">getNodeType</span><span class="o">()</span> <span class="o">!=</span> <span class="n">getNodeType</span><span class="o">())</span> <span class="o">{</span></span>
...
<span id="LC1378" class="line" lang="java">        <span class="c1">// in theory nodeName can't be null but better be careful</span></span>
<span id="LC1379" class="line" lang="java">        <span class="c1">// who knows what other implementations may be doing?...</span></span>
<span id="LC1380" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">getNodeName</span><span class="o">()</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1381" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">arg</span><span class="o">.</span><span class="na">getNodeName</span><span class="o">()</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1382" class="line" lang="java">                <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1383" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC1384" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1385" class="line" lang="java">        <span class="k">else</span> <span class="nf">if</span> <span class="o">(!</span><span class="n">getNodeName</span><span class="o">().</span><span class="na">equals</span><span class="o">(</span><span class="n">arg</span><span class="o">.</span><span class="na">getNodeName</span><span class="o">()))</span> <span class="o">{</span></span>
<span id="LC1386" class="line" lang="java">            <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1387" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1388" class="line" lang="java"></span>
<span id="LC1389" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">getLocalName</span><span class="o">()</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1390" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">arg</span><span class="o">.</span><span class="na">getLocalName</span><span class="o">()</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1391" class="line" lang="java">                <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1392" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC1393" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1394" class="line" lang="java">        <span class="k">else</span> <span class="nf">if</span> <span class="o">(!</span><span class="n">getLocalName</span><span class="o">().</span><span class="na">equals</span><span class="o">(</span><span class="n">arg</span><span class="o">.</span><span class="na">getLocalName</span><span class="o">()))</span> <span class="o">{</span></span>
...
<span id="LC1398" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">getNamespaceURI</span><span class="o">()</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1399" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">arg</span><span class="o">.</span><span class="na">getNamespaceURI</span><span class="o">()</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC1403" class="line" lang="java">        <span class="k">else</span> <span class="nf">if</span> <span class="o">(!</span><span class="n">getNamespaceURI</span><span class="o">().</span><span class="na">equals</span><span class="o">(</span><span class="n">arg</span><span class="o">.</span><span class="na">getNamespaceURI</span><span class="o">()))</span> <span class="o">{</span></span>
...
<span id="LC1407" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">getPrefix</span><span class="o">()</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1408" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">arg</span><span class="o">.</span><span class="na">getPrefix</span><span class="o">()</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC1412" class="line" lang="java">        <span class="k">else</span> <span class="nf">if</span> <span class="o">(!</span><span class="n">getPrefix</span><span class="o">().</span><span class="na">equals</span><span class="o">(</span><span class="n">arg</span><span class="o">.</span><span class="na">getPrefix</span><span class="o">()))</span> <span class="o">{</span></span>
<span id="LC1413" class="line" lang="java">            <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1414" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1415" class="line" lang="java"></span>
<span id="LC1416" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">getNodeValue</span><span class="o">()</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1417" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">arg</span><span class="o">.</span><span class="na">getNodeValue</span><span class="o">()</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1418" class="line" lang="java">                <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1419" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC1420" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1421" class="line" lang="java">        <span class="k">else</span> <span class="nf">if</span> <span class="o">(!</span><span class="n">getNodeValue</span><span class="o">().</span><span class="na">equals</span><span class="o">(</span><span class="n">arg</span><span class="o">.</span><span class="na">getNodeValue</span><span class="o">()))</span> <span class="o">{</span></span>
<span id="LC1422" class="line" lang="java">            <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1423" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1424" class="line" lang="java">    <span class="cm">/*</span></span>
<span id="LC1425" class="line" lang="java"><span class="cm">        if (getBaseURI() == null) {</span></span>
<span id="LC1426" class="line" lang="java"><span class="cm">            if (((NodeImpl) arg).getBaseURI() != null) {</span></span>
<span id="LC1427" class="line" lang="java"><span class="cm">                return false;</span></span>
<span id="LC1428" class="line" lang="java"><span class="cm">            }</span></span>
<span id="LC1429" class="line" lang="java"><span class="cm">        }</span></span>
<span id="LC1430" class="line" lang="java"><span class="cm">        else if (!getBaseURI().equals(((NodeImpl) arg).getBaseURI())) {</span></span>
<span id="LC1431" class="line" lang="java"><span class="cm">            return false;</span></span>
...
<span id="LC1435" class="line" lang="java">             <span class="k">return</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC1439" class="line" lang="java"><span class="cm">     * DOM Level 3 - Experimental:</span></span>
<span id="LC1440" class="line" lang="java"><span class="cm">     * Look up the namespace URI associated to the given prefix, starting from this node.</span></span>
<span id="LC1441" class="line" lang="java"><span class="cm">     * Use lookupNamespaceURI(null) to lookup the default namespace</span></span>
<span id="LC1442" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1443" class="line" lang="java"><span class="cm">     * @param namespaceURI</span></span>
<span id="LC1444" class="line" lang="java"><span class="cm">     * @return th URI for the namespace</span></span>
<span id="LC1445" class="line" lang="java"><span class="cm">     * @since DOM Level 3</span></span>
<span id="LC1446" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1447" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">lookupNamespaceURI</span><span class="o">(</span><span class="nc">String</span> <span class="n">specifiedPrefix</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1448" class="line" lang="java">        <span class="kt">short</span> <span class="n">type</span> <span class="o">=</span> <span class="k">this</span><span class="o">.</span><span class="na">getNodeType</span><span class="o">();</span></span>
<span id="LC1449" class="line" lang="java">        <span class="k">switch</span> <span class="o">(</span><span class="n">type</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1450" class="line" lang="java">        <span class="k">case</span> <span class="nc">Node</span><span class="o">.</span><span class="na">ELEMENT_NODE</span> <span class="o">:</span> <span class="o">{</span></span>
<span id="LC1451" class="line" lang="java"></span>
<span id="LC1452" class="line" lang="java">                <span class="nc">String</span> <span class="n">namespace</span> <span class="o">=</span> <span class="k">this</span><span class="o">.</span><span class="na">getNamespaceURI</span><span class="o">();</span></span>
<span id="LC1453" class="line" lang="java">                <span class="nc">String</span> <span class="n">prefix</span> <span class="o">=</span> <span class="k">this</span><span class="o">.</span><span class="na">getPrefix</span><span class="o">();</span></span>
<span id="LC1454" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="n">namespace</span> <span class="o">!=</span><span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1455" class="line" lang="java">                    <span class="c1">// REVISIT: is it possible that prefix is empty string?</span></span>
<span id="LC1456" class="line" lang="java">                    <span class="k">if</span> <span class="o">(</span><span class="n">specifiedPrefix</span><span class="o">==</span> <span class="kc">null</span> <span class="o">&amp;&amp;</span> <span class="n">prefix</span><span class="o">==</span><span class="n">specifiedPrefix</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1457" class="line" lang="java">                        <span class="c1">// looking for default namespace</span></span>
<span id="LC1458" class="line" lang="java">                        <span class="k">return</span> <span class="n">namespace</span><span class="o">;</span></span>
<span id="LC1459" class="line" lang="java">                    <span class="o">}</span> <span class="k">else</span> <span class="k">if</span> <span class="o">(</span><span class="n">prefix</span> <span class="o">!=</span> <span class="kc">null</span> <span class="o">&amp;&amp;</span> <span class="n">prefix</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">specifiedPrefix</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC1460" class="line" lang="java">                        <span class="c1">// non default namespace</span></span>
<span id="LC1461" class="line" lang="java">                        <span class="k">return</span> <span class="n">namespace</span><span class="o">;</span></span>
<span id="LC1462" class="line" lang="java">                    <span class="o">}</span></span>
<span id="LC1463" class="line" lang="java">                <span class="o">}</span></span>
<span id="LC1464" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="k">this</span><span class="o">.</span><span class="na">hasAttributes</span><span class="o">())</span> <span class="o">{</span></span>
<span id="LC1465" class="line" lang="java">                    <span class="nc">NamedNodeMap</span> <span class="n">map</span> <span class="o">=</span> <span class="k">this</span><span class="o">.</span><span class="na">getAttributes</span><span class="o">();</span></span>
<span id="LC1466" class="line" lang="java">                    <span class="kt">int</span> <span class="n">length</span> <span class="o">=</span> <span class="n">map</span><span class="o">.</span><span class="na">getLength</span><span class="o">();</span></span>
<span id="LC1467" class="line" lang="java">                    <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span><span class="o">=</span><span class="mi">0</span><span class="o">;</span><span class="n">i</span><span class="o">&lt;</span><span class="n">length</span><span class="o">;</span><span class="n">i</span><span class="o">++)</span> <span class="o">{</span></span>
<span id="LC1468" class="line" lang="java">                        <span class="nc">Node</span> <span class="n">attr</span> <span class="o">=</span> <span class="n">map</span><span class="o">.</span><span class="na">item</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC1469" class="line" lang="java">                        <span class="nc">String</span> <span class="n">attrPrefix</span> <span class="o">=</span> <span class="n">attr</span><span class="o">.</span><span class="na">getPrefix</span><span class="o">();</span></span>
<span id="LC1470" class="line" lang="java">                        <span class="nc">String</span> <span class="n">value</span> <span class="o">=</span> <span class="n">attr</span><span class="o">.</span><span class="na">getNodeValue</span><span class="o">();</span></span>
<span id="LC1471" class="line" lang="java">                        <span class="n">namespace</span> <span class="o">=</span> <span class="n">attr</span><span class="o">.</span><span class="na">getNamespaceURI</span><span class="o">();</span></span>
<span id="LC1472" class="line" lang="java">                        <span class="k">if</span> <span class="o">(</span><span class="n">namespace</span> <span class="o">!=</span><span class="kc">null</span> <span class="o">&amp;&amp;</span> <span class="n">namespace</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="s">"http://www.w3.org/2000/xmlns/"</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC1473" class="line" lang="java">                            <span class="c1">// at this point we are dealing with DOM Level 2 nodes only</span></span>
<span id="LC1474" class="line" lang="java">                            <span class="k">if</span> <span class="o">(</span><span class="n">specifiedPrefix</span> <span class="o">==</span> <span class="kc">null</span> <span class="o">&amp;&amp;</span></span>
<span id="LC1475" class="line" lang="java">                                <span class="n">attr</span><span class="o">.</span><span class="na">getNodeName</span><span class="o">().</span><span class="na">equals</span><span class="o">(</span><span class="s">"xmlns"</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC1476" class="line" lang="java">                                <span class="c1">// default namespace</span></span>
<span id="LC1477" class="line" lang="java">                                <span class="k">return</span> <span class="n">value</span><span class="o">;</span></span>
<span id="LC1478" class="line" lang="java">                            <span class="o">}</span> <span class="k">else</span> <span class="k">if</span> <span class="o">(</span><span class="n">attrPrefix</span> <span class="o">!=</span><span class="kc">null</span> <span class="o">&amp;&amp;</span></span>
<span id="LC1479" class="line" lang="java">                                       <span class="n">attrPrefix</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="s">"xmlns"</span><span class="o">)</span> <span class="o">&amp;&amp;</span></span>
<span id="LC1480" class="line" lang="java">                                       <span class="n">attr</span><span class="o">.</span><span class="na">getLocalName</span><span class="o">().</span><span class="na">equals</span><span class="o">(</span><span class="n">specifiedPrefix</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC1481" class="line" lang="java">                 <span class="c1">// non default namespace</span></span>
<span id="LC1482" class="line" lang="java">                                <span class="k">return</span> <span class="n">value</span><span class="o">;</span></span>
...
<span id="LC1488" class="line" lang="java"><span class="cm">                NodeImpl ancestor = (NodeImpl)getElementAncestor(this);</span></span>
<span id="LC1489" class="line" lang="java"><span class="cm">                if (ancestor != null) {</span></span>
<span id="LC1490" class="line" lang="java"><span class="cm">                    return ancestor.lookupNamespaceURI(specifiedPrefix);</span></span>
...
<span id="LC1499" class="line" lang="java"><span class="cm">        case Node.DOCUMENT_NODE : {</span></span>
<span id="LC1500" class="line" lang="java"><span class="cm">                return((NodeImpl)((Document)this).getDocumentElement()).lookupNamespaceURI(specifiedPrefix) ;</span></span>
<span id="LC1501" class="line" lang="java"><span class="cm">            }</span></span>
<span id="LC1502" class="line" lang="java"><span class="cm">*/</span></span>
<span id="LC1503" class="line" lang="java">        <span class="k">case</span> <span class="nc">Node</span><span class="o">.</span><span class="na">ENTITY_NODE</span> <span class="o">:</span></span>
<span id="LC1504" class="line" lang="java">        <span class="k">case</span> <span class="nc">Node</span><span class="o">.</span><span class="na">NOTATION_NODE</span><span class="o">:</span></span>
<span id="LC1505" class="line" lang="java">        <span class="k">case</span> <span class="nc">Node</span><span class="o">.</span><span class="na">DOCUMENT_FRAGMENT_NODE</span><span class="o">:</span></span>
<span id="LC1506" class="line" lang="java">        <span class="k">case</span> <span class="nc">Node</span><span class="o">.</span><span class="na">DOCUMENT_TYPE_NODE</span><span class="o">:</span></span>
<span id="LC1507" class="line" lang="java">            <span class="c1">// type is unknown</span></span>
<span id="LC1508" class="line" lang="java">            <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1509" class="line" lang="java">        <span class="k">case</span> <span class="nc">Node</span><span class="o">.</span><span class="na">ATTRIBUTE_NODE</span><span class="o">:{</span></span>
<span id="LC1510" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="k">this</span><span class="o">.</span><span class="na">getOwnerElement</span><span class="o">().</span><span class="na">getNodeType</span><span class="o">()</span> <span class="o">==</span> <span class="nc">Node</span><span class="o">.</span><span class="na">ELEMENT_NODE</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1511" class="line" lang="java">                    <span class="k">return</span> <span class="nf">getOwnerElement</span><span class="o">().</span><span class="na">lookupNamespaceURI</span><span class="o">(</span><span class="n">specifiedPrefix</span><span class="o">);</span></span>
...
<span id="LC1516" class="line" lang="java">        <span class="k">default</span><span class="o">:{</span></span>
<span id="LC1517" class="line" lang="java">           <span class="cm">/*</span></span>
<span id="LC1518" class="line" lang="java"><span class="cm">                NodeImpl ancestor = (NodeImpl)getElementAncestor(this);</span></span>
<span id="LC1519" class="line" lang="java"><span class="cm">                if (ancestor != null) {</span></span>
<span id="LC1520" class="line" lang="java"><span class="cm">                    return ancestor.lookupNamespaceURI(specifiedPrefix);</span></span>
...
<span id="LC1531" class="line" lang="java"><span class="cm">     *  DOM Level 3: Experimental</span></span>
<span id="LC1532" class="line" lang="java"><span class="cm">     *  This method checks if the specified &lt;code&gt;namespaceURI&lt;/code&gt; is the</span></span>
<span id="LC1533" class="line" lang="java"><span class="cm">     *  default namespace or not.</span></span>
<span id="LC1534" class="line" lang="java"><span class="cm">     *  @param namespaceURI The namespace URI to look for.</span></span>
<span id="LC1535" class="line" lang="java"><span class="cm">     *  @return  &lt;code&gt;true&lt;/code&gt; if the specified &lt;code&gt;namespaceURI&lt;/code&gt;</span></span>
<span id="LC1536" class="line" lang="java"><span class="cm">     *   is the default namespace, &lt;code&gt;false&lt;/code&gt; otherwise.</span></span>
<span id="LC1537" class="line" lang="java"><span class="cm">     * @since DOM Level 3</span></span>
<span id="LC1538" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1539" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isDefaultNamespace</span><span class="o">(</span><span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">){</span></span>
<span id="LC1540" class="line" lang="java">       <span class="cm">/*</span></span>
<span id="LC1541" class="line" lang="java"><span class="cm">        // REVISIT: remove casts when DOM L3 becomes REC.</span></span>
<span id="LC1542" class="line" lang="java"><span class="cm">        short type = this.getNodeType();</span></span>
<span id="LC1543" class="line" lang="java"><span class="cm">        switch (type) {</span></span>
<span id="LC1544" class="line" lang="java"><span class="cm">        case Node.ELEMENT_NODE: {</span></span>
<span id="LC1545" class="line" lang="java"><span class="cm">            String namespace = this.getNamespaceURI();</span></span>
<span id="LC1546" class="line" lang="java"><span class="cm">            String prefix = this.getPrefix();</span></span>
<span id="LC1547" class="line" lang="java"></span>
<span id="LC1548" class="line" lang="java"><span class="cm">            // REVISIT: is it possible that prefix is empty string?</span></span>
<span id="LC1549" class="line" lang="java"><span class="cm">            if (prefix == null || prefix.length() == 0) {</span></span>
<span id="LC1550" class="line" lang="java"><span class="cm">                if (namespaceURI == null) {</span></span>
<span id="LC1551" class="line" lang="java"><span class="cm">                    return (namespace == namespaceURI);</span></span>
<span id="LC1552" class="line" lang="java"><span class="cm">                }</span></span>
<span id="LC1553" class="line" lang="java"><span class="cm">                return namespaceURI.equals(namespace);</span></span>
<span id="LC1554" class="line" lang="java"><span class="cm">            }</span></span>
<span id="LC1555" class="line" lang="java"><span class="cm">            if (this.hasAttributes()) {</span></span>
<span id="LC1556" class="line" lang="java"><span class="cm">                ElementImpl elem = (ElementImpl)this;</span></span>
<span id="LC1557" class="line" lang="java"><span class="cm">                NodeImpl attr = (NodeImpl)elem.getAttributeNodeNS("http://www.w3.org/2000/xmlns/", "xmlns");</span></span>
<span id="LC1558" class="line" lang="java"><span class="cm">                if (attr != null) {</span></span>
<span id="LC1559" class="line" lang="java"><span class="cm">                    String value = attr.getNodeValue();</span></span>
<span id="LC1560" class="line" lang="java"><span class="cm">                    if (namespaceURI == null) {</span></span>
<span id="LC1561" class="line" lang="java"><span class="cm">                        return (namespace == value);</span></span>
<span id="LC1562" class="line" lang="java"><span class="cm">                    }</span></span>
<span id="LC1563" class="line" lang="java"><span class="cm">                    return namespaceURI.equals(value);</span></span>
...
<span id="LC1567" class="line" lang="java"><span class="cm">            NodeImpl ancestor = (NodeImpl)getElementAncestor(this);</span></span>
<span id="LC1568" class="line" lang="java"><span class="cm">            if (ancestor != null) {</span></span>
<span id="LC1569" class="line" lang="java"><span class="cm">                return ancestor.isDefaultNamespace(namespaceURI);</span></span>
<span id="LC1570" class="line" lang="java"><span class="cm">            }</span></span>
<span id="LC1571" class="line" lang="java"><span class="cm">            return false;</span></span>
<span id="LC1572" class="line" lang="java"><span class="cm">        }</span></span>
<span id="LC1573" class="line" lang="java"><span class="cm">        case Node.DOCUMENT_NODE:{</span></span>
<span id="LC1574" class="line" lang="java"><span class="cm">                return((NodeImpl)((Document)this).getDocumentElement()).isDefaultNamespace(namespaceURI);</span></span>
<span id="LC1575" class="line" lang="java"><span class="cm">            }</span></span>
<span id="LC1576" class="line" lang="java"></span>
<span id="LC1577" class="line" lang="java"><span class="cm">        case Node.ENTITY_NODE :</span></span>
<span id="LC1578" class="line" lang="java"><span class="cm">          case Node.NOTATION_NODE:</span></span>
<span id="LC1579" class="line" lang="java"><span class="cm">        case Node.DOCUMENT_FRAGMENT_NODE:</span></span>
<span id="LC1580" class="line" lang="java"><span class="cm">        case Node.DOCUMENT_TYPE_NODE:</span></span>
<span id="LC1581" class="line" lang="java"><span class="cm">            // type is unknown</span></span>
<span id="LC1582" class="line" lang="java"><span class="cm">            return false;</span></span>
<span id="LC1583" class="line" lang="java"><span class="cm">        case Node.ATTRIBUTE_NODE:{</span></span>
<span id="LC1584" class="line" lang="java"><span class="cm">                if (this.ownerNode.getNodeType() == Node.ELEMENT_NODE) {</span></span>
<span id="LC1585" class="line" lang="java"><span class="cm">                    return ownerNode.isDefaultNamespace(namespaceURI);</span></span>
<span id="LC1586" class="line" lang="java"></span>
<span id="LC1587" class="line" lang="java"><span class="cm">                }</span></span>
<span id="LC1588" class="line" lang="java"><span class="cm">                return false;</span></span>
<span id="LC1589" class="line" lang="java"><span class="cm">            }</span></span>
<span id="LC1590" class="line" lang="java"><span class="cm">        default:{</span></span>
<span id="LC1591" class="line" lang="java"><span class="cm">                NodeImpl ancestor = (NodeImpl)getElementAncestor(this);</span></span>
<span id="LC1592" class="line" lang="java"><span class="cm">                if (ancestor != null) {</span></span>
<span id="LC1593" class="line" lang="java"><span class="cm">                    return ancestor.isDefaultNamespace(namespaceURI);</span></span>
<span id="LC1594" class="line" lang="java"><span class="cm">                }</span></span>
<span id="LC1595" class="line" lang="java"><span class="cm">                return false;</span></span>
...
<span id="LC1607" class="line" lang="java"><span class="cm">     * DOM Level 3 - Experimental:</span></span>
<span id="LC1608" class="line" lang="java"><span class="cm">     * Look up the prefix associated to the given namespace URI, starting from this node.</span></span>
<span id="LC1609" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1610" class="line" lang="java"><span class="cm">     * @param namespaceURI</span></span>
<span id="LC1611" class="line" lang="java"><span class="cm">     * @return the prefix for the namespace</span></span>
<span id="LC1612" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1613" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">lookupPrefix</span><span class="o">(</span><span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">){</span></span>
<span id="LC1614" class="line" lang="java"></span>
<span id="LC1615" class="line" lang="java">        <span class="c1">// REVISIT: When Namespaces 1.1 comes out this may not be true</span></span>
<span id="LC1616" class="line" lang="java">        <span class="c1">// Prefix can't be bound to null namespace</span></span>
<span id="LC1617" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">namespaceURI</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1618" class="line" lang="java">            <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1619" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC1620" class="line" lang="java"></span>
<span id="LC1621" class="line" lang="java">        <span class="kt">short</span> <span class="n">type</span> <span class="o">=</span> <span class="k">this</span><span class="o">.</span><span class="na">getNodeType</span><span class="o">();</span></span>
<span id="LC1622" class="line" lang="java"></span>
<span id="LC1623" class="line" lang="java">        <span class="k">switch</span> <span class="o">(</span><span class="n">type</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1624" class="line" lang="java"><span class="cm">/*</span></span>
<span id="LC1625" class="line" lang="java"><span class="cm">        case Node.ELEMENT_NODE: {</span></span>
<span id="LC1626" class="line" lang="java"></span>
<span id="LC1627" class="line" lang="java"><span class="cm">                String namespace = this.getNamespaceURI(); // to flip out children</span></span>
<span id="LC1628" class="line" lang="java"><span class="cm">                return lookupNamespacePrefix(namespaceURI, (ElementImpl)this);</span></span>
<span id="LC1629" class="line" lang="java"><span class="cm">            }</span></span>
<span id="LC1630" class="line" lang="java"></span>
<span id="LC1631" class="line" lang="java"><span class="cm">        case Node.DOCUMENT_NODE:{</span></span>
<span id="LC1632" class="line" lang="java"><span class="cm">                return((NodeImpl)((Document)this).getDocumentElement()).lookupPrefix(namespaceURI);</span></span>
<span id="LC1633" class="line" lang="java"><span class="cm">            }</span></span>
<span id="LC1634" class="line" lang="java"><span class="cm">*/</span></span>
<span id="LC1635" class="line" lang="java">        <span class="k">case</span> <span class="nc">Node</span><span class="o">.</span><span class="na">ENTITY_NODE</span> <span class="o">:</span></span>
<span id="LC1636" class="line" lang="java">        <span class="k">case</span> <span class="nc">Node</span><span class="o">.</span><span class="na">NOTATION_NODE</span><span class="o">:</span></span>
<span id="LC1637" class="line" lang="java">        <span class="k">case</span> <span class="nc">Node</span><span class="o">.</span><span class="na">DOCUMENT_FRAGMENT_NODE</span><span class="o">:</span></span>
<span id="LC1638" class="line" lang="java">        <span class="k">case</span> <span class="nc">Node</span><span class="o">.</span><span class="na">DOCUMENT_TYPE_NODE</span><span class="o">:</span></span>
<span id="LC1639" class="line" lang="java">            <span class="c1">// type is unknown</span></span>
<span id="LC1640" class="line" lang="java">            <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1641" class="line" lang="java">        <span class="k">case</span> <span class="nc">Node</span><span class="o">.</span><span class="na">ATTRIBUTE_NODE</span><span class="o">:{</span></span>
<span id="LC1642" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="k">this</span><span class="o">.</span><span class="na">getOwnerElement</span><span class="o">().</span><span class="na">getNodeType</span><span class="o">()</span> <span class="o">==</span> <span class="nc">Node</span><span class="o">.</span><span class="na">ELEMENT_NODE</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1643" class="line" lang="java">                    <span class="k">return</span> <span class="nf">getOwnerElement</span><span class="o">().</span><span class="na">lookupPrefix</span><span class="o">(</span><span class="n">namespaceURI</span><span class="o">);</span></span>
...
<span id="LC1650" class="line" lang="java"><span class="cm">                NodeImpl ancestor = (NodeImpl)getElementAncestor(this);</span></span>
<span id="LC1651" class="line" lang="java"><span class="cm">                if (ancestor != null) {</span></span>
<span id="LC1652" class="line" lang="java"><span class="cm">                    return ancestor.lookupPrefix(namespaceURI);</span></span>
...
<span id="LC1661" class="line" lang="java"><span class="cm">     * Returns whether this node is the same node as the given one.</span></span>
<span id="LC1662" class="line" lang="java"><span class="cm">     * &lt;br&gt;This method provides a way to determine whether two</span></span>
<span id="LC1663" class="line" lang="java"><span class="cm">     * &lt;code&gt;Node&lt;/code&gt; references returned by the implementation reference</span></span>
<span id="LC1664" class="line" lang="java"><span class="cm">     * the same object. When two &lt;code&gt;Node&lt;/code&gt; references are references</span></span>
<span id="LC1665" class="line" lang="java"><span class="cm">     * to the same object, even if through a proxy, the references may be</span></span>
<span id="LC1666" class="line" lang="java"><span class="cm">     * used completely interchangably, such that all attributes have the</span></span>
<span id="LC1667" class="line" lang="java"><span class="cm">     * same values and calling the same DOM method on either reference</span></span>
<span id="LC1668" class="line" lang="java"><span class="cm">     * always has exactly the same effect.</span></span>
<span id="LC1669" class="line" lang="java"><span class="cm">     * @param other The node to test against.</span></span>
<span id="LC1670" class="line" lang="java"><span class="cm">     * @return Returns &lt;code&gt;true&lt;/code&gt; if the nodes are the same,</span></span>
<span id="LC1671" class="line" lang="java"><span class="cm">     *   &lt;code&gt;false&lt;/code&gt; otherwise.</span></span>
<span id="LC1672" class="line" lang="java"><span class="cm">     * @since DOM Level 3</span></span>
<span id="LC1673" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1674" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isSameNode</span><span class="o">(</span><span class="nc">Node</span> <span class="n">other</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1675" class="line" lang="java">        <span class="c1">// we do not use any wrapper so the answer is obvious</span></span>
<span id="LC1676" class="line" lang="java">        <span class="k">return</span> <span class="k">this</span> <span class="o">==</span> <span class="n">other</span><span class="o">;</span></span>
...
<span id="LC1680" class="line" lang="java"><span class="cm">     * This attribute returns the text content of this node and its</span></span>
<span id="LC1681" class="line" lang="java"><span class="cm">     * descendants. When it is defined to be null, setting it has no effect.</span></span>
<span id="LC1682" class="line" lang="java"><span class="cm">     * When set, any possible children this node may have are removed and</span></span>
<span id="LC1683" class="line" lang="java"><span class="cm">     * replaced by a single &lt;code&gt;Text&lt;/code&gt; node containing the string</span></span>
<span id="LC1684" class="line" lang="java"><span class="cm">     * this attribute is set to. On getting, no serialization is performed,</span></span>
<span id="LC1685" class="line" lang="java"><span class="cm">     * the returned string does not contain any markup. No whitespace</span></span>
<span id="LC1686" class="line" lang="java"><span class="cm">     * normalization is performed, the returned string does not contain the</span></span>
<span id="LC1687" class="line" lang="java"><span class="cm">     * element content whitespaces . Similarly, on setting, no parsing is</span></span>
<span id="LC1688" class="line" lang="java"><span class="cm">     * performed either, the input string is taken as pure textual content.</span></span>
<span id="LC1689" class="line" lang="java"><span class="cm">     * &lt;br&gt;The string returned is made of the text content of this node</span></span>
<span id="LC1690" class="line" lang="java"><span class="cm">     * depending on its type, as defined below:</span></span>
<span id="LC1691" class="line" lang="java"><span class="cm">     * &lt;table border='1'&gt;</span></span>
<span id="LC1692" class="line" lang="java"><span class="cm">     * &lt;tr&gt;</span></span>
<span id="LC1693" class="line" lang="java"><span class="cm">     * &lt;th&gt;Node type&lt;/th&gt;</span></span>
<span id="LC1694" class="line" lang="java"><span class="cm">     * &lt;th&gt;Content&lt;/th&gt;</span></span>
...
<span id="LC1697" class="line" lang="java"><span class="cm">     * &lt;td valign='top' rowspan='1' colspan='1'&gt;</span></span>
<span id="LC1698" class="line" lang="java"><span class="cm">     * ELEMENT_NODE, ENTITY_NODE, ENTITY_REFERENCE_NODE,</span></span>
<span id="LC1699" class="line" lang="java"><span class="cm">     * DOCUMENT_FRAGMENT_NODE&lt;/td&gt;</span></span>
<span id="LC1700" class="line" lang="java"><span class="cm">     * &lt;td valign='top' rowspan='1' colspan='1'&gt;concatenation of the &lt;code&gt;textContent&lt;/code&gt;</span></span>
<span id="LC1701" class="line" lang="java"><span class="cm">     * attribute value of every child node, excluding COMMENT_NODE and</span></span>
<span id="LC1702" class="line" lang="java"><span class="cm">     * PROCESSING_INSTRUCTION_NODE nodes&lt;/td&gt;</span></span>
<span id="LC1703" class="line" lang="java"><span class="cm">     * &lt;/tr&gt;</span></span>
<span id="LC1704" class="line" lang="java"><span class="cm">     * &lt;tr&gt;</span></span>
<span id="LC1705" class="line" lang="java"><span class="cm">     * &lt;td valign='top' rowspan='1' colspan='1'&gt;ATTRIBUTE_NODE, TEXT_NODE,</span></span>
<span id="LC1706" class="line" lang="java"><span class="cm">     * CDATA_SECTION_NODE, COMMENT_NODE, PROCESSING_INSTRUCTION_NODE&lt;/td&gt;</span></span>
<span id="LC1707" class="line" lang="java"><span class="cm">     * &lt;td valign='top' rowspan='1' colspan='1'&gt;</span></span>
<span id="LC1708" class="line" lang="java"><span class="cm">     * &lt;code&gt;nodeValue&lt;/code&gt;&lt;/td&gt;</span></span>
<span id="LC1709" class="line" lang="java"><span class="cm">     * &lt;/tr&gt;</span></span>
<span id="LC1710" class="line" lang="java"><span class="cm">     * &lt;tr&gt;</span></span>
<span id="LC1711" class="line" lang="java"><span class="cm">     * &lt;td valign='top' rowspan='1' colspan='1'&gt;DOCUMENT_NODE, DOCUMENT_TYPE_NODE, NOTATION_NODE&lt;/td&gt;</span></span>
<span id="LC1712" class="line" lang="java"><span class="cm">     * &lt;td valign='top' rowspan='1' colspan='1'&gt;</span></span>
<span id="LC1713" class="line" lang="java"><span class="cm">     * null&lt;/td&gt;</span></span>
<span id="LC1714" class="line" lang="java"><span class="cm">     * &lt;/tr&gt;</span></span>
<span id="LC1715" class="line" lang="java"><span class="cm">     * &lt;/table&gt;</span></span>
<span id="LC1716" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1717" class="line" lang="java"><span class="cm">     *   NO_MODIFICATION_ALLOWED_ERR: Raised when the node is readonly.</span></span>
<span id="LC1718" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1719" class="line" lang="java"><span class="cm">     *   DOMSTRING_SIZE_ERR: Raised when it would return more characters than</span></span>
<span id="LC1720" class="line" lang="java"><span class="cm">     *   fit in a &lt;code&gt;DOMString&lt;/code&gt; variable on the implementation</span></span>
<span id="LC1721" class="line" lang="java"><span class="cm">     *   platform.</span></span>
<span id="LC1722" class="line" lang="java"><span class="cm">       * @since DOM Level 3</span></span>
<span id="LC1723" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1724" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTextContent</span><span class="o">(</span><span class="nc">String</span> <span class="n">textContent</span><span class="o">)</span></span>
<span id="LC1725" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">DOMException</span> <span class="o">{</span></span>
<span id="LC1726" class="line" lang="java">        <span class="n">setNodeValue</span><span class="o">(</span><span class="n">textContent</span><span class="o">);</span></span>
<span id="LC1727" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1728" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1729" class="line" lang="java"><span class="cm">     * This attribute returns the text content of this node and its</span></span>
<span id="LC1730" class="line" lang="java"><span class="cm">     * descendants. When it is defined to be null, setting it has no effect.</span></span>
<span id="LC1731" class="line" lang="java"><span class="cm">     * When set, any possible children this node may have are removed and</span></span>
<span id="LC1732" class="line" lang="java"><span class="cm">     * replaced by a single &lt;code&gt;Text&lt;/code&gt; node containing the string</span></span>
<span id="LC1733" class="line" lang="java"><span class="cm">     * this attribute is set to. On getting, no serialization is performed,</span></span>
<span id="LC1734" class="line" lang="java"><span class="cm">     * the returned string does not contain any markup. No whitespace</span></span>
<span id="LC1735" class="line" lang="java"><span class="cm">     * normalization is performed, the returned string does not contain the</span></span>
<span id="LC1736" class="line" lang="java"><span class="cm">     * element content whitespaces . Similarly, on setting, no parsing is</span></span>
<span id="LC1737" class="line" lang="java"><span class="cm">     * performed either, the input string is taken as pure textual content.</span></span>
<span id="LC1738" class="line" lang="java"><span class="cm">     * &lt;br&gt;The string returned is made of the text content of this node</span></span>
<span id="LC1739" class="line" lang="java"><span class="cm">     * depending on its type, as defined below:</span></span>
<span id="LC1740" class="line" lang="java"><span class="cm">     * &lt;table border='1'&gt;</span></span>
<span id="LC1741" class="line" lang="java"><span class="cm">     * &lt;tr&gt;</span></span>
<span id="LC1742" class="line" lang="java"><span class="cm">     * &lt;th&gt;Node type&lt;/th&gt;</span></span>
<span id="LC1743" class="line" lang="java"><span class="cm">     * &lt;th&gt;Content&lt;/th&gt;</span></span>
<span id="LC1744" class="line" lang="java"><span class="cm">     * &lt;/tr&gt;</span></span>
<span id="LC1745" class="line" lang="java"><span class="cm">     * &lt;tr&gt;</span></span>
<span id="LC1746" class="line" lang="java"><span class="cm">     * &lt;td valign='top' rowspan='1' colspan='1'&gt;</span></span>
<span id="LC1747" class="line" lang="java"><span class="cm">     * ELEMENT_NODE, ENTITY_NODE, ENTITY_REFERENCE_NODE,</span></span>
<span id="LC1748" class="line" lang="java"><span class="cm">     * DOCUMENT_FRAGMENT_NODE&lt;/td&gt;</span></span>
<span id="LC1749" class="line" lang="java"><span class="cm">     * &lt;td valign='top' rowspan='1' colspan='1'&gt;concatenation of the &lt;code&gt;textContent&lt;/code&gt;</span></span>
<span id="LC1750" class="line" lang="java"><span class="cm">     * attribute value of every child node, excluding COMMENT_NODE and</span></span>
<span id="LC1751" class="line" lang="java"><span class="cm">     * PROCESSING_INSTRUCTION_NODE nodes&lt;/td&gt;</span></span>
<span id="LC1752" class="line" lang="java"><span class="cm">     * &lt;/tr&gt;</span></span>
<span id="LC1753" class="line" lang="java"><span class="cm">     * &lt;tr&gt;</span></span>
<span id="LC1754" class="line" lang="java"><span class="cm">     * &lt;td valign='top' rowspan='1' colspan='1'&gt;ATTRIBUTE_NODE, TEXT_NODE,</span></span>
<span id="LC1755" class="line" lang="java"><span class="cm">     * CDATA_SECTION_NODE, COMMENT_NODE, PROCESSING_INSTRUCTION_NODE&lt;/td&gt;</span></span>
<span id="LC1756" class="line" lang="java"><span class="cm">     * &lt;td valign='top' rowspan='1' colspan='1'&gt;</span></span>
<span id="LC1757" class="line" lang="java"><span class="cm">     * &lt;code&gt;nodeValue&lt;/code&gt;&lt;/td&gt;</span></span>
<span id="LC1758" class="line" lang="java"><span class="cm">     * &lt;/tr&gt;</span></span>
<span id="LC1759" class="line" lang="java"><span class="cm">     * &lt;tr&gt;</span></span>
<span id="LC1760" class="line" lang="java"><span class="cm">     * &lt;td valign='top' rowspan='1' colspan='1'&gt;DOCUMENT_NODE, DOCUMENT_TYPE_NODE, NOTATION_NODE&lt;/td&gt;</span></span>
<span id="LC1761" class="line" lang="java"><span class="cm">     * &lt;td valign='top' rowspan='1' colspan='1'&gt;</span></span>
<span id="LC1762" class="line" lang="java"><span class="cm">     * null&lt;/td&gt;</span></span>
<span id="LC1763" class="line" lang="java"><span class="cm">     * &lt;/tr&gt;</span></span>
<span id="LC1764" class="line" lang="java"><span class="cm">     * &lt;/table&gt;</span></span>
<span id="LC1765" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1766" class="line" lang="java"><span class="cm">     *   NO_MODIFICATION_ALLOWED_ERR: Raised when the node is readonly.</span></span>
<span id="LC1767" class="line" lang="java"><span class="cm">     * @exception DOMException</span></span>
<span id="LC1768" class="line" lang="java"><span class="cm">     *   DOMSTRING_SIZE_ERR: Raised when it would return more characters than</span></span>
<span id="LC1769" class="line" lang="java"><span class="cm">     *   fit in a &lt;code&gt;DOMString&lt;/code&gt; variable on the implementation</span></span>
<span id="LC1770" class="line" lang="java"><span class="cm">     *   platform.</span></span>
<span id="LC1771" class="line" lang="java"><span class="cm">     * @since DOM Level 3</span></span>
<span id="LC1772" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1773" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getTextContent</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">DOMException</span> <span class="o">{</span></span>
<span id="LC1774" class="line" lang="java">        <span class="k">return</span> <span class="nf">getNodeValue</span><span class="o">();</span>  <span class="c1">// overriden in some subclasses</span></span>
...
<span id="LC1778" class="line" lang="java"><span class="cm">     * Compares a node with this node with regard to their position in the</span></span>
<span id="LC1779" class="line" lang="java"><span class="cm">     * document.</span></span>
<span id="LC1780" class="line" lang="java"><span class="cm">     * @param other The node to compare against this node.</span></span>
<span id="LC1781" class="line" lang="java"><span class="cm">     * @return Returns how the given node is positioned relatively to this</span></span>
<span id="LC1782" class="line" lang="java"><span class="cm">     *   node.</span></span>
<span id="LC1783" class="line" lang="java"><span class="cm">     * @since DOM Level 3</span></span>
<span id="LC1784" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1785" class="line" lang="java">    <span class="kd">public</span> <span class="kt">short</span> <span class="nf">compareDocumentPosition</span><span class="o">(</span><span class="nc">Node</span> <span class="n">other</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span> <span class="o">{</span></span>
<span id="LC1786" class="line" lang="java">        <span class="k">return</span> <span class="mi">0</span><span class="o">;</span></span>
...
<span id="LC1790" class="line" lang="java"><span class="cm">     * The absolute base URI of this node or &lt;code&gt;null&lt;/code&gt; if undefined.</span></span>
<span id="LC1791" class="line" lang="java"><span class="cm">     * This value is computed according to . However, when the</span></span>
<span id="LC1792" class="line" lang="java"><span class="cm">     * &lt;code&gt;Document&lt;/code&gt; supports the feature "HTML" , the base URI is</span></span>
<span id="LC1793" class="line" lang="java"><span class="cm">     * computed using first the value of the href attribute of the HTML BASE</span></span>
<span id="LC1794" class="line" lang="java"><span class="cm">     * element if any, and the value of the &lt;code&gt;documentURI&lt;/code&gt;</span></span>
<span id="LC1795" class="line" lang="java"><span class="cm">     * attribute from the &lt;code&gt;Document&lt;/code&gt; interface otherwise.</span></span>
<span id="LC1796" class="line" lang="java"><span class="cm">     * &lt;br&gt; When the node is an &lt;code&gt;Element&lt;/code&gt;, a &lt;code&gt;Document&lt;/code&gt;</span></span>
<span id="LC1797" class="line" lang="java"><span class="cm">     * or a a &lt;code&gt;ProcessingInstruction&lt;/code&gt;, this attribute represents</span></span>
<span id="LC1798" class="line" lang="java"><span class="cm">     * the properties [base URI] defined in . When the node is a</span></span>
<span id="LC1799" class="line" lang="java"><span class="cm">     * &lt;code&gt;Notation&lt;/code&gt;, an &lt;code&gt;Entity&lt;/code&gt;, or an</span></span>
<span id="LC1800" class="line" lang="java"><span class="cm">     * &lt;code&gt;EntityReference&lt;/code&gt;, this attribute represents the</span></span>
<span id="LC1801" class="line" lang="java"><span class="cm">     * properties [declaration base URI] in the . How will this be affected</span></span>
<span id="LC1802" class="line" lang="java"><span class="cm">     * by resolution of relative namespace URIs issue?It's not.Should this</span></span>
<span id="LC1803" class="line" lang="java"><span class="cm">     * only be on Document, Element, ProcessingInstruction, Entity, and</span></span>
<span id="LC1804" class="line" lang="java"><span class="cm">     * Notation nodes, according to the infoset? If not, what is it equal to</span></span>
<span id="LC1805" class="line" lang="java"><span class="cm">     * on other nodes? Null? An empty string? I think it should be the</span></span>
<span id="LC1806" class="line" lang="java"><span class="cm">     * parent's.No.Should this be read-only and computed or and actual</span></span>
<span id="LC1807" class="line" lang="java"><span class="cm">     * read-write attribute?Read-only and computed (F2F 19 Jun 2000 and</span></span>
<span id="LC1808" class="line" lang="java"><span class="cm">     * teleconference 30 May 2001).If the base HTML element is not yet</span></span>
<span id="LC1809" class="line" lang="java"><span class="cm">     * attached to a document, does the insert change the Document.baseURI?</span></span>
<span id="LC1810" class="line" lang="java"><span class="cm">     * Yes. (F2F 26 Sep 2001)</span></span>
<span id="LC1811" class="line" lang="java"><span class="cm">     * @since DOM Level 3</span></span>
<span id="LC1812" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1813" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getBaseURI</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC1814" class="line" lang="java">        <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC1818" class="line" lang="java"><span class="cm">     * DOM Level 3 WD - Experimental.</span></span>
<span id="LC1819" class="line" lang="java"><span class="cm">     * Renaming node</span></span>
<span id="LC1820" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1821" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Node</span> <span class="nf">renameNode</span><span class="o">(</span><span class="nc">Node</span> <span class="n">n</span><span class="o">,</span></span>
<span id="LC1822" class="line" lang="java">                           <span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">,</span></span>
<span id="LC1823" class="line" lang="java">                           <span class="nc">String</span> <span class="n">name</span><span class="o">)</span></span>
<span id="LC1824" class="line" lang="java">                           <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">{</span></span>
<span id="LC1825" class="line" lang="java">        <span class="k">return</span> <span class="n">n</span><span class="o">;</span></span>
...
<span id="LC1830" class="line" lang="java"><span class="cm">     *  DOM Level 3 WD - Experimental</span></span>
<span id="LC1831" class="line" lang="java"><span class="cm">     *  Normalize document.</span></span>
<span id="LC1832" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1833" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">normalizeDocument</span><span class="o">(){</span></span>
...
<span id="LC1837" class="line" lang="java"><span class="cm">     *  The configuration used when &lt;code&gt;Document.normalizeDocument&lt;/code&gt; is</span></span>
<span id="LC1838" class="line" lang="java"><span class="cm">     * invoked.</span></span>
<span id="LC1839" class="line" lang="java"><span class="cm">     * @since DOM Level 3</span></span>
<span id="LC1840" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1841" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DOMConfiguration</span> <span class="nf">getDomConfig</span><span class="o">(){</span></span>
...
<span id="LC1846" class="line" lang="java">    <span class="cm">/**Experimental DOM Level 3 feature: documentURI */</span></span>
<span id="LC1847" class="line" lang="java">    <span class="kd">protected</span> <span class="nc">String</span> <span class="n">fDocumentURI</span><span class="o">;</span></span>
<span id="LC1848" class="line" lang="java"></span>
<span id="LC1849" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1850" class="line" lang="java"><span class="cm">     * DOM Level 3 WD - Experimental.</span></span>
<span id="LC1851" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1852" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDocumentURI</span><span class="o">(</span><span class="nc">String</span> <span class="n">documentURI</span><span class="o">){</span></span>
<span id="LC1853" class="line" lang="java"></span>
<span id="LC1854" class="line" lang="java">        <span class="n">fDocumentURI</span><span class="o">=</span> <span class="n">documentURI</span><span class="o">;</span></span>
...
<span id="LC1858" class="line" lang="java"><span class="cm">     * DOM Level 3 WD - Experimental.</span></span>
<span id="LC1859" class="line" lang="java"><span class="cm">     * The location of the document or &lt;code&gt;null&lt;/code&gt; if undefined.</span></span>
<span id="LC1860" class="line" lang="java"><span class="cm">     * &lt;br&gt;Beware that when the &lt;code&gt;Document&lt;/code&gt; supports the feature</span></span>
<span id="LC1861" class="line" lang="java"><span class="cm">     * "HTML" , the href attribute of the HTML BASE element takes precedence</span></span>
<span id="LC1862" class="line" lang="java"><span class="cm">     * over this attribute.</span></span>
<span id="LC1863" class="line" lang="java"><span class="cm">     * @since DOM Level 3</span></span>
<span id="LC1864" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1865" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getDocumentURI</span><span class="o">(){</span></span>
<span id="LC1866" class="line" lang="java">        <span class="k">return</span> <span class="n">fDocumentURI</span><span class="o">;</span></span>
<span id="LC1867" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1868" class="line" lang="java"></span>
<span id="LC1869" class="line" lang="java">        <span class="cm">/**Experimental DOM Level 3 feature: Document actualEncoding */</span></span>
<span id="LC1870" class="line" lang="java">    <span class="kd">protected</span> <span class="nc">String</span> <span class="n">actualEncoding</span><span class="o">;</span></span>
<span id="LC1871" class="line" lang="java"></span>
<span id="LC1872" class="line" lang="java">     <span class="cm">/**</span></span>
<span id="LC1873" class="line" lang="java"><span class="cm">     * DOM Level 3 WD - Experimental.</span></span>
<span id="LC1874" class="line" lang="java"><span class="cm">     * An attribute specifying the actual encoding of this document. This is</span></span>
<span id="LC1875" class="line" lang="java"><span class="cm">     * &lt;code&gt;null&lt;/code&gt; otherwise.</span></span>
<span id="LC1876" class="line" lang="java"><span class="cm">     * &lt;br&gt; This attribute represents the property [character encoding scheme]</span></span>
<span id="LC1877" class="line" lang="java"><span class="cm">     * defined in .</span></span>
<span id="LC1878" class="line" lang="java"><span class="cm">     * @since DOM Level 3</span></span>
<span id="LC1879" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1880" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getActualEncoding</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC1881" class="line" lang="java">        <span class="k">return</span> <span class="n">actualEncoding</span><span class="o">;</span></span>
...
<span id="LC1885" class="line" lang="java"><span class="cm">     * DOM Level 3 WD - Experimental.</span></span>
<span id="LC1886" class="line" lang="java"><span class="cm">     * An attribute specifying the actual encoding of this document. This is</span></span>
<span id="LC1887" class="line" lang="java"><span class="cm">     * &lt;code&gt;null&lt;/code&gt; otherwise.</span></span>
<span id="LC1888" class="line" lang="java"><span class="cm">     * &lt;br&gt; This attribute represents the property [character encoding scheme]</span></span>
<span id="LC1889" class="line" lang="java"><span class="cm">     * defined in .</span></span>
<span id="LC1890" class="line" lang="java"><span class="cm">     * @since DOM Level 3</span></span>
<span id="LC1891" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1892" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setActualEncoding</span><span class="o">(</span><span class="nc">String</span> <span class="n">value</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1893" class="line" lang="java">        <span class="n">actualEncoding</span> <span class="o">=</span> <span class="n">value</span><span class="o">;</span></span>
...
<span id="LC1897" class="line" lang="java"><span class="cm">    * DOM Level 3 WD - Experimental.</span></span>
<span id="LC1898" class="line" lang="java"><span class="cm">    */</span></span>
<span id="LC1899" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Text</span> <span class="nf">replaceWholeText</span><span class="o">(</span><span class="nc">String</span> <span class="n">content</span><span class="o">)</span></span>
<span id="LC1900" class="line" lang="java">                                 <span class="kd">throws</span> <span class="nc">DOMException</span><span class="o">{</span></span>
<span id="LC1901" class="line" lang="java"><span class="cm">/*</span></span>
<span id="LC1902" class="line" lang="java"></span>
<span id="LC1903" class="line" lang="java"><span class="cm">        if (needsSyncData()) {</span></span>
<span id="LC1904" class="line" lang="java"><span class="cm">            synchronizeData();</span></span>
<span id="LC1905" class="line" lang="java"><span class="cm">        }</span></span>
<span id="LC1906" class="line" lang="java"></span>
<span id="LC1907" class="line" lang="java"><span class="cm">        // make sure we can make the replacement</span></span>
<span id="LC1908" class="line" lang="java"><span class="cm">        if (!canModify(nextSibling)) {</span></span>
<span id="LC1909" class="line" lang="java"><span class="cm">            throw new DOMException(DOMException.NO_MODIFICATION_ALLOWED_ERR,</span></span>
<span id="LC1910" class="line" lang="java"><span class="cm">                DOMMessageFormatter.formatMessage(DOMMessageFormatter.DOM_DOMAIN, "NO_MODIFICATION_ALLOWED_ERR", null));</span></span>
<span id="LC1911" class="line" lang="java"><span class="cm">        }</span></span>
<span id="LC1912" class="line" lang="java"></span>
<span id="LC1913" class="line" lang="java"><span class="cm">        Node parent = this.getParentNode();</span></span>
<span id="LC1914" class="line" lang="java"><span class="cm">        if (content == null || content.length() == 0) {</span></span>
<span id="LC1915" class="line" lang="java"><span class="cm">            // remove current node</span></span>
<span id="LC1916" class="line" lang="java"><span class="cm">            if (parent !=null) { // check if node in the tree</span></span>
<span id="LC1917" class="line" lang="java"><span class="cm">                parent.removeChild(this);</span></span>
<span id="LC1918" class="line" lang="java"><span class="cm">                return null;</span></span>
<span id="LC1919" class="line" lang="java"><span class="cm">            }</span></span>
<span id="LC1920" class="line" lang="java"><span class="cm">        }</span></span>
<span id="LC1921" class="line" lang="java"><span class="cm">        Text currentNode = null;</span></span>
<span id="LC1922" class="line" lang="java"><span class="cm">        if (isReadOnly()){</span></span>
<span id="LC1923" class="line" lang="java"><span class="cm">            Text newNode = this.ownerDocument().createTextNode(content);</span></span>
<span id="LC1924" class="line" lang="java"><span class="cm">            if (parent !=null) { // check if node in the tree</span></span>
<span id="LC1925" class="line" lang="java"><span class="cm">                parent.insertBefore(newNode, this);</span></span>
<span id="LC1926" class="line" lang="java"><span class="cm">                parent.removeChild(this);</span></span>
<span id="LC1927" class="line" lang="java"><span class="cm">                currentNode = newNode;</span></span>
<span id="LC1928" class="line" lang="java"><span class="cm">            } else {</span></span>
<span id="LC1929" class="line" lang="java"><span class="cm">                return newNode;</span></span>
...
<span id="LC1932" class="line" lang="java"><span class="cm">            this.setData(content);</span></span>
<span id="LC1933" class="line" lang="java"><span class="cm">            currentNode = this;</span></span>
<span id="LC1934" class="line" lang="java"><span class="cm">        }</span></span>
<span id="LC1935" class="line" lang="java"><span class="cm">        Node sibling =  currentNode.getNextSibling();</span></span>
<span id="LC1936" class="line" lang="java"><span class="cm">        while ( sibling !=null) {</span></span>
<span id="LC1937" class="line" lang="java"><span class="cm">            parent.removeChild(sibling);</span></span>
<span id="LC1938" class="line" lang="java"><span class="cm">            sibling = currentNode.getNextSibling();</span></span>
<span id="LC1939" class="line" lang="java"><span class="cm">        }</span></span>
<span id="LC1940" class="line" lang="java"></span>
<span id="LC1941" class="line" lang="java"><span class="cm">        return currentNode;</span></span>
<span id="LC1942" class="line" lang="java"><span class="cm">*/</span></span>
<span id="LC1943" class="line" lang="java">        <span class="k">return</span> <span class="kc">null</span><span class="o">;</span> <span class="c1">//Pending</span></span>
...
<span id="LC1947" class="line" lang="java"><span class="cm">     * DOM Level 3 WD - Experimental.</span></span>
<span id="LC1948" class="line" lang="java"><span class="cm">     * Returns all text of &lt;code&gt;Text&lt;/code&gt; nodes logically-adjacent text</span></span>
<span id="LC1949" class="line" lang="java"><span class="cm">     * nodes to this node, concatenated in document order.</span></span>
<span id="LC1950" class="line" lang="java"><span class="cm">     * @since DOM Level 3</span></span>
<span id="LC1951" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1952" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getWholeText</span><span class="o">(){</span></span>
<span id="LC1953" class="line" lang="java"></span>
<span id="LC1954" class="line" lang="java"><span class="cm">/*</span></span>
<span id="LC1955" class="line" lang="java"><span class="cm">        if (needsSyncData()) {</span></span>
<span id="LC1956" class="line" lang="java"><span class="cm">            synchronizeData();</span></span>
<span id="LC1957" class="line" lang="java"><span class="cm">        }</span></span>
<span id="LC1958" class="line" lang="java"><span class="cm">        if (nextSibling == null) {</span></span>
<span id="LC1959" class="line" lang="java"><span class="cm">            return data;</span></span>
<span id="LC1960" class="line" lang="java"><span class="cm">        }</span></span>
<span id="LC1961" class="line" lang="java"><span class="cm">        StringBuffer buffer = new StringBuffer();</span></span>
<span id="LC1962" class="line" lang="java"><span class="cm">        if (data != null &amp;&amp; data.length() != 0) {</span></span>
<span id="LC1963" class="line" lang="java"><span class="cm">            buffer.append(data);</span></span>
<span id="LC1964" class="line" lang="java"><span class="cm">        }</span></span>
<span id="LC1965" class="line" lang="java"><span class="cm">        getWholeText(nextSibling, buffer);</span></span>
<span id="LC1966" class="line" lang="java"><span class="cm">        return buffer.toString();</span></span>
<span id="LC1967" class="line" lang="java"><span class="cm">*/</span></span>
<span id="LC1968" class="line" lang="java">        <span class="k">return</span> <span class="kc">null</span><span class="o">;</span> <span class="c1">// PENDING</span></span>
...
<span id="LC1973" class="line" lang="java"><span class="cm">    * DOM Level 3 WD - Experimental.</span></span>
<span id="LC1974" class="line" lang="java"><span class="cm">     * Returns whether this text node contains whitespace in element content,</span></span>
<span id="LC1975" class="line" lang="java"><span class="cm">     * often abusively called "ignorable whitespace".</span></span>
<span id="LC1976" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1977" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isWhitespaceInElementContent</span><span class="o">(){</span></span>
...
<span id="LC1985" class="line" lang="java"><span class="cm">     * NON-DOM: set the type of this attribute to be ID type.</span></span>
<span id="LC1986" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1987" class="line" lang="java"><span class="cm">     * @param id</span></span>
<span id="LC1988" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1989" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIdAttribute</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">id</span><span class="o">){</span></span>
<span id="LC1990" class="line" lang="java">        <span class="c1">//PENDING</span></span>
...
<span id="LC1994" class="line" lang="java"><span class="cm">     * DOM Level 3: register the given attribute node as an ID attribute</span></span>
<span id="LC1995" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1996" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIdAttribute</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">makeId</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1997" class="line" lang="java">        <span class="c1">//PENDING</span></span>
...
<span id="LC2002" class="line" lang="java"><span class="cm">     * DOM Level 3: register the given attribute node as an ID attribute</span></span>
<span id="LC2003" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC2004" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIdAttributeNode</span><span class="o">(</span><span class="nc">Attr</span> <span class="n">at</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">makeId</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC2005" class="line" lang="java">        <span class="c1">//PENDING</span></span>
...
<span id="LC2009" class="line" lang="java"><span class="cm">     * DOM Level 3: register the given attribute node as an ID attribute</span></span>
<span id="LC2010" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC2011" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIdAttributeNS</span><span class="o">(</span><span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">,</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span></span>
<span id="LC2012" class="line" lang="java">                                    <span class="kt">boolean</span> <span class="n">makeId</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC2013" class="line" lang="java">        <span class="c1">//PENDING</span></span>
<span id="LC2014" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC2015" class="line" lang="java">         <span class="cm">/**</span></span>
<span id="LC2016" class="line" lang="java"><span class="cm">         * Method getSchemaTypeInfo.</span></span>
<span id="LC2017" class="line" lang="java"><span class="cm">         * @return TypeInfo</span></span>
<span id="LC2018" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC2019" class="line" lang="java">    <span class="kd">public</span> <span class="nc">TypeInfo</span> <span class="nf">getSchemaTypeInfo</span><span class="o">(){</span></span>
<span id="LC2020" class="line" lang="java">      <span class="k">return</span> <span class="kc">null</span><span class="o">;</span> <span class="c1">//PENDING</span></span>
<span id="LC2021" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC2022" class="line" lang="java"></span>
<span id="LC2023" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isId</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC2024" class="line" lang="java">        <span class="k">return</span> <span class="kc">false</span><span class="o">;</span> <span class="c1">//PENDING</span></span>
<span id="LC2025" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC2026" class="line" lang="java"></span>
<span id="LC2027" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">xmlEncoding</span><span class="o">;</span></span>
<span id="LC2028" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getXmlEncoding</span> <span class="o">(</span> <span class="o">)</span> <span class="o">{</span></span>
<span id="LC2029" class="line" lang="java">        <span class="k">return</span> <span class="n">xmlEncoding</span><span class="o">;</span></span>
<span id="LC2030" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC2031" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setXmlEncoding</span> <span class="o">(</span> <span class="nc">String</span> <span class="n">xmlEncoding</span> <span class="o">)</span> <span class="o">{</span></span>
<span id="LC2032" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">xmlEncoding</span> <span class="o">=</span> <span class="n">xmlEncoding</span><span class="o">;</span></span>
<span id="LC2033" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC2034" class="line" lang="java"></span>
<span id="LC2035" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">xmlStandalone</span><span class="o">;</span></span>
<span id="LC2036" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getXmlStandalone</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC2037" class="line" lang="java">        <span class="k">return</span> <span class="n">xmlStandalone</span><span class="o">;</span></span>
<span id="LC2038" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC2039" class="line" lang="java"></span>
<span id="LC2040" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setXmlStandalone</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">xmlStandalone</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span> <span class="o">{</span></span>
<span id="LC2041" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">xmlStandalone</span> <span class="o">=</span> <span class="n">xmlStandalone</span><span class="o">;</span></span>
<span id="LC2042" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC2043" class="line" lang="java"></span>
<span id="LC2044" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">xmlVersion</span><span class="o">;</span></span>
<span id="LC2045" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getXmlVersion</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC2046" class="line" lang="java">        <span class="k">return</span> <span class="n">xmlVersion</span><span class="o">;</span></span>
<span id="LC2047" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC2048" class="line" lang="java"></span>
<span id="LC2049" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setXmlVersion</span><span class="o">(</span><span class="nc">String</span> <span class="n">xmlVersion</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">DOMException</span> <span class="o">{</span></span>
<span id="LC2050" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">xmlVersion</span> <span class="o">=</span> <span class="n">xmlVersion</span><span class="o">;</span></span>
