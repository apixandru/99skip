...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: EmptySerializer.java,v 1.2.4.1 2005/09/15 08:15:16 suresh_emailid Exp $</span></span>
...
<span id="LC30" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.transform.SourceLocator</span><span class="o">;</span></span>
<span id="LC31" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.transform.Transformer</span><span class="o">;</span></span>
...
<span id="LC41" class="line" lang="java"><span class="cm"> * This class is an adapter class. Its only purpose is to be extended and</span></span>
<span id="LC42" class="line" lang="java"><span class="cm"> * for that extended class to over-ride all methods that are to be used.</span></span>
<span id="LC43" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC44" class="line" lang="java"><span class="cm"> * This class is not a public API, it is only public because it is used</span></span>
<span id="LC45" class="line" lang="java"><span class="cm"> * across package boundaries.</span></span>
...
<span id="LC49" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">EmptySerializer</span> <span class="kd">implements</span> <span class="nc">SerializationHandler</span></span>
<span id="LC50" class="line" lang="java"><span class="o">{</span></span>
<span id="LC51" class="line" lang="java">    <span class="kd">protected</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">String</span> <span class="no">ERR</span> <span class="o">=</span> <span class="s">"EmptySerializer method not over-ridden"</span><span class="o">;</span></span>
<span id="LC52" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC53" class="line" lang="java"><span class="cm">     * @see SerializationHandler#asContentHandler()</span></span>
<span id="LC54" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC55" class="line" lang="java"></span>
<span id="LC56" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">couldThrowIOException</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
<span id="LC57" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC58" class="line" lang="java">        <span class="k">return</span><span class="o">;</span> <span class="c1">// don't do anything.</span></span>
<span id="LC59" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC60" class="line" lang="java"></span>
<span id="LC61" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">couldThrowSAXException</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC62" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC63" class="line" lang="java">        <span class="k">return</span><span class="o">;</span> <span class="c1">// don't do anything.</span></span>
<span id="LC64" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC65" class="line" lang="java"></span>
<span id="LC66" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">couldThrowSAXException</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">chars</span><span class="o">,</span> <span class="kt">int</span> <span class="n">off</span><span class="o">,</span> <span class="kt">int</span> <span class="n">len</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC67" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC68" class="line" lang="java">        <span class="k">return</span><span class="o">;</span> <span class="c1">// don't do anything.</span></span>
<span id="LC69" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC70" class="line" lang="java"></span>
<span id="LC71" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">couldThrowSAXException</span><span class="o">(</span><span class="nc">String</span> <span class="n">elemQName</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC72" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC73" class="line" lang="java">        <span class="k">return</span><span class="o">;</span> <span class="c1">// don't do anything.</span></span>
<span id="LC74" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC75" class="line" lang="java"></span>
<span id="LC76" class="line" lang="java">    <span class="kt">void</span> <span class="nf">aMethodIsCalled</span><span class="o">()</span></span>
<span id="LC77" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC78" class="line" lang="java"></span>
<span id="LC79" class="line" lang="java">        <span class="c1">// throw new RuntimeException(err);</span></span>
...
<span id="LC85" class="line" lang="java"><span class="cm">     * @see SerializationHandler#asContentHandler()</span></span>
<span id="LC86" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC87" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ContentHandler</span> <span class="nf">asContentHandler</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
<span id="LC88" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC89" class="line" lang="java">        <span class="n">couldThrowIOException</span><span class="o">();</span></span>
...
<span id="LC93" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setContentHandler(org.xml.sax.ContentHandler)</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC95" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setContentHandler</span><span class="o">(</span><span class="nc">ContentHandler</span> <span class="n">ch</span><span class="o">)</span></span>
<span id="LC96" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC97" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC98" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC99" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC100" class="line" lang="java"><span class="cm">     * @see SerializationHandler#close()</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC102" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">close</span><span class="o">()</span></span>
<span id="LC103" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC104" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC105" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC106" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">     * @see SerializationHandler#getOutputFormat()</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC109" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Properties</span> <span class="nf">getOutputFormat</span><span class="o">()</span></span>
<span id="LC110" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC111" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
...
<span id="LC115" class="line" lang="java"><span class="cm">     * @see SerializationHandler#getOutputStream()</span></span>
<span id="LC116" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC117" class="line" lang="java">    <span class="kd">public</span> <span class="nc">OutputStream</span> <span class="nf">getOutputStream</span><span class="o">()</span></span>
<span id="LC118" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC119" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC120" class="line" lang="java">        <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC121" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC122" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC123" class="line" lang="java"><span class="cm">     * @see SerializationHandler#getWriter()</span></span>
<span id="LC124" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC125" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Writer</span> <span class="nf">getWriter</span><span class="o">()</span></span>
<span id="LC126" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC127" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
...
<span id="LC131" class="line" lang="java"><span class="cm">     * @see SerializationHandler#reset()</span></span>
<span id="LC132" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC133" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">reset</span><span class="o">()</span></span>
<span id="LC134" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC135" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC136" class="line" lang="java">        <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC137" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC138" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC139" class="line" lang="java"><span class="cm">     * @see SerializationHandler#serialize(org.w3c.dom.Node)</span></span>
<span id="LC140" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC141" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">serialize</span><span class="o">(</span><span class="nc">Node</span> <span class="n">node</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
<span id="LC142" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC143" class="line" lang="java">        <span class="n">couldThrowIOException</span><span class="o">();</span></span>
<span id="LC144" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC145" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setCdataSectionElements(java.util.Vector)</span></span>
<span id="LC147" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC148" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setCdataSectionElements</span><span class="o">(</span><span class="nc">Vector</span> <span class="n">URI_and_localNames</span><span class="o">)</span></span>
<span id="LC149" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC150" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC151" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC152" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC153" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setEscaping(boolean)</span></span>
<span id="LC154" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC155" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">setEscaping</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">escape</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC156" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC157" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
...
<span id="LC161" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setIndent(boolean)</span></span>
<span id="LC162" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC163" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIndent</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">indent</span><span class="o">)</span></span>
<span id="LC164" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC165" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC166" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC167" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC168" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setIndentAmount(int)</span></span>
<span id="LC169" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC170" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIndentAmount</span><span class="o">(</span><span class="kt">int</span> <span class="n">spaces</span><span class="o">)</span></span>
<span id="LC171" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC172" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC173" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC174" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC175" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setIsStandalone(boolean)</span></span>
<span id="LC176" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC177" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIsStandalone</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">isStandalone</span><span class="o">)</span></span>
<span id="LC178" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC179" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC180" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC181" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC182" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setOutputFormat(java.util.Properties)</span></span>
<span id="LC183" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC184" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOutputFormat</span><span class="o">(</span><span class="nc">Properties</span> <span class="n">format</span><span class="o">)</span></span>
<span id="LC185" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC186" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC187" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC188" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC189" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setOutputStream(java.io.OutputStream)</span></span>
<span id="LC190" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC191" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOutputStream</span><span class="o">(</span><span class="nc">OutputStream</span> <span class="n">output</span><span class="o">)</span></span>
<span id="LC192" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC193" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC194" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC195" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC196" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setVersion(java.lang.String)</span></span>
<span id="LC197" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC198" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setVersion</span><span class="o">(</span><span class="nc">String</span> <span class="n">version</span><span class="o">)</span></span>
<span id="LC199" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC200" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC201" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC202" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC203" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setWriter(java.io.Writer)</span></span>
<span id="LC204" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC205" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setWriter</span><span class="o">(</span><span class="nc">Writer</span> <span class="n">writer</span><span class="o">)</span></span>
<span id="LC206" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC207" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC208" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC209" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC210" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setTransformer(javax.xml.transform.Transformer)</span></span>
<span id="LC211" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC212" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTransformer</span><span class="o">(</span><span class="nc">Transformer</span> <span class="n">transformer</span><span class="o">)</span></span>
<span id="LC213" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC214" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC215" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC216" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC217" class="line" lang="java"><span class="cm">     * @see SerializationHandler#getTransformer()</span></span>
<span id="LC218" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC219" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Transformer</span> <span class="nf">getTransformer</span><span class="o">()</span></span>
<span id="LC220" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC221" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
...
<span id="LC225" class="line" lang="java"><span class="cm">     * @see SerializationHandler#flushPending()</span></span>
<span id="LC226" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC227" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">flushPending</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC228" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC229" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC230" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC231" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC232" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#addAttribute(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)</span></span>
<span id="LC233" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC234" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addAttribute</span><span class="o">(</span></span>
<span id="LC235" class="line" lang="java">        <span class="nc">String</span> <span class="n">uri</span><span class="o">,</span></span>
<span id="LC236" class="line" lang="java">        <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span></span>
<span id="LC237" class="line" lang="java">        <span class="nc">String</span> <span class="n">rawName</span><span class="o">,</span></span>
<span id="LC238" class="line" lang="java">        <span class="nc">String</span> <span class="n">type</span><span class="o">,</span></span>
<span id="LC239" class="line" lang="java">        <span class="nc">String</span> <span class="n">value</span><span class="o">,</span></span>
<span id="LC240" class="line" lang="java">        <span class="kt">boolean</span> <span class="nc">XSLAttribute</span><span class="o">)</span></span>
<span id="LC241" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC242" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC243" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC244" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC245" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC246" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#addAttributes(org.xml.sax.Attributes)</span></span>
<span id="LC247" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC248" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addAttributes</span><span class="o">(</span><span class="nc">Attributes</span> <span class="n">atts</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC249" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC250" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC251" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC252" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC253" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#addAttribute(java.lang.String, java.lang.String)</span></span>
<span id="LC254" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC255" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addAttribute</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="nc">String</span> <span class="n">value</span><span class="o">)</span></span>
<span id="LC256" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC257" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
...
<span id="LC261" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#characters(java.lang.String)</span></span>
<span id="LC262" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC263" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">characters</span><span class="o">(</span><span class="nc">String</span> <span class="n">chars</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC264" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC265" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC266" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC267" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC268" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#endElement(java.lang.String)</span></span>
<span id="LC269" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC270" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endElement</span><span class="o">(</span><span class="nc">String</span> <span class="n">elemName</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC271" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC272" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC273" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC274" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC275" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#startDocument()</span></span>
<span id="LC276" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC277" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startDocument</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC278" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC279" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC280" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC281" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC282" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#startElement(java.lang.String, java.lang.String, java.lang.String)</span></span>
<span id="LC283" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC284" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startElement</span><span class="o">(</span><span class="nc">String</span> <span class="n">uri</span><span class="o">,</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span> <span class="nc">String</span> <span class="n">qName</span><span class="o">)</span></span>
<span id="LC285" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC286" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC287" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">(</span><span class="n">qName</span><span class="o">);</span></span>
<span id="LC288" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC289" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#startElement(java.lang.String)</span></span>
<span id="LC291" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC292" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startElement</span><span class="o">(</span><span class="nc">String</span> <span class="n">qName</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC293" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC294" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">(</span><span class="n">qName</span><span class="o">);</span></span>
<span id="LC295" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC296" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC297" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#namespaceAfterStartElement(java.lang.String, java.lang.String)</span></span>
<span id="LC298" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC299" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">namespaceAfterStartElement</span><span class="o">(</span><span class="nc">String</span> <span class="n">uri</span><span class="o">,</span> <span class="nc">String</span> <span class="n">prefix</span><span class="o">)</span></span>
<span id="LC300" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC301" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC302" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC303" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC304" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC305" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#startPrefixMapping(java.lang.String, java.lang.String, boolean)</span></span>
<span id="LC306" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC307" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">startPrefixMapping</span><span class="o">(</span></span>
<span id="LC308" class="line" lang="java">        <span class="nc">String</span> <span class="n">prefix</span><span class="o">,</span></span>
<span id="LC309" class="line" lang="java">        <span class="nc">String</span> <span class="n">uri</span><span class="o">,</span></span>
<span id="LC310" class="line" lang="java">        <span class="kt">boolean</span> <span class="n">shouldFlush</span><span class="o">)</span></span>
<span id="LC311" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC312" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC313" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
...
<span id="LC317" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#entityReference(java.lang.String)</span></span>
<span id="LC318" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC319" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">entityReference</span><span class="o">(</span><span class="nc">String</span> <span class="n">entityName</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC320" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC321" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC322" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC323" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC324" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#getNamespaceMappings()</span></span>
<span id="LC325" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC326" class="line" lang="java">    <span class="kd">public</span> <span class="nc">NamespaceMappings</span> <span class="nf">getNamespaceMappings</span><span class="o">()</span></span>
<span id="LC327" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC328" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
...
<span id="LC332" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#getPrefix(java.lang.String)</span></span>
<span id="LC333" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC334" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPrefix</span><span class="o">(</span><span class="nc">String</span> <span class="n">uri</span><span class="o">)</span></span>
<span id="LC335" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC336" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
...
<span id="LC340" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#getNamespaceURI(java.lang.String, boolean)</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC342" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getNamespaceURI</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">isElement</span><span class="o">)</span></span>
<span id="LC343" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC344" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
...
<span id="LC348" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#getNamespaceURIFromPrefix(java.lang.String)</span></span>
<span id="LC349" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC350" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getNamespaceURIFromPrefix</span><span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">)</span></span>
<span id="LC351" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC352" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC353" class="line" lang="java">        <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC354" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC355" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC356" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#setDocumentLocator(org.xml.sax.Locator)</span></span>
<span id="LC357" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC358" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDocumentLocator</span><span class="o">(</span><span class="nc">Locator</span> <span class="n">arg0</span><span class="o">)</span></span>
<span id="LC359" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC360" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC361" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC362" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC363" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#endDocument()</span></span>
<span id="LC364" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC365" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endDocument</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC366" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC367" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC368" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC369" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC370" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#startPrefixMapping(java.lang.String, java.lang.String)</span></span>
<span id="LC371" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC372" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startPrefixMapping</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg1</span><span class="o">)</span></span>
...
<span id="LC375" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC376" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC377" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC378" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#endPrefixMapping(java.lang.String)</span></span>
<span id="LC379" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC380" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endPrefixMapping</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg0</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC381" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC382" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC383" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC384" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC385" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#startElement(java.lang.String, java.lang.String, java.lang.String, org.xml.sax.Attributes)</span></span>
<span id="LC386" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC387" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startElement</span><span class="o">(</span></span>
<span id="LC388" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span></span>
<span id="LC389" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg1</span><span class="o">,</span></span>
<span id="LC390" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg2</span><span class="o">,</span></span>
<span id="LC391" class="line" lang="java">        <span class="nc">Attributes</span> <span class="n">arg3</span><span class="o">)</span></span>
<span id="LC392" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC393" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC394" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC395" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC396" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC397" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#endElement(java.lang.String, java.lang.String, java.lang.String)</span></span>
<span id="LC398" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC399" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endElement</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg1</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg2</span><span class="o">)</span></span>
<span id="LC400" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC401" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC402" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC403" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC404" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC405" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#characters(char[], int, int)</span></span>
<span id="LC406" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC407" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">characters</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">arg0</span><span class="o">,</span> <span class="kt">int</span> <span class="n">arg1</span><span class="o">,</span> <span class="kt">int</span> <span class="n">arg2</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC408" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC409" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">(</span><span class="n">arg0</span><span class="o">,</span> <span class="n">arg1</span><span class="o">,</span> <span class="n">arg2</span><span class="o">);</span></span>
<span id="LC410" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC411" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC412" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#ignorableWhitespace(char[], int, int)</span></span>
<span id="LC413" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC414" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">ignorableWhitespace</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">arg0</span><span class="o">,</span> <span class="kt">int</span> <span class="n">arg1</span><span class="o">,</span> <span class="kt">int</span> <span class="n">arg2</span><span class="o">)</span></span>
<span id="LC415" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC416" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC417" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC418" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC419" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC420" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#processingInstruction(java.lang.String, java.lang.String)</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC422" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">processingInstruction</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg1</span><span class="o">)</span></span>
...
<span id="LC425" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC426" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC427" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC428" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ContentHandler#skippedEntity(java.lang.String)</span></span>
<span id="LC429" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC430" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">skippedEntity</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg0</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC431" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC432" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC433" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC434" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC435" class="line" lang="java"><span class="cm">     * @see ExtendedLexicalHandler#comment(java.lang.String)</span></span>
<span id="LC436" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC437" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">comment</span><span class="o">(</span><span class="nc">String</span> <span class="n">comment</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC438" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC439" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC440" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC441" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC442" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.LexicalHandler#startDTD(java.lang.String, java.lang.String, java.lang.String)</span></span>
<span id="LC443" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC444" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startDTD</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg1</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg2</span><span class="o">)</span></span>
<span id="LC445" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC446" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC447" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC448" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC449" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC450" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.LexicalHandler#endDTD()</span></span>
<span id="LC451" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC452" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endDTD</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC453" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC454" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC455" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC456" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC457" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.LexicalHandler#startEntity(java.lang.String)</span></span>
<span id="LC458" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC459" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startEntity</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg0</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC460" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC461" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC462" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC463" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC464" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.LexicalHandler#endEntity(java.lang.String)</span></span>
<span id="LC465" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC466" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endEntity</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg0</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC467" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC468" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC469" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC470" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC471" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.LexicalHandler#startCDATA()</span></span>
<span id="LC472" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC473" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startCDATA</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC474" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC475" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC476" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC477" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC478" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.LexicalHandler#endCDATA()</span></span>
<span id="LC479" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC480" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endCDATA</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC481" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC482" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC483" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC484" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC485" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.LexicalHandler#comment(char[], int, int)</span></span>
<span id="LC486" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC487" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">comment</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">arg0</span><span class="o">,</span> <span class="kt">int</span> <span class="n">arg1</span><span class="o">,</span> <span class="kt">int</span> <span class="n">arg2</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC488" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC489" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC490" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC491" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC492" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getDoctypePublic()</span></span>
<span id="LC493" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC494" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getDoctypePublic</span><span class="o">()</span></span>
<span id="LC495" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC496" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
...
<span id="LC500" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getDoctypeSystem()</span></span>
<span id="LC501" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC502" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getDoctypeSystem</span><span class="o">()</span></span>
<span id="LC503" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC504" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC505" class="line" lang="java">        <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC506" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC507" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC508" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getEncoding()</span></span>
<span id="LC509" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC510" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getEncoding</span><span class="o">()</span></span>
<span id="LC511" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC512" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC513" class="line" lang="java">        <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC514" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC515" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC516" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getIndent()</span></span>
<span id="LC517" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC518" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getIndent</span><span class="o">()</span></span>
<span id="LC519" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC520" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
...
<span id="LC524" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getIndentAmount()</span></span>
<span id="LC525" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC526" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getIndentAmount</span><span class="o">()</span></span>
<span id="LC527" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC528" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC529" class="line" lang="java">        <span class="k">return</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC530" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC531" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC532" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getMediaType()</span></span>
<span id="LC533" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC534" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMediaType</span><span class="o">()</span></span>
<span id="LC535" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC536" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
...
<span id="LC540" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getOmitXMLDeclaration()</span></span>
<span id="LC541" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC542" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getOmitXMLDeclaration</span><span class="o">()</span></span>
<span id="LC543" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC544" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
...
<span id="LC548" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getStandalone()</span></span>
<span id="LC549" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC550" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getStandalone</span><span class="o">()</span></span>
<span id="LC551" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC552" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
...
<span id="LC556" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#getVersion()</span></span>
<span id="LC557" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC558" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getVersion</span><span class="o">()</span></span>
<span id="LC559" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC560" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC561" class="line" lang="java">        <span class="k">return</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC562" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC563" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC564" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setDoctype(java.lang.String, java.lang.String)</span></span>
<span id="LC565" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC566" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDoctype</span><span class="o">(</span><span class="nc">String</span> <span class="n">system</span><span class="o">,</span> <span class="nc">String</span> <span class="n">pub</span><span class="o">)</span></span>
<span id="LC567" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC568" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC569" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC570" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC571" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setDoctypePublic(java.lang.String)</span></span>
<span id="LC572" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC573" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDoctypePublic</span><span class="o">(</span><span class="nc">String</span> <span class="n">doctype</span><span class="o">)</span></span>
<span id="LC574" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC575" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC576" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC577" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC578" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setDoctypeSystem(java.lang.String)</span></span>
<span id="LC579" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC580" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDoctypeSystem</span><span class="o">(</span><span class="nc">String</span> <span class="n">doctype</span><span class="o">)</span></span>
<span id="LC581" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC582" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC583" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC584" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC585" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setEncoding(java.lang.String)</span></span>
<span id="LC586" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC587" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setEncoding</span><span class="o">(</span><span class="nc">String</span> <span class="n">encoding</span><span class="o">)</span></span>
<span id="LC588" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC589" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC590" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC591" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC592" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setMediaType(java.lang.String)</span></span>
<span id="LC593" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC594" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMediaType</span><span class="o">(</span><span class="nc">String</span> <span class="n">mediatype</span><span class="o">)</span></span>
<span id="LC595" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC596" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC597" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC598" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC599" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setOmitXMLDeclaration(boolean)</span></span>
<span id="LC600" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC601" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOmitXMLDeclaration</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">b</span><span class="o">)</span></span>
<span id="LC602" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC603" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC604" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC605" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC606" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setStandalone(java.lang.String)</span></span>
<span id="LC607" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC608" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setStandalone</span><span class="o">(</span><span class="nc">String</span> <span class="n">standalone</span><span class="o">)</span></span>
<span id="LC609" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC610" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
<span id="LC611" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC612" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC613" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.DeclHandler#elementDecl(java.lang.String, java.lang.String)</span></span>
<span id="LC614" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC615" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">elementDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg1</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC616" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC617" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC618" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC619" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC620" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.DeclHandler#attributeDecl(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)</span></span>
<span id="LC621" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC622" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">attributeDecl</span><span class="o">(</span></span>
<span id="LC623" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span></span>
<span id="LC624" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg1</span><span class="o">,</span></span>
<span id="LC625" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg2</span><span class="o">,</span></span>
<span id="LC626" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg3</span><span class="o">,</span></span>
<span id="LC627" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg4</span><span class="o">)</span></span>
<span id="LC628" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC629" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC630" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC631" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC632" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC633" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.DeclHandler#internalEntityDecl(java.lang.String, java.lang.String)</span></span>
<span id="LC634" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC635" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">internalEntityDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg1</span><span class="o">)</span></span>
<span id="LC636" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC637" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC638" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC639" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC640" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC641" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ext.DeclHandler#externalEntityDecl(java.lang.String, java.lang.String, java.lang.String)</span></span>
<span id="LC642" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC643" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">externalEntityDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg1</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg2</span><span class="o">)</span></span>
<span id="LC644" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC645" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC646" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC647" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC648" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC649" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ErrorHandler#warning(org.xml.sax.SAXParseException)</span></span>
<span id="LC650" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC651" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">warning</span><span class="o">(</span><span class="nc">SAXParseException</span> <span class="n">arg0</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC652" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC653" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC654" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC655" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC656" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ErrorHandler#error(org.xml.sax.SAXParseException)</span></span>
<span id="LC657" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC658" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">error</span><span class="o">(</span><span class="nc">SAXParseException</span> <span class="n">arg0</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC659" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC660" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC661" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC662" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC663" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ErrorHandler#fatalError(org.xml.sax.SAXParseException)</span></span>
<span id="LC664" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC665" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">fatalError</span><span class="o">(</span><span class="nc">SAXParseException</span> <span class="n">arg0</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC666" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC667" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC668" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC669" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC670" class="line" lang="java"><span class="cm">     * @see Serializer#asDOMSerializer()</span></span>
<span id="LC671" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC672" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DOMSerializer</span> <span class="nf">asDOMSerializer</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
<span id="LC673" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC674" class="line" lang="java">        <span class="n">couldThrowIOException</span><span class="o">();</span></span>
...
<span id="LC679" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setNamespaceMappings(NamespaceMappings)</span></span>
<span id="LC680" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC681" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setNamespaceMappings</span><span class="o">(</span><span class="nc">NamespaceMappings</span> <span class="n">mappings</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC682" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
...
<span id="LC686" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#setSourceLocator(javax.xml.transform.SourceLocator)</span></span>
<span id="LC687" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC688" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSourceLocator</span><span class="o">(</span><span class="nc">SourceLocator</span> <span class="n">locator</span><span class="o">)</span></span>
<span id="LC689" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC690" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
...
<span id="LC694" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#addUniqueAttribute(java.lang.String, java.lang.String, int)</span></span>
<span id="LC695" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC696" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addUniqueAttribute</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="nc">String</span> <span class="n">value</span><span class="o">,</span> <span class="kt">int</span> <span class="n">flags</span><span class="o">)</span></span>
<span id="LC697" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC698" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC699" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
...
<span id="LC703" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#characters(org.w3c.dom.Node)</span></span>
<span id="LC704" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC705" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">characters</span><span class="o">(</span><span class="nc">Node</span> <span class="n">node</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC706" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC707" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
...
<span id="LC711" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#addXSLAttribute(java.lang.String, java.lang.String, java.lang.String)</span></span>
<span id="LC712" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC713" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addXSLAttribute</span><span class="o">(</span><span class="nc">String</span> <span class="n">qName</span><span class="o">,</span> <span class="nc">String</span> <span class="n">value</span><span class="o">,</span> <span class="nc">String</span> <span class="n">uri</span><span class="o">)</span></span>
<span id="LC714" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC715" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
...
<span id="LC719" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#addAttribute(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)</span></span>
<span id="LC720" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC721" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addAttribute</span><span class="o">(</span><span class="nc">String</span> <span class="n">uri</span><span class="o">,</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span> <span class="nc">String</span> <span class="n">rawName</span><span class="o">,</span> <span class="nc">String</span> <span class="n">type</span><span class="o">,</span> <span class="nc">String</span> <span class="n">value</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC722" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC723" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
<span id="LC724" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC725" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC726" class="line" lang="java"><span class="cm">     * @see org.xml.sax.DTDHandler#notationDecl(java.lang.String, java.lang.String, java.lang.String)</span></span>
<span id="LC727" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC728" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">notationDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg1</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg2</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC729" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC730" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
...
<span id="LC734" class="line" lang="java"><span class="cm">     * @see org.xml.sax.DTDHandler#unparsedEntityDecl(java.lang.String, java.lang.String, java.lang.String, java.lang.String)</span></span>
<span id="LC735" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC736" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">unparsedEntityDecl</span><span class="o">(</span></span>
<span id="LC737" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span></span>
<span id="LC738" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg1</span><span class="o">,</span></span>
<span id="LC739" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg2</span><span class="o">,</span></span>
<span id="LC740" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg3</span><span class="o">)</span></span>
<span id="LC741" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span> <span class="o">{</span></span>
<span id="LC742" class="line" lang="java">        <span class="n">couldThrowSAXException</span><span class="o">();</span></span>
...
<span id="LC746" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setDTDEntityExpansion(boolean)</span></span>
<span id="LC747" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC748" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDTDEntityExpansion</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">expand</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC749" class="line" lang="java">        <span class="n">aMethodIsCalled</span><span class="o">();</span></span>
