...
<span id="LC28" class="line" lang="java"><span class="cm"> * An interface to tell to the c14n if a node is included or not in the output</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC30" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">NodeFilter</span> <span class="o">{</span></span>
<span id="LC31" class="line" lang="java"></span>
<span id="LC32" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC33" class="line" lang="java"><span class="cm">     * Tells if a node must be output in c14n.</span></span>
<span id="LC34" class="line" lang="java"><span class="cm">     * @param n</span></span>
<span id="LC35" class="line" lang="java"><span class="cm">     * @return 1 if the node should be output.</span></span>
<span id="LC36" class="line" lang="java"><span class="cm">     *         0 if node must not be output,</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">     *         -1 if the node and all it's child must not be output.</span></span>
<span id="LC38" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC40" class="line" lang="java">    <span class="kt">int</span> <span class="nf">isNodeInclude</span><span class="o">(</span><span class="nc">Node</span> <span class="n">n</span><span class="o">);</span></span>
<span id="LC41" class="line" lang="java"></span>
<span id="LC42" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC43" class="line" lang="java"><span class="cm">     * Tells if a node must be output in a c14n.</span></span>
<span id="LC44" class="line" lang="java"><span class="cm">     * The caller must assured that this method is always call</span></span>
<span id="LC45" class="line" lang="java"><span class="cm">     * in document order. The implementations can use this</span></span>
<span id="LC46" class="line" lang="java"><span class="cm">     * restriction to optimize the transformation.</span></span>
<span id="LC47" class="line" lang="java"><span class="cm">     * @param n</span></span>
<span id="LC48" class="line" lang="java"><span class="cm">     * @param level the relative level in the tree</span></span>
<span id="LC49" class="line" lang="java"><span class="cm">     * @return 1 if the node should be output.</span></span>
<span id="LC50" class="line" lang="java"><span class="cm">     *         0 if node must not be output,</span></span>
<span id="LC51" class="line" lang="java"><span class="cm">     *         -1 if the node and all it's child must not be output.</span></span>
<span id="LC52" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC53" class="line" lang="java">    <span class="kt">int</span> <span class="nf">isNodeIncludeDO</span><span class="o">(</span><span class="nc">Node</span> <span class="n">n</span><span class="o">,</span> <span class="kt">int</span> <span class="n">level</span><span class="o">);</span></span>
