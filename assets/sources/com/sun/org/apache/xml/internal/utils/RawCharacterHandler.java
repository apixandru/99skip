...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: RawCharacterHandler.java,v 1.2.4.1 2005/09/15 08:15:52 suresh_emailid Exp $</span></span>
...
<span id="LC26" class="line" lang="java"><span class="cm"> * An interface that a Serializer/ContentHandler/ContentHandler must</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * implement in order for disable-output-escaping to work.</span></span>
...
<span id="LC30" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">RawCharacterHandler</span></span>
...
<span id="LC34" class="line" lang="java"><span class="cm">   * Serialize the characters without escaping.</span></span>
<span id="LC35" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC36" class="line" lang="java"><span class="cm">   * @param ch Array of characters</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">   * @param start Start index of characters in the array</span></span>
<span id="LC38" class="line" lang="java"><span class="cm">   * @param length Number of characters in the array</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">   * @throws javax.xml.transform.TransformerException</span></span>
<span id="LC41" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC42" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">charactersRaw</span><span class="o">(</span><span class="kt">char</span> <span class="n">ch</span><span class="o">[],</span> <span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span></span>
<span id="LC43" class="line" lang="java">    <span class="kd">throws</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">transform</span><span class="o">.</span><span class="na">TransformerException</span><span class="o">;</span></span>
