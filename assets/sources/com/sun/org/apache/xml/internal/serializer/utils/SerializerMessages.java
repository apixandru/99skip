...
<span id="LC43" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">SerializerMessages</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span> <span class="o">{</span></span>
...
<span id="LC73" class="line" lang="java">                <span class="s">"The message key ''{0}'' is not in the message class ''{1}''"</span> <span class="o">},</span></span>
...
<span id="LC76" class="line" lang="java">                <span class="s">"The format of message ''{0}'' in message class ''{1}'' failed."</span> <span class="o">},</span></span>
...
<span id="LC79" class="line" lang="java">                <span class="s">"The serializer class ''{0}'' does not implement org.xml.sax.ContentHandler."</span> <span class="o">},</span></span>
...
<span id="LC82" class="line" lang="java">                    <span class="s">"The resource [ {0} ] could not be found.\n {1}"</span> <span class="o">},</span></span>
...
<span id="LC85" class="line" lang="java">                    <span class="s">"The resource [ {0} ] could not load: {1} \n {2} \t {3}"</span> <span class="o">},</span></span>
...
<span id="LC88" class="line" lang="java">                    <span class="s">"Buffer size &lt;=0"</span> <span class="o">},</span></span>
...
<span id="LC91" class="line" lang="java">                    <span class="s">"Invalid UTF-16 surrogate detected: {0} ?"</span> <span class="o">},</span></span>
...
<span id="LC94" class="line" lang="java">                <span class="s">"IO error"</span> <span class="o">},</span></span>
...
<span id="LC97" class="line" lang="java">                <span class="s">"Cannot add attribute {0} after child nodes or before an element is produced.  Attribute will be ignored."</span> <span class="o">},</span></span>
...
<span id="LC105" class="line" lang="java">                <span class="s">"Namespace for prefix ''{0}'' has not been declared."</span> <span class="o">},</span></span>
...
<span id="LC114" class="line" lang="java">                <span class="s">"Attribute ''{0}'' outside of element."</span> <span class="o">},</span></span>
...
<span id="LC124" class="line" lang="java">                <span class="s">"Namespace declaration ''{0}''=''{1}'' outside of element."</span> <span class="o">},</span></span>
...
<span id="LC127" class="line" lang="java">                <span class="s">"Could not load ''{0}'' (check CLASSPATH), now using just the defaults"</span> <span class="o">},</span></span>
...
<span id="LC130" class="line" lang="java">                <span class="s">"Attempt to output character of integral value {0} that is not represented in specified output encoding of {1}."</span> <span class="o">},</span></span>
...
<span id="LC133" class="line" lang="java">                <span class="s">"Could not load the propery file ''{0}'' for output method ''{1}'' (check CLASSPATH)"</span> <span class="o">},</span></span>
...
<span id="LC136" class="line" lang="java">                <span class="s">"Invalid port number"</span> <span class="o">},</span></span>
...
<span id="LC139" class="line" lang="java">                <span class="s">"Port cannot be set when host is null"</span> <span class="o">},</span></span>
...
<span id="LC142" class="line" lang="java">                <span class="s">"Host is not a well formed address"</span> <span class="o">},</span></span>
...
<span id="LC145" class="line" lang="java">                <span class="s">"The scheme is not conformant."</span> <span class="o">},</span></span>
...
<span id="LC148" class="line" lang="java">                <span class="s">"Cannot set scheme from null string"</span> <span class="o">},</span></span>
...
<span id="LC151" class="line" lang="java">                <span class="s">"Path contains invalid escape sequence"</span> <span class="o">},</span></span>
...
<span id="LC154" class="line" lang="java">                <span class="s">"Path contains invalid character: {0}"</span> <span class="o">},</span></span>
...
<span id="LC157" class="line" lang="java">                <span class="s">"Fragment contains invalid character"</span> <span class="o">},</span></span>
...
<span id="LC160" class="line" lang="java">                <span class="s">"Fragment cannot be set when path is null"</span> <span class="o">},</span></span>
...
<span id="LC163" class="line" lang="java">                <span class="s">"Fragment can only be set for a generic URI"</span> <span class="o">},</span></span>
...
<span id="LC166" class="line" lang="java">                <span class="s">"No scheme found in URI"</span> <span class="o">},</span></span>
...
<span id="LC169" class="line" lang="java">                <span class="s">"Cannot initialize URI with empty parameters"</span> <span class="o">},</span></span>
...
<span id="LC172" class="line" lang="java">                <span class="s">"Fragment cannot be specified in both the path and fragment"</span> <span class="o">},</span></span>
...
<span id="LC175" class="line" lang="java">                <span class="s">"Query string cannot be specified in path and query string"</span> <span class="o">},</span></span>
...
<span id="LC178" class="line" lang="java">                <span class="s">"Port may not be specified if host is not specified"</span> <span class="o">},</span></span>
...
<span id="LC181" class="line" lang="java">                <span class="s">"Userinfo may not be specified if host is not specified"</span> <span class="o">},</span></span>
...
<span id="LC184" class="line" lang="java">                <span class="s">"Warning:  The version of the output document is requested to be ''{0}''.  This version of XML is not supported.  The version of the output document will be ''1.0''."</span> <span class="o">},</span></span>
...
<span id="LC187" class="line" lang="java">                <span class="s">"Scheme is required!"</span> <span class="o">},</span></span>
...
<span id="LC195" class="line" lang="java">                <span class="s">"The Properties object passed to the SerializerFactory does not have a ''{0}'' property."</span> <span class="o">},</span></span>
...
<span id="LC198" class="line" lang="java">                <span class="s">"Warning:  The encoding ''{0}'' is not supported by the Java runtime."</span> <span class="o">},</span></span>
