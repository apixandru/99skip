...
<span id="LC35" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XMLErrorResources_sv</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span></span>
...
<span id="LC185" class="line" lang="java">      <span class="s">"Funktionen st\u00F6ds inte!"</span><span class="o">},</span></span>
...
<span id="LC188" class="line" lang="java">      <span class="s">"Orsak kan inte skrivas \u00F6ver"</span><span class="o">},</span></span>
...
<span id="LC191" class="line" lang="java">      <span class="s">"Hittade ingen standardimplementering "</span><span class="o">},</span></span>
...
<span id="LC194" class="line" lang="java">      <span class="s">"ChunkedIntArray({0}) underst\u00F6ds f\u00F6r n\u00E4rvarande inte"</span><span class="o">},</span></span>
...
<span id="LC197" class="line" lang="java">      <span class="s">"Offset st\u00F6rre \u00E4n plats"</span><span class="o">},</span></span>
...
<span id="LC200" class="line" lang="java">      <span class="s">"Sidorutin \u00E4r inte tillg\u00E4nglig, id={0}"</span><span class="o">},</span></span>
...
<span id="LC203" class="line" lang="java">      <span class="s">"CoroutineManager har tagit emot co_exit()-beg\u00E4ran"</span><span class="o">},</span></span>
...
<span id="LC206" class="line" lang="java">      <span class="s">"co_joinCoroutineSet() utf\u00F6rdes inte"</span><span class="o">},</span></span>
...
<span id="LC209" class="line" lang="java">      <span class="s">"Parameterfel f\u00F6r sidorutin ({0})"</span><span class="o">},</span></span>
...
<span id="LC212" class="line" lang="java">      <span class="s">"\nUNEXPECTED: Parsersvar {0} f\u00F6r doTerminate"</span><span class="o">},</span></span>
...
<span id="LC215" class="line" lang="java">      <span class="s">"parse f\u00E5r inte anropas medan tolkning sker"</span><span class="o">},</span></span>
...
<span id="LC218" class="line" lang="java">      <span class="s">"Fel: typad iterator f\u00F6r axeln {0} har inte implementerats"</span><span class="o">},</span></span>
...
<span id="LC221" class="line" lang="java">      <span class="s">"Fel: iterator f\u00F6r axeln {0} har inte implementerats "</span><span class="o">},</span></span>
...
<span id="LC224" class="line" lang="java">      <span class="s">"Iteratorklon underst\u00F6ds inte"</span><span class="o">},</span></span>
...
<span id="LC227" class="line" lang="java">      <span class="s">"Ok\u00E4nd axeltraverstyp: {0}"</span><span class="o">},</span></span>
...
<span id="LC230" class="line" lang="java">      <span class="s">"Axeltravers underst\u00F6ds inte: {0}"</span><span class="o">},</span></span>
...
<span id="LC233" class="line" lang="java">      <span class="s">"Inga fler DTM-id:n \u00E4r tillg\u00E4ngliga"</span><span class="o">},</span></span>
...
<span id="LC236" class="line" lang="java">      <span class="s">"Underst\u00F6ds inte: {0}"</span><span class="o">},</span></span>
...
<span id="LC239" class="line" lang="java">      <span class="s">"Nod m\u00E5ste vara icke-null f\u00F6r getDTMHandleFromNode"</span><span class="o">},</span></span>
...
<span id="LC242" class="line" lang="java">      <span class="s">"Kunde inte matcha noden med en referens"</span><span class="o">},</span></span>
...
<span id="LC245" class="line" lang="java">       <span class="s">"startParse f\u00E5r inte anropas medan tolkning sker"</span><span class="o">},</span></span>
...
<span id="LC248" class="line" lang="java">       <span class="s">"startParse beh\u00F6ver en SAXParser som \u00E4r icke-null"</span><span class="o">},</span></span>
...
<span id="LC251" class="line" lang="java">       <span class="s">"kunde inte initiera parser med"</span><span class="o">},</span></span>
...
<span id="LC254" class="line" lang="java">       <span class="s">"undantag skapar ny instans f\u00F6r pool"</span><span class="o">},</span></span>
...
<span id="LC257" class="line" lang="java">       <span class="s">"S\u00F6kv\u00E4gen inneh\u00E5ller en ogiltig escape-sekvens"</span><span class="o">},</span></span>
...
<span id="LC260" class="line" lang="java">       <span class="s">"Schema kr\u00E4vs!"</span><span class="o">},</span></span>
...
<span id="LC263" class="line" lang="java">       <span class="s">"Schema saknas i URI: {0}"</span><span class="o">},</span></span>
...
<span id="LC266" class="line" lang="java">       <span class="s">"Schema saknas i URI"</span><span class="o">},</span></span>
...
<span id="LC269" class="line" lang="java">       <span class="s">"S\u00F6kv\u00E4gen inneh\u00E5ller ett ogiltigt tecken: {0}"</span><span class="o">},</span></span>
...
<span id="LC272" class="line" lang="java">       <span class="s">"Kan inte st\u00E4lla in schema fr\u00E5n null-str\u00E4ng"</span><span class="o">},</span></span>
...
<span id="LC275" class="line" lang="java">       <span class="s">"Schemat \u00E4r inte likformigt."</span><span class="o">},</span></span>
...
<span id="LC278" class="line" lang="java">       <span class="s">"V\u00E4rd \u00E4r inte en v\u00E4lformulerad adress"</span><span class="o">},</span></span>
...
<span id="LC281" class="line" lang="java">       <span class="s">"Port kan inte st\u00E4llas in n\u00E4r v\u00E4rd \u00E4r null"</span><span class="o">},</span></span>
...
<span id="LC284" class="line" lang="java">       <span class="s">"Ogiltigt portnummer"</span><span class="o">},</span></span>
...
<span id="LC287" class="line" lang="java">       <span class="s">"Fragment kan bara st\u00E4llas in f\u00F6r en allm\u00E4n URI"</span><span class="o">},</span></span>
...
<span id="LC290" class="line" lang="java">       <span class="s">"Fragment kan inte st\u00E4llas in n\u00E4r s\u00F6kv\u00E4g \u00E4r null"</span><span class="o">},</span></span>
...
<span id="LC293" class="line" lang="java">       <span class="s">"Fragment inneh\u00E5ller ett ogiltigt tecken"</span><span class="o">},</span></span>
...
<span id="LC296" class="line" lang="java">      <span class="s">"Parser anv\u00E4nds redan"</span><span class="o">},</span></span>
...
<span id="LC299" class="line" lang="java">      <span class="s">"Kan inte \u00E4ndra {0} {1} medan tolkning sker"</span><span class="o">},</span></span>
...
<span id="LC302" class="line" lang="java">      <span class="s">"Sj\u00E4lvorsakande inte till\u00E5ten"</span><span class="o">},</span></span>
...
<span id="LC305" class="line" lang="java">      <span class="s">"Anv\u00E4ndarinfo f\u00E5r inte anges om v\u00E4rden inte \u00E4r angiven"</span><span class="o">},</span></span>
...
<span id="LC308" class="line" lang="java">      <span class="s">"Port f\u00E5r inte anges om v\u00E4rden inte \u00E4r angiven"</span><span class="o">},</span></span>
...
<span id="LC311" class="line" lang="java">      <span class="s">"Fr\u00E5gestr\u00E4ng kan inte anges i b\u00E5de s\u00F6kv\u00E4gen och fr\u00E5gestr\u00E4ngen"</span><span class="o">},</span></span>
...
<span id="LC314" class="line" lang="java">      <span class="s">"Fragment kan inte anges i b\u00E5de s\u00F6kv\u00E4gen och fragmentet"</span><span class="o">},</span></span>
...
<span id="LC317" class="line" lang="java">      <span class="s">"Kan inte initiera URI med tomma parametrar"</span><span class="o">},</span></span>
...
<span id="LC320" class="line" lang="java">      <span class="s">"Metoden st\u00F6ds \u00E4nnu inte "</span><span class="o">},</span></span>
...
<span id="LC323" class="line" lang="java">      <span class="s">"IncrementalSAXSource_Filter kan f\u00F6r n\u00E4rvarande inte startas om"</span><span class="o">},</span></span>
...
<span id="LC326" class="line" lang="java">      <span class="s">"XMLReader inte f\u00F6re startParse-beg\u00E4ran"</span><span class="o">},</span></span>
...
<span id="LC329" class="line" lang="java">      <span class="s">"Axeltravers underst\u00F6ds inte: {0}"</span><span class="o">},</span></span>
...
<span id="LC332" class="line" lang="java">      <span class="s">"ListingErrorHandler skapad med null PrintWriter!"</span><span class="o">},</span></span>
...
<span id="LC335" class="line" lang="java">      <span class="s">"SystemId ok\u00E4nt"</span><span class="o">},</span></span>
...
<span id="LC338" class="line" lang="java">      <span class="s">"Platsen f\u00F6r felet \u00E4r ok\u00E4nd"</span><span class="o">},</span></span>
...
<span id="LC341" class="line" lang="java">      <span class="s">"Prefix m\u00E5ste matchas till en namnrymd: {0}"</span><span class="o">},</span></span>
...
<span id="LC344" class="line" lang="java">      <span class="s">"createDocument() st\u00F6ds inte i XPathContext!"</span><span class="o">},</span></span>
...
<span id="LC347" class="line" lang="java">      <span class="s">"Underordnat attribut har inget \u00E4gardokument!"</span><span class="o">},</span></span>
...
<span id="LC350" class="line" lang="java">      <span class="s">"Underordnat attribut har inget \u00E4gardokumentelement!"</span><span class="o">},</span></span>
...
<span id="LC353" class="line" lang="java">      <span class="s">"Varning: utdatatext kan inte skrivas ut f\u00F6re dokumentelement! Ignoreras..."</span><span class="o">},</span></span>
...
<span id="LC356" class="line" lang="java">      <span class="s">"En DOM kan inte ha fler \u00E4n en rot!"</span><span class="o">},</span></span>
...
<span id="LC359" class="line" lang="java">       <span class="s">"Argumentet 'localName' \u00E4r null"</span><span class="o">},</span></span>
...
<span id="LC365" class="line" lang="java">       <span class="s">"Localname i QNAME b\u00F6r vara giltigt NCName"</span><span class="o">},</span></span>
...
<span id="LC371" class="line" lang="java">       <span class="s">"Prefix i QNAME b\u00F6r vara giltigt NCName"</span><span class="o">},</span></span>
...
<span id="LC374" class="line" lang="java">      <span class="s">"Namnet kan inte b\u00F6rja med kolon"</span><span class="o">},</span></span>
<span id="LC375" class="line" lang="java"></span>
<span id="LC376" class="line" lang="java">    <span class="o">{</span> <span class="s">"BAD_CODE"</span><span class="o">,</span> <span class="s">"Parameter f\u00F6r createMessage ligger utanf\u00F6r gr\u00E4nsv\u00E4rdet"</span><span class="o">},</span></span>
<span id="LC377" class="line" lang="java">    <span class="o">{</span> <span class="s">"FORMAT_FAILED"</span><span class="o">,</span> <span class="s">"Undantag utl\u00F6st vid messageFormat-anrop"</span><span class="o">},</span></span>
<span id="LC378" class="line" lang="java">    <span class="o">{</span> <span class="s">"line"</span><span class="o">,</span> <span class="s">"Rad nr"</span><span class="o">},</span></span>
<span id="LC379" class="line" lang="java">    <span class="o">{</span> <span class="s">"column"</span><span class="o">,</span><span class="s">"Kolumn nr"</span><span class="o">},</span></span>
...
<span id="LC382" class="line" lang="java">      <span class="s">"Serializerklassen ''{0}'' implementerar inte org.xml.sax.ContentHandler."</span><span class="o">},</span></span>
...
<span id="LC385" class="line" lang="java">      <span class="s">"Resursen [ {0} ] kunde inte h\u00E4mtas.\n {1}"</span> <span class="o">},</span></span>
...
<span id="LC388" class="line" lang="java">      <span class="s">"Resursen [ {0} ] kunde inte laddas: {1} \n {2} \t {3}"</span> <span class="o">},</span></span>
...
<span id="LC391" class="line" lang="java">      <span class="s">"Buffertstorlek &lt;=0"</span> <span class="o">},</span></span>
...
<span id="LC394" class="line" lang="java">      <span class="s">"Ogiltigt UTF-16-surrogat uppt\u00E4ckt: {0} ?"</span> <span class="o">},</span></span>
...
<span id="LC397" class="line" lang="java">      <span class="s">"IO-fel"</span> <span class="o">},</span></span>
...
<span id="LC400" class="line" lang="java">      <span class="s">"Kan inte l\u00E4gga till attributet {0} efter underordnade noder eller innan ett element har skapats. Attributet ignoreras."</span><span class="o">},</span></span>
...
<span id="LC408" class="line" lang="java">      <span class="s">"Namnrymd f\u00F6r prefix ''{0}'' har inte deklarerats."</span> <span class="o">},</span></span>
...
<span id="LC416" class="line" lang="java">      <span class="s">"Attributet ''{0}'' finns utanf\u00F6r elementet."</span> <span class="o">},</span></span>
...
<span id="LC426" class="line" lang="java">      <span class="s">"Namnrymdsdeklarationen ''{0}''=''{1}'' finns utanf\u00F6r element."</span> <span class="o">},</span></span>
...
<span id="LC429" class="line" lang="java">      <span class="s">"Kunde inte ladda ''{0}'' (kontrollera CLASSPATH), anv\u00E4nder nu enbart standardv\u00E4rden"</span><span class="o">},</span></span>
...
<span id="LC432" class="line" lang="java">       <span class="s">"F\u00F6rs\u00F6k att skriva utdatatecken med integralv\u00E4rdet {0} som inte \u00E4r representerat i angiven utdatakodning av {1}."</span><span class="o">},</span></span>
...
<span id="LC435" class="line" lang="java">      <span class="s">"Kunde inte ladda egenskapsfilen ''{0}'' f\u00F6r utdatametoden ''{1}'' (kontrollera CLASSPATH)"</span> <span class="o">}</span></span>
