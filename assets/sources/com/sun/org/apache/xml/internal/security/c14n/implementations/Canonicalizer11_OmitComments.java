...
<span id="LC28" class="line" lang="java"><span class="cm"> * @author Sean Mullan</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC30" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">Canonicalizer11_OmitComments</span> <span class="kd">extends</span> <span class="nc">Canonicalizer11</span> <span class="o">{</span></span>
<span id="LC31" class="line" lang="java"></span>
<span id="LC32" class="line" lang="java">    <span class="kd">public</span> <span class="nf">Canonicalizer11_OmitComments</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC36" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="nc">String</span> <span class="nf">engineGetURI</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC37" class="line" lang="java">        <span class="k">return</span> <span class="nc">Canonicalizer</span><span class="o">.</span><span class="na">ALGO_ID_C14N11_OMIT_COMMENTS</span><span class="o">;</span></span>
<span id="LC38" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC39" class="line" lang="java"></span>
<span id="LC40" class="line" lang="java">    <span class="kd">public</span> <span class="kd">final</span> <span class="kt">boolean</span> <span class="nf">engineGetIncludeComments</span><span class="o">()</span> <span class="o">{</span></span>
