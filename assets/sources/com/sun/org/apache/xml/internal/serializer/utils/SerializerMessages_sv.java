...
<span id="LC43" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">SerializerMessages_sv</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span> <span class="o">{</span></span>
...
<span id="LC73" class="line" lang="java">                <span class="s">"Meddelandenyckeln ''{0}'' \u00E4r inte i meddelandeklassen ''{1}''"</span> <span class="o">},</span></span>
...
<span id="LC76" class="line" lang="java">                <span class="s">"Formatet p\u00E5 meddelandet ''{0}'' i meddelandeklassen ''{1}'' underk\u00E4ndes."</span> <span class="o">},</span></span>
...
<span id="LC79" class="line" lang="java">                <span class="s">"Serializerklassen ''{0}'' implementerar inte org.xml.sax.ContentHandler."</span> <span class="o">},</span></span>
...
<span id="LC82" class="line" lang="java">                    <span class="s">"Resursen [ {0} ] kunde inte h\u00E4mtas.\n {1}"</span> <span class="o">},</span></span>
...
<span id="LC85" class="line" lang="java">                    <span class="s">"Resursen [ {0} ] kunde inte laddas: {1} \n {2} \t {3}"</span> <span class="o">},</span></span>
...
<span id="LC88" class="line" lang="java">                    <span class="s">"Buffertstorlek &lt;=0"</span> <span class="o">},</span></span>
...
<span id="LC91" class="line" lang="java">                    <span class="s">"Ogiltigt UTF-16-surrogat uppt\u00E4ckt: {0} ?"</span> <span class="o">},</span></span>
...
<span id="LC94" class="line" lang="java">                <span class="s">"IO-fel"</span> <span class="o">},</span></span>
...
<span id="LC97" class="line" lang="java">                <span class="s">"Kan inte l\u00E4gga till attributet {0} efter underordnade noder eller innan ett element har skapats. Attributet ignoreras."</span> <span class="o">},</span></span>
...
<span id="LC105" class="line" lang="java">                <span class="s">"Namnrymd f\u00F6r prefix ''{0}'' har inte deklarerats."</span> <span class="o">},</span></span>
...
<span id="LC114" class="line" lang="java">                <span class="s">"Attributet ''{0}'' finns utanf\u00F6r elementet."</span> <span class="o">},</span></span>
...
<span id="LC124" class="line" lang="java">                <span class="s">"Namnrymdsdeklarationen ''{0}''=''{1}'' finns utanf\u00F6r element."</span> <span class="o">},</span></span>
...
<span id="LC127" class="line" lang="java">                <span class="s">"Kunde inte ladda ''{0}'' (kontrollera CLASSPATH), anv\u00E4nder nu enbart standardv\u00E4rden"</span> <span class="o">},</span></span>
...
<span id="LC130" class="line" lang="java">                <span class="s">"F\u00F6rs\u00F6k att skriva utdatatecken med integralv\u00E4rdet {0} som inte \u00E4r representerat i angiven utdatakodning av {1}."</span> <span class="o">},</span></span>
...
<span id="LC133" class="line" lang="java">                <span class="s">"Kunde inte ladda egenskapsfilen ''{0}'' f\u00F6r utdatametoden ''{1}'' (kontrollera CLASSPATH)"</span> <span class="o">},</span></span>
...
<span id="LC136" class="line" lang="java">                <span class="s">"Ogiltigt portnummer"</span> <span class="o">},</span></span>
...
<span id="LC139" class="line" lang="java">                <span class="s">"Port kan inte st\u00E4llas in n\u00E4r v\u00E4rd \u00E4r null"</span> <span class="o">},</span></span>
...
<span id="LC142" class="line" lang="java">                <span class="s">"V\u00E4rd \u00E4r inte en v\u00E4lformulerad adress"</span> <span class="o">},</span></span>
...
<span id="LC145" class="line" lang="java">                <span class="s">"Schemat \u00E4r inte likformigt."</span> <span class="o">},</span></span>
...
<span id="LC148" class="line" lang="java">                <span class="s">"Kan inte st\u00E4lla in schema fr\u00E5n null-str\u00E4ng"</span> <span class="o">},</span></span>
...
<span id="LC151" class="line" lang="java">                <span class="s">"S\u00F6kv\u00E4gen inneh\u00E5ller en ogiltig escape-sekvens"</span> <span class="o">},</span></span>
...
<span id="LC154" class="line" lang="java">                <span class="s">"S\u00F6kv\u00E4gen inneh\u00E5ller ett ogiltigt tecken: {0}"</span> <span class="o">},</span></span>
...
<span id="LC157" class="line" lang="java">                <span class="s">"Fragment inneh\u00E5ller ett ogiltigt tecken"</span> <span class="o">},</span></span>
...
<span id="LC160" class="line" lang="java">                <span class="s">"Fragment kan inte st\u00E4llas in n\u00E4r s\u00F6kv\u00E4g \u00E4r null"</span> <span class="o">},</span></span>
...
<span id="LC163" class="line" lang="java">                <span class="s">"Fragment kan bara st\u00E4llas in f\u00F6r en allm\u00E4n URI"</span> <span class="o">},</span></span>
...
<span id="LC166" class="line" lang="java">                <span class="s">"Schema saknas i URI"</span> <span class="o">},</span></span>
...
<span id="LC169" class="line" lang="java">                <span class="s">"Kan inte initiera URI med tomma parametrar"</span> <span class="o">},</span></span>
...
<span id="LC172" class="line" lang="java">                <span class="s">"Fragment kan inte anges i b\u00E5de s\u00F6kv\u00E4gen och fragmentet"</span> <span class="o">},</span></span>
...
<span id="LC175" class="line" lang="java">                <span class="s">"Fr\u00E5gestr\u00E4ng kan inte anges i b\u00E5de s\u00F6kv\u00E4gen och fr\u00E5gestr\u00E4ngen"</span> <span class="o">},</span></span>
...
<span id="LC178" class="line" lang="java">                <span class="s">"Port f\u00E5r inte anges om v\u00E4rden inte \u00E4r angiven"</span> <span class="o">},</span></span>
...
<span id="LC181" class="line" lang="java">                <span class="s">"Anv\u00E4ndarinfo f\u00E5r inte anges om v\u00E4rden inte \u00E4r angiven"</span> <span class="o">},</span></span>
...
<span id="LC184" class="line" lang="java">                <span class="s">"Varning:  Versionen av utdatadokumentet som beg\u00E4rts \u00E4r ''{0}''.  Den h\u00E4r versionen av XML st\u00F6ds inte.  Versionen av utdatadokumentet kommer att vara ''1.0''."</span> <span class="o">},</span></span>
...
<span id="LC187" class="line" lang="java">                <span class="s">"Schema kr\u00E4vs!"</span> <span class="o">},</span></span>
...
<span id="LC195" class="line" lang="java">                <span class="s">"Egenskapsobjektet som \u00F6verf\u00F6rts till SerializerFactory har ingen ''{0}''-egenskap."</span> <span class="o">},</span></span>
...
<span id="LC198" class="line" lang="java">                <span class="s">"Varning: Kodningen ''{0}'' st\u00F6ds inte av Java runtime."</span> <span class="o">},</span></span>
