...
<span id="LC30" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">Canonicalizer11_WithComments</span> <span class="kd">extends</span> <span class="nc">Canonicalizer11</span> <span class="o">{</span></span>
<span id="LC31" class="line" lang="java"></span>
<span id="LC32" class="line" lang="java">    <span class="kd">public</span> <span class="nf">Canonicalizer11_WithComments</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC33" class="line" lang="java">        <span class="kd">super</span><span class="o">(</span><span class="kc">true</span><span class="o">);</span></span>
...
<span id="LC37" class="line" lang="java">        <span class="k">return</span> <span class="nc">Canonicalizer</span><span class="o">.</span><span class="na">ALGO_ID_C14N11_WITH_COMMENTS</span><span class="o">;</span></span>
...
<span id="LC41" class="line" lang="java">        <span class="k">return</span> <span class="kc">true</span><span class="o">;</span></span>
