...
<span id="LC35" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XMLErrorResources_fr</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span></span>
...
<span id="LC185" class="line" lang="java">      <span class="s">"Fonction non prise en charge."</span><span class="o">},</span></span>
...
<span id="LC188" class="line" lang="java">      <span class="s">"Impossible de remplacer la cause"</span><span class="o">},</span></span>
...
<span id="LC191" class="line" lang="java">      <span class="s">"Aucune impl\u00E9mentation par d\u00E9faut trouv\u00E9e "</span><span class="o">},</span></span>
...
<span id="LC194" class="line" lang="java">      <span class="s">"ChunkedIntArray({0}) n''est actuellement pas pris en charge"</span><span class="o">},</span></span>
...
<span id="LC197" class="line" lang="java">      <span class="s">"D\u00E9calage sup\u00E9rieur \u00E0 l'emplacement"</span><span class="o">},</span></span>
...
<span id="LC200" class="line" lang="java">      <span class="s">"Coroutine non disponible, id={0}"</span><span class="o">},</span></span>
...
<span id="LC203" class="line" lang="java">      <span class="s">"CoroutineManager a re\u00E7u la demande co_exit()"</span><span class="o">},</span></span>
...
<span id="LC206" class="line" lang="java">      <span class="s">"Echec de co_joinCoroutineSet()"</span><span class="o">},</span></span>
...
<span id="LC209" class="line" lang="java">      <span class="s">"Erreur de param\u00E8tre de coroutine ({0})"</span><span class="o">},</span></span>
...
<span id="LC212" class="line" lang="java">      <span class="s">"\nINATTENDU : r\u00E9ponses doTerminate de l''analyseur - {0}"</span><span class="o">},</span></span>
...
<span id="LC215" class="line" lang="java">      <span class="s">"impossible d'appeler l'analyse lorsqu'elle est en cours"</span><span class="o">},</span></span>
...
<span id="LC218" class="line" lang="java">      <span class="s">"Erreur : it\u00E9rateur saisi pour l''axe {0} non impl\u00E9ment\u00E9"</span><span class="o">},</span></span>
...
<span id="LC221" class="line" lang="java">      <span class="s">"Erreur : it\u00E9rateur pour l''axe {0} non impl\u00E9ment\u00E9 "</span><span class="o">},</span></span>
...
<span id="LC224" class="line" lang="java">      <span class="s">"Clone d'it\u00E9rateur non pris en charge"</span><span class="o">},</span></span>
...
<span id="LC227" class="line" lang="java">      <span class="s">"Type de parcours d''axe inconnu : {0}"</span><span class="o">},</span></span>
...
<span id="LC230" class="line" lang="java">      <span class="s">"Parcours d''axe non pris en charge : {0}"</span><span class="o">},</span></span>
...
<span id="LC233" class="line" lang="java">      <span class="s">"Aucun autre ID DTM n'est disponible"</span><span class="o">},</span></span>
...
<span id="LC236" class="line" lang="java">      <span class="s">"Non pris en charge : {0}"</span><span class="o">},</span></span>
...
<span id="LC239" class="line" lang="java">      <span class="s">"Le noeud doit \u00EAtre non NULL pour getDTMHandleFromNode"</span><span class="o">},</span></span>
...
<span id="LC242" class="line" lang="java">      <span class="s">"Impossible de r\u00E9soudre le noeud sur un descripteur"</span><span class="o">},</span></span>
...
<span id="LC245" class="line" lang="java">       <span class="s">"impossible d'appeler startParse lorsque l'analyse est en cours"</span><span class="o">},</span></span>
...
<span id="LC248" class="line" lang="java">       <span class="s">"startParse n\u00E9cessite un SAXParser non NULL"</span><span class="o">},</span></span>
...
<span id="LC251" class="line" lang="java">       <span class="s">"impossible d'initialiser l'analyseur avec"</span><span class="o">},</span></span>
...
<span id="LC254" class="line" lang="java">       <span class="s">"exception lors de la cr\u00E9ation de l'instance du pool"</span><span class="o">},</span></span>
...
<span id="LC257" class="line" lang="java">       <span class="s">"Le chemin d'acc\u00E8s contient une s\u00E9quence d'\u00E9chappement non valide"</span><span class="o">},</span></span>
...
<span id="LC260" class="line" lang="java">       <span class="s">"Mod\u00E8le obligatoire."</span><span class="o">},</span></span>
...
<span id="LC263" class="line" lang="java">       <span class="s">"Mod\u00E8le introuvable dans l''URI: {0}"</span><span class="o">},</span></span>
...
<span id="LC266" class="line" lang="java">       <span class="s">"Mod\u00E8le introuvable dans l'URI"</span><span class="o">},</span></span>
...
<span id="LC269" class="line" lang="java">       <span class="s">"Le chemin contient un caract\u00E8re non valide : {0}"</span><span class="o">},</span></span>
...
<span id="LC272" class="line" lang="java">       <span class="s">"Impossible de d\u00E9finir le mod\u00E8le \u00E0 partir de la cha\u00EEne NULL"</span><span class="o">},</span></span>
...
<span id="LC275" class="line" lang="java">       <span class="s">"Le mod\u00E8le n'est pas conforme."</span><span class="o">},</span></span>
...
<span id="LC278" class="line" lang="java">       <span class="s">"Le format de l'adresse de l'h\u00F4te n'est pas correct"</span><span class="o">},</span></span>
...
<span id="LC281" class="line" lang="java">       <span class="s">"Impossible de d\u00E9finir le port quand l'h\u00F4te est NULL"</span><span class="o">},</span></span>
...
<span id="LC284" class="line" lang="java">       <span class="s">"Num\u00E9ro de port non valide"</span><span class="o">},</span></span>
...
<span id="LC287" class="line" lang="java">       <span class="s">"Le fragment ne peut \u00EAtre d\u00E9fini que pour un URI g\u00E9n\u00E9rique"</span><span class="o">},</span></span>
...
<span id="LC290" class="line" lang="java">       <span class="s">"Impossible de d\u00E9finir le fragment quand le chemin d'acc\u00E8s est NULL"</span><span class="o">},</span></span>
...
<span id="LC293" class="line" lang="java">       <span class="s">"Le fragment contient un caract\u00E8re non valide"</span><span class="o">},</span></span>
...
<span id="LC296" class="line" lang="java">      <span class="s">"L'analyseur est d\u00E9j\u00E0 utilis\u00E9"</span><span class="o">},</span></span>
...
<span id="LC299" class="line" lang="java">      <span class="s">"Impossible de modifier {0} {1} pendant l''analyse"</span><span class="o">},</span></span>
...
<span id="LC302" class="line" lang="java">      <span class="s">"Causalit\u00E9 circulaire non autoris\u00E9e"</span><span class="o">},</span></span>
...
<span id="LC305" class="line" lang="java">      <span class="s">"Userinfo peut ne pas \u00EAtre sp\u00E9cifi\u00E9 si l'h\u00F4te ne l'est pas"</span><span class="o">},</span></span>
...
<span id="LC308" class="line" lang="java">      <span class="s">"Le port peut ne pas \u00EAtre sp\u00E9cifi\u00E9 si l'h\u00F4te ne l'est pas"</span><span class="o">},</span></span>
...
<span id="LC311" class="line" lang="java">      <span class="s">"La cha\u00EEne de requ\u00EAte ne doit pas figurer dans un chemin et une cha\u00EEne de requ\u00EAte"</span><span class="o">},</span></span>
...
<span id="LC314" class="line" lang="java">      <span class="s">"Le fragment ne doit pas \u00EAtre indiqu\u00E9 \u00E0 la fois dans le chemin et dans le fragment"</span><span class="o">},</span></span>
...
<span id="LC317" class="line" lang="java">      <span class="s">"Impossible d'initialiser l'URI avec des param\u00E8tres vides"</span><span class="o">},</span></span>
...
<span id="LC320" class="line" lang="java">      <span class="s">"La m\u00E9thode n'est pas encore prise en charge "</span><span class="o">},</span></span>
...
<span id="LC323" class="line" lang="java">      <span class="s">"IncrementalSAXSource_Filter ne peut actuellement pas \u00EAtre red\u00E9marr\u00E9"</span><span class="o">},</span></span>
...
<span id="LC326" class="line" lang="java">      <span class="s">"XMLReader pas avant la demande startParse"</span><span class="o">},</span></span>
...
<span id="LC329" class="line" lang="java">      <span class="s">"Parcours d''axe non pris en charge : {0}"</span><span class="o">},</span></span>
...
<span id="LC332" class="line" lang="java">      <span class="s">"ListingErrorHandler cr\u00E9\u00E9 avec PrintWriter NULL."</span><span class="o">},</span></span>
...
<span id="LC335" class="line" lang="java">      <span class="s">"ID syst\u00E8me inconnu"</span><span class="o">},</span></span>
...
<span id="LC338" class="line" lang="java">      <span class="s">"Emplacement de l'erreur inconnu"</span><span class="o">},</span></span>
...
<span id="LC341" class="line" lang="java">      <span class="s">"Le pr\u00E9fixe doit \u00EAtre r\u00E9solu en espace de noms : {0}"</span><span class="o">},</span></span>
...
<span id="LC344" class="line" lang="java">      <span class="s">"createDocument() non pris en charge dans XPathContext."</span><span class="o">},</span></span>
...
<span id="LC347" class="line" lang="java">      <span class="s">"L'enfant de l'attribut ne poss\u00E8de pas de document propri\u00E9taire."</span><span class="o">},</span></span>
...
<span id="LC350" class="line" lang="java">      <span class="s">"L'enfant de l'attribut ne poss\u00E8de pas d'\u00E9l\u00E9ment de document propri\u00E9taire."</span><span class="o">},</span></span>
...
<span id="LC353" class="line" lang="java">      <span class="s">"Avertissement : impossible de g\u00E9n\u00E9rer une sortie du texte avant l'\u00E9l\u00E9ment de document. Non pris en compte..."</span><span class="o">},</span></span>
...
<span id="LC356" class="line" lang="java">      <span class="s">"Impossible d'avoir plus d'une racine sur un DOM."</span><span class="o">},</span></span>
...
<span id="LC359" class="line" lang="java">       <span class="s">"L'argument \"localName\" est NULL"</span><span class="o">},</span></span>
...
<span id="LC365" class="line" lang="java">       <span class="s">"Le nom local du QName doit \u00EAtre un NCName valide"</span><span class="o">},</span></span>
...
<span id="LC371" class="line" lang="java">       <span class="s">"Le pr\u00E9fixe du QName doit \u00EAtre un NCName valide"</span><span class="o">},</span></span>
...
<span id="LC374" class="line" lang="java">      <span class="s">"Le nom ne peut pas commencer par deux-points"</span><span class="o">},</span></span>
<span id="LC375" class="line" lang="java"></span>
<span id="LC376" class="line" lang="java">    <span class="o">{</span> <span class="s">"BAD_CODE"</span><span class="o">,</span> <span class="s">"Le param\u00E8tre createMessage \u00E9tait hors limites"</span><span class="o">},</span></span>
<span id="LC377" class="line" lang="java">    <span class="o">{</span> <span class="s">"FORMAT_FAILED"</span><span class="o">,</span> <span class="s">"Exception g\u00E9n\u00E9r\u00E9e pendant l'appel messageFormat"</span><span class="o">},</span></span>
<span id="LC378" class="line" lang="java">    <span class="o">{</span> <span class="s">"line"</span><span class="o">,</span> <span class="s">"Ligne n\u00B0"</span><span class="o">},</span></span>
<span id="LC379" class="line" lang="java">    <span class="o">{</span> <span class="s">"column"</span><span class="o">,</span><span class="s">"Colonne n\u00B0"</span><span class="o">},</span></span>
...
<span id="LC382" class="line" lang="java">      <span class="s">"La classe de serializer ''{0}'' n''impl\u00E9mente pas org.xml.sax.ContentHandler."</span><span class="o">},</span></span>
...
<span id="LC385" class="line" lang="java">      <span class="s">"La ressource [ {0} ] est introuvable.\n {1}"</span> <span class="o">},</span></span>
...
<span id="LC388" class="line" lang="java">      <span class="s">"La ressource [ {0} ] n''a pas pu charger : {1} \n {2} \t {3}"</span> <span class="o">},</span></span>
...
<span id="LC391" class="line" lang="java">      <span class="s">"Taille du tampon &lt;=0"</span> <span class="o">},</span></span>
...
<span id="LC394" class="line" lang="java">      <span class="s">"Substitut UTF-16 non valide d\u00E9tect\u00E9 : {0} ?"</span> <span class="o">},</span></span>
...
<span id="LC397" class="line" lang="java">      <span class="s">"Erreur d'E-S"</span> <span class="o">},</span></span>
...
<span id="LC400" class="line" lang="java">      <span class="s">"Impossible d''ajouter l''attribut {0} apr\u00E8s des noeuds enfant ou avant la production d''un \u00E9l\u00E9ment. L''attribut est ignor\u00E9."</span><span class="o">},</span></span>
...
<span id="LC408" class="line" lang="java">      <span class="s">"L''espace de noms du pr\u00E9fixe ''{0}'' n''a pas \u00E9t\u00E9 d\u00E9clar\u00E9."</span> <span class="o">},</span></span>
...
<span id="LC416" class="line" lang="java">      <span class="s">"Attribut ''{0}'' \u00E0 l''ext\u00E9rieur de l''\u00E9l\u00E9ment."</span> <span class="o">},</span></span>
...
<span id="LC426" class="line" lang="java">      <span class="s">"La d\u00E9claration d''espace de noms ''{0}''=''{1}'' est \u00E0 l''ext\u00E9rieur de l''\u00E9l\u00E9ment."</span> <span class="o">},</span></span>
...
<span id="LC429" class="line" lang="java">      <span class="s">"Impossible de charger ''{0}'' (v\u00E9rifier CLASSPATH), les valeurs par d\u00E9faut sont donc employ\u00E9es"</span><span class="o">},</span></span>
...
<span id="LC432" class="line" lang="java">       <span class="s">"Tentative de sortie d''un caract\u00E8re avec une valeur enti\u00E8re {0}, non repr\u00E9sent\u00E9 dans l''encodage de sortie sp\u00E9cifi\u00E9 pour {1}."</span><span class="o">},</span></span>
...
<span id="LC435" class="line" lang="java">      <span class="s">"Impossible de charger le fichier de propri\u00E9t\u00E9s ''{0}'' pour la m\u00E9thode de sortie ''{1}'' (v\u00E9rifier CLASSPATH)"</span> <span class="o">}</span></span>
