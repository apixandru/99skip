...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: SerializerBase.java,v 1.5 2006/04/14 12:09:19 sunithareddy Exp $</span></span>
...
<span id="LC28" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.transform.SourceLocator</span><span class="o">;</span></span>
<span id="LC29" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.transform.Transformer</span><span class="o">;</span></span>
<span id="LC30" class="line" lang="java"></span>
<span id="LC31" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.serializer.utils.MsgKey</span><span class="o">;</span></span>
<span id="LC32" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xml.internal.serializer.utils.Utils</span><span class="o">;</span></span>
<span id="LC33" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.Attributes</span><span class="o">;</span></span>
<span id="LC34" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.ContentHandler</span><span class="o">;</span></span>
<span id="LC35" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.Locator</span><span class="o">;</span></span>
<span id="LC36" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.SAXException</span><span class="o">;</span></span>
<span id="LC37" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.SAXParseException</span><span class="o">;</span></span>
<span id="LC38" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.ext.Locator2</span><span class="o">;</span></span>
...
<span id="LC42" class="line" lang="java"><span class="cm"> * This class acts as a base class for the XML "serializers"</span></span>
<span id="LC43" class="line" lang="java"><span class="cm"> * and the stream serializers.</span></span>
<span id="LC44" class="line" lang="java"><span class="cm"> * It contains a number of common fields and methods.</span></span>
<span id="LC45" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> * @xsl.usage internal</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC48" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">SerializerBase</span></span>
<span id="LC49" class="line" lang="java">    <span class="kd">implements</span> <span class="nc">SerializationHandler</span><span class="o">,</span> <span class="nc">SerializerConstants</span></span>
...
<span id="LC54" class="line" lang="java"><span class="cm">     * To fire off the end element trace event</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">     * @param name Name of element</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC57" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">fireEndElem</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span></span>
<span id="LC58" class="line" lang="java">        <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC59" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC60" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC61" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC62" class="line" lang="java">            <span class="n">flushMyWriter</span><span class="o">();</span></span>
<span id="LC63" class="line" lang="java">            <span class="n">m_tracer</span><span class="o">.</span><span class="na">fireGenerateEvent</span><span class="o">(</span><span class="nc">SerializerTrace</span><span class="o">.</span><span class="na">EVENTTYPE_ENDELEMENT</span><span class="o">,</span><span class="n">name</span><span class="o">,</span> <span class="o">(</span><span class="nc">Attributes</span><span class="o">)</span><span class="kc">null</span><span class="o">);</span></span>
...
<span id="LC68" class="line" lang="java"><span class="cm">     * Report the characters trace event</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">     * @param chars  content of characters</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">     * @param start  starting index of characters to output</span></span>
<span id="LC71" class="line" lang="java"><span class="cm">     * @param length  number of characters to output</span></span>
<span id="LC72" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC73" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">fireCharEvent</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">chars</span><span class="o">,</span> <span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span></span>
<span id="LC74" class="line" lang="java">        <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC75" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC76" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC77" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC78" class="line" lang="java">            <span class="n">flushMyWriter</span><span class="o">();</span></span>
<span id="LC79" class="line" lang="java">            <span class="n">m_tracer</span><span class="o">.</span><span class="na">fireGenerateEvent</span><span class="o">(</span><span class="nc">SerializerTrace</span><span class="o">.</span><span class="na">EVENTTYPE_CHARACTERS</span><span class="o">,</span> <span class="n">chars</span><span class="o">,</span> <span class="n">start</span><span class="o">,</span><span class="n">length</span><span class="o">);</span></span>
...
<span id="LC84" class="line" lang="java"><span class="cm">     * true if we still need to call startDocumentInternal()</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC86" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">boolean</span> <span class="n">m_needToCallStartDocument</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC87" class="line" lang="java"></span>
<span id="LC88" class="line" lang="java">    <span class="cm">/** True if a trailing "]]&gt;" still needs to be written to be</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">     * written out. Used to merge adjacent CDATA sections</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC91" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">boolean</span> <span class="n">m_cdataTagOpen</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC92" class="line" lang="java"></span>
<span id="LC93" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">     * All the attributes of the current element, collected from</span></span>
<span id="LC95" class="line" lang="java"><span class="cm">     * startPrefixMapping() calls, or addAddtribute() calls, or</span></span>
<span id="LC96" class="line" lang="java"><span class="cm">     * from the SAX attributes in a startElement() call.</span></span>
<span id="LC97" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC98" class="line" lang="java">    <span class="kd">protected</span> <span class="nc">AttributesImplSerializer</span> <span class="n">m_attributes</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">AttributesImplSerializer</span><span class="o">();</span></span>
<span id="LC99" class="line" lang="java"></span>
<span id="LC100" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">     * Tells if we're in an EntityRef event.</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC103" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">boolean</span> <span class="n">m_inEntityRef</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC104" class="line" lang="java"></span>
<span id="LC105" class="line" lang="java">    <span class="cm">/** This flag is set while receiving events from the external DTD */</span></span>
<span id="LC106" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">boolean</span> <span class="n">m_inExternalDTD</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC107" class="line" lang="java"></span>
<span id="LC108" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC109" class="line" lang="java"><span class="cm">     * The System ID for the doc type.</span></span>
<span id="LC110" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC111" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">m_doctypeSystem</span><span class="o">;</span></span>
<span id="LC112" class="line" lang="java"></span>
<span id="LC113" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC114" class="line" lang="java"><span class="cm">     * The public ID for the doc type.</span></span>
<span id="LC115" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC116" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">m_doctypePublic</span><span class="o">;</span></span>
<span id="LC117" class="line" lang="java"></span>
<span id="LC118" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC119" class="line" lang="java"><span class="cm">     * Flag to tell that we need to add the doctype decl, which we can't do</span></span>
<span id="LC120" class="line" lang="java"><span class="cm">     * until the first element is encountered.</span></span>
<span id="LC121" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC122" class="line" lang="java">    <span class="kt">boolean</span> <span class="n">m_needToOutputDocTypeDecl</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC123" class="line" lang="java"></span>
<span id="LC124" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC125" class="line" lang="java"><span class="cm">     * The character encoding.  Must match the encoding used for the</span></span>
<span id="LC126" class="line" lang="java"><span class="cm">     * printWriter.</span></span>
<span id="LC127" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC128" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">m_encoding</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC129" class="line" lang="java"></span>
<span id="LC130" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC131" class="line" lang="java"><span class="cm">     * Tells if we should write the XML declaration.</span></span>
<span id="LC132" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC133" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">m_shouldNotWriteXMLHeader</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC134" class="line" lang="java"></span>
<span id="LC135" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC136" class="line" lang="java"><span class="cm">     * The standalone value for the doctype.</span></span>
<span id="LC137" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC138" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">m_standalone</span><span class="o">;</span></span>
<span id="LC139" class="line" lang="java"></span>
<span id="LC140" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC141" class="line" lang="java"><span class="cm">     * True if standalone was specified.</span></span>
<span id="LC142" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC143" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">boolean</span> <span class="n">m_standaloneWasSpecified</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC144" class="line" lang="java"></span>
<span id="LC145" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">     * Determine if the output is a standalone.</span></span>
<span id="LC147" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC148" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">boolean</span> <span class="n">m_isStandalone</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC149" class="line" lang="java"></span>
<span id="LC150" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC151" class="line" lang="java"><span class="cm">     * Flag to tell if indenting (pretty-printing) is on.</span></span>
<span id="LC152" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC153" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">boolean</span> <span class="n">m_doIndent</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC154" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC155" class="line" lang="java"><span class="cm">     * Amount to indent.</span></span>
<span id="LC156" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC157" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">int</span> <span class="n">m_indentAmount</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC158" class="line" lang="java"></span>
<span id="LC159" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC160" class="line" lang="java"><span class="cm">     * Tells the XML version, for writing out to the XML decl.</span></span>
<span id="LC161" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC162" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">m_version</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC163" class="line" lang="java"></span>
<span id="LC164" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC165" class="line" lang="java"><span class="cm">     * The mediatype.  Not used right now.</span></span>
<span id="LC166" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC167" class="line" lang="java">    <span class="kd">private</span> <span class="nc">String</span> <span class="n">m_mediatype</span><span class="o">;</span></span>
<span id="LC168" class="line" lang="java"></span>
<span id="LC169" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC170" class="line" lang="java"><span class="cm">     * The transformer that was around when this output handler was created (if</span></span>
<span id="LC171" class="line" lang="java"><span class="cm">     * any).</span></span>
<span id="LC172" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC173" class="line" lang="java">    <span class="kd">private</span> <span class="nc">Transformer</span> <span class="n">m_transformer</span><span class="o">;</span></span>
<span id="LC174" class="line" lang="java"></span>
<span id="LC175" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC176" class="line" lang="java"><span class="cm">     * Pairs of local names and corresponding URIs of CDATA sections. This list</span></span>
<span id="LC177" class="line" lang="java"><span class="cm">     * comes from the cdata-section-elements attribute. Every second one is a</span></span>
<span id="LC178" class="line" lang="java"><span class="cm">     * local name, and every other second one is the URI for the local name.</span></span>
<span id="LC179" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC180" class="line" lang="java">    <span class="kd">protected</span> <span class="nc">Vector</span> <span class="n">m_cdataSectionElements</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC181" class="line" lang="java"></span>
<span id="LC182" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC183" class="line" lang="java"><span class="cm">     * Namespace support, that keeps track of currently defined</span></span>
<span id="LC184" class="line" lang="java"><span class="cm">     * prefix/uri mappings. As processed elements come and go, so do</span></span>
<span id="LC185" class="line" lang="java"><span class="cm">     * the associated mappings for that element.</span></span>
<span id="LC186" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC187" class="line" lang="java">    <span class="kd">protected</span> <span class="nc">NamespaceMappings</span> <span class="n">m_prefixMap</span><span class="o">;</span></span>
<span id="LC188" class="line" lang="java"></span>
<span id="LC189" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC190" class="line" lang="java"><span class="cm">     * Handle for firing generate events.  This interface may be implemented</span></span>
<span id="LC191" class="line" lang="java"><span class="cm">     * by the referenced transformer object.</span></span>
<span id="LC192" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC193" class="line" lang="java">    <span class="kd">protected</span> <span class="nc">SerializerTrace</span> <span class="n">m_tracer</span><span class="o">;</span></span>
<span id="LC194" class="line" lang="java"></span>
<span id="LC195" class="line" lang="java">    <span class="kd">protected</span> <span class="nc">SourceLocator</span> <span class="n">m_sourceLocator</span><span class="o">;</span></span>
...
<span id="LC199" class="line" lang="java"><span class="cm">     * The writer to send output to. This field is only used in the ToStream</span></span>
<span id="LC200" class="line" lang="java"><span class="cm">     * serializers, but exists here just so that the fireStartDoc() and</span></span>
<span id="LC201" class="line" lang="java"><span class="cm">     * other fire... methods can flush this writer when tracing.</span></span>
<span id="LC202" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC203" class="line" lang="java">    <span class="kd">protected</span> <span class="n">java</span><span class="o">.</span><span class="na">io</span><span class="o">.</span><span class="na">Writer</span> <span class="n">m_writer</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC204" class="line" lang="java"></span>
<span id="LC205" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC206" class="line" lang="java"><span class="cm">     * A reference to "stack frame" corresponding to</span></span>
<span id="LC207" class="line" lang="java"><span class="cm">     * the current element. Such a frame is pushed at a startElement()</span></span>
<span id="LC208" class="line" lang="java"><span class="cm">     * and popped at an endElement(). This frame contains information about</span></span>
<span id="LC209" class="line" lang="java"><span class="cm">     * the element, such as its namespace URI.</span></span>
<span id="LC210" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC211" class="line" lang="java">    <span class="kd">protected</span> <span class="nc">ElemContext</span> <span class="n">m_elemContext</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">ElemContext</span><span class="o">();</span></span>
<span id="LC212" class="line" lang="java"></span>
<span id="LC213" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC214" class="line" lang="java"><span class="cm">     * A utility buffer for converting Strings passed to</span></span>
<span id="LC215" class="line" lang="java"><span class="cm">     * character() methods to character arrays.</span></span>
<span id="LC216" class="line" lang="java"><span class="cm">     * Reusing this buffer means not creating a new character array</span></span>
<span id="LC217" class="line" lang="java"><span class="cm">     * everytime and it runs faster.</span></span>
<span id="LC218" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC219" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">char</span><span class="o">[]</span> <span class="n">m_charsBuff</span> <span class="o">=</span> <span class="k">new</span> <span class="kt">char</span><span class="o">[</span><span class="mi">60</span><span class="o">];</span></span>
<span id="LC220" class="line" lang="java"></span>
<span id="LC221" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC222" class="line" lang="java"><span class="cm">     * A utility buffer for converting Strings passed to</span></span>
<span id="LC223" class="line" lang="java"><span class="cm">     * attribute methods to character arrays.</span></span>
<span id="LC224" class="line" lang="java"><span class="cm">     * Reusing this buffer means not creating a new character array</span></span>
<span id="LC225" class="line" lang="java"><span class="cm">     * everytime and it runs faster.</span></span>
<span id="LC226" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC227" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">char</span><span class="o">[]</span> <span class="n">m_attrBuff</span> <span class="o">=</span> <span class="k">new</span> <span class="kt">char</span><span class="o">[</span><span class="mi">30</span><span class="o">];</span></span>
<span id="LC228" class="line" lang="java"></span>
<span id="LC229" class="line" lang="java">    <span class="kd">private</span> <span class="nc">Locator</span> <span class="n">m_locator</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC230" class="line" lang="java"></span>
<span id="LC231" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">boolean</span> <span class="n">m_needToCallSetDocumentInfo</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC232" class="line" lang="java"></span>
<span id="LC233" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC234" class="line" lang="java"><span class="cm">     * Receive notification of a comment.</span></span>
<span id="LC235" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC236" class="line" lang="java"><span class="cm">     * @see ExtendedLexicalHandler#comment(String)</span></span>
<span id="LC237" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC238" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">comment</span><span class="o">(</span><span class="nc">String</span> <span class="n">data</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC239" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC240" class="line" lang="java">        <span class="kd">final</span> <span class="kt">int</span> <span class="n">length</span> <span class="o">=</span> <span class="n">data</span><span class="o">.</span><span class="na">length</span><span class="o">();</span></span>
<span id="LC241" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">length</span> <span class="o">&gt;</span> <span class="n">m_charsBuff</span><span class="o">.</span><span class="na">length</span><span class="o">)</span></span>
<span id="LC242" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC243" class="line" lang="java">            <span class="n">m_charsBuff</span> <span class="o">=</span> <span class="k">new</span> <span class="kt">char</span><span class="o">[</span><span class="n">length</span> <span class="o">*</span> <span class="mi">2</span> <span class="o">+</span> <span class="mi">1</span><span class="o">];</span></span>
<span id="LC244" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC245" class="line" lang="java">        <span class="n">data</span><span class="o">.</span><span class="na">getChars</span><span class="o">(</span><span class="mi">0</span><span class="o">,</span> <span class="n">length</span><span class="o">,</span> <span class="n">m_charsBuff</span><span class="o">,</span> <span class="mi">0</span><span class="o">);</span></span>
<span id="LC246" class="line" lang="java">        <span class="n">comment</span><span class="o">(</span><span class="n">m_charsBuff</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">length</span><span class="o">);</span></span>
...
<span id="LC250" class="line" lang="java"><span class="cm">     * If at runtime, when the qname of the attribute is</span></span>
<span id="LC251" class="line" lang="java"><span class="cm">     * known, another prefix is specified for the attribute, then we can</span></span>
<span id="LC252" class="line" lang="java"><span class="cm">     * patch or hack the name with this method. For</span></span>
<span id="LC253" class="line" lang="java"><span class="cm">     * a qname of the form "ns?:otherprefix:name", this function patches the</span></span>
<span id="LC254" class="line" lang="java"><span class="cm">     * qname by simply ignoring "otherprefix".</span></span>
<span id="LC255" class="line" lang="java"><span class="cm">     * TODO: This method is a HACK! We do not have access to the</span></span>
<span id="LC256" class="line" lang="java"><span class="cm">     * XML file, it sometimes generates a NS prefix of the form "ns?" for</span></span>
<span id="LC257" class="line" lang="java"><span class="cm">     * an attribute.</span></span>
<span id="LC258" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC259" class="line" lang="java">    <span class="kd">protected</span> <span class="nc">String</span> <span class="nf">patchName</span><span class="o">(</span><span class="nc">String</span> <span class="n">qname</span><span class="o">)</span></span>
...
<span id="LC263" class="line" lang="java">        <span class="kd">final</span> <span class="kt">int</span> <span class="n">lastColon</span> <span class="o">=</span> <span class="n">qname</span><span class="o">.</span><span class="na">lastIndexOf</span><span class="o">(</span><span class="sc">':'</span><span class="o">);</span></span>
<span id="LC264" class="line" lang="java"></span>
<span id="LC265" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">lastColon</span> <span class="o">&gt;</span> <span class="mi">0</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC266" class="line" lang="java">            <span class="kd">final</span> <span class="kt">int</span> <span class="n">firstColon</span> <span class="o">=</span> <span class="n">qname</span><span class="o">.</span><span class="na">indexOf</span><span class="o">(</span><span class="sc">':'</span><span class="o">);</span></span>
<span id="LC267" class="line" lang="java">            <span class="kd">final</span> <span class="nc">String</span> <span class="n">prefix</span> <span class="o">=</span> <span class="n">qname</span><span class="o">.</span><span class="na">substring</span><span class="o">(</span><span class="mi">0</span><span class="o">,</span> <span class="n">firstColon</span><span class="o">);</span></span>
<span id="LC268" class="line" lang="java">            <span class="kd">final</span> <span class="nc">String</span> <span class="n">localName</span> <span class="o">=</span> <span class="n">qname</span><span class="o">.</span><span class="na">substring</span><span class="o">(</span><span class="n">lastColon</span> <span class="o">+</span> <span class="mi">1</span><span class="o">);</span></span>
<span id="LC269" class="line" lang="java"></span>
<span id="LC270" class="line" lang="java">        <span class="c1">// If uri is "" then ignore prefix</span></span>
<span id="LC271" class="line" lang="java">            <span class="kd">final</span> <span class="nc">String</span> <span class="n">uri</span> <span class="o">=</span> <span class="n">m_prefixMap</span><span class="o">.</span><span class="na">lookupNamespace</span><span class="o">(</span><span class="n">prefix</span><span class="o">);</span></span>
<span id="LC272" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">uri</span> <span class="o">!=</span> <span class="kc">null</span> <span class="o">&amp;&amp;</span> <span class="n">uri</span><span class="o">.</span><span class="na">length</span><span class="o">()</span> <span class="o">==</span> <span class="mi">0</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC273" class="line" lang="java">                <span class="k">return</span> <span class="n">localName</span><span class="o">;</span></span>
<span id="LC274" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC275" class="line" lang="java">            <span class="k">else</span> <span class="nf">if</span> <span class="o">(</span><span class="n">firstColon</span> <span class="o">!=</span> <span class="n">lastColon</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC276" class="line" lang="java">                <span class="k">return</span> <span class="n">prefix</span> <span class="o">+</span> <span class="sc">':'</span> <span class="o">+</span> <span class="n">localName</span><span class="o">;</span></span>
<span id="LC277" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC278" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC279" class="line" lang="java">        <span class="k">return</span> <span class="n">qname</span><span class="o">;</span></span>
...
<span id="LC283" class="line" lang="java"><span class="cm">     * Returns the local name of a qualified name. If the name has no prefix,</span></span>
<span id="LC284" class="line" lang="java"><span class="cm">     * then it works as the identity (SAX2).</span></span>
<span id="LC285" class="line" lang="java"><span class="cm">     * @param qname the qualified name</span></span>
<span id="LC286" class="line" lang="java"><span class="cm">     * @return the name, but excluding any prefix and colon.</span></span>
<span id="LC287" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC288" class="line" lang="java">    <span class="kd">protected</span> <span class="kd">static</span> <span class="nc">String</span> <span class="nf">getLocalName</span><span class="o">(</span><span class="nc">String</span> <span class="n">qname</span><span class="o">)</span></span>
<span id="LC289" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC290" class="line" lang="java">        <span class="kd">final</span> <span class="kt">int</span> <span class="n">col</span> <span class="o">=</span> <span class="n">qname</span><span class="o">.</span><span class="na">lastIndexOf</span><span class="o">(</span><span class="sc">':'</span><span class="o">);</span></span>
<span id="LC291" class="line" lang="java">        <span class="k">return</span> <span class="o">(</span><span class="n">col</span> <span class="o">&gt;</span> <span class="mi">0</span><span class="o">)</span> <span class="o">?</span> <span class="n">qname</span><span class="o">.</span><span class="na">substring</span><span class="o">(</span><span class="n">col</span> <span class="o">+</span> <span class="mi">1</span><span class="o">)</span> <span class="o">:</span> <span class="n">qname</span><span class="o">;</span></span>
...
<span id="LC295" class="line" lang="java"><span class="cm">     * Receive an object for locating the origin of SAX document events.</span></span>
<span id="LC296" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC297" class="line" lang="java"><span class="cm">     * @param locator An object that can return the location of any SAX document</span></span>
<span id="LC298" class="line" lang="java"><span class="cm">     * event.</span></span>
<span id="LC299" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC300" class="line" lang="java"><span class="cm">     * Receive an object for locating the origin of SAX document events.</span></span>
<span id="LC301" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC302" class="line" lang="java"><span class="cm">     * &lt;p&gt;SAX parsers are strongly encouraged (though not absolutely</span></span>
<span id="LC303" class="line" lang="java"><span class="cm">     * required) to supply a locator: if it does so, it must supply</span></span>
<span id="LC304" class="line" lang="java"><span class="cm">     * the locator to the application by invoking this method before</span></span>
<span id="LC305" class="line" lang="java"><span class="cm">     * invoking any of the other methods in the DocumentHandler</span></span>
<span id="LC306" class="line" lang="java"><span class="cm">     * interface.&lt;/p&gt;</span></span>
<span id="LC307" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC308" class="line" lang="java"><span class="cm">     * &lt;p&gt;The locator allows the application to determine the end</span></span>
<span id="LC309" class="line" lang="java"><span class="cm">     * position of any document-related event, even if the parser is</span></span>
<span id="LC310" class="line" lang="java"><span class="cm">     * not reporting an error.  Typically, the application will</span></span>
<span id="LC311" class="line" lang="java"><span class="cm">     * use this information for reporting its own errors (such as</span></span>
<span id="LC312" class="line" lang="java"><span class="cm">     * character content that does not match an application's</span></span>
<span id="LC313" class="line" lang="java"><span class="cm">     * business rules).  The information returned by the locator</span></span>
<span id="LC314" class="line" lang="java"><span class="cm">     * is probably not sufficient for use with a search engine.&lt;/p&gt;</span></span>
<span id="LC315" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC316" class="line" lang="java"><span class="cm">     * &lt;p&gt;Note that the locator will return correct information only</span></span>
<span id="LC317" class="line" lang="java"><span class="cm">     * during the invocation of the events in this interface.  The</span></span>
<span id="LC318" class="line" lang="java"><span class="cm">     * application should not attempt to use it at any other time.&lt;/p&gt;</span></span>
<span id="LC319" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC320" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDocumentLocator</span><span class="o">(</span><span class="nc">Locator</span> <span class="n">locator</span><span class="o">)</span></span>
<span id="LC321" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC322" class="line" lang="java">        <span class="n">m_locator</span> <span class="o">=</span> <span class="n">locator</span><span class="o">;</span></span>
...
<span id="LC326" class="line" lang="java"><span class="cm">     * Adds the given attribute to the set of collected attributes , but only if</span></span>
<span id="LC327" class="line" lang="java"><span class="cm">     * there is a currently open element.</span></span>
<span id="LC328" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC329" class="line" lang="java"><span class="cm">     * An element is currently open if a startElement() notification has</span></span>
<span id="LC330" class="line" lang="java"><span class="cm">     * occured but the start of the element has not yet been written to the</span></span>
<span id="LC331" class="line" lang="java"><span class="cm">     * output.  In the stream case this means that we have not yet been forced</span></span>
<span id="LC332" class="line" lang="java"><span class="cm">     * to close the elements opening tag by another notification, such as a</span></span>
<span id="LC333" class="line" lang="java"><span class="cm">     * character notification.</span></span>
<span id="LC334" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC335" class="line" lang="java"><span class="cm">     * @param uri the URI of the attribute</span></span>
<span id="LC336" class="line" lang="java"><span class="cm">     * @param localName the local name of the attribute</span></span>
<span id="LC337" class="line" lang="java"><span class="cm">     * @param rawName    the qualified name of the attribute</span></span>
<span id="LC338" class="line" lang="java"><span class="cm">     * @param type the type of the attribute (probably CDATA)</span></span>
<span id="LC339" class="line" lang="java"><span class="cm">     * @param value the value of the attribute</span></span>
<span id="LC340" class="line" lang="java"><span class="cm">     * @param XSLAttribute true if this attribute is coming from an xsl:attriute element</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#addAttribute(String, String, String, String, String)</span></span>
<span id="LC342" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC343" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addAttribute</span><span class="o">(</span></span>
<span id="LC344" class="line" lang="java">        <span class="nc">String</span> <span class="n">uri</span><span class="o">,</span></span>
<span id="LC345" class="line" lang="java">        <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span></span>
<span id="LC346" class="line" lang="java">        <span class="nc">String</span> <span class="n">rawName</span><span class="o">,</span></span>
<span id="LC347" class="line" lang="java">        <span class="nc">String</span> <span class="n">type</span><span class="o">,</span></span>
<span id="LC348" class="line" lang="java">        <span class="nc">String</span> <span class="n">value</span><span class="o">,</span></span>
<span id="LC349" class="line" lang="java">        <span class="kt">boolean</span> <span class="nc">XSLAttribute</span><span class="o">)</span></span>
<span id="LC350" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC351" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC352" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_startTagOpen</span><span class="o">)</span></span>
<span id="LC353" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC354" class="line" lang="java">            <span class="n">addAttributeAlways</span><span class="o">(</span><span class="n">uri</span><span class="o">,</span> <span class="n">localName</span><span class="o">,</span> <span class="n">rawName</span><span class="o">,</span> <span class="n">type</span><span class="o">,</span> <span class="n">value</span><span class="o">,</span> <span class="nc">XSLAttribute</span><span class="o">);</span></span>
...
<span id="LC360" class="line" lang="java"><span class="cm">     * Adds the given attribute to the set of attributes, even if there is</span></span>
<span id="LC361" class="line" lang="java"><span class="cm">     * no currently open element. This is useful if a SAX startPrefixMapping()</span></span>
<span id="LC362" class="line" lang="java"><span class="cm">     * should need to add an attribute before the element name is seen.</span></span>
<span id="LC363" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC364" class="line" lang="java"><span class="cm">     * @param uri the URI of the attribute</span></span>
<span id="LC365" class="line" lang="java"><span class="cm">     * @param localName the local name of the attribute</span></span>
<span id="LC366" class="line" lang="java"><span class="cm">     * @param rawName   the qualified name of the attribute</span></span>
<span id="LC367" class="line" lang="java"><span class="cm">     * @param type the type of the attribute (probably CDATA)</span></span>
<span id="LC368" class="line" lang="java"><span class="cm">     * @param value the value of the attribute</span></span>
<span id="LC369" class="line" lang="java"><span class="cm">     * @param XSLAttribute true if this attribute is coming from an xsl:attribute element</span></span>
<span id="LC370" class="line" lang="java"><span class="cm">     * @return true if the attribute was added,</span></span>
<span id="LC371" class="line" lang="java"><span class="cm">     * false if an existing value was replaced.</span></span>
<span id="LC372" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC373" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">addAttributeAlways</span><span class="o">(</span></span>
<span id="LC374" class="line" lang="java">        <span class="nc">String</span> <span class="n">uri</span><span class="o">,</span></span>
<span id="LC375" class="line" lang="java">        <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span></span>
<span id="LC376" class="line" lang="java">        <span class="nc">String</span> <span class="n">rawName</span><span class="o">,</span></span>
<span id="LC377" class="line" lang="java">        <span class="nc">String</span> <span class="n">type</span><span class="o">,</span></span>
<span id="LC378" class="line" lang="java">        <span class="nc">String</span> <span class="n">value</span><span class="o">,</span></span>
<span id="LC379" class="line" lang="java">        <span class="kt">boolean</span> <span class="nc">XSLAttribute</span><span class="o">)</span></span>
<span id="LC380" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC381" class="line" lang="java">        <span class="kt">boolean</span> <span class="n">was_added</span><span class="o">;</span></span>
<span id="LC382" class="line" lang="java"><span class="c1">//            final int index =</span></span>
<span id="LC383" class="line" lang="java"><span class="c1">//                (localName == null || uri == null) ?</span></span>
<span id="LC384" class="line" lang="java"><span class="c1">//                m_attributes.getIndex(rawName):m_attributes.getIndex(uri, localName);</span></span>
<span id="LC385" class="line" lang="java">            <span class="kt">int</span> <span class="n">index</span><span class="o">;</span></span>
<span id="LC386" class="line" lang="java"><span class="c1">//            if (localName == null || uri == null){</span></span>
<span id="LC387" class="line" lang="java"><span class="c1">//                index = m_attributes.getIndex(rawName);</span></span>
<span id="LC388" class="line" lang="java"><span class="c1">//            }</span></span>
<span id="LC389" class="line" lang="java"><span class="c1">//            else {</span></span>
<span id="LC390" class="line" lang="java"><span class="c1">//                index = m_attributes.getIndex(uri, localName);</span></span>
<span id="LC391" class="line" lang="java"><span class="c1">//            }</span></span>
<span id="LC392" class="line" lang="java"></span>
<span id="LC393" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">localName</span> <span class="o">==</span> <span class="kc">null</span> <span class="o">||</span> <span class="n">uri</span> <span class="o">==</span> <span class="kc">null</span> <span class="o">||</span> <span class="n">uri</span><span class="o">.</span><span class="na">length</span><span class="o">()</span> <span class="o">==</span> <span class="mi">0</span><span class="o">)</span></span>
<span id="LC394" class="line" lang="java">                <span class="n">index</span> <span class="o">=</span> <span class="n">m_attributes</span><span class="o">.</span><span class="na">getIndex</span><span class="o">(</span><span class="n">rawName</span><span class="o">);</span></span>
<span id="LC395" class="line" lang="java">            <span class="k">else</span> <span class="o">{</span></span>
<span id="LC396" class="line" lang="java">                <span class="n">index</span> <span class="o">=</span> <span class="n">m_attributes</span><span class="o">.</span><span class="na">getIndex</span><span class="o">(</span><span class="n">uri</span><span class="o">,</span><span class="n">localName</span><span class="o">);</span></span>
<span id="LC397" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC398" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">index</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="o">)</span></span>
<span id="LC399" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC400" class="line" lang="java">                <span class="cm">/* We've seen the attribute before.</span></span>
<span id="LC401" class="line" lang="java"><span class="cm">                 * We may have a null uri or localName, but all</span></span>
<span id="LC402" class="line" lang="java"><span class="cm">                 * we really want to re-set is the value anyway.</span></span>
<span id="LC403" class="line" lang="java"><span class="cm">                 */</span></span>
<span id="LC404" class="line" lang="java">                <span class="n">m_attributes</span><span class="o">.</span><span class="na">setValue</span><span class="o">(</span><span class="n">index</span><span class="o">,</span><span class="n">value</span><span class="o">);</span></span>
<span id="LC405" class="line" lang="java">                <span class="n">was_added</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC406" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC407" class="line" lang="java">            <span class="k">else</span></span>
<span id="LC408" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC409" class="line" lang="java">                <span class="c1">// the attribute doesn't exist yet, create it</span></span>
<span id="LC410" class="line" lang="java">                <span class="n">m_attributes</span><span class="o">.</span><span class="na">addAttribute</span><span class="o">(</span><span class="n">uri</span><span class="o">,</span> <span class="n">localName</span><span class="o">,</span> <span class="n">rawName</span><span class="o">,</span> <span class="n">type</span><span class="o">,</span> <span class="n">value</span><span class="o">);</span></span>
<span id="LC411" class="line" lang="java">                <span class="n">was_added</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC412" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC413" class="line" lang="java">            <span class="k">return</span> <span class="n">was_added</span><span class="o">;</span></span>
...
<span id="LC419" class="line" lang="java"><span class="cm">     *  Adds  the given attribute to the set of collected attributes,</span></span>
<span id="LC420" class="line" lang="java"><span class="cm">     * but only if there is a currently open element.</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">     * @param name the attribute's qualified name</span></span>
<span id="LC423" class="line" lang="java"><span class="cm">     * @param value the value of the attribute</span></span>
<span id="LC424" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC425" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addAttribute</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="kd">final</span> <span class="nc">String</span> <span class="n">value</span><span class="o">)</span></span>
<span id="LC426" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC427" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_startTagOpen</span><span class="o">)</span></span>
<span id="LC428" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC429" class="line" lang="java">            <span class="kd">final</span> <span class="nc">String</span> <span class="n">patchedName</span> <span class="o">=</span> <span class="n">patchName</span><span class="o">(</span><span class="n">name</span><span class="o">);</span></span>
<span id="LC430" class="line" lang="java">            <span class="kd">final</span> <span class="nc">String</span> <span class="n">localName</span> <span class="o">=</span> <span class="n">getLocalName</span><span class="o">(</span><span class="n">patchedName</span><span class="o">);</span></span>
<span id="LC431" class="line" lang="java">            <span class="kd">final</span> <span class="nc">String</span> <span class="n">uri</span> <span class="o">=</span> <span class="n">getNamespaceURI</span><span class="o">(</span><span class="n">patchedName</span><span class="o">,</span> <span class="kc">false</span><span class="o">);</span></span>
<span id="LC432" class="line" lang="java"></span>
<span id="LC433" class="line" lang="java">            <span class="n">addAttributeAlways</span><span class="o">(</span><span class="n">uri</span><span class="o">,</span><span class="n">localName</span><span class="o">,</span> <span class="n">patchedName</span><span class="o">,</span> <span class="s">"CDATA"</span><span class="o">,</span> <span class="n">value</span><span class="o">,</span> <span class="kc">false</span><span class="o">);</span></span>
...
<span id="LC438" class="line" lang="java"><span class="cm">     * Adds the given xsl:attribute to the set of collected attributes,</span></span>
<span id="LC439" class="line" lang="java"><span class="cm">     * but only if there is a currently open element.</span></span>
<span id="LC440" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC441" class="line" lang="java"><span class="cm">     * @param name the attribute's qualified name (prefix:localName)</span></span>
<span id="LC442" class="line" lang="java"><span class="cm">     * @param value the value of the attribute</span></span>
<span id="LC443" class="line" lang="java"><span class="cm">     * @param uri the URI that the prefix of the name points to</span></span>
<span id="LC444" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC445" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addXSLAttribute</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="kd">final</span> <span class="nc">String</span> <span class="n">value</span><span class="o">,</span> <span class="kd">final</span> <span class="nc">String</span> <span class="n">uri</span><span class="o">)</span></span>
<span id="LC446" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC447" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_startTagOpen</span><span class="o">)</span></span>
<span id="LC448" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC449" class="line" lang="java">            <span class="kd">final</span> <span class="nc">String</span> <span class="n">patchedName</span> <span class="o">=</span> <span class="n">patchName</span><span class="o">(</span><span class="n">name</span><span class="o">);</span></span>
<span id="LC450" class="line" lang="java">            <span class="kd">final</span> <span class="nc">String</span> <span class="n">localName</span> <span class="o">=</span> <span class="n">getLocalName</span><span class="o">(</span><span class="n">patchedName</span><span class="o">);</span></span>
<span id="LC451" class="line" lang="java"></span>
<span id="LC452" class="line" lang="java">            <span class="n">addAttributeAlways</span><span class="o">(</span><span class="n">uri</span><span class="o">,</span><span class="n">localName</span><span class="o">,</span> <span class="n">patchedName</span><span class="o">,</span> <span class="s">"CDATA"</span><span class="o">,</span> <span class="n">value</span><span class="o">,</span> <span class="kc">true</span><span class="o">);</span></span>
...
<span id="LC457" class="line" lang="java"><span class="cm">     * Add the given attributes to the currently collected ones. These</span></span>
<span id="LC458" class="line" lang="java"><span class="cm">     * attributes are always added, regardless of whether on not an element</span></span>
<span id="LC459" class="line" lang="java"><span class="cm">     * is currently open.</span></span>
<span id="LC460" class="line" lang="java"><span class="cm">     * @param atts List of attributes to add to this list</span></span>
<span id="LC461" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC462" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addAttributes</span><span class="o">(</span><span class="nc">Attributes</span> <span class="n">atts</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC463" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC464" class="line" lang="java"></span>
<span id="LC465" class="line" lang="java">        <span class="kt">int</span> <span class="n">nAtts</span> <span class="o">=</span> <span class="n">atts</span><span class="o">.</span><span class="na">getLength</span><span class="o">();</span></span>
<span id="LC466" class="line" lang="java">        <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">nAtts</span><span class="o">;</span> <span class="n">i</span><span class="o">++)</span></span>
<span id="LC467" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC468" class="line" lang="java">            <span class="nc">String</span> <span class="n">uri</span> <span class="o">=</span> <span class="n">atts</span><span class="o">.</span><span class="na">getURI</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC469" class="line" lang="java"></span>
<span id="LC470" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">uri</span><span class="o">)</span></span>
<span id="LC471" class="line" lang="java">                <span class="n">uri</span> <span class="o">=</span> <span class="s">""</span><span class="o">;</span></span>
<span id="LC472" class="line" lang="java"></span>
<span id="LC473" class="line" lang="java">            <span class="n">addAttributeAlways</span><span class="o">(</span></span>
<span id="LC474" class="line" lang="java">                <span class="n">uri</span><span class="o">,</span></span>
<span id="LC475" class="line" lang="java">                <span class="n">atts</span><span class="o">.</span><span class="na">getLocalName</span><span class="o">(</span><span class="n">i</span><span class="o">),</span></span>
<span id="LC476" class="line" lang="java">                <span class="n">atts</span><span class="o">.</span><span class="na">getQName</span><span class="o">(</span><span class="n">i</span><span class="o">),</span></span>
<span id="LC477" class="line" lang="java">                <span class="n">atts</span><span class="o">.</span><span class="na">getType</span><span class="o">(</span><span class="n">i</span><span class="o">),</span></span>
<span id="LC478" class="line" lang="java">                <span class="n">atts</span><span class="o">.</span><span class="na">getValue</span><span class="o">(</span><span class="n">i</span><span class="o">),</span></span>
<span id="LC479" class="line" lang="java">                <span class="kc">false</span><span class="o">);</span></span>
...
<span id="LC485" class="line" lang="java"><span class="cm">     * Return a {@link ContentHandler} interface into this serializer.</span></span>
<span id="LC486" class="line" lang="java"><span class="cm">     * If the serializer does not support the {@link ContentHandler}</span></span>
<span id="LC487" class="line" lang="java"><span class="cm">     * interface, it should return null.</span></span>
<span id="LC488" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC489" class="line" lang="java"><span class="cm">     * @return A {@link ContentHandler} interface into this serializer,</span></span>
<span id="LC490" class="line" lang="java"><span class="cm">     *  or null if the serializer is not SAX 2 capable</span></span>
<span id="LC491" class="line" lang="java"><span class="cm">     * @throws IOException An I/O exception occured</span></span>
<span id="LC492" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC493" class="line" lang="java">    <span class="kd">public</span> <span class="nc">ContentHandler</span> <span class="nf">asContentHandler</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
...
<span id="LC499" class="line" lang="java"><span class="cm">     * Report the end of an entity.</span></span>
<span id="LC500" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC501" class="line" lang="java"><span class="cm">     * @param name The name of the entity that is ending.</span></span>
<span id="LC502" class="line" lang="java"><span class="cm">     * @throws org.xml.sax.SAXException The application may raise an exception.</span></span>
<span id="LC503" class="line" lang="java"><span class="cm">     * @see #startEntity</span></span>
<span id="LC504" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC505" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endEntity</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span> <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC506" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC507" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">name</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="s">"[dtd]"</span><span class="o">))</span></span>
<span id="LC508" class="line" lang="java">            <span class="n">m_inExternalDTD</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC509" class="line" lang="java">        <span class="n">m_inEntityRef</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC510" class="line" lang="java"></span>
<span id="LC511" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC512" class="line" lang="java">            <span class="k">this</span><span class="o">.</span><span class="na">fireEndEntity</span><span class="o">(</span><span class="n">name</span><span class="o">);</span></span>
...
<span id="LC516" class="line" lang="java"><span class="cm">     * Flush and close the underlying java.io.Writer. This method applies to</span></span>
<span id="LC517" class="line" lang="java"><span class="cm">     * ToStream serializers, not ToSAXHandler serializers.</span></span>
<span id="LC518" class="line" lang="java"><span class="cm">     * @see ToStream</span></span>
<span id="LC519" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC520" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">close</span><span class="o">()</span></span>
<span id="LC521" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC522" class="line" lang="java">        <span class="c1">// do nothing (base behavior)</span></span>
...
<span id="LC526" class="line" lang="java"><span class="cm">     * Initialize global variables</span></span>
<span id="LC527" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC528" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">initCDATA</span><span class="o">()</span></span>
<span id="LC529" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC530" class="line" lang="java">        <span class="c1">// CDATA stack</span></span>
<span id="LC531" class="line" lang="java">        <span class="c1">//        _cdataStack = new Stack();</span></span>
<span id="LC532" class="line" lang="java">        <span class="c1">//        _cdataStack.push(new Integer(-1)); // push dummy value</span></span>
...
<span id="LC536" class="line" lang="java"><span class="cm">     * Returns the character encoding to be used in the output document.</span></span>
<span id="LC537" class="line" lang="java"><span class="cm">     * @return the character encoding to be used in the output document.</span></span>
<span id="LC538" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC539" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getEncoding</span><span class="o">()</span></span>
<span id="LC540" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC541" class="line" lang="java">        <span class="k">return</span> <span class="n">m_encoding</span><span class="o">;</span></span>
...
<span id="LC545" class="line" lang="java"><span class="cm">     * Sets the character encoding coming from the xsl:output encoding stylesheet attribute.</span></span>
<span id="LC546" class="line" lang="java"><span class="cm">     * @param m_encoding the character encoding</span></span>
<span id="LC547" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC548" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setEncoding</span><span class="o">(</span><span class="nc">String</span> <span class="n">m_encoding</span><span class="o">)</span></span>
<span id="LC549" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC550" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_encoding</span> <span class="o">=</span> <span class="n">m_encoding</span><span class="o">;</span></span>
...
<span id="LC554" class="line" lang="java"><span class="cm">     * Sets the value coming from the xsl:output omit-xml-declaration stylesheet attribute</span></span>
<span id="LC555" class="line" lang="java"><span class="cm">     * @param b true if the XML declaration is to be omitted from the output</span></span>
<span id="LC556" class="line" lang="java"><span class="cm">     * document.</span></span>
<span id="LC557" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC558" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setOmitXMLDeclaration</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">b</span><span class="o">)</span></span>
<span id="LC559" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC560" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_shouldNotWriteXMLHeader</span> <span class="o">=</span> <span class="n">b</span><span class="o">;</span></span>
...
<span id="LC565" class="line" lang="java"><span class="cm">     * @return true if the XML declaration is to be omitted from the output</span></span>
<span id="LC566" class="line" lang="java"><span class="cm">     * document.</span></span>
<span id="LC567" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC568" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getOmitXMLDeclaration</span><span class="o">()</span></span>
<span id="LC569" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC570" class="line" lang="java">        <span class="k">return</span> <span class="n">m_shouldNotWriteXMLHeader</span><span class="o">;</span></span>
...
<span id="LC574" class="line" lang="java"><span class="cm">     * Returns the previously set value of the value to be used as the public</span></span>
<span id="LC575" class="line" lang="java"><span class="cm">     * identifier in the document type declaration (DTD).</span></span>
<span id="LC576" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC577" class="line" lang="java"><span class="cm">     *@return the public identifier to be used in the DOCTYPE declaration in the</span></span>
<span id="LC578" class="line" lang="java"><span class="cm">     * output document.</span></span>
<span id="LC579" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC580" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getDoctypePublic</span><span class="o">()</span></span>
<span id="LC581" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC582" class="line" lang="java">        <span class="k">return</span> <span class="n">m_doctypePublic</span><span class="o">;</span></span>
<span id="LC583" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC584" class="line" lang="java"></span>
<span id="LC585" class="line" lang="java">    <span class="cm">/** Set the value coming from the xsl:output doctype-public stylesheet attribute.</span></span>
<span id="LC586" class="line" lang="java"><span class="cm">      * @param doctypePublic the public identifier to be used in the DOCTYPE</span></span>
<span id="LC587" class="line" lang="java"><span class="cm">      * declaration in the output document.</span></span>
<span id="LC588" class="line" lang="java"><span class="cm">      */</span></span>
<span id="LC589" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDoctypePublic</span><span class="o">(</span><span class="nc">String</span> <span class="n">doctypePublic</span><span class="o">)</span></span>
<span id="LC590" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC591" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_doctypePublic</span> <span class="o">=</span> <span class="n">doctypePublic</span><span class="o">;</span></span>
...
<span id="LC596" class="line" lang="java"><span class="cm">     * Returns the previously set value of the value to be used</span></span>
<span id="LC597" class="line" lang="java"><span class="cm">     * as the system identifier in the document type declaration (DTD).</span></span>
<span id="LC598" class="line" lang="java"><span class="cm">         * @return the system identifier to be used in the DOCTYPE declaration in</span></span>
<span id="LC599" class="line" lang="java"><span class="cm">         * the output document.</span></span>
<span id="LC600" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC601" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC602" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getDoctypeSystem</span><span class="o">()</span></span>
<span id="LC603" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC604" class="line" lang="java">        <span class="k">return</span> <span class="n">m_doctypeSystem</span><span class="o">;</span></span>
<span id="LC605" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC606" class="line" lang="java"></span>
<span id="LC607" class="line" lang="java">    <span class="cm">/** Set the value coming from the xsl:output doctype-system stylesheet attribute.</span></span>
<span id="LC608" class="line" lang="java"><span class="cm">      * @param doctypeSystem the system identifier to be used in the DOCTYPE</span></span>
<span id="LC609" class="line" lang="java"><span class="cm">      * declaration in the output document.</span></span>
<span id="LC610" class="line" lang="java"><span class="cm">      */</span></span>
<span id="LC611" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDoctypeSystem</span><span class="o">(</span><span class="nc">String</span> <span class="n">doctypeSystem</span><span class="o">)</span></span>
<span id="LC612" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC613" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_doctypeSystem</span> <span class="o">=</span> <span class="n">doctypeSystem</span><span class="o">;</span></span>
<span id="LC614" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC615" class="line" lang="java"></span>
<span id="LC616" class="line" lang="java">    <span class="cm">/** Set the value coming from the xsl:output doctype-public and doctype-system stylesheet properties</span></span>
<span id="LC617" class="line" lang="java"><span class="cm">     * @param doctypeSystem the system identifier to be used in the DOCTYPE</span></span>
<span id="LC618" class="line" lang="java"><span class="cm">     * declaration in the output document.</span></span>
<span id="LC619" class="line" lang="java"><span class="cm">     * @param doctypePublic the public identifier to be used in the DOCTYPE</span></span>
<span id="LC620" class="line" lang="java"><span class="cm">     * declaration in the output document.</span></span>
<span id="LC621" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC622" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDoctype</span><span class="o">(</span><span class="nc">String</span> <span class="n">doctypeSystem</span><span class="o">,</span> <span class="nc">String</span> <span class="n">doctypePublic</span><span class="o">)</span></span>
<span id="LC623" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC624" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_doctypeSystem</span> <span class="o">=</span> <span class="n">doctypeSystem</span><span class="o">;</span></span>
<span id="LC625" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_doctypePublic</span> <span class="o">=</span> <span class="n">doctypePublic</span><span class="o">;</span></span>
...
<span id="LC629" class="line" lang="java"><span class="cm">     * Sets the value coming from the xsl:output standalone stylesheet attribute.</span></span>
<span id="LC630" class="line" lang="java"><span class="cm">     * @param standalone a value of "yes" indicates that the</span></span>
<span id="LC631" class="line" lang="java"><span class="cm">     * &lt;code&gt;standalone&lt;/code&gt; delaration is to be included in the output</span></span>
<span id="LC632" class="line" lang="java"><span class="cm">     * document. This method remembers if the value was explicitly set using</span></span>
<span id="LC633" class="line" lang="java"><span class="cm">     * this method, verses if the value is the default value.</span></span>
<span id="LC634" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC635" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setStandalone</span><span class="o">(</span><span class="nc">String</span> <span class="n">standalone</span><span class="o">)</span></span>
<span id="LC636" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC637" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">standalone</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC638" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC639" class="line" lang="java">            <span class="n">m_standaloneWasSpecified</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC640" class="line" lang="java">            <span class="n">setStandaloneInternal</span><span class="o">(</span><span class="n">standalone</span><span class="o">);</span></span>
...
<span id="LC644" class="line" lang="java"><span class="cm">     * Sets the XSL standalone attribute, but does not remember if this is a</span></span>
<span id="LC645" class="line" lang="java"><span class="cm">     * default or explicite setting.</span></span>
<span id="LC646" class="line" lang="java"><span class="cm">     * @param standalone "yes" | "no"</span></span>
<span id="LC647" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC648" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">setStandaloneInternal</span><span class="o">(</span><span class="nc">String</span> <span class="n">standalone</span><span class="o">)</span></span>
<span id="LC649" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC650" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="s">"yes"</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">standalone</span><span class="o">))</span></span>
<span id="LC651" class="line" lang="java">            <span class="n">m_standalone</span> <span class="o">=</span> <span class="s">"yes"</span><span class="o">;</span></span>
<span id="LC652" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC653" class="line" lang="java">            <span class="n">m_standalone</span> <span class="o">=</span> <span class="s">"no"</span><span class="o">;</span></span>
...
<span id="LC658" class="line" lang="java"><span class="cm">     * Gets the XSL standalone attribute</span></span>
<span id="LC659" class="line" lang="java"><span class="cm">     * @return a value of "yes" if the &lt;code&gt;standalone&lt;/code&gt; delaration is to</span></span>
<span id="LC660" class="line" lang="java"><span class="cm">     * be included in the output document.</span></span>
<span id="LC661" class="line" lang="java"><span class="cm">     *  @see XSLOutputAttributes#getStandalone()</span></span>
<span id="LC662" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC663" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getStandalone</span><span class="o">()</span></span>
<span id="LC664" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC665" class="line" lang="java">        <span class="k">return</span> <span class="n">m_standalone</span><span class="o">;</span></span>
...
<span id="LC669" class="line" lang="java"><span class="cm">     * @return true if the output document should be indented to visually</span></span>
<span id="LC670" class="line" lang="java"><span class="cm">     * indicate its structure.</span></span>
<span id="LC671" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC672" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getIndent</span><span class="o">()</span></span>
<span id="LC673" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC674" class="line" lang="java">        <span class="k">return</span> <span class="n">m_doIndent</span><span class="o">;</span></span>
<span id="LC675" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC676" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC677" class="line" lang="java"><span class="cm">     * Gets the mediatype the media-type or MIME type associated with the output</span></span>
<span id="LC678" class="line" lang="java"><span class="cm">     * document.</span></span>
<span id="LC679" class="line" lang="java"><span class="cm">     * @return the mediatype the media-type or MIME type associated with the</span></span>
<span id="LC680" class="line" lang="java"><span class="cm">     * output document.</span></span>
<span id="LC681" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC682" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getMediaType</span><span class="o">()</span></span>
<span id="LC683" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC684" class="line" lang="java">        <span class="k">return</span> <span class="n">m_mediatype</span><span class="o">;</span></span>
...
<span id="LC688" class="line" lang="java"><span class="cm">     * Gets the version of the output format.</span></span>
<span id="LC689" class="line" lang="java"><span class="cm">     * @return the version of the output format.</span></span>
<span id="LC690" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC691" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getVersion</span><span class="o">()</span></span>
<span id="LC692" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC693" class="line" lang="java">        <span class="k">return</span> <span class="n">m_version</span><span class="o">;</span></span>
...
<span id="LC697" class="line" lang="java"><span class="cm">     * Sets the value coming from the xsl:output version attribute.</span></span>
<span id="LC698" class="line" lang="java"><span class="cm">     * @param version the version of the output format.</span></span>
<span id="LC699" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setVersion(String)</span></span>
<span id="LC700" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC701" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setVersion</span><span class="o">(</span><span class="nc">String</span> <span class="n">version</span><span class="o">)</span></span>
<span id="LC702" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC703" class="line" lang="java">        <span class="n">m_version</span> <span class="o">=</span> <span class="n">version</span><span class="o">;</span></span>
...
<span id="LC707" class="line" lang="java"><span class="cm">     * Sets the value coming from the xsl:output media-type stylesheet attribute.</span></span>
<span id="LC708" class="line" lang="java"><span class="cm">     * @param mediaType the non-null media-type or MIME type associated with the</span></span>
<span id="LC709" class="line" lang="java"><span class="cm">     * output document.</span></span>
<span id="LC710" class="line" lang="java"><span class="cm">     * @see javax.xml.transform.OutputKeys#MEDIA_TYPE</span></span>
<span id="LC711" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setMediaType(String)</span></span>
<span id="LC712" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC713" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setMediaType</span><span class="o">(</span><span class="nc">String</span> <span class="n">mediaType</span><span class="o">)</span></span>
<span id="LC714" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC715" class="line" lang="java">        <span class="n">m_mediatype</span> <span class="o">=</span> <span class="n">mediaType</span><span class="o">;</span></span>
...
<span id="LC719" class="line" lang="java"><span class="cm">     * @return the number of spaces to indent for each indentation level.</span></span>
<span id="LC720" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC721" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getIndentAmount</span><span class="o">()</span></span>
<span id="LC722" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC723" class="line" lang="java">        <span class="k">return</span> <span class="n">m_indentAmount</span><span class="o">;</span></span>
...
<span id="LC727" class="line" lang="java"><span class="cm">     * Sets the indentation amount.</span></span>
<span id="LC728" class="line" lang="java"><span class="cm">     * @param m_indentAmount The m_indentAmount to set</span></span>
<span id="LC729" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC730" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIndentAmount</span><span class="o">(</span><span class="kt">int</span> <span class="n">m_indentAmount</span><span class="o">)</span></span>
<span id="LC731" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC732" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_indentAmount</span> <span class="o">=</span> <span class="n">m_indentAmount</span><span class="o">;</span></span>
...
<span id="LC736" class="line" lang="java"><span class="cm">     * Sets the value coming from the xsl:output indent stylesheet</span></span>
<span id="LC737" class="line" lang="java"><span class="cm">     * attribute.</span></span>
<span id="LC738" class="line" lang="java"><span class="cm">     * @param doIndent true if the output document should be indented to</span></span>
<span id="LC739" class="line" lang="java"><span class="cm">     * visually indicate its structure.</span></span>
<span id="LC740" class="line" lang="java"><span class="cm">     * @see XSLOutputAttributes#setIndent(boolean)</span></span>
<span id="LC741" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC742" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIndent</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">doIndent</span><span class="o">)</span></span>
<span id="LC743" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC744" class="line" lang="java">        <span class="n">m_doIndent</span> <span class="o">=</span> <span class="n">doIndent</span><span class="o">;</span></span>
...
<span id="LC748" class="line" lang="java"><span class="cm">     * Sets the isStandalone property</span></span>
<span id="LC749" class="line" lang="java"><span class="cm">     * @param isStandalone true if the ORACLE_IS_STANDALONE is set to yes</span></span>
<span id="LC750" class="line" lang="java"><span class="cm">     * @see OutputPropertiesFactory ORACLE_IS_STANDALONE</span></span>
<span id="LC751" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC752" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIsStandalone</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">isStandalone</span><span class="o">)</span></span>
<span id="LC753" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC754" class="line" lang="java">       <span class="n">m_isStandalone</span> <span class="o">=</span> <span class="n">isStandalone</span><span class="o">;</span></span>
...
<span id="LC758" class="line" lang="java"><span class="cm">     * This method is used when a prefix/uri namespace mapping</span></span>
<span id="LC759" class="line" lang="java"><span class="cm">     * is indicated after the element was started with a</span></span>
<span id="LC760" class="line" lang="java"><span class="cm">     * startElement() and before and endElement().</span></span>
<span id="LC761" class="line" lang="java"><span class="cm">     * startPrefixMapping(prefix,uri) would be used before the</span></span>
<span id="LC762" class="line" lang="java"><span class="cm">     * startElement() call.</span></span>
<span id="LC763" class="line" lang="java"><span class="cm">     * @param uri the URI of the namespace</span></span>
<span id="LC764" class="line" lang="java"><span class="cm">     * @param prefix the prefix associated with the given URI.</span></span>
<span id="LC765" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC766" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#namespaceAfterStartElement(String, String)</span></span>
<span id="LC767" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC768" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">namespaceAfterStartElement</span><span class="o">(</span><span class="nc">String</span> <span class="n">uri</span><span class="o">,</span> <span class="nc">String</span> <span class="n">prefix</span><span class="o">)</span></span>
<span id="LC769" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC770" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC771" class="line" lang="java">        <span class="c1">// default behavior is to do nothing</span></span>
...
<span id="LC775" class="line" lang="java"><span class="cm">     * Return a {@link DOMSerializer} interface into this serializer. If the</span></span>
<span id="LC776" class="line" lang="java"><span class="cm">     * serializer does not support the {@link DOMSerializer} interface, it should</span></span>
<span id="LC777" class="line" lang="java"><span class="cm">     * return null.</span></span>
<span id="LC778" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC779" class="line" lang="java"><span class="cm">     * @return A {@link DOMSerializer} interface into this serializer,  or null</span></span>
<span id="LC780" class="line" lang="java"><span class="cm">     * if the serializer is not DOM capable</span></span>
<span id="LC781" class="line" lang="java"><span class="cm">     * @throws IOException An I/O exception occured</span></span>
<span id="LC782" class="line" lang="java"><span class="cm">     * @see Serializer#asDOMSerializer()</span></span>
<span id="LC783" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC784" class="line" lang="java">    <span class="kd">public</span> <span class="nc">DOMSerializer</span> <span class="nf">asDOMSerializer</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
<span id="LC785" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC786" class="line" lang="java">        <span class="k">return</span> <span class="k">this</span><span class="o">;</span></span>
...
<span id="LC790" class="line" lang="java"><span class="cm">     * Push a boolean state based on if the name of the current element</span></span>
<span id="LC791" class="line" lang="java"><span class="cm">     * is found in the list of qnames.  A state is only pushed if</span></span>
<span id="LC792" class="line" lang="java"><span class="cm">     * there were some cdata-section-names were specified.</span></span>
<span id="LC793" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC794" class="line" lang="java"><span class="cm">     * Hidden parameters are the vector of qualified elements specified in</span></span>
<span id="LC795" class="line" lang="java"><span class="cm">     * cdata-section-names attribute, and the m_cdataSectionStates stack</span></span>
<span id="LC796" class="line" lang="java"><span class="cm">     * onto which whether the current element is in the list is pushed (true or</span></span>
<span id="LC797" class="line" lang="java"><span class="cm">     * false). Other hidden parameters are the current elements namespaceURI,</span></span>
<span id="LC798" class="line" lang="java"><span class="cm">     * localName and qName</span></span>
<span id="LC799" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC800" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">boolean</span> <span class="nf">isCdataSection</span><span class="o">()</span></span>
<span id="LC801" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC802" class="line" lang="java"></span>
<span id="LC803" class="line" lang="java">        <span class="kt">boolean</span> <span class="n">b</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC804" class="line" lang="java"></span>
<span id="LC805" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_cdataSectionElements</span><span class="o">)</span></span>
<span id="LC806" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC807" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_elementLocalName</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC808" class="line" lang="java">                <span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_elementLocalName</span> <span class="o">=</span></span>
<span id="LC809" class="line" lang="java">                    <span class="n">getLocalName</span><span class="o">(</span><span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_elementName</span><span class="o">);</span></span>
<span id="LC810" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_elementURI</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC811" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC812" class="line" lang="java">                <span class="nc">String</span> <span class="n">prefix</span> <span class="o">=</span> <span class="n">getPrefixPart</span><span class="o">(</span><span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_elementName</span><span class="o">);</span></span>
<span id="LC813" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="n">prefix</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC814" class="line" lang="java">                    <span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_elementURI</span> <span class="o">=</span></span>
<span id="LC815" class="line" lang="java">                        <span class="n">m_prefixMap</span><span class="o">.</span><span class="na">lookupNamespace</span><span class="o">(</span><span class="n">prefix</span><span class="o">);</span></span>
...
<span id="LC819" class="line" lang="java">            <span class="k">if</span> <span class="o">((</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_elementURI</span><span class="o">)</span></span>
<span id="LC820" class="line" lang="java">                <span class="o">&amp;&amp;</span> <span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_elementURI</span><span class="o">.</span><span class="na">length</span><span class="o">()</span> <span class="o">==</span> <span class="mi">0</span><span class="o">)</span></span>
<span id="LC821" class="line" lang="java">                <span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_elementURI</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC822" class="line" lang="java"></span>
<span id="LC823" class="line" lang="java">            <span class="kt">int</span> <span class="n">nElems</span> <span class="o">=</span> <span class="n">m_cdataSectionElements</span><span class="o">.</span><span class="na">size</span><span class="o">();</span></span>
<span id="LC824" class="line" lang="java"></span>
<span id="LC825" class="line" lang="java">            <span class="c1">// loop through 2 at a time, as these are pairs of URI and localName</span></span>
<span id="LC826" class="line" lang="java">            <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">nElems</span><span class="o">;</span> <span class="n">i</span> <span class="o">+=</span> <span class="mi">2</span><span class="o">)</span></span>
<span id="LC827" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC828" class="line" lang="java">                <span class="nc">String</span> <span class="n">uri</span> <span class="o">=</span> <span class="o">(</span><span class="nc">String</span><span class="o">)</span> <span class="n">m_cdataSectionElements</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">i</span><span class="o">);</span></span>
<span id="LC829" class="line" lang="java">                <span class="nc">String</span> <span class="n">loc</span> <span class="o">=</span> <span class="o">(</span><span class="nc">String</span><span class="o">)</span> <span class="n">m_cdataSectionElements</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">i</span> <span class="o">+</span> <span class="mi">1</span><span class="o">);</span></span>
<span id="LC830" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="n">loc</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_elementLocalName</span><span class="o">)</span></span>
<span id="LC831" class="line" lang="java">                    <span class="o">&amp;&amp;</span> <span class="n">subPartMatch</span><span class="o">(</span><span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_elementURI</span><span class="o">,</span> <span class="n">uri</span><span class="o">))</span></span>
<span id="LC832" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC833" class="line" lang="java">                    <span class="n">b</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC839" class="line" lang="java">        <span class="k">return</span> <span class="n">b</span><span class="o">;</span></span>
...
<span id="LC843" class="line" lang="java"><span class="cm">     * Tell if two strings are equal, without worry if the first string is null.</span></span>
<span id="LC844" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC845" class="line" lang="java"><span class="cm">     * @param p String reference, which may be null.</span></span>
<span id="LC846" class="line" lang="java"><span class="cm">     * @param t String reference, which may be null.</span></span>
<span id="LC847" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC848" class="line" lang="java"><span class="cm">     * @return true if strings are equal.</span></span>
<span id="LC849" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC850" class="line" lang="java">    <span class="kd">private</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">boolean</span> <span class="nf">subPartMatch</span><span class="o">(</span><span class="nc">String</span> <span class="n">p</span><span class="o">,</span> <span class="nc">String</span> <span class="n">t</span><span class="o">)</span></span>
<span id="LC851" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC852" class="line" lang="java">        <span class="k">return</span> <span class="o">(</span><span class="n">p</span> <span class="o">==</span> <span class="n">t</span><span class="o">)</span> <span class="o">||</span> <span class="o">((</span><span class="kc">null</span> <span class="o">!=</span> <span class="n">p</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="o">(</span><span class="n">p</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">t</span><span class="o">)));</span></span>
...
<span id="LC856" class="line" lang="java"><span class="cm">     * Returns the local name of a qualified name.</span></span>
<span id="LC857" class="line" lang="java"><span class="cm">     * If the name has no prefix,</span></span>
<span id="LC858" class="line" lang="java"><span class="cm">     * then it works as the identity (SAX2).</span></span>
<span id="LC859" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC860" class="line" lang="java"><span class="cm">     * @param qname a qualified name</span></span>
<span id="LC861" class="line" lang="java"><span class="cm">     * @return returns the prefix of the qualified name,</span></span>
<span id="LC862" class="line" lang="java"><span class="cm">     * or null if there is no prefix.</span></span>
<span id="LC863" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC864" class="line" lang="java">    <span class="kd">protected</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">String</span> <span class="nf">getPrefixPart</span><span class="o">(</span><span class="nc">String</span> <span class="n">qname</span><span class="o">)</span></span>
<span id="LC865" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC866" class="line" lang="java">        <span class="kd">final</span> <span class="kt">int</span> <span class="n">col</span> <span class="o">=</span> <span class="n">qname</span><span class="o">.</span><span class="na">indexOf</span><span class="o">(</span><span class="sc">':'</span><span class="o">);</span></span>
<span id="LC867" class="line" lang="java">        <span class="k">return</span> <span class="o">(</span><span class="n">col</span> <span class="o">&gt;</span> <span class="mi">0</span><span class="o">)</span> <span class="o">?</span> <span class="n">qname</span><span class="o">.</span><span class="na">substring</span><span class="o">(</span><span class="mi">0</span><span class="o">,</span> <span class="n">col</span><span class="o">)</span> <span class="o">:</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC868" class="line" lang="java">        <span class="c1">//return (col &gt; 0) ? qname.substring(0,col) : "";</span></span>
...
<span id="LC872" class="line" lang="java"><span class="cm">     * Some users of the serializer may need the current namespace mappings</span></span>
<span id="LC873" class="line" lang="java"><span class="cm">     * @return the current namespace mappings (prefix/uri)</span></span>
<span id="LC874" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#getNamespaceMappings()</span></span>
<span id="LC875" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC876" class="line" lang="java">    <span class="kd">public</span> <span class="nc">NamespaceMappings</span> <span class="nf">getNamespaceMappings</span><span class="o">()</span></span>
<span id="LC877" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC878" class="line" lang="java">        <span class="k">return</span> <span class="n">m_prefixMap</span><span class="o">;</span></span>
...
<span id="LC882" class="line" lang="java"><span class="cm">     * Returns the prefix currently pointing to the given URI (if any).</span></span>
<span id="LC883" class="line" lang="java"><span class="cm">     * @param namespaceURI the uri of the namespace in question</span></span>
<span id="LC884" class="line" lang="java"><span class="cm">     * @return a prefix pointing to the given URI (if any).</span></span>
<span id="LC885" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#getPrefix(String)</span></span>
<span id="LC886" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC887" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPrefix</span><span class="o">(</span><span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">)</span></span>
<span id="LC888" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC889" class="line" lang="java">        <span class="nc">String</span> <span class="n">prefix</span> <span class="o">=</span> <span class="n">m_prefixMap</span><span class="o">.</span><span class="na">lookupPrefix</span><span class="o">(</span><span class="n">namespaceURI</span><span class="o">);</span></span>
<span id="LC890" class="line" lang="java">        <span class="k">return</span> <span class="n">prefix</span><span class="o">;</span></span>
...
<span id="LC894" class="line" lang="java"><span class="cm">     * Returns the URI of an element or attribute. Note that default namespaces</span></span>
<span id="LC895" class="line" lang="java"><span class="cm">     * do not apply directly to attributes.</span></span>
<span id="LC896" class="line" lang="java"><span class="cm">     * @param qname a qualified name</span></span>
<span id="LC897" class="line" lang="java"><span class="cm">     * @param isElement true if the qualified name is the name of</span></span>
<span id="LC898" class="line" lang="java"><span class="cm">     * an element.</span></span>
<span id="LC899" class="line" lang="java"><span class="cm">     * @return returns the namespace URI associated with the qualified name.</span></span>
<span id="LC900" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC901" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getNamespaceURI</span><span class="o">(</span><span class="nc">String</span> <span class="n">qname</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">isElement</span><span class="o">)</span></span>
<span id="LC902" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC903" class="line" lang="java">        <span class="nc">String</span> <span class="n">uri</span> <span class="o">=</span> <span class="no">EMPTYSTRING</span><span class="o">;</span></span>
<span id="LC904" class="line" lang="java">        <span class="kt">int</span> <span class="n">col</span> <span class="o">=</span> <span class="n">qname</span><span class="o">.</span><span class="na">lastIndexOf</span><span class="o">(</span><span class="sc">':'</span><span class="o">);</span></span>
<span id="LC905" class="line" lang="java">        <span class="kd">final</span> <span class="nc">String</span> <span class="n">prefix</span> <span class="o">=</span> <span class="o">(</span><span class="n">col</span> <span class="o">&gt;</span> <span class="mi">0</span><span class="o">)</span> <span class="o">?</span> <span class="n">qname</span><span class="o">.</span><span class="na">substring</span><span class="o">(</span><span class="mi">0</span><span class="o">,</span> <span class="n">col</span><span class="o">)</span> <span class="o">:</span> <span class="no">EMPTYSTRING</span><span class="o">;</span></span>
<span id="LC906" class="line" lang="java"></span>
<span id="LC907" class="line" lang="java">        <span class="k">if</span> <span class="o">(!</span><span class="no">EMPTYSTRING</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="n">prefix</span><span class="o">)</span> <span class="o">||</span> <span class="n">isElement</span><span class="o">)</span></span>
<span id="LC908" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC909" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">m_prefixMap</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC910" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC911" class="line" lang="java">                <span class="n">uri</span> <span class="o">=</span> <span class="n">m_prefixMap</span><span class="o">.</span><span class="na">lookupNamespace</span><span class="o">(</span><span class="n">prefix</span><span class="o">);</span></span>
<span id="LC912" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="n">uri</span> <span class="o">==</span> <span class="kc">null</span> <span class="o">&amp;&amp;</span> <span class="o">!</span><span class="n">prefix</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="no">XMLNS_PREFIX</span><span class="o">))</span></span>
<span id="LC913" class="line" lang="java">                <span class="o">{</span></span>
<span id="LC914" class="line" lang="java">                    <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span></span>
<span id="LC915" class="line" lang="java">                        <span class="nc">Utils</span><span class="o">.</span><span class="na">messages</span><span class="o">.</span><span class="na">createMessage</span><span class="o">(</span></span>
<span id="LC916" class="line" lang="java">                            <span class="nc">MsgKey</span><span class="o">.</span><span class="na">ER_NAMESPACE_PREFIX</span><span class="o">,</span></span>
<span id="LC917" class="line" lang="java">                            <span class="k">new</span> <span class="nc">Object</span><span class="o">[]</span> <span class="o">{</span> <span class="n">qname</span><span class="o">.</span><span class="na">substring</span><span class="o">(</span><span class="mi">0</span><span class="o">,</span> <span class="n">col</span><span class="o">)</span> <span class="o">}</span>  <span class="o">));</span></span>
...
<span id="LC921" class="line" lang="java">        <span class="k">return</span> <span class="n">uri</span><span class="o">;</span></span>
...
<span id="LC925" class="line" lang="java"><span class="cm">     * Returns the URI of prefix (if any)</span></span>
<span id="LC926" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC927" class="line" lang="java"><span class="cm">         * @param prefix the prefix whose URI is searched for</span></span>
<span id="LC928" class="line" lang="java"><span class="cm">     * @return the namespace URI currently associated with the</span></span>
<span id="LC929" class="line" lang="java"><span class="cm">     * prefix, null if the prefix is undefined.</span></span>
<span id="LC930" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC931" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getNamespaceURIFromPrefix</span><span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">)</span></span>
<span id="LC932" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC933" class="line" lang="java">        <span class="nc">String</span> <span class="n">uri</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC934" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_prefixMap</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC935" class="line" lang="java">            <span class="n">uri</span> <span class="o">=</span> <span class="n">m_prefixMap</span><span class="o">.</span><span class="na">lookupNamespace</span><span class="o">(</span><span class="n">prefix</span><span class="o">);</span></span>
<span id="LC936" class="line" lang="java">        <span class="k">return</span> <span class="n">uri</span><span class="o">;</span></span>
...
<span id="LC940" class="line" lang="java"><span class="cm">     * Entity reference event.</span></span>
<span id="LC941" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC942" class="line" lang="java"><span class="cm">     * @param name Name of entity</span></span>
<span id="LC943" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC944" class="line" lang="java"><span class="cm">     * @throws org.xml.sax.SAXException</span></span>
<span id="LC945" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC946" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">entityReference</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span> <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC947" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC948" class="line" lang="java"></span>
<span id="LC949" class="line" lang="java">        <span class="n">flushPending</span><span class="o">();</span></span>
<span id="LC950" class="line" lang="java"></span>
<span id="LC951" class="line" lang="java">        <span class="n">startEntity</span><span class="o">(</span><span class="n">name</span><span class="o">);</span></span>
<span id="LC952" class="line" lang="java">        <span class="n">endEntity</span><span class="o">(</span><span class="n">name</span><span class="o">);</span></span>
<span id="LC953" class="line" lang="java"></span>
<span id="LC954" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC955" class="line" lang="java">                    <span class="n">fireEntityReference</span><span class="o">(</span><span class="n">name</span><span class="o">);</span></span>
...
<span id="LC959" class="line" lang="java"><span class="cm">     * Sets the transformer associated with this serializer</span></span>
<span id="LC960" class="line" lang="java"><span class="cm">     * @param t the transformer associated with this serializer.</span></span>
<span id="LC961" class="line" lang="java"><span class="cm">     * @see SerializationHandler#setTransformer(Transformer)</span></span>
<span id="LC962" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC963" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setTransformer</span><span class="o">(</span><span class="nc">Transformer</span> <span class="n">t</span><span class="o">)</span></span>
<span id="LC964" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC965" class="line" lang="java">        <span class="n">m_transformer</span> <span class="o">=</span> <span class="n">t</span><span class="o">;</span></span>
<span id="LC966" class="line" lang="java"></span>
<span id="LC967" class="line" lang="java">        <span class="c1">// If this transformer object implements the SerializerTrace interface</span></span>
<span id="LC968" class="line" lang="java">        <span class="c1">// then assign m_tracer to the transformer object so it can be used</span></span>
<span id="LC969" class="line" lang="java">        <span class="c1">// to fire trace events.</span></span>
<span id="LC970" class="line" lang="java">        <span class="k">if</span> <span class="o">((</span><span class="n">m_transformer</span> <span class="k">instanceof</span> <span class="nc">SerializerTrace</span><span class="o">)</span> <span class="o">&amp;&amp;</span></span>
<span id="LC971" class="line" lang="java">            <span class="o">(((</span><span class="nc">SerializerTrace</span><span class="o">)</span> <span class="n">m_transformer</span><span class="o">).</span><span class="na">hasTraceListeners</span><span class="o">()))</span> <span class="o">{</span></span>
<span id="LC972" class="line" lang="java">           <span class="n">m_tracer</span> <span class="o">=</span> <span class="o">(</span><span class="nc">SerializerTrace</span><span class="o">)</span> <span class="n">m_transformer</span><span class="o">;</span></span>
<span id="LC973" class="line" lang="java">        <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC974" class="line" lang="java">           <span class="n">m_tracer</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
...
<span id="LC978" class="line" lang="java"><span class="cm">     * Gets the transformer associated with this serializer</span></span>
<span id="LC979" class="line" lang="java"><span class="cm">     * @return returns the transformer associated with this serializer.</span></span>
<span id="LC980" class="line" lang="java"><span class="cm">     * @see SerializationHandler#getTransformer()</span></span>
<span id="LC981" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC982" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Transformer</span> <span class="nf">getTransformer</span><span class="o">()</span></span>
<span id="LC983" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC984" class="line" lang="java">        <span class="k">return</span> <span class="n">m_transformer</span><span class="o">;</span></span>
...
<span id="LC988" class="line" lang="java"><span class="cm">     * This method gets the nodes value as a String and uses that String as if</span></span>
<span id="LC989" class="line" lang="java"><span class="cm">     * it were an input character notification.</span></span>
<span id="LC990" class="line" lang="java"><span class="cm">     * @param node the Node to serialize</span></span>
<span id="LC991" class="line" lang="java"><span class="cm">     * @throws org.xml.sax.SAXException</span></span>
<span id="LC992" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC993" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">characters</span><span class="o">(</span><span class="n">org</span><span class="o">.</span><span class="na">w3c</span><span class="o">.</span><span class="na">dom</span><span class="o">.</span><span class="na">Node</span> <span class="n">node</span><span class="o">)</span></span>
<span id="LC994" class="line" lang="java">        <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC995" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC996" class="line" lang="java">        <span class="n">flushPending</span><span class="o">();</span></span>
<span id="LC997" class="line" lang="java">        <span class="nc">String</span> <span class="n">data</span> <span class="o">=</span> <span class="n">node</span><span class="o">.</span><span class="na">getNodeValue</span><span class="o">();</span></span>
<span id="LC998" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">data</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC999" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1000" class="line" lang="java">            <span class="kd">final</span> <span class="kt">int</span> <span class="n">length</span> <span class="o">=</span> <span class="n">data</span><span class="o">.</span><span class="na">length</span><span class="o">();</span></span>
<span id="LC1001" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">length</span> <span class="o">&gt;</span> <span class="n">m_charsBuff</span><span class="o">.</span><span class="na">length</span><span class="o">)</span></span>
<span id="LC1002" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC1003" class="line" lang="java">                <span class="n">m_charsBuff</span> <span class="o">=</span> <span class="k">new</span> <span class="kt">char</span><span class="o">[</span><span class="n">length</span> <span class="o">*</span> <span class="mi">2</span> <span class="o">+</span> <span class="mi">1</span><span class="o">];</span></span>
<span id="LC1004" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC1005" class="line" lang="java">            <span class="n">data</span><span class="o">.</span><span class="na">getChars</span><span class="o">(</span><span class="mi">0</span><span class="o">,</span> <span class="n">length</span><span class="o">,</span> <span class="n">m_charsBuff</span><span class="o">,</span> <span class="mi">0</span><span class="o">);</span></span>
<span id="LC1006" class="line" lang="java">            <span class="n">characters</span><span class="o">(</span><span class="n">m_charsBuff</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="n">length</span><span class="o">);</span></span>
...
<span id="LC1012" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ErrorHandler#error(SAXParseException)</span></span>
<span id="LC1013" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1014" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">error</span><span class="o">(</span><span class="nc">SAXParseException</span> <span class="n">exc</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span> <span class="o">{</span></span>
...
<span id="LC1018" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ErrorHandler#fatalError(SAXParseException)</span></span>
<span id="LC1019" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1020" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">fatalError</span><span class="o">(</span><span class="nc">SAXParseException</span> <span class="n">exc</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span> <span class="o">{</span></span>
<span id="LC1021" class="line" lang="java"></span>
<span id="LC1022" class="line" lang="java">      <span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_startTagOpen</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC1027" class="line" lang="java"><span class="cm">     * @see org.xml.sax.ErrorHandler#warning(SAXParseException)</span></span>
<span id="LC1028" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1029" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">warning</span><span class="o">(</span><span class="nc">SAXParseException</span> <span class="n">exc</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
...
<span id="LC1034" class="line" lang="java"><span class="cm">     * To fire off start entity trace event</span></span>
<span id="LC1035" class="line" lang="java"><span class="cm">     * @param name Name of entity</span></span>
<span id="LC1036" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1037" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">fireStartEntity</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span></span>
<span id="LC1038" class="line" lang="java">        <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC1039" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1040" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1041" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1042" class="line" lang="java">            <span class="n">flushMyWriter</span><span class="o">();</span></span>
<span id="LC1043" class="line" lang="java">            <span class="n">m_tracer</span><span class="o">.</span><span class="na">fireGenerateEvent</span><span class="o">(</span><span class="nc">SerializerTrace</span><span class="o">.</span><span class="na">EVENTTYPE_ENTITYREF</span><span class="o">,</span> <span class="n">name</span><span class="o">);</span></span>
...
<span id="LC1048" class="line" lang="java"><span class="cm">     * Report the characters event</span></span>
<span id="LC1049" class="line" lang="java"><span class="cm">     * @param chars  content of characters</span></span>
<span id="LC1050" class="line" lang="java"><span class="cm">     * @param start  starting index of characters to output</span></span>
<span id="LC1051" class="line" lang="java"><span class="cm">     * @param length  number of characters to output</span></span>
<span id="LC1052" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1053" class="line" lang="java"><span class="c1">//    protected void fireCharEvent(char[] chars, int start, int length)</span></span>
<span id="LC1054" class="line" lang="java"><span class="c1">//        throws org.xml.sax.SAXException</span></span>
<span id="LC1055" class="line" lang="java"><span class="c1">//    {</span></span>
<span id="LC1056" class="line" lang="java"><span class="c1">//        if (m_tracer != null)</span></span>
<span id="LC1057" class="line" lang="java"><span class="c1">//            m_tracer.fireGenerateEvent(SerializerTrace.EVENTTYPE_CHARACTERS, chars, start,length);</span></span>
<span id="LC1058" class="line" lang="java"><span class="c1">//    }</span></span>
<span id="LC1059" class="line" lang="java"><span class="c1">//</span></span>
<span id="LC1060" class="line" lang="java"></span>
<span id="LC1061" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1062" class="line" lang="java"><span class="cm">     * This method is only used internally when flushing the writer from the</span></span>
<span id="LC1063" class="line" lang="java"><span class="cm">     * various fire...() trace events.  Due to the writer being wrapped with</span></span>
<span id="LC1064" class="line" lang="java"><span class="cm">     * SerializerTraceWriter it may cause the flush of these trace events:</span></span>
<span id="LC1065" class="line" lang="java"><span class="cm">     * EVENTTYPE_OUTPUT_PSEUDO_CHARACTERS</span></span>
<span id="LC1066" class="line" lang="java"><span class="cm">     * EVENTTYPE_OUTPUT_CHARACTERS</span></span>
<span id="LC1067" class="line" lang="java"><span class="cm">     * which trace the output written to the output stream.</span></span>
<span id="LC1068" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1069" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1070" class="line" lang="java">    <span class="kd">private</span> <span class="kt">void</span> <span class="nf">flushMyWriter</span><span class="o">()</span></span>
<span id="LC1071" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1072" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_writer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1073" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1074" class="line" lang="java">            <span class="k">try</span></span>
<span id="LC1075" class="line" lang="java">            <span class="o">{</span></span>
<span id="LC1076" class="line" lang="java">                <span class="n">m_writer</span><span class="o">.</span><span class="na">flush</span><span class="o">();</span></span>
<span id="LC1077" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC1078" class="line" lang="java">            <span class="k">catch</span><span class="o">(</span><span class="nc">IOException</span> <span class="n">ioe</span><span class="o">)</span></span>
...
<span id="LC1085" class="line" lang="java"><span class="cm">     * Report the CDATA trace event</span></span>
<span id="LC1086" class="line" lang="java"><span class="cm">     * @param chars  content of CDATA</span></span>
<span id="LC1087" class="line" lang="java"><span class="cm">     * @param start  starting index of characters to output</span></span>
<span id="LC1088" class="line" lang="java"><span class="cm">     * @param length  number of characters to output</span></span>
<span id="LC1089" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1090" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">fireCDATAEvent</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">chars</span><span class="o">,</span> <span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span></span>
<span id="LC1091" class="line" lang="java">        <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC1092" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1093" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1094" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1095" class="line" lang="java">            <span class="n">flushMyWriter</span><span class="o">();</span></span>
<span id="LC1096" class="line" lang="java">                        <span class="n">m_tracer</span><span class="o">.</span><span class="na">fireGenerateEvent</span><span class="o">(</span><span class="nc">SerializerTrace</span><span class="o">.</span><span class="na">EVENTTYPE_CDATA</span><span class="o">,</span> <span class="n">chars</span><span class="o">,</span> <span class="n">start</span><span class="o">,</span><span class="n">length</span><span class="o">);</span></span>
...
<span id="LC1101" class="line" lang="java"><span class="cm">     * Report the comment trace event</span></span>
<span id="LC1102" class="line" lang="java"><span class="cm">     * @param chars  content of comment</span></span>
<span id="LC1103" class="line" lang="java"><span class="cm">     * @param start  starting index of comment to output</span></span>
<span id="LC1104" class="line" lang="java"><span class="cm">     * @param length  number of characters to output</span></span>
<span id="LC1105" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1106" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">fireCommentEvent</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">chars</span><span class="o">,</span> <span class="kt">int</span> <span class="n">start</span><span class="o">,</span> <span class="kt">int</span> <span class="n">length</span><span class="o">)</span></span>
<span id="LC1107" class="line" lang="java">        <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC1108" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1109" class="line" lang="java">                <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1110" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1111" class="line" lang="java">            <span class="n">flushMyWriter</span><span class="o">();</span></span>
<span id="LC1112" class="line" lang="java">                        <span class="n">m_tracer</span><span class="o">.</span><span class="na">fireGenerateEvent</span><span class="o">(</span><span class="nc">SerializerTrace</span><span class="o">.</span><span class="na">EVENTTYPE_COMMENT</span><span class="o">,</span> <span class="k">new</span> <span class="nc">String</span><span class="o">(</span><span class="n">chars</span><span class="o">,</span> <span class="n">start</span><span class="o">,</span> <span class="n">length</span><span class="o">));</span></span>
...
<span id="LC1118" class="line" lang="java"><span class="cm">     * To fire off end entity trace event</span></span>
<span id="LC1119" class="line" lang="java"><span class="cm">     * @param name Name of entity</span></span>
<span id="LC1120" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1121" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">fireEndEntity</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span></span>
<span id="LC1122" class="line" lang="java">        <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC1123" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1124" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1125" class="line" lang="java">            <span class="n">flushMyWriter</span><span class="o">();</span></span>
<span id="LC1126" class="line" lang="java">        <span class="c1">// we do not need to handle this.</span></span>
...
<span id="LC1130" class="line" lang="java"><span class="cm">     * To fire off start document trace  event</span></span>
<span id="LC1131" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1132" class="line" lang="java">     <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">fireStartDoc</span><span class="o">()</span></span>
<span id="LC1133" class="line" lang="java">        <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC1134" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1135" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1136" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1137" class="line" lang="java">            <span class="n">flushMyWriter</span><span class="o">();</span></span>
<span id="LC1138" class="line" lang="java">            <span class="n">m_tracer</span><span class="o">.</span><span class="na">fireGenerateEvent</span><span class="o">(</span><span class="nc">SerializerTrace</span><span class="o">.</span><span class="na">EVENTTYPE_STARTDOCUMENT</span><span class="o">);</span></span>
...
<span id="LC1144" class="line" lang="java"><span class="cm">     * To fire off end document trace event</span></span>
<span id="LC1145" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1146" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">fireEndDoc</span><span class="o">()</span></span>
<span id="LC1147" class="line" lang="java">        <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC1148" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1149" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1150" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1151" class="line" lang="java">            <span class="n">flushMyWriter</span><span class="o">();</span></span>
<span id="LC1152" class="line" lang="java">            <span class="n">m_tracer</span><span class="o">.</span><span class="na">fireGenerateEvent</span><span class="o">(</span><span class="nc">SerializerTrace</span><span class="o">.</span><span class="na">EVENTTYPE_ENDDOCUMENT</span><span class="o">);</span></span>
...
<span id="LC1157" class="line" lang="java"><span class="cm">     * Report the start element trace event. This trace method needs to be</span></span>
<span id="LC1158" class="line" lang="java"><span class="cm">     * called just before the attributes are cleared.</span></span>
<span id="LC1159" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1160" class="line" lang="java"><span class="cm">     * @param elemName the qualified name of the element</span></span>
<span id="LC1161" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1162" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1163" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">fireStartElem</span><span class="o">(</span><span class="nc">String</span> <span class="n">elemName</span><span class="o">)</span></span>
<span id="LC1164" class="line" lang="java">        <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC1165" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1166" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1167" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1168" class="line" lang="java">            <span class="n">flushMyWriter</span><span class="o">();</span></span>
<span id="LC1169" class="line" lang="java">            <span class="n">m_tracer</span><span class="o">.</span><span class="na">fireGenerateEvent</span><span class="o">(</span><span class="nc">SerializerTrace</span><span class="o">.</span><span class="na">EVENTTYPE_STARTELEMENT</span><span class="o">,</span></span>
<span id="LC1170" class="line" lang="java">                <span class="n">elemName</span><span class="o">,</span> <span class="n">m_attributes</span><span class="o">);</span></span>
...
<span id="LC1176" class="line" lang="java"><span class="cm">     * To fire off the end element event</span></span>
<span id="LC1177" class="line" lang="java"><span class="cm">     * @param name Name of element</span></span>
<span id="LC1178" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1179" class="line" lang="java"><span class="c1">//    protected void fireEndElem(String name)</span></span>
<span id="LC1180" class="line" lang="java"><span class="c1">//        throws org.xml.sax.SAXException</span></span>
<span id="LC1181" class="line" lang="java"><span class="c1">//    {</span></span>
<span id="LC1182" class="line" lang="java"><span class="c1">//        if (m_tracer != null)</span></span>
<span id="LC1183" class="line" lang="java"><span class="c1">//            m_tracer.fireGenerateEvent(SerializerTrace.EVENTTYPE_ENDELEMENT,name, (Attributes)null);</span></span>
...
<span id="LC1188" class="line" lang="java"><span class="cm">     * To fire off the PI trace event</span></span>
<span id="LC1189" class="line" lang="java"><span class="cm">     * @param name Name of PI</span></span>
<span id="LC1190" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1191" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">fireEscapingEvent</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="nc">String</span> <span class="n">data</span><span class="o">)</span></span>
<span id="LC1192" class="line" lang="java">        <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC1193" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1194" class="line" lang="java"></span>
<span id="LC1195" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1196" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1197" class="line" lang="java">            <span class="n">flushMyWriter</span><span class="o">();</span></span>
<span id="LC1198" class="line" lang="java">            <span class="n">m_tracer</span><span class="o">.</span><span class="na">fireGenerateEvent</span><span class="o">(</span><span class="nc">SerializerTrace</span><span class="o">.</span><span class="na">EVENTTYPE_PI</span><span class="o">,</span><span class="n">name</span><span class="o">,</span> <span class="n">data</span><span class="o">);</span></span>
...
<span id="LC1204" class="line" lang="java"><span class="cm">     * To fire off the entity reference trace event</span></span>
<span id="LC1205" class="line" lang="java"><span class="cm">     * @param name Name of entity reference</span></span>
<span id="LC1206" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1207" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">fireEntityReference</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">)</span></span>
<span id="LC1208" class="line" lang="java">        <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC1209" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1210" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1211" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1212" class="line" lang="java">            <span class="n">flushMyWriter</span><span class="o">();</span></span>
<span id="LC1213" class="line" lang="java">            <span class="n">m_tracer</span><span class="o">.</span><span class="na">fireGenerateEvent</span><span class="o">(</span><span class="nc">SerializerTrace</span><span class="o">.</span><span class="na">EVENTTYPE_ENTITYREF</span><span class="o">,</span><span class="n">name</span><span class="o">,</span> <span class="o">(</span><span class="nc">Attributes</span><span class="o">)</span><span class="kc">null</span><span class="o">);</span></span>
...
<span id="LC1218" class="line" lang="java"><span class="cm">     * Receive notification of the beginning of a document.</span></span>
<span id="LC1219" class="line" lang="java"><span class="cm">     * This method is never a self generated call,</span></span>
<span id="LC1220" class="line" lang="java"><span class="cm">     * but only called externally.</span></span>
<span id="LC1221" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1222" class="line" lang="java"><span class="cm">     * &lt;p&gt;The SAX parser will invoke this method only once, before any</span></span>
<span id="LC1223" class="line" lang="java"><span class="cm">     * other methods in this interface or in DTDHandler (except for</span></span>
<span id="LC1224" class="line" lang="java"><span class="cm">     * setDocumentLocator).&lt;/p&gt;</span></span>
<span id="LC1225" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1226" class="line" lang="java"><span class="cm">     * @throws org.xml.sax.SAXException Any SAX exception, possibly</span></span>
<span id="LC1227" class="line" lang="java"><span class="cm">     *            wrapping another exception.</span></span>
...
<span id="LC1231" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startDocument</span><span class="o">()</span> <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC1232" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1233" class="line" lang="java"></span>
<span id="LC1234" class="line" lang="java">        <span class="c1">// if we do get called with startDocument(), handle it right away</span></span>
<span id="LC1235" class="line" lang="java">        <span class="n">startDocumentInternal</span><span class="o">();</span></span>
<span id="LC1236" class="line" lang="java">        <span class="n">m_needToCallStartDocument</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC1241" class="line" lang="java"><span class="cm">     * This method handles what needs to be done at a startDocument() call,</span></span>
<span id="LC1242" class="line" lang="java"><span class="cm">     * whether from an external caller, or internally called in the</span></span>
<span id="LC1243" class="line" lang="java"><span class="cm">     * serializer.  For historical reasons the serializer is flexible to</span></span>
<span id="LC1244" class="line" lang="java"><span class="cm">     * startDocument() not always being called.</span></span>
<span id="LC1245" class="line" lang="java"><span class="cm">     * Even if no external call is</span></span>
<span id="LC1246" class="line" lang="java"><span class="cm">     * made into startDocument() this method will always be called as a self</span></span>
<span id="LC1247" class="line" lang="java"><span class="cm">     * generated internal startDocument, it handles what needs to be done at a</span></span>
<span id="LC1248" class="line" lang="java"><span class="cm">     * startDocument() call.</span></span>
<span id="LC1249" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1250" class="line" lang="java"><span class="cm">     * This method exists just to make sure that startDocument() is only ever</span></span>
<span id="LC1251" class="line" lang="java"><span class="cm">     * called from an external caller, which in principle is just a matter of</span></span>
<span id="LC1252" class="line" lang="java"><span class="cm">     * style.</span></span>
<span id="LC1253" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1254" class="line" lang="java"><span class="cm">     * @throws SAXException</span></span>
<span id="LC1255" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1256" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">startDocumentInternal</span><span class="o">()</span> <span class="kd">throws</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC1257" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1258" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_tracer</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1259" class="line" lang="java">            <span class="k">this</span><span class="o">.</span><span class="na">fireStartDoc</span><span class="o">();</span></span>
...
<span id="LC1263" class="line" lang="java">    <span class="cm">/* This method extracts version and encoding information from SAX events.</span></span>
<span id="LC1264" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1265" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">setDocumentInfo</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC1266" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_locator</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1267" class="line" lang="java">                <span class="k">return</span><span class="o">;</span></span>
<span id="LC1268" class="line" lang="java">        <span class="k">try</span><span class="o">{</span></span>
<span id="LC1269" class="line" lang="java">            <span class="nc">String</span> <span class="n">strVersion</span> <span class="o">=</span> <span class="o">((</span><span class="nc">Locator2</span><span class="o">)</span><span class="n">m_locator</span><span class="o">).</span><span class="na">getXMLVersion</span><span class="o">();</span></span>
<span id="LC1270" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">strVersion</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1271" class="line" lang="java">                <span class="n">setVersion</span><span class="o">(</span><span class="n">strVersion</span><span class="o">);</span></span>
<span id="LC1272" class="line" lang="java">            <span class="cm">/*String strEncoding = ((Locator2)m_locator).getEncoding();</span></span>
<span id="LC1273" class="line" lang="java"><span class="cm">            if (strEncoding != null)</span></span>
<span id="LC1274" class="line" lang="java"><span class="cm">                setEncoding(strEncoding); */</span></span>
<span id="LC1275" class="line" lang="java"></span>
<span id="LC1276" class="line" lang="java">        <span class="o">}</span><span class="k">catch</span><span class="o">(</span><span class="nc">ClassCastException</span> <span class="n">e</span><span class="o">){}</span></span>
...
<span id="LC1280" class="line" lang="java"><span class="cm">     * This method is used to set the source locator, which might be used to</span></span>
<span id="LC1281" class="line" lang="java"><span class="cm">     * generated an error message.</span></span>
<span id="LC1282" class="line" lang="java"><span class="cm">     * @param locator the source locator</span></span>
<span id="LC1283" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1284" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#setSourceLocator(javax.xml.transform.SourceLocator)</span></span>
<span id="LC1285" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1286" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSourceLocator</span><span class="o">(</span><span class="nc">SourceLocator</span> <span class="n">locator</span><span class="o">)</span></span>
<span id="LC1287" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1288" class="line" lang="java">        <span class="n">m_sourceLocator</span> <span class="o">=</span> <span class="n">locator</span><span class="o">;</span></span>
...
<span id="LC1293" class="line" lang="java"><span class="cm">     * Used only by TransformerSnapshotImpl to restore the serialization</span></span>
<span id="LC1294" class="line" lang="java"><span class="cm">     * to a previous state.</span></span>
<span id="LC1295" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1296" class="line" lang="java"><span class="cm">     * @param mappings NamespaceMappings</span></span>
<span id="LC1297" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1298" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setNamespaceMappings</span><span class="o">(</span><span class="nc">NamespaceMappings</span> <span class="n">mappings</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1299" class="line" lang="java">        <span class="n">m_prefixMap</span> <span class="o">=</span> <span class="n">mappings</span><span class="o">;</span></span>
<span id="LC1300" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC1301" class="line" lang="java"></span>
<span id="LC1302" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">reset</span><span class="o">()</span></span>
<span id="LC1303" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1304" class="line" lang="java">        <span class="n">resetSerializerBase</span><span class="o">();</span></span>
<span id="LC1305" class="line" lang="java">        <span class="k">return</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC1309" class="line" lang="java"><span class="cm">     * Reset all of the fields owned by SerializerBase</span></span>
<span id="LC1310" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1311" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1312" class="line" lang="java">    <span class="kd">private</span> <span class="kt">void</span> <span class="nf">resetSerializerBase</span><span class="o">()</span></span>
<span id="LC1313" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1314" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_attributes</span><span class="o">.</span><span class="na">clear</span><span class="o">();</span></span>
<span id="LC1315" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_cdataSectionElements</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1316" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_elemContext</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">ElemContext</span><span class="o">();</span></span>
<span id="LC1317" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_doctypePublic</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1318" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_doctypeSystem</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1319" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_doIndent</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1320" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_encoding</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1321" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_indentAmount</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC1322" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_inEntityRef</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1323" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_inExternalDTD</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1324" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_mediatype</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1325" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_needToCallStartDocument</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC1326" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_needToOutputDocTypeDecl</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1327" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="k">this</span><span class="o">.</span><span class="na">m_prefixMap</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC1328" class="line" lang="java">            <span class="k">this</span><span class="o">.</span><span class="na">m_prefixMap</span><span class="o">.</span><span class="na">reset</span><span class="o">();</span></span>
<span id="LC1329" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_shouldNotWriteXMLHeader</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1330" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_sourceLocator</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1331" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_standalone</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1332" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_standaloneWasSpecified</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC1333" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_tracer</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1334" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_transformer</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1335" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">m_version</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC1336" class="line" lang="java">        <span class="c1">// don't set writer to null, so that it might be re-used</span></span>
<span id="LC1337" class="line" lang="java">        <span class="c1">//this.m_writer = null;</span></span>
...
<span id="LC1341" class="line" lang="java"><span class="cm">     * Returns true if the serializer is used for temporary output rather than</span></span>
<span id="LC1342" class="line" lang="java"><span class="cm">     * final output.</span></span>
<span id="LC1343" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1344" class="line" lang="java"><span class="cm">     * This concept is made clear in the XSLT 2.0 draft.</span></span>
<span id="LC1345" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1346" class="line" lang="java">    <span class="kd">final</span> <span class="kt">boolean</span> <span class="nf">inTemporaryOutputState</span><span class="o">()</span></span>
<span id="LC1347" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1348" class="line" lang="java">        <span class="cm">/* This is a hack. We should really be letting the serializer know</span></span>
<span id="LC1349" class="line" lang="java"><span class="cm">         * that it is in temporary output state with an explicit call, but</span></span>
<span id="LC1350" class="line" lang="java"><span class="cm">         * from a pragmatic point of view (for now anyways) having no output</span></span>
<span id="LC1351" class="line" lang="java"><span class="cm">         * encoding at all, not even the default UTF-8 indicates that the serializer</span></span>
<span id="LC1352" class="line" lang="java"><span class="cm">         * is being used for temporary RTF.</span></span>
<span id="LC1353" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC1354" class="line" lang="java">        <span class="k">return</span> <span class="o">(</span><span class="n">getEncoding</span><span class="o">()</span> <span class="o">==</span> <span class="kc">null</span><span class="o">);</span></span>
...
<span id="LC1359" class="line" lang="java"><span class="cm">     * This method adds an attribute the the current element,</span></span>
<span id="LC1360" class="line" lang="java"><span class="cm">     * but should not be used for an xsl:attribute child.</span></span>
<span id="LC1361" class="line" lang="java"><span class="cm">     * @see ExtendedContentHandler#addAttribute(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)</span></span>
<span id="LC1362" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1363" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addAttribute</span><span class="o">(</span><span class="nc">String</span> <span class="n">uri</span><span class="o">,</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">,</span> <span class="nc">String</span> <span class="n">rawName</span><span class="o">,</span> <span class="nc">String</span> <span class="n">type</span><span class="o">,</span> <span class="nc">String</span> <span class="n">value</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">SAXException</span></span>
<span id="LC1364" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1365" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_elemContext</span><span class="o">.</span><span class="na">m_startTagOpen</span><span class="o">)</span></span>
<span id="LC1366" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC1367" class="line" lang="java">            <span class="n">addAttributeAlways</span><span class="o">(</span><span class="n">uri</span><span class="o">,</span> <span class="n">localName</span><span class="o">,</span> <span class="n">rawName</span><span class="o">,</span> <span class="n">type</span><span class="o">,</span> <span class="n">value</span><span class="o">,</span> <span class="kc">false</span><span class="o">);</span></span>
...
<span id="LC1372" class="line" lang="java"><span class="cm">     * @see org.xml.sax.DTDHandler#notationDecl(java.lang.String, java.lang.String, java.lang.String)</span></span>
<span id="LC1373" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1374" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">notationDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg1</span><span class="o">,</span> <span class="nc">String</span> <span class="n">arg2</span><span class="o">)</span></span>
<span id="LC1375" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span> <span class="o">{</span></span>
<span id="LC1376" class="line" lang="java">        <span class="c1">// This method just provides a definition to satisfy the interface</span></span>
<span id="LC1377" class="line" lang="java">        <span class="c1">// A particular sub-class of SerializerBase provides the implementation (if desired)</span></span>
...
<span id="LC1381" class="line" lang="java"><span class="cm">     * @see org.xml.sax.DTDHandler#unparsedEntityDecl(java.lang.String, java.lang.String, java.lang.String, java.lang.String)</span></span>
<span id="LC1382" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1383" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">unparsedEntityDecl</span><span class="o">(</span></span>
<span id="LC1384" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg0</span><span class="o">,</span></span>
<span id="LC1385" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg1</span><span class="o">,</span></span>
<span id="LC1386" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg2</span><span class="o">,</span></span>
<span id="LC1387" class="line" lang="java">        <span class="nc">String</span> <span class="n">arg3</span><span class="o">)</span></span>
<span id="LC1388" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">SAXException</span> <span class="o">{</span></span>
<span id="LC1389" class="line" lang="java">        <span class="c1">// This method just provides a definition to satisfy the interface</span></span>
<span id="LC1390" class="line" lang="java">        <span class="c1">// A particular sub-class of SerializerBase provides the implementation (if desired)</span></span>
...
<span id="LC1394" class="line" lang="java"><span class="cm">     * If set to false the serializer does not expand DTD entities,</span></span>
<span id="LC1395" class="line" lang="java"><span class="cm">     * but leaves them as is, the default value is true.</span></span>
<span id="LC1396" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1397" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDTDEntityExpansion</span><span class="o">(</span><span class="kt">boolean</span> <span class="n">expand</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC1398" class="line" lang="java">        <span class="c1">// This method just provides a definition to satisfy the interface</span></span>
<span id="LC1399" class="line" lang="java">        <span class="c1">// A particular sub-class of SerializerBase provides the implementation (if desired)</span></span>
