...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: DTMDefaultBaseTraversers.java,v 1.2.4.1 2005/09/15 08:15:00 suresh_emailid Exp $</span></span>
...
<span id="LC38" class="line" lang="java"><span class="cm"> * PLEASE NOTE that the public interface for all traversers should be</span></span>
<span id="LC39" class="line" lang="java"><span class="cm"> * in terms of DTM Node Handles... but they may use the internal node</span></span>
<span id="LC40" class="line" lang="java"><span class="cm"> * identity indices within their logic, for efficiency's sake. Be very</span></span>
<span id="LC41" class="line" lang="java"><span class="cm"> * careful to avoid confusing these when maintaining this code.</span></span>
<span id="LC42" class="line" lang="java"><span class="cm"> * */</span></span>
<span id="LC43" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">DTMDefaultBaseTraversers</span> <span class="kd">extends</span> <span class="nc">DTMDefaultBase</span></span>
...
<span id="LC47" class="line" lang="java"><span class="cm">   * Construct a DTMDefaultBaseTraversers object from a DOM node.</span></span>
<span id="LC48" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC49" class="line" lang="java"><span class="cm">   * @param mgr The DTMManager who owns this DTM.</span></span>
<span id="LC50" class="line" lang="java"><span class="cm">   * @param source The object that is used to specify the construction source.</span></span>
<span id="LC51" class="line" lang="java"><span class="cm">   * @param dtmIdentity The DTM identity ID for this DTM.</span></span>
<span id="LC52" class="line" lang="java"><span class="cm">   * @param whiteSpaceFilter The white space filter for this DTM, which may</span></span>
<span id="LC53" class="line" lang="java"><span class="cm">   *                         be null.</span></span>
<span id="LC54" class="line" lang="java"><span class="cm">   * @param xstringfactory The factory to use for creating XMLStrings.</span></span>
<span id="LC55" class="line" lang="java"><span class="cm">   * @param doIndexing true if the caller considers it worth it to use</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">   *                   indexing schemes.</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC58" class="line" lang="java">  <span class="kd">public</span> <span class="nf">DTMDefaultBaseTraversers</span><span class="o">(</span><span class="nc">DTMManager</span> <span class="n">mgr</span><span class="o">,</span> <span class="nc">Source</span> <span class="n">source</span><span class="o">,</span></span>
<span id="LC59" class="line" lang="java">                                  <span class="kt">int</span> <span class="n">dtmIdentity</span><span class="o">,</span></span>
<span id="LC60" class="line" lang="java">                                  <span class="nc">DTMWSFilter</span> <span class="n">whiteSpaceFilter</span><span class="o">,</span></span>
<span id="LC61" class="line" lang="java">                                  <span class="nc">XMLStringFactory</span> <span class="n">xstringfactory</span><span class="o">,</span></span>
<span id="LC62" class="line" lang="java">                                  <span class="kt">boolean</span> <span class="n">doIndexing</span><span class="o">)</span></span>
<span id="LC63" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC64" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">mgr</span><span class="o">,</span> <span class="n">source</span><span class="o">,</span> <span class="n">dtmIdentity</span><span class="o">,</span> <span class="n">whiteSpaceFilter</span><span class="o">,</span> <span class="n">xstringfactory</span><span class="o">,</span></span>
<span id="LC65" class="line" lang="java">          <span class="n">doIndexing</span><span class="o">);</span></span>
...
<span id="LC69" class="line" lang="java"><span class="cm">   * Construct a DTMDefaultBaseTraversers object from a DOM node.</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC71" class="line" lang="java"><span class="cm">   * @param mgr The DTMManager who owns this DTM.</span></span>
<span id="LC72" class="line" lang="java"><span class="cm">   * @param source The object that is used to specify the construction source.</span></span>
<span id="LC73" class="line" lang="java"><span class="cm">   * @param dtmIdentity The DTM identity ID for this DTM.</span></span>
<span id="LC74" class="line" lang="java"><span class="cm">   * @param whiteSpaceFilter The white space filter for this DTM, which may</span></span>
<span id="LC75" class="line" lang="java"><span class="cm">   *                         be null.</span></span>
<span id="LC76" class="line" lang="java"><span class="cm">   * @param xstringfactory The factory to use for creating XMLStrings.</span></span>
<span id="LC77" class="line" lang="java"><span class="cm">   * @param doIndexing true if the caller considers it worth it to use</span></span>
<span id="LC78" class="line" lang="java"><span class="cm">   *                   indexing schemes.</span></span>
<span id="LC79" class="line" lang="java"><span class="cm">   * @param blocksize The block size of the DTM.</span></span>
<span id="LC80" class="line" lang="java"><span class="cm">   * @param usePrevsib true if we want to build the previous sibling node array.</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">   * @param newNameTable true if we want to use a new ExpandedNameTable for this DTM.</span></span>
<span id="LC82" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC83" class="line" lang="java">  <span class="kd">public</span> <span class="nf">DTMDefaultBaseTraversers</span><span class="o">(</span><span class="nc">DTMManager</span> <span class="n">mgr</span><span class="o">,</span> <span class="nc">Source</span> <span class="n">source</span><span class="o">,</span></span>
<span id="LC84" class="line" lang="java">                                  <span class="kt">int</span> <span class="n">dtmIdentity</span><span class="o">,</span></span>
<span id="LC85" class="line" lang="java">                                  <span class="nc">DTMWSFilter</span> <span class="n">whiteSpaceFilter</span><span class="o">,</span></span>
<span id="LC86" class="line" lang="java">                                  <span class="nc">XMLStringFactory</span> <span class="n">xstringfactory</span><span class="o">,</span></span>
<span id="LC87" class="line" lang="java">                                  <span class="kt">boolean</span> <span class="n">doIndexing</span><span class="o">,</span></span>
<span id="LC88" class="line" lang="java">                                  <span class="kt">int</span> <span class="n">blocksize</span><span class="o">,</span></span>
<span id="LC89" class="line" lang="java">                                  <span class="kt">boolean</span> <span class="n">usePrevsib</span><span class="o">,</span></span>
<span id="LC90" class="line" lang="java">                                  <span class="kt">boolean</span> <span class="n">newNameTable</span><span class="o">)</span></span>
<span id="LC91" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC92" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">mgr</span><span class="o">,</span> <span class="n">source</span><span class="o">,</span> <span class="n">dtmIdentity</span><span class="o">,</span> <span class="n">whiteSpaceFilter</span><span class="o">,</span> <span class="n">xstringfactory</span><span class="o">,</span></span>
<span id="LC93" class="line" lang="java">          <span class="n">doIndexing</span><span class="o">,</span> <span class="n">blocksize</span><span class="o">,</span> <span class="n">usePrevsib</span><span class="o">,</span> <span class="n">newNameTable</span><span class="o">);</span></span>
...
<span id="LC97" class="line" lang="java"><span class="cm">   * This returns a stateless "traverser", that can navigate</span></span>
<span id="LC98" class="line" lang="java"><span class="cm">   * over an XPath axis, though perhaps not in document order.</span></span>
<span id="LC99" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC100" class="line" lang="java"><span class="cm">   * @param axis One of Axes.ANCESTORORSELF, etc.</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">   * @return A DTMAxisTraverser, or null if the given axis isn't supported.</span></span>
<span id="LC103" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC104" class="line" lang="java">  <span class="kd">public</span> <span class="nc">DTMAxisTraverser</span> <span class="nf">getAxisTraverser</span><span class="o">(</span><span class="kd">final</span> <span class="kt">int</span> <span class="n">axis</span><span class="o">)</span></span>
<span id="LC105" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC106" class="line" lang="java"></span>
<span id="LC107" class="line" lang="java">    <span class="nc">DTMAxisTraverser</span> <span class="n">traverser</span><span class="o">;</span></span>
<span id="LC108" class="line" lang="java"></span>
<span id="LC109" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">m_traversers</span><span class="o">)</span>  <span class="c1">// Cache of stateless traversers for this DTM</span></span>
<span id="LC110" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC111" class="line" lang="java">      <span class="n">m_traversers</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DTMAxisTraverser</span><span class="o">[</span><span class="nc">Axis</span><span class="o">.</span><span class="na">getNamesLength</span><span class="o">()];</span></span>
<span id="LC112" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC113" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC114" class="line" lang="java">    <span class="k">else</span></span>
<span id="LC115" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC116" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="n">m_traversers</span><span class="o">[</span><span class="n">axis</span><span class="o">];</span>  <span class="c1">// Share/reuse existing traverser</span></span>
<span id="LC117" class="line" lang="java"></span>
<span id="LC118" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">traverser</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC119" class="line" lang="java">        <span class="k">return</span> <span class="n">traverser</span><span class="o">;</span></span>
<span id="LC120" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC121" class="line" lang="java"></span>
<span id="LC122" class="line" lang="java">    <span class="k">switch</span> <span class="o">(</span><span class="n">axis</span><span class="o">)</span>  <span class="c1">// Generate new traverser</span></span>
<span id="LC123" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC124" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">ANCESTOR</span> <span class="o">:</span></span>
<span id="LC125" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">AncestorTraverser</span><span class="o">();</span></span>
<span id="LC126" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC127" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">ANCESTORORSELF</span> <span class="o">:</span></span>
<span id="LC128" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">AncestorOrSelfTraverser</span><span class="o">();</span></span>
<span id="LC129" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC130" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">ATTRIBUTE</span> <span class="o">:</span></span>
<span id="LC131" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">AttributeTraverser</span><span class="o">();</span></span>
<span id="LC132" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC133" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">CHILD</span> <span class="o">:</span></span>
<span id="LC134" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">ChildTraverser</span><span class="o">();</span></span>
<span id="LC135" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC136" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">DESCENDANT</span> <span class="o">:</span></span>
<span id="LC137" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DescendantTraverser</span><span class="o">();</span></span>
<span id="LC138" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC139" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">DESCENDANTORSELF</span> <span class="o">:</span></span>
<span id="LC140" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DescendantOrSelfTraverser</span><span class="o">();</span></span>
<span id="LC141" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC142" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">FOLLOWING</span> <span class="o">:</span></span>
<span id="LC143" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">FollowingTraverser</span><span class="o">();</span></span>
<span id="LC144" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC145" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">FOLLOWINGSIBLING</span> <span class="o">:</span></span>
<span id="LC146" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">FollowingSiblingTraverser</span><span class="o">();</span></span>
<span id="LC147" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC148" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">NAMESPACE</span> <span class="o">:</span></span>
<span id="LC149" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">NamespaceTraverser</span><span class="o">();</span></span>
<span id="LC150" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC151" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">NAMESPACEDECLS</span> <span class="o">:</span></span>
<span id="LC152" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">NamespaceDeclsTraverser</span><span class="o">();</span></span>
<span id="LC153" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC154" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">PARENT</span> <span class="o">:</span></span>
<span id="LC155" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">ParentTraverser</span><span class="o">();</span></span>
<span id="LC156" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC157" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">PRECEDING</span> <span class="o">:</span></span>
<span id="LC158" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">PrecedingTraverser</span><span class="o">();</span></span>
<span id="LC159" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC160" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">PRECEDINGSIBLING</span> <span class="o">:</span></span>
<span id="LC161" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">PrecedingSiblingTraverser</span><span class="o">();</span></span>
<span id="LC162" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC163" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">SELF</span> <span class="o">:</span></span>
<span id="LC164" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">SelfTraverser</span><span class="o">();</span></span>
<span id="LC165" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC166" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">ALL</span> <span class="o">:</span></span>
<span id="LC167" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">AllFromRootTraverser</span><span class="o">();</span></span>
<span id="LC168" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC169" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">ALLFROMNODE</span> <span class="o">:</span></span>
<span id="LC170" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">AllFromNodeTraverser</span><span class="o">();</span></span>
<span id="LC171" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC172" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">PRECEDINGANDANCESTOR</span> <span class="o">:</span></span>
<span id="LC173" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">PrecedingAndAncestorTraverser</span><span class="o">();</span></span>
<span id="LC174" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC175" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">DESCENDANTSFROMROOT</span> <span class="o">:</span></span>
<span id="LC176" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DescendantFromRootTraverser</span><span class="o">();</span></span>
<span id="LC177" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC178" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">DESCENDANTSORSELFFROMROOT</span> <span class="o">:</span></span>
<span id="LC179" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DescendantOrSelfFromRootTraverser</span><span class="o">();</span></span>
<span id="LC180" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC181" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">ROOT</span> <span class="o">:</span></span>
<span id="LC182" class="line" lang="java">      <span class="n">traverser</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">RootTraverser</span><span class="o">();</span></span>
<span id="LC183" class="line" lang="java">      <span class="k">break</span><span class="o">;</span></span>
<span id="LC184" class="line" lang="java">    <span class="k">case</span> <span class="nc">Axis</span><span class="o">.</span><span class="na">FILTEREDLIST</span> <span class="o">:</span></span>
<span id="LC185" class="line" lang="java">      <span class="k">return</span> <span class="kc">null</span><span class="o">;</span> <span class="c1">// Don't want to throw an exception for this one.</span></span>
<span id="LC186" class="line" lang="java">    <span class="k">default</span> <span class="o">:</span></span>
<span id="LC187" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">DTMException</span><span class="o">(</span><span class="nc">XMLMessages</span><span class="o">.</span><span class="na">createXMLMessage</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_UNKNOWN_AXIS_TYPE</span><span class="o">,</span> <span class="k">new</span> <span class="nc">Object</span><span class="o">[]{</span><span class="nc">Integer</span><span class="o">.</span><span class="na">toString</span><span class="o">(</span><span class="n">axis</span><span class="o">)}));</span> <span class="c1">//"Unknown axis traversal type: "+axis);</span></span>
<span id="LC188" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC189" class="line" lang="java"></span>
<span id="LC190" class="line" lang="java">    <span class="k">if</span> <span class="o">(</span><span class="kc">null</span> <span class="o">==</span> <span class="n">traverser</span><span class="o">)</span></span>
<span id="LC191" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">DTMException</span><span class="o">(</span><span class="nc">XMLMessages</span><span class="o">.</span><span class="na">createXMLMessage</span><span class="o">(</span><span class="nc">XMLErrorResources</span><span class="o">.</span><span class="na">ER_AXIS_TRAVERSER_NOT_SUPPORTED</span><span class="o">,</span> <span class="k">new</span> <span class="nc">Object</span><span class="o">[]{</span><span class="nc">Axis</span><span class="o">.</span><span class="na">getNames</span><span class="o">(</span><span class="n">axis</span><span class="o">)}));</span></span>
<span id="LC192" class="line" lang="java">      <span class="c1">// "Axis traverser not supported: "</span></span>
<span id="LC193" class="line" lang="java">      <span class="c1">//                       + Axis.names[axis]);</span></span>
<span id="LC194" class="line" lang="java"></span>
<span id="LC195" class="line" lang="java">    <span class="n">m_traversers</span><span class="o">[</span><span class="n">axis</span><span class="o">]</span> <span class="o">=</span> <span class="n">traverser</span><span class="o">;</span></span>
<span id="LC196" class="line" lang="java"></span>
<span id="LC197" class="line" lang="java">    <span class="k">return</span> <span class="n">traverser</span><span class="o">;</span></span>
...
<span id="LC201" class="line" lang="java"><span class="cm">   * Implements traversal of the Ancestor access, in reverse document order.</span></span>
<span id="LC202" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC203" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">AncestorTraverser</span> <span class="kd">extends</span> <span class="nc">DTMAxisTraverser</span></span>
...
<span id="LC207" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC208" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC209" class="line" lang="java"><span class="cm">     * @param context The context node if this iteration.</span></span>
<span id="LC210" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC211" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC213" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC214" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC215" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC216" class="line" lang="java">                        <span class="k">return</span> <span class="nf">getParent</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
...
<span id="LC220" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node that is matched</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">     * by the expanded type ID.</span></span>
<span id="LC222" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC223" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC224" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC225" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC226" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC227" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC228" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC229" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC230" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC231" class="line" lang="java">                        <span class="c1">// Process using identities</span></span>
<span id="LC232" class="line" lang="java">      <span class="n">current</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
<span id="LC233" class="line" lang="java"></span>
<span id="LC234" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">m_parent</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">current</span><span class="o">)))</span></span>
<span id="LC235" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC236" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_exptype</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">==</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC237" class="line" lang="java">          <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
<span id="LC238" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC239" class="line" lang="java"></span>
<span id="LC240" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC245" class="line" lang="java"><span class="cm">   * Implements traversal of the Ancestor access, in reverse document order.</span></span>
<span id="LC246" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC247" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">AncestorOrSelfTraverser</span> <span class="kd">extends</span> <span class="nc">AncestorTraverser</span></span>
...
<span id="LC251" class="line" lang="java"><span class="cm">     * By the nature of the stateless traversal, the context node can not be</span></span>
<span id="LC252" class="line" lang="java"><span class="cm">     * returned or the iteration will go into an infinate loop.  To see if</span></span>
<span id="LC253" class="line" lang="java"><span class="cm">     * the self node should be processed, use this function.</span></span>
<span id="LC254" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC255" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal.</span></span>
<span id="LC256" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC257" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC258" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC259" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">)</span></span>
<span id="LC260" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC261" class="line" lang="java">      <span class="k">return</span> <span class="n">context</span><span class="o">;</span></span>
...
<span id="LC265" class="line" lang="java"><span class="cm">     * By the nature of the stateless traversal, the context node can not be</span></span>
<span id="LC266" class="line" lang="java"><span class="cm">     * returned or the iteration will go into an infinate loop.  To see if</span></span>
<span id="LC267" class="line" lang="java"><span class="cm">     * the self node should be processed, use this function.  If the context</span></span>
<span id="LC268" class="line" lang="java"><span class="cm">     * node does not match the expanded type ID, this function will return</span></span>
<span id="LC269" class="line" lang="java"><span class="cm">     * false.</span></span>
<span id="LC270" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC271" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal.</span></span>
<span id="LC272" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC273" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC274" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC275" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC276" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC277" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC278" class="line" lang="java">                        <span class="k">return</span> <span class="o">(</span><span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">context</span><span class="o">)</span> <span class="o">==</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC279" class="line" lang="java">             <span class="o">?</span> <span class="n">context</span> <span class="o">:</span> <span class="n">next</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="n">context</span><span class="o">,</span> <span class="n">expandedTypeID</span><span class="o">);</span></span>
...
<span id="LC284" class="line" lang="java"><span class="cm">   * Implements traversal of the Attribute access</span></span>
<span id="LC285" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC286" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">AttributeTraverser</span> <span class="kd">extends</span> <span class="nc">DTMAxisTraverser</span></span>
...
<span id="LC290" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC291" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC292" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC293" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC294" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC295" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC296" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC297" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC298" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC299" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="n">context</span> <span class="o">==</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC300" class="line" lang="java">             <span class="o">?</span> <span class="n">getFirstAttribute</span><span class="o">(</span><span class="n">context</span><span class="o">)</span> <span class="o">:</span> <span class="n">getNextAttribute</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
...
<span id="LC304" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node that is matched</span></span>
<span id="LC305" class="line" lang="java"><span class="cm">     * by the expanded type ID.</span></span>
<span id="LC306" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC307" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC308" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC309" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC310" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC311" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC312" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC313" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC314" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC315" class="line" lang="java"></span>
<span id="LC316" class="line" lang="java">      <span class="n">current</span> <span class="o">=</span> <span class="o">(</span><span class="n">context</span> <span class="o">==</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC317" class="line" lang="java">                <span class="o">?</span> <span class="n">getFirstAttribute</span><span class="o">(</span><span class="n">context</span><span class="o">)</span> <span class="o">:</span> <span class="n">getNextAttribute</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
<span id="LC318" class="line" lang="java"></span>
<span id="LC319" class="line" lang="java">      <span class="k">do</span></span>
<span id="LC320" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC321" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">==</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC322" class="line" lang="java">          <span class="k">return</span> <span class="n">current</span><span class="o">;</span></span>
<span id="LC323" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC324" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">getNextAttribute</span><span class="o">(</span><span class="n">current</span><span class="o">)));</span></span>
<span id="LC325" class="line" lang="java"></span>
<span id="LC326" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC331" class="line" lang="java"><span class="cm">   * Implements traversal of the Ancestor access, in reverse document order.</span></span>
<span id="LC332" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC333" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">ChildTraverser</span> <span class="kd">extends</span> <span class="nc">DTMAxisTraverser</span></span>
...
<span id="LC337" class="line" lang="java"><span class="cm">     * Get the next indexed node that matches the expanded type ID.  Before</span></span>
<span id="LC338" class="line" lang="java"><span class="cm">     * calling this function, one should first call</span></span>
<span id="LC339" class="line" lang="java"><span class="cm">     * {@link #isIndexed(int) isIndexed} to make sure that the index can</span></span>
<span id="LC340" class="line" lang="java"><span class="cm">     * contain nodes that match the given expanded type ID.</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC342" class="line" lang="java"><span class="cm">     * @param axisRoot The root identity of the axis.</span></span>
<span id="LC343" class="line" lang="java"><span class="cm">     * @param nextPotential The node found must match or occur after this node.</span></span>
<span id="LC344" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID for the request.</span></span>
<span id="LC345" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC346" class="line" lang="java"><span class="cm">     * @return The node ID or NULL if not found.</span></span>
<span id="LC347" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC348" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">int</span> <span class="nf">getNextIndexed</span><span class="o">(</span><span class="kt">int</span> <span class="n">axisRoot</span><span class="o">,</span> <span class="kt">int</span> <span class="n">nextPotential</span><span class="o">,</span></span>
<span id="LC349" class="line" lang="java">                                 <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC350" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC351" class="line" lang="java"></span>
<span id="LC352" class="line" lang="java">      <span class="kt">int</span> <span class="n">nsIndex</span> <span class="o">=</span> <span class="n">m_expandedNameTable</span><span class="o">.</span><span class="na">getNamespaceID</span><span class="o">(</span><span class="n">expandedTypeID</span><span class="o">);</span></span>
<span id="LC353" class="line" lang="java">      <span class="kt">int</span> <span class="n">lnIndex</span> <span class="o">=</span> <span class="n">m_expandedNameTable</span><span class="o">.</span><span class="na">getLocalNameID</span><span class="o">(</span><span class="n">expandedTypeID</span><span class="o">);</span></span>
<span id="LC354" class="line" lang="java"></span>
<span id="LC355" class="line" lang="java">      <span class="k">for</span> <span class="o">(;</span> <span class="o">;</span> <span class="o">)</span></span>
<span id="LC356" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC357" class="line" lang="java">        <span class="kt">int</span> <span class="n">nextID</span> <span class="o">=</span> <span class="n">findElementFromIndex</span><span class="o">(</span><span class="n">nsIndex</span><span class="o">,</span> <span class="n">lnIndex</span><span class="o">,</span> <span class="n">nextPotential</span><span class="o">);</span></span>
<span id="LC358" class="line" lang="java"></span>
<span id="LC359" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="no">NOTPROCESSED</span> <span class="o">!=</span> <span class="n">nextID</span><span class="o">)</span></span>
<span id="LC360" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC361" class="line" lang="java">          <span class="kt">int</span> <span class="n">parentID</span> <span class="o">=</span> <span class="n">m_parent</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">nextID</span><span class="o">);</span></span>
<span id="LC362" class="line" lang="java"></span>
<span id="LC363" class="line" lang="java">          <span class="c1">// Is it a child?</span></span>
<span id="LC364" class="line" lang="java">          <span class="k">if</span><span class="o">(</span><span class="n">parentID</span> <span class="o">==</span> <span class="n">axisRoot</span><span class="o">)</span></span>
<span id="LC365" class="line" lang="java">            <span class="k">return</span> <span class="n">nextID</span><span class="o">;</span></span>
<span id="LC366" class="line" lang="java"></span>
<span id="LC367" class="line" lang="java">          <span class="c1">// If the parent occured before the subtree root, then</span></span>
<span id="LC368" class="line" lang="java">          <span class="c1">// we know it is past the child axis.</span></span>
<span id="LC369" class="line" lang="java">          <span class="k">if</span><span class="o">(</span><span class="n">parentID</span> <span class="o">&lt;</span> <span class="n">axisRoot</span><span class="o">)</span></span>
<span id="LC370" class="line" lang="java">              <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC371" class="line" lang="java"></span>
<span id="LC372" class="line" lang="java">          <span class="c1">// Otherwise, it could be a descendant below the subtree root</span></span>
<span id="LC373" class="line" lang="java">          <span class="c1">// children, or it could be after the subtree root.  So we have</span></span>
<span id="LC374" class="line" lang="java">          <span class="c1">// to climb up until the parent is less than the subtree root, in</span></span>
<span id="LC375" class="line" lang="java">          <span class="c1">// which case we return NULL, or until it is equal to the subtree</span></span>
<span id="LC376" class="line" lang="java">          <span class="c1">// root, in which case we continue to look.</span></span>
<span id="LC377" class="line" lang="java">          <span class="k">do</span></span>
<span id="LC378" class="line" lang="java">          <span class="o">{</span></span>
<span id="LC379" class="line" lang="java">            <span class="n">parentID</span> <span class="o">=</span> <span class="n">m_parent</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">parentID</span><span class="o">);</span></span>
<span id="LC380" class="line" lang="java">            <span class="k">if</span><span class="o">(</span><span class="n">parentID</span> <span class="o">&lt;</span> <span class="n">axisRoot</span><span class="o">)</span></span>
<span id="LC381" class="line" lang="java">              <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC382" class="line" lang="java">          <span class="o">}</span></span>
<span id="LC383" class="line" lang="java">            <span class="k">while</span><span class="o">(</span><span class="n">parentID</span> <span class="o">&gt;</span> <span class="n">axisRoot</span><span class="o">);</span></span>
<span id="LC384" class="line" lang="java"></span>
<span id="LC385" class="line" lang="java">          <span class="c1">// System.out.println("Found node via index: "+first);</span></span>
<span id="LC386" class="line" lang="java">          <span class="n">nextPotential</span> <span class="o">=</span> <span class="n">nextID</span><span class="o">+</span><span class="mi">1</span><span class="o">;</span></span>
<span id="LC387" class="line" lang="java">          <span class="k">continue</span><span class="o">;</span></span>
<span id="LC388" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC389" class="line" lang="java"></span>
<span id="LC390" class="line" lang="java">        <span class="n">nextNode</span><span class="o">();</span></span>
<span id="LC391" class="line" lang="java"></span>
<span id="LC392" class="line" lang="java">        <span class="k">if</span><span class="o">(!(</span><span class="n">m_nextsib</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">axisRoot</span><span class="o">)</span> <span class="o">==</span> <span class="no">NOTPROCESSED</span><span class="o">))</span></span>
<span id="LC393" class="line" lang="java">          <span class="k">break</span><span class="o">;</span></span>
<span id="LC394" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC395" class="line" lang="java"></span>
<span id="LC396" class="line" lang="java">      <span class="k">return</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
...
<span id="LC400" class="line" lang="java"><span class="cm">     * By the nature of the stateless traversal, the context node can not be</span></span>
<span id="LC401" class="line" lang="java"><span class="cm">     * returned or the iteration will go into an infinate loop.  So to traverse</span></span>
<span id="LC402" class="line" lang="java"><span class="cm">     * an axis, the first function must be used to get the first node.</span></span>
<span id="LC403" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC404" class="line" lang="java"><span class="cm">     * &lt;p&gt;This method needs to be overloaded only by those axis that process</span></span>
<span id="LC405" class="line" lang="java"><span class="cm">     * the self node. &lt;\p&gt;</span></span>
<span id="LC406" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC407" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal. This is the point</span></span>
<span id="LC408" class="line" lang="java"><span class="cm">     * that the traversal starts from.</span></span>
<span id="LC409" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC410" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC411" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">)</span></span>
<span id="LC412" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC413" class="line" lang="java">      <span class="k">return</span> <span class="nf">getFirstChild</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
...
<span id="LC417" class="line" lang="java"><span class="cm">     * By the nature of the stateless traversal, the context node can not be</span></span>
<span id="LC418" class="line" lang="java"><span class="cm">     * returned or the iteration will go into an infinate loop.  So to traverse</span></span>
<span id="LC419" class="line" lang="java"><span class="cm">     * an axis, the first function must be used to get the first node.</span></span>
<span id="LC420" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">     * &lt;p&gt;This method needs to be overloaded only by those axis that process</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">     * the self node. &lt;\p&gt;</span></span>
<span id="LC423" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC424" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal. This is the point</span></span>
<span id="LC425" class="line" lang="java"><span class="cm">     * of origin for the traversal -- its "root node" or starting point.</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC427" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC428" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC429" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC430" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC431" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC432" class="line" lang="java">      <span class="k">if</span><span class="o">(</span><span class="kc">true</span><span class="o">)</span></span>
<span id="LC433" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC434" class="line" lang="java">        <span class="kt">int</span> <span class="n">identity</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC435" class="line" lang="java"></span>
<span id="LC436" class="line" lang="java">        <span class="kt">int</span> <span class="n">firstMatch</span> <span class="o">=</span> <span class="n">getNextIndexed</span><span class="o">(</span><span class="n">identity</span><span class="o">,</span> <span class="n">_firstch</span><span class="o">(</span><span class="n">identity</span><span class="o">),</span></span>
<span id="LC437" class="line" lang="java">                                 <span class="n">expandedTypeID</span><span class="o">);</span></span>
<span id="LC438" class="line" lang="java"></span>
<span id="LC439" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">firstMatch</span><span class="o">);</span></span>
<span id="LC440" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC441" class="line" lang="java">      <span class="k">else</span></span>
<span id="LC442" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC443" class="line" lang="java">                                <span class="c1">// %REVIEW% Dead code. Eliminate?</span></span>
<span id="LC444" class="line" lang="java">        <span class="k">for</span> <span class="o">(</span><span class="kt">int</span> <span class="n">current</span> <span class="o">=</span> <span class="n">_firstch</span><span class="o">(</span><span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">context</span><span class="o">));</span></span>
<span id="LC445" class="line" lang="java">             <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="n">current</span><span class="o">;</span></span>
<span id="LC446" class="line" lang="java">             <span class="n">current</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">current</span><span class="o">))</span></span>
<span id="LC447" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC448" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="n">m_exptype</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">==</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC449" class="line" lang="java">              <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
<span id="LC450" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC451" class="line" lang="java">        <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC456" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC457" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC458" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC459" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC460" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC461" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC462" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC463" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC464" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC465" class="line" lang="java">      <span class="k">return</span> <span class="nf">getNextSibling</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
...
<span id="LC469" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node that is matched</span></span>
<span id="LC470" class="line" lang="java"><span class="cm">     * by the expanded type ID.</span></span>
<span id="LC471" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC472" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC473" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC474" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC475" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC476" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC477" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC478" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC479" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC480" class="line" lang="java">                        <span class="c1">// Process in Identifier space</span></span>
<span id="LC481" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">current</span><span class="o">));</span></span>
<span id="LC482" class="line" lang="java">           <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="n">current</span><span class="o">;</span></span>
<span id="LC483" class="line" lang="java">           <span class="n">current</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">current</span><span class="o">))</span></span>
<span id="LC484" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC485" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_exptype</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">==</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC486" class="line" lang="java">            <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
...
<span id="LC494" class="line" lang="java"><span class="cm">   * Super class for derived classes that want a convenient way to access</span></span>
<span id="LC495" class="line" lang="java"><span class="cm">   * the indexing mechanism.</span></span>
<span id="LC496" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC497" class="line" lang="java">  <span class="kd">private</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">IndexedDTMAxisTraverser</span> <span class="kd">extends</span> <span class="nc">DTMAxisTraverser</span></span>
...
<span id="LC501" class="line" lang="java"><span class="cm">     * Tell if the indexing is on and the given expanded type ID matches</span></span>
<span id="LC502" class="line" lang="java"><span class="cm">     * what is in the indexes.  Derived classes should call this before</span></span>
<span id="LC503" class="line" lang="java"><span class="cm">     * calling {@link #getNextIndexed(int, int, int) getNextIndexed} method.</span></span>
<span id="LC504" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC505" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID being requested.</span></span>
<span id="LC506" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC507" class="line" lang="java"><span class="cm">     * @return true if it is OK to call the</span></span>
<span id="LC508" class="line" lang="java"><span class="cm">     *         {@link #getNextIndexed(int, int, int) getNextIndexed} method.</span></span>
<span id="LC509" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC510" class="line" lang="java">    <span class="kd">protected</span> <span class="kd">final</span> <span class="kt">boolean</span> <span class="nf">isIndexed</span><span class="o">(</span><span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC511" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC512" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="n">m_indexing</span></span>
<span id="LC513" class="line" lang="java">              <span class="o">&amp;&amp;</span> <span class="nc">ExpandedNameTable</span><span class="o">.</span><span class="na">ELEMENT</span></span>
<span id="LC514" class="line" lang="java">                 <span class="o">==</span> <span class="n">m_expandedNameTable</span><span class="o">.</span><span class="na">getType</span><span class="o">(</span><span class="n">expandedTypeID</span><span class="o">));</span></span>
...
<span id="LC518" class="line" lang="java"><span class="cm">     * Tell if a node is outside the axis being traversed.  This method must be</span></span>
<span id="LC519" class="line" lang="java"><span class="cm">     * implemented by derived classes, and must be robust enough to handle any</span></span>
<span id="LC520" class="line" lang="java"><span class="cm">     * node that occurs after the axis root.</span></span>
<span id="LC521" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC522" class="line" lang="java"><span class="cm">     * @param axisRoot The root identity of the axis.</span></span>
<span id="LC523" class="line" lang="java"><span class="cm">     * @param identity The node in question.</span></span>
<span id="LC524" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC525" class="line" lang="java"><span class="cm">     * @return true if the given node falls outside the axis being traversed.</span></span>
<span id="LC526" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC527" class="line" lang="java">    <span class="kd">protected</span> <span class="kd">abstract</span> <span class="kt">boolean</span> <span class="nf">isAfterAxis</span><span class="o">(</span><span class="kt">int</span> <span class="n">axisRoot</span><span class="o">,</span> <span class="kt">int</span> <span class="n">identity</span><span class="o">);</span></span>
<span id="LC528" class="line" lang="java"></span>
<span id="LC529" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC530" class="line" lang="java"><span class="cm">     * Tell if the axis has been fully processed to tell if a the wait for</span></span>
<span id="LC531" class="line" lang="java"><span class="cm">     * an arriving node should terminate.  This method must be implemented</span></span>
<span id="LC532" class="line" lang="java"><span class="cm">     * be a derived class.</span></span>
<span id="LC533" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC534" class="line" lang="java"><span class="cm">     * @param axisRoot The root identity of the axis.</span></span>
<span id="LC535" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC536" class="line" lang="java"><span class="cm">     * @return true if the axis has been fully processed.</span></span>
<span id="LC537" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC538" class="line" lang="java">    <span class="kd">protected</span> <span class="kd">abstract</span> <span class="kt">boolean</span> <span class="nf">axisHasBeenProcessed</span><span class="o">(</span><span class="kt">int</span> <span class="n">axisRoot</span><span class="o">);</span></span>
<span id="LC539" class="line" lang="java"></span>
<span id="LC540" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC541" class="line" lang="java"><span class="cm">     * Get the next indexed node that matches the expanded type ID.  Before</span></span>
<span id="LC542" class="line" lang="java"><span class="cm">     * calling this function, one should first call</span></span>
<span id="LC543" class="line" lang="java"><span class="cm">     * {@link #isIndexed(int) isIndexed} to make sure that the index can</span></span>
<span id="LC544" class="line" lang="java"><span class="cm">     * contain nodes that match the given expanded type ID.</span></span>
<span id="LC545" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC546" class="line" lang="java"><span class="cm">     * @param axisRoot The root identity of the axis.</span></span>
<span id="LC547" class="line" lang="java"><span class="cm">     * @param nextPotential The node found must match or occur after this node.</span></span>
<span id="LC548" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID for the request.</span></span>
<span id="LC549" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC550" class="line" lang="java"><span class="cm">     * @return The node ID or NULL if not found.</span></span>
<span id="LC551" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC552" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">int</span> <span class="nf">getNextIndexed</span><span class="o">(</span><span class="kt">int</span> <span class="n">axisRoot</span><span class="o">,</span> <span class="kt">int</span> <span class="n">nextPotential</span><span class="o">,</span></span>
<span id="LC553" class="line" lang="java">                                 <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC554" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC555" class="line" lang="java"></span>
<span id="LC556" class="line" lang="java">      <span class="kt">int</span> <span class="n">nsIndex</span> <span class="o">=</span> <span class="n">m_expandedNameTable</span><span class="o">.</span><span class="na">getNamespaceID</span><span class="o">(</span><span class="n">expandedTypeID</span><span class="o">);</span></span>
<span id="LC557" class="line" lang="java">      <span class="kt">int</span> <span class="n">lnIndex</span> <span class="o">=</span> <span class="n">m_expandedNameTable</span><span class="o">.</span><span class="na">getLocalNameID</span><span class="o">(</span><span class="n">expandedTypeID</span><span class="o">);</span></span>
<span id="LC558" class="line" lang="java"></span>
<span id="LC559" class="line" lang="java">      <span class="k">while</span><span class="o">(</span><span class="kc">true</span><span class="o">)</span></span>
<span id="LC560" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC561" class="line" lang="java">        <span class="kt">int</span> <span class="n">next</span> <span class="o">=</span> <span class="n">findElementFromIndex</span><span class="o">(</span><span class="n">nsIndex</span><span class="o">,</span> <span class="n">lnIndex</span><span class="o">,</span> <span class="n">nextPotential</span><span class="o">);</span></span>
<span id="LC562" class="line" lang="java"></span>
<span id="LC563" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="no">NOTPROCESSED</span> <span class="o">!=</span> <span class="n">next</span><span class="o">)</span></span>
<span id="LC564" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC565" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="n">isAfterAxis</span><span class="o">(</span><span class="n">axisRoot</span><span class="o">,</span> <span class="n">next</span><span class="o">))</span></span>
<span id="LC566" class="line" lang="java">            <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC567" class="line" lang="java"></span>
<span id="LC568" class="line" lang="java">          <span class="c1">// System.out.println("Found node via index: "+first);</span></span>
<span id="LC569" class="line" lang="java">          <span class="k">return</span> <span class="n">next</span><span class="o">;</span></span>
<span id="LC570" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC571" class="line" lang="java">        <span class="k">else</span> <span class="nf">if</span><span class="o">(</span><span class="n">axisHasBeenProcessed</span><span class="o">(</span><span class="n">axisRoot</span><span class="o">))</span></span>
<span id="LC572" class="line" lang="java">          <span class="k">break</span><span class="o">;</span></span>
<span id="LC573" class="line" lang="java"></span>
<span id="LC574" class="line" lang="java">        <span class="n">nextNode</span><span class="o">();</span></span>
<span id="LC575" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC576" class="line" lang="java"></span>
<span id="LC577" class="line" lang="java">      <span class="k">return</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
...
<span id="LC582" class="line" lang="java"><span class="cm">   * Implements traversal of the Ancestor access, in reverse document order.</span></span>
<span id="LC583" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC584" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">DescendantTraverser</span> <span class="kd">extends</span> <span class="nc">IndexedDTMAxisTraverser</span></span>
<span id="LC585" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC586" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC587" class="line" lang="java"><span class="cm">     * Get the first potential identity that can be returned.  This should</span></span>
<span id="LC588" class="line" lang="java"><span class="cm">     * be overridded by classes that need to return the self node.</span></span>
<span id="LC589" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC590" class="line" lang="java"><span class="cm">     * @param identity The node identity of the root context of the traversal.</span></span>
<span id="LC591" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC592" class="line" lang="java"><span class="cm">     * @return The first potential node that can be in the traversal.</span></span>
<span id="LC593" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC594" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">int</span> <span class="nf">getFirstPotential</span><span class="o">(</span><span class="kt">int</span> <span class="n">identity</span><span class="o">)</span></span>
<span id="LC595" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC596" class="line" lang="java">      <span class="k">return</span> <span class="n">identity</span> <span class="o">+</span> <span class="mi">1</span><span class="o">;</span></span>
...
<span id="LC600" class="line" lang="java"><span class="cm">     * Tell if the axis has been fully processed to tell if a the wait for</span></span>
<span id="LC601" class="line" lang="java"><span class="cm">     * an arriving node should terminate.</span></span>
<span id="LC602" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC603" class="line" lang="java"><span class="cm">     * @param axisRoot The root identity of the axis.</span></span>
<span id="LC604" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC605" class="line" lang="java"><span class="cm">     * @return true if the axis has been fully processed.</span></span>
<span id="LC606" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC607" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">boolean</span> <span class="nf">axisHasBeenProcessed</span><span class="o">(</span><span class="kt">int</span> <span class="n">axisRoot</span><span class="o">)</span></span>
<span id="LC608" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC609" class="line" lang="java">      <span class="k">return</span> <span class="o">!(</span><span class="n">m_nextsib</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">axisRoot</span><span class="o">)</span> <span class="o">==</span> <span class="no">NOTPROCESSED</span><span class="o">);</span></span>
...
<span id="LC613" class="line" lang="java"><span class="cm">     * Get the subtree root identity from the handle that was passed in by</span></span>
<span id="LC614" class="line" lang="java"><span class="cm">     * the caller.  Derived classes may override this to change the root</span></span>
<span id="LC615" class="line" lang="java"><span class="cm">     * context of the traversal.</span></span>
<span id="LC616" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC617" class="line" lang="java"><span class="cm">     * @param handle handle to the root context.</span></span>
<span id="LC618" class="line" lang="java"><span class="cm">     * @return identity of the root of the subtree.</span></span>
<span id="LC619" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC620" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">int</span> <span class="nf">getSubtreeRoot</span><span class="o">(</span><span class="kt">int</span> <span class="n">handle</span><span class="o">)</span></span>
<span id="LC621" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC622" class="line" lang="java">      <span class="k">return</span> <span class="nf">makeNodeIdentity</span><span class="o">(</span><span class="n">handle</span><span class="o">);</span></span>
...
<span id="LC626" class="line" lang="java"><span class="cm">     * Tell if this node identity is a descendant.  Assumes that</span></span>
<span id="LC627" class="line" lang="java"><span class="cm">     * the node info for the element has already been obtained.</span></span>
<span id="LC628" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC629" class="line" lang="java"><span class="cm">     * %REVIEW% This is really parentFollowsRootInDocumentOrder ...</span></span>
<span id="LC630" class="line" lang="java"><span class="cm">     * which fails if the parent starts after the root ends.</span></span>
<span id="LC631" class="line" lang="java"><span class="cm">     * May be sufficient for this class's logic, but misleadingly named!</span></span>
<span id="LC632" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC633" class="line" lang="java"><span class="cm">     * @param subtreeRootIdentity The root context of the subtree in question.</span></span>
<span id="LC634" class="line" lang="java"><span class="cm">     * @param identity The index number of the node in question.</span></span>
<span id="LC635" class="line" lang="java"><span class="cm">     * @return true if the index is a descendant of _startNode.</span></span>
<span id="LC636" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC637" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">boolean</span> <span class="nf">isDescendant</span><span class="o">(</span><span class="kt">int</span> <span class="n">subtreeRootIdentity</span><span class="o">,</span> <span class="kt">int</span> <span class="n">identity</span><span class="o">)</span></span>
<span id="LC638" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC639" class="line" lang="java">      <span class="k">return</span> <span class="nf">_parent</span><span class="o">(</span><span class="n">identity</span><span class="o">)</span> <span class="o">&gt;=</span> <span class="n">subtreeRootIdentity</span><span class="o">;</span></span>
...
<span id="LC643" class="line" lang="java"><span class="cm">     * Tell if a node is outside the axis being traversed.  This method must be</span></span>
<span id="LC644" class="line" lang="java"><span class="cm">     * implemented by derived classes, and must be robust enough to handle any</span></span>
<span id="LC645" class="line" lang="java"><span class="cm">     * node that occurs after the axis root.</span></span>
<span id="LC646" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC647" class="line" lang="java"><span class="cm">     * @param axisRoot The root identity of the axis.</span></span>
<span id="LC648" class="line" lang="java"><span class="cm">     * @param identity The node in question.</span></span>
<span id="LC649" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC650" class="line" lang="java"><span class="cm">     * @return true if the given node falls outside the axis being traversed.</span></span>
<span id="LC651" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC652" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">boolean</span> <span class="nf">isAfterAxis</span><span class="o">(</span><span class="kt">int</span> <span class="n">axisRoot</span><span class="o">,</span> <span class="kt">int</span> <span class="n">identity</span><span class="o">)</span></span>
<span id="LC653" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC654" class="line" lang="java">      <span class="c1">// %REVIEW% Is there *any* cheaper way to do this?</span></span>
<span id="LC655" class="line" lang="java">                        <span class="c1">// Yes. In ID space, compare to axisRoot's successor</span></span>
<span id="LC656" class="line" lang="java">                        <span class="c1">// (next-sib or ancestor's-next-sib). Probably shallower search.</span></span>
<span id="LC657" class="line" lang="java">      <span class="k">do</span></span>
<span id="LC658" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC659" class="line" lang="java">        <span class="k">if</span><span class="o">(</span><span class="n">identity</span> <span class="o">==</span> <span class="n">axisRoot</span><span class="o">)</span></span>
<span id="LC660" class="line" lang="java">          <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC661" class="line" lang="java">        <span class="n">identity</span> <span class="o">=</span> <span class="n">m_parent</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">identity</span><span class="o">);</span></span>
<span id="LC662" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC663" class="line" lang="java">        <span class="k">while</span><span class="o">(</span><span class="n">identity</span> <span class="o">&gt;=</span> <span class="n">axisRoot</span><span class="o">);</span></span>
<span id="LC664" class="line" lang="java"></span>
<span id="LC665" class="line" lang="java">      <span class="k">return</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC669" class="line" lang="java"><span class="cm">     * By the nature of the stateless traversal, the context node can not be</span></span>
<span id="LC670" class="line" lang="java"><span class="cm">     * returned or the iteration will go into an infinate loop.  So to traverse</span></span>
<span id="LC671" class="line" lang="java"><span class="cm">     * an axis, the first function must be used to get the first node.</span></span>
<span id="LC672" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC673" class="line" lang="java"><span class="cm">     * &lt;p&gt;This method needs to be overloaded only by those axis that process</span></span>
<span id="LC674" class="line" lang="java"><span class="cm">     * the self node. &lt;\p&gt;</span></span>
<span id="LC675" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC676" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal. This is the point</span></span>
<span id="LC677" class="line" lang="java"><span class="cm">     * of origin for the traversal -- its "root node" or starting point.</span></span>
<span id="LC678" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC679" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC680" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC681" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC682" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC683" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC684" class="line" lang="java"></span>
<span id="LC685" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">isIndexed</span><span class="o">(</span><span class="n">expandedTypeID</span><span class="o">))</span></span>
<span id="LC686" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC687" class="line" lang="java">        <span class="kt">int</span> <span class="n">identity</span> <span class="o">=</span> <span class="n">getSubtreeRoot</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC688" class="line" lang="java">        <span class="kt">int</span> <span class="n">firstPotential</span> <span class="o">=</span> <span class="n">getFirstPotential</span><span class="o">(</span><span class="n">identity</span><span class="o">);</span></span>
<span id="LC689" class="line" lang="java"></span>
<span id="LC690" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">getNextIndexed</span><span class="o">(</span><span class="n">identity</span><span class="o">,</span> <span class="n">firstPotential</span><span class="o">,</span> <span class="n">expandedTypeID</span><span class="o">));</span></span>
<span id="LC691" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC692" class="line" lang="java"></span>
<span id="LC693" class="line" lang="java">      <span class="k">return</span> <span class="nf">next</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="n">context</span><span class="o">,</span> <span class="n">expandedTypeID</span><span class="o">);</span></span>
...
<span id="LC697" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC698" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC699" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC700" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC701" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC702" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC703" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC704" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC705" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC706" class="line" lang="java"></span>
<span id="LC707" class="line" lang="java">      <span class="kt">int</span> <span class="n">subtreeRootIdent</span> <span class="o">=</span> <span class="n">getSubtreeRoot</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC708" class="line" lang="java"></span>
<span id="LC709" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">+</span> <span class="mi">1</span><span class="o">;</span> <span class="o">;</span> <span class="n">current</span><span class="o">++)</span></span>
<span id="LC710" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC711" class="line" lang="java">        <span class="kt">int</span> <span class="n">type</span> <span class="o">=</span> <span class="n">_type</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// may call nextNode()</span></span>
<span id="LC712" class="line" lang="java"></span>
<span id="LC713" class="line" lang="java">        <span class="k">if</span> <span class="o">(!</span><span class="n">isDescendant</span><span class="o">(</span><span class="n">subtreeRootIdent</span><span class="o">,</span> <span class="n">current</span><span class="o">))</span></span>
<span id="LC714" class="line" lang="java">          <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC715" class="line" lang="java"></span>
<span id="LC716" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="no">ATTRIBUTE_NODE</span> <span class="o">==</span> <span class="n">type</span> <span class="o">||</span> <span class="no">NAMESPACE_NODE</span> <span class="o">==</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC717" class="line" lang="java">          <span class="k">continue</span><span class="o">;</span></span>
<span id="LC718" class="line" lang="java"></span>
<span id="LC719" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// make handle.</span></span>
...
<span id="LC724" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node that is matched</span></span>
<span id="LC725" class="line" lang="java"><span class="cm">     * by the expanded type ID.</span></span>
<span id="LC726" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC727" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC728" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC729" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC730" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC731" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC732" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC733" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC734" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC735" class="line" lang="java"></span>
<span id="LC736" class="line" lang="java">      <span class="kt">int</span> <span class="n">subtreeRootIdent</span> <span class="o">=</span> <span class="n">getSubtreeRoot</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC737" class="line" lang="java"></span>
<span id="LC738" class="line" lang="java">      <span class="n">current</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">+</span> <span class="mi">1</span><span class="o">;</span></span>
<span id="LC739" class="line" lang="java"></span>
<span id="LC740" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">isIndexed</span><span class="o">(</span><span class="n">expandedTypeID</span><span class="o">))</span></span>
<span id="LC741" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC742" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">getNextIndexed</span><span class="o">(</span><span class="n">subtreeRootIdent</span><span class="o">,</span> <span class="n">current</span><span class="o">,</span> <span class="n">expandedTypeID</span><span class="o">));</span></span>
<span id="LC743" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC744" class="line" lang="java"></span>
<span id="LC745" class="line" lang="java">      <span class="k">for</span> <span class="o">(;</span> <span class="o">;</span> <span class="n">current</span><span class="o">++)</span></span>
<span id="LC746" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC747" class="line" lang="java">        <span class="kt">int</span> <span class="n">exptype</span> <span class="o">=</span> <span class="n">_exptype</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// may call nextNode()</span></span>
<span id="LC748" class="line" lang="java"></span>
<span id="LC749" class="line" lang="java">        <span class="k">if</span> <span class="o">(!</span><span class="n">isDescendant</span><span class="o">(</span><span class="n">subtreeRootIdent</span><span class="o">,</span> <span class="n">current</span><span class="o">))</span></span>
<span id="LC750" class="line" lang="java">          <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC751" class="line" lang="java"></span>
<span id="LC752" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">exptype</span> <span class="o">!=</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC753" class="line" lang="java">          <span class="k">continue</span><span class="o">;</span></span>
<span id="LC754" class="line" lang="java"></span>
<span id="LC755" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// make handle.</span></span>
...
<span id="LC761" class="line" lang="java"><span class="cm">   * Implements traversal of the Ancestor access, in reverse document order.</span></span>
<span id="LC762" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC763" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">DescendantOrSelfTraverser</span> <span class="kd">extends</span> <span class="nc">DescendantTraverser</span></span>
...
<span id="LC767" class="line" lang="java"><span class="cm">     * Get the first potential identity that can be returned, which is the</span></span>
<span id="LC768" class="line" lang="java"><span class="cm">     * axis context, in this case.</span></span>
<span id="LC769" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC770" class="line" lang="java"><span class="cm">     * @param identity The node identity of the root context of the traversal.</span></span>
<span id="LC771" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC772" class="line" lang="java"><span class="cm">     * @return The axis context.</span></span>
<span id="LC773" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC774" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">int</span> <span class="nf">getFirstPotential</span><span class="o">(</span><span class="kt">int</span> <span class="n">identity</span><span class="o">)</span></span>
<span id="LC775" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC776" class="line" lang="java">      <span class="k">return</span> <span class="n">identity</span><span class="o">;</span></span>
...
<span id="LC780" class="line" lang="java"><span class="cm">     * By the nature of the stateless traversal, the context node can not be</span></span>
<span id="LC781" class="line" lang="java"><span class="cm">     * returned or the iteration will go into an infinate loop.  To see if</span></span>
<span id="LC782" class="line" lang="java"><span class="cm">     * the self node should be processed, use this function.</span></span>
<span id="LC783" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC784" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal.</span></span>
<span id="LC785" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC786" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC787" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC788" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">)</span></span>
<span id="LC789" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC790" class="line" lang="java">      <span class="k">return</span> <span class="n">context</span><span class="o">;</span></span>
...
<span id="LC795" class="line" lang="java"><span class="cm">   * Implements traversal of the entire subtree, including the root node.</span></span>
<span id="LC796" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC797" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">AllFromNodeTraverser</span> <span class="kd">extends</span> <span class="nc">DescendantOrSelfTraverser</span></span>
...
<span id="LC801" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC802" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC803" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC804" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC805" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC806" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC807" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC808" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC809" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC810" class="line" lang="java"></span>
<span id="LC811" class="line" lang="java">      <span class="kt">int</span> <span class="n">subtreeRootIdent</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC812" class="line" lang="java"></span>
<span id="LC813" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">+</span> <span class="mi">1</span><span class="o">;</span> <span class="o">;</span> <span class="n">current</span><span class="o">++)</span></span>
<span id="LC814" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC815" class="line" lang="java">        <span class="c1">// Trickological code: _exptype() has the side-effect of</span></span>
<span id="LC816" class="line" lang="java">        <span class="c1">// running nextNode until the specified node has been loaded,</span></span>
<span id="LC817" class="line" lang="java">        <span class="c1">// and thus can be used to ensure that incremental construction of</span></span>
<span id="LC818" class="line" lang="java">        <span class="c1">// the DTM has gotten this far. Using it just for that side-effect</span></span>
<span id="LC819" class="line" lang="java">        <span class="c1">// is quite a kluge...</span></span>
<span id="LC820" class="line" lang="java">        <span class="n">_exptype</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// make sure it's here.</span></span>
<span id="LC821" class="line" lang="java"></span>
<span id="LC822" class="line" lang="java">        <span class="k">if</span> <span class="o">(!</span><span class="n">isDescendant</span><span class="o">(</span><span class="n">subtreeRootIdent</span><span class="o">,</span> <span class="n">current</span><span class="o">))</span></span>
<span id="LC823" class="line" lang="java">          <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC824" class="line" lang="java"></span>
<span id="LC825" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// make handle.</span></span>
...
<span id="LC831" class="line" lang="java"><span class="cm">   * Implements traversal of the following access, in document order.</span></span>
<span id="LC832" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC833" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">FollowingTraverser</span> <span class="kd">extends</span> <span class="nc">DescendantTraverser</span></span>
...
<span id="LC837" class="line" lang="java"><span class="cm">     * Get the first of the following.</span></span>
<span id="LC838" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC839" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal. This is the point</span></span>
<span id="LC840" class="line" lang="java"><span class="cm">     * that the traversal starts from.</span></span>
<span id="LC841" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC842" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC843" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">)</span></span>
<span id="LC844" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC845" class="line" lang="java">                        <span class="c1">// Compute in ID space</span></span>
<span id="LC846" class="line" lang="java">                        <span class="n">context</span><span class="o">=</span><span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC847" class="line" lang="java"></span>
<span id="LC848" class="line" lang="java">      <span class="kt">int</span> <span class="n">first</span><span class="o">;</span></span>
<span id="LC849" class="line" lang="java">      <span class="kt">int</span> <span class="n">type</span> <span class="o">=</span> <span class="n">_type</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC850" class="line" lang="java"></span>
<span id="LC851" class="line" lang="java">      <span class="k">if</span> <span class="o">((</span><span class="no">DTM</span><span class="o">.</span><span class="na">ATTRIBUTE_NODE</span> <span class="o">==</span> <span class="n">type</span><span class="o">)</span> <span class="o">||</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NAMESPACE_NODE</span> <span class="o">==</span> <span class="n">type</span><span class="o">))</span></span>
<span id="LC852" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC853" class="line" lang="java">        <span class="n">context</span> <span class="o">=</span> <span class="n">_parent</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC854" class="line" lang="java">        <span class="n">first</span> <span class="o">=</span> <span class="n">_firstch</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC855" class="line" lang="java"></span>
<span id="LC856" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="no">NULL</span> <span class="o">!=</span> <span class="n">first</span><span class="o">)</span></span>
<span id="LC857" class="line" lang="java">          <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">first</span><span class="o">);</span></span>
<span id="LC858" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC859" class="line" lang="java"></span>
<span id="LC860" class="line" lang="java">      <span class="k">do</span></span>
<span id="LC861" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC862" class="line" lang="java">        <span class="n">first</span> <span class="o">=</span> <span class="n">_nextsib</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC863" class="line" lang="java"></span>
<span id="LC864" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="no">NULL</span> <span class="o">==</span> <span class="n">first</span><span class="o">)</span></span>
<span id="LC865" class="line" lang="java">          <span class="n">context</span> <span class="o">=</span> <span class="n">_parent</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC866" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC867" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">NULL</span> <span class="o">==</span> <span class="n">first</span> <span class="o">&amp;&amp;</span> <span class="no">NULL</span> <span class="o">!=</span> <span class="n">context</span><span class="o">);</span></span>
<span id="LC868" class="line" lang="java"></span>
<span id="LC869" class="line" lang="java">      <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">first</span><span class="o">);</span></span>
...
<span id="LC873" class="line" lang="java"><span class="cm">     * Get the first of the following.</span></span>
<span id="LC874" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC875" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal. This is the point</span></span>
<span id="LC876" class="line" lang="java"><span class="cm">     * of origin for the traversal -- its "root node" or starting point.</span></span>
<span id="LC877" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC878" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC879" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC880" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC881" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC882" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC883" class="line" lang="java">                        <span class="c1">// %REVIEW% This looks like it might want shift into identity space</span></span>
<span id="LC884" class="line" lang="java">                        <span class="c1">// to avoid repeated conversion in the individual functions</span></span>
<span id="LC885" class="line" lang="java">      <span class="kt">int</span> <span class="n">first</span><span class="o">;</span></span>
<span id="LC886" class="line" lang="java">      <span class="kt">int</span> <span class="n">type</span> <span class="o">=</span> <span class="n">getNodeType</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC887" class="line" lang="java"></span>
<span id="LC888" class="line" lang="java">      <span class="k">if</span> <span class="o">((</span><span class="no">DTM</span><span class="o">.</span><span class="na">ATTRIBUTE_NODE</span> <span class="o">==</span> <span class="n">type</span><span class="o">)</span> <span class="o">||</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NAMESPACE_NODE</span> <span class="o">==</span> <span class="n">type</span><span class="o">))</span></span>
<span id="LC889" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC890" class="line" lang="java">        <span class="n">context</span> <span class="o">=</span> <span class="n">getParent</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC891" class="line" lang="java">        <span class="n">first</span> <span class="o">=</span> <span class="n">getFirstChild</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC892" class="line" lang="java"></span>
<span id="LC893" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="no">NULL</span> <span class="o">!=</span> <span class="n">first</span><span class="o">)</span></span>
<span id="LC894" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC895" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">first</span><span class="o">)</span> <span class="o">==</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC896" class="line" lang="java">            <span class="k">return</span> <span class="n">first</span><span class="o">;</span></span>
<span id="LC897" class="line" lang="java">          <span class="k">else</span></span>
<span id="LC898" class="line" lang="java">            <span class="k">return</span> <span class="nf">next</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="n">first</span><span class="o">,</span> <span class="n">expandedTypeID</span><span class="o">);</span></span>
...
<span id="LC902" class="line" lang="java">      <span class="k">do</span></span>
<span id="LC903" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC904" class="line" lang="java">        <span class="n">first</span> <span class="o">=</span> <span class="n">getNextSibling</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC905" class="line" lang="java"></span>
<span id="LC906" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="no">NULL</span> <span class="o">==</span> <span class="n">first</span><span class="o">)</span></span>
<span id="LC907" class="line" lang="java">          <span class="n">context</span> <span class="o">=</span> <span class="n">getParent</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC908" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC909" class="line" lang="java">        <span class="o">{</span></span>
<span id="LC910" class="line" lang="java">          <span class="k">if</span> <span class="o">(</span><span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">first</span><span class="o">)</span> <span class="o">==</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC911" class="line" lang="java">            <span class="k">return</span> <span class="n">first</span><span class="o">;</span></span>
<span id="LC912" class="line" lang="java">          <span class="k">else</span></span>
<span id="LC913" class="line" lang="java">            <span class="k">return</span> <span class="nf">next</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="n">first</span><span class="o">,</span> <span class="n">expandedTypeID</span><span class="o">);</span></span>
<span id="LC914" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC915" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC916" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">NULL</span> <span class="o">==</span> <span class="n">first</span> <span class="o">&amp;&amp;</span> <span class="no">NULL</span> <span class="o">!=</span> <span class="n">context</span><span class="o">);</span></span>
<span id="LC917" class="line" lang="java"></span>
<span id="LC918" class="line" lang="java">      <span class="k">return</span> <span class="n">first</span><span class="o">;</span></span>
...
<span id="LC922" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC923" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC924" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC925" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC926" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC927" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC928" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC929" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC930" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC931" class="line" lang="java">                        <span class="c1">// Compute in identity space</span></span>
<span id="LC932" class="line" lang="java">                        <span class="n">current</span><span class="o">=</span><span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
<span id="LC933" class="line" lang="java"></span>
<span id="LC934" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="kc">true</span><span class="o">)</span></span>
<span id="LC935" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC936" class="line" lang="java">        <span class="n">current</span><span class="o">++;</span> <span class="c1">// Only works on IDs, not handles.</span></span>
<span id="LC937" class="line" lang="java"></span>
<span id="LC938" class="line" lang="java">                                <span class="c1">// %REVIEW% Are we using handles or indexes?</span></span>
<span id="LC939" class="line" lang="java">        <span class="kt">int</span> <span class="n">type</span> <span class="o">=</span> <span class="n">_type</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// may call nextNode()</span></span>
<span id="LC940" class="line" lang="java"></span>
<span id="LC941" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="no">NULL</span> <span class="o">==</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC942" class="line" lang="java">          <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC943" class="line" lang="java"></span>
<span id="LC944" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="no">ATTRIBUTE_NODE</span> <span class="o">==</span> <span class="n">type</span> <span class="o">||</span> <span class="no">NAMESPACE_NODE</span> <span class="o">==</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC945" class="line" lang="java">          <span class="k">continue</span><span class="o">;</span></span>
<span id="LC946" class="line" lang="java"></span>
<span id="LC947" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// make handle.</span></span>
...
<span id="LC952" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node that is matched</span></span>
<span id="LC953" class="line" lang="java"><span class="cm">     * by the expanded type ID.</span></span>
<span id="LC954" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC955" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC956" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC957" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC958" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC959" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC960" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC961" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC962" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC963" class="line" lang="java">                        <span class="c1">// Compute in ID space</span></span>
<span id="LC964" class="line" lang="java">                        <span class="n">current</span><span class="o">=</span><span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
<span id="LC965" class="line" lang="java"></span>
<span id="LC966" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="kc">true</span><span class="o">)</span></span>
<span id="LC967" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC968" class="line" lang="java">        <span class="n">current</span><span class="o">++;</span></span>
<span id="LC969" class="line" lang="java"></span>
<span id="LC970" class="line" lang="java">        <span class="kt">int</span> <span class="n">etype</span> <span class="o">=</span> <span class="n">_exptype</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// may call nextNode()</span></span>
<span id="LC971" class="line" lang="java"></span>
<span id="LC972" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="no">NULL</span> <span class="o">==</span> <span class="n">etype</span><span class="o">)</span></span>
<span id="LC973" class="line" lang="java">          <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC974" class="line" lang="java"></span>
<span id="LC975" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">etype</span> <span class="o">!=</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC976" class="line" lang="java">          <span class="k">continue</span><span class="o">;</span></span>
<span id="LC977" class="line" lang="java"></span>
<span id="LC978" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// make handle.</span></span>
...
<span id="LC984" class="line" lang="java"><span class="cm">   * Implements traversal of the Ancestor access, in reverse document order.</span></span>
<span id="LC985" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC986" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">FollowingSiblingTraverser</span> <span class="kd">extends</span> <span class="nc">DTMAxisTraverser</span></span>
...
<span id="LC990" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC991" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC992" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC993" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC994" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC995" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC996" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC997" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC998" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC999" class="line" lang="java">      <span class="k">return</span> <span class="nf">getNextSibling</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
...
<span id="LC1003" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node that is matched</span></span>
<span id="LC1004" class="line" lang="java"><span class="cm">     * by the expanded type ID.</span></span>
<span id="LC1005" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1006" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1007" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1008" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1009" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1010" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1011" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1012" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1013" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1014" class="line" lang="java"></span>
<span id="LC1015" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">getNextSibling</span><span class="o">(</span><span class="n">current</span><span class="o">)))</span></span>
<span id="LC1016" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1017" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">==</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1018" class="line" lang="java">          <span class="k">return</span> <span class="n">current</span><span class="o">;</span></span>
<span id="LC1019" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1020" class="line" lang="java"></span>
<span id="LC1021" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1026" class="line" lang="java"><span class="cm">   * Implements traversal of the Ancestor access, in reverse document order.</span></span>
<span id="LC1027" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1028" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">NamespaceDeclsTraverser</span> <span class="kd">extends</span> <span class="nc">DTMAxisTraverser</span></span>
...
<span id="LC1032" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC1033" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1034" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1035" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1036" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1037" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1038" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1039" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC1040" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1041" class="line" lang="java"></span>
<span id="LC1042" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="n">context</span> <span class="o">==</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC1043" class="line" lang="java">             <span class="o">?</span> <span class="n">getFirstNamespaceNode</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="kc">false</span><span class="o">)</span></span>
<span id="LC1044" class="line" lang="java">             <span class="o">:</span> <span class="n">getNextNamespaceNode</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="n">current</span><span class="o">,</span> <span class="kc">false</span><span class="o">);</span></span>
...
<span id="LC1048" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node that is matched</span></span>
<span id="LC1049" class="line" lang="java"><span class="cm">     * by the expanded type ID.</span></span>
<span id="LC1050" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1051" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1052" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1053" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1054" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1055" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1056" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1057" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1058" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1059" class="line" lang="java"></span>
<span id="LC1060" class="line" lang="java">      <span class="n">current</span> <span class="o">=</span> <span class="o">(</span><span class="n">context</span> <span class="o">==</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC1061" class="line" lang="java">                <span class="o">?</span> <span class="n">getFirstNamespaceNode</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="kc">false</span><span class="o">)</span></span>
<span id="LC1062" class="line" lang="java">                <span class="o">:</span> <span class="n">getNextNamespaceNode</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="n">current</span><span class="o">,</span> <span class="kc">false</span><span class="o">);</span></span>
<span id="LC1063" class="line" lang="java"></span>
<span id="LC1064" class="line" lang="java">      <span class="k">do</span></span>
<span id="LC1065" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1066" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">==</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1067" class="line" lang="java">          <span class="k">return</span> <span class="n">current</span><span class="o">;</span></span>
<span id="LC1068" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1069" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span></span>
<span id="LC1070" class="line" lang="java">             <span class="o">!=</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">getNextNamespaceNode</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="n">current</span><span class="o">,</span> <span class="kc">false</span><span class="o">)));</span></span>
<span id="LC1071" class="line" lang="java"></span>
<span id="LC1072" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1077" class="line" lang="java"><span class="cm">   * Implements traversal of the Ancestor access, in reverse document order.</span></span>
<span id="LC1078" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1079" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">NamespaceTraverser</span> <span class="kd">extends</span> <span class="nc">DTMAxisTraverser</span></span>
...
<span id="LC1083" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC1084" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1085" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1086" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1087" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1088" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1089" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1090" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC1091" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1092" class="line" lang="java"></span>
<span id="LC1093" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="n">context</span> <span class="o">==</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC1094" class="line" lang="java">             <span class="o">?</span> <span class="n">getFirstNamespaceNode</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="kc">true</span><span class="o">)</span></span>
<span id="LC1095" class="line" lang="java">             <span class="o">:</span> <span class="n">getNextNamespaceNode</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="n">current</span><span class="o">,</span> <span class="kc">true</span><span class="o">);</span></span>
...
<span id="LC1099" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node that is matched</span></span>
<span id="LC1100" class="line" lang="java"><span class="cm">     * by the expanded type ID.</span></span>
<span id="LC1101" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1102" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1103" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1104" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1105" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1106" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1107" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1108" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1109" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1110" class="line" lang="java"></span>
<span id="LC1111" class="line" lang="java">      <span class="n">current</span> <span class="o">=</span> <span class="o">(</span><span class="n">context</span> <span class="o">==</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC1112" class="line" lang="java">                <span class="o">?</span> <span class="n">getFirstNamespaceNode</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="kc">true</span><span class="o">)</span></span>
<span id="LC1113" class="line" lang="java">                <span class="o">:</span> <span class="n">getNextNamespaceNode</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="n">current</span><span class="o">,</span> <span class="kc">true</span><span class="o">);</span></span>
<span id="LC1114" class="line" lang="java"></span>
<span id="LC1115" class="line" lang="java">      <span class="k">do</span></span>
<span id="LC1116" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1117" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">==</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1118" class="line" lang="java">          <span class="k">return</span> <span class="n">current</span><span class="o">;</span></span>
<span id="LC1119" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1120" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span></span>
<span id="LC1121" class="line" lang="java">             <span class="o">!=</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">getNextNamespaceNode</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="n">current</span><span class="o">,</span> <span class="kc">true</span><span class="o">)));</span></span>
<span id="LC1122" class="line" lang="java"></span>
<span id="LC1123" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1128" class="line" lang="java"><span class="cm">   * Implements traversal of the Ancestor access, in reverse document order.</span></span>
<span id="LC1129" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1130" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">ParentTraverser</span> <span class="kd">extends</span> <span class="nc">DTMAxisTraverser</span></span>
<span id="LC1131" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1132" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1133" class="line" lang="java"><span class="cm">     * By the nature of the stateless traversal, the context node can not be</span></span>
<span id="LC1134" class="line" lang="java"><span class="cm">     * returned or the iteration will go into an infinate loop.  So to traverse</span></span>
<span id="LC1135" class="line" lang="java"><span class="cm">     * an axis, the first function must be used to get the first node.</span></span>
<span id="LC1136" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1137" class="line" lang="java"><span class="cm">     * &lt;p&gt;This method needs to be overloaded only by those axis that process</span></span>
<span id="LC1138" class="line" lang="java"><span class="cm">     * the self node. &lt;\p&gt;</span></span>
<span id="LC1139" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1140" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal. This is the point</span></span>
<span id="LC1141" class="line" lang="java"><span class="cm">     * that the traversal starts from.</span></span>
<span id="LC1142" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC1143" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1144" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">)</span></span>
<span id="LC1145" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1146" class="line" lang="java">      <span class="k">return</span> <span class="nf">getParent</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
...
<span id="LC1150" class="line" lang="java"><span class="cm">     * By the nature of the stateless traversal, the context node can not be</span></span>
<span id="LC1151" class="line" lang="java"><span class="cm">     * returned or the iteration will go into an infinate loop.  So to traverse</span></span>
<span id="LC1152" class="line" lang="java"><span class="cm">     * an axis, the first function must be used to get the first node.</span></span>
<span id="LC1153" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1154" class="line" lang="java"><span class="cm">     * &lt;p&gt;This method needs to be overloaded only by those axis that process</span></span>
<span id="LC1155" class="line" lang="java"><span class="cm">     * the self node. &lt;\p&gt;</span></span>
<span id="LC1156" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1157" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal. This is the point</span></span>
<span id="LC1158" class="line" lang="java"><span class="cm">     * of origin for the traversal -- its "root node" or starting point.</span></span>
<span id="LC1159" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1160" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1161" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC1162" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1163" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1164" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1165" class="line" lang="java">                        <span class="c1">// Compute in ID space</span></span>
<span id="LC1166" class="line" lang="java">      <span class="n">current</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
<span id="LC1167" class="line" lang="java"></span>
<span id="LC1168" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">m_parent</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">current</span><span class="o">)))</span></span>
<span id="LC1169" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1170" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">m_exptype</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">==</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1171" class="line" lang="java">          <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
<span id="LC1172" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1173" class="line" lang="java"></span>
<span id="LC1174" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1179" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC1180" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1181" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1182" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1183" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1184" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1185" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1186" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC1187" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1188" class="line" lang="java"></span>
<span id="LC1189" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1195" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node that is matched</span></span>
<span id="LC1196" class="line" lang="java"><span class="cm">     * by the expanded type ID.</span></span>
<span id="LC1197" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1198" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1199" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1200" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1201" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1202" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1203" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1204" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1205" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1206" class="line" lang="java"></span>
<span id="LC1207" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1212" class="line" lang="java"><span class="cm">   * Implements traversal of the Ancestor access, in reverse document order.</span></span>
<span id="LC1213" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1214" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">PrecedingTraverser</span> <span class="kd">extends</span> <span class="nc">DTMAxisTraverser</span></span>
...
<span id="LC1218" class="line" lang="java"><span class="cm">     * Tell if the current identity is an ancestor of the context identity.</span></span>
<span id="LC1219" class="line" lang="java"><span class="cm">     * This is an expensive operation, made worse by the stateless traversal.</span></span>
<span id="LC1220" class="line" lang="java"><span class="cm">     * But the preceding axis is used fairly infrequently.</span></span>
<span id="LC1221" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1222" class="line" lang="java"><span class="cm">     * @param contextIdent The context node of the axis traversal.</span></span>
<span id="LC1223" class="line" lang="java"><span class="cm">     * @param currentIdent The node in question.</span></span>
<span id="LC1224" class="line" lang="java"><span class="cm">     * @return true if the currentIdent node is an ancestor of contextIdent.</span></span>
<span id="LC1225" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1226" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">boolean</span> <span class="nf">isAncestor</span><span class="o">(</span><span class="kt">int</span> <span class="n">contextIdent</span><span class="o">,</span> <span class="kt">int</span> <span class="n">currentIdent</span><span class="o">)</span></span>
<span id="LC1227" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1228" class="line" lang="java">                        <span class="c1">// %REVIEW% See comments in IsAfterAxis; using the "successor" of</span></span>
<span id="LC1229" class="line" lang="java">                        <span class="c1">// contextIdent is probably more efficient.</span></span>
<span id="LC1230" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="n">contextIdent</span> <span class="o">=</span> <span class="n">m_parent</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">contextIdent</span><span class="o">);</span> <span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="n">contextIdent</span><span class="o">;</span></span>
<span id="LC1231" class="line" lang="java">              <span class="n">contextIdent</span> <span class="o">=</span> <span class="n">m_parent</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">contextIdent</span><span class="o">))</span></span>
<span id="LC1232" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1233" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">contextIdent</span> <span class="o">==</span> <span class="n">currentIdent</span><span class="o">)</span></span>
...
<span id="LC1237" class="line" lang="java">      <span class="k">return</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC1241" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC1242" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1243" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1244" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1245" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1246" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1247" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1248" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC1249" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1250" class="line" lang="java">                        <span class="c1">// compute in ID space</span></span>
<span id="LC1251" class="line" lang="java">      <span class="kt">int</span> <span class="n">subtreeRootIdent</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC1252" class="line" lang="java"></span>
<span id="LC1253" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">-</span> <span class="mi">1</span><span class="o">;</span> <span class="n">current</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">current</span><span class="o">--)</span></span>
<span id="LC1254" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1255" class="line" lang="java">        <span class="kt">short</span> <span class="n">type</span> <span class="o">=</span> <span class="n">_type</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
<span id="LC1256" class="line" lang="java"></span>
<span id="LC1257" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="no">ATTRIBUTE_NODE</span> <span class="o">==</span> <span class="n">type</span> <span class="o">||</span> <span class="no">NAMESPACE_NODE</span> <span class="o">==</span> <span class="n">type</span></span>
<span id="LC1258" class="line" lang="java">                <span class="o">||</span> <span class="n">isAncestor</span><span class="o">(</span><span class="n">subtreeRootIdent</span><span class="o">,</span> <span class="n">current</span><span class="o">))</span></span>
<span id="LC1259" class="line" lang="java">          <span class="k">continue</span><span class="o">;</span></span>
<span id="LC1260" class="line" lang="java"></span>
<span id="LC1261" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// make handle.</span></span>
<span id="LC1262" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1263" class="line" lang="java"></span>
<span id="LC1264" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1268" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node that is matched</span></span>
<span id="LC1269" class="line" lang="java"><span class="cm">     * by the expanded type ID.</span></span>
<span id="LC1270" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1271" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1272" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1273" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1274" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1275" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1276" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1277" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1278" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1279" class="line" lang="java">                        <span class="c1">// Compute in ID space</span></span>
<span id="LC1280" class="line" lang="java">      <span class="kt">int</span> <span class="n">subtreeRootIdent</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC1281" class="line" lang="java"></span>
<span id="LC1282" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">-</span> <span class="mi">1</span><span class="o">;</span> <span class="n">current</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">current</span><span class="o">--)</span></span>
<span id="LC1283" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1284" class="line" lang="java">        <span class="kt">int</span> <span class="n">exptype</span> <span class="o">=</span> <span class="n">m_exptype</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
<span id="LC1285" class="line" lang="java"></span>
<span id="LC1286" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">exptype</span> <span class="o">!=</span> <span class="n">expandedTypeID</span></span>
<span id="LC1287" class="line" lang="java">                <span class="o">||</span> <span class="n">isAncestor</span><span class="o">(</span><span class="n">subtreeRootIdent</span><span class="o">,</span> <span class="n">current</span><span class="o">))</span></span>
<span id="LC1288" class="line" lang="java">          <span class="k">continue</span><span class="o">;</span></span>
<span id="LC1289" class="line" lang="java"></span>
<span id="LC1290" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// make handle.</span></span>
<span id="LC1291" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1292" class="line" lang="java"></span>
<span id="LC1293" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1298" class="line" lang="java"><span class="cm">   * Implements traversal of the Ancestor and the Preceding axis,</span></span>
<span id="LC1299" class="line" lang="java"><span class="cm">   * in reverse document order.</span></span>
<span id="LC1300" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1301" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">PrecedingAndAncestorTraverser</span> <span class="kd">extends</span> <span class="nc">DTMAxisTraverser</span></span>
...
<span id="LC1305" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC1306" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1307" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1308" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1309" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1310" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1311" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1312" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC1313" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1314" class="line" lang="java">                        <span class="c1">// Compute in ID space</span></span>
<span id="LC1315" class="line" lang="java">      <span class="kt">int</span> <span class="n">subtreeRootIdent</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">context</span> <span class="o">);</span></span>
<span id="LC1316" class="line" lang="java"></span>
<span id="LC1317" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">-</span> <span class="mi">1</span><span class="o">;</span> <span class="n">current</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">current</span><span class="o">--)</span></span>
<span id="LC1318" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1319" class="line" lang="java">        <span class="kt">short</span> <span class="n">type</span> <span class="o">=</span> <span class="n">_type</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
<span id="LC1320" class="line" lang="java"></span>
<span id="LC1321" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="no">ATTRIBUTE_NODE</span> <span class="o">==</span> <span class="n">type</span> <span class="o">||</span> <span class="no">NAMESPACE_NODE</span> <span class="o">==</span> <span class="n">type</span><span class="o">)</span></span>
<span id="LC1322" class="line" lang="java">          <span class="k">continue</span><span class="o">;</span></span>
<span id="LC1323" class="line" lang="java"></span>
<span id="LC1324" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// make handle.</span></span>
<span id="LC1325" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1326" class="line" lang="java"></span>
<span id="LC1327" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1331" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node that is matched</span></span>
<span id="LC1332" class="line" lang="java"><span class="cm">     * by the expanded type ID.</span></span>
<span id="LC1333" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1334" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1335" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1336" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1337" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1338" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1339" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1340" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1341" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1342" class="line" lang="java">                        <span class="c1">// Compute in ID space</span></span>
<span id="LC1343" class="line" lang="java">      <span class="kt">int</span> <span class="n">subtreeRootIdent</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC1344" class="line" lang="java"></span>
<span id="LC1345" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">-</span> <span class="mi">1</span><span class="o">;</span> <span class="n">current</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="o">;</span> <span class="n">current</span><span class="o">--)</span></span>
<span id="LC1346" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1347" class="line" lang="java">        <span class="kt">int</span> <span class="n">exptype</span> <span class="o">=</span> <span class="n">m_exptype</span><span class="o">.</span><span class="na">elementAt</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
<span id="LC1348" class="line" lang="java"></span>
<span id="LC1349" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">exptype</span> <span class="o">!=</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1350" class="line" lang="java">          <span class="k">continue</span><span class="o">;</span></span>
<span id="LC1351" class="line" lang="java"></span>
<span id="LC1352" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// make handle.</span></span>
<span id="LC1353" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1354" class="line" lang="java"></span>
<span id="LC1355" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1360" class="line" lang="java"><span class="cm">   * Implements traversal of the Ancestor access, in reverse document order.</span></span>
<span id="LC1361" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1362" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">PrecedingSiblingTraverser</span> <span class="kd">extends</span> <span class="nc">DTMAxisTraverser</span></span>
...
<span id="LC1366" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC1367" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1368" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1369" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1370" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1371" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1372" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1373" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC1374" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1375" class="line" lang="java">      <span class="k">return</span> <span class="nf">getPreviousSibling</span><span class="o">(</span><span class="n">current</span><span class="o">);</span></span>
...
<span id="LC1379" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node that is matched</span></span>
<span id="LC1380" class="line" lang="java"><span class="cm">     * by the expanded type ID.</span></span>
<span id="LC1381" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1382" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1383" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1384" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1385" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1386" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1387" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1388" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1389" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1390" class="line" lang="java"></span>
<span id="LC1391" class="line" lang="java">      <span class="k">while</span> <span class="o">(</span><span class="no">DTM</span><span class="o">.</span><span class="na">NULL</span> <span class="o">!=</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">getPreviousSibling</span><span class="o">(</span><span class="n">current</span><span class="o">)))</span></span>
<span id="LC1392" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1393" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">==</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1394" class="line" lang="java">          <span class="k">return</span> <span class="n">current</span><span class="o">;</span></span>
<span id="LC1395" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1396" class="line" lang="java"></span>
<span id="LC1397" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1402" class="line" lang="java"><span class="cm">   * Implements traversal of the Self axis.</span></span>
<span id="LC1403" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1404" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">SelfTraverser</span> <span class="kd">extends</span> <span class="nc">DTMAxisTraverser</span></span>
...
<span id="LC1408" class="line" lang="java"><span class="cm">     * By the nature of the stateless traversal, the context node can not be</span></span>
<span id="LC1409" class="line" lang="java"><span class="cm">     * returned or the iteration will go into an infinate loop.  To see if</span></span>
<span id="LC1410" class="line" lang="java"><span class="cm">     * the self node should be processed, use this function.</span></span>
<span id="LC1411" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1412" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal.</span></span>
<span id="LC1413" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1414" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC1415" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1416" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">)</span></span>
<span id="LC1417" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1418" class="line" lang="java">      <span class="k">return</span> <span class="n">context</span><span class="o">;</span></span>
...
<span id="LC1422" class="line" lang="java"><span class="cm">     * By the nature of the stateless traversal, the context node can not be</span></span>
<span id="LC1423" class="line" lang="java"><span class="cm">     * returned or the iteration will go into an infinate loop.  To see if</span></span>
<span id="LC1424" class="line" lang="java"><span class="cm">     * the self node should be processed, use this function.  If the context</span></span>
<span id="LC1425" class="line" lang="java"><span class="cm">     * node does not match the expanded type ID, this function will return</span></span>
<span id="LC1426" class="line" lang="java"><span class="cm">     * false.</span></span>
<span id="LC1427" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1428" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal.</span></span>
<span id="LC1429" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1430" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1431" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC1432" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1433" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1434" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1435" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">context</span><span class="o">)</span> <span class="o">==</span> <span class="n">expandedTypeID</span><span class="o">)</span> <span class="o">?</span> <span class="n">context</span> <span class="o">:</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1439" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC1440" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1441" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1442" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1443" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1444" class="line" lang="java"><span class="cm">     * @return Always return NULL for this axis.</span></span>
<span id="LC1445" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1446" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC1447" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1448" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1452" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node that is matched</span></span>
<span id="LC1453" class="line" lang="java"><span class="cm">     * by the expanded type ID.</span></span>
<span id="LC1454" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1455" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1456" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1457" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1458" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1459" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1460" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1461" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1462" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1463" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1468" class="line" lang="java"><span class="cm">   * Implements traversal of the Ancestor access, in reverse document order.</span></span>
<span id="LC1469" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1470" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">AllFromRootTraverser</span> <span class="kd">extends</span> <span class="nc">AllFromNodeTraverser</span></span>
...
<span id="LC1474" class="line" lang="java"><span class="cm">     * Return the root.</span></span>
<span id="LC1475" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1476" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal.</span></span>
<span id="LC1477" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1478" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC1479" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1480" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">)</span></span>
<span id="LC1481" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1482" class="line" lang="java">      <span class="k">return</span> <span class="nf">getDocumentRoot</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
...
<span id="LC1486" class="line" lang="java"><span class="cm">     * Return the root if it matches the expanded type ID.</span></span>
<span id="LC1487" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1488" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal.</span></span>
<span id="LC1489" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1490" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1491" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC1492" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1493" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1494" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1495" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">getDocumentRoot</span><span class="o">(</span><span class="n">context</span><span class="o">))</span> <span class="o">==</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1496" class="line" lang="java">             <span class="o">?</span> <span class="n">context</span> <span class="o">:</span> <span class="n">next</span><span class="o">(</span><span class="n">context</span><span class="o">,</span> <span class="n">context</span><span class="o">,</span> <span class="n">expandedTypeID</span><span class="o">);</span></span>
...
<span id="LC1500" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC1501" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1502" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1503" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1504" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1505" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1506" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1507" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC1508" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1509" class="line" lang="java">                        <span class="c1">// Compute in ID space</span></span>
<span id="LC1510" class="line" lang="java">      <span class="kt">int</span> <span class="n">subtreeRootIdent</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC1511" class="line" lang="java"></span>
<span id="LC1512" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">+</span> <span class="mi">1</span><span class="o">;</span> <span class="o">;</span> <span class="n">current</span><span class="o">++)</span></span>
<span id="LC1513" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1514" class="line" lang="java">                                <span class="c1">// Kluge test: Just make sure +1 yielded a real node</span></span>
<span id="LC1515" class="line" lang="java">        <span class="kt">int</span> <span class="n">type</span> <span class="o">=</span> <span class="n">_type</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// may call nextNode()</span></span>
<span id="LC1516" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">type</span> <span class="o">==</span> <span class="no">NULL</span><span class="o">)</span></span>
<span id="LC1517" class="line" lang="java">          <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC1518" class="line" lang="java"></span>
<span id="LC1519" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// make handle.</span></span>
...
<span id="LC1524" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node that is matched</span></span>
<span id="LC1525" class="line" lang="java"><span class="cm">     * by the expanded type ID.</span></span>
<span id="LC1526" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1527" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1528" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1529" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1530" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1531" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1532" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1533" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1534" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1535" class="line" lang="java">                        <span class="c1">// Compute in ID space</span></span>
<span id="LC1536" class="line" lang="java">      <span class="kt">int</span> <span class="n">subtreeRootIdent</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC1537" class="line" lang="java"></span>
<span id="LC1538" class="line" lang="java">      <span class="k">for</span> <span class="o">(</span><span class="n">current</span> <span class="o">=</span> <span class="n">makeNodeIdentity</span><span class="o">(</span><span class="n">current</span><span class="o">)</span> <span class="o">+</span> <span class="mi">1</span><span class="o">;</span> <span class="o">;</span> <span class="n">current</span><span class="o">++)</span></span>
<span id="LC1539" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1540" class="line" lang="java">        <span class="kt">int</span> <span class="n">exptype</span> <span class="o">=</span> <span class="n">_exptype</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// may call nextNode()</span></span>
<span id="LC1541" class="line" lang="java"></span>
<span id="LC1542" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">exptype</span> <span class="o">==</span> <span class="no">NULL</span><span class="o">)</span></span>
<span id="LC1543" class="line" lang="java">          <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
<span id="LC1544" class="line" lang="java"></span>
<span id="LC1545" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">exptype</span> <span class="o">!=</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1546" class="line" lang="java">          <span class="k">continue</span><span class="o">;</span></span>
<span id="LC1547" class="line" lang="java"></span>
<span id="LC1548" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">current</span><span class="o">);</span>  <span class="c1">// make handle.</span></span>
...
<span id="LC1554" class="line" lang="java"><span class="cm">   * Implements traversal of the Self axis.</span></span>
<span id="LC1555" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1556" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">RootTraverser</span> <span class="kd">extends</span> <span class="nc">AllFromRootTraverser</span></span>
<span id="LC1557" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC1558" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC1559" class="line" lang="java"><span class="cm">     * Return the root if it matches the expanded type ID,</span></span>
<span id="LC1560" class="line" lang="java"><span class="cm">     * else return null (nothing found)</span></span>
<span id="LC1561" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1562" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal.</span></span>
<span id="LC1563" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1564" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1565" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC1566" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1567" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1568" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1569" class="line" lang="java">      <span class="kt">int</span> <span class="n">root</span><span class="o">=</span><span class="n">getDocumentRoot</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC1570" class="line" lang="java">      <span class="k">return</span> <span class="o">(</span><span class="n">getExpandedTypeID</span><span class="o">(</span><span class="n">root</span><span class="o">)</span> <span class="o">==</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1571" class="line" lang="java">        <span class="o">?</span> <span class="n">root</span> <span class="o">:</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1575" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node.</span></span>
<span id="LC1576" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1577" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1578" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1579" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1580" class="line" lang="java"><span class="cm">     * @return Always return NULL for this axis.</span></span>
<span id="LC1581" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1582" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">)</span></span>
<span id="LC1583" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1584" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1588" class="line" lang="java"><span class="cm">     * Traverse to the next node after the current node that is matched</span></span>
<span id="LC1589" class="line" lang="java"><span class="cm">     * by the expanded type ID.</span></span>
<span id="LC1590" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1591" class="line" lang="java"><span class="cm">     * @param context The context node of this iteration.</span></span>
<span id="LC1592" class="line" lang="java"><span class="cm">     * @param current The current node of the iteration.</span></span>
<span id="LC1593" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1594" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1595" class="line" lang="java"><span class="cm">     * @return the next node in the iteration, or DTM.NULL.</span></span>
<span id="LC1596" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1597" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">current</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1598" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1599" class="line" lang="java">      <span class="k">return</span> <span class="no">NULL</span><span class="o">;</span></span>
...
<span id="LC1604" class="line" lang="java"><span class="cm">   * A non-xpath axis, returns all nodes that aren't namespaces or attributes,</span></span>
<span id="LC1605" class="line" lang="java"><span class="cm">   * from and including the root.</span></span>
<span id="LC1606" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1607" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">DescendantOrSelfFromRootTraverser</span> <span class="kd">extends</span> <span class="nc">DescendantTraverser</span></span>
...
<span id="LC1611" class="line" lang="java"><span class="cm">     * Get the first potential identity that can be returned, which is the axis</span></span>
<span id="LC1612" class="line" lang="java"><span class="cm">     * root context in this case.</span></span>
<span id="LC1613" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1614" class="line" lang="java"><span class="cm">     * @param identity The node identity of the root context of the traversal.</span></span>
<span id="LC1615" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1616" class="line" lang="java"><span class="cm">     * @return The identity argument.</span></span>
<span id="LC1617" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1618" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">int</span> <span class="nf">getFirstPotential</span><span class="o">(</span><span class="kt">int</span> <span class="n">identity</span><span class="o">)</span></span>
<span id="LC1619" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1620" class="line" lang="java">      <span class="k">return</span> <span class="n">identity</span><span class="o">;</span></span>
...
<span id="LC1624" class="line" lang="java"><span class="cm">     * Get the first potential identity that can be returned.</span></span>
<span id="LC1625" class="line" lang="java"><span class="cm">     * @param handle handle to the root context.</span></span>
<span id="LC1626" class="line" lang="java"><span class="cm">     * @return identity of the root of the subtree.</span></span>
<span id="LC1627" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1628" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">int</span> <span class="nf">getSubtreeRoot</span><span class="o">(</span><span class="kt">int</span> <span class="n">handle</span><span class="o">)</span></span>
<span id="LC1629" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1630" class="line" lang="java">                        <span class="c1">// %REVIEW% Shouldn't this always be 0?</span></span>
<span id="LC1631" class="line" lang="java">      <span class="k">return</span> <span class="nf">makeNodeIdentity</span><span class="o">(</span><span class="n">getDocument</span><span class="o">());</span></span>
...
<span id="LC1635" class="line" lang="java"><span class="cm">     * Return the root.</span></span>
<span id="LC1636" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1637" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal.</span></span>
<span id="LC1638" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1639" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC1640" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1641" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">)</span></span>
<span id="LC1642" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1643" class="line" lang="java">      <span class="k">return</span> <span class="nf">getDocumentRoot</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
...
<span id="LC1647" class="line" lang="java"><span class="cm">     * By the nature of the stateless traversal, the context node can not be</span></span>
<span id="LC1648" class="line" lang="java"><span class="cm">     * returned or the iteration will go into an infinate loop.  So to traverse</span></span>
<span id="LC1649" class="line" lang="java"><span class="cm">     * an axis, the first function must be used to get the first node.</span></span>
<span id="LC1650" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1651" class="line" lang="java"><span class="cm">     * &lt;p&gt;This method needs to be overloaded only by those axis that process</span></span>
<span id="LC1652" class="line" lang="java"><span class="cm">     * the self node. &lt;\p&gt;</span></span>
<span id="LC1653" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1654" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal. This is the point</span></span>
<span id="LC1655" class="line" lang="java"><span class="cm">     * of origin for the traversal -- its "root node" or starting point.</span></span>
<span id="LC1656" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1657" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1658" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC1659" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1660" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1661" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1662" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">isIndexed</span><span class="o">(</span><span class="n">expandedTypeID</span><span class="o">))</span></span>
<span id="LC1663" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1664" class="line" lang="java">        <span class="kt">int</span> <span class="n">identity</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC1665" class="line" lang="java">        <span class="kt">int</span> <span class="n">firstPotential</span> <span class="o">=</span> <span class="n">getFirstPotential</span><span class="o">(</span><span class="n">identity</span><span class="o">);</span></span>
<span id="LC1666" class="line" lang="java"></span>
<span id="LC1667" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">getNextIndexed</span><span class="o">(</span><span class="n">identity</span><span class="o">,</span> <span class="n">firstPotential</span><span class="o">,</span> <span class="n">expandedTypeID</span><span class="o">));</span></span>
<span id="LC1668" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1669" class="line" lang="java"></span>
<span id="LC1670" class="line" lang="java">      <span class="kt">int</span> <span class="n">root</span> <span class="o">=</span> <span class="n">first</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC1671" class="line" lang="java">      <span class="k">return</span> <span class="nf">next</span><span class="o">(</span><span class="n">root</span><span class="o">,</span> <span class="n">root</span><span class="o">,</span> <span class="n">expandedTypeID</span><span class="o">);</span></span>
...
<span id="LC1676" class="line" lang="java"><span class="cm">   * A non-xpath axis, returns all nodes that aren't namespaces or attributes,</span></span>
<span id="LC1677" class="line" lang="java"><span class="cm">   * from but not including the root.</span></span>
<span id="LC1678" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC1679" class="line" lang="java">  <span class="kd">private</span> <span class="kd">class</span> <span class="nc">DescendantFromRootTraverser</span> <span class="kd">extends</span> <span class="nc">DescendantTraverser</span></span>
...
<span id="LC1683" class="line" lang="java"><span class="cm">     * Get the first potential identity that can be returned, which is the axis</span></span>
<span id="LC1684" class="line" lang="java"><span class="cm">     * root context in this case.</span></span>
<span id="LC1685" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1686" class="line" lang="java"><span class="cm">     * @param identity The node identity of the root context of the traversal.</span></span>
<span id="LC1687" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1688" class="line" lang="java"><span class="cm">     * @return The identity argument.</span></span>
<span id="LC1689" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1690" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">int</span> <span class="nf">getFirstPotential</span><span class="o">(</span><span class="kt">int</span> <span class="n">identity</span><span class="o">)</span></span>
<span id="LC1691" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1692" class="line" lang="java">      <span class="k">return</span> <span class="nf">_firstch</span><span class="o">(</span><span class="mi">0</span><span class="o">);</span></span>
...
<span id="LC1696" class="line" lang="java"><span class="cm">     * Get the first potential identity that can be returned.</span></span>
<span id="LC1697" class="line" lang="java"><span class="cm">     * @param handle handle to the root context.</span></span>
<span id="LC1698" class="line" lang="java"><span class="cm">     * @return identity of the root of the subtree.</span></span>
<span id="LC1699" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1700" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">int</span> <span class="nf">getSubtreeRoot</span><span class="o">(</span><span class="kt">int</span> <span class="n">handle</span><span class="o">)</span></span>
<span id="LC1701" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1702" class="line" lang="java">      <span class="k">return</span> <span class="mi">0</span><span class="o">;</span></span>
...
<span id="LC1706" class="line" lang="java"><span class="cm">     * Return the root.</span></span>
<span id="LC1707" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1708" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal.</span></span>
<span id="LC1709" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1710" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC1711" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1712" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">)</span></span>
<span id="LC1713" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1714" class="line" lang="java">      <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">_firstch</span><span class="o">(</span><span class="mi">0</span><span class="o">));</span></span>
...
<span id="LC1718" class="line" lang="java"><span class="cm">     * By the nature of the stateless traversal, the context node can not be</span></span>
<span id="LC1719" class="line" lang="java"><span class="cm">     * returned or the iteration will go into an infinate loop.  So to traverse</span></span>
<span id="LC1720" class="line" lang="java"><span class="cm">     * an axis, the first function must be used to get the first node.</span></span>
<span id="LC1721" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1722" class="line" lang="java"><span class="cm">     * &lt;p&gt;This method needs to be overloaded only by those axis that process</span></span>
<span id="LC1723" class="line" lang="java"><span class="cm">     * the self node. &lt;\p&gt;</span></span>
<span id="LC1724" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1725" class="line" lang="java"><span class="cm">     * @param context The context node of this traversal. This is the point</span></span>
<span id="LC1726" class="line" lang="java"><span class="cm">     * of origin for the traversal -- its "root node" or starting point.</span></span>
<span id="LC1727" class="line" lang="java"><span class="cm">     * @param expandedTypeID The expanded type ID that must match.</span></span>
<span id="LC1728" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC1729" class="line" lang="java"><span class="cm">     * @return the first node in the traversal.</span></span>
<span id="LC1730" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC1731" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">first</span><span class="o">(</span><span class="kt">int</span> <span class="n">context</span><span class="o">,</span> <span class="kt">int</span> <span class="n">expandedTypeID</span><span class="o">)</span></span>
<span id="LC1732" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC1733" class="line" lang="java">      <span class="k">if</span> <span class="o">(</span><span class="n">isIndexed</span><span class="o">(</span><span class="n">expandedTypeID</span><span class="o">))</span></span>
<span id="LC1734" class="line" lang="java">      <span class="o">{</span></span>
<span id="LC1735" class="line" lang="java">        <span class="kt">int</span> <span class="n">identity</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></span>
<span id="LC1736" class="line" lang="java">        <span class="kt">int</span> <span class="n">firstPotential</span> <span class="o">=</span> <span class="n">getFirstPotential</span><span class="o">(</span><span class="n">identity</span><span class="o">);</span></span>
<span id="LC1737" class="line" lang="java"></span>
<span id="LC1738" class="line" lang="java">        <span class="k">return</span> <span class="nf">makeNodeHandle</span><span class="o">(</span><span class="n">getNextIndexed</span><span class="o">(</span><span class="n">identity</span><span class="o">,</span> <span class="n">firstPotential</span><span class="o">,</span> <span class="n">expandedTypeID</span><span class="o">));</span></span>
<span id="LC1739" class="line" lang="java">      <span class="o">}</span></span>
<span id="LC1740" class="line" lang="java"></span>
<span id="LC1741" class="line" lang="java">      <span class="kt">int</span> <span class="n">root</span> <span class="o">=</span> <span class="n">getDocumentRoot</span><span class="o">(</span><span class="n">context</span><span class="o">);</span></span>
<span id="LC1742" class="line" lang="java">      <span class="k">return</span> <span class="nf">next</span><span class="o">(</span><span class="n">root</span><span class="o">,</span> <span class="n">root</span><span class="o">,</span> <span class="n">expandedTypeID</span><span class="o">);</span></span>
