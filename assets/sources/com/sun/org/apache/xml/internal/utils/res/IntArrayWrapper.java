...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: IntArrayWrapper.java,v 1.1.4.1 2005/09/08 11:39:32 suresh_emailid Exp $</span></span>
...
<span id="LC27" class="line" lang="java"><span class="cm"> * It is a mutable object to wrap the int[] used in</span></span>
...
<span id="LC30" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">IntArrayWrapper</span> <span class="o">{</span></span>
<span id="LC31" class="line" lang="java">    <span class="kd">private</span> <span class="kt">int</span><span class="o">[]</span> <span class="n">m_int</span><span class="o">;</span></span>
<span id="LC32" class="line" lang="java"></span>
<span id="LC33" class="line" lang="java">    <span class="kd">public</span> <span class="nf">IntArrayWrapper</span><span class="o">(</span><span class="kt">int</span><span class="o">[]</span> <span class="n">arg</span><span class="o">){</span></span>
<span id="LC34" class="line" lang="java">        <span class="n">m_int</span> <span class="o">=</span> <span class="n">arg</span><span class="o">;</span></span>
<span id="LC35" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC36" class="line" lang="java"></span>
<span id="LC37" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getInt</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">){</span></span>
<span id="LC38" class="line" lang="java">        <span class="k">return</span> <span class="n">m_int</span><span class="o">[</span><span class="n">index</span><span class="o">];</span></span>
...
<span id="LC42" class="line" lang="java">        <span class="k">return</span> <span class="n">m_int</span><span class="o">.</span><span class="na">length</span><span class="o">;</span></span>
