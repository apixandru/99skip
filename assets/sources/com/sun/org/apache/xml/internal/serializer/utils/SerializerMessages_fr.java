...
<span id="LC43" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">SerializerMessages_fr</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span> <span class="o">{</span></span>
...
<span id="LC73" class="line" lang="java">                <span class="s">"La cl\u00E9 de message ''{0}'' ne figure pas dans la classe de messages ''{1}''"</span> <span class="o">},</span></span>
...
<span id="LC76" class="line" lang="java">                <span class="s">"Echec du format de message ''{0}'' dans la classe de messages ''{1}''."</span> <span class="o">},</span></span>
...
<span id="LC79" class="line" lang="java">                <span class="s">"La classe de serializer ''{0}'' n''impl\u00E9mente pas org.xml.sax.ContentHandler."</span> <span class="o">},</span></span>
...
<span id="LC82" class="line" lang="java">                    <span class="s">"La ressource [ {0} ] est introuvable.\n {1}"</span> <span class="o">},</span></span>
...
<span id="LC85" class="line" lang="java">                    <span class="s">"La ressource [ {0} ] n''a pas pu charger : {1} \n {2} \t {3}"</span> <span class="o">},</span></span>
...
<span id="LC88" class="line" lang="java">                    <span class="s">"Taille du tampon &lt;=0"</span> <span class="o">},</span></span>
...
<span id="LC91" class="line" lang="java">                    <span class="s">"Substitut UTF-16 non valide d\u00E9tect\u00E9 : {0} ?"</span> <span class="o">},</span></span>
...
<span id="LC94" class="line" lang="java">                <span class="s">"Erreur d'E/S"</span> <span class="o">},</span></span>
...
<span id="LC97" class="line" lang="java">                <span class="s">"Impossible d''ajouter l''attribut {0} apr\u00E8s des noeuds enfant ou avant la production d''un \u00E9l\u00E9ment. L''attribut est ignor\u00E9."</span> <span class="o">},</span></span>
...
<span id="LC105" class="line" lang="java">                <span class="s">"L''espace de noms du pr\u00E9fixe ''{0}'' n''a pas \u00E9t\u00E9 d\u00E9clar\u00E9."</span> <span class="o">},</span></span>
...
<span id="LC114" class="line" lang="java">                <span class="s">"Attribut ''{0}'' en dehors de l''\u00E9l\u00E9ment."</span> <span class="o">},</span></span>
...
<span id="LC124" class="line" lang="java">                <span class="s">"La d\u00E9claration d''espace de noms ''{0}''=''{1}'' est \u00E0 l''ext\u00E9rieur de l''\u00E9l\u00E9ment."</span> <span class="o">},</span></span>
...
<span id="LC127" class="line" lang="java">                <span class="s">"Impossible de charger ''{0}'' (v\u00E9rifier CLASSPATH), les valeurs par d\u00E9faut sont donc employ\u00E9es"</span> <span class="o">},</span></span>
...
<span id="LC130" class="line" lang="java">                <span class="s">"Tentative de sortie d''un caract\u00E8re avec une valeur enti\u00E8re {0}, non repr\u00E9sent\u00E9 dans l''encodage de sortie sp\u00E9cifi\u00E9 pour {1}."</span> <span class="o">},</span></span>
...
<span id="LC133" class="line" lang="java">                <span class="s">"Impossible de charger le fichier de propri\u00E9t\u00E9s ''{0}'' pour la m\u00E9thode de sortie ''{1}'' (v\u00E9rifier CLASSPATH)"</span> <span class="o">},</span></span>
...
<span id="LC136" class="line" lang="java">                <span class="s">"Num\u00E9ro de port non valide"</span> <span class="o">},</span></span>
...
<span id="LC139" class="line" lang="java">                <span class="s">"Impossible de d\u00E9finir le port quand l'h\u00F4te est NULL"</span> <span class="o">},</span></span>
...
<span id="LC142" class="line" lang="java">                <span class="s">"Le format de l'adresse de l'h\u00F4te n'est pas correct"</span> <span class="o">},</span></span>
...
<span id="LC145" class="line" lang="java">                <span class="s">"Le mod\u00E8le n'est pas conforme."</span> <span class="o">},</span></span>
...
<span id="LC148" class="line" lang="java">                <span class="s">"Impossible de d\u00E9finir le mod\u00E8le \u00E0 partir de la cha\u00EEne NULL"</span> <span class="o">},</span></span>
...
<span id="LC151" class="line" lang="java">                <span class="s">"Le chemin d'acc\u00E8s contient une s\u00E9quence d'\u00E9chappement non valide"</span> <span class="o">},</span></span>
...
<span id="LC154" class="line" lang="java">                <span class="s">"Le chemin contient un caract\u00E8re non valide : {0}"</span> <span class="o">},</span></span>
...
<span id="LC157" class="line" lang="java">                <span class="s">"Le fragment contient un caract\u00E8re non valide"</span> <span class="o">},</span></span>
...
<span id="LC160" class="line" lang="java">                <span class="s">"Impossible de d\u00E9finir le fragment quand le chemin d'acc\u00E8s est NULL"</span> <span class="o">},</span></span>
...
<span id="LC163" class="line" lang="java">                <span class="s">"Le fragment ne peut \u00EAtre d\u00E9fini que pour un URI g\u00E9n\u00E9rique"</span> <span class="o">},</span></span>
...
<span id="LC166" class="line" lang="java">                <span class="s">"Mod\u00E8le introuvable dans l'URI"</span> <span class="o">},</span></span>
...
<span id="LC169" class="line" lang="java">                <span class="s">"Impossible d'initialiser l'URI avec des param\u00E8tres vides"</span> <span class="o">},</span></span>
...
<span id="LC172" class="line" lang="java">                <span class="s">"Le fragment ne doit pas \u00EAtre indiqu\u00E9 \u00E0 la fois dans le chemin et dans le fragment"</span> <span class="o">},</span></span>
...
<span id="LC175" class="line" lang="java">                <span class="s">"La cha\u00EEne de requ\u00EAte ne doit pas figurer dans un chemin et une cha\u00EEne de requ\u00EAte"</span> <span class="o">},</span></span>
...
<span id="LC178" class="line" lang="java">                <span class="s">"Le port peut ne pas \u00EAtre sp\u00E9cifi\u00E9 si l'h\u00F4te ne l'est pas"</span> <span class="o">},</span></span>
...
<span id="LC181" class="line" lang="java">                <span class="s">"Userinfo peut ne pas \u00EAtre sp\u00E9cifi\u00E9 si l'h\u00F4te ne l'est pas"</span> <span class="o">},</span></span>
...
<span id="LC184" class="line" lang="java">                <span class="s">"Avertissement : la version du document de sortie doit \u00EAtre ''{0}''. Cette version XML n''est pas prise en charge. La version du document de sortie sera ''1.0''."</span> <span class="o">},</span></span>
...
<span id="LC187" class="line" lang="java">                <span class="s">"Mod\u00E8le obligatoire."</span> <span class="o">},</span></span>
...
<span id="LC195" class="line" lang="java">                <span class="s">"L''objet de propri\u00E9t\u00E9s transmis \u00E0 SerializerFactory ne comporte aucune propri\u00E9t\u00E9 ''{0}''."</span> <span class="o">},</span></span>
...
<span id="LC198" class="line" lang="java">                <span class="s">"Avertissement : l''encodage ''{0}'' n''est pas pris en charge par l''ex\u00E9cution Java."</span> <span class="o">},</span></span>
