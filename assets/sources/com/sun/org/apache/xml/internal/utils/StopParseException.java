...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: StopParseException.java,v 1.2.4.1 2005/09/15 08:15:54 suresh_emailid Exp $</span></span>
...
<span id="LC26" class="line" lang="java"><span class="cm"> * This is a special exception that is used to stop parsing when</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * search for an element.  For instance, when searching for xml:stylesheet</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> * PIs, it is used to stop the parse once the document element is found.</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> * @see StylesheetPIHandler</span></span>
...
<span id="LC32" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">StopParseException</span> <span class="kd">extends</span> <span class="n">org</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">sax</span><span class="o">.</span><span class="na">SAXException</span></span>
<span id="LC33" class="line" lang="java"><span class="o">{</span></span>
<span id="LC34" class="line" lang="java">        <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="mi">210102479218258961L</span><span class="o">;</span></span>
<span id="LC35" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC36" class="line" lang="java"><span class="cm">   * Constructor StopParseException.</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC38" class="line" lang="java">  <span class="nc">StopParseException</span><span class="o">()</span></span>
<span id="LC39" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC40" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="s">"Stylesheet PIs found, stop the parse"</span><span class="o">);</span></span>
