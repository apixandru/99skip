...
<span id="LC24" class="line" lang="java"><span class="cm"> *  Represents a PSVI item for one element information item.</span></span>
<span id="LC25" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC26" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">ElementPSVI</span> <span class="kd">extends</span> <span class="nc">ItemPSVI</span> <span class="o">{</span></span>
<span id="LC27" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC28" class="line" lang="java"><span class="cm">     * [element declaration]: an item isomorphic to the element declaration</span></span>
<span id="LC29" class="line" lang="java"><span class="cm">     * used to validate this element.</span></span>
<span id="LC30" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC31" class="line" lang="java">    <span class="kd">public</span> <span class="nc">XSElementDeclaration</span> <span class="nf">getElementDeclaration</span><span class="o">();</span></span>
<span id="LC32" class="line" lang="java"></span>
<span id="LC33" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC34" class="line" lang="java"><span class="cm">     *  [notation]: the notation declaration.</span></span>
<span id="LC35" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC36" class="line" lang="java">    <span class="kd">public</span> <span class="nc">XSNotationDeclaration</span> <span class="nf">getNotation</span><span class="o">();</span></span>
<span id="LC37" class="line" lang="java"></span>
<span id="LC38" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">     * [nil]: true if clause 3.2 of Element Locally Valid (Element) (3.3.4) is</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">     * satisfied, otherwise false.</span></span>
<span id="LC41" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC42" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">getNil</span><span class="o">();</span></span>
<span id="LC43" class="line" lang="java"></span>
<span id="LC44" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC45" class="line" lang="java"><span class="cm">     * schema information: the schema information property if it is the</span></span>
<span id="LC46" class="line" lang="java"><span class="cm">     * validation root, &lt;code&gt;null&lt;/code&gt; otherwise.</span></span>
<span id="LC47" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC48" class="line" lang="java">    <span class="kd">public</span> <span class="nc">XSModel</span> <span class="nf">getSchemaInformation</span><span class="o">();</span></span>
