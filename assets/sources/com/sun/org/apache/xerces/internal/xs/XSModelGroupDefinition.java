...
<span id="LC24" class="line" lang="java"><span class="cm"> * This interface represents the Model Group Definition schema component.</span></span>
<span id="LC25" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC26" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">XSModelGroupDefinition</span> <span class="kd">extends</span> <span class="nc">XSObject</span> <span class="o">{</span></span>
<span id="LC27" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC28" class="line" lang="java"><span class="cm">     * A model group.</span></span>
<span id="LC29" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC30" class="line" lang="java">    <span class="kd">public</span> <span class="nc">XSModelGroup</span> <span class="nf">getModelGroup</span><span class="o">();</span></span>
<span id="LC31" class="line" lang="java"></span>
<span id="LC32" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC33" class="line" lang="java"><span class="cm">     * An annotation if it exists, otherwise &lt;code&gt;null&lt;/code&gt;. If not null</span></span>
<span id="LC34" class="line" lang="java"><span class="cm">     * then the first [annotation] from the sequence of annotations.</span></span>
<span id="LC35" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC36" class="line" lang="java">    <span class="kd">public</span> <span class="nc">XSAnnotation</span> <span class="nf">getAnnotation</span><span class="o">();</span></span>
<span id="LC37" class="line" lang="java"></span>
<span id="LC38" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">     * A sequence of [annotations] or an empty &lt;code&gt;XSObjectList&lt;/code&gt;.</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC41" class="line" lang="java">    <span class="kd">public</span> <span class="nc">XSObjectList</span> <span class="nf">getAnnotations</span><span class="o">();</span></span>
