...
<span id="LC24" class="line" lang="java"><span class="cm"> * This interface represents the Attribute Group Definition schema component.</span></span>
<span id="LC25" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC26" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">XSAttributeGroupDefinition</span> <span class="kd">extends</span> <span class="nc">XSObject</span> <span class="o">{</span></span>
<span id="LC27" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC28" class="line" lang="java"><span class="cm">     * A set of [attribute uses] if it exists, otherwise an empty</span></span>
<span id="LC29" class="line" lang="java"><span class="cm">     * &lt;code&gt;XSObjectList&lt;/code&gt;.</span></span>
<span id="LC30" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC31" class="line" lang="java">    <span class="kd">public</span> <span class="nc">XSObjectList</span> <span class="nf">getAttributeUses</span><span class="o">();</span></span>
<span id="LC32" class="line" lang="java"></span>
<span id="LC33" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC34" class="line" lang="java"><span class="cm">     * A [wildcard] if it exists, otherwise &lt;code&gt;null&lt;/code&gt;.</span></span>
<span id="LC35" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC36" class="line" lang="java">    <span class="kd">public</span> <span class="nc">XSWildcard</span> <span class="nf">getAttributeWildcard</span><span class="o">();</span></span>
<span id="LC37" class="line" lang="java"></span>
<span id="LC38" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">     * An annotation if it exists, otherwise &lt;code&gt;null&lt;/code&gt;. If not null</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">     * then the first [annotation] from the sequence of annotations.</span></span>
<span id="LC41" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC42" class="line" lang="java">    <span class="kd">public</span> <span class="nc">XSAnnotation</span> <span class="nf">getAnnotation</span><span class="o">();</span></span>
<span id="LC43" class="line" lang="java"></span>
<span id="LC44" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC45" class="line" lang="java"><span class="cm">     * A sequence of [annotations] or an empty &lt;code&gt;XSObjectList&lt;/code&gt;.</span></span>
<span id="LC46" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC47" class="line" lang="java">    <span class="kd">public</span> <span class="nc">XSObjectList</span> <span class="nf">getAnnotations</span><span class="o">();</span></span>
