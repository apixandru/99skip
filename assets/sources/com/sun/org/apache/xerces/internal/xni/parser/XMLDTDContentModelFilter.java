...
<span id="LC23" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xerces.internal.xni.XMLDTDContentModelHandler</span><span class="o">;</span></span>
<span id="LC24" class="line" lang="java"></span>
<span id="LC25" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC26" class="line" lang="java"><span class="cm"> * Defines a DTD content model filter that acts as both a receiver and</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * an emitter of DTD content model events.</span></span>
...
<span id="LC32" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">XMLDTDContentModelFilter</span></span>
<span id="LC33" class="line" lang="java">    <span class="kd">extends</span> <span class="nc">XMLDTDContentModelHandler</span><span class="o">,</span> <span class="nc">XMLDTDContentModelSource</span> <span class="o">{</span></span>
<span id="LC34" class="line" lang="java"></span>
<span id="LC35" class="line" lang="java"><span class="o">}</span> <span class="c1">// interface XMLDTDContentModelFilter</span></span>
