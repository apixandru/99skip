...
<span id="LC24" class="line" lang="java"><span class="cm"> * A runtime exception that's thrown if an error happens when the application</span></span>
<span id="LC25" class="line" lang="java"><span class="cm"> * tries to get a DV factory instance.</span></span>
...
<span id="LC30" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">DVFactoryException</span> <span class="kd">extends</span> <span class="nc">RuntimeException</span> <span class="o">{</span></span>
<span id="LC31" class="line" lang="java"></span>
<span id="LC32" class="line" lang="java">    <span class="cm">/** Serialization version. */</span></span>
<span id="LC33" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="o">-</span><span class="mi">3738854697928682412L</span><span class="o">;</span></span>
<span id="LC34" class="line" lang="java"></span>
<span id="LC35" class="line" lang="java">    <span class="kd">public</span> <span class="nf">DVFactoryException</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC39" class="line" lang="java">    <span class="kd">public</span> <span class="nf">DVFactoryException</span><span class="o">(</span><span class="nc">String</span> <span class="n">msg</span><span class="o">)</span> <span class="o">{</span></span>
