...
<span id="LC21" class="line" lang="java"><span class="kn">package</span> <span class="nn">com.sun.org.apache.xerces.internal.xs.datatypes</span><span class="o">;</span></span>
<span id="LC22" class="line" lang="java"></span>
<span id="LC23" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC24" class="line" lang="java"><span class="cm"> * Interface to expose QName actual values</span></span>
<span id="LC25" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC26" class="line" lang="java"><span class="cm"> * @author Ankit Pasricha, IBM</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC28" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">XSQName</span> <span class="o">{</span></span>
<span id="LC29" class="line" lang="java"></span>
<span id="LC30" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC31" class="line" lang="java"><span class="cm">     * @return com.sun.org.apache.xerces.internal.xni.QName class instance</span></span>
<span id="LC32" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC33" class="line" lang="java">    <span class="kd">public</span> <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">xerces</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">xni</span><span class="o">.</span><span class="na">QName</span> <span class="nf">getXNIQName</span><span class="o">();</span></span>
<span id="LC34" class="line" lang="java"></span>
<span id="LC35" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC36" class="line" lang="java"><span class="cm">     * @return javax.xml.namespace.QName class instance</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC38" class="line" lang="java">    <span class="kd">public</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">namespace</span><span class="o">.</span><span class="na">QName</span> <span class="nf">getJAXPQName</span><span class="o">();</span></span>
