...
<span id="LC22" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.w3c.dom.DOMImplementation</span><span class="o">;</span></span>
<span id="LC23" class="line" lang="java"></span>
<span id="LC24" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC25" class="line" lang="java"><span class="cm"> * &lt;p&gt;This DOMImplementation class is description of a particular</span></span>
<span id="LC26" class="line" lang="java"><span class="cm"> * implementation of the Document Object Model. As such its data is</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * static, shared by all instances of this implementation.&lt;/p&gt;</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> * &lt;p&gt;This implementation simply extends DOMImplementationImpl to differentiate</span></span>
<span id="LC30" class="line" lang="java"><span class="cm"> * between the Deferred DOM Implementations and Non-Deferred DOM Implementations.&lt;/p&gt;</span></span>
...
<span id="LC37" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">DeferredDOMImplementationImpl</span></span>
<span id="LC38" class="line" lang="java">    <span class="kd">extends</span> <span class="nc">DOMImplementationImpl</span> <span class="o">{</span></span>
...
<span id="LC44" class="line" lang="java">    <span class="c1">// static</span></span>
<span id="LC45" class="line" lang="java"></span>
<span id="LC46" class="line" lang="java">    <span class="cm">/** Dom implementation singleton. */</span></span>
<span id="LC47" class="line" lang="java">    <span class="kd">static</span> <span class="nc">DeferredDOMImplementationImpl</span> <span class="n">singleton</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">DeferredDOMImplementationImpl</span><span class="o">();</span></span>
...
<span id="LC51" class="line" lang="java">    <span class="c1">// Public methods</span></span>
<span id="LC52" class="line" lang="java">    <span class="c1">//</span></span>
<span id="LC53" class="line" lang="java"></span>
<span id="LC54" class="line" lang="java">    <span class="cm">/** NON-DOM: Obtain and return the single shared object */</span></span>
<span id="LC55" class="line" lang="java">    <span class="kd">public</span> <span class="kd">static</span> <span class="nc">DOMImplementation</span> <span class="nf">getDOMImplementation</span><span class="o">()</span> <span class="o">{</span></span>
