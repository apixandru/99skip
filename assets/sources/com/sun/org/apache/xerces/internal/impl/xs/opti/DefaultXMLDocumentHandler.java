...
<span id="LC21" class="line" lang="java"><span class="kn">package</span> <span class="nn">com.sun.org.apache.xerces.internal.impl.xs.opti</span><span class="o">;</span></span>
...
<span id="LC25" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xerces.internal.xni.NamespaceContext</span><span class="o">;</span></span>
<span id="LC26" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xerces.internal.xni.XMLLocator</span><span class="o">;</span></span>
...
<span id="LC28" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xerces.internal.xni.XMLAttributes</span><span class="o">;</span></span>
<span id="LC29" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xerces.internal.xni.XMLDTDHandler</span><span class="o">;</span></span>
<span id="LC30" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xerces.internal.xni.XMLDocumentHandler</span><span class="o">;</span></span>
<span id="LC31" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xerces.internal.xni.XMLDTDContentModelHandler</span><span class="o">;</span></span>
<span id="LC32" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xerces.internal.xni.XMLResourceIdentifier</span><span class="o">;</span></span>
<span id="LC33" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xerces.internal.xni.parser.XMLDocumentSource</span><span class="o">;</span></span>
<span id="LC34" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xerces.internal.xni.parser.XMLDTDSource</span><span class="o">;</span></span>
<span id="LC35" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xerces.internal.xni.parser.XMLDTDContentModelSource</span><span class="o">;</span></span>
<span id="LC36" class="line" lang="java"></span>
<span id="LC37" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.xerces.internal.xni.XNIException</span><span class="o">;</span></span>
<span id="LC38" class="line" lang="java"></span>
<span id="LC39" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC40" class="line" lang="java"><span class="cm"> * @xerces.internal</span></span>
<span id="LC41" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC42" class="line" lang="java"><span class="cm"> * @author Rahul Srivastava, Sun Microsystems Inc.</span></span>
<span id="LC43" class="line" lang="java"><span class="cm"> * @author Sandy Gao, IBM</span></span>
<span id="LC44" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC45" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC46" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">DefaultXMLDocumentHandler</span> <span class="kd">implements</span> <span class="nc">XMLDocumentHandler</span><span class="o">,</span></span>
<span id="LC47" class="line" lang="java">                                                  <span class="nc">XMLDTDHandler</span><span class="o">,</span></span>
<span id="LC48" class="line" lang="java">                                                  <span class="nc">XMLDTDContentModelHandler</span> <span class="o">{</span></span>
<span id="LC49" class="line" lang="java"></span>
<span id="LC50" class="line" lang="java">    <span class="cm">/** Default Constructor */</span></span>
<span id="LC51" class="line" lang="java">    <span class="kd">public</span> <span class="nf">DefaultXMLDocumentHandler</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC55" class="line" lang="java">    <span class="c1">// XMLDocumentHandler methods</span></span>
...
<span id="LC59" class="line" lang="java"><span class="cm">     * The start of the document.</span></span>
<span id="LC60" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC61" class="line" lang="java"><span class="cm">     * @param locator  The document locator, or null if the document</span></span>
<span id="LC62" class="line" lang="java"><span class="cm">     *                 location cannot be reported during the parsing</span></span>
<span id="LC63" class="line" lang="java"><span class="cm">     *                 of this document. However, it is &lt;em&gt;strongly&lt;/em&gt;</span></span>
<span id="LC64" class="line" lang="java"><span class="cm">     *                 recommended that a locator be supplied that can</span></span>
<span id="LC65" class="line" lang="java"><span class="cm">     *                 at least report the system identifier of the</span></span>
<span id="LC66" class="line" lang="java"><span class="cm">     *                 document.</span></span>
<span id="LC67" class="line" lang="java"><span class="cm">     * @param encoding The auto-detected IANA encoding name of the entity</span></span>
<span id="LC68" class="line" lang="java"><span class="cm">     *                 stream. This value will be null in those situations</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">     *                 where the entity encoding is not auto-detected (e.g.</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">     *                 internal entities or a document entity that is</span></span>
<span id="LC71" class="line" lang="java"><span class="cm">     *                 parsed from a java.io.Reader).</span></span>
<span id="LC72" class="line" lang="java"><span class="cm">     * @param augs     Additional information that may include infoset augmentations</span></span>
<span id="LC73" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC74" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC75" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC76" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startDocument</span><span class="o">(</span><span class="nc">XMLLocator</span> <span class="n">locator</span><span class="o">,</span> <span class="nc">String</span> <span class="n">encoding</span><span class="o">,</span></span>
<span id="LC77" class="line" lang="java">                              <span class="nc">NamespaceContext</span> <span class="n">context</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span></span>
<span id="LC78" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC82" class="line" lang="java"><span class="cm">     * Notifies of the presence of an XMLDecl line in the document. If</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">     * present, this method will be called immediately following the</span></span>
<span id="LC84" class="line" lang="java"><span class="cm">     * startDocument call.</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC86" class="line" lang="java"><span class="cm">     * @param version    The XML version.</span></span>
<span id="LC87" class="line" lang="java"><span class="cm">     * @param encoding   The IANA encoding name of the document, or null if</span></span>
<span id="LC88" class="line" lang="java"><span class="cm">     *                   not specified.</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">     * @param standalone The standalone value, or null if not specified.</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">     * @param augs       Additional information that may include infoset augmentations</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC95" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">xmlDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">version</span><span class="o">,</span> <span class="nc">String</span> <span class="n">encoding</span><span class="o">,</span> <span class="nc">String</span> <span class="n">standalone</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span></span>
<span id="LC96" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC100" class="line" lang="java"><span class="cm">     * Notifies of the presence of the DOCTYPE line in the document.</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">     * @param rootElement</span></span>
<span id="LC103" class="line" lang="java"><span class="cm">     *                 The name of the root element.</span></span>
<span id="LC104" class="line" lang="java"><span class="cm">     * @param publicId The public identifier if an external DTD or null</span></span>
<span id="LC105" class="line" lang="java"><span class="cm">     *                 if the external DTD is specified using SYSTEM.</span></span>
<span id="LC106" class="line" lang="java"><span class="cm">     * @param systemId The system identifier if an external DTD, null</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">     *                 otherwise.</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">     * @param augs     Additional information that may include infoset augmentations</span></span>
<span id="LC109" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC110" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC111" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC112" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC113" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">doctypeDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">rootElement</span><span class="o">,</span> <span class="nc">String</span> <span class="n">publicId</span><span class="o">,</span> <span class="nc">String</span> <span class="n">systemId</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span></span>
<span id="LC114" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC118" class="line" lang="java"><span class="cm">     * A comment.</span></span>
<span id="LC119" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC120" class="line" lang="java"><span class="cm">     * @param text   The text in the comment.</span></span>
<span id="LC121" class="line" lang="java"><span class="cm">     * @param augs   Additional information that may include infoset augmentations</span></span>
<span id="LC122" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC123" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC124" class="line" lang="java"><span class="cm">     *                   Thrown by application to signal an error.</span></span>
<span id="LC125" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC126" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">comment</span><span class="o">(</span><span class="nc">XMLString</span> <span class="n">text</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC130" class="line" lang="java"><span class="cm">     * A processing instruction. Processing instructions consist of a</span></span>
<span id="LC131" class="line" lang="java"><span class="cm">     * target name and, optionally, text data. The data is only meaningful</span></span>
<span id="LC132" class="line" lang="java"><span class="cm">     * to the application.</span></span>
<span id="LC133" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC134" class="line" lang="java"><span class="cm">     * Typically, a processing instruction's data will contain a series</span></span>
<span id="LC135" class="line" lang="java"><span class="cm">     * of pseudo-attributes. These pseudo-attributes follow the form of</span></span>
<span id="LC136" class="line" lang="java"><span class="cm">     * element attributes but are &lt;strong&gt;not&lt;/strong&gt; parsed or presented</span></span>
<span id="LC137" class="line" lang="java"><span class="cm">     * to the application as anything other than text. The application is</span></span>
<span id="LC138" class="line" lang="java"><span class="cm">     * responsible for parsing the data.</span></span>
<span id="LC139" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC140" class="line" lang="java"><span class="cm">     * @param target The target.</span></span>
<span id="LC141" class="line" lang="java"><span class="cm">     * @param data   The data or null if none specified.</span></span>
<span id="LC142" class="line" lang="java"><span class="cm">     * @param augs   Additional information that may include infoset augmentations</span></span>
<span id="LC143" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC144" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC147" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">processingInstruction</span><span class="o">(</span><span class="nc">String</span> <span class="n">target</span><span class="o">,</span> <span class="nc">XMLString</span> <span class="n">data</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span></span>
<span id="LC148" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC152" class="line" lang="java"><span class="cm">     * The start of a namespace prefix mapping. This method will only be</span></span>
<span id="LC153" class="line" lang="java"><span class="cm">     * called when namespace processing is enabled.</span></span>
<span id="LC154" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC155" class="line" lang="java"><span class="cm">     * @param prefix The namespace prefix.</span></span>
<span id="LC156" class="line" lang="java"><span class="cm">     * @param uri    The URI bound to the prefix.</span></span>
<span id="LC157" class="line" lang="java"><span class="cm">     * @param augs   Additional information that may include infoset augmentations</span></span>
<span id="LC158" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC159" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC160" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC161" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC162" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startPrefixMapping</span><span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">,</span> <span class="nc">String</span> <span class="n">uri</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span></span>
<span id="LC163" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC167" class="line" lang="java"><span class="cm">     * The start of an element.</span></span>
<span id="LC168" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC169" class="line" lang="java"><span class="cm">     * @param element    The name of the element.</span></span>
<span id="LC170" class="line" lang="java"><span class="cm">     * @param attributes The element attributes.</span></span>
<span id="LC171" class="line" lang="java"><span class="cm">     * @param augs       Additional information that may include infoset augmentations</span></span>
<span id="LC172" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC173" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC174" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC175" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC176" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startElement</span><span class="o">(</span><span class="nc">QName</span> <span class="n">element</span><span class="o">,</span> <span class="nc">XMLAttributes</span> <span class="n">attributes</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span></span>
<span id="LC177" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC181" class="line" lang="java"><span class="cm">     * An empty element.</span></span>
<span id="LC182" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC183" class="line" lang="java"><span class="cm">     * @param element    The name of the element.</span></span>
<span id="LC184" class="line" lang="java"><span class="cm">     * @param attributes The element attributes.</span></span>
<span id="LC185" class="line" lang="java"><span class="cm">     * @param augs       Additional information that may include infoset augmentations</span></span>
<span id="LC186" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC187" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC188" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC189" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC190" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">emptyElement</span><span class="o">(</span><span class="nc">QName</span> <span class="n">element</span><span class="o">,</span> <span class="nc">XMLAttributes</span> <span class="n">attributes</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span></span>
<span id="LC191" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC195" class="line" lang="java"><span class="cm">     * This method notifies the start of a general entity.</span></span>
<span id="LC196" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC197" class="line" lang="java"><span class="cm">     * &lt;strong&gt;Note:&lt;/strong&gt; This method is not called for entity references</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">     * appearing as part of attribute values.</span></span>
<span id="LC199" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC200" class="line" lang="java"><span class="cm">     * @param name     The name of the general entity.</span></span>
<span id="LC201" class="line" lang="java"><span class="cm">     * @param identifier The resource identifier.</span></span>
<span id="LC202" class="line" lang="java"><span class="cm">     * @param encoding The auto-detected IANA encoding name of the entity</span></span>
<span id="LC203" class="line" lang="java"><span class="cm">     *                 stream. This value will be null in those situations</span></span>
<span id="LC204" class="line" lang="java"><span class="cm">     *                 where the entity encoding is not auto-detected (e.g.</span></span>
<span id="LC205" class="line" lang="java"><span class="cm">     *                 internal entities or a document entity that is</span></span>
<span id="LC206" class="line" lang="java"><span class="cm">     *                 parsed from a java.io.Reader).</span></span>
...
<span id="LC209" class="line" lang="java"><span class="cm">     * @exception XNIException Thrown by handler to signal an error.</span></span>
<span id="LC210" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC211" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startGeneralEntity</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span></span>
<span id="LC212" class="line" lang="java">                                   <span class="nc">XMLResourceIdentifier</span> <span class="n">identifier</span><span class="o">,</span></span>
<span id="LC213" class="line" lang="java">                                   <span class="nc">String</span> <span class="n">encoding</span><span class="o">,</span></span>
<span id="LC214" class="line" lang="java">                                   <span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC218" class="line" lang="java"><span class="cm">     * Notifies of the presence of a TextDecl line in an entity. If present,</span></span>
<span id="LC219" class="line" lang="java"><span class="cm">     * this method will be called immediately following the startEntity call.</span></span>
<span id="LC220" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">     * &lt;strong&gt;Note:&lt;/strong&gt; This method will never be called for the</span></span>
<span id="LC222" class="line" lang="java"><span class="cm">     * document entity; it is only called for external general entities</span></span>
<span id="LC223" class="line" lang="java"><span class="cm">     * referenced in document content.</span></span>
<span id="LC224" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC225" class="line" lang="java"><span class="cm">     * &lt;strong&gt;Note:&lt;/strong&gt; This method is not called for entity references</span></span>
<span id="LC226" class="line" lang="java"><span class="cm">     * appearing as part of attribute values.</span></span>
<span id="LC227" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC228" class="line" lang="java"><span class="cm">     * @param version  The XML version, or null if not specified.</span></span>
<span id="LC229" class="line" lang="java"><span class="cm">     * @param encoding The IANA encoding name of the entity.</span></span>
<span id="LC230" class="line" lang="java"><span class="cm">     * @param augs     Additional information that may include infoset augmentations</span></span>
<span id="LC231" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC232" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC233" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC234" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC235" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">textDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">version</span><span class="o">,</span> <span class="nc">String</span> <span class="n">encoding</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC239" class="line" lang="java"><span class="cm">     * This method notifies the end of a general entity.</span></span>
<span id="LC240" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC241" class="line" lang="java"><span class="cm">     * &lt;strong&gt;Note:&lt;/strong&gt; This method is not called for entity references</span></span>
<span id="LC242" class="line" lang="java"><span class="cm">     * appearing as part of attribute values.</span></span>
<span id="LC243" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC244" class="line" lang="java"><span class="cm">     * @param name   The name of the entity.</span></span>
...
<span id="LC247" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC248" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC249" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC250" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endGeneralEntity</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC254" class="line" lang="java"><span class="cm">     * Character content.</span></span>
<span id="LC255" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC256" class="line" lang="java"><span class="cm">     * @param text   The content.</span></span>
<span id="LC257" class="line" lang="java"><span class="cm">     * @param augs   Additional information that may include infoset augmentations</span></span>
<span id="LC258" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC259" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC260" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC261" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC262" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">characters</span><span class="o">(</span><span class="nc">XMLString</span> <span class="n">text</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC266" class="line" lang="java"><span class="cm">     * Ignorable whitespace. For this method to be called, the document</span></span>
<span id="LC267" class="line" lang="java"><span class="cm">     * source must have some way of determining that the text containing</span></span>
<span id="LC268" class="line" lang="java"><span class="cm">     * only whitespace characters should be considered ignorable. For</span></span>
<span id="LC269" class="line" lang="java"><span class="cm">     * example, the validator can determine if a length of whitespace</span></span>
<span id="LC270" class="line" lang="java"><span class="cm">     * characters in the document are ignorable based on the element</span></span>
<span id="LC271" class="line" lang="java"><span class="cm">     * content model.</span></span>
<span id="LC272" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC273" class="line" lang="java"><span class="cm">     * @param text   The ignorable whitespace.</span></span>
<span id="LC274" class="line" lang="java"><span class="cm">     * @param augs   Additional information that may include infoset augmentations</span></span>
<span id="LC275" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC276" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC277" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC278" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC279" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">ignorableWhitespace</span><span class="o">(</span><span class="nc">XMLString</span> <span class="n">text</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC283" class="line" lang="java"><span class="cm">     * The end of an element.</span></span>
<span id="LC284" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC285" class="line" lang="java"><span class="cm">     * @param element The name of the element.</span></span>
<span id="LC286" class="line" lang="java"><span class="cm">     * @param augs    Additional information that may include infoset augmentations</span></span>
<span id="LC287" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC288" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC291" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endElement</span><span class="o">(</span><span class="nc">QName</span> <span class="n">element</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC295" class="line" lang="java"><span class="cm">     * The end of a namespace prefix mapping. This method will only be</span></span>
<span id="LC296" class="line" lang="java"><span class="cm">     * called when namespace processing is enabled.</span></span>
<span id="LC297" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC298" class="line" lang="java"><span class="cm">     * @param prefix The namespace prefix.</span></span>
<span id="LC299" class="line" lang="java"><span class="cm">     * @param augs   Additional information that may include infoset augmentations</span></span>
<span id="LC300" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC301" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC302" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC303" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC304" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endPrefixMapping</span><span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC308" class="line" lang="java"><span class="cm">     * The start of a CDATA section.</span></span>
...
<span id="LC312" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC313" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC314" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC315" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startCDATA</span><span class="o">(</span><span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC319" class="line" lang="java"><span class="cm">     * The end of a CDATA section.</span></span>
<span id="LC320" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC321" class="line" lang="java"><span class="cm">     * @param augs   Additional information that may include infoset augmentations</span></span>
<span id="LC322" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC323" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC324" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC325" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC326" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endCDATA</span><span class="o">(</span><span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC330" class="line" lang="java"><span class="cm">     * The end of the document.</span></span>
<span id="LC331" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC332" class="line" lang="java"><span class="cm">     * @param augs   Additional information that may include infoset augmentations</span></span>
<span id="LC333" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC334" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC335" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
<span id="LC336" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC337" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endDocument</span><span class="o">(</span><span class="nc">Augmentations</span> <span class="n">augs</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC342" class="line" lang="java">    <span class="c1">// XMLDTDHandler methods</span></span>
...
<span id="LC346" class="line" lang="java"><span class="cm">     * The start of the DTD.</span></span>
<span id="LC347" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC348" class="line" lang="java"><span class="cm">     * @param locator  The document locator, or null if the document</span></span>
<span id="LC349" class="line" lang="java"><span class="cm">     *                 location cannot be reported during the parsing of</span></span>
<span id="LC350" class="line" lang="java"><span class="cm">     *                 the document DTD. However, it is &lt;em&gt;strongly&lt;/em&gt;</span></span>
<span id="LC351" class="line" lang="java"><span class="cm">     *                 recommended that a locator be supplied that can</span></span>
<span id="LC352" class="line" lang="java"><span class="cm">     *                 at least report the base system identifier of the</span></span>
<span id="LC353" class="line" lang="java"><span class="cm">     *                 DTD.</span></span>
<span id="LC354" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC355" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC356" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC357" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC358" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC359" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startDTD</span><span class="o">(</span><span class="nc">XMLLocator</span> <span class="n">locator</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span></span>
<span id="LC360" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC364" class="line" lang="java"><span class="cm">     * This method notifies of the start of a parameter entity. The parameter</span></span>
<span id="LC365" class="line" lang="java"><span class="cm">     * entity name start with a '%' character.</span></span>
<span id="LC366" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC367" class="line" lang="java"><span class="cm">     * @param name     The name of the parameter entity.</span></span>
<span id="LC368" class="line" lang="java"><span class="cm">     * @param identifier The resource identifier.</span></span>
<span id="LC369" class="line" lang="java"><span class="cm">     * @param encoding The auto-detected IANA encoding name of the entity</span></span>
<span id="LC370" class="line" lang="java"><span class="cm">     *                 stream. This value will be null in those situations</span></span>
<span id="LC371" class="line" lang="java"><span class="cm">     *                 where the entity encoding is not auto-detected (e.g.</span></span>
<span id="LC372" class="line" lang="java"><span class="cm">     *                 internal parameter entities).</span></span>
<span id="LC373" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
...
<span id="LC376" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC377" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC378" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startParameterEntity</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span></span>
<span id="LC379" class="line" lang="java">                                     <span class="nc">XMLResourceIdentifier</span> <span class="n">identifier</span><span class="o">,</span></span>
<span id="LC380" class="line" lang="java">                                     <span class="nc">String</span> <span class="n">encoding</span><span class="o">,</span></span>
<span id="LC381" class="line" lang="java">                                     <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC385" class="line" lang="java"><span class="cm">     * Notifies of the presence of a TextDecl line in an entity. If present,</span></span>
<span id="LC386" class="line" lang="java"><span class="cm">     * this method will be called immediately following the startEntity call.</span></span>
<span id="LC387" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC388" class="line" lang="java"><span class="cm">     * &lt;strong&gt;Note:&lt;/strong&gt; This method is only called for external</span></span>
<span id="LC389" class="line" lang="java"><span class="cm">     * parameter entities referenced in the DTD.</span></span>
<span id="LC390" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC391" class="line" lang="java"><span class="cm">     * @param version  The XML version, or null if not specified.</span></span>
<span id="LC392" class="line" lang="java"><span class="cm">     * @param encoding The IANA encoding name of the entity.</span></span>
<span id="LC393" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC394" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC395" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC396" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC397" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC398" class="line" lang="java"><span class="cm">/*</span></span>
<span id="LC399" class="line" lang="java"><span class="cm">    public void textDecl(String version, String encoding,</span></span>
<span id="LC400" class="line" lang="java"><span class="cm">                         Augmentations augmentations) throws XNIException {</span></span>
...
<span id="LC405" class="line" lang="java"><span class="cm">     * This method notifies the end of a parameter entity. Parameter entity</span></span>
<span id="LC406" class="line" lang="java"><span class="cm">     * names begin with a '%' character.</span></span>
<span id="LC407" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC408" class="line" lang="java"><span class="cm">     * @param name The name of the parameter entity.</span></span>
<span id="LC409" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC410" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC411" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC412" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC413" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC414" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endParameterEntity</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span></span>
<span id="LC415" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC419" class="line" lang="java"><span class="cm">     * The start of the DTD external subset.</span></span>
<span id="LC420" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">     * @param identifier The resource identifier.</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">     * @param augmentations</span></span>
<span id="LC423" class="line" lang="java"><span class="cm">     *                   Additional information that may include infoset</span></span>
<span id="LC424" class="line" lang="java"><span class="cm">     *                   augmentations.</span></span>
<span id="LC425" class="line" lang="java"><span class="cm">     * @exception XNIException</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">     *                   Thrown by handler to signal an error.</span></span>
...
<span id="LC429" class="line" lang="java">                                    <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span></span>
<span id="LC430" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC434" class="line" lang="java"><span class="cm">     * The end of the DTD external subset.</span></span>
<span id="LC435" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC436" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC437" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC438" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC439" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC440" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC441" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endExternalSubset</span><span class="o">(</span><span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span></span>
<span id="LC442" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC446" class="line" lang="java"><span class="cm">     * A comment.</span></span>
<span id="LC447" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC448" class="line" lang="java"><span class="cm">     * @param text The text in the comment.</span></span>
<span id="LC449" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC450" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC451" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC452" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by application to signal an error.</span></span>
<span id="LC453" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC454" class="line" lang="java"><span class="cm">/*</span></span>
<span id="LC455" class="line" lang="java"><span class="cm">    public void comment(XMLString text, Augmentations augmentations)</span></span>
<span id="LC456" class="line" lang="java"><span class="cm">        throws XNIException {</span></span>
...
<span id="LC461" class="line" lang="java"><span class="cm">     * A processing instruction. Processing instructions consist of a</span></span>
<span id="LC462" class="line" lang="java"><span class="cm">     * target name and, optionally, text data. The data is only meaningful</span></span>
<span id="LC463" class="line" lang="java"><span class="cm">     * to the application.</span></span>
<span id="LC464" class="line" lang="java"><span class="cm">     * &lt;p&gt;</span></span>
<span id="LC465" class="line" lang="java"><span class="cm">     * Typically, a processing instruction's data will contain a series</span></span>
<span id="LC466" class="line" lang="java"><span class="cm">     * of pseudo-attributes. These pseudo-attributes follow the form of</span></span>
<span id="LC467" class="line" lang="java"><span class="cm">     * element attributes but are &lt;strong&gt;not&lt;/strong&gt; parsed or presented</span></span>
<span id="LC468" class="line" lang="java"><span class="cm">     * to the application as anything other than text. The application is</span></span>
<span id="LC469" class="line" lang="java"><span class="cm">     * responsible for parsing the data.</span></span>
<span id="LC470" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC471" class="line" lang="java"><span class="cm">     * @param target The target.</span></span>
<span id="LC472" class="line" lang="java"><span class="cm">     * @param data   The data or null if none specified.</span></span>
<span id="LC473" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC474" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
...
<span id="LC479" class="line" lang="java"><span class="cm">    public void processingInstruction(String target, XMLString data,</span></span>
<span id="LC480" class="line" lang="java"><span class="cm">                                      Augmentations augmentations)</span></span>
<span id="LC481" class="line" lang="java"><span class="cm">        throws XNIException {</span></span>
...
<span id="LC487" class="line" lang="java"><span class="cm">     * An element declaration.</span></span>
<span id="LC488" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC489" class="line" lang="java"><span class="cm">     * @param name         The name of the element.</span></span>
<span id="LC490" class="line" lang="java"><span class="cm">     * @param contentModel The element content model.</span></span>
<span id="LC491" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC492" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC493" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC494" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC495" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC496" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">elementDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="nc">String</span> <span class="n">contentModel</span><span class="o">,</span></span>
<span id="LC497" class="line" lang="java">                            <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span></span>
<span id="LC498" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC502" class="line" lang="java"><span class="cm">     * The start of an attribute list.</span></span>
<span id="LC503" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC504" class="line" lang="java"><span class="cm">     * @param elementName The name of the element that this attribute</span></span>
<span id="LC505" class="line" lang="java"><span class="cm">     *                    list is associated with.</span></span>
<span id="LC506" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC507" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC508" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC509" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC510" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC511" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startAttlist</span><span class="o">(</span><span class="nc">String</span> <span class="n">elementName</span><span class="o">,</span></span>
<span id="LC512" class="line" lang="java">                             <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC516" class="line" lang="java"><span class="cm">     * An attribute declaration.</span></span>
<span id="LC517" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC518" class="line" lang="java"><span class="cm">     * @param elementName   The name of the element that this attribute</span></span>
<span id="LC519" class="line" lang="java"><span class="cm">     *                      is associated with.</span></span>
<span id="LC520" class="line" lang="java"><span class="cm">     * @param attributeName The name of the attribute.</span></span>
<span id="LC521" class="line" lang="java"><span class="cm">     * @param type          The attribute type. This value will be one of</span></span>
<span id="LC522" class="line" lang="java"><span class="cm">     *                      the following: "CDATA", "ENTITY", "ENTITIES",</span></span>
<span id="LC523" class="line" lang="java"><span class="cm">     *                      "ENUMERATION", "ID", "IDREF", "IDREFS",</span></span>
<span id="LC524" class="line" lang="java"><span class="cm">     *                      "NMTOKEN", "NMTOKENS", or "NOTATION".</span></span>
<span id="LC525" class="line" lang="java"><span class="cm">     * @param enumeration   If the type has the value "ENUMERATION" or</span></span>
<span id="LC526" class="line" lang="java"><span class="cm">     *                      "NOTATION", this array holds the allowed attribute</span></span>
<span id="LC527" class="line" lang="java"><span class="cm">     *                      values; otherwise, this array is null.</span></span>
<span id="LC528" class="line" lang="java"><span class="cm">     * @param defaultType   The attribute default type. This value will be</span></span>
<span id="LC529" class="line" lang="java"><span class="cm">     *                      one of the following: "#FIXED", "#IMPLIED",</span></span>
<span id="LC530" class="line" lang="java"><span class="cm">     *                      "#REQUIRED", or null.</span></span>
<span id="LC531" class="line" lang="java"><span class="cm">     * @param defaultValue  The attribute default value, or null if no</span></span>
<span id="LC532" class="line" lang="java"><span class="cm">     *                      default value is specified.</span></span>
<span id="LC533" class="line" lang="java"><span class="cm">     * @param nonNormalizedDefaultValue  The attribute default value with no normalization</span></span>
<span id="LC534" class="line" lang="java"><span class="cm">     *                      performed, or null if no default value is specified.</span></span>
<span id="LC535" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC536" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC537" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC538" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC539" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC540" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">attributeDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">elementName</span><span class="o">,</span> <span class="nc">String</span> <span class="n">attributeName</span><span class="o">,</span></span>
<span id="LC541" class="line" lang="java">                              <span class="nc">String</span> <span class="n">type</span><span class="o">,</span> <span class="nc">String</span><span class="o">[]</span> <span class="n">enumeration</span><span class="o">,</span></span>
<span id="LC542" class="line" lang="java">                              <span class="nc">String</span> <span class="n">defaultType</span><span class="o">,</span> <span class="nc">XMLString</span> <span class="n">defaultValue</span><span class="o">,</span></span>
<span id="LC543" class="line" lang="java">                              <span class="nc">XMLString</span> <span class="n">nonNormalizedDefaultValue</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span></span>
<span id="LC544" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC548" class="line" lang="java"><span class="cm">     * The end of an attribute list.</span></span>
<span id="LC549" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC550" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC551" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC552" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC553" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC554" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC555" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endAttlist</span><span class="o">(</span><span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC559" class="line" lang="java"><span class="cm">     * An internal entity declaration.</span></span>
<span id="LC560" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC561" class="line" lang="java"><span class="cm">     * @param name The name of the entity. Parameter entity names start with</span></span>
<span id="LC562" class="line" lang="java"><span class="cm">     *             '%', whereas the name of a general entity is just the</span></span>
<span id="LC563" class="line" lang="java"><span class="cm">     *             entity name.</span></span>
<span id="LC564" class="line" lang="java"><span class="cm">     * @param text The value of the entity.</span></span>
<span id="LC565" class="line" lang="java"><span class="cm">     * @param nonNormalizedText The non-normalized value of the entity. This</span></span>
<span id="LC566" class="line" lang="java"><span class="cm">     *             value contains the same sequence of characters that was in</span></span>
<span id="LC567" class="line" lang="java"><span class="cm">     *             the internal entity declaration, without any entity</span></span>
<span id="LC568" class="line" lang="java"><span class="cm">     *             references expanded.</span></span>
<span id="LC569" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC570" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC571" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC572" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC573" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC574" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">internalEntityDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="nc">XMLString</span> <span class="n">text</span><span class="o">,</span></span>
<span id="LC575" class="line" lang="java">                                   <span class="nc">XMLString</span> <span class="n">nonNormalizedText</span><span class="o">,</span></span>
<span id="LC576" class="line" lang="java">                                   <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span></span>
<span id="LC577" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC581" class="line" lang="java"><span class="cm">     * An external entity declaration.</span></span>
<span id="LC582" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC583" class="line" lang="java"><span class="cm">     * @param name     The name of the entity. Parameter entity names start</span></span>
<span id="LC584" class="line" lang="java"><span class="cm">     *                 with '%', whereas the name of a general entity is just</span></span>
<span id="LC585" class="line" lang="java"><span class="cm">     *                 the entity name.</span></span>
<span id="LC586" class="line" lang="java"><span class="cm">     * @param identifier    An object containing all location information</span></span>
<span id="LC587" class="line" lang="java"><span class="cm">     *                      pertinent to this external entity.</span></span>
<span id="LC588" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC589" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC590" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC591" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC592" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC593" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">externalEntityDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span></span>
<span id="LC594" class="line" lang="java">                                   <span class="nc">XMLResourceIdentifier</span> <span class="n">identifier</span><span class="o">,</span></span>
<span id="LC595" class="line" lang="java">                                   <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span></span>
<span id="LC596" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC600" class="line" lang="java"><span class="cm">     * An unparsed entity declaration.</span></span>
<span id="LC601" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC602" class="line" lang="java"><span class="cm">     * @param name     The name of the entity.</span></span>
<span id="LC603" class="line" lang="java"><span class="cm">     * @param identifier    An object containing all location information</span></span>
<span id="LC604" class="line" lang="java"><span class="cm">     *                      pertinent to this unparsed entity declaration.</span></span>
<span id="LC605" class="line" lang="java"><span class="cm">     * @param notation The name of the notation.</span></span>
<span id="LC606" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC607" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC608" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC609" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC610" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC611" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">unparsedEntityDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span></span>
<span id="LC612" class="line" lang="java">                                   <span class="nc">XMLResourceIdentifier</span> <span class="n">identifier</span><span class="o">,</span></span>
<span id="LC613" class="line" lang="java">                                   <span class="nc">String</span> <span class="n">notation</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span></span>
...
<span id="LC618" class="line" lang="java"><span class="cm">     * A notation declaration</span></span>
<span id="LC619" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC620" class="line" lang="java"><span class="cm">     * @param name     The name of the notation.</span></span>
<span id="LC621" class="line" lang="java"><span class="cm">     * @param identifier    An object containing all location information</span></span>
<span id="LC622" class="line" lang="java"><span class="cm">     *                      pertinent to this notation.</span></span>
<span id="LC623" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC624" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
...
<span id="LC628" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">notationDecl</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">,</span> <span class="nc">XMLResourceIdentifier</span> <span class="n">identifier</span><span class="o">,</span></span>
<span id="LC629" class="line" lang="java">                             <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC633" class="line" lang="java"><span class="cm">     * The start of a conditional section.</span></span>
<span id="LC634" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC635" class="line" lang="java"><span class="cm">     * @param type The type of the conditional section. This value will</span></span>
<span id="LC636" class="line" lang="java"><span class="cm">     *             either be CONDITIONAL_INCLUDE or CONDITIONAL_IGNORE.</span></span>
<span id="LC637" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC638" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC639" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC640" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC641" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC642" class="line" lang="java"><span class="cm">     * @see #CONDITIONAL_INCLUDE</span></span>
<span id="LC643" class="line" lang="java"><span class="cm">     * @see #CONDITIONAL_IGNORE</span></span>
<span id="LC644" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC645" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startConditional</span><span class="o">(</span><span class="kt">short</span> <span class="n">type</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span></span>
<span id="LC646" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC650" class="line" lang="java"><span class="cm">     * Characters within an IGNORE conditional section.</span></span>
<span id="LC651" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC652" class="line" lang="java"><span class="cm">     * @param text The ignored text.</span></span>
<span id="LC653" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC654" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC655" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC656" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC657" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC658" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">ignoredCharacters</span><span class="o">(</span><span class="nc">XMLString</span> <span class="n">text</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span></span>
<span id="LC659" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC663" class="line" lang="java"><span class="cm">     * The end of a conditional section.</span></span>
<span id="LC664" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC665" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
...
<span id="LC670" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endConditional</span><span class="o">(</span><span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC674" class="line" lang="java"><span class="cm">     * The end of the DTD.</span></span>
<span id="LC675" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC676" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC677" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC678" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC679" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC680" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC681" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endDTD</span><span class="o">(</span><span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC686" class="line" lang="java">    <span class="c1">// XMLDTDContentModelHandler methods</span></span>
...
<span id="LC690" class="line" lang="java"><span class="cm">     * The start of a content model. Depending on the type of the content</span></span>
<span id="LC691" class="line" lang="java"><span class="cm">     * model, specific methods may be called between the call to the</span></span>
<span id="LC692" class="line" lang="java"><span class="cm">     * startContentModel method and the call to the endContentModel method.</span></span>
<span id="LC693" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC694" class="line" lang="java"><span class="cm">     * @param elementName The name of the element.</span></span>
<span id="LC695" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC696" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC697" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC698" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC699" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC700" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startContentModel</span><span class="o">(</span><span class="nc">String</span> <span class="n">elementName</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span></span>
...
<span id="LC705" class="line" lang="java"><span class="cm">     * A content model of ANY.</span></span>
<span id="LC706" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC707" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC708" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC709" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC710" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC711" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC712" class="line" lang="java"><span class="cm">     * @see #empty</span></span>
<span id="LC713" class="line" lang="java"><span class="cm">     * @see #startGroup</span></span>
<span id="LC714" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC715" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">any</span><span class="o">(</span><span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC719" class="line" lang="java"><span class="cm">     * A content model of EMPTY.</span></span>
<span id="LC720" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC721" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC722" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC723" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC724" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC725" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC726" class="line" lang="java"><span class="cm">     * @see #any</span></span>
<span id="LC727" class="line" lang="java"><span class="cm">     * @see #startGroup</span></span>
<span id="LC728" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC729" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">empty</span><span class="o">(</span><span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC733" class="line" lang="java"><span class="cm">     * A start of either a mixed or children content model. A mixed</span></span>
<span id="LC734" class="line" lang="java"><span class="cm">     * content model will immediately be followed by a call to the</span></span>
<span id="LC735" class="line" lang="java"><span class="cm">     * &lt;code&gt;pcdata()&lt;/code&gt; method. A children content model will</span></span>
<span id="LC736" class="line" lang="java"><span class="cm">     * contain additional groups and/or elements.</span></span>
<span id="LC737" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC738" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC739" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
...
<span id="LC743" class="line" lang="java"><span class="cm">     * @see #any</span></span>
<span id="LC744" class="line" lang="java"><span class="cm">     * @see #empty</span></span>
<span id="LC745" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC746" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">startGroup</span><span class="o">(</span><span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC750" class="line" lang="java"><span class="cm">     * The appearance of "#PCDATA" within a group signifying a</span></span>
<span id="LC751" class="line" lang="java"><span class="cm">     * mixed content model. This method will be the first called</span></span>
<span id="LC752" class="line" lang="java"><span class="cm">     * following the content model's &lt;code&gt;startGroup()&lt;/code&gt;.</span></span>
<span id="LC753" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC754" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC755" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC756" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC757" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC758" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC759" class="line" lang="java"><span class="cm">     * @see #startGroup</span></span>
<span id="LC760" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC761" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">pcdata</span><span class="o">(</span><span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC765" class="line" lang="java"><span class="cm">     * A referenced element in a mixed or children content model.</span></span>
<span id="LC766" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC767" class="line" lang="java"><span class="cm">     * @param elementName The name of the referenced element.</span></span>
<span id="LC768" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
...
<span id="LC771" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC772" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC773" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">element</span><span class="o">(</span><span class="nc">String</span> <span class="n">elementName</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span></span>
<span id="LC774" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC778" class="line" lang="java"><span class="cm">     * The separator between choices or sequences of a mixed or children</span></span>
<span id="LC779" class="line" lang="java"><span class="cm">     * content model.</span></span>
<span id="LC780" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC781" class="line" lang="java"><span class="cm">     * @param separator The type of children separator.</span></span>
<span id="LC782" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
...
<span id="LC787" class="line" lang="java"><span class="cm">     * @see #SEPARATOR_CHOICE</span></span>
<span id="LC788" class="line" lang="java"><span class="cm">     * @see #SEPARATOR_SEQUENCE</span></span>
<span id="LC789" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC790" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">separator</span><span class="o">(</span><span class="kt">short</span> <span class="n">separator</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span></span>
<span id="LC791" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC795" class="line" lang="java"><span class="cm">     * The occurrence count for a child in a children content model or</span></span>
<span id="LC796" class="line" lang="java"><span class="cm">     * for the mixed content model group.</span></span>
<span id="LC797" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC798" class="line" lang="java"><span class="cm">     * @param occurrence The occurrence count for the last element</span></span>
<span id="LC799" class="line" lang="java"><span class="cm">     *                   or group.</span></span>
<span id="LC800" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC801" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC802" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC803" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC804" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC805" class="line" lang="java"><span class="cm">     * @see #OCCURS_ZERO_OR_ONE</span></span>
<span id="LC806" class="line" lang="java"><span class="cm">     * @see #OCCURS_ZERO_OR_MORE</span></span>
<span id="LC807" class="line" lang="java"><span class="cm">     * @see #OCCURS_ONE_OR_MORE</span></span>
<span id="LC808" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC809" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">occurrence</span><span class="o">(</span><span class="kt">short</span> <span class="n">occurrence</span><span class="o">,</span> <span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span></span>
<span id="LC810" class="line" lang="java">        <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC814" class="line" lang="java"><span class="cm">     * The end of a group for mixed or children content models.</span></span>
<span id="LC815" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC816" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
<span id="LC817" class="line" lang="java"><span class="cm">     *                      augmentations.</span></span>
<span id="LC818" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC819" class="line" lang="java"><span class="cm">     * @throws XNIException Thrown by handler to signal an error.</span></span>
<span id="LC820" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC821" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endGroup</span><span class="o">(</span><span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
...
<span id="LC825" class="line" lang="java"><span class="cm">     * The end of a content model.</span></span>
<span id="LC826" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC827" class="line" lang="java"><span class="cm">     * @param augmentations Additional information that may include infoset</span></span>
...
<span id="LC832" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">endContentModel</span><span class="o">(</span><span class="nc">Augmentations</span> <span class="n">augmentations</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XNIException</span> <span class="o">{</span></span>
<span id="LC833" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC834" class="line" lang="java"></span>
<span id="LC835" class="line" lang="java">    <span class="kd">private</span> <span class="nc">XMLDocumentSource</span> <span class="n">fDocumentSource</span><span class="o">;</span></span>
<span id="LC836" class="line" lang="java"></span>
<span id="LC837" class="line" lang="java">    <span class="cm">/** Sets the document source. */</span></span>
<span id="LC838" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDocumentSource</span><span class="o">(</span><span class="nc">XMLDocumentSource</span> <span class="n">source</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC839" class="line" lang="java">        <span class="n">fDocumentSource</span> <span class="o">=</span> <span class="n">source</span><span class="o">;</span></span>
<span id="LC840" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC841" class="line" lang="java"></span>
<span id="LC842" class="line" lang="java">    <span class="cm">/** Returns the document source. */</span></span>
<span id="LC843" class="line" lang="java">    <span class="kd">public</span> <span class="nc">XMLDocumentSource</span> <span class="nf">getDocumentSource</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC844" class="line" lang="java">        <span class="k">return</span> <span class="n">fDocumentSource</span><span class="o">;</span></span>
<span id="LC845" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC846" class="line" lang="java"></span>
<span id="LC847" class="line" lang="java">    <span class="kd">private</span> <span class="nc">XMLDTDSource</span> <span class="n">fDTDSource</span><span class="o">;</span></span>
<span id="LC848" class="line" lang="java"></span>
<span id="LC849" class="line" lang="java">    <span class="c1">// set the source of this handler</span></span>
<span id="LC850" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDTDSource</span><span class="o">(</span><span class="nc">XMLDTDSource</span> <span class="n">source</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC851" class="line" lang="java">        <span class="n">fDTDSource</span> <span class="o">=</span> <span class="n">source</span><span class="o">;</span></span>
<span id="LC852" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC853" class="line" lang="java"></span>
<span id="LC854" class="line" lang="java">    <span class="c1">// return the source from which this handler derives its events</span></span>
<span id="LC855" class="line" lang="java">    <span class="kd">public</span> <span class="nc">XMLDTDSource</span> <span class="nf">getDTDSource</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC856" class="line" lang="java">        <span class="k">return</span> <span class="n">fDTDSource</span><span class="o">;</span></span>
<span id="LC857" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC858" class="line" lang="java"></span>
<span id="LC859" class="line" lang="java">    <span class="kd">private</span> <span class="nc">XMLDTDContentModelSource</span> <span class="n">fCMSource</span><span class="o">;</span></span>
<span id="LC860" class="line" lang="java"></span>
<span id="LC861" class="line" lang="java">    <span class="c1">// set content model source</span></span>
<span id="LC862" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setDTDContentModelSource</span><span class="o">(</span><span class="nc">XMLDTDContentModelSource</span> <span class="n">source</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC863" class="line" lang="java">        <span class="n">fCMSource</span> <span class="o">=</span> <span class="n">source</span><span class="o">;</span></span>
<span id="LC864" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC865" class="line" lang="java"></span>
<span id="LC866" class="line" lang="java">    <span class="c1">// get content model source</span></span>
<span id="LC867" class="line" lang="java">    <span class="kd">public</span> <span class="nc">XMLDTDContentModelSource</span> <span class="nf">getDTDContentModelSource</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC868" class="line" lang="java">        <span class="k">return</span> <span class="n">fCMSource</span><span class="o">;</span></span>
