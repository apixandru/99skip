...
<span id="LC26" class="line" lang="java"><span class="cm"> * Defines a document filter that acts as both a receiver and an emitter</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * of document events.</span></span>
...
<span id="LC32" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">XMLDocumentFilter</span></span>
<span id="LC33" class="line" lang="java">    <span class="kd">extends</span> <span class="nc">XMLDocumentHandler</span><span class="o">,</span> <span class="nc">XMLDocumentSource</span> <span class="o">{</span></span>
<span id="LC34" class="line" lang="java"></span>
<span id="LC35" class="line" lang="java"></span>
<span id="LC36" class="line" lang="java"><span class="o">}</span> <span class="c1">// interface XMLDocumentFilter</span></span>
