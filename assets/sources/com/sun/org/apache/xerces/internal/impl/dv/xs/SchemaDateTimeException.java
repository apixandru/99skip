...
<span id="LC27" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">SchemaDateTimeException</span> <span class="kd">extends</span> <span class="nc">RuntimeException</span> <span class="o">{</span></span>
<span id="LC28" class="line" lang="java"></span>
<span id="LC29" class="line" lang="java">    <span class="cm">/** Serialization version. */</span></span>
<span id="LC30" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="o">-</span><span class="mi">8520832235337769040L</span><span class="o">;</span></span>
<span id="LC31" class="line" lang="java"></span>
<span id="LC32" class="line" lang="java">    <span class="kd">public</span> <span class="nf">SchemaDateTimeException</span> <span class="o">()</span> <span class="o">{</span></span>
<span id="LC33" class="line" lang="java">        <span class="kd">super</span><span class="o">();</span></span>
<span id="LC34" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC35" class="line" lang="java"></span>
<span id="LC36" class="line" lang="java">    <span class="kd">public</span> <span class="nf">SchemaDateTimeException</span> <span class="o">(</span><span class="nc">String</span> <span class="n">s</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC37" class="line" lang="java">        <span class="kd">super</span> <span class="o">(</span><span class="n">s</span><span class="o">);</span></span>
