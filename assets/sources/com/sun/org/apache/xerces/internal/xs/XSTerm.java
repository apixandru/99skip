...
<span id="LC24" class="line" lang="java"><span class="cm"> * Describes a term that can be one of a model group, a wildcard, or an</span></span>
<span id="LC25" class="line" lang="java"><span class="cm"> * element declaration. Objects implementing</span></span>
<span id="LC26" class="line" lang="java"><span class="cm"> * &lt;code&gt;XSElementDeclaration&lt;/code&gt;, &lt;code&gt;XSModelGroup&lt;/code&gt; and</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * &lt;code&gt;XSWildcard&lt;/code&gt; interfaces also implement this interface.</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC29" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">XSTerm</span> <span class="kd">extends</span> <span class="nc">XSObject</span> <span class="o">{</span></span>
