...
<span id="LC29" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.stream.Location</span><span class="o">;</span></span>
...
<span id="LC31" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.stream.StreamFilter</span><span class="o">;</span></span>
...
<span id="LC34" class="line" lang="java"><span class="kn">import</span> <span class="nn">javax.xml.stream.events.XMLEvent</span><span class="o">;</span></span>
...
<span id="LC39" class="line" lang="java"><span class="cm"> * @author Joe Wang:</span></span>
<span id="LC40" class="line" lang="java"><span class="cm"> * This is a rewrite of the original class. The focus is on removing caching, and make the filtered</span></span>
<span id="LC41" class="line" lang="java"><span class="cm"> * stream reader more compatible with those in other implementations. Note however, that this version</span></span>
<span id="LC42" class="line" lang="java"><span class="cm"> * will not solve all the issues related to the undefined condition in the spec. The priority is</span></span>
<span id="LC43" class="line" lang="java"><span class="cm"> * to pass the TCK. Issues arising due to the requirement, that is, (1) should it initiate at BEGIN_DOCUMENT</span></span>
<span id="LC44" class="line" lang="java"><span class="cm"> * or an accepted event; (2) should hasNext() advance the underlining stream in order to find an acceptable</span></span>
<span id="LC45" class="line" lang="java"><span class="cm"> * event, would have to wait until 1.1 of StAX in which the filtered stream reader would be defined more clearly.</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC47" class="line" lang="java"></span>
<span id="LC48" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">XMLStreamFilterImpl</span> <span class="kd">implements</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">stream</span><span class="o">.</span><span class="na">XMLStreamReader</span> <span class="o">{</span></span>
<span id="LC49" class="line" lang="java"></span>
<span id="LC50" class="line" lang="java">    <span class="kd">private</span> <span class="nc">StreamFilter</span> <span class="n">fStreamFilter</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC51" class="line" lang="java">    <span class="kd">private</span> <span class="nc">XMLStreamReader</span> <span class="n">fStreamReader</span> <span class="o">=</span> <span class="kc">null</span><span class="o">;</span></span>
<span id="LC52" class="line" lang="java">    <span class="kd">private</span> <span class="kt">int</span> <span class="n">fCurrentEvent</span><span class="o">;</span></span>
<span id="LC53" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">fEventAccepted</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC54" class="line" lang="java"></span>
<span id="LC55" class="line" lang="java">    <span class="cm">/**the very issue around a long discussion. but since we must pass the TCK, we have to allow</span></span>
<span id="LC56" class="line" lang="java"><span class="cm">     * hasNext() to advance the underlining stream in order to find the next acceptable event</span></span>
<span id="LC57" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC58" class="line" lang="java">    <span class="kd">private</span> <span class="kt">boolean</span> <span class="n">fStreamAdvancedByHasNext</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC59" class="line" lang="java">    <span class="cm">/** Creates a new instance of XMLStreamFilterImpl */</span></span>
<span id="LC60" class="line" lang="java"></span>
<span id="LC61" class="line" lang="java">    <span class="kd">public</span> <span class="nf">XMLStreamFilterImpl</span><span class="o">(</span><span class="nc">XMLStreamReader</span> <span class="n">reader</span><span class="o">,</span><span class="nc">StreamFilter</span> <span class="n">filter</span><span class="o">){</span></span>
<span id="LC62" class="line" lang="java">        <span class="n">fStreamReader</span> <span class="o">=</span> <span class="n">reader</span><span class="o">;</span></span>
<span id="LC63" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">fStreamFilter</span> <span class="o">=</span> <span class="n">filter</span><span class="o">;</span></span>
<span id="LC64" class="line" lang="java"></span>
<span id="LC65" class="line" lang="java">        <span class="c1">//this is debatable to initiate at an acceptable event,</span></span>
<span id="LC66" class="line" lang="java">        <span class="c1">//but it's neccessary in order to pass the TCK and yet avoid skipping element</span></span>
<span id="LC67" class="line" lang="java">        <span class="k">try</span> <span class="o">{</span></span>
<span id="LC68" class="line" lang="java">            <span class="k">if</span> <span class="o">(</span><span class="n">fStreamFilter</span><span class="o">.</span><span class="na">accept</span><span class="o">(</span><span class="n">fStreamReader</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC69" class="line" lang="java">                <span class="n">fEventAccepted</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC70" class="line" lang="java">            <span class="o">}</span> <span class="k">else</span> <span class="o">{</span></span>
<span id="LC71" class="line" lang="java">                <span class="n">findNextEvent</span><span class="o">();</span></span>
<span id="LC72" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC73" class="line" lang="java">        <span class="o">}</span><span class="k">catch</span><span class="o">(</span><span class="nc">XMLStreamException</span> <span class="n">xs</span><span class="o">){</span></span>
<span id="LC74" class="line" lang="java">            <span class="nc">System</span><span class="o">.</span><span class="na">err</span><span class="o">.</span><span class="na">println</span><span class="o">(</span><span class="s">"Error while creating a stream Filter"</span><span class="o">+</span><span class="n">xs</span><span class="o">);</span></span>
...
<span id="LC80" class="line" lang="java"><span class="cm">     * @param sf</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC82" class="line" lang="java">    <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">setStreamFilter</span><span class="o">(</span><span class="nc">StreamFilter</span> <span class="n">sf</span><span class="o">){</span></span>
<span id="LC83" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">fStreamFilter</span> <span class="o">=</span> <span class="n">sf</span><span class="o">;</span></span>
...
<span id="LC89" class="line" lang="java"><span class="cm">     * @throws XMLStreamException</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC91" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">next</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">XMLStreamException</span> <span class="o">{</span></span>
<span id="LC92" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">fStreamAdvancedByHasNext</span> <span class="o">&amp;&amp;</span> <span class="n">fEventAccepted</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC93" class="line" lang="java">            <span class="n">fStreamAdvancedByHasNext</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC94" class="line" lang="java">            <span class="k">return</span> <span class="n">fCurrentEvent</span><span class="o">;</span></span>
<span id="LC95" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC96" class="line" lang="java">        <span class="kt">int</span> <span class="n">event</span> <span class="o">=</span> <span class="n">findNextEvent</span><span class="o">();</span></span>
<span id="LC97" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">event</span> <span class="o">!=</span> <span class="o">-</span><span class="mi">1</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC98" class="line" lang="java">            <span class="k">return</span> <span class="n">event</span><span class="o">;</span></span>
<span id="LC99" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC100" class="line" lang="java"></span>
<span id="LC101" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">IllegalStateException</span><span class="o">(</span><span class="s">"The stream reader has reached the end of the document, or there are no more "</span><span class="o">+</span></span>
<span id="LC102" class="line" lang="java">                                    <span class="s">" items to return"</span><span class="o">);</span></span>
...
<span id="LC106" class="line" lang="java"><span class="cm">     * @throws XMLStreamException</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC109" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">nextTag</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">XMLStreamException</span> <span class="o">{</span></span>
<span id="LC110" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">fStreamAdvancedByHasNext</span> <span class="o">&amp;&amp;</span> <span class="n">fEventAccepted</span> <span class="o">&amp;&amp;</span></span>
<span id="LC111" class="line" lang="java">                <span class="o">(</span><span class="n">fCurrentEvent</span> <span class="o">==</span> <span class="nc">XMLEvent</span><span class="o">.</span><span class="na">START_ELEMENT</span> <span class="o">||</span> <span class="n">fCurrentEvent</span> <span class="o">==</span> <span class="nc">XMLEvent</span><span class="o">.</span><span class="na">START_ELEMENT</span><span class="o">))</span> <span class="o">{</span></span>
<span id="LC112" class="line" lang="java">            <span class="n">fStreamAdvancedByHasNext</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC113" class="line" lang="java">            <span class="k">return</span> <span class="n">fCurrentEvent</span><span class="o">;</span></span>
<span id="LC114" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC115" class="line" lang="java"></span>
<span id="LC116" class="line" lang="java">        <span class="kt">int</span> <span class="n">event</span> <span class="o">=</span> <span class="n">findNextTag</span><span class="o">();</span></span>
<span id="LC117" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">event</span> <span class="o">!=</span> <span class="o">-</span><span class="mi">1</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC118" class="line" lang="java">            <span class="k">return</span> <span class="n">event</span><span class="o">;</span></span>
<span id="LC119" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC120" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">IllegalStateException</span><span class="o">(</span><span class="s">"The stream reader has reached the end of the document, or there are no more "</span><span class="o">+</span></span>
<span id="LC121" class="line" lang="java">                                    <span class="s">" items to return"</span><span class="o">);</span></span>
...
<span id="LC126" class="line" lang="java"><span class="cm">     * @throws XMLStreamException</span></span>
<span id="LC127" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC128" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC129" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">hasNext</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">XMLStreamException</span> <span class="o">{</span></span>
<span id="LC130" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">fStreamReader</span><span class="o">.</span><span class="na">hasNext</span><span class="o">())</span> <span class="o">{</span></span>
<span id="LC131" class="line" lang="java">            <span class="k">if</span> <span class="o">(!</span><span class="n">fEventAccepted</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC132" class="line" lang="java">                <span class="k">if</span> <span class="o">((</span><span class="n">fCurrentEvent</span> <span class="o">=</span> <span class="n">findNextEvent</span><span class="o">())</span> <span class="o">==</span> <span class="o">-</span><span class="mi">1</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC135" class="line" lang="java">                    <span class="n">fStreamAdvancedByHasNext</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
...
<span id="LC143" class="line" lang="java">    <span class="kd">private</span> <span class="kt">int</span> <span class="nf">findNextEvent</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">XMLStreamException</span> <span class="o">{</span></span>
<span id="LC144" class="line" lang="java">        <span class="n">fStreamAdvancedByHasNext</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC145" class="line" lang="java">        <span class="k">while</span><span class="o">(</span><span class="n">fStreamReader</span><span class="o">.</span><span class="na">hasNext</span><span class="o">()){</span></span>
<span id="LC146" class="line" lang="java">            <span class="n">fCurrentEvent</span> <span class="o">=</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">next</span><span class="o">();</span></span>
<span id="LC147" class="line" lang="java">            <span class="k">if</span><span class="o">(</span><span class="n">fStreamFilter</span><span class="o">.</span><span class="na">accept</span><span class="o">(</span><span class="n">fStreamReader</span><span class="o">)){</span></span>
<span id="LC148" class="line" lang="java">                <span class="n">fEventAccepted</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC149" class="line" lang="java">                <span class="k">return</span> <span class="n">fCurrentEvent</span><span class="o">;</span></span>
<span id="LC150" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC151" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC152" class="line" lang="java">        <span class="c1">//although it seems that IllegalStateException should be thrown when next() is called</span></span>
<span id="LC153" class="line" lang="java">        <span class="c1">//on a stream that has no more items, we have to assume END_DOCUMENT is always accepted</span></span>
<span id="LC154" class="line" lang="java">        <span class="c1">//in order to pass the TCK</span></span>
<span id="LC155" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">fCurrentEvent</span> <span class="o">==</span> <span class="nc">XMLEvent</span><span class="o">.</span><span class="na">END_DOCUMENT</span><span class="o">)</span></span>
<span id="LC156" class="line" lang="java">            <span class="k">return</span> <span class="n">fCurrentEvent</span><span class="o">;</span></span>
...
<span id="LC160" class="line" lang="java">    <span class="kd">private</span> <span class="kt">int</span> <span class="nf">findNextTag</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">XMLStreamException</span> <span class="o">{</span></span>
<span id="LC161" class="line" lang="java">        <span class="n">fStreamAdvancedByHasNext</span> <span class="o">=</span> <span class="kc">false</span><span class="o">;</span></span>
<span id="LC162" class="line" lang="java">        <span class="k">while</span><span class="o">(</span><span class="n">fStreamReader</span><span class="o">.</span><span class="na">hasNext</span><span class="o">()){</span></span>
<span id="LC163" class="line" lang="java">            <span class="n">fCurrentEvent</span> <span class="o">=</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">nextTag</span><span class="o">();</span></span>
<span id="LC164" class="line" lang="java">            <span class="k">if</span><span class="o">(</span><span class="n">fStreamFilter</span><span class="o">.</span><span class="na">accept</span><span class="o">(</span><span class="n">fStreamReader</span><span class="o">)){</span></span>
<span id="LC165" class="line" lang="java">                <span class="n">fEventAccepted</span> <span class="o">=</span> <span class="kc">true</span><span class="o">;</span></span>
<span id="LC166" class="line" lang="java">                <span class="k">return</span> <span class="n">fCurrentEvent</span><span class="o">;</span></span>
<span id="LC167" class="line" lang="java">            <span class="o">}</span></span>
<span id="LC168" class="line" lang="java">        <span class="o">}</span></span>
<span id="LC169" class="line" lang="java">        <span class="k">if</span> <span class="o">(</span><span class="n">fCurrentEvent</span> <span class="o">==</span> <span class="nc">XMLEvent</span><span class="o">.</span><span class="na">END_DOCUMENT</span><span class="o">)</span></span>
<span id="LC170" class="line" lang="java">            <span class="k">return</span> <span class="n">fCurrentEvent</span><span class="o">;</span></span>
<span id="LC171" class="line" lang="java">        <span class="k">else</span></span>
<span id="LC172" class="line" lang="java">            <span class="k">return</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span></span>
...
<span id="LC176" class="line" lang="java"><span class="cm">     * @throws XMLStreamException</span></span>
<span id="LC177" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC178" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">close</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">XMLStreamException</span> <span class="o">{</span></span>
<span id="LC179" class="line" lang="java">        <span class="n">fStreamReader</span><span class="o">.</span><span class="na">close</span><span class="o">();</span></span>
...
<span id="LC184" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC185" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC186" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getAttributeCount</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC187" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getAttributeCount</span><span class="o">();</span></span>
...
<span id="LC192" class="line" lang="java"><span class="cm">     * @param index</span></span>
...
<span id="LC195" class="line" lang="java">    <span class="kd">public</span> <span class="nc">QName</span> <span class="nf">getAttributeName</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC196" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getAttributeName</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
...
<span id="LC201" class="line" lang="java"><span class="cm">     * @param index</span></span>
<span id="LC202" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC203" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC204" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getAttributeNamespace</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC205" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getAttributeNamespace</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
...
<span id="LC210" class="line" lang="java"><span class="cm">     * @param index</span></span>
<span id="LC211" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC213" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getAttributePrefix</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC214" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getAttributePrefix</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
...
<span id="LC219" class="line" lang="java"><span class="cm">     * @param index</span></span>
<span id="LC220" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC222" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getAttributeType</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC223" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getAttributeType</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
...
<span id="LC228" class="line" lang="java"><span class="cm">     * @param index</span></span>
...
<span id="LC231" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getAttributeValue</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC232" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getAttributeValue</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
...
<span id="LC237" class="line" lang="java"><span class="cm">     * @param namespaceURI</span></span>
<span id="LC238" class="line" lang="java"><span class="cm">     * @param localName</span></span>
<span id="LC239" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC240" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC241" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getAttributeValue</span><span class="o">(</span><span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">,</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC242" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getAttributeValue</span><span class="o">(</span><span class="n">namespaceURI</span><span class="o">,</span><span class="n">localName</span><span class="o">);</span></span>
...
<span id="LC247" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC248" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC249" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getCharacterEncodingScheme</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC250" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getCharacterEncodingScheme</span><span class="o">();</span></span>
...
<span id="LC255" class="line" lang="java"><span class="cm">     * @throws XMLStreamException</span></span>
<span id="LC256" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC257" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC258" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getElementText</span><span class="o">()</span> <span class="kd">throws</span> <span class="nc">XMLStreamException</span> <span class="o">{</span></span>
<span id="LC259" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getElementText</span><span class="o">();</span></span>
...
<span id="LC264" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC265" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC266" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getEncoding</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC267" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getEncoding</span><span class="o">();</span></span>
...
<span id="LC272" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC273" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC274" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getEventType</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC275" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getEventType</span><span class="o">();</span></span>
...
<span id="LC280" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC281" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC282" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getLocalName</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC283" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getLocalName</span><span class="o">();</span></span>
...
<span id="LC288" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC290" class="line" lang="java">    <span class="kd">public</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">stream</span><span class="o">.</span><span class="na">Location</span> <span class="nf">getLocation</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC291" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getLocation</span><span class="o">();</span></span>
...
<span id="LC296" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC297" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC298" class="line" lang="java">    <span class="kd">public</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">namespace</span><span class="o">.</span><span class="na">QName</span> <span class="nf">getName</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC299" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getName</span><span class="o">();</span></span>
...
<span id="LC306" class="line" lang="java">    <span class="kd">public</span> <span class="n">javax</span><span class="o">.</span><span class="na">xml</span><span class="o">.</span><span class="na">namespace</span><span class="o">.</span><span class="na">NamespaceContext</span> <span class="nf">getNamespaceContext</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC307" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getNamespaceContext</span><span class="o">();</span></span>
...
<span id="LC314" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getNamespaceCount</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC315" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getNamespaceCount</span><span class="o">();</span></span>
...
<span id="LC320" class="line" lang="java"><span class="cm">     * @param index</span></span>
...
<span id="LC323" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getNamespacePrefix</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC324" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getNamespacePrefix</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
...
<span id="LC329" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC330" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC331" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getNamespaceURI</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC332" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getNamespaceURI</span><span class="o">();</span></span>
...
<span id="LC337" class="line" lang="java"><span class="cm">     * @param index</span></span>
<span id="LC338" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC339" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC340" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getNamespaceURI</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC341" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getNamespaceURI</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
...
<span id="LC346" class="line" lang="java"><span class="cm">     * @param prefix</span></span>
...
<span id="LC349" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getNamespaceURI</span><span class="o">(</span><span class="nc">String</span> <span class="n">prefix</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC350" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getNamespaceURI</span><span class="o">(</span><span class="n">prefix</span><span class="o">);</span></span>
...
<span id="LC355" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC356" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC357" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPIData</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC358" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getPIData</span><span class="o">();</span></span>
...
<span id="LC363" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC364" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC365" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPITarget</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC366" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getPITarget</span><span class="o">();</span></span>
...
<span id="LC371" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC372" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC373" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getPrefix</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC374" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getPrefix</span><span class="o">();</span></span>
...
<span id="LC380" class="line" lang="java"><span class="cm">     * @throws IllegalArgumentException</span></span>
...
<span id="LC383" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Object</span> <span class="nf">getProperty</span><span class="o">(</span><span class="n">java</span><span class="o">.</span><span class="na">lang</span><span class="o">.</span><span class="na">String</span> <span class="n">name</span><span class="o">)</span> <span class="kd">throws</span> <span class="n">java</span><span class="o">.</span><span class="na">lang</span><span class="o">.</span><span class="na">IllegalArgumentException</span> <span class="o">{</span></span>
<span id="LC384" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getProperty</span><span class="o">(</span><span class="n">name</span><span class="o">);</span></span>
...
<span id="LC391" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getText</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC392" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getText</span><span class="o">();</span></span>
...
<span id="LC397" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC398" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC399" class="line" lang="java">    <span class="kd">public</span> <span class="kt">char</span><span class="o">[]</span> <span class="nf">getTextCharacters</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC400" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getTextCharacters</span><span class="o">();</span></span>
...
<span id="LC405" class="line" lang="java"><span class="cm">     * @param sourceStart</span></span>
<span id="LC406" class="line" lang="java"><span class="cm">     * @param target</span></span>
<span id="LC407" class="line" lang="java"><span class="cm">     * @param targetStart</span></span>
<span id="LC408" class="line" lang="java"><span class="cm">     * @param length</span></span>
<span id="LC409" class="line" lang="java"><span class="cm">     * @throws XMLStreamException</span></span>
...
<span id="LC418" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC419" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC420" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getTextLength</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC421" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getTextLength</span><span class="o">();</span></span>
...
<span id="LC428" class="line" lang="java">    <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getTextStart</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC429" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getTextStart</span><span class="o">();</span></span>
...
<span id="LC436" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getVersion</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC437" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getVersion</span><span class="o">();</span></span>
...
<span id="LC442" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC443" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC444" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">hasName</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC445" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">hasName</span><span class="o">();</span></span>
...
<span id="LC450" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC451" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC452" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">hasText</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC453" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">hasText</span><span class="o">();</span></span>
...
<span id="LC458" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC459" class="line" lang="java"><span class="cm">     * @param index</span></span>
<span id="LC460" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC461" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isAttributeSpecified</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC462" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">isAttributeSpecified</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
...
<span id="LC467" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC468" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC469" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isCharacters</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC470" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">isCharacters</span><span class="o">();</span></span>
...
<span id="LC477" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isEndElement</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC478" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">isEndElement</span><span class="o">();</span></span>
...
<span id="LC485" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isStandalone</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC486" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">isStandalone</span><span class="o">();</span></span>
...
<span id="LC491" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC492" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC493" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isStartElement</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC494" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">isStartElement</span><span class="o">();</span></span>
...
<span id="LC499" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC500" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC501" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">isWhiteSpace</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC502" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">isWhiteSpace</span><span class="o">();</span></span>
...
<span id="LC508" class="line" lang="java"><span class="cm">     * @param type</span></span>
<span id="LC509" class="line" lang="java"><span class="cm">     * @param namespaceURI</span></span>
<span id="LC510" class="line" lang="java"><span class="cm">     * @param localName</span></span>
<span id="LC511" class="line" lang="java"><span class="cm">     * @throws XMLStreamException</span></span>
<span id="LC512" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC513" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">require</span><span class="o">(</span><span class="kt">int</span> <span class="n">type</span><span class="o">,</span> <span class="nc">String</span> <span class="n">namespaceURI</span><span class="o">,</span> <span class="nc">String</span> <span class="n">localName</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">XMLStreamException</span> <span class="o">{</span></span>
<span id="LC514" class="line" lang="java">        <span class="n">fStreamReader</span><span class="o">.</span><span class="na">require</span><span class="o">(</span><span class="n">type</span><span class="o">,</span><span class="n">namespaceURI</span><span class="o">,</span><span class="n">localName</span><span class="o">);</span></span>
...
<span id="LC521" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">standaloneSet</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC522" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">standaloneSet</span><span class="o">();</span></span>
...
<span id="LC527" class="line" lang="java"><span class="cm">     * @param index</span></span>
<span id="LC528" class="line" lang="java"><span class="cm">     * @return</span></span>
<span id="LC529" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC530" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getAttributeLocalName</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">){</span></span>
<span id="LC531" class="line" lang="java">        <span class="k">return</span> <span class="n">fStreamReader</span><span class="o">.</span><span class="na">getAttributeLocalName</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
