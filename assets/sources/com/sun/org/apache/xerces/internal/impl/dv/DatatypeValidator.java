...
<span id="LC26" class="line" lang="java"><span class="cm"> * The interface that a DTD datatype must implement. The implementation of this</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * interface must be thread-safe.</span></span>
...
<span id="LC34" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">DatatypeValidator</span> <span class="o">{</span></span>
<span id="LC35" class="line" lang="java"></span>
<span id="LC36" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">     * validate a given string against this DV</span></span>
<span id="LC38" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">     * @param content       the string value that needs to be validated</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">     * @param context       the validation context</span></span>
<span id="LC41" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC42" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">validate</span><span class="o">(</span><span class="nc">String</span> <span class="n">content</span><span class="o">,</span> <span class="nc">ValidationContext</span> <span class="n">context</span><span class="o">)</span></span>
