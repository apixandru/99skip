...
<span id="LC61" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.bcel.internal.classfile.ConstantPool</span><span class="o">;</span></span>
<span id="LC62" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.bcel.internal.classfile.ConstantUtf8</span><span class="o">;</span></span>
<span id="LC63" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.bcel.internal.classfile.ConstantNameAndType</span><span class="o">;</span></span>
<span id="LC64" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.bcel.internal.classfile.ConstantCP</span><span class="o">;</span></span>
<span id="LC65" class="line" lang="java"><span class="kn">import</span> <span class="nn">com.sun.org.apache.bcel.internal.classfile.*</span><span class="o">;</span></span>
<span id="LC66" class="line" lang="java"></span>
<span id="LC67" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> * Super class for the GET/PUTxxx family of instructions.</span></span>
...
<span id="LC72" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">FieldInstruction</span> <span class="kd">extends</span> <span class="nc">FieldOrMethod</span></span>
<span id="LC73" class="line" lang="java">  <span class="kd">implements</span> <span class="nc">TypedInstruction</span> <span class="o">{</span></span>
...
<span id="LC78" class="line" lang="java">  <span class="nc">FieldInstruction</span><span class="o">()</span> <span class="o">{}</span></span>
<span id="LC79" class="line" lang="java"></span>
<span id="LC80" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">   * @param index to constant pool</span></span>
<span id="LC82" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC83" class="line" lang="java">  <span class="kd">protected</span> <span class="nf">FieldInstruction</span><span class="o">(</span><span class="kt">short</span> <span class="n">opcode</span><span class="o">,</span> <span class="kt">int</span> <span class="n">index</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC84" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">opcode</span><span class="o">,</span> <span class="n">index</span><span class="o">);</span></span>
...
<span id="LC88" class="line" lang="java"><span class="cm">   * @return mnemonic for instruction with symbolic references resolved</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC90" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">toString</span><span class="o">(</span><span class="nc">ConstantPool</span> <span class="n">cp</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC91" class="line" lang="java">    <span class="k">return</span> <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">bcel</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">Constants</span><span class="o">.</span><span class="na">OPCODE_NAMES</span><span class="o">[</span><span class="n">opcode</span><span class="o">]</span> <span class="o">+</span> <span class="s">" "</span> <span class="o">+</span></span>
<span id="LC92" class="line" lang="java">      <span class="n">cp</span><span class="o">.</span><span class="na">constantToString</span><span class="o">(</span><span class="n">index</span><span class="o">,</span> <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">bcel</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">Constants</span><span class="o">.</span><span class="na">CONSTANT_Fieldref</span><span class="o">);</span></span>
<span id="LC93" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC94" class="line" lang="java"></span>
<span id="LC95" class="line" lang="java">  <span class="cm">/** @return size of field (1 or 2)</span></span>
<span id="LC96" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC97" class="line" lang="java">  <span class="kd">protected</span> <span class="kt">int</span> <span class="nf">getFieldSize</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC98" class="line" lang="java">    <span class="k">return</span> <span class="nf">getType</span><span class="o">(</span><span class="n">cpg</span><span class="o">).</span><span class="na">getSize</span><span class="o">();</span></span>
<span id="LC99" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC100" class="line" lang="java"></span>
<span id="LC101" class="line" lang="java">  <span class="cm">/** @return return type of referenced field</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC103" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Type</span> <span class="nf">getType</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC104" class="line" lang="java">    <span class="k">return</span> <span class="nf">getFieldType</span><span class="o">(</span><span class="n">cpg</span><span class="o">);</span></span>
<span id="LC105" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC106" class="line" lang="java"></span>
<span id="LC107" class="line" lang="java">  <span class="cm">/** @return type of field</span></span>
<span id="LC108" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC109" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Type</span> <span class="nf">getFieldType</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC110" class="line" lang="java">    <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">getType</span><span class="o">(</span><span class="n">getSignature</span><span class="o">(</span><span class="n">cpg</span><span class="o">));</span></span>
<span id="LC111" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC112" class="line" lang="java"></span>
<span id="LC113" class="line" lang="java">  <span class="cm">/** @return name of referenced field.</span></span>
<span id="LC114" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC115" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getFieldName</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC116" class="line" lang="java">    <span class="k">return</span> <span class="nf">getName</span><span class="o">(</span><span class="n">cpg</span><span class="o">);</span></span>
