...
<span id="LC62" class="line" lang="java"><span class="cm"> * Get the type associated with an instruction, int for ILOAD, or the type</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * of the field of a PUTFIELD instruction, e.g..</span></span>
...
<span id="LC67" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">TypedInstruction</span> <span class="o">{</span></span>
<span id="LC68" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Type</span> <span class="nf">getType</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">);</span></span>
