...
<span id="LC62" class="line" lang="java"><span class="cm"> * FCMPG - Compare floats: value1 &gt; value2</span></span>
...
<span id="LC67" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">FCMPG</span> <span class="kd">extends</span> <span class="nc">Instruction</span></span>
<span id="LC68" class="line" lang="java">  <span class="kd">implements</span> <span class="nc">TypedInstruction</span><span class="o">,</span> <span class="nc">StackProducer</span><span class="o">,</span> <span class="nc">StackConsumer</span> <span class="o">{</span></span>
<span id="LC69" class="line" lang="java">  <span class="kd">public</span> <span class="nf">FCMPG</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC70" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">bcel</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">Constants</span><span class="o">.</span><span class="na">FCMPG</span><span class="o">,</span> <span class="o">(</span><span class="kt">short</span><span class="o">)</span><span class="mi">1</span><span class="o">);</span></span>
<span id="LC71" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC72" class="line" lang="java"></span>
<span id="LC73" class="line" lang="java">  <span class="cm">/** @return Type.FLOAT</span></span>
<span id="LC74" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC75" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Type</span> <span class="nf">getType</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cp</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC76" class="line" lang="java">    <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">FLOAT</span><span class="o">;</span></span>
...
<span id="LC89" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitTypedInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC90" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitStackProducer</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC91" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitStackConsumer</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC92" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitFCMPG</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
