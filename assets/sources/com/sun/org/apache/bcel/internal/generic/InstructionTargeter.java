...
<span id="LC62" class="line" lang="java"><span class="cm"> * Denote that a class targets InstructionHandles within an InstructionList. Namely</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * the following implementers:</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC65" class="line" lang="java"><span class="cm"> * @see BranchHandle</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> * @see LocalVariableGen</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> * @see CodeExceptionGen</span></span>
...
<span id="LC70" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">InstructionTargeter</span> <span class="o">{</span></span>
<span id="LC71" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">containsTarget</span><span class="o">(</span><span class="nc">InstructionHandle</span> <span class="n">ih</span><span class="o">);</span></span>
<span id="LC72" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">updateTarget</span><span class="o">(</span><span class="nc">InstructionHandle</span> <span class="n">old_ih</span><span class="o">,</span> <span class="nc">InstructionHandle</span> <span class="n">new_ih</span><span class="o">);</span></span>
