...
<span id="LC62" class="line" lang="java"><span class="cm"> * IF_ACMPEQ - Branch if reference comparison succeeds</span></span>
...
<span id="LC68" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">IF_ACMPEQ</span> <span class="kd">extends</span> <span class="nc">IfInstruction</span> <span class="o">{</span></span>
...
<span id="LC73" class="line" lang="java">  <span class="no">IF_ACMPEQ</span><span class="o">()</span> <span class="o">{}</span></span>
<span id="LC74" class="line" lang="java"></span>
<span id="LC75" class="line" lang="java">  <span class="kd">public</span> <span class="nf">IF_ACMPEQ</span><span class="o">(</span><span class="nc">InstructionHandle</span> <span class="n">target</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC76" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">bcel</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">Constants</span><span class="o">.</span><span class="na">IF_ACMPEQ</span><span class="o">,</span> <span class="n">target</span><span class="o">);</span></span>
...
<span id="LC83" class="line" lang="java">    <span class="k">return</span> <span class="k">new</span> <span class="nf">IF_ACMPNE</span><span class="o">(</span><span class="n">target</span><span class="o">);</span></span>
...
<span id="LC87" class="line" lang="java"><span class="cm">   * Call corresponding visitor method(s). The order is:</span></span>
<span id="LC88" class="line" lang="java"><span class="cm">   * Call visitor methods of implemented interfaces first, then</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">   * call methods according to the class hierarchy in descending order,</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">   * i.e., the most specific visitXXX() call comes last.</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">   * @param v Visitor object</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC94" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">accept</span><span class="o">(</span><span class="nc">Visitor</span> <span class="n">v</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC95" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitStackConsumer</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC96" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitBranchInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC97" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitIfInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC98" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitIF_ACMPEQ</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
