...
<span id="LC62" class="line" lang="java"><span class="cm"> * LCMP - Compare longs:</span></span>
...
<span id="LC64" class="line" lang="java"><span class="cm"> *        ..., result &lt;= -1, 0, 1&gt;</span></span>
...
<span id="LC68" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">LCMP</span> <span class="kd">extends</span> <span class="nc">Instruction</span></span>
<span id="LC69" class="line" lang="java">  <span class="kd">implements</span> <span class="nc">TypedInstruction</span><span class="o">,</span> <span class="nc">StackProducer</span><span class="o">,</span> <span class="nc">StackConsumer</span></span>
<span id="LC70" class="line" lang="java"><span class="o">{</span></span>
<span id="LC71" class="line" lang="java">  <span class="kd">public</span> <span class="nf">LCMP</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC72" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">bcel</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">Constants</span><span class="o">.</span><span class="na">LCMP</span><span class="o">,</span> <span class="o">(</span><span class="kt">short</span><span class="o">)</span><span class="mi">1</span><span class="o">);</span></span>
<span id="LC73" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC74" class="line" lang="java"></span>
<span id="LC75" class="line" lang="java">  <span class="cm">/** @return Type.LONG</span></span>
...
<span id="LC78" class="line" lang="java">    <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">LONG</span><span class="o">;</span></span>
...
<span id="LC93" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitLCMP</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
