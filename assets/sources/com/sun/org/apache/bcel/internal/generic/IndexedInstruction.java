...
<span id="LC62" class="line" lang="java"><span class="cm"> * Denote entity that refers to an index, e.g. local variable instructions,</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * RET, CPInstruction, etc.</span></span>
...
<span id="LC67" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">IndexedInstruction</span> <span class="o">{</span></span>
<span id="LC68" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">getIndex</span><span class="o">();</span></span>
<span id="LC69" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">setIndex</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">);</span></span>
