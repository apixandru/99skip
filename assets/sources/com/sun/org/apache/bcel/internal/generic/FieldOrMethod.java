...
<span id="LC63" class="line" lang="java"><span class="cm"> * Super class for InvokeInstruction and FieldInstruction, since they have</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> * some methods in common!</span></span>
...
<span id="LC68" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">FieldOrMethod</span> <span class="kd">extends</span> <span class="nc">CPInstruction</span> <span class="kd">implements</span> <span class="nc">LoadClass</span> <span class="o">{</span></span>
...
<span id="LC73" class="line" lang="java">  <span class="nc">FieldOrMethod</span><span class="o">()</span> <span class="o">{}</span></span>
<span id="LC74" class="line" lang="java"></span>
<span id="LC75" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC76" class="line" lang="java"><span class="cm">   * @param index to constant pool</span></span>
<span id="LC77" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC78" class="line" lang="java">  <span class="kd">protected</span> <span class="nf">FieldOrMethod</span><span class="o">(</span><span class="kt">short</span> <span class="n">opcode</span><span class="o">,</span> <span class="kt">int</span> <span class="n">index</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC79" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">opcode</span><span class="o">,</span> <span class="n">index</span><span class="o">);</span></span>
<span id="LC80" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC81" class="line" lang="java"></span>
<span id="LC82" class="line" lang="java">  <span class="cm">/** @return signature of referenced method/field.</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC84" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getSignature</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC85" class="line" lang="java">    <span class="nc">ConstantPool</span>        <span class="n">cp</span>   <span class="o">=</span> <span class="n">cpg</span><span class="o">.</span><span class="na">getConstantPool</span><span class="o">();</span></span>
<span id="LC86" class="line" lang="java">    <span class="nc">ConstantCP</span>          <span class="n">cmr</span>  <span class="o">=</span> <span class="o">(</span><span class="nc">ConstantCP</span><span class="o">)</span><span class="n">cp</span><span class="o">.</span><span class="na">getConstant</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
<span id="LC87" class="line" lang="java">    <span class="nc">ConstantNameAndType</span> <span class="n">cnat</span> <span class="o">=</span> <span class="o">(</span><span class="nc">ConstantNameAndType</span><span class="o">)</span><span class="n">cp</span><span class="o">.</span><span class="na">getConstant</span><span class="o">(</span><span class="n">cmr</span><span class="o">.</span><span class="na">getNameAndTypeIndex</span><span class="o">());</span></span>
<span id="LC88" class="line" lang="java"></span>
<span id="LC89" class="line" lang="java">    <span class="k">return</span> <span class="o">((</span><span class="nc">ConstantUtf8</span><span class="o">)</span><span class="n">cp</span><span class="o">.</span><span class="na">getConstant</span><span class="o">(</span><span class="n">cnat</span><span class="o">.</span><span class="na">getSignatureIndex</span><span class="o">())).</span><span class="na">getBytes</span><span class="o">();</span></span>
<span id="LC90" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC91" class="line" lang="java"></span>
<span id="LC92" class="line" lang="java">  <span class="cm">/** @return name of referenced method/field.</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC94" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getName</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC95" class="line" lang="java">    <span class="nc">ConstantPool</span>        <span class="n">cp</span>   <span class="o">=</span> <span class="n">cpg</span><span class="o">.</span><span class="na">getConstantPool</span><span class="o">();</span></span>
<span id="LC96" class="line" lang="java">    <span class="nc">ConstantCP</span>          <span class="n">cmr</span>  <span class="o">=</span> <span class="o">(</span><span class="nc">ConstantCP</span><span class="o">)</span><span class="n">cp</span><span class="o">.</span><span class="na">getConstant</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
<span id="LC97" class="line" lang="java">    <span class="nc">ConstantNameAndType</span> <span class="n">cnat</span> <span class="o">=</span> <span class="o">(</span><span class="nc">ConstantNameAndType</span><span class="o">)</span><span class="n">cp</span><span class="o">.</span><span class="na">getConstant</span><span class="o">(</span><span class="n">cmr</span><span class="o">.</span><span class="na">getNameAndTypeIndex</span><span class="o">());</span></span>
<span id="LC98" class="line" lang="java">    <span class="k">return</span> <span class="o">((</span><span class="nc">ConstantUtf8</span><span class="o">)</span><span class="n">cp</span><span class="o">.</span><span class="na">getConstant</span><span class="o">(</span><span class="n">cnat</span><span class="o">.</span><span class="na">getNameIndex</span><span class="o">())).</span><span class="na">getBytes</span><span class="o">();</span></span>
<span id="LC99" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC100" class="line" lang="java"></span>
<span id="LC101" class="line" lang="java">  <span class="cm">/** @return name of the referenced class/interface</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC103" class="line" lang="java">  <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getClassName</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC104" class="line" lang="java">    <span class="nc">ConstantPool</span> <span class="n">cp</span>  <span class="o">=</span> <span class="n">cpg</span><span class="o">.</span><span class="na">getConstantPool</span><span class="o">();</span></span>
<span id="LC105" class="line" lang="java">    <span class="nc">ConstantCP</span>   <span class="n">cmr</span> <span class="o">=</span> <span class="o">(</span><span class="nc">ConstantCP</span><span class="o">)</span><span class="n">cp</span><span class="o">.</span><span class="na">getConstant</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
<span id="LC106" class="line" lang="java">    <span class="k">return</span> <span class="n">cp</span><span class="o">.</span><span class="na">getConstantString</span><span class="o">(</span><span class="n">cmr</span><span class="o">.</span><span class="na">getClassIndex</span><span class="o">(),</span> <span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">bcel</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">Constants</span><span class="o">.</span><span class="na">CONSTANT_Class</span><span class="o">).</span><span class="na">replace</span><span class="o">(</span><span class="sc">'/'</span><span class="o">,</span> <span class="sc">'.'</span><span class="o">);</span></span>
<span id="LC107" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC108" class="line" lang="java"></span>
<span id="LC109" class="line" lang="java">  <span class="cm">/** @return type of the referenced class/interface</span></span>
<span id="LC110" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC111" class="line" lang="java">  <span class="kd">public</span> <span class="nc">ObjectType</span> <span class="nf">getClassType</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC112" class="line" lang="java">    <span class="k">return</span> <span class="k">new</span> <span class="nf">ObjectType</span><span class="o">(</span><span class="n">getClassName</span><span class="o">(</span><span class="n">cpg</span><span class="o">));</span></span>
<span id="LC113" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC114" class="line" lang="java"></span>
<span id="LC115" class="line" lang="java">  <span class="cm">/** @return type of the referenced class/interface</span></span>
<span id="LC116" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC117" class="line" lang="java">  <span class="kd">public</span> <span class="nc">ObjectType</span> <span class="nf">getLoadClassType</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC118" class="line" lang="java">    <span class="k">return</span> <span class="nf">getClassType</span><span class="o">(</span><span class="n">cpg</span><span class="o">);</span></span>
