...
<span id="LC67" class="line" lang="java"><span class="cm"> * and represents a reference to a Utf8 encoded string.</span></span>
...
<span id="LC72" class="line" lang="java"><span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">ConstantUtf8</span> <span class="kd">extends</span> <span class="nc">Constant</span> <span class="o">{</span></span>
<span id="LC73" class="line" lang="java">  <span class="kd">private</span> <span class="nc">String</span> <span class="n">bytes</span><span class="o">;</span></span>
...
<span id="LC78" class="line" lang="java">  <span class="kd">public</span> <span class="nf">ConstantUtf8</span><span class="o">(</span><span class="nc">ConstantUtf8</span> <span class="n">c</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC79" class="line" lang="java">    <span class="k">this</span><span class="o">(</span><span class="n">c</span><span class="o">.</span><span class="na">getBytes</span><span class="o">());</span></span>
...
<span id="LC88" class="line" lang="java">  <span class="nc">ConstantUtf8</span><span class="o">(</span><span class="nc">DataInputStream</span> <span class="n">file</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
<span id="LC89" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC90" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">CONSTANT_Utf8</span><span class="o">);</span></span>
<span id="LC91" class="line" lang="java"></span>
<span id="LC92" class="line" lang="java">    <span class="n">bytes</span> <span class="o">=</span> <span class="n">file</span><span class="o">.</span><span class="na">readUTF</span><span class="o">();</span></span>
...
<span id="LC96" class="line" lang="java"><span class="cm">   * @param bytes Data</span></span>
<span id="LC97" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC98" class="line" lang="java">  <span class="kd">public</span> <span class="nf">ConstantUtf8</span><span class="o">(</span><span class="nc">String</span> <span class="n">bytes</span><span class="o">)</span></span>
<span id="LC99" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC100" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">CONSTANT_Utf8</span><span class="o">);</span></span>
<span id="LC101" class="line" lang="java"></span>
<span id="LC102" class="line" lang="java">    <span class="k">if</span><span class="o">(</span><span class="n">bytes</span> <span class="o">==</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC103" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">IllegalArgumentException</span><span class="o">(</span><span class="s">"bytes must not be null!"</span><span class="o">);</span></span>
<span id="LC104" class="line" lang="java"></span>
<span id="LC105" class="line" lang="java">    <span class="k">this</span><span class="o">.</span><span class="na">bytes</span>  <span class="o">=</span> <span class="n">bytes</span><span class="o">;</span></span>
...
<span id="LC109" class="line" lang="java"><span class="cm">   * Called by objects that are traversing the nodes of the tree implicitely</span></span>
<span id="LC110" class="line" lang="java"><span class="cm">   * defined by the contents of a Java class. I.e., the hierarchy of methods,</span></span>
<span id="LC111" class="line" lang="java"><span class="cm">   * fields, attributes, etc. spawns a tree of objects.</span></span>
...
<span id="LC116" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitConstantUtf8</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
...
<span id="LC120" class="line" lang="java"><span class="cm">   * Dump String in Utf8 format to file stream.</span></span>
<span id="LC121" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC122" class="line" lang="java"><span class="cm">   * @param file Output file stream</span></span>
...
<span id="LC125" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">dump</span><span class="o">(</span><span class="nc">DataOutputStream</span> <span class="n">file</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
<span id="LC126" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC127" class="line" lang="java">    <span class="n">file</span><span class="o">.</span><span class="na">writeByte</span><span class="o">(</span><span class="n">tag</span><span class="o">);</span></span>
<span id="LC128" class="line" lang="java">    <span class="n">file</span><span class="o">.</span><span class="na">writeUTF</span><span class="o">(</span><span class="n">bytes</span><span class="o">);</span></span>
...
<span id="LC132" class="line" lang="java"><span class="cm">   * @return Data converted to string.</span></span>
<span id="LC133" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC134" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">String</span> <span class="nf">getBytes</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">bytes</span><span class="o">;</span> <span class="o">}</span></span>
<span id="LC135" class="line" lang="java"></span>
<span id="LC136" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC137" class="line" lang="java"><span class="cm">   * @param bytes.</span></span>
<span id="LC138" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC139" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">setBytes</span><span class="o">(</span><span class="nc">String</span> <span class="n">bytes</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC140" class="line" lang="java">    <span class="k">this</span><span class="o">.</span><span class="na">bytes</span> <span class="o">=</span> <span class="n">bytes</span><span class="o">;</span></span>
...
<span id="LC144" class="line" lang="java"><span class="cm">   * @return String representation</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC146" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">String</span> <span class="nf">toString</span><span class="o">()</span></span>
<span id="LC147" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC148" class="line" lang="java">    <span class="k">return</span> <span class="kd">super</span><span class="o">.</span><span class="na">toString</span><span class="o">()</span> <span class="o">+</span> <span class="s">"(\""</span> <span class="o">+</span> <span class="nc">Utility</span><span class="o">.</span><span class="na">replace</span><span class="o">(</span><span class="n">bytes</span><span class="o">,</span> <span class="s">"\n"</span><span class="o">,</span> <span class="s">"\\n"</span><span class="o">)</span> <span class="o">+</span> <span class="s">"\")"</span><span class="o">;</span></span>
