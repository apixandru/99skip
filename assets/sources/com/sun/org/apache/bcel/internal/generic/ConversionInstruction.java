...
<span id="LC62" class="line" lang="java"><span class="cm"> * Super class for the x2y family of instructions.</span></span>
...
<span id="LC66" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">ConversionInstruction</span> <span class="kd">extends</span> <span class="nc">Instruction</span></span>
...
<span id="LC72" class="line" lang="java">  <span class="nc">ConversionInstruction</span><span class="o">()</span> <span class="o">{}</span></span>
<span id="LC73" class="line" lang="java"></span>
<span id="LC74" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC75" class="line" lang="java"><span class="cm">   * @param opcode opcode of instruction</span></span>
<span id="LC76" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC77" class="line" lang="java">  <span class="kd">protected</span> <span class="nf">ConversionInstruction</span><span class="o">(</span><span class="kt">short</span> <span class="n">opcode</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC85" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">D2I</span><span class="o">:</span> <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">F2I</span><span class="o">:</span> <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">L2I</span><span class="o">:</span></span>
<span id="LC86" class="line" lang="java">      <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">INT</span><span class="o">;</span></span>
<span id="LC87" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">D2F</span><span class="o">:</span> <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">I2F</span><span class="o">:</span> <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">L2F</span><span class="o">:</span></span>
<span id="LC88" class="line" lang="java">      <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">FLOAT</span><span class="o">;</span></span>
<span id="LC89" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">D2L</span><span class="o">:</span> <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">F2L</span><span class="o">:</span> <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">I2L</span><span class="o">:</span></span>
<span id="LC90" class="line" lang="java">      <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">LONG</span><span class="o">;</span></span>
<span id="LC91" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">F2D</span><span class="o">:</span>  <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">I2D</span><span class="o">:</span> <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">L2D</span><span class="o">:</span></span>
<span id="LC92" class="line" lang="java">        <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">DOUBLE</span><span class="o">;</span></span>
<span id="LC93" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">I2B</span><span class="o">:</span></span>
...
<span id="LC95" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">I2C</span><span class="o">:</span></span>
<span id="LC96" class="line" lang="java">      <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">CHAR</span><span class="o">;</span></span>
<span id="LC97" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">I2S</span><span class="o">:</span></span>
<span id="LC98" class="line" lang="java">      <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">SHORT</span><span class="o">;</span></span>
<span id="LC99" class="line" lang="java"></span>
<span id="LC100" class="line" lang="java">    <span class="k">default</span><span class="o">:</span> <span class="c1">// Never reached</span></span>
<span id="LC101" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">ClassGenException</span><span class="o">(</span><span class="s">"Unknown type "</span> <span class="o">+</span> <span class="n">opcode</span><span class="o">);</span></span>
