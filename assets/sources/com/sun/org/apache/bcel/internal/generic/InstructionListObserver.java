...
<span id="LC62" class="line" lang="java"><span class="cm"> * Implement this interface if you're interested in changes to an InstructionList object</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * and register yourself with addObserver().</span></span>
...
<span id="LC67" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">InstructionListObserver</span> <span class="o">{</span></span>
<span id="LC68" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">notify</span><span class="o">(</span><span class="nc">InstructionList</span> <span class="n">list</span><span class="o">);</span></span>
