...
<span id="LC63" class="line" lang="java"><span class="cm"> * Utility class that implements a sequence of bytes which can be read</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> * via the `readByte()' method. This is used to implement a wrapper for the</span></span>
<span id="LC65" class="line" lang="java"><span class="cm"> * Java byte code stream to gain some more readability.</span></span>
...
<span id="LC69" class="line" lang="java"><span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">ByteSequence</span> <span class="kd">extends</span> <span class="nc">DataInputStream</span> <span class="o">{</span></span>
<span id="LC70" class="line" lang="java">  <span class="kd">private</span> <span class="nc">ByteArrayStream</span> <span class="n">byte_stream</span><span class="o">;</span></span>
<span id="LC71" class="line" lang="java"></span>
<span id="LC72" class="line" lang="java">  <span class="kd">public</span> <span class="nf">ByteSequence</span><span class="o">(</span><span class="kt">byte</span><span class="o">[]</span> <span class="n">bytes</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC73" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="k">new</span> <span class="nc">ByteArrayStream</span><span class="o">(</span><span class="n">bytes</span><span class="o">));</span></span>
<span id="LC74" class="line" lang="java">    <span class="n">byte_stream</span> <span class="o">=</span> <span class="o">(</span><span class="nc">ByteArrayStream</span><span class="o">)</span><span class="n">in</span><span class="o">;</span></span>
<span id="LC75" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC76" class="line" lang="java"></span>
<span id="LC77" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">int</span> <span class="nf">getIndex</span><span class="o">()</span>   <span class="o">{</span> <span class="k">return</span> <span class="n">byte_stream</span><span class="o">.</span><span class="na">getPosition</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC78" class="line" lang="java">  <span class="kd">final</span>  <span class="kt">void</span>      <span class="nf">unreadByte</span><span class="o">()</span> <span class="o">{</span> <span class="n">byte_stream</span><span class="o">.</span><span class="na">unreadByte</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC79" class="line" lang="java"></span>
<span id="LC80" class="line" lang="java">  <span class="kd">private</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">ByteArrayStream</span> <span class="kd">extends</span> <span class="nc">ByteArrayInputStream</span> <span class="o">{</span></span>
<span id="LC81" class="line" lang="java">    <span class="nc">ByteArrayStream</span><span class="o">(</span><span class="kt">byte</span><span class="o">[]</span> <span class="n">bytes</span><span class="o">)</span> <span class="o">{</span> <span class="kd">super</span><span class="o">(</span><span class="n">bytes</span><span class="o">);</span> <span class="o">}</span></span>
<span id="LC82" class="line" lang="java">    <span class="kd">final</span> <span class="kt">int</span>  <span class="nf">getPosition</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">pos</span><span class="o">;</span> <span class="o">}</span> <span class="c1">// is protected in ByteArrayInputStream</span></span>
<span id="LC83" class="line" lang="java">    <span class="kd">final</span> <span class="kt">void</span> <span class="nf">unreadByte</span><span class="o">()</span>  <span class="o">{</span> <span class="k">if</span><span class="o">(</span><span class="n">pos</span> <span class="o">&gt;</span> <span class="mi">0</span><span class="o">)</span> <span class="n">pos</span><span class="o">--;</span> <span class="o">}</span></span>
