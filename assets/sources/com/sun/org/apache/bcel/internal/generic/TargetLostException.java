...
<span id="LC62" class="line" lang="java"><span class="cm"> * Thrown by InstructionList.remove() when one or multiple disposed instruction</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * are still being referenced by a InstructionTargeter object. I.e. the</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> * InstructionTargeter has to be notified that (one of) the InstructionHandle it</span></span>
<span id="LC65" class="line" lang="java"><span class="cm"> * is referencing is being removed from the InstructionList and thus not valid anymore.</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> * Making this an exception instead of a return value forces the user to handle</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> * these case explicitely in a try { ... } catch. The following code illustrates</span></span>
<span id="LC69" class="line" lang="java"><span class="cm"> * how this may be done:</span></span>
...
<span id="LC73" class="line" lang="java"><span class="cm"> *     try {</span></span>
<span id="LC74" class="line" lang="java"><span class="cm"> *      il.delete(start_ih, end_ih);</span></span>
<span id="LC75" class="line" lang="java"><span class="cm"> *     } catch(TargetLostException e) {</span></span>
<span id="LC76" class="line" lang="java"><span class="cm"> *       InstructionHandle[] targets = e.getTargets();</span></span>
<span id="LC77" class="line" lang="java"><span class="cm"> *       for(int i=0; i &lt; targets.length; i++) {</span></span>
<span id="LC78" class="line" lang="java"><span class="cm"> *         InstructionTargeter[] targeters = targets[i].getTargeters();</span></span>
<span id="LC79" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC80" class="line" lang="java"><span class="cm"> *         for(int j=0; j &lt; targeters.length; j++)</span></span>
<span id="LC81" class="line" lang="java"><span class="cm"> *           targeters[j].updateTarget(targets[i], new_target);</span></span>
...
<span id="LC86" class="line" lang="java"><span class="cm"> * @see InstructionHandle</span></span>
<span id="LC87" class="line" lang="java"><span class="cm"> * @see InstructionList</span></span>
<span id="LC88" class="line" lang="java"><span class="cm"> * @see InstructionTargeter</span></span>
<span id="LC89" class="line" lang="java"><span class="cm"> * @author  &lt;A HREF="mailto:markus.dahm@berlin.de"&gt;M. Dahm&lt;/A&gt;</span></span>
<span id="LC90" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC91" class="line" lang="java"><span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">TargetLostException</span> <span class="kd">extends</span> <span class="nc">Exception</span> <span class="o">{</span></span>
<span id="LC92" class="line" lang="java">  <span class="kd">private</span> <span class="nc">InstructionHandle</span><span class="o">[]</span> <span class="n">targets</span><span class="o">;</span></span>
<span id="LC93" class="line" lang="java"></span>
<span id="LC94" class="line" lang="java">  <span class="nc">TargetLostException</span><span class="o">(</span><span class="nc">InstructionHandle</span><span class="o">[]</span> <span class="n">t</span><span class="o">,</span> <span class="nc">String</span> <span class="n">mesg</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC95" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">mesg</span><span class="o">);</span></span>
<span id="LC96" class="line" lang="java">    <span class="n">targets</span> <span class="o">=</span> <span class="n">t</span><span class="o">;</span></span>
...
<span id="LC100" class="line" lang="java"><span class="cm">   * @return list of instructions still being targeted.</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC102" class="line" lang="java">  <span class="kd">public</span> <span class="nc">InstructionHandle</span><span class="o">[]</span> <span class="nf">getTargets</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">targets</span><span class="o">;</span> <span class="o">}</span></span>
