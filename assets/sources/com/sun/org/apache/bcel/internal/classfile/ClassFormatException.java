...
<span id="LC62" class="line" lang="java"><span class="cm"> * Thrown when the BCEL attempts to read a class file and determines</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * that the file is malformed or otherwise cannot be interpreted as a</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> * class file.</span></span>
...
<span id="LC68" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">ClassFormatException</span> <span class="kd">extends</span> <span class="nc">RuntimeException</span> <span class="o">{</span></span>
<span id="LC69" class="line" lang="java">  <span class="kd">public</span> <span class="nf">ClassFormatException</span><span class="o">()</span> <span class="o">{</span> <span class="kd">super</span><span class="o">();</span> <span class="o">}</span></span>
<span id="LC70" class="line" lang="java">  <span class="kd">public</span> <span class="nf">ClassFormatException</span><span class="o">(</span><span class="nc">String</span> <span class="n">s</span><span class="o">)</span> <span class="o">{</span> <span class="kd">super</span><span class="o">(</span><span class="n">s</span><span class="o">);</span> <span class="o">}</span></span>
