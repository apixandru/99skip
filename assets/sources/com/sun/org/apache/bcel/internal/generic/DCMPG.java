...
<span id="LC62" class="line" lang="java"><span class="cm"> * DCMPG - Compare doubles: value1 &gt; value2</span></span>
...
<span id="LC68" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">DCMPG</span> <span class="kd">extends</span> <span class="nc">Instruction</span></span>
...
<span id="LC71" class="line" lang="java">  <span class="kd">public</span> <span class="nf">DCMPG</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC72" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">bcel</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">Constants</span><span class="o">.</span><span class="na">DCMPG</span><span class="o">,</span> <span class="o">(</span><span class="kt">short</span><span class="o">)</span><span class="mi">1</span><span class="o">);</span></span>
<span id="LC73" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC74" class="line" lang="java"></span>
<span id="LC75" class="line" lang="java">  <span class="cm">/** @return Type.DOUBLE</span></span>
<span id="LC76" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC77" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Type</span> <span class="nf">getType</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cp</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC78" class="line" lang="java">    <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">DOUBLE</span><span class="o">;</span></span>
...
<span id="LC94" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitDCMPG</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
