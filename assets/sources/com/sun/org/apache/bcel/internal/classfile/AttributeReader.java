...
<span id="LC62" class="line" lang="java"><span class="cm"> * Unknown (non-standard) attributes may be read via user-defined factory</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * objects that can be registered with the Attribute.addAttributeReader</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> * method. These factory objects should implement this interface.</span></span>
<span id="LC65" class="line" lang="java"></span>
<span id="LC66" class="line" lang="java"><span class="cm"> * @see Attribute</span></span>
...
<span id="LC69" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">AttributeReader</span> <span class="o">{</span></span>
<span id="LC70" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC71" class="line" lang="java"><span class="cm">     When this attribute reader is added via the static method</span></span>
<span id="LC72" class="line" lang="java"><span class="cm">     Attribute.addAttributeReader, an attribute name is associated with it.</span></span>
<span id="LC73" class="line" lang="java"><span class="cm">     As the class file parser parses attributes, it will call various</span></span>
<span id="LC74" class="line" lang="java"><span class="cm">     AttributeReaders based on the name of the attributes it is</span></span>
<span id="LC75" class="line" lang="java"><span class="cm">     constructing.</span></span>
<span id="LC76" class="line" lang="java"></span>
<span id="LC77" class="line" lang="java"><span class="cm">     @param name_index An index into the constant pool, indexing a</span></span>
<span id="LC78" class="line" lang="java"><span class="cm">     ConstantUtf8 that represents the name of the attribute.</span></span>
<span id="LC79" class="line" lang="java"></span>
<span id="LC80" class="line" lang="java"><span class="cm">     @param length The length of the data contained in the attribute.  This</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">     is written into the constant pool and should agree with what the</span></span>
<span id="LC82" class="line" lang="java"><span class="cm">     factory expects the length to be.</span></span>
<span id="LC83" class="line" lang="java"></span>
<span id="LC84" class="line" lang="java"><span class="cm">     @param file This is the data input stream that the factory needs to read</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">     its data from.</span></span>
<span id="LC86" class="line" lang="java"></span>
<span id="LC87" class="line" lang="java"><span class="cm">     @param constant_pool This is the constant pool associated with the</span></span>
<span id="LC88" class="line" lang="java"><span class="cm">     Attribute that we are constructing.</span></span>
<span id="LC89" class="line" lang="java"></span>
<span id="LC90" class="line" lang="java"><span class="cm">     @return The user-defined AttributeReader should take this data and use</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">     it to construct an attribute.  In the case of errors, a null can be</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">     returned which will cause the parsing of the class file to fail.</span></span>
<span id="LC93" class="line" lang="java"></span>
<span id="LC94" class="line" lang="java"><span class="cm">     @see Attribute#addAttributeReader( String, AttributeReader )</span></span>
<span id="LC95" class="line" lang="java"><span class="cm">  */</span></span>
<span id="LC96" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Attribute</span> <span class="nf">createAttribute</span><span class="o">(</span><span class="kt">int</span> <span class="n">name_index</span><span class="o">,</span></span>
<span id="LC97" class="line" lang="java">                                   <span class="kt">int</span> <span class="n">length</span><span class="o">,</span></span>
<span id="LC98" class="line" lang="java">                                   <span class="n">java</span><span class="o">.</span><span class="na">io</span><span class="o">.</span><span class="na">DataInputStream</span> <span class="n">file</span><span class="o">,</span></span>
<span id="LC99" class="line" lang="java">                                   <span class="nc">ConstantPool</span> <span class="n">constant_pool</span><span class="o">);</span></span>
