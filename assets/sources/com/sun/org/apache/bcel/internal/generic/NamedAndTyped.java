...
<span id="LC62" class="line" lang="java"><span class="cm"> * Denote entity that has both name and type. This is true for local variables,</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * methods and fields.</span></span>
...
<span id="LC67" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">NamedAndTyped</span> <span class="o">{</span></span>
...
<span id="LC69" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Type</span>   <span class="nf">getType</span><span class="o">();</span></span>
<span id="LC70" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span>   <span class="nf">setName</span><span class="o">(</span><span class="nc">String</span> <span class="n">name</span><span class="o">);</span></span>
<span id="LC71" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span>   <span class="nf">setType</span><span class="o">(</span><span class="nc">Type</span> <span class="n">type</span><span class="o">);</span></span>
