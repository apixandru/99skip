...
<span id="LC62" class="line" lang="java"><span class="cm"> * DREM - Remainder of doubles</span></span>
...
<span id="LC68" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">DREM</span> <span class="kd">extends</span> <span class="nc">ArithmeticInstruction</span> <span class="o">{</span></span>
<span id="LC69" class="line" lang="java">  <span class="cm">/** Remainder of doubles</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC71" class="line" lang="java">  <span class="kd">public</span> <span class="nf">DREM</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC72" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">bcel</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">Constants</span><span class="o">.</span><span class="na">DREM</span><span class="o">);</span></span>
...
<span id="LC77" class="line" lang="java"><span class="cm">   * Call corresponding visitor method(s). The order is:</span></span>
<span id="LC78" class="line" lang="java"><span class="cm">   * Call visitor methods of implemented interfaces first, then</span></span>
<span id="LC79" class="line" lang="java"><span class="cm">   * call methods according to the class hierarchy in descending order,</span></span>
<span id="LC80" class="line" lang="java"><span class="cm">   * i.e., the most specific visitXXX() call comes last.</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC82" class="line" lang="java"><span class="cm">   * @param v Visitor object</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC84" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">accept</span><span class="o">(</span><span class="nc">Visitor</span> <span class="n">v</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC89" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitDREM</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
