...
<span id="LC65" class="line" lang="java"><span class="cm"> * PUTSTATIC - Put static field in class</span></span>
...
<span id="LC68" class="line" lang="java"><span class="cm"> * &lt;PRE&gt;Stack: ..., value.word1, value.word2 -&amp;gt; ...&lt;/PRE&gt;</span></span>
...
<span id="LC72" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">PUTSTATIC</span> <span class="kd">extends</span> <span class="nc">FieldInstruction</span></span>
<span id="LC73" class="line" lang="java">  <span class="kd">implements</span> <span class="nc">ExceptionThrower</span><span class="o">,</span> <span class="nc">PopInstruction</span> <span class="o">{</span></span>
...
<span id="LC78" class="line" lang="java">  <span class="no">PUTSTATIC</span><span class="o">()</span> <span class="o">{}</span></span>
<span id="LC79" class="line" lang="java"></span>
<span id="LC80" class="line" lang="java">  <span class="kd">public</span> <span class="nf">PUTSTATIC</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC81" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">PUTSTATIC</span><span class="o">,</span> <span class="n">index</span><span class="o">);</span></span>
<span id="LC82" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC83" class="line" lang="java"></span>
<span id="LC84" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">consumeStack</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">)</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getFieldSize</span><span class="o">(</span><span class="n">cpg</span><span class="o">);</span> <span class="o">}</span></span>
...
<span id="LC91" class="line" lang="java">    <span class="n">cs</span><span class="o">[</span><span class="nc">ExceptionConstants</span><span class="o">.</span><span class="na">EXCS_FIELD_AND_METHOD_RESOLUTION</span><span class="o">.</span><span class="na">length</span><span class="o">]</span> <span class="o">=</span></span>
<span id="LC92" class="line" lang="java">      <span class="nc">ExceptionConstants</span><span class="o">.</span><span class="na">INCOMPATIBLE_CLASS_CHANGE_ERROR</span><span class="o">;</span></span>
<span id="LC93" class="line" lang="java"></span>
<span id="LC94" class="line" lang="java">    <span class="k">return</span> <span class="n">cs</span><span class="o">;</span></span>
...
<span id="LC99" class="line" lang="java"><span class="cm">   * Call corresponding visitor method(s). The order is:</span></span>
<span id="LC100" class="line" lang="java"><span class="cm">   * Call visitor methods of implemented interfaces first, then</span></span>
<span id="LC101" class="line" lang="java"><span class="cm">   * call methods according to the class hierarchy in descending order,</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">   * i.e., the most specific visitXXX() call comes last.</span></span>
...
<span id="LC107" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitExceptionThrower</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
...
<span id="LC109" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitPopInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
...
<span id="LC111" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitLoadClass</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC112" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitCPInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC113" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitFieldOrMethod</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC114" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitFieldInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC115" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitPUTSTATIC</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
