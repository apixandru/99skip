...
<span id="LC62" class="line" lang="java"><span class="cm"> * Denotes an unparameterized instruction to load a value from a local</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * variable, e.g. ILOAD.</span></span>
...
<span id="LC67" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">LoadInstruction</span> <span class="kd">extends</span> <span class="nc">LocalVariableInstruction</span></span>
<span id="LC68" class="line" lang="java">  <span class="kd">implements</span> <span class="nc">PushInstruction</span></span>
...
<span id="LC75" class="line" lang="java">  <span class="nc">LoadInstruction</span><span class="o">(</span><span class="kt">short</span> <span class="n">canon_tag</span><span class="o">,</span> <span class="kt">short</span> <span class="n">c_tag</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC81" class="line" lang="java"><span class="cm">   * @param c_tag Instruction number for compact version, ALOAD_0, e.g.</span></span>
...
<span id="LC84" class="line" lang="java">  <span class="kd">protected</span> <span class="nf">LoadInstruction</span><span class="o">(</span><span class="kt">short</span> <span class="n">opcode</span><span class="o">,</span> <span class="kt">short</span> <span class="n">c_tag</span><span class="o">,</span> <span class="kt">int</span> <span class="n">n</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC97" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitStackProducer</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC98" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitPushInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
...
<span id="LC101" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitLoadInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
