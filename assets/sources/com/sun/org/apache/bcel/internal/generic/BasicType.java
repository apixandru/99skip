...
<span id="LC63" class="line" lang="java"><span class="cm"> * Denotes basic type such as int.</span></span>
...
<span id="LC67" class="line" lang="java"><span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">BasicType</span> <span class="kd">extends</span> <span class="nc">Type</span> <span class="o">{</span></span>
<span id="LC68" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">   * Constructor for basic types such as int, long, `void'</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC71" class="line" lang="java"><span class="cm">   * @param type one of T_INT, T_BOOLEAN, ..., T_VOID</span></span>
<span id="LC72" class="line" lang="java"><span class="cm">   * @see com.sun.org.apache.bcel.internal.Constants</span></span>
<span id="LC73" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC74" class="line" lang="java">  <span class="nc">BasicType</span><span class="o">(</span><span class="kt">byte</span> <span class="n">type</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC75" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">type</span><span class="o">,</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">SHORT_TYPE_NAMES</span><span class="o">[</span><span class="n">type</span><span class="o">]);</span></span>
<span id="LC76" class="line" lang="java"></span>
<span id="LC77" class="line" lang="java">    <span class="k">if</span><span class="o">((</span><span class="n">type</span> <span class="o">&lt;</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">T_BOOLEAN</span><span class="o">)</span> <span class="o">||</span> <span class="o">(</span><span class="n">type</span> <span class="o">&gt;</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">T_VOID</span><span class="o">))</span></span>
<span id="LC78" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">ClassGenException</span><span class="o">(</span><span class="s">"Invalid type: "</span> <span class="o">+</span> <span class="n">type</span><span class="o">);</span></span>
<span id="LC79" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC80" class="line" lang="java"></span>
<span id="LC81" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">BasicType</span> <span class="nf">getType</span><span class="o">(</span><span class="kt">byte</span> <span class="n">type</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC82" class="line" lang="java">    <span class="k">switch</span><span class="o">(</span><span class="n">type</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC83" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">T_VOID</span><span class="o">:</span>    <span class="k">return</span> <span class="no">VOID</span><span class="o">;</span></span>
<span id="LC84" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">T_BOOLEAN</span><span class="o">:</span> <span class="k">return</span> <span class="no">BOOLEAN</span><span class="o">;</span></span>
<span id="LC85" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">T_BYTE</span><span class="o">:</span>    <span class="k">return</span> <span class="no">BYTE</span><span class="o">;</span></span>
<span id="LC86" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">T_SHORT</span><span class="o">:</span>   <span class="k">return</span> <span class="no">SHORT</span><span class="o">;</span></span>
<span id="LC87" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">T_CHAR</span><span class="o">:</span>    <span class="k">return</span> <span class="no">CHAR</span><span class="o">;</span></span>
<span id="LC88" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">T_INT</span><span class="o">:</span>     <span class="k">return</span> <span class="no">INT</span><span class="o">;</span></span>
<span id="LC89" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">T_LONG</span><span class="o">:</span>    <span class="k">return</span> <span class="no">LONG</span><span class="o">;</span></span>
<span id="LC90" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">T_DOUBLE</span><span class="o">:</span>  <span class="k">return</span> <span class="no">DOUBLE</span><span class="o">;</span></span>
<span id="LC91" class="line" lang="java">    <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">T_FLOAT</span><span class="o">:</span>   <span class="k">return</span> <span class="no">FLOAT</span><span class="o">;</span></span>
<span id="LC92" class="line" lang="java"></span>
<span id="LC93" class="line" lang="java">    <span class="k">default</span><span class="o">:</span></span>
<span id="LC94" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">ClassGenException</span><span class="o">(</span><span class="s">"Invalid type: "</span> <span class="o">+</span> <span class="n">type</span><span class="o">);</span></span>
...
<span id="LC98" class="line" lang="java">  <span class="cm">/** @return true if both type objects refer to the same type</span></span>
...
<span id="LC101" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">equals</span><span class="o">(</span><span class="nc">Object</span> <span class="n">type</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC102" class="line" lang="java">    <span class="k">return</span> <span class="o">(</span><span class="n">type</span> <span class="k">instanceof</span> <span class="nc">BasicType</span><span class="o">)?</span></span>
<span id="LC103" class="line" lang="java">      <span class="o">((</span><span class="nc">BasicType</span><span class="o">)</span><span class="n">type</span><span class="o">).</span><span class="na">type</span> <span class="o">==</span> <span class="k">this</span><span class="o">.</span><span class="na">type</span> <span class="o">:</span> <span class="kc">false</span><span class="o">;</span></span>
...
<span id="LC107" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">hashCode</span><span class="o">()</span> <span class="o">{</span></span>
