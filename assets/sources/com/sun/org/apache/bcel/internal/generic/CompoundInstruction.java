...
<span id="LC62" class="line" lang="java"><span class="cm"> * Wrapper class for `compound' operations, virtual instructions that</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * don't exist as byte code, but give a useful meaning. For example,</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> * the (virtual) PUSH instruction takes an arbitray argument and produces the</span></span>
<span id="LC65" class="line" lang="java"><span class="cm"> * appropiate code at dump time (ICONST, LDC, BIPUSH, ...). Also you can use the</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> * SWITCH instruction as a useful template for either LOOKUPSWITCH or</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> * TABLESWITCH.</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC69" class="line" lang="java"><span class="cm"> * The interface provides the possibilty for the user to write</span></span>
<span id="LC70" class="line" lang="java"><span class="cm"> * `templates' or `macros' for such reuseable code patterns.</span></span>
...
<span id="LC73" class="line" lang="java"><span class="cm"> * @see PUSH</span></span>
<span id="LC74" class="line" lang="java"><span class="cm"> * @see SWITCH</span></span>
<span id="LC75" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC76" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">CompoundInstruction</span> <span class="o">{</span></span>
<span id="LC77" class="line" lang="java">  <span class="kd">public</span> <span class="nc">InstructionList</span> <span class="nf">getInstructionList</span><span class="o">();</span></span>
