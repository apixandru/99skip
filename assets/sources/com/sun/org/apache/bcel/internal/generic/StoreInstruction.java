...
<span id="LC62" class="line" lang="java"><span class="cm"> * Denotes an unparameterized instruction to store a value into a local variable,</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * e.g. ISTORE.</span></span>
...
<span id="LC67" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">StoreInstruction</span> <span class="kd">extends</span> <span class="nc">LocalVariableInstruction</span></span>
<span id="LC68" class="line" lang="java">  <span class="kd">implements</span> <span class="nc">PopInstruction</span></span>
...
<span id="LC73" class="line" lang="java"><span class="cm">   * tag and length are defined in readInstruction and initFromFile, respectively.</span></span>
<span id="LC74" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC75" class="line" lang="java">  <span class="nc">StoreInstruction</span><span class="o">(</span><span class="kt">short</span> <span class="n">canon_tag</span><span class="o">,</span> <span class="kt">short</span> <span class="n">c_tag</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC76" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">canon_tag</span><span class="o">,</span> <span class="n">c_tag</span><span class="o">);</span></span>
...
<span id="LC80" class="line" lang="java"><span class="cm">   * @param opcode Instruction opcode</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">   * @param c_tag Instruction number for compact version, ASTORE_0, e.g.</span></span>
<span id="LC82" class="line" lang="java"><span class="cm">   * @param n local variable index (unsigned short)</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC84" class="line" lang="java">  <span class="kd">protected</span> <span class="nf">StoreInstruction</span><span class="o">(</span><span class="kt">short</span> <span class="n">opcode</span><span class="o">,</span> <span class="kt">short</span> <span class="n">c_tag</span><span class="o">,</span> <span class="kt">int</span> <span class="n">n</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC85" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">opcode</span><span class="o">,</span> <span class="n">c_tag</span><span class="o">,</span> <span class="n">n</span><span class="o">);</span></span>
...
<span id="LC89" class="line" lang="java"><span class="cm">   * Call corresponding visitor method(s). The order is:</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">   * Call visitor methods of implemented interfaces first, then</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">   * call methods according to the class hierarchy in descending order,</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">   * i.e., the most specific visitXXX() call comes last.</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">   * @param v Visitor object</span></span>
<span id="LC95" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC96" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">accept</span><span class="o">(</span><span class="nc">Visitor</span> <span class="n">v</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC97" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitStackConsumer</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC98" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitPopInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC99" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitTypedInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC100" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitLocalVariableInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC101" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitStoreInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
