...
<span id="LC62" class="line" lang="java"><span class="cm"> * This interface denotes those constants that have a "natural" value,</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * such as ConstantLong, ConstantString, etc..</span></span>
...
<span id="LC66" class="line" lang="java"><span class="cm"> * @see     Constant</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC68" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">ConstantObject</span> <span class="o">{</span></span>
<span id="LC69" class="line" lang="java">  <span class="cm">/** @return object representing the constant, e.g., Long for ConstantLong</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC71" class="line" lang="java">  <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">Object</span> <span class="nf">getConstantValue</span><span class="o">(</span><span class="nc">ConstantPool</span> <span class="n">cp</span><span class="o">);</span></span>
