...
<span id="LC65" class="line" lang="java"><span class="cm"> * This class represents a constant pool reference to a field.</span></span>
...
<span id="LC69" class="line" lang="java"><span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">ConstantFieldref</span> <span class="kd">extends</span> <span class="nc">ConstantCP</span> <span class="o">{</span></span>
...
<span id="LC73" class="line" lang="java">  <span class="kd">public</span> <span class="nf">ConstantFieldref</span><span class="o">(</span><span class="nc">ConstantFieldref</span> <span class="n">c</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC74" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">CONSTANT_Fieldref</span><span class="o">,</span> <span class="n">c</span><span class="o">.</span><span class="na">getClassIndex</span><span class="o">(),</span> <span class="n">c</span><span class="o">.</span><span class="na">getNameAndTypeIndex</span><span class="o">());</span></span>
...
<span id="LC83" class="line" lang="java">  <span class="nc">ConstantFieldref</span><span class="o">(</span><span class="nc">DataInputStream</span> <span class="n">file</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
<span id="LC84" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC85" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">CONSTANT_Fieldref</span><span class="o">,</span> <span class="n">file</span><span class="o">);</span></span>
...
<span id="LC89" class="line" lang="java"><span class="cm">   * @param class_index Reference to the class containing the Field</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">   * @param name_and_type_index and the Field signature</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC92" class="line" lang="java">  <span class="kd">public</span> <span class="nf">ConstantFieldref</span><span class="o">(</span><span class="kt">int</span> <span class="n">class_index</span><span class="o">,</span></span>
...
<span id="LC94" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">CONSTANT_Fieldref</span><span class="o">,</span> <span class="n">class_index</span><span class="o">,</span> <span class="n">name_and_type_index</span><span class="o">);</span></span>
...
<span id="LC99" class="line" lang="java"><span class="cm">   * defined by the contents of a Java class. I.e., the hierarchy of Fields,</span></span>
...
<span id="LC105" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitConstantFieldref</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
