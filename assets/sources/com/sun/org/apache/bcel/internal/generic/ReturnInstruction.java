...
<span id="LC64" class="line" lang="java"><span class="cm"> * Super class for the xRETURN family of instructions.</span></span>
...
<span id="LC68" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">ReturnInstruction</span> <span class="kd">extends</span> <span class="nc">Instruction</span></span>
<span id="LC69" class="line" lang="java">  <span class="kd">implements</span> <span class="nc">ExceptionThrower</span><span class="o">,</span> <span class="nc">TypedInstruction</span><span class="o">,</span> <span class="nc">StackConsumer</span> <span class="o">{</span></span>
...
<span id="LC74" class="line" lang="java">  <span class="nc">ReturnInstruction</span><span class="o">()</span> <span class="o">{}</span></span>
<span id="LC75" class="line" lang="java"></span>
<span id="LC76" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC77" class="line" lang="java"><span class="cm">   * @param opcode of instruction</span></span>
<span id="LC78" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC79" class="line" lang="java">  <span class="kd">protected</span> <span class="nf">ReturnInstruction</span><span class="o">(</span><span class="kt">short</span> <span class="n">opcode</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC80" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">opcode</span><span class="o">,</span> <span class="o">(</span><span class="kt">short</span><span class="o">)</span><span class="mi">1</span><span class="o">);</span></span>
<span id="LC81" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC82" class="line" lang="java"></span>
<span id="LC83" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Type</span> <span class="nf">getType</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC85" class="line" lang="java">      <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">IRETURN</span><span class="o">:</span> <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">INT</span><span class="o">;</span></span>
<span id="LC86" class="line" lang="java">      <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">LRETURN</span><span class="o">:</span> <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">LONG</span><span class="o">;</span></span>
<span id="LC87" class="line" lang="java">      <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">FRETURN</span><span class="o">:</span> <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">FLOAT</span><span class="o">;</span></span>
<span id="LC88" class="line" lang="java">      <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">DRETURN</span><span class="o">:</span> <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">DOUBLE</span><span class="o">;</span></span>
<span id="LC89" class="line" lang="java">      <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">ARETURN</span><span class="o">:</span> <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">OBJECT</span><span class="o">;</span></span>
<span id="LC90" class="line" lang="java">      <span class="k">case</span> <span class="nc">Constants</span><span class="o">.</span><span class="na">RETURN</span><span class="o">:</span>  <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">VOID</span><span class="o">;</span></span>
<span id="LC91" class="line" lang="java"></span>
<span id="LC92" class="line" lang="java">    <span class="k">default</span><span class="o">:</span> <span class="c1">// Never reached</span></span>
<span id="LC93" class="line" lang="java">      <span class="k">throw</span> <span class="k">new</span> <span class="nf">ClassGenException</span><span class="o">(</span><span class="s">"Unknown type "</span> <span class="o">+</span> <span class="n">opcode</span><span class="o">);</span></span>
...
<span id="LC97" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Class</span><span class="o">[]</span> <span class="nf">getExceptions</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC98" class="line" lang="java">    <span class="k">return</span> <span class="k">new</span> <span class="nc">Class</span><span class="o">[]</span> <span class="o">{</span> <span class="nc">ExceptionConstants</span><span class="o">.</span><span class="na">ILLEGAL_MONITOR_STATE</span> <span class="o">};</span></span>
<span id="LC99" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC100" class="line" lang="java"></span>
<span id="LC101" class="line" lang="java">  <span class="cm">/** @return type associated with the instruction</span></span>
<span id="LC102" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC103" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Type</span> <span class="nf">getType</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cp</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC104" class="line" lang="java">    <span class="k">return</span> <span class="nf">getType</span><span class="o">();</span></span>
