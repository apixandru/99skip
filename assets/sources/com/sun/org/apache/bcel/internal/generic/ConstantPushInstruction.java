...
<span id="LC62" class="line" lang="java"><span class="cm"> * Denotes a push instruction that produces a literal on the stack</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * such as  SIPUSH, BIPUSH, ICONST, etc.</span></span>
...
<span id="LC67" class="line" lang="java"><span class="cm"> * @see ICONST</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> * @see SIPUSH</span></span>
<span id="LC69" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC70" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">ConstantPushInstruction</span> <span class="kd">extends</span> <span class="nc">PushInstruction</span><span class="o">,</span> <span class="nc">TypedInstruction</span> <span class="o">{</span></span>
<span id="LC71" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Number</span> <span class="nf">getValue</span><span class="o">();</span></span>
