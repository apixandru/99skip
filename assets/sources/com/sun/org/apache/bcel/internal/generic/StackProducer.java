...
<span id="LC62" class="line" lang="java"><span class="cm"> * Denote an instruction that may produce a value on top of the stack</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * (this excludes DUP_X1, e.g.)</span></span>
...
<span id="LC67" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">StackProducer</span> <span class="o">{</span></span>
<span id="LC68" class="line" lang="java">  <span class="cm">/** @return how many words are produced on stack</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC70" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">produceStack</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">);</span></span>
