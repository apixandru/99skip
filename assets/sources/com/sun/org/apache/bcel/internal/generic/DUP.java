...
<span id="LC62" class="line" lang="java"><span class="cm"> * DUP - Duplicate top operand stack word</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * &lt;PRE&gt;Stack: ..., word -&amp;gt; ..., word, word&lt;/PRE&gt;</span></span>
...
<span id="LC67" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">DUP</span> <span class="kd">extends</span> <span class="nc">StackInstruction</span> <span class="kd">implements</span> <span class="nc">PushInstruction</span> <span class="o">{</span></span>
<span id="LC68" class="line" lang="java">  <span class="kd">public</span> <span class="nf">DUP</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC69" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">bcel</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">Constants</span><span class="o">.</span><span class="na">DUP</span><span class="o">);</span></span>
...
<span id="LC85" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitDUP</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
