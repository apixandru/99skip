...
<span id="LC62" class="line" lang="java"><span class="cm"> * BASTORE -  Store into byte or boolean array</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * &lt;PRE&gt;Stack: ..., arrayref, index, value -&amp;gt; ...&lt;/PRE&gt;</span></span>
...
<span id="LC67" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">BASTORE</span> <span class="kd">extends</span> <span class="nc">ArrayInstruction</span> <span class="kd">implements</span> <span class="nc">StackConsumer</span> <span class="o">{</span></span>
<span id="LC68" class="line" lang="java">  <span class="cm">/** Store byte or boolean into array</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC70" class="line" lang="java">  <span class="kd">public</span> <span class="nf">BASTORE</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC71" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">bcel</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">Constants</span><span class="o">.</span><span class="na">BASTORE</span><span class="o">);</span></span>
...
<span id="LC84" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitStackConsumer</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC85" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitExceptionThrower</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC86" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitTypedInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC87" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitArrayInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC88" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitBASTORE</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
