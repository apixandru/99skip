...
<span id="LC62" class="line" lang="java"><span class="cm"> * Denote an instruction that may consume a value from the stack.</span></span>
...
<span id="LC66" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">StackConsumer</span> <span class="o">{</span></span>
<span id="LC67" class="line" lang="java">  <span class="cm">/** @return how many words are consumed from stack</span></span>
<span id="LC68" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC69" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">consumeStack</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">);</span></span>
