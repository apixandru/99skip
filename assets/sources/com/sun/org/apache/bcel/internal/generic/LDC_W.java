...
<span id="LC64" class="line" lang="java"><span class="cm"> * LDC_W - Push item from constant pool (wide index)</span></span>
<span id="LC65" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> * &lt;PRE&gt;Stack: ... -&amp;gt; ..., item.word1, item.word2&lt;/PRE&gt;</span></span>
...
<span id="LC70" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">LDC_W</span> <span class="kd">extends</span> <span class="no">LDC</span> <span class="o">{</span></span>
...
<span id="LC75" class="line" lang="java">  <span class="no">LDC_W</span><span class="o">()</span> <span class="o">{}</span></span>
<span id="LC76" class="line" lang="java"></span>
<span id="LC77" class="line" lang="java">  <span class="kd">public</span> <span class="nf">LDC_W</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC78" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">index</span><span class="o">);</span></span>
...
<span id="LC82" class="line" lang="java"><span class="cm">   * Read needed data (i.e., index) from file.</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC84" class="line" lang="java">  <span class="kd">protected</span> <span class="kt">void</span> <span class="nf">initFromFile</span><span class="o">(</span><span class="nc">ByteSequence</span> <span class="n">bytes</span><span class="o">,</span> <span class="kt">boolean</span> <span class="n">wide</span><span class="o">)</span></span>
...
<span id="LC87" class="line" lang="java">    <span class="n">setIndex</span><span class="o">(</span><span class="n">bytes</span><span class="o">.</span><span class="na">readUnsignedShort</span><span class="o">());</span></span>
<span id="LC88" class="line" lang="java">    <span class="c1">// Override just in case it has been changed</span></span>
