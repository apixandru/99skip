...
<span id="LC62" class="line" lang="java"><span class="cm"> * Denotes that an instruction may start the process of loading and resolving</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * the referenced class in the Virtual Machine.</span></span>
...
<span id="LC67" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">LoadClass</span> <span class="o">{</span></span>
<span id="LC68" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">   * Returns the ObjectType of the referenced class or interface</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">   * that may be loaded and resolved.</span></span>
<span id="LC71" class="line" lang="java"><span class="cm">   * @return object type that may be loaded or null if a primitive is</span></span>
<span id="LC72" class="line" lang="java"><span class="cm">   * referenced</span></span>
<span id="LC73" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC74" class="line" lang="java">  <span class="kd">public</span> <span class="nc">ObjectType</span> <span class="nf">getLoadClassType</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">);</span></span>
<span id="LC75" class="line" lang="java"></span>
<span id="LC76" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC77" class="line" lang="java"><span class="cm">   * Returns the type associated with this instruction.</span></span>
<span id="LC78" class="line" lang="java"><span class="cm">   * LoadClass instances are always typed, but this type</span></span>
<span id="LC79" class="line" lang="java"><span class="cm">   * does not always refer to the type of the class or interface</span></span>
<span id="LC80" class="line" lang="java"><span class="cm">   * that it possibly forces to load. For example, GETFIELD would</span></span>
<span id="LC81" class="line" lang="java"><span class="cm">   * return the type of the field and not the type of the class</span></span>
<span id="LC82" class="line" lang="java"><span class="cm">   * where the field is defined.</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">   * If no class is forced to be loaded, &lt;B&gt;null&lt;/B&gt; is returned.</span></span>
<span id="LC84" class="line" lang="java"><span class="cm">   * An example for this is an ANEWARRAY instruction that creates</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">   * an int[][].</span></span>
<span id="LC86" class="line" lang="java"><span class="cm">   * @see #getLoadClassType(ConstantPoolGen)</span></span>
<span id="LC87" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC88" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Type</span> <span class="nf">getType</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">);</span></span>
