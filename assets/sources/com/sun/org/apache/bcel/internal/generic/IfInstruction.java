...
<span id="LC62" class="line" lang="java"><span class="cm"> * Super class for the IFxxx family of instructions.</span></span>
...
<span id="LC66" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">IfInstruction</span> <span class="kd">extends</span> <span class="nc">BranchInstruction</span> <span class="kd">implements</span> <span class="nc">StackConsumer</span> <span class="o">{</span></span>
...
<span id="LC71" class="line" lang="java">  <span class="nc">IfInstruction</span><span class="o">()</span> <span class="o">{}</span></span>
<span id="LC72" class="line" lang="java"></span>
<span id="LC73" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC74" class="line" lang="java"><span class="cm">   * @param instruction Target instruction to branch to</span></span>
<span id="LC75" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC76" class="line" lang="java">  <span class="kd">protected</span> <span class="nf">IfInstruction</span><span class="o">(</span><span class="kt">short</span> <span class="n">opcode</span><span class="o">,</span> <span class="nc">InstructionHandle</span> <span class="n">target</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC77" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">opcode</span><span class="o">,</span> <span class="n">target</span><span class="o">);</span></span>
...
<span id="LC81" class="line" lang="java"><span class="cm">   * @return negation of instruction, e.g. IFEQ.negate() == IFNE</span></span>
<span id="LC82" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC83" class="line" lang="java">  <span class="kd">public</span> <span class="kd">abstract</span> <span class="nc">IfInstruction</span> <span class="nf">negate</span><span class="o">();</span></span>
