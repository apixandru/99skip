...
<span id="LC62" class="line" lang="java"><span class="cm"> * IFLT - Branch if int comparison with zero succeeds</span></span>
...
<span id="LC68" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">IFLT</span> <span class="kd">extends</span> <span class="nc">IfInstruction</span> <span class="o">{</span></span>
...
<span id="LC73" class="line" lang="java">  <span class="no">IFLT</span><span class="o">()</span> <span class="o">{}</span></span>
<span id="LC74" class="line" lang="java"></span>
<span id="LC75" class="line" lang="java">  <span class="kd">public</span> <span class="nf">IFLT</span><span class="o">(</span><span class="nc">InstructionHandle</span> <span class="n">target</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC76" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">bcel</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">Constants</span><span class="o">.</span><span class="na">IFLT</span><span class="o">,</span> <span class="n">target</span><span class="o">);</span></span>
...
<span id="LC83" class="line" lang="java">    <span class="k">return</span> <span class="k">new</span> <span class="nf">IFGE</span><span class="o">(</span><span class="n">target</span><span class="o">);</span></span>
...
<span id="LC99" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitIFLT</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
