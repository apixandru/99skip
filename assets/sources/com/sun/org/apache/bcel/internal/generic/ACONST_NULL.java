...
<span id="LC62" class="line" lang="java"><span class="cm"> * ACONST_NULL - Push null reference</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * &lt;PRE&gt;Stack: ... -&amp;gt; ..., null&lt;/PRE&gt;</span></span>
...
<span id="LC67" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">ACONST_NULL</span> <span class="kd">extends</span> <span class="nc">Instruction</span></span>
<span id="LC68" class="line" lang="java">  <span class="kd">implements</span> <span class="nc">PushInstruction</span><span class="o">,</span> <span class="nc">TypedInstruction</span> <span class="o">{</span></span>
<span id="LC69" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC70" class="line" lang="java"><span class="cm">   * Push null reference</span></span>
<span id="LC71" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC72" class="line" lang="java">  <span class="kd">public</span> <span class="nf">ACONST_NULL</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC73" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">bcel</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">Constants</span><span class="o">.</span><span class="na">ACONST_NULL</span><span class="o">,</span> <span class="o">(</span><span class="kt">short</span><span class="o">)</span><span class="mi">1</span><span class="o">);</span></span>
<span id="LC74" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC75" class="line" lang="java"></span>
<span id="LC76" class="line" lang="java">  <span class="cm">/** @return Type.NULL</span></span>
<span id="LC77" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC78" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Type</span> <span class="nf">getType</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cp</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC79" class="line" lang="java">    <span class="k">return</span> <span class="nc">Type</span><span class="o">.</span><span class="na">NULL</span><span class="o">;</span></span>
...
<span id="LC93" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitPushInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC94" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitTypedInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC95" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitACONST_NULL</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
