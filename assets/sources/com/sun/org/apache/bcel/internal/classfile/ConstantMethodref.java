...
<span id="LC65" class="line" lang="java"><span class="cm"> * This class represents a constant pool reference to a method.</span></span>
...
<span id="LC69" class="line" lang="java"><span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">ConstantMethodref</span> <span class="kd">extends</span> <span class="nc">ConstantCP</span> <span class="o">{</span></span>
...
<span id="LC73" class="line" lang="java">  <span class="kd">public</span> <span class="nf">ConstantMethodref</span><span class="o">(</span><span class="nc">ConstantMethodref</span> <span class="n">c</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC74" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">CONSTANT_Methodref</span><span class="o">,</span> <span class="n">c</span><span class="o">.</span><span class="na">getClassIndex</span><span class="o">(),</span> <span class="n">c</span><span class="o">.</span><span class="na">getNameAndTypeIndex</span><span class="o">());</span></span>
...
<span id="LC83" class="line" lang="java">  <span class="nc">ConstantMethodref</span><span class="o">(</span><span class="nc">DataInputStream</span> <span class="n">file</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
<span id="LC84" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC85" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">CONSTANT_Methodref</span><span class="o">,</span> <span class="n">file</span><span class="o">);</span></span>
...
<span id="LC92" class="line" lang="java">  <span class="kd">public</span> <span class="nf">ConstantMethodref</span><span class="o">(</span><span class="kt">int</span> <span class="n">class_index</span><span class="o">,</span></span>
...
<span id="LC94" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">CONSTANT_Methodref</span><span class="o">,</span> <span class="n">class_index</span><span class="o">,</span> <span class="n">name_and_type_index</span><span class="o">);</span></span>
...
<span id="LC105" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitConstantMethodref</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
