...
<span id="LC61" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.util.Objects</span><span class="o">;</span></span>
<span id="LC62" class="line" lang="java"></span>
<span id="LC63" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> * Returnaddress, the type JSR or JSR_W instructions push upon the stack.</span></span>
<span id="LC65" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> * see vmspec2 3.3.3</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> * @author  &lt;A HREF="http://www.inf.fu-berlin.de/~ehaase"&gt;Enver Haase&lt;/A&gt;</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC69" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">ReturnaddressType</span> <span class="kd">extends</span> <span class="nc">Type</span> <span class="o">{</span></span>
<span id="LC70" class="line" lang="java"></span>
<span id="LC71" class="line" lang="java">  <span class="kd">public</span> <span class="kd">static</span> <span class="kd">final</span> <span class="nc">ReturnaddressType</span> <span class="no">NO_TARGET</span> <span class="o">=</span> <span class="k">new</span> <span class="nc">ReturnaddressType</span><span class="o">();</span></span>
<span id="LC72" class="line" lang="java">  <span class="kd">private</span> <span class="nc">InstructionHandle</span> <span class="n">returnTarget</span><span class="o">;</span></span>
<span id="LC73" class="line" lang="java"></span>
<span id="LC74" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC75" class="line" lang="java"><span class="cm">   * A Returnaddress [that doesn't know where to return to].</span></span>
<span id="LC76" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC77" class="line" lang="java">  <span class="kd">private</span> <span class="nf">ReturnaddressType</span><span class="o">(){</span></span>
<span id="LC78" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">T_ADDRESS</span><span class="o">,</span> <span class="s">"&lt;return address&gt;"</span><span class="o">);</span></span>
...
<span id="LC82" class="line" lang="java"><span class="cm">   * Creates a ReturnaddressType object with a target.</span></span>
<span id="LC83" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC84" class="line" lang="java">  <span class="kd">public</span> <span class="nf">ReturnaddressType</span><span class="o">(</span><span class="nc">InstructionHandle</span> <span class="n">returnTarget</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC85" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">T_ADDRESS</span><span class="o">,</span> <span class="s">"&lt;return address targeting "</span><span class="o">+</span><span class="n">returnTarget</span><span class="o">+</span><span class="s">"&gt;"</span><span class="o">);</span></span>
<span id="LC86" class="line" lang="java">        <span class="k">this</span><span class="o">.</span><span class="na">returnTarget</span> <span class="o">=</span> <span class="n">returnTarget</span><span class="o">;</span></span>
...
<span id="LC90" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">hashCode</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC91" class="line" lang="java">      <span class="k">return</span> <span class="nc">Objects</span><span class="o">.</span><span class="na">hashCode</span><span class="o">(</span><span class="k">this</span><span class="o">.</span><span class="na">returnTarget</span><span class="o">);</span></span>
...
<span id="LC95" class="line" lang="java"><span class="cm">   * Returns if the two Returnaddresses refer to the same target.</span></span>
...
<span id="LC98" class="line" lang="java">  <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">equals</span><span class="o">(</span><span class="nc">Object</span> <span class="n">rat</span><span class="o">){</span></span>
<span id="LC99" class="line" lang="java">    <span class="k">if</span><span class="o">(!(</span><span class="n">rat</span> <span class="k">instanceof</span> <span class="nc">ReturnaddressType</span><span class="o">))</span></span>
...
<span id="LC102" class="line" lang="java">    <span class="k">return</span> <span class="o">((</span><span class="nc">ReturnaddressType</span><span class="o">)</span><span class="n">rat</span><span class="o">).</span><span class="na">returnTarget</span><span class="o">.</span><span class="na">equals</span><span class="o">(</span><span class="k">this</span><span class="o">.</span><span class="na">returnTarget</span><span class="o">);</span></span>
...
<span id="LC106" class="line" lang="java"><span class="cm">   * @return the target of this ReturnaddressType</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC108" class="line" lang="java">  <span class="kd">public</span> <span class="nc">InstructionHandle</span> <span class="nf">getTarget</span><span class="o">(){</span></span>
<span id="LC109" class="line" lang="java">    <span class="k">return</span> <span class="n">returnTarget</span><span class="o">;</span></span>
