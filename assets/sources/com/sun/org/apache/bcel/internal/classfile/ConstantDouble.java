...
<span id="LC67" class="line" lang="java"><span class="cm"> * and represents a reference to a Double object.</span></span>
...
<span id="LC72" class="line" lang="java"><span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">ConstantDouble</span> <span class="kd">extends</span> <span class="nc">Constant</span> <span class="kd">implements</span> <span class="nc">ConstantObject</span> <span class="o">{</span></span>
<span id="LC73" class="line" lang="java">  <span class="kd">private</span> <span class="kt">double</span> <span class="n">bytes</span><span class="o">;</span></span>
...
<span id="LC78" class="line" lang="java">  <span class="kd">public</span> <span class="nf">ConstantDouble</span><span class="o">(</span><span class="kt">double</span> <span class="n">bytes</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC79" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">CONSTANT_Double</span><span class="o">);</span></span>
<span id="LC80" class="line" lang="java">    <span class="k">this</span><span class="o">.</span><span class="na">bytes</span> <span class="o">=</span> <span class="n">bytes</span><span class="o">;</span></span>
...
<span id="LC84" class="line" lang="java"><span class="cm">   * Initialize from another object.</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC86" class="line" lang="java">  <span class="kd">public</span> <span class="nf">ConstantDouble</span><span class="o">(</span><span class="nc">ConstantDouble</span> <span class="n">c</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC87" class="line" lang="java">    <span class="k">this</span><span class="o">(</span><span class="n">c</span><span class="o">.</span><span class="na">getBytes</span><span class="o">());</span></span>
...
<span id="LC96" class="line" lang="java">  <span class="nc">ConstantDouble</span><span class="o">(</span><span class="nc">DataInputStream</span> <span class="n">file</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
<span id="LC97" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC98" class="line" lang="java">    <span class="k">this</span><span class="o">(</span><span class="n">file</span><span class="o">.</span><span class="na">readDouble</span><span class="o">());</span></span>
...
<span id="LC102" class="line" lang="java"><span class="cm">   * Called by objects that are traversing the nodes of the tree implicitely</span></span>
<span id="LC103" class="line" lang="java"><span class="cm">   * defined by the contents of a Java class. I.e., the hierarchy of methods,</span></span>
<span id="LC104" class="line" lang="java"><span class="cm">   * fields, attributes, etc. spawns a tree of objects.</span></span>
<span id="LC105" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC106" class="line" lang="java"><span class="cm">   * @param v Visitor object</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC108" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">accept</span><span class="o">(</span><span class="nc">Visitor</span> <span class="n">v</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC109" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitConstantDouble</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC110" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC111" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC112" class="line" lang="java"><span class="cm">   * Dump constant double to file stream in binary format.</span></span>
<span id="LC113" class="line" lang="java"><span class="cm">   *</span></span>
<span id="LC114" class="line" lang="java"><span class="cm">   * @param file Output file stream</span></span>
<span id="LC115" class="line" lang="java"><span class="cm">   * @throws IOException</span></span>
<span id="LC116" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC117" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">dump</span><span class="o">(</span><span class="nc">DataOutputStream</span> <span class="n">file</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
<span id="LC118" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC119" class="line" lang="java">    <span class="n">file</span><span class="o">.</span><span class="na">writeByte</span><span class="o">(</span><span class="n">tag</span><span class="o">);</span></span>
<span id="LC120" class="line" lang="java">    <span class="n">file</span><span class="o">.</span><span class="na">writeDouble</span><span class="o">(</span><span class="n">bytes</span><span class="o">);</span></span>
<span id="LC121" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC122" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC123" class="line" lang="java"><span class="cm">   * @return data, i.e., 8 bytes.</span></span>
<span id="LC124" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC125" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">double</span> <span class="nf">getBytes</span><span class="o">()</span> <span class="o">{</span> <span class="k">return</span> <span class="n">bytes</span><span class="o">;</span> <span class="o">}</span></span>
<span id="LC126" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC127" class="line" lang="java"><span class="cm">   * @param bytes.</span></span>
<span id="LC128" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC129" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="kt">void</span> <span class="nf">setBytes</span><span class="o">(</span><span class="kt">double</span> <span class="n">bytes</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC130" class="line" lang="java">    <span class="k">this</span><span class="o">.</span><span class="na">bytes</span> <span class="o">=</span> <span class="n">bytes</span><span class="o">;</span></span>
...
<span id="LC135" class="line" lang="java">  <span class="kd">public</span> <span class="kd">final</span> <span class="nc">String</span> <span class="nf">toString</span><span class="o">()</span></span>
<span id="LC136" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC137" class="line" lang="java">    <span class="k">return</span> <span class="kd">super</span><span class="o">.</span><span class="na">toString</span><span class="o">()</span> <span class="o">+</span> <span class="s">"(bytes = "</span> <span class="o">+</span> <span class="n">bytes</span> <span class="o">+</span> <span class="s">")"</span><span class="o">;</span></span>
<span id="LC138" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC139" class="line" lang="java"></span>
<span id="LC140" class="line" lang="java">  <span class="cm">/** @return Double object</span></span>
<span id="LC141" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC142" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Object</span> <span class="nf">getConstantValue</span><span class="o">(</span><span class="nc">ConstantPool</span> <span class="n">cp</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC143" class="line" lang="java">    <span class="k">return</span> <span class="k">new</span> <span class="nf">Double</span><span class="o">(</span><span class="n">bytes</span><span class="o">);</span></span>
