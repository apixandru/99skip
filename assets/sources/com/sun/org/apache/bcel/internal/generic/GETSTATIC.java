...
<span id="LC65" class="line" lang="java"><span class="cm"> * GETSTATIC - Fetch static field from class</span></span>
...
<span id="LC72" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">GETSTATIC</span> <span class="kd">extends</span> <span class="nc">FieldInstruction</span> <span class="kd">implements</span> <span class="nc">PushInstruction</span><span class="o">,</span> <span class="nc">ExceptionThrower</span> <span class="o">{</span></span>
...
<span id="LC77" class="line" lang="java">  <span class="no">GETSTATIC</span><span class="o">()</span> <span class="o">{}</span></span>
<span id="LC78" class="line" lang="java"></span>
<span id="LC79" class="line" lang="java">  <span class="kd">public</span> <span class="nf">GETSTATIC</span><span class="o">(</span><span class="kt">int</span> <span class="n">index</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC80" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">GETSTATIC</span><span class="o">,</span> <span class="n">index</span><span class="o">);</span></span>
<span id="LC81" class="line" lang="java">  <span class="o">}</span></span>
<span id="LC82" class="line" lang="java"></span>
<span id="LC83" class="line" lang="java">  <span class="kd">public</span> <span class="kt">int</span> <span class="nf">produceStack</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cpg</span><span class="o">)</span> <span class="o">{</span> <span class="k">return</span> <span class="n">getFieldSize</span><span class="o">(</span><span class="n">cpg</span><span class="o">);</span> <span class="o">}</span></span>
<span id="LC84" class="line" lang="java"></span>
<span id="LC85" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Class</span><span class="o">[]</span> <span class="nf">getExceptions</span><span class="o">()</span> <span class="o">{</span></span>
...
<span id="LC88" class="line" lang="java">    <span class="nc">System</span><span class="o">.</span><span class="na">arraycopy</span><span class="o">(</span><span class="nc">ExceptionConstants</span><span class="o">.</span><span class="na">EXCS_FIELD_AND_METHOD_RESOLUTION</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span></span>
<span id="LC89" class="line" lang="java">                     <span class="n">cs</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="nc">ExceptionConstants</span><span class="o">.</span><span class="na">EXCS_FIELD_AND_METHOD_RESOLUTION</span><span class="o">.</span><span class="na">length</span><span class="o">);</span></span>
<span id="LC90" class="line" lang="java">    <span class="n">cs</span><span class="o">[</span><span class="nc">ExceptionConstants</span><span class="o">.</span><span class="na">EXCS_FIELD_AND_METHOD_RESOLUTION</span><span class="o">.</span><span class="na">length</span><span class="o">]</span> <span class="o">=</span></span>
<span id="LC91" class="line" lang="java">      <span class="nc">ExceptionConstants</span><span class="o">.</span><span class="na">INCOMPATIBLE_CLASS_CHANGE_ERROR</span><span class="o">;</span></span>
...
<span id="LC106" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitStackProducer</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC107" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitPushInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
...
<span id="LC109" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitTypedInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
...
<span id="LC113" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitFieldInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC114" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitGETSTATIC</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
