...
<span id="LC64" class="line" lang="java"><span class="cm"> * Abstract definition of a class repository. Instances may be used</span></span>
<span id="LC65" class="line" lang="java"><span class="cm"> * to load classes from different sources and may be used in the</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> * Repository.setRepository method.</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> * @see com.sun.org.apache.bcel.internal.Repository</span></span>
<span id="LC69" class="line" lang="java"><span class="cm"> * @author &lt;A HREF="mailto:markus.dahm@berlin.de"&gt;M. Dahm&lt;/A&gt;</span></span>
<span id="LC70" class="line" lang="java"><span class="cm"> * @author David Dixon-Peugh</span></span>
<span id="LC71" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC72" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">Repository</span> <span class="kd">extends</span> <span class="n">java</span><span class="o">.</span><span class="na">io</span><span class="o">.</span><span class="na">Serializable</span> <span class="o">{</span></span>
<span id="LC73" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC74" class="line" lang="java"><span class="cm">   * Store the provided class under "clazz.getClassName()"</span></span>
<span id="LC75" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC76" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">storeClass</span><span class="o">(</span><span class="nc">JavaClass</span> <span class="n">clazz</span><span class="o">);</span></span>
<span id="LC77" class="line" lang="java"></span>
<span id="LC78" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC79" class="line" lang="java"><span class="cm">   * Remove class from repository</span></span>
<span id="LC80" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC81" class="line" lang="java">  <span class="kd">public</span> <span class="kt">void</span> <span class="nf">removeClass</span><span class="o">(</span><span class="nc">JavaClass</span> <span class="n">clazz</span><span class="o">);</span></span>
<span id="LC82" class="line" lang="java"></span>
<span id="LC83" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC84" class="line" lang="java"><span class="cm">   * Find the class with the name provided, if the class</span></span>
<span id="LC85" class="line" lang="java"><span class="cm">   * isn't there, return NULL.</span></span>
<span id="LC86" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC87" class="line" lang="java">  <span class="kd">public</span> <span class="nc">JavaClass</span> <span class="nf">findClass</span><span class="o">(</span><span class="nc">String</span> <span class="n">className</span><span class="o">);</span></span>
<span id="LC88" class="line" lang="java"></span>
<span id="LC89" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">   * Find the class with the name provided, if the class</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">   * isn't there, make an attempt to load it.</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC93" class="line" lang="java">  <span class="kd">public</span> <span class="nc">JavaClass</span> <span class="nf">loadClass</span><span class="o">(</span><span class="nc">String</span> <span class="n">className</span><span class="o">)</span></span>
<span id="LC94" class="line" lang="java">    <span class="kd">throws</span> <span class="n">java</span><span class="o">.</span><span class="na">lang</span><span class="o">.</span><span class="na">ClassNotFoundException</span><span class="o">;</span></span>
<span id="LC95" class="line" lang="java"></span>
<span id="LC96" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC97" class="line" lang="java"><span class="cm">   * Find the JavaClass instance for the given run-time class object</span></span>
<span id="LC98" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC99" class="line" lang="java">  <span class="kd">public</span> <span class="nc">JavaClass</span> <span class="nf">loadClass</span><span class="o">(</span><span class="nc">Class</span> <span class="n">clazz</span><span class="o">)</span></span>
<span id="LC100" class="line" lang="java">    <span class="kd">throws</span> <span class="n">java</span><span class="o">.</span><span class="na">lang</span><span class="o">.</span><span class="na">ClassNotFoundException</span><span class="o">;</span></span>
<span id="LC101" class="line" lang="java"></span>
<span id="LC102" class="line" lang="java">  <span class="cm">/** Clear all entries from cache.</span></span>
