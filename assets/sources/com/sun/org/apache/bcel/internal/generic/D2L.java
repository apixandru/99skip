...
<span id="LC62" class="line" lang="java"><span class="cm"> * D2L - Convert double to long</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * &lt;PRE&gt;Stack: ..., value.word1, value.word2 -&amp;gt; ..., result.word1, result.word2&lt;/PRE&gt;</span></span>
...
<span id="LC67" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">D2L</span> <span class="kd">extends</span> <span class="nc">ConversionInstruction</span> <span class="o">{</span></span>
<span id="LC68" class="line" lang="java">  <span class="cm">/** Convert double to long</span></span>
<span id="LC69" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC70" class="line" lang="java">  <span class="kd">public</span> <span class="nf">D2L</span><span class="o">()</span> <span class="o">{</span></span>
<span id="LC71" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">bcel</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">Constants</span><span class="o">.</span><span class="na">D2L</span><span class="o">);</span></span>
...
<span id="LC84" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitTypedInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
...
<span id="LC87" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitConversionInstruction</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
<span id="LC88" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitD2L</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
