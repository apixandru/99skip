...
<span id="LC62" class="line" lang="java"><span class="cm"> * Super class for JSR - Jump to subroutine</span></span>
...
<span id="LC66" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">JsrInstruction</span> <span class="kd">extends</span> <span class="nc">BranchInstruction</span></span>
<span id="LC67" class="line" lang="java">  <span class="kd">implements</span> <span class="nc">UnconditionalBranch</span><span class="o">,</span> <span class="nc">TypedInstruction</span><span class="o">,</span> <span class="nc">StackProducer</span></span>
<span id="LC68" class="line" lang="java"><span class="o">{</span></span>
<span id="LC69" class="line" lang="java">  <span class="nc">JsrInstruction</span><span class="o">(</span><span class="kt">short</span> <span class="n">opcode</span><span class="o">,</span> <span class="nc">InstructionHandle</span> <span class="n">target</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC70" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">opcode</span><span class="o">,</span> <span class="n">target</span><span class="o">);</span></span>
...
<span id="LC77" class="line" lang="java">  <span class="nc">JsrInstruction</span><span class="o">(){}</span></span>
<span id="LC78" class="line" lang="java"></span>
<span id="LC79" class="line" lang="java">  <span class="cm">/** @return return address type</span></span>
<span id="LC80" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC81" class="line" lang="java">  <span class="kd">public</span> <span class="nc">Type</span> <span class="nf">getType</span><span class="o">(</span><span class="nc">ConstantPoolGen</span> <span class="n">cp</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC82" class="line" lang="java">    <span class="k">return</span> <span class="k">new</span> <span class="nf">ReturnaddressType</span><span class="o">(</span><span class="n">physicalSuccessor</span><span class="o">());</span></span>
...
<span id="LC86" class="line" lang="java"><span class="cm">   * Returns an InstructionHandle to the physical successor</span></span>
<span id="LC87" class="line" lang="java"><span class="cm">   * of this JsrInstruction. &lt;B&gt;For this method to work,</span></span>
<span id="LC88" class="line" lang="java"><span class="cm">   * this JsrInstruction object must not be shared between</span></span>
<span id="LC89" class="line" lang="java"><span class="cm">   * multiple InstructionHandle objects!&lt;/B&gt;</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">   * Formally, there must not be InstructionHandle objects</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">   * i, j where i != j and i.getInstruction() == this ==</span></span>
<span id="LC92" class="line" lang="java"><span class="cm">   * j.getInstruction().</span></span>
<span id="LC93" class="line" lang="java"><span class="cm">   * @return an InstructionHandle to the "next" instruction that</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">   * will be executed when RETurned from a subroutine.</span></span>
<span id="LC95" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC96" class="line" lang="java">  <span class="kd">public</span> <span class="nc">InstructionHandle</span> <span class="nf">physicalSuccessor</span><span class="o">(){</span></span>
<span id="LC97" class="line" lang="java">    <span class="nc">InstructionHandle</span> <span class="n">ih</span> <span class="o">=</span> <span class="k">this</span><span class="o">.</span><span class="na">target</span><span class="o">;</span></span>
<span id="LC98" class="line" lang="java"></span>
<span id="LC99" class="line" lang="java">    <span class="c1">// Rewind!</span></span>
<span id="LC100" class="line" lang="java">    <span class="k">while</span><span class="o">(</span><span class="n">ih</span><span class="o">.</span><span class="na">getPrev</span><span class="o">()</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span></span>
<span id="LC101" class="line" lang="java">      <span class="n">ih</span> <span class="o">=</span> <span class="n">ih</span><span class="o">.</span><span class="na">getPrev</span><span class="o">();</span></span>
<span id="LC102" class="line" lang="java"></span>
<span id="LC103" class="line" lang="java">    <span class="c1">// Find the handle for "this" JsrInstruction object.</span></span>
<span id="LC104" class="line" lang="java">    <span class="k">while</span><span class="o">(</span><span class="n">ih</span><span class="o">.</span><span class="na">getInstruction</span><span class="o">()</span> <span class="o">!=</span> <span class="k">this</span><span class="o">)</span></span>
<span id="LC105" class="line" lang="java">      <span class="n">ih</span> <span class="o">=</span> <span class="n">ih</span><span class="o">.</span><span class="na">getNext</span><span class="o">();</span></span>
<span id="LC106" class="line" lang="java"></span>
<span id="LC107" class="line" lang="java">    <span class="nc">InstructionHandle</span> <span class="n">toThis</span> <span class="o">=</span> <span class="n">ih</span><span class="o">;</span></span>
<span id="LC108" class="line" lang="java"></span>
<span id="LC109" class="line" lang="java">    <span class="k">while</span><span class="o">(</span><span class="n">ih</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">){</span></span>
<span id="LC110" class="line" lang="java">        <span class="n">ih</span> <span class="o">=</span> <span class="n">ih</span><span class="o">.</span><span class="na">getNext</span><span class="o">();</span></span>
<span id="LC111" class="line" lang="java">        <span class="k">if</span> <span class="o">((</span><span class="n">ih</span> <span class="o">!=</span> <span class="kc">null</span><span class="o">)</span> <span class="o">&amp;&amp;</span> <span class="o">(</span><span class="n">ih</span><span class="o">.</span><span class="na">getInstruction</span><span class="o">()</span> <span class="o">==</span> <span class="k">this</span><span class="o">))</span></span>
<span id="LC112" class="line" lang="java">        <span class="k">throw</span> <span class="k">new</span> <span class="nf">RuntimeException</span><span class="o">(</span><span class="s">"physicalSuccessor() called on a shared JsrInstruction."</span><span class="o">);</span></span>
<span id="LC113" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC114" class="line" lang="java"></span>
<span id="LC115" class="line" lang="java">    <span class="c1">// Return the physical successor</span></span>
<span id="LC116" class="line" lang="java">    <span class="k">return</span> <span class="n">toThis</span><span class="o">.</span><span class="na">getNext</span><span class="o">();</span></span>
