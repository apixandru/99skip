...
<span id="LC62" class="line" lang="java"><span class="cm"> * Denote an instruction that may throw a run-time or a linking</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> * exception (or both) during execution.  This is not quite the truth</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> * as such; because all instructions may throw an</span></span>
<span id="LC65" class="line" lang="java"><span class="cm"> * java.lang.VirtualMachineError. These exceptions are omitted.</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> * The Lava Language Specification specifies exactly which</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> * &lt;i&gt;RUN-TIME&lt;/i&gt; and which &lt;i&gt;LINKING&lt;/i&gt; exceptions each</span></span>
<span id="LC69" class="line" lang="java"><span class="cm"> * instruction may throw which is reflected by the implementers.  Due</span></span>
<span id="LC70" class="line" lang="java"><span class="cm"> * to the structure of the JVM specification, it may be possible that</span></span>
<span id="LC71" class="line" lang="java"><span class="cm"> * an Instruction implementing this interface returns a Class[] of</span></span>
<span id="LC72" class="line" lang="java"><span class="cm"> * size 0.</span></span>
<span id="LC73" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC74" class="line" lang="java"><span class="cm"> * Please note that we speak of an "exception" here when we mean any</span></span>
<span id="LC75" class="line" lang="java"><span class="cm"> * "Throwable" object; so this term is equally used for "Exception"</span></span>
<span id="LC76" class="line" lang="java"><span class="cm"> * and "Error" objects.</span></span>
<span id="LC77" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC78" class="line" lang="java"><span class="cm"> * @author  &lt;A HREF="http://www.inf.fu-berlin.de/~ehaase"&gt;Enver Haase&lt;/A&gt;</span></span>
<span id="LC79" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC80" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">ExceptionThrower</span> <span class="o">{</span></span>
<span id="LC81" class="line" lang="java">  <span class="kd">public</span> <span class="n">java</span><span class="o">.</span><span class="na">lang</span><span class="o">.</span><span class="na">Class</span><span class="o">[]</span> <span class="nf">getExceptions</span><span class="o">();</span></span>
