...
<span id="LC65" class="line" lang="java"><span class="cm"> * This class represents a constant pool reference to an interface method.</span></span>
...
<span id="LC69" class="line" lang="java"><span class="kd">public</span> <span class="kd">final</span> <span class="kd">class</span> <span class="nc">ConstantInterfaceMethodref</span> <span class="kd">extends</span> <span class="nc">ConstantCP</span> <span class="o">{</span></span>
<span id="LC70" class="line" lang="java">  <span class="cm">/**</span></span>
<span id="LC71" class="line" lang="java"><span class="cm">   * Initialize from another object.</span></span>
<span id="LC72" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC73" class="line" lang="java">  <span class="kd">public</span> <span class="nf">ConstantInterfaceMethodref</span><span class="o">(</span><span class="nc">ConstantInterfaceMethodref</span> <span class="n">c</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC74" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">CONSTANT_InterfaceMethodref</span><span class="o">,</span> <span class="n">c</span><span class="o">.</span><span class="na">getClassIndex</span><span class="o">(),</span> <span class="n">c</span><span class="o">.</span><span class="na">getNameAndTypeIndex</span><span class="o">());</span></span>
...
<span id="LC78" class="line" lang="java"><span class="cm">   * Initialize instance from file data.</span></span>
...
<span id="LC83" class="line" lang="java">  <span class="nc">ConstantInterfaceMethodref</span><span class="o">(</span><span class="nc">DataInputStream</span> <span class="n">file</span><span class="o">)</span> <span class="kd">throws</span> <span class="nc">IOException</span></span>
<span id="LC84" class="line" lang="java">  <span class="o">{</span></span>
<span id="LC85" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">CONSTANT_InterfaceMethodref</span><span class="o">,</span> <span class="n">file</span><span class="o">);</span></span>
...
<span id="LC89" class="line" lang="java"><span class="cm">   * @param class_index Reference to the class containing the method</span></span>
<span id="LC90" class="line" lang="java"><span class="cm">   * @param name_and_type_index and the method signature</span></span>
<span id="LC91" class="line" lang="java"><span class="cm">   */</span></span>
<span id="LC92" class="line" lang="java">  <span class="kd">public</span> <span class="nf">ConstantInterfaceMethodref</span><span class="o">(</span><span class="kt">int</span> <span class="n">class_index</span><span class="o">,</span></span>
<span id="LC93" class="line" lang="java">                                    <span class="kt">int</span> <span class="n">name_and_type_index</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC94" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="nc">Constants</span><span class="o">.</span><span class="na">CONSTANT_InterfaceMethodref</span><span class="o">,</span> <span class="n">class_index</span><span class="o">,</span> <span class="n">name_and_type_index</span><span class="o">);</span></span>
...
<span id="LC98" class="line" lang="java"><span class="cm">   * Called by objects that are traversing the nodes of the tree implicitely</span></span>
<span id="LC99" class="line" lang="java"><span class="cm">   * defined by the contents of a Java class. I.e., the hierarchy of methods,</span></span>
<span id="LC100" class="line" lang="java"><span class="cm">   * fields, attributes, etc. spawns a tree of objects.</span></span>
...
<span id="LC105" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitConstantInterfaceMethodref</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
