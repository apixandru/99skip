...
<span id="LC62" class="line" lang="java"><span class="cm"> * IFNONNULL - Branch if reference is not null</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> * &lt;PRE&gt;Stack: ..., reference -&amp;gt; ...&lt;/PRE&gt;</span></span>
...
<span id="LC68" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">IFNONNULL</span> <span class="kd">extends</span> <span class="nc">IfInstruction</span> <span class="o">{</span></span>
...
<span id="LC73" class="line" lang="java">  <span class="no">IFNONNULL</span><span class="o">()</span> <span class="o">{}</span></span>
<span id="LC74" class="line" lang="java"></span>
<span id="LC75" class="line" lang="java">  <span class="kd">public</span> <span class="nf">IFNONNULL</span><span class="o">(</span><span class="nc">InstructionHandle</span> <span class="n">target</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC76" class="line" lang="java">    <span class="kd">super</span><span class="o">(</span><span class="n">com</span><span class="o">.</span><span class="na">sun</span><span class="o">.</span><span class="na">org</span><span class="o">.</span><span class="na">apache</span><span class="o">.</span><span class="na">bcel</span><span class="o">.</span><span class="na">internal</span><span class="o">.</span><span class="na">Constants</span><span class="o">.</span><span class="na">IFNONNULL</span><span class="o">,</span> <span class="n">target</span><span class="o">);</span></span>
...
<span id="LC83" class="line" lang="java">    <span class="k">return</span> <span class="k">new</span> <span class="nf">IFNULL</span><span class="o">(</span><span class="n">target</span><span class="o">);</span></span>
...
<span id="LC98" class="line" lang="java">    <span class="n">v</span><span class="o">.</span><span class="na">visitIFNONNULL</span><span class="o">(</span><span class="k">this</span><span class="o">);</span></span>
