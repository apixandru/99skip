...
<span id="LC62" class="line" lang="java"><span class="cm"> * Super class for GOTO</span></span>
...
<span id="LC66" class="line" lang="java"><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">GotoInstruction</span> <span class="kd">extends</span> <span class="nc">BranchInstruction</span></span>
<span id="LC67" class="line" lang="java">  <span class="kd">implements</span> <span class="nc">UnconditionalBranch</span></span>
<span id="LC68" class="line" lang="java"><span class="o">{</span></span>
<span id="LC69" class="line" lang="java">  <span class="nc">GotoInstruction</span><span class="o">(</span><span class="kt">short</span> <span class="n">opcode</span><span class="o">,</span> <span class="nc">InstructionHandle</span> <span class="n">target</span><span class="o">)</span> <span class="o">{</span></span>
...
<span id="LC77" class="line" lang="java">  <span class="nc">GotoInstruction</span><span class="o">(){}</span></span>
