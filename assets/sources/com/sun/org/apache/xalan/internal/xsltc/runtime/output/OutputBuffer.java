...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: OutputBuffer.java,v 1.2.4.1 2005/09/06 11:35:23 pvedula Exp $</span></span>
...
<span id="LC29" class="line" lang="java"><span class="kd">interface</span> <span class="nc">OutputBuffer</span> <span class="o">{</span></span>
<span id="LC30" class="line" lang="java"></span>
<span id="LC31" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">close</span><span class="o">();</span></span>
<span id="LC32" class="line" lang="java">    <span class="kd">public</span> <span class="nc">OutputBuffer</span> <span class="nf">append</span><span class="o">(</span><span class="kt">char</span> <span class="n">ch</span><span class="o">);</span></span>
<span id="LC33" class="line" lang="java">    <span class="kd">public</span> <span class="nc">OutputBuffer</span> <span class="nf">append</span><span class="o">(</span><span class="nc">String</span> <span class="n">s</span><span class="o">);</span></span>
<span id="LC34" class="line" lang="java">    <span class="kd">public</span> <span class="nc">OutputBuffer</span> <span class="nf">append</span><span class="o">(</span><span class="kt">char</span><span class="o">[]</span> <span class="n">s</span><span class="o">,</span> <span class="kt">int</span> <span class="n">from</span><span class="o">,</span> <span class="kt">int</span> <span class="n">to</span><span class="o">);</span></span>
