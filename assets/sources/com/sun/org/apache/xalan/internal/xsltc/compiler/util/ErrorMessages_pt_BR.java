...
<span id="LC28" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">ErrorMessages_pt_BR</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span> <span class="o">{</span></span>
...
<span id="LC98" class="line" lang="java">        <span class="s">"Mais de uma folha de estilos definida no mesmo arquivo."</span><span class="o">},</span></span>
...
<span id="LC106" class="line" lang="java">        <span class="s">"O modelo ''{0}'' j\u00E1 foi definido nesta folha de estilos."</span><span class="o">},</span></span>
...
<span id="LC115" class="line" lang="java">        <span class="s">"O modelo ''{0}'' n\u00E3o foi definido nesta folha de estilos."</span><span class="o">},</span></span>
...
<span id="LC122" class="line" lang="java">        <span class="s">"A vari\u00E1vel ''{0}'' est\u00E1 definida v\u00E1rias vezes no mesmo escopo."</span><span class="o">},</span></span>
...
<span id="LC130" class="line" lang="java">        <span class="s">"Vari\u00E1vel ou par\u00E2metro ''{0}'' indefinido."</span><span class="o">},</span></span>
...
<span id="LC138" class="line" lang="java">        <span class="s">"N\u00E3o \u00E9 poss\u00EDvel localizar a classe ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC147" class="line" lang="java">        <span class="s">"N\u00E3o \u00E9 poss\u00EDvel localizar o m\u00E9todo externo ''{0}'' (deve ser p\u00FAblico)."</span><span class="o">},</span></span>
...
<span id="LC156" class="line" lang="java">        <span class="s">"N\u00E3o \u00E9 poss\u00EDvel converter o argumento/tipo de retorno na chamada para o m\u00E9todo ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC163" class="line" lang="java">        <span class="s">"Arquivo ou URI ''{0}'' n\u00E3o encontrado."</span><span class="o">},</span></span>
...
<span id="LC170" class="line" lang="java">        <span class="s">"URI inv\u00E1lido ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC177" class="line" lang="java">        <span class="s">"N\u00E3o \u00E9 poss\u00EDvel abrir o arquivo ou o URI ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC184" class="line" lang="java">        <span class="s">"elemento &lt;xsl:stylesheet&gt; ou &lt;xsl:transform&gt; esperado."</span><span class="o">},</span></span>
...
<span id="LC192" class="line" lang="java">        <span class="s">"O prefixo do namespace ''{0}'' n\u00E3o foi declarado."</span><span class="o">},</span></span>
...
<span id="LC199" class="line" lang="java">        <span class="s">"N\u00E3o \u00E9 poss\u00EDvel resolver a chamada para a fun\u00E7\u00E3o ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC206" class="line" lang="java">        <span class="s">"O argumento para \"{0}'' deve ser uma string literal."</span><span class="o">},</span></span>
...
<span id="LC214" class="line" lang="java">        <span class="s">"Erro durante o parsing da express\u00E3o XPath ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC222" class="line" lang="java">        <span class="s">"O atributo obrigat\u00F3rio ''{0}'' n\u00E3o foi encontrado."</span><span class="o">},</span></span>
...
<span id="LC230" class="line" lang="java">        <span class="s">"Caractere inv\u00E1lido ''{0}'' na express\u00E3o XPath."</span><span class="o">},</span></span>
...
<span id="LC239" class="line" lang="java">        <span class="s">"Nome inv\u00E1lido ''{0}'' para instru\u00E7\u00E3o de processamento."</span><span class="o">},</span></span>
...
<span id="LC248" class="line" lang="java">        <span class="s">"Atributo ''{0}'' fora do elemento."</span><span class="o">},</span></span>
...
<span id="LC257" class="line" lang="java">        <span class="s">"Atributo ''{0}'' inv\u00E1lido."</span><span class="o">},</span></span>
...
<span id="LC266" class="line" lang="java">        <span class="s">"Import/Include circular. Folha de estilos ''{0}'' j\u00E1 carregada."</span><span class="o">},</span></span>
...
<span id="LC274" class="line" lang="java">        <span class="s">"Os fragmentos da \u00E1rvore n\u00E3o podem ser classificados (os elementos &lt;xsl:sort&gt; foram ignorados). Voc\u00EA deve classificar os n\u00F3s ao criar a \u00E1rvore de resultados."</span><span class="o">},</span></span>
...
<span id="LC282" class="line" lang="java">        <span class="s">"A formata\u00E7\u00E3o decimal ''{0}'' j\u00E1 foi definida."</span><span class="o">},</span></span>
...
<span id="LC289" class="line" lang="java">        <span class="s">"A vers\u00E3o XSL \"{0}'' n\u00E3o \u00E9 suportada por XSLTC."</span><span class="o">},</span></span>
...
<span id="LC296" class="line" lang="java">        <span class="s">"Refer\u00EAncia de vari\u00E1vel/par\u00E2metro circulares ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC303" class="line" lang="java">        <span class="s">"Operador desconhecido para a express\u00E3o bin\u00E1ria."</span><span class="o">},</span></span>
...
<span id="LC310" class="line" lang="java">        <span class="s">"Argumento(s) inv\u00E1lido(s) para a chamada da fun\u00E7\u00E3o."</span><span class="o">},</span></span>
...
<span id="LC318" class="line" lang="java">        <span class="s">"O segundo argumento para a fun\u00E7\u00E3o document() deve ser um conjunto de n\u00F3s."</span><span class="o">},</span></span>
...
<span id="LC326" class="line" lang="java">        <span class="s">"\u00C9 necess\u00E1rio, pelo menos, um elemento &lt;xsl:when&gt; em &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC334" class="line" lang="java">        <span class="s">"\u00C9 permitido somente um elemento &lt;xsl:otherwise&gt; em &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC342" class="line" lang="java">        <span class="s">"&lt;xsl:otherwise&gt; s\u00F3 pode ser usado em &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC350" class="line" lang="java">        <span class="s">"&lt;xsl:when&gt; s\u00F3 pode ser usado em &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC358" class="line" lang="java">        <span class="s">"Somente os elementos &lt;xsl:when&gt; e &lt;xsl:otherwise&gt; s\u00E3o permitidos em &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC365" class="line" lang="java">        <span class="s">"&lt;xsl:attribute-set&gt; n\u00E3o encontrado no atributo 'name'."</span><span class="o">},</span></span>
...
<span id="LC372" class="line" lang="java">        <span class="s">"Elemento filho inv\u00E1lido."</span><span class="o">},</span></span>
...
<span id="LC380" class="line" lang="java">        <span class="s">"Voc\u00EA n\u00E3o pode chamar um elemento ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC388" class="line" lang="java">        <span class="s">"Voc\u00EA n\u00E3o pode chamar um atributo ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC398" class="line" lang="java">        <span class="s">"Dados de texto fora do elemento &lt;xsl:stylesheet&gt; de n\u00EDvel superior."</span><span class="o">},</span></span>
...
<span id="LC406" class="line" lang="java">        <span class="s">"Parser de JAXP n\u00E3o configurado corretamente"</span><span class="o">},</span></span>
...
<span id="LC413" class="line" lang="java">        <span class="s">"Erro interno-XSLTC irrecuper\u00E1vel: ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC421" class="line" lang="java">        <span class="s">"Elemento XSL n\u00E3o suportado ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC430" class="line" lang="java">        <span class="s">"Extens\u00E3o de XSLTC n\u00E3o reconhecida ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC440" class="line" lang="java">        <span class="s">"O documento de entrada n\u00E3o \u00E9 uma folha de estilos (o namespace XSL n\u00E3o foi declarado no elemento-raiz)."</span><span class="o">},</span></span>
...
<span id="LC447" class="line" lang="java">        <span class="s">"N\u00E3o foi poss\u00EDvel localizar o alvo da folha de estilos ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC453" class="line" lang="java">        <span class="s">"N\u00E3o foi poss\u00EDvel ler o alvo ''{0}'' da folha de estilos, porque o acesso a ''{1}'' n\u00E3o \u00E9 permitido em virtude da restri\u00E7\u00E3o definida pela propriedade accessExternalStylesheet."</span><span class="o">},</span></span>
...
<span id="LC461" class="line" lang="java">        <span class="s">"N\u00E3o implementado: ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC468" class="line" lang="java">        <span class="s">"O documento de entrada n\u00E3o cont\u00E9m uma folha de estilos XSL."</span><span class="o">},</span></span>
...
<span id="LC475" class="line" lang="java">        <span class="s">"N\u00E3o foi poss\u00EDvel fazer parsing do elemento ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC484" class="line" lang="java">        <span class="s">"O atributo use de &lt;key&gt; deve ser node, node-set, string ou number."</span><span class="o">},</span></span>
...
<span id="LC492" class="line" lang="java">        <span class="s">"A vers\u00E3o do documento XML de sa\u00EDda deve ser 1.0"</span><span class="o">},</span></span>
...
<span id="LC499" class="line" lang="java">        <span class="s">"Opera\u00E7\u00E3o desconhecida para a express\u00E3o relacional"</span><span class="o">},</span></span>
...
<span id="LC509" class="line" lang="java">        <span class="s">"Tentativa de usar um conjunto de atributos ''{0}'' n\u00E3o existente."</span><span class="o">},</span></span>
...
<span id="LC519" class="line" lang="java">        <span class="s">"N\u00E3o \u00E9 poss\u00EDvel fazer parsing do modelo do valor do atributo ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC525" class="line" lang="java">        <span class="s">"Tipo de dados desconhecido na assinatura da classe ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC534" class="line" lang="java">        <span class="s">"N\u00E3o \u00E9 poss\u00EDvel converter o tipo de dados ''{0}'' em ''{1}''."</span><span class="o">},</span></span>
...
<span id="LC541" class="line" lang="java">        <span class="s">"Este Templates n\u00E3o cont\u00E9m uma defini\u00E7\u00E3o de classe translet v\u00E1lida."</span><span class="o">},</span></span>
...
<span id="LC548" class="line" lang="java">        <span class="s">"Este Templates n\u00E3o cont\u00E9m uma classe com o nome ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC554" class="line" lang="java">        <span class="s">"N\u00E3o foi poss\u00EDvel carregar a classe translet ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC557" class="line" lang="java">        <span class="s">"Classe translet carregada, mas n\u00E3o \u00E9 poss\u00EDvel criar uma inst\u00E2ncia translet."</span><span class="o">},</span></span>
...
<span id="LC566" class="line" lang="java">        <span class="s">"Tentativa de definir ErrorListener para ''{0}'' como nulo"</span><span class="o">},</span></span>
...
<span id="LC573" class="line" lang="java">        <span class="s">"Somente StreamSource, SAXSource e DOMSource s\u00E3o suportados por XSLTC"</span><span class="o">},</span></span>
...
<span id="LC580" class="line" lang="java">        <span class="s">"O objeto source especificado para ''{0}'' n\u00E3o tem conte\u00FAdo."</span><span class="o">},</span></span>
...
<span id="LC587" class="line" lang="java">        <span class="s">"N\u00E3o foi poss\u00EDvel compilar a folha de estilos"</span><span class="o">},</span></span>
...
<span id="LC598" class="line" lang="java">        <span class="s">"TransformerFactory n\u00E3o reconhece o atributo ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC601" class="line" lang="java">        <span class="s">"Valor incorreto especificado para o atributo ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC608" class="line" lang="java">        <span class="s">"setResult() deve ser chamado antes de startDocument()."</span><span class="o">},</span></span>
...
<span id="LC618" class="line" lang="java">        <span class="s">"O Transformer n\u00E3o tem um objeto translet encapsulado."</span><span class="o">},</span></span>
...
<span id="LC626" class="line" lang="java">        <span class="s">"Nenhum handler de sa\u00EDda definido para o resultado da transforma\u00E7\u00E3o."</span><span class="o">},</span></span>
...
<span id="LC633" class="line" lang="java">        <span class="s">"O objeto result especificado para ''{0}'' \u00E9 inv\u00E1lido."</span><span class="o">},</span></span>
...
<span id="LC643" class="line" lang="java">        <span class="s">"Tentativa de acessar a propriedade ''{0}'' do Transformer inv\u00E1lida."</span><span class="o">},</span></span>
...
<span id="LC651" class="line" lang="java">        <span class="s">"N\u00E3o foi poss\u00EDvel criar o adaptador SAX2DOM: ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC658" class="line" lang="java">        <span class="s">"XSLTCSource.build() chamado sem o systemId ser definido."</span><span class="o">},</span></span>
...
<span id="LC661" class="line" lang="java">            <span class="s">"O resultado n\u00E3o deve ser nulo"</span><span class="o">},</span></span>
...
<span id="LC668" class="line" lang="java">        <span class="s">"O valor do par\u00E2metro {0} deve ser um Objeto Java v\u00E1lido"</span><span class="o">},</span></span>
...
<span id="LC672" class="line" lang="java">        <span class="s">"A op\u00E7\u00E3o -i deve ser usada com a op\u00E7\u00E3o -o."</span><span class="o">},</span></span>
...
<span id="LC708" class="line" lang="java">        <span class="s">"&lt;xsl:sort&gt; s\u00F3 pode ser usado dentro de &lt;xsl:for-each&gt; ou &lt;xsl:apply-templates&gt;."</span><span class="o">},</span></span>
...
<span id="LC717" class="line" lang="java">        <span class="s">"A codifica\u00E7\u00E3o de sa\u00EDda ''{0}'' n\u00E3o \u00E9 suportada nesta JVM."</span><span class="o">},</span></span>
...
<span id="LC724" class="line" lang="java">        <span class="s">"Erro de sintaxe em ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC733" class="line" lang="java">        <span class="s">"N\u00E3o \u00E9 poss\u00EDvel localizar o construtor externo ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC741" class="line" lang="java">        <span class="s">"O primeiro argumento para a fun\u00E7\u00E3o Java n\u00E3o static ''{0}'' n\u00E3o \u00E9 uma refer\u00EAncia de objeto v\u00E1lida."</span><span class="o">},</span></span>
...
<span id="LC749" class="line" lang="java">        <span class="s">"Erro ao verificar o tipo de express\u00E3o ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC757" class="line" lang="java">        <span class="s">"Erro ao verificar o tipo de uma express\u00E3o em uma localiza\u00E7\u00E3o desconhecida."</span><span class="o">},</span></span>
...
<span id="LC764" class="line" lang="java">        <span class="s">"A op\u00E7\u00E3o da linha de comandos ''{0}'' n\u00E3o \u00E9 v\u00E1lida."</span><span class="o">},</span></span>
...
<span id="LC771" class="line" lang="java">        <span class="s">"A op\u00E7\u00E3o da linha de comandos ''{0}'' n\u00E3o encontrou um argumento obrigat\u00F3rio."</span><span class="o">},</span></span>
...
<span id="LC825" class="line" lang="java">        <span class="s">"Transformar usando translet ''{0}'' "</span><span class="o">},</span></span>
...
<span id="LC832" class="line" lang="java">        <span class="s">"Transformar usando translet ''{0}'' do arquivo jar ''{1}''"</span><span class="o">},</span></span>
...
<span id="LC840" class="line" lang="java">        <span class="s">"N\u00E3o foi poss\u00EDvel criar uma inst\u00E2ncia da classe TransformerFactory ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC850" class="line" lang="java">         <span class="s">"N\u00E3o foi poss\u00EDvel usar o nome ''{0}'' como o nome da classe translet, pois ele cont\u00E9m caracteres que n\u00E3o s\u00E3o permitidos no nome da classe Java. O nome ''{1}'' foi usado."</span><span class="o">},</span></span>
...
<span id="LC858" class="line" lang="java">        <span class="s">"Erros do compilador:"</span><span class="o">},</span></span>
...
<span id="LC866" class="line" lang="java">        <span class="s">"Advert\u00EAncias do compilador:"</span><span class="o">},</span></span>
...
<span id="LC876" class="line" lang="java">        <span class="s">"Erros de translet:"</span><span class="o">},</span></span>
...
<span id="LC885" class="line" lang="java">        <span class="s">"Um atributo cujo valor deve ser um QName ou uma lista de QNames separada por espa\u00E7os em branco tinha o valor ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC894" class="line" lang="java">        <span class="s">"Um atributo cujo valor deve ser um NCName tinha o valor ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC907" class="line" lang="java">        <span class="s">"O atributo method de um elemento &lt;xsl:output&gt; tinha o valor ''{0}''. O valor deve ser um dos seguintes: ''xml'', ''html'', ''text'', ou qname, mas n\u00E3o ncname"</span><span class="o">},</span></span>
...
<span id="LC910" class="line" lang="java">        <span class="s">"O nome do recurso n\u00E3o pode ser nulo em TransformerFactory.getFeature(Nome da string)."</span><span class="o">},</span></span>
...
<span id="LC913" class="line" lang="java">        <span class="s">"O nome do recurso n\u00E3o pode ser nulo em TransformerFactory.setFeature(Nome da string, valor booliano)."</span><span class="o">},</span></span>
...
<span id="LC916" class="line" lang="java">        <span class="s">"N\u00E3o \u00E9 poss\u00EDvel definir o recurso ''{0}'' nesta TransformerFactory."</span><span class="o">},</span></span>
...
<span id="LC919" class="line" lang="java">        <span class="s">"FEATURE_SECURE_PROCESSING: N\u00E3o \u00E9 poss\u00EDvel definir o recurso como falso quando o gerenciador de seguran\u00E7a est\u00E1 presente."</span><span class="o">},</span></span>
...
<span id="LC929" class="line" lang="java">         <span class="s">"Erro interno de XSLTC: o byte code gerado cont\u00E9m um bloco try-catch-finally e n\u00E3o pode ser outlined."</span><span class="o">},</span></span>
...
<span id="LC942" class="line" lang="java">         <span class="s">"Erro interno de XSLTC: os marcadores OutlineableChunkStart e OutlineableChunkEnd devem ser balanceados e aninhados corretamente."</span><span class="o">},</span></span>
...
<span id="LC955" class="line" lang="java">         <span class="s">"Erro interno de XSLTC: ainda h\u00E1 refer\u00EAncia no m\u00E9todo original a uma instru\u00E7\u00E3o que fazia parte de um bloco de byte code que foi outlined."</span></span>
...
<span id="LC966" class="line" lang="java">         <span class="s">"Erro interno de XSLTC: um m\u00E9todo no translet excede a limita\u00E7\u00E3o da M\u00E1quina Virtual Java quanto ao tamanho de um m\u00E9todo de de 64 kilobytes. Em geral, essa situa\u00E7\u00E3o \u00E9 causada por modelos de uma folha de estilos que s\u00E3o muito grandes. Tente reestruturar sua folha de estilos de forma a usar modelos menores."</span></span>
<span id="LC967" class="line" lang="java">        <span class="o">},</span></span>
<span id="LC968" class="line" lang="java"></span>
<span id="LC969" class="line" lang="java">         <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">DESERIALIZE_TRANSLET_ERR</span><span class="o">,</span> <span class="s">"Quando a seguran\u00E7a do Java est\u00E1 ativada, o suporte para desserializar TemplatesImpl fica desativado. Essa situa\u00E7\u00E3o pode ser corrigida definindo a propriedade do sistema jdk.xml.enableTemplatesImplDeserialization como true."</span><span class="o">}</span></span>
