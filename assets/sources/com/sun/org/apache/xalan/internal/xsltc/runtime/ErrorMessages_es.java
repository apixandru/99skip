...
<span id="LC94" class="line" lang="java">        <span class="s">"Error interno de tiempo de ejecuci\u00F3n en ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC101" class="line" lang="java">        <span class="s">"Error de tiempo de ejecuci\u00F3n al ejecutar &lt;xsl:copy&gt;."</span><span class="o">},</span></span>
...
<span id="LC110" class="line" lang="java">        <span class="s">"Conversi\u00F3n no v\u00E1lida de ''{0}'' a ''{1}''."</span><span class="o">},</span></span>
...
<span id="LC118" class="line" lang="java">        <span class="s">"Funci\u00F3n externa ''{0}'' no soportada por XSLTC."</span><span class="o">},</span></span>
...
<span id="LC126" class="line" lang="java">        <span class="s">"Tipo de argumento desconocido en la expresi\u00F3n de igualdad."</span><span class="o">},</span></span>
...
<span id="LC135" class="line" lang="java">        <span class="s">"Tipo de argumento ''{0}'' no v\u00E1lido en la llamada a ''{1}''"</span><span class="o">},</span></span>
...
<span id="LC143" class="line" lang="java">        <span class="s">"Intentando formatear n\u00FAmero ''{0}'' mediante el patr\u00F3n ''{1}''."</span><span class="o">},</span></span>
...
<span id="LC151" class="line" lang="java">        <span class="s">"No se puede clonar el iterador ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC160" class="line" lang="java">        <span class="s">"El iterador para el eje ''{0}'' no est\u00E1 soportado."</span><span class="o">},</span></span>
...
<span id="LC169" class="line" lang="java">        <span class="s">"El iterador para el eje introducido ''{0}'' no est\u00E1 soportado."</span><span class="o">},</span></span>
...
<span id="LC178" class="line" lang="java">        <span class="s">"El atributo ''{0}'' est\u00E1 fuera del elemento."</span><span class="o">},</span></span>
...
<span id="LC188" class="line" lang="java">        <span class="s">"Declaraci\u00F3n del espacio de nombres ''{0}''=''{1}'' fuera del elemento."</span><span class="o">},</span></span>
...
<span id="LC196" class="line" lang="java">        <span class="s">"No se ha declarado el espacio de nombres para el prefijo ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC203" class="line" lang="java">        <span class="s">"Se ha creado DOMAdapter mediante un tipo incorrecto de DOM de origen."</span><span class="o">},</span></span>
...
<span id="LC212" class="line" lang="java">        <span class="s">"El analizador SAX que est\u00E1 utilizando no maneja los eventos de declaraci\u00F3n DTD."</span><span class="o">},</span></span>
...
<span id="LC221" class="line" lang="java">        <span class="s">"El analizador SAX que est\u00E1 utilizando no soporta los espacios de nombres XML."</span><span class="o">},</span></span>
...
<span id="LC228" class="line" lang="java">        <span class="s">"No se ha podido resolver la referencia al URI ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC236" class="line" lang="java">        <span class="s">"Elemento ''{0}'' de XSL no soportado"</span><span class="o">},</span></span>
...
<span id="LC245" class="line" lang="java">        <span class="s">"Extensi\u00F3n ''{0}'' de XSLTC no reconocida"</span><span class="o">},</span></span>
...
<span id="LC255" class="line" lang="java">        <span class="s">"El translet especificado, ''{0}'' se ha creado con una versi\u00F3n de XSLTC m\u00E1s reciente que la versi\u00F3n del tiempo de ejecuci\u00F3n de XSLTC que se est\u00E1 utilizando. Debe volver a compilar la hoja de estilo o utilizar una versi\u00F3n m\u00E1s reciente de XSLTC para ejecutar este translet."</span><span class="o">},</span></span>
...
<span id="LC264" class="line" lang="java">        <span class="s">"Un atributo cuyo valor debe ser un QName ten\u00EDa el valor ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC274" class="line" lang="java">        <span class="s">"Un atributo cuyo valor debe ser un NCName ten\u00EDa el valor ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC277" class="line" lang="java">        <span class="s">"El uso de la funci\u00F3n de extensi\u00F3n ''{0}'' no est\u00E1 permitido cuando la funci\u00F3n de procesamiento seguro se ha definido en true."</span><span class="o">},</span></span>
...
<span id="LC280" class="line" lang="java">        <span class="s">"El uso del elemento de extensi\u00F3n ''{0}'' no est\u00E1 permitido cuando la funci\u00F3n de procesamiento seguro se ha definido en true."</span><span class="o">},</span></span>
