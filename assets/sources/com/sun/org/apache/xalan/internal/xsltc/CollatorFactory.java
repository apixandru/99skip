...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: CollatorFactory.java,v 1.2.4.1 2005/08/31 10:16:33 pvedula Exp $</span></span>
...
<span id="LC30" class="line" lang="java"><span class="cm"> * @author W. Eliot Kimber (eliot@isogen.com)</span></span>
...
<span id="LC33" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">CollatorFactory</span> <span class="o">{</span></span>
<span id="LC34" class="line" lang="java"></span>
<span id="LC35" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Collator</span> <span class="nf">getCollator</span><span class="o">(</span><span class="nc">String</span> <span class="n">lang</span><span class="o">,</span> <span class="nc">String</span> <span class="n">country</span><span class="o">);</span></span>
<span id="LC36" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Collator</span> <span class="nf">getCollator</span><span class="o">(</span><span class="nc">Locale</span> <span class="n">locale</span><span class="o">);</span></span>
