...
<span id="LC94" class="line" lang="java">        <span class="s">"Errore interno in runtime in ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC101" class="line" lang="java">        <span class="s">"Errore in runtime durante l'esecuzione di &lt;xsl:copy&gt;."</span><span class="o">},</span></span>
...
<span id="LC110" class="line" lang="java">        <span class="s">"Conversione non valida da ''{0}'' a ''{1}''."</span><span class="o">},</span></span>
...
<span id="LC118" class="line" lang="java">        <span class="s">"Funzione esterna ''{0}'' non supportata da XSLTC."</span><span class="o">},</span></span>
...
<span id="LC126" class="line" lang="java">        <span class="s">"Tipo di argomento sconosciuto nell'espressione di uguaglianza."</span><span class="o">},</span></span>
...
<span id="LC135" class="line" lang="java">        <span class="s">"Tipo di argomento ''{0}'' non valido nella chiamata a ''{1}''"</span><span class="o">},</span></span>
...
<span id="LC143" class="line" lang="java">        <span class="s">"Tentativo di formattare il numero ''{0}'' mediante il pattern ''{1}''."</span><span class="o">},</span></span>
...
<span id="LC151" class="line" lang="java">        <span class="s">"Impossibile duplicare l''iteratore ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC160" class="line" lang="java">        <span class="s">"Iteratore per l''asse ''{0}'' non supportato."</span><span class="o">},</span></span>
...
<span id="LC169" class="line" lang="java">        <span class="s">"Iteratore per l''asse immesso ''{0}'' non supportato."</span><span class="o">},</span></span>
...
<span id="LC178" class="line" lang="java">        <span class="s">"Attributo ''{0}'' al di fuori dell''elemento."</span><span class="o">},</span></span>
...
<span id="LC188" class="line" lang="java">        <span class="s">"Dichiarazione dello spazio di nomi ''{0}''=''{1}'' al di fuori dell''elemento."</span><span class="o">},</span></span>
...
<span id="LC196" class="line" lang="java">        <span class="s">"Lo spazio di nomi per il prefisso ''{0}'' non \u00E8 stato dichiarato."</span><span class="o">},</span></span>
...
<span id="LC203" class="line" lang="java">        <span class="s">"DOMAdapter creato utilizzando il tipo errato di DOM di origine."</span><span class="o">},</span></span>
...
<span id="LC212" class="line" lang="java">        <span class="s">"Il parser SAX in uso non gestisce gli eventi di dichiarazione DTD."</span><span class="o">},</span></span>
...
<span id="LC221" class="line" lang="java">        <span class="s">"Il parser SAX in uso non supporta gli spazi di nomi XML."</span><span class="o">},</span></span>
...
<span id="LC228" class="line" lang="java">        <span class="s">"Impossibile risolvere il riferimento URI ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC236" class="line" lang="java">        <span class="s">"Elemento XSL \"{0}\" non supportato"</span><span class="o">},</span></span>
...
<span id="LC245" class="line" lang="java">        <span class="s">"Estensione XSLTC ''{0}'' non riconosciuta"</span><span class="o">},</span></span>
...
<span id="LC255" class="line" lang="java">        <span class="s">"Il translet specificato ''{0}'' \u00E8 stato creato utilizzando una versione di XSLTC pi\u00F9 recente di quella della fase di runtime XSLTC in uso. Ricompilare il foglio di stile o utilizzare una versione pi\u00F9 recente di XSLTC per eseguire questo translet."</span><span class="o">},</span></span>
...
<span id="LC264" class="line" lang="java">        <span class="s">"Un attributo il cui valore deve essere un QName contiene il valore ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC274" class="line" lang="java">        <span class="s">"Un attributo il cui valore deve essere un NCName contiene il valore ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC277" class="line" lang="java">        <span class="s">"Non \u00E8 consentito utilizzare la funzione di estensione ''{0}'' se la funzione di elaborazione sicura \u00E8 impostata su true."</span><span class="o">},</span></span>
...
<span id="LC280" class="line" lang="java">        <span class="s">"Non \u00E8 consentito utilizzare l''elemento di estensione ''{0}'' se la funzione di elaborazione sicura \u00E8 impostata su true."</span><span class="o">},</span></span>
