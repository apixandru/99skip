...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: SourceLoader.java,v 1.2.4.1 2005/09/05 09:02:30 pvedula Exp $</span></span>
...
<span id="LC26" class="line" lang="java"><span class="kn">import</span> <span class="nn">org.xml.sax.InputSource</span><span class="o">;</span></span>
...
<span id="LC31" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">SourceLoader</span> <span class="o">{</span></span>
<span id="LC32" class="line" lang="java"></span>
<span id="LC33" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC34" class="line" lang="java"><span class="cm">     * This interface is used to plug external document loaders into XSLTC</span></span>
<span id="LC35" class="line" lang="java"><span class="cm">     * (used with the &lt;xsl:include&gt; and &lt;xsl:import&gt; elements.</span></span>
<span id="LC36" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC37" class="line" lang="java"><span class="cm">     * @param href The URI of the document to load</span></span>
<span id="LC38" class="line" lang="java"><span class="cm">     * @param context The URI of the currently loaded document</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">     * @param xsltc The compiler that resuests the document</span></span>
<span id="LC40" class="line" lang="java"><span class="cm">     * @return An InputSource with the loaded document</span></span>
<span id="LC41" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC42" class="line" lang="java">    <span class="kd">public</span> <span class="nc">InputSource</span> <span class="nf">loadSource</span><span class="o">(</span><span class="nc">String</span> <span class="n">href</span><span class="o">,</span> <span class="nc">String</span> <span class="n">context</span><span class="o">,</span> <span class="no">XSLTC</span> <span class="n">xsltc</span><span class="o">);</span></span>
