...
<span id="LC28" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">ErrorMessages_sv</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span> <span class="o">{</span></span>
...
<span id="LC98" class="line" lang="java">        <span class="s">"Fler \u00E4n en formatmall har definierats i samma fil."</span><span class="o">},</span></span>
...
<span id="LC106" class="line" lang="java">        <span class="s">"Mallen ''{0}'' har redan definierats i denna formatmall."</span><span class="o">},</span></span>
...
<span id="LC115" class="line" lang="java">        <span class="s">"Mallen ''{0}'' har inte definierats i denna formatmall."</span><span class="o">},</span></span>
...
<span id="LC122" class="line" lang="java">        <span class="s">"Variabeln ''{0}'' har definierats flera g\u00E5nger i samma omfattning."</span><span class="o">},</span></span>
...
<span id="LC130" class="line" lang="java">        <span class="s">"Variabeln eller parametern ''{0}'' har inte definierats."</span><span class="o">},</span></span>
...
<span id="LC138" class="line" lang="java">        <span class="s">"Hittar inte klassen ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC147" class="line" lang="java">        <span class="s">"Hittar inte den externa metoden ''{0}'' (m\u00E5ste vara allm\u00E4n)."</span><span class="o">},</span></span>
...
<span id="LC156" class="line" lang="java">        <span class="s">"Kan inte konvertera argument/returtyp vid anrop till metoden ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC163" class="line" lang="java">        <span class="s">"Fil eller URI ''{0}'' hittades inte."</span><span class="o">},</span></span>
...
<span id="LC170" class="line" lang="java">        <span class="s">"Ogiltig URI ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC177" class="line" lang="java">        <span class="s">"Kan inte \u00F6ppna filen eller URI ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC184" class="line" lang="java">        <span class="s">"F\u00F6rv\u00E4ntade &lt;xsl:stylesheet&gt;- eller &lt;xsl:transform&gt;-element."</span><span class="o">},</span></span>
...
<span id="LC192" class="line" lang="java">        <span class="s">"Namnrymdsprefixet ''{0}'' har inte deklarerats."</span><span class="o">},</span></span>
...
<span id="LC199" class="line" lang="java">        <span class="s">"Kan inte matcha anrop till funktionen ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC206" class="line" lang="java">        <span class="s">"Argument till ''{0}'' m\u00E5ste vara en litteral str\u00E4ng."</span><span class="o">},</span></span>
...
<span id="LC214" class="line" lang="java">        <span class="s">"Fel vid tolkning av XPath-uttrycket ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC222" class="line" lang="java">        <span class="s">"Det obligatoriska attributet ''{0}'' saknas."</span><span class="o">},</span></span>
...
<span id="LC230" class="line" lang="java">        <span class="s">"Otill\u00E5tet tecken ''{0}'' i XPath-uttrycket."</span><span class="o">},</span></span>
...
<span id="LC239" class="line" lang="java">        <span class="s">"''{0}'' \u00E4r ett otill\u00E5tet namn i bearbetningsinstruktion."</span><span class="o">},</span></span>
...
<span id="LC248" class="line" lang="java">        <span class="s">"Attributet ''{0}'' finns utanf\u00F6r elementet."</span><span class="o">},</span></span>
...
<span id="LC257" class="line" lang="java">        <span class="s">"''{0}'' \u00E4r ett otill\u00E5tet attribut."</span><span class="o">},</span></span>
...
<span id="LC266" class="line" lang="java">        <span class="s">"Cirkul\u00E4r import/include. Formatmallen ''{0}'' har redan laddats."</span><span class="o">},</span></span>
...
<span id="LC274" class="line" lang="java">        <span class="s">"Resultattr\u00E4dfragment kan inte sorteras (&lt;xsl:sort&gt;-element ignoreras). Du m\u00E5ste sortera noderna n\u00E4r resultattr\u00E4det skapas."</span><span class="o">},</span></span>
...
<span id="LC282" class="line" lang="java">        <span class="s">"Decimalformateringen ''{0}'' har redan definierats."</span><span class="o">},</span></span>
...
<span id="LC289" class="line" lang="java">        <span class="s">"XSL-versionen ''{0}'' underst\u00F6ds inte i XSLTC."</span><span class="o">},</span></span>
...
<span id="LC296" class="line" lang="java">        <span class="s">"Cirkul\u00E4r variabel-/parameterreferens i ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC303" class="line" lang="java">        <span class="s">"Ok\u00E4nd operator f\u00F6r bin\u00E4rt uttryck."</span><span class="o">},</span></span>
...
<span id="LC310" class="line" lang="java">        <span class="s">"Otill\u00E5tna argument f\u00F6r funktionsanrop."</span><span class="o">},</span></span>
...
<span id="LC318" class="line" lang="java">        <span class="s">"Andra argumentet f\u00F6r document()-funktion m\u00E5ste vara en nodupps\u00E4ttning."</span><span class="o">},</span></span>
...
<span id="LC326" class="line" lang="java">        <span class="s">"Minst ett &lt;xsl:when&gt;-element kr\u00E4vs i &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC334" class="line" lang="java">        <span class="s">"Endast ett &lt;xsl:otherwise&gt;-element \u00E4r till\u00E5tet i &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC342" class="line" lang="java">        <span class="s">"&lt;xsl:otherwise&gt; anv\u00E4nds endast inom &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC350" class="line" lang="java">        <span class="s">"&lt;xsl:when&gt; anv\u00E4nds endast inom &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC358" class="line" lang="java">        <span class="s">"Endast &lt;xsl:when&gt;- och &lt;xsl:otherwise&gt;-element \u00E4r till\u00E5tna i &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC365" class="line" lang="java">        <span class="s">"&lt;xsl:attribute-set&gt; saknar 'name'-attribut."</span><span class="o">},</span></span>
...
<span id="LC372" class="line" lang="java">        <span class="s">"Otill\u00E5tet underordnat element."</span><span class="o">},</span></span>
...
<span id="LC380" class="line" lang="java">        <span class="s">"Du kan inte anropa elementet ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC388" class="line" lang="java">        <span class="s">"Du kan inte anropa attributet ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC398" class="line" lang="java">        <span class="s">"Textdata utanf\u00F6r toppniv\u00E5elementet &lt;xsl:stylesheet&gt;."</span><span class="o">},</span></span>
...
<span id="LC406" class="line" lang="java">        <span class="s">"JAXP-parser har inte konfigurerats korrekt"</span><span class="o">},</span></span>
...
<span id="LC413" class="line" lang="java">        <span class="s">"O\u00E5terkalleligt internt XSLTC-fel: ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC421" class="line" lang="java">        <span class="s">"XSL-elementet ''{0}'' st\u00F6ds inte."</span><span class="o">},</span></span>
...
<span id="LC430" class="line" lang="java">        <span class="s">"XSLTC-till\u00E4gget ''{0}'' \u00E4r ok\u00E4nt."</span><span class="o">},</span></span>
...
<span id="LC440" class="line" lang="java">        <span class="s">"Indatadokumentet \u00E4r ingen formatmall (XSL-namnrymden har inte deklarerats i rotelementet)."</span><span class="o">},</span></span>
...
<span id="LC447" class="line" lang="java">        <span class="s">"Hittade inte formatmallen ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC453" class="line" lang="java">        <span class="s">"Kunde inte l\u00E4sa formatmallen ''{0}'', eftersom ''{1}''-\u00E5tkomst inte till\u00E5ts p\u00E5 grund av begr\u00E4nsning som anges av egenskapen accessExternalStylesheet."</span><span class="o">},</span></span>
...
<span id="LC461" class="line" lang="java">        <span class="s">"Inte implementerad: ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC468" class="line" lang="java">        <span class="s">"Indatadokumentet inneh\u00E5ller ingen XSL-formatmall."</span><span class="o">},</span></span>
...
<span id="LC475" class="line" lang="java">        <span class="s">"Kunde inte tolka elementet ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC484" class="line" lang="java">        <span class="s">"use-attribut f\u00F6r &lt;key&gt; m\u00E5ste vara node, node-set, string eller number."</span><span class="o">},</span></span>
...
<span id="LC492" class="line" lang="java">        <span class="s">"XML-dokumentets utdataversion m\u00E5ste vara 1.0"</span><span class="o">},</span></span>
...
<span id="LC499" class="line" lang="java">        <span class="s">"Ok\u00E4nd operator f\u00F6r relationsuttryck"</span><span class="o">},</span></span>
...
<span id="LC509" class="line" lang="java">        <span class="s">"F\u00F6rs\u00F6ker anv\u00E4nda en icke-befintlig attributupps\u00E4ttning ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC519" class="line" lang="java">        <span class="s">"Kan inte tolka attributv\u00E4rdemallen ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC525" class="line" lang="java">        <span class="s">"Ok\u00E4nd datatyp i signaturen f\u00F6r klassen ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC534" class="line" lang="java">        <span class="s">"Kan inte konvertera datatyp ''{0}'' till ''{1}''."</span><span class="o">},</span></span>
...
<span id="LC541" class="line" lang="java">        <span class="s">"Templates inneh\u00E5ller inte n\u00E5gon giltig klassdefinition f\u00F6r translet."</span><span class="o">},</span></span>
...
<span id="LC548" class="line" lang="java">        <span class="s">"Templates inneh\u00E5ller inte n\u00E5gon klass med namnet {0}."</span><span class="o">},</span></span>
...
<span id="LC554" class="line" lang="java">        <span class="s">"Kunde inte ladda translet-klassen ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC557" class="line" lang="java">        <span class="s">"Translet-klassen har laddats, men kan inte skapa instans av translet."</span><span class="o">},</span></span>
...
<span id="LC566" class="line" lang="java">        <span class="s">"F\u00F6rs\u00F6ker st\u00E4lla in ErrorListener f\u00F6r ''{0}'' p\u00E5 null"</span><span class="o">},</span></span>
...
<span id="LC573" class="line" lang="java">        <span class="s">"Endast StreamSource, SAXSource och DOMSource st\u00F6ds av XSLTC"</span><span class="o">},</span></span>
...
<span id="LC580" class="line" lang="java">        <span class="s">"Source-objektet som \u00F6verf\u00F6rdes till ''{0}'' saknar inneh\u00E5ll."</span><span class="o">},</span></span>
...
<span id="LC587" class="line" lang="java">        <span class="s">"Kunde inte kompilera formatmall"</span><span class="o">},</span></span>
...
<span id="LC598" class="line" lang="java">        <span class="s">"TransformerFactory k\u00E4nner inte igen attributet ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC601" class="line" lang="java">        <span class="s">"Fel v\u00E4rde har angetts f\u00F6r attributet ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC608" class="line" lang="java">        <span class="s">"setResult() m\u00E5ste anropas f\u00F6re startDocument()."</span><span class="o">},</span></span>
...
<span id="LC618" class="line" lang="java">        <span class="s">"Transformer saknar inkapslat objekt f\u00F6r translet."</span><span class="o">},</span></span>
...
<span id="LC626" class="line" lang="java">        <span class="s">"Det finns ingen definierad utdatahanterare f\u00F6r transformeringsresultat."</span><span class="o">},</span></span>
...
<span id="LC633" class="line" lang="java">        <span class="s">"Result-objekt som \u00F6verf\u00F6rdes till ''{0}'' \u00E4r ogiltigt."</span><span class="o">},</span></span>
...
<span id="LC643" class="line" lang="java">        <span class="s">"F\u00F6rs\u00F6ker f\u00E5 \u00E5tkomst till ogiltig Transformer-egenskap, ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC651" class="line" lang="java">        <span class="s">"Kunde inte skapa SAX2DOM-adapter: ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC658" class="line" lang="java">        <span class="s">"XSLTCSource.build() anropades utan angivet systemId."</span><span class="o">},</span></span>
...
<span id="LC661" class="line" lang="java">            <span class="s">"Result borde inte vara null"</span><span class="o">},</span></span>
...
<span id="LC668" class="line" lang="java">        <span class="s">"Parameterv\u00E4rdet f\u00F6r {0} m\u00E5ste vara giltigt Java-objekt"</span><span class="o">},</span></span>
...
<span id="LC672" class="line" lang="java">        <span class="s">"Alternativet -i m\u00E5ste anv\u00E4ndas med alternativet -o."</span><span class="o">},</span></span>
...
<span id="LC708" class="line" lang="java">        <span class="s">"&lt;xsl:sort&gt; kan anv\u00E4ndas endast i &lt;xsl:for-each&gt; eller &lt;xsl:apply-templates&gt;."</span><span class="o">},</span></span>
...
<span id="LC717" class="line" lang="java">        <span class="s">"Utdatakodning ''{0}'' underst\u00F6ds inte i JVM."</span><span class="o">},</span></span>
...
<span id="LC724" class="line" lang="java">        <span class="s">"Syntaxfel i ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC733" class="line" lang="java">        <span class="s">"Hittar inte den externa konstruktorn ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC741" class="line" lang="java">        <span class="s">"Det f\u00F6rsta argumentet f\u00F6r den icke-statiska Java-funktionen ''{0}'' \u00E4r inte n\u00E5gon giltig objektreferens."</span><span class="o">},</span></span>
...
<span id="LC749" class="line" lang="java">        <span class="s">"Fel vid kontroll av typ av uttrycket ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC757" class="line" lang="java">        <span class="s">"Fel vid kontroll av typ av ett uttryck p\u00E5 ok\u00E4nd plats."</span><span class="o">},</span></span>
...
<span id="LC764" class="line" lang="java">        <span class="s">"Ogiltigt kommandoradsalternativ: ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC771" class="line" lang="java">        <span class="s">"Kommandoradsalternativet ''{0}'' saknar obligatoriskt argument."</span><span class="o">},</span></span>
...
<span id="LC825" class="line" lang="java">        <span class="s">"Transformering via translet ''{0}'' "</span><span class="o">},</span></span>
...
<span id="LC832" class="line" lang="java">        <span class="s">"Transformering via translet ''{0}'' fr\u00E5n jar-filen ''{1}''"</span><span class="o">},</span></span>
...
<span id="LC840" class="line" lang="java">        <span class="s">"Kunde inte skapa en instans av TransformerFactory-klassen ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC850" class="line" lang="java">         <span class="s">"''{0}'' kunde inte anv\u00E4ndas som namn p\u00E5 transletklassen eftersom det inneh\u00E5ller otill\u00E5tna tecken f\u00F6r Java-klassnamn. Namnet ''{1}'' anv\u00E4ndes ist\u00E4llet."</span><span class="o">},</span></span>
...
<span id="LC858" class="line" lang="java">        <span class="s">"Kompileringsfel:"</span><span class="o">},</span></span>
...
<span id="LC866" class="line" lang="java">        <span class="s">"Kompileringsvarningar:"</span><span class="o">},</span></span>
...
<span id="LC876" class="line" lang="java">        <span class="s">"Transletfel:"</span><span class="o">},</span></span>
...
<span id="LC885" class="line" lang="java">        <span class="s">"Ett attribut vars v\u00E4rde m\u00E5ste vara ett QName eller en blankteckenavgr\u00E4nsad lista med QNames hade v\u00E4rdet ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC894" class="line" lang="java">        <span class="s">"Ett attribut vars v\u00E4rde m\u00E5ste vara ett NCName hade v\u00E4rdet ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC907" class="line" lang="java">        <span class="s">"Metodattributet f\u00F6r ett &lt;xsl:output&gt;-element hade v\u00E4rdet ''{0}''. Endast n\u00E5got av f\u00F6ljande v\u00E4rden kan anv\u00E4ndas: ''xml'', ''html'', ''text'' eller qname-but-not-ncname i XML"</span><span class="o">},</span></span>
...
<span id="LC910" class="line" lang="java">        <span class="s">"Funktionsnamnet kan inte vara null i TransformerFactory.getFeature(namn p\u00E5 str\u00E4ng)."</span><span class="o">},</span></span>
...
<span id="LC913" class="line" lang="java">        <span class="s">"Funktionsnamnet kan inte vara null i TransformerFactory.setFeature(namn p\u00E5 str\u00E4ng, booleskt v\u00E4rde)."</span><span class="o">},</span></span>
...
<span id="LC916" class="line" lang="java">        <span class="s">"Kan inte st\u00E4lla in funktionen ''{0}'' i denna TransformerFactory."</span><span class="o">},</span></span>
...
<span id="LC919" class="line" lang="java">        <span class="s">"FEATURE_SECURE_PROCESSING: Funktionen kan inte anges till false om s\u00E4kerhetshanteraren anv\u00E4nds."</span><span class="o">},</span></span>
...
<span id="LC929" class="line" lang="java">         <span class="s">"Internt XSLTC-fel: den genererade bytekoden inneh\u00E5ller ett try-catch-finally-block och kan inte g\u00F6ras till en disposition."</span><span class="o">},</span></span>
...
<span id="LC942" class="line" lang="java">         <span class="s">"Internt XSLTC-fel: mark\u00F6rerna OutlineableChunkStart och OutlineableChunkEnd m\u00E5ste vara balanserade och korrekt kapslade."</span><span class="o">},</span></span>
...
<span id="LC955" class="line" lang="java">         <span class="s">"Internt XSLTC-fel: originalmetoden refererar fortfarande till en instruktion som var en del av ett bytekodsblock som gjordes till en disposition."</span></span>
...
<span id="LC966" class="line" lang="java">         <span class="s">"Internt XSLTC-fel: en metod i transleten \u00F6verstiger Java Virtual Machines l\u00E4ngdbegr\u00E4nsning f\u00F6r en metod p\u00E5 64 kilobytes.  Det h\u00E4r orsakas vanligen av mycket stora mallar i en formatmall. F\u00F6rs\u00F6k att omstrukturera formatmallen att anv\u00E4nda mindre mallar."</span></span>
<span id="LC967" class="line" lang="java">        <span class="o">},</span></span>
<span id="LC968" class="line" lang="java"></span>
<span id="LC969" class="line" lang="java">         <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">DESERIALIZE_TRANSLET_ERR</span><span class="o">,</span> <span class="s">"N\u00E4r Java-s\u00E4kerheten \u00E4r aktiverad \u00E4r st\u00F6det f\u00F6r avserialisering av TemplatesImpl avaktiverat. Du kan \u00E5sidos\u00E4tta det h\u00E4r genom att st\u00E4lla in systemegenskapen jdk.xml.enableTemplatesImplDeserialization till sant."</span><span class="o">}</span></span>
