...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: CurrentCall.java,v 1.2.4.1 2005/09/01 12:23:16 pvedula Exp $</span></span>
...
<span id="LC33" class="line" lang="java"><span class="kd">final</span> <span class="kd">class</span> <span class="nc">CurrentCall</span> <span class="kd">extends</span> <span class="nc">FunctionCall</span> <span class="o">{</span></span>
<span id="LC34" class="line" lang="java">    <span class="kd">public</span> <span class="nf">CurrentCall</span><span class="o">(</span><span class="nc">QName</span> <span class="n">fname</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC35" class="line" lang="java">        <span class="kd">super</span><span class="o">(</span><span class="n">fname</span><span class="o">);</span></span>
<span id="LC36" class="line" lang="java">    <span class="o">}</span></span>
<span id="LC37" class="line" lang="java"></span>
<span id="LC38" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">translate</span><span class="o">(</span><span class="nc">ClassGenerator</span> <span class="n">classGen</span><span class="o">,</span> <span class="nc">MethodGenerator</span> <span class="n">methodGen</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC39" class="line" lang="java">        <span class="n">methodGen</span><span class="o">.</span><span class="na">getInstructionList</span><span class="o">().</span><span class="na">append</span><span class="o">(</span><span class="n">methodGen</span><span class="o">.</span><span class="na">loadCurrentNode</span><span class="o">());</span></span>
