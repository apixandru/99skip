...
<span id="LC28" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">ErrorMessages_es</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span> <span class="o">{</span></span>
...
<span id="LC98" class="line" lang="java">        <span class="s">"Se ha definido m\u00E1s de una hoja de estilo en el mismo archivo."</span><span class="o">},</span></span>
...
<span id="LC106" class="line" lang="java">        <span class="s">"La plantilla ''{0}'' ya se ha definido en esta hoja de estilo."</span><span class="o">},</span></span>
...
<span id="LC115" class="line" lang="java">        <span class="s">"La plantilla ''{0}'' no se ha definido en esta hoja de estilo."</span><span class="o">},</span></span>
...
<span id="LC122" class="line" lang="java">        <span class="s">"Se ha definido varias veces la variable ''{0}'' en el mismo \u00E1mbito."</span><span class="o">},</span></span>
...
<span id="LC130" class="line" lang="java">        <span class="s">"No se ha definido la variable o el par\u00E1metro ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC138" class="line" lang="java">        <span class="s">"No se ha encontrado la clase ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC147" class="line" lang="java">        <span class="s">"No se ha encontrado el m\u00E9todo externo ''{0}'' (debe ser p\u00FAblico)."</span><span class="o">},</span></span>
...
<span id="LC156" class="line" lang="java">        <span class="s">"No se puede convertir el tipo de argumento/retorno en la llamada al m\u00E9todo ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC163" class="line" lang="java">        <span class="s">"No se ha encontrado el archivo o URI ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC170" class="line" lang="java">        <span class="s">"URI ''{0}'' no v\u00E1lido."</span><span class="o">},</span></span>
...
<span id="LC177" class="line" lang="java">        <span class="s">"No se puede abrir el archivo o URI ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC184" class="line" lang="java">        <span class="s">"Se esperaba el elemento &lt;xsl:stylesheet&gt; o &lt;xsl:transform&gt;."</span><span class="o">},</span></span>
...
<span id="LC192" class="line" lang="java">        <span class="s">"No se ha declarado el prefijo de espacio de nombres ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC199" class="line" lang="java">        <span class="s">"No se ha podido resolver la llamada a la funci\u00F3n ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC206" class="line" lang="java">        <span class="s">"El argumento en ''{0}'' debe ser una cadena literal."</span><span class="o">},</span></span>
...
<span id="LC214" class="line" lang="java">        <span class="s">"Error al analizar la expresi\u00F3n XPath ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC222" class="line" lang="java">        <span class="s">"Falta el atributo ''{0}'' necesario."</span><span class="o">},</span></span>
...
<span id="LC230" class="line" lang="java">        <span class="s">"Car\u00E1cter ''{0}'' no permitido en la expresi\u00F3n XPath."</span><span class="o">},</span></span>
...
<span id="LC239" class="line" lang="java">        <span class="s">"Nombre ''{0}'' no permitido para la instrucci\u00F3n de procesamiento."</span><span class="o">},</span></span>
...
<span id="LC248" class="line" lang="java">        <span class="s">"El atributo ''{0}'' est\u00E1 fuera del elemento."</span><span class="o">},</span></span>
...
<span id="LC257" class="line" lang="java">        <span class="s">"Atributo ''{0}'' no permitido."</span><span class="o">},</span></span>
...
<span id="LC266" class="line" lang="java">        <span class="s">"Import/include circular. La hoja de estilo ''{0}'' ya se ha cargado."</span><span class="o">},</span></span>
...
<span id="LC274" class="line" lang="java">        <span class="s">"Los fragmentos del \u00E1rbol de resultados no se pueden ordenar (los elementos &lt;xsl:sort&gt; se ignoran). Debe ordenar los nodos al crear el \u00E1rbol de resultados."</span><span class="o">},</span></span>
...
<span id="LC282" class="line" lang="java">        <span class="s">"Ya se ha definido el formato decimal ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC289" class="line" lang="java">        <span class="s">"La versi\u00F3n XSL ''{0}'' no est\u00E1 soportada por XSLTC."</span><span class="o">},</span></span>
...
<span id="LC296" class="line" lang="java">        <span class="s">"La referencia de variable/par\u00E1metro circular en ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC303" class="line" lang="java">        <span class="s">"Operador desconocido para la expresi\u00F3n binaria."</span><span class="o">},</span></span>
...
<span id="LC310" class="line" lang="java">        <span class="s">"Argumentos no permitidos para la llamada de funci\u00F3n."</span><span class="o">},</span></span>
...
<span id="LC318" class="line" lang="java">        <span class="s">"El segundo argumento en la funci\u00F3n document() debe ser un juego de nodos."</span><span class="o">},</span></span>
...
<span id="LC326" class="line" lang="java">        <span class="s">"Se necesita al menos un elemento &lt;xsl:when&gt; en &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC334" class="line" lang="java">        <span class="s">"S\u00F3lo se permite un elemento &lt;xsl:otherwise&gt; en &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC342" class="line" lang="java">        <span class="s">"&lt;xsl:otherwise&gt; s\u00F3lo se puede utilizar en &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC350" class="line" lang="java">        <span class="s">"&lt;xsl:when&gt; s\u00F3lo se puede utilizar en &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC358" class="line" lang="java">        <span class="s">"S\u00F3lo se permiten los elementos &lt;xsl:when&gt; y &lt;xsl:otherwise&gt; en &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC365" class="line" lang="java">        <span class="s">"Falta el atributo 'name' en &lt;xsl:attribute-set&gt;"</span><span class="o">},</span></span>
...
<span id="LC372" class="line" lang="java">        <span class="s">"Elemento secundario no permitido."</span><span class="o">},</span></span>
...
<span id="LC380" class="line" lang="java">        <span class="s">"No se puede llamar ''{0}'' a un elemento"</span><span class="o">},</span></span>
...
<span id="LC388" class="line" lang="java">        <span class="s">"No se puede llamar ''{0}'' a un atributo"</span><span class="o">},</span></span>
...
<span id="LC398" class="line" lang="java">        <span class="s">"Datos de texto fuera del elemento &lt;xsl:stylesheet&gt; de nivel superior."</span><span class="o">},</span></span>
...
<span id="LC406" class="line" lang="java">        <span class="s">"El analizador JAXP no se ha configurado correctamente"</span><span class="o">},</span></span>
...
<span id="LC413" class="line" lang="java">        <span class="s">"Error interno de XSLTC irrecuperable: ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC421" class="line" lang="java">        <span class="s">"Elemento ''{0}'' de XSL no soportado."</span><span class="o">},</span></span>
...
<span id="LC430" class="line" lang="java">        <span class="s">"Extensi\u00F3n ''{0}'' de XSLTC no reconocida."</span><span class="o">},</span></span>
...
<span id="LC440" class="line" lang="java">        <span class="s">"El documento de entrada no es una hoja de estilo (el espacio de nombres XSL no se ha declarado en el elemento ra\u00EDz)."</span><span class="o">},</span></span>
...
<span id="LC447" class="line" lang="java">        <span class="s">"No se ha encontrado el destino de hoja de estilo ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC453" class="line" lang="java">        <span class="s">"No se ha podido leer el destino de hoja de estilos ''{0}'', porque no se permite el acceso ''{1}'' debido a una restricci\u00F3n definida por la propiedad accessExternalStylesheet."</span><span class="o">},</span></span>
...
<span id="LC461" class="line" lang="java">        <span class="s">"No implantado: ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC468" class="line" lang="java">        <span class="s">"El documento de entrada no contiene una hoja de estilo XSL."</span><span class="o">},</span></span>
...
<span id="LC475" class="line" lang="java">        <span class="s">"No se ha podido analizar el elemento ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC484" class="line" lang="java">        <span class="s">"El atributo use de &lt;key&gt; debe ser node, node-set, string o number."</span><span class="o">},</span></span>
...
<span id="LC492" class="line" lang="java">        <span class="s">"La versi\u00F3n del documento XML de salida debe ser 1.0"</span><span class="o">},</span></span>
...
<span id="LC499" class="line" lang="java">        <span class="s">"Operador desconocido para la expresi\u00F3n relacional"</span><span class="o">},</span></span>
...
<span id="LC509" class="line" lang="java">        <span class="s">"Se est\u00E1 intentando utilizar el juego de atributos ''{0}'' no existente."</span><span class="o">},</span></span>
...
<span id="LC519" class="line" lang="java">        <span class="s">"No se puede analizar la plantilla del valor de atributo ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC525" class="line" lang="java">        <span class="s">"Tipo de datos desconocido en la firma para la clase ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC534" class="line" lang="java">        <span class="s">"No se puede convertir el tipo de datos ''{0}'' en ''{1}''."</span><span class="o">},</span></span>
...
<span id="LC541" class="line" lang="java">        <span class="s">"Templates no contiene una definici\u00F3n de clase translet."</span><span class="o">},</span></span>
...
<span id="LC548" class="line" lang="java">        <span class="s">"Templates no contiene una clase con el nombre ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC554" class="line" lang="java">        <span class="s">"No se ha podido cargar la clase de translet ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC557" class="line" lang="java">        <span class="s">"La clase de translet se ha cargado, pero no se puede crear una instancia de translet."</span><span class="o">},</span></span>
...
<span id="LC566" class="line" lang="java">        <span class="s">"Intentando definir ErrorListener para ''{0}'' como nulo"</span><span class="o">},</span></span>
...
<span id="LC573" class="line" lang="java">        <span class="s">"S\u00F3lo StreamSource, SAXSource y DOMSource est\u00E1n soportados por XSLTC"</span><span class="o">},</span></span>
...
<span id="LC580" class="line" lang="java">        <span class="s">"El objeto Source que se ha transferido a ''{0}'' no tiene contenido."</span><span class="o">},</span></span>
...
<span id="LC587" class="line" lang="java">        <span class="s">"No se ha podido compilar la hoja de estilo"</span><span class="o">},</span></span>
...
<span id="LC598" class="line" lang="java">        <span class="s">"TransformerFactory no reconoce el atributo ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC601" class="line" lang="java">        <span class="s">"Valor no v\u00E1lido especificado para el atributo ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC608" class="line" lang="java">        <span class="s">"setResult() debe llamarse antes de startDocument()."</span><span class="o">},</span></span>
...
<span id="LC618" class="line" lang="java">        <span class="s">"Transformer no tiene un objeto translet encapsulado."</span><span class="o">},</span></span>
...
<span id="LC626" class="line" lang="java">        <span class="s">"No se ha definido el manejador de salida para el resultado de la transformaci\u00F3n."</span><span class="o">},</span></span>
...
<span id="LC633" class="line" lang="java">        <span class="s">"El objeto Result que se ha pasado a ''{0}'' no es v\u00E1lido."</span><span class="o">},</span></span>
...
<span id="LC643" class="line" lang="java">        <span class="s">"Se est\u00E1 intentando acceder a la propiedad ''{0}'' de Transformer no v\u00E1lida."</span><span class="o">},</span></span>
...
<span id="LC651" class="line" lang="java">        <span class="s">"No se ha podido crear el adaptador SAX2DOM: ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC658" class="line" lang="java">        <span class="s">"Se ha llamado a XSLTCSource.build() sin haber definido la identificaci\u00F3n del sistema."</span><span class="o">},</span></span>
...
<span id="LC661" class="line" lang="java">            <span class="s">"El resultado no debe ser nulo"</span><span class="o">},</span></span>
...
<span id="LC668" class="line" lang="java">        <span class="s">"El valor del par\u00E1metro {0} debe ser un objeto Java v\u00E1lido"</span><span class="o">},</span></span>
...
<span id="LC672" class="line" lang="java">        <span class="s">"La opci\u00F3n -i debe utilizarse con la opci\u00F3n -o."</span><span class="o">},</span></span>
...
<span id="LC708" class="line" lang="java">        <span class="s">"&lt;xsl:sort&gt; s\u00F3lo se puede utilizar en &lt;xsl:for-each&gt; o &lt;xsl:apply-templates&gt;."</span><span class="o">},</span></span>
...
<span id="LC717" class="line" lang="java">        <span class="s">"La codificaci\u00F3n de salida ''{0}'' no est\u00E1 soportada en esta JVM."</span><span class="o">},</span></span>
...
<span id="LC724" class="line" lang="java">        <span class="s">"Error de sintaxis en ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC733" class="line" lang="java">        <span class="s">"No se ha encontrado el constructor externo ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC741" class="line" lang="java">        <span class="s">"El primer argumento de la funci\u00F3n Java no est\u00E1tica ''{0}'' no es una referencia de objeto v\u00E1lida."</span><span class="o">},</span></span>
...
<span id="LC749" class="line" lang="java">        <span class="s">"Error al comprobar el tipo de la expresi\u00F3n ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC757" class="line" lang="java">        <span class="s">"Error al comprobar el tipo de una expresi\u00F3n en una ubicaci\u00F3n desconocida."</span><span class="o">},</span></span>
...
<span id="LC764" class="line" lang="java">        <span class="s">"La opci\u00F3n de l\u00EDnea de comandos ''{0}'' no es v\u00E1lida."</span><span class="o">},</span></span>
...
<span id="LC771" class="line" lang="java">        <span class="s">"Falta un argumento necesario en la opci\u00F3n de l\u00EDnea de comandos ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC825" class="line" lang="java">        <span class="s">"Transformaci\u00F3n que utiliza el translet ''{0}'' "</span><span class="o">},</span></span>
...
<span id="LC832" class="line" lang="java">        <span class="s">"Transformaci\u00F3n que utiliza el translet ''{0}'' del archivo jar ''{1}''"</span><span class="o">},</span></span>
...
<span id="LC840" class="line" lang="java">        <span class="s">"No se ha podido crear una instancia de la clase TransformerFactory ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC850" class="line" lang="java">         <span class="s">"El nombre ''{0}'' no se ha podido utilizar como el nombre de la clase de translet porque contiene caracteres que no est\u00E1n permitidos en el nombre de la clase Java. Se ha utilizado el nombre ''{1}'' en su lugar."</span><span class="o">},</span></span>
...
<span id="LC858" class="line" lang="java">        <span class="s">"Errores del compilador:"</span><span class="o">},</span></span>
...
<span id="LC866" class="line" lang="java">        <span class="s">"Advertencias del compilador:"</span><span class="o">},</span></span>
...
<span id="LC876" class="line" lang="java">        <span class="s">"Errores del translet:"</span><span class="o">},</span></span>
...
<span id="LC885" class="line" lang="java">        <span class="s">"Un atributo cuyo valor debe ser un QName o lista de QNames separados por espacios en blanco ten\u00EDa el valor ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC894" class="line" lang="java">        <span class="s">"Un atributo cuyo valor debe ser un NCName ten\u00EDa el valor ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC907" class="line" lang="java">        <span class="s">"El atributo method de un elemento &lt;xsl:output&gt; ten\u00EDa el valor ''{0}''. El valor debe ser ''xml'', ''html'', ''text'' o qname-but-not-ncname"</span><span class="o">},</span></span>
...
<span id="LC910" class="line" lang="java">        <span class="s">"El nombre de funci\u00F3n no puede ser nulo en TransformerFactory.getFeature (nombre de cadena)."</span><span class="o">},</span></span>
...
<span id="LC913" class="line" lang="java">        <span class="s">"El nombre de funci\u00F3n no puede ser nulo en TransformerFactory.setFeature (nombre de cadena, valor booleano)."</span><span class="o">},</span></span>
...
<span id="LC916" class="line" lang="java">        <span class="s">"No se puede definir la funci\u00F3n ''{0}''en esta f\u00E1brica del transformador."</span><span class="o">},</span></span>
...
<span id="LC919" class="line" lang="java">        <span class="s">"FEATURE_SECURE_PROCESSING: no se puede definir la funci\u00F3n en false cuando est\u00E1 presente el gestor de seguridad."</span><span class="o">},</span></span>
...
<span id="LC929" class="line" lang="java">         <span class="s">"Error interno de XSLTC: el c\u00F3digo de bytes generado contiene un bloque try-catch-finally y no se puede delimitar."</span><span class="o">},</span></span>
...
<span id="LC942" class="line" lang="java">         <span class="s">"Error interno de XSLTC: los marcadores OutlineableChunkStart y OutlineableChunkEnd deben estar equilibrados y correctamente anidados."</span><span class="o">},</span></span>
...
<span id="LC955" class="line" lang="java">         <span class="s">"Error interno de XSLTC: todav\u00EDa se hace referencia a una instrucci\u00F3n que formaba parte de un bloque de c\u00F3digo de bytes delimitado en el m\u00E9todo original."</span></span>
...
<span id="LC966" class="line" lang="java">         <span class="s">"Error interno de XSLTC: un m\u00E9todo en el translet excede la limitaci\u00F3n de Java Virtual Machine de longitud de un m\u00E9todo de 64 kilobytes. Normalmente, esto lo causan plantillas en una hoja de estilos demasiado grandes. Pruebe a reestructurar la hoja de estilos para utilizar plantillas m\u00E1s peque\u00F1as."</span></span>
<span id="LC967" class="line" lang="java">        <span class="o">},</span></span>
<span id="LC968" class="line" lang="java"></span>
<span id="LC969" class="line" lang="java">         <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">DESERIALIZE_TRANSLET_ERR</span><span class="o">,</span> <span class="s">"Cuando la seguridad de Java est\u00E1 activada, el soporte para anular la serializaci\u00F3n de TemplatesImpl est\u00E1 desactivado. Esto se puede sustituir definiendo la propiedad del sistema jdk.xml.enableTemplatesImplDeserialization en true."</span><span class="o">}</span></span>
