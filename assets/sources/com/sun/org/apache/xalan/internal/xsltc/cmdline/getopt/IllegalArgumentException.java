...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: IllegalArgumentException.java,v 1.2.4.1 2005/08/31 11:47:56 pvedula Exp $</span></span>
...
<span id="LC27" class="line" lang="java"><span class="kd">class</span> <span class="nc">IllegalArgumentException</span> <span class="kd">extends</span> <span class="nc">GetOptsException</span><span class="o">{</span></span>
<span id="LC28" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="mi">8642122427294793651L</span><span class="o">;</span></span>
<span id="LC29" class="line" lang="java">    <span class="kd">public</span> <span class="nf">IllegalArgumentException</span><span class="o">(</span><span class="nc">String</span> <span class="n">msg</span><span class="o">){</span></span>
<span id="LC30" class="line" lang="java">        <span class="kd">super</span><span class="o">(</span><span class="n">msg</span><span class="o">);</span></span>
