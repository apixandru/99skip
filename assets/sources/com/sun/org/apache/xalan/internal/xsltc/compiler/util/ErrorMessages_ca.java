...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: ErrorMessages_ca.java,v 1.1.6.1 2005/09/05 11:52:59 pvedula Exp $</span></span>
...
<span id="LC26" class="line" lang="java"><span class="kn">import</span> <span class="nn">java.util.ListResourceBundle</span><span class="o">;</span></span>
<span id="LC27" class="line" lang="java"></span>
<span id="LC28" class="line" lang="java"><span class="cm">/**</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> * @author Morten Jorgensen</span></span>
<span id="LC30" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC31" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">ErrorMessages_ca</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span> <span class="o">{</span></span>
<span id="LC32" class="line" lang="java"></span>
<span id="LC33" class="line" lang="java"><span class="cm">/*</span></span>
<span id="LC34" class="line" lang="java"><span class="cm"> * XSLTC compile-time error messages.</span></span>
<span id="LC35" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC36" class="line" lang="java"><span class="cm"> * General notes to translators and definitions:</span></span>
<span id="LC37" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC38" class="line" lang="java"><span class="cm"> *   1) XSLTC is the name of the product.  It is an acronym for "XSLT Compiler".</span></span>
<span id="LC39" class="line" lang="java"><span class="cm"> *      XSLT is an acronym for "XML Stylesheet Language: Transformations".</span></span>
<span id="LC40" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC41" class="line" lang="java"><span class="cm"> *   2) A stylesheet is a description of how to transform an input XML document</span></span>
<span id="LC42" class="line" lang="java"><span class="cm"> *      into a resultant XML document (or HTML document or text).  The</span></span>
<span id="LC43" class="line" lang="java"><span class="cm"> *      stylesheet itself is described in the form of an XML document.</span></span>
<span id="LC44" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC45" class="line" lang="java"><span class="cm"> *   3) A template is a component of a stylesheet that is used to match a</span></span>
<span id="LC46" class="line" lang="java"><span class="cm"> *      particular portion of an input document and specifies the form of the</span></span>
<span id="LC47" class="line" lang="java"><span class="cm"> *      corresponding portion of the output document.</span></span>
<span id="LC48" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC49" class="line" lang="java"><span class="cm"> *   4) An axis is a particular "dimension" in a tree representation of an XML</span></span>
<span id="LC50" class="line" lang="java"><span class="cm"> *      document; the nodes in the tree are divided along different axes.</span></span>
<span id="LC51" class="line" lang="java"><span class="cm"> *      Traversing the "child" axis, for instance, means that the program</span></span>
<span id="LC52" class="line" lang="java"><span class="cm"> *      would visit each child of a particular node; traversing the "descendant"</span></span>
<span id="LC53" class="line" lang="java"><span class="cm"> *      axis means that the program would visit the child nodes of a particular</span></span>
<span id="LC54" class="line" lang="java"><span class="cm"> *      node, their children, and so on until the leaf nodes of the tree are</span></span>
<span id="LC55" class="line" lang="java"><span class="cm"> *      reached.</span></span>
<span id="LC56" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC57" class="line" lang="java"><span class="cm"> *   5) An iterator is an object that traverses nodes in a tree along a</span></span>
<span id="LC58" class="line" lang="java"><span class="cm"> *      particular axis, one at a time.</span></span>
<span id="LC59" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC60" class="line" lang="java"><span class="cm"> *   6) An element is a mark-up tag in an XML document; an attribute is a</span></span>
<span id="LC61" class="line" lang="java"><span class="cm"> *      modifier on the tag.  For example, in &lt;elem attr='val' attr2='val2'&gt;</span></span>
<span id="LC62" class="line" lang="java"><span class="cm"> *      "elem" is an element name, "attr" and "attr2" are attribute names with</span></span>
<span id="LC63" class="line" lang="java"><span class="cm"> *      the values "val" and "val2", respectively.</span></span>
<span id="LC64" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC65" class="line" lang="java"><span class="cm"> *   7) A namespace declaration is a special attribute that is used to associate</span></span>
<span id="LC66" class="line" lang="java"><span class="cm"> *      a prefix with a URI (the namespace).  The meanings of element names and</span></span>
<span id="LC67" class="line" lang="java"><span class="cm"> *      attribute names that use that prefix are defined with respect to that</span></span>
<span id="LC68" class="line" lang="java"><span class="cm"> *      namespace.</span></span>
<span id="LC69" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC70" class="line" lang="java"><span class="cm"> *   8) DOM is an acronym for Document Object Model.  It is a tree</span></span>
<span id="LC71" class="line" lang="java"><span class="cm"> *      representation of an XML document.</span></span>
<span id="LC72" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC73" class="line" lang="java"><span class="cm"> *      SAX is an acronym for the Simple API for XML processing.  It is an API</span></span>
<span id="LC74" class="line" lang="java"><span class="cm"> *      used inform an XML processor (in this case XSLTC) of the structure and</span></span>
<span id="LC75" class="line" lang="java"><span class="cm"> *      content of an XML document.</span></span>
<span id="LC76" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC77" class="line" lang="java"><span class="cm"> *      Input to the stylesheet processor can come from an XML parser in the</span></span>
<span id="LC78" class="line" lang="java"><span class="cm"> *      form of a DOM tree or through the SAX API.</span></span>
<span id="LC79" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC80" class="line" lang="java"><span class="cm"> *   9) DTD is a document type declaration.  It is a way of specifying the</span></span>
<span id="LC81" class="line" lang="java"><span class="cm"> *      grammar for an XML file, the names and types of elements, attributes,</span></span>
<span id="LC82" class="line" lang="java"><span class="cm"> *      etc.</span></span>
<span id="LC83" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC84" class="line" lang="java"><span class="cm"> *  10) XPath is a specification that describes a notation for identifying</span></span>
<span id="LC85" class="line" lang="java"><span class="cm"> *      nodes in a tree-structured representation of an XML document.  An</span></span>
<span id="LC86" class="line" lang="java"><span class="cm"> *      instance of that notation is referred to as an XPath expression.</span></span>
<span id="LC87" class="line" lang="java"><span class="cm"> *</span></span>
<span id="LC88" class="line" lang="java"><span class="cm"> *  11) Translet is an invented term that refers to the class file that contains</span></span>
<span id="LC89" class="line" lang="java"><span class="cm"> *      the compiled form of a stylesheet.</span></span>
<span id="LC90" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC91" class="line" lang="java"></span>
<span id="LC92" class="line" lang="java">    <span class="c1">// These message should be read from a locale-specific resource bundle</span></span>
<span id="LC93" class="line" lang="java">    <span class="cm">/** Get the lookup table for error messages.</span></span>
<span id="LC94" class="line" lang="java"><span class="cm">     *</span></span>
<span id="LC95" class="line" lang="java"><span class="cm">     * @return The message lookup table.</span></span>
<span id="LC96" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC97" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Object</span><span class="o">[][]</span> <span class="nf">getContents</span><span class="o">()</span></span>
<span id="LC98" class="line" lang="java">    <span class="o">{</span></span>
<span id="LC99" class="line" lang="java">      <span class="k">return</span> <span class="k">new</span> <span class="nc">Object</span><span class="o">[][]</span> <span class="o">{</span></span>
<span id="LC100" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">MULTIPLE_STYLESHEET_ERR</span><span class="o">,</span></span>
<span id="LC101" class="line" lang="java">        <span class="s">"S'ha definit m\u00e9s d'un full d'estils en el mateix fitxer."</span><span class="o">},</span></span>
<span id="LC102" class="line" lang="java"></span>
<span id="LC103" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC104" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text is the name of a</span></span>
<span id="LC105" class="line" lang="java"><span class="cm">         * template.  The same name was used on two different templates in the</span></span>
<span id="LC106" class="line" lang="java"><span class="cm">         * same stylesheet.</span></span>
<span id="LC107" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC108" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TEMPLATE_REDEF_ERR</span><span class="o">,</span></span>
<span id="LC109" class="line" lang="java">        <span class="s">"La plantilla ''{0}'' ja est\u00e0 definida en aquest full d''estils."</span><span class="o">},</span></span>
...
<span id="LC113" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text is the name of a</span></span>
<span id="LC114" class="line" lang="java"><span class="cm">         * template.  A reference to the template name was encountered, but the</span></span>
<span id="LC115" class="line" lang="java"><span class="cm">         * template is undefined.</span></span>
<span id="LC116" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC117" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TEMPLATE_UNDEF_ERR</span><span class="o">,</span></span>
<span id="LC118" class="line" lang="java">        <span class="s">"La plantilla ''{0}'' no est\u00e0 definida en aquest full d''estils."</span><span class="o">},</span></span>
<span id="LC119" class="line" lang="java"></span>
<span id="LC120" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC121" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text is the name of a variable</span></span>
<span id="LC122" class="line" lang="java"><span class="cm">         * that was defined more than once.</span></span>
<span id="LC123" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC124" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">VARIABLE_REDEF_ERR</span><span class="o">,</span></span>
<span id="LC125" class="line" lang="java">        <span class="s">"La variable ''{0}'' s''ha definit m\u00e9s d''una vegada en el mateix \u00e0mbit."</span><span class="o">},</span></span>
<span id="LC126" class="line" lang="java"></span>
<span id="LC127" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC128" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text is the name of a variable</span></span>
<span id="LC129" class="line" lang="java"><span class="cm">         * or parameter.  A reference to the variable or parameter was found,</span></span>
<span id="LC130" class="line" lang="java"><span class="cm">         * but it was never defined.</span></span>
<span id="LC131" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC132" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">VARIABLE_UNDEF_ERR</span><span class="o">,</span></span>
<span id="LC133" class="line" lang="java">        <span class="s">"La variable o el par\u00e0metre ''{0}'' no s''ha definit."</span><span class="o">},</span></span>
<span id="LC134" class="line" lang="java"></span>
<span id="LC135" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC136" class="line" lang="java"><span class="cm">         * Note to translators:  The word "class" here refers to a Java class.</span></span>
<span id="LC137" class="line" lang="java"><span class="cm">         * Processing the stylesheet required a class to be loaded, but it could</span></span>
<span id="LC138" class="line" lang="java"><span class="cm">         * not be found.  The substitution text is the name of the class.</span></span>
<span id="LC139" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC140" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">CLASS_NOT_FOUND_ERR</span><span class="o">,</span></span>
<span id="LC141" class="line" lang="java">        <span class="s">"No s''ha trobat la classe ''{0}''."</span><span class="o">},</span></span>
<span id="LC142" class="line" lang="java"></span>
<span id="LC143" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC144" class="line" lang="java"><span class="cm">         * Note to translators:  The word "method" here refers to a Java method.</span></span>
<span id="LC145" class="line" lang="java"><span class="cm">         * Processing the stylesheet required a reference to the method named by</span></span>
<span id="LC146" class="line" lang="java"><span class="cm">         * the substitution text, but it could not be found.  "public" is the</span></span>
<span id="LC147" class="line" lang="java"><span class="cm">         * Java keyword.</span></span>
<span id="LC148" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC149" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">METHOD_NOT_FOUND_ERR</span><span class="o">,</span></span>
<span id="LC150" class="line" lang="java">        <span class="s">"No s''ha trobat el m\u00e8tode extern ''{0}'' (ha de ser public)."</span><span class="o">},</span></span>
<span id="LC151" class="line" lang="java"></span>
<span id="LC152" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC153" class="line" lang="java"><span class="cm">         * Note to translators:  The word "method" here refers to a Java method.</span></span>
<span id="LC154" class="line" lang="java"><span class="cm">         * Processing the stylesheet required a reference to the method named by</span></span>
<span id="LC155" class="line" lang="java"><span class="cm">         * the substitution text, but no method with the required types of</span></span>
<span id="LC156" class="line" lang="java"><span class="cm">         * arguments or return type could be found.</span></span>
<span id="LC157" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC158" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ARGUMENT_CONVERSION_ERR</span><span class="o">,</span></span>
<span id="LC159" class="line" lang="java">        <span class="s">"No s''ha pogut convertir l''argument o tipus de retorn a la crida del m\u00e8tode ''{0}''"</span><span class="o">},</span></span>
<span id="LC160" class="line" lang="java"></span>
<span id="LC161" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC162" class="line" lang="java"><span class="cm">         * Note to translators:  The file or URI named in the substitution text</span></span>
<span id="LC163" class="line" lang="java"><span class="cm">         * is missing.</span></span>
<span id="LC164" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC165" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">FILE_NOT_FOUND_ERR</span><span class="o">,</span></span>
<span id="LC166" class="line" lang="java">        <span class="s">"No s''ha trobat el fitxer o URI ''{0}''."</span><span class="o">},</span></span>
<span id="LC167" class="line" lang="java"></span>
<span id="LC168" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC169" class="line" lang="java"><span class="cm">         * Note to translators:  This message is displayed when the URI</span></span>
<span id="LC170" class="line" lang="java"><span class="cm">         * mentioned in the substitution text is not well-formed syntactically.</span></span>
<span id="LC171" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC172" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">INVALID_URI_ERR</span><span class="o">,</span></span>
<span id="LC173" class="line" lang="java">        <span class="s">"L''URI ''{0}'' no \u00e9s v\u00e0lid."</span><span class="o">},</span></span>
<span id="LC174" class="line" lang="java"></span>
<span id="LC175" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC176" class="line" lang="java"><span class="cm">         * Note to translators:  The file or URI named in the substitution text</span></span>
<span id="LC177" class="line" lang="java"><span class="cm">         * exists but could not be opened.</span></span>
<span id="LC178" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC179" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">FILE_ACCESS_ERR</span><span class="o">,</span></span>
<span id="LC180" class="line" lang="java">        <span class="s">"No es pot obrir el fitxer o l''URI ''{0}''."</span><span class="o">},</span></span>
<span id="LC181" class="line" lang="java"></span>
<span id="LC182" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC183" class="line" lang="java"><span class="cm">         * Note to translators: &lt;xsl:stylesheet&gt; and &lt;xsl:transform&gt; are</span></span>
<span id="LC184" class="line" lang="java"><span class="cm">         * keywords that should not be translated.</span></span>
<span id="LC185" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC186" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">MISSING_ROOT_ERR</span><span class="o">,</span></span>
<span id="LC187" class="line" lang="java">        <span class="s">"S''esperava l''element &lt;xsl:stylesheet&gt; o &lt;xsl:transform&gt;."</span><span class="o">},</span></span>
<span id="LC188" class="line" lang="java"></span>
<span id="LC189" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC190" class="line" lang="java"><span class="cm">         * Note to translators:  The stylesheet contained a reference to a</span></span>
<span id="LC191" class="line" lang="java"><span class="cm">         * namespace prefix that was undefined.  The value of the substitution</span></span>
<span id="LC192" class="line" lang="java"><span class="cm">         * text is the name of the prefix.</span></span>
<span id="LC193" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC194" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">NAMESPACE_UNDEF_ERR</span><span class="o">,</span></span>
<span id="LC195" class="line" lang="java">        <span class="s">"El prefix d''espai de noms ''{0}'' no s''ha declarat."</span><span class="o">},</span></span>
<span id="LC196" class="line" lang="java"></span>
<span id="LC197" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC198" class="line" lang="java"><span class="cm">         * Note to translators:  The Java function named in the stylesheet could</span></span>
<span id="LC199" class="line" lang="java"><span class="cm">         * not be found.</span></span>
<span id="LC200" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC201" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">FUNCTION_RESOLVE_ERR</span><span class="o">,</span></span>
<span id="LC202" class="line" lang="java">        <span class="s">"No s''ha pogut resoldre la crida de la funci\u00f3 ''{0}''."</span><span class="o">},</span></span>
<span id="LC203" class="line" lang="java"></span>
<span id="LC204" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC205" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text is the name of a</span></span>
<span id="LC206" class="line" lang="java"><span class="cm">         * function.  A literal string here means a constant string value.</span></span>
<span id="LC207" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC208" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">NEED_LITERAL_ERR</span><span class="o">,</span></span>
<span id="LC209" class="line" lang="java">        <span class="s">"L''argument de ''{0}'' ha de ser una cadena de literals."</span><span class="o">},</span></span>
<span id="LC210" class="line" lang="java"></span>
<span id="LC211" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC212" class="line" lang="java"><span class="cm">         * Note to translators:  This message indicates there was a syntactic</span></span>
<span id="LC213" class="line" lang="java"><span class="cm">         * error in the form of an XPath expression.  The substitution text is</span></span>
<span id="LC214" class="line" lang="java"><span class="cm">         * the expression.</span></span>
<span id="LC215" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC216" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">XPATH_PARSER_ERR</span><span class="o">,</span></span>
<span id="LC217" class="line" lang="java">        <span class="s">"S''ha produ\u00eft un error en analitzar l''expressi\u00f3 XPath ''{0}''."</span><span class="o">},</span></span>
<span id="LC218" class="line" lang="java"></span>
<span id="LC219" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC220" class="line" lang="java"><span class="cm">         * Note to translators:  An element in the stylesheet requires a</span></span>
<span id="LC221" class="line" lang="java"><span class="cm">         * particular attribute named by the substitution text, but that</span></span>
<span id="LC222" class="line" lang="java"><span class="cm">         * attribute was not specified in the stylesheet.</span></span>
<span id="LC223" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC224" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">REQUIRED_ATTR_ERR</span><span class="o">,</span></span>
<span id="LC225" class="line" lang="java">        <span class="s">"No s''ha especificat l''atribut obligatori ''{0}''."</span><span class="o">},</span></span>
<span id="LC226" class="line" lang="java"></span>
<span id="LC227" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC228" class="line" lang="java"><span class="cm">         * Note to translators:  This message indicates that a character not</span></span>
<span id="LC229" class="line" lang="java"><span class="cm">         * permitted in an XPath expression was encountered.  The substitution</span></span>
<span id="LC230" class="line" lang="java"><span class="cm">         * text is the offending character.</span></span>
<span id="LC231" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC232" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_CHAR_ERR</span><span class="o">,</span></span>
<span id="LC233" class="line" lang="java">        <span class="s">"L''expressi\u00f3 XPath cont\u00e9 el car\u00e0cter no perm\u00e8s ''{0}''."</span><span class="o">},</span></span>
<span id="LC234" class="line" lang="java"></span>
<span id="LC235" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC236" class="line" lang="java"><span class="cm">         * Note to translators:  A processing instruction is a mark-up item in</span></span>
<span id="LC237" class="line" lang="java"><span class="cm">         * an XML document that request some behaviour of an XML processor.  The</span></span>
<span id="LC238" class="line" lang="java"><span class="cm">         * form of the name of was invalid in this case, and the substitution</span></span>
<span id="LC239" class="line" lang="java"><span class="cm">         * text is the name.</span></span>
<span id="LC240" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC241" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_PI_ERR</span><span class="o">,</span></span>
<span id="LC242" class="line" lang="java">        <span class="s">"La instrucci\u00f3 de processament t\u00e9 el nom no perm\u00e8s ''{0}''."</span><span class="o">},</span></span>
<span id="LC243" class="line" lang="java"></span>
<span id="LC244" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC245" class="line" lang="java"><span class="cm">         * Note to translators:  This message is reported if the stylesheet</span></span>
<span id="LC246" class="line" lang="java"><span class="cm">         * being processed attempted to construct an XML document with an</span></span>
<span id="LC247" class="line" lang="java"><span class="cm">         * attribute in a place other than on an element.  The substitution text</span></span>
<span id="LC248" class="line" lang="java"><span class="cm">         * specifies the name of the attribute.</span></span>
<span id="LC249" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC250" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">STRAY_ATTRIBUTE_ERR</span><span class="o">,</span></span>
<span id="LC251" class="line" lang="java">        <span class="s">"L''atribut ''{0}'' es troba fora de l''element."</span><span class="o">},</span></span>
<span id="LC252" class="line" lang="java"></span>
<span id="LC253" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC254" class="line" lang="java"><span class="cm">         * Note to translators:  An attribute that wasn't recognized was</span></span>
<span id="LC255" class="line" lang="java"><span class="cm">         * specified on an element in the stylesheet.  The attribute is named</span></span>
<span id="LC256" class="line" lang="java"><span class="cm">         * by the substitution</span></span>
<span id="LC257" class="line" lang="java"><span class="cm">         * text.</span></span>
<span id="LC258" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC259" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_ATTRIBUTE_ERR</span><span class="o">,</span></span>
<span id="LC260" class="line" lang="java">        <span class="s">"No es permet l''atribut ''{0}''."</span><span class="o">},</span></span>
<span id="LC261" class="line" lang="java"></span>
<span id="LC262" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC263" class="line" lang="java"><span class="cm">         * Note to translators:  "import" and "include" are keywords that should</span></span>
<span id="LC264" class="line" lang="java"><span class="cm">         * not be translated.  This messages indicates that the stylesheet</span></span>
<span id="LC265" class="line" lang="java"><span class="cm">         * named in the substitution text imported or included itself either</span></span>
<span id="LC266" class="line" lang="java"><span class="cm">         * directly or indirectly.</span></span>
<span id="LC267" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC268" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">CIRCULAR_INCLUDE_ERR</span><span class="o">,</span></span>
<span id="LC269" class="line" lang="java">        <span class="s">"Import/include circular. El full d''estils ''{0}'' ja s''ha carregat."</span><span class="o">},</span></span>
<span id="LC270" class="line" lang="java"></span>
<span id="LC271" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC272" class="line" lang="java"><span class="cm">         * Note to translators:  A result-tree fragment is a portion of a</span></span>
<span id="LC273" class="line" lang="java"><span class="cm">         * resulting XML document represented as a tree.  "&lt;xsl:sort&gt;" is a</span></span>
<span id="LC274" class="line" lang="java"><span class="cm">         * keyword and should not be translated.</span></span>
<span id="LC275" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC276" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">RESULT_TREE_SORT_ERR</span><span class="o">,</span></span>
<span id="LC277" class="line" lang="java">        <span class="s">"Els fragments de l'arbre de resultats no es poden classificar (es passen per alt els elements &lt;xsl:sort&gt;). Heu de classificar els nodes quan creeu l'arbre de resultats. "</span><span class="o">},</span></span>
<span id="LC278" class="line" lang="java"></span>
<span id="LC279" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC280" class="line" lang="java"><span class="cm">         * Note to translators:  A name can be given to a particular style to be</span></span>
<span id="LC281" class="line" lang="java"><span class="cm">         * used to format decimal values.  The substitution text gives the name</span></span>
<span id="LC282" class="line" lang="java"><span class="cm">         * of such a style for which more than one declaration was encountered.</span></span>
<span id="LC283" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC284" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">SYMBOLS_REDEF_ERR</span><span class="o">,</span></span>
<span id="LC285" class="line" lang="java">        <span class="s">"El formatatge decimal ''{0}'' ja est\u00e0 definit."</span><span class="o">},</span></span>
<span id="LC286" class="line" lang="java"></span>
<span id="LC287" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC288" class="line" lang="java"><span class="cm">         * Note to translators:  The stylesheet version named in the</span></span>
<span id="LC289" class="line" lang="java"><span class="cm">         * substitution text is not supported.</span></span>
<span id="LC290" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC291" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">XSL_VERSION_ERR</span><span class="o">,</span></span>
<span id="LC292" class="line" lang="java">        <span class="s">"XSLTC no d\u00f3na suport a la versi\u00f3 XSL ''{0}''."</span><span class="o">},</span></span>
<span id="LC293" class="line" lang="java"></span>
<span id="LC294" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC295" class="line" lang="java"><span class="cm">         * Note to translators:  The definitions of one or more variables or</span></span>
<span id="LC296" class="line" lang="java"><span class="cm">         * parameters depend on one another.</span></span>
<span id="LC297" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC298" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">CIRCULAR_VARIABLE_ERR</span><span class="o">,</span></span>
<span id="LC299" class="line" lang="java">        <span class="s">"Hi ha una refer\u00e8ncia de variable/par\u00e0metre circular a ''{0}''."</span><span class="o">},</span></span>
<span id="LC300" class="line" lang="java"></span>
<span id="LC301" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC302" class="line" lang="java"><span class="cm">         * Note to translators:  The operator in an expresion with two operands was</span></span>
<span id="LC303" class="line" lang="java"><span class="cm">         * not recognized.</span></span>
<span id="LC304" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC305" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_BINARY_OP_ERR</span><span class="o">,</span></span>
<span id="LC306" class="line" lang="java">        <span class="s">"L'operador de l'expressi\u00f3 bin\u00e0ria \u00e9s desconegut."</span><span class="o">},</span></span>
<span id="LC307" class="line" lang="java"></span>
<span id="LC308" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC309" class="line" lang="java"><span class="cm">         * Note to translators:  This message is produced if a reference to a</span></span>
<span id="LC310" class="line" lang="java"><span class="cm">         * function has too many or too few arguments.</span></span>
<span id="LC311" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC312" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_ARG_ERR</span><span class="o">,</span></span>
<span id="LC313" class="line" lang="java">        <span class="s">"La crida de funci\u00f3 t\u00e9 arguments no permesos."</span><span class="o">},</span></span>
<span id="LC314" class="line" lang="java"></span>
<span id="LC315" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC316" class="line" lang="java"><span class="cm">         * Note to translators:  "document()" is the name of function and must</span></span>
<span id="LC317" class="line" lang="java"><span class="cm">         * not be translated.  A node-set is a set of the nodes in the tree</span></span>
<span id="LC318" class="line" lang="java"><span class="cm">         * representation of an XML document.</span></span>
<span id="LC319" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC320" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">DOCUMENT_ARG_ERR</span><span class="o">,</span></span>
<span id="LC321" class="line" lang="java">        <span class="s">"El segon argument de la funci\u00f3 document() ha de ser un conjunt de nodes."</span><span class="o">},</span></span>
<span id="LC322" class="line" lang="java"></span>
<span id="LC323" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC324" class="line" lang="java"><span class="cm">         * Note to translators:  "&lt;xsl:when&gt;" and "&lt;xsl:choose&gt;" are keywords</span></span>
<span id="LC325" class="line" lang="java"><span class="cm">         * and should not be translated.  This message describes a syntax error</span></span>
<span id="LC326" class="line" lang="java"><span class="cm">         * in the stylesheet.</span></span>
<span id="LC327" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC328" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">MISSING_WHEN_ERR</span><span class="o">,</span></span>
<span id="LC329" class="line" lang="java">        <span class="s">"Es necessita com a m\u00ednim un element &lt;xsl:when&gt; a &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
<span id="LC330" class="line" lang="java"></span>
<span id="LC331" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC332" class="line" lang="java"><span class="cm">         * Note to translators:  "&lt;xsl:otherwise&gt;" and "&lt;xsl:choose&gt;" are</span></span>
<span id="LC333" class="line" lang="java"><span class="cm">         * keywords and should not be translated.  This message describes a</span></span>
<span id="LC334" class="line" lang="java"><span class="cm">         * syntax error in the stylesheet.</span></span>
<span id="LC335" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC336" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">MULTIPLE_OTHERWISE_ERR</span><span class="o">,</span></span>
<span id="LC337" class="line" lang="java">        <span class="s">"Nom\u00e9s es permet un element &lt;xsl:otherwise&gt; a &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
<span id="LC338" class="line" lang="java"></span>
<span id="LC339" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC340" class="line" lang="java"><span class="cm">         * Note to translators:  "&lt;xsl:otherwise&gt;" and "&lt;xsl:choose&gt;" are</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">         * keywords and should not be translated.  This message describes a</span></span>
<span id="LC342" class="line" lang="java"><span class="cm">         * syntax error in the stylesheet.</span></span>
<span id="LC343" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC344" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">STRAY_OTHERWISE_ERR</span><span class="o">,</span></span>
<span id="LC345" class="line" lang="java">        <span class="s">"&lt;xsl:otherwise&gt; nom\u00e9s es pot utilitzar dins de &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
<span id="LC346" class="line" lang="java"></span>
<span id="LC347" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC348" class="line" lang="java"><span class="cm">         * Note to translators:  "&lt;xsl:when&gt;" and "&lt;xsl:choose&gt;" are keywords</span></span>
<span id="LC349" class="line" lang="java"><span class="cm">         * and should not be translated.  This message describes a syntax error</span></span>
<span id="LC350" class="line" lang="java"><span class="cm">         * in the stylesheet.</span></span>
<span id="LC351" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC352" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">STRAY_WHEN_ERR</span><span class="o">,</span></span>
<span id="LC353" class="line" lang="java">        <span class="s">"&lt;xsl:when&gt; nom\u00e9s es pot utilitzar dins de &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
<span id="LC354" class="line" lang="java"></span>
<span id="LC355" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC356" class="line" lang="java"><span class="cm">         * Note to translators:  "&lt;xsl:when&gt;", "&lt;xsl:otherwise&gt;" and</span></span>
<span id="LC357" class="line" lang="java"><span class="cm">         * "&lt;xsl:choose&gt;" are keywords and should not be translated.  This</span></span>
<span id="LC358" class="line" lang="java"><span class="cm">         * message describes a syntax error in the stylesheet.</span></span>
<span id="LC359" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC360" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">WHEN_ELEMENT_ERR</span><span class="o">,</span></span>
<span id="LC361" class="line" lang="java">        <span class="s">"A &lt;xsl:choose&gt; nom\u00e9s es permeten els elements &lt;xsl:when&gt; i &lt;xsl:otherwise&gt;."</span><span class="o">},</span></span>
<span id="LC362" class="line" lang="java"></span>
<span id="LC363" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC364" class="line" lang="java"><span class="cm">         * Note to translators:  "&lt;xsl:attribute-set&gt;" and "name" are keywords</span></span>
<span id="LC365" class="line" lang="java"><span class="cm">         * that should not be translated.</span></span>
<span id="LC366" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC367" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">UNNAMED_ATTRIBSET_ERR</span><span class="o">,</span></span>
<span id="LC368" class="line" lang="java">        <span class="s">"L'atribut 'name' falta a &lt;xsl:attribute-set&gt;."</span><span class="o">},</span></span>
<span id="LC369" class="line" lang="java"></span>
<span id="LC370" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC371" class="line" lang="java"><span class="cm">         * Note to translators:  An element in the stylesheet contained an</span></span>
<span id="LC372" class="line" lang="java"><span class="cm">         * element of a type that it was not permitted to contain.</span></span>
<span id="LC373" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC374" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_CHILD_ERR</span><span class="o">,</span></span>
<span id="LC375" class="line" lang="java">        <span class="s">"L'element subordinat no \u00e9s perm\u00e8s."</span><span class="o">},</span></span>
<span id="LC376" class="line" lang="java"></span>
<span id="LC377" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC378" class="line" lang="java"><span class="cm">         * Note to translators:  The stylesheet tried to create an element with</span></span>
<span id="LC379" class="line" lang="java"><span class="cm">         * a name that was not a valid XML name.  The substitution text contains</span></span>
<span id="LC380" class="line" lang="java"><span class="cm">         * the name.</span></span>
<span id="LC381" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC382" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_ELEM_NAME_ERR</span><span class="o">,</span></span>
<span id="LC383" class="line" lang="java">        <span class="s">"No podeu cridar un element ''{0}''"</span><span class="o">},</span></span>
<span id="LC384" class="line" lang="java"></span>
<span id="LC385" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC386" class="line" lang="java"><span class="cm">         * Note to translators:  The stylesheet tried to create an attribute</span></span>
<span id="LC387" class="line" lang="java"><span class="cm">         * with a name that was not a valid XML name.  The substitution text</span></span>
<span id="LC388" class="line" lang="java"><span class="cm">         * contains the name.</span></span>
<span id="LC389" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC390" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_ATTR_NAME_ERR</span><span class="o">,</span></span>
<span id="LC391" class="line" lang="java">        <span class="s">"No podeu cridar un atribut ''{0}''"</span><span class="o">},</span></span>
<span id="LC392" class="line" lang="java"></span>
<span id="LC393" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC394" class="line" lang="java"><span class="cm">         * Note to translators:  The children of the outermost element of a</span></span>
<span id="LC395" class="line" lang="java"><span class="cm">         * stylesheet are referred to as top-level elements.  No text should</span></span>
<span id="LC396" class="line" lang="java"><span class="cm">         * occur within that outermost element unless it is within a top-level</span></span>
<span id="LC397" class="line" lang="java"><span class="cm">         * element.  This message indicates that that constraint was violated.</span></span>
<span id="LC398" class="line" lang="java"><span class="cm">         * "&lt;xsl:stylesheet&gt;" is a keyword that should not be translated.</span></span>
<span id="LC399" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC400" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_TEXT_NODE_ERR</span><span class="o">,</span></span>
<span id="LC401" class="line" lang="java">        <span class="s">"Hi ha dades fora de l'element de nivell superior &lt;xsl:stylesheet&gt;."</span><span class="o">},</span></span>
<span id="LC402" class="line" lang="java"></span>
<span id="LC403" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC404" class="line" lang="java"><span class="cm">         * Note to translators:  JAXP is an acronym for the Java API for XML</span></span>
<span id="LC405" class="line" lang="java"><span class="cm">         * Processing.  This message indicates that the XML parser provided to</span></span>
<span id="LC406" class="line" lang="java"><span class="cm">         * XSLTC to process the XML input document had a configuration problem.</span></span>
<span id="LC407" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC408" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">SAX_PARSER_CONFIG_ERR</span><span class="o">,</span></span>
<span id="LC409" class="line" lang="java">        <span class="s">"L'analitzador JAXP no s'ha configurat correctament"</span><span class="o">},</span></span>
<span id="LC410" class="line" lang="java"></span>
<span id="LC411" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC412" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text names the internal error</span></span>
<span id="LC413" class="line" lang="java"><span class="cm">         * encountered.</span></span>
<span id="LC414" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC415" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">INTERNAL_ERR</span><span class="o">,</span></span>
<span id="LC416" class="line" lang="java">        <span class="s">"S''ha produ\u00eft un error intern d''XSLTC irrecuperable: ''{0}''"</span><span class="o">},</span></span>
<span id="LC417" class="line" lang="java"></span>
<span id="LC418" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC419" class="line" lang="java"><span class="cm">         * Note to translators:  The stylesheet contained an element that was</span></span>
<span id="LC420" class="line" lang="java"><span class="cm">         * not recognized as part of the XSL syntax.  The substitution text</span></span>
<span id="LC421" class="line" lang="java"><span class="cm">         * gives the element name.</span></span>
<span id="LC422" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC423" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">UNSUPPORTED_XSL_ERR</span><span class="o">,</span></span>
<span id="LC424" class="line" lang="java">        <span class="s">"L''element d''XSL ''{0}'' no t\u00e9 suport."</span><span class="o">},</span></span>
<span id="LC425" class="line" lang="java"></span>
<span id="LC426" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC427" class="line" lang="java"><span class="cm">         * Note to translators:  The stylesheet referred to an extension to the</span></span>
<span id="LC428" class="line" lang="java"><span class="cm">         * XSL syntax and indicated that it was defined by XSLTC, but XSTLC does</span></span>
<span id="LC429" class="line" lang="java"><span class="cm">         * not recognized the particular extension named.  The substitution text</span></span>
<span id="LC430" class="line" lang="java"><span class="cm">         * gives the extension name.</span></span>
<span id="LC431" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC432" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">UNSUPPORTED_EXT_ERR</span><span class="o">,</span></span>
<span id="LC433" class="line" lang="java">        <span class="s">"No es reconeix l''extensi\u00f3 d''XSLTC ''{0}''."</span><span class="o">},</span></span>
<span id="LC434" class="line" lang="java"></span>
<span id="LC435" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC436" class="line" lang="java"><span class="cm">         * Note to translators:  The XML document given to XSLTC as a stylesheet</span></span>
<span id="LC437" class="line" lang="java"><span class="cm">         * was not, in fact, a stylesheet.  XSLTC is able to detect that in this</span></span>
<span id="LC438" class="line" lang="java"><span class="cm">         * case because the outermost element in the stylesheet has to be</span></span>
<span id="LC439" class="line" lang="java"><span class="cm">         * declared with respect to the XSL namespace URI, but no declaration</span></span>
<span id="LC440" class="line" lang="java"><span class="cm">         * for that namespace was seen.</span></span>
<span id="LC441" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC442" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">MISSING_XSLT_URI_ERR</span><span class="o">,</span></span>
<span id="LC443" class="line" lang="java">        <span class="s">"El document d'entrada no \u00e9s un full d'estils (l'espai de noms XSL no s'ha declarat en l'element arrel)."</span><span class="o">},</span></span>
<span id="LC444" class="line" lang="java"></span>
<span id="LC445" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC446" class="line" lang="java"><span class="cm">         * Note to translators:  XSLTC could not find the stylesheet document</span></span>
<span id="LC447" class="line" lang="java"><span class="cm">         * with the name specified by the substitution text.</span></span>
<span id="LC448" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC449" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">MISSING_XSLT_TARGET_ERR</span><span class="o">,</span></span>
<span id="LC450" class="line" lang="java">        <span class="s">"No s''ha trobat la destinaci\u00f3 ''{0}'' del full d''estils."</span><span class="o">},</span></span>
<span id="LC451" class="line" lang="java"></span>
<span id="LC452" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC453" class="line" lang="java"><span class="cm">         * Note to translators:  access to the stylesheet target is denied</span></span>
<span id="LC454" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC455" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ACCESSING_XSLT_TARGET_ERR</span><span class="o">,</span></span>
<span id="LC456" class="line" lang="java">        <span class="s">"Could not read stylesheet target ''{0}'', because ''{1}'' access is not allowed."</span><span class="o">},</span></span>
<span id="LC457" class="line" lang="java"></span>
<span id="LC458" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC459" class="line" lang="java"><span class="cm">         * Note to translators:  This message represents an internal error in</span></span>
<span id="LC460" class="line" lang="java"><span class="cm">         * condition in XSLTC.  The substitution text is the class name in XSLTC</span></span>
<span id="LC461" class="line" lang="java"><span class="cm">         * that is missing some functionality.</span></span>
<span id="LC462" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC463" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">NOT_IMPLEMENTED_ERR</span><span class="o">,</span></span>
<span id="LC464" class="line" lang="java">        <span class="s">"No s''ha implementat ''{0}''."</span><span class="o">},</span></span>
<span id="LC465" class="line" lang="java"></span>
<span id="LC466" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC467" class="line" lang="java"><span class="cm">         * Note to translators:  The XML document given to XSLTC as a stylesheet</span></span>
<span id="LC468" class="line" lang="java"><span class="cm">         * was not, in fact, a stylesheet.</span></span>
<span id="LC469" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC470" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">NOT_STYLESHEET_ERR</span><span class="o">,</span></span>
<span id="LC471" class="line" lang="java">        <span class="s">"El document d'entrada no cont\u00e9 cap full d'estils XSL."</span><span class="o">},</span></span>
<span id="LC472" class="line" lang="java"></span>
<span id="LC473" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC474" class="line" lang="java"><span class="cm">         * Note to translators:  The element named in the substitution text was</span></span>
<span id="LC475" class="line" lang="java"><span class="cm">         * encountered in the stylesheet but is not recognized.</span></span>
<span id="LC476" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC477" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ELEMENT_PARSE_ERR</span><span class="o">,</span></span>
<span id="LC478" class="line" lang="java">        <span class="s">"No s''ha pogut analitzar l''element ''{0}''"</span><span class="o">},</span></span>
<span id="LC479" class="line" lang="java"></span>
<span id="LC480" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC481" class="line" lang="java"><span class="cm">         * Note to translators:  "use", "&lt;key&gt;", "node", "node-set", "string"</span></span>
<span id="LC482" class="line" lang="java"><span class="cm">         * and "number" are keywords in this context and should not be</span></span>
<span id="LC483" class="line" lang="java"><span class="cm">         * translated.  This message indicates that the value of the "use"</span></span>
<span id="LC484" class="line" lang="java"><span class="cm">         * attribute was not one of the permitted values.</span></span>
<span id="LC485" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC486" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">KEY_USE_ATTR_ERR</span><span class="o">,</span></span>
<span id="LC487" class="line" lang="java">        <span class="s">"L'atribut use de &lt;key&gt; ha de ser node, node-set, string o number."</span><span class="o">},</span></span>
<span id="LC488" class="line" lang="java"></span>
<span id="LC489" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC490" class="line" lang="java"><span class="cm">         * Note to translators:  An XML document can specify the version of the</span></span>
<span id="LC491" class="line" lang="java"><span class="cm">         * XML specification to which it adheres.  This message indicates that</span></span>
<span id="LC492" class="line" lang="java"><span class="cm">         * the version specified for the output document was not valid.</span></span>
<span id="LC493" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC494" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">OUTPUT_VERSION_ERR</span><span class="o">,</span></span>
<span id="LC495" class="line" lang="java">        <span class="s">"La versi\u00f3 del document XML de sortida ha de ser 1.0"</span><span class="o">},</span></span>
<span id="LC496" class="line" lang="java"></span>
<span id="LC497" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC498" class="line" lang="java"><span class="cm">         * Note to translators:  The operator in a comparison operation was</span></span>
<span id="LC499" class="line" lang="java"><span class="cm">         * not recognized.</span></span>
<span id="LC500" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC501" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_RELAT_OP_ERR</span><span class="o">,</span></span>
<span id="LC502" class="line" lang="java">        <span class="s">"L'operador de l'expressi\u00f3 relacional \u00e9s desconegut."</span><span class="o">},</span></span>
<span id="LC503" class="line" lang="java"></span>
<span id="LC504" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC505" class="line" lang="java"><span class="cm">         * Note to translators:  An attribute set defines as a set of XML</span></span>
<span id="LC506" class="line" lang="java"><span class="cm">         * attributes that can be added to an element in the output XML document</span></span>
<span id="LC507" class="line" lang="java"><span class="cm">         * as a group.  This message is reported if the name specified was not</span></span>
<span id="LC508" class="line" lang="java"><span class="cm">         * used to declare an attribute set.  The substitution text is the name</span></span>
<span id="LC509" class="line" lang="java"><span class="cm">         * that is in error.</span></span>
<span id="LC510" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC511" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ATTRIBSET_UNDEF_ERR</span><span class="o">,</span></span>
<span id="LC512" class="line" lang="java">        <span class="s">"S''ha intentat utilitzar el conjunt d''atributs ''{0}'' que no existeix."</span><span class="o">},</span></span>
<span id="LC513" class="line" lang="java"></span>
<span id="LC514" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC515" class="line" lang="java"><span class="cm">         * Note to translators:  The term "attribute value template" is a term</span></span>
<span id="LC516" class="line" lang="java"><span class="cm">         * defined by XSLT which describes the value of an attribute that is</span></span>
<span id="LC517" class="line" lang="java"><span class="cm">         * determined by an XPath expression.  The message indicates that the</span></span>
<span id="LC518" class="line" lang="java"><span class="cm">         * expression was syntactically incorrect; the substitution text</span></span>
<span id="LC519" class="line" lang="java"><span class="cm">         * contains the expression that was in error.</span></span>
<span id="LC520" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC521" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ATTR_VAL_TEMPLATE_ERR</span><span class="o">,</span></span>
<span id="LC522" class="line" lang="java">        <span class="s">"No es pot analitzar la plantilla de valors d''atributs ''{0}''."</span><span class="o">},</span></span>
<span id="LC523" class="line" lang="java"></span>
<span id="LC524" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC525" class="line" lang="java"><span class="cm">         * Note to translators:  ???</span></span>
<span id="LC526" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC527" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">UNKNOWN_SIG_TYPE_ERR</span><span class="o">,</span></span>
<span id="LC528" class="line" lang="java">        <span class="s">"El tipus de dades de la signatura de la classe ''{0}'' \u00e9s desconegut."</span><span class="o">},</span></span>
<span id="LC529" class="line" lang="java"></span>
<span id="LC530" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC531" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text refers to data types.</span></span>
<span id="LC532" class="line" lang="java"><span class="cm">         * The message is displayed if a value in a particular context needs to</span></span>
<span id="LC533" class="line" lang="java"><span class="cm">         * be converted to type {1}, but that's not possible for a value of</span></span>
<span id="LC534" class="line" lang="java"><span class="cm">         * type {0}.</span></span>
<span id="LC535" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC536" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">DATA_CONVERSION_ERR</span><span class="o">,</span></span>
<span id="LC537" class="line" lang="java">        <span class="s">"No es pot convertir el tipus de dades ''{0}'' en ''{1}''."</span><span class="o">},</span></span>
<span id="LC538" class="line" lang="java"></span>
<span id="LC539" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC540" class="line" lang="java"><span class="cm">         * Note to translators:  "Templates" is a Java class name that should</span></span>
<span id="LC541" class="line" lang="java"><span class="cm">         * not be translated.</span></span>
<span id="LC542" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC543" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">NO_TRANSLET_CLASS_ERR</span><span class="o">,</span></span>
<span id="LC544" class="line" lang="java">        <span class="s">"Templates no cont\u00e9 cap definici\u00f3 de classe translet."</span><span class="o">},</span></span>
<span id="LC545" class="line" lang="java"></span>
<span id="LC546" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC547" class="line" lang="java"><span class="cm">         * Note to translators:  "Templates" is a Java class name that should</span></span>
<span id="LC548" class="line" lang="java"><span class="cm">         * not be translated.</span></span>
<span id="LC549" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC550" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">NO_MAIN_TRANSLET_ERR</span><span class="o">,</span></span>
<span id="LC551" class="line" lang="java">        <span class="s">"Templates no cont\u00e9 cap classe amb el nom ''{0}''."</span><span class="o">},</span></span>
<span id="LC552" class="line" lang="java"></span>
<span id="LC553" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC554" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text is the name of a class.</span></span>
<span id="LC555" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC556" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TRANSLET_CLASS_ERR</span><span class="o">,</span></span>
<span id="LC557" class="line" lang="java">        <span class="s">"No s''ha pogut carregar la classe translet ''{0}''."</span><span class="o">},</span></span>
<span id="LC558" class="line" lang="java"></span>
<span id="LC559" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TRANSLET_OBJECT_ERR</span><span class="o">,</span></span>
<span id="LC560" class="line" lang="java">        <span class="s">"La classe translet s''ha carregat, per\u00f2 no es pot crear la inst\u00e0ncia translet."</span><span class="o">},</span></span>
<span id="LC561" class="line" lang="java"></span>
<span id="LC562" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC563" class="line" lang="java"><span class="cm">         * Note to translators:  "ErrorListener" is a Java interface name that</span></span>
<span id="LC564" class="line" lang="java"><span class="cm">         * should not be translated.  The message indicates that the user tried</span></span>
<span id="LC565" class="line" lang="java"><span class="cm">         * to set an ErrorListener object on object of the class named in the</span></span>
<span id="LC566" class="line" lang="java"><span class="cm">         * substitution text with "null" Java value.</span></span>
<span id="LC567" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC568" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ERROR_LISTENER_NULL_ERR</span><span class="o">,</span></span>
<span id="LC569" class="line" lang="java">        <span class="s">"S''ha intentat establir ErrorListener de ''{0}'' en un valor nul."</span><span class="o">},</span></span>
<span id="LC570" class="line" lang="java"></span>
<span id="LC571" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC572" class="line" lang="java"><span class="cm">         * Note to translators:  StreamSource, SAXSource and DOMSource are Java</span></span>
<span id="LC573" class="line" lang="java"><span class="cm">         * interface names that should not be translated.</span></span>
<span id="LC574" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC575" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_UNKNOWN_SOURCE_ERR</span><span class="o">,</span></span>
<span id="LC576" class="line" lang="java">        <span class="s">"XSLTC nom\u00e9s d\u00f3na suport a StreamSource, SAXSource i DOMSource."</span><span class="o">},</span></span>
<span id="LC577" class="line" lang="java"></span>
<span id="LC578" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC579" class="line" lang="java"><span class="cm">         * Note to translators:  "Source" is a Java class name that should not</span></span>
<span id="LC580" class="line" lang="java"><span class="cm">         * be translated.  The substitution text is the name of Java method.</span></span>
<span id="LC581" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC582" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_NO_SOURCE_ERR</span><span class="o">,</span></span>
<span id="LC583" class="line" lang="java">        <span class="s">"L''objecte source donat a ''{0}'' no t\u00e9 contingut."</span><span class="o">},</span></span>
<span id="LC584" class="line" lang="java"></span>
<span id="LC585" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC586" class="line" lang="java"><span class="cm">         * Note to translators:  The message indicates that XSLTC failed to</span></span>
<span id="LC587" class="line" lang="java"><span class="cm">         * compile the stylesheet into a translet (class file).</span></span>
<span id="LC588" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC589" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_COMPILE_ERR</span><span class="o">,</span></span>
<span id="LC590" class="line" lang="java">        <span class="s">"No s'ha pogut compilar el full d'estils."</span><span class="o">},</span></span>
<span id="LC591" class="line" lang="java"></span>
<span id="LC592" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC593" class="line" lang="java"><span class="cm">         * Note to translators:  "TransformerFactory" is a class name.  In this</span></span>
<span id="LC594" class="line" lang="java"><span class="cm">         * context, an attribute is a property or setting of the</span></span>
<span id="LC595" class="line" lang="java"><span class="cm">         * TransformerFactory object.  The substitution text is the name of the</span></span>
<span id="LC596" class="line" lang="java"><span class="cm">         * unrecognised attribute.  The method used to retrieve the attribute is</span></span>
<span id="LC597" class="line" lang="java"><span class="cm">         * "getAttribute", so it's not clear whether it would be best to</span></span>
<span id="LC598" class="line" lang="java"><span class="cm">         * translate the term "attribute".</span></span>
<span id="LC599" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC600" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_INVALID_ATTR_ERR</span><span class="o">,</span></span>
<span id="LC601" class="line" lang="java">        <span class="s">"TransformerFactory no reconeix l''atribut ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC608" class="line" lang="java">        <span class="s">"setResult() s'ha de cridar abans de startDocument()."</span><span class="o">},</span></span>
...
<span id="LC618" class="line" lang="java">        <span class="s">"Transformer no cont\u00e9 cap objecte translet."</span><span class="o">},</span></span>
...
<span id="LC626" class="line" lang="java">        <span class="s">"No s'ha definit cap manejador de sortida per al resultat de transformaci\u00f3."</span><span class="o">},</span></span>
...
<span id="LC633" class="line" lang="java">        <span class="s">"L''objecte result donat a ''{0}'' no \u00e9s v\u00e0lid."</span><span class="o">},</span></span>
...
<span id="LC643" class="line" lang="java">        <span class="s">"S''ha intentat accedir a una propietat Transformer ''{0}'' no v\u00e0lida."</span><span class="o">},</span></span>
...
<span id="LC651" class="line" lang="java">        <span class="s">"No s''ha pogut crear l''adaptador SAX2DOM ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC658" class="line" lang="java">        <span class="s">"S'ha cridat XSLTCSource.build() sense que s'hagu\u00e9s establert la identificaci\u00f3 del sistema."</span><span class="o">},</span></span>
<span id="LC659" class="line" lang="java"></span>
<span id="LC660" class="line" lang="java"></span>
<span id="LC661" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">COMPILE_STDIN_ERR</span><span class="o">,</span></span>
<span id="LC662" class="line" lang="java">        <span class="s">"L'opci\u00f3 -i s'ha d'utilitzar amb l'opci\u00f3 -o."</span><span class="o">},</span></span>
...
<span id="LC666" class="line" lang="java"><span class="cm">         * Note to translators:  This message contains usage information for a</span></span>
<span id="LC667" class="line" lang="java"><span class="cm">         * means of invoking XSLTC from the command-line.  The message is</span></span>
<span id="LC668" class="line" lang="java"><span class="cm">         * formatted for presentation in English.  The strings &lt;output&gt;,</span></span>
<span id="LC669" class="line" lang="java"><span class="cm">         * &lt;directory&gt;, etc. indicate user-specified argument values, and can</span></span>
<span id="LC670" class="line" lang="java"><span class="cm">         * be translated - the argument &lt;package&gt; refers to a Java package, so</span></span>
<span id="LC671" class="line" lang="java"><span class="cm">         * it should be handled in the same way the term is handled for JDK</span></span>
<span id="LC672" class="line" lang="java"><span class="cm">         * documentation.</span></span>
<span id="LC673" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC674" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">COMPILE_USAGE_STR</span><span class="o">,</span></span>
<span id="LC675" class="line" lang="java">        <span class="s">"RESUM\n   java com.sun.org.apache.xalan.internal.xsltc.cmdline.Compile [-o &lt;sortida&gt;]\n      [-d &lt;directori&gt;] [-j &lt;fitxer_jar&gt;] [-p &lt;paquet&gt;]\n      [-n] [-x] [-s] [-u] [-v] [-h] { &lt;full_estils&gt; |  -i }\n\nOPCIONS\n   -o &lt;sortida&gt;    assigna el nom &lt;sortida&gt; al translet\n generat. Per defecte, el nom de translet\n s'obt\u00e9 del nom de &lt;full_estils&gt;. Aquesta opci\u00f3\n no es t\u00e9 en compte si es compilen diversos fulls d'estils.\n   -d &lt;directori&gt; especifica un directori de destinaci\u00f3 per al translet\n   -j &lt;fitxer_jar&gt;   empaqueta les classes translet en un fitxer jar del nom\n                  especificat com a &lt;fitxer_jar&gt;\n   -p &lt;paquet&gt; especifica un prefix de nom de paquet per a totes les classes\n                  translet generades.\n -n habilita l'inlining (com a mitjana, el funcionament per defecte\n \u00e9s millor).\n   -x            habilita la sortida de missatges de depuraci\u00f3 addicionals\n   -s inhabilita la crida de System.exit\n   -u             interpreta els arguments &lt;full_estils&gt; com URL\n -i obliga el compilador a llegir el full d'estils des de l'entrada est\u00e0ndard\n   -v imprimeix la versi\u00f3 del compilador\n   -h             imprimeix aquesta sent\u00e8ncia d'\u00fas.\n"</span><span class="o">},</span></span>
...
<span id="LC680" class="line" lang="java"><span class="cm">         * formatted for presentation in English.  The strings &lt;jarfile&gt;,</span></span>
<span id="LC681" class="line" lang="java"><span class="cm">         * &lt;document&gt;, etc. indicate user-specified argument values, and can</span></span>
<span id="LC682" class="line" lang="java"><span class="cm">         * be translated - the argument &lt;class&gt; refers to a Java class, so it</span></span>
<span id="LC683" class="line" lang="java"><span class="cm">         * should be handled in the same way the term is handled for JDK</span></span>
...
<span id="LC692" class="line" lang="java"><span class="cm">         * Note to translators:  "&lt;xsl:sort&gt;", "&lt;xsl:for-each&gt;" and</span></span>
<span id="LC693" class="line" lang="java"><span class="cm">         * "&lt;xsl:apply-templates&gt;" are keywords that should not be translated.</span></span>
<span id="LC694" class="line" lang="java"><span class="cm">         * The message indicates that an xsl:sort element must be a child of</span></span>
<span id="LC695" class="line" lang="java"><span class="cm">         * one of the other kinds of elements mentioned.</span></span>
<span id="LC696" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC697" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">STRAY_SORT_ERR</span><span class="o">,</span></span>
<span id="LC698" class="line" lang="java">        <span class="s">"&lt;xsl:sort&gt; nom\u00e9s es pot utilitzar amb &lt;xsl:for-each&gt; o &lt;xsl:apply-templates&gt;."</span><span class="o">},</span></span>
<span id="LC699" class="line" lang="java"></span>
<span id="LC700" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC701" class="line" lang="java"><span class="cm">         * Note to translators:  The message indicates that the encoding</span></span>
<span id="LC702" class="line" lang="java"><span class="cm">         * requested for the output document was on that requires support that</span></span>
<span id="LC703" class="line" lang="java"><span class="cm">         * is not available from the Java Virtual Machine being used to execute</span></span>
<span id="LC704" class="line" lang="java"><span class="cm">         * the program.</span></span>
<span id="LC705" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC706" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">UNSUPPORTED_ENCODING</span><span class="o">,</span></span>
<span id="LC707" class="line" lang="java">        <span class="s">"Aquesta JVM no d\u00f3na suport a la codificaci\u00f3 de sortida ''{0}''."</span><span class="o">},</span></span>
<span id="LC708" class="line" lang="java"></span>
<span id="LC709" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC710" class="line" lang="java"><span class="cm">         * Note to translators:  The message indicates that the XPath expression</span></span>
<span id="LC711" class="line" lang="java"><span class="cm">         * named in the substitution text was not well formed syntactically.</span></span>
<span id="LC712" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC713" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">SYNTAX_ERR</span><span class="o">,</span></span>
<span id="LC714" class="line" lang="java">        <span class="s">"S''ha produ\u00eft un error de sintaxi a ''{0}''."</span><span class="o">},</span></span>
<span id="LC715" class="line" lang="java"></span>
<span id="LC716" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC717" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text is the name of a Java</span></span>
<span id="LC718" class="line" lang="java"><span class="cm">         * class.  The term "constructor" here is the Java term.  The message is</span></span>
<span id="LC719" class="line" lang="java"><span class="cm">         * displayed if XSLTC could not find a constructor for the specified</span></span>
<span id="LC720" class="line" lang="java"><span class="cm">         * class.</span></span>
<span id="LC721" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC722" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">CONSTRUCTOR_NOT_FOUND</span><span class="o">,</span></span>
<span id="LC723" class="line" lang="java">        <span class="s">"No s''ha trobat el constructor extern ''{0}''."</span><span class="o">},</span></span>
<span id="LC724" class="line" lang="java"></span>
<span id="LC725" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC726" class="line" lang="java"><span class="cm">         * Note to translators:  "static" is the Java keyword.  The substitution</span></span>
<span id="LC727" class="line" lang="java"><span class="cm">         * text is the name of a function.  The first argument of that function</span></span>
<span id="LC728" class="line" lang="java"><span class="cm">         * is not of the required type.</span></span>
<span id="LC729" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC730" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">NO_JAVA_FUNCT_THIS_REF</span><span class="o">,</span></span>
<span id="LC731" class="line" lang="java">        <span class="s">"El primer argument de la funci\u00f3 Java no static ''{0}'' no \u00e9s una refer\u00e8ncia d''objecte v\u00e0lida."</span><span class="o">},</span></span>
<span id="LC732" class="line" lang="java"></span>
<span id="LC733" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC734" class="line" lang="java"><span class="cm">         * Note to translators:  An XPath expression was not of the type</span></span>
<span id="LC735" class="line" lang="java"><span class="cm">         * required in a particular context.  The substitution text is the</span></span>
<span id="LC736" class="line" lang="java"><span class="cm">         * expression that was in error.</span></span>
<span id="LC737" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC738" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TYPE_CHECK_ERR</span><span class="o">,</span></span>
<span id="LC739" class="line" lang="java">        <span class="s">"S''ha produ\u00eft un error en comprovar el tipus de l''expressi\u00f3 ''{0}''."</span><span class="o">},</span></span>
<span id="LC740" class="line" lang="java"></span>
<span id="LC741" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC742" class="line" lang="java"><span class="cm">         * Note to translators:  An XPath expression was not of the type</span></span>
<span id="LC743" class="line" lang="java"><span class="cm">         * required in a particular context.  However, the location of the</span></span>
<span id="LC744" class="line" lang="java"><span class="cm">         * problematic expression is unknown.</span></span>
<span id="LC745" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC746" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TYPE_CHECK_UNK_LOC_ERR</span><span class="o">,</span></span>
<span id="LC747" class="line" lang="java">        <span class="s">"S'ha produ\u00eft un error en comprovar el tipus d'expressi\u00f3 en una ubicaci\u00f3 desconeguda."</span><span class="o">},</span></span>
<span id="LC748" class="line" lang="java"></span>
<span id="LC749" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC750" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text is the name of a command-</span></span>
<span id="LC751" class="line" lang="java"><span class="cm">         * line option that was not recognized.</span></span>
<span id="LC752" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC753" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_CMDLINE_OPTION_ERR</span><span class="o">,</span></span>
<span id="LC754" class="line" lang="java">        <span class="s">"L''opci\u00f3 de l\u00ednia d''ordres ''{0}'' no \u00e9s v\u00e0lida."</span><span class="o">},</span></span>
<span id="LC755" class="line" lang="java"></span>
<span id="LC756" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC757" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text is the name of a command-</span></span>
<span id="LC758" class="line" lang="java"><span class="cm">         * line option.</span></span>
<span id="LC759" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC760" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">CMDLINE_OPT_MISSING_ARG_ERR</span><span class="o">,</span></span>
<span id="LC761" class="line" lang="java">        <span class="s">"A l''opci\u00f3 de l\u00ednia d''ordres ''{0}'' li falta un argument obligatori."</span><span class="o">},</span></span>
<span id="LC762" class="line" lang="java"></span>
<span id="LC763" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC764" class="line" lang="java"><span class="cm">         * Note to translators:  This message is used to indicate the severity</span></span>
<span id="LC765" class="line" lang="java"><span class="cm">         * of another message.  The substitution text contains two error</span></span>
<span id="LC766" class="line" lang="java"><span class="cm">         * messages.  The spacing before the second substitution text indents</span></span>
<span id="LC767" class="line" lang="java"><span class="cm">         * it the same amount as the first in English.</span></span>
<span id="LC768" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC769" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">WARNING_PLUS_WRAPPED_MSG</span><span class="o">,</span></span>
<span id="LC770" class="line" lang="java">        <span class="s">"AV\u00cdS: ''{0}''\n       :{1}"</span><span class="o">},</span></span>
<span id="LC771" class="line" lang="java"></span>
<span id="LC772" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC773" class="line" lang="java"><span class="cm">         * Note to translators:  This message is used to indicate the severity</span></span>
<span id="LC774" class="line" lang="java"><span class="cm">         * of another message.  The substitution text is an error message.</span></span>
<span id="LC775" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC776" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">WARNING_MSG</span><span class="o">,</span></span>
<span id="LC777" class="line" lang="java">        <span class="s">"AV\u00cdS: ''{0}''"</span><span class="o">},</span></span>
<span id="LC778" class="line" lang="java"></span>
<span id="LC779" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC780" class="line" lang="java"><span class="cm">         * Note to translators:  This message is used to indicate the severity</span></span>
<span id="LC781" class="line" lang="java"><span class="cm">         * of another message.  The substitution text contains two error</span></span>
<span id="LC782" class="line" lang="java"><span class="cm">         * messages.  The spacing before the second substitution text indents</span></span>
<span id="LC783" class="line" lang="java"><span class="cm">         * it the same amount as the first in English.</span></span>
<span id="LC784" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC785" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">FATAL_ERR_PLUS_WRAPPED_MSG</span><span class="o">,</span></span>
<span id="LC786" class="line" lang="java">        <span class="s">"ERROR MOLT GREU: ''{0}''\n           :{1}"</span><span class="o">},</span></span>
<span id="LC787" class="line" lang="java"></span>
<span id="LC788" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC789" class="line" lang="java"><span class="cm">         * Note to translators:  This message is used to indicate the severity</span></span>
<span id="LC790" class="line" lang="java"><span class="cm">         * of another message.  The substitution text is an error message.</span></span>
<span id="LC791" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC792" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">FATAL_ERR_MSG</span><span class="o">,</span></span>
<span id="LC793" class="line" lang="java">        <span class="s">"ERROR MOLT GREU: ''{0}''"</span><span class="o">},</span></span>
<span id="LC794" class="line" lang="java"></span>
<span id="LC795" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC796" class="line" lang="java"><span class="cm">         * Note to translators:  This message is used to indicate the severity</span></span>
<span id="LC797" class="line" lang="java"><span class="cm">         * of another message.  The substitution text contains two error</span></span>
<span id="LC798" class="line" lang="java"><span class="cm">         * messages.  The spacing before the second substitution text indents</span></span>
<span id="LC799" class="line" lang="java"><span class="cm">         * it the same amount as the first in English.</span></span>
<span id="LC800" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC801" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ERROR_PLUS_WRAPPED_MSG</span><span class="o">,</span></span>
<span id="LC802" class="line" lang="java">        <span class="s">"ERROR:  ''{0}''\n     :{1}"</span><span class="o">},</span></span>
<span id="LC803" class="line" lang="java"></span>
<span id="LC804" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC805" class="line" lang="java"><span class="cm">         * Note to translators:  This message is used to indicate the severity</span></span>
<span id="LC806" class="line" lang="java"><span class="cm">         * of another message.  The substitution text is an error message.</span></span>
<span id="LC807" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC808" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ERROR_MSG</span><span class="o">,</span></span>
<span id="LC809" class="line" lang="java">        <span class="s">"ERROR:  ''{0}''"</span><span class="o">},</span></span>
<span id="LC810" class="line" lang="java"></span>
<span id="LC811" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC812" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text is the name of a class.</span></span>
<span id="LC813" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC814" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TRANSFORM_WITH_TRANSLET_STR</span><span class="o">,</span></span>
<span id="LC815" class="line" lang="java">        <span class="s">"Transformaci\u00f3 mitjan\u00e7ant translet ''{0}'' "</span><span class="o">},</span></span>
<span id="LC816" class="line" lang="java"></span>
<span id="LC817" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC818" class="line" lang="java"><span class="cm">         * Note to translators:  The first substitution is the name of a class,</span></span>
<span id="LC819" class="line" lang="java"><span class="cm">         * while the second substitution is the name of a jar file.</span></span>
<span id="LC820" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC821" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TRANSFORM_WITH_JAR_STR</span><span class="o">,</span></span>
<span id="LC822" class="line" lang="java">        <span class="s">"Transformaci\u00f3 mitjan\u00e7ant translet ''{0}'' des del fitxer jar ''{1}''"</span><span class="o">},</span></span>
<span id="LC823" class="line" lang="java"></span>
<span id="LC824" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC825" class="line" lang="java"><span class="cm">         * Note to translators:  "TransformerFactory" is the name of a Java</span></span>
<span id="LC826" class="line" lang="java"><span class="cm">         * interface and must not be translated.  The substitution text is</span></span>
<span id="LC827" class="line" lang="java"><span class="cm">         * the name of the class that could not be instantiated.</span></span>
<span id="LC828" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC829" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">COULD_NOT_CREATE_TRANS_FACT</span><span class="o">,</span></span>
<span id="LC830" class="line" lang="java">        <span class="s">"No s''ha pogut crear una inst\u00e0ncia de la classe TransformerFactory ''{0}''."</span><span class="o">},</span></span>
<span id="LC831" class="line" lang="java"></span>
<span id="LC832" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC833" class="line" lang="java"><span class="cm">         * Note to translators:  The following message is used as a header.</span></span>
<span id="LC834" class="line" lang="java"><span class="cm">         * All the error messages are collected together and displayed beneath</span></span>
<span id="LC835" class="line" lang="java"><span class="cm">         * this message.</span></span>
<span id="LC836" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC837" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">COMPILER_ERROR_KEY</span><span class="o">,</span></span>
<span id="LC838" class="line" lang="java">        <span class="s">"Errors del compilador:"</span><span class="o">},</span></span>
<span id="LC839" class="line" lang="java"></span>
<span id="LC840" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC841" class="line" lang="java"><span class="cm">         * Note to translators:  The following message is used as a header.</span></span>
<span id="LC842" class="line" lang="java"><span class="cm">         * All the warning messages are collected together and displayed</span></span>
<span id="LC843" class="line" lang="java"><span class="cm">         * beneath this message.</span></span>
<span id="LC844" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC845" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">COMPILER_WARNING_KEY</span><span class="o">,</span></span>
<span id="LC846" class="line" lang="java">        <span class="s">"Avisos del compilador:"</span><span class="o">},</span></span>
<span id="LC847" class="line" lang="java"></span>
<span id="LC848" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC849" class="line" lang="java"><span class="cm">         * Note to translators:  The following message is used as a header.</span></span>
<span id="LC850" class="line" lang="java"><span class="cm">         * All the error messages that are produced when the stylesheet is</span></span>
<span id="LC851" class="line" lang="java"><span class="cm">         * applied to an input document are collected together and displayed</span></span>
<span id="LC852" class="line" lang="java"><span class="cm">         * beneath this message.  A 'translet' is the compiled form of a</span></span>
<span id="LC853" class="line" lang="java"><span class="cm">         * stylesheet (see above).</span></span>
<span id="LC854" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC855" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">RUNTIME_ERROR_KEY</span><span class="o">,</span></span>
<span id="LC856" class="line" lang="java">        <span class="s">"Errors de translet:"</span><span class="o">},</span></span>
<span id="LC857" class="line" lang="java"></span>
<span id="LC858" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_SECUREPROCESSING_FEATURE</span><span class="o">,</span></span>
<span id="LC859" class="line" lang="java">        <span class="s">"FEATURE_SECURE_PROCESSING: Cannot set the feature to false when security manager is present."</span><span class="o">}</span></span>
