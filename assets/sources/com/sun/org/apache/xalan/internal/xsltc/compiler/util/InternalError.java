...
<span id="LC22" class="line" lang="java"><span class="cm"> * $Id: InternalError.java,v 1.0 2011-08-18 04:34:19 joehw Exp $</span></span>
...
<span id="LC26" class="line" lang="java"><span class="cm"> * Marks a class of errors in which XSLTC has reached some incorrect internal</span></span>
<span id="LC27" class="line" lang="java"><span class="cm"> * state from which it cannot recover.</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC29" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">InternalError</span> <span class="kd">extends</span> <span class="nc">Error</span> <span class="o">{</span></span>
<span id="LC30" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC31" class="line" lang="java"><span class="cm">     * Construct an &lt;code&gt;InternalError&lt;/code&gt; with the specified error message.</span></span>
<span id="LC32" class="line" lang="java"><span class="cm">     * @param msg the error message</span></span>
<span id="LC33" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC34" class="line" lang="java">    <span class="kd">public</span> <span class="nf">InternalError</span><span class="o">(</span><span class="nc">String</span> <span class="n">msg</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC35" class="line" lang="java">        <span class="kd">super</span><span class="o">(</span><span class="n">msg</span><span class="o">);</span></span>
