...
<span id="LC28" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">ErrorMessages_it</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span> <span class="o">{</span></span>
...
<span id="LC98" class="line" lang="java">        <span class="s">"Sono stati definiti pi\u00F9 fogli di stile nello stesso file."</span><span class="o">},</span></span>
...
<span id="LC106" class="line" lang="java">        <span class="s">"Il modello ''{0}'' \u00E8 gi\u00E0 stato definito in questo foglio di stile."</span><span class="o">},</span></span>
...
<span id="LC115" class="line" lang="java">        <span class="s">"Il modello ''{0}'' non \u00E8 stato definito in questo foglio di stile."</span><span class="o">},</span></span>
...
<span id="LC122" class="line" lang="java">        <span class="s">"La variabile ''{0}'' \u00E8 stata definita pi\u00F9 volte nello stesso ambito."</span><span class="o">},</span></span>
...
<span id="LC130" class="line" lang="java">        <span class="s">"Variabile o parametro ''{0}'' non definito."</span><span class="o">},</span></span>
...
<span id="LC138" class="line" lang="java">        <span class="s">"Impossibile trovare la classe \"{0}\"."</span><span class="o">},</span></span>
...
<span id="LC147" class="line" lang="java">        <span class="s">"Impossibile trovare il metodo esterno ''{0}'' (deve essere pubblico)."</span><span class="o">},</span></span>
...
<span id="LC156" class="line" lang="java">        <span class="s">"Impossibile convertire l''argomento o il tipo restituito in una chiamata per il metodo ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC163" class="line" lang="java">        <span class="s">"File o URI ''{0}'' non trovato."</span><span class="o">},</span></span>
...
<span id="LC170" class="line" lang="java">        <span class="s">"URI ''{0}'' non valido."</span><span class="o">},</span></span>
...
<span id="LC177" class="line" lang="java">        <span class="s">"Impossibile aprire il file o l''URI ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC184" class="line" lang="java">        <span class="s">"\u00C8 previsto un elemento &lt;xsl:stylesheet&gt; o &lt;xsl:transform&gt;."</span><span class="o">},</span></span>
...
<span id="LC192" class="line" lang="java">        <span class="s">"Prefisso spazio di nomi ''{0}'' non dichiarato."</span><span class="o">},</span></span>
...
<span id="LC199" class="line" lang="java">        <span class="s">"Impossibile risolvere la chiamata per la funzione ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC206" class="line" lang="java">        <span class="s">"L''argomento per ''{0}'' deve essere una stringa di valori."</span><span class="o">},</span></span>
...
<span id="LC214" class="line" lang="java">        <span class="s">"Errore durante l''analisi dell''espressione XPath ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC222" class="line" lang="java">        <span class="s">"Attributo obbligatorio ''{0}'' mancante."</span><span class="o">},</span></span>
...
<span id="LC230" class="line" lang="java">        <span class="s">"Carattere ''{0}'' non valido nell''espressione XPath."</span><span class="o">},</span></span>
...
<span id="LC239" class="line" lang="java">        <span class="s">"Nome ''{0}'' non valido per l''istruzione di elaborazione."</span><span class="o">},</span></span>
...
<span id="LC248" class="line" lang="java">        <span class="s">"Attributo ''{0}'' al di fuori dell''elemento."</span><span class="o">},</span></span>
...
<span id="LC257" class="line" lang="java">        <span class="s">"Attributo ''{0}'' non valido."</span><span class="o">},</span></span>
...
<span id="LC266" class="line" lang="java">        <span class="s">"Importazione/inclusione circolare. Il foglio di stile ''{0}'' \u00E8 gi\u00E0 stato caricato."</span><span class="o">},</span></span>
...
<span id="LC274" class="line" lang="java">        <span class="s">"Impossibile ordinare i frammenti della struttura di risultati (gli elementi &lt;xsl:sort&gt; verranno ignorati). \u00C8 necessario ordinare i nodi quando si crea la struttura di risultati."</span><span class="o">},</span></span>
...
<span id="LC282" class="line" lang="java">        <span class="s">"Formattazione decimale ''{0}'' gi\u00E0 definita."</span><span class="o">},</span></span>
...
<span id="LC289" class="line" lang="java">        <span class="s">"La versione XSL ''{0}'' non \u00E8 supportata da XSLTC."</span><span class="o">},</span></span>
...
<span id="LC296" class="line" lang="java">        <span class="s">"Riferimento di variabile/parametro circolare in ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC303" class="line" lang="java">        <span class="s">"Operatore sconosciuto per l'espressione binaria."</span><span class="o">},</span></span>
...
<span id="LC310" class="line" lang="java">        <span class="s">"Uno o pi\u00F9 argomenti non validi per la chiamata della funzione."</span><span class="o">},</span></span>
...
<span id="LC318" class="line" lang="java">        <span class="s">"Il secondo argomento per la funzione document() deve essere un set di nodi."</span><span class="o">},</span></span>
...
<span id="LC326" class="line" lang="java">        <span class="s">"\u00C8 richiesto almeno un elemento &lt;xsl:when&gt; in &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC334" class="line" lang="java">        <span class="s">"\u00C8 consentito un solo elemento &lt;xsl:otherwise&gt; in &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC342" class="line" lang="java">        <span class="s">"&lt;xsl:otherwise&gt; pu\u00F2 essere utilizzato sono in &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC350" class="line" lang="java">        <span class="s">"&lt;xsl:when&gt; pu\u00F2 essere utilizzato sono in &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC358" class="line" lang="java">        <span class="s">"Sono consentiti solo elementi &lt;xsl:when&gt; e &lt;xsl:otherwise&gt; in &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
...
<span id="LC365" class="line" lang="java">        <span class="s">"&lt;xsl:attribute-set&gt; mancante nell'attributo 'name'."</span><span class="o">},</span></span>
...
<span id="LC372" class="line" lang="java">        <span class="s">"Elemento figlio non valido."</span><span class="o">},</span></span>
...
<span id="LC380" class="line" lang="java">        <span class="s">"Impossibile richiamare un elemento ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC388" class="line" lang="java">        <span class="s">"Impossibile richiamare un attributo ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC398" class="line" lang="java">        <span class="s">"I dati di testo non rientrano nell'elemento &lt;xsl:stylesheet&gt; di livello superiore."</span><span class="o">},</span></span>
...
<span id="LC406" class="line" lang="java">        <span class="s">"Parser JAXP non configurato correttamente"</span><span class="o">},</span></span>
...
<span id="LC413" class="line" lang="java">        <span class="s">"Errore interno XSLTC irreversibile: ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC421" class="line" lang="java">        <span class="s">"Elemento XSL \"{0}\" non supportato."</span><span class="o">},</span></span>
...
<span id="LC430" class="line" lang="java">        <span class="s">"Estensione XSLTC ''{0}'' non riconosciuta."</span><span class="o">},</span></span>
...
<span id="LC440" class="line" lang="java">        <span class="s">"Il documento di input non \u00E8 un foglio di stile (spazio di nomi XSL non dichiarato nell'elemento radice)."</span><span class="o">},</span></span>
...
<span id="LC447" class="line" lang="java">        <span class="s">"Impossibile trovare la destinazione ''{0}'' del foglio di stile."</span><span class="o">},</span></span>
...
<span id="LC453" class="line" lang="java">        <span class="s">"Impossibile leggere la destinazione del foglio di stile ''{0}''. Accesso ''{1}'' non consentito a causa della limitazione definita dalla propriet\u00E0 accessExternalStylesheet."</span><span class="o">},</span></span>
...
<span id="LC461" class="line" lang="java">        <span class="s">"Non implementato: ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC468" class="line" lang="java">        <span class="s">"Il documento di input non contiene un foglio di stile XSL."</span><span class="o">},</span></span>
...
<span id="LC475" class="line" lang="java">        <span class="s">"Impossibile analizzare l''elemento ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC484" class="line" lang="java">        <span class="s">"L'attributo di uso &lt;key&gt; deve essere un nodo, un set di nodi, una stringa o un numero."</span><span class="o">},</span></span>
...
<span id="LC492" class="line" lang="java">        <span class="s">"La versione del documento XML di output deve essere 1.0"</span><span class="o">},</span></span>
...
<span id="LC499" class="line" lang="java">        <span class="s">"Operatore sconosciuto per l'espressione relazionale"</span><span class="o">},</span></span>
...
<span id="LC509" class="line" lang="java">        <span class="s">"Tentativo di utilizzare un set di attributi ''{0}'' inesistente."</span><span class="o">},</span></span>
...
<span id="LC519" class="line" lang="java">        <span class="s">"Impossibile analizzare il modello di valore di attributo ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC525" class="line" lang="java">        <span class="s">"Tipo di dati sconosciuto nella firma per la classe ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC534" class="line" lang="java">        <span class="s">"Impossibile convertire il tipo di dati ''{0}'' in ''{1}''."</span><span class="o">},</span></span>
...
<span id="LC541" class="line" lang="java">        <span class="s">"Il modello non contiene una definizione di classe di translet valida."</span><span class="o">},</span></span>
...
<span id="LC548" class="line" lang="java">        <span class="s">"Il modello non contiene una classe denominata ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC554" class="line" lang="java">        <span class="s">"Impossibile caricare la classe di translet ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC557" class="line" lang="java">        <span class="s">"La classe di translet \u00E8 stata caricata, ma non \u00E8 possibile creare l'istanza del translet."</span><span class="o">},</span></span>
...
<span id="LC566" class="line" lang="java">        <span class="s">"Tentativo di impostare ErrorListener per ''{0}'' su null"</span><span class="o">},</span></span>
...
<span id="LC573" class="line" lang="java">        <span class="s">"XSLTC supporta solo StreamSource, SAXSource e DOMSource."</span><span class="o">},</span></span>
...
<span id="LC580" class="line" lang="java">        <span class="s">"L''oggetto di origine passato a ''{0}'' non ha contenuti."</span><span class="o">},</span></span>
...
<span id="LC587" class="line" lang="java">        <span class="s">"Impossibile compilare il foglio di stile"</span><span class="o">},</span></span>
...
<span id="LC598" class="line" lang="java">        <span class="s">"TransformerFactory non riconosce l''attributo ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC601" class="line" lang="java">        <span class="s">"Valore errato specificato per l''attributo ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC608" class="line" lang="java">        <span class="s">"setResult() deve essere richiamato prima di startDocument()."</span><span class="o">},</span></span>
...
<span id="LC618" class="line" lang="java">        <span class="s">"Il trasformatore non contiene alcun oggetto incapsulato."</span><span class="o">},</span></span>
...
<span id="LC626" class="line" lang="java">        <span class="s">"Nessun handler di output definito per il risultato della trasformazione."</span><span class="o">},</span></span>
...
<span id="LC633" class="line" lang="java">        <span class="s">"L''oggetto di risultato passato a ''{0}'' non \u00E8 valido."</span><span class="o">},</span></span>
...
<span id="LC643" class="line" lang="java">        <span class="s">"Tentativo di accedere a una propriet\u00E0 ''{0}'' del trasformatore non valida."</span><span class="o">},</span></span>
...
<span id="LC651" class="line" lang="java">        <span class="s">"Impossibile creare l''adattatore SAX2DOM ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC658" class="line" lang="java">        <span class="s">"XSLTCSource.build() richiamato senza che sia stato impostato systemId."</span><span class="o">},</span></span>
...
<span id="LC661" class="line" lang="java">            <span class="s">"Il risultato non deve essere nullo"</span><span class="o">},</span></span>
...
<span id="LC668" class="line" lang="java">        <span class="s">"Il valore del parametro {0} deve essere un oggetto Java valido"</span><span class="o">},</span></span>
...
<span id="LC672" class="line" lang="java">        <span class="s">"L'opzione -i deve essere utilizzata con l'opzione -o."</span><span class="o">},</span></span>
...
<span id="LC708" class="line" lang="java">        <span class="s">"&lt;xsl:sort&gt; pu\u00F2 essere utilizzato sono in &lt;xsl:for-each&gt; o &lt;xsl:apply-templates&gt;."</span><span class="o">},</span></span>
...
<span id="LC717" class="line" lang="java">        <span class="s">"La codifica di output ''{0}'' non \u00E8 supportata in questa JVM."</span><span class="o">},</span></span>
...
<span id="LC724" class="line" lang="java">        <span class="s">"Errore di sintassi in ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC733" class="line" lang="java">        <span class="s">"Impossibile trovare il costruttore esterno ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC741" class="line" lang="java">        <span class="s">"Il primo argomento per la funzione Java non statica ''{0}'' non \u00E8 un riferimento di oggetto valido."</span><span class="o">},</span></span>
...
<span id="LC749" class="line" lang="java">        <span class="s">"Errore durante il controllo del tipo dell''espressione ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC757" class="line" lang="java">        <span class="s">"Errore durante il controllo del tipo di un''espressione in una posizione sconosciuta."</span><span class="o">},</span></span>
...
<span id="LC764" class="line" lang="java">        <span class="s">"L''opzione di riga di comando ''{0}'' non \u00E8 valida."</span><span class="o">},</span></span>
...
<span id="LC771" class="line" lang="java">        <span class="s">"Nell''opzione di riga di comando ''{0}'' manca un argomento obbligatorio."</span><span class="o">},</span></span>
...
<span id="LC825" class="line" lang="java">        <span class="s">"Trasformazione mediante il translet ''{0}'' "</span><span class="o">},</span></span>
...
<span id="LC832" class="line" lang="java">        <span class="s">"Trasformazione mediante il translet ''{0}'' del file jar ''{1}''"</span><span class="o">},</span></span>
...
<span id="LC840" class="line" lang="java">        <span class="s">"Impossibile creare un''istanza della classe TransformerFactory ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC850" class="line" lang="java">         <span class="s">"Impossibile utilizzare il nome ''{0}'' per la classe di translet poich\u00E9 contiene caratteri non consentiti nel nome della classe Java. Verr\u00E0 utilizzato il nome ''{1}''."</span><span class="o">},</span></span>
...
<span id="LC858" class="line" lang="java">        <span class="s">"Errori del compilatore:"</span><span class="o">},</span></span>
...
<span id="LC866" class="line" lang="java">        <span class="s">"Avvertenze del compilatore:"</span><span class="o">},</span></span>
...
<span id="LC876" class="line" lang="java">        <span class="s">"Errori del translet:"</span><span class="o">},</span></span>
...
<span id="LC885" class="line" lang="java">        <span class="s">"Un attributo il cui valore deve essere un QName o una lista separata da spazi di QName contiene il valore ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC894" class="line" lang="java">        <span class="s">"Un attributo il cui valore deve essere un NCName contiene il valore ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC907" class="line" lang="java">        <span class="s">"L''attributo di metodo per un elemento &lt;xsl:output&gt; ha il valore ''{0}'', ma deve essere uno tra ''xml'', ''html'', ''text'' o qname-but-not-ncname"</span><span class="o">},</span></span>
...
<span id="LC910" class="line" lang="java">        <span class="s">"Il nome funzione non pu\u00F2 essere nullo in TransformerFactory.getFeature (nome stringa)."</span><span class="o">},</span></span>
...
<span id="LC913" class="line" lang="java">        <span class="s">"Il nome funzione non pu\u00F2 essere nullo in TransformerFactory.setFeature (nome stringa, valore booleano)."</span><span class="o">},</span></span>
...
<span id="LC916" class="line" lang="java">        <span class="s">"Impossibile impostare la funzione ''{0}'' in questo TransformerFactory."</span><span class="o">},</span></span>
...
<span id="LC919" class="line" lang="java">        <span class="s">"FEATURE_SECURE_PROCESSING: impossibile impostare la funzione su false se \u00E8 presente Security Manager."</span><span class="o">},</span></span>
...
<span id="LC929" class="line" lang="java">         <span class="s">"Errore XSLTC interno: il bytecode generato contiene un blocco try-catch-finally e non pu\u00F2 essere di tipo outlined."</span><span class="o">},</span></span>
...
<span id="LC942" class="line" lang="java">         <span class="s">"Errore XSLTC interno: gli indicatori OutlineableChunkStart e OutlineableChunkEnd devono essere bilanciati e nidificati correttamente."</span><span class="o">},</span></span>
...
<span id="LC955" class="line" lang="java">         <span class="s">"Errore XSLTC interno: a un'istruzione che faceva parte di un blocco di bytecode di tipo outlined viene ancora fatto riferimento nel metodo originale."</span></span>
