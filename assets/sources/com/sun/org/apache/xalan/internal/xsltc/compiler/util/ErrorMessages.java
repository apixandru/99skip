...
<span id="LC28" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">ErrorMessages</span> <span class="kd">extends</span> <span class="nc">ListResourceBundle</span> <span class="o">{</span></span>
...
<span id="LC98" class="line" lang="java">        <span class="s">"More than one stylesheet defined in the same file."</span><span class="o">},</span></span>
...
<span id="LC106" class="line" lang="java">        <span class="s">"Template ''{0}'' already defined in this stylesheet."</span><span class="o">},</span></span>
...
<span id="LC115" class="line" lang="java">        <span class="s">"Template ''{0}'' not defined in this stylesheet."</span><span class="o">},</span></span>
...
<span id="LC122" class="line" lang="java">        <span class="s">"Variable ''{0}'' is multiply defined in the same scope."</span><span class="o">},</span></span>
...
<span id="LC130" class="line" lang="java">        <span class="s">"Variable or parameter ''{0}'' is undefined."</span><span class="o">},</span></span>
...
<span id="LC138" class="line" lang="java">        <span class="s">"Cannot find class ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC147" class="line" lang="java">        <span class="s">"Cannot find external method ''{0}'' (must be public)."</span><span class="o">},</span></span>
...
<span id="LC156" class="line" lang="java">        <span class="s">"Cannot convert argument/return type in call to method ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC163" class="line" lang="java">        <span class="s">"File or URI ''{0}'' not found."</span><span class="o">},</span></span>
...
<span id="LC170" class="line" lang="java">        <span class="s">"Invalid URI ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC177" class="line" lang="java">        <span class="s">"Cannot open file or URI ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC184" class="line" lang="java">        <span class="s">"&lt;xsl:stylesheet&gt; or &lt;xsl:transform&gt; element expected."</span><span class="o">},</span></span>
...
<span id="LC192" class="line" lang="java">        <span class="s">"Namespace prefix ''{0}'' is undeclared."</span><span class="o">},</span></span>
...
<span id="LC199" class="line" lang="java">        <span class="s">"Unable to resolve call to function ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC206" class="line" lang="java">        <span class="s">"Argument to ''{0}'' must be a literal string."</span><span class="o">},</span></span>
...
<span id="LC214" class="line" lang="java">        <span class="s">"Error parsing XPath expression ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC222" class="line" lang="java">        <span class="s">"Required attribute ''{0}'' is missing."</span><span class="o">},</span></span>
...
<span id="LC230" class="line" lang="java">        <span class="s">"Illegal character ''{0}'' in XPath expression."</span><span class="o">},</span></span>
...
<span id="LC239" class="line" lang="java">        <span class="s">"Illegal name ''{0}'' for processing instruction."</span><span class="o">},</span></span>
...
<span id="LC248" class="line" lang="java">        <span class="s">"Attribute ''{0}'' outside of element."</span><span class="o">},</span></span>
...
<span id="LC257" class="line" lang="java">        <span class="s">"Illegal attribute ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC266" class="line" lang="java">        <span class="s">"Circular import/include. Stylesheet ''{0}'' already loaded."</span><span class="o">},</span></span>
...
<span id="LC274" class="line" lang="java">        <span class="s">"Result-tree fragments cannot be sorted (&lt;xsl:sort&gt; elements are "</span> <span class="o">+</span></span>
<span id="LC275" class="line" lang="java">        <span class="s">"ignored). You must sort the nodes when creating the result tree."</span><span class="o">},</span></span>
<span id="LC276" class="line" lang="java"></span>
<span id="LC277" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC278" class="line" lang="java"><span class="cm">         * Note to translators:  A name can be given to a particular style to be</span></span>
<span id="LC279" class="line" lang="java"><span class="cm">         * used to format decimal values.  The substitution text gives the name</span></span>
<span id="LC280" class="line" lang="java"><span class="cm">         * of such a style for which more than one declaration was encountered.</span></span>
<span id="LC281" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC282" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">SYMBOLS_REDEF_ERR</span><span class="o">,</span></span>
<span id="LC283" class="line" lang="java">        <span class="s">"Decimal formatting ''{0}'' is already defined."</span><span class="o">},</span></span>
<span id="LC284" class="line" lang="java"></span>
<span id="LC285" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC286" class="line" lang="java"><span class="cm">         * Note to translators:  The stylesheet version named in the</span></span>
<span id="LC287" class="line" lang="java"><span class="cm">         * substitution text is not supported.</span></span>
<span id="LC288" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC289" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">XSL_VERSION_ERR</span><span class="o">,</span></span>
<span id="LC290" class="line" lang="java">        <span class="s">"XSL version ''{0}'' is not supported by XSLTC."</span><span class="o">},</span></span>
<span id="LC291" class="line" lang="java"></span>
<span id="LC292" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC293" class="line" lang="java"><span class="cm">         * Note to translators:  The definitions of one or more variables or</span></span>
<span id="LC294" class="line" lang="java"><span class="cm">         * parameters depend on one another.</span></span>
<span id="LC295" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC296" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">CIRCULAR_VARIABLE_ERR</span><span class="o">,</span></span>
<span id="LC297" class="line" lang="java">        <span class="s">"Circular variable/parameter reference in ''{0}''."</span><span class="o">},</span></span>
<span id="LC298" class="line" lang="java"></span>
<span id="LC299" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC300" class="line" lang="java"><span class="cm">         * Note to translators:  The operator in an expresion with two operands was</span></span>
<span id="LC301" class="line" lang="java"><span class="cm">         * not recognized.</span></span>
<span id="LC302" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC303" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_BINARY_OP_ERR</span><span class="o">,</span></span>
<span id="LC304" class="line" lang="java">        <span class="s">"Unknown operator for binary expression."</span><span class="o">},</span></span>
<span id="LC305" class="line" lang="java"></span>
<span id="LC306" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC307" class="line" lang="java"><span class="cm">         * Note to translators:  This message is produced if a reference to a</span></span>
<span id="LC308" class="line" lang="java"><span class="cm">         * function has too many or too few arguments.</span></span>
<span id="LC309" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC310" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_ARG_ERR</span><span class="o">,</span></span>
<span id="LC311" class="line" lang="java">        <span class="s">"Illegal argument(s) for function call."</span><span class="o">},</span></span>
<span id="LC312" class="line" lang="java"></span>
<span id="LC313" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC314" class="line" lang="java"><span class="cm">         * Note to translators:  "document()" is the name of function and must</span></span>
<span id="LC315" class="line" lang="java"><span class="cm">         * not be translated.  A node-set is a set of the nodes in the tree</span></span>
<span id="LC316" class="line" lang="java"><span class="cm">         * representation of an XML document.</span></span>
<span id="LC317" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC318" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">DOCUMENT_ARG_ERR</span><span class="o">,</span></span>
<span id="LC319" class="line" lang="java">        <span class="s">"Second argument to document() function must be a node-set."</span><span class="o">},</span></span>
<span id="LC320" class="line" lang="java"></span>
<span id="LC321" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC322" class="line" lang="java"><span class="cm">         * Note to translators:  "&lt;xsl:when&gt;" and "&lt;xsl:choose&gt;" are keywords</span></span>
<span id="LC323" class="line" lang="java"><span class="cm">         * and should not be translated.  This message describes a syntax error</span></span>
<span id="LC324" class="line" lang="java"><span class="cm">         * in the stylesheet.</span></span>
<span id="LC325" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC326" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">MISSING_WHEN_ERR</span><span class="o">,</span></span>
<span id="LC327" class="line" lang="java">        <span class="s">"At least one &lt;xsl:when&gt; element required in &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
<span id="LC328" class="line" lang="java"></span>
<span id="LC329" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC330" class="line" lang="java"><span class="cm">         * Note to translators:  "&lt;xsl:otherwise&gt;" and "&lt;xsl:choose&gt;" are</span></span>
<span id="LC331" class="line" lang="java"><span class="cm">         * keywords and should not be translated.  This message describes a</span></span>
<span id="LC332" class="line" lang="java"><span class="cm">         * syntax error in the stylesheet.</span></span>
<span id="LC333" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC334" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">MULTIPLE_OTHERWISE_ERR</span><span class="o">,</span></span>
<span id="LC335" class="line" lang="java">        <span class="s">"Only one &lt;xsl:otherwise&gt; element allowed in &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
<span id="LC336" class="line" lang="java"></span>
<span id="LC337" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC338" class="line" lang="java"><span class="cm">         * Note to translators:  "&lt;xsl:otherwise&gt;" and "&lt;xsl:choose&gt;" are</span></span>
<span id="LC339" class="line" lang="java"><span class="cm">         * keywords and should not be translated.  This message describes a</span></span>
<span id="LC340" class="line" lang="java"><span class="cm">         * syntax error in the stylesheet.</span></span>
<span id="LC341" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC342" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">STRAY_OTHERWISE_ERR</span><span class="o">,</span></span>
<span id="LC343" class="line" lang="java">        <span class="s">"&lt;xsl:otherwise&gt; can only be used within &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
<span id="LC344" class="line" lang="java"></span>
<span id="LC345" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC346" class="line" lang="java"><span class="cm">         * Note to translators:  "&lt;xsl:when&gt;" and "&lt;xsl:choose&gt;" are keywords</span></span>
<span id="LC347" class="line" lang="java"><span class="cm">         * and should not be translated.  This message describes a syntax error</span></span>
<span id="LC348" class="line" lang="java"><span class="cm">         * in the stylesheet.</span></span>
<span id="LC349" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC350" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">STRAY_WHEN_ERR</span><span class="o">,</span></span>
<span id="LC351" class="line" lang="java">        <span class="s">"&lt;xsl:when&gt; can only be used within &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
<span id="LC352" class="line" lang="java"></span>
<span id="LC353" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC354" class="line" lang="java"><span class="cm">         * Note to translators:  "&lt;xsl:when&gt;", "&lt;xsl:otherwise&gt;" and</span></span>
<span id="LC355" class="line" lang="java"><span class="cm">         * "&lt;xsl:choose&gt;" are keywords and should not be translated.  This</span></span>
<span id="LC356" class="line" lang="java"><span class="cm">         * message describes a syntax error in the stylesheet.</span></span>
<span id="LC357" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC358" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">WHEN_ELEMENT_ERR</span><span class="o">,</span></span>
<span id="LC359" class="line" lang="java">        <span class="s">"Only &lt;xsl:when&gt; and &lt;xsl:otherwise&gt; elements allowed in &lt;xsl:choose&gt;."</span><span class="o">},</span></span>
<span id="LC360" class="line" lang="java"></span>
<span id="LC361" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC362" class="line" lang="java"><span class="cm">         * Note to translators:  "&lt;xsl:attribute-set&gt;" and "name" are keywords</span></span>
<span id="LC363" class="line" lang="java"><span class="cm">         * that should not be translated.</span></span>
<span id="LC364" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC365" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">UNNAMED_ATTRIBSET_ERR</span><span class="o">,</span></span>
<span id="LC366" class="line" lang="java">        <span class="s">"&lt;xsl:attribute-set&gt; is missing the 'name' attribute."</span><span class="o">},</span></span>
<span id="LC367" class="line" lang="java"></span>
<span id="LC368" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC369" class="line" lang="java"><span class="cm">         * Note to translators:  An element in the stylesheet contained an</span></span>
<span id="LC370" class="line" lang="java"><span class="cm">         * element of a type that it was not permitted to contain.</span></span>
<span id="LC371" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC372" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_CHILD_ERR</span><span class="o">,</span></span>
<span id="LC373" class="line" lang="java">        <span class="s">"Illegal child element."</span><span class="o">},</span></span>
<span id="LC374" class="line" lang="java"></span>
<span id="LC375" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC376" class="line" lang="java"><span class="cm">         * Note to translators:  The stylesheet tried to create an element with</span></span>
<span id="LC377" class="line" lang="java"><span class="cm">         * a name that was not a valid XML name.  The substitution text contains</span></span>
<span id="LC378" class="line" lang="java"><span class="cm">         * the name.</span></span>
<span id="LC379" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC380" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_ELEM_NAME_ERR</span><span class="o">,</span></span>
<span id="LC381" class="line" lang="java">        <span class="s">"You cannot call an element ''{0}''"</span><span class="o">},</span></span>
<span id="LC382" class="line" lang="java"></span>
<span id="LC383" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC384" class="line" lang="java"><span class="cm">         * Note to translators:  The stylesheet tried to create an attribute</span></span>
<span id="LC385" class="line" lang="java"><span class="cm">         * with a name that was not a valid XML name.  The substitution text</span></span>
<span id="LC386" class="line" lang="java"><span class="cm">         * contains the name.</span></span>
<span id="LC387" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC388" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_ATTR_NAME_ERR</span><span class="o">,</span></span>
<span id="LC389" class="line" lang="java">        <span class="s">"You cannot call an attribute ''{0}''"</span><span class="o">},</span></span>
<span id="LC390" class="line" lang="java"></span>
<span id="LC391" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC392" class="line" lang="java"><span class="cm">         * Note to translators:  The children of the outermost element of a</span></span>
<span id="LC393" class="line" lang="java"><span class="cm">         * stylesheet are referred to as top-level elements.  No text should</span></span>
<span id="LC394" class="line" lang="java"><span class="cm">         * occur within that outermost element unless it is within a top-level</span></span>
<span id="LC395" class="line" lang="java"><span class="cm">         * element.  This message indicates that that constraint was violated.</span></span>
<span id="LC396" class="line" lang="java"><span class="cm">         * "&lt;xsl:stylesheet&gt;" is a keyword that should not be translated.</span></span>
<span id="LC397" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC398" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_TEXT_NODE_ERR</span><span class="o">,</span></span>
<span id="LC399" class="line" lang="java">        <span class="s">"Text data outside of top-level &lt;xsl:stylesheet&gt; element."</span><span class="o">},</span></span>
<span id="LC400" class="line" lang="java"></span>
<span id="LC401" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC402" class="line" lang="java"><span class="cm">         * Note to translators:  JAXP is an acronym for the Java API for XML</span></span>
<span id="LC403" class="line" lang="java"><span class="cm">         * Processing.  This message indicates that the XML parser provided to</span></span>
<span id="LC404" class="line" lang="java"><span class="cm">         * XSLTC to process the XML input document had a configuration problem.</span></span>
<span id="LC405" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC406" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">SAX_PARSER_CONFIG_ERR</span><span class="o">,</span></span>
<span id="LC407" class="line" lang="java">        <span class="s">"JAXP parser not configured correctly"</span><span class="o">},</span></span>
<span id="LC408" class="line" lang="java"></span>
<span id="LC409" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC410" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text names the internal error</span></span>
<span id="LC411" class="line" lang="java"><span class="cm">         * encountered.</span></span>
<span id="LC412" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC413" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">INTERNAL_ERR</span><span class="o">,</span></span>
<span id="LC414" class="line" lang="java">        <span class="s">"Unrecoverable XSLTC-internal error: ''{0}''"</span><span class="o">},</span></span>
<span id="LC415" class="line" lang="java"></span>
<span id="LC416" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC417" class="line" lang="java"><span class="cm">         * Note to translators:  The stylesheet contained an element that was</span></span>
<span id="LC418" class="line" lang="java"><span class="cm">         * not recognized as part of the XSL syntax.  The substitution text</span></span>
<span id="LC419" class="line" lang="java"><span class="cm">         * gives the element name.</span></span>
<span id="LC420" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC421" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">UNSUPPORTED_XSL_ERR</span><span class="o">,</span></span>
<span id="LC422" class="line" lang="java">        <span class="s">"Unsupported XSL element ''{0}''."</span><span class="o">},</span></span>
<span id="LC423" class="line" lang="java"></span>
<span id="LC424" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC425" class="line" lang="java"><span class="cm">         * Note to translators:  The stylesheet referred to an extension to the</span></span>
<span id="LC426" class="line" lang="java"><span class="cm">         * XSL syntax and indicated that it was defined by XSLTC, but XSTLC does</span></span>
<span id="LC427" class="line" lang="java"><span class="cm">         * not recognized the particular extension named.  The substitution text</span></span>
<span id="LC428" class="line" lang="java"><span class="cm">         * gives the extension name.</span></span>
<span id="LC429" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC430" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">UNSUPPORTED_EXT_ERR</span><span class="o">,</span></span>
<span id="LC431" class="line" lang="java">        <span class="s">"Unrecognised XSLTC extension ''{0}''."</span><span class="o">},</span></span>
<span id="LC432" class="line" lang="java"></span>
<span id="LC433" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC434" class="line" lang="java"><span class="cm">         * Note to translators:  The XML document given to XSLTC as a stylesheet</span></span>
<span id="LC435" class="line" lang="java"><span class="cm">         * was not, in fact, a stylesheet.  XSLTC is able to detect that in this</span></span>
<span id="LC436" class="line" lang="java"><span class="cm">         * case because the outermost element in the stylesheet has to be</span></span>
<span id="LC437" class="line" lang="java"><span class="cm">         * declared with respect to the XSL namespace URI, but no declaration</span></span>
<span id="LC438" class="line" lang="java"><span class="cm">         * for that namespace was seen.</span></span>
<span id="LC439" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC440" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">MISSING_XSLT_URI_ERR</span><span class="o">,</span></span>
<span id="LC441" class="line" lang="java">        <span class="s">"The input document is not a stylesheet (the XSL namespace is not "</span><span class="o">+</span></span>
<span id="LC442" class="line" lang="java">        <span class="s">"declared in the root element)."</span><span class="o">},</span></span>
<span id="LC443" class="line" lang="java"></span>
<span id="LC444" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC445" class="line" lang="java"><span class="cm">         * Note to translators:  XSLTC could not find the stylesheet document</span></span>
<span id="LC446" class="line" lang="java"><span class="cm">         * with the name specified by the substitution text.</span></span>
<span id="LC447" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC448" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">MISSING_XSLT_TARGET_ERR</span><span class="o">,</span></span>
<span id="LC449" class="line" lang="java">        <span class="s">"Could not find stylesheet target ''{0}''."</span><span class="o">},</span></span>
<span id="LC450" class="line" lang="java"></span>
<span id="LC451" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC452" class="line" lang="java"><span class="cm">         * Note to translators:  access to the stylesheet target is denied</span></span>
<span id="LC453" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC454" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ACCESSING_XSLT_TARGET_ERR</span><span class="o">,</span></span>
<span id="LC455" class="line" lang="java">        <span class="s">"Could not read stylesheet target ''{0}'', because ''{1}'' access is not allowed due to restriction set by the accessExternalStylesheet property."</span><span class="o">},</span></span>
<span id="LC456" class="line" lang="java"></span>
<span id="LC457" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC458" class="line" lang="java"><span class="cm">         * Note to translators:  This message represents an internal error in</span></span>
<span id="LC459" class="line" lang="java"><span class="cm">         * condition in XSLTC.  The substitution text is the class name in XSLTC</span></span>
<span id="LC460" class="line" lang="java"><span class="cm">         * that is missing some functionality.</span></span>
<span id="LC461" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC462" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">NOT_IMPLEMENTED_ERR</span><span class="o">,</span></span>
<span id="LC463" class="line" lang="java">        <span class="s">"Not implemented: ''{0}''."</span><span class="o">},</span></span>
<span id="LC464" class="line" lang="java"></span>
<span id="LC465" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC466" class="line" lang="java"><span class="cm">         * Note to translators:  The XML document given to XSLTC as a stylesheet</span></span>
<span id="LC467" class="line" lang="java"><span class="cm">         * was not, in fact, a stylesheet.</span></span>
<span id="LC468" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC469" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">NOT_STYLESHEET_ERR</span><span class="o">,</span></span>
<span id="LC470" class="line" lang="java">        <span class="s">"The input document does not contain an XSL stylesheet."</span><span class="o">},</span></span>
<span id="LC471" class="line" lang="java"></span>
<span id="LC472" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC473" class="line" lang="java"><span class="cm">         * Note to translators:  The element named in the substitution text was</span></span>
<span id="LC474" class="line" lang="java"><span class="cm">         * encountered in the stylesheet but is not recognized.</span></span>
<span id="LC475" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC476" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ELEMENT_PARSE_ERR</span><span class="o">,</span></span>
<span id="LC477" class="line" lang="java">        <span class="s">"Could not parse element ''{0}''"</span><span class="o">},</span></span>
<span id="LC478" class="line" lang="java"></span>
<span id="LC479" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC480" class="line" lang="java"><span class="cm">         * Note to translators:  "use", "&lt;key&gt;", "node", "node-set", "string"</span></span>
<span id="LC481" class="line" lang="java"><span class="cm">         * and "number" are keywords in this context and should not be</span></span>
<span id="LC482" class="line" lang="java"><span class="cm">         * translated.  This message indicates that the value of the "use"</span></span>
<span id="LC483" class="line" lang="java"><span class="cm">         * attribute was not one of the permitted values.</span></span>
<span id="LC484" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC485" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">KEY_USE_ATTR_ERR</span><span class="o">,</span></span>
<span id="LC486" class="line" lang="java">        <span class="s">"The use attribute of &lt;key&gt; must be node, node-set, string or number."</span><span class="o">},</span></span>
<span id="LC487" class="line" lang="java"></span>
<span id="LC488" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC489" class="line" lang="java"><span class="cm">         * Note to translators:  An XML document can specify the version of the</span></span>
<span id="LC490" class="line" lang="java"><span class="cm">         * XML specification to which it adheres.  This message indicates that</span></span>
<span id="LC491" class="line" lang="java"><span class="cm">         * the version specified for the output document was not valid.</span></span>
<span id="LC492" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC493" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">OUTPUT_VERSION_ERR</span><span class="o">,</span></span>
<span id="LC494" class="line" lang="java">        <span class="s">"Output XML document version should be 1.0"</span><span class="o">},</span></span>
<span id="LC495" class="line" lang="java"></span>
<span id="LC496" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC497" class="line" lang="java"><span class="cm">         * Note to translators:  The operator in a comparison operation was</span></span>
<span id="LC498" class="line" lang="java"><span class="cm">         * not recognized.</span></span>
<span id="LC499" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC500" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_RELAT_OP_ERR</span><span class="o">,</span></span>
<span id="LC501" class="line" lang="java">        <span class="s">"Unknown operator for relational expression"</span><span class="o">},</span></span>
<span id="LC502" class="line" lang="java"></span>
<span id="LC503" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC504" class="line" lang="java"><span class="cm">         * Note to translators:  An attribute set defines as a set of XML</span></span>
<span id="LC505" class="line" lang="java"><span class="cm">         * attributes that can be added to an element in the output XML document</span></span>
<span id="LC506" class="line" lang="java"><span class="cm">         * as a group.  This message is reported if the name specified was not</span></span>
<span id="LC507" class="line" lang="java"><span class="cm">         * used to declare an attribute set.  The substitution text is the name</span></span>
<span id="LC508" class="line" lang="java"><span class="cm">         * that is in error.</span></span>
<span id="LC509" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC510" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ATTRIBSET_UNDEF_ERR</span><span class="o">,</span></span>
<span id="LC511" class="line" lang="java">        <span class="s">"Attempting to use non-existing attribute set ''{0}''."</span><span class="o">},</span></span>
<span id="LC512" class="line" lang="java"></span>
<span id="LC513" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC514" class="line" lang="java"><span class="cm">         * Note to translators:  The term "attribute value template" is a term</span></span>
<span id="LC515" class="line" lang="java"><span class="cm">         * defined by XSLT which describes the value of an attribute that is</span></span>
<span id="LC516" class="line" lang="java"><span class="cm">         * determined by an XPath expression.  The message indicates that the</span></span>
<span id="LC517" class="line" lang="java"><span class="cm">         * expression was syntactically incorrect; the substitution text</span></span>
<span id="LC518" class="line" lang="java"><span class="cm">         * contains the expression that was in error.</span></span>
<span id="LC519" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC520" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ATTR_VAL_TEMPLATE_ERR</span><span class="o">,</span></span>
<span id="LC521" class="line" lang="java">        <span class="s">"Cannot parse attribute value template ''{0}''."</span><span class="o">},</span></span>
<span id="LC522" class="line" lang="java"></span>
<span id="LC523" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC524" class="line" lang="java"><span class="cm">         * Note to translators:  ???</span></span>
<span id="LC525" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC526" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">UNKNOWN_SIG_TYPE_ERR</span><span class="o">,</span></span>
<span id="LC527" class="line" lang="java">        <span class="s">"Unknown data-type in signature for class ''{0}''."</span><span class="o">},</span></span>
<span id="LC528" class="line" lang="java"></span>
<span id="LC529" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC530" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text refers to data types.</span></span>
<span id="LC531" class="line" lang="java"><span class="cm">         * The message is displayed if a value in a particular context needs to</span></span>
<span id="LC532" class="line" lang="java"><span class="cm">         * be converted to type {1}, but that's not possible for a value of</span></span>
<span id="LC533" class="line" lang="java"><span class="cm">         * type {0}.</span></span>
<span id="LC534" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC535" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">DATA_CONVERSION_ERR</span><span class="o">,</span></span>
<span id="LC536" class="line" lang="java">        <span class="s">"Cannot convert data-type ''{0}'' to ''{1}''."</span><span class="o">},</span></span>
<span id="LC537" class="line" lang="java"></span>
<span id="LC538" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC539" class="line" lang="java"><span class="cm">         * Note to translators:  "Templates" is a Java class name that should</span></span>
<span id="LC540" class="line" lang="java"><span class="cm">         * not be translated.</span></span>
<span id="LC541" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC542" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">NO_TRANSLET_CLASS_ERR</span><span class="o">,</span></span>
<span id="LC543" class="line" lang="java">        <span class="s">"This Templates does not contain a valid translet class definition."</span><span class="o">},</span></span>
<span id="LC544" class="line" lang="java"></span>
<span id="LC545" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC546" class="line" lang="java"><span class="cm">         * Note to translators:  "Templates" is a Java class name that should</span></span>
<span id="LC547" class="line" lang="java"><span class="cm">         * not be translated.</span></span>
<span id="LC548" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC549" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">NO_MAIN_TRANSLET_ERR</span><span class="o">,</span></span>
<span id="LC550" class="line" lang="java">        <span class="s">"This Templates does not contain a class with the name ''{0}''."</span><span class="o">},</span></span>
<span id="LC551" class="line" lang="java"></span>
<span id="LC552" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC553" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text is the name of a class.</span></span>
<span id="LC554" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC555" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TRANSLET_CLASS_ERR</span><span class="o">,</span></span>
<span id="LC556" class="line" lang="java">        <span class="s">"Could not load the translet class ''{0}''."</span><span class="o">},</span></span>
<span id="LC557" class="line" lang="java"></span>
<span id="LC558" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TRANSLET_OBJECT_ERR</span><span class="o">,</span></span>
<span id="LC559" class="line" lang="java">        <span class="s">"Translet class loaded, but unable to create translet instance."</span><span class="o">},</span></span>
<span id="LC560" class="line" lang="java"></span>
<span id="LC561" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC562" class="line" lang="java"><span class="cm">         * Note to translators:  "ErrorListener" is a Java interface name that</span></span>
<span id="LC563" class="line" lang="java"><span class="cm">         * should not be translated.  The message indicates that the user tried</span></span>
<span id="LC564" class="line" lang="java"><span class="cm">         * to set an ErrorListener object on object of the class named in the</span></span>
<span id="LC565" class="line" lang="java"><span class="cm">         * substitution text with "null" Java value.</span></span>
<span id="LC566" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC567" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ERROR_LISTENER_NULL_ERR</span><span class="o">,</span></span>
<span id="LC568" class="line" lang="java">        <span class="s">"Attempting to set ErrorListener for ''{0}'' to null"</span><span class="o">},</span></span>
<span id="LC569" class="line" lang="java"></span>
<span id="LC570" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC571" class="line" lang="java"><span class="cm">         * Note to translators:  StreamSource, SAXSource and DOMSource are Java</span></span>
<span id="LC572" class="line" lang="java"><span class="cm">         * interface names that should not be translated.</span></span>
<span id="LC573" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC574" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_UNKNOWN_SOURCE_ERR</span><span class="o">,</span></span>
<span id="LC575" class="line" lang="java">        <span class="s">"Only StreamSource, SAXSource and DOMSource are supported by XSLTC"</span><span class="o">},</span></span>
<span id="LC576" class="line" lang="java"></span>
<span id="LC577" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC578" class="line" lang="java"><span class="cm">         * Note to translators:  "Source" is a Java class name that should not</span></span>
<span id="LC579" class="line" lang="java"><span class="cm">         * be translated.  The substitution text is the name of Java method.</span></span>
<span id="LC580" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC581" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_NO_SOURCE_ERR</span><span class="o">,</span></span>
<span id="LC582" class="line" lang="java">        <span class="s">"Source object passed to ''{0}'' has no contents."</span><span class="o">},</span></span>
<span id="LC583" class="line" lang="java"></span>
<span id="LC584" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC585" class="line" lang="java"><span class="cm">         * Note to translators:  The message indicates that XSLTC failed to</span></span>
<span id="LC586" class="line" lang="java"><span class="cm">         * compile the stylesheet into a translet (class file).</span></span>
<span id="LC587" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC588" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_COMPILE_ERR</span><span class="o">,</span></span>
<span id="LC589" class="line" lang="java">        <span class="s">"Could not compile stylesheet"</span><span class="o">},</span></span>
<span id="LC590" class="line" lang="java"></span>
<span id="LC591" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC592" class="line" lang="java"><span class="cm">         * Note to translators:  "TransformerFactory" is a class name.  In this</span></span>
<span id="LC593" class="line" lang="java"><span class="cm">         * context, an attribute is a property or setting of the</span></span>
<span id="LC594" class="line" lang="java"><span class="cm">         * TransformerFactory object.  The substitution text is the name of the</span></span>
<span id="LC595" class="line" lang="java"><span class="cm">         * unrecognised attribute.  The method used to retrieve the attribute is</span></span>
<span id="LC596" class="line" lang="java"><span class="cm">         * "getAttribute", so it's not clear whether it would be best to</span></span>
<span id="LC597" class="line" lang="java"><span class="cm">         * translate the term "attribute".</span></span>
<span id="LC598" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC599" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_INVALID_ATTR_ERR</span><span class="o">,</span></span>
<span id="LC600" class="line" lang="java">        <span class="s">"TransformerFactory does not recognise attribute ''{0}''."</span><span class="o">},</span></span>
<span id="LC601" class="line" lang="java"></span>
<span id="LC602" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_INVALID_ATTR_VALUE_ERR</span><span class="o">,</span></span>
<span id="LC603" class="line" lang="java">        <span class="s">"Incorrect value specified for ''{0}'' attribute."</span><span class="o">},</span></span>
<span id="LC604" class="line" lang="java"></span>
<span id="LC605" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC606" class="line" lang="java"><span class="cm">         * Note to translators:  "setResult()" and "startDocument()" are Java</span></span>
<span id="LC607" class="line" lang="java"><span class="cm">         * method names that should not be translated.</span></span>
<span id="LC608" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC609" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_SET_RESULT_ERR</span><span class="o">,</span></span>
<span id="LC610" class="line" lang="java">        <span class="s">"setResult() must be called prior to startDocument()."</span><span class="o">},</span></span>
<span id="LC611" class="line" lang="java"></span>
<span id="LC612" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC613" class="line" lang="java"><span class="cm">         * Note to translators:  "Transformer" is a Java interface name that</span></span>
<span id="LC614" class="line" lang="java"><span class="cm">         * should not be translated.  A Transformer object should contained a</span></span>
<span id="LC615" class="line" lang="java"><span class="cm">         * reference to a translet object in order to be used for</span></span>
<span id="LC616" class="line" lang="java"><span class="cm">         * transformations; this message is produced if that requirement is not</span></span>
<span id="LC617" class="line" lang="java"><span class="cm">         * met.</span></span>
<span id="LC618" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC619" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_NO_TRANSLET_ERR</span><span class="o">,</span></span>
<span id="LC620" class="line" lang="java">        <span class="s">"The Transformer has no encapsulated translet object."</span><span class="o">},</span></span>
<span id="LC621" class="line" lang="java"></span>
<span id="LC622" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC623" class="line" lang="java"><span class="cm">         * Note to translators:  The XML document that results from a</span></span>
<span id="LC624" class="line" lang="java"><span class="cm">         * transformation needs to be sent to an output handler object; this</span></span>
<span id="LC625" class="line" lang="java"><span class="cm">         * message is produced if that requirement is not met.</span></span>
<span id="LC626" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC627" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_NO_HANDLER_ERR</span><span class="o">,</span></span>
<span id="LC628" class="line" lang="java">        <span class="s">"No defined output handler for transformation result."</span><span class="o">},</span></span>
<span id="LC629" class="line" lang="java"></span>
<span id="LC630" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC631" class="line" lang="java"><span class="cm">         * Note to translators:  "Result" is a Java interface name in this</span></span>
<span id="LC632" class="line" lang="java"><span class="cm">         * context.  The substitution text is a method name.</span></span>
<span id="LC633" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC634" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_NO_RESULT_ERR</span><span class="o">,</span></span>
<span id="LC635" class="line" lang="java">        <span class="s">"Result object passed to ''{0}'' is invalid."</span><span class="o">},</span></span>
<span id="LC636" class="line" lang="java"></span>
<span id="LC637" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC638" class="line" lang="java"><span class="cm">         * Note to translators:  "Transformer" is a Java interface name.  The</span></span>
<span id="LC639" class="line" lang="java"><span class="cm">         * user's program attempted to access an unrecognized property with the</span></span>
<span id="LC640" class="line" lang="java"><span class="cm">         * name specified in the substitution text.  The method used to retrieve</span></span>
<span id="LC641" class="line" lang="java"><span class="cm">         * the property is "getOutputProperty", so it's not clear whether it</span></span>
<span id="LC642" class="line" lang="java"><span class="cm">         * would be best to translate the term "property".</span></span>
<span id="LC643" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC644" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_UNKNOWN_PROP_ERR</span><span class="o">,</span></span>
<span id="LC645" class="line" lang="java">        <span class="s">"Attempting to access invalid Transformer property ''{0}''."</span><span class="o">},</span></span>
<span id="LC646" class="line" lang="java"></span>
<span id="LC647" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC648" class="line" lang="java"><span class="cm">         * Note to translators:  SAX2DOM is the name of a Java class that should</span></span>
<span id="LC649" class="line" lang="java"><span class="cm">         * not be translated.  This is an adapter in the sense that it takes a</span></span>
<span id="LC650" class="line" lang="java"><span class="cm">         * DOM object and converts it to something that uses the SAX API.</span></span>
<span id="LC651" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC652" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">SAX2DOM_ADAPTER_ERR</span><span class="o">,</span></span>
<span id="LC653" class="line" lang="java">        <span class="s">"Could not create SAX2DOM adapter: ''{0}''."</span><span class="o">},</span></span>
<span id="LC654" class="line" lang="java"></span>
<span id="LC655" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC656" class="line" lang="java"><span class="cm">         * Note to translators:  "XSLTCSource.build()" is a Java method name.</span></span>
<span id="LC657" class="line" lang="java"><span class="cm">         * "systemId" is an XML term that is short for "system identification".</span></span>
<span id="LC658" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC659" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">XSLTC_SOURCE_ERR</span><span class="o">,</span></span>
<span id="LC660" class="line" lang="java">        <span class="s">"XSLTCSource.build() called without systemId being set."</span><span class="o">},</span></span>
<span id="LC661" class="line" lang="java"></span>
<span id="LC662" class="line" lang="java">        <span class="o">{</span> <span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ER_RESULT_NULL</span><span class="o">,</span></span>
<span id="LC663" class="line" lang="java">            <span class="s">"Result should not be null"</span><span class="o">},</span></span>
<span id="LC664" class="line" lang="java"></span>
<span id="LC665" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC666" class="line" lang="java"><span class="cm">         * Note to translators:  This message indicates that the value argument</span></span>
<span id="LC667" class="line" lang="java"><span class="cm">         * of setParameter must be a valid Java Object.</span></span>
<span id="LC668" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC669" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_INVALID_SET_PARAM_VALUE</span><span class="o">,</span></span>
<span id="LC670" class="line" lang="java">        <span class="s">"The value of param {0} must be a valid Java Object"</span><span class="o">},</span></span>
<span id="LC671" class="line" lang="java"></span>
<span id="LC672" class="line" lang="java"></span>
<span id="LC673" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">COMPILE_STDIN_ERR</span><span class="o">,</span></span>
<span id="LC674" class="line" lang="java">        <span class="s">"The -i option must be used with the -o option."</span><span class="o">},</span></span>
...
<span id="LC678" class="line" lang="java"><span class="cm">         * Note to translators:  This message contains usage information for a</span></span>
<span id="LC679" class="line" lang="java"><span class="cm">         * means of invoking XSLTC from the command-line.  The message is</span></span>
<span id="LC680" class="line" lang="java"><span class="cm">         * formatted for presentation in English.  The strings &lt;output&gt;,</span></span>
<span id="LC681" class="line" lang="java"><span class="cm">         * &lt;directory&gt;, etc. indicate user-specified argument values, and can</span></span>
<span id="LC682" class="line" lang="java"><span class="cm">         * be translated - the argument &lt;package&gt; refers to a Java package, so</span></span>
<span id="LC683" class="line" lang="java"><span class="cm">         * it should be handled in the same way the term is handled for JDK</span></span>
<span id="LC684" class="line" lang="java"><span class="cm">         * documentation.</span></span>
<span id="LC685" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC686" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">COMPILE_USAGE_STR</span><span class="o">,</span></span>
<span id="LC687" class="line" lang="java">        <span class="s">"SYNOPSIS\n"</span><span class="o">+</span></span>
<span id="LC688" class="line" lang="java">        <span class="s">"   java com.sun.org.apache.xalan.internal.xsltc.cmdline.Compile [-o &lt;output&gt;]\n"</span><span class="o">+</span></span>
<span id="LC689" class="line" lang="java">        <span class="s">"      [-d &lt;directory&gt;] [-j &lt;jarfile&gt;] [-p &lt;package&gt;]\n"</span><span class="o">+</span></span>
<span id="LC690" class="line" lang="java">        <span class="s">"      [-n] [-x] [-u] [-v] [-h] { &lt;stylesheet&gt; | -i }\n\n"</span><span class="o">+</span></span>
<span id="LC691" class="line" lang="java">        <span class="s">"OPTIONS\n"</span><span class="o">+</span></span>
<span id="LC692" class="line" lang="java">        <span class="s">"   -o &lt;output&gt;    assigns the name &lt;output&gt; to the generated\n"</span><span class="o">+</span></span>
<span id="LC693" class="line" lang="java">        <span class="s">"                  translet.  By default the translet name is\n"</span><span class="o">+</span></span>
<span id="LC694" class="line" lang="java">        <span class="s">"                  derived from the &lt;stylesheet&gt; name.  This option\n"</span><span class="o">+</span></span>
<span id="LC695" class="line" lang="java">        <span class="s">"                  is ignored if compiling multiple stylesheets.\n"</span><span class="o">+</span></span>
<span id="LC696" class="line" lang="java">        <span class="s">"   -d &lt;directory&gt; specifies a destination directory for translet\n"</span><span class="o">+</span></span>
<span id="LC697" class="line" lang="java">        <span class="s">"   -j &lt;jarfile&gt;   packages translet classes into a jar file of the\n"</span><span class="o">+</span></span>
<span id="LC698" class="line" lang="java">        <span class="s">"                  name specified as &lt;jarfile&gt;\n"</span><span class="o">+</span></span>
<span id="LC699" class="line" lang="java">        <span class="s">"   -p &lt;package&gt;   specifies a package name prefix for all generated\n"</span><span class="o">+</span></span>
<span id="LC700" class="line" lang="java">        <span class="s">"                  translet classes.\n"</span><span class="o">+</span></span>
<span id="LC701" class="line" lang="java">        <span class="s">"   -n             enables template inlining (default behavior better\n"</span><span class="o">+</span></span>
<span id="LC702" class="line" lang="java">        <span class="s">"                  on average).\n"</span><span class="o">+</span></span>
<span id="LC703" class="line" lang="java">        <span class="s">"   -x             turns on additional debugging message output\n"</span><span class="o">+</span></span>
<span id="LC704" class="line" lang="java">        <span class="s">"   -u             interprets &lt;stylesheet&gt; arguments as URLs\n"</span><span class="o">+</span></span>
<span id="LC705" class="line" lang="java">        <span class="s">"   -i             forces compiler to read stylesheet from stdin\n"</span><span class="o">+</span></span>
<span id="LC706" class="line" lang="java">        <span class="s">"   -v             prints the version of the compiler\n"</span><span class="o">+</span></span>
<span id="LC707" class="line" lang="java">        <span class="s">"   -h             prints this usage statement\n"</span><span class="o">},</span></span>
<span id="LC708" class="line" lang="java"></span>
<span id="LC709" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC710" class="line" lang="java"><span class="cm">         * Note to translators:  This message contains usage information for a</span></span>
<span id="LC711" class="line" lang="java"><span class="cm">         * means of invoking XSLTC from the command-line.  The message is</span></span>
<span id="LC712" class="line" lang="java"><span class="cm">         * formatted for presentation in English.  The strings &lt;jarfile&gt;,</span></span>
<span id="LC713" class="line" lang="java"><span class="cm">         * &lt;document&gt;, etc. indicate user-specified argument values, and can</span></span>
<span id="LC714" class="line" lang="java"><span class="cm">         * be translated - the argument &lt;class&gt; refers to a Java class, so it</span></span>
<span id="LC715" class="line" lang="java"><span class="cm">         * should be handled in the same way the term is handled for JDK</span></span>
<span id="LC716" class="line" lang="java"><span class="cm">         * documentation.</span></span>
<span id="LC717" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC718" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TRANSFORM_USAGE_STR</span><span class="o">,</span></span>
<span id="LC719" class="line" lang="java">        <span class="s">"SYNOPSIS \n"</span><span class="o">+</span></span>
<span id="LC720" class="line" lang="java">        <span class="s">"   java com.sun.org.apache.xalan.internal.xsltc.cmdline.Transform [-j &lt;jarfile&gt;]\n"</span><span class="o">+</span></span>
<span id="LC721" class="line" lang="java">        <span class="s">"      [-x] [-n &lt;iterations&gt;] {-u &lt;document_url&gt; | &lt;document&gt;}\n"</span><span class="o">+</span></span>
<span id="LC722" class="line" lang="java">        <span class="s">"      &lt;class&gt; [&lt;param1&gt;=&lt;value1&gt; ...]\n\n"</span><span class="o">+</span></span>
<span id="LC723" class="line" lang="java">        <span class="s">"   uses the translet &lt;class&gt; to transform an XML document \n"</span><span class="o">+</span></span>
<span id="LC724" class="line" lang="java">        <span class="s">"   specified as &lt;document&gt;. The translet &lt;class&gt; is either in\n"</span><span class="o">+</span></span>
<span id="LC725" class="line" lang="java">        <span class="s">"   the user's CLASSPATH or in the optionally specified &lt;jarfile&gt;.\n"</span><span class="o">+</span></span>
<span id="LC726" class="line" lang="java">        <span class="s">"OPTIONS\n"</span><span class="o">+</span></span>
<span id="LC727" class="line" lang="java">        <span class="s">"   -j &lt;jarfile&gt;    specifies a jarfile from which to load translet\n"</span><span class="o">+</span></span>
<span id="LC728" class="line" lang="java">        <span class="s">"   -x              turns on additional debugging message output\n"</span><span class="o">+</span></span>
<span id="LC729" class="line" lang="java">        <span class="s">"   -n &lt;iterations&gt; runs the transformation &lt;iterations&gt; times and\n"</span><span class="o">+</span></span>
<span id="LC730" class="line" lang="java">        <span class="s">"                   displays profiling information\n"</span><span class="o">+</span></span>
<span id="LC731" class="line" lang="java">        <span class="s">"   -u &lt;document_url&gt; specifies XML input document as a URL\n"</span><span class="o">},</span></span>
...
<span id="LC736" class="line" lang="java"><span class="cm">         * Note to translators:  "&lt;xsl:sort&gt;", "&lt;xsl:for-each&gt;" and</span></span>
<span id="LC737" class="line" lang="java"><span class="cm">         * "&lt;xsl:apply-templates&gt;" are keywords that should not be translated.</span></span>
<span id="LC738" class="line" lang="java"><span class="cm">         * The message indicates that an xsl:sort element must be a child of</span></span>
<span id="LC739" class="line" lang="java"><span class="cm">         * one of the other kinds of elements mentioned.</span></span>
<span id="LC740" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC741" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">STRAY_SORT_ERR</span><span class="o">,</span></span>
<span id="LC742" class="line" lang="java">        <span class="s">"&lt;xsl:sort&gt; can only be used within &lt;xsl:for-each&gt; or &lt;xsl:apply-templates&gt;."</span><span class="o">},</span></span>
<span id="LC743" class="line" lang="java"></span>
<span id="LC744" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC745" class="line" lang="java"><span class="cm">         * Note to translators:  The message indicates that the encoding</span></span>
<span id="LC746" class="line" lang="java"><span class="cm">         * requested for the output document was on that requires support that</span></span>
<span id="LC747" class="line" lang="java"><span class="cm">         * is not available from the Java Virtual Machine being used to execute</span></span>
<span id="LC748" class="line" lang="java"><span class="cm">         * the program.</span></span>
<span id="LC749" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC750" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">UNSUPPORTED_ENCODING</span><span class="o">,</span></span>
<span id="LC751" class="line" lang="java">        <span class="s">"Output encoding ''{0}'' is not supported on this JVM."</span><span class="o">},</span></span>
<span id="LC752" class="line" lang="java"></span>
<span id="LC753" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC754" class="line" lang="java"><span class="cm">         * Note to translators:  The message indicates that the XPath expression</span></span>
<span id="LC755" class="line" lang="java"><span class="cm">         * named in the substitution text was not well formed syntactically.</span></span>
<span id="LC756" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC757" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">SYNTAX_ERR</span><span class="o">,</span></span>
<span id="LC758" class="line" lang="java">        <span class="s">"Syntax error in ''{0}''."</span><span class="o">},</span></span>
<span id="LC759" class="line" lang="java"></span>
<span id="LC760" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC761" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text is the name of a Java</span></span>
<span id="LC762" class="line" lang="java"><span class="cm">         * class.  The term "constructor" here is the Java term.  The message is</span></span>
<span id="LC763" class="line" lang="java"><span class="cm">         * displayed if XSLTC could not find a constructor for the specified</span></span>
<span id="LC764" class="line" lang="java"><span class="cm">         * class.</span></span>
<span id="LC765" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC766" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">CONSTRUCTOR_NOT_FOUND</span><span class="o">,</span></span>
<span id="LC767" class="line" lang="java">        <span class="s">"Cannot find external constructor ''{0}''."</span><span class="o">},</span></span>
<span id="LC768" class="line" lang="java"></span>
<span id="LC769" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC770" class="line" lang="java"><span class="cm">         * Note to translators:  "static" is the Java keyword.  The substitution</span></span>
<span id="LC771" class="line" lang="java"><span class="cm">         * text is the name of a function.  The first argument of that function</span></span>
<span id="LC772" class="line" lang="java"><span class="cm">         * is not of the required type.</span></span>
<span id="LC773" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC774" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">NO_JAVA_FUNCT_THIS_REF</span><span class="o">,</span></span>
<span id="LC775" class="line" lang="java">        <span class="s">"The first argument to the non-static Java function ''{0}'' is not a "</span><span class="o">+</span></span>
<span id="LC776" class="line" lang="java">        <span class="s">"valid object reference."</span><span class="o">},</span></span>
<span id="LC777" class="line" lang="java"></span>
<span id="LC778" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC779" class="line" lang="java"><span class="cm">         * Note to translators:  An XPath expression was not of the type</span></span>
<span id="LC780" class="line" lang="java"><span class="cm">         * required in a particular context.  The substitution text is the</span></span>
<span id="LC781" class="line" lang="java"><span class="cm">         * expression that was in error.</span></span>
<span id="LC782" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC783" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TYPE_CHECK_ERR</span><span class="o">,</span></span>
<span id="LC784" class="line" lang="java">        <span class="s">"Error checking type of the expression ''{0}''."</span><span class="o">},</span></span>
<span id="LC785" class="line" lang="java"></span>
<span id="LC786" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC787" class="line" lang="java"><span class="cm">         * Note to translators:  An XPath expression was not of the type</span></span>
<span id="LC788" class="line" lang="java"><span class="cm">         * required in a particular context.  However, the location of the</span></span>
<span id="LC789" class="line" lang="java"><span class="cm">         * problematic expression is unknown.</span></span>
<span id="LC790" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC791" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TYPE_CHECK_UNK_LOC_ERR</span><span class="o">,</span></span>
<span id="LC792" class="line" lang="java">        <span class="s">"Error checking type of an expression at an unknown location."</span><span class="o">},</span></span>
<span id="LC793" class="line" lang="java"></span>
<span id="LC794" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC795" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text is the name of a command-</span></span>
<span id="LC796" class="line" lang="java"><span class="cm">         * line option that was not recognized.</span></span>
<span id="LC797" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC798" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ILLEGAL_CMDLINE_OPTION_ERR</span><span class="o">,</span></span>
<span id="LC799" class="line" lang="java">        <span class="s">"The command-line option ''{0}'' is not valid."</span><span class="o">},</span></span>
<span id="LC800" class="line" lang="java"></span>
<span id="LC801" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC802" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text is the name of a command-</span></span>
<span id="LC803" class="line" lang="java"><span class="cm">         * line option.</span></span>
<span id="LC804" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC805" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">CMDLINE_OPT_MISSING_ARG_ERR</span><span class="o">,</span></span>
<span id="LC806" class="line" lang="java">        <span class="s">"The command-line option ''{0}'' is missing a required argument."</span><span class="o">},</span></span>
<span id="LC807" class="line" lang="java"></span>
<span id="LC808" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC809" class="line" lang="java"><span class="cm">         * Note to translators:  This message is used to indicate the severity</span></span>
<span id="LC810" class="line" lang="java"><span class="cm">         * of another message.  The substitution text contains two error</span></span>
<span id="LC811" class="line" lang="java"><span class="cm">         * messages.  The spacing before the second substitution text indents</span></span>
<span id="LC812" class="line" lang="java"><span class="cm">         * it the same amount as the first in English.</span></span>
<span id="LC813" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC814" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">WARNING_PLUS_WRAPPED_MSG</span><span class="o">,</span></span>
<span id="LC815" class="line" lang="java">        <span class="s">"WARNING:  ''{0}''\n       :{1}"</span><span class="o">},</span></span>
<span id="LC816" class="line" lang="java"></span>
<span id="LC817" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC818" class="line" lang="java"><span class="cm">         * Note to translators:  This message is used to indicate the severity</span></span>
<span id="LC819" class="line" lang="java"><span class="cm">         * of another message.  The substitution text is an error message.</span></span>
<span id="LC820" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC821" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">WARNING_MSG</span><span class="o">,</span></span>
<span id="LC822" class="line" lang="java">        <span class="s">"WARNING:  ''{0}''"</span><span class="o">},</span></span>
<span id="LC823" class="line" lang="java"></span>
<span id="LC824" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC825" class="line" lang="java"><span class="cm">         * Note to translators:  This message is used to indicate the severity</span></span>
<span id="LC826" class="line" lang="java"><span class="cm">         * of another message.  The substitution text contains two error</span></span>
<span id="LC827" class="line" lang="java"><span class="cm">         * messages.  The spacing before the second substitution text indents</span></span>
<span id="LC828" class="line" lang="java"><span class="cm">         * it the same amount as the first in English.</span></span>
<span id="LC829" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC830" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">FATAL_ERR_PLUS_WRAPPED_MSG</span><span class="o">,</span></span>
<span id="LC831" class="line" lang="java">        <span class="s">"FATAL ERROR:  ''{0}''\n           :{1}"</span><span class="o">},</span></span>
<span id="LC832" class="line" lang="java"></span>
<span id="LC833" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC834" class="line" lang="java"><span class="cm">         * Note to translators:  This message is used to indicate the severity</span></span>
<span id="LC835" class="line" lang="java"><span class="cm">         * of another message.  The substitution text is an error message.</span></span>
<span id="LC836" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC837" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">FATAL_ERR_MSG</span><span class="o">,</span></span>
<span id="LC838" class="line" lang="java">        <span class="s">"FATAL ERROR:  ''{0}''"</span><span class="o">},</span></span>
<span id="LC839" class="line" lang="java"></span>
<span id="LC840" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC841" class="line" lang="java"><span class="cm">         * Note to translators:  This message is used to indicate the severity</span></span>
<span id="LC842" class="line" lang="java"><span class="cm">         * of another message.  The substitution text contains two error</span></span>
<span id="LC843" class="line" lang="java"><span class="cm">         * messages.  The spacing before the second substitution text indents</span></span>
<span id="LC844" class="line" lang="java"><span class="cm">         * it the same amount as the first in English.</span></span>
<span id="LC845" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC846" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ERROR_PLUS_WRAPPED_MSG</span><span class="o">,</span></span>
<span id="LC847" class="line" lang="java">        <span class="s">"ERROR:  ''{0}''\n     :{1}"</span><span class="o">},</span></span>
<span id="LC848" class="line" lang="java"></span>
<span id="LC849" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC850" class="line" lang="java"><span class="cm">         * Note to translators:  This message is used to indicate the severity</span></span>
<span id="LC851" class="line" lang="java"><span class="cm">         * of another message.  The substitution text is an error message.</span></span>
<span id="LC852" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC853" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">ERROR_MSG</span><span class="o">,</span></span>
<span id="LC854" class="line" lang="java">        <span class="s">"ERROR:  ''{0}''"</span><span class="o">},</span></span>
<span id="LC855" class="line" lang="java"></span>
<span id="LC856" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC857" class="line" lang="java"><span class="cm">         * Note to translators:  The substitution text is the name of a class.</span></span>
<span id="LC858" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC859" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TRANSFORM_WITH_TRANSLET_STR</span><span class="o">,</span></span>
<span id="LC860" class="line" lang="java">        <span class="s">"Transform using translet ''{0}'' "</span><span class="o">},</span></span>
<span id="LC861" class="line" lang="java"></span>
<span id="LC862" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC863" class="line" lang="java"><span class="cm">         * Note to translators:  The first substitution is the name of a class,</span></span>
<span id="LC864" class="line" lang="java"><span class="cm">         * while the second substitution is the name of a jar file.</span></span>
<span id="LC865" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC866" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TRANSFORM_WITH_JAR_STR</span><span class="o">,</span></span>
<span id="LC867" class="line" lang="java">        <span class="s">"Transform using translet ''{0}'' from jar file ''{1}''"</span><span class="o">},</span></span>
<span id="LC868" class="line" lang="java"></span>
<span id="LC869" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC870" class="line" lang="java"><span class="cm">         * Note to translators:  "TransformerFactory" is the name of a Java</span></span>
<span id="LC871" class="line" lang="java"><span class="cm">         * interface and must not be translated.  The substitution text is</span></span>
<span id="LC872" class="line" lang="java"><span class="cm">         * the name of the class that could not be instantiated.</span></span>
<span id="LC873" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC874" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">COULD_NOT_CREATE_TRANS_FACT</span><span class="o">,</span></span>
<span id="LC875" class="line" lang="java">        <span class="s">"Could not create an instance of the TransformerFactory class ''{0}''."</span><span class="o">},</span></span>
<span id="LC876" class="line" lang="java"></span>
<span id="LC877" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC878" class="line" lang="java"><span class="cm">         * Note to translators:  This message is produced when the user</span></span>
<span id="LC879" class="line" lang="java"><span class="cm">         * specified a name for the translet class that contains characters</span></span>
<span id="LC880" class="line" lang="java"><span class="cm">         * that are not permitted in a Java class name.  The substitution</span></span>
<span id="LC881" class="line" lang="java"><span class="cm">         * text "{0}" specifies the name the user requested, while "{1}"</span></span>
<span id="LC882" class="line" lang="java"><span class="cm">         * specifies the name the processor used instead.</span></span>
<span id="LC883" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC884" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">TRANSLET_NAME_JAVA_CONFLICT</span><span class="o">,</span></span>
<span id="LC885" class="line" lang="java">         <span class="s">"The name ''{0}'' could not be used as the name of the translet "</span><span class="o">+</span></span>
<span id="LC886" class="line" lang="java">         <span class="s">"class because it contains characters that are not permitted in the "</span><span class="o">+</span></span>
<span id="LC887" class="line" lang="java">         <span class="s">"name of Java class.  The name ''{1}'' was used instead."</span><span class="o">},</span></span>
<span id="LC888" class="line" lang="java"></span>
<span id="LC889" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC890" class="line" lang="java"><span class="cm">         * Note to translators:  The following message is used as a header.</span></span>
<span id="LC891" class="line" lang="java"><span class="cm">         * All the error messages are collected together and displayed beneath</span></span>
<span id="LC892" class="line" lang="java"><span class="cm">         * this message.</span></span>
<span id="LC893" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC894" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">COMPILER_ERROR_KEY</span><span class="o">,</span></span>
<span id="LC895" class="line" lang="java">        <span class="s">"Compiler errors:"</span><span class="o">},</span></span>
<span id="LC896" class="line" lang="java"></span>
<span id="LC897" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC898" class="line" lang="java"><span class="cm">         * Note to translators:  The following message is used as a header.</span></span>
<span id="LC899" class="line" lang="java"><span class="cm">         * All the warning messages are collected together and displayed</span></span>
<span id="LC900" class="line" lang="java"><span class="cm">         * beneath this message.</span></span>
<span id="LC901" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC902" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">COMPILER_WARNING_KEY</span><span class="o">,</span></span>
<span id="LC903" class="line" lang="java">        <span class="s">"Compiler warnings:"</span><span class="o">},</span></span>
<span id="LC904" class="line" lang="java"></span>
<span id="LC905" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC906" class="line" lang="java"><span class="cm">         * Note to translators:  The following message is used as a header.</span></span>
<span id="LC907" class="line" lang="java"><span class="cm">         * All the error messages that are produced when the stylesheet is</span></span>
<span id="LC908" class="line" lang="java"><span class="cm">         * applied to an input document are collected together and displayed</span></span>
<span id="LC909" class="line" lang="java"><span class="cm">         * beneath this message.  A 'translet' is the compiled form of a</span></span>
<span id="LC910" class="line" lang="java"><span class="cm">         * stylesheet (see above).</span></span>
<span id="LC911" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC912" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">RUNTIME_ERROR_KEY</span><span class="o">,</span></span>
<span id="LC913" class="line" lang="java">        <span class="s">"Translet errors:"</span><span class="o">},</span></span>
<span id="LC914" class="line" lang="java"></span>
<span id="LC915" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC916" class="line" lang="java"><span class="cm">         * Note to translators:  An attribute whose value is constrained to</span></span>
<span id="LC917" class="line" lang="java"><span class="cm">         * be a "QName" or a list of "QNames" had a value that was incorrect.</span></span>
<span id="LC918" class="line" lang="java"><span class="cm">         * 'QName' is an XML syntactic term that must not be translated.  The</span></span>
<span id="LC919" class="line" lang="java"><span class="cm">         * substitution text contains the actual value of the attribute.</span></span>
<span id="LC920" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC921" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">INVALID_QNAME_ERR</span><span class="o">,</span></span>
<span id="LC922" class="line" lang="java">        <span class="s">"An attribute whose value must be a QName or whitespace-separated list of QNames had the value ''{0}''"</span><span class="o">},</span></span>
<span id="LC923" class="line" lang="java"></span>
<span id="LC924" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC925" class="line" lang="java"><span class="cm">         * Note to translators:  An attribute whose value is required to</span></span>
<span id="LC926" class="line" lang="java"><span class="cm">         * be an "NCName".</span></span>
<span id="LC927" class="line" lang="java"><span class="cm">         * 'NCName' is an XML syntactic term that must not be translated.  The</span></span>
<span id="LC928" class="line" lang="java"><span class="cm">         * substitution text contains the actual value of the attribute.</span></span>
<span id="LC929" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC930" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">INVALID_NCNAME_ERR</span><span class="o">,</span></span>
<span id="LC931" class="line" lang="java">        <span class="s">"An attribute whose value must be an NCName had the value ''{0}''"</span><span class="o">},</span></span>
<span id="LC932" class="line" lang="java"></span>
<span id="LC933" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC934" class="line" lang="java"><span class="cm">         * Note to translators:  An attribute with an incorrect value was</span></span>
<span id="LC935" class="line" lang="java"><span class="cm">         * encountered.  The permitted value is one of the literal values</span></span>
<span id="LC936" class="line" lang="java"><span class="cm">         * "xml", "html" or "text"; it is also permitted to have the form of</span></span>
<span id="LC937" class="line" lang="java"><span class="cm">         * a QName that is not also an NCName.  The terms "method",</span></span>
<span id="LC938" class="line" lang="java"><span class="cm">         * "xsl:output", "xml", "html" and "text" are keywords that must not</span></span>
<span id="LC939" class="line" lang="java"><span class="cm">         * be translated.  The term "qname-but-not-ncname" is an XML syntactic</span></span>
<span id="LC940" class="line" lang="java"><span class="cm">         * term.  The substitution text contains the actual value of the</span></span>
<span id="LC941" class="line" lang="java"><span class="cm">         * attribute.</span></span>
<span id="LC942" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC943" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">INVALID_METHOD_IN_OUTPUT</span><span class="o">,</span></span>
<span id="LC944" class="line" lang="java">        <span class="s">"The method attribute of an &lt;xsl:output&gt; element had the value ''{0}''.  The value must be one of ''xml'', ''html'', ''text'', or qname-but-not-ncname"</span><span class="o">},</span></span>
<span id="LC945" class="line" lang="java"></span>
<span id="LC946" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_GET_FEATURE_NULL_NAME</span><span class="o">,</span></span>
<span id="LC947" class="line" lang="java">        <span class="s">"The feature name cannot be null in TransformerFactory.getFeature(String name)."</span><span class="o">},</span></span>
<span id="LC948" class="line" lang="java"></span>
<span id="LC949" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_SET_FEATURE_NULL_NAME</span><span class="o">,</span></span>
<span id="LC950" class="line" lang="java">        <span class="s">"The feature name cannot be null in TransformerFactory.setFeature(String name, boolean value)."</span><span class="o">},</span></span>
<span id="LC951" class="line" lang="java"></span>
<span id="LC952" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_UNSUPPORTED_FEATURE</span><span class="o">,</span></span>
<span id="LC953" class="line" lang="java">        <span class="s">"Cannot set the feature ''{0}'' on this TransformerFactory."</span><span class="o">},</span></span>
<span id="LC954" class="line" lang="java"></span>
<span id="LC955" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">JAXP_SECUREPROCESSING_FEATURE</span><span class="o">,</span></span>
<span id="LC956" class="line" lang="java">        <span class="s">"FEATURE_SECURE_PROCESSING: Cannot set the feature to false when security manager is present."</span><span class="o">},</span></span>
<span id="LC957" class="line" lang="java"></span>
<span id="LC958" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC959" class="line" lang="java"><span class="cm">         * Note to translators:  This message describes an internal error in the</span></span>
<span id="LC960" class="line" lang="java"><span class="cm">         * processor.  The term "byte code" is a Java technical term for the</span></span>
<span id="LC961" class="line" lang="java"><span class="cm">         * executable code in a Java method, and "try-catch-finally block"</span></span>
<span id="LC962" class="line" lang="java"><span class="cm">         * refers to the Java keywords with those names.  "Outlined" is a</span></span>
<span id="LC963" class="line" lang="java"><span class="cm">         * technical term internal to XSLTC and should not be translated.</span></span>
<span id="LC964" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC965" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">OUTLINE_ERR_TRY_CATCH</span><span class="o">,</span></span>
<span id="LC966" class="line" lang="java">         <span class="s">"Internal XSLTC error:  the generated byte code contains a "</span> <span class="o">+</span></span>
<span id="LC967" class="line" lang="java">         <span class="s">"try-catch-finally block and cannot be outlined."</span><span class="o">},</span></span>
<span id="LC968" class="line" lang="java"></span>
<span id="LC969" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC970" class="line" lang="java"><span class="cm">         * Note to translators:  This message describes an internal error in the</span></span>
<span id="LC971" class="line" lang="java"><span class="cm">         * processor.  The terms "OutlineableChunkStart" and</span></span>
<span id="LC972" class="line" lang="java"><span class="cm">         * "OutlineableChunkEnd" are the names of classes internal to XSLTC and</span></span>
<span id="LC973" class="line" lang="java"><span class="cm">         * should not be translated.  The message indicates that for every</span></span>
<span id="LC974" class="line" lang="java"><span class="cm">         * "start" there must be a corresponding "end", and vice versa, and</span></span>
<span id="LC975" class="line" lang="java"><span class="cm">         * that if one of a pair of "start" and "end" appears between another</span></span>
<span id="LC976" class="line" lang="java"><span class="cm">         * pair of corresponding "start" and "end", then the other half of the</span></span>
<span id="LC977" class="line" lang="java"><span class="cm">         * pair must also be between that same enclosing pair.</span></span>
<span id="LC978" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC979" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">OUTLINE_ERR_UNBALANCED_MARKERS</span><span class="o">,</span></span>
<span id="LC980" class="line" lang="java">         <span class="s">"Internal XSLTC error:  OutlineableChunkStart and "</span> <span class="o">+</span></span>
<span id="LC981" class="line" lang="java">         <span class="s">"OutlineableChunkEnd markers must be balanced and properly nested."</span><span class="o">},</span></span>
<span id="LC982" class="line" lang="java"></span>
<span id="LC983" class="line" lang="java">        <span class="cm">/*</span></span>
<span id="LC984" class="line" lang="java"><span class="cm">         * Note to translators:  This message describes an internal error in the</span></span>
<span id="LC985" class="line" lang="java"><span class="cm">         * processor.  The term "byte code" is a Java technical term for the</span></span>
<span id="LC986" class="line" lang="java"><span class="cm">         * executable code in a Java method.  The "method" that is being</span></span>
<span id="LC987" class="line" lang="java"><span class="cm">         * referred to is a Java method in a translet that XSLTC is generating</span></span>
<span id="LC988" class="line" lang="java"><span class="cm">         * in processing a stylesheet.  The "instruction" that is being</span></span>
<span id="LC989" class="line" lang="java"><span class="cm">         * referred to is one of the instrutions in the Java byte code in that</span></span>
<span id="LC990" class="line" lang="java"><span class="cm">         * method.  "Outlined" is a technical term internal to XSLTC and</span></span>
<span id="LC991" class="line" lang="java"><span class="cm">         * should not be translated.</span></span>
<span id="LC992" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC993" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">OUTLINE_ERR_DELETED_TARGET</span><span class="o">,</span></span>
<span id="LC994" class="line" lang="java">         <span class="s">"Internal XSLTC error:  an instruction that was part of a block of "</span> <span class="o">+</span></span>
<span id="LC995" class="line" lang="java">         <span class="s">"byte code that was outlined is still referred to in the original "</span> <span class="o">+</span></span>
<span id="LC996" class="line" lang="java">         <span class="s">"method."</span></span>
...
<span id="LC1001" class="line" lang="java"><span class="cm">         * Note to translators:  This message describes an internal error in the</span></span>
<span id="LC1002" class="line" lang="java"><span class="cm">         * processor.  The "method" that is being referred to is a Java method</span></span>
<span id="LC1003" class="line" lang="java"><span class="cm">         * in a translet that XSLTC is generating.</span></span>
<span id="LC1004" class="line" lang="java"><span class="cm">         *</span></span>
<span id="LC1005" class="line" lang="java"><span class="cm">         */</span></span>
<span id="LC1006" class="line" lang="java">        <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">OUTLINE_ERR_METHOD_TOO_BIG</span><span class="o">,</span></span>
<span id="LC1007" class="line" lang="java">         <span class="s">"Internal XSLTC error:  a method in the translet exceeds the Java "</span> <span class="o">+</span></span>
<span id="LC1008" class="line" lang="java">         <span class="s">"Virtual Machine limitation on the length of a method of 64 "</span> <span class="o">+</span></span>
<span id="LC1009" class="line" lang="java">         <span class="s">"kilobytes.  This is usually caused by templates in a stylesheet "</span> <span class="o">+</span></span>
<span id="LC1010" class="line" lang="java">         <span class="s">"that are very large.  Try restructuring your stylesheet to use "</span> <span class="o">+</span></span>
<span id="LC1011" class="line" lang="java">         <span class="s">"smaller templates."</span></span>
<span id="LC1012" class="line" lang="java">        <span class="o">},</span></span>
<span id="LC1013" class="line" lang="java"></span>
<span id="LC1014" class="line" lang="java">         <span class="o">{</span><span class="nc">ErrorMsg</span><span class="o">.</span><span class="na">DESERIALIZE_TRANSLET_ERR</span><span class="o">,</span> <span class="s">"When Java security is enabled, "</span> <span class="o">+</span></span>
<span id="LC1015" class="line" lang="java">                        <span class="s">"support for deserializing TemplatesImpl is disabled."</span> <span class="o">+</span></span>
<span id="LC1016" class="line" lang="java">                        <span class="s">"This can be overridden by setting the jdk.xml.enableTemplatesImplDeserialization"</span> <span class="o">+</span></span>
<span id="LC1017" class="line" lang="java">                        <span class="s">" system property to true."</span><span class="o">}</span></span>
