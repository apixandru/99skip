...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: Closure.java,v 1.2.4.1 2005/09/01 12:01:23 pvedula Exp $</span></span>
...
<span id="LC27" class="line" lang="java"><span class="cm"> * @author Santiago Pericas-Geertsen</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC29" class="line" lang="java"><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">Closure</span> <span class="o">{</span></span>
<span id="LC30" class="line" lang="java"></span>
<span id="LC31" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC32" class="line" lang="java"><span class="cm">     * Returns true if this closure is compiled in an inner class (i.e.</span></span>
<span id="LC33" class="line" lang="java"><span class="cm">     * if this is a real closure).</span></span>
<span id="LC34" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC35" class="line" lang="java">    <span class="kd">public</span> <span class="kt">boolean</span> <span class="nf">inInnerClass</span><span class="o">();</span></span>
<span id="LC36" class="line" lang="java"></span>
<span id="LC37" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC38" class="line" lang="java"><span class="cm">     * Returns a reference to its parent closure or null if outermost.</span></span>
<span id="LC39" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC40" class="line" lang="java">    <span class="kd">public</span> <span class="nc">Closure</span> <span class="nf">getParentClosure</span><span class="o">();</span></span>
<span id="LC41" class="line" lang="java"></span>
<span id="LC42" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC43" class="line" lang="java"><span class="cm">     * Returns the name of the auxiliary class or null if this predicate</span></span>
<span id="LC44" class="line" lang="java"><span class="cm">     * is compiled inside the Translet.</span></span>
<span id="LC45" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC46" class="line" lang="java">    <span class="kd">public</span> <span class="nc">String</span> <span class="nf">getInnerClassName</span><span class="o">();</span></span>
<span id="LC47" class="line" lang="java"></span>
<span id="LC48" class="line" lang="java">    <span class="cm">/**</span></span>
<span id="LC49" class="line" lang="java"><span class="cm">     * Add new variable to the closure.</span></span>
<span id="LC50" class="line" lang="java"><span class="cm">     */</span></span>
<span id="LC51" class="line" lang="java">    <span class="kd">public</span> <span class="kt">void</span> <span class="nf">addVariable</span><span class="o">(</span><span class="nc">VariableRefBase</span> <span class="n">variableRef</span><span class="o">);</span></span>
