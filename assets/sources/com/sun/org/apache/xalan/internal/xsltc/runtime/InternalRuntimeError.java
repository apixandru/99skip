...
<span id="LC22" class="line" lang="java"><span class="cm"> * $Id: InternalRuntimeError.java,v 1.0 2009-11-25 04:34:28 joehw Exp $</span></span>
...
<span id="LC27" class="line" lang="java"><span class="cm"> * Class to express failed assertions and similar for the xsltc runtime.</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> * As java.lang.AssertionError was introduced in JDK 1.4 we can't use that yet.</span></span>
<span id="LC29" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC30" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">InternalRuntimeError</span> <span class="kd">extends</span> <span class="nc">Error</span> <span class="o">{</span></span>
<span id="LC31" class="line" lang="java"></span>
<span id="LC32" class="line" lang="java">    <span class="kd">public</span> <span class="nf">InternalRuntimeError</span><span class="o">(</span><span class="nc">String</span> <span class="n">message</span><span class="o">)</span> <span class="o">{</span></span>
<span id="LC33" class="line" lang="java">        <span class="kd">super</span><span class="o">(</span><span class="n">message</span><span class="o">);</span></span>
