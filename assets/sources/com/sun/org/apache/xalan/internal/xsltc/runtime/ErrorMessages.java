...
<span id="LC94" class="line" lang="java">        <span class="s">"Run-time internal error in ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC101" class="line" lang="java">        <span class="s">"Run-time error when executing &lt;xsl:copy&gt;."</span><span class="o">},</span></span>
...
<span id="LC110" class="line" lang="java">        <span class="s">"Invalid conversion from ''{0}'' to ''{1}''."</span><span class="o">},</span></span>
...
<span id="LC118" class="line" lang="java">        <span class="s">"External function ''{0}'' not supported by XSLTC."</span><span class="o">},</span></span>
...
<span id="LC126" class="line" lang="java">        <span class="s">"Unknown argument type in equality expression."</span><span class="o">},</span></span>
...
<span id="LC135" class="line" lang="java">        <span class="s">"Invalid argument type ''{0}'' in call to ''{1}''"</span><span class="o">},</span></span>
...
<span id="LC143" class="line" lang="java">        <span class="s">"Attempting to format number ''{0}'' using pattern ''{1}''."</span><span class="o">},</span></span>
...
<span id="LC151" class="line" lang="java">        <span class="s">"Cannot clone iterator ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC160" class="line" lang="java">        <span class="s">"Iterator for axis ''{0}'' not supported."</span><span class="o">},</span></span>
...
<span id="LC169" class="line" lang="java">        <span class="s">"Iterator for typed axis ''{0}'' not supported."</span><span class="o">},</span></span>
...
<span id="LC178" class="line" lang="java">        <span class="s">"Attribute ''{0}'' outside of element."</span><span class="o">},</span></span>
...
<span id="LC188" class="line" lang="java">        <span class="s">"Namespace declaration ''{0}''=''{1}'' outside of element."</span><span class="o">},</span></span>
...
<span id="LC196" class="line" lang="java">        <span class="s">"Namespace for prefix ''{0}'' has not been declared."</span><span class="o">},</span></span>
...
<span id="LC203" class="line" lang="java">        <span class="s">"DOMAdapter created using wrong type of source DOM."</span><span class="o">},</span></span>
...
<span id="LC212" class="line" lang="java">        <span class="s">"The SAX parser you are using does not handle DTD declaration events."</span><span class="o">},</span></span>
...
<span id="LC221" class="line" lang="java">        <span class="s">"The SAX parser you are using does not have support for XML Namespaces."</span><span class="o">},</span></span>
...
<span id="LC228" class="line" lang="java">        <span class="s">"Could not resolve the URI reference ''{0}''."</span><span class="o">},</span></span>
...
<span id="LC236" class="line" lang="java">        <span class="s">"Unsupported XSL element ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC245" class="line" lang="java">        <span class="s">"Unrecognized XSLTC extension ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC255" class="line" lang="java">        <span class="s">"The specified translet, ''{0}'', was created using a version of XSLTC more recent than the version of the XSLTC run-time that is in use.  You must recompile the stylesheet or use a more recent version of XSLTC to run this translet."</span><span class="o">},</span></span>
...
<span id="LC264" class="line" lang="java">        <span class="s">"An attribute whose value must be a QName had the value ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC274" class="line" lang="java">        <span class="s">"An attribute whose value must be an NCName had the value ''{0}''"</span><span class="o">},</span></span>
...
<span id="LC277" class="line" lang="java">        <span class="s">"Use of the extension function ''{0}'' is not allowed when the secure processing feature is set to true."</span><span class="o">},</span></span>
...
<span id="LC280" class="line" lang="java">        <span class="s">"Use of the extension element ''{0}'' is not allowed when the secure processing feature is set to true."</span><span class="o">},</span></span>
