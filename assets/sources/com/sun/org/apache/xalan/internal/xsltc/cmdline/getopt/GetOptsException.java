...
<span id="LC21" class="line" lang="java"><span class="cm"> * $Id: GetOptsException.java,v 1.2.4.1 2005/08/31 11:47:06 pvedula Exp $</span></span>
...
<span id="LC27" class="line" lang="java"><span class="cm"> * @author G Todd Miller</span></span>
<span id="LC28" class="line" lang="java"><span class="cm"> */</span></span>
<span id="LC29" class="line" lang="java"><span class="kd">public</span> <span class="kd">class</span> <span class="nc">GetOptsException</span> <span class="kd">extends</span> <span class="nc">Exception</span><span class="o">{</span></span>
<span id="LC30" class="line" lang="java">    <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="mi">8736874967183039804L</span><span class="o">;</span></span>
<span id="LC31" class="line" lang="java">    <span class="kd">public</span> <span class="nf">GetOptsException</span><span class="o">(</span><span class="nc">String</span> <span class="n">msg</span><span class="o">){</span></span>
<span id="LC32" class="line" lang="java">        <span class="kd">super</span><span class="o">(</span><span class="n">msg</span><span class="o">);</span></span>
